...
`python .\Scripts\skyguard_production.py next --limit 35` should surface these
first:
...
11. `core-apache-cockpit-station-model09` — CPG station model09 with glass overhead brow and readable bucket seat (additional queued method; does not supersede station-model08 until accepted)
12. `core-apache-cockpit-station-model10` — CPG station model10 with formed plate greenhouse (additional queued method; does not supersede station-model09 until accepted)
13. `core-apache-cockpit-station-model11` — CPG station model11 with dark formed greenhouse (additional queued method; does not supersede station-model10 until accepted)
14. `core-apache-cockpit-station-model12` — CPG station model12 with dark interior and non-white glass (additional queued method; does not supersede station-model11 until accepted)
15. `core-apache-cockpit-station-model13` — CPG station model13 with formed greenhouse bays (additional queued method; does not supersede station-model12 until accepted)
16. `core-apache-cockpit-station-model14` — CPG station model14 with greenhouse shell owning the silhouette (additional queued method; does not supersede station-model13 until accepted)
...
21. `core-apache-cockpit-station-model19` — CPG station model19 built from the plates plus the model18 visual fail: glass in the look-out, one inset dash (additional queued method; does not supersede station-model18 until accepted)
22. `core-apache-cockpit-station-model20` — CPG station model20 built from the plates plus the model19 visual fail: raked windshield, greenhouse enclosure, one inset dash (additional queued method; does not supersede station-model19 until accepted)
23. `core-apache-cockpit-station-model21` — CPG station model21 built from the plates plus the model20 visual fail: greenhouse shell owns three-quarter, eye_forward through glass, one inset dash (additional queued method; does not supersede station-model20 until accepted)
24. `core-apache-cockpit-station-model22` — CPG station model22 built from the plates plus the model21 cycle fail: GEO_Dash look-out assert survives bevel (additional queued method; does not supersede station-model21 until accepted)
25. `core-apache-cockpit-station-model23` — CPG station model23 built from the plates plus the model22 visual fail: greenhouse hull owns three-quarter, well-only TEDAC, eye_forward through glass (additional queued method; does not supersede station-model22 until accepted)
26. `core-apache-cockpit-station-model24` — CPG station model24 built from the plates plus the model23 cycle fail: keep model23 architecture, GEO_TEDAC calls orient_emit_faces_to_eye after object_from_bmesh (additional queued method; does not supersede station-model23 until accepted)
27. `core-apache-cockpit-station-model25` — CPG station model25 built from the plates plus the model24 visual fail: stop emitting the cage, one dash with TDU/MPD wells as holes, eye_forward through glass (additional queued method; does not supersede station-model24 until accepted)
28. `core-apache-cockpit-station-model26` — CPG station model26 built from the plates plus the model25 cycle fail: keep model25 architecture, GEO_Dash emit faces at TDU/MPD indices after bevel (additional queued method; does not supersede station-model25 until accepted)
29. `core-apache-cockpit-station-model27` — CPG station model27 built from the plates plus the model26 visual fail: keep model26 assert-path, open look-out, formed dash wells, closed greenhouse hull (additional queued method; does not supersede station-model26 until accepted)
30. `core-apache-cockpit-station-model28` — CPG station model28 built from the plates plus the model27 visual fail: keep model27 assert-path, look-out glass, formed dash wells, closed greenhouse hull (additional queued method; does not supersede station-model27 until accepted)
31. `core-apache-cockpit-station-model29` — CPG station model29 built from the plates plus the model28 visual fail: keep model28 assert-path, open look-out, formed dash cavities, closed greenhouse hull (additional queued method; does not supersede station-model28 until accepted)
32. `core-apache-30mm` — 30 mm chin gun
33. `core-apache-hydra` — Hydra / rocket pods
34. `core-apache-hellfire` — Hellfire / guided missile and launch rail
35. `core-apache-airframe` — exterior airframe
...
`core-apache-cockpit-station-model28`, and
`core-apache-cockpit-station-model29` are additional queued Apache P0
...
python .\Scripts\skyguard_production.py next --limit 35
...
`core-apache-cockpit-station-model27`,
`core-apache-cockpit-station-model28`, and
`core-apache-cockpit-station-model29` have registered workers and stay
