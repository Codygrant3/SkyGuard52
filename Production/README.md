...
`python .\Scripts\skyguard_production.py next --limit 20` should surface these
first:
...
17. `core-apache-30mm` — 30 mm chin gun
18. `core-apache-hydra` — Hydra / rocket pods
19. `core-apache-hellfire` — Hellfire / guided missile and launch rail
20. `core-apache-airframe` — exterior airframe
...
`core-apache-cockpit-station-model13`, and
`core-apache-cockpit-station-model14` are additional queued Apache P0
...
python .\Scripts\skyguard_production.py next --limit 20
...
`core-apache-cockpit-station-model12`,
`core-apache-cockpit-station-model13`, and
`core-apache-cockpit-station-model14` have registered workers and stay
