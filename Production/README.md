...
`python .\Scripts\skyguard_production.py next --limit 25` should surface these
first:
...
22. `core-apache-30mm` — 30 mm chin gun
23. `core-apache-hydra` — Hydra / rocket pods
24. `core-apache-hellfire` — Hellfire / guided missile and launch rail
25. `core-apache-airframe` — exterior airframe
...
`core-apache-cockpit-station-model18`, and
`core-apache-cockpit-station-model19` are additional queued Apache P0
...
python .\Scripts\skyguard_production.py next --limit 25
...
`core-apache-cockpit-station-model17`,
`core-apache-cockpit-station-model18`, and
`core-apache-cockpit-station-model19` have registered workers and stay
