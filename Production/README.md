...
`python .\Scripts\skyguard_production.py next --limit 28` should surface these
first:
...
25. `core-apache-30mm` — 30 mm chin gun
26. `core-apache-hydra` — Hydra / rocket pods
27. `core-apache-hellfire` — Hellfire / guided missile and launch rail
28. `core-apache-airframe` — exterior airframe
...
`core-apache-cockpit-station-model21`, and
`core-apache-cockpit-station-model22` are additional queued Apache P0
...
python .\Scripts\skyguard_production.py next --limit 28
...
`core-apache-cockpit-station-model20`,
`core-apache-cockpit-station-model21`, and
`core-apache-cockpit-station-model22` have registered workers and stay
