...
$supervisor = 'D:\Skyguard52\Scripts\build_skyguard_recovery03_native_recovery03_once.ps1'
$dotnet = 'D:\UE_5.8\Engine\Binaries\ThirdParty\DotNet\10.0\win-x64\dotnet.exe'
$testRoot = Join-Path $env:TEMP 'SkyguardRecovery03ExactHostTest'
...
[ordered]@{
    schema = 'skyguard.recovery03-native-build-recovery03-exact-host-test.v1'
