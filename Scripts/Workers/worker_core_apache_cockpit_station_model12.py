...
"""Governed AH-64 CPG station-model12 worker.

Keeps the model11 layout, sockets, look-out, glass overhead brow,
side canopy skins, hoods, emit wells, TEDAC readability, spun knobs,
HOCAS heads, dark formed greenhouse rails, formed joint plates, and
the model11 bucket seat. Dark interior plus non-white glass: consoles
use a dark InteriorOlive value and CanopyGlass is darker and less
white so three-quarter does not read as a beige/white kit. Real
...
ASSET_ID = "core-apache-cockpit-station-model12"
EYE = (0.0, 0.0, 1.18)
TEDAC = (0.50, 0.0, 0.88)
...
def build_asset(asset_collection) -> None:
    ...
    glass = emit_material("MAT_CPG_CanopyGlass", (0.22, 0.28, 0.32), 0.08, 0.0, alpha=0.22)
