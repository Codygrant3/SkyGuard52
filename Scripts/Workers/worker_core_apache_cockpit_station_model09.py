...
"""Governed AH-64 CPG station-model09 worker.

Keeps the model08 layout, sockets, look-out, glass overhead brow,
side canopy skins, hoods, emit wells, TEDAC readability, spun knobs,
and HOCAS heads. The seat must read as a bucket from three-quarter:
visible recessed pan well, tall inner bolster cheeks, and a cupped
back — not a dark slanted slab. Real bmesh only. Public layout only.
...
ASSET_ID = "core-apache-cockpit-station-model09"
EYE = (0.0, 0.0, 1.18)
TEDAC = (0.50, 0.0, 0.88)
