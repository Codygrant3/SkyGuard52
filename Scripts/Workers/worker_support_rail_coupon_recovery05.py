...
"""Recovery05 production binding for the immutable rail-coupon generator.

This wrapper preserves the frozen source and applies six measured, bounded
...
Blender 5.2, calibrated review-light exposure, additional cockpit fill, and a
near clip distance that keeps the governed close-detail camera readable.
Geometry and dimensional authorities are unchanged.
"""
...
REPLACEMENTS = (
    (
        ...
        'GATE = "GATE7_COMBAT_ASSET_REFINEMENT_CYCLE03_RAIL_COUPON_RECOVERY05_ATTEMPT01"',
        "gate identity",
    ),
    (
...
compiled = compile(recovery_text, str(SOURCE) + "::Recovery05", "exec")
