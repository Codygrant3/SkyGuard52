...
"""Governed AH-64 CPG station-model15 worker.

Keeps the model14 layout, sockets, look-out, glass overhead brow,
...
model14 bucket seat. Inset glass panes sit in the punched bay openings
so three-quarter reads as a formed plate shell with window panes, not
a beam cage with draped milky sheets. TEDAC stays one housing with
green emit and public crosshair visible; side MPDs are inset in the
same housing. Real bmesh only. Public layout only. Outputs go only to
--output.
"""
...
ASSET_ID = "core-apache-cockpit-station-model15"
EYE = (0.0, 0.0, 1.18)
TEDAC = (0.50, 0.0, 0.88)
