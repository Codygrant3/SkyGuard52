...
"""Governed AH-64 CPG station-model10 worker.

Keeps the model09 layout, sockets, look-out, glass overhead brow,
side canopy skins, hoods, emit wells, TEDAC readability, spun knobs,
HOCAS heads, and the model09 bucket seat. Greenhouse rails, sills,
and A-pillars must read as formed plate/section structure from
three-quarter — not white tubes or a stick cage. Real bmesh only.
...
ASSET_ID = "core-apache-cockpit-station-model10"
EYE = (0.0, 0.0, 1.18)
TEDAC = (0.50, 0.0, 0.88)
