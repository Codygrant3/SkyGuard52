...
"""Recovery01 identity binding for the frozen street/shore postflight."""
...
RECOVERY_ID = 'ASSET_ID = "m01-environment-hero-streetshore-proof01-recovery01"'
...
exec(compile(text, str(SOURCE) + "::Recovery01", "exec"), {"__name__": "__main__", "__file__": str(SOURCE)})
