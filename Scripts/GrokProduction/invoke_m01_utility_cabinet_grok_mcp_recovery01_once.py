...
PROMPT = PROJECT / "Production" / "Prompts" / "M01_UTILITY_CABINET_GROK_MCP_RECOVERY01.md"
FINALIZER = PROJECT / "Scripts" / "GrokProduction" / "finalize_m01_utility_cabinet_recovery01_scene.py"
ATTEMPT = PROJECT / "Production" / "Attempts" / "m01-utility-cabinet-grok-mcp-recovery01" / "attempt_20260811T091500000000Z"


def load_base():
    spec = importlib.util.spec_from_file_location("skyguard_utility_cabinet_recovery01_base", BASE_SUPERVISOR)
...
def configure(module) -> None:
    ...
    module.EXPECTED_BLEND = module.OUTPUT / "M01_Promenade_UtilityCabinet_Recovery01.blend"
    module.EXPECTED_GLB = module.OUTPUT / "exports" / "M01_Promenade_UtilityCabinet_Recovery01.glb"
...
def normalize_terminal(module) -> None:
    ...
    value["schema"] = "skyguard.m01-utility-cabinet.grok-mcp.recovery01.terminal.v1"
    value["asset"] = "M01 promenade utility cabinet"
