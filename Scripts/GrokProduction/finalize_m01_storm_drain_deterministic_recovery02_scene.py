...
replacements = {
    'OUTPUT = ROOT / r"Production\\Attempts\\m01-storm-drain-grok-mcp-recovery01\\attempt_20260811T101500000000Z\\output"': 'OUTPUT = ROOT / r"Production\\Attempts\\m01-storm-drain-deterministic-recovery02\\attempt_20260811T103000000000Z\\output"',
    ...
    'M01_Promenade_StormDrain_Recovery01.blend': 'M01_Promenade_StormDrain_Recovery02.blend',
    'M01_Promenade_StormDrain_Recovery01.glb': 'M01_Promenade_StormDrain_Recovery02.glb',
    'skyguard.m01-storm-drain.grok-mcp.recovery01.implementation.v1': 'skyguard.m01-storm-drain.deterministic-recovery02.implementation.v1',
}
