...
PROMPT = PROJECT / r"Production\Prompts\M01_PROMENADE_BENCH_GROK_MCP_PRODUCTION01.md"
FINALIZER = PROJECT / r"Scripts\GrokProduction\finalize_m01_promenade_bench_production01_scene.py"
ATTEMPT = PROJECT / r"Production\Attempts\m01-promenade-bench-grok-mcp-production01\attempt_20260811T1122000000000Z"
...
PROMPT_BYTES = 5_639
PROMPT_SHA256 = "4cbc336ac00f4310bfb8ba9d637b04bd59294104e6c64fcf97001b7b64da2c58"
FINALIZER_BYTES = 16_775
FINALIZER_SHA256 = "9945ea0c22fd4c26d3cc4c97a78be60b827629706a027d6299a12d2914bb0772"
...
def require_authority(path: Path, size: int, digest: str) -> None:
    if not path.is_file() or path.stat().st_size != size or sha256(path) != digest:
        raise RuntimeError(f"Frozen promenade-bench authority changed: {path}")


def load_base():
    spec = importlib.util.spec_from_file_location("skyguard_m01_promenade_bench_production01_base", BASE_SUPERVISOR)
...
def configure(module) -> None:
    ...
    module.EXPECTED_BLEND = module.OUTPUT / "M01_Promenade_Bench_Production01.blend"
    module.EXPECTED_GLB = module.OUTPUT / "exports" / "M01_Promenade_Bench_Production01.glb"
...
def normalize_terminal(module) -> None:
    ...
    value["schema"] = "skyguard.m01-promenade-bench.grok-mcp.production01.terminal.v1"
    value["asset"] = "M01 promenade bench"
