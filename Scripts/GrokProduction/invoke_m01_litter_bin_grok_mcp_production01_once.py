...
PROMPT = PROJECT / r"Production\Prompts\M01_LITTER_BIN_GROK_MCP_PRODUCTION01.md"
FINALIZER = PROJECT / r"Scripts\GrokProduction\finalize_m01_litter_bin_production01_scene.py"
ATTEMPT = PROJECT / r"Production\Attempts\m01-litter-bin-grok-mcp-production01\attempt_20260811T113000000000Z"
...
PROMPT_BYTES = 4_704
PROMPT_SHA256 = "945ae3cf1c629546a9179e9e03edfb57cc1a4230ca489f4e0b397014bc48cbc5"
FINALIZER_BYTES = 15_174
FINALIZER_SHA256 = "76899bd797df663b0fc7f127b59b094abcb48fd0432d49ff973b67c2e0b88ce4"
...
def require_authority(path: Path, size: int, digest: str) -> None:
    if not path.is_file() or path.stat().st_size != size or sha256(path) != digest:
        raise RuntimeError(f"Frozen litter-bin authority changed: {path}")


def load_base():
    spec = importlib.util.spec_from_file_location("skyguard_m01_litter_bin_production01_base", BASE_SUPERVISOR)
...
def configure(module) -> None:
    ...
    module.EXPECTED_BLEND = module.OUTPUT / "M01_Promenade_LitterBin_Production01.blend"
    module.EXPECTED_GLB = module.OUTPUT / "exports" / "M01_Promenade_LitterBin_Production01.glb"
...
def normalize_terminal(module) -> None:
    ...
    value["schema"] = "skyguard.m01-litter-bin.grok-mcp.production01.terminal.v1"
    value["asset"] = "M01 promenade litter bin"
