...
ATTEMPT = Path(r"D:\Skyguard52\Production\Attempts\m01-radar-post-grok-mcp\attempt_20260811T040000000000Z")
OUTPUT = ATTEMPT / "output"
BLEND = OUTPUT / "M01_RadarPost_GrokMCP_Production_A.blend"
GLB = OUTPUT / "exports" / "M01_RadarPost_GrokMCP_Production_A.glb"
...
def main():
    ...
    implementation = {
        "schema": "skyguard.m01-radar-post.grok-mcp.production-implementation.v1",
    ...
    receipt = {
        "schema": "skyguard.m01-radar-post.scene-serialization-receipt.v1",
        "classification": "PASSED_STRUCTURAL_PENDING_VISUAL",
        "blend": str(BLEND),
        "glb": str(GLB),
