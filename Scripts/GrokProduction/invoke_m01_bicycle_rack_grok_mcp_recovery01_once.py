...
PROMPT = PROJECT / "Production" / "Prompts" / "M01_BICYCLE_RACK_GROK_MCP_RECOVERY01.md"
FINALIZER = PROJECT / "Scripts" / "GrokProduction" / "finalize_m01_bicycle_rack_recovery01_scene.py"
ATTEMPT = PROJECT / "Production" / "Attempts" / "m01-bicycle-rack-grok-mcp-recovery01" / "attempt_20260811T072500000000Z"


def load_base():
    spec = importlib.util.spec_from_file_location("skyguard_bicycle_rack_base_supervisor", BASE_SUPERVISOR)
...
def configure(module) -> None:
    ...
    module.EXPECTED_BLEND = module.OUTPUT / "M01_Promenade_BicycleRack_Recovery01.blend"
    module.EXPECTED_GLB = module.OUTPUT / "exports" / "M01_Promenade_BicycleRack_Recovery01.glb"
...
def normalize_terminal(module) -> None:
    ...
    value["schema"] = "skyguard.m01-bicycle-rack.grok-mcp.recovery01.terminal.v1"
