...
ATTEMPT = PROJECT / r"Production\Attempts\m02-harbor-double-bitt-bollard-deterministic-recovery04\attempt_20260811T1317000000000Z"
...
def main() -> int:
    ...
    old = r'OUTPUT = ROOT / r"Production\Attempts\m02-harbor-double-bitt-bollard-grok-mcp-production01\attempt_20260811T1245000000000Z\output"'
    new = r'OUTPUT = ROOT / r"Production\Attempts\m02-harbor-double-bitt-bollard-deterministic-recovery04\attempt_20260811T1317000000000Z\output"'
    if old not in text:
        raise RuntimeError("Expected finalizer OUTPUT assignment not found")
    text = text.replace(old, new)
    FINALIZER.write_text(text, encoding="utf-8")
    if "deterministic-recovery04" not in FINALIZER.read_text(encoding="utf-8"):
        raise RuntimeError("Finalizer rewrite failed")
    ...
    terminal = {
        "schema": "skyguard.m02-harbor-double-bitt-bollard.deterministic-recovery04.terminal.v1",
