...
PROMPT = PROJECT / "Production" / "Prompts" / "CORE_IGLA_MISSILE_GROK_MCP_REFINEMENT01.md"
FINALIZER = PROJECT / "Scripts" / "GrokProduction" / "finalize_core_igla_missile_refinement01_scene.py"
ATTEMPT = PROJECT / "Production" / "Attempts" / "core-igla-missile-grok-mcp-refinement01" / "attempt_20260811T0737000000000Z"


def load_base():
    spec = importlib.util.spec_from_file_location("skyguard_core_igla_missile_refinement01_base", BASE_SUPERVISOR)
...
def configure(module) -> None:
    ...
    module.EXPECTED_BLEND = module.OUTPUT / "CORE_IglaMissile_Refinement01.blend"
    module.EXPECTED_GLB = module.OUTPUT / "exports" / "CORE_IglaMissile_Refinement01.glb"
...
def normalize_terminal(module) -> None:
    ...
    value["schema"] = "skyguard.core-igla-missile.grok-mcp.refinement01.terminal.v1"
    value["asset"] = "Core 9K38 Igla missile provisional visual exterior"
    value["representation_boundary"] = "Non-operational exterior game asset; only length and body diameter are authoritative"
