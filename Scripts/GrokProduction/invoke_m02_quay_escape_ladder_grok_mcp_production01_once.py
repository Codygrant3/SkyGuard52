...
PROMPT = PROJECT / r"Production\Prompts\M02_QUAY_ESCAPE_LADDER_GROK_MCP_PRODUCTION01.md"
FINALIZER = PROJECT / r"Scripts\GrokProduction\finalize_m02_quay_escape_ladder_production01_scene.py"
ATTEMPT = PROJECT / r"Production\Attempts\m02-quay-escape-ladder-grok-mcp-production01\attempt_20260812T1215000000000Z"
...
PROMPT_BYTES = 5_482
PROMPT_SHA256 = "a65b978047b194215faba330deafa8a0226622294f7023db05186d2e4b55b243"
FINALIZER_BYTES = 17_866
FINALIZER_SHA256 = "579c311117ce2c274208191865a2e82ccece062f9af2d7ec1972de0a8c5e99a0"
...
def require_authority(path: Path, size: int, digest: str) -> None:
    if not path.is_file() or path.stat().st_size != size or sha256(path) != digest:
        raise RuntimeError(f"Frozen quay ladder authority changed: {path}")


def load_base():
    spec = importlib.util.spec_from_file_location("skyguard_m02_quay_escape_ladder_production01_base", BASE_SUPERVISOR)
...
def configure(module) -> None:
    ...
    module.EXPECTED_BLEND = module.OUTPUT / "M02_Quay_EscapeLadder_Production01.blend"
    module.EXPECTED_GLB = module.OUTPUT / "exports" / "M02_Quay_EscapeLadder_Production01.glb"
...
def normalize_terminal(module) -> None:
    ...
    value["schema"] = "skyguard.m02-quay-escape-ladder.grok-mcp.production01.terminal.v1"
    value["asset"] = "M02 galvanized quay escape ladder"
