...
ATTEMPT = Path(r"D:\Skyguard52\Production\Attempts\m01-radar-post-grok-mcp-correction01\attempt_20260811T044000000000Z")
OUTPUT = ATTEMPT / "output"
BLEND = OUTPUT / "M01_RadarPost_GrokMCP_Production_R01.blend"
GLB = OUTPUT / "exports" / "M01_RadarPost_GrokMCP_Production_R01.glb"
...
def main():
    ...
    implementation = {
        "schema": "skyguard.m01-radar-post.grok-mcp.production-correction01-implementation.v1",
    ...
    receipt = {
        "schema": "skyguard.m01-radar-post.production-correction01.scene-serialization-receipt.v1",
        "classification": "PASSED_STRUCTURAL_PENDING_VISUAL",
        "blend": str(BLEND),
        "glb": str(GLB),
