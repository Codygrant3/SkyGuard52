...
FINALIZER = PROJECT / r"Scripts\GrokProduction\finalize_m02_harbor_double_bitt_bollard_deterministic_recovery05_scene.py"
ATTEMPT = PROJECT / r"Production\Attempts\m02-harbor-double-bitt-bollard-deterministic-recovery05\attempt_20260811T1320000000000Z"
...
def main() -> int:
    ...
    if "deterministic-recovery05" not in FINALIZER.read_text(encoding="utf-8"):
        raise RuntimeError("Finalizer is not bound to recovery05 output")
    heavy = heavy_running()
    if heavy:
    ...
    terminal = {
        "schema": "skyguard.m02-harbor-double-bitt-bollard.deterministic-recovery05.terminal.v1",
