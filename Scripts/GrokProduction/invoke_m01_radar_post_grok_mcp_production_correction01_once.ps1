...
$sourceBlend = 'D:\Skyguard52\Production\Attempts\m01-radar-post-grok-mcp\attempt_20260811T040000000000Z\output\checkpoint\M01_RadarPost_GrokMCP_Checkpoint_A.blend'
$sourceBlendBytes = 4285820
$sourceBlendHash = '2b1574d9fa60c7abd058e198903d0431e83d18dc2842facdf13063e7d160df47'
$promptPath = 'D:\Skyguard52\Production\Prompts\M01_RADAR_POST_GROK_MCP_PRODUCTION_CORRECTION01.md'
$attemptRoot = 'D:\Skyguard52\Production\Attempts\m01-radar-post-grok-mcp-correction01\attempt_20260811T044000000000Z'
...
$finalizeScript = 'D:\Skyguard52\Scripts\GrokProduction\finalize_m01_radar_post_scene_correction01.py'
$expectedBlend = Join-Path $outputRoot 'M01_RadarPost_GrokMCP_Production_R01.blend'
$expectedGlb = Join-Path $outputRoot 'exports\M01_RadarPost_GrokMCP_Production_R01.glb'
...
try {
    ...
    $grokProcess.Refresh()
    if ($null -eq $grokProcess.ExitCode) {
        throw 'The completed Grok process did not expose a numeric exit code.'
    }
    ...
    if (Test-Path -LiteralPath $attemptRoot) {
        ...
        $terminal = [ordered]@{
            schema = 'skyguard.m01-radar-post.grok-mcp.production-correction01.terminal.v1'
