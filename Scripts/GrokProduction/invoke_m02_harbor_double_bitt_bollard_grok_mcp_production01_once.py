...
PROMPT = PROJECT / r"Production\Prompts\M02_HARBOR_DOUBLE_BITT_BOLLARD_GROK_MCP_PRODUCTION01.md"
FINALIZER = PROJECT / r"Scripts\GrokProduction\finalize_m02_harbor_double_bitt_bollard_production01_scene.py"
ATTEMPT = PROJECT / r"Production\Attempts\m02-harbor-double-bitt-bollard-grok-mcp-production01\attempt_20260811T1245000000000Z"
...
PROMPT_BYTES = 5_342
PROMPT_SHA256 = "3b9724fb984ae9dfab646eee03c687cd90d83868a66a6e9fc6a5ad86a9d4383b"
FINALIZER_BYTES = 17_357
FINALIZER_SHA256 = "7a60023ec34c2c74d01c9ecd65b7bdcbb5b014a2f1aecc4abbd564926fab0be3"
...
def require_authority(path: Path, size: int, digest: str) -> None:
    if not path.is_file() or path.stat().st_size != size or sha256(path) != digest:
        raise RuntimeError(f"Frozen double-bitt bollard authority changed: {path}")


def load_base():
    spec = importlib.util.spec_from_file_location("skyguard_m02_harbor_double_bitt_bollard_production01_base", BASE_SUPERVISOR)
...
def configure(module) -> None:
    ...
    module.EXPECTED_BLEND = module.OUTPUT / "M02_Harbor_DoubleBittBollard_Production01.blend"
    module.EXPECTED_GLB = module.OUTPUT / "exports" / "M02_Harbor_DoubleBittBollard_Production01.glb"
...
def normalize_terminal(module) -> None:
    ...
    value["schema"] = "skyguard.m02-harbor-double-bitt-bollard.grok-mcp.production01.terminal.v1"
    value["asset"] = "M02 harbor double-bitt mooring bollard"
