...
$promptPath = 'D:\Skyguard52\Production\Prompts\M01_RADAR_POST_GROK_MCP_PRODUCTION_CORRECTION02.md'
$attemptRoot = 'D:\Skyguard52\Production\Attempts\m01-radar-post-grok-mcp-correction02\attempt_20260811T045000000000Z'
...
$finalizeScript = 'D:\Skyguard52\Scripts\GrokProduction\finalize_m01_radar_post_scene_correction02.py'
$expectedBlend = Join-Path $outputRoot 'M01_RadarPost_GrokMCP_Production_R02.blend'
$expectedGlb = Join-Path $outputRoot 'exports\M01_RadarPost_GrokMCP_Production_R02.glb'
...
try {
    ...
    if (Test-Path -LiteralPath $attemptRoot) {
        ...
        $terminal = [ordered]@{
            schema = 'skyguard.m01-radar-post.grok-mcp.production-correction02.terminal.v1'
