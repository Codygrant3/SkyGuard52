"""Fresh Recovery01 binding for the frozen promenade-kit Attempt01 supervisor."""
...
replacements = {
    'SOURCE = PROJECT / "Content" / "Skyguard" / "Meshes" / "Source" / "Mission01" / "Coastal_Production_001" / "BLD_M01_COAST_PROD_001_MASTER.blend"':
        'SOURCE = Path(r"D:\\Skyguard52\\Production\\Attempts\\m01-promenade-prop-kit-grok-mcp\\attempt_20260811T061500000000Z\\output\\checkpoint\\M01_Promenade_PropKit_Checkpoint_A.blend")',
    'SOURCE_BYTES = 201985': 'SOURCE_BYTES = 800160',
    'SOURCE_SHA = "4cb6bc2acc06310c4328687d65c808db6adfe5b1c5e49774a81bec60bf4a08cb"':
        'SOURCE_SHA = "3fa0c2df3f492582dafffe3494811194c1314c59d59d60289c861b6a7d150b76"',
    'PROMPT = PROJECT / "Production" / "Prompts" / "M01_PROMENADE_PROP_KIT_GROK_MCP_PRODUCTION_ATTEMPT01.md"':
        'PROMPT = PROJECT / "Production" / "Prompts" / "M01_PROMENADE_PROP_KIT_GROK_MCP_PRODUCTION_RECOVERY01.md"',
    'FINALIZER = PROJECT / "Scripts" / "GrokProduction" / "finalize_m01_promenade_prop_kit_scene.py"':
        'FINALIZER = PROJECT / "Scripts" / "GrokProduction" / "finalize_m01_promenade_prop_kit_scene_recovery01.py"',
    'ATTEMPT = PROJECT / "Production" / "Attempts" / "m01-promenade-prop-kit-grok-mcp" / "attempt_20260811T061500000000Z"':
        'ATTEMPT = PROJECT / "Production" / "Attempts" / "m01-promenade-prop-kit-grok-mcp-recovery01" / "attempt_20260811T063000000000Z"',
    'skyguard.m01-promenade-prop-kit.grok-mcp.production-attempt01.terminal.v1':
        'skyguard.m01-promenade-prop-kit.grok-mcp.production-recovery01.terminal.v1',
}
