...
SOURCE_BYTES = 205_836
SOURCE_SHA = "a9a05718c3359392d3dc0d994b9cafb0b3ac5873f17a904e15a8c4ffe8e7239d"
PROMPT = PROJECT / "Production/Prompts/CORE_REARGUNNER_CHARACTER_GROK_MCP_REFINEMENT01.md"
FINALIZER = PROJECT / "Scripts/GrokProduction/finalize_core_reargunner_character_refinement01_scene.py"
ATTEMPT = PROJECT / "Production/Attempts/core-reargunner-character-grok-mcp-refinement01/attempt_20260811T0805000000000Z"


def load_base():
    spec = importlib.util.spec_from_file_location("skyguard_core_reargunner_character_refinement01_base", BASE_SUPERVISOR)
...
def configure(module) -> None:
    ...
    module.EXPECTED_BLEND = module.OUTPUT / "CORE_RearGunner_Refinement01_GrokMCP.blend"
    module.EXPECTED_GLB = module.OUTPUT / "exports/CORE_RearGunner_Refinement01_GrokMCP.glb"
...
def normalize_terminal(module) -> None:
    ...
    value["schema"] = "skyguard.core-reargunner-character.grok-mcp.refinement01.terminal.v1"
    value["asset"] = "Rear-seat gunner full-character Refinement01"
    value["representation_boundary"] = "Project-provisional seated profile; neutral nonidentifying character; no hands, weapons, cockpit, insignia, or external geometry"
