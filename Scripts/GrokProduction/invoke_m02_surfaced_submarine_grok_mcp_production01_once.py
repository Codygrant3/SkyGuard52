...
PROMPT = PROJECT / r"Production\Prompts\M02_SURFACED_SUBMARINE_GROK_MCP_PRODUCTION01.md"
FINALIZER = PROJECT / r"Scripts\GrokProduction\finalize_m02_surfaced_submarine_production01_scene.py"
ATTEMPT = PROJECT / r"Production\Attempts\m02-surfaced-submarine-grok-mcp-production01\attempt_20260811T1137000000000Z"
...
PROMPT_BYTES = 7_097
PROMPT_SHA256 = "43b4ebd41d16d2d53543a0d075c7daea76d7b7ec51bc1c4ad014a0bb1ded81cc"
FINALIZER_BYTES = 17_008
FINALIZER_SHA256 = "3e25b365d8a52bff68a40b439c60bef6bff00dad5cb010e685fb6d8c92d247d5"
...
def require_authority(path: Path, size: int, digest: str) -> None:
    if not path.is_file() or path.stat().st_size != size or sha256(path) != digest:
        raise RuntimeError(f"Frozen surfaced-submarine authority changed: {path}")


def load_base():
    spec = importlib.util.spec_from_file_location("skyguard_m02_surfaced_submarine_production01_base", BASE_SUPERVISOR)
...
def configure(module) -> None:
    ...
    module.EXPECTED_BLEND = module.OUTPUT / "M02_Harbor_SurfacedSubmarine_Production01.blend"
    module.EXPECTED_GLB = module.OUTPUT / "exports" / "M02_Harbor_SurfacedSubmarine_Production01.glb"
...
def normalize_terminal(module) -> None:
    ...
    value["schema"] = "skyguard.m02-surfaced-submarine.grok-mcp.production01.terminal.v1"
    value["asset"] = "M02 surfaced submarine"
