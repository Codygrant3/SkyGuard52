...
$AttemptRoot = 'D:\Skyguard52\Saved\BuildAttempts\PHASE4_M01_RECOVERY05_ENVIRONMENT_NATIVE_BUILD_RECOVERY03\build_attempt_01'
$TerminalManifest = 'D:\Skyguard52\Saved\Reports\PHASE4_M01_RECOVERY05_ENVIRONMENT_NATIVE_BUILD_RECOVERY03_TERMINAL_SUPERVISOR_MANIFEST.json'
$EmergencyReceipt = 'D:\Skyguard52\Saved\Reports\PHASE4_M01_RECOVERY05_ENVIRONMENT_NATIVE_BUILD_RECOVERY03_EMERGENCY_RECEIPT.jsonl'
$OfflineTestRoot = [System.IO.Path]::Combine(
    [System.IO.Path]::GetTempPath(),
    'Skyguard52_Recovery03_OfflineContractTest'
)
...
function Write-Emergency {
    ...
    try {
        ...
        $record = [ordered]@{
            ...
            gate = 'PHASE4_M01_RECOVERY05_ENVIRONMENT_NATIVE_BUILD_RECOVERY03'
            stage = $Stage
            message = $Message
        }
        $encoding = New-Object System.Text.UTF8Encoding($false)
...
try {
    $State = [ordered]@{
        schema = 'skyguard.phase4.m01-recovery05-environment-native-build-recovery03-terminal.v1'
    ...
    foreach ($excluded in @(
        'D:\SG52M01R03\Plugins\SkyguardRecovery03NativeRecovery01',
        'D:\SG52M01R03\Plugins\SkyguardRecovery03NativeRecovery04'
    )) {
    ...
    $viewSource = 'D:\SG52M01R03\Source\Skyguard52\SkyguardMission01EnvironmentDirector.cpp'
    [void](Assert-File `
        $viewSource `
        15032 `
