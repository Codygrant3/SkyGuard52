...
CLASS_NAME = "FSkyguardMission10IntegrationReadiness"
# Declaration presence only. Do not invent
# INDEX_NONE or lock WaveCount
# construction in the .cpp. This is leftover-safe
# Mission10 IntegrationReadiness WaveCount FIELD
# (int32 = 0). It is NOT leftover
...
# the origin/main `= 0` default, and nearby
...
# struct section of
# FSkyguardMission10IntegrationReadiness only,
...
class Mission10WaveCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 WaveCount field contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_wave_count_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
