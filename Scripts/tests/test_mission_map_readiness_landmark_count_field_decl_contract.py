...
# LandmarkCount FIELD (declaration-only;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe MissionMapReadiness
# LandmarkCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 LandmarkCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover mission-map-
...
# bLandmarksDistinct #1160. LOCK those sibling
# scripts. LOCK in-flight leftover-safe
# MissionMapReadiness RoutePointCount /
# ObjectiveAnchorCount sibling scripts. Do not parse
...
TARGET = "int32 LandmarkCount = 0;"
TARGET_WRONG = "int32 LandmarkCount = 1;"
LOCKED_DECL = TARGET
...
class MissionMapReadinessLandmarkCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("LandmarkCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_landmark_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_landmark_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 LandmarkCount"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("LandmarkCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("LandmarkCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 LandmarkCount"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("LandmarkCount", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission-map-readiness LandmarkCount field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission-map-readiness LandmarkCount contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_landmark_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission_map_readiness_landmark"
                "_count_field_decl_contract.py"
            )
        )
        self.assertIn(
