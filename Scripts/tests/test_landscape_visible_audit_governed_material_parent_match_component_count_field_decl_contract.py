...
# GovernedMaterialParentMatchComponentCount FIELD
...
# THIS IS leftover-safe FSkyguardLandscapeVisibleAudit
# GovernedMaterialParentMatchComponentCount. THIS IS NOT
...
# leftover VisibleAudit bSuccess #1199 /
# LandscapeComponentCount #1200 / VisibleComponentCount
# #1201 / RegisteredComponentCount #1202 /
# RenderStateCreatedComponentCount #1203. LOCK in-flight
# HiddenInGameComponentCount /
# GeneratedMaterialInstanceReadyComponentCount scripts;
# do not edit them. LOCK leftover landscape-visible-
...
# #665 #666 #668-#673, or open drafts #674-#1203.
...
# THIS IS leftover-safe FSkyguardLandscapeVisibleAudit
# GovernedMaterialParentMatchComponentCount FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# int32 GovernedMaterialParentMatchComponentCount = 0; one-line /
...
TARGET = "int32 GovernedMaterialParentMatchComponentCount = 0;"
TARGET_WRONG = "float GovernedMaterialParentMatchComponentCount = 0;"
LOCKED_DECL = TARGET
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*int32\s+GovernedMaterialParentMatchComponentCount\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for int32 GovernedMaterialParentMatchComponentCount is missing from "
...
class LandscapeVisibleAuditGovernedMaterialParentMatchComponentCountFieldDeclContractTests(unittest.TestCase):
    def test_landscape_visible_audit_struct_exists(self) -> None:
        ...
        self.assertIn("GovernedMaterialParentMatchComponentCount", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("GovernedMaterialParentMatchComponentCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_governed_material_parent_match_component_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_governed_material_parent_match_component_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 GovernedMaterialParentMatchComponentCount"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("GovernedMaterialParentMatchComponentCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("GovernedMaterialParentMatchComponentCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 GovernedMaterialParentMatchComponentCount"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("GovernedMaterialParentMatchComponentCount", locked_only)
