...
# Mission04 Integration static GetMissionId
# METHOD on ASkyguardMission04IntegrationDirector.
# Distinct from leftover Mission01 GetMissionId
# #620 and leftover Mission03 GetMissionId #647.
# It is NOT leftover environment-readiness defaults
# #6b9d / #b931, NOT leftover Environment
# GetReadiness, NOT leftover Mission01 Integration
# GetReadiness #614, NOT leftover Mission03 Integration
# GetReadiness #637, NOT leftover Mission04
# GetReadiness #658, NOT leftover BindRuntimeActors
# (retired live mount in the locked decl), NOT
# leftover GetAircraft (returns the retired live
# mount), NOT leftover HandleDroneCityImpact, and
...
# lock leftover retired live-mount spawn. Do not
...
# GetReadiness / GetObjectiveRuntime / GetWaveState /
...
# ValidateMissionContract (Mission01 #621 /
# Mission03 #646). Do not lock leftover
# MissionBriefingComponent methods
...
# #614, leftover Mission03 GetReadiness
# #637, leftover Mission04 GetReadiness
# #658, leftover Mission04 GetWaveState #659,
# leftover Mission04 GetObjectiveRuntime #660,
...
# locking the body or the TEXT payload as a
# behavioral test.
# Nearby origin/main
...
# leftover theater-kit #59, leftover #107–#660, plus
...
class Mission04GetMissionIdDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("Convoy", UFUNCTION_INTEGRATION)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_m03_ready = f"\t{M03_GET_READINESS}\n"
        ...
        leftover_mission_id = f"\t{GET_READINESS}\n"
    ...
    def test_get_mission_id_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("EnvironmentReadiness", GET_MISSION_ID)
        self.assertNotIn("MissionMapReadiness", GET_MISSION_ID)
        self.assertNotIn("Mission01IntegrationReadiness", GET_MISSION_ID)
        self.assertNotIn("Mission03IntegrationReadiness", GET_MISSION_ID)
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotIn(leftover_waves, UFUNCTION_INTEGRATION)
    ...
    def test_contract_does_not_lock_get_mission_id_cpp_body(self) -> None:
        ...
        self.assertNotIn("return Other", GET_MISSION_ID)
        self.assertNotIn("return WaveState", GET_MISSION_ID)
        self.assertNotIn("return Readiness", GET_MISSION_ID)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 GetReadiness method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission04 GetMissionId contains "
