...
# INDEX_NONE or lock SearchlightStarboard
# construction in the .cpp. This is leftover-safe
# Mission04 SearchlightStarboard FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps) on
# ASkyguardMission04IntegrationDirector. It is
# NOT leftover Mission04 Root field
# / branch cursor/mission04-root-field-
# decl-contract-c332, NOT leftover Mission04
# SearchlightPort sibling / branch cursor/
# mission04-searchlight-port-field-decl-
# contract-c332, NOT leftover Mission03 Root field
...
# drafts #674-#906 including leftover Mission03
...
LOCKED_DECL = SEARCHLIGHT_STARBOARD_FIELD
...
# an isolated Python SearchlightStarboard
...
class Mission04SearchlightStarboardFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("SearchlightStarboard", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_searchlight_starboard_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_port = f"\t{SEARCHLIGHT_PORT_FIELD}\n"
    ...
    def test_searchlight_starboard_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertIn("SearchlightStarboard", LOCKED_DECL)
        ...
        self.assertNotIn("SearchlightPort", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("SearchlightStarboard;", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 SearchlightStarboard field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 SearchlightStarboard field contains "
    ...
    def test_contract_is_searchlight_starboard_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_searchlight_starboard(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_searchlight_starboard_field"
                "_decl_contract.py"
            )
        )
        leftover_56_64 = (
    ...
    def test_readiness_struct_does_not_satisfy_searchlight_starboard(self) -> None:
        leftover = (
    ...
    def test_searchlight_track_runtime_struct_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
