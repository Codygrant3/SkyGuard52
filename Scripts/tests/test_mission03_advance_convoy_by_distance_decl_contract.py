...
# INDEX_NONE or lock AdvanceConvoyByDistance
# construction in the .cpp. This is leftover-safe
# Mission03 Convoy AdvanceConvoyByDistance on
...
# Integration, not Waves, not Environment, not
...
# AdvanceConvoyByDistance method declaration
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission03IntegrationDirector::AdvanceConvoyByDistance",
    "SkyguardMission03IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission03AdvanceConvoyByDistanceDeclContractTests(unittest.TestCase):
    def test_mission03_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, ADVANCE_CONVOY_BY_DISTANCE),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, ADVANCE_CONVOY_BY_DISTANCE)
        self.assertIn("AdvanceConvoyByDistance", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, ADVANCE_CONVOY_BY_DISTANCE)
    ...
    def test_missing_advance_convoy_by_distance_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission03IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, ADVANCE_CONVOY_BY_DISTANCE)
        self.assertIn("AdvanceConvoyByDistance", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, ADVANCE_CONVOY_BY_DISTANCE)
        self.assertIn("AdvanceConvoyByDistance", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("BlueprintPure", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("Category", ADVANCE_CONVOY_BY_DISTANCE)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, ADVANCE_CONVOY_BY_DISTANCE)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, ADVANCE_CONVOY_BY_DISTANCE)
        self.assertIn("AdvanceConvoyByDistance", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = "\tvoid AdvanceConvoyByDistance(float DistanceCentimeters);\n"
        as_const = "\tbool AdvanceConvoyByDistance(float DistanceCentimeters) const;\n"
        as_int = "\tint32 AdvanceConvoyByDistance(float DistanceCentimeters);\n"
        with_arg = "\tbool AdvanceConvoyByDistance(int32 Amount = 1);\n"
        ...
        leftover_convoy_route_enum = (
            "\tESkyguardConvoyRouteState ConvoyRouteState;\n"
        )
        leftover_no_arg = "\tbool AdvanceConvoyByDistance();\n"
        as_void_name = "\tvoid AdvanceConvoyByDistance(float DistanceCentimeters) const;\n"
        renamed = "\tbool AdvanceConvoy();\n"
        short_name = "\tbool AdvanceConvoyByDistanceCm();\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, ADVANCE_CONVOY_BY_DISTANCE)
            self.assertIn("AdvanceConvoyByDistance", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_advance_convoy_by_distance_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, ADVANCE_CONVOY_BY_DISTANCE),
            ADVANCE_CONVOY_BY_DISTANCE,
        )
        self.assertTrue(has_declaration(section, ADVANCE_CONVOY_BY_DISTANCE))
        self.assertEqual(
            declaration_count(section, ADVANCE_CONVOY_BY_DISTANCE),
            1,
        )
        self.assertTrue(
            ADVANCE_CONVOY_BY_DISTANCE.startswith("bool "),
            ADVANCE_CONVOY_BY_DISTANCE,
        )
        self.assertTrue(
            ADVANCE_CONVOY_BY_DISTANCE.endswith("(float DistanceCentimeters);"),
            ADVANCE_CONVOY_BY_DISTANCE,
        )
        self.assertIn("AdvanceConvoyByDistance", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertIn("DistanceCentimeters", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertIn("float ", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("static ", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn(
            "const USkyguardMissionDefinition* Mission",
            ADVANCE_CONVOY_BY_DISTANCE,
        )
        ...
        self.assertNotIn("EnvironmentReadiness", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("MissionMapReadiness", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("TObjectPtr", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("TSoftObjectPtr", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("INDEX_NONE", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("UFUNCTION", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("{", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("}", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("return ", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn(" const;", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("Root", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("Briefing", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("AudioDirector", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("RadioChatter", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("SortiePresentation", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("CampaignDefinition", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("TSoftObjectPtr<USkyguardMissionDefinition>", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("Readiness;", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("bAutoInitialize", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("bAllowBoundedActorSpawning", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("bAutoLaunchAfterBriefing", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("PathfinderSpawnLocation", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetAircraft", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("BindRuntimeActors", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("HandleDroneCityImpact", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("ConfigureMissionDefinition", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("InitializePlayableMission", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("NotifyProtectedAssetFailed", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("SynchronizeRuntimeState", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("NotifyObjectiveProgress", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("IsCorePlayableReady", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetObjectiveRuntime", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetGunner", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetPathfinder", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetReadiness", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetMissionId", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("ValidateDefinition", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("ConfigureFromMission", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("AdvanceBriefing", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("SetAssetsReady", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("AcknowledgeAndLaunch", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("CanLaunch", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetElapsedSeconds", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetBriefingState", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetMinimumWarmupSeconds", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetBriefingText", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetRadioChatter", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetPresentation", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetMissionTitle", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("AcknowledgeBriefing", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("LaunchSortie", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("HullCollider", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("OpticalTracker", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("WeaponServo", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("CountermeasurePod", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("MinHeightFromOriginCm", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("RadarNode", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("ESkyguardMission02WaveState", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("ESkyguardMission03WaveState", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("NotifyThreatDestroyed", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetWaveState", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetCurrentWaveIndex", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetRemainingThreatsInWave", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("StartNextWave", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("NotifyConvoyDamage", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetConvoyRouteState", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetConvoyRouteAlpha", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetConvoyWorldLocation", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("GetConvoyIntegrity", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("ESkyguardConvoyRouteState", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("ValidateMissionContract", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("HarborIndustrial", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("MaxIntegrity", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("CurrentIntegrity", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("FillAndFinalize", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("FillAndFail", ADVANCE_CONVOY_BY_DISTANCE)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, ADVANCE_CONVOY_BY_DISTANCE)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tbool\n"
            "\tAdvanceConvoyByDistance(float DistanceCentimeters);\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_CONVOY} {ADVANCE_CONVOY_BY_DISTANCE}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{ADVANCE_CONVOY_BY_DISTANCE}\n}}\n"
        self.assertTrue(has_declaration(one_line, ADVANCE_CONVOY_BY_DISTANCE))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, ADVANCE_CONVOY_BY_DISTANCE),
            section,
    ...
    def test_environment_category_does_not_satisfy_convoy(self) -> None:
        ...
        self.assertNotIn(integration, UFUNCTION_CONVOY)
        self.assertNotIn(waves, UFUNCTION_CONVOY)
        self.assertEqual(waves, UFUNCTION_WAVES)

    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        locked_only = f"{ADVANCE_CONVOY_BY_DISTANCE}\n"
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, ADVANCE_CONVOY_BY_DISTANCE)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", ADVANCE_CONVOY_BY_DISTANCE)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_advance_convoy_by_distance_cpp_body(self) -> None:
        locked_only = f"{ADVANCE_CONVOY_BY_DISTANCE}\n"
        self.assertNotIn("{", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("}", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("return ", ADVANCE_CONVOY_BY_DISTANCE)
        ...
        self.assertNotIn("return false", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("return true", ADVANCE_CONVOY_BY_DISTANCE)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{ADVANCE_CONVOY_BY_DISTANCE}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ADVANCE_CONVOY_BY_DISTANCE)
        self.assertIn("AdvanceConvoyByDistance", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertTrue(ADVANCE_CONVOY_BY_DISTANCE.startswith("bool "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, ADVANCE_CONVOY_BY_DISTANCE)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("CurrentIntegrity", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("SkyguardApacheAircraft.h", ADVANCE_CONVOY_BY_DISTANCE)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", ADVANCE_CONVOY_BY_DISTANCE)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{ADVANCE_CONVOY_BY_DISTANCE}\n"
        self.assertEqual(
            require_declaration(locked_only, ADVANCE_CONVOY_BY_DISTANCE),
            ADVANCE_CONVOY_BY_DISTANCE,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, ADVANCE_CONVOY_BY_DISTANCE)
        ...
        self.assertNotIn("GetConvoyRouteState", locked_only)
        self.assertNotIn("GetConvoyRouteAlpha", locked_only)
        self.assertNotIn("GetConvoyWorldLocation", locked_only)
        self.assertNotIn("GetConvoyIntegrity", locked_only)
        self.assertNotIn("ESkyguardConvoyRouteState", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 AdvanceConvoyByDistance method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{ADVANCE_CONVOY_BY_DISTANCE}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, ADVANCE_CONVOY_BY_DISTANCE.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                ADVANCE_CONVOY_BY_DISTANCE.lower(),
                "mission03 AdvanceConvoyByDistance contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, ADVANCE_CONVOY_BY_DISTANCE)

    def test_contract_is_advance_convoy_by_distance_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertNotIn("TArray<FText>& OutErrors", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("static ", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertTrue(
            ADVANCE_CONVOY_BY_DISTANCE.endswith(");"),
            ADVANCE_CONVOY_BY_DISTANCE,
        )
        self.assertTrue(ADVANCE_CONVOY_BY_DISTANCE.endswith(";"))
        self.assertNotIn("EnvironmentReadiness", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertNotIn("MissionMapReadiness", ADVANCE_CONVOY_BY_DISTANCE)
        self.assertIn(UFUNCTION_CONVOY, section)

    def test_sibling_director_fields_do_not_satisfy_advance_convoy_by_distance(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, ADVANCE_CONVOY_BY_DISTANCE)
            )
            self.assertNotEqual(ADVANCE_CONVOY_BY_DISTANCE, leftover)
        self.assertIn(
    ...
    def test_leftover_mission_definition_validate_does_not_satisfy(self) -> None:
        ...
        self.assertNotIn(MISSION_DEFINITION_VALIDATE, ADVANCE_CONVOY_BY_DISTANCE)
        self.assertIn(
            "Scripts/tests/test_mission_definition_validate_definition"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission03_advance_convoy_by_distance"
            "_decl_contract.py"
        )
