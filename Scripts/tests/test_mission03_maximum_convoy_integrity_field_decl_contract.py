...
# INDEX_NONE or lock MaximumConvoyIntegrity
# construction in the .cpp. This is leftover-safe
# Mission03 MaximumConvoyIntegrity FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps, ClampMin="1" one-line or
# split-line, int32 default 100) on
# ASkyguardMission03IntegrationDirector. Note
...
# field #859 / branch cursor/mission02-maximum-
# fuel-terminal-integrity-field-decl-contract-c332,
# NOT leftover Mission10 MaximumProtectedIntegrity,
# NOT leftover Mission03 CampaignSaveUserIndex sibling
# (int32 = 0, ClampMin="0", Category Campaign),
...
# (`int32 MaximumConvoyIntegrity = 100;` with
# ClampMin="1" on the same line);
...
# Do NOT parse FSkyguardMission03IntegrationReadiness.
# Do NOT parse GetConvoyIntegrity() / GetReadiness().
# Category is Skyguard|Mission03, not
# leftover Mission02 Campaign #857, not leftover
# Mission02 MaximumFuelTerminalIntegrity #859, not leftover
# Mission10 MaximumProtectedIntegrity, not leftover
# Mission03 CampaignSaveUserIndex sibling, not leftover
# retired-mount spawn fields, not leftover
...
# drafts #674-#799, leftover Apache
...
UPROPERTY_MISSION03_CLAMP = 'meta=(ClampMin="1")'
...
LOCKED_DECL = MAXIMUM_CONVOY_INTEGRITY_FIELD
...
# an isolated Python MaximumConvoyIntegrity
...
LEFTOVER_GET_CONVOY_INTEGRITY_NOT_LOCKED = (
    "GetConvoyIntegrity",
    GET_CONVOY_INTEGRITY,
...
class Mission03MaximumConvoyIntegrityFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("MaximumConvoyIntegrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_maximum_convoy_integrity_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        macro_only = f"\t{UPROPERTY_MISSION03}\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn(UPROPERTY_MISSION03_CLAMP, section)
        ...
        self.assertNotIn("Skyguard|Mission10|Protection", UPROPERTY_MISSION03)
        ...
        self.assertNotIn("Mission04", UPROPERTY_MISSION03)
        self.assertNotIn("Mission05", UPROPERTY_MISSION03)
        self.assertNotIn("Mission06", UPROPERTY_MISSION03)
        self.assertNotIn("Protection", UPROPERTY_MISSION03)
        self.assertNotIn("Search", UPROPERTY_MISSION03)
        self.assertNotIn("Waves", UPROPERTY_MISSION03)
        self.assertNotIn("Payload", UPROPERTY_MISSION03)
        self.assertNotIn("Targets", UPROPERTY_MISSION03)
        self.assertNotIn("Objectives", UPROPERTY_MISSION03)
        self.assertNotIn("Environment", UPROPERTY_MISSION03)
        self.assertNotIn("Briefing", UPROPERTY_MISSION03)
        self.assertNotIn("Mission10", UPROPERTY_MISSION03)
        self.assertNotIn("Boss", UPROPERTY_MISSION03)
        self.assertNotIn("Destruction", UPROPERTY_MISSION03)
        self.assertNotIn("Apache", UPROPERTY_MISSION03)
        self.assertNotIn("Mission07", UPROPERTY_MISSION03)
        self.assertNotIn("Mission08", UPROPERTY_MISSION03)
        self.assertNotIn("Mission09", UPROPERTY_MISSION03)
        self.assertNotIn("Encounter", UPROPERTY_MISSION03)
        self.assertNotIn("Safety", UPROPERTY_MISSION03)
        self.assertNotIn("Performance", UPROPERTY_MISSION03)
        self.assertNotIn("Hoist", UPROPERTY_MISSION03)
        self.assertNotIn("Rescue", UPROPERTY_MISSION03)
        self.assertNotIn("Evacuation", UPROPERTY_MISSION03)
        self.assertNotIn("Campaign", UPROPERTY_MISSION03)
        self.assertIn("Skyguard|Mission03", UPROPERTY_MISSION03)
        self.assertNotIn("ClampMin", UPROPERTY_MISSION03)
        self.assertNotIn("ClampMin", LOCKED_DECL)
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, UPROPERTY_MISSION03)
    ...
    def test_maximum_convoy_integrity_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 MaximumConvoyIntegrity"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("MaximumConvoyIntegrity", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION03} {LOCKED_DECL}\n"
            "};\n"
        )
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(environment, UPROPERTY_MISSION03)
        self.assertNotEqual(briefing, UPROPERTY_MISSION03)
        self.assertNotIn(environment, UPROPERTY_MISSION03)
        self.assertNotIn(briefing, UPROPERTY_MISSION03)
        leftover_m01 = (
            'UFUNCTION(BlueprintCallable, '
        ...
        self.assertNotEqual(leftover_m01, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m02, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_harbor, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m03, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m04, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m05, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m06, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_waves, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m05_waves, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_integration, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m07_ready, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m08_waves, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m08_hoist, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m08_safety, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m08_protection, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m08_ready, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m09_ready, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m09_waves, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m10_safety, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m09_protection, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m09_performance, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_m09_objectives, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_payload, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_targets, UPROPERTY_MISSION03)
        self.assertNotEqual(leftover_objectives, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m01, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m02, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_harbor, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m03, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m04, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m05, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m06, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m05_waves, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_integration, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m07_ready, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m08_waves, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m08_hoist, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m08_safety, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m08_protection, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m08_ready, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m09_ready, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m09_waves, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m10_safety, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m09_protection, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m09_performance, UPROPERTY_MISSION03)
        self.assertNotIn(leftover_m09_objectives, UPROPERTY_MISSION03)
        self.assertNotIn("Mission01", UPROPERTY_MISSION03)
        self.assertNotIn("Mission02", UPROPERTY_MISSION03)
        self.assertNotIn("Mission04", UPROPERTY_MISSION03)
        self.assertNotIn("Mission05", UPROPERTY_MISSION03)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("MaximumConvoyIntegrity", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 MaximumConvoyIntegrity"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("MaximumConvoyIntegrity", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 MaximumConvoyIntegrity field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission03 MaximumConvoyIntegrity contains "
    ...
    def test_contract_is_maximum_convoy_integrity_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_maximum_convoy_integrity(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tint32 MaximumConvoyIntegrity = 1;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_contract_does_not_relock_leftover_handle_boss_phase_changed(
        ...
        for token in LEFTOVER_HANDLE_BOSS_PHASE_CHANGED_NOT_LOCKED:
            ...
            self.assertNotIn(token, LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", UPROPERTY_MISSION03)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission03_maximum_convoy_integrity_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission03_maximum_convoy_integrity_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission03_campaign_save_user_index_does_not_satisfy(
        self,
    ) -> None:
        leftover = CAMPAIGN_SAVE_USER_INDEX_FIELD
        region = f"\t{leftover}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(region, LOCKED_DECL)
        self.assertIn("MaximumConvoyIntegrity", str(raised.exception))
        ...
        self.assertNotIn('ClampMin="0"', LOCKED_DECL)
        self.assertNotIn("Campaign", UPROPERTY_MISSION03)

    def test_leftover_mission02_maximum_fuel_terminal_integrity_stays_locked(
        self,
    ) -> None:
        leftover = MAXIMUM_FUEL_TERMINAL_INTEGRITY_FIELD
        region = f"\t{leftover}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(region, LOCKED_DECL)
        self.assertIn("MaximumConvoyIntegrity", str(raised.exception))
        ...
        self.assertNotIn(MAXIMUM_FUEL_TERMINAL_INTEGRITY_FIELD, LOCKED_DECL)

    def test_leftover_mission10_maximum_protected_integrity_stays_locked(
        self,
    ) -> None:
        leftover = MAXIMUM_PROTECTED_INTEGRITY_FIELD
        region = f"\t{leftover}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(region, LOCKED_DECL)
        self.assertIn("MaximumConvoyIntegrity", str(raised.exception))
        ...
        self.assertNotIn(MAXIMUM_PROTECTED_INTEGRITY_FIELD, LOCKED_DECL)

    def test_leftover_get_convoy_integrity_and_get_readiness_stay_unlocked(
        self,
    ) -> None:
        for leftover in (GET_CONVOY_INTEGRITY, GET_READINESS):
            region = f"\t{leftover}\n"
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, LOCKED_DECL)
            self.assertIn("MaximumConvoyIntegrity", str(raised.exception))
        ...
        self.assertNotIn("GetConvoyIntegrity", LOCKED_DECL)
        self.assertNotIn("GetReadiness", LOCKED_DECL)
        self.assertIn(
    ...
    def test_contract_does_not_parse_readiness_struct(self) -> None:
        ...
        self.assertIsNone(
            re.search(
                ...
                r"FSkyguardMission03IntegrationReadiness\b",
                header,
            )
        )
        self.assertIn(
