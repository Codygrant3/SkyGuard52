...
# Mission03 IntegrationReadiness bWavesReady
...
# leftover Mission10 bPhaseWavesReady FIELD
# #817 / branch cursor/mission10-
# phase-waves-ready-field-decl-contract-c332,
# NOT leftover Mission02 WaveCount #871 /
# leftover Mission03 WaveCount sibling,
# NOT leftover Mission03 wave-state enum
# #0242 / leftover GetWaveState(),
# NOT leftover Mission03 bMissionDefinitionValid /
# bCampaignDefinitionValid / bMapAssemblyReady /
# leftover bGunnerReady siblings,
...
# not leftover Mission01/02/04-10 readiness structs).
...
# drafts #674-#891 including leftover Mission02
# methods #828-#844, Root #845 through
# CampaignSaveUserIndex #857, leftover Mission02
# fields #861-#874 including leftover bWavesReady
# #865 / breakwater-ready #866, leftover Mission03
# bMissionDefinitionValid / bCampaignDefinitionValid /
# bMapAssemblyReady / leftover bGunnerReady /
# leftover bRoadHunterReady / leftover bObjectivesReady
# siblings, leftover Mission03 WaveCount sibling,
# leftover Mission02 WaveCount #871, leftover Mission10
# bWavesReady / leftover Mission10 bPhaseWavesReady #817,
# leftover Mission03 wave-state enum #0242, leftover
# GetWaveState(), leftover convoy-route-state enum #d34e, leftover Mission02
# RadioLineCount #874, leftover Mission03 director
# fields through Readiness #890 / MaximumConvoyIntegrity
# #889 / MissionDefinition #882, leftover Mission10
# bWavesReady / leftover Mission10
# bPhaseWavesReady #817, leftover Mission10
...
# FSkyguardMission03IntegrationReadiness. This is NOT leftover
# Mission02 bWavesReady #865. This is NOT leftover Mission10
# bWavesReady. This is NOT leftover Mission03
# bMissionDefinitionValid / bCampaignDefinitionValid /
# bMapAssemblyReady / leftover bGunnerReady siblings.
# This is NOT leftover Mission02 WaveCount #871. This is
# NOT leftover Mission03 WaveCount. This is NOT leftover
# Mission10 bWavesReady / leftover Mission10
# bPhaseWavesReady #817. This is NOT leftover Mission03
# wave-state enum #0242. This is NOT leftover GetWaveState().
# This is NOT leftover convoy-route-state enum #d34e.
LOCKED = {
...
class Mission03WavesReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_waves_ready_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("ESkyguardConvoyRouteState", LOCKED_DECL)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 bWavesReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission03 bWavesReady contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_waves_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission09_waves_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_wave_state"
            "_enum_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
