...
# Mission05 Integration InitializePlayableMission
...
# #628, or leftover Mission04 InitializePlayableMission
# #648. Distinct from leftover briefing-widget /
...
# isolated-test drafts #107–#645, leftover Apache
...
# leftover theater-kit #59, leftover #107–#663, plus
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission05IntegrationDirector::InitializePlayableMission",
    "SkyguardMission05IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission05InitializePlayableMissionDeclContractTests(unittest.TestCase):
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardTempestBoss", INITIALIZE_PLAYABLE_MISSION)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 InitializePlayableMission method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission05 InitializePlayableMission contains "
