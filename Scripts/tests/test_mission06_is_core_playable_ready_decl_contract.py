...
# Mission06 Integration IsCorePlayableReady on
# ASkyguardMission06IntegrationDirector. It is
# NOT leftover Mission05 IsCorePlayableReady
# #684, NOT leftover Mission01 / Mission03 /
# Mission04 IsCorePlayableReady, NOT leftover
...
# leftover Mission01 IsCorePlayableReady,
# leftover Mission03 IsCorePlayableReady,
# leftover Mission04 IsCorePlayableReady,
...
# (`bool IsCorePlayableReady() const;`); accept
...
# Category is Skyguard|Mission06|Integration, not
# Mission01 / Mission02 / Mission03 / Mission04 /
# Mission05 / Waves / Payload / Targets /
...
# #684, not leftover Mission05 Protection, not
...
# Mission05 IsCorePlayableReady #684.
...
# IsCorePlayableReady, leftover Mission06 wave-state
...
# IsCorePlayableReady method declaration
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission06IntegrationDirector::IsCorePlayableReady",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission06IsCorePlayableReadyDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("BlueprintPure", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("Category", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("BlueprintCallable", UFUNCTION_INTEGRATION)
        self.assertIn("Skyguard|Mission06|Integration", UFUNCTION_INTEGRATION)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tvoid IsCorePlayableReady() const;\n"
        )
        as_const = (
            "\tbool IsCorePlayableReady();\n"
        )
        with_arg = (
            "\tbool IsCorePlayableReady(int32 Amount) const;\n"
        )
    ...
    def test_is_core_playable_ready_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("ESkyguardAirfieldTarget Target", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("int32 Damage", IS_CORE_PLAYABLE_READY)
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(leftover_m03_waves, UFUNCTION_INTEGRATION)
        self.assertNotEqual(leftover_m04_waves, UFUNCTION_INTEGRATION)
        ...
        self.assertNotEqual(leftover_m05_ready, UFUNCTION_INTEGRATION)
        ...
        self.assertNotIn(leftover_m03_waves, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_m04_waves, UFUNCTION_INTEGRATION)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_is_core_playable_ready"
                "_decl_contract.py"
            )
        )
        self.assertIn(
