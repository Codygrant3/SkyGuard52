...
# Mission05 IntegrationReadiness bSortiePresentationReady
...
# bSortiePresentationReady FIELD #868 / branch cursor/mission02-
# sortie-presentation-ready-field-decl-contract-c332,
# NOT leftover Mission03 bSortiePresentationReady
# FIELD #900 / branch cursor/mission03-
# sortie-presentation-ready-field-decl-contract-c332,
# NOT leftover Mission04 bSortiePresentationReady
# FIELD #938 / branch cursor/mission04-
# sortie-presentation-ready-field-decl-contract-c332,
# NOT leftover Mission10 bSortiePresentationReady
# FIELD #820 / branch cursor/mission10-
# sortie-presentation-ready-field-decl-contract-c332,
# NOT leftover Mission05 director SortiePresentation
# UPROPERTY #951 / branch cursor/mission05-
# sortie-presentation-field-decl-contract-c332,
# NOT leftover sibling Mission05 director field
# drafts Root #947 through TempestSpawnRotation #962
# and readiness-struct drafts
# bMissionDefinitionValid #965 / bCampaignDefinitionValid #963 /
# bMapAssemblyReady #964 / bGunnerReady #967 / bTempestReady #966 /
# bObjectivesReady #968 / bStormRuntimeReady #969 /
# bProtectedTargetsReady #970 / bWavesReady #971,
# NOT leftover Mission02 bWavesReady FIELD #865 /
# branch cursor/mission02-waves-ready-field-decl-contract-c332,
# NOT leftover Mission03 bWavesReady FIELD #899 /
# branch cursor/mission03-waves-ready-field-decl-contract-c332,
# NOT leftover Mission04 bWavesReady FIELD #933 /
# branch cursor/mission04-waves-ready-field-decl-contract-c332,
# NOT leftover Mission10 bPhaseWavesReady FIELD #817 /
# branch cursor/mission10-phase-waves-ready-field-decl-contract-c332,
...
# drafts #674-#967 including leftover Mission02
...
# bObjectivesReady stay leftover-only.
LOCKED = {
...
LEFTOVER_MISSION10_WAVES_READY_NOT_LOCKED = (
    ...
    "test_mission10_phase_waves_ready_field_decl_contract.py",
    "cursor/mission10-phase-waves-ready-field-decl-contract-c332",
    "bPhaseWavesReady",
)
...
LEFTOVER_MISSION05_STORM_RUNTIME_READY_NOT_LOCKED = (
    "test_mission05_storm_runtime_ready_field_decl_contract.py",
    "cursor/mission05-storm-runtime-ready-field-decl-contract-c332",
    "bStormRuntimeReady",
)
...
class Mission05SortiePresentationReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_true = (
            "public:\n"
            f"\t{UPROPERTY_MISSION10}\n"
            f"\t{SORTIE_PRESENTATION_READY_TRUE}\n"
            "};\n"
        )
        wrap_true_one_line = (
            "public:\n"
        ...
        for header in (
            ...
            section = public_section(header)
            self.assertTrue(
                has_declaration(section, SORTIE_PRESENTATION_READY_TRUE),
                section,
            )
            self.assertEqual(
                require_declaration(
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 bSortiePresentationReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 bSortiePresentationReady contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission05_sortie_presentation_ready"
            "_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_sortie_presentation_ready"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_same_name_sortie_presentation_ready_contracts_stay_locked(
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_sortie_presentation_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission02_sortie_presentation_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission03_sortie_presentation_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_sortie_presentation_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission05_sortie_presentation"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission05_storm_runtime_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission05_protected_targets_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission05_waves_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_tempest_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        for leftover in LEFTOVER_MISSION04_SORTIE_PRESENTATION_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
