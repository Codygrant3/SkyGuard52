...
# INDEX_NONE or lock DebrisCenter construction in the
...
# DebrisCenter;`); accept that form and other
...
# ControlLinkage, DebrisNose, DebrisTail,
...
# leftover isolated-test drafts #107–#505
# including leftover
...
# drafts #107–#505, plus PathfinderBoss
# production files. This lane only adds an isolated
# Python DebrisCenter field declaration contract on
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardPathfinderBoss::DebrisCenter",
    "SkyguardPathfinderBoss.cpp",
    "SetExposed",
...
class PathfinderDebrisCenterFieldDeclContractTests(unittest.TestCase):
    def test_pathfinder_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, DEBRIS_CENTER_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, DEBRIS_CENTER_FIELD)
        self.assertIn("DebrisCenter", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(has_declaration(section, DEBRIS_CENTER_FIELD))

    def test_missing_debris_center_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardPathfinderBoss();\n"
            "\tTObjectPtr<USkyguardBossWeakPointComponent> "
            "CommandAntenna;\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, DEBRIS_CENTER_FIELD)
        self.assertIn("DebrisCenter", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, DEBRIS_CENTER_FIELD)
        self.assertIn("DebrisCenter", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertTrue(has_declaration(section, DEBRIS_CENTER_FIELD), section)
        self.assertNotIn("UPROPERTY", DEBRIS_CENTER_FIELD)
        self.assertNotIn("VisibleAnywhere", DEBRIS_CENTER_FIELD)
        self.assertNotIn("BlueprintReadOnly", DEBRIS_CENTER_FIELD)
        self.assertNotIn("Category", DEBRIS_CENTER_FIELD)
        self.assertNotIn("BlueprintPure", UPROPERTY_BOSS)
        self.assertNotIn("BlueprintCallable", UPROPERTY_BOSS)
        self.assertIn("Skyguard|Boss|Destruction", UPROPERTY_BOSS)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, DEBRIS_CENTER_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, DEBRIS_CENTER_FIELD)
        self.assertIn("DebrisCenter", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = "\tUStaticMeshComponent* DebrisCenter;\n"
        as_array = (
            "\tTArray<TObjectPtr<UStaticMeshComponent>> "
            "DebrisCenter;\n"
        )
        scene = "\tTObjectPtr<USceneComponent> DebrisCenter;\n"
        weak_point = (
            "\tTObjectPtr<USkyguardBossWeakPointComponent> "
            "DebrisCenter;\n"
        )
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, DEBRIS_CENTER_FIELD)
            self.assertIn("DebrisCenter", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_debris_center_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, DEBRIS_CENTER_FIELD),
            DEBRIS_CENTER_FIELD,
        )
        self.assertTrue(has_declaration(section, DEBRIS_CENTER_FIELD))
        self.assertEqual(declaration_count(section, DEBRIS_CENTER_FIELD), 1)
        self.assertTrue(
            DEBRIS_CENTER_FIELD.startswith(
                "TObjectPtr<UStaticMeshComponent> "
            ),
            DEBRIS_CENTER_FIELD,
        )
        self.assertTrue(DEBRIS_CENTER_FIELD.endswith(";"), DEBRIS_CENTER_FIELD)
        self.assertIn("DebrisCenter", DEBRIS_CENTER_FIELD)
        self.assertIn(
            "UStaticMeshComponent",
            DEBRIS_CENTER_FIELD,
        )
        self.assertIn("TObjectPtr<", DEBRIS_CENTER_FIELD)
        self.assertNotIn("TArray<", DEBRIS_CENTER_FIELD)
        self.assertNotIn("=", DEBRIS_CENTER_FIELD)
        self.assertNotIn("INDEX_NONE", DEBRIS_CENTER_FIELD)
        self.assertNotIn("UFUNCTION", DEBRIS_CENTER_FIELD)
        self.assertNotIn("{", DEBRIS_CENTER_FIELD)
        self.assertNotIn("}", DEBRIS_CENTER_FIELD)
        self.assertNotIn("return ", DEBRIS_CENTER_FIELD)
        self.assertNotIn("CommandAntenna", DEBRIS_CENTER_FIELD)
        self.assertNotIn("NoseCamera", DEBRIS_CENTER_FIELD)
        self.assertNotIn("ControlLinkage", DEBRIS_CENTER_FIELD)
        self.assertNotIn("DebrisNose", DEBRIS_CENTER_FIELD)
        self.assertNotIn("Engine", DEBRIS_CENTER_FIELD)
        self.assertNotIn("DebrisTail", DEBRIS_CENTER_FIELD)
        self.assertNotIn("DebrisSpine", DEBRIS_CENTER_FIELD)
        self.assertNotIn("EncounterController", DEBRIS_CENTER_FIELD)
        self.assertNotIn("AdvanceEncounter", DEBRIS_CENTER_FIELD)
        self.assertNotIn("ResetEncounterState", DEBRIS_CENTER_FIELD)
        self.assertNotIn("IsRouteStateSafe", DEBRIS_CENTER_FIELD)
        self.assertNotIn("GetRouteProgress", DEBRIS_CENTER_FIELD)
        self.assertNotIn("GetEffectiveSpeedMultiplier", DEBRIS_CENTER_FIELD)
        self.assertNotIn("IsAttackTelegraphActive", DEBRIS_CENTER_FIELD)
        self.assertNotIn("GetTelegraphsTriggered", DEBRIS_CENTER_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", DEBRIS_CENTER_FIELD)
        self.assertNotIn("BeginTerminalStrikeCycle", DEBRIS_CENTER_FIELD)
        self.assertNotIn("OpenGuidanceArrayExposure", DEBRIS_CENTER_FIELD)
        self.assertNotIn("IssueClimbCommand", DEBRIS_CENTER_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", DEBRIS_CENTER_FIELD)
        self.assertNotIn("GetGunnerMount", DEBRIS_CENTER_FIELD)
        self.assertNotIn("FaceWorldLocation", DEBRIS_CENTER_FIELD)
        self.assertNotIn("PortGuidanceArray", DEBRIS_CENTER_FIELD)
        self.assertNotIn("CommandCore", DEBRIS_CENTER_FIELD)
        self.assertNotIn("PortEngine", DEBRIS_CENTER_FIELD)
        self.assertNotIn("StarboardEngine", DEBRIS_CENTER_FIELD)
        self.assertNotIn("SetSearchlightTracked", DEBRIS_CENTER_FIELD)
        self.assertNotIn("SetContactIdentified", DEBRIS_CENTER_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", DEBRIS_CENTER_FIELD)
        self.assertNotIn("SetLightningExposed", DEBRIS_CENTER_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", DEBRIS_CENTER_FIELD)
        self.assertNotIn("HullCollider", DEBRIS_CENTER_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, DEBRIS_CENTER_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_BOSS} {DEBRIS_CENTER_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(declaration_count(section, DEBRIS_CENTER_FIELD), 1)
        one_line = f"{{\npublic:\n\t{DEBRIS_CENTER_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, DEBRIS_CENTER_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, DEBRIS_CENTER_FIELD), section)
        self.assertEqual(
            require_declaration(section, DEBRIS_CENTER_FIELD),
    ...
    def test_assigned_debris_center_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<UStaticMeshComponent> "
            "DebrisCenter = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, DEBRIS_CENTER_FIELD)
        self.assertIn("DebrisCenter", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, DEBRIS_CENTER_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        ...
        for region in (
            ...
            self.assertIn("DebrisCenter", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, DEBRIS_CENTER_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{DEBRIS_CENTER_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, DEBRIS_CENTER_FIELD)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            DEBRIS_CENTER_FIELD.startswith("UFUNCTION"),
            DEBRIS_CENTER_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, DEBRIS_CENTER_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", DEBRIS_CENTER_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_debris_center_cpp_body(self) -> None:
        locked_only = f"{DEBRIS_CENTER_FIELD}\n"
        self.assertNotIn("{", DEBRIS_CENTER_FIELD)
        self.assertNotIn("}", DEBRIS_CENTER_FIELD)
        self.assertNotIn("return ", DEBRIS_CENTER_FIELD)
        self.assertNotIn("ASkyguardPathfinderBoss::DebrisCenter", DEBRIS_CENTER_FIELD)
        self.assertNotIn("SkyguardPathfinderBoss.cpp", DEBRIS_CENTER_FIELD)
        self.assertNotIn("SkyguardPathfinderBoss.cpp", locked_only)
        self.assertNotIn("return false", DEBRIS_CENTER_FIELD)
        self.assertNotIn("return true", DEBRIS_CENTER_FIELD)
        self.assertNotIn("CreateDefaultSubobject", DEBRIS_CENTER_FIELD)
        self.assertNotIn("SetExposed", DEBRIS_CENTER_FIELD)
        self.assertNotIn("RefreshAuthoredWeakPointRegistry", DEBRIS_CENTER_FIELD)
        self.assertNotIn("SetBossPhase", DEBRIS_CENTER_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_sibling_pathfinder_fields(self) -> None:
        ...
        for token in PATHFINDER_SIBLING_FIELDS_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("CommandAntenna", DEBRIS_CENTER_FIELD)
        self.assertNotIn("NoseCamera", DEBRIS_CENTER_FIELD)
        self.assertNotIn("ControlLinkage", DEBRIS_CENTER_FIELD)
        self.assertNotIn("DebrisNose", DEBRIS_CENTER_FIELD)
        ...
        self.assertNotIn("DebrisSpine", DEBRIS_CENTER_FIELD)
        self.assertNotIn("EncounterController", DEBRIS_CENTER_FIELD)
        self.assertIn("UStaticMeshComponent", DEBRIS_CENTER_FIELD)
        self.assertIn("DebrisCenter", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_divert_wreck_from_civilians_sibling(
        ...
        for token in DIVERT_WRECK_FROM_CIVILIANS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("DivertWreckFromCivilians", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_set_civilian_separation_meters_sibling(
        ...
        for token in SET_CIVILIAN_SEPARATION_METERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("SetCivilianSeparationMeters", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_get_civilian_separation_meters_sibling(
        ...
        for token in GET_CIVILIAN_SEPARATION_METERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("GetCivilianSeparationMeters", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_getters(self) -> None:
        ...
        for token in GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("GetFinaleStage", DEBRIS_CENTER_FIELD)
        self.assertNotIn("IssueClimbCommand", DEBRIS_CENTER_FIELD)
        self.assertNotIn("IsWreckDiverted", DEBRIS_CENTER_FIELD)
        self.assertNotIn("GetObjectiveMilestonesReached", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_finale_stage(self) -> None:
        ...
        for token in GET_FINALE_STAGE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("GetFinaleStage", DEBRIS_CENTER_FIELD)
        self.assertNotIn("ESkyguardLastFlightStage", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_is_climb_command_issued_sibling(
        ...
        for token in IS_CLIMB_COMMAND_ISSUED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("IsClimbCommandIssued", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_open_first_window(), DEBRIS_CENTER_FIELD)
        self.assertNotIn(leftover_open_final_window(), locked_only)
        self.assertNotIn(leftover_open_final_window(), DEBRIS_CENTER_FIELD)
        self.assertNotIn(leftover_arm_command_core_path(), locked_only)
        self.assertNotIn(leftover_arm_command_core_path(), DEBRIS_CENTER_FIELD)
        self.assertNotIn(leftover_apply_strike(), locked_only)
        self.assertNotIn(leftover_apply_strike(), DEBRIS_CENTER_FIELD)
        self.assertNotIn(leftover_is_lock_eligible(), locked_only)
        self.assertNotIn(leftover_is_lock_eligible(), DEBRIS_CENTER_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, locked_only)
            self.assertNotIn(name, DEBRIS_CENTER_FIELD)
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_debris_getters(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("GetDefeatDebrisPieceCount", DEBRIS_CENTER_FIELD)
        self.assertNotIn("GetMaxDefeatDebrisPieces", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_starboard_guidance_array(
        ...
        for token in LEFTOVER_STARBOARD_GUIDANCE_ARRAY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("StarboardGuidanceArray", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_port_strike_bay_mechanism(
        ...
        for token in LEFTOVER_PORT_STRIKE_BAY_MECHANISM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("PortStrikeBayMechanism", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_starboard_strike_bay_mechanism(
        ...
        for token in LEFTOVER_STARBOARD_STRIKE_BAY_MECHANISM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("StarboardStrikeBayMechanism", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_port_cooling_system(self) -> None:
        ...
        for token in LEFTOVER_PORT_COOLING_SYSTEM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("PortCoolingSystem", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_starboard_cooling_system(
        ...
        for token in LEFTOVER_STARBOARD_COOLING_SYSTEM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("StarboardCoolingSystem", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_jammer(self) -> None:
        ...
        for token in LEFTOVER_JAMMER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("Jammer", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_last_flight_debris_fields(
        ...
        for token in LEFTOVER_LAST_FLIGHT_DEBRIS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("DebrisArmorPort", DEBRIS_CENTER_FIELD)
        self.assertNotIn("DebrisArmorStarboard", DEBRIS_CENTER_FIELD)
        self.assertNotIn("DebrisStrikeBayPort", DEBRIS_CENTER_FIELD)
        self.assertNotIn("DebrisStrikeBayStarboard", DEBRIS_CENTER_FIELD)
        self.assertNotIn("DebrisEnginePort", DEBRIS_CENTER_FIELD)
        self.assertNotIn("DebrisEngineStarboard", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("SetSearchlightTracked", DEBRIS_CENTER_FIELD)
        self.assertNotIn("ASkyguardBlackKiteBoss", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("SetContactIdentified", DEBRIS_CENTER_FIELD)
        self.assertNotIn("OpenOrbitExposure", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", DEBRIS_CENTER_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("SetLightningExposed", DEBRIS_CENTER_FIELD)
        self.assertNotIn("ASkyguardTempestBoss", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_iron_rain(self) -> None:
        ...
        for token in LEFTOVER_IRON_RAIN_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", DEBRIS_CENTER_FIELD)
        self.assertNotIn("ASkyguardIronRainBoss", DEBRIS_CENTER_FIELD)
        self.assertNotIn(
            "ASkyguardIronRainBoss::IssueClimbCommand",
            DEBRIS_CENTER_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        for token in LEFTOVER_PATROL_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("ASkyguardPatrolShip", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        ...
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            ...
            self.assertNotIn(neighbor, DEBRIS_CENTER_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("ASkyguardGunner", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("SkyguardRadarNode", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(self) -> None:
        ...
        self.assertNotIn("USkyguardDebriefWidget", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            ...
            self.assertNotIn(token, DEBRIS_CENTER_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", DEBRIS_CENTER_FIELD)
        self.assertNotIn("MaxIntegrity", DEBRIS_CENTER_FIELD)
        self.assertNotIn("CurrentIntegrity", DEBRIS_CENTER_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_open_leftover_weak_point_component_header(
        ...
        self.assertNotIn(leftover_header, DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, DEBRIS_CENTER_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", DEBRIS_CENTER_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{DEBRIS_CENTER_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, DEBRIS_CENTER_FIELD),
            DEBRIS_CENTER_FIELD,
        )
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(self) -> None:
        ...
        self.assertNotIn("ASkyguardPathfinderBoss::DebrisCenter", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "pathfinder DebrisCenter field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{DEBRIS_CENTER_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, DEBRIS_CENTER_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                DEBRIS_CENTER_FIELD.lower(),
                "pathfinder DebrisCenter contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, DEBRIS_CENTER_FIELD)

    def test_contract_is_debris_center_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertIn("UStaticMeshComponent", DEBRIS_CENTER_FIELD)
        self.assertTrue(DEBRIS_CENTER_FIELD.endswith(";"))
        self.assertNotIn("=", DEBRIS_CENTER_FIELD)
        self.assertIn(UPROPERTY_BOSS, section)
