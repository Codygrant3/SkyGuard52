...
# INDEX_NONE or lock DebrisStarboardPanel construction in the
...
# DebrisPortPanel, DebrisIntakePanel,
...
# leftover isolated-test drafts #107–#514
# including leftover
...
FIELD_NAME = "DebrisStarboardPanel"
...
# drafts #107–#514, plus TempestBoss
# production files. This lane only adds an isolated
# Python DebrisStarboardPanel field declaration contract on
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardTempestBoss::DebrisStarboardPanel",
    "SkyguardTempestBoss.cpp",
    "SetExposed",
...
class TempestDebrisStarboardPanelFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(has_declaration(section, DEBRIS_STARBOARD_PANEL_FIELD))
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = "\tUSkyguardBossWeakPointComponent* DebrisStarboardPanel;\n"
        as_array = (
            "\tTArray<TObjectPtr<USkyguardBossWeakPointComponent>> "
            "DebrisStarboardPanel;\n"
        )
        scene = "\tTObjectPtr<USceneComponent> DebrisStarboardPanel;\n"
        static_mesh = (
            "\tTObjectPtr<USkyguardBossWeakPointComponent> "
            "DebrisStarboardPanel;\n"
        )
    ...
    def test_debris_starboard_panel_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("CommandCore", DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("PortEngine", DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("StarboardEngine", DEBRIS_STARBOARD_PANEL_FIELD)
    ...
    def test_contract_does_not_lock_debris_starboard_panel_cpp_body(self) -> None:
        ...
        self.assertNotIn("}", DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("return ", DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("ASkyguardTempestBoss::DebrisStarboardPanel", DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("SkyguardTempestBoss.cpp", DEBRIS_STARBOARD_PANEL_FIELD)
        ...
        self.assertNotIn("RefreshAuthoredWeakPointRegistry", DEBRIS_STARBOARD_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_sibling_tempest_fields(self) -> None:
        ...
        self.assertNotIn("DebrisIntakePanel", DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("RequiredLockStabilitySeconds", DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertIn("UStaticMeshComponent", DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertIn("DebrisStarboardPanel", DEBRIS_STARBOARD_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_starboard_guidance_array(
        ...
        for token in LEFTOVER_STARBOARD_GUIDANCE_ARRAY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("StarboardGuidanceArray", DEBRIS_STARBOARD_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_port_strike_bay_mechanism(
        ...
        for token in LEFTOVER_PORT_STRIKE_BAY_MECHANISM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("PortStrikeBayMechanism", DEBRIS_STARBOARD_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_starboard_strike_bay_mechanism(
        ...
        for token in LEFTOVER_STARBOARD_STRIKE_BAY_MECHANISM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("StarboardStrikeBayMechanism", DEBRIS_STARBOARD_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_port_cooling_system(self) -> None:
        ...
        for token in LEFTOVER_PORT_COOLING_SYSTEM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("PortCoolingSystem", DEBRIS_STARBOARD_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_starboard_cooling_system(
        ...
        for token in LEFTOVER_STARBOARD_COOLING_SYSTEM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("StarboardCoolingSystem", DEBRIS_STARBOARD_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_jammer(self) -> None:
        ...
        for token in LEFTOVER_JAMMER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("Jammer", DEBRIS_STARBOARD_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_last_flight_debris_fields(
        ...
        self.assertNotIn("DebrisArmorStarboard", DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("DebrisStrikeBayPort", DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("DebrisStrikeBayStarboard", DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("DebrisEnginePort", DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("DebrisEngineStarboard", DEBRIS_STARBOARD_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_iron_rain(self) -> None:
        ...
        for token in LEFTOVER_IRON_RAIN_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn("ASkyguardIronRainBoss", DEBRIS_STARBOARD_PANEL_FIELD)
        self.assertNotIn(
            "ASkyguardIronRainBoss::IssueClimbCommand",
            DEBRIS_STARBOARD_PANEL_FIELD,
        )
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(self) -> None:
        ...
        self.assertNotIn("ASkyguardTempestBoss::DebrisStarboardPanel", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "tempest DebrisStarboardPanel field contract contains "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "tempest DebrisStarboardPanel contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
