...
# Mission03 Waves getter
# GetCurrentWaveIndex on
...
# GetCurrentWaveIndex Waves getter declaration
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission03IntegrationDirector::GetCurrentWaveIndex",
    "SkyguardMission03IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission03GetCurrentWaveIndexDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = "\tvoid GetCurrentWaveIndex();\n"
        as_const = "\tbool GetCurrentWaveIndex() const;\n"
        as_int = "\tint32 GetCurrentWaveIndex();\n"
        with_arg = "\tbool GetCurrentWaveIndex(int32 Amount = 1);\n"
        ...
        as_void_name = "\tvoid GetCurrentWaveIndex() const;\n"
    ...
    def test_get_current_wave_index_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            GET_CURRENT_WAVE_INDEX.endswith(" const"),
            GET_CURRENT_WAVE_INDEX,
        )
        self.assertIn("GetCurrentWaveIndex", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("static ", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn(
            "const USkyguardMissionDefinition* Mission",
            GET_CURRENT_WAVE_INDEX,
        )
        ...
        self.assertNotIn("EnvironmentReadiness", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("MissionMapReadiness", GET_CURRENT_WAVE_INDEX)
        ...
        self.assertNotIn(" const;", GET_CURRENT_WAVE_INDEX)
        ...
        self.assertNotIn("TSoftObjectPtr<USkyguardMissionDefinition>", GET_CURRENT_WAVE_INDEX)
        ...
        self.assertNotIn("ValidateDefinition", GET_CURRENT_WAVE_INDEX)
        ...
        self.assertNotIn("ESkyguardMission03WaveState", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("NotifyThreatDestroyed", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetWaveState", GET_CURRENT_WAVE_INDEX)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 GetCurrentWaveIndex method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission03 GetCurrentWaveIndex contains "
    ...
    def test_contract_is_get_current_wave_index_declaration_only(
        ...
        self.assertNotIn("TArray<FText>& OutErrors", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("static ", GET_CURRENT_WAVE_INDEX)
        self.assertTrue(
            GET_CURRENT_WAVE_INDEX.endswith(" const"),
            GET_CURRENT_WAVE_INDEX,
        )
        self.assertFalse(GET_CURRENT_WAVE_INDEX.endswith(";"))
        self.assertNotIn("EnvironmentReadiness", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("MissionMapReadiness", GET_CURRENT_WAVE_INDEX)
        self.assertIn(UFUNCTION_WAVES, section)
    ...
    def test_leftover_mission_definition_validate_does_not_satisfy(self) -> None:
        ...
        self.assertNotIn(MISSION_DEFINITION_VALIDATE, GET_CURRENT_WAVE_INDEX)
        self.assertIn(
            "Scripts/tests/test_mission_definition_validate_definition"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
