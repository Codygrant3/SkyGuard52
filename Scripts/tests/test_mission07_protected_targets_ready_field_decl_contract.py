...
STRUCT_NAME = "FSkyguardMission07IntegrationReadiness"
...
# Mission07 IntegrationReadiness bProtectedTargetsReady
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool default false,
# one-line / split-line UPROPERTY wraps) on
# FSkyguardMission07IntegrationReadiness. It is
# leftover-safe Mission07 readiness-struct
# bProtectedTargetsReady FIELD (declaration-only).
# It is NOT leftover Mission06 bProtectedTargetsReady
# FIELD #1002 / branch cursor/mission06-
# protected-targets-ready-field-decl-contract-c332,
# NOT leftover Mission07 GetProtectedTarget
# #723, NOT leftover Mission07 protected-target
# enum #18f2 / leftover Mission07 protected-
# target-runtime-defaults #866c, NOT leftover
# Mission07 director Readiness #1027, NOT leftover
# Mission07 wave-state enum #74d8, NOT leftover
# Mission07 readiness-struct bWavesReady #1034 /
# leftover-safe Mission07 bSearchRuntimeReady /
# leftover-safe Mission07 bBriefingReady siblings
# spawned this wave, NOT leftover Mission06
# bWavesReady FIELD #1003 / branch cursor/mission06-
# waves-ready-field-decl-contract-c332,
# NOT leftover Mission07 readiness-struct
# bRadarGhostReady / bObjectivesReady / bGunnerReady
# #1031 siblings,
...
# NOT leftover Mission02 bWavesReady
# FIELD #865 / branch cursor/mission02-
# waves-ready-field-decl-contract-c332,
# NOT leftover Mission03 bWavesReady
# FIELD #899 / branch cursor/mission03-
# waves-ready-field-decl-contract-c332,
# NOT leftover Mission04 bWavesReady
# FIELD #933 / branch cursor/mission04-
# waves-ready-field-decl-contract-c332,
# NOT leftover Mission05 bWavesReady
# FIELD #971 / branch cursor/mission05-
# waves-ready-field-decl-contract-c332,
# NOT leftover Mission10 bWavesReady
# FIELD #817 / branch cursor/mission10-
# waves-ready-field-decl-contract-c332,
...
# struct section of
# FSkyguardMission07IntegrationReadiness only
# (not ASkyguardMission07IntegrationDirector public
...
# after bMapAssemblyReady and before bGunnerReady on this
# struct). This contract is bProtectedTargetsReady after
# bSearchRuntimeReady. Skip leftover
...
# drafts #674-#1031 including leftover Mission02
...
# the locked FSkyguardMission07IntegrationReadiness
# public section. Do not parse
# ASkyguardMission07IntegrationDirector director-class
# fields. Do not parse FSkyguardAirfieldTargetRuntime.
...
# drafts #674-#1031. Do not reopen leftover
...
LEFTOVER_MISSION05_PROTECTED_TARGET_COUNT_NOT_LOCKED = (
    "test_mission05_protected_target_count_field_decl_contract.py",
    "cursor/mission05-protected-target-count-field-decl-contract-c332",
)
LEFTOVER_MISSION10_PROTECTED_GROUPS_READY_NOT_LOCKED = (
    "test_mission10_protected_groups_ready_field_decl_contract.py",
    "cursor/mission10-protected-groups-ready-field-decl-contract-c332",
)
...
LEFTOVER_MISSION07_SEARCH_RUNTIME_READY_NOT_LOCKED = (
    "test_mission07_search_runtime_ready_field_decl_contract.py",
    "cursor/mission07-search-runtime-ready-field-decl-contract-c332",
)
...
class Mission07ProtectedTargetsReadyFieldDeclContractTests(unittest.TestCase):
    def test_mission07_struct_exists(self) -> None:
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 bProtectedTargetsReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission07 bProtectedTargetsReady contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_protected_targets"
                "_ready_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_same_name_protected_targets_ready_contracts_stay_locked(
        self,
    ) -> None:
        for leftover in LEFTOVER_SAME_NAME_WAVES_READY_NOT_LOCKED:
            self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        self.assertNotIn(
            "Scripts/tests/test_mission07_protected_targets_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_waves_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission02_waves_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission03_waves_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_waves_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        for leftover in LEFTOVER_MISSION04_WAVES_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION05_WAVES_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        ...
        for leftover in LEFTOVER_MISSION06_WAVES_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        ...
        for leftover in LEFTOVER_MISSION05_PROTECTED_TARGETS_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION05_PROTECTED_TARGET_COUNT_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION10_PROTECTED_GROUPS_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION07_SEARCH_RUNTIME_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        ...
        self.assertNotEqual(LOCKED_DECL, OBJECTIVES_READY)
        self.assertNotEqual(LOCKED_DECL, RADAR_GHOST_READY)
        self.assertNotEqual(LOCKED_DECL, WAVES_READY)
        self.assertNotEqual(LOCKED_DECL, SEARCH_RUNTIME_READY)
        self.assertNotEqual(LOCKED_DECL, BRIEFING_READY)
        self.assertNotIn(GUNNER_READY, LOCKED_DECL)
        self.assertNotIn(OBJECTIVES_READY, LOCKED_DECL)
        self.assertNotIn(RADAR_GHOST_READY, LOCKED_DECL)
        self.assertNotIn(WAVES_READY, LOCKED_DECL)
        self.assertNotIn(SEARCH_RUNTIME_READY, LOCKED_DECL)
        self.assertNotIn(BRIEFING_READY, LOCKED_DECL)
        self.assertIn("bObjectivesReady", public_section(origin_main_header()))
        self.assertIn("bWavesReady", public_section(origin_main_header()))
        self.assertIn("bSearchRuntimeReady", public_section(origin_main_header()))
        self.assertNotIn(
            "ASkyguardMission07IntegrationDirector",
            LOCKED_DECL,
        )
        ...
        self.assertNotIn("FSkyguardMission07ProtectedTargetRuntime", section)
        self.assertTrue(has_declaration(section, LOCKED_DECL), section)
