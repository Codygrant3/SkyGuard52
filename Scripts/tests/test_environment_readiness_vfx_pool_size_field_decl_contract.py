...
# #321b. THIS IS NOT leftover environment-vfx-pool-
# fail-closed #0a95. THIS IS NOT leftover
# environment-quality-enum #06c7. THIS IS NOT leftover
# director VFX pool component. THIS IS NOT leftover
# BoundCapabilityCount #1167 / TreeInstanceCount
# #1165. THIS IS NOT leftover in-flight leftover-safe
# ShrubInstanceCount (LOCK that sibling script;
# do not edit it). THIS IS NOT leftover director
# TreeInstances HISM field.
# THIS IS leftover-safe FSkyguardEnvironmentReadiness
# VFXPoolSize FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# int32 VFXPoolSize = 0;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardEnvironmentReadiness
# VFXPoolSize. THIS IS NOT leftover mission-map-
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardEnvironmentReadiness
# VFXPoolSize. THIS IS NOT leftover Mission05
...
# MissionMapReadiness VFXPoolSize
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 VFXPoolSize = 0;
# one-line / split-line UPROPERTY wraps;
...
# VFXPoolSize FIELD (declaration-only). It is
...
TARGET = "int32 VFXPoolSize = 0;"
TARGET_WRONG = "int32 VFXPoolSize = 1;"
LOCKED_DECL = TARGET
...
LEFTOVER_ENVIRONMENT_READINESS_NOT_LOCKED = (
    ...
    "test_environment_vfx_pool_fail_closed.py",
...
class EnvironmentReadinessVfxPoolSizeFieldDeclContractTests(unittest.TestCase):
    def test_environment_readiness_struct_exists(self) -> None:
        ...
        self.assertNotIn("USkyguardEnvironmentVFXPoolComponent", section)
        self.assertNotIn("VFXPool;", section)
        self.assertNotIn('Category="Skyguard|Environment|VFX"', section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("VFXPoolSize", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_vfx_pool_size_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_vfx_pool_size_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 VFXPoolSize"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("VFXPoolSize", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("VFXPoolSize", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 VFXPoolSize"))
    ...
    def test_contract_does_not_relock_leftover_environment_readiness(
        ...
        self.assertIn(
            "Scripts/tests/test_environment_vfx_pool"
            "_fail_closed.py",
            LOCKED_SCRIPTS,
        )
        ...
        self.assertNotIn("USkyguardEnvironmentVFXPoolComponent", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("VFXPoolSize", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_vfx_pool_size(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_environment_readiness_vfx"
                "_pool_size_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_parser_does_not_land_on_anchors_or_director(self) -> None:
        leftovers = (
            ...
            "\tTObjectPtr<USkyguardEnvironmentVFXPoolComponent> "
            "VFXPool;\n"
            "\tUPROPERTY(VisibleAnywhere, BlueprintReadOnly, "
