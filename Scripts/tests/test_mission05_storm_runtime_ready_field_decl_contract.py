...
# INDEX_NONE or lock bStormRuntimeReady
# construction in the .cpp. This is leftover-safe
# Mission05 IntegrationReadiness bStormRuntimeReady
...
# defaults #89c9 / branch cursor/storm-
# runtime-defaults-contract-89c9 (do not lock
# FSkyguardStormRuntime members),
# NOT leftover Mission04 bSearchlightsReady
# FIELD #935 / branch cursor/mission04-
# searchlights-ready-field-decl-contract-c332,
# NOT leftover Mission05 bGunnerReady FIELD #967 /
# branch cursor/mission05-gunner-ready-field-
# decl-contract-c332,
# NOT leftover Mission05 bTempestReady FIELD #966 /
# branch cursor/mission05-tempest-ready-field-
# decl-contract-c332,
# NOT leftover Mission05 bObjectivesReady FIELD #968 /
# branch cursor/mission05-objectives-ready-field-
# decl-contract-c332,
# NOT leftover Mission01/02/03/04/10 same-name
# Readiness drafts,
...
# Mission05 bMapAssemblyReady FIELD / branch
# cursor/mission05-map-assembly-ready-field-
# decl-contract-c332, not leftover Mission05
# bMissionDefinitionValid / bCampaignDefinitionValid
# readiness-struct drafts, not leftover Mission04
# bBlackKiteReady FIELD #931 / branch cursor/
# mission04-black-kite-ready-field-decl-contract-
# c332, not leftover Mission03 bRoadHunterReady
# FIELD #896 / branch cursor/mission03-road-
# hunter-ready-field-decl-contract-c332, not leftover
# Mission02 bBreakwaterReady FIELD #866 / branch
# cursor/mission02-breakwater-ready-field-decl-
# contract-c332, not leftover Mission10 last-
# flight-ready draft cursor/mission10-last-flight-
...
# drafts #674-#968 including leftover Mission02
...
STORM_RUNTIME_READY_FIELD = (
    "bool bStormRuntimeReady = false;"
)
LOCKED_DECL = STORM_RUNTIME_READY_FIELD
...
# an isolated Python bStormRuntimeReady
# field declaration contract on
# FSkyguardMission05IntegrationReadiness.
# SKIP leftover retired-mount runtime-ready forever.
# SKIP leftover storm-runtime-defaults #89c9.
# Sibling Mission05 readiness-struct drafts
# bGunnerReady #967 / bTempestReady #966 /
# bObjectivesReady #968 stay leftover-only.
# Leftover Mission04 bSearchlightsReady #935 stays
# leftover-only.
LOCKED = {
...
STORM_RUNTIME_READY_FIELD_TRUE = (
    "bool bStormRuntimeReady = true;"
)
...
LEFTOVER_MISSION03_ROAD_HUNTER_READY_NOT_LOCKED = (
    "test_mission03_road_hunter_ready_field_decl_contract.py",
    "cursor/mission03-road-hunter-ready-field-decl-contract-c332",
    "bRoadHunterReady",
)
...
LEFTOVER_MISSION10_LAST_FLIGHT_READY_NOT_LOCKED = (
    "test_mission10_last_flight_ready_field_decl_contract.py",
    "cursor/mission10-last-flight-ready-field-decl-contract-c332",
    "bLastFlightReady",
)
...
LEFTOVER_MISSION05_TEMPEST_READY_NOT_LOCKED = (
    "test_mission05_tempest_ready_field_decl_contract.py",
    "cursor/mission05-tempest-ready-field-decl-contract-c332",
    "bTempestReady",
)
...
LEFTOVER_SAME_NAME_BOSS_READY_NOT_LOCKED = (
    "test_mission02_breakwater_ready_field_decl_contract.py",
    "test_mission03_road_hunter_ready_field_decl_contract.py",
    "test_mission04_black_kite_ready_field_decl_contract.py",
    "test_mission10_last_flight_ready_field_decl_contract.py",
...
class Mission05StormRuntimeReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bStormRuntimeReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_storm_runtime_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_storm_runtime_ready_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bStormRuntimeReady"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= false;"), LOCKED_DECL)
        self.assertIn("bStormRuntimeReady", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_true = (
            "public:\n"
            f"\t{UPROPERTY_MISSION10}\n"
            f"\t{STORM_RUNTIME_READY_FIELD_TRUE}\n"
            "};\n"
        )
        wrap_true_one_line = (
            "public:\n"
        ...
        for header in (
            ...
            section = public_section(header)
            self.assertTrue(
                has_declaration(section, STORM_RUNTIME_READY_FIELD_TRUE),
                section,
            )
            self.assertEqual(
                require_declaration(
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bStormRuntimeReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bStormRuntimeReady"))
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        # This Mission05 field default false is not Harbor 40/80.
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bStormRuntimeReady", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 bStormRuntimeReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 bStormRuntimeReady contains "
    ...
    def test_contract_is_storm_runtime_ready_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_storm_runtime_ready(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_storm_runtime_ready"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_same_name_map_assembly_ready_contracts_stay_locked(
        self,
    ) -> None:
        for leftover in LEFTOVER_SAME_NAME_MAP_ASSEMBLY_READY_NOT_LOCKED:
            self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        self.assertNotIn(
            "Scripts/tests/test_mission05_storm_runtime_ready"
            "_field_decl_contract.py",
        ...
        for leftover in LEFTOVER_MISSION04_MAP_ASSEMBLY_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        ...
        for leftover in LEFTOVER_SAME_NAME_BOSS_READY_NOT_LOCKED:
            self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in (
            LEFTOVER_MISSION05_MAP_ASSEMBLY_READY_NOT_LOCKED,
            LEFTOVER_MISSION05_MISSION_DEFINITION_VALID_NOT_LOCKED,
            ...
            for token in leftover:
                if token.endswith(".py"):
                    self.assertIn("Scripts/tests/" + token, LOCKED_SCRIPTS)
                elif token.startswith("cursor/"):
                    continue
                else:
                    self.assertNotIn(token, LOCKED_DECL)
        self.assertNotIn("bMapAssemblyReady", LOCKED_DECL)
        self.assertNotIn("bBlackKiteReady", LOCKED_DECL)
        self.assertNotIn("bRoadHunterReady", LOCKED_DECL)
        self.assertNotIn("bBreakwaterReady", LOCKED_DECL)
        self.assertNotIn("bLastFlightReady", LOCKED_DECL)
        ...
        self.assertNotIn("bTempestReady", LOCKED_DECL)
