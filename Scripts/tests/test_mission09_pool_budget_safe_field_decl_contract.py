...
# bPoolBudgetSafe FIELD (declaration-only;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission09 readiness-struct
# bPoolBudgetSafe. THIS IS NOT leftover Mission09
# director PoolBudget #1099. THIS IS NOT leftover
# Mission09 pool-budget-defaults #4537. THIS IS NOT
# leftover Mission09 pool-runtime-defaults #5426.
# THIS IS NOT leftover Mission08
# FSkyguardMission08IntegrationReadiness
# bPoolBudgetSafe. THIS IS NOT leftover
...
# #1101 / bCampaignRuntimeStarted #1103 /
# bMapAssemblyReady #1104. THIS IS NOT leftover
# Mission09 director MissionDefinition #1092. THIS IS
# NOT leftover Mission09 director Readiness field
# #1100 / leftover Mission09 director Root #1083.
# THIS IS NOT leftover Mission06/05/04/03/02/01/10
# same-name readiness-struct bPoolBudgetSafe drafts.
...
# Do not reopen leftover #664, leftover closed-without-merge #658-#673,
# leftover Mission05 closed-without-merge #665 #666 #668-#673,
# or open drafts #674-#1107.
...
# director Root #1083 through director Readiness #1100 / director PoolBudget #1099.
# LOCK leftover Mission09 readiness-struct
# bMissionDefinitionValid #1101 through
# bObjectivesReady #1107.
# LOCK leftover Mission09 pool-budget-defaults #4537 / leftover
# Mission09 pool-runtime-defaults #5426.
...
# INDEX_NONE or lock bPoolBudgetSafe
# construction in the .cpp. This is leftover-safe
# Mission09 IntegrationReadiness bPoolBudgetSafe
...
# bPoolBudgetSafe FIELD / branch
# cursor/mission08-pool-budget-safe-field-
...
# drafts #674-#1107 including leftover Mission02
...
# drafts #674-#1107. Do not reopen leftover
...
POOL_BUDGET_SAFE_TRUE = (
    "bool bPoolBudgetSafe = true;"
)
LOCKED_DECL = POOL_BUDGET_SAFE
...
# an isolated Python bPoolBudgetSafe
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission08_pool_budget_safe_field_decl_contract.py",
    "Scripts/tests/test_mission01_pool_budget_safe_field_decl_contract.py",
    "Scripts/tests/test_mission04_pool_budget_safe_field_decl_contract.py",
    "Scripts/tests/test_mission05_pool_budget_safe_field_decl_contract.py",
    "Scripts/tests/test_mission06_pool_budget_safe_field_decl_contract.py",
    "Scripts/tests/test_mission10_pool_budget_safe_field_decl_contract.py",
    ...
    "Scripts/tests/test_mission07_pool_budget_safe_field_decl_contract.py",
    ...
    "Scripts/tests/test_mission02_pool_budget_safe_field_decl_contract.py",
    ...
    "Scripts/tests/test_mission03_pool_budget_safe_field_decl_contract.py",
...
LEFTOVER_MISSION08_POOL_BUDGET_SAFE_NOT_LOCKED = (
    "test_mission08_pool_budget_safe_field_decl_contract.py",
    "cursor/mission08-pool-budget-safe-field-decl-contract-c332",
)
...
LEFTOVER_SAME_NAME_POOL_BUDGET_SAFE_NOT_LOCKED = (
    "test_mission01_pool_budget_safe_field_decl_contract.py",
    "test_mission02_pool_budget_safe_field_decl_contract.py",
    "test_mission03_pool_budget_safe_field_decl_contract.py",
    "test_mission04_pool_budget_safe_field_decl_contract.py",
    "test_mission05_pool_budget_safe_field_decl_contract.py",
    "test_mission06_pool_budget_safe_field_decl_contract.py",
    "test_mission07_pool_budget_safe_field_decl_contract.py",
    "test_mission08_pool_budget_safe_field_decl_contract.py",
    "test_mission10_pool_budget_safe_field_decl_contract.py",
)
...
LEFTOVER_MISSION09_DIRECTOR_POOL_BUDGET_NOT_LOCKED = (
    "test_mission09_pool_budget_field_decl_contract.py",
    "cursor/mission09-pool-budget-field-decl-contract-c332",
...
class Mission09PoolBudgetSafeFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bPoolBudgetSafe", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_pool_budget_safe_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_pool_budget_safe_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bPoolBudgetSafe"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bPoolBudgetSafe", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bPoolBudgetSafe", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bPoolBudgetSafe"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bPoolBudgetSafe", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 bPoolBudgetSafe field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 bPoolBudgetSafe contains "
    ...
    def test_contract_is_pool_budget_safe_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_pool_budget_safe(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission09_pool_budget_safe"
            "_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_pool_budget_safe"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
            "Scripts/tests/test_mission08_pool_budget_safe"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_contract_does_not_parse_director_class_or_storm_runtime(
        ...
        for token in LEFTOVER_MISSION08_MAP_ASSEMBLY_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION08_POOL_BUDGET_SAFE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION09_MAP_ASSEMBLY_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_SAME_NAME_POOL_BUDGET_SAFE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION09_OBJECTIVES_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION09_DIRECTOR_POOL_BUDGET_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
