...
# INDEX_NONE or lock AudioDirector construction in the
# .cpp. This is a FIELD contract on
# ASkyguardMission01IntegrationDirector, not leftover
# USkyguardAudioDirectorComponent method / fail-closed
# contracts (already drafted) and not leftover
# briefing-widget getters. Keep AudioDirector
# distinct from sibling director fields Briefing /
...
# AcknowledgeBriefing / LaunchSortie. Do not open
# SkyguardAudioDirectorComponent.h. Stay off leftover
...
# AudioDirector;`); accept that form and other
...
# AudioDirector field declaration contract on
...
# #6b9d / #b931, sibling Briefing / Root field
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission01IntegrationDirector::AudioDirector",
    "SkyguardMission01IntegrationDirector.cpp",
...
class Mission01AudioDirectorFieldDeclContractTests(unittest.TestCase):
    def test_mission01_class_exists(self) -> None:
        ...
        self.assertTrue(has_declaration(section, AUDIO_DIRECTOR_FIELD), section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, AUDIO_DIRECTOR_FIELD)
        self.assertIn("AudioDirector", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(has_declaration(section, AUDIO_DIRECTOR_FIELD))
    ...
    def test_missing_audio_director_declaration_fails_closed(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, AUDIO_DIRECTOR_FIELD)
        self.assertIn("AudioDirector", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, AUDIO_DIRECTOR_FIELD)
        self.assertIn("AudioDirector", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertTrue(has_declaration(section, AUDIO_DIRECTOR_FIELD), section)
        self.assertNotIn("UPROPERTY", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("VisibleAnywhere", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("BlueprintReadOnly", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("Category", AUDIO_DIRECTOR_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, AUDIO_DIRECTOR_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, AUDIO_DIRECTOR_FIELD)
        self.assertIn("AudioDirector", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = "\tUSkyguardAudioDirectorComponent* AudioDirector;\n"
        as_array = (
            "\tTArray<TObjectPtr<USkyguardAudioDirectorComponent>> "
            "AudioDirector;\n"
        )
        scene = "\tTObjectPtr<USceneComponent> AudioDirector;\n"
        briefing = (
            "\tTObjectPtr<USkyguardMissionBriefingComponent> "
            "AudioDirector;\n"
        )
        weak = (
            "\tTWeakObjectPtr<USkyguardAudioDirectorComponent> "
            "AudioDirector;\n"
        )
        assigned = (
            "\tTObjectPtr<USkyguardAudioDirectorComponent> "
        ...
        soft = (
            "\tTSoftObjectPtr<USkyguardAudioDirectorComponent> "
            "AudioDirector;\n"
        )
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, AUDIO_DIRECTOR_FIELD)
            self.assertIn("AudioDirector", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_audio_director_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(has_declaration(section, AUDIO_DIRECTOR_FIELD))
        self.assertEqual(declaration_count(section, AUDIO_DIRECTOR_FIELD), 1)
        self.assertTrue(
            AUDIO_DIRECTOR_FIELD.startswith(
                "TObjectPtr<USkyguardAudioDirectorComponent> "
            ),
            AUDIO_DIRECTOR_FIELD,
        )
        self.assertTrue(AUDIO_DIRECTOR_FIELD.endswith(";"), AUDIO_DIRECTOR_FIELD)
        self.assertIn("AudioDirector", AUDIO_DIRECTOR_FIELD)
        self.assertIn(
            "USkyguardAudioDirectorComponent",
            AUDIO_DIRECTOR_FIELD,
        )
        self.assertIn("TObjectPtr<", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("TArray<", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("TSoftObjectPtr", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("=", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("INDEX_NONE", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("UFUNCTION", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("{", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("}", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("return ", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("Briefing", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("RadioChatter", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("SortiePresentation", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("CampaignDefinition", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("MissionDefinition", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("Readiness", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("PathfinderSpawnLocation", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("GetAircraft", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("ConfigureFromMission", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("AdvanceBriefing", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("SetAssetsReady", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("AcknowledgeAndLaunch", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("CanLaunch", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("GetElapsedSeconds", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("GetBriefingState", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("GetMinimumWarmupSeconds", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("GetBriefingText", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("GetRadioChatter", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("GetPresentation", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("GetMissionTitle", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("AcknowledgeBriefing", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("LaunchSortie", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("HullCollider", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("OpticalTracker", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("WeaponServo", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("CountermeasurePod", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("RadarNode", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("ESkyguardMission02WaveState", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("HarborIndustrial", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("MaxIntegrity", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("CurrentIntegrity", AUDIO_DIRECTOR_FIELD)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, AUDIO_DIRECTOR_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION01} {AUDIO_DIRECTOR_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(declaration_count(section, AUDIO_DIRECTOR_FIELD), 1)
        one_line = f"{{\npublic:\n\t{AUDIO_DIRECTOR_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, AUDIO_DIRECTOR_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, AUDIO_DIRECTOR_FIELD), section)
        self.assertEqual(
            require_declaration(section, AUDIO_DIRECTOR_FIELD),
    ...
    def test_assigned_audio_director_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<USkyguardAudioDirectorComponent> "
            "AudioDirector = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, AUDIO_DIRECTOR_FIELD)
        self.assertIn("AudioDirector", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, AUDIO_DIRECTOR_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("AudioDirector", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, AUDIO_DIRECTOR_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{AUDIO_DIRECTOR_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, AUDIO_DIRECTOR_FIELD)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            AUDIO_DIRECTOR_FIELD.startswith("UFUNCTION"),
            AUDIO_DIRECTOR_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, AUDIO_DIRECTOR_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", AUDIO_DIRECTOR_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_audio_director_cpp_body(self) -> None:
        locked_only = f"{AUDIO_DIRECTOR_FIELD}\n"
        self.assertNotIn("{", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("}", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("return ", AUDIO_DIRECTOR_FIELD)
        ...
        self.assertNotIn("return false", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("return true", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("CreateDefaultSubobject", AUDIO_DIRECTOR_FIELD)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{AUDIO_DIRECTOR_FIELD}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, AUDIO_DIRECTOR_FIELD)
        self.assertIn("AudioDirector", AUDIO_DIRECTOR_FIELD)
        self.assertIn(
            "USkyguardAudioDirectorComponent",
            AUDIO_DIRECTOR_FIELD,
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, AUDIO_DIRECTOR_FIELD)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("CurrentIntegrity", AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", AUDIO_DIRECTOR_FIELD)

    def test_contract_does_not_open_leftover_audio_director_component_header(
        self,
    ) -> None:
        locked_only = f"{AUDIO_DIRECTOR_FIELD}\n"
        file_text = this_file_text()
        leftover_header = "SkyguardAudioDirectorComponent.h"
        self.assertNotIn(leftover_header, locked_only)
        self.assertNotIn(leftover_header, AUDIO_DIRECTOR_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, AUDIO_DIRECTOR_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", AUDIO_DIRECTOR_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{AUDIO_DIRECTOR_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, AUDIO_DIRECTOR_FIELD),
            AUDIO_DIRECTOR_FIELD,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, AUDIO_DIRECTOR_FIELD)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 AudioDirector field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{AUDIO_DIRECTOR_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, AUDIO_DIRECTOR_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                AUDIO_DIRECTOR_FIELD.lower(),
                "mission01 AudioDirector contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live cop" + "y",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, AUDIO_DIRECTOR_FIELD)

    def test_contract_is_audio_director_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertTrue(AUDIO_DIRECTOR_FIELD.endswith(";"))
        self.assertNotIn("=", AUDIO_DIRECTOR_FIELD)
        self.assertIn(UPROPERTY_MISSION01, section)

    def test_sibling_director_fields_do_not_satisfy_audio_director(self) -> None:
        for leftover in (
            ROOT_FIELD,
            BRIEFING_FIELD,
            RADIO_CHATTER_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, AUDIO_DIRECTOR_FIELD))
            self.assertNotEqual(AUDIO_DIRECTOR_FIELD, leftover)
        self.assertIn(
            "Scripts/tests/test_mission01_root_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
