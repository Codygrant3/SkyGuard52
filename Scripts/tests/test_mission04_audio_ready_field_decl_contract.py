...
# THIS file is leftover-safe Mission04
# FSkyguardMission04IntegrationReadiness
# bAudioReady FIELD (declaration-only).
# It is NOT leftover Mission02 bAudioReady
...
# audio-ready-field-decl-contract-c332,
# NOT leftover Mission04 director
# AudioDirector field #911 / branch
# cursor/mission04-audio-director-field-
# decl-contract-c332, NOT leftover
# Mission04 Readiness director field #926,
# NOT leftover GetReadiness(), NOT leftover
# retired-mount runtime-ready struct field
# (skip that leftover struct field
# entirely). Parse the PUBLIC SECTION of
# struct FSkyguardMission04IntegrationReadiness
# only. Do NOT parse
# ASkyguardMission04IntegrationDirector
# public fields. Do not lock leftover
...
# Mission04 IntegrationReadiness bAudioReady
...
class Mission04AudioReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        for header in (
            ...
            section = public_section(header)
            self.assertTrue(
                has_declaration(section, AUDIO_READY_TRUE),
                section,
            )
            self.assertEqual(
                require_declaration(
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 bAudioReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 bAudioReady contains "
