...
# Mission03 Integration getter on
...
# objective-runtime fail-closed #6845, and NOT
...
# leftover campaign-subsystem GetObjectiveRuntime
# #313.
...
# #617, leftover objective-runtime fail-closed
# #6845, leftover Harbor Mission02, sibling
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission03IntegrationDirector::GetObjectiveRuntime",
    "SkyguardMission03IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission03GetObjectiveRuntimeDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 GetObjectiveRuntime method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission03 GetObjectiveRuntime contains "
