...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission07 ProtectedTargetRuntime
# Target. THIS IS NOT leftover Mission07
...
# Mission07 ProtectedTargetRuntime Target
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly ESkyguardMission07ProtectedTarget
# default NavigationStation,
...
# the origin/main NavigationStation default,
...
class Mission07ProtectedTargetRuntimeTargetFieldDeclContractTests(unittest.TestCase):
    ...
    def test_target_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("ESkyguardMission07ProtectedTarget Target"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("NavigationStation;"), LOCKED_DECL)
        ...
        self.assertIn("ESkyguardMission07ProtectedTarget ", LOCKED_DECL)
        self.assertIn("NavigationStation", LOCKED_DECL)
        ...
        self.assertIn("ESkyguardMission07ProtectedTarget", LOCKED_DECL)
        self.assertTrue(
            LOCKED_DECL.startswith("ESkyguardMission07ProtectedTarget "),
            LOCKED_DECL,
        )
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tESkyguardMission07ProtectedTarget\n"
            "\tTarget = ESkyguardMission07ProtectedTarget::NavigationStation;\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
        ...
        wrap_true_default = (
            "public:\n"
            f"\t{UPROPERTY_MISSION10}\n"
            "\tESkyguardMission07ProtectedTarget Target = ESkyguardMission07ProtectedTarget::NavigationStation;\n"
            "};\n"
        )
        header_wrap_type = (
            f"struct {CLASS_NAME}\n{{\n{wrap_type}"
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("Target", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("ESkyguardMission07ProtectedTarget Target"))
    ...
    def test_contract_is_target_field_declaration_only(
        ...
        self.assertTrue(LOCKED_DECL.startswith("ESkyguardMission07ProtectedTarget Target"))
        self.assertIn("Target", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("NavigationStation;"))
