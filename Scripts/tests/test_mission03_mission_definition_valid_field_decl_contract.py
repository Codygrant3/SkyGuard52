...
# Mission03 IntegrationReadiness bMissionDefinitionValid
...
# drafts #674-#890 including leftover Mission02
...
class Mission03MissionDefinitionValidFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission03_mission_definition"
                "_valid_field_decl_contract.py"
            )
        )
        self.assertIn(
