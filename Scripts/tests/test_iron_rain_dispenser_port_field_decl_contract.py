...
# INDEX_NONE or lock DispenserPort construction
...
# DispenserPort;`); accept that form and other
...
# DispenserPort field declaration contract on
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardIronRainBoss::DispenserPort",
    "SkyguardIronRainBoss.cpp",
    "SetExposed",
...
class IronRainDispenserPortFieldDeclContractTests(unittest.TestCase):
    def test_iron_rain_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, DISPENSER_PORT_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, DISPENSER_PORT_FIELD)
        self.assertIn("DispenserPort", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, DISPENSER_PORT_FIELD)
    ...
    def test_missing_dispenser_port_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardIronRainBoss();\n"
            f"\t{DISPENSER_CENTER_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, DISPENSER_PORT_FIELD)
        self.assertIn("DispenserPort", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, DISPENSER_PORT_FIELD)
        self.assertIn("DispenserPort", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UPROPERTY", DISPENSER_PORT_FIELD)
        self.assertNotIn("VisibleAnywhere", DISPENSER_PORT_FIELD)
        self.assertNotIn("BlueprintReadOnly", DISPENSER_PORT_FIELD)
        self.assertNotIn("Category", DISPENSER_PORT_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, DISPENSER_PORT_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, DISPENSER_PORT_FIELD)
        self.assertIn("DispenserPort", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUSkyguardBossWeakPointComponent* DispenserPort;\n"
        )
        as_array = (
        ...
        scene = (
            "\tTObjectPtr<USceneComponent> DispenserPort;\n"
        )
        mesh = (
            "\tTObjectPtr<UStaticMeshComponent> DispenserPort;\n"
        )
        weak = (
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, DISPENSER_PORT_FIELD)
            self.assertIn("DispenserPort", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_dispenser_port_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, DISPENSER_PORT_FIELD),
            DISPENSER_PORT_FIELD,
        )
        self.assertTrue(has_declaration(section, DISPENSER_PORT_FIELD))
        self.assertEqual(declaration_count(section, DISPENSER_PORT_FIELD), 1)
        self.assertTrue(
            DISPENSER_PORT_FIELD.startswith(
                "TObjectPtr<USkyguardBossWeakPointComponent> "
            ),
            DISPENSER_PORT_FIELD,
        )
        self.assertTrue(DISPENSER_PORT_FIELD.endswith(";"), DISPENSER_PORT_FIELD)
        self.assertIn("DispenserPort", DISPENSER_PORT_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            DISPENSER_PORT_FIELD,
        )
        self.assertIn("TObjectPtr<", DISPENSER_PORT_FIELD)
        self.assertNotIn("TArray<", DISPENSER_PORT_FIELD)
        self.assertNotIn("=", DISPENSER_PORT_FIELD)
        self.assertNotIn("INDEX_NONE", DISPENSER_PORT_FIELD)
        self.assertNotIn("UFUNCTION", DISPENSER_PORT_FIELD)
        self.assertNotIn("{", DISPENSER_PORT_FIELD)
        self.assertNotIn("}", DISPENSER_PORT_FIELD)
        self.assertNotIn("return ", DISPENSER_PORT_FIELD)
        self.assertNotIn("CommandAntenna", DISPENSER_PORT_FIELD)
        self.assertNotIn("ControlLinkage", DISPENSER_PORT_FIELD)
        self.assertNotIn("NoseCamera", DISPENSER_PORT_FIELD)
        self.assertNotIn("DebrisCenter", DISPENSER_PORT_FIELD)
        self.assertNotIn("DebrisTail", DISPENSER_PORT_FIELD)
        self.assertNotIn("DebrisNose", DISPENSER_PORT_FIELD)
        self.assertNotIn("DebrisSpine", DISPENSER_PORT_FIELD)
        self.assertNotIn("AdvanceEncounter", DISPENSER_PORT_FIELD)
        self.assertNotIn("ResetEncounterState", DISPENSER_PORT_FIELD)
        self.assertNotIn("IsRouteStateSafe", DISPENSER_PORT_FIELD)
        self.assertNotIn("GetRouteProgress", DISPENSER_PORT_FIELD)
        self.assertNotIn("GetEffectiveSpeedMultiplier", DISPENSER_PORT_FIELD)
        self.assertNotIn("IsAttackTelegraphActive", DISPENSER_PORT_FIELD)
        self.assertNotIn("GetTelegraphsTriggered", DISPENSER_PORT_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", DISPENSER_PORT_FIELD)
        self.assertNotIn("RadarNode", DISPENSER_PORT_FIELD)
        self.assertNotIn("BeginTerminalStrikeCycle", DISPENSER_PORT_FIELD)
        self.assertNotIn("OpenGuidanceArrayExposure", DISPENSER_PORT_FIELD)
        self.assertNotIn("IssueClimbCommand", DISPENSER_PORT_FIELD)
        self.assertNotIn("DivertWreckFromCivilians", DISPENSER_PORT_FIELD)
        self.assertNotIn("SetCivilianSeparationMeters", DISPENSER_PORT_FIELD)
        self.assertNotIn("GetCivilianSeparationMeters", DISPENSER_PORT_FIELD)
        self.assertNotIn("GetFinaleStage", DISPENSER_PORT_FIELD)
        self.assertNotIn("IsClimbCommandIssued", DISPENSER_PORT_FIELD)
        self.assertNotIn("IsWreckDiverted", DISPENSER_PORT_FIELD)
        self.assertNotIn("GetObjectiveMilestonesReached", DISPENSER_PORT_FIELD)
        self.assertNotIn("ESkyguardLastFlightStage", DISPENSER_PORT_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", DISPENSER_PORT_FIELD)
        self.assertNotIn("GetGunnerMount", DISPENSER_PORT_FIELD)
        self.assertNotIn("FaceWorldLocation", DISPENSER_PORT_FIELD)
        self.assertNotIn("PortGuidanceArray", DISPENSER_PORT_FIELD)
        self.assertNotIn("DebrisArmorPort", DISPENSER_PORT_FIELD)
        self.assertNotIn("SetSearchlightTracked", DISPENSER_PORT_FIELD)
        self.assertNotIn("SetContactIdentified", DISPENSER_PORT_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", DISPENSER_PORT_FIELD)
        self.assertNotIn("SetLightningExposed", DISPENSER_PORT_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", DISPENSER_PORT_FIELD)
        self.assertNotIn("HullCollider", DISPENSER_PORT_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, DISPENSER_PORT_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_PORT} {DISPENSER_PORT_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(
                declaration_count(section, DISPENSER_PORT_FIELD),
                1,
            )
        one_line = f"{{\npublic:\n\t{DISPENSER_PORT_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, DISPENSER_PORT_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, DISPENSER_PORT_FIELD),
            section,
    ...
    def test_assigned_dispenser_port_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<USkyguardBossWeakPointComponent> "
            "DispenserPort = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, DISPENSER_PORT_FIELD)
        self.assertIn("DispenserPort", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, DISPENSER_PORT_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("DispenserPort", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, DISPENSER_PORT_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{DISPENSER_PORT_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, DISPENSER_PORT_FIELD)
        ...
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_PORT, section)
        self.assertTrue(has_declaration(section, DISPENSER_PORT_FIELD), section)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            DISPENSER_PORT_FIELD.startswith("UFUNCTION"),
            DISPENSER_PORT_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, DISPENSER_PORT_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", DISPENSER_PORT_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_dispenser_port_cpp_body(self) -> None:
        locked_only = f"{DISPENSER_PORT_FIELD}\n"
        self.assertNotIn("{", DISPENSER_PORT_FIELD)
        self.assertNotIn("}", DISPENSER_PORT_FIELD)
        self.assertNotIn("return ", DISPENSER_PORT_FIELD)
        ...
        self.assertNotIn("SkyguardIronRainBoss.cpp", DISPENSER_PORT_FIELD)
        self.assertNotIn("SkyguardIronRainBoss.cpp", locked_only)
        self.assertNotIn("return false", DISPENSER_PORT_FIELD)
        self.assertNotIn("return true", DISPENSER_PORT_FIELD)
        self.assertNotIn("CreateDefaultSubobject", DISPENSER_PORT_FIELD)
        self.assertNotIn("SetExposed", DISPENSER_PORT_FIELD)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            DISPENSER_PORT_FIELD,
        )
        self.assertNotIn("SetBossPhase", DISPENSER_PORT_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", DISPENSER_PORT_FIELD)

    def test_contract_does_not_relock_sibling_tempest_fields(self) -> None:
        locked_only = f"{DISPENSER_PORT_FIELD}\n"
        for token in SIBLING_TEMPEST_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
        self.assertNotIn("PortDischargeBoom", DISPENSER_PORT_FIELD)
        self.assertNotIn("StarboardDischargeBoom", DISPENSER_PORT_FIELD)
        self.assertNotIn("EngineIntake", DISPENSER_PORT_FIELD)
        self.assertNotIn("DebrisPortPanel", DISPENSER_PORT_FIELD)
        self.assertNotIn("DebrisStarboardPanel", DISPENSER_PORT_FIELD)
        self.assertNotIn("DebrisIntakePanel", DISPENSER_PORT_FIELD)
        self.assertNotIn("RequiredLockStabilitySeconds", DISPENSER_PORT_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            DISPENSER_PORT_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_encounter_controller(
        ...
        for token in LEFTOVER_ENCOUNTER_CONTROLLER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
        self.assertNotIn("EncounterController", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_control_servo(self) -> None:
        ...
        for token in LEFTOVER_CONTROL_SERVO_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
        self.assertNotIn("ControlServo", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_sibling_iron_rain_fields(self) -> None:
        ...
        for token in SIBLING_IRON_RAIN_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
        self.assertNotIn("DispenserCenter", DISPENSER_PORT_FIELD)
        self.assertNotIn("MaxReleasesPerBay", DISPENSER_PORT_FIELD)
        self.assertIn("DispenserPort", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_dispenser_starboard(
        ...
        for token in LEFTOVER_DISPENSER_STARBOARD_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
        self.assertNotIn("DispenserStarboard", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_get_maneuver(self) -> None:
        ...
        for token in LEFTOVER_GET_MANEUVER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
        self.assertNotIn("GetManeuver", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_open_first_window(), DISPENSER_PORT_FIELD)
        self.assertNotIn(leftover_open_final_window(), locked_only)
        self.assertNotIn(leftover_open_final_window(), DISPENSER_PORT_FIELD)
        self.assertNotIn(leftover_arm_command_core_path(), locked_only)
        self.assertNotIn(leftover_arm_command_core_path(), DISPENSER_PORT_FIELD)
        self.assertNotIn(leftover_apply_strike(), locked_only)
        self.assertNotIn(leftover_apply_strike(), DISPENSER_PORT_FIELD)
        self.assertNotIn(leftover_is_lock_eligible(), locked_only)
        self.assertNotIn(leftover_is_lock_eligible(), DISPENSER_PORT_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, locked_only)
            self.assertNotIn(name, DISPENSER_PORT_FIELD)
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_debris_getters(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
        self.assertNotIn("GetDefeatDebrisPieceCount", DISPENSER_PORT_FIELD)
        self.assertNotIn("GetMaxDefeatDebrisPieces", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
        self.assertNotIn("SetSearchlightTracked", DISPENSER_PORT_FIELD)
        self.assertNotIn("ASkyguardBlackKiteBoss", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            ...
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
        self.assertNotIn("SetContactIdentified", DISPENSER_PORT_FIELD)
        self.assertNotIn("OpenOrbitExposure", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_NOT_LOCKED:
            ...
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", DISPENSER_PORT_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest_methods(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
        self.assertNotIn("SetLightningExposed", DISPENSER_PORT_FIELD)
        self.assertNotIn("ApplyCorrectiveBankGust", DISPENSER_PORT_FIELD)
        self.assertNotIn("IsLightningExposed", DISPENSER_PORT_FIELD)
        self.assertNotIn("GetLockStabilitySeconds", DISPENSER_PORT_FIELD)
        self.assertNotIn(leftover_advance_stabilized_lock(), DISPENSER_PORT_FIELD)
        self.assertNotIn(leftover_arm_break_finish(), DISPENSER_PORT_FIELD)
        self.assertNotIn(leftover_is_break_finish_armed(), DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        for token in LEFTOVER_PATROL_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
        self.assertNotIn("ASkyguardPatrolShip", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        ...
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            ...
            self.assertNotIn(neighbor, DISPENSER_PORT_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
        self.assertNotIn("ASkyguardGunner", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
        self.assertNotIn("SkyguardRadarNode", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            ...
            self.assertNotIn(token, DISPENSER_PORT_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", DISPENSER_PORT_FIELD)
        self.assertNotIn("MaxIntegrity", DISPENSER_PORT_FIELD)
        self.assertNotIn("CurrentIntegrity", DISPENSER_PORT_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", DISPENSER_PORT_FIELD)
        self.assertNotIn(
            "SkyguardPathfinderEncounterController.h",
            DISPENSER_PORT_FIELD,
        )
    ...
    def test_contract_does_not_open_leftover_weak_point_component_header(
        ...
        self.assertNotIn(leftover_header, DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, DISPENSER_PORT_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", DISPENSER_PORT_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{DISPENSER_PORT_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, DISPENSER_PORT_FIELD),
            DISPENSER_PORT_FIELD,
        )
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardIronRainBoss::DispenserPort", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "iron rain DispenserPort field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{DISPENSER_PORT_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, DISPENSER_PORT_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                DISPENSER_PORT_FIELD.lower(),
                "iron rain DispenserPort contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, DISPENSER_PORT_FIELD)

    def test_contract_is_dispenser_port_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertTrue(DISPENSER_PORT_FIELD.endswith(";"))
        self.assertNotIn("=", DISPENSER_PORT_FIELD)
        self.assertIn(UPROPERTY_PORT, section)
