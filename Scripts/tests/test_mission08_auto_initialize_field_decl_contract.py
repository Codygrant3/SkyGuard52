...
# THIS IS leftover-safe Mission08 bAutoInitialize FIELD
...
# / branch cursor/mission07-auto-initialize-field-
# decl-contract-c332. THIS IS NOT leftover Mission06
# bAutoInitialize field #986 / branch cursor/
# mission06-auto-initialize-field-decl-contract-
# c332. THIS IS NOT leftover Mission10 bAutoInitialize
# field #800 / branch cursor/mission10-auto-
# initialize-field-decl-contract-c332. THIS IS NOT
# leftover Mission05 bAutoInitialize field #954 /
# branch cursor/mission05-auto-initialize-field-
# decl-contract-c332. THIS IS NOT leftover Mission08
# InitializePlayableMission #729 / branch cursor/
# mission08-initialize-playable-mission-decl-
# contract-c332.
...
# bAutoInitialize director-field drafts.
...
# Mission08 bAutoInitialize FIELD
...
class Mission08AutoInitializeFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 bAutoInitialize field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 bAutoInitialize field contains "
