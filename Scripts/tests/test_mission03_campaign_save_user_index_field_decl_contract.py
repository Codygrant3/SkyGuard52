...
# Mission03 CampaignSaveUserIndex FIELD
...
# Category is Skyguard|Mission03|Campaign, not
# leftover Mission02 Campaign #857, not
...
UPROPERTY_MISSION03_CLAMP = 'meta=(ClampMin="0")'
...
class Mission03CampaignSaveUserIndexFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn('Category="Skyguard|Mission03|Campaign"', section)
        ...
        self.assertIn("Campaign", UPROPERTY_MISSION03)
        self.assertIn("Skyguard|Mission03|Campaign", UPROPERTY_MISSION03)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 CampaignSaveUserIndex field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission03 CampaignSaveUserIndex contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission03_campaign_save_user_index_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission03_campaign_save_user_index_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
