...
# Mission10 SortiePresentation
# FIELD (declaration-only, split-line) on
# ASkyguardMission10IntegrationDirector. It is
# NOT leftover Mission01 SortiePresentation field #575 /
...
# Category is Skyguard|Mission10, not Evacuation, not
...
# drafts #674–#795, leftover Apache
...
class Mission10SortiePresentationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_sortie_presentation"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
