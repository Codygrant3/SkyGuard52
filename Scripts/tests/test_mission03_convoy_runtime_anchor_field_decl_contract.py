...
# INDEX_NONE or lock ConvoyRuntimeAnchor
# construction in the .cpp. This is leftover-safe
# Mission03 ConvoyRuntimeAnchor FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps) on
# ASkyguardMission03IntegrationDirector. It is
# NOT leftover Mission10 Root field
# #786 / leftover Mission02 Root field
# #845 / leftover Mission03 Root sibling /
# leftover Mission10 HighwayConvoyAnchor
# #787 / leftover convoy-route-state enum
# #d34e / leftover Mission03 GetConvoyRouteState
# / GetConvoyRouteAlpha / GetConvoyWorldLocation
# / GetConvoyIntegrity / AdvanceConvoyByDistance
# / NotifyConvoyDamage method contracts /
# leftover Mission03 wave-state enum #0242.
# Lock the UPROPERTY + TObjectPtr line, not the
# comment text above ConvoyRuntimeAnchor.
...
# bAutoLaunchAfterBriefing / Root sibling
# director fields. Not leftover HighwayConvoyAnchor.
...
# Root #574, not leftover Mission10 Root #786,
...
LOCKED_DECL = CONVOY_RUNTIME_ANCHOR
...
# an isolated Python ConvoyRuntimeAnchor
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission03_get_day_beat_kit_decl_contract.py",
    "Scripts/tests/test_mission03_get_day_beat_kind_decl_contract.py",
    "Scripts/tests/test_mission03_get_day_beat_index_decl_contract.py",
    "Scripts/tests/test_mission03_tick_day_beat_kit_decl_contract.py",
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission03IntegrationDirector::Root",
    "ASkyguardMission10IntegrationDirector::Root",
    "ASkyguardMission10IntegrationDirector::HighwayConvoyAnchor",
    "SkyguardMission10IntegrationDirector.cpp",
...
class Mission03ConvoyRuntimeAnchorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("ConvoyRuntimeAnchor", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_convoy_runtime_anchor_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn('Category="Skyguard|Mission03|Convoy"', section)
        self.assertTrue(
            has_declaration(section, LOCKED_DECL),
            section,
        )
        ...
        self.assertIn("Skyguard|Mission03|Convoy", UPROPERTY_MISSION03)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_anchor = f"\t{ROOT_FIELD}\n"
        leftover_highway = f"\t{HIGHWAY_CONVOY_ANCHOR}\n"
    ...
    def test_convoy_runtime_anchor_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertNotIn("Runtime attachment point", LOCKED_DECL)
        self.assertNotIn("protected convoy visuals", LOCKED_DECL)
        self.assertNotIn("USTRUCT", LOCKED_DECL)
        self.assertNotIn("bConvoyRouteReady", LOCKED_DECL)
        self.assertNotIn("bMissionDefinitionValid", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("ConvoyRuntimeAnchor", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("ConvoyRuntimeAnchor;", locked_only)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("bConvoyRouteReady", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 ConvoyRuntimeAnchor field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission03 ConvoyRuntimeAnchor field contains "
    ...
    def test_contract_is_convoy_runtime_anchor_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_convoy_runtime_anchor(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tTObjectPtr<USceneComponent> ConvoyRuntimeAnchor = nullptr;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission03_convoy_runtime_anchor_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
