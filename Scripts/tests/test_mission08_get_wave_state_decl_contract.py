...
# Boss / Destruction / Briefing / Hoist / Rescue /
...
# drafts #674–#739, leftover Apache
...
# Do not reopen open drafts #674–#739.
...
class Mission08GetWaveStateDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        renamed = (
            "\tESkyguardMission08WaveState GetState() const;\n"
        )
        short_name = "\tESkyguardMission08WaveState GetWave() const;\n"
    ...
    def test_get_wave_state_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            GET_WAVE_STATE.startswith("ESkyguardMission08WaveState "),
            GET_WAVE_STATE,
        )
        self.assertIn("ESkyguardMission08WaveState", GET_WAVE_STATE)
    ...
    def test_contract_does_not_lock_get_wave_state_cpp_body(self) -> None:
        ...
        self.assertNotIn("return ", GET_WAVE_STATE)
        self.assertNotIn(
            "ASkyguardMission08IntegrationDirector::GetWaveState",
            GET_WAVE_STATE,
        )
        self.assertNotIn(
            "SkyguardMission08IntegrationDirector.cpp",
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("GetWaveState", GET_WAVE_STATE)
        self.assertTrue(GET_WAVE_STATE.startswith("ESkyguardMission08WaveState "))
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 GetWaveState method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission08 GetWaveState contains "
