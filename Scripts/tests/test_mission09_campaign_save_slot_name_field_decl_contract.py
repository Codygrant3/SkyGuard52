...
# THIS IS leftover-safe Mission09 CampaignSaveSlotName FIELD
# (declaration-only, one-line / split-line UPROPERTY wraps,
# FString TEXT("Skyguard52Campaign") default) on
# ASkyguardMission09IntegrationDirector.
# THIS IS NOT leftover Mission08 director CampaignSaveSlotName
# (same-name other mission; lock leftover Mission08 director
# Root #1044 through Readiness #1066). THIS IS NOT leftover
# Mission08 CampaignDefinition #1055 / leftover Mission08
# bCampaignDefinitionValid #1068. THIS IS NOT leftover
# Mission07 CampaignSaveSlotName
# / branch cursor/mission07-campaign-save-slot-name-
# field-decl-contract-c332. THIS IS NOT leftover
# Mission06 CampaignSaveSlotName #989 / branch cursor/
# mission06-campaign-save-slot-name-field-decl-contract-
# c332. THIS IS NOT leftover Mission10 CampaignSaveSlotName
# / branch cursor/mission10-campaign-save-slot-name-
# field-decl-contract-c332. THIS IS NOT leftover
# Mission05 CampaignSaveSlotName #957 / branch cursor/
# mission05-campaign-save-slot-name-field-decl-contract-
# c332. THIS IS NOT leftover Mission08 CampaignDefinition
# #1055 / branch cursor/mission08-campaign-definition-
...
# director Root #1044 through Readiness #1066. LOCK leftover
...
# Root #1083 through MissionDefinition #1092. LOCK leftover
# Mission01/02/03/04/05/06/07/08/10
# same-name CampaignSaveSlotName director-field drafts.
...
# INDEX_NONE or lock CampaignSaveSlotName
# construction in the .cpp. This is leftover-safe
# Mission09 CampaignSaveSlotName FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps, FString TEXT default) on
# ASkyguardMission09IntegrationDirector. Note
# EditAnywhere / BlueprintReadWrite / FString =
# TEXT("Skyguard52Campaign"), not VisibleAnywhere /
# BlueprintReadOnly / TSoftObjectPtr. It is
# NOT leftover Mission01 CampaignSaveSlotName field
# #583 / branch cursor/mission01-campaign-save-
# slot-name-field-decl-contract-c332, NOT leftover
# Mission02 CampaignSaveSlotName field #855 /
# branch cursor/mission02-campaign-save-slot-name-
# field-decl-contract-c332, NOT leftover Mission04
# CampaignSaveSlotName field #919 / branch cursor/
# mission04-campaign-save-slot-name-field-decl-
# contract-c332, NOT leftover Mission05
# CampaignSaveSlotName field #957 / branch cursor/
# mission05-campaign-save-slot-name-field-decl-
# contract-c332, NOT leftover Mission06
# CampaignSaveSlotName field #989 / branch cursor/
# mission06-campaign-save-slot-name-field-decl-
# contract-c332, NOT leftover Mission07 Root #1011 /
# Briefing #1012 / AudioDirector #1013 / RadioChatter
# #1016 / SortiePresentation #1014 / CampaignDefinition
# #1015 / MissionDefinition / bAutoInitialize /
# bAllowBoundedActorSpawning / bAutoLaunchAfterBriefing
# sibling field lanes, NOT leftover Mission01
# bAutoInitialize field #580 / leftover Mission02
# bAutoInitialize field #852 / leftover Mission03
# bAutoInitialize field #885 / leftover Mission04
# bAutoInitialize field #915 / leftover Mission05
# bAutoInitialize field #954 / leftover Mission10
# bAutoInitialize field #800, NOT leftover
...
# MissionDefinition in-flight branches, leftover
# Mission06 bAutoInitialize / bAllowBoundedActorSpawning /
# bAutoLaunchAfterBriefing in-flight branches, NOT leftover Mission04 bAudioReady #937 /
...
# bAutoLaunchAfterBriefing / CampaignSaveUserIndex
# sibling director fields.
...
# the `= TEXT("Skyguard52Campaign")` default, and nearby
# split-line UPROPERTY wraps without locking invented
# metadata or a different body.
# Nearby origin/main
...
# leftover FSkyguardHoistWindowRuntime,
# leftover FSkyguardMission08ProtectedTargetRuntime,
...
# Mission04 / Mission05 / Mission06 / leftover Mission07 /
# Mission09, not leftover Mission01
...
# Mission08IntegrationDirector public section. Pathfinder MinHeightFromOriginCm
...
# drafts #674-#1092 including leftover Mission03
...
# MissionDefinition in-flight. Do not reopen open
# drafts #674-#1092.
...
LOCKED_DECL = CAMPAIGN_SAVE_SLOT_NAME_FIELD
...
# an isolated Python CampaignSaveSlotName
...
# ProtectedTargetCount #1082. LOCK leftover Mission09
# Blueprint UFUNCTION methods. LOCK leftover Mission09
# Root #1083 / SkylineAnchor #1084 / MajorBridgeAnchor
# #1085 / Briefing #1086 / AudioDirector #1087 /
# RadioChatter #1088 / SortiePresentation #1089 /
# PowerStationAnchor #1090 / CampaignDefinition #1091 /
# MissionDefinition #1092. THIS IS NOT leftover Mission08
# director CampaignSaveSlotName. THIS IS NOT leftover
# Mission09 Blueprint UFUNCTION methods. THIS IS NOT
# leftover FSkyguardMission09IntegrationReadiness fields.
# Skip leftover BindRuntimeActors / leftover
# HandleDroneCityImpact / leftover GetStormRainBeatKit
# without UFUNCTION / leftover spawn / leftover runtime-
# ready flag forever. Harbor 40/80 fail-closed in
...
class Mission09CampaignSaveSlotNameFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("CampaignSaveSlotName", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_campaign_save_slot_name_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_campaign_save_slot_name_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertIn("CampaignSaveSlotName", LOCKED_DECL)
        self.assertIn('= TEXT("Skyguard52Campaign")', LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_indent = (
            "public:\n"
            "\tFString\n"
            '\t\tCampaignSaveSlotName = TEXT("Skyguard52Campaign");\n'
            "};\n"
        )
        wrap_name = (
            "public:\n"
    ...
    def test_declaration_accepts_origin_main_default_forms(self) -> None:
        ...
        self.assertIn("Skyguard52Campaign", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("CampaignSaveSlotName", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FString "))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("CampaignSaveSlotName", locked_only)
    ...
    def test_harbor_40_80_tokens_fail_closed_if_present(self) -> None:
        ...
        # Harbor forty/eighty fail-closed in Mission02/03/04/
        # 05/06/07 test files (Mission08/09-only).
        ...
        for rel in (
            ...
            self.assertNotIn(forty, sibling_text)
            self.assertNotIn(eighty, sibling_text)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 CampaignSaveSlotName field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 CampaignSaveSlotName field contains "
    ...
    def test_contract_is_campaign_save_slot_name_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_campaign_save_slot_name(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        self.assertNotIn("return true", LOCKED_DECL)
        self.assertIn('= TEXT("Skyguard52Campaign")', LOCKED_DECL)
        self.assertNotIn("OtherCampaignSlot", LOCKED_DECL)
        self.assertNotIn("= false", LOCKED_DECL)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_campaign_save_slot_name"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_mission04_radio_chatter_does_not_satisfy(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission06_campaign_save_slot_name_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission07_campaign_save_slot_name_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_airfield_target_runtime_does_not_satisfy_campaign_save_slot_name(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_does_not_satisfy_campaign_save_slot_name(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_leftover_mission06_campaign_save_slot_name_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_leftover_mission07_campaign_save_slot_name_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_search_track_runtime_does_not_satisfy_campaign_save_slot_name(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_protected_target_runtime_does_not_satisfy_campaign_save_slot_name(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
