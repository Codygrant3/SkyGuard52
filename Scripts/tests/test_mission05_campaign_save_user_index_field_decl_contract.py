...
# int32 default 0) on
# ASkyguardMission05IntegrationDirector. Note
...
# ClampMin on the next line);
# accept that form, other one-line / split-line wraps,
# the `= 0` default, and nearby split-line
...
# Category is Skyguard|Mission05|Campaign, not
# leftover Mission04 Campaign #920, not leftover
# Mission03 Campaign #886, not leftover
# Mission02 Campaign #857, not leftover
# Mission05 CampaignSaveSlotName sibling, not leftover
# Mission05 Root #947 / AudioDirector #948 /
# Briefing #949 / RadioChatter #950 /
# SortiePresentation #951 / CampaignDefinition #952 /
# MissionDefinition #953 / bAutoInitialize #954 /
# bAllowBoundedActorSpawning #955, not
...
# drafts #674-#955 including leftover Mission05
...
class Mission05CampaignSaveUserIndexFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn('Category="Skyguard|Mission05|Campaign"', section)
        ...
        self.assertIn("Campaign", UPROPERTY_MISSION05)
        self.assertIn("Skyguard|Mission05|Campaign", UPROPERTY_MISSION05)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 CampaignSaveUserIndex field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 CampaignSaveUserIndex contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_campaign_save_user_index_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_storm_runtime_struct_does_not_satisfy_campaign_save_user_index(
        self,
    ) -> None:
        leftover = (
