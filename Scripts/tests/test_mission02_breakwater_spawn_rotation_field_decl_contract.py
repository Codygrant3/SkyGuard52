...
# INDEX_NONE or lock BreakwaterSpawnRotation
# construction in the .cpp. This is leftover-safe
# Mission02 BreakwaterSpawnRotation FIELD
# (declaration-only; EditAnywhere /
# BlueprintReadWrite FRotator default
...
# sibling field, NOT leftover LastFlightSpawnLocation
# sibling field #803, NOT leftover retired-mount spawn
...
# or leftover LastFlightSpawnLocation. Do not lock
...
# drafts #674-#805+, leftover Apache
...
LOCKED_DECL = BREAKWATER_SPAWN_ROTATION
...
# an isolated Python BreakwaterSpawnRotation
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission02IntegrationDirector::BreakwaterSpawnRotation",
    "SkyguardMission02IntegrationDirector.cpp",
    "ASkyguardMission10IntegrationDirector::LastFlightSpawnRotation",
    "SkyguardMission10IntegrationDirector.cpp",
...
def standalone_harbor_interval_present(text: str, token: str) -> bool:
    ...
    # Mission08-only values. origin/main Mission02 yaw 1-8-0
...
class Mission02BreakwaterSpawnRotationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("BreakwaterSpawnRotation", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_breakwater_spawn_rotation_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("Skyguard|Mission02|Protection", UPROPERTY_MISSION02)
    ...
    def test_breakwater_spawn_rotation_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FRotator BreakwaterSpawnRotation"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= FRotator(0.f, 180.f, 0.f);"), LOCKED_DECL)
        self.assertNotIn("LastFlightSpawnRotation", LOCKED_DECL)
        self.assertNotIn("BreakwaterSpawnLocation", LOCKED_DECL)
        self.assertNotIn("CampaignSaveSlotName", LOCKED_DECL)
        self.assertIn("BreakwaterSpawnRotation", LOCKED_DECL)
        ...
        self.assertIn("FRotator", LOCKED_DECL)
        self.assertTrue(
            LOCKED_DECL.startswith("FRotator "),
            LOCKED_DECL,
        )
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("BreakwaterSpawnRotation", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FRotator BreakwaterSpawnRotation"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("BreakwaterSpawnRotation", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 BreakwaterSpawnRotation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 BreakwaterSpawnRotation contains "
    ...
    def test_contract_is_root_field_declaration_only(
        ...
        for group in leftover_groups:
            for token in group:
                self.assertNotIn(token, locked_only)
                self.assertNotIn(token, LOCKED_DECL)
        # Short roster Break/Hold/Climb/Descend stay leftover. "Break"
        # is only a prefix of Breakwater, not a locked roster value.
    ...
    def test_sibling_director_fields_do_not_satisfy_breakwater_spawn_rotation(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_breakwater_spawn_rotation_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_breakwater_engine_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_breakwater_elevator_linkage_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_breakwater_decoy_pods_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_breakwater_port_latch_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_breakwater_starboard_latch_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_breakwater_debris_engine_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_breakwater_debris_starboard_panel_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_breakwater_debris_port_panel_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
