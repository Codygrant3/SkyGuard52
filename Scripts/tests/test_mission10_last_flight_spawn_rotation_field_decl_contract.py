...
# INDEX_NONE or lock LastFlightSpawnRotation
# construction in the .cpp. This is leftover-safe
# Mission10 LastFlightSpawnRotation FIELD
...
LOCKED_DECL = LAST_FLIGHT_SPAWN_ROTATION
...
# an isolated Python LastFlightSpawnRotation
...
class Mission10LastFlightSpawnRotationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("LastFlightSpawnRotation", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_last_flight_spawn_rotation_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_last_flight_spawn_rotation_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FRotator LastFlightSpawnRotation"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= FRotator(0.f, 195.f, 0.f);"), LOCKED_DECL)
        self.assertIn("LastFlightSpawnRotation", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("LastFlightSpawnRotation", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FRotator LastFlightSpawnRotation"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("LastFlightSpawnRotation", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 LastFlightSpawnRotation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission10 LastFlightSpawnRotation contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_last_flight_spawn_rotation(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_last_flight_spawn_rotation_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
