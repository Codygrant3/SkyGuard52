...
# Mission10 Integration InitializePlayableMission
...
# drafts #674–#765, leftover Apache
...
class Mission10InitializePlayableMissionDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_initialize_playable_mission"
                "_decl_contract.py"
            )
        )
        self.assertIn(
