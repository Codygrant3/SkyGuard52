...
# Mission02 IntegrationReadiness bWavesReady
...
# a bool readiness FIELD named bWavesReady, NOT a
# leftover Mission02 wave-state enum / leftover
# Mission02 GetWaveState. It is
# NOT leftover Mission10 bPhaseWavesReady FIELD
...
class Mission02WavesReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 bWavesReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 bWavesReady contains "
