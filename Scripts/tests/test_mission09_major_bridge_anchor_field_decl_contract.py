...
# INDEX_NONE or lock MajorBridgeAnchor
# construction in the .cpp. This is leftover-safe
# Mission09 MajorBridgeAnchor FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps) on
# ASkyguardMission09IntegrationDirector. It is
# NOT leftover Mission09 Root FIELD #1083 /
# branch cursor/mission09-root-field-decl-
# contract-c332, NOT leftover Mission01-08/10
# Root, NOT leftover Mission08
# RescueHelicopterAnchor / HoistCableAnchor,
# NOT leftover Mission08 Root field
...
# methods.
# not leftover Mission09 Root #1083 /
# SkylineAnchor / PowerStationAnchor /
# leftover Mission08 RescueHelicopterAnchor /
# HoistCableAnchor / Briefing / AudioDirector /
...
# origin/main is a split-line UPROPERTY then
# one-line field
...
# drafts #674-#1083 including leftover Mission03
# ObjectiveCount #905 / WaveCount #906 / RadioLineCount #904,
# leftover Mission09 Root #1083. Do not lock leftover
# Mission09 Root or leftover Mission08
# RescueHelicopterAnchor / HoistCableAnchor.
...
LOCKED_DECL = MAJOR_BRIDGE_ANCHOR
...
# an isolated Python MajorBridgeAnchor
...
# Mission08 ObjectiveCount #1080 through
# ProtectedTargetCount #1082. Lock leftover
# Mission08 Blueprint UFUNCTION methods #729-#749.
# Lock leftover Mission09 Root #1083. Lock leftover
# Mission09 Blueprint UFUNCTION methods
# InitializePlayableMission through
# ValidateMissionContract.
# This is leftover-safe Mission09 director
# MajorBridgeAnchor. It is NOT leftover Mission09
# Root #1083, NOT leftover Mission01-08/10 Root,
...
class Mission09MajorBridgeAnchorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("MajorBridgeAnchor", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_major_bridge_anchor_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_major_bridge_anchor_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertIn("MajorBridgeAnchor", LOCKED_DECL)
        ...
        self.assertNotIn("HoistCableAnchor", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("MajorBridgeAnchor;", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 MajorBridgeAnchor field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 MajorBridgeAnchor field contains "
    ...
    def test_contract_is_major_bridge_anchor_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_root(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tTObjectPtr<USceneComponent> MajorBridgeAnchor = nullptr;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_major_bridge_anchor_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_declaration_accepts_origin_main_default_forms(self) -> None:
        ...
        stem = "TObjectPtr<USceneComponent> MajorBridgeAnchor"
        ...
        self.assertEqual(LOCKED_DECL, "TObjectPtr<USceneComponent> MajorBridgeAnchor;")
