...
# INDEX_NONE or lock GetConvoyRouteAlpha
# construction in the .cpp. This is leftover-safe
# Mission03 Convoy GetConvoyRouteAlpha
# on ASkyguardMission03IntegrationDirector. It is
# NOT leftover BindRuntimeActors, leftover
# GetAircraft, leftover HandleDroneCityImpact,
# leftover Harbor Mission02 / Harbor #6/#8/#9,
# leftover spawn-location fields, leftover
# convoy-route-state enum #d34e, leftover
# Mission03 wave-state enum #0242.
...
# Mission03 wave-state enum #0242.
# origin/main has no inline body; do not invent a
# body. Accept one-line / split-line UFUNCTION
# wraps. Do not invent a body.
# Nearby origin/main
...
# GetConvoyRouteAlpha method declaration
...
SIBLING_INTEGRATION_METHODS_NOT_LOCKED = (
    ...
    "test_mission03_get_convoy_route_state_decl_contract.py",
    "test_mission03_get_convoy_world_location_decl_contract.py",
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission03IntegrationDirector::GetConvoyRouteAlpha",
    "SkyguardMission03IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission03GetConvoyRouteAlphaDeclContractTests(unittest.TestCase):
    def test_mission03_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, GET_CONVOY_ROUTE_ALPHA),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, GET_CONVOY_ROUTE_ALPHA)
        self.assertIn("GetConvoyRouteAlpha", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, GET_CONVOY_ROUTE_ALPHA)
    ...
    def test_missing_get_convoy_route_alpha_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission03IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, GET_CONVOY_ROUTE_ALPHA)
        self.assertIn("GetConvoyRouteAlpha", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, GET_CONVOY_ROUTE_ALPHA)
        self.assertIn("GetConvoyRouteAlpha", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("BlueprintPure", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("Category", GET_CONVOY_ROUTE_ALPHA)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, GET_CONVOY_ROUTE_ALPHA)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, GET_CONVOY_ROUTE_ALPHA)
        self.assertIn("GetConvoyRouteAlpha", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = "\tvoid GetConvoyRouteAlpha() const;\n"
        as_bool = "\tbool GetConvoyRouteAlpha() const;\n"
        as_const = (
            "\tfloat "
            "GetConvoyRouteAlpha();\n"
        )
        with_arg = (
            "\tfloat "
            "GetConvoyRouteAlpha(float DeltaSeconds) const;\n"
        )
        renamed = (
            "\tfloat "
            "GetReady() const;\n"
        ...
        leftover_world_loc = f"\t{GET_CONVOY_WORLD_LOCATION}\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, GET_CONVOY_ROUTE_ALPHA)
            self.assertIn("GetConvoyRouteAlpha", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_get_convoy_route_alpha_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, GET_CONVOY_ROUTE_ALPHA),
            GET_CONVOY_ROUTE_ALPHA,
        )
        self.assertTrue(has_declaration(section, GET_CONVOY_ROUTE_ALPHA))
        self.assertEqual(
            declaration_count(section, GET_CONVOY_ROUTE_ALPHA),
            1,
        )
        self.assertTrue(
            GET_CONVOY_ROUTE_ALPHA.startswith("float"),
            GET_CONVOY_ROUTE_ALPHA,
        )
        self.assertTrue(
            GET_CONVOY_ROUTE_ALPHA.endswith(" const;"),
            GET_CONVOY_ROUTE_ALPHA,
        )
        self.assertTrue(
            GET_CONVOY_ROUTE_ALPHA.endswith(";"),
            GET_CONVOY_ROUTE_ALPHA,
        )
        self.assertIn("GetConvoyRouteAlpha", GET_CONVOY_ROUTE_ALPHA)
        self.assertIn("GetConvoyRouteAlpha()", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn(
            "ESkyguardMission03WaveState",
            GET_CONVOY_ROUTE_ALPHA,
        )
        self.assertNotIn("EnvironmentReadiness", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("MissionMapReadiness", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("Mission01IntegrationReadiness", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("Mission03IntegrationReadiness", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("TArray<", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("TObjectPtr", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("TSoftObjectPtr", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("INDEX_NONE", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("UFUNCTION", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("{", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("}", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("return ", GET_CONVOY_ROUTE_ALPHA)
        self.assertIn("const;", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("Root", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("Briefing", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("AudioDirector", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("RadioChatter", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("SortiePresentation", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("CampaignDefinition", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("MissionDefinition", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("Readiness;", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("bAutoInitialize", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("bAllowBoundedActorSpawning", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("bAutoLaunchAfterBriefing", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("PathfinderSpawnLocation", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetAircraft", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("BindRuntimeActors", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("HandleDroneCityImpact", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("StartNextWave", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("NotifyThreatDestroyed", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("AdvanceConvoyByDistance", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("NotifyConvoyDamage", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetReadiness", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetWaveState", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetConvoyRouteState", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetConvoyWorldLocation", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetConvoyIntegrity", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetDayBeatKit", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("ConvoyRuntimeAnchor", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("RoadHunterSpawnLocation", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("ASkyguardMission02IntegrationDirector", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("ConfigureMissionDefinition", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("NotifyObjectiveProgress", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("NotifyProtectedAssetFailed", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("InitializePlayableMission", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("IsCorePlayableReady", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("SynchronizeRuntimeState", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetObjectiveRuntime", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetGunner", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetPathfinder", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetMissionId", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("ValidateMissionContract", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("ConfigureFromMission", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("AdvanceBriefing", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("SetAssetsReady", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("AcknowledgeAndLaunch", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("CanLaunch", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetElapsedSeconds", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetBriefingState", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetMinimumWarmupSeconds", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetBriefingText", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetRadioChatter", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetPresentation", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("GetMissionTitle", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("AcknowledgeBriefing", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("LaunchSortie", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("HullCollider", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("OpticalTracker", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("WeaponServo", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("CountermeasurePod", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("MinHeightFromOriginCm", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("RadarNode", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("ESkyguardMission02WaveState", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("HarborIndustrial", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("MaxIntegrity", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("CurrentIntegrity", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("FillAndFinalize", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("FillAndFail", GET_CONVOY_ROUTE_ALPHA)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, GET_CONVOY_ROUTE_ALPHA)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_CONVOY} {GET_CONVOY_ROUTE_ALPHA}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{GET_CONVOY_ROUTE_ALPHA}\n}}\n"
        self.assertTrue(has_declaration(one_line, GET_CONVOY_ROUTE_ALPHA))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, GET_CONVOY_ROUTE_ALPHA),
            section,
    ...
    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        locked_only = f"{GET_CONVOY_ROUTE_ALPHA}\n"
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, GET_CONVOY_ROUTE_ALPHA)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", GET_CONVOY_ROUTE_ALPHA)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_get_convoy_route_alpha_cpp_body(self) -> None:
        locked_only = f"{GET_CONVOY_ROUTE_ALPHA}\n"
        self.assertNotIn("{", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("}", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("return ", GET_CONVOY_ROUTE_ALPHA)
        ...
        self.assertNotIn("return Other", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("return WaveState", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("return WaveState", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("return Readiness", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("return false", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("return true", GET_CONVOY_ROUTE_ALPHA)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{GET_CONVOY_ROUTE_ALPHA}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_CONVOY_ROUTE_ALPHA)
        self.assertIn("GetConvoyRouteAlpha", GET_CONVOY_ROUTE_ALPHA)
        self.assertTrue(GET_CONVOY_ROUTE_ALPHA.startswith("float"))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, GET_CONVOY_ROUTE_ALPHA)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("CurrentIntegrity", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("SkyguardApacheAircraft.h", GET_CONVOY_ROUTE_ALPHA)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", GET_CONVOY_ROUTE_ALPHA)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{GET_CONVOY_ROUTE_ALPHA}\n"
        self.assertEqual(
            require_declaration(locked_only, GET_CONVOY_ROUTE_ALPHA),
            GET_CONVOY_ROUTE_ALPHA,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_CONVOY_ROUTE_ALPHA)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 GetConvoyRouteAlpha method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{GET_CONVOY_ROUTE_ALPHA}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, GET_CONVOY_ROUTE_ALPHA.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                GET_CONVOY_ROUTE_ALPHA.lower(),
                "mission03 GetConvoyRouteAlpha contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, GET_CONVOY_ROUTE_ALPHA)

    def test_contract_is_get_convoy_route_alpha_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(GET_CONVOY_ROUTE_ALPHA.startswith("float"))
        self.assertIn("GetConvoyRouteAlpha", GET_CONVOY_ROUTE_ALPHA)
        self.assertIn("GetConvoyRouteAlpha() const", GET_CONVOY_ROUTE_ALPHA)
        self.assertTrue(GET_CONVOY_ROUTE_ALPHA.endswith(" const;"))
        self.assertTrue(GET_CONVOY_ROUTE_ALPHA.endswith(";"))
        self.assertNotIn("EnvironmentReadiness", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("MissionMapReadiness", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("Mission01IntegrationReadiness", GET_CONVOY_ROUTE_ALPHA)
        self.assertNotIn("Mission03IntegrationReadiness", GET_CONVOY_ROUTE_ALPHA)
    ...
    def test_sibling_director_fields_do_not_satisfy_get_convoy_route_alpha(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, GET_CONVOY_ROUTE_ALPHA)
            )
            self.assertNotEqual(GET_CONVOY_ROUTE_ALPHA, leftover)
        self.assertIn(
    ...
    def test_leftover_handle_drone_city_impact_does_not_satisfy(self) -> None:
        ...
        self.assertIn("GetConvoyRouteAlpha", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, GET_CONVOY_ROUTE_ALPHA))
        locked_only = f"{GET_CONVOY_ROUTE_ALPHA}\n"
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tfloat "
            "GetConvoyRouteAlpha() const { return Readiness; }\n"
            "};\n"
        )
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission03_get_convoy_route_alpha"
            "_decl_contract.py"
        )
