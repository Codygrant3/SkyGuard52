...
# Mission10 ProtectedRuntime bDestroyed FIELD
# (FSkyguardMission10ProtectedRuntime::bDestroyed).
# It is NOT leftover Mission10 protected-group
# enum #6f9d, NOT leftover Mission10 protected-
# runtime-defaults #7898, NOT leftover
# GetProtectedGroup #782, NOT leftover
# NotifyProtectedGroupDamage #774, NOT leftover
# NotifyProtectedAssetFailed #773, NOT leftover
# Group (uses leftover enum #6f9d). Skip leftover
# Group. This is leftover-safe Mission10
# bDestroyed FIELD
# (VisibleAnywhere / BlueprintReadOnly,
# declaration-only, one-line / split-line
# UPROPERTY wraps, = false default) on
...
# the origin/main `= false` default, and nearby
...
# not ASkyguardMission10IntegrationDirector, not leftover
# FSkyguardMission10IntegrationReadiness. Skip leftover
# Group / leftover Mission10 Readiness #809 /
# leftover Mission10 CampaignDefinition #798 /
# leftover Mission10 MissionDefinition #799.
...
# FSkyguardMission10ProtectedRuntime. Do not reopen leftover
...
class Mission10ProtectedRuntimeDestroyedFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 bDestroyed field contract "
    ...
    def test_contract_is_destroyed_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission10_protected_runtime_destroyed_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_protected_runtime_destroyed_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
