...
# bMapAssemblyReady FIELD (declaration-only;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission09 readiness-struct
# bMapAssemblyReady. THIS IS NOT leftover Mission08
# FSkyguardMission08IntegrationReadiness
# bMapAssemblyReady. THIS IS NOT leftover
...
# (sibling draft). THIS IS NOT leftover Mission09
# director MissionDefinition #1092. THIS IS
# NOT leftover Mission09 director Readiness field
# (sibling in-flight on cursor/mission09-readiness-
# field-decl-contract-c332). THIS IS NOT leftover
# Mission06/05/04/03/02/01/10 same-name readiness-
# struct bMapAssemblyReady drafts. THIS IS NOT
# leftover Mission09 Root #1083 through director
...
# merge #665 #666 #668-#673, or open drafts #674-#1100.
...
# INDEX_NONE or lock bMapAssemblyReady
# construction in the .cpp. This is leftover-safe
# Mission09 IntegrationReadiness bMapAssemblyReady
...
# bMapAssemblyReady FIELD / branch
# cursor/mission08-map-assembly-ready-field-
# decl-contract-c332, It is
...
# drafts #674-#1100 including leftover Mission02
...
# drafts #674-#1100. Do not reopen leftover
...
LOCKED_DECL = MAP_ASSEMBLY_READY
...
# an isolated Python bMapAssemblyReady
...
class Mission09MapAssemblyReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bMapAssemblyReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_map_assembly_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_map_assembly_ready_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bMapAssemblyReady"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bMapAssemblyReady", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bMapAssemblyReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bMapAssemblyReady"))
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 bMapAssemblyReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 bMapAssemblyReady contains "
