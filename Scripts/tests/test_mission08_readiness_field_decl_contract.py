...
# THIS IS leftover-safe Mission08 DIRECTOR CLASS Readiness FIELD
# (declaration-only, one-line / split-line UPROPERTY wraps)
# on ASkyguardMission08IntegrationDirector.
...
# struct members (sibling this wave: bMissionDefinitionValid /
# bCampaignDefinitionValid). THIS IS NOT leftover
# MaximumProtectedTargetIntegrity #1065. THIS IS NOT leftover
# RequiredCoveredSeconds #1063 / MinimumWeaponSeparationMeters
# #1064. Skip leftover spawn location / rotation forever.
# LOCK leftover drafts #56-#64 and leftover #107-#673.
# Do not reopen leftover #664. Do not reopen closed-without-
# merge leftover #658-#673. Do not reopen leftover Mission05
# closed-without-merge #665 #666 #668-#673. Do not reopen leftover
# Mission08 Blueprint UFUNCTION methods #729-#749. Do not reopen
# leftover Mission08 director Root #1044 through
# MaximumProtectedTargetIntegrity #1065. Do not reopen leftover
# Mission08 wave-state enum #68fc / leftover Mission08
# protected-target enum #a66a / leftover Mission08
# protected-target-runtime-defaults #75e6 / leftover
# hoist-window-runtime-defaults #ec79. Lock leftover same-name
# Mission01/02/03/04/05/06/07/10 director and readiness-struct
# drafts. Skip leftover runtime-ready flag forever.
# PARSE public section of ASkyguardMission08IntegrationDirector
# only. Do NOT parse FSkyguardMission08IntegrationReadiness,
# FSkyguardHoistWindowRuntime,
# FSkyguardMission08ProtectedTargetRuntime, or private
# UPROPERTY(Transient). Do not lock .cpp construction or
# UpdateReadiness(). Accept one-line or split-line UPROPERTY
# wraps. Fail-closed if the type or declaration is missing.
# Note VisibleAnywhere / BlueprintReadOnly / Category
# Skyguard|Mission08, not EditAnywhere / BlueprintReadWrite.
# Harbor clock tokens fail closed in Mission02/03/04/05/06/07
# test files; this contract is Mission08-only. Incoming clock
# names must be absent. Apache CPG lock stays 30 mm / Hydra /
# Hellfire.
# Declaration presence only. Do not invent
# INDEX_NONE or lock Readiness
# construction in the .cpp. This is leftover-safe
# Mission07 DIRECTOR CLASS Readiness FIELD
...
# drafts #674-#991, leftover Apache
...
class Mission08ReadinessFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("Skyguard|Mission05|Protection", UPROPERTY_MISSION08)
    ...
    def test_readiness_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FSkyguardMission08IntegrationReadiness "),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("Readiness", LOCKED_DECL)
        self.assertIn("FSkyguardMission08IntegrationReadiness", LOCKED_DECL)
    ...
    def test_contract_is_readiness_field_declaration_only(
        ...
        self.assertNotIn("return ", LOCKED_DECL)
        self.assertNotIn("{", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FSkyguardMission08IntegrationReadiness"))
        self.assertIn("Readiness", LOCKED_DECL)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_readiness_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_same_name_readiness_contracts_stay_locked(self) -> None:
        ...
        self.assertNotIn("EditAnywhere", UPROPERTY_MISSION08)
        self.assertNotIn("BlueprintReadWrite", UPROPERTY_MISSION08)
        self.assertIn("VisibleAnywhere", UPROPERTY_MISSION08)
        self.assertIn("BlueprintReadOnly", UPROPERTY_MISSION08)
    ...
    def test_contract_does_not_parse_readiness_struct(self) -> None:
        ...
        self.assertIsNone(
            re.search(
                r"class\s+(?:SKYGUARD52_API\s+)?"
                r"FSkyguardMission08IntegrationReadiness\b",
                header,
            )
        )
        self.assertIn(
