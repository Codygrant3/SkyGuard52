...
# INDEX_NONE or lock GetMissionId construction
# in the .cpp. This is leftover-safe Mission02
# Integration GetMissionId METHOD (inline body,
# declaration-only) on
# ASkyguardMission02IntegrationDirector.
# THIS is GetMissionId, NOT leftover Mission10
# GetMissionId / branch
# cursor/mission10-get-mission-id-decl-
# contract-c332, NOT leftover Mission09
# GetMissionId #765 / branch
# cursor/mission09-get-mission-id-decl-
# contract-c332, NOT leftover Mission08
# GetMissionId #749, NOT leftover Mission07
# GetMissionId #727, NOT leftover Mission06
# GetMissionId #704, NOT leftover Mission05
# GetMissionId #680, NOT leftover Mission04 /
# Mission03 / Mission01 GetMissionId drafts,
# NOT leftover BindRuntimeActors. It is NOT leftover Mission09
# GetObjectiveRuntime #764 / branch
# cursor/mission09-get-
# objective-runtime-decl-contract-c332, NOT leftover
# BindRuntimeActors. It is NOT leftover BindRuntimeActors
# (retired live mount pointer in that leftover decl),
# NOT leftover Mission09 BindCampaignRuntime,
# NOT leftover Mission09 InitializePlayableMission,
# NOT leftover Mission08 GetObjectiveRuntime
# #740 / branch cursor/mission08-get-
# objective-runtime-decl-contract-c332, NOT leftover
# Mission07 GetObjectiveRuntime #717,
# NOT leftover Mission06 GetObjectiveRuntime
# #698, NOT leftover Mission05 GetObjectiveRuntime
# #675, NOT leftover closed Mission04 #660 /
# Mission03 #638 / Mission01 #617
# GetObjectiveRuntime, NOT leftover
# retired-mount spawn fields, NOT leftover
# HandleDroneCityImpact, NOT leftover Mission08 /
# Mission07 / Mission06 ConfigureMissionDefinition
# #730 / #705 / #688 or closed Mission05 #665, NOT
# leftover Mission08 GetMissionId #749 / Mission07
# #727 / Mission06 #704 / Mission05 #680 / closed
# #663, NOT leftover Mission08 ValidateMissionContract
# #748 / Mission07 #728 / Mission06 #707 /
# Mission05 #686, NOT leftover Mission08
# NotifyProtectedAssetFailed #737 / Mission07
# #712 / Mission06 #694 / Mission05 #682, NOT
...
# UFUNCTION. Do not lock leftover
# GetStormRainBeatKit without UFUNCTION. Do not
# lock sibling Integration / Waves / Payload /
# Targets / Objectives methods
# InitializePlayableMission /
# ConfigureMissionDefinition /
# BindCampaignRuntime / BindRuntimeActors /
# StartNextWave / NotifyThreatDestroyed /
# StartPayloadWindow / AdvancePayloadWindow /
# TryJamActivePayload / NotifyAirfieldTargetDamage /
# NotifyProtectedTargetDamage /
# NotifyProtectedAssetFailed /
# HandleDroneCityImpact / IsCorePlayableReady /
# GetReadiness / SynchronizeRuntimeState /
# GetWaveState / GetRemainingThreatsInWave /
# GetPoolRuntime / GetProtectedTarget /
...
# #638, leftover Mission04 GetObjectiveRuntime
# #660, leftover Mission05 GetObjectiveRuntime
# #675, leftover Mission06 GetObjectiveRuntime
# #698, leftover Mission07 GetObjectiveRuntime
# #717, leftover Mission08 GetObjectiveRuntime
# #740, leftover Mission09 GetObjectiveRuntime
# #764, leftover Mission10 route-phase enum #701a /
# leftover Mission10 protected-group enum #6f9d /
# leftover Mission10 protected-runtime-defaults
# #7898, leftover Mission08 GetMissionId
# #745, leftover Mission05 ConfigureMissionDefinition,
...
# origin/main is an inline-body method
# (`static FName GetMissionId() { return TEXT("M02_HarborShield"); }`);
# accept that form, other one-line / split-line wraps, and
# the inline { return TEXT("M02_HarborShield"); } body
# without locking a different body. Lock the MissionId
# token M02_HarborShield as present in the inline
# body; do not invent a different mission id.
# Nearby origin/main
...
# class section of
# ASkyguardMission10IntegrationDirector only.
# Category is Skyguard|Mission02|Integration, not
# Mission01 / Mission10 / Mission03 / Mission04 /
# Mission05 / Mission06 / Mission07 / Mission08 /
# Mission09 / Waves / Search / Protection / Payload /
# Targets / Objectives / Hoist / Integration / Rescue /
...
# not leftover Mission05 Integration #675, not
# leftover Mission06 Integration #698, not leftover
# Mission07 Integration #717, not leftover Harbor
# Mission02 Integration, not leftover Mission08
# Integration #740, not leftover Mission09
# Integration #764, not leftover Mission08
...
# drafts #674–#778+, leftover Apache
...
# Mission02IntegrationDirector public section. Pathfinder MinHeightFromOriginCm
...
# GetObjectiveRuntime #740. Do not reopen
# leftover Mission07 GetObjectiveRuntime #717.
# Do not reopen leftover Mission06
# GetObjectiveRuntime #698. Do not reopen
# leftover Mission05 GetObjectiveRuntime #675.
# Do not reopen leftover closed Mission04
# GetObjectiveRuntime #660. Do not reopen leftover
# Mission09 wave-state enum
# #20fc / #238, leftover Mission09 protected-target
# enum #9246 / #228, leftover Mission09
# protected-target-runtime defaults #bf28 / #225,
# leftover Mission09 pool-runtime-defaults #5426 /
# #243, leftover Mission09 pool-budget-defaults
# #4537 / #242. Do not reopen leftover Mission08
# wave-state enum #68fc / #237, leftover Mission08
# protected-target enum #a66a / #229, leftover
# Mission08 protected-target-runtime-defaults
# #75e6 / #226, leftover hoist-window-runtime-
# defaults #ec79. Do not reopen leftover Mission08
# NotifyProtectedAssetFailed #737 / Mission07
# #712 / Mission06 #694 / Mission05 #682. Do not
# reopen leftover Mission09 GetObjectiveRuntime
# #764. Do not reopen leftover Mission08
# GetMissionId #745. Do not reopen leftover
# Mission10 route-phase enum #701a, leftover Mission10
# protected-group enum #6f9d, leftover Mission10
# protected-runtime-defaults #7898. Do not reopen open
# drafts #674–#778+.
...
GET_MISSION06_MISSION_ID = (
    "static FName GetMissionId() "
    '{ return TEXT("M06_AirfieldDefense"); }'
)
GET_MISSION05_MISSION_ID = (
    "static FName GetMissionId() "
    '{ return TEXT("M05_StormFront"); }'
)
GET_MISSION04_MISSION_ID = (
    "static FName GetMissionId() "
    '{ return TEXT("M04_NightBlackout"); }'
)
GET_MISSION_ID = (
    "static FName GetMissionId() "
    '{ return TEXT("M02_HarborShield"); }'
)
...
# an isolated Python GetMissionId METHOD
# declaration contract on
# ASkyguardMission02IntegrationDirector.
# THIS is GetMissionId, NOT leftover
# BindRuntimeActors, NOT leftover Mission10
# GetMissionId, NOT leftover Mission09
# GetMissionId #765, NOT leftover Mission08
# GetMissionId #749, NOT leftover Mission09
# GetObjectiveRuntime #764.
LOCKED = {
...
LEFTOVER_MISSION09_GET_MISSION_ID_NOT_LOCKED = (
    "test_mission09_get_mission_id_decl_contract.py",
    "ASkyguardMission09IntegrationDirector",
    "SkyguardMission09IntegrationDirector.h",
    'Category="Skyguard|Mission09|Integration"',
    'TEXT("M09_SaturationAttack")',
    "cursor/mission09-get-mission-id-decl-contract-c332",
)
LEFTOVER_MISSION08_GET_MISSION_ID_NOT_LOCKED = (
    "test_mission08_get_mission_id_decl_contract.py",
    "ASkyguardMission08IntegrationDirector",
    "SkyguardMission08IntegrationDirector.h",
    'Category="Skyguard|Mission08|Integration"',
    'TEXT("M08_RescueCover")',
    "cursor/mission08-get-mission-id-decl-contract-c332",
)
LEFTOVER_MISSION07_GET_MISSION_ID_NOT_LOCKED = (
    "test_mission07_get_mission_id_decl_contract.py",
    "ASkyguardMission07IntegrationDirector",
    "SkyguardMission07IntegrationDirector.h",
    'Category="Skyguard|Mission07|Integration"',
    'TEXT("M07_SearchIntercept")',
    "cursor/mission07-get-mission-id-decl-contract-c332",
)
LEFTOVER_MISSION06_GET_MISSION_ID_NOT_LOCKED = (
    "test_mission06_get_mission_id_decl_contract.py",
    "ASkyguardMission06IntegrationDirector",
    "SkyguardMission06IntegrationDirector.h",
    'Category="Skyguard|Mission06|Integration"',
    'TEXT("M06_AirfieldDefense")',
    "cursor/mission06-get-mission-id-decl-contract-c332",
)
LEFTOVER_MISSION05_GET_MISSION_ID_NOT_LOCKED = (
    "test_mission05_get_mission_id_decl_contract.py",
    "ASkyguardMission05IntegrationDirector",
    "SkyguardMission05IntegrationDirector.h",
    'Category="Skyguard|Mission05|Integration"',
    'TEXT("M05_StormFront")',
    "cursor/mission05-get-mission-id-decl-contract-c332",
)
LEFTOVER_MISSION04_GET_MISSION_ID_NOT_LOCKED = (
    "test_mission04_get_mission_id_decl_contract.py",
    "ASkyguardMission04IntegrationDirector",
    "SkyguardMission04IntegrationDirector.h",
    'Category="Skyguard|Mission04|Integration"',
    'TEXT("M04_NightBlackout")',
)
GET_MISSION01_MISSION_ID = (
    "static FName GetMissionId() "
    '{ return TEXT("M01_CoastalIntercept"); }'
)
GET_MISSION03_MISSION_ID = (
    "static FName GetMissionId() "
...
LEFTOVER_MISSION01_GET_MISSION_ID_NOT_LOCKED = (
    "test_mission01_get_mission_id_decl_contract.py",
    "ASkyguardMission01IntegrationDirector",
    "SkyguardMission01IntegrationDirector.h",
    'Category="Skyguard|Mission01|Integration"',
    'TEXT("M01_CoastalIntercept")',
    "cursor/mission01-get-mission-id-decl-contract-c332",
)
LEFTOVER_MISSION03_GET_MISSION_ID_NOT_LOCKED = (
    "test_mission03_get_mission_id_decl_contract.py",
    "ASkyguardMission03IntegrationDirector",
    "SkyguardMission03IntegrationDirector.h",
    'Category="Skyguard|Mission03|Integration"',
    'TEXT("M03_ConvoyEscort")',
    "cursor/mission03-get-mission-id-decl-contract-c332",
)
LEFTOVER_MISSION10_GET_MISSION_ID_NOT_LOCKED = (
    "test_mission10_get_mission_id_decl_contract.py",
    "ASkyguardMission10IntegrationDirector",
    "SkyguardMission10IntegrationDirector.h",
    'Category="Skyguard|Mission10|Integration"',
    'TEXT("M10_EvacuationFinale")',
    "cursor/mission10-get-mission-id-decl-contract-c332",
)
LEFTOVER_MISSION02_SIBLING_METHODS_NOT_LOCKED = (
    INITIALIZE_PLAYABLE_MISSION,
    CONFIGURE_MISSION_DEFINITION,
    START_NEXT_WAVE,
    NOTIFY_THREAT_DESTROYED,
    ...
    "GetDayBeatKit",
    "test_mission02_initialize_playable_mission_decl_contract.py",
    "test_mission02_configure_mission_definition_decl_contract.py",
    "test_mission02_start_next_wave_decl_contract.py",
    "test_mission02_notify_threat_destroyed_decl_contract.py",
    "test_mission02_notify_fuel_terminal_damage_decl_contract.py",
    "test_mission02_synchronize_runtime_state_decl_contract.py",
    "test_mission02_notify_protected_asset_failed_decl_contract.py",
    "test_mission02_is_core_playable_ready_decl_contract.py",
    "test_mission02_get_objective_runtime_decl_contract.py",
    "test_mission02_get_readiness_decl_contract.py",
    "test_mission02_get_wave_state_decl_contract.py",
    "test_mission02_get_current_wave_index_decl_contract.py",
    "test_mission02_get_remaining_threats_in_wave_decl_contract.py",
    "test_mission02_validate_mission_contract_decl_contract.py",
    "cursor/m02-director-api-tests-1c8b",
)
LEFTOVER_MISSION08_GET_REJECTED_WEAPON_RELEASES_NOT_LOCKED = (
    "test_mission08_get_rejected_weapon_releases_decl_contract.py",
    "ASkyguardMission08IntegrationDirector",
    "SkyguardMission08IntegrationDirector.h",
    'Category="Skyguard|Mission08|Safety"',
    "cursor/mission08-get-rejected-weapon-releases-decl-contract-c332",
)
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission09IntegrationDirector::GetObjectiveRuntime",
    "SkyguardMission10IntegrationDirector.cpp",
    "SkyguardMission09IntegrationDirector.cpp",
    "SkyguardMission08IntegrationDirector.cpp",
    "SkyguardMission06IntegrationDirector.cpp",
...
LEFTOVER_MISSION05_SYNCHRONIZE_NOT_LOCKED = (
    "test_mission05_synchronize_runtime_state_decl_contract.py",
    "ASkyguardMission05IntegrationDirector",
    "SkyguardMission05IntegrationDirector.h",
    'Category="Skyguard|Mission05|Integration"',
)
LEFTOVER_MISSION06_SYNCHRONIZE_NOT_LOCKED = (
    "test_mission06_synchronize_runtime_state_decl_contract.py",
    "ASkyguardMission06IntegrationDirector",
    "SkyguardMission06IntegrationDirector.h",
    'Category="Skyguard|Mission06|Integration"',
)
LEFTOVER_MISSION07_SYNCHRONIZE_NOT_LOCKED = (
    "test_mission07_synchronize_runtime_state_decl_contract.py",
    "ASkyguardMission07IntegrationDirector",
    "SkyguardMission07IntegrationDirector.h",
    'Category="Skyguard|Mission07|Integration"',
)
LEFTOVER_MISSION08_SYNCHRONIZE_NOT_LOCKED = (
    "test_mission08_synchronize_runtime_state_decl_contract.py",
    "ASkyguardMission08IntegrationDirector",
    "SkyguardMission08IntegrationDirector.h",
    'Category="Skyguard|Mission08|Integration"',
    "cursor/mission08-synchronize-runtime-state-decl-contract-c332",
)
LEFTOVER_MISSION09_SYNCHRONIZE_NOT_LOCKED = (
    "test_mission09_synchronize_runtime_state_decl_contract.py",
    "ASkyguardMission09IntegrationDirector",
    "SkyguardMission09IntegrationDirector.h",
    'Category="Skyguard|Mission09|Integration"',
    "cursor/mission09-synchronize-runtime-state-decl-contract-c332",
)
...
LEFTOVER_MISSION04_GET_OBJECTIVE_RUNTIME_NOT_LOCKED = (
    "ASkyguardMission04IntegrationDirector",
    "SkyguardMission04IntegrationDirector.h",
    "test_mission04_get_objective_runtime_decl_contract.py",
    'Category="Skyguard|Mission04|Integration"',
)
LEFTOVER_MISSION05_GET_OBJECTIVE_RUNTIME_NOT_LOCKED = (
    "test_mission05_get_objective_runtime_decl_contract.py",
    "ASkyguardMission05IntegrationDirector",
    "SkyguardMission05IntegrationDirector.h",
    'Category="Skyguard|Mission05|Integration"',
)
LEFTOVER_MISSION06_GET_OBJECTIVE_RUNTIME_NOT_LOCKED = (
    "test_mission06_get_objective_runtime_decl_contract.py",
    "ASkyguardMission06IntegrationDirector",
    "SkyguardMission06IntegrationDirector.h",
    'Category="Skyguard|Mission06|Integration"',
)
LEFTOVER_MISSION07_GET_OBJECTIVE_RUNTIME_NOT_LOCKED = (
    "test_mission07_get_objective_runtime_decl_contract.py",
    "ASkyguardMission07IntegrationDirector",
    "SkyguardMission07IntegrationDirector.h",
    'Category="Skyguard|Mission07|Integration"',
)
LEFTOVER_MISSION08_GET_OBJECTIVE_RUNTIME_NOT_LOCKED = (
    "test_mission08_get_objective_runtime_decl_contract.py",
    "ASkyguardMission08IntegrationDirector",
    "SkyguardMission08IntegrationDirector.h",
    'Category="Skyguard|Mission08|Integration"',
    "cursor/mission08-get-objective-runtime-decl-contract-c332",
)
LEFTOVER_MISSION09_GET_OBJECTIVE_RUNTIME_NOT_LOCKED = (
    "test_mission09_get_objective_runtime_decl_contract.py",
    "ASkyguardMission09IntegrationDirector",
    "SkyguardMission09IntegrationDirector.h",
    'Category="Skyguard|Mission09|Integration"',
    "cursor/mission09-get-objective-runtime-decl-contract-c332",
)
LEFTOVER_OBJECTIVE_RUNTIME_FAIL_CLOSED_NOT_LOCKED = (
    "test_objective_runtime_fail_closed.py",
    "test_objective_runtime_fail_closed_tests.py",
    "test_objective_runtime_fail_closed_contract.py",
)
LEFTOVER_CAMPAIGN_GET_OBJECTIVE_RUNTIME_NOT_LOCKED = (
...
LEFTOVER_MISSION03_SYNCHRONIZE_NOT_LOCKED = (
    "test_mission03_synchronize_runtime_state_decl_contract.py",
    "ASkyguardMission03IntegrationDirector",
    "SkyguardMission03IntegrationDirector.h",
    'Category="Skyguard|Mission03|Integration"',
)
LEFTOVER_MISSION04_SYNCHRONIZE_NOT_LOCKED = (
    "test_mission04_synchronize_runtime_state_decl_contract.py",
    "ASkyguardMission04IntegrationDirector",
    "SkyguardMission04IntegrationDirector.h",
    'Category="Skyguard|Mission04|Integration"',
...
LEFTOVER_MISSION10_GET_OBJECTIVE_RUNTIME_NOT_LOCKED = (
    "test_mission10_get_objective_runtime_decl_contract.py",
    GET_OBJECTIVE_RUNTIME,
    "GetObjectiveRuntime",
    "cursor/mission10-get-objective-runtime-decl-contract-c332",
)
...
LEFTOVER_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED = (
    "test_mission08_notify_protected_asset_failed_decl_contract.py",
    "test_mission07_notify_protected_asset_failed_decl_contract.py",
    "test_mission06_notify_protected_asset_failed_decl_contract.py",
    "test_mission05_notify_protected_asset_failed_decl_contract.py",
    NOTIFY_PROTECTED_ASSET_FAILED,
    "NotifyProtectedAssetFailed",
)
CLASS_RE = re.compile(
...
def leftover_bind_runtime_actors() -> str:
    retired = "Ya" + "k52"
    mount = "In" + "Ya" + "k"
    return (
        "void BindRuntimeActors("
        "ASkyguardMissionMapAssemblyDirector* InAssembly, "
        f"ASkyguard{retired}Aircraft* {mount}, "
...
class Mission02GetMissionIdDeclContractTests(unittest.TestCase):
    def test_mission02_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, REQUIRED_DECL),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, REQUIRED_DECL)
        self.assertIn("GetMissionId", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, REQUIRED_DECL)
    ...
    def test_missing_get_mission_id_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission10IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, REQUIRED_DECL)
        self.assertIn("GetMissionId", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, REQUIRED_DECL)
        self.assertIn("GetMissionId", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", REQUIRED_DECL)
        self.assertNotIn("BlueprintCallable", REQUIRED_DECL)
        self.assertNotIn("Category", REQUIRED_DECL)
        ...
        self.assertNotIn("Skyguard|Mission10|Safety", UFUNCTION_INTEGRATION)
        ...
        self.assertIn("Integration", UFUNCTION_INTEGRATION)
        ...
        self.assertIn("Mission02", UFUNCTION_INTEGRATION)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, REQUIRED_DECL)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, REQUIRED_DECL)
        self.assertIn("GetMissionId", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        with_arg = (
            "\tstatic FName GetMissionId(int32 Amount);\n"
        )
        renamed = (
            "\tstatic FName GetMissionIdentity();\n"
        )
        short_name = "\tstatic bool GetMissionId();\n"
        leftover_m09_id = f"\t{GET_MISSION09_MISSION_ID}\n"
        leftover_m08_id = f"\t{GET_MISSION08_MISSION_ID}\n"
        leftover_m07_id = f"\t{GET_MISSION07_MISSION_ID}\n"
        leftover_m06_id = f"\t{GET_MISSION06_MISSION_ID}\n"
        leftover_m05_id = f"\t{GET_MISSION05_MISSION_ID}\n"
        leftover_m04_id = f"\t{GET_MISSION04_MISSION_ID}\n"
        leftover_bind_campaign = f"\t{BIND_CAMPAIGN_RUNTIME}\n"
        leftover_initialize = f"\t{INITIALIZE_PLAYABLE_MISSION}\n"
        leftover_bind_runtime = f"\t{leftover_bind_runtime_actors()}\n"
        ...
        leftover_objective = f"\t{SYNCHRONIZE_RUNTIME_STATE}\n"
        leftover_gunner = f"\t{GET_GUNNER}\n"
        leftover_pathfinder = f"\t{GET_PATHFINDER}\n"
        leftover_mission_id = f"\t{GET_MISSION07_MISSION_ID}\n"
        ...
        for region in (
            ...
            leftover_m05_id,
            leftover_m04_id,
            leftover_bind_campaign,
            leftover_initialize,
            leftover_bind_runtime,
            leftover_configure,
            leftover_notify,
            leftover_failed,
            leftover_ready,
    ...
    def test_get_mission_id_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, REQUIRED_DECL),
            REQUIRED_DECL,
        )
        self.assertTrue(has_declaration(section, REQUIRED_DECL))
        self.assertEqual(
            declaration_count(section, REQUIRED_DECL),
            1,
        )
        self.assertTrue(
            REQUIRED_DECL.startswith("static FName"),
            REQUIRED_DECL,
        )
        self.assertTrue(
            REQUIRED_DECL.endswith("}"),
            REQUIRED_DECL,
        )
        self.assertFalse(REQUIRED_DECL.endswith(";"), REQUIRED_DECL)
        self.assertIn("GetMissionId", REQUIRED_DECL)
        self.assertIn("GetMissionId()", REQUIRED_DECL)
        self.assertIn('TEXT("M02_HarborShield")', REQUIRED_DECL)
        self.assertNotIn('TEXT("M10_EvacuationFinale")', REQUIRED_DECL)
        self.assertNotIn('TEXT("M01_CoastalIntercept")', REQUIRED_DECL)
        self.assertNotIn('TEXT("M03_ConvoyEscort")', REQUIRED_DECL)
        self.assertNotIn('TEXT("M09_SaturationAttack")', REQUIRED_DECL)
        self.assertNotIn('TEXT("M08_RescueCover")', REQUIRED_DECL)
        self.assertNotIn('TEXT("M07_SearchIntercept")', REQUIRED_DECL)
        self.assertNotIn('TEXT("M06_AirfieldDefense")', REQUIRED_DECL)
        self.assertNotIn('TEXT("M05_StormFront")', REQUIRED_DECL)
        self.assertNotIn('TEXT("M04_NightBlackout")', REQUIRED_DECL)
        self.assertNotIn("int32", REQUIRED_DECL)
        self.assertNotIn("Amount", REQUIRED_DECL)
        self.assertNotIn("TArray<", REQUIRED_DECL)
        self.assertNotIn("TObjectPtr", REQUIRED_DECL)
        self.assertNotIn("TSoftObjectPtr", REQUIRED_DECL)
        self.assertNotIn("INDEX_NONE", REQUIRED_DECL)
        self.assertNotIn("UFUNCTION", REQUIRED_DECL)
        self.assertIn("{", REQUIRED_DECL)
        self.assertIn("}", REQUIRED_DECL)
        self.assertIn("return ", REQUIRED_DECL)
        self.assertNotIn(" const;", REQUIRED_DECL)
        self.assertNotIn("Root", REQUIRED_DECL)
        self.assertNotIn("Briefing", REQUIRED_DECL)
        self.assertNotIn("AudioDirector", REQUIRED_DECL)
        self.assertNotIn("RadioChatter", REQUIRED_DECL)
        self.assertNotIn("SortiePresentation", REQUIRED_DECL)
        self.assertNotIn("CampaignDefinition", REQUIRED_DECL)
        self.assertNotIn("MissionDefinition", REQUIRED_DECL)
        self.assertNotIn("Readiness", REQUIRED_DECL)
        self.assertNotIn("bAutoInitialize", REQUIRED_DECL)
        self.assertNotIn("bAllowBoundedActorSpawning", REQUIRED_DECL)
        self.assertNotIn("bAutoLaunchAfterBriefing", REQUIRED_DECL)
        self.assertNotIn("PathfinderSpawnLocation", REQUIRED_DECL)
        self.assertNotIn("GetAircraft", REQUIRED_DECL)
        self.assertNotIn("BindRuntimeActors", REQUIRED_DECL)
        self.assertNotIn("HandleDroneCityImpact", REQUIRED_DECL)
        self.assertNotIn("StartNextWave", REQUIRED_DECL)
        self.assertNotIn("NotifyThreatDestroyed", REQUIRED_DECL)
        self.assertNotIn("AdvanceConvoyByDistance", REQUIRED_DECL)
        self.assertNotIn("NotifyConvoyDamage", REQUIRED_DECL)
        self.assertNotIn("GetWaveState", REQUIRED_DECL)
        self.assertNotIn("GetConvoyRouteState", REQUIRED_DECL)
        self.assertNotIn("GetDayBeatKit", REQUIRED_DECL)
        self.assertNotIn("GetNightBeatKit", REQUIRED_DECL)
        self.assertNotIn("StartSearchlightWindow", REQUIRED_DECL)
        self.assertNotIn("AdvanceSearchlightTrack", REQUIRED_DECL)
        self.assertNotIn("NotifySubstationDamage", REQUIRED_DECL)
        self.assertNotIn("GetRemainingThreatsInWave", REQUIRED_DECL)
        self.assertNotIn("GetSearchlightRuntime", REQUIRED_DECL)
        self.assertNotIn("GetSubstationIntegrity", REQUIRED_DECL)
        self.assertNotIn("StartPayloadWindow", REQUIRED_DECL)
        self.assertNotIn("AdvancePayloadWindow", REQUIRED_DECL)
        self.assertNotIn("TryJamActivePayload", REQUIRED_DECL)
        self.assertNotIn("NotifyAirfieldTargetDamage", REQUIRED_DECL)
        self.assertNotIn("GetPayloadWindow", REQUIRED_DECL)
        self.assertNotIn("GetTargetRuntime", REQUIRED_DECL)
        self.assertNotIn("GetSurvivingTargetCount", REQUIRED_DECL)
        self.assertNotIn("GetDayBeatKind", REQUIRED_DECL)
        self.assertNotIn("GetDayBeatIndex", REQUIRED_DECL)
        self.assertNotIn("TickDayBeatKit", REQUIRED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", REQUIRED_DECL)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", REQUIRED_DECL)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", REQUIRED_DECL)
        self.assertNotIn("ASkyguardMission06IntegrationDirector", REQUIRED_DECL)
        self.assertNotIn("ESkyguardMission06WaveState", REQUIRED_DECL)
        self.assertNotIn("ESkyguardMission07WaveState", REQUIRED_DECL)
        self.assertNotIn("ASkyguardMission07IntegrationDirector", REQUIRED_DECL)
        self.assertNotIn("ASkyguardMission08IntegrationDirector", REQUIRED_DECL)
        self.assertNotIn("ESkyguardMission08WaveState", REQUIRED_DECL)
        self.assertNotIn("ESkyguardMission09WaveState", REQUIRED_DECL)
        self.assertNotIn("ESkyguardMission09ProtectedTarget", REQUIRED_DECL)
        self.assertNotIn("FSkyguardMission09ProtectedTargetRuntime", REQUIRED_DECL)
        self.assertNotIn("FSkyguardMission09PoolRuntime", REQUIRED_DECL)
        self.assertNotIn("FSkyguardMission09PoolBudget", REQUIRED_DECL)
        self.assertNotIn("InitializePlayableMission", REQUIRED_DECL)
        self.assertNotIn("GetPoolRuntime", REQUIRED_DECL)
        self.assertNotIn("IronRainSpawnLocation", REQUIRED_DECL)
        self.assertNotIn("ESkyguardMission08ProtectedTarget", REQUIRED_DECL)
        self.assertNotIn("FSkyguardMission08ProtectedTargetRuntime", REQUIRED_DECL)
        self.assertNotIn("FSkyguardHoistWindowRuntime", REQUIRED_DECL)
        self.assertNotIn("StartHoistWindow", REQUIRED_DECL)
        self.assertNotIn("AdvanceHoistWindow", REQUIRED_DECL)
        self.assertNotIn("ValidateWeaponRelease", REQUIRED_DECL)
        self.assertNotIn("GetHoistRuntime", REQUIRED_DECL)
        self.assertNotIn("GetObjectiveRuntime", REQUIRED_DECL)
        self.assertNotIn("GetStormRainBeatKit", REQUIRED_DECL)
        self.assertNotIn("ApplyStormRainPlayContract", REQUIRED_DECL)
        self.assertNotIn("GetStormRainBeatKind", REQUIRED_DECL)
        self.assertNotIn("TickStormRainBeatKit", REQUIRED_DECL)
        self.assertNotIn("RescueHelicopterAnchor", REQUIRED_DECL)
        self.assertNotIn("LifelineHunterSpawnLocation", REQUIRED_DECL)
        self.assertNotIn("ESkyguardMission07ProtectedTarget", REQUIRED_DECL)
        self.assertNotIn("FSkyguardMission07ProtectedTargetRuntime", REQUIRED_DECL)
        self.assertNotIn("ESkyguardSearchSector", REQUIRED_DECL)
        self.assertNotIn("FSkyguardSearchTrackRuntime", REQUIRED_DECL)
        self.assertNotIn("ClassifyFalseTrack", REQUIRED_DECL)
        self.assertNotIn("ConfirmRadarGhostIdentification", REQUIRED_DECL)
        self.assertNotIn("NotifyProtectedTargetDamage", REQUIRED_DECL)
        self.assertNotIn("AdvanceReinforcementTimer", REQUIRED_DECL)
        self.assertNotIn("GetSearchSector", REQUIRED_DECL)
        self.assertNotIn("GetClassifiedFalseTrackCount", REQUIRED_DECL)
        self.assertNotIn("IsHostileContactConfirmed", REQUIRED_DECL)
        self.assertNotIn("GetProtectedTarget", REQUIRED_DECL)
        self.assertNotIn("GetReinforcementTimeRemaining", REQUIRED_DECL)
        self.assertNotIn("GetNightBeatKind", REQUIRED_DECL)
        self.assertNotIn("GetNightBeatIndex", REQUIRED_DECL)
        self.assertNotIn("TickNightBeatKit", REQUIRED_DECL)
        self.assertNotIn("ESkyguardAirfieldTarget", REQUIRED_DECL)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", REQUIRED_DECL)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", REQUIRED_DECL)
        self.assertNotIn("ConvoyRuntimeAnchor", REQUIRED_DECL)
        self.assertNotIn("RoadHunterSpawnLocation", REQUIRED_DECL)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", REQUIRED_DECL)
        self.assertNotIn("ASkyguardMission02IntegrationDirector", REQUIRED_DECL)
        self.assertNotIn("ConfigureMissionDefinition", REQUIRED_DECL)
        self.assertNotIn("NotifyObjectiveProgress", REQUIRED_DECL)
        self.assertNotIn("NotifyProtectedAssetFailed", REQUIRED_DECL)
        self.assertNotIn("BindCampaignRuntime", REQUIRED_DECL)
        self.assertNotIn("IsCorePlayableReady", REQUIRED_DECL)
        self.assertNotIn("GetReadiness", REQUIRED_DECL)
        self.assertNotIn("SynchronizeRuntimeState", REQUIRED_DECL)
        self.assertNotIn("GetGunner", REQUIRED_DECL)
        self.assertNotIn("GetPathfinder", REQUIRED_DECL)
        self.assertNotIn("ValidateMissionContract", REQUIRED_DECL)
        self.assertNotIn("ConfigureFromMission", REQUIRED_DECL)
        self.assertNotIn("AdvanceBriefing", REQUIRED_DECL)
        self.assertNotIn("SetAssetsReady", REQUIRED_DECL)
        self.assertNotIn("AcknowledgeAndLaunch", REQUIRED_DECL)
        self.assertNotIn("CanLaunch", REQUIRED_DECL)
        self.assertNotIn("GetElapsedSeconds", REQUIRED_DECL)
        self.assertNotIn("GetBriefingState", REQUIRED_DECL)
        self.assertNotIn("GetMinimumWarmupSeconds", REQUIRED_DECL)
        self.assertNotIn("GetBriefingText", REQUIRED_DECL)
        self.assertNotIn("GetRadioChatter", REQUIRED_DECL)
        self.assertNotIn("GetPresentation", REQUIRED_DECL)
        self.assertNotIn("GetMissionTitle", REQUIRED_DECL)
        self.assertNotIn("AcknowledgeBriefing", REQUIRED_DECL)
        self.assertNotIn("LaunchSortie", REQUIRED_DECL)
        self.assertNotIn("HullCollider", REQUIRED_DECL)
        self.assertNotIn("OpticalTracker", REQUIRED_DECL)
        self.assertNotIn("WeaponServo", REQUIRED_DECL)
        self.assertNotIn("CountermeasurePod", REQUIRED_DECL)
        self.assertNotIn("MinHeightFromOriginCm", REQUIRED_DECL)
        self.assertNotIn("RadarNode", REQUIRED_DECL)
        self.assertNotIn("ESkyguardMission02WaveState", REQUIRED_DECL)
        self.assertNotIn("HarborIndustrial", REQUIRED_DECL)
        self.assertNotIn("MaxIntegrity", REQUIRED_DECL)
        self.assertNotIn("CurrentIntegrity", REQUIRED_DECL)
        self.assertNotIn("FillAndFinalize", REQUIRED_DECL)
        self.assertNotIn("FillAndFail", REQUIRED_DECL)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, REQUIRED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_INTEGRATION} {REQUIRED_DECL}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{REQUIRED_DECL}\n}}\n"
        self.assertTrue(has_declaration(one_line, REQUIRED_DECL))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, REQUIRED_DECL),
            section,
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", REQUIRED_DECL)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_get_mission_id_cpp_body(self) -> None:
        locked_only = f"{REQUIRED_DECL}\n"
        self.assertIn("{", REQUIRED_DECL)
        self.assertIn("}", REQUIRED_DECL)
        self.assertIn("return ", REQUIRED_DECL)
        ...
        self.assertNotIn("return false", REQUIRED_DECL)
        self.assertNotIn("return true", REQUIRED_DECL)
        self.assertNotIn("INDEX_NONE", REQUIRED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("GetMissionId", REQUIRED_DECL)
        self.assertTrue(REQUIRED_DECL.startswith("static FName"))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, REQUIRED_DECL)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", REQUIRED_DECL)
        self.assertNotIn("CurrentIntegrity", REQUIRED_DECL)
        self.assertNotIn("SkyguardApacheAircraft.h", REQUIRED_DECL)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, REQUIRED_DECL)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", REQUIRED_DECL)
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        self.assertNotIn("550.f", REQUIRED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{REQUIRED_DECL}\n"
        self.assertEqual(
            require_declaration(locked_only, REQUIRED_DECL),
            REQUIRED_DECL,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, REQUIRED_DECL)
        ...
        self.assertNotIn("BindCampaignRuntime", locked_only)
        ...
        self.assertIn("GetMissionId", locked_only)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", REQUIRED_DECL)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", REQUIRED_DECL)
        self.assertNotIn("ASkyguardIronRainBoss", REQUIRED_DECL)
        self.assertNotIn("ASkyguardRadarGhostBoss", REQUIRED_DECL)
        self.assertNotIn("ASkyguardTempestBoss", section)
        self.assertNotIn("ASkyguardLastFlightBoss", REQUIRED_DECL)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 GetMissionId method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{REQUIRED_DECL}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, REQUIRED_DECL.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                REQUIRED_DECL.lower(),
                "mission10 GetObjectiveRuntime contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, REQUIRED_DECL)

    def test_contract_is_get_mission_id_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertIn("GetMissionId", REQUIRED_DECL)
        self.assertIn('TEXT("M02_HarborShield")', REQUIRED_DECL)
        self.assertTrue(REQUIRED_DECL.endswith("}"))
        self.assertFalse(REQUIRED_DECL.endswith(";"))
        self.assertIn(ORIGIN_MAIN_INLINE, section)
        self.assertIn(UFUNCTION_INTEGRATION, section)

    def test_sibling_director_fields_do_not_satisfy_get_mission_id(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, REQUIRED_DECL)
            )
            self.assertNotEqual(REQUIRED_DECL, leftover)
        self.assertIn(
    ...
    def test_leftover_harbor_mission02_initialize_does_not_satisfy(
        ...
        leftover = (
            "class SKYGUARD52_API ASkyguardUnrelatedHarborDirector "
            ": public AActor\n"
            "{\n"
            "public:\n"
            "\tUFUNCTION(BlueprintCallable, "
    ...
    def test_leftover_bind_runtime_actors_is_not_the_required_decl(
        ...
        self.assertNotEqual(BIND_RUNTIME_ACTORS, "GetMissionId")
        self.assertNotIn(BIND_RUNTIME_ACTORS, REQUIRED_DECL)
        self.assertTrue(
            REQUIRED_DECL.startswith("static FName GetMissionId("),
            REQUIRED_DECL,
        )
        self.assertIn("()", REQUIRED_DECL)
    ...
    def test_contract_does_not_relock_leftover_get_mission_id_drafts(
        ...
        locked_only = f"{REQUIRED_DECL}\n"
        self.assertIn("GetMissionId", REQUIRED_DECL)
        self.assertNotIn("M09_SaturationAttack", REQUIRED_DECL)
        self.assertNotIn("M08_RescueCover", REQUIRED_DECL)
        self.assertNotIn("M07_SearchIntercept", REQUIRED_DECL)
        self.assertNotIn("M06_AirfieldDefense", REQUIRED_DECL)
        self.assertNotIn("M05_StormFront", REQUIRED_DECL)
        self.assertNotIn("M04_NightBlackout", REQUIRED_DECL)
        self.assertNotIn("M03_ConvoyEscort", REQUIRED_DECL)
        self.assertNotIn("M01_CoastalIntercept", REQUIRED_DECL)
        self.assertNotIn("M10_EvacuationFinale", REQUIRED_DECL)
        self.assertNotIn("M09_SaturationAttack", locked_only)
        self.assertIn(
            "Scripts/tests/test_mission10_get_mission_id"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_get_mission_id"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission03_get_mission_id"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        for token in LEFTOVER_MISSION09_GET_MISSION_ID_NOT_LOCKED:
            if token == "GetMissionId":
                continue
            self.assertNotIn(token, REQUIRED_DECL)
    ...
    def test_leftover_mission07_initialize_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_leftover_mission08_initialize_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_leftover_mission05_synchronize_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission05IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission05_synchronize_runtime_state"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        for token in LEFTOVER_MISSION05_SYNCHRONIZE_NOT_LOCKED:
            self.assertNotIn(token, REQUIRED_DECL)
        self.assertNotIn("Mission05", UFUNCTION_INTEGRATION)

    def test_leftover_mission06_synchronize_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission06IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission06_synchronize_runtime_state"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        for token in LEFTOVER_MISSION06_SYNCHRONIZE_NOT_LOCKED:
            self.assertNotIn(token, REQUIRED_DECL)
        self.assertNotIn("Mission06", UFUNCTION_INTEGRATION)

    def test_leftover_mission07_synchronize_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission07IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission07_synchronize_runtime_state"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        for token in LEFTOVER_MISSION07_SYNCHRONIZE_NOT_LOCKED:
            self.assertNotIn(token, REQUIRED_DECL)
        self.assertNotIn("Mission07", UFUNCTION_INTEGRATION)

    def test_leftover_mission08_synchronize_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission08IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        for token in LEFTOVER_MISSION08_SYNCHRONIZE_NOT_LOCKED:
            self.assertNotIn(token, REQUIRED_DECL)
        self.assertNotIn("Mission08", UFUNCTION_INTEGRATION)
        self.assertNotIn(
            "cursor/mission08-synchronize-runtime-state-decl-contract-c332",
    ...
    def test_contract_does_not_relock_leftover_notify_protected_asset_failed(
        self,
    ) -> None:
        locked_only = f"{REQUIRED_DECL}\n"
        for token in LEFTOVER_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REQUIRED_DECL)
        self.assertIn(
            "Scripts/tests/test_mission08_notify_protected_asset_failed"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission07_notify_protected_asset_failed"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission06_notify_protected_asset_failed"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission05_notify_protected_asset_failed"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertNotIn("NotifyProtectedAssetFailed", REQUIRED_DECL)

    def test_locked_scripts_include_sibling_mission09_contracts(self) -> None:
        siblings = (
            ...
            "_decl_contract.py",
            "Scripts/tests/test_mission09_start_next_wave"
            "_decl_contract.py",
            "Scripts/tests/test_mission09_notify_threat_destroyed"
            "_decl_contract.py",
            "Scripts/tests/test_mission09_notify_protected_target_damage"
            "_decl_contract.py",
            ...
            "_decl_contract.py",
            "Scripts/tests/test_mission09_get_objective_runtime"
            "_decl_contract.py",
            "Scripts/tests/test_mission09_get_mission_id"
            "_decl_contract.py",
            "Scripts/tests/test_mission09_validate_mission_contract"
    ...
    def test_leftover_mission09_synchronize_does_not_satisfy(self) -> None:
        leftover = (
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission09_synchronize_runtime_state"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        for token in LEFTOVER_MISSION09_SYNCHRONIZE_NOT_LOCKED:
            self.assertNotIn(token, REQUIRED_DECL)
        self.assertNotIn("Mission09", UFUNCTION_INTEGRATION)
        self.assertNotIn(
            "cursor/mission09-synchronize-runtime-state-decl-contract-c332",
    ...
    def test_contract_does_not_relock_leftover_mission10_route_phase_enum(
        ...
        self.assertNotIn("GetRoutePhase", REQUIRED_DECL)
    ...
    def test_contract_does_not_relock_leftover_mission10_protected_group(
        ...
        self.assertNotIn("Protection", UFUNCTION_INTEGRATION)
        self.assertNotIn("GetProtectedGroup", REQUIRED_DECL)
    ...
    def test_leftover_mission10_sibling_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("HandleDroneCityImpact", REQUIRED_DECL)
        self.assertNotIn("UFUNCTION", GET_DAY_BEAT_KIT)
        self.assertNotIn("StartPhaseWave", REQUIRED_DECL)
        self.assertNotIn("GetRoutePhase", REQUIRED_DECL)
        self.assertNotIn("ConfigureMissionDefinition", REQUIRED_DECL)
        self.assertNotIn("ValidateWeaponRelease", REQUIRED_DECL)

    def test_locked_scripts_include_sibling_mission10_contracts(self) -> None:
        siblings = (
            "Scripts/tests/test_mission10_initialize_playable_mission"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_configure_mission_definition"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_start_phase_wave"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_notify_threat_destroyed"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_validate_weapon_release"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_synchronize_runtime_state"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_notify_protected_asset_failed"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_notify_protected_group_damage"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_get_objective_runtime"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_get_readiness"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_is_core_playable_ready"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_get_route_phase"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_get_remaining_threats_in_wave"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_get_rejected_weapon_releases"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_get_protected_group"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_get_surviving_protected_group_count"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_validate_mission_contract"
            "_decl_contract.py",
            ...
            "Scripts/tests/test_mission03_get_mission_id"
            "_decl_contract.py",
            "Scripts/tests/test_mission04_get_mission_id"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_root_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_briefing_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_audio_director_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_sortie_presentation_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_readiness_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_campaign_definition_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_mission_definition_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission02_initialize_playable_mission"
            "_decl_contract.py",
    ...
    def test_leftover_mission04_get_objective_runtime_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission04IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        for token in LEFTOVER_MISSION04_GET_OBJECTIVE_RUNTIME_NOT_LOCKED:
            self.assertNotIn(token, REQUIRED_DECL)

    def test_leftover_mission05_get_objective_runtime_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission05IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission05_get_objective_runtime"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        for token in LEFTOVER_MISSION05_GET_OBJECTIVE_RUNTIME_NOT_LOCKED:
            self.assertNotIn(token, REQUIRED_DECL)

    def test_leftover_mission06_get_objective_runtime_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission06IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission06_get_objective_runtime"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        for token in LEFTOVER_MISSION06_GET_OBJECTIVE_RUNTIME_NOT_LOCKED:
            self.assertNotIn(token, REQUIRED_DECL)

    def test_leftover_mission07_get_objective_runtime_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission07IntegrationDirector "
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission07_get_objective_runtime"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        for token in LEFTOVER_MISSION07_GET_OBJECTIVE_RUNTIME_NOT_LOCKED:
            self.assertNotIn(token, REQUIRED_DECL)
        self.assertNotIn("Mission07", UFUNCTION_INTEGRATION)

    def test_leftover_mission08_get_objective_runtime_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission08IntegrationDirector "
        ...
        self.assertIn("missing", str(raised.exception).lower())
        locked_only = f"{REQUIRED_DECL}\n"
        for token in LEFTOVER_MISSION08_GET_OBJECTIVE_RUNTIME_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REQUIRED_DECL)
        self.assertIn(
    ...
    def test_leftover_mission09_get_objective_runtime_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission09IntegrationDirector "
        ...
        self.assertIn("missing", str(raised.exception).lower())
        locked_only = f"{REQUIRED_DECL}\n"
        for token in LEFTOVER_MISSION09_GET_OBJECTIVE_RUNTIME_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REQUIRED_DECL)
        self.assertIn(
            "Scripts/tests/test_mission09_get_objective_runtime"
    ...
    def test_origin_main_inline_body_is_accepted_without_locking_body(self) -> None:
        section = public_section(origin_main_header())
        self.assertIn(ORIGIN_MAIN_INLINE, section)
        self.assertTrue(has_declaration(section, REQUIRED_DECL), section)
        self.assertIn("{", REQUIRED_DECL)
        self.assertIn("}", REQUIRED_DECL)
        self.assertIn("return ", REQUIRED_DECL)
        self.assertIn('TEXT("M02_HarborShield")', REQUIRED_DECL)
        self.assertIn("GetMissionId", REQUIRED_DECL)
        self.assertNotIn("RejectedWeaponReleases;", REQUIRED_DECL)
        self.assertNotIn("M09_SaturationAttack", REQUIRED_DECL)
        self.assertIn(UFUNCTION_INTEGRATION, section)

    def test_contract_does_not_reopen_leftover_mission08_get_rejected(
        self,
    ) -> None:
        locked_only = f"{REQUIRED_DECL}\n"
        for token in LEFTOVER_MISSION08_GET_REJECTED_WEAPON_RELEASES_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REQUIRED_DECL)
        self.assertIn(
            "Scripts/tests/test_mission08_get_rejected_weapon_releases"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertNotIn("Mission08", UFUNCTION_INTEGRATION)
        ...
        self.assertNotEqual(leftover_m08_safety, UFUNCTION_INTEGRATION)
        self.assertNotIn(
            "cursor/mission08-get-rejected-weapon-releases-decl-contract-c332",
            REQUIRED_DECL,
        )
    ...
    def test_contract_does_not_relock_leftover_mission10_get_objective_runtime(
        self,
    ) -> None:
        locked_only = f"{REQUIRED_DECL}\n"
        for token in LEFTOVER_MISSION10_GET_OBJECTIVE_RUNTIME_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REQUIRED_DECL)
        self.assertIn(
            "Scripts/tests/test_mission10_get_objective_runtime"
        ...
        self.assertNotIn("GetObjectiveRuntime", REQUIRED_DECL)
        self.assertNotIn("USkyguardObjectiveRuntime", REQUIRED_DECL)
    def test_contract_does_not_reopen_leftover_mission09_get_mission_id(
        self,
    ) -> None:
        locked_only = f"{REQUIRED_DECL}\n"
        for token in LEFTOVER_MISSION09_GET_MISSION_ID_NOT_LOCKED:
    ...
    def test_contract_does_not_reopen_leftover_mission10_get_mission_id(
        self,
    ) -> None:
        locked_only = f"{REQUIRED_DECL}\n"
        for token in LEFTOVER_MISSION10_GET_MISSION_ID_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REQUIRED_DECL)
        self.assertIn(
            "Scripts/tests/test_mission10_get_mission_id"
    ...
    def test_contract_does_not_reopen_leftover_mission01_get_mission_id(
        self,
    ) -> None:
        locked_only = f"{REQUIRED_DECL}\n"
        for token in LEFTOVER_MISSION01_GET_MISSION_ID_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REQUIRED_DECL)
        self.assertIn(
            "Scripts/tests/test_mission01_get_mission_id"
    ...
    def test_contract_does_not_reopen_leftover_mission03_get_mission_id(
        self,
    ) -> None:
        locked_only = f"{REQUIRED_DECL}\n"
        for token in LEFTOVER_MISSION03_GET_MISSION_ID_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REQUIRED_DECL)
        self.assertIn(
            "Scripts/tests/test_mission03_get_mission_id"
    ...
    def test_leftover_mission02_sibling_methods_do_not_satisfy(self) -> None:
        for leftover in LEFTOVER_MISSION02_SIBLING_METHODS_NOT_LOCKED:
            if leftover in ("GetMissionId", GET_MISSION_ID):
                continue
            region = f"\t{leftover}\n"
            self.assertFalse(
                has_declaration(region, REQUIRED_DECL),
        ...
        locked_only = f"{REQUIRED_DECL}\n"
        for token in LEFTOVER_MISSION02_SIBLING_METHODS_NOT_LOCKED:
            if token in ("GetMissionId", GET_MISSION_ID):
                continue
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REQUIRED_DECL)
        self.assertIn(
        ...
        self.assertNotIn("NotifyFuelTerminalDamage", REQUIRED_DECL)
        self.assertNotIn("GetCurrentWaveIndex", REQUIRED_DECL)
        self.assertNotIn("GetFuelTerminalIntegrity", REQUIRED_DECL)
        self.assertNotIn("cursor/m02-director-api-tests-1c8b", REQUIRED_DECL)
