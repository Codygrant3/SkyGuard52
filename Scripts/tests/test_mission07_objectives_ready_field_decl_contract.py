...
# Mission07 IntegrationReadiness bObjectivesReady
...
# FIELD #1000 / branch cursor/mission06-
# objectives-ready-field-decl-contract-c332. It is
...
# This readiness-struct field sits after bRadarGhostReady.
# Skip leftover b + Ya + kRuntimeReady forever (it sits
# after bMapAssemblyReady and before bGunnerReady). This contract
# is bObjectivesReady after bRadarGhostReady. Skip leftover
...
# drafts #674-#998 including leftover Mission02
...
# Parse the struct body between struct
# FSkyguardMission07IntegrationReadiness and the
# following UCLASS / ASkyguardMission07IntegrationDirector.
# Do not parse leftover
...
# bMissionDefinitionValid #1028 / bCampaignDefinitionValid
# #1029 / bMapAssemblyReady #1030 / bGunnerReady #1031.
# Do not reopen leftover Mission06 bObjectivesReady #1000.
...
# Mission05 bObjectivesReady #968.
...
LEFTOVER_MISSION07_READINESS_SIBLINGS_NOT_LOCKED = (
    "test_mission07_mission_definition_valid_field_decl_contract.py",
    "test_mission07_campaign_definition_valid_field_decl_contract.py",
...
class Mission07ObjectivesReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 bObjectivesReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission07 bObjectivesReady contains "
    ...
    def test_contract_does_not_parse_director_class_or_storm_runtime(
        ...
        for token in LEFTOVER_MISSION07_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION07_READINESS_SIBLINGS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
    ...
    def test_leftover_same_name_objectives_ready_contracts_stay_locked(
        ...
        self.assertIn(
            "Scripts/tests/test_mission07_mission_definition_valid"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
