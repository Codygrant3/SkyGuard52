# THIS IS leftover-safe ASkyguardProtectAsset::ApplyDamage.
...
# Do NOT contract IsDestroyed / GetIntegrityFraction /
...
TARGET_WRONG_SIBLING = "void ResetIntegrity();"
LOCKED_DECL = TARGET
UFUNCTION_CALLABLE = (
    'UFUNCTION(BlueprintCallable, Category="Skyguard|Campaign")'
)
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # param, a bool/float return, or a sibling ResetIntegrity
...
class ProtectAssetApplyDamageDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "protect-asset ApplyDamage decl contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(Path(__file__).name.endswith(
            "test_protect_asset_apply_damage"
            "_decl_contract.py"
        ))
