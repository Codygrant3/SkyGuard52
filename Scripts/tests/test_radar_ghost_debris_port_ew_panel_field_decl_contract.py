...
# INDEX_NONE or lock DebrisPortEWPanel construction
...
# DebrisPortEWPanel;`); accept that form and other
...
# isolated-test drafts #107–#535 including
...
# leftover isolated-test drafts #107–#535,
# leftover searchlight-track-runtime-defaults
...
# drafts #107–#535 stay sibling-only.
LOCKED_SCRIPTS = (
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardRadarGhostBoss::DebrisPortEWPanel",
    "SkyguardRadarGhostBoss.cpp",
    "SetExposed",
...
class RadarGhostDebrisPortEWPanelFieldDeclContractTests(unittest.TestCase):
    def test_radar_ghost_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, DEBRIS_PORT_EW_PANEL_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertIn("DebrisPortEWPanel", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_missing_debris_port_ew_panel_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardRadarGhostBoss();\n"
            f"\t{SIGNATURE_MODULATOR_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertIn("DebrisPortEWPanel", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertIn("DebrisPortEWPanel", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UPROPERTY", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("VisibleAnywhere", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("BlueprintReadOnly", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("Category", DEBRIS_PORT_EW_PANEL_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertIn("DebrisPortEWPanel", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUStaticMeshComponent* DebrisPortEWPanel;\n"
        )
        as_array = (
        ...
        scene = (
            "\tTObjectPtr<USceneComponent> DebrisPortEWPanel;\n"
        )
        mesh = (
            "\tTObjectPtr<USkyguardBossWeakPointComponent> "
            "DebrisPortEWPanel;\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, DEBRIS_PORT_EW_PANEL_FIELD)
            self.assertIn("DebrisPortEWPanel", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_debris_port_ew_panel_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, DEBRIS_PORT_EW_PANEL_FIELD),
            DEBRIS_PORT_EW_PANEL_FIELD,
        )
        self.assertTrue(has_declaration(section, DEBRIS_PORT_EW_PANEL_FIELD))
        self.assertEqual(declaration_count(section, DEBRIS_PORT_EW_PANEL_FIELD), 1)
        self.assertTrue(
            DEBRIS_PORT_EW_PANEL_FIELD.startswith(
                "TObjectPtr<UStaticMeshComponent> "
            ),
            DEBRIS_PORT_EW_PANEL_FIELD,
        )
        self.assertTrue(DEBRIS_PORT_EW_PANEL_FIELD.endswith(";"), DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertIn("DebrisPortEWPanel", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertIn(
            "UStaticMeshComponent",
            DEBRIS_PORT_EW_PANEL_FIELD,
        )
        self.assertIn("TObjectPtr<", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("TArray<", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("=", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("INDEX_NONE", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("UFUNCTION", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("{", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("}", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("return ", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("CommandAntenna", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("ControlLinkage", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("NoseCamera", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("DebrisCenter", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("DebrisTail", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("DebrisNose", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("DebrisSpine", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("AdvanceEncounter", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("ResetEncounterState", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("IsRouteStateSafe", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("GetRouteProgress", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("GetEffectiveSpeedMultiplier", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("IsAttackTelegraphActive", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("GetTelegraphsTriggered", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("RadarNode", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("BeginTerminalStrikeCycle", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("OpenGuidanceArrayExposure", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("IssueClimbCommand", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("DivertWreckFromCivilians", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("SetCivilianSeparationMeters", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("GetCivilianSeparationMeters", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("GetFinaleStage", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("IsClimbCommandIssued", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("IsWreckDiverted", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("GetObjectiveMilestonesReached", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("ESkyguardLastFlightStage", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("GetGunnerMount", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("FaceWorldLocation", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("PortGuidanceArray", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("DebrisArmorPort", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("SetSearchlightTracked", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("SetContactIdentified", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("SetLightningExposed", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("HullCollider", DEBRIS_PORT_EW_PANEL_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_DESTRUCTION} {DEBRIS_PORT_EW_PANEL_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(
                declaration_count(section, DEBRIS_PORT_EW_PANEL_FIELD),
                1,
            )
        one_line = f"{{\npublic:\n\t{DEBRIS_PORT_EW_PANEL_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, DEBRIS_PORT_EW_PANEL_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, DEBRIS_PORT_EW_PANEL_FIELD),
            section,
    ...
    def test_assigned_debris_port_ew_panel_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<UStaticMeshComponent> "
            "DebrisPortEWPanel = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertIn("DebrisPortEWPanel", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, DEBRIS_PORT_EW_PANEL_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("DebrisPortEWPanel", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, DEBRIS_PORT_EW_PANEL_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{DEBRIS_PORT_EW_PANEL_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, DEBRIS_PORT_EW_PANEL_FIELD)
        ...
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_DESTRUCTION, section)
        self.assertTrue(has_declaration(section, DEBRIS_PORT_EW_PANEL_FIELD), section)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            DEBRIS_PORT_EW_PANEL_FIELD.startswith("UFUNCTION"),
            DEBRIS_PORT_EW_PANEL_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, DEBRIS_PORT_EW_PANEL_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", DEBRIS_PORT_EW_PANEL_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_debris_port_ew_panel_cpp_body(self) -> None:
        locked_only = f"{DEBRIS_PORT_EW_PANEL_FIELD}\n"
        self.assertNotIn("{", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("}", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("return ", DEBRIS_PORT_EW_PANEL_FIELD)
        ...
        self.assertNotIn("SkyguardRadarGhostBoss.cpp", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("SkyguardRadarGhostBoss.cpp", locked_only)
        self.assertNotIn("return false", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("return true", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("CreateDefaultSubobject", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("SetExposed", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            DEBRIS_PORT_EW_PANEL_FIELD,
        )
        self.assertNotIn("SetBossPhase", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", DEBRIS_PORT_EW_PANEL_FIELD)

    def test_contract_does_not_relock_sibling_tempest_fields(self) -> None:
        locked_only = f"{DEBRIS_PORT_EW_PANEL_FIELD}\n"
        for token in SIBLING_TEMPEST_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("PortDischargeBoom", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("StarboardDischargeBoom", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("EngineIntake", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("DebrisPortPanel", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("DebrisStarboardPanel", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("DebrisIntakePanel", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("RequiredLockStabilitySeconds", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertIn(
            "UStaticMeshComponent",
            DEBRIS_PORT_EW_PANEL_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_encounter_controller(
        ...
        for token in LEFTOVER_ENCOUNTER_CONTROLLER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("EncounterController", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_control_servo(self) -> None:
        ...
        for token in LEFTOVER_CONTROL_SERVO_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("ControlServo", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_sibling_iron_rain_fields(self) -> None:
        ...
        for token in SIBLING_IRON_RAIN_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("DispenserCenter", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("MaxReleasesPerBay", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertIn("DebrisPortEWPanel", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_dispenser_starboard(
        ...
        for token in LEFTOVER_DISPENSER_STARBOARD_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("DispenserStarboard", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_get_maneuver(self) -> None:
        ...
        for token in LEFTOVER_GET_MANEUVER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("GetManeuver", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_open_first_window(), DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn(leftover_open_final_window(), locked_only)
        self.assertNotIn(leftover_open_final_window(), DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn(leftover_arm_command_core_path(), locked_only)
        self.assertNotIn(leftover_arm_command_core_path(), DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn(leftover_apply_strike(), locked_only)
        self.assertNotIn(leftover_apply_strike(), DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn(leftover_is_lock_eligible(), locked_only)
        self.assertNotIn(leftover_is_lock_eligible(), DEBRIS_PORT_EW_PANEL_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, locked_only)
            self.assertNotIn(name, DEBRIS_PORT_EW_PANEL_FIELD)
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_debris_getters(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("GetDefeatDebrisPieceCount", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("GetMaxDefeatDebrisPieces", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("SetSearchlightTracked", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("ASkyguardBlackKiteBoss", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("SetContactIdentified", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("OpenOrbitExposure", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("IsContactIdentified", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_sibling_radar_ghost_fields(self) -> None:
        ...
        for token in SIBLING_RADAR_GHOST_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("SignatureModulator", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("RadarReceiver", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("CoolingDoor", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("DebrisStarboardEWPanel", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("DebrisCoolingDoor", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertIn("DebrisPortEWPanel", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_dispenser_port(self) -> None:
        ...
        for token in LEFTOVER_DISPENSER_PORT_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("DispenserPort", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest_methods(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("SetLightningExposed", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("ApplyCorrectiveBankGust", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("IsLightningExposed", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("GetLockStabilitySeconds", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn(leftover_advance_stabilized_lock(), DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn(leftover_arm_break_finish(), DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn(leftover_is_break_finish_armed(), DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        for token in LEFTOVER_PATROL_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("ASkyguardPatrolShip", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        ...
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            ...
            self.assertNotIn(neighbor, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("ASkyguardGunner", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("SkyguardRadarNode", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            ...
            self.assertNotIn(token, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("MaxIntegrity", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("CurrentIntegrity", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn(
            "SkyguardPathfinderEncounterController.h",
            DEBRIS_PORT_EW_PANEL_FIELD,
        )
    ...
    def test_contract_does_not_open_leftover_weak_point_component_header(
        ...
        self.assertNotIn(leftover_header, DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", DEBRIS_PORT_EW_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{DEBRIS_PORT_EW_PANEL_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, DEBRIS_PORT_EW_PANEL_FIELD),
            DEBRIS_PORT_EW_PANEL_FIELD,
        )
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardRadarGhostBoss::DebrisPortEWPanel", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "radar ghost DebrisPortEWPanel field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{DEBRIS_PORT_EW_PANEL_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, DEBRIS_PORT_EW_PANEL_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                DEBRIS_PORT_EW_PANEL_FIELD.lower(),
                "radar ghost DebrisPortEWPanel contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, DEBRIS_PORT_EW_PANEL_FIELD)

    def test_contract_is_debris_port_ew_panel_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertTrue(DEBRIS_PORT_EW_PANEL_FIELD.endswith(";"))
        self.assertNotIn("=", DEBRIS_PORT_EW_PANEL_FIELD)
        self.assertIn(UPROPERTY_DESTRUCTION, section)
