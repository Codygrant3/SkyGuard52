...
# Leftover #56–#64 plus Mission 07 production sources and merged #103.
...
# Search-sector (#218), search-track (#219), protected-target runtime
# (#221), and protected-target enum (#223) are sibling Mission 07 contracts.
LOCKED_SCRIPTS = (
...
# Apache CPG night-search/intercept wave progression. Not Yak-52 intercept
# states. This is the seven-state list; Searching is required.
LIVE_WAVE_STATES = [
    "Briefing",
    "Searching",
    "AwaitingWave",
...
# Search-sector (#218), search-track (#219), protected-target runtime
# (#221), protected-target enum (#223), and readiness (bYakRuntimeReady)
# stay unlocked.
SIBLING_TYPES = (
...
class Mission07WaveStateEnumContractTests(unittest.TestCase):
    ...
    def test_missing_enum_fails_closed(self) -> None:
        ...
        self.assertIn("ESkyguardMission07WaveState", str(raised.exception))
    ...
    def test_enumerators_match_live_order(self) -> None:
        ...
        self.assertNotEqual(len(enumerators), 6, enumerators)
        self.assertIn("Searching", enumerators)
        self.assertNotEqual(enumerators, SIX_STATE_WAVE_LIST)
        body = enum_body(header, "ESkyguardMission07WaveState")
