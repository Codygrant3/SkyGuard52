...
# bPCGGenerationAuthorized FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bPCGGenerationAuthorized = false; one-line /
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bPCGGenerationAuthorized FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# bool bPCGGenerationAuthorized = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover Mission01 environment-readiness-defaults
...
# FSkyguardMission01EnvironmentReadiness bPCGGenerationAuthorized
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bPCGGenerationAuthorized = false;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bPCGGenerationAuthorized. THIS IS NOT leftover mission-map-
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bPCGGenerationAuthorized. THIS IS NOT leftover Mission05
...
# Mission01 EnvironmentReadiness bPCGGenerationAuthorized
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bPCGGenerationAuthorized = false;
# one-line / split-line UPROPERTY wraps;
...
# bPCGGenerationAuthorized FIELD (declaration-only). It is
...
TARGET = "bool bPCGGenerationAuthorized = false;"
TARGET_WRONG = "bool bPCGGenerationAuthorized = true;"
LOCKED_DECL = TARGET
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*bool\s+bPCGGenerationAuthorized\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for bool bPCGGenerationAuthorized is missing from "
...
class Mission01EnvironmentReadinessPcgGenerationAuthorizedFieldDeclContractTests(unittest.TestCase):
    def test_environment_readiness_struct_exists(self) -> None:
        ...
        self.assertIn("bPCGGenerationAuthorized", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bPCGGenerationAuthorized", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_pcg_generation_authorized_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bPCGGenerationAuthorized"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bPCGGenerationAuthorized", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bPCGGenerationAuthorized", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bPCGGenerationAuthorized"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bPCGGenerationAuthorized", locked_only)
