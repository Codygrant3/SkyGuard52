...
# Mission02 CampaignDefinition FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps) on
# ASkyguardMission02IntegrationDirector. It is
# NOT leftover Mission10 CampaignDefinition field
# #798 / branch cursor/mission10-campaign-
# definition-field-decl-contract-c332. It is
# NOT leftover Mission10 CampaignDefinition field
# #798, NOT leftover Mission01 CampaignDefinition field
...
# Integration, not Mission01 / Mission10 / Mission03 /
...
# drafts #674-#847, leftover Apache
...
# RadioChatter / SortiePresentation, leftover
# Mission01 / Mission03-10 CampaignDefinition
...
class Mission02CampaignDefinitionFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 CampaignDefinition field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 CampaignDefinition contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_campaign_definition_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission10_campaign_definition_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission10IntegrationDirector "
    ...
    def test_leftover_mission02_sibling_field_contracts_stay_locked(
        ...
        locked_only = f"{LOCKED_DECL}\n"
        self.assertNotIn("bCampaignDefinitionValid", locked_only)
        self.assertNotIn("bCampaignRuntimeStarted", locked_only)
        for token in leftover_spawn_name_tokens():
            self.assertNotIn(token, LOCKED_DECL)
