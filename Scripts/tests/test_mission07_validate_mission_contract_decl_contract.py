...
# Mission07 Integration ValidateMissionContract METHOD on
# ASkyguardMission07IntegrationDirector. It is
# NOT leftover Mission06 ValidateMissionContract #707,
# NOT leftover Mission06 GetMissionId #704,
# NOT leftover Mission07 GetMissionId,
# NOT leftover GetNightBeatKit without UFUNCTION,
...
# origin/main is a split-line declaration-only method
# (`static bool ValidateMissionContract(
# const USkyguardMissionDefinition* Mission,
# TArray<FText>& OutErrors);`);
# require that form, accept other one-line / split-line
...
# #668/#669. Do not reopen leftover open
# drafts #674–#725. Skip leftover #664.
...
class Mission07ValidateMissionContractDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("BlueprintCallable", VALIDATE_MISSION_CONTRACT)
    ...
    def test_validate_mission_contract_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("GetSearchSector", VALIDATE_MISSION_CONTRACT)
        ...
        self.assertNotIn("ASkyguardMission06IntegrationDirector", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("ESkyguardMission06WaveState", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("ESkyguardMission07WaveState", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("FSkyguardMission07IntegrationReadiness", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("FSkyguardSearchTrackRuntime", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("ClassifyFalseTrack", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("ConfirmRadarGhostIdentification", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("NotifyProtectedTargetDamage", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("AdvanceReinforcementTimer", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetReadiness", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetClassifiedFalseTrackCount", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("IsHostileContactConfirmed", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetReinforcementTimeRemaining", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetNightBeatKind", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetNightBeatIndex", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("TickNightBeatKit", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("ESkyguardAirfieldTarget", VALIDATE_MISSION_CONTRACT)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardRadarGhostBoss", VALIDATE_MISSION_CONTRACT)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 ValidateMissionContract method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission07 ValidateMissionContract contains "
    ...
    def test_leftover_environment_validate_mission_contract_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_validate_mission_contract"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission07_get_mission_id_does_not_satisfy(self) -> None:
        region = f"\t{GET_MISSION_ID}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(region, VALIDATE_MISSION_CONTRACT)
        self.assertIn("ValidateMissionContract", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_locked_scripts_include_sibling_mission07_contracts(self) -> None:
        siblings = (
        ...
        for script in siblings:
            ...
            self.assertNotIn(script, VALIDATE_MISSION_CONTRACT)
