...
# Mission08 IntegrationReadiness bProtectedTargetsReady
...
# before bGunnerReady — do not contract it),
# NOT leftover Mission08 bGunnerReady
# FIELD #1069 / branch cursor/
# mission08-gunner-ready-field-decl-
# contract-c332, NOT leftover Mission08
# bLifelineHunterReady FIELD (opening this
# wake) / branch cursor/mission08-lifeline-
# hunter-ready-field-decl-contract-c332,
# NOT leftover bObjectivesReady (in-flight)
# / branch cursor/mission08-objectives-ready-
# field-decl-contract-c332, NOT leftover
# bWavesReady #1073 / branch cursor/
# mission08-waves-ready-field-decl-contract-
# c332, NOT leftover Mission07
# bProtectedTargetsReady FIELD #1036 / branch
# cursor/mission07-protected-targets-ready-
# field-decl-contract-c332, NOT leftover
# Mission08 protected-target enum #a66a /
# leftover Mission08 protected-target-runtime-
# defaults #75e6, NOT leftover bBriefingReady
# (sibling this wave) / branch cursor/
# mission08-briefing-ready-field-decl-
# contract-c332, NOT leftover
# bRescueAnimationReady #1074 / branch cursor/
# mission08-rescue-animation-ready-field-decl-
# contract-c332, NOT leftover director
# Readiness #1066, NOT leftover retired-mount
# spawn, NOT leftover Mission08 director
# LifelineHunterSpawnLocation #1061 /
# LifelineHunterSpawnRotation #1062, NOT leftover
# Mission07 bRadarGhostReady FIELD / branch
# cursor/mission07-radar-ghost-ready-field-
...
# Do not reopen leftover Mission08 Blueprint
# UFUNCTION methods #729-#749. Do not reopen
# leftover Mission08 director Root #1044 through
# Readiness #1066. Do not reopen leftover
# FSkyguardMission08IntegrationReadiness
# bMissionDefinitionValid #1067 through
# bRescueAnimationReady #1074. Do not reopen
# leftover Mission07 readiness-struct
...
class Mission08RescueAnimationReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 bProtectedTargetsReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 bProtectedTargetsReady contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission08_protected"
            "_targets_ready_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_protected"
                "_targets_ready_field_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_lifeline"
            "_hunter_ready_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_objectives"
            "_ready_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_waves"
            "_ready_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_same_name_ready_contracts_stay_locked(
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_rescue_animation"
            "_ready_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission07_protected_targets"
            "_ready_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
