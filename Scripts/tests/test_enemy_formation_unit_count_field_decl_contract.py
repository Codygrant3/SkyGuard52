# THIS IS leftover-safe FSkyguardEnemyFormationDefinition UnitCount.
...
# if the initializer is missing or is not `= 3`,
# or if meta ClampMin/ClampMax is missing or wrong.
# Harbor 40/80 fail-closed in the parse window.
# Accept one-line and split-line UPROPERTY wraps.
# Parse STRUCT `FSkyguardEnemyFormationDefinition` body ONLY after
# `struct FSkyguardEnemyFormationDefinition`. Stop at
# `struct FSkyguardEnemyWaveDefinition` and later structs.
# Do NOT parse `FSkyguardEnemyWaveDefinition`
# (leftover enemy-wave-defaults #189 / leftover isolated
# WaveId #1344 plus Formations / StartTime drafts).
# Do NOT parse `FSkyguardRoutePoint`
# (leftover isolated fields #1339-#1343, leftover defaults #180).
...
# (leftover mission-definition field decls #350+).
# Do NOT parse leftover enemy-formation-defaults #183 / #2f1a.
# Do NOT parse leftover enemy-wave-defaults #189 / #dc07.
# Do NOT parse leftover mission-types-defaults-tests
# #153 / #f47d (keep that bulk file in LOCKED_SCRIPTS).
# Do NOT parse leftover #1332-#1349 RadioLine / RoutePoint /
# EnemyWave isolated field drafts.
# Do NOT parse leftover TheaterKit #1299-#1331.
# Do NOT parse leftover RadioLine #1332-#1338.
# Do NOT contract sibling fields FormationId remaining /
# Formation remaining / SpacingCentimeters remaining.
# THIS IS NOT leftover enemy-formation-defaults #183 / #2f1a.
# THIS IS NOT leftover enemy-wave-defaults #189 / #dc07.
# THIS IS NOT leftover EnemyWave isolated WaveId #1344
# plus Formations / StartTime drafts being opened.
# THIS IS NOT leftover route-point-defaults #180 / #0ac5.
# THIS IS NOT leftover RoutePoint isolated PointId #1339,
# WorldLocation #1340, LookAheadSeconds, AllowCombatOrbit,
# or TargetAirspeedKph draft.
...
# #1332-#1338.
# THIS IS NOT leftover radio-line-defaults #172 / #1dec.
# THIS IS NOT leftover radio-chatter-empty-fail-closed
# #177 / #52ae, leftover empty-queue #150 / #5137,
# leftover empty-line #121 / #fb2b.
...
# the bulk).
# THIS IS NOT leftover mission-definition Waves /
# Objectives / Route / Weather / ScoreRules field decls.
# Analog: leftover enemy-formation-defaults then this
# isolated UnitCount field decl, same as leftover
# enemy-wave-defaults then isolated WaveId.
# If a clone asserts VisibleAnywhere /
# Category="Skyguard|Theater" / BlueprintReadWrite /
# `FName WeatherIdentity` / `FName LineId` /
# `FName PointId` / `FName WaveId` / `FName FormationId` /
# `ESkyguardFormationType Formation` / bare no `=`,
# retarget: type is int32 UnitCount, initializer is
# `= 3`, specifiers are EditAnywhere + BlueprintReadOnly +
# meta = (ClampMin = "1", ClampMax = "32"), no Category.
...
STRUCT_NAME = "FSkyguardEnemyFormationDefinition"
...
ROUTE_POINT_NAME = "FSkyguardRoutePoint"
BOSS_WEAK_POINT_NAME = "FSkyguardBossWeakPointDefinition"
...
TARGET = "int32 UnitCount = 3;"
TARGET_WRONG_BARE = "int32 UnitCount;"
TARGET_WRONG_EQ_NONE = "int32 UnitCount = NAME_None;"
TARGET_WRONG_FALSE = "int32 UnitCount = false;"
TARGET_WRONG_TRUE = "int32 UnitCount = true;"
TARGET_WRONG_ZERO = "int32 UnitCount = 0.f;"
TARGET_WRONG_FLOAT = "float UnitCount = 3;"
TARGET_WRONG_ONE = "int32 UnitCount = 1;"
TARGET_WRONG_THIRTY_TWO = "int32 UnitCount = 32;"
TARGET_WRONG_FNAME = "FName UnitCount;"
...
UPROPERTY_EDIT_READONLY_NO_META = (
    "UPROPERTY(EditAnywhere, BlueprintReadOnly)"
)
UPROPERTY_COMPACT_META = (
    "UPROPERTY(EditAnywhere, BlueprintReadOnly, "
    'meta=(ClampMin="1", ClampMax="32"))'
)
...
STOP_BEFORE_BOSS_WEAK_POINT = "struct FSkyguardBossWeakPointDefinition"
...
STOP_BEFORE_FORMATION_TYPE = "enum class ESkyguardFormationType"
...
SIBLING_FORMATION_ID = "FormationId"
SIBLING_FORMATION = "Formation"
SIBLING_SPACING = "SpacingCentimeters"
LEFTOVER_WAVE_WAVE_ID = "WaveId"
LEFTOVER_WAVE_START_TIME = "StartTimeSeconds"
LEFTOVER_WAVE_FORMATIONS = "Formations"
LEFTOVER_WAVE_COMPLETION = "CompletionObjectiveId"
SIBLING_ROUTE_POINT_WORLD_LOCATION = "WorldLocation"
...
LEFTOVER_FORMATION_ID_SCRIPT = (
    "Scripts/tests/test_enemy_formation_formation_id"
    "_field_decl_contract.py"
)
LEFTOVER_FORMATION_FIELD_SCRIPT = (
    "Scripts/tests/test_enemy_formation_formation"
    "_field_decl_contract.py"
)
...
LEFTOVER_ENEMY_WAVE_WAVE_ID = (
    "Scripts/tests/test_enemy_wave_wave_id"
    "_field_decl_contract.py"
)
LEFTOVER_ENEMY_WAVE_FORMATIONS = (
    "Scripts/tests/test_enemy_wave_formations"
    "_field_decl_contract.py"
)
LEFTOVER_ENEMY_WAVE_START_TIME = (
    "Scripts/tests/test_enemy_wave_start_time_seconds"
    "_field_decl_contract.py"
)
LEFTOVER_FORMATION_TYPE_ENUM = (
    "Scripts/tests/test_enemy_formation_type_enum_contract.py"
)
LEFTOVER_FORMATION_TYPE_ENUM_PY = (
    "Scripts/tests/test_enemy_formation_type_enum.py"
)
LEFTOVER_FORMATION_TYPE_ENUM_TESTS = (
    "Scripts/tests/test_enemy_formation_type_enum_tests.py"
)
LEFTOVER_ENEMY_WAVE_DEFAULTS = (
    "Scripts/tests/test_enemy_wave_defaults_contract.py"
)
LEFTOVER_ENEMY_WAVE_DEFAULTS_PY = (
    "Scripts/tests/test_enemy_wave_defaults.py"
)
LEFTOVER_ENEMY_WAVE_DEFAULTS_TESTS = (
    "Scripts/tests/test_enemy_wave_defaults_tests.py"
)
LEFTOVER_ENEMY_FORMATION_DEFAULTS = (
    "Scripts/tests/test_enemy_formation_defaults_contract.py"
)
LEFTOVER_ENEMY_FORMATION_DEFAULTS_PY = (
    "Scripts/tests/test_enemy_formation_defaults.py"
)
LEFTOVER_ENEMY_FORMATION_DEFAULTS_TESTS = (
    "Scripts/tests/test_enemy_formation_defaults_tests.py"
)
...
def leftover_enemy_wave_scripts() -> tuple[str, ...]:
    return (
        LEFTOVER_ENEMY_WAVE_DEFAULTS,
        LEFTOVER_ENEMY_WAVE_DEFAULTS_PY,
        LEFTOVER_ENEMY_WAVE_DEFAULTS_TESTS,
...
def leftover_route_point_scripts() -> tuple[str, ...]:
    return leftover_enemy_wave_scripts()
...
def has_declaration(region: str, declaration: str) -> bool:
    # Fail-closed on authored `int32 UnitCount = 3;`.
    # Reject missing initializer, `= 1` / `= 32` /
    # Harbor 40/80 / leftover Health / FName UnitCount /
    # float UnitCount / bare `int32 UnitCount;`. Do not
    # accept sibling FormationId / Formation /
    # SpacingCentimeters remaining fields.
    if not has_one_declaration(region, declaration):
        return False
    compact = collapsed(region)
    if re.search(
        r"int32\s+UnitCount\s*=\s*3\s*;",
        compact,
    ) is None:
        return False
    if re.search(
        r"int32\s+UnitCount\s*=\s*1\b",
        compact,
    ):
        return False
    if re.search(
        r"int32\s+UnitCount\s*=\s*32\b",
        compact,
    ):
        return False
    if re.search(
        r"float\s+UnitCount\b",
        compact,
    ):
        return False
    if re.search(
        r"FName\s+UnitCount\b",
        compact,
    ):
        return False
    if re.search(
        r"int32\s+UnitCount\s*;",
        compact,
    ):
        return False
    return True
...
def leaked_neighbor_tokens() -> tuple[str, ...]:
    return (
        STOP_BEFORE_BOSS_WEAK_POINT,
        STOP_BEFORE_WEATHER_PROFILE,
        STOP_BEFORE_ENEMY_WAVE,
        STOP_BEFORE_FORMATION_TYPE,
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    while True:
        ...
        if depth == 0 and re.match(
            r"\s*int32\s+UnitCount\b", compact[index:]
        ):
            return compact[start : index - 1]
        cursor = cursor + match.start() + 1
    raise AssertionError(
        "UPROPERTY for int32 UnitCount is missing from "
...
def require_unit_count_specifiers(section: str) -> str:
    ...
    if "EditAnywhere" not in specifiers:
        raise AssertionError(
            ...
            f"{HEADER_PATH} struct {STRUCT_NAME} UnitCount UPROPERTY"
        )
    if "BlueprintReadWrite" in specifiers:
        raise AssertionError(
            "BlueprintReadWrite instead of BlueprintReadOnly on "
            f"origin/main:{HEADER_PATH} struct {STRUCT_NAME} UnitCount"
        )
    ...
    if 'ClampMin = "1"' not in specifiers:
        raise AssertionError(
            'ClampMin = "1" is missing from origin/main:'
            f"{HEADER_PATH} struct {STRUCT_NAME} UnitCount UPROPERTY"
        )
    if 'ClampMax = "32"' not in specifiers:
        raise AssertionError(
            'ClampMax = "32" is missing from origin/main:'
            f"{HEADER_PATH} struct {STRUCT_NAME} UnitCount UPROPERTY"
        )
    compact = collapsed(specifiers)
    if 'meta =(ClampMin = "1",ClampMax = "32")' not in compact:
        raise AssertionError(
            'meta = (ClampMin = "1", ClampMax = "32") is missing or '
            "wrong on origin/main:"
            f"{HEADER_PATH} struct {STRUCT_NAME} UnitCount UPROPERTY"
        )
    return specifiers


class EnemyFormationUnitCountFieldDeclContractTests(unittest.TestCase):
    def test_enemy_formation_struct_exists(self) -> None:
        ...
        self.assertEqual(STRUCT_NAME, ENEMY_FORMATION_NAME)
        self.assertNotEqual(STRUCT_NAME, ROUTE_POINT_NAME)
        self.assertNotEqual(STRUCT_NAME, BOSS_WEAK_POINT_NAME)
        ...
        self.assertTrue(has_identifier(section, "UnitCount"), section)
        ...
        self.assertIn(STOP_BEFORE_BOSS_WEAK_POINT, header)
        self.assertNotIn(STOP_BEFORE_BOSS_WEAK_POINT, section)
        self.assertNotIn(STOP_BEFORE_BOSS_WEAK_POINT, body)
        self.assertIn(STOP_BEFORE_FORMATION_TYPE, header)
        self.assertNotIn(STOP_BEFORE_FORMATION_TYPE, section)
        self.assertNotIn(STOP_BEFORE_FORMATION_TYPE, body)
        ...
        self.assertIn(STOP_BEFORE_ROUTE_POINT, header)
        self.assertNotIn(STOP_BEFORE_ROUTE_POINT, section)
        self.assertNotIn(STOP_BEFORE_ROUTE_POINT, body)
    ...
    def test_missing_struct_fails_closed(self) -> None:
        with self.assertRaises(AssertionError) as raised:
            struct_body(
                "struct FSkyguardUnrelatedEnemyFormationDefinition\n{\n};\n"
            )
    ...
    def test_later_struct_declaration_does_not_satisfy(self) -> None:
        mixed = (
            ...
            "\tGENERATED_BODY()\n"
            "};\n"
            f"{STOP_BEFORE_ENEMY_WAVE}\n"
            "{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
            f"{STOP_BEFORE_BOSS_WEAK_POINT}\n"
            "{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
            f"{STOP_BEFORE_ROUTE_POINT}\n"
            "{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
            f"{STOP_BEFORE_ROUTE_DEFINITION}\n"
            "{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
        ...
        self.assertFalse(has_identifier(section, "UnitCount"), section)
        self.assertNotIn(STOP_BEFORE_ENEMY_WAVE, section)
        self.assertNotIn(STOP_BEFORE_BOSS_WEAK_POINT, section)
        self.assertNotIn(ENEMY_WAVE_NAME, section)
        self.assertNotIn(STOP_BEFORE_ROUTE_POINT, section)
        self.assertNotIn(STOP_BEFORE_ROUTE_DEFINITION, section)
        self.assertNotIn(STOP_BEFORE_MISSION_DEFINITION, section)
        self.assertNotIn(BOSS_WEAK_POINT_NAME, section)
        self.assertNotIn(ENEMY_WAVE_NAME, section)
        self.assertNotIn(ROUTE_POINT_NAME, section)
        self.assertNotIn(ROUTE_DEFINITION_NAME, section)
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, LOCKED_DECL)
        self.assertIn("UnitCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_missing_unit_count_declaration_fails_closed(self) -> None:
        empty = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            f"\tFName {SIBLING_FORMATION_ID};\n"
            "};\n"
        )
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        specifiers = require_unit_count_specifiers(section)
    ...
    def test_bare_or_wrong_initializer_fails_closed(self) -> None:
        ...
        self.assertIn("int32 UnitCount = 3;", compact_origin)
        self.assertNotIn("UnitCount = NAME_None", compact_origin)
        self.assertNotIn("UnitCount = false", compact_origin)
        self.assertNotIn("UnitCount = true", compact_origin)
        self.assertNotIn("UnitCount = 0.f", compact_origin)
        self.assertNotIn("UnitCount = 160.f", compact_origin)
        self.assertNotIn("int32 UnitCount;", compact_origin.replace(
            "int32 UnitCount = 3;",
            "",
        ))

    def test_unit_count_declaration_matches_origin_main(self) -> None:
        section = spec_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 UnitCount"),
            LOCKED_DECL,
        )
        ...
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_THIRTY_TWO}\n", LOCKED_DECL)
        )
        self.assertFalse(
    ...
    def test_wrong_default_and_renames_do_not_satisfy(self) -> None:
        ...
        wrongs = (
            ...
            f"\t{TARGET_WRONG_BARE}\n",
            f"\t{TARGET_WRONG_ONE}\n",
            f"\t{TARGET_WRONG_THIRTY_TWO}\n",
            f"\t{TARGET_WRONG_FNAME}\n",
            "\tFName UnitCounts;\n",
            "\tbool UnitCount;\n",
            "\tfloat UnitCount = " + forty + ";\n",
            "\tfloat UnitCount = " + eighty + ";\n",
        )
    ...
    def test_dropped_edit_anywhere_or_read_write_fails_closed(self) -> None:
        origin = require_unit_count_specifiers(
        ...
        self.assertIn('ClampMax = "32"', origin)
        no_edit = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_unit_count_specifiers(spec_section(no_edit))
        ...
        with self.assertRaises(AssertionError) as raised:
            require_unit_count_specifiers(spec_section(read_write))
        ...
        with self.assertRaises(AssertionError) as raised:
            require_unit_count_specifiers(spec_section(visible))
        self.assertIn("EditAnywhere", str(raised.exception))
        with_category = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_unit_count_specifiers(spec_section(with_category))
        ...
        no_clamp = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            f"\t{UPROPERTY_EDIT_READONLY_NO_META}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_unit_count_specifiers(spec_section(no_clamp))
        ...
        with self.assertRaises(AssertionError) as raised:
            require_unit_count_specifiers(spec_section(changed_clamp))
        self.assertTrue(
            "ClampMin" in str(raised.exception)
            or "ClampMax" in str(raised.exception)
            or "meta =" in str(raised.exception),
            str(raised.exception),
        )
        compact_meta = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            f"\t{UPROPERTY_COMPACT_META}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_unit_count_specifiers(spec_section(compact_meta))
        self.assertTrue(
            "ClampMin" in str(raised.exception)
            or "meta =" in str(raised.exception),
            str(raised.exception),
    ...
    def test_does_not_contract_sibling_enemy_formation_fields(self) -> None:
        for sibling in sibling_uncontracted_decls():
            self.assertNotIn(sibling, LOCKED_DECL)
        for field in leftover_neighbor_hit_fields():
            self.assertNotIn(field, LOCKED_DECL)
        ...
        self.assertTrue(has_identifier(section, SIBLING_FORMATION_ID), SIBLING_FORMATION_ID)
        self.assertTrue(has_identifier(section, SIBLING_FORMATION), SIBLING_FORMATION)
        self.assertTrue(has_identifier(section, SIBLING_SPACING), SIBLING_SPACING)
        self.assertNotIn(LEFTOVER_WAVE_WAVE_ID, LOCKED_DECL)
        self.assertNotIn(LEFTOVER_WAVE_START_TIME, section)
        self.assertNotIn(LEFTOVER_WAVE_FORMATIONS, section)
        self.assertNotIn(LEFTOVER_WAVE_COMPLETION, section)
        for leftover in leftover_theater_siblings():
    ...
    def test_does_not_parse_neighbor_structs(self) -> None:
        header = origin_main_header()
        section = spec_section(header)
        ...
        self.assertIn(STOP_BEFORE_BOSS_WEAK_POINT, header)
        self.assertNotIn(STOP_BEFORE_BOSS_WEAK_POINT, section)
        self.assertNotIn(STOP_BEFORE_BOSS_WEAK_POINT, leaked)
        self.assertIn(STOP_BEFORE_WEATHER_PROFILE, header)
        self.assertNotIn(STOP_BEFORE_WEATHER_PROFILE, section)
        self.assertNotIn(STOP_BEFORE_WEATHER_PROFILE, leaked)
        self.assertIn(STOP_BEFORE_FORMATION_TYPE, header)
        self.assertNotIn(STOP_BEFORE_FORMATION_TYPE, section)
        self.assertNotIn(STOP_BEFORE_FORMATION_TYPE, leaked)
        self.assertIn(STOP_BEFORE_ENEMY_FORMATION, header)
        self.assertNotIn(STOP_BEFORE_ENEMY_FORMATION, section)
        self.assertNotIn(STOP_BEFORE_ENEMY_FORMATION, leaked)
        self.assertIn(STOP_BEFORE_ROUTE_POINT, header)
        self.assertNotIn(STOP_BEFORE_ROUTE_POINT, section)
        self.assertNotIn(STOP_BEFORE_ROUTE_POINT, leaked)
        self.assertIn(STOP_BEFORE_ROUTE_DEFINITION, header)
        self.assertNotIn(STOP_BEFORE_ROUTE_DEFINITION, section)
    ...
    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        ...
        self.assertIn("EditAnywhere", UPROPERTY_EDIT_READONLY)
        self.assertIn("BlueprintReadOnly", UPROPERTY_EDIT_READONLY)
        self.assertIn('meta = (ClampMin = "1", ClampMax = "32")', UPROPERTY_EDIT_READONLY)
        self.assertNotIn("VisibleAnywhere", UPROPERTY_EDIT_READONLY)
        self.assertNotIn("BlueprintReadWrite", UPROPERTY_EDIT_READONLY)
        self.assertNotIn("Category", UPROPERTY_EDIT_READONLY)
        ...
        self.assertNotIn('meta=(ClampMin="1"', UPROPERTY_EDIT_READONLY)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "enemy-formation UnitCount field decl contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(Path(__file__).name.endswith(
            "enemy_formation_unit_count_field_decl_contract.py"
        ))
        self.assertNotIn("SkyguardMissionTypes.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardMissionDefinition.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardMissionTypes.cpp", THIS_SCRIPT)
        ...
        self.assertIn(LEFTOVER_ENEMY_WAVE_WAVE_ID, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_ENEMY_WAVE_FORMATIONS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_ENEMY_WAVE_START_TIME, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_FORMATION_TYPE_ENUM, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_ENEMY_FORMATION_DEFAULTS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_FORMATION_ID_SCRIPT, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_FORMATION_FIELD_SCRIPT, LOCKED_SCRIPTS)
    ...
    def test_contract_is_target_field_declaration_only(self) -> None:
        ...
        self.assertNotIn(STOP_BEFORE_BOSS_WEAK_POINT, locked_only)
        self.assertNotIn(STOP_BEFORE_ENEMY_FORMATION, locked_only)
        self.assertNotIn(STOP_BEFORE_ROUTE_POINT, locked_only)
        ...
        self.assertNotIn(SIBLING_FORMATION_ID, locked_only)
        self.assertNotIn(SIBLING_FORMATION, locked_only)
        self.assertNotIn(SIBLING_SPACING, locked_only)
        self.assertNotIn(STOP_BEFORE_WEATHER_PROFILE, locked_only)
        self.assertNotIn(LEFTOVER_WAVE_WAVE_ID, locked_only)
        self.assertNotIn(LEFTOVER_WAVE_START_TIME, locked_only)
        self.assertNotIn(LEFTOVER_WAVE_FORMATIONS, locked_only)
        self.assertNotIn(LEFTOVER_WAVE_COMPLETION, locked_only)
        self.assertNotIn(STOP_BEFORE_ENEMY_WAVE, locked_only)
        self.assertNotIn(STOP_BEFORE_FORMATION_TYPE, locked_only)
        self.assertNotIn(SIBLING_ROUTE_POINT_WORLD_LOCATION, locked_only)
        for helper in namespace_helper_tokens():
