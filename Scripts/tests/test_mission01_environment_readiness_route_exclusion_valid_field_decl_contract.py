...
# bRouteExclusionValid FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bRouteExclusionValid = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover Mission01 environment-readiness-defaults
# #6b9d/#204. THIS IS NOT leftover director RouteExclusion #588
# (ASkyguardMission01EnvironmentDirector::RouteExclusion;
# DIFFERENT name on the director class). THIS IS NOT leftover
# IsPointAllowedForPCG #622. THIS IS NOT leftover OceanTileCount
# #1170 / BeachTileCount #1171 / LandTileCount #1172 /
# bAuthoredLandscapeSurfaceExposed #1173. THIS IS NOT leftover
# in-flight leftover-safe bContinuousCoastline /
# LandscapeComponentCount (LOCK those sibling scripts; do not
# edit them). THIS IS leftover-safe
# FSkyguardMission01EnvironmentReadiness bRouteExclusionValid
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bRouteExclusionValid FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bRouteExclusionValid = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bRouteExclusionValid FIELD (declaration-only;
...
# BlueprintReadOnly bool bRouteExclusionValid = false;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bRouteExclusionValid. THIS IS NOT leftover mission-map-
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bRouteExclusionValid. THIS IS NOT leftover Mission05
...
# Mission01 EnvironmentReadiness bRouteExclusionValid
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bRouteExclusionValid = false;
# one-line / split-line UPROPERTY wraps;
...
# bRouteExclusionValid FIELD (declaration-only). It is
...
TARGET = "bool bRouteExclusionValid = false;"
TARGET_WRONG = "bool bRouteExclusionValid = true;"
LOCKED_DECL = TARGET
...
class Mission01EnvironmentReadinessRouteExclusionValidFieldDeclContractTests(unittest.TestCase):
    def test_environment_readiness_struct_exists(self) -> None:
        ...
        self.assertIn("bRouteExclusionValid", section)
        ...
        self.assertNotIn("TObjectPtr<UBoxComponent> RouteExclusion", section)
        self.assertNotIn("IsRouteExclusionSafe", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bRouteExclusionValid", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_route_exclusion_valid_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_route_exclusion_valid_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bRouteExclusionValid"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bRouteExclusionValid", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bRouteExclusionValid", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bRouteExclusionValid"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bRouteExclusionValid", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_route_exclusion_valid(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
