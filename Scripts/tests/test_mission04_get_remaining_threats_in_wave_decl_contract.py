...
# Mission04 Waves GetRemainingThreatsInWave
# on ASkyguardMission04IntegrationDirector. It is
...
# (do not lock enum values), and NOT leftover
# Mission03 GetRemainingThreatsInWave #639. Distinct from leftover
...
# #639, leftover Mission01 GetRemainingThreatsInWave,
# leftover Mission04 GetWaveState #659 / GetReadiness
# #658 / GetObjectiveRuntime #660, leftover Mission04
# wave-state enum #bb22
...
# Category is Skyguard|Mission04|Waves, not
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission04IntegrationDirector::GetRemainingThreatsInWave",
    "SkyguardMission04IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission04GetRemainingThreatsInWaveDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission04|Waves", UFUNCTION_WAVES)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_wave_getter = f"\t{GET_WAVE_STATE}\n"
    ...
    def test_get_remaining_threats_in_wave_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("ESkyguardMission03WaveState", GET_REMAINING_THREATS_IN_WAVE)
        ...
        self.assertNotIn("Mission04IntegrationReadiness", GET_REMAINING_THREATS_IN_WAVE)
    ...
    def test_environment_category_does_not_satisfy_waves(self) -> None:
        ...
        self.assertNotIn("Mission03", UFUNCTION_WAVES)
        self.assertNotIn("Integration", UFUNCTION_WAVES)
        self.assertNotIn("Convoy", UFUNCTION_WAVES)
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertNotIn("{", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("}", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("return Other", GET_REMAINING_THREATS_IN_WAVE)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 GetRemainingThreatsInWave method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission04 GetRemainingThreatsInWave contains "
