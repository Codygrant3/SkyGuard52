...
# INDEX_NONE or lock CampaignDefinition construction
# in the .cpp. This is a FIELD contract on
# ASkyguardMission01IntegrationDirector, not leftover
# USkyguardCampaignDefinition public methods
# (already drafted) and not leftover briefing-widget
# getters. Keep CampaignDefinition distinct from
...
# CampaignDefinition;`); accept that form and other
...
# CampaignDefinition field declaration contract on
...
# SortiePresentation field contracts stay
# sibling-only.
LOCKED_SCRIPTS = (
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission01IntegrationDirector::CampaignDefinition",
    "SkyguardMission01IntegrationDirector.cpp",
...
class Mission01CampaignDefinitionFieldDeclContractTests(unittest.TestCase):
    def test_mission01_class_exists(self) -> None:
        ...
        self.assertTrue(has_declaration(section, CAMPAIGN_DEFINITION_FIELD), section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, CAMPAIGN_DEFINITION_FIELD)
        self.assertIn("CampaignDefinition", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(has_declaration(section, CAMPAIGN_DEFINITION_FIELD))
    ...
    def test_missing_campaign_definition_declaration_fails_closed(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, CAMPAIGN_DEFINITION_FIELD)
        self.assertIn("CampaignDefinition", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, CAMPAIGN_DEFINITION_FIELD)
        self.assertIn("CampaignDefinition", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertTrue(has_declaration(section, CAMPAIGN_DEFINITION_FIELD), section)
        self.assertNotIn("UPROPERTY", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("EditAnywhere", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("BlueprintReadWrite", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("Category", CAMPAIGN_DEFINITION_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, CAMPAIGN_DEFINITION_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, CAMPAIGN_DEFINITION_FIELD)
        self.assertIn("CampaignDefinition", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = "\tUSkyguardCampaignDefinition* CampaignDefinition;\n"
        as_array = (
            "\tTArray<TSoftObjectPtr<USkyguardCampaignDefinition>> "
            "CampaignDefinition;\n"
        )
        scene = "\tTSoftObjectPtr<USceneComponent> CampaignDefinition;\n"
        briefing = (
            "\tTSoftObjectPtr<USkyguardMissionDefinition> "
            "CampaignDefinition;\n"
        )
        weak = (
            "\tTWeakObjectPtr<USkyguardCampaignDefinition> "
            "CampaignDefinition;\n"
        )
        assigned = (
            "\tTSoftObjectPtr<USkyguardCampaignDefinition> "
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, CAMPAIGN_DEFINITION_FIELD)
            self.assertIn("CampaignDefinition", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_campaign_definition_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(has_declaration(section, CAMPAIGN_DEFINITION_FIELD))
        self.assertEqual(declaration_count(section, CAMPAIGN_DEFINITION_FIELD), 1)
        self.assertTrue(
            CAMPAIGN_DEFINITION_FIELD.startswith(
                "TSoftObjectPtr<USkyguardCampaignDefinition> "
            ),
            CAMPAIGN_DEFINITION_FIELD,
        )
        self.assertTrue(CAMPAIGN_DEFINITION_FIELD.endswith(";"), CAMPAIGN_DEFINITION_FIELD)
        self.assertIn("CampaignDefinition", CAMPAIGN_DEFINITION_FIELD)
        self.assertIn(
            "USkyguardCampaignDefinition",
            CAMPAIGN_DEFINITION_FIELD,
        )
        self.assertIn("TSoftObjectPtr<", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("TArray<", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("TWeakObjectPtr", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("=", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("INDEX_NONE", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("UFUNCTION", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("{", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("}", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("return ", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("Briefing", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("RadioChatter", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("SortiePresentation", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("AudioDirector", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("MissionDefinition", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("Readiness", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("PathfinderSpawnLocation", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("GetAircraft", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("ConfigureFromMission", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("AdvanceBriefing", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("SetAssetsReady", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("AcknowledgeAndLaunch", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("CanLaunch", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("GetElapsedSeconds", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("GetBriefingState", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("GetMinimumWarmupSeconds", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("GetBriefingText", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("GetRadioChatter", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("GetPresentation", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("GetMissionTitle", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("AcknowledgeBriefing", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("LaunchSortie", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("HullCollider", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("OpticalTracker", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("WeaponServo", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("CountermeasurePod", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("RadarNode", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("ESkyguardMission02WaveState", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("HarborIndustrial", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("MaxIntegrity", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("CurrentIntegrity", CAMPAIGN_DEFINITION_FIELD)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, CAMPAIGN_DEFINITION_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION01} {CAMPAIGN_DEFINITION_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(declaration_count(section, CAMPAIGN_DEFINITION_FIELD), 1)
        one_line = f"{{\npublic:\n\t{CAMPAIGN_DEFINITION_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, CAMPAIGN_DEFINITION_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, CAMPAIGN_DEFINITION_FIELD), section)
        self.assertEqual(
            require_declaration(section, CAMPAIGN_DEFINITION_FIELD),
    ...
    def test_assigned_campaign_definition_does_not_satisfy(self) -> None:
        assigned = (
            "\tTSoftObjectPtr<USkyguardCampaignDefinition> "
            "CampaignDefinition = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, CAMPAIGN_DEFINITION_FIELD)
        self.assertIn("CampaignDefinition", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, CAMPAIGN_DEFINITION_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("CampaignDefinition", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, CAMPAIGN_DEFINITION_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{CAMPAIGN_DEFINITION_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, CAMPAIGN_DEFINITION_FIELD)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            CAMPAIGN_DEFINITION_FIELD.startswith("UFUNCTION"),
            CAMPAIGN_DEFINITION_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, CAMPAIGN_DEFINITION_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", CAMPAIGN_DEFINITION_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_campaign_definition_cpp_body(self) -> None:
        locked_only = f"{CAMPAIGN_DEFINITION_FIELD}\n"
        self.assertNotIn("{", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("}", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("return ", CAMPAIGN_DEFINITION_FIELD)
        ...
        self.assertNotIn("return false", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("return true", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("CreateDefaultSubobject", CAMPAIGN_DEFINITION_FIELD)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{CAMPAIGN_DEFINITION_FIELD}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, CAMPAIGN_DEFINITION_FIELD)
        self.assertIn("CampaignDefinition", CAMPAIGN_DEFINITION_FIELD)
        self.assertIn(
            "USkyguardCampaignDefinition",
            CAMPAIGN_DEFINITION_FIELD,
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, CAMPAIGN_DEFINITION_FIELD)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("CurrentIntegrity", CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", CAMPAIGN_DEFINITION_FIELD)
    ...
    def test_contract_does_not_open_leftover_campaign_definition_header(
        ...
        self.assertNotIn(leftover_header, CAMPAIGN_DEFINITION_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, CAMPAIGN_DEFINITION_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", CAMPAIGN_DEFINITION_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{CAMPAIGN_DEFINITION_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, CAMPAIGN_DEFINITION_FIELD),
            CAMPAIGN_DEFINITION_FIELD,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, CAMPAIGN_DEFINITION_FIELD)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 CampaignDefinition field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{CAMPAIGN_DEFINITION_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, CAMPAIGN_DEFINITION_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                CAMPAIGN_DEFINITION_FIELD.lower(),
                "mission01 CampaignDefinition contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live cop" + "y",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, CAMPAIGN_DEFINITION_FIELD)

    def test_contract_is_campaign_definition_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertTrue(CAMPAIGN_DEFINITION_FIELD.endswith(";"))
        self.assertNotIn("=", CAMPAIGN_DEFINITION_FIELD)
        self.assertIn(UPROPERTY_MISSION01, section)
    ...
    def test_sibling_director_fields_do_not_satisfy_campaign_definition(
        ...
        for leftover in (
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, CAMPAIGN_DEFINITION_FIELD))
            self.assertNotEqual(CAMPAIGN_DEFINITION_FIELD, leftover)
        self.assertIn(
            "Scripts/tests/test_mission01_root_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
