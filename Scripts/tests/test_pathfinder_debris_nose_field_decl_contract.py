...
# INDEX_NONE or lock DebrisNose construction
...
# DebrisNose;`); accept that form and other
...
# sibling field contracts. Stay off leftover
...
# isolated-test drafts #107–#503 including
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardPathfinderBoss::DebrisNose",
    "SkyguardPathfinderBoss.cpp",
    "SetExposed",
...
class PathfinderDebrisNoseFieldDeclContractTests(unittest.TestCase):
    def test_pathfinder_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, DEBRIS_NOSE_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, DEBRIS_NOSE_FIELD)
        self.assertIn("DebrisNose", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, DEBRIS_NOSE_FIELD)
    ...
    def test_missing_debris_nose_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardPathfinderBoss();\n"
            f"\t{COMMAND_ANTENNA_FIELD}\n"
            f"\t{ENGINE_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, DEBRIS_NOSE_FIELD)
        self.assertIn("DebrisNose", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, DEBRIS_NOSE_FIELD)
        self.assertIn("DebrisNose", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UPROPERTY", DEBRIS_NOSE_FIELD)
        self.assertNotIn("VisibleAnywhere", DEBRIS_NOSE_FIELD)
        self.assertNotIn("BlueprintReadOnly", DEBRIS_NOSE_FIELD)
        self.assertNotIn("Category", DEBRIS_NOSE_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, DEBRIS_NOSE_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, DEBRIS_NOSE_FIELD)
        self.assertIn("DebrisNose", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUStaticMeshComponent* DebrisNose;\n"
        )
        as_array = (
        ...
        scene = (
            "\tTObjectPtr<USceneComponent> DebrisNose;\n"
        )
        mesh = (
            "\tTObjectPtr<USkyguardBossWeakPointComponent> DebrisNose;\n"
        )
        weak = (
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, DEBRIS_NOSE_FIELD)
            self.assertIn("DebrisNose", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_debris_nose_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, DEBRIS_NOSE_FIELD),
            DEBRIS_NOSE_FIELD,
        )
        self.assertTrue(has_declaration(section, DEBRIS_NOSE_FIELD))
        self.assertEqual(declaration_count(section, DEBRIS_NOSE_FIELD), 1)
        self.assertTrue(
            DEBRIS_NOSE_FIELD.startswith(
                "TObjectPtr<UStaticMeshComponent> "
            ),
            DEBRIS_NOSE_FIELD,
        )
        self.assertTrue(DEBRIS_NOSE_FIELD.endswith(";"), DEBRIS_NOSE_FIELD)
        self.assertIn("DebrisNose", DEBRIS_NOSE_FIELD)
        self.assertIn(
            "UStaticMeshComponent",
            DEBRIS_NOSE_FIELD,
        )
        self.assertIn("TObjectPtr<", DEBRIS_NOSE_FIELD)
        self.assertNotIn("TArray<", DEBRIS_NOSE_FIELD)
        self.assertNotIn("=", DEBRIS_NOSE_FIELD)
        self.assertNotIn("INDEX_NONE", DEBRIS_NOSE_FIELD)
        self.assertNotIn("UFUNCTION", DEBRIS_NOSE_FIELD)
        self.assertNotIn("{", DEBRIS_NOSE_FIELD)
        self.assertNotIn("}", DEBRIS_NOSE_FIELD)
        self.assertNotIn("return ", DEBRIS_NOSE_FIELD)
        self.assertNotIn("CommandAntenna", DEBRIS_NOSE_FIELD)
        self.assertNotIn("ControlLinkage", DEBRIS_NOSE_FIELD)
        self.assertNotIn("NoseCamera", DEBRIS_NOSE_FIELD)
        self.assertNotIn("DebrisCenter", DEBRIS_NOSE_FIELD)
        self.assertNotIn("DebrisTail", DEBRIS_NOSE_FIELD)
        self.assertNotIn("DebrisSpine", DEBRIS_NOSE_FIELD)
        self.assertNotIn("EncounterController", DEBRIS_NOSE_FIELD)
        self.assertNotIn("AdvanceEncounter", DEBRIS_NOSE_FIELD)
        self.assertNotIn("ResetEncounterState", DEBRIS_NOSE_FIELD)
        self.assertNotIn("IsRouteStateSafe", DEBRIS_NOSE_FIELD)
        self.assertNotIn("GetRouteProgress", DEBRIS_NOSE_FIELD)
        self.assertNotIn("GetEffectiveSpeedMultiplier", DEBRIS_NOSE_FIELD)
        self.assertNotIn("IsAttackTelegraphActive", DEBRIS_NOSE_FIELD)
        self.assertNotIn("GetTelegraphsTriggered", DEBRIS_NOSE_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", DEBRIS_NOSE_FIELD)
        self.assertNotIn("RadarNode", DEBRIS_NOSE_FIELD)
        self.assertNotIn("BeginTerminalStrikeCycle", DEBRIS_NOSE_FIELD)
        self.assertNotIn("OpenGuidanceArrayExposure", DEBRIS_NOSE_FIELD)
        self.assertNotIn("IssueClimbCommand", DEBRIS_NOSE_FIELD)
        self.assertNotIn("DivertWreckFromCivilians", DEBRIS_NOSE_FIELD)
        self.assertNotIn("SetCivilianSeparationMeters", DEBRIS_NOSE_FIELD)
        self.assertNotIn("GetCivilianSeparationMeters", DEBRIS_NOSE_FIELD)
        self.assertNotIn("GetFinaleStage", DEBRIS_NOSE_FIELD)
        self.assertNotIn("IsClimbCommandIssued", DEBRIS_NOSE_FIELD)
        self.assertNotIn("IsWreckDiverted", DEBRIS_NOSE_FIELD)
        self.assertNotIn("GetObjectiveMilestonesReached", DEBRIS_NOSE_FIELD)
        self.assertNotIn("ESkyguardLastFlightStage", DEBRIS_NOSE_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", DEBRIS_NOSE_FIELD)
        self.assertNotIn("GetGunnerMount", DEBRIS_NOSE_FIELD)
        self.assertNotIn("FaceWorldLocation", DEBRIS_NOSE_FIELD)
        self.assertNotIn("PortGuidanceArray", DEBRIS_NOSE_FIELD)
        self.assertNotIn("DebrisArmorPort", DEBRIS_NOSE_FIELD)
        self.assertNotIn("SetSearchlightTracked", DEBRIS_NOSE_FIELD)
        self.assertNotIn("SetContactIdentified", DEBRIS_NOSE_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", DEBRIS_NOSE_FIELD)
        self.assertNotIn("SetLightningExposed", DEBRIS_NOSE_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", DEBRIS_NOSE_FIELD)
        self.assertNotIn("HullCollider", DEBRIS_NOSE_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, DEBRIS_NOSE_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_DEBRIS} {DEBRIS_NOSE_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(
                declaration_count(section, DEBRIS_NOSE_FIELD),
                1,
            )
        one_line = f"{{\npublic:\n\t{DEBRIS_NOSE_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, DEBRIS_NOSE_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, DEBRIS_NOSE_FIELD),
            section,
    ...
    def test_assigned_debris_nose_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<UStaticMeshComponent> "
            "DebrisNose = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, DEBRIS_NOSE_FIELD)
        self.assertIn("DebrisNose", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, DEBRIS_NOSE_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("DebrisNose", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, DEBRIS_NOSE_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{DEBRIS_NOSE_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, DEBRIS_NOSE_FIELD)
        ...
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_DEBRIS, section)
        self.assertTrue(has_declaration(section, DEBRIS_NOSE_FIELD), section)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            DEBRIS_NOSE_FIELD.startswith("UFUNCTION"),
            DEBRIS_NOSE_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, DEBRIS_NOSE_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", DEBRIS_NOSE_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_debris_nose_cpp_body(self) -> None:
        locked_only = f"{DEBRIS_NOSE_FIELD}\n"
        self.assertNotIn("{", DEBRIS_NOSE_FIELD)
        self.assertNotIn("}", DEBRIS_NOSE_FIELD)
        self.assertNotIn("return ", DEBRIS_NOSE_FIELD)
        ...
        self.assertNotIn("SkyguardPathfinderBoss.cpp", DEBRIS_NOSE_FIELD)
        self.assertNotIn("SkyguardPathfinderBoss.cpp", locked_only)
        self.assertNotIn("return false", DEBRIS_NOSE_FIELD)
        self.assertNotIn("return true", DEBRIS_NOSE_FIELD)
        self.assertNotIn("CreateDefaultSubobject", DEBRIS_NOSE_FIELD)
        self.assertNotIn("SetExposed", DEBRIS_NOSE_FIELD)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            DEBRIS_NOSE_FIELD,
        )
        self.assertNotIn("SetBossPhase", DEBRIS_NOSE_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_relock_sibling_pathfinder_fields(self) -> None:
        ...
        for token in SIBLING_PATHFINDER_FIELDS_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_NOSE_FIELD)
        self.assertNotIn("CommandAntenna", DEBRIS_NOSE_FIELD)
        self.assertNotIn("ControlLinkage", DEBRIS_NOSE_FIELD)
        self.assertNotIn("NoseCamera", DEBRIS_NOSE_FIELD)
        self.assertNotIn("DebrisCenter", DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_open_first_window(), DEBRIS_NOSE_FIELD)
        self.assertNotIn(leftover_open_final_window(), locked_only)
        self.assertNotIn(leftover_open_final_window(), DEBRIS_NOSE_FIELD)
        self.assertNotIn(leftover_arm_command_core_path(), locked_only)
        self.assertNotIn(leftover_arm_command_core_path(), DEBRIS_NOSE_FIELD)
        self.assertNotIn(leftover_apply_strike(), locked_only)
        self.assertNotIn(leftover_apply_strike(), DEBRIS_NOSE_FIELD)
        self.assertNotIn(leftover_is_lock_eligible(), locked_only)
        self.assertNotIn(leftover_is_lock_eligible(), DEBRIS_NOSE_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, locked_only)
            self.assertNotIn(name, DEBRIS_NOSE_FIELD)
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_debris_getters(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_NOSE_FIELD)
        self.assertNotIn("GetDefeatDebrisPieceCount", DEBRIS_NOSE_FIELD)
        self.assertNotIn("GetMaxDefeatDebrisPieces", DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_NOSE_FIELD)
        self.assertNotIn("SetSearchlightTracked", DEBRIS_NOSE_FIELD)
        self.assertNotIn("ASkyguardBlackKiteBoss", DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_NOSE_FIELD)
        self.assertNotIn("SetContactIdentified", DEBRIS_NOSE_FIELD)
        self.assertNotIn("OpenOrbitExposure", DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_NOSE_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", DEBRIS_NOSE_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_NOSE_FIELD)
        self.assertNotIn("SetLightningExposed", DEBRIS_NOSE_FIELD)
        self.assertNotIn("ASkyguardTempestBoss", DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_iron_rain(self) -> None:
        ...
        for token in LEFTOVER_IRON_RAIN_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_NOSE_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", DEBRIS_NOSE_FIELD)
        self.assertNotIn("ASkyguardIronRainBoss", DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        for token in LEFTOVER_PATROL_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_NOSE_FIELD)
        self.assertNotIn("ASkyguardPatrolShip", DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        ...
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            ...
            self.assertNotIn(neighbor, DEBRIS_NOSE_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_NOSE_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_NOSE_FIELD)
        self.assertNotIn("ASkyguardGunner", DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_NOSE_FIELD)
        self.assertNotIn("SkyguardRadarNode", DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_NOSE_FIELD)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            ...
            self.assertNotIn(token, DEBRIS_NOSE_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", DEBRIS_NOSE_FIELD)
        self.assertNotIn("MaxIntegrity", DEBRIS_NOSE_FIELD)
        self.assertNotIn("CurrentIntegrity", DEBRIS_NOSE_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", DEBRIS_NOSE_FIELD)
        self.assertNotIn(
            "SkyguardPathfinderEncounterController.h",
            DEBRIS_NOSE_FIELD,
        )
    ...
    def test_contract_does_not_open_leftover_weak_point_component_header(
        ...
        self.assertNotIn(leftover_header, DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, DEBRIS_NOSE_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", DEBRIS_NOSE_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{DEBRIS_NOSE_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, DEBRIS_NOSE_FIELD),
            DEBRIS_NOSE_FIELD,
        )
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardPathfinderBoss::DebrisNose", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "pathfinder DebrisNose field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{DEBRIS_NOSE_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, DEBRIS_NOSE_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                DEBRIS_NOSE_FIELD.lower(),
                "pathfinder DebrisNose contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, DEBRIS_NOSE_FIELD)

    def test_contract_is_debris_nose_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertTrue(DEBRIS_NOSE_FIELD.endswith(";"))
        self.assertNotIn("=", DEBRIS_NOSE_FIELD)
        self.assertIn(UPROPERTY_DEBRIS, section)
