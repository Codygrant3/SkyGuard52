...
# Mission02 Integration SynchronizeRuntimeState
# METHOD on ASkyguardMission02IntegrationDirector.
# THIS is SynchronizeRuntimeState, NOT leftover
# BindRuntimeActors. It is NOT leftover Mission10
# SynchronizeRuntimeState / branch
# cursor/mission10-synchronize-
# runtime-state-decl-contract-c332, NOT leftover
# BindRuntimeActors. It is NOT leftover BindRuntimeActors
# (retired live mount pointer in that leftover decl),
# NOT leftover Mission09 SynchronizeRuntimeState
# #757 / branch cursor/mission09-synchronize-
# runtime-state-decl-contract-c332, NOT leftover
# Mission08 SynchronizeRuntimeState
# #738 / branch cursor/mission08-synchronize-
# runtime-state-decl-contract-c332, NOT leftover
# Mission07 SynchronizeRuntimeState #714,
# NOT leftover Mission06 SynchronizeRuntimeState
# #695, NOT leftover Mission05 SynchronizeRuntimeState
# #683, NOT leftover Mission01 / Mission03 /
# Mission04 SynchronizeRuntimeState #635 / #656,
# NOT leftover Mission02 InitializePlayableMission
# #828 / ConfigureMissionDefinition #829 /
# StartNextWave #830 / NotifyThreatDestroyed #831
# siblings, NOT leftover merged Mission02 C++
# bundle #102 / cursor/m02-director-api-tests-1c8b,
# NOT leftover retired-mount spawn fields, NOT leftover
...
# #615, leftover Mission03 SynchronizeRuntimeState
# #635, leftover Mission04 SynchronizeRuntimeState
# #656, leftover Mission05 SynchronizeRuntimeState
# #683, leftover Mission06 SynchronizeRuntimeState
# #695, leftover Mission07 SynchronizeRuntimeState
# #714, leftover Mission08 SynchronizeRuntimeState
# #738, leftover Mission09 SynchronizeRuntimeState
# #757, leftover Mission10 SynchronizeRuntimeState,
...
# (`void SynchronizeRuntimeState();`); accept
...
# not leftover Mission05 Integration #683, not
# leftover Mission06 Integration #695, not leftover
# Mission07 Integration #714, not leftover Harbor
# Mission02 Harbor, not leftover Mission08
# Integration #738, not leftover Mission09
# Integration #757, not leftover Mission08
...
# drafts #674–#831+, leftover Apache
...
# clock names must be absent from this test file
# and the Mission02IntegrationDirector public
# section. Pathfinder MinHeightFromOriginCm
...
# SynchronizeRuntimeState #738. Do not reopen
# leftover Mission07 SynchronizeRuntimeState #714.
# Do not reopen leftover Mission06
# SynchronizeRuntimeState #695. Do not reopen
# leftover Mission05 SynchronizeRuntimeState #683.
...
# reopen leftover Mission09 SynchronizeRuntimeState
# #757. Do not reopen leftover Mission10
# SynchronizeRuntimeState. Do not reopen leftover
...
# Do not reopen leftover Mission01 Root #574 /
# environment-root #592 / Mission01 Readiness #579.
# Do not reopen leftover Mission10 Briefing #795 /
# AudioDirector #794 / SortiePresentation #797 /
# Readiness #809 / CampaignDefinition #798 /
# MissionDefinition #799. Do not reopen leftover
# Mission10 ProtectedGroupCount #825 /
# ObjectiveCount #823 / WaveCount #824 /
# Integrity #826 / bDestroyed #827. Do not reopen
# leftover GetDayBeatKit without UFUNCTION. Do not
# reopen open drafts #674–#831+.
...
REQUIRED_DECL = SYNCHRONIZE_RUNTIME_STATE
...
# an isolated Python SynchronizeRuntimeState
# method declaration contract on
# ASkyguardMission02IntegrationDirector.
# THIS is SynchronizeRuntimeState, NOT leftover
# BindRuntimeActors, NOT leftover Mission10
# SynchronizeRuntimeState, NOT leftover Mission09
# SynchronizeRuntimeState #757.
LOCKED = {
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission02IntegrationDirector::SynchronizeRuntimeState",
    "ASkyguardMission10IntegrationDirector::SynchronizeRuntimeState",
    "ASkyguardMission09IntegrationDirector::SynchronizeRuntimeState",
    "SkyguardMission02IntegrationDirector.cpp",
    "SkyguardMission10IntegrationDirector.cpp",
    "SkyguardMission09IntegrationDirector.cpp",
    "SkyguardMission08IntegrationDirector.cpp",
...
LEFTOVER_MISSION10_SYNCHRONIZE_NOT_LOCKED = (
    "test_mission10_synchronize_runtime_state_decl_contract.py",
    "ASkyguardMission10IntegrationDirector",
    "SkyguardMission10IntegrationDirector.h",
    'Category="Skyguard|Mission10|Integration"',
    "cursor/mission10-synchronize-runtime-state-decl-contract-c332",
)
LEFTOVER_MISSION02_SIBLINGS_NOT_LOCKED = (
    "test_mission02_initialize_playable_mission_decl_contract.py",
...
class Mission02SynchronizeRuntimeStateDeclContractTests(unittest.TestCase):
    ...
    def test_missing_synchronize_runtime_state_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission02IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
    ...
    def test_synchronize_runtime_state_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, REQUIRED_DECL),
            REQUIRED_DECL,
        ...
        self.assertIn("SynchronizeRuntimeState", REQUIRED_DECL)
    ...
    def test_contract_does_not_lock_synchronize_runtime_state_cpp_body(self) -> None:
        locked_only = f"{REQUIRED_DECL}\n"
        self.assertNotIn("{", REQUIRED_DECL)
        self.assertNotIn("}", REQUIRED_DECL)
        self.assertNotIn("return ", REQUIRED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("SynchronizeRuntimeState", REQUIRED_DECL)
        self.assertTrue(REQUIRED_DECL.startswith("void "))
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertNotIn(
            "ASkyguardMission08IntegrationDirector::BindCampaignRuntime",
            section,
        )
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("{", REQUIRED_DECL)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 SynchronizeRuntimeState method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                REQUIRED_DECL.lower(),
                "mission02 SynchronizeRuntimeState contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_synchronize_runtime_state(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_leftover_mission10_synchronize_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
        ...
        for token in LEFTOVER_MISSION10_SYNCHRONIZE_NOT_LOCKED:
            self.assertNotIn(token, REQUIRED_DECL)
    ...
    def test_leftover_bind_runtime_actors_is_not_the_required_decl(
        ...
        self.assertNotEqual(BIND_RUNTIME_ACTORS, "SynchronizeRuntimeState")
        self.assertNotIn(BIND_RUNTIME_ACTORS, REQUIRED_DECL)
        self.assertTrue(
            REQUIRED_DECL.startswith("void SynchronizeRuntimeState("),
            REQUIRED_DECL,
        )
        self.assertIn("()", REQUIRED_DECL)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission02_synchronize_runtime_state"
            "_decl_contract.py"
        )
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_synchronize_runtime_state"
                "_decl_contract.py"
            )
        )
        self.assertIn(
