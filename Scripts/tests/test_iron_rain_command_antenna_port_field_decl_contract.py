...
# INDEX_NONE or lock CommandAntennaPort construction
...
# CommandAntennaPort;`); accept that form and other
...
# DispenserStarboard, CommandAntennaStarboard,
# DecoyController,
...
# CommandAntennaPort field declaration contract on
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardIronRainBoss::CommandAntennaPort",
    "SkyguardIronRainBoss.cpp",
    "SetExposed",
...
class IronRainCommandAntennaPortFieldDeclContractTests(unittest.TestCase):
    def test_iron_rain_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, COMMAND_ANTENNA_PORT_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, COMMAND_ANTENNA_PORT_FIELD)
        self.assertIn("CommandAntennaPort", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_missing_command_antenna_port_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardIronRainBoss();\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, COMMAND_ANTENNA_PORT_FIELD)
        self.assertIn("CommandAntennaPort", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, COMMAND_ANTENNA_PORT_FIELD)
        self.assertIn("CommandAntennaPort", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UPROPERTY", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("VisibleAnywhere", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("BlueprintReadOnly", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("Category", COMMAND_ANTENNA_PORT_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, COMMAND_ANTENNA_PORT_FIELD)
        self.assertIn("CommandAntennaPort", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUSkyguardBossWeakPointComponent* CommandAntennaPort;\n"
        )
        as_array = (
        ...
        scene = (
            "\tTObjectPtr<USceneComponent> CommandAntennaPort;\n"
        )
        mesh = (
            "\tTObjectPtr<UStaticMeshComponent> CommandAntennaPort;\n"
        )
        weak = (
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, COMMAND_ANTENNA_PORT_FIELD)
            self.assertIn("CommandAntennaPort", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_command_antenna_port_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, COMMAND_ANTENNA_PORT_FIELD),
            COMMAND_ANTENNA_PORT_FIELD,
        )
        self.assertTrue(has_declaration(section, COMMAND_ANTENNA_PORT_FIELD))
        self.assertEqual(declaration_count(section, COMMAND_ANTENNA_PORT_FIELD), 1)
        self.assertTrue(
            COMMAND_ANTENNA_PORT_FIELD.startswith(
                "TObjectPtr<USkyguardBossWeakPointComponent> "
            ),
            COMMAND_ANTENNA_PORT_FIELD,
        )
        self.assertTrue(COMMAND_ANTENNA_PORT_FIELD.endswith(";"), COMMAND_ANTENNA_PORT_FIELD)
        self.assertIn("CommandAntennaPort", COMMAND_ANTENNA_PORT_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            COMMAND_ANTENNA_PORT_FIELD,
        )
        self.assertIn("TObjectPtr<", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("TArray<", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("=", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("INDEX_NONE", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("UFUNCTION", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("{", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("}", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("return ", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("CommandAntenna;", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("ControlLinkage", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("NoseCamera", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("DebrisCenter", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("DebrisTail", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("DebrisNose", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("DebrisSpine", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("AdvanceEncounter", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("ResetEncounterState", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("IsRouteStateSafe", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("GetRouteProgress", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("GetEffectiveSpeedMultiplier", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("IsAttackTelegraphActive", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("GetTelegraphsTriggered", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("RadarNode", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("BeginTerminalStrikeCycle", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("OpenGuidanceArrayExposure", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("IssueClimbCommand", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("DivertWreckFromCivilians", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("SetCivilianSeparationMeters", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("GetCivilianSeparationMeters", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("GetFinaleStage", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("IsClimbCommandIssued", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("IsWreckDiverted", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("GetObjectiveMilestonesReached", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("ESkyguardLastFlightStage", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("GetGunnerMount", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("FaceWorldLocation", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("PortGuidanceArray", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("DebrisArmorPort", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("SetSearchlightTracked", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("SetContactIdentified", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("SetLightningExposed", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("HullCollider", COMMAND_ANTENNA_PORT_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_PORT} {COMMAND_ANTENNA_PORT_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(
                declaration_count(section, COMMAND_ANTENNA_PORT_FIELD),
                1,
            )
        one_line = f"{{\npublic:\n\t{COMMAND_ANTENNA_PORT_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, COMMAND_ANTENNA_PORT_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, COMMAND_ANTENNA_PORT_FIELD),
            section,
    ...
    def test_assigned_command_antenna_port_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<USkyguardBossWeakPointComponent> "
            "CommandAntennaPort = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, COMMAND_ANTENNA_PORT_FIELD)
        self.assertIn("CommandAntennaPort", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, COMMAND_ANTENNA_PORT_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("CommandAntennaPort", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, COMMAND_ANTENNA_PORT_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{COMMAND_ANTENNA_PORT_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, COMMAND_ANTENNA_PORT_FIELD)
        ...
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_PORT, section)
        self.assertTrue(has_declaration(section, COMMAND_ANTENNA_PORT_FIELD), section)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            COMMAND_ANTENNA_PORT_FIELD.startswith("UFUNCTION"),
            COMMAND_ANTENNA_PORT_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, COMMAND_ANTENNA_PORT_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", COMMAND_ANTENNA_PORT_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_command_antenna_port_cpp_body(self) -> None:
        locked_only = f"{COMMAND_ANTENNA_PORT_FIELD}\n"
        self.assertNotIn("{", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("}", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("return ", COMMAND_ANTENNA_PORT_FIELD)
        ...
        self.assertNotIn("SkyguardIronRainBoss.cpp", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("SkyguardIronRainBoss.cpp", locked_only)
        self.assertNotIn("return false", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("return true", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("CreateDefaultSubobject", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("SetExposed", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            COMMAND_ANTENNA_PORT_FIELD,
        )
        self.assertNotIn("SetBossPhase", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", COMMAND_ANTENNA_PORT_FIELD)

    def test_contract_does_not_relock_sibling_tempest_fields(self) -> None:
        locked_only = f"{COMMAND_ANTENNA_PORT_FIELD}\n"
        for token in SIBLING_TEMPEST_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("PortDischargeBoom", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("StarboardDischargeBoom", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("EngineIntake", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("DebrisPortPanel", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("DebrisStarboardPanel", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("DebrisIntakePanel", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("RequiredLockStabilitySeconds", COMMAND_ANTENNA_PORT_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            COMMAND_ANTENNA_PORT_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_encounter_controller(
        ...
        for token in LEFTOVER_ENCOUNTER_CONTROLLER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("EncounterController", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_control_servo(self) -> None:
        ...
        for token in LEFTOVER_CONTROL_SERVO_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("ControlServo", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_sibling_iron_rain_fields(self) -> None:
        ...
        for token in SIBLING_IRON_RAIN_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("DispenserPort", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("DispenserCenter", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("MaxReleasesPerBay", COMMAND_ANTENNA_PORT_FIELD)
        self.assertIn("CommandAntennaPort", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_dispenser_starboard(
        ...
        for token in LEFTOVER_DISPENSER_STARBOARD_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("DispenserStarboard", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_get_maneuver(self) -> None:
        ...
        for token in LEFTOVER_GET_MANEUVER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("GetManeuver", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_open_first_window(), COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn(leftover_open_final_window(), locked_only)
        self.assertNotIn(leftover_open_final_window(), COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn(leftover_arm_command_core_path(), locked_only)
        self.assertNotIn(leftover_arm_command_core_path(), COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn(leftover_apply_strike(), locked_only)
        self.assertNotIn(leftover_apply_strike(), COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn(leftover_is_lock_eligible(), locked_only)
        self.assertNotIn(leftover_is_lock_eligible(), COMMAND_ANTENNA_PORT_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, locked_only)
            self.assertNotIn(name, COMMAND_ANTENNA_PORT_FIELD)
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_debris_getters(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("GetDefeatDebrisPieceCount", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("GetMaxDefeatDebrisPieces", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("SetSearchlightTracked", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("ASkyguardBlackKiteBoss", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            ...
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("SetContactIdentified", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("OpenOrbitExposure", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_NOT_LOCKED:
            ...
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest_methods(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("SetLightningExposed", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("ApplyCorrectiveBankGust", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("IsLightningExposed", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("GetLockStabilitySeconds", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn(leftover_advance_stabilized_lock(), COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn(leftover_arm_break_finish(), COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn(leftover_is_break_finish_armed(), COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        for token in LEFTOVER_PATROL_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("ASkyguardPatrolShip", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        ...
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            ...
            self.assertNotIn(neighbor, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("ASkyguardGunner", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("SkyguardRadarNode", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            ...
            self.assertNotIn(token, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("MaxIntegrity", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("CurrentIntegrity", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn(
            "SkyguardPathfinderEncounterController.h",
            COMMAND_ANTENNA_PORT_FIELD,
        )
    ...
    def test_contract_does_not_open_leftover_weak_point_component_header(
        ...
        self.assertNotIn(leftover_header, COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, COMMAND_ANTENNA_PORT_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", COMMAND_ANTENNA_PORT_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{COMMAND_ANTENNA_PORT_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, COMMAND_ANTENNA_PORT_FIELD),
            COMMAND_ANTENNA_PORT_FIELD,
        )
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardIronRainBoss::CommandAntennaPort", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "iron rain CommandAntennaPort field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{COMMAND_ANTENNA_PORT_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, COMMAND_ANTENNA_PORT_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                COMMAND_ANTENNA_PORT_FIELD.lower(),
                "iron rain CommandAntennaPort contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, COMMAND_ANTENNA_PORT_FIELD)

    def test_contract_is_command_antenna_port_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertTrue(COMMAND_ANTENNA_PORT_FIELD.endswith(";"))
        self.assertNotIn("=", COMMAND_ANTENNA_PORT_FIELD)
        self.assertIn(UPROPERTY_PORT, section)
