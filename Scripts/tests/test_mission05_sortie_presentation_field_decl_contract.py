...
# THIS IS NOT leftover Mission04 bSortiePresentationReady #938.
# THIS IS NOT leftover Mission03 bSortiePresentationReady #900 /
# leftover Mission02 bSortiePresentationReady #868.
# THIS IS NOT leftover sortie-presentation-state enum #6c40 /
...
# SearchlightStarboard / Briefing / AudioDirector siblings.
# THIS IS NOT leftover FSkyguardMission05IntegrationReadiness
# fields, NOT leftover FSkyguardStormRuntime fields.
# THIS IS NOT leftover BindRuntimeActors. THIS IS NOT
...
# reopen open drafts #674-#948. LOCK leftover Mission10
# route-phase enum #701a, leftover Mission10 protected-group
# enum #6f9d, leftover Mission10 protected-runtime-defaults
# #7898. LOCK leftover convoy-route-state enum #d34e,
# leftover Mission03 wave-state enum #0242, leftover
# searchlight-track-runtime-defaults #7347. LOCK leftover
# radio-line-defaults #1dec. Skip leftover retired-mount
# spawn / runtime-ready entirely. Lock leftover Mission01 /
# Mission02 / Mission03 / Mission04 / Mission10 same-name
# Readiness drafts and leftover Mission02 / Mission03 /
# Mission04 / Mission10 same-name director SortiePresentation
# field drafts.
...
# Mission05 SortiePresentation FIELD
...
# c332, NOT leftover Mission10 AudioDirector field
# #794 / branch cursor/
...
# FSkyguardStormRuntime, private, or Mission01 /
# Mission02 / Mission03 / Mission04 / Mission06-10 directors.
...
# drafts #674-#908 including leftover Mission03
...
class Mission05SortiePresentationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("Skyguard|Mission02|Protection", UPROPERTY_MISSION05)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 SortiePresentation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 SortiePresentation field contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_sortie_presentation_field"
                "_decl_contract.py"
            )
        )
        leftover_56_64 = (
    ...
    def test_leftover_mission03_sortie_presentation_does_not_satisfy(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_sortie_presentation_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_leftover_mission04_sortie_presentation_does_not_satisfy(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_sortie_presentation_ready_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
