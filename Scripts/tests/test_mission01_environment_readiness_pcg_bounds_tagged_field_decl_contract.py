...
# bPCGBoundsTagged FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bPCGBoundsTagged = false; one-line /
...
# bPCGBoundsTagged. THIS IS NOT leftover
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bPCGBoundsTagged FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# bool bPCGBoundsTagged = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover Mission01 environment-readiness-defaults
...
# FSkyguardMission01EnvironmentReadiness bPCGBoundsTagged
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bPCGBoundsTagged = false;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bPCGBoundsTagged. THIS IS NOT leftover mission-map-
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bPCGBoundsTagged. THIS IS NOT leftover Mission05
...
# Mission01 EnvironmentReadiness bPCGBoundsTagged
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bPCGBoundsTagged = false;
# one-line / split-line UPROPERTY wraps;
...
# bPCGBoundsTagged FIELD (declaration-only). It is
...
TARGET = "bool bPCGBoundsTagged = false;"
TARGET_WRONG = "bool bPCGBoundsTagged = true;"
LOCKED_DECL = TARGET
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*bool\s+bPCGBoundsTagged\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for bool bPCGBoundsTagged is missing from "
...
class Mission01EnvironmentReadinessPcgBoundsTaggedFieldDeclContractTests(unittest.TestCase):
    def test_environment_readiness_struct_exists(self) -> None:
        ...
        self.assertIn("bPCGBoundsTagged", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bPCGBoundsTagged", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_pcg_bounds_tagged_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_pcg_bounds_tagged_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bPCGBoundsTagged"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bPCGBoundsTagged", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bPCGBoundsTagged", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bPCGBoundsTagged"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bPCGBoundsTagged", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_pcg_bounds_tagged(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
