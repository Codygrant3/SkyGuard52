...
# or lock the IsChinTurretDown body in the .cpp.
...
# GetSensorTurret; this is not that GetChinTurret
# mount getter). This is not leftover
...
# IsCanopyGlassCracked, AreEnginesDown, IsRotorDown,
# GetSensorQuality, and remaining unused neighbors
# (IsRotorDown, GetChinSlewScale, GetChinFireScale,
...
# IsChinTurretDown declaration contract on
...
# SetFirstPersonInterior, SetDirectFlightInput,
# GetForwardSpeed, ApplyDamage, GetDamageFraction,
# IsCanopyGlassCracked, ApplySystemHit, ApplyHit,
...
# AreEnginesDown sibling, leftover IsRotorDown
# sibling, leftover GetSensorQuality sibling, and
...
# IsCanopyGlassCracked, and remaining public methods
# stay sibling-only.
UNLOCKED_NEIGHBORS = (
...
# IsChinTurretDown return type is not a leftover
# roster value lock.
LEFTOVER_NOT_LOCKED = (
    "ESkyguardApacheSystem",
...
# .cpp IsChinTurretDown body / invented INDEX_NONE stay
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardApacheAircraft::IsChinTurretDown",
    "SkyguardApacheAircraft.cpp",
)
SIBLING_TYPES = (
...
class ApacheIsChinTurretDownDeclContractTests(unittest.TestCase):
    def test_apache_aircraft_class_exists(self) -> None:
        ...
        self.assertTrue(has_declaration(section, IS_CHIN_TURRET_DOWN), section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, IS_CHIN_TURRET_DOWN)
        self.assertIn("IsChinTurretDown", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(has_declaration(section, IS_CHIN_TURRET_DOWN))

    def test_missing_is_chin_turret_down_declaration_fails_closed(self) -> None:
        neighbors_only = (
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, IS_CHIN_TURRET_DOWN)
        self.assertIn("IsChinTurretDown", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, IS_CHIN_TURRET_DOWN)
        self.assertIn("IsChinTurretDown", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertTrue(has_declaration(section, IS_CHIN_TURRET_DOWN), section)
        self.assertNotIn("BlueprintPure", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("UFUNCTION", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("Category", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("BlueprintCallable", IS_CHIN_TURRET_DOWN)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, IS_CHIN_TURRET_DOWN)
        self.assertIn("IsChinTurretDown", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        missing_parens = "\tbool IsChinTurretDown const;\n"
        wrong_return_void = "\tvoid IsChinTurretDown() const;\n"
        wrong_return_float = "\tfloat IsChinTurretDown() const;\n"
        wrong_return_int = "\tint32 IsChinTurretDown() const;\n"
        missing_const = "\tbool IsChinTurretDown();\n"
        added_arg = "\tbool IsChinTurretDown(float Extra) const;\n"
        leftover_canopy = (
            "\tbool IsCanopyGlassCracked() const "
            "{ return bCanopyGlassCracked; }\n"
        )
        ...
        leftover_chin_slew = "\tfloat GetChinSlewScale() const;\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, IS_CHIN_TURRET_DOWN)
            self.assertIn("IsChinTurretDown", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_is_chin_turret_down_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, IS_CHIN_TURRET_DOWN),
            IS_CHIN_TURRET_DOWN,
        )
        self.assertTrue(has_declaration(section, IS_CHIN_TURRET_DOWN))
        self.assertEqual(declaration_count(section, IS_CHIN_TURRET_DOWN), 1)
        self.assertTrue(
            IS_CHIN_TURRET_DOWN.startswith("bool "),
            IS_CHIN_TURRET_DOWN,
        )
        self.assertTrue(IS_CHIN_TURRET_DOWN.endswith(";"), IS_CHIN_TURRET_DOWN)
        self.assertIn("IsChinTurretDown()", IS_CHIN_TURRET_DOWN)
        self.assertIn(" const", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("INDEX_NONE", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("{", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("}", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("return ", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("IsCanopyGlassCracked", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("AreEnginesDown", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("IsRotorDown", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("IsSystemDown", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetEnginePowerScale", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetDamageFraction", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("ApplyDamage", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetForwardSpeed", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("FaceWorldLocation", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("ApplySystemHit", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("ApplyHit", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("IsSensorLive", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("IsThermalAvailable", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("IsSensorViewActive", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetChinMuzzleLocation", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetChinTurret", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("AimChinTurret", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetChinSlewScale", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetChinFireScale", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetRotorPowerScale", IS_CHIN_TURRET_DOWN)

    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tbool\n"
            "\tIsChinTurretDown() const;\n"
            "private:\n"
            "};\n"
        )
        wrap_name = (
            "public:\n"
            "\tbool IsChinTurretDown(\n"
            "\t) const;\n"
            "private:\n"
            "};\n"
        )
        ...
        for header in (
            ...
            section = public_section(header)
            self.assertTrue(
                has_declaration(section, IS_CHIN_TURRET_DOWN),
                section,
            )
            self.assertEqual(
                require_declaration(section, IS_CHIN_TURRET_DOWN),
            ...
            self.assertEqual(
                declaration_count(section, IS_CHIN_TURRET_DOWN),
                1,
            )
        one_line = f"{{\npublic:\n\t{IS_CHIN_TURRET_DOWN}\n}}\n"
        self.assertTrue(has_declaration(one_line, IS_CHIN_TURRET_DOWN))
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, IS_CHIN_TURRET_DOWN), section)
        self.assertEqual(
            require_declaration(section, IS_CHIN_TURRET_DOWN),
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        locked_only = f"{IS_CHIN_TURRET_DOWN}\n"
        self.assertNotIn("INDEX_NONE", locked_only)
        self.assertNotIn("INDEX_NONE", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("return INDEX_NONE", locked_only)
        self.assertNotIn("NAME_None", IS_CHIN_TURRET_DOWN)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_is_chin_turret_down_cpp_body(self) -> None:
        locked_only = f"{IS_CHIN_TURRET_DOWN}\n"
        self.assertNotIn("{", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("}", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("return ", IS_CHIN_TURRET_DOWN)
        ...
        self.assertNotIn("SkyguardApacheAircraft.cpp", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("SkyguardApacheAircraft.cpp", locked_only)
        self.assertNotIn("return false", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("return true", IS_CHIN_TURRET_DOWN)

    def test_contract_does_not_relock_mount_getters(self) -> None:
        locked_only = f"{IS_CHIN_TURRET_DOWN}\n"
        for token in MOUNT_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetGunnerMount", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetEyeMount", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetWeaponMount", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetChinTurret", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetPilotMount", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetSensorTurret", IS_CHIN_TURRET_DOWN)

    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        locked_only = f"{IS_CHIN_TURRET_DOWN}\n"
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetChinMuzzleLocation", IS_CHIN_TURRET_DOWN)
    ...
    def test_contract_does_not_relock_set_rotor_power(self) -> None:
        ...
        for neighbor in SET_ROTOR_POWER_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, IS_CHIN_TURRET_DOWN)
        self.assertNotIn("SetRotorPower", IS_CHIN_TURRET_DOWN)
    ...
    def test_contract_does_not_relock_issue_pilot_command(self) -> None:
        ...
        for neighbor in ISSUE_PILOT_COMMAND_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, IS_CHIN_TURRET_DOWN)
        self.assertNotIn("IssuePilotCommand", IS_CHIN_TURRET_DOWN)
    ...
    def test_contract_does_not_relock_get_pilot_helpers(self) -> None:
        ...
        for neighbor in GET_PILOT_HELPERS_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetPilotCommand", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("GetPilotConfirmationsIssued", IS_CHIN_TURRET_DOWN)
    ...
    def test_contract_does_not_relock_orbit_or_face(self) -> None:
        ...
        for neighbor in ORBIT_AND_FACE_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, IS_CHIN_TURRET_DOWN)
        self.assertNotIn("SetOrbitFocus", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("FaceWorldLocation", IS_CHIN_TURRET_DOWN)
    ...
    def test_contract_does_not_relock_sensor_view_or_interior(self) -> None:
        ...
        for neighbor in SENSOR_VIEW_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, IS_CHIN_TURRET_DOWN)
        self.assertNotIn("SetSensorView", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("SetFirstPersonInterior", IS_CHIN_TURRET_DOWN)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_CHIN_TURRET_DOWN)
        self.assertNotIn("ESkyguardApacheSystem", IS_CHIN_TURRET_DOWN)
    ...
    def test_contract_does_not_relock_leftover_direct_flight_input_sibling(
        ...
        self.assertNotIn("SetDirectFlightInput", IS_CHIN_TURRET_DOWN)
    ...
    def test_contract_does_not_relock_leftover_get_sensor_quality_sibling(
        ...
        self.assertNotIn("GetSensorQuality", IS_CHIN_TURRET_DOWN)
    ...
    def test_contract_does_not_lock_pilot_command_enum_values(self) -> None:
        ...
        for token in leftover_short_roster_values():
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_CHIN_TURRET_DOWN)
        self.assertNotIn("Pursuit", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("OrbitLeft", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("AttackRun", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("FaceTarget", IS_CHIN_TURRET_DOWN)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        for token in LEFTOVER_WIDGET_DECL_NOT_LOCKED:
            ...
            self.assertNotIn(token, IS_CHIN_TURRET_DOWN)
            self.assertNotIn(token, section)
        self.assertNotIn("USkyguardDebriefWidget", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("USkyguardBriefingWidget", IS_CHIN_TURRET_DOWN)
        self.assertNotIn(
            "test_debrief_widget_travel_next_decl_contract.py",
            IS_CHIN_TURRET_DOWN,
        )
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, IS_CHIN_TURRET_DOWN)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("ESkyguardMissionSkylineStyle", IS_CHIN_TURRET_DOWN)

    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{IS_CHIN_TURRET_DOWN}\n"
        self.assertEqual(
            require_declaration(locked_only, IS_CHIN_TURRET_DOWN),
            IS_CHIN_TURRET_DOWN,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "apache IsChinTurretDown contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            ...
            self.assertNotIn(banned, IS_CHIN_TURRET_DOWN.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                lowered,
                f"apache IsChinTurretDown contains {banned}; "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, IS_CHIN_TURRET_DOWN)

    def test_contract_is_is_chin_turret_down_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertNotIn("return ", IS_CHIN_TURRET_DOWN)
        self.assertNotIn("{", IS_CHIN_TURRET_DOWN)
        self.assertTrue(IS_CHIN_TURRET_DOWN.startswith("bool "))
        self.assertTrue(IS_CHIN_TURRET_DOWN.endswith(";"))
        self.assertIn(" const", IS_CHIN_TURRET_DOWN)
        self.assertIn(UFUNCTION_APACHE, section)
