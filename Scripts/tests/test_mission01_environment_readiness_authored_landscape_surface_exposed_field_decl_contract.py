...
# bAuthoredLandscapeSurfaceExposed FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly bool
# bAuthoredLandscapeSurfaceExposed = false; one-line /
...
# Do not reopen open drafts #674-#1170.
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bAuthoredLandscapeSurfaceExposed FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bAuthoredLandscapeSurfaceExposed = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# FSkyguardMission01EnvironmentReadiness bAuthoredLandscapeSurfaceExposed
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bAuthoredLandscapeSurfaceExposed = false;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bAuthoredLandscapeSurfaceExposed. THIS IS NOT leftover mission-map-
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bAuthoredLandscapeSurfaceExposed. THIS IS NOT leftover Mission05
...
# Mission01 EnvironmentReadiness bAuthoredLandscapeSurfaceExposed
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bAuthoredLandscapeSurfaceExposed = false;
# one-line / split-line UPROPERTY wraps;
...
# bAuthoredLandscapeSurfaceExposed FIELD (declaration-only). It is
...
TARGET = "bool bAuthoredLandscapeSurfaceExposed = false;"
TARGET_WRONG = "bool bAuthoredLandscapeSurfaceExposed = true;"
LOCKED_DECL = TARGET
...
class Mission01EnvironmentReadinessAuthoredLandscapeSurfaceExposedFieldDeclContractTests(unittest.TestCase):
    def test_environment_readiness_struct_exists(self) -> None:
        ...
        self.assertIn("bAuthoredLandscapeSurfaceExposed", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bAuthoredLandscapeSurfaceExposed", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_authored_landscape_surface_exposed_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_authored_landscape_surface_exposed_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bAuthoredLandscapeSurfaceExposed"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bAuthoredLandscapeSurfaceExposed", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bAuthoredLandscapeSurfaceExposed", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bAuthoredLandscapeSurfaceExposed"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bAuthoredLandscapeSurfaceExposed", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_authored_landscape_surface_exposed(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
