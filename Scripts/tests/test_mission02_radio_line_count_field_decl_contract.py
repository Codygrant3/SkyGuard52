...
# leftover radio-line-defaults #1dec / branch
# cursor/radio-line-defaults-contract-1dec, NOT leftover
# Mission01 RadioLineCount sibling on
...
# struct section of
# FSkyguardMission02IntegrationReadiness only
# (not ASkyguardMission02IntegrationDirector).
...
# FSkyguardMission02IntegrationReadiness public section. Pathfinder MinHeightFromOriginCm
...
class Mission02RadioLineCountFieldDeclContractTests(unittest.TestCase):
    def test_mission02_struct_exists(self) -> None:
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 RadioLineCount field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 RadioLineCount contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_radio_line_count"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
