...
# Mission10 Waves GetRemainingThreatsInWave
# METHOD (inline body) on
# ASkyguardMission10IntegrationDirector. It is
# NOT leftover Mission09 GetRemainingThreatsInWave
# #761 / branch cursor/mission09-get-remaining-
# threats-in-wave-decl-contract-c332, NOT leftover
# Mission08 GetRemainingThreatsInWave #742, NOT
# leftover Mission07 GetRemainingThreatsInWave
# #721, NOT leftover Mission06
# GetRemainingThreatsInWave #699, NOT leftover
# Mission05 GetRemainingThreatsInWave #677, NOT
# leftover closed Mission04 GetRemainingThreatsInWave
# #662, NOT leftover
...
# Mission08 / Mission09, not leftover Mission09 Waves
# #761, Payload / Targets / Objectives / Search /
# Protection / Hoist / Safety / Boss / Destruction /
...
class Mission10GetRemainingThreatsInWaveDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        with_arg = (
            "\tconst FSkyguardMission09IntegrationReadiness& "
            "GetRemainingThreatsInWave(int32 Amount) const;\n"
        )
        renamed = (
            "\tconst FSkyguardMission09IntegrationReadiness& "
            "GetReadyState() const;\n"
        )
        short_name = "\tbool GetRemainingThreatsInWave() const;\n"
        leftover_m06_type = (
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 GetRemainingThreatsInWave method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission10 GetRemainingThreatsInWave contains "
