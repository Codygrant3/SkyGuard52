...
# CampaignSaveSlotName / CampaignSaveUserIndex field
...
# (`int32 MaximumFuelTerminalIntegrity = 100;` with
...
# Category is Skyguard|Mission02, not
# leftover Mission10|Campaign, not
...
# drafts #674-#857, leftover Apache
...
UPROPERTY_MISSION02_CLAMP = 'meta=(ClampMin="1")'
...
LOCKED_DECL = MAXIMUM_FUEL_TERMINAL_INTEGRITY_FIELD
...
# an isolated Python MaximumFuelTerminalIntegrity
# field declaration contract on
# ASkyguardMission02IntegrationDirector.
# Not leftover Mission10 protected-group
# enum #6f9d / protected-runtime-defaults
# #7898. Not leftover Mission10
# CampaignSaveUserIndex field.
LOCKED = {
...
class Mission10MaximumFuelTerminalIntegrityFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("MaximumFuelTerminalIntegrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_maximum_fuel_terminal_integrity_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        macro_only = f"\t{UPROPERTY_MISSION02}\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn(UPROPERTY_MISSION02_CLAMP, section)
        ...
        self.assertNotIn("BlueprintCallable", UPROPERTY_MISSION02)
        self.assertNotIn("BlueprintPure", UPROPERTY_MISSION02)
        self.assertIn("Skyguard|Mission02", UPROPERTY_MISSION02)
        self.assertNotIn("Skyguard|Mission10|Protection", UPROPERTY_MISSION02)
        self.assertNotIn("Skyguard|Mission10|Campaign", UPROPERTY_MISSION02)
        self.assertNotIn("Integration", UPROPERTY_MISSION02)
        self.assertNotIn("Mission01", UPROPERTY_MISSION02)
        self.assertNotIn("Mission03", UPROPERTY_MISSION02)
        self.assertNotIn("Mission04", UPROPERTY_MISSION02)
        self.assertNotIn("Mission05", UPROPERTY_MISSION02)
        self.assertNotIn("Mission06", UPROPERTY_MISSION02)
        self.assertNotIn("Protection", UPROPERTY_MISSION02)
        self.assertNotIn("Search", UPROPERTY_MISSION02)
        self.assertNotIn("Waves", UPROPERTY_MISSION02)
        self.assertNotIn("Payload", UPROPERTY_MISSION02)
        self.assertNotIn("Targets", UPROPERTY_MISSION02)
        self.assertNotIn("Objectives", UPROPERTY_MISSION02)
        self.assertNotIn("Environment", UPROPERTY_MISSION02)
        self.assertNotIn("Briefing", UPROPERTY_MISSION02)
        self.assertNotIn("Mission10", UPROPERTY_MISSION02)
        self.assertNotIn("Boss", UPROPERTY_MISSION02)
        self.assertNotIn("Destruction", UPROPERTY_MISSION02)
        self.assertNotIn("Apache", UPROPERTY_MISSION02)
        self.assertNotIn("Mission07", UPROPERTY_MISSION02)
        self.assertNotIn("Mission08", UPROPERTY_MISSION02)
        self.assertNotIn("Mission09", UPROPERTY_MISSION02)
        self.assertNotIn("Encounter", UPROPERTY_MISSION02)
        self.assertNotIn("Safety", UPROPERTY_MISSION02)
        self.assertNotIn("Performance", UPROPERTY_MISSION02)
        self.assertNotIn("Hoist", UPROPERTY_MISSION02)
        self.assertNotIn("Rescue", UPROPERTY_MISSION02)
        self.assertNotIn("Evacuation", UPROPERTY_MISSION02)
        self.assertNotIn("Campaign", UPROPERTY_MISSION02)
        self.assertIn("Skyguard|Mission02", UPROPERTY_MISSION02)
        self.assertNotIn("ClampMin", UPROPERTY_MISSION02)
        self.assertNotIn("ClampMin", LOCKED_DECL)
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, UPROPERTY_MISSION02)
    ...
    def test_maximum_fuel_terminal_integrity_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 MaximumFuelTerminalIntegrity"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("MaximumFuelTerminalIntegrity", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tint32\n"
            "\tMaximumFuelTerminalIntegrity = 100;\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION02} {LOCKED_DECL}\n"
            "};\n"
        )
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(environment, UPROPERTY_MISSION02)
        self.assertNotEqual(briefing, UPROPERTY_MISSION02)
        self.assertNotIn(environment, UPROPERTY_MISSION02)
        self.assertNotIn(briefing, UPROPERTY_MISSION02)
        leftover_m01 = (
            'UFUNCTION(BlueprintCallable, '
        ...
        self.assertNotEqual(leftover_m01, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m02, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_harbor, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m03, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m04, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m05, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m06, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_waves, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m05_waves, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_integration, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m07_ready, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m08_waves, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m08_hoist, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m08_safety, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m08_protection, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m08_ready, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m09_ready, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m09_waves, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m10_safety, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m09_protection, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m09_performance, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_m09_objectives, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_payload, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_targets, UPROPERTY_MISSION02)
        self.assertNotEqual(leftover_objectives, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m01, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m02, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_harbor, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m03, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m04, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m05, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m06, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m05_waves, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_integration, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m07_ready, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m08_waves, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m08_hoist, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m08_safety, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m08_protection, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m08_ready, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m09_ready, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m09_waves, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m10_safety, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m09_protection, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m09_performance, UPROPERTY_MISSION02)
        self.assertNotIn(leftover_m09_objectives, UPROPERTY_MISSION02)
        self.assertNotIn("Mission01", UPROPERTY_MISSION02)
        self.assertNotIn("Mission03", UPROPERTY_MISSION02)
        self.assertNotIn("Mission04", UPROPERTY_MISSION02)
        self.assertNotIn("Mission05", UPROPERTY_MISSION02)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("MaximumFuelTerminalIntegrity", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 MaximumFuelTerminalIntegrity"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("MaximumFuelTerminalIntegrity", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 MaximumFuelTerminalIntegrity field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 MaximumFuelTerminalIntegrity contains "
    ...
    def test_contract_is_maximum_fuel_terminal_integrity_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertNotIn("int32 Integrity = 100", LOCKED_DECL)
        self.assertNotIn("ESkyguardMission10ProtectedGroup", LOCKED_DECL)
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tint32 MaximumFuelTerminalIntegrity = 1;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_contract_does_not_relock_leftover_handle_boss_phase_changed(
        ...
        for token in LEFTOVER_HANDLE_BOSS_PHASE_CHANGED_NOT_LOCKED:
            ...
            self.assertNotIn(token, LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", UPROPERTY_MISSION02)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission02_maximum_fuel_terminal_integrity_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_maximum_fuel_terminal_integrity_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission02_sibling_isolated_contracts_stay_locked(
        self,
    ) -> None:
        for leftover in (
            "Scripts/tests/test_mission02_initialize_playable_mission"
    ...
    def test_leftover_get_fuel_terminal_integrity_stays_locked(self) -> None:
        self.assertIn(
        ...
        locked_only = f"{LOCKED_DECL}\n"
        self.assertNotIn("GetFuelTerminalIntegrity", locked_only)
        self.assertNotIn("GetFuelTerminalIntegrity", LOCKED_DECL)
        self.assertNotIn(GET_FUEL_TERMINAL_INTEGRITY, LOCKED_DECL)
        region = f"\t{GET_FUEL_TERMINAL_INTEGRITY}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(region, LOCKED_DECL)
        self.assertIn("MaximumFuelTerminalIntegrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_leftover_notify_fuel_terminal_damage_stays_locked(self) -> None:
        self.assertIn(
        ...
        self.assertNotIn(NOTIFY_FUEL_TERMINAL_DAMAGE, LOCKED_DECL)
        region = f"\t{NOTIFY_FUEL_TERMINAL_DAMAGE}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(region, LOCKED_DECL)
        self.assertIn("MaximumFuelTerminalIntegrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_leftover_mission10_maximum_protected_integrity_stays_locked(
        ...
        region = f"\t{MAXIMUM_PROTECTED_INTEGRITY_FIELD}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(region, LOCKED_DECL)
        self.assertIn("MaximumFuelTerminalIntegrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_leftover_readiness_field_does_not_satisfy(self) -> None:
        locked_only = f"{LOCKED_DECL}\n"
        self.assertNotIn("Readiness;", locked_only)
        self.assertNotIn("Readiness;", LOCKED_DECL)
        self.assertNotIn(READINESS_FIELD, LOCKED_DECL)
        self.assertNotIn("FSkyguardMission02IntegrationReadiness", LOCKED_DECL)
        region = f"\t{READINESS_FIELD}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(region, LOCKED_DECL)
        self.assertIn("MaximumFuelTerminalIntegrity", str(raised.exception))
