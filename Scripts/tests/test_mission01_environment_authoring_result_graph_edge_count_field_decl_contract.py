...
# GraphEdgeCount. THIS IS NOT leftover mission01-environment-authoring-result-defaults
# #df1a. THIS IS NOT leftover AuthoredPCGGraph #594. Distinct from sibling
# Graph (TObjectPtr) #1234 and in-flight GraphNodeCount.
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphEdgeCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 GraphEdgeCount = 0; one-line / split-line
...
# #1233 / Graph #1234 / bSuccess #1235, leftover MaterialCompilation
# through Error #1232. LOCK in-flight leftover-safe Success /
# Landscape / Graph / VisibleAudit / LandscapeComponentCount /
# GraphNodeCount field siblings; do not edit them.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphEdgeCount. THIS IS NOT leftover mission01-environment-authoring-
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphEdgeCount. THIS IS NOT leftover mission01-environment-authoring-result-
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphEdgeCount FIELD (declaration-only; VisibleAnywhere / BlueprintReadOnly
# int32 GraphEdgeCount = 0; one-line /
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphEdgeCount. THIS IS NOT leftover VisibleAudit
...
# DIFFERENT field).
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphEdgeCount FIELD (declaration-only;
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphEdgeCount. THIS IS NOT leftover VisibleAudit bSuccess #1199.
...
# Do NOT parse FSkyguardLandscapeVisibleAudit (leftover bSuccess #1199).
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphEdgeCount. THIS IS NOT leftover
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphEdgeCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 GraphEdgeCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# BlueprintReadOnly int32 GraphEdgeCount = 0;
...
TARGET = "int32 GraphEdgeCount = 0;"
TARGET_WRONG = "int32 GraphEdgeCount = 1;"
LOCKED_DECL = TARGET
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # FSkyguardMission01EnvironmentAuthoringResult::GraphEdgeCount
    # (must be int32 GraphEdgeCount = 0;).
    # THIS IS NOT leftover VisibleAudit bSuccess #1199.
    # THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*int32\s+GraphEdgeCount\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for int32 GraphEdgeCount is missing from "
...
class Mission01EnvironmentAuthoringResultGraphEdgeCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("GraphEdgeCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_graph_edge_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_graph_edge_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 GraphEdgeCount"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("GraphEdgeCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("GraphEdgeCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 GraphEdgeCount"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("GraphEdgeCount", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_graph_edge_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
