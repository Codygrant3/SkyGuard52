...
# Mission02 Integration RadioChatter
# FIELD (declaration-only, one-line / split-line
# UPROPERTY wraps) on
# ASkyguardMission02IntegrationDirector. It is
# NOT leftover Mission10 RadioChatter field #796 /
# branch cursor/mission10-radio-chatter-field-
# decl-contract-c332, NOT leftover Mission01
# RadioChatter field #576 / branch
# cursor/mission01-radio-chatter-field-decl-
# contract-c332, NOT leftover Mission03-09 same-
# name RadioChatter field contracts, NOT leftover
# Mission02 Briefing field sibling, NOT leftover
# Mission02 Root field sibling, NOT leftover
# Mission02 AudioDirector field sibling, NOT leftover
...
# UFUNCTION siblings #828-#844, NOT leftover
...
# methods.
# not leftover Root / HighwayConvoyAnchor /
...
class Mission02RadioChatterFieldDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tUSkyguardRadioChatterComponent* RadioChatter;\n"
        )
        as_const = (
            "\tconst TObjectPtr<USkyguardRadioChatterComponent>& "
            "RadioChatter;\n"
        )
        with_arg = (
            "\tTArray<TObjectPtr<USkyguardRadioChatterComponent>> "
            "RadioChatter;\n"
        )
        renamed = (
        ...
        leftover_briefing_field = f"\t{BRIEFING_FIELD}\n"
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 RadioChatter field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 RadioChatter field contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_radio_chatter_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
