...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission09 PoolRuntime
# Active. THIS IS NOT leftover Mission08
...
# INDEX_NONE or lock Active
# construction in the .cpp. This is leftover-safe
# Mission09 PoolRuntime Active
...
# Active FIELD (declaration-only). It is
...
# is Active after Available and before PeakActive. Skip leftover
...
class Mission09PoolRuntimeActiveFieldDeclContractTests(unittest.TestCase):
    ...
    def test_active_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 Active"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("Active", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("Active", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 Active"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("Active", locked_only)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_pool_runtime_active"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
