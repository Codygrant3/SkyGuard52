...
# Mission07 CampaignDefinition FIELD
...
# drafts #674-#1012 including leftover Mission06
...
class Mission07CampaignDefinitionFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_campaign_definition_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
