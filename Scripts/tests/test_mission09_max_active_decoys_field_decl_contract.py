...
# MaxActiveDecoys FIELD (declaration-only;
# EditAnywhere / BlueprintReadWrite int32 = 12;
...
# MaxActiveDecoys. THIS IS NOT leftover Mission08
...
# the origin/main `= 12` default,
# ClampMin 0 / ClampMax 24, and nearby split-line
# UPROPERTY wraps without locking a
...
# struct section of
# FSkyguardMission09PoolBudget only
# between struct FSkyguardMission09PoolBudget
# and struct FSkyguardMission09PoolRuntime (not
# ASkyguardMission09IntegrationDirector public
# fields already drafted through Root #1083 /
# leftover director Readiness #1100 / leftover
# bMissionDefinitionValid #1101 through
...
# BlueprintReadWrite / int32. Assert ClampMin 0,
# ClampMax 24, default 12. This PoolBudget field
# sits after PoolCapacity and before
# MaxSimultaneousExplosions. Skip leftover b + Ya +
# kRuntimeReady forever (it sits after
# bMapAssemblyReady and before bGunnerReady). This
# contract is MaxActiveDecoys after PoolCapacity.
# Skip leftover
...
MAX_ACTIVE_DECOYS_WRONG_DEFAULT = (
    "int32 MaxActiveDecoys = 24;"
)
LOCKED_DECL = MAX_ACTIVE_DECOYS
MAX_ACTIVE_THREATS_FIELD = "int32 MaxActiveThreats = 24;"
POOL_CAPACITY_FIELD = "int32 PoolCapacity = 48;"
MAX_SIMULTANEOUS_EXPLOSIONS_FIELD = (
...
# an isolated Python MaxActiveDecoys
...
class Mission09MaxActiveDecoysFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("MaxActiveDecoys", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_max_active_decoys_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
            ...
            f"\t{MAX_SIMULTANEOUS_EXPLOSIONS_FIELD}\n"
        )
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn('ClampMin="0"', UPROPERTY_MISSION10)
        self.assertIn('ClampMax="24"', UPROPERTY_MISSION10)
    ...
    def test_max_active_decoys_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 MaxActiveDecoys"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= 12;"), LOCKED_DECL)
        ...
        self.assertIn("MaxActiveDecoys", LOCKED_DECL)
        self.assertIn("int32 ", LOCKED_DECL)
        self.assertIn("= 12", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("MaxActiveDecoys", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 MaxActiveDecoys"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("MaxActiveDecoys", locked_only)
    ...
    def test_contract_is_max_active_decoys_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(LOCKED_DECL.startswith("int32 MaxActiveDecoys"))
        self.assertIn("MaxActiveDecoys", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("= 12;"))
        self.assertTrue(LOCKED_DECL.endswith(";"))
        self.assertNotIn("GetProtectedGroup", LOCKED_DECL)
        self.assertNotIn("FSkyguardMission10ProtectedRuntime", LOCKED_DECL)
        self.assertIn(UPROPERTY_MISSION10, section)

    def test_sibling_director_fields_do_not_satisfy_max_active_decoys(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_max_active_decoys"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_same_name_wave_count_contracts_stay_locked(
        ...
        self.assertIn(
            "Scripts/tests/test_mission09_maximum_protected_target_integrity"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
