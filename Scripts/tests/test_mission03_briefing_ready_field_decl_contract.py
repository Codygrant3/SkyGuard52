...
# Mission03 IntegrationReadiness bBriefingReady
...
# briefing-ready-field-decl-contract-c332,
# NOT leftover Mission03 director Briefing
# FIELD #878 / branch cursor/mission03-
...
# drafts #674-#896 including leftover Mission02
...
class Mission03BriefingReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 bBriefingReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission03 bBriefingReady contains "
