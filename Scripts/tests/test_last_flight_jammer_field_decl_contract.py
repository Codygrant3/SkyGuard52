...
class LastFlightJammerFieldDeclContractTests(unittest.TestCase):
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, JAMMER_FIELD)
        self.assertNotIn("SetSearchlightTracked", JAMMER_FIELD)
        self.assertNotIn("ASkyguardBlackKiteBoss", JAMMER_FIELD)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "last flight Jammer field contract contains "
