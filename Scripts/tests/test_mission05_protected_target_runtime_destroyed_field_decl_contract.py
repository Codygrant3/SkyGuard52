...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission05 ProtectedTargetRuntime
# bDestroyed. Last leftover-safe Mission05 PTR public
# UPROPERTY field. THIS IS NOT leftover Mission05 PTR
# Target / Integrity siblings. THIS IS NOT leftover
# Mission05 protected-target enum #aaa2. THIS IS NOT
# leftover Mission05 protected-target-runtime-defaults
# #ec8b. THIS IS NOT leftover Mission05 closed-without-
# merge #665 #666 #668-#673. THIS IS NOT leftover
# Mission05 director/readiness UPROPERTY or leftover
# Mission05 methods. THIS IS NOT leftover
# GetProtectedTarget / NotifyProtectedAssetFailed.
# THIS IS NOT leftover Mission06 Airfield bDestroyed
# #1142, leftover Mission07 PTR bDestroyed #1140,
# leftover Mission08 PTR bDestroyed #1128, leftover
# Mission09 PTR bDestroyed #1125, leftover in-flight
# Mission05 PTR Target / Integrity. THIS IS NOT leftover
# Mission06 Airfield Target #1139 / Integrity #1141 /
# Destroyed #1142. THIS IS NOT leftover Mission06
# PayloadWindow bActive #1143 / Target #1144 /
# RemainingSeconds #1145 / bJammed #1146. THIS IS NOT leftover Mission08 PTR
# bDestroyed #1128 / Mission09 PTR bDestroyed #1125.
# THIS IS NOT leftover Mission07 protected-target enum
# #223/#18f2. THIS IS NOT leftover Mission07
# protected-target-runtime-defaults #221/#866c.
# THIS IS NOT leftover Mission07 PTR Target #1137 /
# Integrity #1138. THIS IS NOT leftover Mission08 PTR
# Target #1129 / Mission09 PTR Target #1124. THIS IS NOT
# leftover NotifyThreatDestroyed #713. THIS IS NOT leftover
...
# Mission05 ProtectedTargetRuntime bDestroyed
...
# This ProtectedTargetRuntime field sits last in the public
# section, after Target / Integrity. Skip leftover
# b + Ya + kRuntimeReady forever (it sits after
# bMapAssemblyReady and before bGunnerReady). This contract
# is bDestroyed after Integrity. THIS IS NOT leftover Mission08
# PTR bDestroyed #1128 / Mission09 PTR bDestroyed #1125.
# THIS IS NOT leftover Mission07 PTR Target #1137 /
# Integrity #1138. THIS IS NOT leftover Mission08
...
# Target / Integrity sibling fields. Skip leftover
...
# Harbor 40/80 fail-closed in this NEW Mission05
...
class Mission05ProtectedTargetRuntimeDestroyedFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 bDestroyed field contract "
