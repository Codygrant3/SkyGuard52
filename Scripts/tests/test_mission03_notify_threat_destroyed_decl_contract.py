...
# INDEX_NONE or lock NotifyThreatDestroyed construction
# in the .cpp. This is leftover-safe Mission03
# Waves NotifyThreatDestroyed on
...
# method. Not leftover StartNextWave. Not leftover Briefing (#568) /
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission03IntegrationDirector::NotifyThreatDestroyed",
    "SkyguardMission03IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission03NotifyThreatDestroyedDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("BlueprintPure", NOTIFY_THREAT_DESTROYED)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_start = f"\t{START_NEXT_WAVE}\n"
        ...
        as_void_name = "\tvoid NotifyThreatDestroyed() const;\n"
    ...
    def test_notify_threat_destroyed_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("EnvironmentReadiness", NOTIFY_THREAT_DESTROYED)
        self.assertNotIn("MissionMapReadiness", NOTIFY_THREAT_DESTROYED)
        ...
        self.assertNotIn("TSoftObjectPtr<USkyguardMissionDefinition>", NOTIFY_THREAT_DESTROYED)
        ...
        self.assertNotIn("ValidateDefinition", NOTIFY_THREAT_DESTROYED)
        ...
        self.assertNotIn("ESkyguardMission03WaveState", NOTIFY_THREAT_DESTROYED)
        self.assertNotIn("StartNextWave", NOTIFY_THREAT_DESTROYED)
        self.assertNotIn("GetWaveState", NOTIFY_THREAT_DESTROYED)
        self.assertNotIn("GetCurrentWaveIndex", NOTIFY_THREAT_DESTROYED)
    ...
    def test_environment_category_does_not_satisfy_waves(self) -> None:
        ...
        self.assertNotEqual(integration, UFUNCTION_WAVES)
        self.assertNotIn(environment, UFUNCTION_WAVES)
        self.assertNotIn(briefing, UFUNCTION_WAVES)
        self.assertNotIn(integration, UFUNCTION_WAVES)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 NotifyThreatDestroyed method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission03 NotifyThreatDestroyed contains "
    ...
    def test_contract_is_notify_threat_destroyed_declaration_only(
        ...
        self.assertNotIn("TArray<FText>& OutErrors", NOTIFY_THREAT_DESTROYED)
        self.assertNotIn("static ", NOTIFY_THREAT_DESTROYED)
        self.assertTrue(
    ...
    def test_leftover_mission_definition_validate_does_not_satisfy(self) -> None:
        ...
        self.assertNotIn(MISSION_DEFINITION_VALIDATE, NOTIFY_THREAT_DESTROYED)
        self.assertIn(
            "Scripts/tests/test_mission_definition_validate_definition"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
