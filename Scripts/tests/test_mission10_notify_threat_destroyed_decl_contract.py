...
# Mission10 Waves NotifyThreatDestroyed
...
# Category is Skyguard|Mission10|Waves, not
...
# drafts #674–#768+, leftover Apache
...
# Do not reopen open drafts #674–#768+.
...
class Mission10NotifyThreatDestroyedDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission10|Waves", UFUNCTION_WAVES)
        ...
        self.assertNotIn("Mission02", UFUNCTION_WAVES)
    ...
    def test_environment_category_does_not_satisfy_waves(self) -> None:
        ...
        self.assertNotEqual(leftover_m10_integration, UFUNCTION_WAVES)
    ...
    def test_contract_is_notify_threat_destroyed_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_notify_threat_destroyed"
                "_decl_contract.py"
            )
        )
        self.assertIn(
