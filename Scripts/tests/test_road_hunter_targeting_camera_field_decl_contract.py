...
# INDEX_NONE or lock TargetingCamera construction
# in the .cpp. This is a FIELD contract on
# ASkyguardRoadHunterBoss, not leftover RoadHunter
# sibling fields LeftActuator / RightActuator /
...
# not lock Breakwater here). Keep TargetingCamera
...
# TargetingCamera;`); accept that form and other
...
# TargetingCamera field declaration contract on
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardRoadHunterBoss::TargetingCamera",
    "SkyguardRoadHunterBoss.cpp",
    "SetExposed",
...
class RoadHunterTargetingCameraFieldDeclContractTests(unittest.TestCase):
    def test_road_hunter_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, TARGETING_CAMERA_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, TARGETING_CAMERA_FIELD)
        self.assertIn("TargetingCamera", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, TARGETING_CAMERA_FIELD)
    ...
    def test_missing_targeting_camera_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardRoadHunterBoss();\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, TARGETING_CAMERA_FIELD)
        self.assertIn("TargetingCamera", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, TARGETING_CAMERA_FIELD)
        self.assertIn("TargetingCamera", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UPROPERTY", TARGETING_CAMERA_FIELD)
        self.assertNotIn("VisibleAnywhere", TARGETING_CAMERA_FIELD)
        self.assertNotIn("BlueprintReadOnly", TARGETING_CAMERA_FIELD)
        self.assertNotIn("Category", TARGETING_CAMERA_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, TARGETING_CAMERA_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, TARGETING_CAMERA_FIELD)
        self.assertIn("TargetingCamera", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUSkyguardBossWeakPointComponent* TargetingCamera;\n"
        )
        as_array = (
        ...
        scene = (
            "\tTObjectPtr<USceneComponent> TargetingCamera;\n"
        )
        mesh = (
            "\tTObjectPtr<UStaticMeshComponent> TargetingCamera;\n"
        )
        weak = (
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, TARGETING_CAMERA_FIELD)
            self.assertIn("TargetingCamera", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_targeting_camera_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, TARGETING_CAMERA_FIELD),
            TARGETING_CAMERA_FIELD,
        )
        self.assertTrue(has_declaration(section, TARGETING_CAMERA_FIELD))
        self.assertEqual(declaration_count(section, TARGETING_CAMERA_FIELD), 1)
        self.assertTrue(
            TARGETING_CAMERA_FIELD.startswith(
                "TObjectPtr<USkyguardBossWeakPointComponent> "
            ),
            TARGETING_CAMERA_FIELD,
        )
        self.assertTrue(TARGETING_CAMERA_FIELD.endswith(";"), TARGETING_CAMERA_FIELD)
        self.assertIn("TargetingCamera", TARGETING_CAMERA_FIELD)
        self.assertNotIn("LeftActuator", TARGETING_CAMERA_FIELD)
        self.assertNotIn("RightActuator", TARGETING_CAMERA_FIELD)
        self.assertNotIn("DebrisLeftWing", TARGETING_CAMERA_FIELD)
        self.assertNotIn("DebrisEngine", TARGETING_CAMERA_FIELD)
        self.assertNotIn("DebrisRightWing", TARGETING_CAMERA_FIELD)
        self.assertNotIn("DebrisCoolingDoor", TARGETING_CAMERA_FIELD)
        self.assertNotIn("SignatureModulator", TARGETING_CAMERA_FIELD)
        self.assertNotIn("RadarReceiver", TARGETING_CAMERA_FIELD)
        self.assertNotIn("CoolingDoor", TARGETING_CAMERA_FIELD)
        self.assertNotIn("PortLatch", TARGETING_CAMERA_FIELD)
        self.assertNotIn("NoseCamera", TARGETING_CAMERA_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            TARGETING_CAMERA_FIELD,
        )
        self.assertIn("TObjectPtr<", TARGETING_CAMERA_FIELD)
        self.assertNotIn("TArray<", TARGETING_CAMERA_FIELD)
        self.assertNotIn("=", TARGETING_CAMERA_FIELD)
        self.assertNotIn("INDEX_NONE", TARGETING_CAMERA_FIELD)
        self.assertNotIn("UFUNCTION", TARGETING_CAMERA_FIELD)
        self.assertNotIn("{", TARGETING_CAMERA_FIELD)
        self.assertNotIn("}", TARGETING_CAMERA_FIELD)
        self.assertNotIn("return ", TARGETING_CAMERA_FIELD)
        self.assertNotIn("CommandAntenna", TARGETING_CAMERA_FIELD)
        self.assertNotIn("ControlLinkage", TARGETING_CAMERA_FIELD)
        self.assertNotIn("NoseCamera", TARGETING_CAMERA_FIELD)
        self.assertNotIn("DebrisCenter", TARGETING_CAMERA_FIELD)
        self.assertNotIn("DebrisTail", TARGETING_CAMERA_FIELD)
        self.assertNotIn("DebrisNose", TARGETING_CAMERA_FIELD)
        self.assertNotIn("DebrisSpine", TARGETING_CAMERA_FIELD)
        self.assertNotIn("AdvanceEncounter", TARGETING_CAMERA_FIELD)
        self.assertNotIn("ResetEncounterState", TARGETING_CAMERA_FIELD)
        self.assertNotIn("IsRouteStateSafe", TARGETING_CAMERA_FIELD)
        self.assertNotIn("GetRouteProgress", TARGETING_CAMERA_FIELD)
        self.assertNotIn("GetEffectiveSpeedMultiplier", TARGETING_CAMERA_FIELD)
        self.assertNotIn("IsAttackTelegraphActive", TARGETING_CAMERA_FIELD)
        self.assertNotIn("GetTelegraphsTriggered", TARGETING_CAMERA_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", TARGETING_CAMERA_FIELD)
        self.assertNotIn("RadarNode", TARGETING_CAMERA_FIELD)
        self.assertNotIn("BeginTerminalStrikeCycle", TARGETING_CAMERA_FIELD)
        self.assertNotIn("OpenGuidanceArrayExposure", TARGETING_CAMERA_FIELD)
        self.assertNotIn("IssueClimbCommand", TARGETING_CAMERA_FIELD)
        self.assertNotIn("DivertWreckFromCivilians", TARGETING_CAMERA_FIELD)
        self.assertNotIn("SetCivilianSeparationMeters", TARGETING_CAMERA_FIELD)
        self.assertNotIn("GetCivilianSeparationMeters", TARGETING_CAMERA_FIELD)
        self.assertNotIn("GetFinaleStage", TARGETING_CAMERA_FIELD)
        self.assertNotIn("IsClimbCommandIssued", TARGETING_CAMERA_FIELD)
        self.assertNotIn("IsWreckDiverted", TARGETING_CAMERA_FIELD)
        self.assertNotIn("GetObjectiveMilestonesReached", TARGETING_CAMERA_FIELD)
        self.assertNotIn("ESkyguardLastFlightStage", TARGETING_CAMERA_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", TARGETING_CAMERA_FIELD)
        self.assertNotIn("GetGunnerMount", TARGETING_CAMERA_FIELD)
        self.assertNotIn("FaceWorldLocation", TARGETING_CAMERA_FIELD)
        self.assertNotIn("PortGuidanceArray", TARGETING_CAMERA_FIELD)
        self.assertNotIn("DebrisArmorPort", TARGETING_CAMERA_FIELD)
        self.assertNotIn("SetSearchlightTracked", TARGETING_CAMERA_FIELD)
        self.assertNotIn("SetContactIdentified", TARGETING_CAMERA_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", TARGETING_CAMERA_FIELD)
        self.assertNotIn("SetLightningExposed", TARGETING_CAMERA_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", TARGETING_CAMERA_FIELD)
        self.assertNotIn("HullCollider", TARGETING_CAMERA_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, TARGETING_CAMERA_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_PORT} {TARGETING_CAMERA_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(
                declaration_count(section, TARGETING_CAMERA_FIELD),
                1,
            )
        one_line = f"{{\npublic:\n\t{TARGETING_CAMERA_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, TARGETING_CAMERA_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, TARGETING_CAMERA_FIELD),
            section,
    ...
    def test_assigned_targeting_camera_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<USkyguardBossWeakPointComponent> "
            "TargetingCamera = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, TARGETING_CAMERA_FIELD)
        self.assertIn("TargetingCamera", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, TARGETING_CAMERA_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("TargetingCamera", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, TARGETING_CAMERA_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{TARGETING_CAMERA_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, TARGETING_CAMERA_FIELD)
        ...
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_PORT, section)
        self.assertTrue(has_declaration(section, TARGETING_CAMERA_FIELD), section)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            TARGETING_CAMERA_FIELD.startswith("UFUNCTION"),
            TARGETING_CAMERA_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, TARGETING_CAMERA_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", TARGETING_CAMERA_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_targeting_camera_cpp_body(self) -> None:
        locked_only = f"{TARGETING_CAMERA_FIELD}\n"
        self.assertNotIn("{", TARGETING_CAMERA_FIELD)
        self.assertNotIn("}", TARGETING_CAMERA_FIELD)
        self.assertNotIn("return ", TARGETING_CAMERA_FIELD)
        ...
        self.assertNotIn("SkyguardRoadHunterBoss.cpp", TARGETING_CAMERA_FIELD)
        self.assertNotIn("SkyguardRoadHunterBoss.cpp", locked_only)
        self.assertNotIn("return false", TARGETING_CAMERA_FIELD)
        self.assertNotIn("return true", TARGETING_CAMERA_FIELD)
        self.assertNotIn("CreateDefaultSubobject", TARGETING_CAMERA_FIELD)
        self.assertNotIn("SetExposed", TARGETING_CAMERA_FIELD)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            TARGETING_CAMERA_FIELD,
        )
        self.assertNotIn("SetBossPhase", TARGETING_CAMERA_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", TARGETING_CAMERA_FIELD)

    def test_contract_does_not_relock_sibling_tempest_fields(self) -> None:
        locked_only = f"{TARGETING_CAMERA_FIELD}\n"
        for token in SIBLING_TEMPEST_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("PortDischargeBoom", TARGETING_CAMERA_FIELD)
        self.assertNotIn("StarboardDischargeBoom", TARGETING_CAMERA_FIELD)
        self.assertNotIn("EngineIntake", TARGETING_CAMERA_FIELD)
        self.assertNotIn("DebrisPortPanel", TARGETING_CAMERA_FIELD)
        self.assertNotIn("DebrisStarboardPanel", TARGETING_CAMERA_FIELD)
        self.assertNotIn("DebrisIntakePanel", TARGETING_CAMERA_FIELD)
        self.assertNotIn("RequiredLockStabilitySeconds", TARGETING_CAMERA_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            TARGETING_CAMERA_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_encounter_controller(
        ...
        for token in LEFTOVER_ENCOUNTER_CONTROLLER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("EncounterController", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_control_servo(self) -> None:
        ...
        for token in LEFTOVER_CONTROL_SERVO_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("ControlServo", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_sibling_iron_rain_fields(self) -> None:
        ...
        for token in SIBLING_IRON_RAIN_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("DispenserCenter", TARGETING_CAMERA_FIELD)
        self.assertNotIn("MaxReleasesPerBay", TARGETING_CAMERA_FIELD)
        self.assertIn("TargetingCamera", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost_methods(
        ...
        for token in LEFTOVER_RADAR_GHOST_METHODS_NOT_LOCKED:
            ...
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("SetContactIdentified", TARGETING_CAMERA_FIELD)
        self.assertNotIn("OpenOrbitExposure", TARGETING_CAMERA_FIELD)
        self.assertNotIn("IsContactIdentified", TARGETING_CAMERA_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", TARGETING_CAMERA_FIELD)
        self.assertNotIn(leftover_open_rear_aspect_window(), TARGETING_CAMERA_FIELD)

    def test_debris_cooling_door_does_not_satisfy_targeting_camera(self) -> None:
        leftover = f"\t{DEBRIS_COOLING_DOOR_FIELD}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover, TARGETING_CAMERA_FIELD)
        self.assertIn("TargetingCamera", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover, TARGETING_CAMERA_FIELD))
        self.assertNotEqual(DEBRIS_COOLING_DOOR_FIELD, TARGETING_CAMERA_FIELD)
        self.assertNotIn("UStaticMeshComponent", TARGETING_CAMERA_FIELD)
        self.assertNotIn(
            "USkyguardBossWeakPointComponent",
            DEBRIS_COOLING_DOOR_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_dispenser_starboard(
        ...
        for token in LEFTOVER_DISPENSER_STARBOARD_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("DispenserStarboard", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_get_maneuver(self) -> None:
        ...
        for token in LEFTOVER_GET_MANEUVER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("GetManeuver", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_open_first_window(), TARGETING_CAMERA_FIELD)
        self.assertNotIn(leftover_open_final_window(), locked_only)
        self.assertNotIn(leftover_open_final_window(), TARGETING_CAMERA_FIELD)
        self.assertNotIn(leftover_arm_command_core_path(), locked_only)
        self.assertNotIn(leftover_arm_command_core_path(), TARGETING_CAMERA_FIELD)
        self.assertNotIn(leftover_apply_strike(), locked_only)
        self.assertNotIn(leftover_apply_strike(), TARGETING_CAMERA_FIELD)
        self.assertNotIn(leftover_is_lock_eligible(), locked_only)
        self.assertNotIn(leftover_is_lock_eligible(), TARGETING_CAMERA_FIELD)
        self.assertNotIn(leftover_arm_emergency_finish(), locked_only)
        self.assertNotIn(leftover_arm_emergency_finish(), TARGETING_CAMERA_FIELD)
        ...
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_debris_getters(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("GetDefeatDebrisPieceCount", TARGETING_CAMERA_FIELD)
        self.assertNotIn("GetMaxDefeatDebrisPieces", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("SetSearchlightTracked", TARGETING_CAMERA_FIELD)
        self.assertNotIn("ASkyguardBlackKiteBoss", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        self.assertNotIn("CoolingDoor", TARGETING_CAMERA_FIELD)
        self.assertNotIn("SignatureModulator", TARGETING_CAMERA_FIELD)
        self.assertNotIn("ASkyguardRadarGhostBoss", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_NOT_LOCKED:
            ...
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", TARGETING_CAMERA_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest_methods(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("SetLightningExposed", TARGETING_CAMERA_FIELD)
        self.assertNotIn("ApplyCorrectiveBankGust", TARGETING_CAMERA_FIELD)
        self.assertNotIn("IsLightningExposed", TARGETING_CAMERA_FIELD)
        self.assertNotIn("GetLockStabilitySeconds", TARGETING_CAMERA_FIELD)
        self.assertNotIn(leftover_advance_stabilized_lock(), TARGETING_CAMERA_FIELD)
        self.assertNotIn(leftover_arm_break_finish(), TARGETING_CAMERA_FIELD)
        self.assertNotIn(leftover_is_break_finish_armed(), TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        for token in LEFTOVER_PATROL_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("ASkyguardPatrolShip", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        ...
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            ...
            self.assertNotIn(neighbor, TARGETING_CAMERA_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("ASkyguardGunner", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("SkyguardRadarNode", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            ...
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", TARGETING_CAMERA_FIELD)
        self.assertNotIn("MaxIntegrity", TARGETING_CAMERA_FIELD)
        self.assertNotIn("CurrentIntegrity", TARGETING_CAMERA_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", TARGETING_CAMERA_FIELD)
        self.assertNotIn(
            "SkyguardPathfinderEncounterController.h",
            TARGETING_CAMERA_FIELD,
        )
    ...
    def test_contract_does_not_open_leftover_weak_point_component_header(
        ...
        self.assertNotIn(leftover_header, TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, TARGETING_CAMERA_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{TARGETING_CAMERA_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, TARGETING_CAMERA_FIELD),
            TARGETING_CAMERA_FIELD,
        )
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardRoadHunterBoss::TargetingCamera", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "road hunter TargetingCamera field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{TARGETING_CAMERA_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, TARGETING_CAMERA_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                TARGETING_CAMERA_FIELD.lower(),
                "road hunter TargetingCamera contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, TARGETING_CAMERA_FIELD)

    def test_contract_is_targeting_camera_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertTrue(TARGETING_CAMERA_FIELD.endswith(";"))
        self.assertNotIn("=", TARGETING_CAMERA_FIELD)
        self.assertIn(UPROPERTY_PORT, section)
    ...
    def test_contract_does_not_relock_sibling_breakwater_fields(self) -> None:
        ...
        for token in SIBLING_BREAKWATER_FIELDS_NOT_LOCKED:
            ...
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("PortLatch", TARGETING_CAMERA_FIELD)
        self.assertNotIn("StarboardLatch", TARGETING_CAMERA_FIELD)
        self.assertNotIn("DecoyPods", TARGETING_CAMERA_FIELD)
        self.assertNotIn("ElevatorLinkage", TARGETING_CAMERA_FIELD)
        self.assertNotIn("ASkyguardBreakwaterBoss", TARGETING_CAMERA_FIELD)
        self.assertIn(
            "Scripts/tests/test_breakwater_engine_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_road_hunter_engine_is_not_breakwater_engine(self) -> None:
        locked_only = f"{TARGETING_CAMERA_FIELD}\n"
        self.assertNotEqual(ROAD_HUNTER_ENGINE_FIELD, TARGETING_CAMERA_FIELD)
        ...
        for token in LEFTOVER_BREAKWATER_ENGINE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("Engine;", TARGETING_CAMERA_FIELD)
        self.assertNotIn("ASkyguardBreakwaterBoss", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_mission02_wave_state(
        ...
        for token in LEFTOVER_MISSION02_WAVE_STATE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("ESkyguardMission02WaveState", TARGETING_CAMERA_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter_fields(
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, TARGETING_CAMERA_FIELD)
        self.assertNotIn("OpticalTracker", TARGETING_CAMERA_FIELD)
        self.assertNotIn("WeaponServo", TARGETING_CAMERA_FIELD)
        self.assertNotIn("CountermeasurePod", TARGETING_CAMERA_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", TARGETING_CAMERA_FIELD)
