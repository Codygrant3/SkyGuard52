...
# Mission04 IntegrationReadiness bBriefingReady
...
# NOT leftover Mission02 bBriefingReady
# FIELD #870 / branch cursor/mission02-
# briefing-ready-field-decl-contract-c332,
# NOT leftover Mission03 bBriefingReady
# FIELD #903 / branch cursor/mission03-
# briefing-ready-field-decl-contract-c332,
# NOT leftover Mission10 bBriefingReady
# FIELD #819 / branch cursor/mission10-
# briefing-ready-field-decl-contract-c332,
...
class Mission04BriefingReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        for header in (
            ...
            section = public_section(header)
            self.assertTrue(
                has_declaration(section, BRIEFING_READY_TRUE),
                section,
            )
            self.assertEqual(
                require_declaration(
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 bBriefingReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 bBriefingReady contains "
