...
# #613 or leftover Mission03 IsCorePlayableReady
# #636. Distinct from leftover briefing-widget /
...
# #636, leftover Mission04 wave-state enum #bb22,
...
# isolated-test drafts #107–#654, leftover Apache
...
# leftover theater-kit #59, leftover #107–#654, plus
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission04IntegrationDirector::IsCorePlayableReady",
    "SkyguardMission04IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission04IsCorePlayableReadyDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 IsCorePlayableReady method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission04 IsCorePlayableReady contains "
