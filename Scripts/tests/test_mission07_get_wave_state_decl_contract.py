...
# (`ESkyguardMission07WaveState GetWaveState()
...
class Mission07GetWaveStateDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        renamed = (
            "\tESkyguardMission07WaveState GetState() const;\n"
        )
        short_name = "\tESkyguardMission07WaveState GetWave() const;\n"
    ...
    def test_get_wave_state_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            GET_WAVE_STATE.startswith("ESkyguardMission07WaveState "),
            GET_WAVE_STATE,
        )
        self.assertIn("ESkyguardMission07WaveState", GET_WAVE_STATE)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("GetWaveState", GET_WAVE_STATE)
        self.assertTrue(GET_WAVE_STATE.startswith("ESkyguardMission07WaveState "))
