...
STRUCT_NAME = "FSkyguardHoistWindowRuntime"
CLASS_NAME = STRUCT_NAME
# THIS IS leftover-safe Mission08 HoistWindowRuntime
# CompletedWindows FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly int32 = 0;
# one-line / split-line UPROPERTY wraps; origin/main
# has NO Category). PARSE
# FSkyguardHoistWindowRuntime STRUCT
# public section only (after struct
# FSkyguardHoistWindowRuntime, before
# struct FSkyguardMission08IntegrationReadiness).
# Do NOT parse ASkyguardMission08IntegrationDirector,
# FSkyguardMission08IntegrationReadiness,
# FSkyguardMission08ProtectedTargetRuntime, leftover enum
# ESkyguardMission08ProtectedTarget type body, leftover
# FSkyguardMission09IntegrationReadiness, leftover
# FSkyguardMission09PoolBudget, leftover
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission08 HoistWindowRuntime
# CompletedWindows FIELD (declaration-only). THIS IS NOT leftover
# Mission08 director RequiredCoveredSeconds / leftover
# hoist RemainingSeconds. THIS IS NOT leftover
# Mission08 director MaximumProtectedTargetIntegrity #1065.
# THIS IS NOT leftover Mission09 ProtectedTargetRuntime
# Integrity #1126. THIS IS NOT leftover Mission08
# protected-target enum #229/#a66a. THIS IS NOT leftover
# Mission08 protected-target-runtime-defaults #226/#75e6.
# THIS IS NOT leftover Mission08 readiness
...
# merge #665 #666 #668-#673, or open drafts #674-#1131.
# LOCK leftover Mission01/02/03/04/05/06/07/09/10
...
# drafts #1116-#1126. LOCK leftover Mission08
# ProtectedTargetRuntime Target #1129 / Integrity
# #1127 / bDestroyed #1128 and leftover HoistWindowRuntime
# bActive #1130 / CoveredSeconds #1131.
...
# Mission08 HoistWindowRuntime CoveredSeconds
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 default 0,
# one-line / split-line UPROPERTY wraps) on
# FSkyguardHoistWindowRuntime. It is
# leftover-safe Mission08 HoistWindowRuntime
# CompletedWindows FIELD (declaration-only). It is
...
# struct section of
# FSkyguardHoistWindowRuntime only
# between struct FSkyguardHoistWindowRuntime
# and struct FSkyguardMission08IntegrationReadiness / the following UCLASS /
...
# This HoistWindowRuntime field sits after CoveredSeconds in the
# public section.
# Skip leftover b + Ya + kRuntimeReady forever (it sits
# after bMapAssemblyReady and before bGunnerReady). This contract
# is CompletedWindows after CoveredSeconds.
# THIS IS NOT leftover RemainingSeconds / leftover CoveredSeconds /
# leftover bActive. THIS IS NOT leftover
# Mission08 RequiredCoveredSeconds director field. THIS IS NOT
...
# drafts #674-#1131 including leftover Mission02
...
# the locked FSkyguardHoistWindowRuntime
# public section. Do not parse
# ASkyguardMission08IntegrationDirector director-class
# fields. Do not parse leftover FSkyguardMission08ProtectedTargetRuntime.
...
# drafts #674-#1131. Do not reopen leftover
...
COMPLETED_WINDOWS_WRONG = (
    "int32 CompletedWindows = 2;"
)
LOCKED_DECL = COMPLETED_WINDOWS
...
# an isolated Python CompletedWindows
...
# LOCK leftover Mission01/02/03/04/05/06/07/09/10 same-name
...
LEFTOVER_HOIST_WINDOW_NOT_LOCKED = (
    ...
    "test_mission08_start_hoist_window_decl_contract.py",
    "test_mission08_advance_hoist_window_decl_contract.py",
    "test_mission08_hoist_window_runtime_covered_seconds_field_decl_contract.py",
    "test_mission08_hoist_window_runtime_active_field_decl_contract.py",
)
...
class Mission08HoistWindowRuntimeCompletedWindowsFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("CompletedWindows", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_completed_windows_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_bool = "\tbool CompletedWindows = false;\n"
        leftover_enum = (
            "\tESkyguardMission08ProtectedTarget CompletedWindows = "
            "ESkyguardMission08ProtectedTarget::RescueHelicopter;\n"
        )
        leftover_zero = f"\t{COMPLETED_WINDOWS_WRONG}\n"
        ...
        leftover_m09_integrity = (
            "\tFSkyguardMission09ProtectedTargetRuntime CompletedWindows;\n"
        )
        leftover_hoist_remaining = "\tfloat RemainingSeconds = 0.f;\n"
        leftover_covered = "\tfloat CoveredSeconds = 0.f;\n"
        leftover_active = "\tbool bActive = false;\n"
        leftover_required = "\tfloat RequiredCoveredSeconds = 4.f;\n"
        leftover_float = "\tfloat CompletedWindows = 0.f;\n"
        leftover_director_required = (
    ...
    def test_completed_windows_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 CompletedWindows"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("CompletedWindows", LOCKED_DECL)
        ...
        self.assertNotIn("CoveredSeconds", LOCKED_DECL)
        self.assertNotIn("Category", LOCKED_DECL)
        self.assertNotIn("ClampMin", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("CompletedWindows", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 CompletedWindows"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("CompletedWindows", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 WaveCount field contract "
    ...
    def test_contract_is_completed_windows_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_completed_windows(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission08_hoist_window_runtime_completed_windows"
            "_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_hoist_window_runtime_completed_windows"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_hoist_window(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_hoist_window_runtime_covered_seconds"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_hoist_window_runtime_active"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_same_name_wave_count_contracts_stay_locked(
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_protected_target_runtime_integrity"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_protected_target_runtime_destroyed"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_protected_target_runtime_target"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
