...
# INDEX_NONE or lock InitializePlayableMission
# construction in the .cpp. This is leftover-safe
# Mission02 Integration InitializePlayableMission
# on ASkyguardMission02IntegrationDirector. It is
# NOT leftover Mission10 InitializePlayableMission
...
# (`bool InitializePlayableMission();`); accept that
...
# drafts #674–#825+, leftover Apache
...
class Mission02InitializePlayableMissionDeclContractTests(unittest.TestCase):
    def test_mission02_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, INITIALIZE_PLAYABLE_MISSION),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, INITIALIZE_PLAYABLE_MISSION)
        self.assertIn("InitializePlayableMission", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, INITIALIZE_PLAYABLE_MISSION)
    ...
    def test_missing_initialize_declaration_fails_closed(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, INITIALIZE_PLAYABLE_MISSION)
        self.assertIn("InitializePlayableMission", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, INITIALIZE_PLAYABLE_MISSION)
        self.assertIn("InitializePlayableMission", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("BlueprintCallable", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("Category", INITIALIZE_PLAYABLE_MISSION)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, INITIALIZE_PLAYABLE_MISSION)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, INITIALIZE_PLAYABLE_MISSION)
        self.assertIn("InitializePlayableMission", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = "\tvoid InitializePlayableMission();\n"
        as_const = "\tbool InitializePlayableMission() const;\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, INITIALIZE_PLAYABLE_MISSION)
            self.assertIn("InitializePlayableMission", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_initialize_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(has_declaration(section, INITIALIZE_PLAYABLE_MISSION))
        self.assertEqual(
            declaration_count(section, INITIALIZE_PLAYABLE_MISSION),
            1,
        )
        self.assertTrue(
            INITIALIZE_PLAYABLE_MISSION.startswith("bool "),
            INITIALIZE_PLAYABLE_MISSION,
        )
        self.assertTrue(
            INITIALIZE_PLAYABLE_MISSION.endswith(";"),
            INITIALIZE_PLAYABLE_MISSION,
        )
        self.assertIn("InitializePlayableMission", INITIALIZE_PLAYABLE_MISSION)
        self.assertIn("()", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("TArray<", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("TObjectPtr", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("TSoftObjectPtr", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("INDEX_NONE", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("UFUNCTION", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("{", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("}", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("return ", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("const;", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("Root", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("Briefing", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("AudioDirector", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("RadioChatter", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("SortiePresentation", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("CampaignDefinition", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("MissionDefinition", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("Readiness", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("bAutoInitialize", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("bAllowBoundedActorSpawning", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("bAutoLaunchAfterBriefing", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("PathfinderSpawnLocation", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetAircraft", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("BindRuntimeActors", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("HandleDroneCityImpact", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("StartNextWave", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("NotifyThreatDestroyed", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("AdvanceConvoyByDistance", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("NotifyConvoyDamage", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetWaveState", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetConvoyRouteState", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetDayBeatKit", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetNightBeatKit", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("StartSearchlightWindow", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("AdvanceSearchlightTrack", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("NotifySubstationDamage", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetRemainingThreatsInWave", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetSearchlightRuntime", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetSubstationIntegrity", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("StartPayloadWindow", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("AdvancePayloadWindow", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("TryJamActivePayload", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("NotifyAirfieldTargetDamage", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetPayloadWindow", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetTargetRuntime", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetSurvivingTargetCount", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetDayBeatKind", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetDayBeatIndex", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("TickDayBeatKit", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("HandleBossPhaseChanged", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ASkyguardMission06IntegrationDirector", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ESkyguardMission06WaveState", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ESkyguardMission07WaveState", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ASkyguardMission07IntegrationDirector", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ASkyguardMission08IntegrationDirector", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ESkyguardMission08WaveState", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ESkyguardMission09WaveState", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ESkyguardMission09ProtectedTarget", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("FSkyguardMission09ProtectedTargetRuntime", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("FSkyguardMission09PoolRuntime", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("FSkyguardMission09PoolBudget", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("BindCampaignRuntime", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetPoolRuntime", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("IronRainSpawnLocation", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ESkyguardMission08ProtectedTarget", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("FSkyguardMission08ProtectedTargetRuntime", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("FSkyguardHoistWindowRuntime", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("StartHoistWindow", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("AdvanceHoistWindow", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ValidateWeaponRelease", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetHoistRuntime", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetRejectedWeaponReleases", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetStormRainBeatKit", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ApplyStormRainPlayContract", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetStormRainBeatKind", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("TickStormRainBeatKit", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("RescueHelicopterAnchor", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("LifelineHunterSpawnLocation", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ESkyguardMission07ProtectedTarget", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("FSkyguardMission07ProtectedTargetRuntime", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ESkyguardSearchSector", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("FSkyguardSearchTrackRuntime", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ClassifyFalseTrack", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ConfirmRadarGhostIdentification", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("NotifyProtectedTargetDamage", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("AdvanceReinforcementTimer", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetSearchSector", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetClassifiedFalseTrackCount", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("IsHostileContactConfirmed", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetProtectedTarget", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetReinforcementTimeRemaining", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetNightBeatKind", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetNightBeatIndex", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("TickNightBeatKit", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ESkyguardAirfieldTarget", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ConvoyRuntimeAnchor", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("RoadHunterSpawnLocation", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ASkyguardMission02IntegrationDirector", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ConfigureMissionDefinition", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("NotifyObjectiveProgress", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("NotifyProtectedAssetFailed", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("SynchronizeRuntimeState", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("IsCorePlayableReady", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetReadiness", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetObjectiveRuntime", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetGunner", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetPathfinder", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetMissionId", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ValidateMissionContract", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ConfigureFromMission", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("AdvanceBriefing", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("SetAssetsReady", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("AcknowledgeAndLaunch", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("CanLaunch", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetElapsedSeconds", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetBriefingState", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetMinimumWarmupSeconds", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetBriefingText", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetRadioChatter", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetPresentation", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetMissionTitle", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("AcknowledgeBriefing", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("LaunchSortie", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("HullCollider", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("OpticalTracker", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("WeaponServo", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("CountermeasurePod", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("MinHeightFromOriginCm", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("RadarNode", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ESkyguardMission02WaveState", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("HarborIndustrial", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("MaxIntegrity", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("CurrentIntegrity", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("FillAndFinalize", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("FillAndFail", INITIALIZE_PLAYABLE_MISSION)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, INITIALIZE_PLAYABLE_MISSION)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_INTEGRATION} {INITIALIZE_PLAYABLE_MISSION}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{INITIALIZE_PLAYABLE_MISSION}\n}}\n"
        self.assertTrue(has_declaration(one_line, INITIALIZE_PLAYABLE_MISSION))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, INITIALIZE_PLAYABLE_MISSION),
            section,
    ...
    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        locked_only = f"{INITIALIZE_PLAYABLE_MISSION}\n"
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, INITIALIZE_PLAYABLE_MISSION)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", INITIALIZE_PLAYABLE_MISSION)
        section = public_section(origin_main_header())
    ...
    def test_contract_does_not_lock_initialize_cpp_body(self) -> None:
        ...
        self.assertNotIn("return false", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("return true", INITIALIZE_PLAYABLE_MISSION)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{INITIALIZE_PLAYABLE_MISSION}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, INITIALIZE_PLAYABLE_MISSION)
        self.assertIn("InitializePlayableMission", INITIALIZE_PLAYABLE_MISSION)
        self.assertTrue(INITIALIZE_PLAYABLE_MISSION.startswith("bool "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, INITIALIZE_PLAYABLE_MISSION)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("CurrentIntegrity", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("SkyguardApacheAircraft.h", INITIALIZE_PLAYABLE_MISSION)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", INITIALIZE_PLAYABLE_MISSION)
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        self.assertNotIn("550.f", INITIALIZE_PLAYABLE_MISSION)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{INITIALIZE_PLAYABLE_MISSION}\n"
        self.assertEqual(
            require_declaration(locked_only, INITIALIZE_PLAYABLE_MISSION),
            INITIALIZE_PLAYABLE_MISSION,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, INITIALIZE_PLAYABLE_MISSION)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ASkyguardIronRainBoss", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ASkyguardRadarGhostBoss", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("ASkyguardTempestBoss", section)
        self.assertNotIn("ASkyguardLastFlightBoss", INITIALIZE_PLAYABLE_MISSION)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 InitializePlayableMission method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{INITIALIZE_PLAYABLE_MISSION}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, INITIALIZE_PLAYABLE_MISSION.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                INITIALIZE_PLAYABLE_MISSION.lower(),
                "mission02 InitializePlayableMission contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, INITIALIZE_PLAYABLE_MISSION)
    ...
    def test_contract_is_initialize_playable_mission_declaration_only(
        ...
        self.assertTrue(INITIALIZE_PLAYABLE_MISSION.startswith("bool "))
        self.assertIn("InitializePlayableMission", INITIALIZE_PLAYABLE_MISSION)
        self.assertTrue(INITIALIZE_PLAYABLE_MISSION.endswith(";"))
        self.assertIn(UFUNCTION_INTEGRATION, section)
    ...
    def test_sibling_director_fields_do_not_satisfy_initialize(
        ...
        for leftover in (
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, INITIALIZE_PLAYABLE_MISSION)
            )
            self.assertNotEqual(INITIALIZE_PLAYABLE_MISSION, leftover)
        self.assertIn(
    ...
    def test_leftover_handle_drone_city_impact_does_not_satisfy(self) -> None:
        ...
        self.assertIn("InitializePlayableMission", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, INITIALIZE_PLAYABLE_MISSION))
        locked_only = f"{INITIALIZE_PLAYABLE_MISSION}\n"
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tbool InitializePlayableMission() { return false; }\n"
            "};\n"
        )
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_initialize_playable_mission"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission10_route_phase_enum(
        ...
        self.assertNotIn("GetRoutePhase", INITIALIZE_PLAYABLE_MISSION)
    ...
    def test_contract_does_not_relock_leftover_mission10_protected_group(
        ...
        self.assertNotIn("Protection", UFUNCTION_INTEGRATION)
        self.assertNotIn("GetProtectedGroup", INITIALIZE_PLAYABLE_MISSION)
    ...
    def test_leftover_mission10_sibling_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("HandleDroneCityImpact", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("UFUNCTION", GET_DAY_BEAT_KIT)
        self.assertNotIn("StartPhaseWave", INITIALIZE_PLAYABLE_MISSION)
        self.assertNotIn("GetRoutePhase", INITIALIZE_PLAYABLE_MISSION)
