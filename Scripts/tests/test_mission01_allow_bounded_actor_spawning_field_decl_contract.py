...
# (`bool bAllowBoundedActorSpawning = true;`); accept
...
# split-line UPROPERTY wraps. Parse the public class
...
# isolated-test drafts #107–#577, leftover Apache
...
# bAllowBoundedActorSpawning field declaration
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission01IntegrationDirector::bAllowBoundedActorSpawning",
    "SkyguardMission01IntegrationDirector.cpp",
...
class Mission01AllowBoundedActorSpawningFieldDeclContractTests(unittest.TestCase):
    def test_mission01_class_exists(self) -> None:
        ...
        self.assertTrue(has_declaration(section, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD), section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertIn("bAllowBoundedActorSpawning", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(has_declaration(section, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD))

    def test_missing_allow_bounded_actor_spawning_declaration_fails_closed(
        self,
    ) -> None:
        neighbors_only = (
            "\tASkyguardMission01IntegrationDirector();\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertIn("bAllowBoundedActorSpawning", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertIn("bAllowBoundedActorSpawning", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertTrue(has_declaration(section, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD), section)
        self.assertNotIn("UPROPERTY", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("EditAnywhere", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("BlueprintReadWrite", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("Category", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertIn("bAllowBoundedActorSpawning", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        unassigned = "\tbool bAllowBoundedActorSpawning;\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
            self.assertIn("bAllowBoundedActorSpawning", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_allow_bounded_actor_spawning_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(has_declaration(section, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD))
        self.assertEqual(declaration_count(section, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD), 1)
        self.assertTrue(
            ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD.startswith("bool "),
            ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD,
        )
        self.assertTrue(ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD.endswith(";"), ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertIn("bAllowBoundedActorSpawning", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertIn("= true", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("int32", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("TArray<", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("TObjectPtr", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("TSoftObjectPtr", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("false", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("INDEX_NONE", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("UFUNCTION", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("{", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("}", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("return ", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("Briefing", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("RadioChatter", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("SortiePresentation", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("AudioDirector", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("CampaignDefinition", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("MissionDefinition", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("Readiness", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("bAutoInitialize", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn(
            "bAutoLaunchAfterBriefing",
            ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD,
        )
        self.assertNotIn("PathfinderSpawnLocation", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("GetAircraft", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("ConfigureFromMission", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("AdvanceBriefing", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("SetAssetsReady", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("AcknowledgeAndLaunch", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("CanLaunch", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("GetElapsedSeconds", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("GetBriefingState", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("GetMinimumWarmupSeconds", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("GetBriefingText", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("GetRadioChatter", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("GetPresentation", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("GetMissionTitle", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("AcknowledgeBriefing", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("LaunchSortie", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("HullCollider", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("OpticalTracker", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("WeaponServo", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("CountermeasurePod", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("RadarNode", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("ESkyguardMission02WaveState", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("HarborIndustrial", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("MaxIntegrity", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("CurrentIntegrity", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_assign = (
            "public:\n"
            "\tbool bAllowBoundedActorSpawning =\n"
            "\ttrue;\n"
            "};\n"
        )
        wrap_uproperty = (
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION01} {ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(declaration_count(section, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD), 1)
        one_line = f"{{\npublic:\n\t{ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD), section)
        self.assertEqual(
            require_declaration(section, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD),
    ...
    def test_unassigned_allow_bounded_actor_spawning_does_not_satisfy(self) -> None:
        unassigned = "\tbool bAllowBoundedActorSpawning;\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(unassigned, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertIn("bAllowBoundedActorSpawning", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(unassigned, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD))

    def test_false_allow_bounded_actor_spawning_does_not_satisfy(self) -> None:
        wrong_false = "\tbool bAllowBoundedActorSpawning = false;\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(wrong_false, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertIn("bAllowBoundedActorSpawning", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(wrong_false, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("bAllowBoundedActorSpawning", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD.startswith("UFUNCTION"),
            ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_allow_bounded_actor_spawning_cpp_body(
        self,
    ) -> None:
        locked_only = f"{ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD}\n"
        self.assertNotIn("{", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        ...
        self.assertNotIn("return false", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("return true", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("CreateDefaultSubobject", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertIn("bAllowBoundedActorSpawning", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertIn("bool ", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("CurrentIntegrity", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
    ...
    def test_contract_does_not_open_leftover_campaign_definition_header(
        ...
        self.assertNotIn(leftover_header, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD),
            ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 bAllowBoundedActorSpawning field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD.lower(),
                "mission01 bAllowBoundedActorSpawning contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live cop" + "y",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)

    def test_contract_is_allow_bounded_actor_spawning_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertTrue(ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD.endswith(";"))
        self.assertIn("= true", ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD)
        self.assertIn(UPROPERTY_MISSION01, section)
    ...
    def test_sibling_director_fields_do_not_satisfy_allow_bounded_actor_spawning(
        ...
        for leftover in (
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD))
            self.assertNotEqual(ALLOW_BOUNDED_ACTOR_SPAWNING_FIELD, leftover)
        self.assertIn(
            "Scripts/tests/test_mission01_root_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
