...
# VisibleComponentCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 VisibleComponentCount = 0; one-line /
...
# THIS IS NOT leftover in-flight VisibleAudit LandscapeComponentCount
# (LOCK that script; do not edit it).
# THIS IS NOT leftover FootprintSampleResult Error #1198.
# LOCK leftover landscape-visible-audit-defaults #0bce.
# LOCK leftover Mission01 EnvironmentReadiness LandscapeComponentCount
# #1176. LOCK leftover Footprint bSuccess #1189.
# LOCK leftover VisibleAudit bSuccess
# test_landscape_visible_audit_success_field_decl_contract.py.
# LOCK leftover VisibleAudit LandscapeComponentCount
# test_landscape_visible_audit_landscape_component_count_field_decl_contract.py.
# Parse STRUCT public section only AFTER struct
# FSkyguardLandscapeVisibleAudit and BEFORE struct
...
# MaterialCompilationResult / EnvironmentAuthoringResult.
# Fail closed if the type or decl is missing, renamed, or
# Category= is added. Harbor 40/80 fail-closed in this
# Mission01-related test file. Ban retired live-copy tokens
# via split tokens (b + Ya + kRuntimeReady). Stay Apache CPG
...
# leftover landscape-footprint-sample-defaults #af83/#202,
# leftover landscape-height-sample-defaults #46a3/#200,
# leftover SampleLandscapeFootprint #627, leftover
# SampleLandscapeHeight #626, leftover Mission01
# environment-readiness-defaults #6b9d, leftover director
# OceanTiles #585 / BeachTiles #586 / LandTiles #587 /
# RouteExclusion #588 / ProductionLandscape #591 /
# AuthoredPCGGraph #594.
# Do not reopen leftover #536-#673, leftover Mission10
# Integrity #826 / bDestroyed #827, leftover Mission05
# #665 #666 #668-#673, or open drafts #674-#1199.
...
# LandscapeComponentCount later; this ticket is VisibleComponentCount only).
# LOCK leftover landscape-visible-audit-defaults #0bce.
...
# THIS IS leftover-safe FSkyguardLandscapeVisibleAudit
# VisibleComponentCount FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# int32 VisibleComponentCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover Mission01 environment-readiness-defaults
...
# Do not reopen open drafts #674-#1199.
# THIS IS leftover-safe FSkyguardLandscapeVisibleAudit
# VisibleComponentCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 VisibleComponentCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# BlueprintReadOnly int32 VisibleComponentCount = 0;
...
# VisibleComponentCount FIELD (declaration-only). It is
...
TARGET = "int32 VisibleComponentCount = 0;"
TARGET_WRONG = "float VisibleComponentCount = 0;"
LOCKED_DECL = TARGET
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*int32\s+VisibleComponentCount\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for int32 VisibleComponentCount is missing from "
...
class LandscapeVisibleAuditVisibleComponentCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("VisibleComponentCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_visible_component_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_visible_component_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 VisibleComponentCount"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("VisibleComponentCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("VisibleComponentCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 VisibleComponentCount"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("VisibleComponentCount", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_visible_component_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
