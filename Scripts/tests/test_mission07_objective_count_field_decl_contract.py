...
# Mission07 IntegrationReadiness ObjectiveCount
...
# NOT leftover Mission01/06/08/09 ObjectiveCount
# same-name drafts,
...
# is leftover-safe Mission07 readiness-struct ObjectiveCount after
# bCampaignRuntimeStarted. It is NOT leftover Mission06
# ObjectiveCount #1009 / branch cursor/mission06-
# objective-count-field-decl-contract-c332. It is NOT leftover
# Mission07 director Readiness #1027. Skip leftover
...
# THIS IS NOT leftover Mission06 ObjectiveCount #1009,
# leftover Mission07 director Readiness #1027,
...
class Mission07ObjectiveCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_objective_count"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
