...
# Mission06 Integration InitializePlayableMission
# on ASkyguardMission06IntegrationDirector. It is
# NOT leftover Mission05 InitializePlayableMission
...
# #666, not leftover Harbor Mission02 Integration.
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission06IntegrationDirector::InitializePlayableMission",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission06InitializePlayableMissionDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 InitializePlayableMission method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission06 InitializePlayableMission contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_initialize_playable_mission"
                "_decl_contract.py"
            )
        )
        self.assertIn(
