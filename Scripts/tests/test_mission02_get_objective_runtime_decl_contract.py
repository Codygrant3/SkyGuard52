...
# Mission02 Integration GetObjectiveRuntime
# METHOD on ASkyguardMission02IntegrationDirector.
# THIS is GetObjectiveRuntime, NOT leftover
# Mission02 InitializePlayableMission #828 /
# leftover Configure #829 / leftover StartNextWave
# #830 / leftover NotifyThreatDestroyed #831 /
# leftover NotifyFuelTerminalDamage #832, NOT leftover
# merged Mission02 C++ bundle #102, NOT leftover
# BindRuntimeActors. It is NOT leftover Mission10
# GetObjectiveRuntime, NOT leftover Mission09
...
# #764, leftover Mission10 GetObjectiveRuntime,
# leftover objective-runtime-fail-closed / leftover
# objective-definition-defaults / leftover
# objective-progress-defaults, leftover Mission10
# bObjectivesReady #815 / ObjectiveCount #823,
...
# #7898, leftover Mission05 ConfigureMissionDefinition,
...
# (`USkyguardObjectiveRuntime* GetObjectiveRuntime() const;`); accept
# that form, other one-line / split-line wraps, and
# an inline body without locking the body.
# Nearby origin/main
...
# drafts #674–#834+, leftover Apache
...
REQUIRED_DECL = GET_OBJECTIVE_RUNTIME
...
# an isolated Python GetObjectiveRuntime
# METHOD declaration contract on
# ASkyguardMission02IntegrationDirector.
# THIS is GetObjectiveRuntime, NOT leftover
# Mission02 InitializePlayableMission #828 /
# leftover ConfigureMissionDefinition #829 /
# leftover StartNextWave #830 / leftover
# NotifyThreatDestroyed #831 / leftover
# NotifyFuelTerminalDamage #832 siblings, NOT leftover
# merged Mission02 C++ bundle #102, NOT leftover
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission02_get_surviving_target_count_decl_contract.py",
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission02IntegrationDirector::GetObjectiveRuntime",
    "ASkyguardMission10IntegrationDirector::GetObjectiveRuntime",
...
class Mission02GetObjectiveRuntimeDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        as_const = "\tUSkyguardObjectiveRuntime* GetObjectiveRuntime();\n"
        with_arg = "\tUSkyguardObjectiveRuntime* GetObjectiveRuntime(int32 Amount) const;\n"
        renamed = "\tUSkyguardObjectiveRuntime* GetObjectives() const;\n"
        short_name = "\tUSkyguardObjectiveRuntime* ObjectiveRuntime() const;\n"
    ...
    def test_get_objective_runtime_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            REQUIRED_DECL.startswith("USkyguardObjectiveRuntime*"),
            REQUIRED_DECL,
        )
        self.assertTrue(
        ...
        self.assertIn("GetObjectiveRuntime", REQUIRED_DECL)
        ...
        self.assertIn(" const;", REQUIRED_DECL)
        ...
        self.assertNotIn("GetRejectedWeaponReleases", REQUIRED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("GetObjectiveRuntime", REQUIRED_DECL)
        self.assertTrue(REQUIRED_DECL.startswith("USkyguardObjectiveRuntime*"))
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertNotIn(
            "ASkyguardMission08IntegrationDirector::GetObjectiveRuntime",
            section,
        )
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("{", REQUIRED_DECL)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 GetObjectiveRuntime method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                REQUIRED_DECL.lower(),
                "mission02 GetObjectiveRuntime contains "
    ...
    def test_leftover_harbor_mission02_wave_state_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
    ...
    def test_leftover_bind_runtime_actors_is_not_the_required_decl(
        ...
        self.assertNotEqual(BIND_RUNTIME_ACTORS, "GetObjectiveRuntime")
        self.assertNotIn(BIND_RUNTIME_ACTORS, REQUIRED_DECL)
        self.assertTrue(
            REQUIRED_DECL.startswith("USkyguardObjectiveRuntime* GetObjectiveRuntime("),
            REQUIRED_DECL,
        )
        self.assertIn("()", REQUIRED_DECL)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_get_objective_runtime"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission10_get_objective_runtime_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission10IntegrationDirector "
        ...
        self.assertIn(
            "Scripts/tests/test_mission10_objectives_ready_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_objective_count_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
