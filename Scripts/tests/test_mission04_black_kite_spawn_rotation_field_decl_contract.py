...
# INDEX_NONE or lock BlackKiteSpawnRotation
# construction in the .cpp. This is leftover-safe
# Mission04 BlackKiteSpawnRotation FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps plus the FRotator default
# FRotator(0.f, 170.f, 0.f)) on
# ASkyguardMission04IntegrationDirector. Note
# EditAnywhere / BlueprintReadWrite /
# Category Skyguard|Mission04 /
# FRotator default, not VisibleAnywhere /
# BlueprintReadOnly / TObjectPtr / ClampMin. It is
# NOT leftover Mission04 BlackKiteSpawnLocation
# sibling. It is
# NOT leftover Mission04 Root #907 / CampaignDefinition
# #914 / MissionDefinition #916 / bAutoInitialize #915 /
# bAllowBoundedActorSpawning #917 /
# bAutoLaunchAfterBriefing #918. It is
...
# Category is Skyguard|Mission04, not
...
# Root #907, CampaignDefinition #914, bAutoInitialize #915,
# MissionDefinition #916, bAllowBoundedActorSpawning #917,
# bAutoLaunchAfterBriefing #918. Do not reopen leftover
# Mission04 CampaignSaveSlotName / CampaignSaveUserIndex
# drafts. Do not reopen leftover Mission04
# BlackKiteSpawnLocation sibling.
...
UPROPERTY_MISSION04_CLAMP = 'meta=(ClampMin="0")'
...
BLACK_KITE_SPAWN_ROTATION_FIELD = (
    "FRotator BlackKiteSpawnRotation = "
    "FRotator(0.f, 170.f, 0.f);"
)
...
LOCKED_DECL = BLACK_KITE_SPAWN_ROTATION_FIELD
...
# an isolated Python BlackKiteSpawnRotation
...
LEFTOVER_MISSION04_BLACK_KITE_SPAWN_LOCATION_NOT_LOCKED = (
    "BlackKiteSpawnLocation",
    BLACK_KITE_SPAWN_LOCATION,
...
class Mission04BlackKiteSpawnRotationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("BlackKiteSpawnRotation", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_black_kite_spawn_rotation_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_black_kite_spawn_rotation_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FRotator BlackKiteSpawnRotation"),
            LOCKED_DECL,
        )
        self.assertTrue(
            LOCKED_DECL.endswith("= FRotator(0.f, 170.f, 0.f);"),
            LOCKED_DECL,
        )
        self.assertIn("BlackKiteSpawnRotation", LOCKED_DECL)
        self.assertIn("= FRotator(0.f, 170.f, 0.f)", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("BlackKiteSpawnRotation", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FRotator BlackKiteSpawnRotation"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("BlackKiteSpawnRotation", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 BlackKiteSpawnRotation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 BlackKiteSpawnRotation contains "
    ...
    def test_contract_is_black_kite_spawn_rotation_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_black_kite_spawn_rotation(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_black_kite_spawn_rotation_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_same_name_campaign_save_user_index_contracts_stay_locked(
        ...
        self.assertNotIn(
            "Scripts/tests/test_mission04_black_kite_spawn_rotation"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
