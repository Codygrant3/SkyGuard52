...
# bEscalatingWavesReady FIELD (declaration-only;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission09 readiness-struct
# bEscalatingWavesReady. THIS IS NOT leftover
# Mission08 FSkyguardMission08IntegrationReadiness
# bWavesReady. THIS IS NOT leftover
# Mission07 same-name readiness-struct field
# bWavesReady / leftover Mission07 bGunnerReady.
# THIS IS NOT leftover Mission09 director fields.
# THIS IS NOT leftover Mission09 director Readiness
# field #1100 / branch cursor/mission09-readiness-
# field-decl-contract-c332. THIS IS NOT leftover
# Mission09 director Root #1083. THIS IS NOT leftover
# Mission01/02/03/04/05/06/07/08/10 same-name
# readiness-struct drafts. THIS IS NOT leftover
...
# forever; it sits immediately before leftover
# bGunnerReady in this same struct -- do not test it;
...
# #5426 / leftover Mission09 pool-budget-defaults
# #4537.
...
# INDEX_NONE or lock bEscalatingWavesReady
# construction in the .cpp. This is leftover-safe
# Mission09 IntegrationReadiness bEscalatingWavesReady
...
# NOT leftover Mission07 bGunnerReady
...
# RuntimeReady (skip forever; sits immediately
# before bGunnerReady), NOT leftover
...
# BETWEEN bMapAssemblyReady and bGunnerReady on this
...
ESCALATING_WAVES_READY = (
    "bool bEscalatingWavesReady = false;"
)
ESCALATING_WAVES_READY_TRUE = (
    "bool bEscalatingWavesReady = true;"
)
LOCKED_DECL = ESCALATING_WAVES_READY
...
# an isolated Python bEscalatingWavesReady
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission01_waves_ready_field_decl_contract.py",
    "Scripts/tests/test_mission04_waves_ready_field_decl_contract.py",
    ...
    "Scripts/tests/test_mission09_waves_ready_field_decl_contract.py",
    "Scripts/tests/test_mission10_waves_ready_field_decl_contract.py",
...
LEFTOVER_MISSION07_WAVES_READY_NOT_LOCKED = (
    "test_mission07_waves_ready_field_decl_contract.py",
    "cursor/mission07-waves-ready-field-decl-contract-c332",
)
LEFTOVER_MISSION02_WAVES_READY_NOT_LOCKED = (
    "test_mission02_waves_ready_field_decl_contract.py",
    "cursor/mission02-waves-ready-field-decl-contract-c332",
)
LEFTOVER_MISSION03_WAVES_READY_NOT_LOCKED = (
    "test_mission03_waves_ready_field_decl_contract.py",
    "cursor/mission03-waves-ready-field-decl-contract-c332",
)
LEFTOVER_MISSION04_WAVES_READY_NOT_LOCKED = (
    "test_mission04_waves_ready_field_decl_contract.py",
    "cursor/mission04-waves-ready-field-decl-contract-c332",
)
LEFTOVER_MISSION05_WAVES_READY_NOT_LOCKED = (
    "test_mission05_waves_ready_field_decl_contract.py",
    "cursor/mission05-waves-ready-field-decl-contract-c332",
)
...
LEFTOVER_MISSION10_WAVES_READY_NOT_LOCKED = (
    "test_mission10_waves_ready_field_decl_contract.py",
    "cursor/mission10-waves-ready-field-decl-contract-c332",
)
LEFTOVER_SAME_NAME_WAVES_READY_NOT_LOCKED = (
    "test_mission01_waves_ready_field_decl_contract.py",
    "test_mission02_waves_ready_field_decl_contract.py",
    "test_mission03_waves_ready_field_decl_contract.py",
    "test_mission04_waves_ready_field_decl_contract.py",
    "test_mission05_waves_ready_field_decl_contract.py",
    "test_mission06_waves_ready_field_decl_contract.py",
    "test_mission07_waves_ready_field_decl_contract.py",
    "test_mission09_waves_ready_field_decl_contract.py",
    "test_mission10_waves_ready_field_decl_contract.py",
)
...
class Mission09EscalatingWavesReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bEscalatingWavesReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_escalating_waves_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_escalating_waves_ready_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bEscalatingWavesReady"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bEscalatingWavesReady", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bEscalatingWavesReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bEscalatingWavesReady"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bEscalatingWavesReady", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 bEscalatingWavesReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 bEscalatingWavesReady contains "
    ...
    def test_contract_is_escalating_waves_ready_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_escalating_waves_ready(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission09_escalating"
            "_waves_ready_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_escalating"
                "_waves_ready_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_same_name_gunner_ready_contracts_stay_locked(
        self,
    ) -> None:
        ...
        for leftover in LEFTOVER_MISSION09_READINESS_STRUCT_SIBLINGS_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_SAME_NAME_WAVES_READY_NOT_LOCKED:
            self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION08_WAVES_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION07_WAVES_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION09_GUNNER_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION09_IRON_RAIN_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        self.assertIn(
        ...
        self.assertNotIn(
            "Scripts/tests/test_mission09_escalating_waves_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
