...
FOR_MISSION = "const FSkyguardDaySortieBeatKit& ForMission(FName MissionId);"
...
class DaySortieForMissionContractTests(unittest.TestCase):
    ...
    def test_declaration_does_not_invent_which_kit_is_returned(self) -> None:
        body = namespace_body(origin_main_header())
        self.assertNotIn("return BrokenHighway()", FOR_MISSION)
        self.assertNotIn("return DustOffensive()", FOR_MISSION)
        self.assertNotIn("return HunterKiller()", FOR_MISSION)
        ...
        self.assertNotIn("BrokenHighway()", FOR_MISSION)
        self.assertNotIn("DustOffensive()", FOR_MISSION)
        self.assertNotIn("HunterKiller()", FOR_MISSION)
        self.assertNotEqual(FOR_MISSION, "BrokenHighway()")
        self.assertNotEqual(FOR_MISSION, "DustOffensive()")
        self.assertNotEqual(FOR_MISSION, "HunterKiller()")
    ...
    def test_contract_does_not_relock_kind_at(self) -> None:
        ...
        self.assertNotIn("ESkyguardDaySortieBeatKind KindAt(", (FOR_MISSION,))
    ...
    def test_contract_does_not_read_cpp_or_which_kit_tables(self) -> None:
        ...
        self.assertNotIn("SkyguardDaySortieBeatKit::ForMission", body)
        self.assertNotIn("return BrokenHighway()", body)
        self.assertNotIn("return DustOffensive()", body)
        self.assertNotIn("return HunterKiller()", body)
    ...
    def test_declaration_bans_igla_yak_rifle(self) -> None:
        ...
        for banned in BANNED:
            self.assertNotIn(
                banned,
                lowered,
                f"day-sortie ForMission contains {banned}; "
