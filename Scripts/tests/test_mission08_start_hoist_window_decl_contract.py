...
# INDEX_NONE or lock StartHoistWindow
# construction in the .cpp. This is leftover-safe
# Mission08 Hoist StartHoistWindow METHOD
...
# an isolated Python StartHoistWindow
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission08IntegrationDirector::StartHoistWindow",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission08StartHoistWindowDeclContractTests(unittest.TestCase):
    def test_mission08_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, START_HOIST_WINDOW),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, START_HOIST_WINDOW)
        self.assertIn("StartHoistWindow", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, START_HOIST_WINDOW)
    ...
    def test_missing_initialize_declaration_fails_closed(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, START_HOIST_WINDOW)
        self.assertIn("StartHoistWindow", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, START_HOIST_WINDOW)
        self.assertIn("StartHoistWindow", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("BlueprintCallable", START_HOIST_WINDOW)
        self.assertNotIn("Category", START_HOIST_WINDOW)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, START_HOIST_WINDOW)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, START_HOIST_WINDOW)
        self.assertIn("StartHoistWindow", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = "\tvoid StartHoistWindow(float WindowSeconds);\n"
        as_const = "\tbool StartHoistWindow(float WindowSeconds) const;\n"
        with_arg = "\tbool StartHoistWindow();\n"
        renamed = "\tbool StartHoist();\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, START_HOIST_WINDOW)
            self.assertIn("StartHoistWindow", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_initialize_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(has_declaration(section, START_HOIST_WINDOW))
        self.assertEqual(
            declaration_count(section, START_HOIST_WINDOW),
            1,
        )
        self.assertTrue(
            START_HOIST_WINDOW.startswith("bool "),
            START_HOIST_WINDOW,
        )
        self.assertTrue(
            START_HOIST_WINDOW.endswith("(float WindowSeconds);"),
            START_HOIST_WINDOW,
        )
        self.assertIn("StartHoistWindow", START_HOIST_WINDOW)
        self.assertIn("(float WindowSeconds)", START_HOIST_WINDOW)
        self.assertNotIn("TArray<", START_HOIST_WINDOW)
        self.assertNotIn("TObjectPtr", START_HOIST_WINDOW)
        self.assertNotIn("TSoftObjectPtr", START_HOIST_WINDOW)
        self.assertNotIn("INDEX_NONE", START_HOIST_WINDOW)
        self.assertNotIn("UFUNCTION", ADVANCE_HOIST_WINDOW)
        self.assertNotIn("{", START_HOIST_WINDOW)
        self.assertNotIn("}", START_HOIST_WINDOW)
        self.assertNotIn("return ", START_HOIST_WINDOW)
        self.assertNotIn("const;", START_HOIST_WINDOW)
        self.assertNotIn("Root", START_HOIST_WINDOW)
        self.assertNotIn("Briefing", START_HOIST_WINDOW)
        self.assertNotIn("AudioDirector", START_HOIST_WINDOW)
        self.assertNotIn("RadioChatter", START_HOIST_WINDOW)
        self.assertNotIn("SortiePresentation", START_HOIST_WINDOW)
        self.assertNotIn("CampaignDefinition", START_HOIST_WINDOW)
        self.assertNotIn("MissionDefinition", START_HOIST_WINDOW)
        self.assertNotIn("Readiness", START_HOIST_WINDOW)
        self.assertNotIn("bAutoInitialize", START_HOIST_WINDOW)
        self.assertNotIn("bAllowBoundedActorSpawning", START_HOIST_WINDOW)
        self.assertNotIn("bAutoLaunchAfterBriefing", START_HOIST_WINDOW)
        self.assertNotIn("PathfinderSpawnLocation", START_HOIST_WINDOW)
        self.assertNotIn("GetAircraft", START_HOIST_WINDOW)
        self.assertNotIn("BindRuntimeActors", START_HOIST_WINDOW)
        self.assertNotIn("HandleDroneCityImpact", START_HOIST_WINDOW)
        self.assertNotIn("InitializePlayableMission", START_HOIST_WINDOW)
        self.assertNotIn("NotifyThreatDestroyed", START_HOIST_WINDOW)
        self.assertNotIn("AdvanceConvoyByDistance", START_HOIST_WINDOW)
        self.assertNotIn("NotifyConvoyDamage", START_HOIST_WINDOW)
        self.assertNotIn("GetWaveState", START_HOIST_WINDOW)
        self.assertNotIn("GetConvoyRouteState", START_HOIST_WINDOW)
        self.assertNotIn("GetDayBeatKit", START_HOIST_WINDOW)
        self.assertNotIn("GetNightBeatKit", START_HOIST_WINDOW)
        self.assertNotIn("StartSearchlightWindow", START_HOIST_WINDOW)
        self.assertNotIn("AdvanceSearchlightTrack", START_HOIST_WINDOW)
        self.assertNotIn("NotifySubstationDamage", START_HOIST_WINDOW)
        self.assertNotIn("GetRemainingThreatsInWave", START_HOIST_WINDOW)
        self.assertNotIn("GetSearchlightRuntime", START_HOIST_WINDOW)
        self.assertNotIn("GetSubstationIntegrity", START_HOIST_WINDOW)
        self.assertNotIn("StartPayloadWindow", START_HOIST_WINDOW)
        self.assertNotIn("AdvancePayloadWindow", START_HOIST_WINDOW)
        self.assertNotIn("TryJamActivePayload", START_HOIST_WINDOW)
        self.assertNotIn("NotifyAirfieldTargetDamage", START_HOIST_WINDOW)
        self.assertNotIn("GetPayloadWindow", START_HOIST_WINDOW)
        self.assertNotIn("GetTargetRuntime", START_HOIST_WINDOW)
        self.assertNotIn("GetSurvivingTargetCount", START_HOIST_WINDOW)
        self.assertNotIn("GetDayBeatKind", START_HOIST_WINDOW)
        self.assertNotIn("GetDayBeatIndex", START_HOIST_WINDOW)
        self.assertNotIn("TickDayBeatKit", START_HOIST_WINDOW)
        self.assertNotIn("HandleBossPhaseChanged", START_HOIST_WINDOW)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", START_HOIST_WINDOW)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", START_HOIST_WINDOW)
        self.assertNotIn("ASkyguardMission06IntegrationDirector", START_HOIST_WINDOW)
        self.assertNotIn("ESkyguardMission06WaveState", START_HOIST_WINDOW)
        self.assertNotIn("ESkyguardMission07WaveState", START_HOIST_WINDOW)
        self.assertNotIn("ESkyguardMission07ProtectedTarget", START_HOIST_WINDOW)
        self.assertNotIn("FSkyguardMission07ProtectedTargetRuntime", START_HOIST_WINDOW)
        self.assertNotIn("ESkyguardSearchSector", START_HOIST_WINDOW)
        self.assertNotIn("FSkyguardSearchTrackRuntime", START_HOIST_WINDOW)
        self.assertNotIn("ClassifyFalseTrack", START_HOIST_WINDOW)
        self.assertNotIn("ConfirmRadarGhostIdentification", START_HOIST_WINDOW)
        self.assertNotIn("NotifyProtectedTargetDamage", START_HOIST_WINDOW)
        self.assertNotIn("AdvanceReinforcementTimer", START_HOIST_WINDOW)
        self.assertNotIn("GetSearchSector", START_HOIST_WINDOW)
        self.assertNotIn("GetClassifiedFalseTrackCount", START_HOIST_WINDOW)
        self.assertNotIn("IsHostileContactConfirmed", START_HOIST_WINDOW)
        self.assertNotIn("GetProtectedTarget", START_HOIST_WINDOW)
        self.assertNotIn("GetReinforcementTimeRemaining", START_HOIST_WINDOW)
        self.assertNotIn("GetNightBeatKind", START_HOIST_WINDOW)
        self.assertNotIn("GetNightBeatIndex", START_HOIST_WINDOW)
        self.assertNotIn("TickNightBeatKit", START_HOIST_WINDOW)
        self.assertNotIn("ESkyguardAirfieldTarget", START_HOIST_WINDOW)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", START_HOIST_WINDOW)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", START_HOIST_WINDOW)
        self.assertNotIn("ConvoyRuntimeAnchor", START_HOIST_WINDOW)
        self.assertNotIn("RoadHunterSpawnLocation", START_HOIST_WINDOW)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", START_HOIST_WINDOW)
        self.assertNotIn("ASkyguardMission02IntegrationDirector", START_HOIST_WINDOW)
        self.assertNotIn("ConfigureMissionDefinition", START_HOIST_WINDOW)
        self.assertNotIn("NotifyObjectiveProgress", START_HOIST_WINDOW)
        self.assertNotIn("NotifyProtectedAssetFailed", START_HOIST_WINDOW)
        self.assertNotIn("SynchronizeRuntimeState", START_HOIST_WINDOW)
        self.assertNotIn("IsCorePlayableReady", START_HOIST_WINDOW)
        self.assertNotIn("GetReadiness", START_HOIST_WINDOW)
        self.assertNotIn("GetObjectiveRuntime", START_HOIST_WINDOW)
        self.assertNotIn("GetGunner", START_HOIST_WINDOW)
        self.assertNotIn("GetPathfinder", START_HOIST_WINDOW)
        self.assertNotIn("GetMissionId", START_HOIST_WINDOW)
        self.assertNotIn("ValidateMissionContract", START_HOIST_WINDOW)
        self.assertNotIn("ConfigureFromMission", START_HOIST_WINDOW)
        self.assertNotIn("AdvanceBriefing", START_HOIST_WINDOW)
        self.assertNotIn("SetAssetsReady", START_HOIST_WINDOW)
        self.assertNotIn("AcknowledgeAndLaunch", START_HOIST_WINDOW)
        self.assertNotIn("CanLaunch", START_HOIST_WINDOW)
        self.assertNotIn("GetElapsedSeconds", START_HOIST_WINDOW)
        self.assertNotIn("GetBriefingState", START_HOIST_WINDOW)
        self.assertNotIn("GetMinimumWarmupSeconds", START_HOIST_WINDOW)
        self.assertNotIn("GetBriefingText", START_HOIST_WINDOW)
        self.assertNotIn("GetRadioChatter", START_HOIST_WINDOW)
        self.assertNotIn("GetPresentation", START_HOIST_WINDOW)
        self.assertNotIn("GetMissionTitle", START_HOIST_WINDOW)
        self.assertNotIn("AcknowledgeBriefing", START_HOIST_WINDOW)
        self.assertNotIn("LaunchSortie", START_HOIST_WINDOW)
        self.assertNotIn("HullCollider", START_HOIST_WINDOW)
        self.assertNotIn("OpticalTracker", START_HOIST_WINDOW)
        self.assertNotIn("WeaponServo", START_HOIST_WINDOW)
        self.assertNotIn("CountermeasurePod", START_HOIST_WINDOW)
        self.assertNotIn("MinHeightFromOriginCm", START_HOIST_WINDOW)
        self.assertNotIn("RadarNode", START_HOIST_WINDOW)
        self.assertNotIn("ESkyguardMission02WaveState", START_HOIST_WINDOW)
        self.assertNotIn("HarborIndustrial", START_HOIST_WINDOW)
        self.assertNotIn("MaxIntegrity", START_HOIST_WINDOW)
        self.assertNotIn("CurrentIntegrity", START_HOIST_WINDOW)
        self.assertNotIn("FillAndFinalize", START_HOIST_WINDOW)
        self.assertNotIn("FillAndFail", START_HOIST_WINDOW)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, START_HOIST_WINDOW)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tbool\n"
            "\tStartHoistWindow(float WindowSeconds);\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_HOIST} {START_HOIST_WINDOW}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{START_HOIST_WINDOW}\n}}\n"
        self.assertTrue(has_declaration(one_line, START_HOIST_WINDOW))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, START_HOIST_WINDOW),
            section,
    ...
    def test_environment_category_does_not_satisfy_hoist(self) -> None:
        ...
        self.assertNotEqual(leftover_waves_m08, UFUNCTION_HOIST)
        ...
        self.assertNotIn(leftover_waves_m08, UFUNCTION_HOIST)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", START_HOIST_WINDOW)
        section = public_section(origin_main_header())
    ...
    def test_contract_does_not_lock_initialize_cpp_body(self) -> None:
        ...
        self.assertNotIn("return false", START_HOIST_WINDOW)
        self.assertNotIn("return true", START_HOIST_WINDOW)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("StartHoistWindow", START_HOIST_WINDOW)
        self.assertTrue(START_HOIST_WINDOW.startswith("bool "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, START_HOIST_WINDOW)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, START_HOIST_WINDOW)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", START_HOIST_WINDOW)
        self.assertNotIn("CurrentIntegrity", START_HOIST_WINDOW)
        self.assertNotIn("SkyguardApacheAircraft.h", START_HOIST_WINDOW)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, START_HOIST_WINDOW)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", START_HOIST_WINDOW)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{START_HOIST_WINDOW}\n"
        self.assertEqual(
            require_declaration(locked_only, START_HOIST_WINDOW),
            START_HOIST_WINDOW,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, START_HOIST_WINDOW)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", START_HOIST_WINDOW)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", START_HOIST_WINDOW)
        self.assertNotIn("ASkyguardIronRainBoss", section)
        self.assertNotIn("ASkyguardRadarGhostBoss", START_HOIST_WINDOW)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 StartHoistWindow method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{START_HOIST_WINDOW}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, START_HOIST_WINDOW.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                START_HOIST_WINDOW.lower(),
                "mission08 StartHoistWindow contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, START_HOIST_WINDOW)

    def test_contract_is_start_hoist_window_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(START_HOIST_WINDOW.startswith("bool "))
        self.assertIn("StartHoistWindow", START_HOIST_WINDOW)
        self.assertTrue(START_HOIST_WINDOW.endswith(";"))
        self.assertIn(UFUNCTION_HOIST, section)

    def test_sibling_director_fields_do_not_satisfy_start_hoist_window(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, START_HOIST_WINDOW)
            )
            self.assertNotEqual(START_HOIST_WINDOW, leftover)
        self.assertIn(
    ...
    def test_leftover_handle_drone_city_impact_does_not_satisfy(self) -> None:
        ...
        self.assertIn("StartHoistWindow", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, START_HOIST_WINDOW))
        locked_only = f"{START_HOIST_WINDOW}\n"
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tbool StartHoistWindow(float WindowSeconds) { return false; }\n"
            "};\n"
        )
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_start_hoist_window"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission08_wave_state_enum(
        ...
        self.assertNotIn("ESkyguardMission08WaveState", START_HOIST_WINDOW)
    ...
    def test_sibling_mission08_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("ConfigureMissionDefinition", START_HOIST_WINDOW)
        self.assertNotIn("NotifyThreatDestroyed", START_HOIST_WINDOW)
        self.assertNotIn("StartNextWave", START_HOIST_WINDOW)
        self.assertNotIn("AdvanceHoistWindow", START_HOIST_WINDOW)
