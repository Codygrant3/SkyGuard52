# THIS IS leftover-safe FSkyguardLandscapeCaptureConfigurationResult
# ViewMode FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly FString ViewMode;
# one-line / split-line UPROPERTY wraps; origin/main has NO Category).
# DEFAULT IS bare `FString ViewMode;` NOT `= false` / `= true` / `= 0`.
# Fail closed if the type or decl is missing, renamed, Category= is
# added, or default is invented. Parse STRUCT public
# section only (after struct FSkyguardLandscapeCaptureConfigurationResult, before
...
# Do NOT parse FSkyguardLandscapeFootprintSampleResult (leftover Error #1198).
...
# LOCK leftover VisibleAudit Error #1213 and leftover Footprint Error #1198.
# Harbor 40/80 fail-closed in this Mission01-related test file.
# Ban retired live-copy tokens via split tokens (b + Ya + kRuntimeReady).
# Stay Apache CPG 30 mm / Hydra / Hellfire.
# THIS IS NOT leftover CaptureConfig Mode #1215.
# THIS IS NOT leftover landscape-capture-diagnostic-enum #ce50
# (Mode is a different field).
# THIS IS NOT leftover landscape-capture-config-defaults #d6fd.
# LOCK leftover landscape-capture-diagnostic-enum #ce50.
# LOCK leftover CaptureConfig Mode #1215.
# LOCK leftover landscape-capture-config CaptureSource sibling.
# THIS IS FSkyguardLandscapeCaptureConfigurationResult::ViewMode,
# NOT leftover CaptureConfig Mode #1215, NOT leftover
# landscape-capture-config-defaults #d6fd.
...
# THIS IS NOT leftover HiddenInGameComponentCount #1204.
# THIS IS NOT leftover Footprint bSuccess #1189 / Error #1198.
# THIS IS NOT leftover VisibleAudit bSuccess #1199 through
# GovernedMaterialParentMatchComponentCount #1206.
# THIS IS NOT leftover ContractCameraFrustumIntersectionCount #1207 /
# bActorHiddenInGame #1208.
# THIS IS NOT leftover BoundsMaximum / bBoundsFiniteAndNonzero.
# LOCK leftover landscape-visible-audit-defaults #0bce.
# LOCK leftover Mission01 EnvironmentReadiness LandscapeComponentCount #1176.
# LOCK leftover Footprint bSuccess #1189 / Error #1198.
# LOCK leftover VisibleAudit bSuccess #1199 through
# GovernedMaterialParentMatchComponentCount #1206.
# LOCK leftover ContractCameraFrustumIntersectionCount #1207 /
# bActorHiddenInGame #1208.
# THIS IS NOT leftover FootprintSampleResult Error #1198.
# THIS IS NOT leftover LandscapeHeightSample Error #1188.
# THIS IS NOT leftover VisibleAudit BoundsMaximum / BoundsMinimum /
# bBoundsFiniteAndNonzero (#1210-#1212).
# LOCK leftover Footprint Error #1198 (different struct).
# LOCK leftover VisibleAudit bSuccess #1199 through
# BoundsMaximum / BoundsMinimum / bBoundsFiniteAndNonzero (#1210-#1212).
# LOCK leftover drafts #56-#64 plus leftover enum/defaults PRs.
# Harbor 40/80 fail-closed in this Mission01-related test file
...
# THIS IS leftover-safe FSkyguardLandscapeCaptureConfigurationResult
# ViewMode FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly FString ViewMode; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# DEFAULT IS bare `FString ViewMode;` NOT `= true` / `= false`. Fail closed if the type
# or decl is missing, renamed, Category= is added, or default
# is not true. Parse STRUCT public section only
# (after struct FSkyguardLandscapeCaptureConfigurationResult, before
# struct FSkyguardLandscapeMaterialCompilationResult).
# Do NOT parse USkyguardMission01EnvironmentAuthoringLibrary.
# Do NOT parse ASkyguardMission01EnvironmentDirector.
# Do NOT parse FSkyguardMission01EnvironmentReadiness.
# Do NOT parse FSkyguardLandscapeFootprintSampleResult.
# THIS IS NOT leftover VisibleAudit HiddenInGameComponentCount
# #1204 (int32 count vs bool). THIS IS NOT leftover
...
# LOCK leftover landscape-footprint-sample-defaults #af83/#202.
# LOCK leftover landscape-height-sample-defaults #46a3/#200.
# LOCK leftover SampleLandscapeFootprint #627.
# LOCK leftover SampleLandscapeHeight #626.
# LOCK leftover Mission01 environment-readiness-defaults #6b9d.
# LOCK leftover director OceanTiles #585 / BeachTiles #586 /
# LandTiles #587. LOCK leftover drafts #56-#64 plus leftover
# enum/defaults PRs. Do not reopen leftover #536-#673, leftover
# Mission10 Integrity #826 / bDestroyed #827, leftover Mission05
...
# THIS IS NOT leftover landscape-visible-audit-defaults
# #0bce (defaults contract, not field-decl).
# THIS IS NOT leftover Mission01 EnvironmentReadiness fields.
# THIS IS NOT leftover Mission01 EnvironmentReadiness
# LandscapeComponentCount #1176 (VisibleAudit also has
# LandscapeComponentCount later; this ticket is
# bActorHiddenInGame only).
# LOCK leftover landscape-visible-audit-defaults #0bce.
...
# LOCK leftover Mission01 environment-readiness-defaults #6b9d.
# LOCK leftover director OceanTiles #585 / BeachTiles #586 /
# LandTiles #587 / RouteExclusion #588 / ProductionLandscape
# #591 / AuthoredPCGGraph #594.
# LOCK leftover drafts #56-#64 plus leftover enum/defaults PRs.
...
STRUCT_NAME = "FSkyguardLandscapeCaptureConfigurationResult"
...
# THIS IS leftover-safe FSkyguardLandscapeCaptureConfigurationResult
# ViewMode FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# FString ViewMode; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover Mission01 environment-readiness-defaults
...
# Do not reopen open drafts #674-#1206.
# THIS IS leftover-safe FSkyguardLandscapeCaptureConfigurationResult
# ViewMode FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly FString ViewMode; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# ViewMode FIELD (declaration-only). It is
...
TARGET = "FString ViewMode;"
TARGET_WRONG = "FName ViewMode;"
LOCKED_DECL = TARGET
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_landscape_capture_config_mode_field_decl_contract.py",
    "Scripts/tests/test_landscape_capture_config_uses_show_only_landscape_field_decl_contract.py",
    "Scripts/tests/test_landscape_capture_config_capture_source_field_decl_contract.py",
...
def alternate_bool_defaults(declaration: str) -> tuple[str, ...]:
    ...
    if "= false;" in declaration:
        forms.append(declaration.replace("= false;", ";"))
    if "= true;" in declaration:
        forms.append(declaration.replace("= true;", ";"))
    if "= 0;" in declaration:
        forms.append(declaration.replace("= 0;", ";"))
    if "= 1;" in declaration:
        forms.append(declaration.replace("= 1;", ";"))
    if "FName ViewMode;" in declaration:
        forms.append(declaration.replace("FName ViewMode;", "FString ViewMode;"))
    if "FText ViewMode;" in declaration:
        forms.append(declaration.replace("FText ViewMode;", "FString ViewMode;"))
    unique: list[str] = []
    for form in forms:
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*FString\s+ViewMode\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for FString ViewMode is missing from "
...
class LandscapeCaptureConfigViewModeFieldDeclContractTests(unittest.TestCase):
    def test_landscape_capture_config_struct_exists(self) -> None:
        ...
        self.assertIn("bUsesShowOnlyLandscape", section)
        self.assertIn("CaptureSource", section)
        self.assertIn("ViewMode", section)
        self.assertIn("Error", section)
        self.assertNotIn("CaptureSource", LOCKED_DECL)
        self.assertNotIn("ESkyguardLandscapeCaptureDiagnosticMode", LOCKED_DECL)
        self.assertNotIn("bSuccess", LOCKED_DECL)
        self.assertNotIn("HiddenInGameComponentCount", LOCKED_DECL)
        self.assertNotIn("BoundsMaximum", LOCKED_DECL)
        self.assertNotIn("BoundsMinimum", LOCKED_DECL)
        self.assertNotIn("bBoundsFiniteAndNonzero", LOCKED_DECL)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("ViewMode", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_view_mode_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_view_mode_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FString ViewMode"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("ViewMode;"), LOCKED_DECL)
        self.assertTrue(has_one_declaration(section, TARGET), section)
        self.assertFalse(has_one_declaration(section, TARGET_WRONG))
        self.assertNotIn("FName ViewMode;", section)
        ...
        self.assertIn("ViewMode", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("ViewMode", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FString ViewMode"))
    ...
    def test_contract_does_not_relock_leftover_environment_readiness(
        ...
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
            "_actor_temporarily_hidden_in_editor"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("ViewMode", locked_only)
    ...
    def test_contract_is_target_field_declaration_only(
        ...
        self.assertTrue(LOCKED_DECL.startswith("FString ViewMode"))
        self.assertIn("ViewMode", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("ViewMode;"))
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_landscape_capture_config"
            "_mode_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_capture_config"
            "_uses_show_only_landscape_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_capture_config"
        ...
        self.assertIn(
            "Scripts/tests/test_landscape_capture_config"
            "_capture_source_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_readiness"
    ...
    def test_parser_does_not_land_on_anchors_or_director(self) -> None:
        ...
        match = CLASS_RE.search(header)
        self.assertIsNotNone(match, header)
        self.assertIn("FSkyguardLandscapeCaptureConfigurationResult", match.group(0))
