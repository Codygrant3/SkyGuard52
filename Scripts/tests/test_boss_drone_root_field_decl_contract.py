...
# INDEX_NONE or lock Root construction in the .cpp.
...
# .cpp Root body / invented INDEX_NONE stay
...
class BossDroneRootFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_root_declaration_fails_closed(
        self,
    ) -> None:
        neighbors_only = (
            "\tASkyguardBossDroneBase();\n"
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn(UPROPERTY_ROOT, section)
        ...
        self.assertNotIn("BlueprintPure", UPROPERTY_ROOT)
        self.assertNotIn("BlueprintCallable", UPROPERTY_ROOT)
        self.assertIn("Skyguard|Boss", UPROPERTY_ROOT)
        self.assertNotIn("Destruction", UPROPERTY_ROOT)
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, UPROPERTY_ROOT)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        box = "\tTObjectPtr<UBoxComponent> Root;\n"
        static_mesh = "\tTObjectPtr<UStaticMeshComponent> Root;\n"
        weak = "\tTWeakObjectPtr<USceneComponent> Root;\n"
        assigned = "\tTObjectPtr<USceneComponent> Root = nullptr;\n"
        wrong_name = "\tTObjectPtr<USceneComponent> BodyMesh;\n"
    ...
    def test_root_declaration_matches_origin_main(
        self,
    ) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
        ...
        self.assertNotIn("GetBossPhase", ROOT_FIELD)
        self.assertNotIn("{", ROOT_FIELD)
        self.assertNotIn("}", ROOT_FIELD)
        ...
        self.assertNotIn("ApplyWeaponHit", ROOT_FIELD)
        self.assertNotIn("IssuePilotCommand", ROOT_FIELD)
        self.assertNotIn(
            "GetMaxDefeatDebrisPieces",
            ROOT_FIELD,
        )
        ...
        self.assertNotIn("GetDefeatDebrisPieceCount", ROOT_FIELD)
        self.assertNotIn("GetTelemetry", ROOT_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", ROOT_FIELD)
        self.assertNotIn("GetGunnerMount", ROOT_FIELD)
        self.assertNotIn("FaceWorldLocation", ROOT_FIELD)
        self.assertNotIn("WeakPoints", ROOT_FIELD)
        self.assertNotIn("SetSearchlightTracked", ROOT_FIELD)
        self.assertNotIn("SetContactIdentified", ROOT_FIELD)
        self.assertNotIn(
            "SetFriendlySeparationMeters",
            ROOT_FIELD,
        )
        self.assertNotIn("SetLightningExposed", ROOT_FIELD)
        self.assertNotIn(
            "OpenUpperEngineExposure",
            ROOT_FIELD,
        )
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        one_line = f"{{\npublic:\n\t{ROOT_FIELD}\n}}\n"
        self.assertTrue(
            has_declaration(one_line, ROOT_FIELD)
        )
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, ROOT_FIELD),
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        ...
        for region in (body, weak_points, phase, telemetry):
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, ROOT_FIELD)
            self.assertIn("Root", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(ROOT_FIELD.startswith("UFUNCTION"), ROOT_FIELD)
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, ROOT_FIELD), section)
    ...
    def test_contract_does_not_lock_root_cpp_body(
        self,
    ) -> None:
        locked_only = f"{ROOT_FIELD}\n"
        self.assertNotIn("{", ROOT_FIELD)
        ...
        self.assertNotIn("SetBossPhase", ROOT_FIELD)
        self.assertNotIn(
            "HandleWeakPointDestroyed",
            ROOT_FIELD,
        )
        self.assertNotIn("RegisterDefeatDebris", ROOT_FIELD)
        self.assertNotIn("CleanupDefeatDebris", ROOT_FIELD)
        self.assertNotIn("HandleDefeated", ROOT_FIELD)
    ...
    def test_contract_does_not_relock_sibling_public_fields(self) -> None:
        ...
        for token in PUBLIC_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ROOT_FIELD)
        self.assertNotIn("BodyMesh", ROOT_FIELD)
        self.assertNotIn("WeakPoints", ROOT_FIELD)
        self.assertNotIn("CurrentPilotCommand", ROOT_FIELD)
        self.assertNotIn("Telemetry", ROOT_FIELD)
        self.assertNotIn("OnBossPhaseChanged", ROOT_FIELD)
        self.assertNotIn("OnPilotCommandNative", ROOT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_live_copy_methods(self) -> None:
        ...
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, ROOT_FIELD)
    ...
    def test_contract_does_not_relock_weak_point_fields(self) -> None:
        ...
        self.assertNotIn("WeakPoints", ROOT_FIELD)
        self.assertNotIn("PortGuidanceArray", ROOT_FIELD)
        self.assertNotIn("CommandCore", ROOT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, ROOT_FIELD)
        self.assertNotIn("SetSearchlightTracked", ROOT_FIELD)
        self.assertNotIn("IsSearchlightTracked", ROOT_FIELD)
        self.assertNotIn("ASkyguardBlackKiteBoss", ROOT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            ...
            self.assertNotIn(token, ROOT_FIELD)
        self.assertNotIn("SetContactIdentified", ROOT_FIELD)
        self.assertNotIn("IsContactIdentified", ROOT_FIELD)
        self.assertNotIn("OpenOrbitExposure", ROOT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        self.assertNotIn("OpenSensorExposure", ROOT_FIELD)
        self.assertNotIn(
            "ASkyguardLifelineHunterBoss",
            ROOT_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_tempest(self) -> None:
        ...
        self.assertNotIn("ASkyguardTempestBoss", ROOT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_iron_rain(self) -> None:
        ...
        self.assertNotIn("OpenDispenserBay", ROOT_FIELD)
        self.assertNotIn("ASkyguardIronRainBoss", ROOT_FIELD)
        self.assertNotIn(
            "ASkyguardIronRainBoss::IssueClimbCommand",
            ROOT_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        self.assertNotIn("ASkyguardPatrolShip", ROOT_FIELD)
    ...
    def test_contract_does_not_relock_mount_getters(self) -> None:
        ...
        for token in MOUNT_GETTERS_NOT_LOCKED:
            ...
            self.assertNotIn(token, ROOT_FIELD)
        self.assertNotIn("GetGunnerMount", ROOT_FIELD)
        self.assertNotIn("GetChinTurret", ROOT_FIELD)
        self.assertNotIn("GetSensorTurret", ROOT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ROOT_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", ROOT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_input_capture(self) -> None:
        ...
        self.assertNotIn("RecordPlayerEvent", ROOT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ROOT_FIELD)
        self.assertNotIn("ASkyguardGunner", ROOT_FIELD)
        self.assertNotIn("FillAndFinalize", ROOT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ROOT_FIELD)
        self.assertNotIn("SkyguardRadarNode", ROOT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", ROOT_FIELD)
        self.assertNotIn(
            "USkyguardBriefingWidget",
            ROOT_FIELD,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("SkyguardPathfinder", ROOT_FIELD)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "boss drone Root field contract contains "
    ...
    def test_contract_is_root_field_declaration_only(
        ...
        self.assertNotIn("return ", ROOT_FIELD)
        self.assertNotIn("{", ROOT_FIELD)
        self.assertTrue(ROOT_FIELD.startswith("TObjectPtr<USceneComponent> "))
