...
# Mission05 MaximumProtectedTargetIntegrity FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps, ClampMin one-line or split-line,
# int32 default 100) on
# ASkyguardMission05IntegrationDirector.
# SKIP leftover retired-mount spawn fields
# forever. This contract is MaximumProtectedTargetIntegrity
# only. It is NOT leftover Mission04
# MaximumSubstationIntegrity #925 / branch
# cursor/mission04-maximum-substation-integrity-
# field-decl-contract-c332, NOT leftover
# Mission03 MaximumConvoyIntegrity #889 / branch
# cursor/mission03-maximum-convoy-integrity-field-
# decl-contract-c332, NOT leftover Mission02
# MaximumFuelTerminalIntegrity #859 / branch
# cursor/mission02-maximum-fuel-terminal-integrity-
# field-decl-contract-c332, NOT leftover Mission10
# MaximumProtectedIntegrity #808 / branch
# cursor/mission10-maximum-protected-integrity-
# field-decl-contract-c332, NOT leftover
# TempestSpawnLocation sibling, NOT leftover
# Mission04 BlackKiteSpawnLocation field drafts,
# NOT leftover Mission03 RoadHunterSpawnLocation
# field drafts, NOT leftover Mission02
# BreakwaterSpawnLocation field drafts, NOT leftover
# Mission10 LastFlightSpawnLocation field drafts,
# NOT leftover BindRuntimeActors /
# HandleDroneCityImpact, NOT leftover
# GetStormRainBeatKit without UFUNCTION,
# NOT leftover Mission05 closed-without-merge
# #665 #666 #668 #669 #670 #671 #672 #673, NOT leftover
# Mission05 wave-state enum #ad28 / protected-target
# enum #aaa2 / protected-target-runtime-defaults
# #ec8b / storm-runtime-defaults #89c9, NOT leftover
# sibling Mission05 director field drafts Root #947 /
# AudioDirector #948 / Briefing #949 / RadioChatter
# #950 / SortiePresentation #951 / CampaignDefinition
# #952 / MissionDefinition #953 / bAutoInitialize #954
# / bAllowBoundedActorSpawning #955 /
# bAutoLaunchAfterBriefing #956 / CampaignSaveSlotName
# (in-flight) / CampaignSaveUserIndex (in-flight).
# Do not reopen leftover drafts #536-#673. Do not
# open leftover drafts #674-#956.
# Note EditAnywhere / BlueprintReadWrite /
# Category Skyguard|Mission05 /
# int32 = 100 / ClampMin 1, not
# VisibleAnywhere / BlueprintReadOnly / TObjectPtr. It is
...
# / branch cursor/mission03-campaign-save-
# user-index-field-decl-contract-c332, NOT leftover
# Mission10 CampaignSaveUserIndex field
# leftover Mission03 CampaignSaveSlotName sibling,
# leftover convoy-route-state enum #d34e,
# leftover Mission03 wave-state enum #0242,
# #804 / branch cursor/mission10-campaign-save-
# user-index-field-decl-contract-c332, NOT leftover
# campaign-save-user-index method contracts,
# NOT leftover Mission01 bAllowBoundedActorSpawning field
# #581 / branch cursor/mission01-allow-bounded-
# actor-spawning-field-decl-contract-c332, NOT leftover
# Mission01 bAutoInitialize field
# #580 / branch cursor/mission01-auto-initialize-
# field-decl-contract-c332, NOT leftover
# Mission01 MissionDefinition field
# #578 / branch cursor/mission01-mission-definition-
# field-decl-contract-c332, NOT leftover
# Mission01 CampaignDefinition field
# #577 / branch cursor/mission01-campaign-definition-
# field-decl-contract-c332, NOT leftover
# Mission01 SortiePresentation field
# #575, NOT leftover Mission01 RadioChatter field
# #576, NOT leftover Mission01 Briefing field
# #568, NOT leftover Mission01 AudioDirector field
# #572, NOT leftover Mission01 Root field
# #574 / branch cursor/mission01-root-field-
# decl-contract-c332 (closed, do not reopen
# #536-#673), NOT leftover environment-root
# #592, NOT leftover mission-definition method
# contracts, NOT leftover Mission10
# ConfigureMissionDefinition #769 / branch
# cursor/mission10-configure-mission-definition-
# decl-contract-c332, NOT leftover Mission10
# Root / Briefing / AudioDirector / RadioChatter /
# SortiePresentation / CampaignDefinition /
# MissionDefinition / bAutoInitialize /
# bAllowBoundedActorSpawning /
# bAutoLaunchAfterBriefing /
# CampaignSaveSlotName field
# siblings, NOT leftover Mission10 route-phase
...
# Do not lock leftover BlackKiteSpawnRotation /
# RequiredTrackSeconds / retired-mount spawn
# fields on this class. Do not lock leftover GetAircraft.
...
# leftover mission-definition method contracts,
...
# leftover Mission06 wave-state enum #fa65, leftover
...
# with ClampMin one-line or split-line);
# accept that form, other one-line / split-line wraps,
# the `= 100` default, and nearby split-line
# UPROPERTY wraps without locking invented metadata.
# Nearby origin/main
# UPROPERTY(EditAnywhere, BlueprintReadWrite,
# Category="Skyguard|Mission05",
# meta=(ClampMin="1"))
# is required as present. Accept one-line and
# split-line UPROPERTY wraps plus the `= 100`
# default. Parse the public class section of
# ASkyguardMission05IntegrationDirector only.
# Do not parse FSkyguardMission05IntegrationReadiness,
# FSkyguardStormRuntime, private, or Mission01-04 /
# Mission06-10 directors.
# Category is Skyguard|Mission05, not leftover
# Mission04 CampaignSaveUserIndex sibling, not leftover
# Mission04 BlackKiteSpawnRotation sibling, not
# leftover Mission03 Campaign, not leftover
# Mission02 Campaign #857, not leftover
# Mission04 CampaignSaveSlotName sibling, not leftover
# Mission04 Root #907 / CampaignDefinition #914 /
# MissionDefinition #916 / bAutoInitialize #915 /
# bAllowBoundedActorSpawning, not
...
# not leftover Mission01 Campaign,
# Integration, not Mission01 / Mission02 / Mission03 /
# Mission05 / Mission06 / Mission07 /
# Mission08 / Mission09, not leftover Mission01
# Root #574, not leftover Mission01
# CampaignSaveUserIndex #584, not leftover
# campaign-save-user-index method contracts, not leftover
# Mission01 bAllowBoundedActorSpawning #581, not leftover
# Mission01 bAutoInitialize #580, not leftover
# Mission01 bAutoLaunchAfterBriefing #582, not leftover
# Mission01 MissionDefinition #578, not leftover Mission09
...
# drafts #674-#956 including leftover Mission04
# CampaignDefinition #914, leftover Mission05
# Root #947 / AudioDirector #948 / Briefing #949 /
# RadioChatter #950 / SortiePresentation #951 /
# CampaignDefinition #952 / MissionDefinition #953 /
# bAutoInitialize #954 / bAllowBoundedActorSpawning
# #955 / bAutoLaunchAfterBriefing #956, leftover radio-line-
# defaults #1dec, leftover Apache
...
# file and the locked Mission05 public decl slice.
# Do not scan
# Apache public section for those tokens. Incoming
# clock names must be absent from the
# Mission05IntegrationDirector public section. Pathfinder MinHeightFromOriginCm
...
# CampaignDefinition #952 / MissionDefinition #953 /
# bAutoInitialize #954 / bAllowBoundedActorSpawning
# #955 / bAutoLaunchAfterBriefing #956.
...
UPROPERTY_MISSION05_CLAMP = 'meta=(ClampMin="1")'
...
# an isolated Python TempestSpawnLocation
...
LEFTOVER_SPAWN_FIELDS_NOT_LOCKED = (
    ...
    BLACK_KITE_SPAWN_LOCATION_TYPE_ONLY,
    BLACK_KITE_SPAWN_LOCATION,
    BLACK_KITE_SPAWN_ROTATION,
    "TempestSpawnRotation",
    TEMPEST_SPAWN_ROTATION,
...
CPP_AND_INVENTED = (
    ...
    "SkyguardMission09IntegrationDirector.cpp",
    "ASkyguardMission02IntegrationDirector::GetRemainingThreatsInWave",
    "ASkyguardMission02IntegrationDirector::MissionDefinition",
    "SkyguardMission02IntegrationDirector.cpp",
    "ASkyguardMission10IntegrationDirector::GetRemainingThreatsInWave",
    "ASkyguardMission10IntegrationDirector::MissionDefinition",
    "SkyguardMission10IntegrationDirector.cpp",
...
LEFTOVER_MISSION02_MAXIMUM_FUEL_TERMINAL_INTEGRITY_NOT_LOCKED = (
    "MaximumFuelTerminalIntegrity",
    MAXIMUM_FUEL_TERMINAL_INTEGRITY_FIELD,
    "test_mission02_maximum_fuel_terminal_integrity_field_decl_contract.py",
    "cursor/mission02-maximum-fuel-terminal-integrity-field-decl-contract-c332",
)
LEFTOVER_MISSION03_MAXIMUM_CONVOY_INTEGRITY_NOT_LOCKED = (
    "MaximumConvoyIntegrity",
    MAXIMUM_CONVOY_INTEGRITY_FIELD,
    "test_mission03_maximum_convoy_integrity_field_decl_contract.py",
    "cursor/mission03-maximum-convoy-integrity-field-decl-contract-c332",
)
LEFTOVER_MISSION04_MAXIMUM_SUBSTATION_INTEGRITY_NOT_LOCKED = (
    "MaximumSubstationIntegrity",
    MAXIMUM_SUBSTATION_INTEGRITY_FIELD,
    "test_mission04_maximum_substation_integrity_field_decl_contract.py",
    "cursor/mission04-maximum-substation-integrity-field-decl-contract-c332",
)
LEFTOVER_MISSION10_MAXIMUM_PROTECTED_INTEGRITY_NOT_LOCKED = (
    "MaximumProtectedIntegrity",
    MAXIMUM_PROTECTED_INTEGRITY_FIELD,
    "test_mission10_maximum_protected_integrity_field_decl_contract.py",
    "cursor/mission10-maximum-protected-integrity-field-decl-contract-c332",
)
LEFTOVER_MISSION05_TEMPEST_SPAWN_LOCATION_NOT_LOCKED = (
    "TempestSpawnLocation",
    TEMPEST_SPAWN_LOCATION,
    "test_mission05_tempest_spawn_location_field_decl_contract.py",
    "cursor/mission05-tempest-spawn-location-field-decl-contract-c332",
)
...
class Mission05MaximumProtectedTargetIntegrityFieldDeclContractTests(unittest.TestCase):
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        macro_only = f"\t{UPROPERTY_MISSION05}\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn(UPROPERTY_MISSION05, section)
        self.assertIn("EditAnywhere", section)
        self.assertIn("BlueprintReadWrite", section)
        self.assertIn('Category="Skyguard|Mission05"', section)
        self.assertIn(UPROPERTY_MISSION05_CLAMP, section)
        self.assertIn('ClampMin="1"', section)
        self.assertNotIn("VisibleAnywhere", UPROPERTY_MISSION05)
        self.assertNotIn("BlueprintReadOnly", UPROPERTY_MISSION05)
        self.assertTrue(
            has_declaration(section, LOCKED_DECL),
            section,
        )
        ...
        self.assertNotIn("Skyguard|Mission10|Protection", UPROPERTY_MISSION05)
        self.assertNotIn("Integration", UPROPERTY_MISSION05)
        self.assertNotIn("Mission01", UPROPERTY_MISSION05)
        self.assertNotIn("Mission02", UPROPERTY_MISSION05)
        self.assertNotIn("Mission03", UPROPERTY_MISSION05)
        self.assertNotIn("Mission04", UPROPERTY_MISSION05)
        self.assertNotIn("Mission06", UPROPERTY_MISSION05)
        self.assertNotIn("Protection", UPROPERTY_MISSION05)
        self.assertNotIn("Search", UPROPERTY_MISSION05)
        self.assertNotIn("Waves", UPROPERTY_MISSION05)
        self.assertNotIn("Payload", UPROPERTY_MISSION05)
        self.assertNotIn("Targets", UPROPERTY_MISSION05)
        self.assertNotIn("Objectives", UPROPERTY_MISSION05)
        self.assertNotIn("Environment", UPROPERTY_MISSION05)
        self.assertNotIn("Briefing", UPROPERTY_MISSION05)
        self.assertNotIn("Mission10", UPROPERTY_MISSION05)
        self.assertNotIn("Boss", UPROPERTY_MISSION05)
        self.assertNotIn("Destruction", UPROPERTY_MISSION05)
        self.assertNotIn("Apache", UPROPERTY_MISSION05)
        self.assertNotIn("Mission07", UPROPERTY_MISSION05)
        self.assertNotIn("Mission08", UPROPERTY_MISSION05)
        self.assertNotIn("Mission09", UPROPERTY_MISSION05)
        self.assertNotIn("Encounter", UPROPERTY_MISSION05)
        self.assertNotIn("Safety", UPROPERTY_MISSION05)
        self.assertNotIn("Performance", UPROPERTY_MISSION05)
        self.assertNotIn("Hoist", UPROPERTY_MISSION05)
        self.assertNotIn("Rescue", UPROPERTY_MISSION05)
        self.assertNotIn("Evacuation", UPROPERTY_MISSION05)
        self.assertNotIn("Campaign", UPROPERTY_MISSION05)
        self.assertNotIn("Skyguard|Mission05|Campaign", UPROPERTY_MISSION05)
        self.assertNotIn("ClampMin", UPROPERTY_MISSION05)
        self.assertNotIn("ClampMin", LOCKED_DECL)
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, UPROPERTY_MISSION05)
    ...
    def test_maximum_protected_target_integrity_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("TObjectPtr<USkyguardRadioChatterComponent>", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION05} {LOCKED_DECL}\n"
            "};\n"
        )
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(environment, UPROPERTY_MISSION05)
        self.assertNotEqual(briefing, UPROPERTY_MISSION05)
        self.assertNotIn(environment, UPROPERTY_MISSION05)
        self.assertNotIn(briefing, UPROPERTY_MISSION05)
        leftover_m01 = (
            'UFUNCTION(BlueprintCallable, '
        ...
        self.assertNotEqual(leftover_m01, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m02, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_harbor, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m03, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m04, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m05, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m06, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_waves, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m05_waves, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_integration, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m07_ready, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m08_waves, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m08_hoist, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m08_safety, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m08_protection, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m08_ready, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m09_ready, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m09_waves, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m10_safety, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m09_protection, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m09_performance, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_m09_objectives, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_payload, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_targets, UPROPERTY_MISSION05)
        self.assertNotEqual(leftover_objectives, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m01, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m02, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_harbor, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m03, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m04, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m05, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m06, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m05_waves, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_integration, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m07_ready, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m08_waves, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m08_hoist, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m08_safety, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m08_protection, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m08_ready, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m09_ready, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m09_waves, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m10_safety, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m09_protection, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m09_performance, UPROPERTY_MISSION05)
        self.assertNotIn(leftover_m09_objectives, UPROPERTY_MISSION05)
        self.assertNotIn("Mission01", UPROPERTY_MISSION05)
        self.assertNotIn("Mission02", UPROPERTY_MISSION05)
        self.assertNotIn("Mission03", UPROPERTY_MISSION05)
        self.assertNotIn("Mission04", UPROPERTY_MISSION05)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 MaximumProtectedTargetIntegrity field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 MaximumProtectedTargetIntegrity contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_maximum_protected_target_integrity(
        ...
        self.assertIn(
            "Scripts/tests/test_mission10_campaign_save_slot_name"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tint32 MaximumProtectedTargetIntegrity = 1;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_contract_does_not_relock_leftover_handle_boss_phase_changed(
        ...
        for token in LEFTOVER_HANDLE_BOSS_PHASE_CHANGED_NOT_LOCKED:
            ...
            self.assertNotIn(token, LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", UPROPERTY_MISSION05)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_maximum_protected_target_integrity_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission10_campaign_save_user_index_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission10IntegrationDirector "
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission10_campaign_save_user_index"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertNotIn("CampaignSaveSlotName", LOCKED_DECL)
        self.assertNotIn("GetCampaignSaveUserIndex", LOCKED_DECL)
        self.assertNotIn("SetCampaignSaveUserIndex", LOCKED_DECL)

    def test_leftover_same_name_campaign_save_user_index_contracts_stay_locked(
        self,
    ) -> None:
        for leftover in (
            "Scripts/tests/test_mission01_campaign_save_user_index"
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_black_kite_spawn_location"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission05_tempest_spawn_location_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertNotIn(
    ...
    def test_leftover_mission02_sibling_field_contracts_stay_locked(
        self,
    ) -> None:
        for leftover in (
            "Scripts/tests/test_mission02_initialize_playable_mission"
            ...
            "_decl_contract.py",
            "Scripts/tests/test_mission02_audio_director"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission02_radio_chatter"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission02_sortie_presentation"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission02_campaign_definition"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission02_mission_definition"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission02_auto_initialize"
            "_field_decl_contract.py",
    ...
    def test_contract_does_not_parse_readiness_struct(self) -> None:
        ...
        self.assertIsNone(
            re.search(
                ...
                r"FSkyguardMission05IntegrationReadiness\b",
                header,
            )
        )
        self.assertIn(
    ...
    def test_leftover_same_name_spawn_location_contracts_stay_locked(
        self,
    ) -> None:
        for leftover in (
            "Scripts/tests/test_mission04_black_kite_spawn_location_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission03_road_hunter_spawn_location_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission02_breakwater_spawn_location_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_last_flight_spawn_location_field"
            "_decl_contract.py",
        ):
            self.assertIn(leftover, LOCKED_SCRIPTS)
        locked_only = f"{LOCKED_DECL}\n"
        self.assertNotIn("BlackKiteSpawnLocation", locked_only)
        self.assertNotIn("RoadHunterSpawnLocation", locked_only)
        self.assertNotIn("BreakwaterSpawnLocation", locked_only)
        self.assertNotIn("LastFlightSpawnLocation", locked_only)
        self.assertNotIn("TempestSpawnLocation", locked_only)
        self.assertNotIn("TempestSpawnLocation", LOCKED_DECL)
        self.assertNotIn("TempestSpawnRotation", locked_only)
        self.assertNotIn("TempestSpawnRotation", LOCKED_DECL)
        self.assertNotIn("MaximumSubstationIntegrity", locked_only)
        self.assertNotIn("MaximumConvoyIntegrity", locked_only)
        self.assertNotIn("MaximumFuelTerminalIntegrity", locked_only)
        self.assertNotIn("MaximumProtectedIntegrity", locked_only)
        for token in leftover_spawn_name_tokens():
            self.assertNotIn(token, LOCKED_DECL)

    def test_leftover_mission05_sibling_field_contracts_stay_locked(
        self,
    ) -> None:
        for leftover in (
            "Scripts/tests/test_mission05_root_field_decl_contract.py",
            ...
            "_decl_contract.py",
            "Scripts/tests/test_mission05_briefing_field_decl_contract.py",
            "Scripts/tests/test_mission05_radio_chatter_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission05_sortie_presentation_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission05_campaign_definition_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission05_mission_definition_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission05_auto_initialize_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission05_allow_bounded_actor_spawning"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission05_auto_launch_after_briefing"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission05_campaign_save_slot_name_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission05_campaign_save_user_index_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission05_tempest_spawn_location_field"
            "_decl_contract.py",
    ...
    def test_storm_runtime_struct_does_not_satisfy_maximum_protected_target_integrity(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_readiness_struct_does_not_satisfy_maximum_protected_target_integrity(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
