...
# Mission08 MaximumProtectedTargetIntegrity FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps, ClampMin on the same line as
# Category or a following wrap line,
# int32 default 100) on
# ASkyguardMission08IntegrationDirector. Note
# EditAnywhere / BlueprintReadWrite /
# Category Skyguard|Mission08 /
# int32 = 100 / ClampMin 1, not VisibleAnywhere /
...
# (`int32 MaximumProtectedTargetIntegrity = 100;` with
# ClampMin meta on the same Category line);
...
# split-line UPROPERTY wraps plus = 100. Accept
# meta=(ClampMin="1") on the same line as Category
# or on a following wrap line. Parse the public
# class section of
...
# Category is Skyguard|Mission08, not
# Skyguard|Mission08|Campaign, not
...
UPROPERTY_MISSION08_CLAMP = 'meta=(ClampMin="1")'
...
class Mission08MaximumProtectedTargetIntegrityFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("Safety", UPROPERTY_MISSION08)
        ...
        self.assertNotIn("Skyguard|Mission08|Campaign", UPROPERTY_MISSION08)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        self.assertNotIn("ClampMin", UPROPERTY_MISSION08)
        self.assertNotIn("ClampMin", LOCKED_DECL)
        self.assertNotIn("VisibleAnywhere", UPROPERTY_MISSION08)
        self.assertNotIn("BlueprintReadOnly", UPROPERTY_MISSION08)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission08_maximum_protected_target_integrity_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_maximum_protected_target_integrity_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
