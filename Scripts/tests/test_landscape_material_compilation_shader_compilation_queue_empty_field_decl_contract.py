...
# bShaderCompilationQueueEmpty. THIS IS NOT leftover
# landscape-material-compilation-defaults #01d4. THIS IS NOT
# leftover CaptureConfig fields. THIS IS NOT leftover
# VisibleAudit fields. Distinct from sibling
# bAssetCompilationQueueEmpty (in-flight; lock that script,
# do not edit it).
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# bShaderCompilationQueueEmpty FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# bool bShaderCompilationQueueEmpty = false; one-line /
...
# struct FSkyguardLandscapeMaterialCompilationResult and BEFORE
...
# Do NOT parse FSkyguardLandscapeHeightSample.
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# bShaderCompilationQueueEmpty. THIS IS NOT leftover
# landscape-material-compilation-defaults #01d4. THIS IS NOT
# leftover landscape-capture-config-defaults #d6fd. THIS IS NOT
# leftover mission01-environment-authoring-result-defaults #df1a.
# THIS IS NOT leftover CaptureConfigurationResult public
# UPROPERTY #1214-#1224. THIS IS NOT leftover MaterialCompilation
# bSuccess #1223 / LandscapeComponentCount #1227 /
# GeneratedMaterialInstanceCount #1225 / MaterialResourceCount
# #1226 / CompilationFinishedResourceCount #1228. THIS IS NOT
# leftover sibling bAssetCompilationQueueEmpty (in-flight).
# LOCK leftover landscape-material-compilation-defaults #01d4.
# LOCK leftover landscape-capture-config-defaults #d6fd.
# LOCK leftover mission01-environment-authoring-result-defaults
# #df1a. LOCK leftover CaptureConfigurationResult public
# UPROPERTY #1214-#1224. LOCK leftover MaterialCompilation
# bSuccess #1223 / LandscapeComponentCount #1227 /
# GeneratedMaterialInstanceCount #1225 / MaterialResourceCount
# #1226 / CompilationFinishedResourceCount #1228.
...
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# bShaderCompilationQueueEmpty. THIS IS NOT leftover VisibleAudit
...
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# bShaderCompilationQueueEmpty. THIS IS NOT leftover VisibleAudit bSuccess #1199.
...
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# bShaderCompilationQueueEmpty FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bShaderCompilationQueueEmpty = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# Fail closed if the type or decl is missing, renamed, or
# Category= is added. Parse STRUCT public section only
# (after struct FSkyguardLandscapeMaterialCompilationResult, before
# struct FSkyguardMission01EnvironmentAuthoringResult).
# Do NOT parse USkyguardMission01EnvironmentAuthoringLibrary.
...
STRUCT_NAME = "FSkyguardLandscapeMaterialCompilationResult"
...
# BlueprintReadOnly bool bShaderCompilationQueueEmpty = false;
...
TARGET = "bool bShaderCompilationQueueEmpty = false;"
TARGET_WRONG = "bool bShaderCompilationQueueEmpty = true;"
LOCKED_DECL = TARGET
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_landscape_material_compilation_landscape_component_count_field_decl_contract.py",
    "Scripts/tests/test_landscape_material_compilation_generated_material_instance_count_field_decl_contract.py",
    "Scripts/tests/test_landscape_material_compilation_material_resource_count_field_decl_contract.py",
    "Scripts/tests/test_landscape_material_compilation_compilation_finished_resource_count_field_decl_contract.py",
    "Scripts/tests/test_landscape_material_compilation_valid_shader_map_resource_count_field_decl_contract.py",
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # bShaderCompilationQueueEmpty (must be = false, not = true).
    # THIS IS NOT leftover VisibleAudit bSuccess #1199.
    # THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*bool\s+bShaderCompilationQueueEmpty\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for bool bShaderCompilationQueueEmpty is missing from "
...
class LandscapeMaterialCompilationShaderCompilationQueueEmptyFieldDeclContractTests(unittest.TestCase):
    def test_landscape_material_compilation_struct_exists(self) -> None:
        ...
        self.assertIn("GeneratedMaterialInstanceCount", section)
        self.assertIn("MaterialResourceCount", section)
        self.assertIn("CompilationFinishedResourceCount", section)
        self.assertIn("ValidShaderMapResourceCount", section)
        self.assertIn("bAssetCompilationQueueEmpty", section)
        self.assertIn("bShaderCompilationQueueEmpty", section)
        ...
        self.assertNotIn("bValid", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bShaderCompilationQueueEmpty", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_shader_compilation_queue_empty_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_shader_compilation_queue_empty_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bShaderCompilationQueueEmpty"),
            LOCKED_DECL,
        )
        ...
        self.assertFalse(
            has_declaration(
                "\tbool bShaderCompilationQueueEmpty = true;\n",
                LOCKED_DECL,
            )
        )
        with self.assertRaises(AssertionError) as raised:
        ...
        self.assertIn("bShaderCompilationQueueEmpty", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bShaderCompilationQueueEmpty", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bShaderCompilationQueueEmpty"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bShaderCompilationQueueEmpty", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_shader_compilation_queue_empty(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_landscape_material_compilation"
            "_compilation_finished_resource_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_material_compilation"
            "_valid_shader_map_resource_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_material_compilation"
    ...
    def test_parser_does_not_land_on_anchors_or_director(self) -> None:
        ...
        match = CLASS_RE.search(header)
        self.assertIsNotNone(match, header)
        self.assertIn("FSkyguardLandscapeMaterialCompilationResult", match.group(0))
