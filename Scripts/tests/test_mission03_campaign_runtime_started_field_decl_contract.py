...
# Mission03 IntegrationReadiness bCampaignRuntimeStarted
...
# field #881, NOT leftover GetReadiness(),
...
# drafts #674-#899 including leftover Mission02
...
# #874 including leftover Mission02
# bCampaignRuntimeStarted #872, leftover Mission03
# director CampaignDefinition field #881 /
# MissionDefinition #882, leftover Mission03 director
# fields through Readiness #890 /
# MaximumConvoyIntegrity #889, leftover Mission10
...
class Mission03CampaignRuntimeStartedFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 bCampaignRuntimeStarted field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission03 bCampaignRuntimeStarted contains "
