...
# INDEX_NONE or lock LifelineHunterSpawnLocation
# construction in the .cpp. This is leftover-safe
# Mission08 LifelineHunterSpawnLocation FIELD
...
# LifelineHunterSpawnLocation). This contract is
# LifelineHunterSpawnLocation only. It is NOT leftover
...
# Lock LifelineHunterSpawnLocation only. Do not lock
...
# leftover Mission07 / Mission09, not leftover Mission01
...
# drafts #674-#1058, leftover Apache
...
# drafts #674-#1058 including leftover Mission03
...
LOCKED_DECL = LIFELINE_HUNTER_SPAWN_LOCATION
...
# an isolated Python LifelineHunterSpawnLocation
...
class Mission08LifelineHunterSpawnLocationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("LifelineHunterSpawnLocation", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_lifeline_hunter_spawn_location_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_lifeline_hunter_spawn_location_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FVector LifelineHunterSpawnLocation"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("LifelineHunterSpawnLocation", LOCKED_DECL)
        self.assertIn("= FVector(57000.f, -9000.f, 5400.f)", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tFVector\n"
            "\tLifelineHunterSpawnLocation = FVector(57000.f, -9000.f, 5400.f);\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("LifelineHunterSpawnLocation", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FVector LifelineHunterSpawnLocation"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("LifelineHunterSpawnLocation", locked_only)
    ...
    def test_contract_is_lifeline_hunter_spawn_location_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        for token in leftover_short_roster_values():
            ...
            self.assertNotEqual(token, "LifelineHunterSpawnLocation")
    ...
    def test_sibling_director_fields_do_not_satisfy_lifeline_hunter_spawn_location(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_airfield_target_runtime_does_not_satisfy_lifeline_hunter_spawn_location(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
