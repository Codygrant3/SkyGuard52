...
# Mission10 Integration SynchronizeRuntimeState
...
# SynchronizeRuntimeState #757 / branch
# cursor/mission09-synchronize-
...
# NOT leftover Mission08 SynchronizeRuntimeState
...
# Mission04 SynchronizeRuntimeState, NOT leftover
...
# #757, leftover Mission10 route-phase enum #701a /
...
# drafts #674–#772+, leftover Apache
...
# #757. Do not reopen leftover Mission10 route-
...
class Mission10SynchronizeRuntimeStateDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 SynchronizeRuntimeState method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                REQUIRED_DECL.lower(),
                "mission10 SynchronizeRuntimeState contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_synchronize_runtime_state"
                "_decl_contract.py"
            )
        )
        self.assertIn(
