# THIS IS leftover-safe FSkyguardObjectiveDefinition DisplayName.
...
# drop to BlueprintReadWrite, if type is not FText, if an
# initializer is added, or if Category= is added.
...
# Do NOT contract sibling fields ObjectiveId / Type /
# RequiredProgress / bRequiredForMissionSuccess /
# bFailureEndsMission / ScoreReward.
# THIS IS NOT leftover objective-definition-defaults #181.
...
# DisplayName field decl.
# If a clone asserts float / `= 160.f` /
# Category="Skyguard|Theater", retarget: type is FText,
# no `=`, no Category.
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # ObjectiveId / Type / RequiredProgress fields.
...
class ObjectiveDefinitionDisplayNameFieldDeclContractTests(unittest.TestCase):
    def test_objective_definition_struct_exists(self) -> None:
        ...
        self.assertTrue(has_identifier(section, "DisplayName"), section)
    ...
    def test_neighbor_struct_declaration_does_not_satisfy(self) -> None:
        ...
        self.assertFalse(has_identifier(section, "DisplayName"), section)
        self.assertNotIn(STOP_BEFORE_FORMATION, section)
        self.assertNotIn(STOP_BEFORE_MISSION_DEF, section)
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_initializer_fails_closed_when_origin_is_bare(self) -> None:
        ...
        self.assertNotIn("DisplayName =", compact_origin)
    ...
    def test_does_not_contract_sibling_objective_fields(self) -> None:
        ...
        self.assertTrue(
            has_identifier(section, SIBLING_REQUIRED_FOR_SUCCESS),
            section,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "objective-definition DisplayName field decl contract "
