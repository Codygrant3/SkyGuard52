...
# bProductionLandscapeBound FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bProductionLandscapeBound = false; one-line /
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bProductionLandscapeBound FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# bool bProductionLandscapeBound = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover Mission01 environment-readiness-defaults
...
# FSkyguardMission01EnvironmentReadiness bProductionLandscapeBound
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bProductionLandscapeBound = false;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bProductionLandscapeBound. THIS IS NOT leftover mission-map-
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bProductionLandscapeBound. THIS IS NOT leftover Mission05
...
# Mission01 EnvironmentReadiness bProductionLandscapeBound
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bProductionLandscapeBound = false;
# one-line / split-line UPROPERTY wraps;
...
# bProductionLandscapeBound FIELD (declaration-only). It is
...
TARGET = "bool bProductionLandscapeBound = false;"
TARGET_WRONG = "bool bProductionLandscapeBound = true;"
LOCKED_DECL = TARGET
...
class Mission01EnvironmentReadinessProductionLandscapeBoundFieldDeclContractTests(unittest.TestCase):
    def test_environment_readiness_struct_exists(self) -> None:
        ...
        self.assertIn("bProductionLandscapeBound", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bProductionLandscapeBound", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_production_landscape_bound_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_production_landscape_bound_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bProductionLandscapeBound"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bProductionLandscapeBound", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bProductionLandscapeBound", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bProductionLandscapeBound"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bProductionLandscapeBound", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_production_landscape_bound(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
