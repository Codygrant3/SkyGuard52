...
# INDEX_NONE or lock DebrisEnginePort
...
# DebrisEnginePort;`); accept that form and
...
# DebrisArmorPort, DebrisStrikeBayStarboard,
...
# lock-phase, leftover drafts #56–#64, leftover Harbor
...
# Python DebrisEnginePort field declaration
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardLastFlightBoss::DebrisEnginePort",
    "SkyguardLastFlightBoss.cpp",
    "SetExposed",
...
class LastFlightDebrisEnginePortFieldDeclContractTests(unittest.TestCase):
    def test_last_flight_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, DEBRIS_ENGINE_PORT_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, DEBRIS_ENGINE_PORT_FIELD)
        self.assertIn("DebrisEnginePort", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_missing_debris_engine_port_declaration_fails_closed(
        self,
    ) -> None:
        neighbors_only = (
            "\tASkyguardLastFlightBoss();\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, DEBRIS_ENGINE_PORT_FIELD)
        self.assertIn("DebrisEnginePort", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, DEBRIS_ENGINE_PORT_FIELD)
        self.assertIn("DebrisEnginePort", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UPROPERTY", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("VisibleAnywhere", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("BlueprintReadOnly", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("Category", DEBRIS_ENGINE_PORT_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, DEBRIS_ENGINE_PORT_FIELD)
        self.assertIn("DebrisEnginePort", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUStaticMeshComponent* DebrisEnginePort;\n"
        )
        as_array = (
        ...
        scene = (
            "\tTObjectPtr<USceneComponent> DebrisEnginePort;\n"
        )
        weak = (
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, DEBRIS_ENGINE_PORT_FIELD)
            self.assertIn("DebrisEnginePort", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_debris_engine_port_declaration_matches_origin_main(
        self,
    ) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
        ...
        self.assertEqual(
            declaration_count(section, DEBRIS_ENGINE_PORT_FIELD),
            1,
        )
        self.assertTrue(
            DEBRIS_ENGINE_PORT_FIELD.startswith(
                "TObjectPtr<UStaticMeshComponent> "
            ),
            DEBRIS_ENGINE_PORT_FIELD,
        )
        self.assertTrue(
            DEBRIS_ENGINE_PORT_FIELD.endswith(";"),
            DEBRIS_ENGINE_PORT_FIELD,
        )
        self.assertIn("DebrisEnginePort", DEBRIS_ENGINE_PORT_FIELD)
        self.assertIn(
        ...
        self.assertIn("TObjectPtr<", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("TArray<", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("=", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("INDEX_NONE", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("UFUNCTION", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("{", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("}", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("return ", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn(
            "BeginTerminalStrikeCycle",
            DEBRIS_ENGINE_PORT_FIELD,
        )
        self.assertNotIn("OpenGuidanceArrayExposure", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("IssueClimbCommand", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn(
            "DivertWreckFromCivilians",
            DEBRIS_ENGINE_PORT_FIELD,
        )
        ...
        self.assertNotIn("GetCivilianSeparationMeters", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("GetFinaleStage", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("IsClimbCommandIssued", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("IsWreckDiverted", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn(
            "GetObjectiveMilestonesReached",
            DEBRIS_ENGINE_PORT_FIELD,
        )
        ...
        self.assertNotIn("GetChinMuzzleLocation", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("GetGunnerMount", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("FaceWorldLocation", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("StarboardGuidanceArray", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("CommandCore", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("SetSearchlightTracked", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("SetContactIdentified", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn(
            "SetFriendlySeparationMeters",
            DEBRIS_ENGINE_PORT_FIELD,
        )
        self.assertNotIn("SetLightningExposed", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn(
            "OpenUpperEngineExposure",
            DEBRIS_ENGINE_PORT_FIELD,
        )
        self.assertNotIn("HullCollider", DEBRIS_ENGINE_PORT_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_PORT} {DEBRIS_ENGINE_PORT_FIELD}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{DEBRIS_ENGINE_PORT_FIELD}\n}}\n"
        self.assertTrue(
            has_declaration(one_line, DEBRIS_ENGINE_PORT_FIELD)
        )
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, DEBRIS_ENGINE_PORT_FIELD),
    ...
    def test_assigned_debris_engine_port_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<UStaticMeshComponent> "
            "DebrisEnginePort = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, DEBRIS_ENGINE_PORT_FIELD)
        self.assertIn("DebrisEnginePort", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, DEBRIS_ENGINE_PORT_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        ...
        for region in (
            ...
            self.assertIn("DebrisEnginePort", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, DEBRIS_ENGINE_PORT_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{DEBRIS_ENGINE_PORT_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, DEBRIS_ENGINE_PORT_FIELD)
        ...
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_PORT, section)
        self.assertTrue(has_declaration(section, DEBRIS_ENGINE_PORT_FIELD), section)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            DEBRIS_ENGINE_PORT_FIELD.startswith("UFUNCTION"),
            DEBRIS_ENGINE_PORT_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, DEBRIS_ENGINE_PORT_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", DEBRIS_ENGINE_PORT_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_debris_engine_port_cpp_body(
        self,
    ) -> None:
        locked_only = f"{DEBRIS_ENGINE_PORT_FIELD}\n"
        self.assertNotIn("{", DEBRIS_ENGINE_PORT_FIELD)
        ...
        self.assertNotIn("return false", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("return true", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("CreateDefaultSubobject", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("SetExposed", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            DEBRIS_ENGINE_PORT_FIELD,
        )
        self.assertNotIn("SetBossPhase", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn(
    ...
    def test_contract_does_not_relock_begin_terminal_strike_cycle_sibling(
        ...
        for token in BEGIN_TERMINAL_STRIKE_CYCLE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("BeginTerminalStrikeCycle", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_divert_wreck_from_civilians_sibling(
        ...
        for token in DIVERT_WRECK_FROM_CIVILIANS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("DivertWreckFromCivilians", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_set_civilian_separation_meters_sibling(
        ...
        for token in SET_CIVILIAN_SEPARATION_METERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("SetCivilianSeparationMeters", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_apply_strike(), DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn(leftover_is_lock_eligible(), locked_only)
        self.assertNotIn(leftover_is_lock_eligible(), DEBRIS_ENGINE_PORT_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, locked_only)
            self.assertNotIn(name, DEBRIS_ENGINE_PORT_FIELD)
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_sibling_last_flight_fields(self) -> None:
        ...
        for token in WEAK_POINT_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("PortGuidanceArray", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("StarboardGuidanceArray", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("PortStrikeBayMechanism", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("StarboardStrikeBayMechanism", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("PortCoolingSystem", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("StarboardCoolingSystem", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("CommandCore", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("PortEngine", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("Jammer", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn(
            "USkyguardBossWeakPointComponent",
            DEBRIS_ENGINE_PORT_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_debris_getters(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("GetDefeatDebrisPieceCount", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("GetMaxDefeatDebrisPieces", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_debris_armor_port(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_ARMOR_PORT_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("DebrisArmorPort", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_starboard_engine(self) -> None:
        ...
        for token in LEFTOVER_STARBOARD_ENGINE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("StarboardEngine", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_sibling_debris_fields(
        ...
        for token in LEFTOVER_SIBLING_DEBRIS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("DebrisArmorStarboard", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("DebrisStrikeBayPort", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("DebrisArmorPort", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("DebrisStrikeBayStarboard", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("DebrisEngineStarboard", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("SetSearchlightTracked", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("ASkyguardBlackKiteBoss", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("SetContactIdentified", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("OpenOrbitExposure", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("SetLightningExposed", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("ASkyguardTempestBoss", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_iron_rain(self) -> None:
        ...
        self.assertNotIn("ASkyguardIronRainBoss", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn(
            "ASkyguardIronRainBoss::IssueClimbCommand",
            DEBRIS_ENGINE_PORT_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        for token in LEFTOVER_PATROL_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("ASkyguardPatrolShip", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        ...
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            ...
            self.assertNotIn(neighbor, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("ASkyguardGunner", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("SkyguardRadarNode", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("MaxIntegrity", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("CurrentIntegrity", DEBRIS_ENGINE_PORT_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_open_leftover_weak_point_component_header(
        ...
        self.assertNotIn(leftover_header, DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, DEBRIS_ENGINE_PORT_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{DEBRIS_ENGINE_PORT_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, DEBRIS_ENGINE_PORT_FIELD),
            DEBRIS_ENGINE_PORT_FIELD,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "last flight DebrisEnginePort field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{DEBRIS_ENGINE_PORT_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, DEBRIS_ENGINE_PORT_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                DEBRIS_ENGINE_PORT_FIELD.lower(),
                "last flight DebrisEnginePort contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, DEBRIS_ENGINE_PORT_FIELD)

    def test_contract_is_debris_engine_port_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(DEBRIS_ENGINE_PORT_FIELD.endswith(";"))
        self.assertNotIn("=", DEBRIS_ENGINE_PORT_FIELD)
        self.assertIn(UPROPERTY_PORT, section)
