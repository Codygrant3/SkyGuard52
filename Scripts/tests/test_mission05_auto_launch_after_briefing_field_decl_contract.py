...
# Mission05 bAutoLaunchAfterBriefing FIELD
...
# NOT leftover Mission01 bAutoLaunchAfterBriefing
...
# after-briefing-field-decl-contract-c332, NOT leftover
# sibling Mission05 Root #947 / AudioDirector #948 /
# Briefing #949 / RadioChatter #950 /
# SortiePresentation #951 / CampaignDefinition #952 /
# MissionDefinition / bAutoInitialize /
# bAllowBoundedActorSpawning field drafts, NOT leftover
# Mission05 wave-state enum #ad28 / protected-target
# enum #aaa2 / protected-target-runtime-defaults #ec8b /
# storm-runtime-defaults #89c9, NOT leftover
# Mission05 closed-without-merge #665 #666 #668 #669
# #670 #671 #672 #673, NOT leftover
# Mission04 bAutoInitialize #915 / branch
# cursor/mission04-auto-initialize-field-
# decl-contract-c332, NOT leftover
# Mission04 CampaignDefinition #914, NOT leftover
# Mission04 MissionDefinition #916, NOT leftover
# Mission10 bAutoInitialize field
# #800 / branch cursor/mission10-auto-initialize-
# field-decl-contract-c332, NOT leftover
# Mission02 bAutoInitialize field
# #852 / branch cursor/mission02-auto-initialize-
# field-decl-contract-c332, NOT leftover
# Mission03 auto-initialize FIELD
# / branch cursor/mission03-auto-initialize-
# field-decl-contract-c332, NOT leftover
# Mission03 CampaignDefinition field
# #881 / branch cursor/mission03-campaign-
# definition-field-decl-contract-c332, NOT leftover
# Mission03 MissionDefinition field sibling, NOT leftover
...
# SortiePresentation / CampaignDefinition field
...
# Readiness / bAllowBoundedActorSpawning /
# bAutoInitialize sibling director fields.
...
# Do not parse FSkyguardStormRuntime.
# Parse ASkyguardMission05IntegrationDirector only.
# private, or Mission01-04 / Mission06-10 directors.
...
# bAutoInitialize #580, not leftover Mission10
# bAutoInitialize #800, not leftover Mission01
# MissionDefinition #578, not leftover Mission09
...
# Stay off leftover Mission03 wave-state enum #0242,
# leftover convoy-route-state enum #d34e, leftover
# GetDayBeatKit without UFUNCTION, leftover
# BindRuntimeActors / HandleDroneCityImpact, leftover
# drafts #56-#64, leftover Harbor
...
# drafts #674-#952 including leftover Mission04
# RadioChatter #912, SortiePresentation #913,
# AudioDirector #911, Briefing #910, leftover Apache
...
# Mission02 siblings InitializePlayableMission
# through ValidateMissionContract, leftover
# Mission02 Root / Briefing / AudioDirector /
# RadioChatter / SortiePresentation /
# CampaignDefinition / MissionDefinition, leftover
# Mission01 / Mission02 / Mission04-10 bAutoInitialize /
# auto-initialize field contracts, leftover
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission03IntegrationDirector::bAutoInitialize",
    "ASkyguardMission04IntegrationDirector::bAutoInitialize",
    "SkyguardMission10IntegrationDirector.cpp",
...
class Mission05AutoLaunchAfterBriefingFieldDeclContractTests(unittest.TestCase):
    ...
    def test_readiness_struct_does_not_satisfy_director_field_lock(self) -> None:
        header = origin_main_header()
        match = re.search(
            r"struct\s+FSkyguardMission05IntegrationReadiness\b.*?\{(.*?)\n\};",
            header,
            re.S,
        )
        self.assertIsNotNone(match, header)
        struct_body = match.group(1)
        self.assertFalse(has_declaration(struct_body, LOCKED_DECL))
        self.assertNotIn("bAutoLaunchAfterBriefing", struct_body)
        readiness_only = (
        ...
        with self.assertRaises(AssertionError) as raised:
            public_section(readiness_only)
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        director_readiness_only = (
        ...
        section = public_section(director_readiness_only)
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_launch = f"\t{AUTO_INITIALIZE_FIELD}\n"
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bAutoLaunchAfterBriefing = true;", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 auto-launch-after-briefing field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 auto-launch-after-briefing field contains "
    ...
    def test_contract_is_auto_launch_after_briefing_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tbool bAutoLaunchAfterBriefing = false;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission05_auto_launch_after_briefing_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_auto_launch_after_briefing_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_auto_launch_after_briefing"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission04_audio_director"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_auto_initialize"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_storm_runtime_struct_does_not_satisfy_auto_launch_after_briefing(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_leftover_mission04_auto_launch_after_briefing_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission04IntegrationDirector "
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission04_auto_launch_after_briefing_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
