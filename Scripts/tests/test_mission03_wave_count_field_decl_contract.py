...
# Mission03 IntegrationReadiness WaveCount
...
# leftover Mission02 WaveCount FIELD #871 /
...
# (not ASkyguardMission03IntegrationDirector public
# fields, not leftover GetWaveState(), not leftover
# Mission03 wave-state enum #0242, not leftover
# Mission03 bWavesReady sibling, not leftover
# Mission02 WaveCount FIELD #871).
...
# the Mission03IntegrationDirector public section,
# and the locked FSkyguardMission03IntegrationReadiness
...
class Mission03WaveCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 WaveCount field contract "
