...
# INDEX_NONE or lock GetMissionId
# construction in the .cpp. This is leftover-safe
# Mission08 Integration GetMissionId METHOD
# on ASkyguardMission08IntegrationDirector. It is
# NOT leftover Mission07 GetMissionId
# #727 / branch cursor/mission07-get-mission-id-
# decl-contract-c332, NOT leftover Mission06
# GetMissionId #704 / branch cursor/mission06-get-
# mission-id-decl-contract-c332, NOT leftover
# Mission05 GetMissionId #680 / branch
# cursor/mission05-get-mission-id-decl-contract-
# c332, NOT leftover closed Mission04 GetMissionId
# #663, NOT leftover Mission07
# ValidateMissionContract #728 / Mission06 #707 /
# Mission05 #686, NOT leftover Mission07
# IsCorePlayableReady #715, NOT leftover
# BindRuntimeActors (retired live mount), NOT
# leftover GetReadiness, NOT leftover Mission06
# IsCorePlayableReady #696, NOT leftover Mission05
# IsCorePlayableReady, NOT leftover Mission01 /
# Mission03 / Mission04 IsCorePlayableReady, NOT
# leftover env-readiness #6b9d/#b931, NOT leftover
# Mission08 NotifyThreatDestroyed, NOT leftover
# Mission08 InitializePlayableMission, NOT leftover
# Mission08 StartNextWave, NOT leftover
# BindRuntimeActors (retired live mount in the
# locked decl), NOT leftover retired-mount spawn
# fields / leftover retired-mount spawn, NOT leftover
...
# leftover GetStormRainBeatKit /
# ApplyStormRainPlayContract /
# GetStormRainBeatKind / TickStormRainBeatKit
# without UFUNCTION, NOT leftover Mission07
# GetRemainingThreatsInWave #721, NOT leftover
# Mission07 GetSurvivingTargetCount #725 /
# Mission06 #703 / Mission05 #674, NOT leftover
# Mission07 GetProtectedTarget #723 / Mission05
# #678, NOT leftover Mission07 wave-state enum
# #74d8, NOT leftover Mission07 protected-target
# enum #18f2, NOT leftover Mission07
# protected-target-runtime defaults #866c, NOT
# leftover search-sector enum #b4d4, NOT leftover
# search-track-runtime-defaults #8266, NOT leftover
# GetNightBeatKit / GetNightBeatKind /
# GetNightBeatIndex / TickNightBeatKit without
# UFUNCTION, NOT leftover Mission06 wave-state
# enum #fa65, NOT leftover airfield-target enum
# #14d2, NOT leftover airfield-target-runtime-
# defaults #6ad8, NOT leftover payload-window-
# runtime-defaults #f114, and NOT leftover
...
# ApplyStormRainPlayContract /
# GetStormRainBeatKind / TickStormRainBeatKit
# without UFUNCTION. Do not lock sibling Integration /
# Waves / Hoist / Safety / Protection / Objectives methods
# InitializePlayableMission /
# ConfigureMissionDefinition /
# BindRuntimeActors / StartNextWave /
# AdvanceHoistWindow / StartHoistWindow /
...
# GetHoistRuntime / GetRejectedWeaponReleases /
# GetProtectedTarget / GetSurvivingTargetCount /
# IsCorePlayableReady / ValidateMissionContract. Do not
...
# leftover Mission07 GetMissionId #727,
# leftover Mission06 GetMissionId #704,
# leftover Mission05 GetMissionId #680,
# leftover closed Mission04 GetMissionId #663,
# leftover Mission07 ValidateMissionContract #728,
# leftover Mission06 ValidateMissionContract #707,
# leftover Mission05 ValidateMissionContract #686,
...
# that inline body is the declaration-only
# origin/main form; do not lock a different body.
# Accept that form and other one-line / split-line
# wraps.
# Nearby origin/main
...
# Category is Skyguard|Mission08|Integration, not
...
# Waves #669, not leftover Mission07 Integration #715,
...
# drafts #674–#746, leftover Apache
...
# #658–#673. Do not reopen leftover Mission07
# IsCorePlayableReady #715. Do not reopen leftover
# Mission08 wave-state enum #68fc / #237,
# leftover Mission08 protected-target enum
# #a66a / #229, leftover Mission08
# protected-target-runtime-defaults #75e6 / #226,
# leftover hoist-window-runtime-defaults #ec79.
# Do not reopen leftover BindRuntimeActors
# (takes retired live-mount pointer) / leftover retired
# spawn / HandleDroneCityImpact. Do not reopen
# leftover GetStormRainBeatKit /
# ApplyStormRainPlayContract /
# GetStormRainBeatKind / TickStormRainBeatKit
# without UFUNCTION. Do not reopen leftover
# Mission07 GetRemainingThreatsInWave #721.
# Do not reopen leftover Mission07
# GetSurvivingTargetCount #725 / Mission06 #703
# / Mission05 #674. Do not reopen leftover
# Mission07 GetProtectedTarget #723 / Mission05
# #678. Do not reopen leftover drafts #56–#64,
# leftover drafts #107–#673, leftover #664,
# closed-without-merge #658–#673. Do not reopen
# open drafts #674–#746.
...
# an isolated Python GetMissionId
...
LEFTOVER_MISSION03_INITIALIZE_NOT_LOCKED = (
    ...
    'Category="Skyguard|Mission08|Harbor"',
)
...
LEFTOVER_MISSION07_VALIDATE_MISSION_CONTRACT_NOT_LOCKED = (
    "test_mission07_validate_mission_contract_decl_contract.py",
    VALIDATE_MISSION_CONTRACT,
    "ValidateMissionContract",
    'Category="Skyguard|Mission07|Integration"',
)
LEFTOVER_MISSION06_VALIDATE_MISSION_CONTRACT_NOT_LOCKED = (
    "test_mission06_validate_mission_contract_decl_contract.py",
    VALIDATE_MISSION_CONTRACT,
    "ValidateMissionContract",
    'Category="Skyguard|Mission06|Integration"',
)
LEFTOVER_MISSION05_VALIDATE_MISSION_CONTRACT_NOT_LOCKED = (
    "test_mission05_validate_mission_contract_decl_contract.py",
    VALIDATE_MISSION_CONTRACT,
    "ValidateMissionContract",
    'Category="Skyguard|Mission05|Integration"',
)

class Mission08GetMissionIdDeclContractTests(unittest.TestCase):
    def test_mission08_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, GET_MISSION_ID),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, GET_MISSION_ID)
    ...
    def test_missing_get_mission_id_declaration_fails_closed(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, GET_MISSION_ID)
        self.assertIn("GetMissionId", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, GET_MISSION_ID)
        self.assertIn("GetMissionId", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", GET_MISSION_ID)
        self.assertNotIn("BlueprintPure", GET_MISSION_ID)
        self.assertNotIn("Category", GET_MISSION_ID)
        self.assertNotIn("BlueprintCallable", UFUNCTION_INTEGRATION)
        self.assertIn("Skyguard|Mission08|Integration", UFUNCTION_INTEGRATION)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, GET_MISSION_ID)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, GET_MISSION_ID)
        self.assertIn("GetMissionId", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_mission_id = f"\t{IS_CORE_PLAYABLE_READY}\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, GET_MISSION_ID)
            self.assertIn("GetMissionId", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_get_mission_id_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(has_declaration(section, GET_MISSION_ID))
        self.assertEqual(
            declaration_count(section, GET_MISSION_ID),
            1,
        )
        self.assertTrue(
            GET_MISSION_ID.startswith("static FName"),
            GET_MISSION_ID,
        )
        self.assertTrue(
            GET_MISSION_ID.endswith("}"),
            GET_MISSION_ID,
        )
        self.assertIn("GetMissionId", GET_MISSION_ID)
        self.assertIn("GetMissionId(", GET_MISSION_ID)
        self.assertIn(
        ...
        self.assertNotIn("TArray<", GET_MISSION_ID)
        self.assertNotIn("TObjectPtr", GET_MISSION_ID)
        self.assertNotIn("TSoftObjectPtr", GET_MISSION_ID)
        self.assertNotIn("INDEX_NONE", GET_MISSION_ID)
        self.assertNotIn("UFUNCTION", GET_MISSION_ID)
        self.assertIn("{", GET_MISSION_ID)
        self.assertIn("}", GET_MISSION_ID)
        self.assertIn("return ", GET_MISSION_ID)
        self.assertNotIn(" const;", GET_MISSION_ID)
        self.assertNotIn(" const", GET_MISSION_ID)
        self.assertNotIn("Root", GET_MISSION_ID)
        self.assertNotIn("Briefing", GET_MISSION_ID)
        self.assertNotIn("AudioDirector", GET_MISSION_ID)
        self.assertNotIn("RadioChatter", GET_MISSION_ID)
        self.assertNotIn("SortiePresentation", GET_MISSION_ID)
        self.assertNotIn("CampaignDefinition", GET_MISSION_ID)
        self.assertNotIn("MissionDefinition", GET_MISSION_ID)
        self.assertNotIn("Readiness", GET_MISSION_ID)
        self.assertNotIn("bAutoInitialize", GET_MISSION_ID)
        self.assertNotIn("bAllowBoundedActorSpawning", GET_MISSION_ID)
        self.assertNotIn("bAutoLaunchAfterBriefing", GET_MISSION_ID)
        self.assertNotIn("PathfinderSpawnLocation", GET_MISSION_ID)
        self.assertNotIn("GetAircraft", GET_MISSION_ID)
        self.assertNotIn("BindRuntimeActors", GET_MISSION_ID)
        self.assertNotIn("HandleDroneCityImpact", GET_MISSION_ID)
        self.assertNotIn("InitializePlayableMission", GET_MISSION_ID)
        self.assertNotIn("StartNextWave", GET_MISSION_ID)
        self.assertNotIn("AdvanceConvoyByDistance", GET_MISSION_ID)
        self.assertNotIn("NotifyConvoyDamage", GET_MISSION_ID)
        self.assertNotIn("GetWaveState", GET_MISSION_ID)
        self.assertNotIn("GetConvoyRouteState", GET_MISSION_ID)
        self.assertNotIn("GetDayBeatKit", GET_MISSION_ID)
        self.assertNotIn("GetNightBeatKit", GET_MISSION_ID)
        self.assertNotIn("StartSearchlightWindow", GET_MISSION_ID)
        self.assertNotIn("AdvanceSearchlightTrack", GET_MISSION_ID)
        self.assertNotIn("NotifySubstationDamage", GET_MISSION_ID)
        self.assertNotIn("GetRemainingThreatsInWave", GET_MISSION_ID)
        self.assertNotIn("GetSearchlightRuntime", GET_MISSION_ID)
        self.assertNotIn("GetSubstationIntegrity", GET_MISSION_ID)
        self.assertNotIn("StartPayloadWindow", GET_MISSION_ID)
        self.assertNotIn("AdvancePayloadWindow", GET_MISSION_ID)
        self.assertNotIn("TryJamActivePayload", GET_MISSION_ID)
        self.assertNotIn("NotifyAirfieldTargetDamage", GET_MISSION_ID)
        self.assertNotIn("GetPayloadWindow", GET_MISSION_ID)
        self.assertNotIn("GetTargetRuntime", GET_MISSION_ID)
        self.assertNotIn("GetSurvivingTargetCount", GET_MISSION_ID)
        self.assertNotIn("GetDayBeatKind", GET_MISSION_ID)
        self.assertNotIn("GetDayBeatIndex", GET_MISSION_ID)
        self.assertNotIn("TickDayBeatKit", GET_MISSION_ID)
        self.assertNotIn("HandleBossPhaseChanged", GET_MISSION_ID)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", GET_MISSION_ID)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", GET_MISSION_ID)
        self.assertNotIn("ASkyguardMission06IntegrationDirector", GET_MISSION_ID)
        self.assertNotIn("ESkyguardMission06WaveState", GET_MISSION_ID)
        self.assertNotIn("ESkyguardMission07WaveState", GET_MISSION_ID)
        self.assertNotIn("ESkyguardMission07ProtectedTarget", GET_MISSION_ID)
        self.assertNotIn("FSkyguardMission07ProtectedTargetRuntime", GET_MISSION_ID)
        self.assertNotIn("ESkyguardSearchSector", GET_MISSION_ID)
        self.assertNotIn("FSkyguardSearchTrackRuntime", GET_MISSION_ID)
        self.assertNotIn("ClassifyFalseTrack", GET_MISSION_ID)
        self.assertNotIn("ConfirmRadarGhostIdentification", GET_MISSION_ID)
        self.assertNotIn("NotifyProtectedTargetDamage", GET_MISSION_ID)
        self.assertNotIn("AdvanceReinforcementTimer", GET_MISSION_ID)
        self.assertNotIn("GetSearchSector", GET_MISSION_ID)
        self.assertNotIn("GetClassifiedFalseTrackCount", GET_MISSION_ID)
        self.assertNotIn("IsHostileContactConfirmed", GET_MISSION_ID)
        self.assertNotIn("GetProtectedTarget", GET_MISSION_ID)
        self.assertNotIn("GetReinforcementTimeRemaining", GET_MISSION_ID)
        self.assertNotIn("GetNightBeatKind", GET_MISSION_ID)
        self.assertNotIn("GetNightBeatIndex", GET_MISSION_ID)
        self.assertNotIn("TickNightBeatKit", GET_MISSION_ID)
        self.assertNotIn("ESkyguardAirfieldTarget", GET_MISSION_ID)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", GET_MISSION_ID)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", GET_MISSION_ID)
        self.assertNotIn("ConvoyRuntimeAnchor", GET_MISSION_ID)
        self.assertNotIn("RoadHunterSpawnLocation", GET_MISSION_ID)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", GET_MISSION_ID)
        self.assertNotIn("ASkyguardMission02IntegrationDirector", GET_MISSION_ID)
        self.assertNotIn("ConfigureMissionDefinition", GET_MISSION_ID)
        self.assertNotIn("NotifyObjectiveProgress", GET_MISSION_ID)
        self.assertNotIn("NotifyProtectedAssetFailed", GET_MISSION_ID)
        self.assertNotIn("SynchronizeRuntimeState", GET_MISSION_ID)
        self.assertNotIn("NotifyThreatDestroyed", GET_MISSION_ID)
        self.assertNotIn("GetReadiness", GET_MISSION_ID)
        self.assertNotIn("GetObjectiveRuntime", GET_MISSION_ID)
        self.assertNotIn("GetGunner", GET_MISSION_ID)
        self.assertNotIn("GetPathfinder", GET_MISSION_ID)
        self.assertNotIn("IsCorePlayableReady", GET_MISSION_ID)
        self.assertNotIn("ValidateMissionContract", GET_MISSION_ID)
        self.assertNotIn("ConfigureFromMission", GET_MISSION_ID)
        self.assertNotIn("AdvanceBriefing", GET_MISSION_ID)
        self.assertNotIn("SetAssetsReady", GET_MISSION_ID)
        self.assertNotIn("AcknowledgeAndLaunch", GET_MISSION_ID)
        self.assertNotIn("CanLaunch", GET_MISSION_ID)
        self.assertNotIn("GetElapsedSeconds", GET_MISSION_ID)
        self.assertNotIn("GetBriefingState", GET_MISSION_ID)
        self.assertNotIn("GetMinimumWarmupSeconds", GET_MISSION_ID)
        self.assertNotIn("GetBriefingText", GET_MISSION_ID)
        self.assertNotIn("GetRadioChatter", GET_MISSION_ID)
        self.assertNotIn("GetPresentation", GET_MISSION_ID)
        self.assertNotIn("GetMissionTitle", GET_MISSION_ID)
        self.assertNotIn("AcknowledgeBriefing", GET_MISSION_ID)
        self.assertNotIn("LaunchSortie", GET_MISSION_ID)
        self.assertNotIn("HullCollider", GET_MISSION_ID)
        self.assertNotIn("OpticalTracker", GET_MISSION_ID)
        self.assertNotIn("WeaponServo", GET_MISSION_ID)
        self.assertNotIn("CountermeasurePod", GET_MISSION_ID)
        self.assertNotIn("MinHeightFromOriginCm", GET_MISSION_ID)
        self.assertNotIn("RadarNode", GET_MISSION_ID)
        self.assertNotIn("ESkyguardMission02WaveState", GET_MISSION_ID)
        self.assertNotIn("HarborIndustrial", GET_MISSION_ID)
        self.assertNotIn("MaxIntegrity", GET_MISSION_ID)
        self.assertNotIn("CurrentIntegrity", GET_MISSION_ID)
        self.assertNotIn("FillAndFinalize", GET_MISSION_ID)
        self.assertNotIn("FillAndFail", GET_MISSION_ID)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, GET_MISSION_ID)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_INTEGRATION} {GET_MISSION_ID}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{GET_MISSION_ID}\n}}\n"
        self.assertTrue(has_declaration(one_line, GET_MISSION_ID))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, GET_MISSION_ID),
            section,
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", GET_MISSION_ID)
        section = public_section(origin_main_header())
    ...
    def test_contract_does_not_lock_get_mission_id_cpp_body(self) -> None:
        ...
        self.assertIn("}", GET_MISSION_ID)
        self.assertIn("return ", GET_MISSION_ID)
        self.assertIn('TEXT("M08_RescueCover")', GET_MISSION_ID)
        self.assertNotIn(
            "ASkyguardMission08IntegrationDirector::GetMissionId",
            GET_MISSION_ID,
        )
        ...
        self.assertNotIn("return false", GET_MISSION_ID)
        self.assertNotIn("return true", GET_MISSION_ID)
        self.assertNotIn("INDEX_NONE", GET_MISSION_ID)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            ...
            self.assertNotIn(token, GET_MISSION_ID)
        self.assertIn("GetMissionId", GET_MISSION_ID)
        self.assertTrue(GET_MISSION_ID.startswith("static FName"))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, GET_MISSION_ID)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, GET_MISSION_ID)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", GET_MISSION_ID)
        self.assertNotIn("CurrentIntegrity", GET_MISSION_ID)
        self.assertNotIn("SkyguardApacheAircraft.h", GET_MISSION_ID)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, GET_MISSION_ID)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", GET_MISSION_ID)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{GET_MISSION_ID}\n"
        self.assertEqual(
            require_declaration(locked_only, GET_MISSION_ID),
            GET_MISSION_ID,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_MISSION_ID)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", GET_MISSION_ID)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", GET_MISSION_ID)
        self.assertNotIn("ASkyguardIronRainBoss", section)
        self.assertNotIn("ASkyguardRadarGhostBoss", GET_MISSION_ID)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 GetMissionId method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{GET_MISSION_ID}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, GET_MISSION_ID.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                GET_MISSION_ID.lower(),
                "mission08 IsCorePlayableReady contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, GET_MISSION_ID)
    ...
    def test_contract_is_get_mission_id_declaration_only(
        ...
        self.assertTrue(GET_MISSION_ID.startswith("static FName"))
        self.assertIn("GetMissionId", GET_MISSION_ID)
        self.assertTrue(GET_MISSION_ID.endswith("}"))
        self.assertIn('TEXT("M08_RescueCover")', GET_MISSION_ID)
        self.assertIn(UFUNCTION_INTEGRATION, section)
    ...
    def test_sibling_director_fields_do_not_satisfy_get_mission_id(
        ...
        for leftover in (
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, GET_MISSION_ID)
            )
            self.assertNotEqual(GET_MISSION_ID, leftover)
        self.assertIn(
    ...
    def test_leftover_handle_drone_city_impact_does_not_satisfy(self) -> None:
        ...
        self.assertIn("GetMissionId", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, GET_MISSION_ID))
        locked_only = f"{GET_MISSION_ID}\n"
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        self.assertNotIn("return false", GET_MISSION_ID)
        self.assertNotIn("return true", GET_MISSION_ID)
        self.assertNotIn("M07_SearchIntercept", GET_MISSION_ID)
        self.assertNotIn("M06_AirfieldDefense", GET_MISSION_ID)
        self.assertNotIn("M05_StormFront", GET_MISSION_ID)
        self.assertNotIn("M04_NightBlackout", GET_MISSION_ID)
    ...
    def test_locked_scripts_keep_leftover_mission07_is_core_playable_ready(
        self,
    ) -> None:
        this_script = (
        ...
        self.assertIn(leftover_m07, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_get_mission_id"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission08_wave_state_enum(
        ...
        self.assertNotIn("ESkyguardMission08WaveState", GET_MISSION_ID)
    ...
    def test_sibling_mission08_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("GetReadiness", GET_MISSION_ID)
        self.assertNotIn("GetObjectiveRuntime", GET_MISSION_ID)
        self.assertNotIn("ValidateWeaponRelease", GET_MISSION_ID)


    def test_contract_does_not_relock_leftover_mission07_get_mission_id(
        self,
    ) -> None:
        locked_only = f"{GET_MISSION_ID}\n"
        for token in LEFTOVER_MISSION07_GET_MISSION_ID_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_MISSION_ID)
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission06_get_mission_id(
        self,
    ) -> None:
        locked_only = f"{GET_MISSION_ID}\n"
        for token in LEFTOVER_MISSION06_GET_MISSION_ID_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_MISSION_ID)
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission05_get_mission_id(
        self,
    ) -> None:
        locked_only = f"{GET_MISSION_ID}\n"
        for token in LEFTOVER_MISSION05_GET_MISSION_ID_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_MISSION_ID)
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission04_get_mission_id(
        self,
    ) -> None:
        locked_only = f"{GET_MISSION_ID}\n"
        for token in LEFTOVER_MISSION04_GET_MISSION_ID_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_MISSION_ID)
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_validate_mission_contract(
        self,
    ) -> None:
        locked_only = f"{GET_MISSION_ID}\n"
        for group in (
    ...
    def test_locked_scripts_list_sibling_mission08_contracts(self) -> None:
        sibling_scripts = (
            "Scripts/tests/test_mission08_initialize_playable_mission"
            "_decl_contract.py",
            ...
            "_decl_contract.py",
            "Scripts/tests/test_mission08_get_surviving_target_count"
            "_decl_contract.py",
            "Scripts/tests/test_mission08_validate_mission_contract"
            "_decl_contract.py",
        )
        for script in sibling_scripts:
        ...
        self.assertNotIn("ConfigureMissionDefinition", GET_MISSION_ID)
        self.assertNotIn("StartNextWave", GET_MISSION_ID)
        self.assertNotIn("StartHoistWindow", GET_MISSION_ID)
        self.assertNotIn("NotifyThreatDestroyed", GET_MISSION_ID)
        self.assertNotIn("AdvanceHoistWindow", GET_MISSION_ID)
        self.assertNotIn("ValidateWeaponRelease", GET_MISSION_ID)
        self.assertNotIn("NotifyProtectedTargetDamage", GET_MISSION_ID)
        self.assertNotIn("NotifyProtectedAssetFailed", GET_MISSION_ID)
        self.assertNotIn("SynchronizeRuntimeState", GET_MISSION_ID)
        ...
        self.assertNotIn("GetWaveState", GET_MISSION_ID)
        self.assertNotIn("GetRemainingThreatsInWave", GET_MISSION_ID)
        self.assertNotIn("GetHoistRuntime", GET_MISSION_ID)
        self.assertNotIn("GetRejectedWeaponReleases", GET_MISSION_ID)
        self.assertNotIn("GetProtectedTarget", GET_MISSION_ID)
        self.assertNotIn("GetSurvivingTargetCount", GET_MISSION_ID)
        self.assertNotIn("ValidateMissionContract", GET_MISSION_ID)
