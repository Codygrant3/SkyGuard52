...
# Mission02 IntegrationReadiness bSortiePresentationReady
...
# FIELD #820 / branch cursor/mission10-sortie-
# presentation-ready-field-decl-contract-c332,
# leftover Mission01 SortiePresentation field
# #575, leftover Mission02 SortiePresentation
# director field #849, leftover Mission10
# SortiePresentation #797, leftover Mission10
# bBriefingReady #819 / leftover Mission10
# bAudioReady #821, leftover sortie-
# presentation-state enum #6c40, leftover
# sortie-presentation fail-closed #7600,
# leftover director Readiness #860, leftover
# Mission02 GetReadiness #837, leftover
# Mission01 Readiness #579, leftover Mission10
# Readiness #809, leftover retired-mount
# runtime-ready sibling, leftover Mission02
# wave-state enum, leftover Mission10 route-
# phase enum #701a, leftover Mission10
# protected-group enum #6f9d, leftover
# Mission10 protected-runtime-defaults #7898,
# leftover Mission02 gunner-ready / breakwater-
# ready / objectives-ready / waves-ready
# sibling fields,
# NOT leftover Mission10 bSortiePresentationReady FIELD #820 /
# branch cursor/mission10-sortie-presentation-ready-field-decl-
...
# drafts #674-#861 including leftover Mission10
# bSortiePresentationReady #820, leftover Apache
...
# drafts #674-#861 including leftover Mission10
# bSortiePresentationReady #820 and leftover Mission02
# siblings #828-#859.
...
LEFTOVER_SORTIE_PRESENTATION_STATE_ENUM_NOT_LOCKED = (
    "test_sortie_presentation_state_enum_contract.py",
    "cursor/sortie-presentation-state-enum-6c40",
...
LEFTOVER_SORTIE_PRESENTATION_FAIL_CLOSED_NOT_LOCKED = (
    ...
    "cursor/sortie-presentation-fail-closed-7600",
)
...
class Mission02SortiePresentationReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        # This Mission02 field default false is not Harbor 40/80.
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 bSortiePresentationReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 bSortiePresentationReady contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_sortie_presentation_ready"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_sortie_presentation_fail"
            "_closed.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
