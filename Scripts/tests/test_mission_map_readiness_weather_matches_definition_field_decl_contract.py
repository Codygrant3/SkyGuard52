...
# bWeatherMatchesDefinition FIELD (declaration-only;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe MissionMapReadiness
# bWeatherMatchesDefinition. THIS IS NOT leftover mission-map-
...
# in-flight bRouteMatchesDefinition /
# in-flight bLandmarksDistinct. LOCK those
...
# merge #665 #666 #668-#673, or open drafts #674-#1157.
...
# drafts #674-#1157 including leftover Mission02
...
# drafts #674-#1157. Do not reopen leftover
...
TARGET = "bool bWeatherMatchesDefinition = false;"
TARGET_WRONG = "bool bWeatherMatchesDefinition = true;"
LOCKED_DECL = TARGET
...
class MissionMapReadinessWeatherMatchesDefinitionFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bWeatherMatchesDefinition", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_weather_matches_definition_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_weather_matches_definition_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bWeatherMatchesDefinition"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bWeatherMatchesDefinition", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
			"\tbool\n"
            "\tbWeatherMatchesDefinition = false;\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bWeatherMatchesDefinition", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bWeatherMatchesDefinition"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bWeatherMatchesDefinition", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_weather_matches_definition(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission_map_readiness_weather"
                "_matches_definition_field_decl_contract.py"
            )
        )
        self.assertIn(
