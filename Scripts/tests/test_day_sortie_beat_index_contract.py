...
# Isolated-test drafts stay off this lane. On-main BrokenHighway()
...
class DaySortieBeatIndexContractTests(unittest.TestCase):
    ...
    def test_contract_does_not_relock_kind_at(self) -> None:
        ...
        self.assertNotIn("ESkyguardDaySortieBeatKind KindAt(", (BEAT_INDEX,))
    ...
    def test_contract_parses_namespace_not_struct_or_enum(self) -> None:
        ...
        body = namespace_body(header)
        self.assertIn(f"namespace {NAMESPACE_NAME}", header)
        self.assertIn(f"struct FSkyguardDaySortieBeatKit", header)
        self.assertIn(f"enum class ESkyguardDaySortieBeatKind", header)
        self.assertNotIn("enum class ESkyguardDaySortieBeatKind", body)
        self.assertNotIn("struct FSkyguardDaySortieBeat", body)
        self.assertNotIn("struct FSkyguardDaySortieBeatKit", body)
        self.assertIn(BEAT_INDEX, body)
    ...
    def test_contract_does_not_read_cpp_or_elapsed_tables(self) -> None:
        ...
        self.assertNotIn("SkyguardDaySortieBeatKit::BeatIndexForElapsed", body)
    ...
    def test_declaration_bans_igla_yak_rifle(self) -> None:
        ...
        for banned in BANNED:
            self.assertNotIn(
                banned,
                lowered,
                f"day-sortie BeatIndexForElapsed contains {banned}; "
