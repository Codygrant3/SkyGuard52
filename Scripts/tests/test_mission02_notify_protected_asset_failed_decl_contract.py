...
# INDEX_NONE or lock NotifyProtectedAssetFailed
# construction in the .cpp. This is leftover-safe
# Mission02 Objectives NotifyProtectedAssetFailed
# METHOD on ASkyguardMission02IntegrationDirector. It is
# NOT leftover Mission10 StartPhaseWave
# #768 / branch cursor/mission10-initialize-
# playable-mission-decl-contract-c332, NOT leftover
# Mission09 InitializePlayableMission
# #751 / branch cursor/mission09-initialize-
# playable-mission-decl-contract-c332, NOT leftover
# Mission08 InitializePlayableMission
# #729 / branch cursor/mission08-initialize-
# playable-mission-decl-contract-c332, NOT leftover
# Mission07 InitializePlayableMission #706,
# NOT leftover Mission06 InitializePlayableMission
# #685, NOT leftover Mission05 InitializePlayableMission
# #666, NOT leftover Mission01 / Mission03 /
# Mission04 InitializePlayableMission, NOT leftover
...
# leftover Harbor #6/#8/#9 / leftover merged Mission02 C++ bundle #102, NOT
...
# BindRuntimeActors / InitializePlayableMission /
...
# (`bool NotifyProtectedAssetFailed();`); accept that
...
# Category is Skyguard|Mission02|Objectives, not
# Mission01 / Mission10 / Mission03 / Mission04 /
# Mission05 / Mission06 / Mission07 / Integration / Search /
# Protection / Payload / Targets / Waves /
...
# drafts #674–#827+, leftover Apache
...
# StartNextWave #731. Do not reopen leftover
# Mission09 StartNextWave #753. Do not reopen
# leftover Mission02 InitializePlayableMission
# (in-flight sibling). Do not reopen leftover
# Mission10 StartPhaseWave. Do not reopen leftover
# Mission10 route-
...
# leftover Mission01 #612 / Mission03 #634 / Mission04
# #655 / Mission05 #682 / Mission06–#10 same-name
# NotifyProtectedAssetFailed drafts. Do not reopen
# leftover Mission02 InitializePlayableMission #828 /
# ConfigureMissionDefinition / StartNextWave /
# NotifyThreatDestroyed siblings. Do not reopen
# leftover merged Mission02 C++ bundle #102. Do not
# reopen open drafts #674–#830+.
INITIALIZE_PLAYABLE_MISSION = "bool InitializePlayableMission();"
UFUNCTION_OBJECTIVES = (
    "UFUNCTION(BlueprintCallable, "
    'Category="Skyguard|Mission02|Objectives")'
)
...
# an isolated Python StartNextWave
...
# #608, leftover Mission03 InitializePlayableMission
# #628, leftover Harbor #6/#8/#9, leftover
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission01_start_next_wave_decl_contract.py",
...
LEFTOVER_MISSION03_INITIALIZE_NOT_LOCKED = (
    ...
    'Category="Skyguard|Mission05|Objectives"',
...
LEFTOVER_MISSION01_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED = (
    "test_mission01_notify_protected_asset_failed_decl_contract.py",
    "ASkyguardMission01IntegrationDirector",
    "SkyguardMission01IntegrationDirector.h",
    'Category="Skyguard|Mission01|Objectives"',
)
LEFTOVER_MISSION02_INITIALIZE_NOT_LOCKED = (
    "test_mission02_initialize_playable_mission_decl_contract.py",
    INITIALIZE_PLAYABLE_MISSION,
    "InitializePlayableMission",
    'Category="Skyguard|Mission02|Integration"',
    "cursor/mission02-initialize-playable-mission-decl-contract-c332",
)

LEFTOVER_MISSION02_CONFIGURE_NOT_LOCKED = (
    "test_mission02_configure_mission_definition_decl_contract.py",
    CONFIGURE_MISSION_DEFINITION,
    "ConfigureMissionDefinition",
    'Category="Skyguard|Mission02|Integration"',
    "cursor/mission02-configure-mission-definition-decl-contract-c332",
)
LEFTOVER_MISSION02_START_NEXT_WAVE_NOT_LOCKED = (
    "test_mission02_start_next_wave_decl_contract.py",
    START_NEXT_WAVE,
    "StartNextWave",
    'Category="Skyguard|Mission02|Waves"',
    "cursor/mission02-start-next-wave-decl-contract-c332",
)
LEFTOVER_MISSION02_NOTIFY_THREAT_DESTROYED_NOT_LOCKED = (
    "test_mission02_notify_threat_destroyed_decl_contract.py",
    NOTIFY_THREAT_DESTROYED,
    "NotifyThreatDestroyed",
    'Category="Skyguard|Mission02|Waves"',
)
LEFTOVER_MISSION10_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED = (
    "test_mission10_notify_protected_asset_failed_decl_contract.py",
    "ASkyguardMission10IntegrationDirector",
    "SkyguardMission10IntegrationDirector.h",
    'Category="Skyguard|Mission10|Objectives"',
    "cursor/mission10-notify-protected-asset-failed-decl-contract-c332",
)
LEFTOVER_MISSION03_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED = (
    "test_mission03_notify_protected_asset_failed_decl_contract.py",
    "ASkyguardMission03IntegrationDirector",
    "SkyguardMission03IntegrationDirector.h",
    'Category="Skyguard|Mission03|Objectives"',
)
LEFTOVER_MISSION04_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED = (
    "test_mission04_notify_protected_asset_failed_decl_contract.py",
    "ASkyguardMission04IntegrationDirector",
    "SkyguardMission04IntegrationDirector.h",
    'Category="Skyguard|Mission04|Objectives"',
)
LEFTOVER_MISSION05_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED = (
    "test_mission05_notify_protected_asset_failed_decl_contract.py",
    "ASkyguardMission05IntegrationDirector",
    "SkyguardMission05IntegrationDirector.h",
    'Category="Skyguard|Mission05|Objectives"',
    "cursor/mission05-notify-protected-asset-failed-decl-contract-c332",
)
LEFTOVER_MISSION06_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED = (
    "test_mission06_notify_protected_asset_failed_decl_contract.py",
    "ASkyguardMission06IntegrationDirector",
    "SkyguardMission06IntegrationDirector.h",
    'Category="Skyguard|Mission06|Objectives"',
)
LEFTOVER_MISSION07_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED = (
    "test_mission07_notify_protected_asset_failed_decl_contract.py",
    "ASkyguardMission07IntegrationDirector",
    "SkyguardMission07IntegrationDirector.h",
    'Category="Skyguard|Mission07|Objectives"',
)
LEFTOVER_MISSION08_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED = (
    "test_mission08_notify_protected_asset_failed_decl_contract.py",
    "ASkyguardMission08IntegrationDirector",
    "SkyguardMission08IntegrationDirector.h",
    'Category="Skyguard|Mission08|Objectives"',
    "cursor/mission08-notify-protected-asset-failed-decl-contract-c332",
)
LEFTOVER_MISSION09_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED = (
    "test_mission09_notify_protected_asset_failed_decl_contract.py",
    "ASkyguardMission09IntegrationDirector",
    "SkyguardMission09IntegrationDirector.h",
    'Category="Skyguard|Mission09|Objectives"',
    "cursor/mission09-notify-protected-asset-failed-decl-contract-c332",
)
LEFTOVER_MISSION10_START_PHASE_WAVE_NOT_LOCKED = (
    "test_mission10_start_phase_wave_decl_contract.py",
    START_PHASE_WAVE,
    "StartPhaseWave",
    'Category="Skyguard|Mission10|Waves"',
    "cursor/mission10-start-phase-wave-decl-contract-c332",
)
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission02IntegrationDirector::NotifyProtectedAssetFailed",
    "SkyguardMission02IntegrationDirector.cpp",
    "ASkyguardMission02IntegrationDirector::InitializePlayableMission",
    "ASkyguardMission10IntegrationDirector::InitializePlayableMission",
    "SkyguardMission10IntegrationDirector.cpp",
    "SkyguardMission09IntegrationDirector.cpp",
    "SkyguardMission08IntegrationDirector.cpp",
    "SkyguardMission06IntegrationDirector.cpp",
...
class Mission02NotifyProtectedAssetFailedDeclContractTests(unittest.TestCase):
    def test_mission02_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, NOTIFY_PROTECTED_ASSET_FAILED),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn("NotifyProtectedAssetFailed", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_missing_notify_protected_asset_failed_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission02IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn("NotifyProtectedAssetFailed", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))

    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        macro_only = f"\t{UFUNCTION_OBJECTIVES}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn("NotifyProtectedAssetFailed", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        section = public_section(origin_main_header())
        self.assertIn(UFUNCTION_OBJECTIVES, section)
        ...
        self.assertNotIn("UFUNCTION", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("BlueprintCallable", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("Category", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("BlueprintPure", UFUNCTION_OBJECTIVES)
        self.assertIn("Skyguard|Mission02|Objectives", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission01", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission03", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission04", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission05", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission06", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Integration", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Search", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Protection", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Payload", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Targets", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Waves", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission07", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission08", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Hoist", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Performance", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Safety", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Rescue", UFUNCTION_OBJECTIVES)
        self.assertIn("BlueprintCallable", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Environment", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Briefing", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission10", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Boss", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Destruction", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Apache", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission06", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission07", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission09", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Evacuation", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Campaign", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Encounter", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Safety", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Hoist", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Rescue", UFUNCTION_OBJECTIVES)
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, UFUNCTION_OBJECTIVES)
            self.assertNotIn(invented, NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn("NotifyProtectedAssetFailed", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = "\tvoid NotifyProtectedAssetFailed();\n"
        as_const = "\tbool NotifyProtectedAssetFailed() const;\n"
        with_arg = "\tbool NotifyProtectedAssetFailed(bool bForce);\n"
        renamed = "\tbool InitializePlayable();\n"
        short_name = "\tbool InitializeMission();\n"
        leftover_configure = f"\t{CONFIGURE_MISSION_DEFINITION}\n"
        leftover_notify = f"\t{NOTIFY_OBJECTIVE_PROGRESS}\n"
        leftover_failed = f"\t{START_NEXT_WAVE}\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, NOTIFY_PROTECTED_ASSET_FAILED)
            self.assertIn("NotifyProtectedAssetFailed", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_notify_protected_asset_failed_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, NOTIFY_PROTECTED_ASSET_FAILED),
            NOTIFY_PROTECTED_ASSET_FAILED,
        )
        self.assertTrue(has_declaration(section, NOTIFY_PROTECTED_ASSET_FAILED))
        self.assertEqual(
            declaration_count(section, NOTIFY_PROTECTED_ASSET_FAILED),
            1,
        )
        self.assertTrue(
            NOTIFY_PROTECTED_ASSET_FAILED.startswith("bool "),
            NOTIFY_PROTECTED_ASSET_FAILED,
        )
        self.assertTrue(
            NOTIFY_PROTECTED_ASSET_FAILED.endswith(";"),
            NOTIFY_PROTECTED_ASSET_FAILED,
        )
        self.assertIn("NotifyProtectedAssetFailed", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn("()", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("TArray<", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("TObjectPtr", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("TSoftObjectPtr", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("INDEX_NONE", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("UFUNCTION", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("{", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("}", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("return ", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("const;", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("Root", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("Briefing", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("AudioDirector", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("RadioChatter", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("SortiePresentation", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("CampaignDefinition", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("MissionDefinition", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("Readiness", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("bAutoInitialize", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("bAllowBoundedActorSpawning", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("bAutoLaunchAfterBriefing", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("PathfinderSpawnLocation", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetAircraft", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("BindRuntimeActors", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("HandleDroneCityImpact", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("InitializePlayableMission", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("NotifyThreatDestroyed", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("AdvanceConvoyByDistance", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("NotifyConvoyDamage", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetWaveState", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetConvoyRouteState", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetDayBeatKit", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetNightBeatKit", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("StartSearchlightWindow", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("AdvanceSearchlightTrack", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("NotifySubstationDamage", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetRemainingThreatsInWave", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetSearchlightRuntime", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetSubstationIntegrity", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("StartPayloadWindow", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("AdvancePayloadWindow", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("TryJamActivePayload", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("NotifyAirfieldTargetDamage", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetPayloadWindow", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetTargetRuntime", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetSurvivingTargetCount", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetDayBeatKind", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetDayBeatIndex", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("TickDayBeatKit", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("HandleBossPhaseChanged", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ASkyguardMission06IntegrationDirector", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ESkyguardMission06WaveState", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ESkyguardMission07WaveState", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ASkyguardMission07IntegrationDirector", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ASkyguardMission08IntegrationDirector", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ESkyguardMission08WaveState", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ESkyguardMission09WaveState", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ESkyguardMission09ProtectedTarget", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("FSkyguardMission09ProtectedTargetRuntime", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("FSkyguardMission09PoolRuntime", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("FSkyguardMission09PoolBudget", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("BindCampaignRuntime", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetPoolRuntime", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("IronRainSpawnLocation", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ESkyguardMission08ProtectedTarget", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("FSkyguardMission08ProtectedTargetRuntime", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("FSkyguardHoistWindowRuntime", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("StartHoistWindow", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("AdvanceHoistWindow", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ValidateWeaponRelease", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetHoistRuntime", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetRejectedWeaponReleases", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetStormRainBeatKit", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ApplyStormRainPlayContract", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetStormRainBeatKind", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("TickStormRainBeatKit", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("RescueHelicopterAnchor", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("LifelineHunterSpawnLocation", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ESkyguardMission07ProtectedTarget", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("FSkyguardMission07ProtectedTargetRuntime", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ESkyguardSearchSector", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("FSkyguardSearchTrackRuntime", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ClassifyFalseTrack", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ConfirmRadarGhostIdentification", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("NotifyProtectedTargetDamage", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("AdvanceReinforcementTimer", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetSearchSector", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetClassifiedFalseTrackCount", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("IsHostileContactConfirmed", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetProtectedTarget", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetReinforcementTimeRemaining", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetNightBeatKind", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetNightBeatIndex", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("TickNightBeatKit", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ESkyguardAirfieldTarget", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ConvoyRuntimeAnchor", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("RoadHunterSpawnLocation", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ASkyguardMission02IntegrationDirector", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ConfigureMissionDefinition", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("NotifyObjectiveProgress", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("StartNextWave", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("SynchronizeRuntimeState", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("IsCorePlayableReady", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetReadiness", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetObjectiveRuntime", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetGunner", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetPathfinder", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetMissionId", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ValidateMissionContract", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ConfigureFromMission", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("AdvanceBriefing", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("SetAssetsReady", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("AcknowledgeAndLaunch", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("CanLaunch", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetElapsedSeconds", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetBriefingState", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetMinimumWarmupSeconds", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetBriefingText", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetRadioChatter", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetPresentation", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetMissionTitle", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("AcknowledgeBriefing", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("LaunchSortie", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("HullCollider", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("OpticalTracker", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("WeaponServo", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("CountermeasurePod", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("MinHeightFromOriginCm", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("RadarNode", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ESkyguardMission02WaveState", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("HarborIndustrial", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("MaxIntegrity", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("CurrentIntegrity", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("FillAndFinalize", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("FillAndFail", NOTIFY_PROTECTED_ASSET_FAILED)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction = (
            "public:\n"
            f"\t{UFUNCTION_OBJECTIVES}\n"
            f"\t{NOTIFY_PROTECTED_ASSET_FAILED}\n"
            "};\n"
        )
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_OBJECTIVES} {NOTIFY_PROTECTED_ASSET_FAILED}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{NOTIFY_PROTECTED_ASSET_FAILED}\n}}\n"
        self.assertTrue(has_declaration(one_line, NOTIFY_PROTECTED_ASSET_FAILED))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, NOTIFY_PROTECTED_ASSET_FAILED),
            section,
    ...
    def test_environment_category_does_not_satisfy_objectives(self) -> None:
        self.assertNotIn("Environment", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Briefing", UFUNCTION_OBJECTIVES)
        environment = (
            'UFUNCTION(BlueprintCallable, '
        ...
        self.assertNotEqual(environment, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(briefing, UFUNCTION_OBJECTIVES)
        self.assertNotIn(environment, UFUNCTION_OBJECTIVES)
        self.assertNotIn(briefing, UFUNCTION_OBJECTIVES)
        leftover_m01 = (
            'UFUNCTION(BlueprintCallable, '
        ...
        self.assertNotEqual(leftover_m01, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m10, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m02_integration, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m02_waves, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_harbor, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m03, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m04, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m05, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m06, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m07, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m08, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m09, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m09_waves, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m10_waves, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m10_safety, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m10_protection, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m09_pool, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_hoist, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_safety, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_waves, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_payload, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_targets, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_objectives, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m01, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m10, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_harbor, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m03, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m04, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m05, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m06, UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission01", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission03", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission04", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission05", UFUNCTION_OBJECTIVES)
    ...
    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", NOTIFY_PROTECTED_ASSET_FAILED)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_notify_protected_asset_failed_cpp_body(self) -> None:
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        self.assertNotIn("{", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("}", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("return ", NOTIFY_PROTECTED_ASSET_FAILED)
        ...
        self.assertNotIn("return false", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("return true", NOTIFY_PROTECTED_ASSET_FAILED)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn("NotifyProtectedAssetFailed", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertTrue(NOTIFY_PROTECTED_ASSET_FAILED.startswith("bool "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("CurrentIntegrity", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("SkyguardApacheAircraft.h", NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        self.assertNotIn("550.f", NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        self.assertEqual(
            require_declaration(locked_only, NOTIFY_PROTECTED_ASSET_FAILED),
            NOTIFY_PROTECTED_ASSET_FAILED,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ASkyguardIronRainBoss", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ASkyguardRadarGhostBoss", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("ASkyguardTempestBoss", section)
        self.assertNotIn("ASkyguardLastFlightBoss", NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertNotIn(
            "ASkyguardMission08IntegrationDirector::InitializePlayableMission",
            section,
        )
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("{", NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 StartNextWave method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, NOTIFY_PROTECTED_ASSET_FAILED.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                NOTIFY_PROTECTED_ASSET_FAILED.lower(),
                "mission02 StartNextWave contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, NOTIFY_PROTECTED_ASSET_FAILED)

    def test_contract_is_notify_protected_asset_failed_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(NOTIFY_PROTECTED_ASSET_FAILED.startswith("bool "))
        self.assertIn("NotifyProtectedAssetFailed", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertTrue(NOTIFY_PROTECTED_ASSET_FAILED.endswith(";"))
        self.assertIn(UFUNCTION_OBJECTIVES, section)

    def test_sibling_director_fields_do_not_satisfy_notify_protected_asset_failed(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, NOTIFY_PROTECTED_ASSET_FAILED)
            )
            self.assertNotEqual(NOTIFY_PROTECTED_ASSET_FAILED, leftover)
        self.assertIn(
    ...
    def test_leftover_mission10_initialize_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
    ...
    def test_leftover_handle_drone_city_impact_does_not_satisfy(self) -> None:
        ...
        self.assertIn("NotifyProtectedAssetFailed", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, NOTIFY_PROTECTED_ASSET_FAILED))
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tbool NotifyProtectedAssetFailed() { return false; }\n"
            "};\n"
        )
    ...
    def test_leftover_mission05_initialize_does_not_satisfy(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_notify_protected_asset_failed"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission03_notify_protected_asset_failed"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_handle_boss_phase_changed(
        ...
        for token in LEFTOVER_HANDLE_BOSS_PHASE_CHANGED_NOT_LOCKED:
            ...
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("HandleBossPhaseChanged", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("HandleBossPhaseChanged", UFUNCTION_OBJECTIVES)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission02_notify_protected_asset_failed"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_notify_protected_asset_failed"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission09_initialize_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_contract_does_not_relock_leftover_mission10_route_phase_enum(
        ...
        self.assertNotIn("GetRoutePhase", NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_contract_does_not_relock_leftover_mission10_protected_group(
        ...
        self.assertNotIn("Protection", UFUNCTION_OBJECTIVES)
        self.assertNotIn("GetProtectedGroup", NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_leftover_mission10_sibling_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("HandleDroneCityImpact", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("UFUNCTION", GET_DAY_BEAT_KIT)
        self.assertNotIn("StartPhaseWave", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("GetRoutePhase", NOTIFY_PROTECTED_ASSET_FAILED)


    def test_contract_does_not_relock_leftover_mission01_notify_protected_asset_failed(
        self,
    ) -> None:
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        for token in LEFTOVER_MISSION01_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn(
            "Scripts/tests/test_mission01_notify_protected_asset_failed"
    ...
    def test_contract_does_not_relock_leftover_mission03_notify_protected_asset_failed(
        self,
    ) -> None:
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        for token in LEFTOVER_MISSION03_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn(
            "Scripts/tests/test_mission03_notify_protected_asset_failed"
    ...
    def test_contract_does_not_relock_leftover_mission04_notify_protected_asset_failed(
        self,
    ) -> None:
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        for token in LEFTOVER_MISSION04_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn(
            "Scripts/tests/test_mission04_notify_protected_asset_failed"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertNotIn("Mission04", UFUNCTION_OBJECTIVES)

    def test_contract_does_not_relock_leftover_mission05_notify_protected_asset_failed(
        self,
    ) -> None:
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        for token in LEFTOVER_MISSION05_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission06_notify_protected_asset_failed(
        self,
    ) -> None:
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        for token in LEFTOVER_MISSION06_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission07_notify_protected_asset_failed(
        self,
    ) -> None:
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        for token in LEFTOVER_MISSION07_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission08_notify_protected_asset_failed(
        self,
    ) -> None:
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        for token in LEFTOVER_MISSION08_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission09_notify_protected_asset_failed(
        self,
    ) -> None:
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        for token in LEFTOVER_MISSION09_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn(
            "Scripts/tests/test_mission09_notify_protected_asset_failed"
    ...
    def test_contract_does_not_relock_leftover_mission10_start_phase_wave(
        self,
    ) -> None:
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        for token in LEFTOVER_MISSION10_START_PHASE_WAVE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn(
            "Scripts/tests/test_mission10_start_phase_wave"
    ...
    def test_leftover_mission02_initialize_does_not_satisfy(self) -> None:
        ...
        for token in LEFTOVER_MISSION02_INITIALIZE_NOT_LOCKED:
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("InitializePlayableMission", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("Integration", UFUNCTION_OBJECTIVES)
        ...
        self.assertIn(
            "Scripts/tests/test_mission02_start_next_wave"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission02_notify_threat_destroyed"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        for token in LEFTOVER_MISSION02_CONFIGURE_NOT_LOCKED:
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        for token in LEFTOVER_MISSION02_START_NEXT_WAVE_NOT_LOCKED:
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        for token in LEFTOVER_MISSION02_NOTIFY_THREAT_DESTROYED_NOT_LOCKED:
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        for token in LEFTOVER_MISSION10_NOTIFY_PROTECTED_ASSET_FAILED_NOT_LOCKED:
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
