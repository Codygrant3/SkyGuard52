...
# Isolated leftover-safe Mission02 Waves GetRemainingThreatsInWave
...
# NOT leftover Mission03 GetRemainingThreatsInWave #639 /
# leftover Mission04 GetRemainingThreatsInWave #662 /
# leftover same-name GetRemainingThreatsInWave drafts
# Mission05-#10 including Mission10. NOT leftover
# Mission03-09 wave-state enum contracts. NOT leftover
# Mission03 GetWaveState #640 / leftover Mission04
# GetWaveState #659 / leftover Mission02 GetWaveState
# sibling (in-flight). NOT leftover Mission10 GetRoutePhase
...
# Mission02 Waves GetRemainingThreatsInWave METHOD on
# ASkyguardMission02IntegrationDirector. It is
# NOT leftover Mission09 GetRemainingThreatsInWave.
...
# leftover Mission03 GetRemainingThreatsInWave #639,
# leftover Mission04 GetRemainingThreatsInWave #662,
...
# leftover Mission10 GetRemainingThreatsInWave,
# leftover Mission02 GetWaveState sibling,
...
# { return RemainingThreatsInWave; }`); accept that
...
# leftover Mission03 GetRemainingThreatsInWave #639 /
# leftover Mission04 GetRemainingThreatsInWave #662,
# leftover open drafts #674–#837+, leftover Apache
...
# and the locked Mission02 public declaration. Pathfinder MinHeightFromOriginCm
...
# Mission02 GetWaveState sibling. Do not reopen leftover
# Mission09 wave-state enum #20fc / #238. Do not reopen
...
# Do not reopen leftover Mission05-#10 same-name
# GetRemainingThreatsInWave drafts. Do not reopen
# leftover Mission10 field/method contracts.
# Do not reopen open drafts #674–#837+.
...
class Mission02GetRemainingThreatsInWaveDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        missing_const = (
            "\tESkyguardMission08WaveState GetRemainingThreatsInWave();\n"
        )
        with_arg = (
            "\tESkyguardMission08WaveState "
        ...
        leftover_m01_type = (
            "\tESkyguardMission01WaveState GetRemainingThreatsInWave() const;\n"
        )
        ...
        leftover_remaining = f"\t{GET_WAVE_STATE}\n"
    ...
    def test_leftover_harbor_mission02_initialize_does_not_satisfy(
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_init_only, LOCKED_DECL)
        self.assertIn("GetRemainingThreatsInWave", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission02_initialize_playable_mission"
    ...
    def test_leftover_environment_get_remaining_threats_in_wave_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission02_get_remaining_threats_in_wave"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_get_remaining_threats_in_wave"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission07_get_remaining_threats_in_wave_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m07_ready_type, LOCKED_DECL)
        self.assertIn("GetRemainingThreatsInWave", str(raised.exception))
    ...
    def test_leftover_mission08_get_remaining_threats_in_wave_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_leftover_mission09_get_remaining_threats_in_wave_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission09IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission02_sibling_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("InitializePlayableMission", LOCKED_DECL)
        self.assertNotIn("NotifyFuelTerminalDamage", LOCKED_DECL)
