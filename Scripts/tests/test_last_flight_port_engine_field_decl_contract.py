...
# PortEngine;`); accept that form and
...
# isolated-test drafts #107–#485 including leftover
...
# Python PortEngine field declaration
...
# leftover isolated-test drafts #107–#485,
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardLastFlightBoss::PortEngine",
    "SkyguardLastFlightBoss.cpp",
    "SetExposed",
...
class LastFlightPortEngineFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_port_engine_declaration_fails_closed(
        self,
    ) -> None:
        neighbors_only = (
            "\tASkyguardLastFlightBoss();\n"
    ...
    def test_port_engine_declaration_matches_origin_main(
        self,
    ) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
        ...
        self.assertNotIn("StarboardGuidanceArray", PORT_ENGINE_FIELD)
        self.assertNotIn("PortCoolingSystem", PORT_ENGINE_FIELD)
        self.assertNotIn("CommandCore", PORT_ENGINE_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        one_line = f"{{\npublic:\n\t{PORT_ENGINE_FIELD}\n}}\n"
        self.assertTrue(
            has_declaration(one_line, PORT_ENGINE_FIELD)
        )
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, PORT_ENGINE_FIELD),
    ...
    def test_contract_does_not_relock_sibling_last_flight_fields(self) -> None:
        ...
        self.assertNotIn("StarboardGuidanceArray", PORT_ENGINE_FIELD)
        self.assertNotIn("PortStrikeBayMechanism", PORT_ENGINE_FIELD)
        self.assertNotIn("StarboardStrikeBayMechanism", PORT_ENGINE_FIELD)
        self.assertNotIn("StarboardCoolingSystem", PORT_ENGINE_FIELD)
        self.assertNotIn("CommandCore", PORT_ENGINE_FIELD)
        self.assertNotIn("PortCoolingSystem", PORT_ENGINE_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
    ...
    def test_contract_does_not_relock_leftover_tempest(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, PORT_ENGINE_FIELD)
        self.assertNotIn("SetLightningExposed", PORT_ENGINE_FIELD)
        self.assertNotIn("ASkyguardTempestBoss", PORT_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_iron_rain(self) -> None:
        ...
        self.assertNotIn("ASkyguardIronRainBoss", PORT_ENGINE_FIELD)
        self.assertNotIn(
            "ASkyguardIronRainBoss::IssueClimbCommand",
            PORT_ENGINE_FIELD,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "last flight PortEngine field contract contains "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "last flight PortEngine contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_is_port_engine_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
