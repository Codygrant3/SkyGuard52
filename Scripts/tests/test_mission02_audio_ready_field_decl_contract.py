...
# Mission02 IntegrationReadiness bAudioReady
...
# NOT leftover Mission10 bAudioReady FIELD #821 /
# branch cursor/mission10-audio-ready-field-decl-
# contract-c332, NOT leftover Mission01 AudioDirector
...
# sibling readiness fields, NOT leftover director Readiness
...
# bAudioReady #821, leftover Apache
...
# drafts #674-#861 including leftover Mission10
# bAudioReady #821 and leftover Mission02
# siblings #828-#859.
...
LEFTOVER_MISSION10_AUDIO_READY_FIELD_NOT_LOCKED = (
...
class Mission02AudioReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 bAudioReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 bAudioReady contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_audio_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission09_audio_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
