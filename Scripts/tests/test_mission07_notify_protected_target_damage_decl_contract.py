...
# Mission07 Protection NotifyProtectedTargetDamage
# METHOD on ASkyguardMission07IntegrationDirector.
# It is NOT leftover Mission07 protected-target
# enum #18f2, NOT leftover Mission07
# protected-target-runtime-defaults #866c, NOT
# leftover Mission05 NotifyProtectedTargetDamage
# #673, NOT leftover search-sector enum #b4d4, NOT
# leftover search-track-runtime-defaults #8266,
# NOT leftover radar-ghost contact-identified
# leftover, NOT leftover Mission07
# InitializePlayableMission, NOT leftover
# Mission06 InitializePlayableMission #685, NOT
...
# sibling decl), NOT leftover retired-mount spawn
...
# Waves / Search / Protection / Payload /
...
# leftover Mission05 NotifyProtectedTargetDamage
# #673, leftover Mission04 wave-state enum #bb22,
...
# Mission07 Integration, not leftover Mission07
# Search / Waves.
...
# an isolated Python InitializePlayableMission
...
LEFTOVER_RADAR_GHOST_CONTACT_IDENTIFIED_NOT_LOCKED = (
    "IsContactIdentified",
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission07IntegrationDirector::InitializePlayableMission",
    "ASkyguardMission07IntegrationDirector::NotifyProtectedTargetDamage",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission07NotifyProtectedTargetDamageDeclContractTests(unittest.TestCase):
    ...
    def test_notify_declaration_matches_origin_main(self) -> None:
        ...
        self.assertIn("ESkyguardMission07ProtectedTarget Target", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertIn("int32 Damage", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertIn("(", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertIn(")", NOTIFY_PROTECTED_TARGET_DAMAGE)
        ...
        self.assertIn("ESkyguardMission07ProtectedTarget", NOTIFY_PROTECTED_TARGET_DAMAGE)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_spaces = (
            "public:\n"
            "\tbool   NotifyProtectedTargetDamage(ESkyguardMission07ProtectedTarget Target, int32 Damage);\n"
            "private:\n"
            "};\n"
        )
        wrap_tab = (
            "public:\n"
            "\tbool\t"
            "NotifyProtectedTargetDamage(ESkyguardMission07ProtectedTarget Target, int32 Damage);\n"
            "};\n"
        )
        wrap_indent = (
            "public:\n"
    ...
    def test_environment_category_does_not_satisfy_protection(self) -> None:
        ...
        self.assertNotEqual(leftover_m07_integration, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m07_waves, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m07_search, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m07_objectives, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m07_boss, UFUNCTION_PROTECTION)
    ...
    def test_contract_does_not_lock_notify_cpp_body(self) -> None:
        locked_only = f"{NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
        self.assertNotIn("{", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("}", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("return ", NOTIFY_PROTECTED_TARGET_DAMAGE)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 NotifyProtectedTargetDamage method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission07 NotifyProtectedTargetDamage contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_notify(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tbool NotifyProtectedTargetDamage(ESkyguardMission07ProtectedTarget Target, int32 Damage) { return false; }\n"
            "};\n"
        )
    ...
    def test_contract_does_not_relock_leftover_mission05_surviving_count(
        ...
        self.assertNotIn("GetSurvivingTargetCount", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetSurvivingTargetCount", UFUNCTION_PROTECTION)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_notify_protected_target_damage"
                "_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission07_classify_false_track"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_search_sector(self) -> None:
        ...
        self.assertNotIn("ESkyguardSearchSector", UFUNCTION_PROTECTION)
        self.assertNotIn("Search", UFUNCTION_PROTECTION)
        self.assertIn("Protection", UFUNCTION_PROTECTION)
        self.assertNotIn("Integration", UFUNCTION_PROTECTION)
    ...
    def test_leftover_radar_ghost_contact_identified_does_not_satisfy(
        self,
    ) -> None:
        leftover_is = "\tbool IsContactIdentified() const;\n"
        leftover_set = "\tvoid SetContactIdentified(bool bIdentified);\n"
        for region in (leftover_is, leftover_set):
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, NOTIFY_PROTECTED_TARGET_DAMAGE)
            self.assertIn("NotifyProtectedTargetDamage", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
        locked_only = f"{NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
        for token in LEFTOVER_RADAR_GHOST_CONTACT_IDENTIFIED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_radar_ghost_set_contact_identified"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
