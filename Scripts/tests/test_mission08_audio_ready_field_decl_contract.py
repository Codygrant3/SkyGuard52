...
# INDEX_NONE or lock bAudioReady
# construction in the .cpp. This is leftover-safe
# Mission08 IntegrationReadiness bAudioReady
...
# bAudioReady FIELD (declaration-only). It is
...
# #1067 through bRescueAnimationReady #1074,
...
# an isolated Python bAudioReady
...
class Mission08AudioReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bAudioReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_audio_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_audio_ready_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bAudioReady"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bAudioReady", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bAudioReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bAudioReady"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bAudioReady", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 bAudioReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 bAudioReady contains "
    ...
    def test_leftover_same_name_audio_ready_contracts_stay_locked(
        self,
    ) -> None:
