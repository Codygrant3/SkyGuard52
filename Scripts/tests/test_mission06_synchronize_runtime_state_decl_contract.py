...
# Mission06 Integration SynchronizeRuntimeState
# on ASkyguardMission06IntegrationDirector. It is
# NOT leftover Mission05 SynchronizeRuntimeState
...
# #683, leftover Mission06
# ConfigureMissionDefinition, leftover Mission06
# InitializePlayableMission, leftover Mission05
# InitializePlayableMission #666, leftover
# Mission05 ConfigureMissionDefinition #665, leftover
...
# #683, not leftover Harbor Mission02 Integration.
...
# leftover Mission05 SynchronizeRuntimeState
# #683, leftover Mission01 / Mission03 / Mission04
# SynchronizeRuntimeState, leftover Mission05
# ConfigureMissionDefinition #665, leftover Mission06
# ConfigureMissionDefinition, leftover Mission06
# InitializePlayableMission, leftover
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission06IntegrationDirector::SynchronizeRuntimeState",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission06SynchronizeRuntimeStateDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 SynchronizeRuntimeState method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission06 SynchronizeRuntimeState contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_synchronize_runtime_state"
                "_decl_contract.py"
            )
        )
        self.assertIn(
