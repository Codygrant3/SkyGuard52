...
# Mission03 Integration SortiePresentation
# FIELD (declaration-only, split-line) on
# ASkyguardMission03IntegrationDirector. It is
# NOT leftover Mission03 Briefing field #878 /
# branch cursor/mission03-briefing-field-decl-
# contract-c332, NOT leftover Mission03
# AudioDirector #877 / RadioChatter sibling,
# NOT leftover Mission01 SortiePresentation #575 /
# leftover Mission02 SortiePresentation #849 /
# leftover Mission10 SortiePresentation #797 /
# leftover sortie-presentation-state enum #6c40 /
# leftover sortie-presentation fail-closed #7600,
# NOT leftover Mission02 Briefing field #846 /
# branch cursor/mission02-briefing-field-decl-
# contract-c332, NOT leftover Mission03 Root
# field #875 / leftover Mission03
# ConvoyRuntimeAnchor #876, NOT leftover
# Mission10 Briefing field #795 /
# branch cursor/mission10-briefing-field-decl-
# contract-c332, NOT leftover Mission10
# bBriefingReady #819, NOT leftover Mission02
# UFUNCTION siblings #828-#842, NOT leftover
# Mission02 GetBreakwater /
# ValidateMissionContract siblings, NOT leftover
# Breakwater field contracts #540-#545, NOT
# leftover merged Mission02 C++ bundle #102, NOT
# leftover FSkyguardMission03IntegrationReadiness
# fields, NOT leftover Mission01 Briefing field #568 /
# branch cursor/mission01-briefing-field-decl-
# contract-c332, NOT leftover Mission01 Root
# field #574 /
# branch cursor/mission01-root-field-decl-
# contract-c332, NOT leftover Mission01
# environment-root field #592 / branch
# cursor/mission01-environment-root-field-
# decl-contract-c332, NOT leftover Mission10
# Root field sibling, NOT leftover
# HighwayConvoyAnchor / BusAAnchor / BusBAnchor /
# AmbulanceAAnchor / AmbulanceBAnchor /
# FerryTerminalAnchor siblings, NOT leftover
# EvacuationShipAnchor (in-flight sibling),
# NOT leftover ValidateMissionContract sibling,
# NOT leftover BindRuntimeActors, NOT leftover
# HandleDroneCityImpact, NOT leftover
# Mission10 protected-group enum
# #6f9d / branch cursor/mission10-protected-group-
# enum-contract-c332, NOT leftover Mission10
...
# methods.
# Harbor 40/80 fail-closed is Mission08-only;
# must not appear as Mission03 Harbor fail-closed
# constants.
# not leftover Root / leftover Mission03 Root #875 /
# leftover Mission03 ConvoyRuntimeAnchor #876 /
# leftover Mission02 Briefing #846 / leftover
# Mission01 Briefing #568 / leftover Mission10
# Briefing #795 / HighwayConvoyAnchor /
# BusAAnchor / BusBAnchor / AmbulanceAAnchor /
# AmbulanceBAnchor / FerryTerminalAnchor /
# EvacuationShipAnchor / AudioDirector /
# RadioChatter /
# Briefing / CampaignDefinition /
# MissionDefinition / Readiness /
...
# leftover sortie-presentation fail-closed /
...
# origin/main is a one-line UPROPERTY plus field
...
# UPROPERTY wraps. Nearby origin/main
# UPROPERTY(VisibleAnywhere, BlueprintReadOnly,
# Category="Skyguard|Mission03")
...
# Category is Skyguard|Mission03, not leftover Mission10, not
# Evacuation, not Integration, not leftover Mission01, not leftover
# Mission03 convoy methods, not leftover Mission10 / Mission04 /
# Mission05 / Mission06 / Mission07 / Mission08 /
# Mission09, not leftover Mission09 Protection #763,
# Payload / Targets / Objectives / Search / Waves /
# Hoist / Safety / Boss / Destruction / Briefing /
# Rescue / Performance / Protection,
# not Environment,
...
# drafts #674–#878, leftover Apache
...
# Mission03IntegrationDirector public section. Pathfinder MinHeightFromOriginCm
...
LAST_FLIGHT_SPAWN_ROTATION = (
    "FRotator LastFlightSpawnRotation"
)
GET_CONVOY_INTEGRITY = (
    "int32 GetConvoyIntegrity() const"
)
...
LEFTOVER_SORTIE_PRESENTATION_FAIL_CLOSED_NOT_LOCKED = (
...
LEFTOVER_MISSION10_SIBLING_METHODS_NOT_LOCKED = (
    ...
    "test_mission10_root_field_decl_contract.py",
    "test_mission10_highway_convoy_anchor_field_decl_contract.py",
    "test_mission10_bus_a_anchor_field_decl_contract.py",
    "test_mission10_bus_b_anchor_field_decl_contract.py",
...
class Mission03SortiePresentationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn("VisibleAnywhere", UPROPERTY_MISSION03)
        self.assertIn("BlueprintReadOnly", UPROPERTY_MISSION03)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        as_const = (
            "\tconst TObjectPtr<USkyguardSortiePresentationComponent>& "
            "SortiePresentation;\n"
        )
        with_arg = (
            "\tTArray<TObjectPtr<USkyguardSortiePresentationComponent>> "
            "SortiePresentation;\n"
        )
        renamed = (
        ...
        leftover_ambulance_a = f"\t{AMBULANCE_A_ANCHOR_FIELD}\n"
    ...
    def test_sortie_presentation_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("TWeakObjectPtr", LOCKED_DECL)
        ...
        self.assertNotIn("HighwayConvoyAnchor", LOCKED_DECL)
        self.assertNotIn("BusAAnchor", LOCKED_DECL)
        self.assertNotIn("BusBAnchor", LOCKED_DECL)
        self.assertNotIn("AmbulanceAAnchor", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_leftover_audio_director_fail_closed(
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_briefing_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission10_briefing_ready_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_sortie_presentation_fail_closed(
        self,
    ) -> None:
        locked_only = f"{LOCKED_DECL}\n"
        for token in LEFTOVER_SORTIE_PRESENTATION_FAIL_CLOSED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        self.assertIn(
            "Scripts/tests/test_sortie_presentation_state_enum"
            "_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertNotIn("SkyguardSortiePresentationComponent.h", locked_only)
        self.assertNotIn("ESkyguardSortiePresentationState", locked_only)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertNotIn("AmbulanceAAnchor", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 Briefing field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission03 Briefing field contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_sortie_presentation(
        ...
        self.assertIn(
            "Scripts/tests/test_mission10_bus_a_anchor"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_bus_b_anchor"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission03_sortie_presentation_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission03_sortie_presentation_field"
                "_decl_contract.py"
            )
        )
        leftover_56_64 = (
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_sortie_presentation_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_mission02_briefing_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission02IntegrationDirector "
            ": public AActor\n"
            "{\n"
