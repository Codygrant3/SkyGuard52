...
# INDEX_NONE or lock RunwayRack construction
# in the .cpp. This is a FIELD contract on
# ASkyguardRunwayBreakerBoss, not leftover
# RunwayBreaker sibling fields HangarRack /
...
# DebrisEngine / PortEngine distinct from leftover
# RoadHunter / Breakwater Engine and DebrisEngine
# (different classes; do not lock those here).
# Sibling fields HangarRack, HeatManifold,
# PortEngine, DebrisPortWing, DebrisPayloadBay,
...
# RunwayRack;`); accept that form and other
...
# isolated-test drafts #107–#548 including
...
# leftover isolated-test drafts #107–#552,
# leftover searchlight-track-runtime-defaults
...
# unlocked for THIS test's primary RunwayRack lock. Leftover
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardRunwayBreakerBoss::RunwayRack",
    "SkyguardRunwayBreakerBoss.cpp",
    "SetExposed",
...
class RunwayBreakerRunwayRackFieldDeclContractTests(unittest.TestCase):
    def test_runway_breaker_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, RUNWAY_RACK_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, RUNWAY_RACK_FIELD)
        self.assertIn("RunwayRack", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, RUNWAY_RACK_FIELD)
    ...
    def test_missing_runway_rack_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardRunwayBreakerBoss();\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, RUNWAY_RACK_FIELD)
        self.assertIn("RunwayRack", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, RUNWAY_RACK_FIELD)
        self.assertIn("RunwayRack", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UPROPERTY", RUNWAY_RACK_FIELD)
        self.assertNotIn("VisibleAnywhere", RUNWAY_RACK_FIELD)
        self.assertNotIn("BlueprintReadOnly", RUNWAY_RACK_FIELD)
        self.assertNotIn("Category", RUNWAY_RACK_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, RUNWAY_RACK_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, RUNWAY_RACK_FIELD)
        self.assertIn("RunwayRack", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUSkyguardBossWeakPointComponent* RunwayRack;\n"
        )
        as_array = (
        ...
        scene = (
            "\tTObjectPtr<USceneComponent> RunwayRack;\n"
        )
        mesh = (
            "\tTObjectPtr<UStaticMeshComponent> RunwayRack;\n"
        )
        weak = (
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, RUNWAY_RACK_FIELD)
            self.assertIn("RunwayRack", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_runway_rack_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, RUNWAY_RACK_FIELD),
            RUNWAY_RACK_FIELD,
        )
        self.assertTrue(has_declaration(section, RUNWAY_RACK_FIELD))
        self.assertEqual(declaration_count(section, RUNWAY_RACK_FIELD), 1)
        self.assertTrue(
            RUNWAY_RACK_FIELD.startswith(
                "TObjectPtr<USkyguardBossWeakPointComponent> "
            ),
            RUNWAY_RACK_FIELD,
        )
        self.assertTrue(RUNWAY_RACK_FIELD.endswith(";"), RUNWAY_RACK_FIELD)
        self.assertIn("RunwayRack", RUNWAY_RACK_FIELD)
        self.assertNotIn("HangarRack", RUNWAY_RACK_FIELD)
        self.assertNotIn("HeatManifold", RUNWAY_RACK_FIELD)
        self.assertNotIn("PortEngine", RUNWAY_RACK_FIELD)
        self.assertNotIn("DebrisPortWing", RUNWAY_RACK_FIELD)
        self.assertNotIn("DebrisPayloadBay", RUNWAY_RACK_FIELD)
        self.assertNotIn("DebrisEngine", RUNWAY_RACK_FIELD)
        self.assertNotIn("TargetingCamera", RUNWAY_RACK_FIELD)
        self.assertNotIn("LeftActuator", RUNWAY_RACK_FIELD)
        self.assertNotIn("RightActuator", RUNWAY_RACK_FIELD)
        self.assertNotIn("DebrisLeftWing", RUNWAY_RACK_FIELD)
        self.assertNotIn("DebrisRightWing", RUNWAY_RACK_FIELD)
        self.assertNotIn("DebrisCoolingDoor", RUNWAY_RACK_FIELD)
        self.assertNotIn("SignatureModulator", RUNWAY_RACK_FIELD)
        self.assertNotIn("RadarReceiver", RUNWAY_RACK_FIELD)
        self.assertNotIn("CoolingDoor", RUNWAY_RACK_FIELD)
        self.assertNotIn("PortLatch", RUNWAY_RACK_FIELD)
        self.assertNotIn("NoseCamera", RUNWAY_RACK_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            RUNWAY_RACK_FIELD,
        )
        self.assertIn("TObjectPtr<", RUNWAY_RACK_FIELD)
        self.assertNotIn("TArray<", RUNWAY_RACK_FIELD)
        self.assertNotIn("=", RUNWAY_RACK_FIELD)
        self.assertNotIn("INDEX_NONE", RUNWAY_RACK_FIELD)
        self.assertNotIn("UFUNCTION", RUNWAY_RACK_FIELD)
        self.assertNotIn("{", RUNWAY_RACK_FIELD)
        self.assertNotIn("}", RUNWAY_RACK_FIELD)
        self.assertNotIn("return ", RUNWAY_RACK_FIELD)
        self.assertNotIn("CommandAntenna", RUNWAY_RACK_FIELD)
        self.assertNotIn("ControlLinkage", RUNWAY_RACK_FIELD)
        self.assertNotIn("NoseCamera", RUNWAY_RACK_FIELD)
        self.assertNotIn("DebrisCenter", RUNWAY_RACK_FIELD)
        self.assertNotIn("DebrisTail", RUNWAY_RACK_FIELD)
        self.assertNotIn("DebrisNose", RUNWAY_RACK_FIELD)
        self.assertNotIn("DebrisSpine", RUNWAY_RACK_FIELD)
        self.assertNotIn("AdvanceEncounter", RUNWAY_RACK_FIELD)
        self.assertNotIn("ResetEncounterState", RUNWAY_RACK_FIELD)
        self.assertNotIn("IsRouteStateSafe", RUNWAY_RACK_FIELD)
        self.assertNotIn("GetRouteProgress", RUNWAY_RACK_FIELD)
        self.assertNotIn("GetEffectiveSpeedMultiplier", RUNWAY_RACK_FIELD)
        self.assertNotIn("IsAttackTelegraphActive", RUNWAY_RACK_FIELD)
        self.assertNotIn("GetTelegraphsTriggered", RUNWAY_RACK_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", RUNWAY_RACK_FIELD)
        self.assertNotIn("RadarNode", RUNWAY_RACK_FIELD)
        self.assertNotIn("BeginTerminalStrikeCycle", RUNWAY_RACK_FIELD)
        self.assertNotIn("OpenGuidanceArrayExposure", RUNWAY_RACK_FIELD)
        self.assertNotIn("IssueClimbCommand", RUNWAY_RACK_FIELD)
        self.assertNotIn("DivertWreckFromCivilians", RUNWAY_RACK_FIELD)
        self.assertNotIn("SetCivilianSeparationMeters", RUNWAY_RACK_FIELD)
        self.assertNotIn("GetCivilianSeparationMeters", RUNWAY_RACK_FIELD)
        self.assertNotIn("GetFinaleStage", RUNWAY_RACK_FIELD)
        self.assertNotIn("IsClimbCommandIssued", RUNWAY_RACK_FIELD)
        self.assertNotIn("IsWreckDiverted", RUNWAY_RACK_FIELD)
        self.assertNotIn("GetObjectiveMilestonesReached", RUNWAY_RACK_FIELD)
        self.assertNotIn("ESkyguardLastFlightStage", RUNWAY_RACK_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", RUNWAY_RACK_FIELD)
        self.assertNotIn("GetGunnerMount", RUNWAY_RACK_FIELD)
        self.assertNotIn("FaceWorldLocation", RUNWAY_RACK_FIELD)
        self.assertNotIn("PortGuidanceArray", RUNWAY_RACK_FIELD)
        self.assertNotIn("DebrisArmorPort", RUNWAY_RACK_FIELD)
        self.assertNotIn("SetSearchlightTracked", RUNWAY_RACK_FIELD)
        self.assertNotIn("SetContactIdentified", RUNWAY_RACK_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", RUNWAY_RACK_FIELD)
        self.assertNotIn("SetLightningExposed", RUNWAY_RACK_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", RUNWAY_RACK_FIELD)
        self.assertNotIn("HullCollider", RUNWAY_RACK_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, RUNWAY_RACK_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_PORT} {RUNWAY_RACK_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(
                declaration_count(section, RUNWAY_RACK_FIELD),
                1,
            )
        one_line = f"{{\npublic:\n\t{RUNWAY_RACK_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, RUNWAY_RACK_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, RUNWAY_RACK_FIELD),
            section,
    ...
    def test_assigned_runway_rack_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<USkyguardBossWeakPointComponent> "
            "RunwayRack = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, RUNWAY_RACK_FIELD)
        self.assertIn("RunwayRack", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, RUNWAY_RACK_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("RunwayRack", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, RUNWAY_RACK_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{RUNWAY_RACK_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, RUNWAY_RACK_FIELD)
        ...
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_PORT, section)
        self.assertTrue(has_declaration(section, RUNWAY_RACK_FIELD), section)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            RUNWAY_RACK_FIELD.startswith("UFUNCTION"),
            RUNWAY_RACK_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, RUNWAY_RACK_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", RUNWAY_RACK_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_runway_rack_cpp_body(self) -> None:
        locked_only = f"{RUNWAY_RACK_FIELD}\n"
        self.assertNotIn("{", RUNWAY_RACK_FIELD)
        self.assertNotIn("}", RUNWAY_RACK_FIELD)
        self.assertNotIn("return ", RUNWAY_RACK_FIELD)
        ...
        self.assertNotIn("SkyguardRunwayBreakerBoss.cpp", RUNWAY_RACK_FIELD)
        self.assertNotIn("SkyguardRunwayBreakerBoss.cpp", locked_only)
        self.assertNotIn("return false", RUNWAY_RACK_FIELD)
        self.assertNotIn("return true", RUNWAY_RACK_FIELD)
        self.assertNotIn("CreateDefaultSubobject", RUNWAY_RACK_FIELD)
        self.assertNotIn("SetExposed", RUNWAY_RACK_FIELD)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            RUNWAY_RACK_FIELD,
        )
        self.assertNotIn("SetBossPhase", RUNWAY_RACK_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", RUNWAY_RACK_FIELD)

    def test_contract_does_not_relock_sibling_tempest_fields(self) -> None:
        locked_only = f"{RUNWAY_RACK_FIELD}\n"
        for token in SIBLING_TEMPEST_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("PortDischargeBoom", RUNWAY_RACK_FIELD)
        self.assertNotIn("StarboardDischargeBoom", RUNWAY_RACK_FIELD)
        self.assertNotIn("EngineIntake", RUNWAY_RACK_FIELD)
        self.assertNotIn("DebrisPortPanel", RUNWAY_RACK_FIELD)
        self.assertNotIn("DebrisStarboardPanel", RUNWAY_RACK_FIELD)
        self.assertNotIn("DebrisIntakePanel", RUNWAY_RACK_FIELD)
        self.assertNotIn("RequiredLockStabilitySeconds", RUNWAY_RACK_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            RUNWAY_RACK_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_encounter_controller(
        ...
        for token in LEFTOVER_ENCOUNTER_CONTROLLER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("EncounterController", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_control_servo(self) -> None:
        ...
        for token in LEFTOVER_CONTROL_SERVO_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("ControlServo", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_sibling_iron_rain_fields(self) -> None:
        ...
        for token in SIBLING_IRON_RAIN_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("DispenserCenter", RUNWAY_RACK_FIELD)
        self.assertNotIn("MaxReleasesPerBay", RUNWAY_RACK_FIELD)
        self.assertIn("RunwayRack", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost_methods(
        ...
        for token in LEFTOVER_RADAR_GHOST_METHODS_NOT_LOCKED:
            ...
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("SetContactIdentified", RUNWAY_RACK_FIELD)
        self.assertNotIn("OpenOrbitExposure", RUNWAY_RACK_FIELD)
        self.assertNotIn("IsContactIdentified", RUNWAY_RACK_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", RUNWAY_RACK_FIELD)
        self.assertNotIn(leftover_open_rear_aspect_window(), RUNWAY_RACK_FIELD)

    def test_debris_cooling_door_does_not_satisfy_runway_rack(self) -> None:
        leftover = f"\t{DEBRIS_COOLING_DOOR_FIELD}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover, RUNWAY_RACK_FIELD)
        self.assertIn("RunwayRack", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover, RUNWAY_RACK_FIELD))
        self.assertNotEqual(DEBRIS_COOLING_DOOR_FIELD, RUNWAY_RACK_FIELD)
        self.assertNotIn("UStaticMeshComponent", RUNWAY_RACK_FIELD)
        self.assertNotIn(
            "USkyguardBossWeakPointComponent",
            DEBRIS_COOLING_DOOR_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_dispenser_starboard(
        ...
        for token in LEFTOVER_DISPENSER_STARBOARD_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("DispenserStarboard", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_get_maneuver(self) -> None:
        ...
        for token in LEFTOVER_GET_MANEUVER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("GetManeuver", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_open_first_window(), RUNWAY_RACK_FIELD)
        self.assertNotIn(leftover_open_final_window(), locked_only)
        self.assertNotIn(leftover_open_final_window(), RUNWAY_RACK_FIELD)
        self.assertNotIn(leftover_arm_command_core_path(), locked_only)
        self.assertNotIn(leftover_arm_command_core_path(), RUNWAY_RACK_FIELD)
        self.assertNotIn(leftover_apply_strike(), locked_only)
        self.assertNotIn(leftover_apply_strike(), RUNWAY_RACK_FIELD)
        self.assertNotIn(leftover_is_lock_eligible(), locked_only)
        self.assertNotIn(leftover_is_lock_eligible(), RUNWAY_RACK_FIELD)
        self.assertNotIn(leftover_arm_emergency_finish(), locked_only)
        self.assertNotIn(leftover_arm_emergency_finish(), RUNWAY_RACK_FIELD)
        ...
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_debris_getters(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("GetDefeatDebrisPieceCount", RUNWAY_RACK_FIELD)
        self.assertNotIn("GetMaxDefeatDebrisPieces", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("SetSearchlightTracked", RUNWAY_RACK_FIELD)
        self.assertNotIn("ASkyguardBlackKiteBoss", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        self.assertNotIn("CoolingDoor", RUNWAY_RACK_FIELD)
        self.assertNotIn("SignatureModulator", RUNWAY_RACK_FIELD)
        self.assertNotIn("ASkyguardRadarGhostBoss", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_NOT_LOCKED:
            ...
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", RUNWAY_RACK_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest_methods(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("SetLightningExposed", RUNWAY_RACK_FIELD)
        self.assertNotIn("ApplyCorrectiveBankGust", RUNWAY_RACK_FIELD)
        self.assertNotIn("IsLightningExposed", RUNWAY_RACK_FIELD)
        self.assertNotIn("GetLockStabilitySeconds", RUNWAY_RACK_FIELD)
        self.assertNotIn(leftover_advance_stabilized_lock(), RUNWAY_RACK_FIELD)
        self.assertNotIn(leftover_arm_break_finish(), RUNWAY_RACK_FIELD)
        self.assertNotIn(leftover_is_break_finish_armed(), RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        for token in LEFTOVER_PATROL_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("ASkyguardPatrolShip", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        ...
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            ...
            self.assertNotIn(neighbor, RUNWAY_RACK_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("ASkyguardGunner", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("SkyguardRadarNode", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            ...
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", RUNWAY_RACK_FIELD)
        self.assertNotIn("MaxIntegrity", RUNWAY_RACK_FIELD)
        self.assertNotIn("CurrentIntegrity", RUNWAY_RACK_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", RUNWAY_RACK_FIELD)
        self.assertNotIn(
            "SkyguardPathfinderEncounterController.h",
            RUNWAY_RACK_FIELD,
        )
    ...
    def test_contract_does_not_open_leftover_weak_point_component_header(
        ...
        self.assertNotIn(leftover_header, RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, RUNWAY_RACK_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{RUNWAY_RACK_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, RUNWAY_RACK_FIELD),
            RUNWAY_RACK_FIELD,
        )
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardRunwayBreakerBoss::RunwayRack", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "runway breaker RunwayRack field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{RUNWAY_RACK_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, RUNWAY_RACK_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                RUNWAY_RACK_FIELD.lower(),
                "runway breaker RunwayRack contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, RUNWAY_RACK_FIELD)

    def test_contract_is_runway_rack_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertTrue(RUNWAY_RACK_FIELD.endswith(";"))
        self.assertNotIn("=", RUNWAY_RACK_FIELD)
        self.assertIn(UPROPERTY_PORT, section)
    ...
    def test_contract_does_not_relock_sibling_road_hunter_fields(self) -> None:
        ...
        self.assertNotIn("DebrisEngine", RUNWAY_RACK_FIELD)
        self.assertNotIn("DebrisRightWing", RUNWAY_RACK_FIELD)
        self.assertNotIn("ASkyguardRoadHunterBoss", RUNWAY_RACK_FIELD)
        self.assertIn("RunwayRack", RUNWAY_RACK_FIELD)
        self.assertNotEqual(RUNWAY_RACK_FIELD, ROAD_HUNTER_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_sibling_breakwater_fields(self) -> None:
        ...
        for token in SIBLING_BREAKWATER_FIELDS_NOT_LOCKED:
            ...
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("PortLatch", RUNWAY_RACK_FIELD)
        self.assertNotIn("StarboardLatch", RUNWAY_RACK_FIELD)
        self.assertNotIn("DecoyPods", RUNWAY_RACK_FIELD)
        self.assertNotIn("ElevatorLinkage", RUNWAY_RACK_FIELD)
        self.assertNotIn("ASkyguardBreakwaterBoss", RUNWAY_RACK_FIELD)
        self.assertIn(
            "Scripts/tests/test_breakwater_engine_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_runway_breaker_runway_rack_is_not_breakwater_engine(self) -> None:
        locked_only = f"{RUNWAY_RACK_FIELD}\n"
        self.assertNotEqual(RUNWAY_RACK_FIELD, BREAKWATER_ENGINE_FIELD)
        self.assertNotEqual(RUNWAY_RACK_FIELD, RADAR_GHOST_ENGINE_FIELD)
        self.assertNotEqual(collapsed(RUNWAY_RACK_FIELD), collapsed(ENGINE_FIELD))
        self.assertNotEqual(RUNWAY_RACK_FIELD, ROAD_HUNTER_ENGINE_FIELD)
        ...
        self.assertNotIn("ASkyguardRoadHunterBoss", RUNWAY_RACK_FIELD)
        self.assertNotIn("ASkyguardRadarGhostBoss", RUNWAY_RACK_FIELD)
        self.assertNotIn("ASkyguardPathfinderBoss", RUNWAY_RACK_FIELD)
        self.assertIn("RunwayRack", RUNWAY_RACK_FIELD)
        self.assertNotIn("DebrisEngine", RUNWAY_RACK_FIELD)
        self.assertNotIn("TargetingCamera", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_mission02_wave_state(
        ...
        for token in LEFTOVER_MISSION02_WAVE_STATE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("ESkyguardMission02WaveState", RUNWAY_RACK_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter_fields(
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RUNWAY_RACK_FIELD)
        self.assertNotIn("OpticalTracker", RUNWAY_RACK_FIELD)
        self.assertNotIn("WeaponServo", RUNWAY_RACK_FIELD)
        self.assertNotIn("CountermeasurePod", RUNWAY_RACK_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", RUNWAY_RACK_FIELD)


    def test_runway_breaker_runway_rack_is_not_radar_ghost_engine(self) -> None:
        locked_only = f"{RUNWAY_RACK_FIELD}\n"
        self.assertNotEqual(RUNWAY_RACK_FIELD, RADAR_GHOST_ENGINE_FIELD)
        self.assertEqual(CLASS_NAME, "ASkyguardRunwayBreakerBoss")
        self.assertNotEqual(CLASS_NAME, "ASkyguardRadarGhostBoss")
    ...
    def test_runway_breaker_runway_rack_is_not_pathfinder_engine(self) -> None:
        locked_only = f"{RUNWAY_RACK_FIELD}\n"
        self.assertNotEqual(
            collapsed(RUNWAY_RACK_FIELD),
    ...
    def test_runway_breaker_runway_rack_is_not_road_hunter_engine(self) -> None:
        locked_only = f"{RUNWAY_RACK_FIELD}\n"
        self.assertNotEqual(RUNWAY_RACK_FIELD, ROAD_HUNTER_ENGINE_FIELD)
        self.assertEqual(CLASS_NAME, "ASkyguardRunwayBreakerBoss")
        self.assertNotEqual(CLASS_NAME, "ASkyguardRoadHunterBoss")
    ...
    def test_hangar_rack_does_not_satisfy_runway_rack(self) -> None:
    ...
    def test_heat_manifold_and_port_engine_do_not_satisfy_runway_rack(
        self,
    ) -> None:
        for region, name in (
            (f"\t{HEAT_MANIFOLD_FIELD}\n", "HeatManifold"),
    ...
    def test_runway_breaker_debris_fields_do_not_satisfy_runway_rack(
        self,
    ) -> None:
        for region, name in (
            (f"\t{RUNWAY_BREAKER_DEBRIS_PORT_WING_FIELD}\n", "DebrisPortWing"),
    ...
    def test_debris_engine_does_not_satisfy_runway_rack(self) -> None:
    ...
    def test_targeting_camera_does_not_satisfy_runway_rack(self) -> None:
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover, RUNWAY_RACK_FIELD))
        self.assertNotEqual(TARGETING_CAMERA_FIELD, RUNWAY_RACK_FIELD)
        self.assertNotIn("TargetingCamera", RUNWAY_RACK_FIELD)
        self.assertIn("RunwayRack", RUNWAY_RACK_FIELD)

    def test_left_and_right_actuators_do_not_satisfy_runway_rack(self) -> None:
        for region, name in (
            (f"\t{LEFT_ACTUATOR_FIELD}\n", "LeftActuator"),
            (f"\t{RIGHT_ACTUATOR_FIELD}\n", "RightActuator"),
        ):
