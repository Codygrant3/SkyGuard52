...
# NOT leftover GetAircraft, NOT leftover
# BindRuntimeActors, and NOT leftover
# HandleDroneCityImpact. Distinct from leftover
# briefing-widget / MissionBriefingComponent
# methods. Do not lock leftover
# HandleDroneCityImpact; it is not this
...
GET_GUNNER = (
    "ASkyguardGunner* GetGunner() const "
    "{ return Gunner; }"
)
...
class Mission01GetMissionIdDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        missing_static = "\tFName GetMissionId();\n"
        extra_arg = (
            "\tstatic FName "
            "GetMissionId(int32 Amount);\n"
        )
        extra_args = (
            "\tstatic FName "
            "GetMissionId("
        ...
        as_bool = "\tstatic bool GetMissionId();\n"
        as_string = (
            "\tstatic FString "
            "GetMissionId();\n"
        )
        ...
        renamed = "\tstatic FName GetId();\n"
        short_name = "\tstatic FName MissionId;\n"
        getter = "\tbool IsCorePlayableReady() const;\n"
        leftover_invert = f"\t{IS_VERTICAL_LOOK_INVERTED}\n"
    ...
    def test_get_mission_id_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("IntegrationReadiness", GET_MISSION_ID)
        ...
        self.assertNotIn("IsVerticalLookInverted", GET_MISSION_ID)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 GetMissionId method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission01 GetMissionId contains "
    ...
    def test_declaration_accepts_split_parameter_wrap(self) -> None:
        ...
        for wrap in (wrap_name, wrap_type_and_name, wrap_ufunction_split):
            header = (
                f"class SKYGUARD52_API {CLASS_NAME} "
                f": public AActor\n{{\n{wrap}"
            )
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_get_gunner"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
