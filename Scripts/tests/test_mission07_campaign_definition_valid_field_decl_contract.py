...
# Mission07 IntegrationReadiness bCampaignDefinitionValid
...
# (in-flight cursor/mission07-mission-definition-
# valid-field-decl-contract-c332), NOT leftover
...
class Mission07CampaignDefinitionValidFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 bCampaignDefinitionValid field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission07 bCampaignDefinitionValid contains "
