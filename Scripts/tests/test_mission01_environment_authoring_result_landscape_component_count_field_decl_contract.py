...
# LandscapeComponentCount. THIS IS NOT leftover MaterialCompilation
# LandscapeComponentCount #1227. THIS IS NOT leftover VisibleAudit
# LandscapeComponentCount #1200. THIS IS NOT leftover Mission01
# EnvironmentReadiness LandscapeComponentCount #1176. THIS IS NOT
# leftover mission01-environment-authoring-result-defaults #df1a.
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# LandscapeComponentCount FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# int32 LandscapeComponentCount = 0; one-line /
...
# Do NOT parse FSkyguardMission01EnvironmentReadiness (leftover
# LandscapeComponentCount #1176).
# Do NOT parse FSkyguardLandscapeVisibleAudit (leftover
# LandscapeComponentCount #1200).
# Do NOT parse FSkyguardLandscapeMaterialCompilationResult (leftover
# LandscapeComponentCount #1227).
...
# leftover MaterialCompilation LandscapeComponentCount #1227,
# leftover VisibleAudit LandscapeComponentCount #1200,
# leftover Mission01 EnvironmentReadiness LandscapeComponentCount
# #1176, leftover AuthoringResult bSuccess #1235 / Landscape #1233 /
# Graph #1234, leftover MaterialCompilation through Error #1232.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# LandscapeComponentCount. THIS IS NOT leftover MaterialCompilation bSuccess #1223.
...
# is not 0. Parse STRUCT public section only AFTER
# struct FSkyguardMission01EnvironmentAuthoringResult and BEFORE
# class USkyguardMission01EnvironmentAuthoringLibrary.
# Do NOT parse USkyguardMission01EnvironmentAuthoringLibrary methods.
# Do NOT parse ASkyguardMission01EnvironmentDirector.
...
# Do NOT parse FSkyguardLandscapeCaptureConfigurationResult (leftover bSuccess #1214).
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# LandscapeComponentCount. THIS IS NOT leftover VisibleAudit bSuccess #1199.
# THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
# THIS IS NOT leftover landscape-capture-config-defaults #d6fd.
# THIS IS NOT leftover landscape-visible-audit-defaults #0bce.
# THIS IS NOT leftover landscape-material-compilation-defaults #01d4.
...
# Do NOT parse FSkyguardLandscapeVisibleAudit (leftover bSuccess #1199).
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# LandscapeComponentCount. THIS IS NOT leftover
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# LandscapeComponentCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 LandscapeComponentCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# Fail closed if the type or decl is missing, renamed, or
...
# BlueprintReadOnly int32 LandscapeComponentCount = 0;
...
# LandscapeComponentCount FIELD (declaration-only). It is
...
TARGET = "int32 LandscapeComponentCount = 0;"
TARGET_WRONG = "float LandscapeComponentCount = 0;"
LOCKED_DECL = TARGET
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # int32 default for FSkyguardMission01EnvironmentAuthoringResult::
    # LandscapeComponentCount (must be = 0, not = 1).
    # THIS IS NOT leftover MaterialCompilation LandscapeComponentCount #1227.
    # THIS IS NOT leftover VisibleAudit LandscapeComponentCount #1200.
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*int32\s+LandscapeComponentCount\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for int32 LandscapeComponentCount is missing from "
...
class Mission01EnvironmentAuthoringResultLandscapeComponentCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("LandscapeComponentCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_landscape_component_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_landscape_component_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 LandscapeComponentCount"),
            LOCKED_DECL,
        )
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("LandscapeComponentCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 LandscapeComponentCount"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("LandscapeComponentCount", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_landscape_component_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
