...
# THIS IS NOT leftover Mission07 Briefing (director field) / branch
# cursor/mission07-briefing-field-decl-contract-c332.
# THIS IS NOT leftover Mission08 Root #1044 / branch
# cursor/mission08-root-field-decl-contract-c332.
# THIS IS NOT leftover Mission08 RescueHelicopterAnchor #1045 /
# HoistCableAnchor #1046 / SurvivorsAnchor #1047 / RaftsAnchor
# #1048 / RescueVesselAnchor #1049.
# THIS IS NOT leftover Mission08 Blueprint UFUNCTION methods
# #729-#749. THIS IS NOT leftover briefing-widget methods.
# THIS IS NOT leftover bBriefingReady readiness-struct field.
# THIS IS NOT leftover Mission08 wave-state enum #68fc /
...
# LOCK leftover Mission07 director Root #1011 through Readiness
# #1027. LOCK leftover Mission07 readiness-struct #1028-#1043.
# LOCK leftover drafts #56-#64 and leftover #107-#673. Do not
# reopen leftover #664, leftover closed-without-merge #658-#673,
# leftover Mission05 closed-without-merge #665 #666 #668-#673,
# or open drafts #674-#1049.
...
# reopen open drafts #674-#1049 (Mission03 RadioLineCount is
...
# ASkyguardMission08IntegrationDirector only.
# Do not parse private UPROPERTY(Transient), or Mission01 / Mission02 / Mission03 / Mission04 / Mission05 / Mission06 / Mission07 / Mission09-10 directors.
...
# leftover Mission07 /
# leftover Mission09, not leftover Mission01
...
class Mission08BriefingFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 Briefing field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 Briefing field contains "
