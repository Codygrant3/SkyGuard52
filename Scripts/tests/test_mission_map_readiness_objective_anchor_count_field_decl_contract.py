...
# ObjectiveAnchorCount FIELD (declaration-only;
...
# FSkyguardMissionMapReadiness, before the
# Native integrity boundary comment).
...
# int32 ObjectiveAnchorCount = 0;
# one-line / split-line UPROPERTY wraps; origin/main
# has NO Category). THIS IS NOT leftover mission-map-
# readiness-defaults #3a2a. THIS IS NOT leftover
# mission-map GetReadiness / ValidateAssembly /
# RebuildRouteSpline / IsPointInsideFlightClearance.
# THIS IS NOT leftover MissionMapReadiness
# bDefinitionValid #1155 / leftover
# bRequiredObjectivesAnchored #1157 /
# leftover bRouteMatchesDefinition #1158 /
# leftover bWeatherMatchesDefinition #1159 /
# leftover bLandmarksDistinct #1160 /
# in-flight RoutePointCount. LOCK those
# sibling scripts. Do not parse ObjectiveAnchor /
# LandmarkAnchor (EditAnywhere).
# Do not reopen leftover Mission10 Group #1156.
...
# #826 / bDestroyed #827, leftover Mission10
# methods/fields #768-#825, leftover Mission10
# Group #1156.
...
# this map test file (Mission08/09-only values).
...
# BlueprintReadOnly int32 ObjectiveAnchorCount = 0;
# one-line / split-line UPROPERTY wraps; origin/main
...
TARGET = "int32 ObjectiveAnchorCount = 0;"
TARGET_WRONG = "int32 ObjectiveAnchorCount = 1;"
LOCKED_DECL = TARGET
...
class MissionMapReadinessObjectiveAnchorCountFieldDeclContractTests(unittest.TestCase):
    def test_mission_map_readiness_struct_exists(self) -> None:
        ...
        self.assertNotIn("Native integrity boundary", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("ObjectiveAnchorCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_objective_anchor_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_objective_anchor_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 ObjectiveAnchorCount"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("ObjectiveAnchorCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("ObjectiveAnchorCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 ObjectiveAnchorCount"))
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        # This MissionMapReadiness ObjectiveAnchorCount default 0 is not Harbor 40/80.
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("ObjectiveAnchorCount", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_objective_anchor_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission_map_readiness_objective"
                "_anchor_count_field_decl_contract.py"
            )
        )
        self.assertIn(
