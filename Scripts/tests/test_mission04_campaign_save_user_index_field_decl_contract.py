...
# Category is Skyguard|Mission04|Campaign, not
...
class Mission04CampaignSaveUserIndexFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn('Category="Skyguard|Mission04|Campaign"', section)
        ...
        self.assertIn("Campaign", UPROPERTY_MISSION04)
        self.assertIn("Skyguard|Mission04|Campaign", UPROPERTY_MISSION04)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 CampaignSaveUserIndex field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 CampaignSaveUserIndex contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission04_campaign_save_user_index_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_campaign_save_user_index_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
