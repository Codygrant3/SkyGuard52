...
CLASS_NAME = "ASkyguardMission06IntegrationDirector"
# Declaration presence only. Do not invent
# INDEX_NONE or lock GetRemainingThreatsInWave
# construction in the .cpp. This is leftover-safe
# Mission06 Waves GetRemainingThreatsInWave on
# ASkyguardMission06IntegrationDirector. It is
# NOT leftover Mission05 GetRemainingThreatsInWave
# #677, NOT leftover Mission01 / Mission03 /
# Mission04 GetRemainingThreatsInWave, NOT leftover
# env-readiness #6b9d/#b931, NOT leftover
# payload-window-runtime-defaults #f114, NOT
# leftover BindRuntimeActors (retired live mount
# in the locked decl), NOT leftover retired-mount
# spawn fields, NOT leftover HandleDroneCityImpact,
# NOT leftover Harbor Mission02 / Harbor #6/#8/#9,
# NOT leftover Mission06 wave-state enum #fa65,
# NOT leftover airfield-target enum #14d2, NOT
# leftover airfield-target-runtime-defaults #6ad8,
# NOT leftover payload-window-runtime-defaults
# #f114, and NOT leftover HandleBossPhaseChanged
# without Blueprint category. Distinct from leftover
...
# leftover Mission04 GetRemainingThreatsInWave,
# leftover Mission05 StartNextWave #668,
# leftover Mission03 / Mission04 StartNextWave,
# leftover Mission04 wave-state enum #bb22, leftover
# Mission06 wave-state enum #fa65, leftover
# airfield-target enum #14d2 (do not add an
# enum-roster contract), leftover
# airfield-target-runtime-defaults #6ad8, leftover
# payload-window-runtime-defaults #f114 (do not
# add a struct-defaults contract), leftover
...
# class section of
# ASkyguardMission06IntegrationDirector only.
# Category is Skyguard|Mission06|Waves, not
# Mission01 / Mission02 / Mission03 / Mission04 /
# Mission05 / Integration / Payload / Targets /
# Objectives / Boss / Destruction / Briefing, not
# Environment, not leftover briefing-widget, not
# leftover MissionBriefingComponent methods, not
# leftover Mission01 Waves, not leftover
# Mission03 Waves, not leftover Mission04
# Waves, not leftover Mission05 Waves
# #677, not leftover Mission05 Protection, not
# leftover Harbor Mission02 Integration.
# Stay off leftover drafts #56–#64, leftover Harbor
# #6/#8/#9, leftover theater-kit #59, leftover
# isolated-test drafts #107–#673, leftover Apache
...
# Mission06IntegrationDirector public section and
...
# #668/#669/#673. Do not reopen leftover
# Mission05 GetRemainingThreatsInWave #677.
...
GET_REMAINING_THREATS_IN_WAVE = "int32 GetRemainingThreatsInWave() const;"
...
# leftover Mission05 GetRemainingThreatsInWave #677,
# leftover Mission01 / Mission03 / Mission04
# GetRemainingThreatsInWave, leftover Mission06 wave-state
# enum #fa65, leftover airfield-target enum #14d2,
# leftover airfield-target-runtime-defaults #6ad8,
# leftover payload-window-runtime-defaults #f114,
# leftover BindRuntimeActors, plus
# SkyguardMission06IntegrationDirector production
# files. This lane only adds an isolated Python
# GetRemainingThreatsInWave method declaration
# contract on ASkyguardMission06IntegrationDirector.
LOCKED = {
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission01_get_remaining_threats_in_wave_decl_contract.py",
...
SIBLING_INTEGRATION_METHODS_NOT_LOCKED = (
    ...
    "test_mission06_start_payload_window_decl_contract.py",
    "test_mission06_try_jam_active_payload_decl_contract.py",
    "test_mission06_advance_payload_window_decl_contract.py",
    "test_mission06_notify_airfield_target_damage_decl_contract.py",
...
LEFTOVER_MISSION06_START_PAYLOAD_WINDOW_NOT_LOCKED = (
    "test_mission06_start_payload_window_decl_contract.py",
    START_PAYLOAD_WINDOW,
    "StartPayloadWindow",
    'Category="Skyguard|Mission06|Payload"',
)
LEFTOVER_MISSION06_TRY_JAM_NOT_LOCKED = (
    "test_mission06_try_jam_active_payload_decl_contract.py",
    TRY_JAM_ACTIVE_PAYLOAD,
    "TryJamActivePayload",
)

LEFTOVER_MISSION06_ADVANCE_PAYLOAD_NOT_LOCKED = (
    "test_mission06_advance_payload_window_decl_contract.py",
    ADVANCE_PAYLOAD_WINDOW,
    "AdvancePayloadWindow",
    'Category="Skyguard|Mission06|Payload"',
)
LEFTOVER_MISSION06_NOTIFY_AIRFIELD_NOT_LOCKED = (
    "test_mission06_notify_airfield_target_damage_decl_contract.py",
    NOTIFY_AIRFIELD_TARGET_DAMAGE,
    "NotifyAirfieldTargetDamage",
    'Category="Skyguard|Mission06|Targets"',
)
LEFTOVER_MISSION01_GET_REMAINING_THREATS_IN_WAVE_NOT_LOCKED = (
    "ASkyguardMission01IntegrationDirector",
    "SkyguardMission01IntegrationDirector.h",
    "test_mission01_get_remaining_threats_in_wave_decl_contract.py",
    'Category="Skyguard|Mission01|Integration"',
)
LEFTOVER_MISSION03_GET_REMAINING_THREATS_IN_WAVE_NOT_LOCKED = (
    "ASkyguardMission03IntegrationDirector",
    "SkyguardMission03IntegrationDirector.h",
    "test_mission03_get_remaining_threats_in_wave_decl_contract.py",
    'Category="Skyguard|Mission03|Integration"',
)
LEFTOVER_MISSION04_GET_REMAINING_THREATS_IN_WAVE_NOT_LOCKED = (
    "ASkyguardMission04IntegrationDirector",
    "SkyguardMission04IntegrationDirector.h",
    "test_mission04_get_remaining_threats_in_wave_decl_contract.py",
    'Category="Skyguard|Mission04|Integration"',
)
LEFTOVER_MISSION05_GET_REMAINING_THREATS_IN_WAVE_NOT_LOCKED = (
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission06IntegrationDirector::GetRemainingThreatsInWave",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission06GetRemainingThreatsInWaveDeclContractTests(unittest.TestCase):
    def test_mission06_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, GET_REMAINING_THREATS_IN_WAVE),
            section,
        )
    ...
    def test_other_class_does_not_satisfy(self) -> None:
        other = (
            ...
            "{\n"
            "public:\n"
            f"\t{GET_REMAINING_THREATS_IN_WAVE}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn("GetRemainingThreatsInWave", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, GET_REMAINING_THREATS_IN_WAVE)
    ...
    def test_missing_get_remaining_threats_in_wave_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission06IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
            ...
            f"\t{NOTIFY_AIRFIELD_TARGET_DAMAGE}\n"
            f"\t{GET_READINESS}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn("GetRemainingThreatsInWave", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn("GetRemainingThreatsInWave", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("BlueprintPure", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("Category", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("BlueprintCallable", UFUNCTION_WAVES)
        self.assertIn("Skyguard|Mission06|Waves", UFUNCTION_WAVES)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, GET_REMAINING_THREATS_IN_WAVE)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn("GetRemainingThreatsInWave", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tvoid GetRemainingThreatsInWave() const;\n"
        )
        as_const = (
            "\tbool GetRemainingThreatsInWave();\n"
        )
        with_arg = (
            "\tbool GetRemainingThreatsInWave(int32 Amount) const;\n"
        )
        ...
        leftover_ready = f"\t{NOTIFY_AIRFIELD_TARGET_DAMAGE}\n"
        ...
        leftover_remaining = f"\t{IS_CORE_PLAYABLE_READY}\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, GET_REMAINING_THREATS_IN_WAVE)
            self.assertIn("GetRemainingThreatsInWave", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_get_remaining_threats_in_wave_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, GET_REMAINING_THREATS_IN_WAVE),
            GET_REMAINING_THREATS_IN_WAVE,
        )
        self.assertTrue(has_declaration(section, GET_REMAINING_THREATS_IN_WAVE))
        self.assertEqual(
            declaration_count(section, GET_REMAINING_THREATS_IN_WAVE),
            1,
        )
        self.assertTrue(
            GET_REMAINING_THREATS_IN_WAVE.startswith("int32 "),
            GET_REMAINING_THREATS_IN_WAVE,
        )
        self.assertTrue(
            GET_REMAINING_THREATS_IN_WAVE.endswith(";"),
            GET_REMAINING_THREATS_IN_WAVE,
        )
        self.assertIn("GetRemainingThreatsInWave", GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn("()", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ESkyguardAirfieldTarget Target", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("int32 Damage", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("TArray<", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("TObjectPtr", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("TSoftObjectPtr", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("INDEX_NONE", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("UFUNCTION", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("{", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("}", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("return ", GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn(" const;", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("Root", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("Briefing", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("AudioDirector", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("RadioChatter", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("SortiePresentation", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("CampaignDefinition", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("MissionDefinition", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("Readiness", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("bAutoInitialize", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("bAllowBoundedActorSpawning", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("bAutoLaunchAfterBriefing", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("PathfinderSpawnLocation", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetAircraft", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("BindRuntimeActors", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("HandleDroneCityImpact", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("InitializePlayableMission", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("NotifyThreatDestroyed", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("AdvanceConvoyByDistance", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("NotifyConvoyDamage", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetWaveState", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetConvoyRouteState", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetDayBeatKit", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetNightBeatKit", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("StartSearchlightWindow", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("AdvanceSearchlightTrack", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("NotifySubstationDamage", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("IsCorePlayableReady", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetSearchlightRuntime", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetSubstationIntegrity", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("StartNextWave", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("AdvancePayloadWindow", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("TryJamActivePayload", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("StartPayloadWindow", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetPayloadWindow", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetTargetRuntime", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetSurvivingTargetCount", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetDayBeatKind", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetDayBeatIndex", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("TickDayBeatKit", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("HandleBossPhaseChanged", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ESkyguardMission06WaveState", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ESkyguardAirfieldTarget", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ConvoyRuntimeAnchor", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("RoadHunterSpawnLocation", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ASkyguardMission02IntegrationDirector", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ConfigureMissionDefinition", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("NotifyObjectiveProgress", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("NotifyProtectedAssetFailed", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("SynchronizeRuntimeState", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("NotifyAirfieldTargetDamage", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetReadiness", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetObjectiveRuntime", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetGunner", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetPathfinder", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetMissionId", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ValidateMissionContract", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ConfigureFromMission", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("AdvanceBriefing", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("SetAssetsReady", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("AcknowledgeAndLaunch", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("CanLaunch", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetElapsedSeconds", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetBriefingState", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetMinimumWarmupSeconds", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetBriefingText", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetRadioChatter", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetPresentation", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetMissionTitle", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("AcknowledgeBriefing", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("LaunchSortie", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("HullCollider", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("OpticalTracker", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("WeaponServo", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("CountermeasurePod", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("MinHeightFromOriginCm", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("RadarNode", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ESkyguardMission02WaveState", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("HarborIndustrial", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("MaxIntegrity", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("CurrentIntegrity", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("FillAndFinalize", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("FillAndFail", GET_REMAINING_THREATS_IN_WAVE)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, GET_REMAINING_THREATS_IN_WAVE)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_WAVES} {GET_REMAINING_THREATS_IN_WAVE}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{GET_REMAINING_THREATS_IN_WAVE}\n}}\n"
        self.assertTrue(has_declaration(one_line, GET_REMAINING_THREATS_IN_WAVE))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, GET_REMAINING_THREATS_IN_WAVE),
            section,
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(leftover_m03_waves, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_m04_waves, UFUNCTION_WAVES)
        ...
        self.assertNotEqual(leftover_m05_ready, UFUNCTION_WAVES)
        ...
        self.assertNotIn(leftover_m03_waves, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m04_waves, UFUNCTION_WAVES)
    ...
    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, GET_REMAINING_THREATS_IN_WAVE)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", GET_REMAINING_THREATS_IN_WAVE)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_get_remaining_threats_in_wave_cpp_body(self) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        self.assertNotIn("{", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("}", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("return ", GET_REMAINING_THREATS_IN_WAVE)
        ...
        self.assertNotIn("return false", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("return true", GET_REMAINING_THREATS_IN_WAVE)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn("GetRemainingThreatsInWave", GET_REMAINING_THREATS_IN_WAVE)
        self.assertTrue(GET_REMAINING_THREATS_IN_WAVE.startswith("int32 "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("CurrentIntegrity", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("SkyguardApacheAircraft.h", GET_REMAINING_THREATS_IN_WAVE)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", GET_REMAINING_THREATS_IN_WAVE)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        self.assertEqual(
            require_declaration(locked_only, GET_REMAINING_THREATS_IN_WAVE),
            GET_REMAINING_THREATS_IN_WAVE,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_REMAINING_THREATS_IN_WAVE)
        ...
        self.assertNotIn("NotifyAirfieldTargetDamage", locked_only)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", GET_REMAINING_THREATS_IN_WAVE)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 GetRemainingThreatsInWave method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, GET_REMAINING_THREATS_IN_WAVE.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                GET_REMAINING_THREATS_IN_WAVE.lower(),
                "mission06 GetRemainingThreatsInWave contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, GET_REMAINING_THREATS_IN_WAVE)
    ...
    def test_contract_is_get_remaining_threats_in_wave_declaration_only(
        ...
        self.assertTrue(GET_REMAINING_THREATS_IN_WAVE.startswith("int32 "))
        self.assertIn("GetRemainingThreatsInWave", GET_REMAINING_THREATS_IN_WAVE)
        self.assertTrue(GET_REMAINING_THREATS_IN_WAVE.endswith(";"))
        self.assertIn(UFUNCTION_WAVES, section)

    def test_sibling_director_fields_do_not_satisfy_get_remaining_threats_in_wave(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, GET_REMAINING_THREATS_IN_WAVE)
            )
            self.assertNotEqual(GET_REMAINING_THREATS_IN_WAVE, leftover)
        self.assertIn(
    ...
    def test_leftover_handle_drone_city_impact_does_not_satisfy(self) -> None:
        ...
        self.assertIn("GetRemainingThreatsInWave", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, GET_REMAINING_THREATS_IN_WAVE))
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tint32 GetRemainingThreatsInWave() const { return 0; }\n"
            "};\n"
        )
    ...
    def test_leftover_mission05_initialize_does_not_satisfy(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission06_start_payload_window"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission06_try_jam_active_payload"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission06_advance_payload_window"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_get_remaining_threats_in_wave"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_get_remaining_threats_in_wave"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission03_get_remaining_threats_in_wave"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission04_get_remaining_threats_in_wave"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission06_wave_state_enum(
        ...
        self.assertIn("Waves", UFUNCTION_WAVES)
    ...
    def test_contract_does_not_relock_leftover_mission06_initialize(
        self,
    ) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
    ...
    def test_contract_does_not_relock_leftover_mission06_configure(
        self,
    ) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        for token in LEFTOVER_MISSION06_CONFIGURE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn(
            "Scripts/tests/test_mission06_configure_mission_definition"
    ...
    def test_contract_does_not_relock_leftover_mission06_notify_threat(
        self,
    ) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
    ...
    def test_contract_does_not_relock_leftover_mission06_start_payload_window(
        self,
    ) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        for token in LEFTOVER_MISSION06_START_PAYLOAD_WINDOW_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn(
            "Scripts/tests/test_mission06_start_payload_window"
    ...
    def test_contract_does_not_relock_leftover_mission06_try_jam(
        self,
    ) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        for token in LEFTOVER_MISSION06_TRY_JAM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn(
            "Scripts/tests/test_mission06_try_jam_active_payload"
    ...
    def test_contract_does_not_relock_leftover_mission05_protected_target_damage(
        self,
    ) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        ...
        self.assertNotIn("NotifyProtectedTargetDamage", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("Protection", UFUNCTION_WAVES)

    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission06_get_remaining_threats_in_wave"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_get_remaining_threats_in_wave"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission06_advance_payload(
        self,
    ) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        for token in LEFTOVER_MISSION06_ADVANCE_PAYLOAD_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn(
            "Scripts/tests/test_mission06_advance_payload_window"
    ...
    def test_contract_does_not_relock_leftover_mission06_notify_airfield(
        self,
    ) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        for token in LEFTOVER_MISSION06_NOTIFY_AIRFIELD_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn(
            "Scripts/tests/test_mission06_notify_airfield_target_damage"
    ...
    def test_leftover_mission01_get_remaining_threats_in_wave_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission01IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        for token in LEFTOVER_MISSION01_GET_REMAINING_THREATS_IN_WAVE_NOT_LOCKED:
            self.assertNotIn(token, GET_REMAINING_THREATS_IN_WAVE)

    def test_leftover_mission03_get_remaining_threats_in_wave_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        for token in LEFTOVER_MISSION03_GET_REMAINING_THREATS_IN_WAVE_NOT_LOCKED:
            self.assertNotIn(token, GET_REMAINING_THREATS_IN_WAVE)

    def test_leftover_mission04_get_remaining_threats_in_wave_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission04IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        for token in LEFTOVER_MISSION04_GET_REMAINING_THREATS_IN_WAVE_NOT_LOCKED:
            self.assertNotIn(token, GET_REMAINING_THREATS_IN_WAVE)

    def test_leftover_mission05_get_remaining_threats_in_wave_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission05IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        for token in LEFTOVER_MISSION05_GET_REMAINING_THREATS_IN_WAVE_NOT_LOCKED:
            self.assertNotIn(token, GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("Mission05", UFUNCTION_WAVES)
