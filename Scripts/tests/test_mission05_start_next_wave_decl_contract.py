...
# INDEX_NONE or lock StartNextWave construction
# in the .cpp. This is leftover-safe Mission05
# Waves StartNextWave on
...
# Mission03 StartNextWave and leftover Mission04
# StartNextWave #649. Distinct from leftover
# Mission05 InitializePlayableMission #666 and
...
# NotifyThreatDestroyed / TriggerLightningWindow /
...
# (`bool StartNextWave();`); accept that form,
# other one-line / split-line wraps, and an
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission05IntegrationDirector::StartNextWave",
    "SkyguardMission05IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission05StartNextWaveDeclContractTests(unittest.TestCase):
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardTempestBoss", START_NEXT_WAVE)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 StartNextWave method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission05 StartNextWave contains "
