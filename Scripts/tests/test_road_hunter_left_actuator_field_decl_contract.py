...
# INDEX_NONE or lock LeftActuator construction
# in the .cpp. This is a FIELD contract on
# ASkyguardRoadHunterBoss, not leftover RoadHunter
# sibling fields TargetingCamera / RightActuator /
...
# not lock Breakwater here). Keep LeftActuator
...
# LeftActuator;`); accept that form and other
...
# LeftActuator field declaration contract on
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardRoadHunterBoss::LeftActuator",
    "SkyguardRoadHunterBoss.cpp",
    "SetExposed",
...
class RoadHunterLeftActuatorFieldDeclContractTests(unittest.TestCase):
    def test_road_hunter_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, LEFT_ACTUATOR_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, LEFT_ACTUATOR_FIELD)
        self.assertIn("LeftActuator", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LEFT_ACTUATOR_FIELD)
    ...
    def test_missing_left_actuator_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardRoadHunterBoss();\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, LEFT_ACTUATOR_FIELD)
        self.assertIn("LeftActuator", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, LEFT_ACTUATOR_FIELD)
        self.assertIn("LeftActuator", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UPROPERTY", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("VisibleAnywhere", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("BlueprintReadOnly", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("Category", LEFT_ACTUATOR_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, LEFT_ACTUATOR_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, LEFT_ACTUATOR_FIELD)
        self.assertIn("LeftActuator", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUSkyguardBossWeakPointComponent* LeftActuator;\n"
        )
        as_array = (
        ...
        scene = (
            "\tTObjectPtr<USceneComponent> LeftActuator;\n"
        )
        mesh = (
            "\tTObjectPtr<UStaticMeshComponent> LeftActuator;\n"
        )
        weak = (
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, LEFT_ACTUATOR_FIELD)
            self.assertIn("LeftActuator", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_left_actuator_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LEFT_ACTUATOR_FIELD),
            LEFT_ACTUATOR_FIELD,
        )
        self.assertTrue(has_declaration(section, LEFT_ACTUATOR_FIELD))
        self.assertEqual(declaration_count(section, LEFT_ACTUATOR_FIELD), 1)
        self.assertTrue(
            LEFT_ACTUATOR_FIELD.startswith(
                "TObjectPtr<USkyguardBossWeakPointComponent> "
            ),
            LEFT_ACTUATOR_FIELD,
        )
        self.assertTrue(LEFT_ACTUATOR_FIELD.endswith(";"), LEFT_ACTUATOR_FIELD)
        self.assertIn("LeftActuator", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("TargetingCamera", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("RightActuator", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("DebrisLeftWing", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("DebrisEngine", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("DebrisRightWing", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("DebrisCoolingDoor", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("SignatureModulator", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("RadarReceiver", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("CoolingDoor", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("PortLatch", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("NoseCamera", LEFT_ACTUATOR_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            LEFT_ACTUATOR_FIELD,
        )
        self.assertIn("TObjectPtr<", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("TArray<", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("=", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("INDEX_NONE", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("UFUNCTION", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("{", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("}", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("return ", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("CommandAntenna", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ControlLinkage", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("NoseCamera", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("DebrisCenter", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("DebrisTail", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("DebrisNose", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("DebrisSpine", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("AdvanceEncounter", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ResetEncounterState", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("IsRouteStateSafe", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("GetRouteProgress", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("GetEffectiveSpeedMultiplier", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("IsAttackTelegraphActive", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("GetTelegraphsTriggered", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("RadarNode", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("BeginTerminalStrikeCycle", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("OpenGuidanceArrayExposure", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("IssueClimbCommand", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("DivertWreckFromCivilians", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("SetCivilianSeparationMeters", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("GetCivilianSeparationMeters", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("GetFinaleStage", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("IsClimbCommandIssued", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("IsWreckDiverted", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("GetObjectiveMilestonesReached", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ESkyguardLastFlightStage", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("GetGunnerMount", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("FaceWorldLocation", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("PortGuidanceArray", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("DebrisArmorPort", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("SetSearchlightTracked", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("SetContactIdentified", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("SetLightningExposed", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("HullCollider", LEFT_ACTUATOR_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, LEFT_ACTUATOR_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_PORT} {LEFT_ACTUATOR_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(
                declaration_count(section, LEFT_ACTUATOR_FIELD),
                1,
            )
        one_line = f"{{\npublic:\n\t{LEFT_ACTUATOR_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, LEFT_ACTUATOR_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, LEFT_ACTUATOR_FIELD),
            section,
    ...
    def test_assigned_left_actuator_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<USkyguardBossWeakPointComponent> "
            "LeftActuator = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, LEFT_ACTUATOR_FIELD)
        self.assertIn("LeftActuator", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, LEFT_ACTUATOR_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("LeftActuator", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, LEFT_ACTUATOR_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{LEFT_ACTUATOR_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, LEFT_ACTUATOR_FIELD)
        ...
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_PORT, section)
        self.assertTrue(has_declaration(section, LEFT_ACTUATOR_FIELD), section)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            LEFT_ACTUATOR_FIELD.startswith("UFUNCTION"),
            LEFT_ACTUATOR_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, LEFT_ACTUATOR_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", LEFT_ACTUATOR_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_left_actuator_cpp_body(self) -> None:
        locked_only = f"{LEFT_ACTUATOR_FIELD}\n"
        self.assertNotIn("{", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("}", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("return ", LEFT_ACTUATOR_FIELD)
        ...
        self.assertNotIn("SkyguardRoadHunterBoss.cpp", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("SkyguardRoadHunterBoss.cpp", locked_only)
        self.assertNotIn("return false", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("return true", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("CreateDefaultSubobject", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("SetExposed", LEFT_ACTUATOR_FIELD)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            LEFT_ACTUATOR_FIELD,
        )
        self.assertNotIn("SetBossPhase", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", LEFT_ACTUATOR_FIELD)

    def test_contract_does_not_relock_sibling_tempest_fields(self) -> None:
        locked_only = f"{LEFT_ACTUATOR_FIELD}\n"
        for token in SIBLING_TEMPEST_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("PortDischargeBoom", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("StarboardDischargeBoom", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("EngineIntake", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("DebrisPortPanel", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("DebrisStarboardPanel", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("DebrisIntakePanel", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("RequiredLockStabilitySeconds", LEFT_ACTUATOR_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            LEFT_ACTUATOR_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_encounter_controller(
        ...
        for token in LEFTOVER_ENCOUNTER_CONTROLLER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("EncounterController", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_control_servo(self) -> None:
        ...
        for token in LEFTOVER_CONTROL_SERVO_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ControlServo", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_sibling_iron_rain_fields(self) -> None:
        ...
        for token in SIBLING_IRON_RAIN_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("DispenserCenter", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("MaxReleasesPerBay", LEFT_ACTUATOR_FIELD)
        self.assertIn("LeftActuator", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost_methods(
        ...
        for token in LEFTOVER_RADAR_GHOST_METHODS_NOT_LOCKED:
            ...
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("SetContactIdentified", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("OpenOrbitExposure", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("IsContactIdentified", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", LEFT_ACTUATOR_FIELD)
        self.assertNotIn(leftover_open_rear_aspect_window(), LEFT_ACTUATOR_FIELD)

    def test_debris_cooling_door_does_not_satisfy_left_actuator(self) -> None:
        leftover = f"\t{DEBRIS_COOLING_DOOR_FIELD}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover, LEFT_ACTUATOR_FIELD)
        self.assertIn("LeftActuator", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover, LEFT_ACTUATOR_FIELD))
        self.assertNotEqual(DEBRIS_COOLING_DOOR_FIELD, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("UStaticMeshComponent", LEFT_ACTUATOR_FIELD)
        self.assertNotIn(
            "USkyguardBossWeakPointComponent",
            DEBRIS_COOLING_DOOR_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_dispenser_starboard(
        ...
        for token in LEFTOVER_DISPENSER_STARBOARD_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("DispenserStarboard", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_get_maneuver(self) -> None:
        ...
        for token in LEFTOVER_GET_MANEUVER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("GetManeuver", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_open_first_window(), LEFT_ACTUATOR_FIELD)
        self.assertNotIn(leftover_open_final_window(), locked_only)
        self.assertNotIn(leftover_open_final_window(), LEFT_ACTUATOR_FIELD)
        self.assertNotIn(leftover_arm_command_core_path(), locked_only)
        self.assertNotIn(leftover_arm_command_core_path(), LEFT_ACTUATOR_FIELD)
        self.assertNotIn(leftover_apply_strike(), locked_only)
        self.assertNotIn(leftover_apply_strike(), LEFT_ACTUATOR_FIELD)
        self.assertNotIn(leftover_is_lock_eligible(), locked_only)
        self.assertNotIn(leftover_is_lock_eligible(), LEFT_ACTUATOR_FIELD)
        self.assertNotIn(leftover_arm_emergency_finish(), locked_only)
        self.assertNotIn(leftover_arm_emergency_finish(), LEFT_ACTUATOR_FIELD)
        ...
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_debris_getters(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("GetDefeatDebrisPieceCount", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("GetMaxDefeatDebrisPieces", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("SetSearchlightTracked", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ASkyguardBlackKiteBoss", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        self.assertNotIn("CoolingDoor", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("SignatureModulator", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ASkyguardRadarGhostBoss", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_NOT_LOCKED:
            ...
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest_methods(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("SetLightningExposed", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ApplyCorrectiveBankGust", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("IsLightningExposed", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("GetLockStabilitySeconds", LEFT_ACTUATOR_FIELD)
        self.assertNotIn(leftover_advance_stabilized_lock(), LEFT_ACTUATOR_FIELD)
        self.assertNotIn(leftover_arm_break_finish(), LEFT_ACTUATOR_FIELD)
        self.assertNotIn(leftover_is_break_finish_armed(), LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        for token in LEFTOVER_PATROL_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ASkyguardPatrolShip", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        ...
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            ...
            self.assertNotIn(neighbor, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ASkyguardGunner", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("SkyguardRadarNode", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            ...
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("MaxIntegrity", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("CurrentIntegrity", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", LEFT_ACTUATOR_FIELD)
        self.assertNotIn(
            "SkyguardPathfinderEncounterController.h",
            LEFT_ACTUATOR_FIELD,
        )
    ...
    def test_contract_does_not_open_leftover_weak_point_component_header(
        ...
        self.assertNotIn(leftover_header, LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{LEFT_ACTUATOR_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, LEFT_ACTUATOR_FIELD),
            LEFT_ACTUATOR_FIELD,
        )
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardRoadHunterBoss::LeftActuator", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "road hunter LeftActuator field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{LEFT_ACTUATOR_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, LEFT_ACTUATOR_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LEFT_ACTUATOR_FIELD.lower(),
                "road hunter LeftActuator contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, LEFT_ACTUATOR_FIELD)

    def test_contract_is_left_actuator_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertTrue(LEFT_ACTUATOR_FIELD.endswith(";"))
        self.assertNotIn("=", LEFT_ACTUATOR_FIELD)
        self.assertIn(UPROPERTY_PORT, section)
    ...
    def test_contract_does_not_relock_sibling_breakwater_fields(self) -> None:
        ...
        for token in SIBLING_BREAKWATER_FIELDS_NOT_LOCKED:
            ...
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("PortLatch", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("StarboardLatch", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("DecoyPods", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ElevatorLinkage", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ASkyguardBreakwaterBoss", LEFT_ACTUATOR_FIELD)
        self.assertIn(
            "Scripts/tests/test_breakwater_engine_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_road_hunter_engine_is_not_breakwater_engine(self) -> None:
        locked_only = f"{LEFT_ACTUATOR_FIELD}\n"
        self.assertNotEqual(ROAD_HUNTER_ENGINE_FIELD, LEFT_ACTUATOR_FIELD)
        ...
        for token in LEFTOVER_BREAKWATER_ENGINE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("Engine;", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ASkyguardBreakwaterBoss", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_mission02_wave_state(
        ...
        for token in LEFTOVER_MISSION02_WAVE_STATE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ESkyguardMission02WaveState", LEFT_ACTUATOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter_fields(
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LEFT_ACTUATOR_FIELD)
        self.assertNotIn("OpticalTracker", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("WeaponServo", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("CountermeasurePod", LEFT_ACTUATOR_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", LEFT_ACTUATOR_FIELD)
