...
# INDEX_NONE or lock PowerStationAnchor
# construction in the .cpp. This is leftover-safe
# Mission09 PowerStationAnchor FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps) on
# ASkyguardMission09IntegrationDirector. It is
# NOT leftover Mission09 Root FIELD / branch
# cursor/mission09-root-field-decl-contract-c332,
# NOT leftover Mission01-08/10 Root, NOT leftover
# Mission08 RescueHelicopterAnchor /
# HoistCableAnchor / SurvivorsAnchor, NOT leftover
# Mission08 Root field
...
# methods.
# not leftover Mission09 Root #1083 / leftover
# Mission09 SkylineAnchor #1084 / leftover
# Mission09 MajorBridgeAnchor #1085 sibling director fields.
...
# private UPROPERTY(Transient), or Mission01 / Mission02 /
...
# not leftover Mission09 Root,
# not leftover Mission08 RescueHelicopterAnchor /
# HoistCableAnchor / SurvivorsAnchor,
...
# drafts #674-#1082, leftover Apache
...
# drafts #674-#1082 including leftover Mission03
...
SKYLINE_ANCHOR_FIELD = (
    "TObjectPtr<USceneComponent> SkylineAnchor;"
)
POWER_STATION_ANCHOR = (
    "TObjectPtr<USceneComponent> PowerStationAnchor;"
)
MAJOR_BRIDGE_ANCHOR = (
...
LOCKED_DECL = POWER_STATION_ANCHOR
...
# an isolated Python PowerStationAnchor
...
# readiness-struct bMissionDefinitionValid #1028
# through SearchTrackCount #1043. Lock leftover
...
# bCampaignRuntimeStarted #1079 and leftover-safe
# Mission08 ObjectiveCount #1080 / WaveCount #1081 /
# ProtectedTargetCount #1082. Lock leftover
...
# ValidateMissionContract. Lock leftover Mission09
# Root #1083 through SortiePresentation #1089.
# This is NOT leftover Mission09 Root #1083,
# NOT leftover Mission09 SkylineAnchor #1084,
# NOT leftover Mission09 MajorBridgeAnchor #1085,
# NOT leftover Mission01-08/10 Root, NOT leftover
# Mission08 RescueHelicopterAnchor / HoistCableAnchor
# / SurvivorsAnchor, NOT leftover Mission08
# GetReadiness #739, NOT leftover Mission08
# InitializePlayableMission #729.
LOCKED = {
...
class Mission09PowerStationAnchorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("PowerStationAnchor", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_power_station_anchor_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_power_station_anchor_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertIn("PowerStationAnchor", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("PowerStationAnchor", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("TObjectPtr<USceneComponent>"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("PowerStationAnchor;", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 PowerStationAnchor field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 PowerStationAnchor field contains "
    ...
    def test_contract_is_power_station_anchor_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_power_station_anchor(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
        ...
        self.assertIn(
            "Scripts/tests/test_mission09_major_bridge"
            "_anchor_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission09_briefing"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_survivors"
            "_anchor_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission09_power_station_anchor_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_power_station_anchor_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_declaration_accepts_origin_main_default_forms(self) -> None:
        ...
        stem = "TObjectPtr<USceneComponent> PowerStationAnchor"
        ...
        self.assertEqual(LOCKED_DECL, "TObjectPtr<USceneComponent> PowerStationAnchor;")
