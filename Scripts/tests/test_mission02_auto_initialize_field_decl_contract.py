...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission02IntegrationDirector::bAutoInitialize",
    "SkyguardMission10IntegrationDirector.cpp",
...
class Mission02AutoInitializeFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_auto_initialize_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
