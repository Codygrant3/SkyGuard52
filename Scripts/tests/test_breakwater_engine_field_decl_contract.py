...
# StarboardLatch / DecoyPods / ElevatorLinkage /
...
# RadarGhost Engine (PR #537) and leftover
# Pathfinder Engine. Keep Breakwater
...
LEFTOVER_BREAKWATER_PORT_LATCH_NOT_LOCKED = (
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardBreakwaterBoss::Engine",
    "SkyguardBreakwaterBoss.cpp",
    "SetExposed",
...
class BreakwaterEngineFieldDeclContractTests(unittest.TestCase):
    def test_breakwater_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, ENGINE_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, ENGINE_FIELD)
    ...
    def test_missing_engine_declaration_fails_closed(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, ENGINE_FIELD)
        self.assertIn("Engine", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, ENGINE_FIELD)
        self.assertIn("Engine", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UPROPERTY", ENGINE_FIELD)
        self.assertNotIn("VisibleAnywhere", ENGINE_FIELD)
        self.assertNotIn("BlueprintReadOnly", ENGINE_FIELD)
        self.assertNotIn("Category", ENGINE_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, ENGINE_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, ENGINE_FIELD)
        self.assertIn("Engine", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_port_latch = f"\t{PORT_LATCH_FIELD}\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, ENGINE_FIELD)
            self.assertIn("Engine", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_engine_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(has_declaration(section, ENGINE_FIELD))
        self.assertEqual(declaration_count(section, ENGINE_FIELD), 1)
        self.assertTrue(
            ENGINE_FIELD.startswith(
                "TObjectPtr<USkyguardBossWeakPointComponent> "
            ),
            ENGINE_FIELD,
        )
        self.assertTrue(ENGINE_FIELD.endswith(";"), ENGINE_FIELD)
        self.assertIn("Engine", ENGINE_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            ENGINE_FIELD,
        )
        self.assertIn("TObjectPtr<", ENGINE_FIELD)
        self.assertNotIn("TArray<", ENGINE_FIELD)
        self.assertNotIn("=", ENGINE_FIELD)
        self.assertNotIn("INDEX_NONE", ENGINE_FIELD)
        self.assertNotIn("UFUNCTION", ENGINE_FIELD)
        self.assertNotIn("{", ENGINE_FIELD)
        self.assertNotIn("}", ENGINE_FIELD)
        self.assertNotIn("return ", ENGINE_FIELD)
        self.assertNotIn("CommandAntenna", ENGINE_FIELD)
        self.assertNotIn("ControlLinkage", ENGINE_FIELD)
        self.assertNotIn("NoseCamera", ENGINE_FIELD)
        self.assertNotIn("DebrisCenter", ENGINE_FIELD)
        self.assertNotIn("DebrisTail", ENGINE_FIELD)
        self.assertNotIn("DebrisNose", ENGINE_FIELD)
        self.assertNotIn("DebrisSpine", ENGINE_FIELD)
        self.assertNotIn("AdvanceEncounter", ENGINE_FIELD)
        self.assertNotIn("ResetEncounterState", ENGINE_FIELD)
        self.assertNotIn("IsRouteStateSafe", ENGINE_FIELD)
        self.assertNotIn("GetRouteProgress", ENGINE_FIELD)
        self.assertNotIn("GetEffectiveSpeedMultiplier", ENGINE_FIELD)
        self.assertNotIn("IsAttackTelegraphActive", ENGINE_FIELD)
        self.assertNotIn("GetTelegraphsTriggered", ENGINE_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", ENGINE_FIELD)
        self.assertNotIn("RadarNode", ENGINE_FIELD)
        self.assertNotIn("BeginTerminalStrikeCycle", ENGINE_FIELD)
        self.assertNotIn("OpenGuidanceArrayExposure", ENGINE_FIELD)
        self.assertNotIn("IssueClimbCommand", ENGINE_FIELD)
        self.assertNotIn("DivertWreckFromCivilians", ENGINE_FIELD)
        self.assertNotIn("SetCivilianSeparationMeters", ENGINE_FIELD)
        self.assertNotIn("GetCivilianSeparationMeters", ENGINE_FIELD)
        self.assertNotIn("GetFinaleStage", ENGINE_FIELD)
        self.assertNotIn("IsClimbCommandIssued", ENGINE_FIELD)
        self.assertNotIn("IsWreckDiverted", ENGINE_FIELD)
        self.assertNotIn("GetObjectiveMilestonesReached", ENGINE_FIELD)
        self.assertNotIn("ESkyguardLastFlightStage", ENGINE_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", ENGINE_FIELD)
        self.assertNotIn("GetGunnerMount", ENGINE_FIELD)
        self.assertNotIn("FaceWorldLocation", ENGINE_FIELD)
        self.assertNotIn("PortGuidanceArray", ENGINE_FIELD)
        self.assertNotIn("DebrisArmorPort", ENGINE_FIELD)
        self.assertNotIn("SetSearchlightTracked", ENGINE_FIELD)
        self.assertNotIn("SetContactIdentified", ENGINE_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", ENGINE_FIELD)
        self.assertNotIn("SetLightningExposed", ENGINE_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", ENGINE_FIELD)
        self.assertNotIn("HullCollider", ENGINE_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, ENGINE_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        for header in (
            ...
            self.assertEqual(
                declaration_count(section, ENGINE_FIELD),
                1,
            )
        one_line = f"{{\npublic:\n\t{ENGINE_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, ENGINE_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, ENGINE_FIELD),
            section,
    ...
    def test_assigned_engine_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, ENGINE_FIELD)
        self.assertIn("Engine", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, ENGINE_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("Engine", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, ENGINE_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{ENGINE_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, ENGINE_FIELD)
        ...
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_PORT, section)
        self.assertTrue(has_declaration(section, ENGINE_FIELD), section)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            ENGINE_FIELD.startswith("UFUNCTION"),
            ENGINE_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, ENGINE_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", ENGINE_FIELD)
        section = public_section(origin_main_header())
    ...
    def test_contract_does_not_lock_engine_cpp_body(self) -> None:
        ...
        self.assertNotIn("SkyguardBreakwaterBoss.cpp", ENGINE_FIELD)
        self.assertNotIn("SkyguardBreakwaterBoss.cpp", locked_only)
        self.assertNotIn("return false", ENGINE_FIELD)
        self.assertNotIn("return true", ENGINE_FIELD)
        self.assertNotIn("CreateDefaultSubobject", ENGINE_FIELD)
        self.assertNotIn("SetExposed", ENGINE_FIELD)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            ENGINE_FIELD,
        )
        self.assertNotIn("SetBossPhase", ENGINE_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", ENGINE_FIELD)

    def test_contract_does_not_relock_sibling_tempest_fields(self) -> None:
        locked_only = f"{ENGINE_FIELD}\n"
        for token in SIBLING_TEMPEST_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("PortDischargeBoom", ENGINE_FIELD)
        self.assertNotIn("StarboardDischargeBoom", ENGINE_FIELD)
        self.assertNotIn("EngineIntake", ENGINE_FIELD)
        self.assertNotIn("DebrisPortPanel", ENGINE_FIELD)
        self.assertNotIn("DebrisStarboardPanel", ENGINE_FIELD)
        self.assertNotIn("DebrisIntakePanel", ENGINE_FIELD)
        self.assertNotIn("RequiredLockStabilitySeconds", ENGINE_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            ENGINE_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_encounter_controller(
        ...
        for token in LEFTOVER_ENCOUNTER_CONTROLLER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("EncounterController", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_control_servo(self) -> None:
        ...
        for token in LEFTOVER_CONTROL_SERVO_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("ControlServo", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_sibling_iron_rain_fields(self) -> None:
        ...
        for token in SIBLING_IRON_RAIN_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("DispenserCenter", ENGINE_FIELD)
        self.assertNotIn("MaxReleasesPerBay", ENGINE_FIELD)
        self.assertIn("Engine", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_dispenser_starboard(
        ...
        for token in LEFTOVER_DISPENSER_STARBOARD_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("DispenserStarboard", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_get_maneuver(self) -> None:
        ...
        for token in LEFTOVER_GET_MANEUVER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("GetManeuver", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_open_first_window(), ENGINE_FIELD)
        self.assertNotIn(leftover_open_final_window(), locked_only)
        self.assertNotIn(leftover_open_final_window(), ENGINE_FIELD)
        self.assertNotIn(leftover_arm_command_core_path(), locked_only)
        self.assertNotIn(leftover_arm_command_core_path(), ENGINE_FIELD)
        self.assertNotIn(leftover_apply_strike(), locked_only)
        self.assertNotIn(leftover_apply_strike(), ENGINE_FIELD)
        self.assertNotIn(leftover_is_lock_eligible(), locked_only)
        self.assertNotIn(leftover_is_lock_eligible(), ENGINE_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, locked_only)
            self.assertNotIn(name, ENGINE_FIELD)
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_debris_getters(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("GetDefeatDebrisPieceCount", ENGINE_FIELD)
        self.assertNotIn("GetMaxDefeatDebrisPieces", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("SetSearchlightTracked", ENGINE_FIELD)
        self.assertNotIn("ASkyguardBlackKiteBoss", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            ...
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("SetContactIdentified", ENGINE_FIELD)
        self.assertNotIn("OpenOrbitExposure", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_sibling_radar_ghost_fields(self) -> None:
        ...
        for token in SIBLING_RADAR_GHOST_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("RadarReceiver", ENGINE_FIELD)
        self.assertNotIn("CoolingDoor", ENGINE_FIELD)
        self.assertNotIn("DebrisPortEWPanel", ENGINE_FIELD)
        self.assertNotIn("DebrisStarboardEWPanel", ENGINE_FIELD)
        self.assertNotIn("DebrisCoolingDoor", ENGINE_FIELD)
        self.assertIn("Engine", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_sibling_breakwater_fields(self) -> None:
        ...
        for token in SIBLING_BREAKWATER_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("PortLatch", ENGINE_FIELD)
        self.assertNotIn("StarboardLatch", ENGINE_FIELD)
        self.assertNotIn("DecoyPods", ENGINE_FIELD)
        self.assertNotIn("ElevatorLinkage", ENGINE_FIELD)
        self.assertNotIn("DebrisEngine", ENGINE_FIELD)
        self.assertIn("Engine", ENGINE_FIELD)
    ...
    def test_breakwater_engine_is_not_radar_ghost_engine(self) -> None:
        ...
        for token in LEFTOVER_ENGINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertIn("Engine", ENGINE_FIELD)
        self.assertNotIn("ASkyguardRadarGhostBoss", ENGINE_FIELD)
        self.assertNotIn("ASkyguardPathfinderBoss", ENGINE_FIELD)
        self.assertNotIn("UStaticMeshComponent", ENGINE_FIELD)

    def test_debris_engine_does_not_satisfy_engine(self) -> None:
        leftover = f"\t{DEBRIS_ENGINE_FIELD}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover, ENGINE_FIELD)
        self.assertIn("Engine", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover, ENGINE_FIELD))
        self.assertNotEqual(DEBRIS_ENGINE_FIELD, ENGINE_FIELD)
        self.assertNotIn("UStaticMeshComponent", ENGINE_FIELD)
        self.assertNotIn(
            "USkyguardBossWeakPointComponent",
            DEBRIS_ENGINE_FIELD,
    ...
    def test_contract_does_not_relock_leftover_harbor_wave_state(self) -> None:
        ...
        for token in LEFTOVER_HARBOR_WAVE_STATE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("ESkyguardMission02WaveState", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_NOT_LOCKED:
            ...
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", ENGINE_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest_methods(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("SetLightningExposed", ENGINE_FIELD)
        self.assertNotIn("ApplyCorrectiveBankGust", ENGINE_FIELD)
        self.assertNotIn("IsLightningExposed", ENGINE_FIELD)
        self.assertNotIn("GetLockStabilitySeconds", ENGINE_FIELD)
        self.assertNotIn(leftover_advance_stabilized_lock(), ENGINE_FIELD)
        self.assertNotIn(leftover_arm_break_finish(), ENGINE_FIELD)
        self.assertNotIn(leftover_is_break_finish_armed(), ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        for token in LEFTOVER_PATROL_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("ASkyguardPatrolShip", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        ...
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            ...
            self.assertNotIn(neighbor, ENGINE_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("ASkyguardGunner", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("SkyguardRadarNode", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, ENGINE_FIELD)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", ENGINE_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            ...
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", ENGINE_FIELD)
        self.assertNotIn("MaxIntegrity", ENGINE_FIELD)
        self.assertNotIn("CurrentIntegrity", ENGINE_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", ENGINE_FIELD)
        self.assertNotIn(
            "SkyguardPathfinderEncounterController.h",
            ENGINE_FIELD,
        )
    ...
    def test_contract_does_not_open_leftover_weak_point_component_header(
        ...
        self.assertNotIn(leftover_header, ENGINE_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, ENGINE_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{ENGINE_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, ENGINE_FIELD),
            ENGINE_FIELD,
        )
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardBreakwaterBoss::Engine", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "breakwater Engine field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{ENGINE_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, ENGINE_FIELD.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, ENGINE_FIELD)
    ...
    def test_contract_is_engine_field_declaration_only(self) -> None:
        ...
        self.assertTrue(ENGINE_FIELD.endswith(";"))
        self.assertNotIn("=", ENGINE_FIELD)
        self.assertIn(UPROPERTY_PORT, section)
