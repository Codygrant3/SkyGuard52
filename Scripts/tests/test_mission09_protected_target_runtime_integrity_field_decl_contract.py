...
STRUCT_NAME = "FSkyguardMission09ProtectedTargetRuntime"
CLASS_NAME = STRUCT_NAME
# THIS IS leftover-safe Mission09 ProtectedTargetRuntime
...
# FSkyguardMission09ProtectedTargetRuntime STRUCT
# public section only (after struct
# FSkyguardMission09ProtectedTargetRuntime, before
...
# FSkyguardMission09PoolRuntime, leftover enum
# ESkyguardMission09ProtectedTarget type body, leftover
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission09 ProtectedTargetRuntime
# Integrity. THIS IS NOT leftover Mission08
...
# merge #665 #666 #668-#673, or open drafts #674-#1124.
...
# Mission09 ProtectedTargetRuntime Integrity
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 default 100,
# one-line / split-line UPROPERTY wraps) on
# FSkyguardMission09ProtectedTargetRuntime. It is
# leftover-safe Mission09 ProtectedTargetRuntime
...
# struct section of
# FSkyguardMission09ProtectedTargetRuntime only
# between struct FSkyguardMission09ProtectedTargetRuntime
# and struct FSkyguardMission09PoolBudget / the following UCLASS /
...
# director MaximumProtectedTargetIntegrity #1097. Skip leftover
...
# the locked FSkyguardMission09PoolRuntime
...
class Mission09ProtectedTargetRuntimeIntegrityFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_protected_target_runtime_integrity"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
