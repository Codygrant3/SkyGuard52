# THIS IS leftover-safe FSkyguardObjectiveDefinition Type.
# origin/main form: one-line and split-line UPROPERTY wraps
# UPROPERTY(EditAnywhere, BlueprintReadOnly)
# then `ESkyguardMissionObjectiveType Type =
...
# The initializer IS ESkyguardMissionObjectiveType::DestroyTargets.
...
# ESkyguardMissionObjectiveType, if the initializer is not
# ESkyguardMissionObjectiveType::DestroyTargets, or if Harbor tokens
...
# then this isolated Type field decl, same as leftover
# weather-profile-defaults then isolated Weather,
...
# retarget: type is ESkyguardMissionObjectiveType Type =
# ESkyguardMissionObjectiveType::DestroyTargets, specifiers
...
TARGET_WRONG_BARE = "ESkyguardMissionObjectiveType Type;"
TARGET_WRONG_PROTECT = (
    "ESkyguardMissionObjectiveType Type = "
    "ESkyguardMissionObjectiveType::ProtectAsset;"
)
TARGET_WRONG_REACH = (
    "ESkyguardMissionObjectiveType Type = "
    "ESkyguardMissionObjectiveType::ReachRoutePoint;"
)
TARGET_WRONG_SURVIVE = (
    "ESkyguardMissionObjectiveType Type = "
    "ESkyguardMissionObjectiveType::Survive;"
)
TARGET_WRONG_SCAN = (
    "ESkyguardMissionObjectiveType Type = "
    "ESkyguardMissionObjectiveType::ScanTargets;"
)
TARGET_WRONG_RESCUE = (
    "ESkyguardMissionObjectiveType Type = "
    "ESkyguardMissionObjectiveType::Rescue;"
)
TARGET_WRONG_BOSS = (
    "ESkyguardMissionObjectiveType Type = "
    "ESkyguardMissionObjectiveType::BossPhase;"
)
TARGET_WRONG_EQ_NONE = (
    "ESkyguardMissionObjectiveType Type = NAME_None;"
)
TARGET_WRONG_FALSE = (
    "ESkyguardMissionObjectiveType Type = false;"
)
TARGET_WRONG_TRUE = (
    "ESkyguardMissionObjectiveType Type = true;"
)
TARGET_WRONG_ZERO = (
    "ESkyguardMissionObjectiveType Type = 0.f;"
)
TARGET_WRONG_FNAME = "FName Type;"
TARGET_WRONG_FLOAT = "float Type;"
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # `ESkyguardMissionObjectiveType Type =
    # ESkyguardMissionObjectiveType::DestroyTargets;`.
    # Do not accept a bare Type, a non-DestroyTargets
    # initializer, FName / float / leftover Health, or
    # sibling ObjectiveId / DisplayName / RequiredProgress /
    ...
    if re.search(
        r"ESkyguardMissionObjectiveType\s+Type\s*;",
        compact,
    ):
        return False
    if re.search(
    ...
    if re.search(
        ...
        return False
    if re.search(
        r"ESkyguardMissionObjectiveType\s+Type\s*=\s*"
        r"ESkyguardMissionObjectiveType::(?!DestroyTargets\b)",
        compact,
    ):
        return False
    if re.search(
        r"ESkyguardMissionObjectiveType\s+Type\s*=\s*"
        r"ESkyguardMissionObjectiveType::DestroyTargets\s*;",
        compact,
    ) is None:
        return False
    return True
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    while True:
        ...
        if depth == 0 and re.match(
            r"\s*ESkyguardMissionObjectiveType\s+Type\b",
            compact[index:],
        ):
            return compact[start : index - 1]
        cursor = cursor + match.start() + 1
    raise AssertionError(
        "UPROPERTY for ESkyguardMissionObjectiveType Type is "
...
def require_type_specifiers(section: str) -> str:
    ...
    if "EditAnywhere" not in specifiers:
        raise AssertionError(
            ...
            f"{HEADER_PATH} struct {STRUCT_NAME} Type UPROPERTY"
        )
    if "BlueprintReadWrite" in specifiers:
        raise AssertionError(
            "BlueprintReadWrite instead of BlueprintReadOnly on "
            f"origin/main:{HEADER_PATH} struct {STRUCT_NAME} Type"
        )
...
class ObjectiveDefinitionTypeFieldDeclContractTests(unittest.TestCase):
    def test_objective_definition_struct_exists(self) -> None:
        ...
        self.assertTrue(has_identifier(section, "Type"), section)
    ...
    def test_later_struct_declaration_does_not_satisfy(self) -> None:
        ...
        self.assertFalse(has_identifier(section, "Type"), section)
        self.assertNotIn(STOP_BEFORE_ENEMY_FORMATION, section)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_PROGRESS, section)
        self.assertNotIn(STOP_BEFORE_MISSION_DEFINITION, section)
    ...
    def test_missing_type_declaration_fails_closed(self) -> None:
        empty = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
    ...
    def test_wrong_or_missing_initializer_fails_closed(self) -> None:
        ...
        protect = (
            ...
            "{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            f"\t{TARGET_WRONG_PROTECT}\n"
            "};\n"
        )
        section = spec_section(protect)
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, LOCKED_DECL)
        self.assertIn("Type", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        ...
        self.assertNotIn("Type = NAME_None", compact_origin)
        self.assertNotIn("Type = false", compact_origin)
        self.assertNotIn("Type = true", compact_origin)
        self.assertNotIn("Type = 0.f", compact_origin)
        self.assertNotIn("Type = 160.f", compact_origin)
        self.assertNotIn(
            "ESkyguardMissionObjectiveType Type = "
            "ESkyguardMissionObjectiveType::ProtectAsset;",
            compact_origin,
    ...
    def test_type_declaration_matches_origin_main(self) -> None:
        section = spec_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("ESkyguardMissionObjectiveType Type"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("ESkyguardMissionObjectiveType ", LOCKED_DECL)
        ...
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_PROTECT}\n", LOCKED_DECL)
        )
        self.assertFalse(
    ...
    def test_wrong_default_and_renames_do_not_satisfy(self) -> None:
        ...
        wrongs = (
            f"\t{TARGET_WRONG_BARE}\n",
            f"\t{TARGET_WRONG_PROTECT}\n",
            f"\t{TARGET_WRONG_REACH}\n",
            f"\t{TARGET_WRONG_SURVIVE}\n",
            f"\t{TARGET_WRONG_SCAN}\n",
            f"\t{TARGET_WRONG_RESCUE}\n",
            f"\t{TARGET_WRONG_BOSS}\n",
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "objective-definition Type field decl contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(Path(__file__).name.endswith(
            "objective_definition_type_field_decl_contract.py"
        ))
        self.assertNotIn("SkyguardMissionTypes.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardMissionDefinition.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardMissionTypes.cpp", THIS_SCRIPT)
