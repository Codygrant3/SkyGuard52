...
# FSkyguardMission01EnvironmentReadiness LandscapeComponentCount
...
# Mission01 EnvironmentReadiness LandscapeComponentCount
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 LandscapeComponentCount = 0;
# one-line / split-line UPROPERTY wraps;
...
TARGET_WRONG = "int32 LandscapeComponentCount = 1;"
LOCKED_DECL = TARGET
...
class Mission01EnvironmentReadinessLandscapeComponentCountFieldDeclContractTests(unittest.TestCase):
