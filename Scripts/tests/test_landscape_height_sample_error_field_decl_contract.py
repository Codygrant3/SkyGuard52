...
# #af83/#202. LOCK leftover-safe sibling #1180
...
# QueryLocation #1185. THIS IS NOT leftover
# HeightCentimeters / HeightfieldSource siblings.
# Fail closed if the parse window includes
# FSkyguardLandscapeFootprintSampleResult (that struct
# also has an Error field).
...
# FSkyguardLandscapeHeightSample QueryLocation
...
class LandscapeHeightSampleErrorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_parse_window_excludes_footprint_error_field(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertNotIn(
            "FSkyguardLandscapeFootprintSampleResult",
        ...
        self.assertIn("FSkyguardLandscapeFootprintSampleResult", polluted)
