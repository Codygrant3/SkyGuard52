...
# Integrity FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly int32 = 100;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission05 ProtectedTargetRuntime
# Integrity FIELD (declaration-only). THIS IS NOT leftover
...
# merge #665 #666 #668-#673, or open drafts #674-#1146.
...
# Mission05 ProtectedTargetRuntime Integrity
...
# Integrity FIELD (declaration-only). It is
...
# This ProtectedTargetRuntime field sits after Target and before
...
# is Integrity after Target and before bDestroyed. THIS IS NOT
...
# drafts #674-#1146 including leftover Mission02
...
# the locked FSkyguardMission05ProtectedTargetRuntime
...
# drafts #674-#1146. Do not reopen leftover
...
class Mission05ProtectedTargetRuntimeIntegrityFieldDeclContractTests(unittest.TestCase):
    ...
    def test_integrity_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(LOCKED_DECL.endswith("= 100;"), LOCKED_DECL)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 Integrity field contract "
    ...
    def test_contract_is_integrity_field_declaration_only(
        ...
        self.assertTrue(LOCKED_DECL.startswith("int32 Integrity"))
        self.assertIn("Integrity", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("= 100;"))
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission05_protected_target_runtime_integrity"
            "_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_protected_target_runtime_integrity"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
