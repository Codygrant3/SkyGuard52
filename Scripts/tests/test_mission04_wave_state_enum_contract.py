...
HEADER_NAME = "SkyguardMission04IntegrationDirector.h"
# Leftover #56–#64 plus Mission 04 production sources and merged #104.
...
LOCKED = {
    ...
    "SkyguardMission04IntegrationTests.cpp",
...
# Isolated-test drafts #107–#227 and newer stay off this lane.
# Searchlight track runtime defaults (#213) is the sibling Mission 04 contract.
LOCKED_SCRIPTS = (
...
# Apache CPG night-sortie wave progression. Not Yak-52 intercept states.
LIVE_WAVE_STATES = [
    "Briefing",
    "AwaitingWave",
    "WaveActive",
...
# Searchlight track (#213) and readiness (bYakRuntimeReady) stay unlocked.
SIBLING_TYPES = (
...
class Mission04WaveStateEnumContractTests(unittest.TestCase):
    ...
    def test_missing_enum_fails_closed(self) -> None:
        ...
        self.assertIn("ESkyguardMission04WaveState", str(raised.exception))
    ...
    def test_enumerators_match_live_order(self) -> None:
        ...
        body = enum_body(header, "ESkyguardMission04WaveState")
