...
# Mission10 IntegrationReadiness ObjectiveCount
# FIELD. It is NOT leftover Mission10
# GetObjectiveRuntime, NOT leftover Mission10
# objectives-ready field #815, NOT leftover
# Mission10 Readiness #809, NOT leftover
# Mission01 Readiness #579, NOT leftover
# GetReadiness #776, NOT leftover retired-mount
# runtime-ready sibling field, NOT leftover
# objective-runtime-fail-closed /
# objective-definition-defaults /
# objective-progress-defaults.
# This is leftover-safe
# Mission10 IntegrationReadiness ObjectiveCount FIELD
...
# Mission10 ObjectiveCount FIELD
# (VisibleAnywhere / BlueprintReadOnly,
# declaration-only, one-line / split-line
# UPROPERTY wraps, = 0 default) on
# FSkyguardMission10IntegrationReadiness. It is
...
# drafts #674-#821+, leftover Apache
...
LOCKED_DECL = OBJECTIVE_COUNT_FIELD
...
# Mission10 GetObjectiveRuntime, leftover Mission10
# objectives-ready field #815, leftover
# objective-runtime-fail-closed #6845, leftover
...
class Mission10ObjectiveCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 ObjectiveCount field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission10 ObjectiveCount contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_objective_count_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
