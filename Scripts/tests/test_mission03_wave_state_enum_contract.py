...
# Leftover #56–#64 plus Mission 03 production sources and merged #99.
...
# Convoy route state (#232) is the sibling Mission 03 contract.
LOCKED_SCRIPTS = (
...
# Apache CPG convoy-escort wave progression. Not Yak-52 intercept states.
LIVE_WAVE_STATES = [
    "Briefing",
    "AwaitingWave",
    "WaveActive",
...
# Convoy route (#232) and readiness (bYakRuntimeReady) stay unlocked.
SIBLING_TYPES = (
...
class Mission03WaveStateEnumContractTests(unittest.TestCase):
    ...
    def test_missing_enum_fails_closed(self) -> None:
        ...
        self.assertIn("ESkyguardMission03WaveState", str(raised.exception))
    ...
    def test_enumerators_match_live_order(self) -> None:
        ...
        body = enum_body(header, "ESkyguardMission03WaveState")
