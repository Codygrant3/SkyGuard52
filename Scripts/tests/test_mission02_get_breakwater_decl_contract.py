...
# INDEX_NONE or lock GetBreakwater
# construction in the .cpp. This is leftover-safe
# Mission02 Integration GetBreakwater METHOD on
...
# GetBreakwater() const { return Breakwater; }`);
...
# leftover Mission02 GetCurrentWaveIndex #839 /
# leftover Mission02 GetFuelTerminalIntegrity /
# leftover Breakwater field contracts #540-#545 /
...
# an isolated Python GetBreakwater
...
LEFTOVER_BREAKWATER_FIELDS_NOT_LOCKED = (
    "StarboardLatch",
    "PortLatch",
    "DecoyPods",
    "ElevatorLinkage",
    "test_breakwater_starboard_latch_field_decl_contract.py",
    "test_breakwater_port_latch_field_decl_contract.py",
    "test_breakwater_decoy_pods_field_decl_contract.py",
    "test_breakwater_elevator_linkage_field_decl_contract.py",
...
LEFTOVER_MISSION02_SIBLING_METHODS_NOT_LOCKED = (
    ...
    "test_mission02_get_fuel_terminal_integrity_decl_contract.py",
...
class Mission02GetBreakwaterDeclContractTests(unittest.TestCase):
    def test_mission02_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, GET_BREAKWATER),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, GET_BREAKWATER)
        self.assertIn("GetBreakwater", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, GET_BREAKWATER)
    ...
    def test_missing_get_breakwater_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, GET_BREAKWATER)
        self.assertIn("GetBreakwater", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, GET_BREAKWATER)
        self.assertIn("GetBreakwater", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", GET_BREAKWATER)
        self.assertNotIn("BlueprintPure", GET_BREAKWATER)
        self.assertNotIn("Category", GET_BREAKWATER)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, GET_BREAKWATER)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, GET_BREAKWATER)
        self.assertIn("GetBreakwater", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tvoid GetBreakwater() const;\n"
        )
        as_const = (
            "\tASkyguardBreakwaterBoss* "
            "GetBreakwater();\n"
        ...
        with_arg = (
            "\tASkyguardBreakwaterBoss* "
            "GetBreakwater(int32 Amount) const;\n"
        )
        renamed = (
            "\tconst FSkyguardMission09IntegrationReadiness& "
            "GetReadyState() const;\n"
        )
        short_name = "\tbool GetBreakwater() const;\n"
        leftover_m06_type = (
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, GET_BREAKWATER)
            self.assertIn("GetBreakwater", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_get_breakwater_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, GET_BREAKWATER),
            GET_BREAKWATER,
        )
        self.assertTrue(has_declaration(section, GET_BREAKWATER))
        self.assertEqual(
            declaration_count(section, GET_BREAKWATER),
            1,
        )
        self.assertTrue(
            GET_BREAKWATER.startswith("ASkyguardBreakwaterBoss*"),
            GET_BREAKWATER,
        )
        self.assertTrue(
            GET_BREAKWATER.startswith("ASkyguardBreakwaterBoss*"),
        ...
        self.assertIn("ASkyguardBreakwaterBoss", GET_BREAKWATER)
        self.assertIn("GetBreakwater", GET_BREAKWATER)
        self.assertNotIn(";", GET_BREAKWATER)
        self.assertIn("return Breakwater;", section)
        self.assertIn(UFUNCTION_INTEGRATION, section)
        self.assertIn(" const", GET_BREAKWATER)
        self.assertIn("()", GET_BREAKWATER)
        self.assertNotIn("TArray<", GET_BREAKWATER)
        self.assertNotIn("TObjectPtr", GET_BREAKWATER)
        self.assertNotIn("TSoftObjectPtr", GET_BREAKWATER)
        self.assertNotIn("INDEX_NONE", GET_BREAKWATER)
        self.assertNotIn("UFUNCTION", GET_BREAKWATER)
        self.assertNotIn("{", GET_BREAKWATER)
        self.assertNotIn("}", GET_BREAKWATER)
        self.assertNotIn("return ", GET_BREAKWATER)
        self.assertIn(" const", GET_BREAKWATER)
        self.assertNotIn("Root", GET_BREAKWATER)
        self.assertNotIn("Briefing", GET_BREAKWATER)
        self.assertNotIn("AudioDirector", GET_BREAKWATER)
        self.assertNotIn("RadioChatter", GET_BREAKWATER)
        self.assertNotIn("SortiePresentation", GET_BREAKWATER)
        self.assertNotIn("CampaignDefinition", GET_BREAKWATER)
        self.assertNotIn("MissionDefinition", GET_BREAKWATER)
        self.assertNotIn("Readiness;", GET_BREAKWATER)
        self.assertNotIn("bAutoInitialize", GET_BREAKWATER)
        self.assertNotIn("bAllowBoundedActorSpawning", GET_BREAKWATER)
        self.assertNotIn("bAutoLaunchAfterBriefing", GET_BREAKWATER)
        self.assertNotIn("PathfinderSpawnLocation", GET_BREAKWATER)
        self.assertNotIn("GetAircraft", GET_BREAKWATER)
        self.assertNotIn("BindRuntimeActors", GET_BREAKWATER)
        self.assertNotIn("HandleDroneCityImpact", GET_BREAKWATER)
        self.assertNotIn("InitializePlayableMission", GET_BREAKWATER)
        self.assertNotIn("StartNextWave", GET_BREAKWATER)
        self.assertNotIn("AdvanceConvoyByDistance", GET_BREAKWATER)
        self.assertNotIn("NotifyConvoyDamage", GET_BREAKWATER)
        self.assertNotIn("GetWaveState", GET_BREAKWATER)
        self.assertNotIn("GetConvoyRouteState", GET_BREAKWATER)
        self.assertNotIn("GetDayBeatKit", GET_BREAKWATER)
        self.assertNotIn("GetNightBeatKit", GET_BREAKWATER)
        self.assertNotIn("StartSearchlightWindow", GET_BREAKWATER)
        self.assertNotIn("AdvanceSearchlightTrack", GET_BREAKWATER)
        self.assertNotIn("NotifySubstationDamage", GET_BREAKWATER)
        self.assertNotIn("GetRemainingThreatsInWave", GET_BREAKWATER)
        self.assertNotIn("GetSearchlightRuntime", GET_BREAKWATER)
        self.assertNotIn("GetSubstationIntegrity", GET_BREAKWATER)
        self.assertNotIn("StartPayloadWindow", GET_BREAKWATER)
        self.assertNotIn("AdvancePayloadWindow", GET_BREAKWATER)
        self.assertNotIn("TryJamActivePayload", GET_BREAKWATER)
        self.assertNotIn("NotifyAirfieldTargetDamage", GET_BREAKWATER)
        self.assertNotIn("GetPayloadWindow", GET_BREAKWATER)
        self.assertNotIn("GetTargetRuntime", GET_BREAKWATER)
        self.assertNotIn("GetSurvivingTargetCount", GET_BREAKWATER)
        self.assertNotIn("GetDayBeatKind", GET_BREAKWATER)
        self.assertNotIn("GetDayBeatIndex", GET_BREAKWATER)
        self.assertNotIn("TickDayBeatKit", GET_BREAKWATER)
        self.assertNotIn("HandleBossPhaseChanged", GET_BREAKWATER)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", GET_BREAKWATER)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", GET_BREAKWATER)
        self.assertNotIn("ASkyguardMission06IntegrationDirector", GET_BREAKWATER)
        self.assertNotIn("ASkyguardMission07IntegrationDirector", GET_BREAKWATER)
        self.assertNotIn("ESkyguardMission06WaveState", GET_BREAKWATER)
        self.assertNotIn("ESkyguardMission07WaveState", GET_BREAKWATER)
        self.assertNotIn("ESkyguardMission08WaveState", GET_BREAKWATER)
        self.assertNotIn("ESkyguardMission09WaveState", GET_BREAKWATER)
        self.assertNotIn("ESkyguardMission07ProtectedTarget", GET_BREAKWATER)
        self.assertNotIn("ESkyguardMission08ProtectedTarget", GET_BREAKWATER)
        self.assertNotIn("ESkyguardMission09ProtectedTarget", GET_BREAKWATER)
        self.assertNotIn("FSkyguardMission07ProtectedTargetRuntime", GET_BREAKWATER)
        self.assertNotIn("FSkyguardMission08ProtectedTargetRuntime", GET_BREAKWATER)
        self.assertNotIn("FSkyguardMission09ProtectedTargetRuntime", GET_BREAKWATER)
        self.assertNotIn("FSkyguardMission08IntegrationReadiness", GET_BREAKWATER)
        self.assertNotIn("FSkyguardMission09IntegrationReadiness", GET_BREAKWATER)
        self.assertNotIn("FSkyguardMission09PoolRuntime", GET_BREAKWATER)
        self.assertNotIn("FSkyguardMission09PoolBudget", GET_BREAKWATER)
        self.assertNotIn("ASkyguardMission08IntegrationDirector", GET_BREAKWATER)
        self.assertNotIn("BindCampaignRuntime", GET_BREAKWATER)
        self.assertNotIn("GetPoolRuntime", GET_BREAKWATER)
        self.assertNotIn("ESkyguardSearchSector", GET_BREAKWATER)
        self.assertNotIn("FSkyguardSearchTrackRuntime", GET_BREAKWATER)
        self.assertNotIn("ClassifyFalseTrack", GET_BREAKWATER)
        self.assertNotIn("ConfirmRadarGhostIdentification", GET_BREAKWATER)
        self.assertNotIn("NotifyProtectedTargetDamage", GET_BREAKWATER)
        self.assertNotIn("AdvanceReinforcementTimer", GET_BREAKWATER)
        self.assertNotIn("GetSearchSector", GET_BREAKWATER)
        self.assertNotIn("GetClassifiedFalseTrackCount", GET_BREAKWATER)
        self.assertNotIn("IsHostileContactConfirmed", GET_BREAKWATER)
        self.assertNotIn("GetProtectedTarget", GET_BREAKWATER)
        self.assertNotIn("GetReinforcementTimeRemaining", GET_BREAKWATER)
        self.assertNotIn("GetNightBeatKind", GET_BREAKWATER)
        self.assertNotIn("GetNightBeatIndex", GET_BREAKWATER)
        self.assertNotIn("TickNightBeatKit", GET_BREAKWATER)
        self.assertNotIn("ESkyguardAirfieldTarget", GET_BREAKWATER)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", GET_BREAKWATER)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", GET_BREAKWATER)
        self.assertNotIn("ConvoyRuntimeAnchor", GET_BREAKWATER)
        self.assertNotIn("RoadHunterSpawnLocation", GET_BREAKWATER)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", GET_BREAKWATER)
        self.assertNotIn("ASkyguardMission02IntegrationDirector", GET_BREAKWATER)
        self.assertNotIn("ConfigureMissionDefinition", GET_BREAKWATER)
        self.assertNotIn("NotifyObjectiveProgress", GET_BREAKWATER)
        self.assertNotIn("NotifyProtectedAssetFailed", GET_BREAKWATER)
        self.assertNotIn("SynchronizeRuntimeState", GET_BREAKWATER)
        self.assertNotIn("NotifyThreatDestroyed", GET_BREAKWATER)
        self.assertNotIn("IsCorePlayableReady", GET_BREAKWATER)
        self.assertNotIn("GetObjectiveRuntime", GET_BREAKWATER)
        self.assertNotIn("GetGunner", GET_BREAKWATER)
        self.assertNotIn("GetPathfinder", GET_BREAKWATER)
        self.assertNotIn("GetMissionId", GET_BREAKWATER)
        self.assertNotIn("ValidateMissionContract", GET_BREAKWATER)
        self.assertNotIn("ConfigureFromMission", GET_BREAKWATER)
        self.assertNotIn("AdvanceBriefing", GET_BREAKWATER)
        self.assertNotIn("SetAssetsReady", GET_BREAKWATER)
        self.assertNotIn("AcknowledgeAndLaunch", GET_BREAKWATER)
        self.assertNotIn("CanLaunch", GET_BREAKWATER)
        self.assertNotIn("GetElapsedSeconds", GET_BREAKWATER)
        self.assertNotIn("GetBriefingState", GET_BREAKWATER)
        self.assertNotIn("GetMinimumWarmupSeconds", GET_BREAKWATER)
        self.assertNotIn("GetBriefingText", GET_BREAKWATER)
        self.assertNotIn("GetRadioChatter", GET_BREAKWATER)
        self.assertNotIn("GetPresentation", GET_BREAKWATER)
        self.assertNotIn("GetMissionTitle", GET_BREAKWATER)
        self.assertNotIn("AcknowledgeBriefing", GET_BREAKWATER)
        self.assertNotIn("LaunchSortie", GET_BREAKWATER)
        self.assertNotIn("HullCollider", GET_BREAKWATER)
        self.assertNotIn("OpticalTracker", GET_BREAKWATER)
        self.assertNotIn("WeaponServo", GET_BREAKWATER)
        self.assertNotIn("CountermeasurePod", GET_BREAKWATER)
        self.assertNotIn("MinHeightFromOriginCm", GET_BREAKWATER)
        self.assertNotIn("RadarNode", GET_BREAKWATER)
        self.assertNotIn("ESkyguardMission02WaveState", GET_BREAKWATER)
        self.assertNotIn("HarborIndustrial", GET_BREAKWATER)
        self.assertNotIn("MaxIntegrity", GET_BREAKWATER)
        self.assertNotIn("CurrentIntegrity", GET_BREAKWATER)
        self.assertNotIn("FillAndFinalize", GET_BREAKWATER)
        self.assertNotIn("FillAndFail", GET_BREAKWATER)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, GET_BREAKWATER)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_INTEGRATION} {GET_BREAKWATER}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{GET_BREAKWATER}\n}}\n"
        self.assertTrue(has_declaration(one_line, GET_BREAKWATER))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, GET_BREAKWATER),
            section,
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(leftover_m05_waves, UFUNCTION_INTEGRATION)
        self.assertNotEqual(leftover_integration, UFUNCTION_INTEGRATION)
        self.assertNotEqual(leftover_m07_ready, UFUNCTION_INTEGRATION)
        self.assertNotEqual(leftover_m08_waves, UFUNCTION_INTEGRATION)
        self.assertNotEqual(leftover_m08_hoist, UFUNCTION_INTEGRATION)
        self.assertNotEqual(leftover_m08_safety, UFUNCTION_INTEGRATION)
        self.assertNotEqual(leftover_m08_protection, UFUNCTION_INTEGRATION)
        self.assertNotEqual(leftover_m08_ready, UFUNCTION_INTEGRATION)
        self.assertNotEqual(leftover_m09_ready, UFUNCTION_INTEGRATION)
        ...
        self.assertNotEqual(leftover_m09_protection, UFUNCTION_INTEGRATION)
        self.assertNotEqual(leftover_m09_performance, UFUNCTION_INTEGRATION)
        self.assertNotEqual(leftover_m09_objectives, UFUNCTION_INTEGRATION)
        ...
        self.assertNotIn(leftover_m05_waves, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_integration, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_m07_ready, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_m08_waves, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_m08_hoist, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_m08_safety, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_m08_protection, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_m08_ready, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_m09_ready, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_m09_waves, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_m10_safety, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_m09_protection, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_m09_performance, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_m09_objectives, UFUNCTION_INTEGRATION)
        self.assertNotIn("Mission01", UFUNCTION_INTEGRATION)
        self.assertNotIn("Mission03", UFUNCTION_INTEGRATION)
        self.assertNotIn("Mission04", UFUNCTION_INTEGRATION)
        self.assertNotIn("Mission05", UFUNCTION_INTEGRATION)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", GET_BREAKWATER)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_get_breakwater_cpp_body(self) -> None:
        locked_only = f"{GET_BREAKWATER}\n"
        self.assertNotIn("{", GET_BREAKWATER)
        self.assertNotIn("}", GET_BREAKWATER)
        self.assertNotIn("return ", GET_BREAKWATER)
        ...
        self.assertNotIn("return false", GET_BREAKWATER)
        self.assertNotIn("return true", GET_BREAKWATER)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{GET_BREAKWATER}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_BREAKWATER)
        self.assertIn("GetBreakwater", GET_BREAKWATER)
        self.assertTrue(GET_BREAKWATER.startswith("ASkyguardBreakwaterBoss*"))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, GET_BREAKWATER)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, GET_BREAKWATER)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", GET_BREAKWATER)
        self.assertNotIn("CurrentIntegrity", GET_BREAKWATER)
        self.assertNotIn("SkyguardApacheAircraft.h", GET_BREAKWATER)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, GET_BREAKWATER)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", GET_BREAKWATER)
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        self.assertNotIn("550.f", GET_BREAKWATER)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{GET_BREAKWATER}\n"
        self.assertEqual(
            require_declaration(locked_only, GET_BREAKWATER),
            GET_BREAKWATER,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_BREAKWATER)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", GET_BREAKWATER)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", GET_BREAKWATER)
        self.assertNotIn("ASkyguardIronRainBoss", GET_BREAKWATER)
        self.assertNotIn("ASkyguardRadarGhostBoss", GET_BREAKWATER)
        self.assertNotIn("ASkyguardTempestBoss", section)
        self.assertNotIn("ASkyguardLastFlightBoss", GET_BREAKWATER)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 GetBreakwater method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{GET_BREAKWATER}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, GET_BREAKWATER.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                GET_BREAKWATER.lower(),
                "mission02 GetBreakwater contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, GET_BREAKWATER)

    def test_contract_is_get_breakwater_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_get_breakwater(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, GET_BREAKWATER)
            )
            self.assertNotEqual(GET_BREAKWATER, leftover)
        self.assertIn(
    ...
    def test_leftover_mission10_get_readiness_does_not_satisfy(
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m10_type, GET_BREAKWATER)
        self.assertIn("GetBreakwater", str(raised.exception))
        self.assertNotIn(
            "cursor/mission10-get-readiness-decl-contract-c332",
            GET_BREAKWATER,
    ...
    def test_leftover_handle_drone_city_impact_does_not_satisfy(self) -> None:
        ...
        self.assertIn("GetBreakwater", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, GET_BREAKWATER))
        locked_only = f"{GET_BREAKWATER}\n"
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_breakwater_starboard_latch"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_breakwater_port_latch"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_breakwater_decoy_pods"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_breakwater_elevator_linkage"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_breakwater_engine"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_mission07_get_readiness_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m07_type, GET_BREAKWATER)
        self.assertIn("GetBreakwater", str(raised.exception))
    ...
    def test_sibling_mission08_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("NotifyThreatDestroyed", GET_BREAKWATER)
        self.assertNotIn("StartNextWave", GET_BREAKWATER)
        self.assertNotIn("StartHoistWindow", GET_BREAKWATER)
        self.assertNotIn("AdvanceHoistWindow", GET_BREAKWATER)
        self.assertNotIn("ValidateWeaponRelease", GET_BREAKWATER)
        self.assertNotIn("IsCorePlayableReady", GET_BREAKWATER)
        self.assertNotIn("SynchronizeRuntimeState", GET_BREAKWATER)
        self.assertNotIn("GetObjectiveRuntime", GET_BREAKWATER)
        self.assertNotIn("GetWaveState", GET_BREAKWATER)
    ...
    def test_leftover_mission08_get_readiness_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m08_type, GET_BREAKWATER)
        self.assertIn("GetBreakwater", str(raised.exception))
        self.assertNotIn(
            "cursor/mission08-get-readiness-decl-contract-c332",
            GET_BREAKWATER,
    ...
    def test_leftover_mission09_get_readiness_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m09_type, GET_BREAKWATER)
        self.assertIn("GetBreakwater", str(raised.exception))
        self.assertNotIn(
            "cursor/mission09-get-readiness-decl-contract-c332",
            GET_BREAKWATER,
    ...
    def test_contract_does_not_relock_leftover_mission10_route_phase_enum(
        ...
        self.assertNotIn("GetRoutePhase", GET_BREAKWATER)
        self.assertNotIn("Waves", UFUNCTION_INTEGRATION)
    ...
    def test_contract_does_not_relock_leftover_mission10_protected_group(
        ...
        self.assertNotIn("Protection", UFUNCTION_INTEGRATION)
        self.assertNotIn("GetProtectedGroup", GET_BREAKWATER)
    ...
    def test_leftover_mission10_sibling_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("HandleDroneCityImpact", GET_BREAKWATER)
        self.assertNotIn("UFUNCTION", GET_DAY_BEAT_KIT)
        self.assertNotIn("StartPhaseWave", GET_BREAKWATER)
        self.assertNotIn("InitializePlayableMission", GET_BREAKWATER)
        self.assertNotIn("ValidateWeaponRelease", GET_BREAKWATER)
        self.assertNotIn("GetRoutePhase", GET_BREAKWATER)
        self.assertIn(
