...
# Mission06 CampaignDefinition FIELD
...
# drafts #674-#981 including leftover Mission03
...
class Mission06CampaignDefinitionFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 AudioDirector field contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_campaign_definition_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
