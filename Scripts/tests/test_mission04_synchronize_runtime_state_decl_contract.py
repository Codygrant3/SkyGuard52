...
# Mission04 Integration SynchronizeRuntimeState
...
# #615 or leftover Mission03 SynchronizeRuntimeState
# #635. Distinct from leftover briefing-widget /
...
# #635, leftover Mission04 wave-state enum #bb22,
...
# #615, leftover Mission03 SynchronizeRuntimeState
# #635, leftover Harbor Mission02, leftover
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission04IntegrationDirector::SynchronizeRuntimeState",
    "SkyguardMission04IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission04SynchronizeRuntimeStateDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 SynchronizeRuntimeState method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission04 SynchronizeRuntimeState contains "
