...
# INDEX_NONE or lock BeachMaterial construction
# in the .cpp. This is a FIELD contract on
# ASkyguardMission01EnvironmentDirector. Keep
# BeachMaterial distinct from leftover
...
# bAutoLaunchAfterBriefing. Keep BeachMaterial
...
# InlandExtentCm / SeawardExtentCm, leftover
# sibling OceanMaterial (in-flight this wave) /
# LandMaterial / BeachTiles / BeachWidthCm.
...
# Category is
# Skyguard|Mission01|Environment|Materials,
# not Environment alone, not Environment|PCG,
# not Environment|Landscape, not
# Environment|Layout, not Mission02 / Boss /
# Destruction / Integration director
# Skyguard|Mission01. Specifiers are EditAnywhere +
# BlueprintReadWrite, not VisibleAnywhere /
# BlueprintReadOnly / EditInstanceOnly / ClampMin.
...
# BeachMaterial field declaration contract on
...
# (#568/#572/#574–#594), leftover briefing-widget
...
# OceanMaterial / LandMaterial / environment Root
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission01EnvironmentDirector::BeachMaterial",
    "SkyguardMission01EnvironmentDirector.cpp",
...
class Mission01BeachMaterialFieldDeclContractTests(unittest.TestCase):
    def test_mission01_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, BEACH_MATERIAL_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, BEACH_MATERIAL_FIELD)
        self.assertIn("BeachMaterial", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(has_declaration(section, BEACH_MATERIAL_FIELD))

    def test_missing_beach_material_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission01EnvironmentDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{OCEAN_TILES_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, BEACH_MATERIAL_FIELD)
        self.assertIn("BeachMaterial", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))

    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        macro_only = f"\t{UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, BEACH_MATERIAL_FIELD)
        self.assertIn("BeachMaterial", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS, section)
        ...
        self.assertNotIn('ClampMin="1000.0"', UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertTrue(
            has_declaration(section, BEACH_MATERIAL_FIELD),
            section,
        )
        self.assertNotIn("UPROPERTY", BEACH_MATERIAL_FIELD)
        self.assertNotIn("EditAnywhere", BEACH_MATERIAL_FIELD)
        self.assertNotIn("EditInstanceOnly", BEACH_MATERIAL_FIELD)
        self.assertNotIn("BlueprintReadWrite", BEACH_MATERIAL_FIELD)
        self.assertNotIn("VisibleAnywhere", BEACH_MATERIAL_FIELD)
        self.assertNotIn("BlueprintReadOnly", BEACH_MATERIAL_FIELD)
        self.assertNotIn("Category", BEACH_MATERIAL_FIELD)
        self.assertNotIn("ClampMin", BEACH_MATERIAL_FIELD)
        self.assertNotIn("=", BEACH_MATERIAL_FIELD)
        self.assertNotIn("BlueprintPure", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotIn("BlueprintCallable", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertIn(
            "Skyguard|Mission01|Environment|Materials",
            UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS,
        )
        self.assertIn("Materials", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertIn("EditAnywhere", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertIn("BlueprintReadWrite", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotIn("Layout", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotIn("ClampMin", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotEqual(
            UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS,
            UPROPERTY_MISSION01_ENVIRONMENT,
        )
        ...
        self.assertNotIn("PCG", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotIn("Landscape", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotIn("EditInstanceOnly", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotIn("VisibleAnywhere", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotIn("BlueprintReadOnly", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotIn("Mission02", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotIn("Boss", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotIn("Destruction", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotIn("Apache", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotIn("Mission07", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotIn("Mission10", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotIn("Encounter", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotIn("Safety", UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotEqual(
            UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS,
            UPROPERTY_INTEGRATION,
        )
        self.assertNotIn(UPROPERTY_INTEGRATION, UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
        self.assertNotIn(
            'Category="Skyguard|Mission01")',
            UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS,
        )
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS)
            self.assertNotIn(invented, BEACH_MATERIAL_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, BEACH_MATERIAL_FIELD)
        self.assertIn("BeachMaterial", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUMaterialInterface* BeachMaterial;\n"
        )
        as_array = (
            "\tTArray<UMaterialInterface*> BeachMaterial;\n"
        )
        float_type = "\tfloat BeachMaterial;\n"
        int_type = "\tint32 BeachMaterial = 45000;\n"
        double_type = "\tdouble BeachMaterial;\n"
        wrong_init = (
            "\tTObjectPtr<UMaterialInterface> BeachMaterial = nullptr;\n"
        )
        assigned_default = (
            "\tTObjectPtr<UMaterialInterface> BeachMaterial = {};\n"
        )
        scene = "\tTObjectPtr<USceneComponent> BeachMaterial;\n"
        static_mesh = "\tTObjectPtr<UStaticMeshComponent> BeachMaterial;\n"
        instanced = (
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, BEACH_MATERIAL_FIELD)
            self.assertIn("BeachMaterial", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_beach_material_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, BEACH_MATERIAL_FIELD),
            BEACH_MATERIAL_FIELD,
        )
        self.assertTrue(has_declaration(section, BEACH_MATERIAL_FIELD))
        self.assertEqual(
            declaration_count(section, BEACH_MATERIAL_FIELD),
            1,
        )
        self.assertTrue(
            BEACH_MATERIAL_FIELD.startswith(
                "TObjectPtr<UMaterialInterface> "
            ),
            BEACH_MATERIAL_FIELD,
        )
        self.assertTrue(BEACH_MATERIAL_FIELD.endswith(";"), BEACH_MATERIAL_FIELD)
        self.assertIn("BeachMaterial", BEACH_MATERIAL_FIELD)
        self.assertIn(
            "UMaterialInterface",
            BEACH_MATERIAL_FIELD,
        )
        self.assertIn("TObjectPtr<", BEACH_MATERIAL_FIELD)
        self.assertNotIn("=", BEACH_MATERIAL_FIELD)
        self.assertNotIn("float", BEACH_MATERIAL_FIELD)
        self.assertNotIn("TArray<", BEACH_MATERIAL_FIELD)
        self.assertNotIn("TSoftObjectPtr", BEACH_MATERIAL_FIELD)
        self.assertNotIn("nullptr", BEACH_MATERIAL_FIELD)
        self.assertNotIn("OceanMaterial", BEACH_MATERIAL_FIELD)
        self.assertNotIn("LandMaterial", BEACH_MATERIAL_FIELD)
        self.assertNotIn("INDEX_NONE", BEACH_MATERIAL_FIELD)
        self.assertNotIn("UFUNCTION", BEACH_MATERIAL_FIELD)
        self.assertNotIn("{", BEACH_MATERIAL_FIELD)
        self.assertNotIn("}", BEACH_MATERIAL_FIELD)
        self.assertNotIn("return ", BEACH_MATERIAL_FIELD)
        self.assertNotIn("OceanTiles", BEACH_MATERIAL_FIELD)
        self.assertNotIn("LandTiles", BEACH_MATERIAL_FIELD)
        self.assertNotIn("RouteExclusion", BEACH_MATERIAL_FIELD)
        self.assertNotIn("IsRouteExclusionSafe", BEACH_MATERIAL_FIELD)
        self.assertNotIn("bRouteExclusionValid", BEACH_MATERIAL_FIELD)
        self.assertNotIn("BeachTiles", BEACH_MATERIAL_FIELD)
        self.assertNotIn("InlandVegetationPCG", BEACH_MATERIAL_FIELD)
        self.assertNotIn("LandScatterBounds", BEACH_MATERIAL_FIELD)
        self.assertNotIn("ProductionLandscape", BEACH_MATERIAL_FIELD)
        self.assertNotIn("AuthoredPCGGraph", BEACH_MATERIAL_FIELD)
        self.assertNotIn("RouteLengthCm", BEACH_MATERIAL_FIELD)
        self.assertNotIn("RouteCorridorHalfWidthCm", BEACH_MATERIAL_FIELD)
        self.assertNotIn("ShorelineLandOffsetCm", BEACH_MATERIAL_FIELD)
        self.assertNotIn("BeachWidthCm", BEACH_MATERIAL_FIELD)
        self.assertNotIn("DistrictLengthCm", BEACH_MATERIAL_FIELD)
        self.assertNotIn("SeawardExtentCm", BEACH_MATERIAL_FIELD)
        self.assertNotIn("InlandExtentCm", BEACH_MATERIAL_FIELD)
        self.assertNotIn("OceanMaterial", BEACH_MATERIAL_FIELD)
        self.assertNotIn("LandMaterial", BEACH_MATERIAL_FIELD)
        self.assertNotIn("bUseAuthoredLandscapeSurface", BEACH_MATERIAL_FIELD)
        self.assertNotIn(
            "bLicensedVegetationLibraryApproved",
            BEACH_MATERIAL_FIELD,
        )
        ...
        self.assertNotIn("Root", BEACH_MATERIAL_FIELD)
        self.assertNotIn("GetReadiness", BEACH_MATERIAL_FIELD)
        self.assertNotIn("Briefing", BEACH_MATERIAL_FIELD)
        self.assertNotIn("AudioDirector", BEACH_MATERIAL_FIELD)
        self.assertNotIn("RadioChatter", BEACH_MATERIAL_FIELD)
        self.assertNotIn("SortiePresentation", BEACH_MATERIAL_FIELD)
        self.assertNotIn("CampaignDefinition", BEACH_MATERIAL_FIELD)
        self.assertNotIn("MissionDefinition", BEACH_MATERIAL_FIELD)
        self.assertNotIn("bAllowBoundedActorSpawning", BEACH_MATERIAL_FIELD)
        self.assertNotIn("bAutoInitialize", BEACH_MATERIAL_FIELD)
        self.assertNotIn("bAutoLaunchAfterBriefing", BEACH_MATERIAL_FIELD)
        self.assertNotIn("PathfinderSpawnLocation", BEACH_MATERIAL_FIELD)
        self.assertNotIn("GetAircraft", BEACH_MATERIAL_FIELD)
        self.assertNotIn("ConfigureFromMission", BEACH_MATERIAL_FIELD)
        self.assertNotIn("AdvanceBriefing", BEACH_MATERIAL_FIELD)
        self.assertNotIn("SetAssetsReady", BEACH_MATERIAL_FIELD)
        self.assertNotIn("AcknowledgeAndLaunch", BEACH_MATERIAL_FIELD)
        self.assertNotIn("CanLaunch", BEACH_MATERIAL_FIELD)
        self.assertNotIn("GetElapsedSeconds", BEACH_MATERIAL_FIELD)
        self.assertNotIn("GetBriefingState", BEACH_MATERIAL_FIELD)
        self.assertNotIn("GetMinimumWarmupSeconds", BEACH_MATERIAL_FIELD)
        self.assertNotIn("GetBriefingText", BEACH_MATERIAL_FIELD)
        self.assertNotIn("GetRadioChatter", BEACH_MATERIAL_FIELD)
        self.assertNotIn("GetPresentation", BEACH_MATERIAL_FIELD)
        self.assertNotIn("GetMissionTitle", BEACH_MATERIAL_FIELD)
        self.assertNotIn("AcknowledgeBriefing", BEACH_MATERIAL_FIELD)
        self.assertNotIn("LaunchSortie", BEACH_MATERIAL_FIELD)
        self.assertNotIn("HullCollider", BEACH_MATERIAL_FIELD)
        self.assertNotIn("OpticalTracker", BEACH_MATERIAL_FIELD)
        self.assertNotIn("WeaponServo", BEACH_MATERIAL_FIELD)
        self.assertNotIn("CountermeasurePod", BEACH_MATERIAL_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", BEACH_MATERIAL_FIELD)
        self.assertNotIn("RadarNode", BEACH_MATERIAL_FIELD)
        self.assertNotIn("ESkyguardMission02WaveState", BEACH_MATERIAL_FIELD)
        self.assertNotIn("HarborIndustrial", BEACH_MATERIAL_FIELD)
        self.assertNotIn("MaxIntegrity", BEACH_MATERIAL_FIELD)
        self.assertNotIn("CurrentIntegrity", BEACH_MATERIAL_FIELD)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, BEACH_MATERIAL_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty = (
            "public:\n"
            f"\t{UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS}\n"
            f"\t{BEACH_MATERIAL_FIELD}\n"
            "};\n"
        )
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION01_ENVIRONMENT_MATERIALS} {BEACH_MATERIAL_FIELD}\n"
            "};\n"
        )
        ...
        header_wrap_uproperty_split_spec = (
            f"class SKYGUARD52_API {CLASS_NAME} "
            f": public AActor\n{{\n{wrap_uproperty_split_spec}"
        )
        for header in (
        ...
        one_line = f"{{\npublic:\n\t{BEACH_MATERIAL_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, BEACH_MATERIAL_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, BEACH_MATERIAL_FIELD),
            section,
    ...
    def test_assigned_beach_material_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<UMaterialInterface> BeachMaterial = nullptr;\n"
        )
        invented_init = (
        ...
        wrong_type = "\tfloat BeachMaterial;\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, BEACH_MATERIAL_FIELD)
        self.assertIn("BeachMaterial", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, BEACH_MATERIAL_FIELD))
        with self.assertRaises(AssertionError) as raised_invented:
            require_declaration(invented_init, BEACH_MATERIAL_FIELD)
        self.assertIn("BeachMaterial", str(raised_invented.exception))
        self.assertFalse(has_declaration(invented_init, BEACH_MATERIAL_FIELD))
        with self.assertRaises(AssertionError) as raised_wrong:
            require_declaration(wrong_type, BEACH_MATERIAL_FIELD)
        self.assertIn("BeachMaterial", str(raised_wrong.exception))
        self.assertFalse(has_declaration(wrong_type, BEACH_MATERIAL_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("BeachMaterial", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, BEACH_MATERIAL_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{BEACH_MATERIAL_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, BEACH_MATERIAL_FIELD)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            BEACH_MATERIAL_FIELD.startswith("UFUNCTION"),
            BEACH_MATERIAL_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", BEACH_MATERIAL_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_beach_material_cpp_body(self) -> None:
        locked_only = f"{BEACH_MATERIAL_FIELD}\n"
        self.assertNotIn("{", BEACH_MATERIAL_FIELD)
        self.assertNotIn("}", BEACH_MATERIAL_FIELD)
        self.assertNotIn("return ", BEACH_MATERIAL_FIELD)
        ...
        self.assertNotIn("return false", BEACH_MATERIAL_FIELD)
        self.assertNotIn("return true", BEACH_MATERIAL_FIELD)
        self.assertNotIn("CreateDefaultSubobject", BEACH_MATERIAL_FIELD)
    ...
    def test_contract_does_not_relock_sibling_environment_fields(self) -> None:
        ...
        for token in SIBLING_ENVIRONMENT_FIELDS_NOT_LOCKED:
            ...
            self.assertNotIn(token, BEACH_MATERIAL_FIELD)
        self.assertIn("BeachMaterial", BEACH_MATERIAL_FIELD)
        self.assertTrue(
            BEACH_MATERIAL_FIELD.startswith(
                "TObjectPtr<UMaterialInterface> "
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, BEACH_MATERIAL_FIELD)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_relock_leftover_get_readiness(self) -> None:
        ...
        self.assertNotIn(GET_READINESS, BEACH_MATERIAL_FIELD)
        self.assertNotIn(GET_READINESS_DECL, locked_only)
        self.assertNotIn(GET_READINESS_DECL, BEACH_MATERIAL_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", BEACH_MATERIAL_FIELD)
        self.assertNotIn("CurrentIntegrity", BEACH_MATERIAL_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", BEACH_MATERIAL_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, BEACH_MATERIAL_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", BEACH_MATERIAL_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{BEACH_MATERIAL_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, BEACH_MATERIAL_FIELD),
            BEACH_MATERIAL_FIELD,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, BEACH_MATERIAL_FIELD)
        ...
        self.assertNotIn("BeachWidthCm", locked_only)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertEqual(declaration_count(section, BEACH_MATERIAL_FIELD), 1)
        self.assertNotIn(
            "SkyguardMission01EnvironmentDirector.cpp",
            section,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 BeachMaterial field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{BEACH_MATERIAL_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, BEACH_MATERIAL_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                BEACH_MATERIAL_FIELD.lower(),
                "mission01 BeachMaterial contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live cop" + "y",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, BEACH_MATERIAL_FIELD)

    def test_contract_is_beach_material_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertIn("BeachMaterial", BEACH_MATERIAL_FIELD)
        self.assertTrue(BEACH_MATERIAL_FIELD.endswith(";"))
        self.assertNotIn("=", BEACH_MATERIAL_FIELD)
        self.assertIn("TObjectPtr<", BEACH_MATERIAL_FIELD)
        self.assertNotIn("OceanMaterial", BEACH_MATERIAL_FIELD)
        self.assertNotIn("LandMaterial", BEACH_MATERIAL_FIELD)
    ...
    def test_sibling_environment_fields_do_not_satisfy_beach_material(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, BEACH_MATERIAL_FIELD))
            self.assertNotEqual(BEACH_MATERIAL_FIELD, leftover)
        self.assertIn(
            "Scripts/tests/test_mission01_ocean_tiles"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
    ...
    def test_sibling_director_fields_do_not_satisfy_beach_material(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_preceding_comment_block_is_not_the_declaration(self) -> None:
        comment_only = (
            "\t/**\n"
            "\t * Mission 1 beach tile material is authored separately.\n"
            "\t * This comment is not the BeachMaterial declaration.\n"
            "\t */\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(comment_only, BEACH_MATERIAL_FIELD)
        self.assertIn("BeachMaterial", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(
            has_declaration(comment_only, BEACH_MATERIAL_FIELD)
        )
        self.assertNotIn(
            "TObjectPtr<UMaterialInterface> BeachMaterial;",
            comment_only,
    ...
    def test_contract_does_not_relock_leftover_layout_floats(
        ...
        for token in LEFTOVER_LAYOUT_FLOATS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, BEACH_MATERIAL_FIELD)
            self.assertNotEqual(token, BEACH_MATERIAL_FIELD)
        self.assertNotEqual(BEACH_MATERIAL_FIELD, INLAND_EXTENT_CM_FIELD)
        self.assertNotEqual(BEACH_MATERIAL_FIELD, BEACH_WIDTH_CM_FIELD)
        self.assertNotEqual(BEACH_MATERIAL_FIELD, SEAWARD_EXTENT_CM_FIELD)
        self.assertNotIn("18000.f", BEACH_MATERIAL_FIELD)
        self.assertNotIn("1800.f", BEACH_MATERIAL_FIELD)

    def test_contract_does_not_relock_leftover_materials(
        self,
    ) -> None:
        locked_only = f"{BEACH_MATERIAL_FIELD}\n"
        for token in LEFTOVER_MATERIALS_NOT_LOCKED:
            ...
            self.assertNotIn(token, BEACH_MATERIAL_FIELD)
            self.assertNotEqual(token, BEACH_MATERIAL_FIELD)
        self.assertNotEqual(BEACH_MATERIAL_FIELD, OCEAN_MATERIAL_FIELD)
        self.assertNotEqual(BEACH_MATERIAL_FIELD, LAND_MATERIAL_FIELD)
        self.assertIn(
            "Scripts/tests/test_mission01_ocean_material"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
