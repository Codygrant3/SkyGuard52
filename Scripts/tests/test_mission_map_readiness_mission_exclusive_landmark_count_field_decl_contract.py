...
# MissionExclusiveLandmarkCount FIELD (declaration-only;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe MissionMapReadiness
# MissionExclusiveLandmarkCount. THIS IS NOT leftover mission-map-
...
# RoutePointCount. LOCK those
# sibling scripts. LOCK in-flight leftover-safe
# MissionMapReadiness ObjectiveAnchorCount /
# LandmarkCount. Do not parse
...
# UPROPERTY(Transient).
# THIS IS leftover-safe MissionMapReadiness
# MissionExclusiveLandmarkCount. THIS IS NOT leftover Mission05
...
# merge #665 #666 #668-#673, or open drafts #674-#1160.
...
# MissionMapReadiness MissionExclusiveLandmarkCount
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 MissionExclusiveLandmarkCount = 0;
...
# MissionExclusiveLandmarkCount FIELD (declaration-only). It is
...
# drafts #674-#1160 including leftover Mission02
...
# drafts #674-#1160. Do not reopen leftover
...
TARGET = "int32 MissionExclusiveLandmarkCount = 0;"
TARGET_WRONG = "int32 MissionExclusiveLandmarkCount = 1;"
LOCKED_DECL = TARGET
...
class MissionMapReadinessMissionExclusiveLandmarkCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("MissionExclusiveLandmarkCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_mission_exclusive_landmark_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_mission_exclusive_landmark_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 MissionExclusiveLandmarkCount"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("MissionExclusiveLandmarkCount", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
			"\tint32\n"
            "\tMissionExclusiveLandmarkCount = 0;\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("MissionExclusiveLandmarkCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 MissionExclusiveLandmarkCount"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("MissionExclusiveLandmarkCount", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_mission_exclusive_landmark_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission_map_readiness_mission"
                "_exclusive_landmark_count_field_decl_contract.py"
            )
        )
        self.assertIn(
