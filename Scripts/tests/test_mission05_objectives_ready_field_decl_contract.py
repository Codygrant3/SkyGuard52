...
# Mission05 IntegrationReadiness bObjectivesReady
...
# NOT leftover Mission02 bObjectivesReady
# FIELD #867 / branch cursor/mission02-
# objectives-ready-field-decl-contract-c332,
# NOT leftover Mission03 bObjectivesReady
# FIELD #897 / branch cursor/mission03-
# objectives-ready-field-decl-contract-c332,
# NOT leftover Mission04 bObjectivesReady
# FIELD #930 / branch cursor/mission04-
# objectives-ready-field-decl-contract-c332,
# NOT leftover Mission10 bObjectivesReady
# FIELD #815 / branch cursor/mission10-
# objectives-ready-field-decl-contract-c332,
...
# bObjectivesReady FIELD #930, not leftover Mission02
# bObjectivesReady FIELD #867, not leftover Mission03
# bObjectivesReady FIELD #897, not leftover Mission10
# bObjectivesReady FIELD #815, not leftover Mission04
...
# drafts #674-#965 including leftover Mission02
...
OBJECTIVES_READY_FIELD = (
    "bool bObjectivesReady = false;"
)
OBJECTIVES_READY_TRUE = (
    "bool bObjectivesReady = true;"
)
LOCKED_DECL = OBJECTIVES_READY_FIELD
...
class Mission05ObjectivesReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        for header in (
            ...
            section = public_section(header)
            self.assertTrue(
                has_declaration(section, OBJECTIVES_READY_TRUE),
                section,
            )
            self.assertEqual(
                require_declaration(
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 bObjectivesReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 bObjectivesReady contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_objectives_ready"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_same_name_objectives_ready_contracts_stay_locked(
        ...
        for leftover in LEFTOVER_MISSION04_OBJECTIVES_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
