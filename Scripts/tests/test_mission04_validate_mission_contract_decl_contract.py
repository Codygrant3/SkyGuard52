...
# leftover spawn-location fields. Distinct from
# leftover Mission01 ValidateMissionContract #621 and leftover Mission03 ValidateMissionContract #646.
# Do NOT lock leftover convoy-route-state enum
# #d34e. Do NOT lock leftover Mission03
# wave-state enum #0242. Do NOT lock leftover
# Mission04 wave-state enum #bb22. Do NOT lock
# leftover GetSearchlightRuntime #7347.
...
# Substation methods InitializePlayableMission /
...
# GetMissionId / GetConvoyRouteAlpha /
...
# #614, leftover Mission01 ValidateMissionContract
# #621, leftover environment-readiness defaults
...
# isolated-test drafts #107–#663, leftover Apache
...
# Mission03 wave-state enum #0242 values. Do not
# lock leftover Mission04 wave-state enum #bb22.
...
class Mission04ValidateMissionContractDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_alpha = f"\t{GET_CONVOY_ROUTE_ALPHA}\n"
        ...
        leftover_validate = f"\t{GET_CONVOY_ROUTE_ALPHA}\n"
    ...
    def test_validate_mission_contract_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("Mission01IntegrationReadiness", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("Mission03IntegrationReadiness", VALIDATE_MISSION_CONTRACT)
        ...
        self.assertNotIn("GetConvoyWorldLocation", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetConvoyIntegrity", VALIDATE_MISSION_CONTRACT)
        ...
        self.assertNotIn("ESkyguardMission04WaveState", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("Mission04IntegrationReadiness", VALIDATE_MISSION_CONTRACT)
        ...
        self.assertNotIn("GetConvoyRouteAlpha", VALIDATE_MISSION_CONTRACT)
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(leftover_callable_convoy, UFUNCTION_INTEGRATION)
        ...
        self.assertNotIn(leftover_callable_convoy, UFUNCTION_INTEGRATION)
    ...
    def test_contract_does_not_lock_validate_mission_contract_cpp_body(self) -> None:
        ...
        self.assertNotIn("return Other", VALIDATE_MISSION_CONTRACT)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 ValidateMissionContract method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission04 ValidateMissionContract contains "
    ...
    def test_leftover_mission03_validate_mission_contract_does_not_satisfy(
        ...
        leftover = (
            ...
            "\tUFUNCTION(BlueprintCallable, "
            'Category="Skyguard|Mission03|Integration")\n'
            f"\t{M03_VALIDATE_MISSION_CONTRACT}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover)
