...
# THIS IS leftover-safe Mission09 PoolBudget
# MaxSimultaneousExplosions FIELD (declaration-only;
# EditAnywhere / BlueprintReadWrite int32 = 6;
# ClampMin 1 / ClampMax 12; one-line / split-line
# UPROPERTY wraps; origin/main has NO Category). PARSE
# FSkyguardMission09PoolBudget STRUCT
# public section only (after struct
# FSkyguardMission09PoolBudget, before
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission09 PoolBudget
# MaxSimultaneousExplosions. THIS IS NOT leftover Mission08
...
# Mission09 IntegrationReadiness WaveCount
# FIELD (declaration-only; EditAnywhere /
# BlueprintReadWrite int32 default 6,
# ClampMin 1 / ClampMax 12, one-line / split-line
# UPROPERTY wraps) on
# FSkyguardMission09PoolBudget. It is
# leftover-safe Mission09 PoolBudget
# MaxSimultaneousExplosions FIELD (declaration-only). It is
...
# with EditAnywhere / BlueprintReadWrite);
# accept that form, other one-line / split-line wraps,
# the origin/main `= 6` default,
...
# This field has no Category. Keep EditAnywhere /
# BlueprintReadWrite / int32. Assert ClampMin 1,
# ClampMax 12, default 6.
# This PoolBudget field sits after MaxActiveDecoys.
# Skip leftover b + Ya + kRuntimeReady forever (it sits
# after bMapAssemblyReady and before bGunnerReady). This contract
# is MaxSimultaneousExplosions after MaxActiveDecoys. Skip leftover
...
UPROPERTY_MISSION10_CLAMP = 'meta=(ClampMin="1", ClampMax="12")'
...
MAX_SIMULTANEOUS_EXPLOSIONS_WRONG = (
    "int32 MaxSimultaneousExplosions = 1;"
)
LOCKED_DECL = MAX_SIMULTANEOUS_EXPLOSIONS
MAX_ACTIVE_THREATS_FIELD = "int32 MaxActiveThreats = 24;"
POOL_CAPACITY_FIELD = "int32 PoolCapacity = 48;"
MAX_ACTIVE_DECOYS_FIELD = "int32 MaxActiveDecoys = 12;"
...
# an isolated Python MaxSimultaneousExplosions
...
def unlocked_neighbors() -> tuple[str, ...]:
    return (
        ...
        LAST_FLIGHT_SPAWN_ROTATION,
        AUTO_LAUNCH_AFTER_BRIEFING_FIELD,
        MAX_ACTIVE_THREATS_FIELD,
        POOL_CAPACITY_FIELD,
        MAX_ACTIVE_DECOYS_FIELD,
    )
...
class Mission09MaxSimultaneousExplosionsFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("MaxSimultaneousExplosions", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_max_simultaneous_explosions_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
            ...
            f"\t{MAX_ACTIVE_THREATS_FIELD}\n"
            f"\t{POOL_CAPACITY_FIELD}\n"
            f"\t{MAX_ACTIVE_DECOYS_FIELD}\n"
        )
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn("EditAnywhere", UPROPERTY_MISSION10)
        self.assertIn("BlueprintReadWrite", UPROPERTY_MISSION10)
        self.assertNotIn("VisibleAnywhere", UPROPERTY_MISSION10)
        self.assertNotIn("BlueprintReadOnly", UPROPERTY_MISSION10)
        self.assertNotIn("Category", UPROPERTY_MISSION10)
        self.assertIn(UPROPERTY_MISSION10_CLAMP, UPROPERTY_MISSION10)
        self.assertIn('ClampMin="1"', UPROPERTY_MISSION10)
        self.assertIn('ClampMax="12"', UPROPERTY_MISSION10)
        self.assertTrue(
            has_declaration(section, LOCKED_DECL),
            section,
        )
        ...
        self.assertIn("ClampMin", UPROPERTY_MISSION10)
    ...
    def test_max_simultaneous_explosions_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 MaxSimultaneousExplosions"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= 6;"), LOCKED_DECL)
        ...
        self.assertIn("EditAnywhere", UPROPERTY_MISSION10)
        self.assertIn("BlueprintReadWrite", UPROPERTY_MISSION10)
        self.assertIn("MaxSimultaneousExplosions", LOCKED_DECL)
        ...
        self.assertNotIn("MaxActiveDecoys", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_default_forms(self) -> None:
        wraps = (
            ...
            "int32 MaxSimultaneousExplosions = 12;",
            "int32 MaxSimultaneousExplosions = 1;",
            "bool bReady = false;",
            "int32 Integrity = 100;",
        )
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("MaxSimultaneousExplosions", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 MaxSimultaneousExplosions"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("MaxSimultaneousExplosions", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 MaxSimultaneousExplosions field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 MaxSimultaneousExplosions contains "
    ...
    def test_contract_is_max_simultaneous_explosions_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(LOCKED_DECL.startswith("int32 MaxSimultaneousExplosions"))
        self.assertIn("MaxSimultaneousExplosions", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("= 6;"))
        self.assertTrue(LOCKED_DECL.endswith(";"))
        self.assertNotIn("GetProtectedGroup", LOCKED_DECL)
        self.assertNotIn("FSkyguardMission10ProtectedRuntime", LOCKED_DECL)
        self.assertIn(UPROPERTY_MISSION10, section)

    def test_sibling_director_fields_do_not_satisfy_max_simultaneous_explosions(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_max_simultaneous_explosions"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_parse_director_class_or_storm_runtime(
        ...
        self.assertNotIn("FSkyguardMission09IntegrationReadiness", section)
        self.assertNotIn("FSkyguardMission09PoolRuntime", section)
        self.assertNotIn("FSkyguardMission09ProtectedTargetRuntime", section)
        self.assertNotIn("WaveCount", section)
        self.assertNotIn("ObjectiveCount", section)
        self.assertNotIn("ProtectedTargetCount", section)
        self.assertIn("MaxSimultaneousExplosions", section)
        self.assertIn("MaxActiveThreats", section)
        self.assertIn("PoolCapacity", section)
        self.assertIn("MaxActiveDecoys", section)
        readiness_only = (
    ...
    def test_leftover_same_name_wave_count_contracts_stay_locked(
        ...
        self.assertIn(
            "Scripts/tests/test_mission09_maximum_protected"
            "_target_integrity_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
