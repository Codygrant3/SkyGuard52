...
# INDEX_NONE or lock RescueHelicopterAnchor
# construction in the .cpp. This is leftover-safe
# Mission08 RescueHelicopterAnchor FIELD
...
# NOT leftover Mission08 Root (this-wave sibling)
# / branch cursor/mission08-root-field-decl-
...
# methods.
# not leftover Mission08 Root (this-wave sibling) /
# HoistCableAnchor (this-wave sibling) /
# SurvivorsAnchor / RaftsAnchor /
...
# drafts #674-#1043 including leftover Mission07
...
# Root (this-wave sibling) or leftover Mission08
# HoistCableAnchor (this-wave sibling).
...
LOCKED_DECL = RESCUE_HELICOPTER_ANCHOR
...
# an isolated Python RescueHelicopterAnchor
...
class Mission08RescueHelicopterAnchorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("RescueHelicopterAnchor", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_rescue_helicopter_anchor_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_rescue_helicopter_anchor_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertIn("RescueHelicopterAnchor", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("RescueHelicopterAnchor;", locked_only)
    ...
    def test_contract_is_rescue_helicopter_anchor_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_rescue_helicopter_anchor(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = (
            "\tTObjectPtr<USceneComponent> "
            "RescueHelicopterAnchor = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_rescue_helicopter_anchor_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_readiness_struct_does_not_satisfy_rescue_helicopter_anchor(self) -> None:
        leftover = (
    ...
    def test_hoist_window_runtime_struct_does_not_satisfy_rescue_helicopter_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_protected_target_runtime_struct_does_not_satisfy_rescue_helicopter_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_storm_runtime_struct_does_not_satisfy_rescue_helicopter_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_airfield_target_runtime_struct_does_not_satisfy_rescue_helicopter_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_struct_does_not_satisfy_rescue_helicopter_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_declaration_accepts_origin_main_default_forms(self) -> None:
        ...
        stem = "TObjectPtr<USceneComponent> RescueHelicopterAnchor"
