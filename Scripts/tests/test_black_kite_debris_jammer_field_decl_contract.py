...
# INDEX_NONE or lock DebrisJammer
...
# DebrisJammer;`); accept that form and
...
# Jammer, PowerBus as the primary assertion. Do
# not lock leftover sibling debris fields
# DebrisPortVane, DebrisStarboardVane as the
...
# Python DebrisJammer field declaration
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardBlackKiteBoss::DebrisJammer",
    "SkyguardBlackKiteBoss.cpp",
    "SetExposed",
...
class BlackKiteDebrisJammerFieldDeclContractTests(unittest.TestCase):
    def test_black_kite_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, DEBRIS_JAMMER_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, DEBRIS_JAMMER_FIELD)
        self.assertIn("DebrisJammer", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, DEBRIS_JAMMER_FIELD)
    ...
    def test_missing_debris_jammer_declaration_fails_closed(
        self,
    ) -> None:
        neighbors_only = (
            "\tASkyguardBlackKiteBoss();\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, DEBRIS_JAMMER_FIELD)
        self.assertIn("DebrisJammer", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, DEBRIS_JAMMER_FIELD)
        self.assertIn("DebrisJammer", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UPROPERTY", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("VisibleAnywhere", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("BlueprintReadOnly", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("Category", DEBRIS_JAMMER_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, DEBRIS_JAMMER_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, DEBRIS_JAMMER_FIELD)
        self.assertIn("DebrisJammer", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUStaticMeshComponent* DebrisJammer;\n"
        )
        as_array = (
        ...
        scene = (
            "\tTObjectPtr<USceneComponent> DebrisJammer;\n"
        )
        weak = (
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, DEBRIS_JAMMER_FIELD)
            self.assertIn("DebrisJammer", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_debris_jammer_declaration_matches_origin_main(
        self,
    ) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
        ...
        self.assertEqual(
            declaration_count(section, DEBRIS_JAMMER_FIELD),
            1,
        )
        self.assertTrue(
            DEBRIS_JAMMER_FIELD.startswith(
                "TObjectPtr<UStaticMeshComponent> "
            ),
            DEBRIS_JAMMER_FIELD,
        )
        self.assertTrue(
            DEBRIS_JAMMER_FIELD.endswith(";"),
            DEBRIS_JAMMER_FIELD,
        )
        self.assertIn("DebrisJammer", DEBRIS_JAMMER_FIELD)
        self.assertIn(
        ...
        self.assertIn("TObjectPtr<", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("TArray<", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("=", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("INDEX_NONE", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("UFUNCTION", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("{", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("}", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("return ", DEBRIS_JAMMER_FIELD)
        self.assertNotIn(
            "BeginTerminalStrikeCycle",
            DEBRIS_JAMMER_FIELD,
        )
        self.assertNotIn("OpenGuidanceArrayExposure", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("IssueClimbCommand", DEBRIS_JAMMER_FIELD)
        self.assertNotIn(
            "DivertWreckFromCivilians",
            DEBRIS_JAMMER_FIELD,
        )
        ...
        self.assertNotIn("GetCivilianSeparationMeters", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("GetFinaleStage", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("IsClimbCommandIssued", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("IsWreckDiverted", DEBRIS_JAMMER_FIELD)
        self.assertNotIn(
            "GetObjectiveMilestonesReached",
            DEBRIS_JAMMER_FIELD,
        )
        ...
        self.assertNotIn("GetChinMuzzleLocation", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("GetGunnerMount", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("FaceWorldLocation", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("StarboardGuidanceArray", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("CommandCore", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("SetSearchlightTracked", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("SetContactIdentified", DEBRIS_JAMMER_FIELD)
        self.assertNotIn(
            "SetFriendlySeparationMeters",
            DEBRIS_JAMMER_FIELD,
        )
        self.assertNotIn("SetLightningExposed", DEBRIS_JAMMER_FIELD)
        self.assertNotIn(
            "OpenUpperEngineExposure",
            DEBRIS_JAMMER_FIELD,
        )
        self.assertNotIn("HullCollider", DEBRIS_JAMMER_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, DEBRIS_JAMMER_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_PORT} {DEBRIS_JAMMER_FIELD}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{DEBRIS_JAMMER_FIELD}\n}}\n"
        self.assertTrue(
            has_declaration(one_line, DEBRIS_JAMMER_FIELD)
        )
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, DEBRIS_JAMMER_FIELD),
    ...
    def test_assigned_debris_jammer_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<UStaticMeshComponent> "
            "DebrisJammer = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, DEBRIS_JAMMER_FIELD)
        self.assertIn("DebrisJammer", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, DEBRIS_JAMMER_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        ...
        debris_port = "\tTObjectPtr<UStaticMeshComponent> DebrisPortVane;\n"
        debris_starboard = (
            "\tTObjectPtr<UStaticMeshComponent> DebrisStarboardVane;\n"
        )
        leftover_jammer = (
        ...
        for region in (
            ...
            self.assertIn("DebrisJammer", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, DEBRIS_JAMMER_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{DEBRIS_JAMMER_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, DEBRIS_JAMMER_FIELD)
        ...
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_PORT, section)
        self.assertTrue(has_declaration(section, DEBRIS_JAMMER_FIELD), section)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            DEBRIS_JAMMER_FIELD.startswith("UFUNCTION"),
            DEBRIS_JAMMER_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, DEBRIS_JAMMER_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", DEBRIS_JAMMER_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_debris_jammer_cpp_body(
        self,
    ) -> None:
        locked_only = f"{DEBRIS_JAMMER_FIELD}\n"
        self.assertNotIn("{", DEBRIS_JAMMER_FIELD)
        ...
        self.assertNotIn("return false", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("return true", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("CreateDefaultSubobject", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("SetExposed", DEBRIS_JAMMER_FIELD)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            DEBRIS_JAMMER_FIELD,
        )
        self.assertNotIn("SetBossPhase", DEBRIS_JAMMER_FIELD)
        self.assertNotIn(
    ...
    def test_contract_does_not_relock_begin_terminal_strike_cycle_sibling(
        ...
        for token in BEGIN_TERMINAL_STRIKE_CYCLE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("BeginTerminalStrikeCycle", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_divert_wreck_from_civilians_sibling(
        ...
        for token in DIVERT_WRECK_FROM_CIVILIANS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("DivertWreckFromCivilians", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_set_civilian_separation_meters_sibling(
        ...
        for token in SET_CIVILIAN_SEPARATION_METERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("SetCivilianSeparationMeters", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_apply_strike(), DEBRIS_JAMMER_FIELD)
        self.assertNotIn(leftover_is_lock_eligible(), locked_only)
        self.assertNotIn(leftover_is_lock_eligible(), DEBRIS_JAMMER_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, locked_only)
            self.assertNotIn(name, DEBRIS_JAMMER_FIELD)
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_sibling_black_kite_fields(self) -> None:
        ...
        for token in WEAK_POINT_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("PortNavigationVane", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("StarboardNavigationVane", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("PowerBus", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("DebrisPortVane", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("DebrisStarboardVane", DEBRIS_JAMMER_FIELD)
        self.assertNotIn(
            "TObjectPtr<USkyguardBossWeakPointComponent> Jammer;",
            DEBRIS_JAMMER_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_last_flight_fields(self) -> None:
        ...
        for token in LEFTOVER_LAST_FLIGHT_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("PortGuidanceArray", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("StarboardGuidanceArray", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("CommandCore", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("PortEngine", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_debris_getters(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("GetDefeatDebrisPieceCount", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("GetMaxDefeatDebrisPieces", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_port_strike_bay_mechanism(
        ...
        for token in LEFTOVER_PORT_STRIKE_BAY_MECHANISM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("PortStrikeBayMechanism", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_starboard_strike_bay_mechanism(
        ...
        for token in LEFTOVER_STARBOARD_STRIKE_BAY_MECHANISM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("StarboardStrikeBayMechanism", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_port_cooling_system(
        ...
        for token in LEFTOVER_PORT_COOLING_SYSTEM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("PortCoolingSystem", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_starboard_cooling_system(
        ...
        for token in LEFTOVER_STARBOARD_COOLING_SYSTEM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("StarboardCoolingSystem", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_searchlight_methods(
        ...
        for token in LEFTOVER_SEARCHLIGHT_METHODS_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("SetSearchlightTracked", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("IsSearchlightTracked", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_last_flight_jammer(self) -> None:
        ...
        self.assertNotIn("ASkyguardLastFlightBoss::Jammer", DEBRIS_JAMMER_FIELD)
        self.assertNotEqual(
            HEADER_PATH,
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("SetContactIdentified", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("OpenOrbitExposure", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("SetLightningExposed", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("ASkyguardTempestBoss", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_iron_rain(self) -> None:
        ...
        self.assertNotIn("ASkyguardIronRainBoss", DEBRIS_JAMMER_FIELD)
        self.assertNotIn(
            "ASkyguardIronRainBoss::IssueClimbCommand",
            DEBRIS_JAMMER_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        for token in LEFTOVER_PATROL_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("ASkyguardPatrolShip", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        ...
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            ...
            self.assertNotIn(neighbor, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("ASkyguardGunner", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("SkyguardRadarNode", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("MaxIntegrity", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("CurrentIntegrity", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_open_leftover_weak_point_component_header(
        ...
        self.assertNotIn(leftover_header, DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, DEBRIS_JAMMER_FIELD)
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        for token in HARBOR_ADJACENT_NOT_LOCKED:
            ...
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_JAMMER_FIELD)
        self.assertNotIn("MinimumCivilianSeparationMeters", DEBRIS_JAMMER_FIELD)
        self.assertNotIn("550.f", DEBRIS_JAMMER_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{DEBRIS_JAMMER_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, DEBRIS_JAMMER_FIELD),
            DEBRIS_JAMMER_FIELD,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "Black Kite DebrisJammer field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{DEBRIS_JAMMER_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, DEBRIS_JAMMER_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                DEBRIS_JAMMER_FIELD.lower(),
                "Black Kite DebrisJammer contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, DEBRIS_JAMMER_FIELD)

    def test_contract_is_debris_jammer_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(DEBRIS_JAMMER_FIELD.endswith(";"))
        self.assertNotIn("=", DEBRIS_JAMMER_FIELD)
        self.assertIn(UPROPERTY_PORT, section)
        self.assertIn("Skyguard|Boss|Destruction", UPROPERTY_PORT)
        self.assertNotIn("Mission04", UPROPERTY_PORT)
        self.assertNotIn("Mission10", UPROPERTY_PORT)
        self.assertNotIn("ASkyguardLastFlightBoss", DEBRIS_JAMMER_FIELD)
        self.assertNotIn(
            "test_last_flight_jammer_field_decl_contract.py",
            locked_only,
        )
