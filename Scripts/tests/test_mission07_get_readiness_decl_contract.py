...
# Mission07 Integration GetReadiness METHOD on
# ASkyguardMission07IntegrationDirector. It is
# NOT leftover Mission06 GetReadiness #697, NOT
...
class Mission07GetReadinessDeclContractTests(unittest.TestCase):
    ...
    def test_get_readiness_declaration_matches_origin_main(self) -> None:
        ...
        self.assertIn("FSkyguardMission07IntegrationReadiness", GET_READINESS)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 GetReadiness method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                GET_READINESS.lower(),
                "mission07 GetReadiness contains "
