...
# Mission09 SortiePresentation FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps) on
# ASkyguardMission09IntegrationDirector. It is
# NOT leftover Mission01 SortiePresentation #575 /
# branch cursor/mission01-sortie-presentation-
# field-decl-contract-c332, NOT leftover Mission02
# SortiePresentation #849 / branch cursor/
# mission02-sortie-presentation-field-decl-
# contract-c332, NOT leftover Mission03
# SortiePresentation #880 / branch cursor/
# mission03-sortie-presentation-field-decl-
# contract-c332, NOT leftover Mission04
# SortiePresentation #913 / branch cursor/
# mission04-sortie-presentation-field-decl-
# contract-c332, NOT leftover Mission05
# SortiePresentation #951 / branch cursor/
# mission05-sortie-presentation-field-decl-
# contract-c332, NOT leftover Mission06
# SortiePresentation #984 / branch cursor/
# mission06-sortie-presentation-field-decl-
# contract-c332, NOT leftover Mission07
# SortiePresentation / branch cursor/mission07-
# sortie-presentation-field-decl-contract-c332,
# NOT leftover Mission08 director SortiePresentation
# #1053 / branch cursor/mission08-sortie-
# presentation-field-decl-contract-c332, NOT leftover
# Mission08 readiness-struct bSortiePresentationReady
# #1078 / branch cursor/mission08-sortie-
# presentation-ready-field-decl-contract-c332, NOT leftover
# Mission10 SortiePresentation #797 / branch cursor/
# mission10-sortie-presentation-field-decl-contract-
# c332, NOT leftover Mission09 Root field
# #1083 / branch cursor/mission09-root-field-
# decl-contract-c332, NOT leftover Mission09
# SkylineAnchor #1084 / branch cursor/mission09-
# skyline-anchor-field-decl-contract-c332, NOT leftover
# Mission09 MajorBridgeAnchor #1085 / branch cursor/
# mission09-major-bridge-anchor-field-decl-contract-
# c332, NOT leftover Mission08 Root field
...
# (including leftover-safe struct bSortiePresentationReady if present),
...
# 06/07/08/10 director SortiePresentation and
# readiness-struct drafts. Lock leftover Mission07
...
# Lock leftover Mission09 Blueprint UFUNCTION
# methods InitializePlayableMission through
...
class Mission09SortiePresentationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 SortiePresentation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 SortiePresentation field contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission09_sortie_presentation_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_sortie_presentation_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_sortie_presentation"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission04_sortie_presentation"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission06_sortie_presentation"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
