...
# (different owning struct; already drafted). Fail if the
# parse window lands on FSkyguardLandscapeHeightSample.
...
# THIS IS NOT leftover FootprintSampleResult SupportedFraction.
# THIS IS NOT leftover FootprintSampleResult MinimumHeightCentimeters.
# THIS IS NOT leftover FootprintSampleResult MaximumHeightCentimeters.
# THIS IS NOT leftover FootprintSampleResult MeanHeightCentimeters.
# THIS IS NOT leftover FootprintSampleResult HeightDeltaCentimeters.
...
# Do not reopen leftover #536-#673, leftover Mission10 Integrity
# #826 / bDestroyed #827, leftover Mission05 #665 #666 #668-#673,
# or open drafts #674-#1196.
# THIS IS leftover-safe FSkyguardLandscapeFootprintSampleResult
# Error FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly FString Error; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# FSkyguardLandscapeFootprintSampleResult Error
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_landscape_footprint_sample_height_delta_centimeters_field_decl_contract.py",
...
class LandscapeFootprintSampleErrorFieldDeclContractTests(unittest.TestCase):
    def test_landscape_footprint_sample_result_struct_exists(self) -> None:
        ...
        self.assertIn("SupportedFraction", section)
        self.assertIn("MeanHeightCentimeters", section)
        self.assertIn("HeightDeltaCentimeters", section)
        self.assertIn("Samples", section)
    ...
    def test_parse_window_excludes_height_sample_error_field(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertNotIn("struct FSkyguardLandscapeHeightSample", section)
        self.assertNotIn("QueryLocation", section)
        ...
        self.assertIn("struct FSkyguardLandscapeHeightSample", polluted)
        self.assertGreater(declaration_count(polluted, LOCKED_DECL), 1)
