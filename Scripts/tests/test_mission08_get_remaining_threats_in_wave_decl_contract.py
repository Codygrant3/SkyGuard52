...
# Mission08 Waves GetRemainingThreatsInWave
...
# leftover Mission06 GetRemainingThreatsInWave
# #699, NOT leftover Mission05
...
# #658–#673. Do not reopen open drafts #674–#739.
...
class Mission08GetRemainingThreatsInWaveDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_get_remaining_threats_in_wave"
                "_decl_contract.py"
            )
        )
        self.assertIn(
