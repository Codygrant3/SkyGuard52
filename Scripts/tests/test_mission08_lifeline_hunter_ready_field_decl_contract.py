...
# INDEX_NONE or lock bLifelineHunterReady
# construction in the .cpp. This is leftover-safe
# Mission08 IntegrationReadiness bLifelineHunterReady
...
# FIELD (in-flight sibling) / branch cursor/
# mission08-gunner-ready-field-decl-
# contract-c332, NOT leftover Mission08 director
...
LIFELINE_HUNTER_READY_TRUE = (
    "bool bLifelineHunterReady = true;"
)
LOCKED_DECL = LIFELINE_HUNTER_READY
...
# an isolated Python bLifelineHunterReady
...
class Mission08LifelineHunterReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bLifelineHunterReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_lifeline_hunter_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_lifeline_hunter_ready_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bLifelineHunterReady"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bLifelineHunterReady", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bLifelineHunterReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bLifelineHunterReady"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bLifelineHunterReady", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 bLifelineHunterReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 bLifelineHunterReady contains "
    ...
    def test_contract_is_lifeline_hunter_ready_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_lifeline_hunter_ready(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
