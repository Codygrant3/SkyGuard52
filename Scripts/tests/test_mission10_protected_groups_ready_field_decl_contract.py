...
# INDEX_NONE or lock bProtectedGroupsReady
# construction in the .cpp. This is leftover-safe
# Mission10 IntegrationReadiness bProtectedGroupsReady
...
# gunner-decl-contract-c332, NOT leftover
...
PROTECTED_GROUPS_READY = (
    "bool bProtectedGroupsReady = false;"
)
LOCKED_DECL = PROTECTED_GROUPS_READY
...
# an isolated Python bProtectedGroupsReady
...
class Mission10ProtectedGroupsReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bProtectedGroupsReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_protected_groups_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_protected_groups_ready_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bProtectedGroupsReady"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= false;"), LOCKED_DECL)
        self.assertIn("bProtectedGroupsReady", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bProtectedGroupsReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bProtectedGroupsReady"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bProtectedGroupsReady", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 bProtectedGroupsReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission10 bProtectedGroupsReady contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_protected_groups_ready"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission10_last_flight_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
