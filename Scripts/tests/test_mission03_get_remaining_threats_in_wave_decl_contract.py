...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission03IntegrationDirector::GetRemainingThreatsInWave",
    "SkyguardMission03IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission03GetRemainingThreatsInWaveDeclContractTests(unittest.TestCase):
    def test_mission03_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, GET_REMAINING_THREATS),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, GET_REMAINING_THREATS)
    ...
    def test_missing_get_remaining_threats_in_wave_declaration_fails_closed(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, GET_REMAINING_THREATS)
        self.assertIn("GetRemainingThreatsInWave", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, GET_REMAINING_THREATS)
        self.assertIn("GetRemainingThreatsInWave", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", GET_REMAINING_THREATS)
        self.assertNotIn("BlueprintPure", GET_REMAINING_THREATS)
        self.assertNotIn("Category", GET_REMAINING_THREATS)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, GET_REMAINING_THREATS)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, GET_REMAINING_THREATS)
        self.assertIn("GetRemainingThreatsInWave", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = "\tvoid GetRemainingThreatsInWave() const;\n"
        as_const = "\tbool GetRemainingThreatsInWave() const;\n"
        as_int = "\tint32 GetRemainingThreatsInWave();\n"
        with_arg = (
            "\tint32 GetRemainingThreatsInWave(int32 Amount = 1) const;\n"
        )
        ...
        as_void_name = "\tvoid GetRemainingThreatsInWave();\n"
        renamed = "\tint32 GetRemainingThreats() const;\n"
        short_name = "\tint32 RemainingThreatsInWave;\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, GET_REMAINING_THREATS)
            self.assertIn("GetRemainingThreatsInWave", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_get_remaining_threats_in_wave_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(has_declaration(section, GET_REMAINING_THREATS))
        self.assertEqual(
            declaration_count(section, GET_REMAINING_THREATS),
            1,
        )
        self.assertTrue(
            GET_REMAINING_THREATS.startswith("int32 "),
            GET_REMAINING_THREATS,
        )
        self.assertTrue(
            GET_REMAINING_THREATS.endswith(" const"),
            GET_REMAINING_THREATS,
        )
        self.assertIn("GetRemainingThreatsInWave", GET_REMAINING_THREATS)
        self.assertNotIn("static ", GET_REMAINING_THREATS)
        self.assertNotIn(
            "const USkyguardMissionDefinition* Mission",
            GET_REMAINING_THREATS,
        )
        ...
        self.assertNotIn("EnvironmentReadiness", GET_REMAINING_THREATS)
        self.assertNotIn("MissionMapReadiness", GET_REMAINING_THREATS)
        self.assertNotIn("TObjectPtr", GET_REMAINING_THREATS)
        self.assertNotIn("TSoftObjectPtr", GET_REMAINING_THREATS)
        self.assertNotIn("INDEX_NONE", GET_REMAINING_THREATS)
        self.assertNotIn("UFUNCTION", GET_REMAINING_THREATS)
        self.assertNotIn("{", GET_REMAINING_THREATS)
        self.assertNotIn("}", GET_REMAINING_THREATS)
        self.assertNotIn("return ", GET_REMAINING_THREATS)
        self.assertNotIn(" const;", GET_REMAINING_THREATS)
        self.assertNotIn("Root", GET_REMAINING_THREATS)
        self.assertNotIn("Briefing", GET_REMAINING_THREATS)
        self.assertNotIn("AudioDirector", GET_REMAINING_THREATS)
        self.assertNotIn("RadioChatter", GET_REMAINING_THREATS)
        self.assertNotIn("SortiePresentation", GET_REMAINING_THREATS)
        self.assertNotIn("CampaignDefinition", GET_REMAINING_THREATS)
        self.assertNotIn("TSoftObjectPtr<USkyguardMissionDefinition>", GET_REMAINING_THREATS)
        self.assertNotIn("Readiness;", GET_REMAINING_THREATS)
        self.assertNotIn("bAutoInitialize", GET_REMAINING_THREATS)
        self.assertNotIn("bAllowBoundedActorSpawning", GET_REMAINING_THREATS)
        self.assertNotIn("bAutoLaunchAfterBriefing", GET_REMAINING_THREATS)
        self.assertNotIn("PathfinderSpawnLocation", GET_REMAINING_THREATS)
        self.assertNotIn("GetAircraft", GET_REMAINING_THREATS)
        self.assertNotIn("BindRuntimeActors", GET_REMAINING_THREATS)
        self.assertNotIn("HandleDroneCityImpact", GET_REMAINING_THREATS)
        self.assertNotIn("ConfigureMissionDefinition", GET_REMAINING_THREATS)
        self.assertNotIn("InitializePlayableMission", GET_REMAINING_THREATS)
        self.assertNotIn("NotifyProtectedAssetFailed", GET_REMAINING_THREATS)
        self.assertNotIn("SynchronizeRuntimeState", GET_REMAINING_THREATS)
        self.assertNotIn("NotifyObjectiveProgress", GET_REMAINING_THREATS)
        self.assertNotIn("IsCorePlayableReady", GET_REMAINING_THREATS)
        self.assertNotIn("GetObjectiveRuntime", GET_REMAINING_THREATS)
        self.assertNotIn("GetGunner", GET_REMAINING_THREATS)
        self.assertNotIn("GetPathfinder", GET_REMAINING_THREATS)
        self.assertNotIn("GetReadiness", GET_REMAINING_THREATS)
        self.assertNotIn("GetMissionId", GET_REMAINING_THREATS)
        self.assertNotIn("ValidateDefinition", GET_REMAINING_THREATS)
        self.assertNotIn("ConfigureFromMission", GET_REMAINING_THREATS)
        self.assertNotIn("AdvanceBriefing", GET_REMAINING_THREATS)
        self.assertNotIn("SetAssetsReady", GET_REMAINING_THREATS)
        self.assertNotIn("AcknowledgeAndLaunch", GET_REMAINING_THREATS)
        self.assertNotIn("CanLaunch", GET_REMAINING_THREATS)
        self.assertNotIn("GetElapsedSeconds", GET_REMAINING_THREATS)
        self.assertNotIn("GetBriefingState", GET_REMAINING_THREATS)
        self.assertNotIn("GetMinimumWarmupSeconds", GET_REMAINING_THREATS)
        self.assertNotIn("GetBriefingText", GET_REMAINING_THREATS)
        self.assertNotIn("GetRadioChatter", GET_REMAINING_THREATS)
        self.assertNotIn("GetPresentation", GET_REMAINING_THREATS)
        self.assertNotIn("GetMissionTitle", GET_REMAINING_THREATS)
        self.assertNotIn("AcknowledgeBriefing", GET_REMAINING_THREATS)
        self.assertNotIn("LaunchSortie", GET_REMAINING_THREATS)
        self.assertNotIn("HullCollider", GET_REMAINING_THREATS)
        self.assertNotIn("OpticalTracker", GET_REMAINING_THREATS)
        self.assertNotIn("WeaponServo", GET_REMAINING_THREATS)
        self.assertNotIn("CountermeasurePod", GET_REMAINING_THREATS)
        self.assertNotIn("MinHeightFromOriginCm", GET_REMAINING_THREATS)
        self.assertNotIn("RadarNode", GET_REMAINING_THREATS)
        self.assertNotIn("ESkyguardMission02WaveState", GET_REMAINING_THREATS)
        self.assertNotIn("ESkyguardMission03WaveState", GET_REMAINING_THREATS)
        self.assertNotIn("NotifyThreatDestroyed", GET_REMAINING_THREATS)
        self.assertNotIn("GetWaveState", GET_REMAINING_THREATS)
        self.assertNotIn("GetCurrentWaveIndex", GET_REMAINING_THREATS)
        self.assertNotIn("StartNextWave", GET_REMAINING_THREATS)
        self.assertNotIn("AdvanceConvoyByDistance", GET_REMAINING_THREATS)
        self.assertNotIn("NotifyConvoyDamage", GET_REMAINING_THREATS)
        self.assertNotIn("ValidateMissionContract", GET_REMAINING_THREATS)
        self.assertNotIn("HarborIndustrial", GET_REMAINING_THREATS)
        self.assertNotIn("MaxIntegrity", GET_REMAINING_THREATS)
        self.assertNotIn("CurrentIntegrity", GET_REMAINING_THREATS)
        self.assertNotIn("FillAndFinalize", GET_REMAINING_THREATS)
        self.assertNotIn("FillAndFail", GET_REMAINING_THREATS)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, GET_REMAINING_THREATS)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction = (
            "public:\n"
            f"\t{UFUNCTION_WAVES}\n"
            f"\t{GET_REMAINING_THREATS}\n"
            "};\n"
        )
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_WAVES} {GET_REMAINING_THREATS}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{GET_REMAINING_THREATS}\n}}\n"
        self.assertTrue(has_declaration(one_line, GET_REMAINING_THREATS))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, GET_REMAINING_THREATS),
            section,
    ...
    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        locked_only = f"{GET_REMAINING_THREATS}\n"
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, GET_REMAINING_THREATS)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", GET_REMAINING_THREATS)
        section = public_section(origin_main_header())
    ...
    def test_contract_does_not_lock_get_remaining_threats_in_wave_cpp_body(self) -> None:
        ...
        self.assertNotIn("return false", GET_REMAINING_THREATS)
        self.assertNotIn("return true", GET_REMAINING_THREATS)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{GET_REMAINING_THREATS}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_REMAINING_THREATS)
        self.assertIn("GetRemainingThreatsInWave", GET_REMAINING_THREATS)
        self.assertTrue(GET_REMAINING_THREATS.startswith("int32 "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, GET_REMAINING_THREATS)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, GET_REMAINING_THREATS)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", GET_REMAINING_THREATS)
        self.assertNotIn("CurrentIntegrity", GET_REMAINING_THREATS)
        self.assertNotIn("SkyguardApacheAircraft.h", GET_REMAINING_THREATS)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, GET_REMAINING_THREATS)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", GET_REMAINING_THREATS)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{GET_REMAINING_THREATS}\n"
        self.assertEqual(
            require_declaration(locked_only, GET_REMAINING_THREATS),
            GET_REMAINING_THREATS,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_REMAINING_THREATS)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 GetRemainingThreatsInWave method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{GET_REMAINING_THREATS}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, GET_REMAINING_THREATS.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                GET_REMAINING_THREATS.lower(),
                "mission03 GetRemainingThreatsInWave contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, GET_REMAINING_THREATS)
    ...
    def test_contract_is_get_remaining_threats_in_wave_declaration_only(
        ...
        self.assertNotIn("TArray<FText>& OutErrors", GET_REMAINING_THREATS)
        self.assertNotIn("static ", GET_REMAINING_THREATS)
        self.assertTrue(
            GET_REMAINING_THREATS.endswith(" const"),
            GET_REMAINING_THREATS,
        )
        self.assertFalse(GET_REMAINING_THREATS.endswith(";"))
        self.assertNotIn("EnvironmentReadiness", GET_REMAINING_THREATS)
        self.assertNotIn("MissionMapReadiness", GET_REMAINING_THREATS)
        self.assertIn(UFUNCTION_WAVES, section)
    ...
    def test_sibling_director_fields_do_not_satisfy_get_remaining_threats_in_wave(
        ...
        for leftover in (
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, GET_REMAINING_THREATS)
            )
            self.assertNotEqual(GET_REMAINING_THREATS, leftover)
        self.assertIn(
    ...
    def test_leftover_mission_definition_validate_does_not_satisfy(self) -> None:
        ...
        self.assertNotIn(MISSION_DEFINITION_VALIDATE, GET_REMAINING_THREATS)
        self.assertIn(
            "Scripts/tests/test_mission_definition_validate_definition"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        self.assertNotIn("}", GET_REMAINING_THREATS)
        self.assertNotIn("return ", GET_REMAINING_THREATS)
        self.assertNotIn("return 0", GET_REMAINING_THREATS)
        self.assertNotIn("return RemainingThreatsInWave", GET_REMAINING_THREATS)
        self.assertNotIn("return false", GET_REMAINING_THREATS)
        self.assertNotIn("return true", GET_REMAINING_THREATS)
