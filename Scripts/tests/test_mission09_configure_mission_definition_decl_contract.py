...
# Mission09 Integration ConfigureMissionDefinition
# METHOD on ASkyguardMission09IntegrationDirector.
# It is NOT leftover Mission08
# ConfigureMissionDefinition #730, NOT leftover
# Mission07 ConfigureMissionDefinition #705, NOT leftover
# Mission05 ConfigureMissionDefinition #665, NOT
# leftover Mission06 ConfigureMissionDefinition
# #688, NOT leftover Mission01 / Mission03 /
# Mission04 ConfigureMissionDefinition, NOT leftover
...
# leftover Mission04 ConfigureMissionDefinition,
# leftover Mission05 ConfigureMissionDefinition
# #665, leftover Mission06
# ConfigureMissionDefinition #688, leftover
# Mission07 ConfigureMissionDefinition, leftover
...
# #665, not leftover Mission06 Integration #688,
# not leftover Mission07 Integration, not leftover
# Mission08 Integration #730, not leftover
...
# ConfigureMissionDefinition method declaration
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission09_bind_runtime_actors_decl_contract.py",
...
SIBLING_INTEGRATION_METHODS_NOT_LOCKED = (
    ...
    "test_mission09_bind_runtime_actors_decl_contract.py",
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission07IntegrationDirector::ConfigureMissionDefinition",
...
LEFTOVER_MISSION09_POOL_NOT_LOCKED = (
...
class Mission09ConfigureMissionDefinitionDeclContractTests(unittest.TestCase):
    ...
    def test_configure_mission_definition_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("ASkyguardMission02IntegrationDirector", CONFIGURE_MISSION_DEFINITION)
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotIn(leftover_m08, UFUNCTION_INTEGRATION)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        # Leftover BindRuntimeActors may name IronRain on the public
        # section. Do not require that leftover decl; keep IronRain
        # off THIS locked ConfigureMissionDefinition method.
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 ConfigureMissionDefinition method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission09 ConfigureMissionDefinition contains "
    ...
    def test_leftover_harbor_mission02_configure_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tbool ConfigureMissionDefinition("
            "USkyguardMissionDefinition* Mission) { return false; }\n"
            "};\n"
        )
    ...
    def test_locked_scripts_include_sibling_mission08_contracts(self) -> None:
        ...
        for script in siblings:
            ...
            self.assertNotIn(script, CONFIGURE_MISSION_DEFINITION)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_configure_mission_definition"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission08_initialize(
        self,
    ) -> None:
        locked_only = f"{CONFIGURE_MISSION_DEFINITION}\n"
    ...
    def test_contract_does_not_relock_leftover_mission09_pool(self) -> None:
        locked_only = f"{CONFIGURE_MISSION_DEFINITION}\n"
        for token in LEFTOVER_MISSION09_POOL_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, CONFIGURE_MISSION_DEFINITION)
        self.assertIn(
    ...
    def test_contract_does_not_require_leftover_bind_runtime_actors(
        self,
    ) -> None:
        locked_only = f"{CONFIGURE_MISSION_DEFINITION}\n"
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        ...
        for token in leftover_spawn_name_tokens():
            ...
            self.assertNotIn(token, CONFIGURE_MISSION_DEFINITION)
        self.assertIn(
            "Scripts/tests/test_mission09_bind_runtime_actors"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
