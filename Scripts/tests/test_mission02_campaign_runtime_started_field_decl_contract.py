...
# Mission02 IntegrationReadiness bCampaignRuntimeStarted
...
# NOT leftover Mission10 bCampaignRuntimeStarted FIELD #822 /
# branch cursor/mission10-campaign-runtime-started-field-decl-
# contract-c332, NOT leftover Mission10 bAudioReady FIELD #821 /
# branch cursor/mission10-audio-ready-field-decl-contract-c332,
# NOT leftover Mission02 audio-ready FIELD sibling / branch
# cursor/mission02-audio-ready-field-decl-contract-c332,
# NOT leftover Mission10 CampaignDefinition #798 / leftover
# Mission02 CampaignDefinition #850 / leftover Mission01
# CampaignDefinition #577, NOT leftover director Readiness
# #860, NOT leftover Mission01 AudioDirector
# field #572, NOT leftover Mission02 AudioDirector
# director field #847, NOT leftover Mission10
# AudioDirector #794, NOT leftover Mission10
# bBriefingReady #819, NOT leftover Mission10
# bSortiePresentationReady #820, NOT leftover
# production-audio entry / audit / routing defaults,
# NOT leftover Mission02 gunner-ready / waves-ready /
# breakwater-ready / objectives-ready / briefing-ready /
# audio-ready / sortie-presentation-ready sibling
# readiness fields, NOT leftover director Readiness
...
# bCampaignRuntimeStarted #822, leftover Apache
...
# drafts #674-#870 including leftover Mission10
# bCampaignRuntimeStarted #822 / leftover Mission10
# bAudioReady #821 / leftover Mission10 bBriefingReady
# #819 / leftover Mission10 bSortiePresentationReady
# #820 / leftover Mission02 CampaignDefinition #850 /
# leftover director Readiness #860 and leftover Mission02
...
LEFTOVER_MISSION10_CAMPAIGN_RUNTIME_STARTED_FIELD_NOT_LOCKED = (
...
LEFTOVER_MISSION02_CAMPAIGN_DEFINITION_NOT_LOCKED = (
    "test_mission02_campaign_definition_field_decl_contract.py",
    "cursor/mission02-campaign-definition-field-decl-contract-c332",
    "CampaignDefinition",
)
...
LEFTOVER_PRODUCTION_AUDIO_NOT_LOCKED = (
    "test_production_audio_entry_defaults_contract.py",
    "test_production_audio_audit_defaults_contract.py",
    "test_production_audio_routing_defaults_contract.py",
    "cursor/production-audio-entry-defaults-contract-314b",
    "cursor/production-audio-audit-defaults-5e51",
    "cursor/production-audio-routing-defaults-fc92",
)
LEFTOVER_AUDIO_DIRECTOR_FIELD_NOT_LOCKED = (
    "test_mission01_audio_director_field_decl_contract.py",
    "test_mission02_audio_director_field_decl_contract.py",
    "test_mission10_audio_director_field_decl_contract.py",
    "cursor/mission01-audio-director-field-decl-contract-c332",
    "cursor/mission02-audio-director-field-decl-contract-c332",
    "cursor/mission10-audio-director-field-decl-contract-c332",
    "AudioDirector",
)
...
class Mission02CampaignRuntimeStartedFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 bCampaignRuntimeStarted field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 bCampaignRuntimeStarted contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_campaign_runtime_started"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
