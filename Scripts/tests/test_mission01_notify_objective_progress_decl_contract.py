...
# INDEX_NONE or lock NotifyObjectiveProgress
...
# (`bool NotifyObjectiveProgress(FName ObjectiveId,`
# ` int32 Amount = 1);`); accept that form, other
...
# NotifyObjectiveProgress method declaration
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission01IntegrationDirector::NotifyObjectiveProgress",
    "SkyguardMission01IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission01NotifyObjectiveProgressDeclContractTests(unittest.TestCase):
    def test_mission01_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, NOTIFY_OBJECTIVE_PROGRESS),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, NOTIFY_OBJECTIVE_PROGRESS)
        self.assertIn("NotifyObjectiveProgress", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, NOTIFY_OBJECTIVE_PROGRESS)
    ...
    def test_missing_notify_declaration_fails_closed(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, NOTIFY_OBJECTIVE_PROGRESS)
        self.assertIn("NotifyObjectiveProgress", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, NOTIFY_OBJECTIVE_PROGRESS)
        self.assertIn("NotifyObjectiveProgress", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("BlueprintCallable", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("Category", NOTIFY_OBJECTIVE_PROGRESS)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, NOTIFY_OBJECTIVE_PROGRESS)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, NOTIFY_OBJECTIVE_PROGRESS)
        self.assertIn("NotifyObjectiveProgress", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tvoid NotifyObjectiveProgress("
        ...
        no_args = "\tbool NotifyObjectiveProgress();\n"
        no_amount = "\tbool NotifyObjectiveProgress(FName ObjectiveId);\n"
        no_default = (
            "\tbool NotifyObjectiveProgress("
            "FName ObjectiveId, int32 Amount);\n"
        )
        swapped = (
            "\tbool NotifyObjectiveProgress("
            "int32 Amount, FName ObjectiveId);\n"
        )
        renamed = "\tbool NotifyObjective();\n"
        short_name = "\tbool NotifyProgress();\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, NOTIFY_OBJECTIVE_PROGRESS)
            self.assertIn("NotifyObjectiveProgress", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_notify_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(has_declaration(section, NOTIFY_OBJECTIVE_PROGRESS))
        self.assertEqual(
            declaration_count(section, NOTIFY_OBJECTIVE_PROGRESS),
            1,
        )
        self.assertTrue(
            NOTIFY_OBJECTIVE_PROGRESS.startswith("bool "),
            NOTIFY_OBJECTIVE_PROGRESS,
        )
        self.assertTrue(
            NOTIFY_OBJECTIVE_PROGRESS.endswith(";"),
            NOTIFY_OBJECTIVE_PROGRESS,
        )
        self.assertIn("NotifyObjectiveProgress", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertIn("FName ObjectiveId", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertIn("int32 Amount = 1", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("TArray<", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("TObjectPtr", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("TSoftObjectPtr", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("INDEX_NONE", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("UFUNCTION", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("{", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("}", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("return ", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("const;", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("Root", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("Briefing", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("AudioDirector", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("RadioChatter", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("SortiePresentation", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("CampaignDefinition", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("MissionDefinition", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("Readiness", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("bAutoInitialize", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("bAllowBoundedActorSpawning", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("bAutoLaunchAfterBriefing", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("PathfinderSpawnLocation", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("GetAircraft", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("BindRuntimeActors", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("HandleDroneCityImpact", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("ConfigureMissionDefinition", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("InitializePlayableMission", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("NotifyProtectedAssetFailed", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("SynchronizeRuntimeState", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("IsCorePlayableReady", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("GetReadiness", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("GetObjectiveRuntime", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("GetGunner", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("GetPathfinder", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("GetMissionId", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("ValidateMissionContract", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("ConfigureFromMission", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("AdvanceBriefing", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("SetAssetsReady", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("AcknowledgeAndLaunch", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("CanLaunch", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("GetElapsedSeconds", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("GetBriefingState", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("GetMinimumWarmupSeconds", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("GetBriefingText", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("GetRadioChatter", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("GetPresentation", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("GetMissionTitle", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("AcknowledgeBriefing", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("LaunchSortie", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("HullCollider", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("OpticalTracker", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("WeaponServo", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("CountermeasurePod", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("MinHeightFromOriginCm", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("RadarNode", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("ESkyguardMission02WaveState", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("HarborIndustrial", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("MaxIntegrity", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("CurrentIntegrity", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("FillAndFinalize", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("FillAndFail", NOTIFY_OBJECTIVE_PROGRESS)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, NOTIFY_OBJECTIVE_PROGRESS)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tbool\n"
            "\tNotifyObjectiveProgress(FName ObjectiveId, int32 Amount = 1);\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_INTEGRATION} {NOTIFY_OBJECTIVE_PROGRESS}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{NOTIFY_OBJECTIVE_PROGRESS}\n}}\n"
        self.assertTrue(has_declaration(one_line, NOTIFY_OBJECTIVE_PROGRESS))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, NOTIFY_OBJECTIVE_PROGRESS),
            section,
    ...
    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        locked_only = f"{NOTIFY_OBJECTIVE_PROGRESS}\n"
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, NOTIFY_OBJECTIVE_PROGRESS)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", NOTIFY_OBJECTIVE_PROGRESS)
        section = public_section(origin_main_header())
    ...
    def test_contract_does_not_lock_notify_cpp_body(self) -> None:
        ...
        self.assertNotIn("return false", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("return true", NOTIFY_OBJECTIVE_PROGRESS)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{NOTIFY_OBJECTIVE_PROGRESS}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_OBJECTIVE_PROGRESS)
        self.assertIn("NotifyObjectiveProgress", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertTrue(NOTIFY_OBJECTIVE_PROGRESS.startswith("bool "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, NOTIFY_OBJECTIVE_PROGRESS)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("CurrentIntegrity", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("SkyguardApacheAircraft.h", NOTIFY_OBJECTIVE_PROGRESS)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", NOTIFY_OBJECTIVE_PROGRESS)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{NOTIFY_OBJECTIVE_PROGRESS}\n"
        self.assertEqual(
            require_declaration(locked_only, NOTIFY_OBJECTIVE_PROGRESS),
            NOTIFY_OBJECTIVE_PROGRESS,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, NOTIFY_OBJECTIVE_PROGRESS)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 NotifyObjectiveProgress method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{NOTIFY_OBJECTIVE_PROGRESS}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, NOTIFY_OBJECTIVE_PROGRESS.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                NOTIFY_OBJECTIVE_PROGRESS.lower(),
                "mission01 NotifyObjectiveProgress contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, NOTIFY_OBJECTIVE_PROGRESS)

    def test_contract_is_notify_objective_progress_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertIn("FName ObjectiveId", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertIn("int32 Amount = 1", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertTrue(NOTIFY_OBJECTIVE_PROGRESS.endswith(";"))
        self.assertIn(UFUNCTION_INTEGRATION, section)
    ...
    def test_sibling_director_fields_do_not_satisfy_notify(
        ...
        for leftover in (
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, NOTIFY_OBJECTIVE_PROGRESS)
            )
            self.assertNotEqual(NOTIFY_OBJECTIVE_PROGRESS, leftover)
        self.assertIn(
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        self.assertNotIn("}", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("return ", NOTIFY_OBJECTIVE_PROGRESS)
        self.assertNotIn("return Other", NOTIFY_OBJECTIVE_PROGRESS)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission01_notify_objective_progress"
            "_decl_contract.py"
        )
