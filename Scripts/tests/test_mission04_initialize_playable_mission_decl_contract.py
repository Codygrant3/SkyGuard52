...
# Mission04 Integration InitializePlayableMission
...
# #608 or leftover Mission03 InitializePlayableMission
# #628. Distinct from leftover briefing-widget /
...
# #628, leftover Mission04 wave-state enum #bb22,
...
class Mission04InitializePlayableMissionDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 InitializePlayableMission method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission04 InitializePlayableMission contains "
