# THIS IS leftover-safe FSkyguardBossDefinition MaximumBreakupPieces.
...
# then `int32 MaximumBreakupPieces = 3;` (initializer IS `= 3`,
# no Category).
# THIS IS leftover-safe isolated UPROPERTY with no Category.
# EditAnywhere IS present. BlueprintReadOnly IS present.
# ClampMin = "0" IS present. ClampMax = "12" IS present.
# Initializer IS `= 3`. There is NO Category=.
# Spaces around `=` in meta ARE required.
# Fail-closed if the UPROPERTY or decl is missing
# or renamed, if EditAnywhere is dropped, if specifiers
# become BlueprintReadWrite / VisibleAnywhere-only,
# if Category= is added, if the type is not int32,
# if the initializer is not `= 3`, if meta ClampMin
# or ClampMax is missing or wrong, or if Harbor tokens
# built as 40 + ".f" / 80 + ".f" appear in the parse window.
# Accept one-line and split-line UPROPERTY wraps.
# Parse STRUCT `FSkyguardBossDefinition` body ONLY after
# `struct FSkyguardBossDefinition`. Stop at
# `struct FSkyguardWeatherProfile` and later structs
# (`FSkyguardMissionPresentation`,
# `FSkyguardMissionScoreRules`,
# `USkyguardMissionDefinition` if present).
# Do NOT parse leftover `FSkyguardBossWeakPointDefinition`
# (leftover defaults #188 / #2242 and isolated WeakPointId /
# RequiredWeapon / ExposesWeakPointId / Integrity field decls).
# Do NOT parse leftover `USkyguardBossWeakPointComponent`
# (#566-#573).
# Do NOT parse leftover `USkyguardMissionDefinition` Boss
# field #358.
# Do NOT parse leftover `FSkyguardObjectiveDefinition`,
# `FSkyguardObjectiveProgress`, `FSkyguardMissionScoreRules`,
# `FSkyguardRouteDefinition`.
# Do NOT parse leftover weather-profile-defaults
# #184 / #7dd0 or leftover weather-profile ProfileId.
# Do NOT parse leftover mission-types-defaults-tests
# #153 / #f47d (keep that bulk file in LOCKED_SCRIPTS).
# Do NOT contract sibling fields BossId / Callsign /
# WeakPoints / DefeatObjectiveId.
# Those sibling decls remain unclaimed.
# THIS IS NOT leftover boss-definition-defaults
# #187 / #cc27.
# Analog leftover boss-definition-defaults then this
# isolated MaximumBreakupPieces field decl, same as leftover
# weather-profile-defaults then isolated ProfileId,
# same as leftover briefing-card-defaults then CardId.
# THIS IS NOT leftover USkyguardMissionDefinition::Boss #358.
# THIS IS NOT leftover TheaterKitSpec #1299-#1314.
# THIS IS NOT leftover TheaterKit actor #1315-#1331.
...
# the bulk).
# Clone LOCKED_SCRIPTS / parse / fail-closed style from
# leftover-safe draft theater-kit-spec-weather-identity
# field decl #1300, then isolated per-field decl here.
# If a clone asserts VisibleAnywhere /
# Category="Skyguard|Theater" / BlueprintReadWrite /
# `FName WeatherIdentity` / `FName BossId` /
# `int32 CompletionScore` / no `=` / ClampMin missing /
# ClampMax missing, retarget: type is int32
# MaximumBreakupPieces, initializer is `= 3`, specifiers
# are EditAnywhere + BlueprintReadOnly +
# meta = (ClampMin = "0", ClampMax = "12"), no Category.
...
STRUCT_NAME = "FSkyguardBossDefinition"
WEATHER_PROFILE_NAME = "FSkyguardWeatherProfile"
WEAK_POINT_DEF_NAME = "FSkyguardBossWeakPointDefinition"
PRESENTATION_NAME = "FSkyguardMissionPresentation"
SCORE_RULES_NAME = "FSkyguardMissionScoreRules"
ENEMY_FORMATION_NAME = "FSkyguardEnemyFormationDefinition"
ENEMY_WAVE_NAME = "FSkyguardEnemyWaveDefinition"
ROUTE_DEFINITION_NAME = "FSkyguardRouteDefinition"
OBJECTIVE_DEFINITION_NAME = "FSkyguardObjectiveDefinition"
MISSION_DEFINITION_NAME = "USkyguardMissionDefinition"
COMPONENT_NAME = "USkyguardRadioChatterComponent"
ACTOR_NAME = "ASkyguardCampaignTheaterKit"
NAMESPACE_NAME = "SkyguardCampaignTheaterKit"
TARGET = "int32 MaximumBreakupPieces = 3;"
TARGET_WRONG_EQ_NONE = "int32 MaximumBreakupPieces = NAME_None;"
TARGET_WRONG_FALSE = "int32 MaximumBreakupPieces = false;"
TARGET_WRONG_TRUE = "int32 MaximumBreakupPieces = true;"
TARGET_WRONG_ZERO = "int32 MaximumBreakupPieces = 0;"
TARGET_WRONG_TWELVE = "int32 MaximumBreakupPieces = 12;"
TARGET_WRONG_FOUR = "int32 MaximumBreakupPieces = 4;"
TARGET_WRONG_FLOAT = "float MaximumBreakupPieces = 3;"
TARGET_WRONG_EMPTY = "int32 MaximumBreakupPieces;"
TARGET_WRONG_FNAME = "FName MaximumBreakupPieces;"
TARGET_WRONG_HEALTH = "float Health = 160.f;"
TARGET_WRONG_NO_CLAMP = (
    "UPROPERTY(EditAnywhere, BlueprintReadOnly)"
)
TARGET_WRONG_CLAMP_MAX = (
    "UPROPERTY(EditAnywhere, BlueprintReadOnly, "
    'meta = (ClampMin = "0", ClampMax = "24"))'
)
TARGET_WRONG_META_NOSPACE = (
    "UPROPERTY(EditAnywhere, BlueprintReadOnly, "
...
STOP_BEFORE_WEAK_POINT_DEF = "struct FSkyguardBossWeakPointDefinition"
STOP_BEFORE_OBJECTIVE_PROGRESS = "struct FSkyguardObjectiveProgress"
STOP_BEFORE_PRESENTATION = "struct FSkyguardMissionPresentation"
STOP_BEFORE_SCORE_RULES = "struct FSkyguardMissionScoreRules"
STOP_BEFORE_ENEMY_FORMATION = "struct FSkyguardEnemyFormationDefinition"
STOP_BEFORE_ENEMY_WAVE = "struct FSkyguardEnemyWaveDefinition"
STOP_BEFORE_ROUTE_DEFINITION = "struct FSkyguardRouteDefinition"
STOP_BEFORE_OBJECTIVE = "struct FSkyguardObjectiveDefinition"
STOP_BEFORE_MISSION_DEFINITION = "USkyguardMissionDefinition"
STOP_BEFORE_DELEGATE = "DECLARE_DYNAMIC_MULTICAST_DELEGATE"
STOP_BEFORE_COMPONENT = "class USkyguardRadioChatterComponent"
...
COMPONENT_PRIME_LINES = "PrimeLines"
COMPONENT_ENQUEUE_LINE = "EnqueueLine"
COMPONENT_ADVANCE_RADIO = "AdvanceRadioState"
COMPONENT_CLEAR_QUEUE = "ClearQueue"
COMPONENT_QUEUED_COUNT = "GetQueuedLineCount"
COMPONENT_CURRENT_LINE_ID = "GetCurrentLineId"
COMPONENT_DROPPED_COUNT = "GetDroppedLineCount"
COMPONENT_PLAYED_COUNT = "GetPlayedLineCount"
COMPONENT_MAX_QUEUED = "MaxQueuedLines"
COMPONENT_INTER_LINE_GAP = "InterLineGapSeconds"
COMPONENT_ON_STARTED = "OnLineStarted"
COMPONENT_ON_FINISHED = "OnLineFinished"
SIBLING_BOSS_ID = "BossId"
SIBLING_CALLSIGN = "Callsign"
SIBLING_WEAK_POINTS = "WeakPoints"
SIBLING_DEFEAT_OBJECTIVE_ID = "DefeatObjectiveId"
LEFTOVER_WEAK_POINT_ID = "WeakPointId"
LEFTOVER_REQUIRED_WEAPON = "RequiredWeapon"
LEFTOVER_EXPOSES_WEAK_POINT_ID = "ExposesWeakPointId"
LEFTOVER_WEAK_POINT_INTEGRITY = "Integrity"
SIBLING_WEATHER = "Weather"
SIBLING_TIME_OF_DAY = "TimeOfDayHours"
SIBLING_WIND_SPEED = "WindSpeedMetersPerSecond"
SIBLING_PRECIPITATION = "Precipitation"
SIBLING_CLOUD_COVERAGE = "CloudCoverage"
SIBLING_WORLD_LOCATION = "WorldLocation"
SIBLING_TARGET_AIRSPEED = "TargetAirspeedKph"
SIBLING_LOOK_AHEAD = "LookAheadSeconds"
SIBLING_ALLOW_COMBAT_ORBIT = "bAllowCombatOrbit"
SIBLING_SPEAKER = "Speaker"
SIBLING_SUBTITLE = "Subtitle"
SIBLING_SOUND = "Sound"
SIBLING_PRIORITY = "Priority"
SIBLING_ESTIMATED_DURATION = "EstimatedDurationSeconds"
SIBLING_COOLDOWN = "CooldownSeconds"
...
LEFTOVER_WEATHER_PROFILE_PROFILE_ID = (
    "Scripts/tests/test_weather_profile_profile_id"
    "_field_decl_contract.py"
)
LEFTOVER_BOSS_DEFINITION_DEFAULTS = (
    "Scripts/tests/test_boss_definition_defaults_contract.py"
)
LEFTOVER_BOSS_DEFINITION_DEFAULTS_PY = (
    "Scripts/tests/test_boss_definition_defaults.py"
)
LEFTOVER_BOSS_DEFINITION_DEFAULTS_TESTS = (
    "Scripts/tests/test_boss_definition_defaults_tests.py"
)
LEFTOVER_BOSS_WEAK_POINT_DEFAULTS = (
    "Scripts/tests/test_boss_weak_point_defaults_contract.py"
)
LEFTOVER_WEAK_POINT_ID_SCRIPT = (
    "Scripts/tests/test_boss_weak_point_definition_weak_point_id"
    "_field_decl_contract.py"
)
LEFTOVER_REQUIRED_WEAPON_SCRIPT = (
    "Scripts/tests/test_boss_weak_point_definition_required_weapon"
    "_field_decl_contract.py"
)
LEFTOVER_EXPOSES_WEAK_POINT_ID_SCRIPT = (
    "Scripts/tests/test_boss_weak_point_definition_exposes_weak_point_id"
    "_field_decl_contract.py"
)
LEFTOVER_WEAK_POINT_INTEGRITY_SCRIPT = (
    "Scripts/tests/test_boss_weak_point_definition_integrity"
    "_field_decl_contract.py"
)
LEFTOVER_MISSION_DEFINITION_BOSS = (
    "Scripts/tests/test_mission_definition_boss_decl_contract.py"
)
LEFTOVER_ROUTE_POINT_POINT_ID = (
    "Scripts/tests/test_route_point_point_id"
    "_field_decl_contract.py"
)
LEFTOVER_WEATHER_PROFILE_DEFAULTS = (
    "Scripts/tests/test_weather_profile_defaults_contract.py"
)
LEFTOVER_WEATHER_PROFILE_DEFAULTS_PY = (
    "Scripts/tests/test_weather_profile_defaults.py"
)
LEFTOVER_WEATHER_PROFILE_DEFAULTS_TESTS = (
    "Scripts/tests/test_weather_profile_defaults_tests.py"
)
LEFTOVER_MISSION_SCORE_RULES_DEFAULTS = (
    "Scripts/tests/test_mission_score_rules_defaults_contract.py"
)
LEFTOVER_ENEMY_FORMATION_DEFAULTS = (
    "Scripts/tests/test_enemy_formation_defaults_contract.py"
)
LEFTOVER_ENEMY_WAVE_DEFAULTS = (
    "Scripts/tests/test_enemy_wave_defaults_contract.py"
)
REMAINING_BOSS_ID_SCRIPT = (
    "Scripts/tests/test_boss_definition_boss_id"
    "_field_decl_contract.py"
)
REMAINING_CALLSIGN_SCRIPT = (
    "Scripts/tests/test_boss_definition_callsign"
    "_field_decl_contract.py"
)
REMAINING_WEAK_POINTS_SCRIPT = (
    "Scripts/tests/test_boss_definition_weak_points"
    "_field_decl_contract.py"
)
REMAINING_DEFEAT_OBJECTIVE_ID_SCRIPT = (
...
LEFTOVER_WEATHER_PROFILE_TIME_OF_DAY = (
    "Scripts/tests/test_weather_profile_time_of_day_hours"
    "_field_decl_contract.py"
)
LEFTOVER_WEATHER_PROFILE_WIND_SPEED = (
    "Scripts/tests/test_weather_profile_wind_speed_meters_per_second"
    "_field_decl_contract.py"
)
LEFTOVER_WEATHER_PROFILE_PRECIPITATION = (
    "Scripts/tests/test_weather_profile_precipitation"
    "_field_decl_contract.py"
)
LEFTOVER_WEATHER_PROFILE_CLOUD_COVERAGE = (
    "Scripts/tests/test_weather_profile_cloud_coverage"
    "_field_decl_contract.py"
)
LEFTOVER_RADIO_LINE_LINE_ID = (
    "Scripts/tests/test_radio_line_line_id"
    "_field_decl_contract.py"
)
LEFTOVER_RADIO_LINE_SPEAKER = (
    "Scripts/tests/test_radio_line_speaker"
    "_field_decl_contract.py"
)
LEFTOVER_RADIO_LINE_SUBTITLE = (
    "Scripts/tests/test_radio_line_subtitle"
    "_field_decl_contract.py"
)
...
LEFTOVER_RADIO_LINE_PRIORITY = (
    "Scripts/tests/test_radio_line_priority"
    "_field_decl_contract.py"
)
LEFTOVER_RADIO_LINE_DURATION = (
    "Scripts/tests/test_radio_line_estimated_duration_seconds"
    "_field_decl_contract.py"
)
LEFTOVER_RADIO_LINE_COOLDOWN = (
    "Scripts/tests/test_radio_line_cooldown_seconds"
    "_field_decl_contract.py"
)
LEFTOVER_ROUTE_POINT_DEFAULTS = (
    "Scripts/tests/test_route_point_defaults_contract.py"
)
LEFTOVER_ROUTE_POINT_DEFAULTS_PY = (
    "Scripts/tests/test_route_point_defaults.py"
)
LEFTOVER_ROUTE_POINT_DEFAULTS_TESTS = (
    "Scripts/tests/test_route_point_defaults_tests.py"
)
...
LEFTOVER_MISSION_DEFINITION_ROUTE = (
    "Scripts/tests/test_mission_definition_route_decl_contract.py"
)
LEFTOVER_MISSION_DEFINITION_OBJECTIVES = (
    "Scripts/tests/test_mission_definition_objectives_decl_contract.py"
)
LEFTOVER_MISSION_DEFINITION_WAVES = (
    "Scripts/tests/test_mission_definition_waves_decl_contract.py"
)
LEFTOVER_MISSION_DEFINITION_WEATHER = (
    "Scripts/tests/test_mission_definition_weather_decl_contract.py"
)
LEFTOVER_MISSION_DEFINITION_SCORE_RULES = (
    "Scripts/tests/test_mission_definition_score_rules_decl_contract.py"
)
SIBLING_WORLD_LOCATION_SCRIPT = (
    "Scripts/tests/test_route_point_world_location"
    "_field_decl_contract.py"
)
REMAINING_TARGET_AIRSPEED_SCRIPT = (
    "Scripts/tests/test_route_point_target_airspeed_kph"
    "_field_decl_contract.py"
)
REMAINING_LOOK_AHEAD_SCRIPT = (
    "Scripts/tests/test_route_point_look_ahead_seconds"
    "_field_decl_contract.py"
)
REMAINING_ALLOW_COMBAT_ORBIT_SCRIPT = (
    "Scripts/tests/test_route_point_allow_combat_orbit"
    "_field_decl_contract.py"
)
CLONE_HEALTH = (
...
LEFTOVER_RADIO_LINE_DEFAULTS = (
    "Scripts/tests/test_radio_line_defaults_contract.py"
)
LEFTOVER_PILOT_MAKE_RADIO_LINE = (
...
LEFTOVER_GET_LAMP_INSTANCE_COUNT = (
    "Scripts/tests/test_theater_kit_get_lamp_instance_count"
    "_decl_contract.py"
)
LEFTOVER_GET_SILHOUETTE_INSTANCE_COUNT = (
    "Scripts/tests/test_theater_kit_get_silhouette_instance_count"
    "_decl_contract.py"
)
LEFTOVER_APPLY_THEATER_KIT = (
...
def sibling_uncontracted_decls() -> tuple[str, ...]:
    return (
        ...
        SIBLING_CALLSIGN,
        SIBLING_WEAK_POINTS,
        SIBLING_DEFEAT_OBJECTIVE_ID,
    )


def leftover_weather_profile_siblings() -> tuple[str, ...]:
    return (
        SIBLING_WEATHER,
        SIBLING_TIME_OF_DAY,
        SIBLING_WIND_SPEED,
        SIBLING_PRECIPITATION,
        SIBLING_CLOUD_COVERAGE,
    )


def leftover_weak_point_fields() -> tuple[str, ...]:
    return (
        LEFTOVER_WEAK_POINT_ID,
        LEFTOVER_REQUIRED_WEAPON,
        LEFTOVER_EXPOSES_WEAK_POINT_ID,
        LEFTOVER_WEAK_POINT_INTEGRITY,
    )


def leftover_boss_defaults_scripts() -> tuple[str, ...]:
    return (
        LEFTOVER_BOSS_DEFINITION_DEFAULTS,
        LEFTOVER_BOSS_DEFINITION_DEFAULTS_PY,
        LEFTOVER_BOSS_DEFINITION_DEFAULTS_TESTS,
...
def leftover_route_point_siblings() -> tuple[str, ...]:
    return (
        SIBLING_WORLD_LOCATION,
        SIBLING_TARGET_AIRSPEED,
        SIBLING_LOOK_AHEAD,
        SIBLING_ALLOW_COMBAT_ORBIT,
    )


def leftover_radio_line_siblings() -> tuple[str, ...]:
    return (
        SIBLING_SPEAKER,
        SIBLING_SUBTITLE,
        SIBLING_SOUND,
        SIBLING_PRIORITY,
        SIBLING_ESTIMATED_DURATION,
        SIBLING_COOLDOWN,
    )


def leftover_radio_line_field_scripts() -> tuple[str, ...]:
    return (
        LEFTOVER_RADIO_LINE_LINE_ID,
        LEFTOVER_RADIO_LINE_SPEAKER,
        LEFTOVER_RADIO_LINE_SUBTITLE,
...
def leftover_route_point_scripts() -> tuple[str, ...]:
    return (
        LEFTOVER_ROUTE_POINT_DEFAULTS,
        LEFTOVER_ROUTE_POINT_DEFAULTS_PY,
        LEFTOVER_ROUTE_POINT_DEFAULTS_TESTS,
        ...
        LEFTOVER_ENEMY_FORMATION_DEFAULTS,
        LEFTOVER_ENEMY_WAVE_DEFAULTS,
    ) + leftover_boss_defaults_scripts()
...
def leftover_radio_defaults_scripts() -> tuple[str, ...]:
    return leftover_radio_line_field_scripts() + (
        LEFTOVER_RADIO_LINE_DEFAULTS,
        LEFTOVER_PILOT_MAKE_RADIO_LINE,
    )
...
def component_uncontracted_decls() -> tuple[str, ...]:
    return (
        COMPONENT_PRIME_LINES,
        COMPONENT_ENQUEUE_LINE,
        COMPONENT_ADVANCE_RADIO,
        COMPONENT_CLEAR_QUEUE,
        COMPONENT_QUEUED_COUNT,
        COMPONENT_CURRENT_LINE_ID,
        COMPONENT_DROPPED_COUNT,
        COMPONENT_PLAYED_COUNT,
        COMPONENT_MAX_QUEUED,
        COMPONENT_INTER_LINE_GAP,
        COMPONENT_ON_STARTED,
        COMPONENT_ON_FINISHED,
    )
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # Reject missing initializer, `= 0` / `= 12` / `= 4` /
    # Harbor 40/80 / leftover Health / float / FName /
    # sibling BossId. Do not accept sibling Callsign /
    # WeakPoints / DefeatObjectiveId.
    if not has_one_declaration(region, declaration):
        return False
    compact = collapsed(region)
    if re.search(
        r"int32\s+MaximumBreakupPieces\s*=\s*3\s*;",
        compact,
    ) is None:
        return False
    if re.search(
        r"int32\s+MaximumBreakupPieces\s*=\s*0\b",
        compact,
    ):
        return False
    if re.search(
        r"int32\s+MaximumBreakupPieces\s*=\s*12\b",
        compact,
    ):
        return False
    if re.search(
        r"int32\s+MaximumBreakupPieces\s*=\s*4\b",
        compact,
    ):
        return False
    if re.search(
        r"float\s+MaximumBreakupPieces\b",
        compact,
    ):
        return False
    if re.search(
        r"FName\s+MaximumBreakupPieces\b",
        compact,
    ):
        return False
    if re.search(
        r"int32\s+MaximumBreakupPieces\s*;",
        compact,
    ):
        return False
    return True
...
def leaked_neighbor_tokens() -> tuple[str, ...]:
    return (
        ...
        STOP_BEFORE_WEAK_POINT_DEF,
        STOP_BEFORE_OBJECTIVE_PROGRESS,
        STOP_BEFORE_PRESENTATION,
        STOP_BEFORE_SCORE_RULES,
        STOP_BEFORE_ENEMY_FORMATION,
        STOP_BEFORE_ENEMY_WAVE,
        STOP_BEFORE_ROUTE_DEFINITION,
        STOP_BEFORE_OBJECTIVE,
        STOP_BEFORE_MISSION_DEFINITION,
        STOP_BEFORE_DELEGATE,
        STOP_BEFORE_COMPONENT,
        ...
        f"class {ACTOR_NAME}",
        f"class SKYGUARD52_API {COMPONENT_NAME}",
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    while True:
        ...
        if depth == 0 and re.match(
            r"\s*int32\s+MaximumBreakupPieces\b", compact[index:]
        ):
            return compact[start : index - 1]
        cursor = cursor + match.start() + 1
    raise AssertionError(
        "UPROPERTY for int32 MaximumBreakupPieces is missing from "
...
def require_maximum_breakup_pieces_specifiers(section: str) -> str:
    specifiers = attached_uproperty_specifiers(section)
    if "EditAnywhere" not in specifiers:
        raise AssertionError(
            "EditAnywhere is missing from origin/main:"
            f"{HEADER_PATH} struct {STRUCT_NAME} "
            "MaximumBreakupPieces UPROPERTY"
        )
    if "BlueprintReadWrite" in specifiers:
        raise AssertionError(
            "BlueprintReadWrite instead of BlueprintReadOnly on "
            f"origin/main:{HEADER_PATH} struct {STRUCT_NAME} "
            "MaximumBreakupPieces"
        )
    if "BlueprintReadOnly" not in specifiers:
        raise AssertionError(
            "BlueprintReadOnly is missing from origin/main:"
            f"{HEADER_PATH} struct {STRUCT_NAME} "
            "MaximumBreakupPieces UPROPERTY"
        )
    if "Category" in specifiers:
        raise AssertionError(
            "Category= is added on origin/main:"
            f"{HEADER_PATH} struct {STRUCT_NAME} "
            "MaximumBreakupPieces UPROPERTY"
        )
    if "ClampMin" not in specifiers:
        raise AssertionError(
            "ClampMin is missing from origin/main:"
            f"{HEADER_PATH} struct {STRUCT_NAME} "
            "MaximumBreakupPieces UPROPERTY"
        )
    if 'ClampMin = "0"' not in specifiers:
        raise AssertionError(
            'ClampMin = "0" is missing or wrong on origin/main:'
            f"{HEADER_PATH} struct {STRUCT_NAME} "
            "MaximumBreakupPieces UPROPERTY"
        )
    if "ClampMax" not in specifiers:
        raise AssertionError(
            "ClampMax is missing from origin/main:"
            f"{HEADER_PATH} struct {STRUCT_NAME} "
            "MaximumBreakupPieces UPROPERTY"
        )
    if 'ClampMax = "12"' not in specifiers:
        raise AssertionError(
            'ClampMax = "12" is missing or wrong on origin/main:'
            f"{HEADER_PATH} struct {STRUCT_NAME} "
            "MaximumBreakupPieces UPROPERTY"
        )
    return specifiers
...
class BossDefinitionMaximumBreakupPiecesFieldDeclContractTests(unittest.TestCase):
    def test_boss_definition_struct_exists(self) -> None:
        ...
        self.assertNotEqual(STRUCT_NAME, WEATHER_PROFILE_NAME)
        self.assertNotEqual(STRUCT_NAME, WEAK_POINT_DEF_NAME)
        self.assertNotEqual(STRUCT_NAME, PRESENTATION_NAME)
        self.assertNotEqual(STRUCT_NAME, SCORE_RULES_NAME)
        self.assertNotEqual(STRUCT_NAME, ENEMY_FORMATION_NAME)
        self.assertNotEqual(STRUCT_NAME, ENEMY_WAVE_NAME)
        self.assertNotEqual(STRUCT_NAME, ROUTE_DEFINITION_NAME)
        self.assertNotEqual(STRUCT_NAME, OBJECTIVE_DEFINITION_NAME)
        self.assertNotEqual(STRUCT_NAME, MISSION_DEFINITION_NAME)
        self.assertNotEqual(STRUCT_NAME, COMPONENT_NAME)
        ...
        self.assertTrue(has_identifier(section, "MaximumBreakupPieces"), section)
        self.assertIn("UPROPERTY", section)
        self.assertIn(STOP_BEFORE_WEATHER_PROFILE, header)
        self.assertNotIn(STOP_BEFORE_WEATHER_PROFILE, section)
        self.assertNotIn(STOP_BEFORE_WEATHER_PROFILE, body)
        self.assertIn(STOP_BEFORE_WEAK_POINT_DEF, header)
        self.assertNotIn(STOP_BEFORE_WEAK_POINT_DEF, section)
        self.assertNotIn(STOP_BEFORE_WEAK_POINT_DEF, body)
        self.assertIn(STOP_BEFORE_OBJECTIVE_PROGRESS, header)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_PROGRESS, section)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_PROGRESS, body)
        self.assertIn(STOP_BEFORE_PRESENTATION, header)
        self.assertNotIn(STOP_BEFORE_PRESENTATION, section)
        self.assertNotIn(STOP_BEFORE_PRESENTATION, body)
        self.assertIn(STOP_BEFORE_SCORE_RULES, header)
        self.assertNotIn(STOP_BEFORE_SCORE_RULES, section)
        self.assertNotIn(STOP_BEFORE_SCORE_RULES, body)
        self.assertIn(STOP_BEFORE_ENEMY_FORMATION, header)
        self.assertNotIn(STOP_BEFORE_ENEMY_FORMATION, section)
        self.assertNotIn(STOP_BEFORE_ENEMY_FORMATION, body)
        self.assertIn(STOP_BEFORE_ENEMY_WAVE, header)
        self.assertNotIn(STOP_BEFORE_ENEMY_WAVE, section)
        self.assertNotIn(STOP_BEFORE_ENEMY_WAVE, body)
        self.assertIn(STOP_BEFORE_ROUTE_DEFINITION, header)
        self.assertNotIn(STOP_BEFORE_ROUTE_DEFINITION, section)
        self.assertNotIn(STOP_BEFORE_ROUTE_DEFINITION, body)
        self.assertIn(STOP_BEFORE_OBJECTIVE, header)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE, section)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE, body)
        self.assertNotIn(STOP_BEFORE_MISSION_DEFINITION, header)
        self.assertNotIn(STOP_BEFORE_MISSION_DEFINITION, section)
        self.assertNotIn(STOP_BEFORE_MISSION_DEFINITION, body)
        self.assertNotIn(STOP_BEFORE_DELEGATE, header)
        self.assertNotIn(STOP_BEFORE_DELEGATE, section)
        self.assertNotIn(STOP_BEFORE_DELEGATE, body)
        self.assertNotIn(COMPONENT_NAME, header)
        self.assertNotIn(COMPONENT_NAME, section)
        self.assertNotIn(COMPONENT_NAME, body)
        ...
        for method in component_uncontracted_decls():
    ...
    def test_missing_struct_fails_closed(self) -> None:
        with self.assertRaises(AssertionError) as raised:
            struct_body(
                "struct FSkyguardUnrelatedWeatherProfile\n{\n};\n"
            )
    ...
    def test_later_struct_declaration_does_not_satisfy(self) -> None:
        mixed = (
            f"{STOP_BEFORE_WEAK_POINT_DEF}\n"
            "{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
            ...
            "\tGENERATED_BODY()\n"
            "};\n"
            f"{STOP_BEFORE_WEATHER_PROFILE}\n"
            "{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
            f"{STOP_BEFORE_PRESENTATION}\n"
            "{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
            f"{STOP_BEFORE_SCORE_RULES}\n"
            "{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
            f"class {MISSION_DEFINITION_NAME} : public UPrimaryDataAsset\n"
            "{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            f"\tFSkyguardBossDefinition Boss;\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
        )
        section = spec_section(mixed)
        self.assertFalse(has_identifier(section, "MaximumBreakupPieces"), section)
        self.assertNotIn(STOP_BEFORE_WEAK_POINT_DEF, section)
        self.assertNotIn(STOP_BEFORE_WEATHER_PROFILE, section)
        self.assertNotIn(STOP_BEFORE_PRESENTATION, section)
        self.assertNotIn(STOP_BEFORE_SCORE_RULES, section)
        self.assertNotIn(STOP_BEFORE_MISSION_DEFINITION, section)
        self.assertNotIn(PRESENTATION_NAME, section)
        self.assertNotIn(SCORE_RULES_NAME, section)
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, LOCKED_DECL)
        self.assertIn("MaximumBreakupPieces", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_missing_maximum_breakup_pieces_declaration_fails_closed(self) -> None:
        empty = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            f"\tFText {SIBLING_CALLSIGN};\n"
            "};\n"
        )
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn("ClampMin", UPROPERTY_EDIT_READONLY)
        self.assertIn("ClampMax", UPROPERTY_EDIT_READONLY)
        self.assertIn('ClampMin = "0"', UPROPERTY_EDIT_READONLY)
        self.assertIn('ClampMax = "12"', UPROPERTY_EDIT_READONLY)
        self.assertIn('meta = (', UPROPERTY_EDIT_READONLY)
        self.assertNotIn("VisibleAnywhere", UPROPERTY_EDIT_READONLY)
        self.assertNotIn("BlueprintReadWrite", UPROPERTY_EDIT_READONLY)
        self.assertNotIn("Category", UPROPERTY_EDIT_READONLY)
        specifiers = require_maximum_breakup_pieces_specifiers(section)
        ...
        self.assertIn('ClampMax = "12"', specifiers)
    ...
    def test_initializer_fails_closed_when_not_3(self) -> None:
        initialized = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
        ...
        self.assertIn("int32 MaximumBreakupPieces = 3;", compact_origin)
        self.assertNotIn("MaximumBreakupPieces = NAME_None", compact_origin)
        self.assertNotIn("MaximumBreakupPieces = false", compact_origin)
        self.assertNotIn("MaximumBreakupPieces = true", compact_origin)
        self.assertNotIn("MaximumBreakupPieces = 0;", compact_origin)
        self.assertNotIn("MaximumBreakupPieces = 12;", compact_origin)
        self.assertNotIn("MaximumBreakupPieces = 160.f", compact_origin)

    def test_maximum_breakup_pieces_declaration_matches_origin_main(self) -> None:
        section = spec_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 MaximumBreakupPieces"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("= 3", LOCKED_DECL)
        ...
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_EMPTY}\n", LOCKED_DECL)
        )
        self.assertFalse(
    ...
    def test_wrong_default_and_renames_do_not_satisfy(self) -> None:
        leftover_primary = (
            "\tint32 " + leftover_retired_primary_hits_field() + " = 3;\n"
        )
        leftover_guided = (
            "\tint32 " + leftover_retired_guided_hits_field() + " = 3;\n"
        )
        forty = "40" + ".f"
        eighty = "80" + ".f"
        wrongs = (
            ...
            leftover_primary,
            leftover_guided,
            f"\tFText {SIBLING_SPEAKER};\n",
            f"\tFText {SIBLING_CALLSIGN};\n",
            f"\tFName {SIBLING_BOSS_ID};\n",
            "\tint32 MaximumBreakupPiecess = 3;\n",
            "\tint32 MaximumBreakupPieces;\n",
            "\tbool MaximumBreakupPieces;\n",
            "\tfloat MaximumBreakupPieces = " + forty + ";\n",
            "\tfloat MaximumBreakupPieces = " + eighty + ";\n",
            f"\t{TARGET_WRONG_TWELVE}\n",
            f"\t{TARGET_WRONG_FOUR}\n",
            f"\t{TARGET_WRONG_EMPTY}\n",
    ...
    def test_dropped_edit_anywhere_or_read_write_fails_closed(self) -> None:
        origin = require_maximum_breakup_pieces_specifiers(
        ...
        self.assertIn('ClampMin = "0"', origin)
        self.assertIn('ClampMax = "12"', origin)
        ...
        with self.assertRaises(AssertionError) as raised:
            require_maximum_breakup_pieces_specifiers(spec_section(no_edit))
        self.assertIn("EditAnywhere", str(raised.exception))
        read_write = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            "\tUPROPERTY(EditAnywhere, BlueprintReadWrite)\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_maximum_breakup_pieces_specifiers(spec_section(read_write))
        self.assertIn("BlueprintReadWrite", str(raised.exception))
        visible = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_maximum_breakup_pieces_specifiers(spec_section(visible))
        self.assertIn("EditAnywhere", str(raised.exception))
        with_category = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_maximum_breakup_pieces_specifiers(spec_section(with_category))
        self.assertIn("Category", str(raised.exception))
        category_specs = attached_uproperty_specifiers(
            spec_section(with_category)
        )
        ...
        no_clamp = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            f"\t{TARGET_WRONG_NO_CLAMP}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_maximum_breakup_pieces_specifiers(spec_section(no_clamp))
        self.assertIn("ClampMin", str(raised.exception))
        wrong_max = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            f"\t{TARGET_WRONG_CLAMP_MAX}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_maximum_breakup_pieces_specifiers(spec_section(wrong_max))
        self.assertIn("ClampMax", str(raised.exception))
        nospace = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            f"\t{TARGET_WRONG_META_NOSPACE}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_maximum_breakup_pieces_specifiers(spec_section(nospace))
        self.assertIn("ClampMin", str(raised.exception))
    ...
    def test_does_not_contract_sibling_boss_definition_fields(self) -> None:
        for sibling in sibling_uncontracted_decls():
            self.assertNotIn(sibling, LOCKED_DECL)
        for field in leftover_neighbor_hit_fields():
            self.assertNotIn(field, LOCKED_DECL)
        for leftover in leftover_theater_siblings():
            self.assertNotIn(leftover, LOCKED_DECL)
        for leftover in leftover_radio_line_siblings():
            self.assertNotIn(leftover, LOCKED_DECL)
        for leftover in leftover_route_point_siblings():
            self.assertNotIn(leftover, LOCKED_DECL)
        for leftover in leftover_weather_profile_siblings():
            self.assertNotIn(leftover, LOCKED_DECL)
        for leftover in leftover_weak_point_fields():
            self.assertNotIn(leftover, LOCKED_DECL)
        for method in component_uncontracted_decls():
            self.assertNotIn(method, LOCKED_DECL)
    ...
    def test_does_not_parse_weather_profile_or_neighbors(self) -> None:
        header = origin_main_header()
        section = spec_section(header)
        leaked = struct_body(header)
        self.assertIn(STOP_BEFORE_WEATHER_PROFILE, header)
        self.assertNotIn(STOP_BEFORE_WEATHER_PROFILE, section)
        self.assertNotIn(STOP_BEFORE_WEATHER_PROFILE, leaked)
        self.assertIn(STOP_BEFORE_WEAK_POINT_DEF, header)
        self.assertNotIn(STOP_BEFORE_WEAK_POINT_DEF, section)
        self.assertNotIn(STOP_BEFORE_WEAK_POINT_DEF, leaked)
        self.assertIn(STOP_BEFORE_OBJECTIVE_PROGRESS, header)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_PROGRESS, section)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_PROGRESS, leaked)
        self.assertIn(STOP_BEFORE_PRESENTATION, header)
        self.assertNotIn(STOP_BEFORE_PRESENTATION, section)
        self.assertNotIn(STOP_BEFORE_PRESENTATION, leaked)
        self.assertIn(STOP_BEFORE_SCORE_RULES, header)
        self.assertNotIn(STOP_BEFORE_SCORE_RULES, section)
        self.assertNotIn(STOP_BEFORE_SCORE_RULES, leaked)
        self.assertIn(STOP_BEFORE_ENEMY_FORMATION, header)
        self.assertNotIn(STOP_BEFORE_ENEMY_FORMATION, section)
        self.assertNotIn(STOP_BEFORE_ENEMY_FORMATION, leaked)
        self.assertIn(STOP_BEFORE_ENEMY_WAVE, header)
        self.assertNotIn(STOP_BEFORE_ENEMY_WAVE, section)
        self.assertNotIn(STOP_BEFORE_ENEMY_WAVE, leaked)
        self.assertIn(STOP_BEFORE_ROUTE_DEFINITION, header)
        self.assertNotIn(STOP_BEFORE_ROUTE_DEFINITION, section)
        self.assertNotIn(STOP_BEFORE_ROUTE_DEFINITION, leaked)
        self.assertIn(STOP_BEFORE_OBJECTIVE, header)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE, section)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE, leaked)
        self.assertNotIn(STOP_BEFORE_MISSION_DEFINITION, header)
        self.assertNotIn(STOP_BEFORE_MISSION_DEFINITION, section)
        self.assertNotIn(STOP_BEFORE_MISSION_DEFINITION, leaked)
        self.assertNotIn(STOP_BEFORE_DELEGATE, header)
        self.assertNotIn(STOP_BEFORE_DELEGATE, section)
        self.assertNotIn(STOP_BEFORE_DELEGATE, leaked)
        self.assertNotIn(COMPONENT_NAME, header)
        self.assertNotIn(COMPONENT_NAME, section)
        self.assertNotIn(COMPONENT_NAME, leaked)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        other = (
            f"\tFName {COMPONENT_CURRENT_LINE_ID}() const;\n"
            f"\tvoid {COMPONENT_PRIME_LINES}();\n"
            f"\tbool {COMPONENT_ENQUEUE_LINE}();\n"
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertNotIn("SkyguardMissionTypes.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardMissionDefinition.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardRadioChatterComponent.cpp", THIS_SCRIPT)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "boss-definition BossId field decl contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(Path(__file__).name.endswith(
            "boss_definition_maximum_breakup_pieces_field_decl_contract.py"
        ))
        self.assertNotIn("SkyguardMissionTypes.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardMissionDefinition.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardMissionTypes.cpp", THIS_SCRIPT)
        ...
        self.assertIn(LEFTOVER_RADIO_LINE_DEFAULTS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_RADIO_LINE_LINE_ID, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_ROUTE_POINT_DEFAULTS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_ROUTE_POINT_POINT_ID, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_WEATHER_PROFILE_DEFAULTS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_WEATHER_PROFILE_PROFILE_ID, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_BOSS_DEFINITION_DEFAULTS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_MISSION_DEFINITION_BOSS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_WEAK_POINT_ID_SCRIPT, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_MISSION_SCORE_RULES_DEFAULTS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_ENEMY_FORMATION_DEFAULTS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_ENEMY_WAVE_DEFAULTS, LOCKED_SCRIPTS)
        ...
        self.assertIn(LEFTOVER_MISSION_DEFINITION_ROUTE, LOCKED_SCRIPTS)
        self.assertIn(SIBLING_WORLD_LOCATION_SCRIPT, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_PILOT_MAKE_RADIO_LINE, LOCKED_SCRIPTS)
    ...
    def test_leftover_mission_result_defaults_stay_locked(self) -> None:
        leftovers = (
            ...
            *leftover_radio_defaults_scripts(),
            "Scripts/tests/test_briefing_card_defaults_contract.py",
            "Scripts/tests/test_briefing_radio_row_defaults_contract.py",
            "Scripts/tests/test_how_to_fly_row_defaults_contract.py",
            "Scripts/tests/test_briefing_card_priority_field_decl_contract.py",
    ...
    def test_sibling_boss_definition_fields_stay_unclaimed(self) -> None:
        remaining = (
            REMAINING_BOSS_ID_SCRIPT,
            REMAINING_CALLSIGN_SCRIPT,
            REMAINING_WEAK_POINTS_SCRIPT,
        ...
        for script in remaining:
            self.assertNotEqual(script, THIS_SCRIPT)
            self.assertNotIn(script, LOCKED_SCRIPTS)
    ...
    def test_contract_is_target_field_declaration_only(self) -> None:
        ...
        self.assertNotIn(COMPONENT_NAME, locked_only)
        self.assertNotIn(STOP_BEFORE_APPLY, locked_only)
        self.assertNotIn(STOP_BEFORE_NAMESPACE, locked_only)
        self.assertNotIn(STOP_BEFORE_DELEGATE, locked_only)
        self.assertNotIn(STOP_BEFORE_WEATHER_PROFILE, locked_only)
        self.assertNotIn(STOP_BEFORE_WEAK_POINT_DEF, locked_only)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_PROGRESS, locked_only)
        self.assertNotIn(STOP_BEFORE_PRESENTATION, locked_only)
        self.assertNotIn(STOP_BEFORE_SCORE_RULES, locked_only)
        self.assertNotIn(STOP_BEFORE_ENEMY_FORMATION, locked_only)
        self.assertNotIn(STOP_BEFORE_ENEMY_WAVE, locked_only)
        self.assertNotIn(STOP_BEFORE_ROUTE_DEFINITION, locked_only)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE, locked_only)
        self.assertNotIn(STOP_BEFORE_MISSION_DEFINITION, locked_only)
        self.assertNotIn(SIBLING_BOSS_ID, locked_only)
        self.assertNotIn(SIBLING_CALLSIGN, locked_only)
        self.assertNotIn(SIBLING_WEAK_POINTS, locked_only)
        self.assertNotIn(SIBLING_DEFEAT_OBJECTIVE_ID, locked_only)
        self.assertNotIn(LEFTOVER_WEAK_POINT_ID, locked_only)
        self.assertNotIn(LEFTOVER_REQUIRED_WEAPON, locked_only)
        self.assertNotIn(LEFTOVER_EXPOSES_WEAK_POINT_ID, locked_only)
        self.assertNotIn(SIBLING_WEATHER, locked_only)
        self.assertNotIn(SIBLING_TIME_OF_DAY, locked_only)
        self.assertNotIn(SIBLING_WIND_SPEED, locked_only)
        self.assertNotIn(SIBLING_PRECIPITATION, locked_only)
        self.assertNotIn(SIBLING_CLOUD_COVERAGE, locked_only)
        self.assertNotIn(SIBLING_WORLD_LOCATION, locked_only)
        self.assertNotIn(SIBLING_TARGET_AIRSPEED, locked_only)
        self.assertNotIn(SIBLING_LOOK_AHEAD, locked_only)
        self.assertNotIn(SIBLING_ALLOW_COMBAT_ORBIT, locked_only)
        for helper in namespace_helper_tokens():
