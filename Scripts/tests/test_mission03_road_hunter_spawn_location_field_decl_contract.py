...
# INDEX_NONE or lock RoadHunterSpawnLocation
# construction in the .cpp. This is leftover-safe
# Mission03 RoadHunterSpawnLocation FIELD
# (declaration-only; EditAnywhere /
# BlueprintReadWrite FVector default
# FVector(70000.f, 45000.f, 6100.f),
...
# sibling field, NOT leftover Mission02
# BreakwaterSpawnLocation #856 / branch
# cursor/mission02-breakwater-spawn-location-
# field-decl-contract-c332, NOT leftover
# Mission10 LastFlightSpawnLocation leftover field
# / leftover LastFlightSpawnRotation sibling field,
# NOT leftover BreakwaterSpawnRotation sibling field,
# NOT leftover RoadHunterSpawnRotation sibling field,
# NOT leftover RoadHunter boss weak-point fields,
# NOT leftover GetDayBeatKit without UFUNCTION,
# NOT leftover convoy-route-state enum #d34e,
# NOT leftover Mission03 wave-state enum #0242,
# NOT leftover BindRuntimeActors /
# HandleDroneCityImpact, NOT leftover Breakwater
# boss fields #540-#545, NOT leftover retired-mount spawn
...
# or leftover LastFlightSpawnRotation. Do not lock
...
# UFUNCTION. Do not lock leftover Mission03
# wave-state enum #0242. Do not lock leftover
# convoy-route-state enum #d34e. Do not lock leftover GetStormRainBeatKit /
...
# (`FVector RoadHunterSpawnLocation =
# FVector(70000.f, 45000.f, 6100.f);`);
# accept that form, other one-line / split-line wraps,
# the origin/main FVector default, and nearby
...
# Mission02 BreakwaterSpawnLocation #856, leftover
# Mission10 LastFlightSpawnLocation, leftover
# RoadHunter boss weak-point fields, leftover
...
# drafts #674-#885, leftover Apache
...
LOCKED_DECL = ROAD_HUNTER_SPAWN_LOCATION
...
# an isolated Python RoadHunterSpawnLocation
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission02IntegrationDirector::BreakwaterSpawnLocation",
    "SkyguardMission10IntegrationDirector.cpp",
    "SkyguardMission02IntegrationDirector.cpp",
...
class Mission03RoadHunterSpawnLocationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("RoadHunterSpawnLocation", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_road_hunter_spawn_location_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_road_loc = f"\t{BREAKWATER_SPAWN_LOCATION}\n"
    ...
    def test_road_hunter_spawn_location_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FVector RoadHunterSpawnLocation"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= FVector(70000.f, 45000.f, 6100.f);"), LOCKED_DECL)
        self.assertIn("RoadHunterSpawnLocation", LOCKED_DECL)
        self.assertIn("FVector ", LOCKED_DECL)
        self.assertIn("= FVector(70000.f, 45000.f, 6100.f)", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("RoadHunterSpawnLocation", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FVector RoadHunterSpawnLocation"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("RoadHunterSpawnLocation", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 RoadHunterSpawnLocation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission03 RoadHunterSpawnLocation contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_road_hunter_spawn_location(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission03_road_hunter_spawn_location_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_road_hunter_targeting_camera"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
