...
# Mission08 AudioDirector FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps) on
# ASkyguardMission08IntegrationDirector. It is
# NOT leftover Mission07 AudioDirector field
# (director field) / branch cursor/
# mission07-audio-director-field-decl-
# contract-c332, NOT leftover Mission08 Root
# #1044 / branch cursor/mission08-root-
# field-decl-contract-c332, NOT leftover
# Mission08 bAudioReady readiness-struct
# field, NOT leftover Mission01 AudioDirector field
...
# c332, NOT leftover Mission07 Root / Briefing
# sibling in-flight lanes, NOT leftover Mission10
# AudioDirector field
# #794 / branch cursor/
...
class Mission08AudioDirectorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 AudioDirector field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 AudioDirector field contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_audio_director_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_mission08_readiness_struct_does_not_satisfy_audio_director(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_mission08_root_does_not_satisfy_audio_director(self) -> None:
        leftover = (
            f"class SKYGUARD52_API {CLASS_NAME} "
            ": public AActor\n"
            "{\n"
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(section, LOCKED_DECL))
        self.assertNotIn(ROOT_FIELD, LOCKED_DECL)
        self.assertIn(
            "Scripts/tests/test_mission08_root_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
    ...
    def test_leftover_mission05_audio_director_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_airfield_target_runtime_does_not_satisfy_audio_director(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_leftover_mission06_audio_director_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission06IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_search_track_runtime_does_not_satisfy_audio_director(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_protected_target_runtime_does_not_satisfy_audio_director(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_does_not_satisfy_audio_director(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
