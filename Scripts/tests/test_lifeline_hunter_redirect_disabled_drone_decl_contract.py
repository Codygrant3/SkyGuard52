...
# or lock the RedirectDisabledDrone body in the
# .cpp. origin/main is one line
# (`bool RedirectDisabledDrone();`); accept that
# form, other split-line wraps, and an inline body
...
# stations / leftover roster / loadout / lock-phase,
# leftover drafts #56–#64, leftover isolated-test
# drafts #107–#435, leftover
...
# Python RedirectDisabledDrone declaration contract
# on ASkyguardLifelineHunterBoss. Stay off leftover
# OpenSensorExposure, leftover
...
# isolated-test drafts #107–#435, leftover
# searchlight-track-runtime-defaults #7347, leftover
...
# leftover apache-cpg-feel #8951, leftover drafts
# #56–#64, leftover isolated-test drafts #107–#435,
...
# .cpp RedirectDisabledDrone body / invented
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardLifelineHunterBoss::RedirectDisabledDrone",
    "SkyguardLifelineHunterBoss.cpp",
    "SetBossPhase",
)
SIBLING_TYPES = (
...
class LifelineHunterRedirectDisabledDroneDeclContractTests(
    unittest.TestCase
):
    def test_lifeline_hunter_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, REDIRECT_DISABLED_DRONE),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, REDIRECT_DISABLED_DRONE)
        self.assertIn("RedirectDisabledDrone", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, REDIRECT_DISABLED_DRONE)
    ...
    def test_missing_redirect_disabled_drone_declaration_fails_closed(
        self,
    ) -> None:
        neighbors_only = (
            "\tASkyguardLifelineHunterBoss();\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, REDIRECT_DISABLED_DRONE)
        self.assertIn("RedirectDisabledDrone", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, REDIRECT_DISABLED_DRONE)
        self.assertIn("RedirectDisabledDrone", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("BlueprintPure", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("UFUNCTION", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("Category", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("BlueprintCallable", REDIRECT_DISABLED_DRONE)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, REDIRECT_DISABLED_DRONE)
        self.assertIn("RedirectDisabledDrone", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        missing_parens = "\tbool RedirectDisabledDrone;\n"
        wrong_return_void = "\tvoid RedirectDisabledDrone();\n"
        wrong_return_int = "\tint32 RedirectDisabledDrone();\n"
        added_const = "\tbool RedirectDisabledDrone() const;\n"
        added_arg = "\tbool RedirectDisabledDrone(bool bRedirected);\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, REDIRECT_DISABLED_DRONE)
            self.assertIn("RedirectDisabledDrone", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_redirect_disabled_drone_declaration_matches_origin_main(
        self,
    ) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
        ...
        self.assertEqual(
            declaration_count(section, REDIRECT_DISABLED_DRONE),
            1,
        )
        self.assertTrue(
            REDIRECT_DISABLED_DRONE.startswith("bool "),
            REDIRECT_DISABLED_DRONE,
        )
        self.assertTrue(
            REDIRECT_DISABLED_DRONE.endswith(";"),
            REDIRECT_DISABLED_DRONE,
        )
        self.assertIn("RedirectDisabledDrone(", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("INDEX_NONE", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("{", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("}", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("return ", REDIRECT_DISABLED_DRONE)
        self.assertNotIn(" const", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("OpenSensorExposure", REDIRECT_DISABLED_DRONE)
        self.assertNotIn(
            "SetFriendlySeparationMeters",
            REDIRECT_DISABLED_DRONE,
        )
        ...
        self.assertNotIn("GetChinMuzzleLocation", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("GetGunnerMount", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("FaceWorldLocation", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("OpticalTracker", REDIRECT_DISABLED_DRONE)
        self.assertNotIn(
            "MinimumWeaponSeparationMeters",
            REDIRECT_DISABLED_DRONE,
        )
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, REDIRECT_DISABLED_DRONE)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        one_line = f"{{\npublic:\n\t{REDIRECT_DISABLED_DRONE}\n}}\n"
        self.assertTrue(
            has_declaration(one_line, REDIRECT_DISABLED_DRONE)
        )
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, REDIRECT_DISABLED_DRONE),
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        locked_only = f"{REDIRECT_DISABLED_DRONE}\n"
        self.assertNotIn("INDEX_NONE", locked_only)
        self.assertNotIn("INDEX_NONE", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("return INDEX_NONE", locked_only)
        self.assertNotIn("NAME_None", REDIRECT_DISABLED_DRONE)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_redirect_disabled_drone_cpp_body(
        self,
    ) -> None:
        locked_only = f"{REDIRECT_DISABLED_DRONE}\n"
        self.assertNotIn("{", REDIRECT_DISABLED_DRONE)
        ...
        self.assertNotIn("return false", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("return true", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("SetBossPhase", REDIRECT_DISABLED_DRONE)
        self.assertNotIn(
    ...
    def test_contract_does_not_relock_open_sensor_exposure_sibling(self) -> None:
        ...
        for token in OPEN_SENSOR_EXPOSURE_NOT_LOCKED:
            ...
            self.assertNotIn(token, REDIRECT_DISABLED_DRONE)
        self.assertNotIn("OpenSensorExposure", REDIRECT_DISABLED_DRONE)
    ...
    def test_contract_does_not_relock_set_friendly_separation_meters_sibling(
        ...
        for token in SET_FRIENDLY_SEPARATION_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REDIRECT_DISABLED_DRONE)
        self.assertNotIn("SetFriendlySeparationMeters", REDIRECT_DISABLED_DRONE)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, REDIRECT_DISABLED_DRONE)
    ...
    def test_contract_does_not_relock_weak_point_fields(self) -> None:
        ...
        self.assertNotIn("OpticalTracker", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("WeaponServo", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("CountermeasurePod", REDIRECT_DISABLED_DRONE)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REDIRECT_DISABLED_DRONE)
        self.assertNotIn("SetSearchlightTracked", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("IsSearchlightTracked", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("ASkyguardBlackKiteBoss", REDIRECT_DISABLED_DRONE)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REDIRECT_DISABLED_DRONE)
        self.assertNotIn("SetContactIdentified", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("IsContactIdentified", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("OpenOrbitExposure", REDIRECT_DISABLED_DRONE)
    ...
    def test_contract_does_not_relock_mount_getters(self) -> None:
        ...
        for token in MOUNT_GETTERS_NOT_LOCKED:
            ...
            self.assertNotIn(token, REDIRECT_DISABLED_DRONE)
        self.assertNotIn("GetGunnerMount", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("GetChinTurret", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("GetSensorTurret", REDIRECT_DISABLED_DRONE)

    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        locked_only = f"{REDIRECT_DISABLED_DRONE}\n"
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, REDIRECT_DISABLED_DRONE)
        self.assertNotIn("GetChinMuzzleLocation", REDIRECT_DISABLED_DRONE)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REDIRECT_DISABLED_DRONE)
        self.assertNotIn("ESkyguardApacheSystem", REDIRECT_DISABLED_DRONE)
    ...
    def test_contract_does_not_relock_leftover_input_capture(self) -> None:
        ...
        self.assertNotIn("RecordPlayerEvent", REDIRECT_DISABLED_DRONE)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REDIRECT_DISABLED_DRONE)
        self.assertNotIn("ASkyguardGunner", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("FillAndFinalize", REDIRECT_DISABLED_DRONE)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REDIRECT_DISABLED_DRONE)
        self.assertNotIn("SkyguardRadarNode", REDIRECT_DISABLED_DRONE)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", REDIRECT_DISABLED_DRONE)
        self.assertNotIn(
            "USkyguardBriefingWidget",
            REDIRECT_DISABLED_DRONE,
        )
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, REDIRECT_DISABLED_DRONE)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", REDIRECT_DISABLED_DRONE)
        self.assertNotIn(
            "ESkyguardMissionSkylineStyle",
            REDIRECT_DISABLED_DRONE,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REDIRECT_DISABLED_DRONE)
        self.assertNotIn("MinHeightFromOriginCm", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("MaxIntegrity", REDIRECT_DISABLED_DRONE)
        self.assertNotIn(
            "SkyguardApacheAircraft.h",
            REDIRECT_DISABLED_DRONE,
        )
        self.assertNotIn("SkyguardPathfinder", REDIRECT_DISABLED_DRONE)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, REDIRECT_DISABLED_DRONE)
    ...
    def test_minimum_weapon_separation_is_not_harbor_40_80(self) -> None:
        ...
        self.assertNotIn(adjacent, REDIRECT_DISABLED_DRONE)
        self.assertNotIn(
            "MinimumWeaponSeparationMeters",
            REDIRECT_DISABLED_DRONE,
        )
        self.assertNotIn("450.f", REDIRECT_DISABLED_DRONE)
        for token in leftover_harbor_tokens():
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{REDIRECT_DISABLED_DRONE}\n"
        self.assertEqual(
            require_declaration(locked_only, REDIRECT_DISABLED_DRONE),
            REDIRECT_DISABLED_DRONE,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "lifeline hunter RedirectDisabledDrone contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, REDIRECT_DISABLED_DRONE.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                REDIRECT_DISABLED_DRONE.lower(),
                "lifeline hunter RedirectDisabledDrone contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, REDIRECT_DISABLED_DRONE)

    def test_contract_is_redirect_disabled_drone_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertNotIn("return ", REDIRECT_DISABLED_DRONE)
        self.assertNotIn("{", REDIRECT_DISABLED_DRONE)
        self.assertTrue(REDIRECT_DISABLED_DRONE.startswith("bool "))
        self.assertTrue(REDIRECT_DISABLED_DRONE.endswith(";"))
        self.assertIn(UFUNCTION_BOSS, section)
