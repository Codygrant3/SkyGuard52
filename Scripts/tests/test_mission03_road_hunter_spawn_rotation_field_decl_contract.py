...
# INDEX_NONE or lock RoadHunterSpawnRotation
# construction in the .cpp. This is leftover-safe
# Mission03 RoadHunterSpawnRotation FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps, FRotator default
# FRotator(0.f, 210.f, 0.f)) on
# ASkyguardMission03IntegrationDirector. Note
# EditAnywhere / BlueprintReadWrite /
# Category Skyguard|Mission03 /
# FRotator default, not VisibleAnywhere /
# BlueprintReadOnly / TObjectPtr / ClampMin.
# It is NOT leftover Mission02
# BreakwaterSpawnRotation field
# #858 / branch cursor/mission02-breakwater-
# spawn-rotation-field-decl-contract-c332,
# NOT leftover Mission03 RoadHunterSpawnLocation
# sibling (draft being opened), NOT leftover
# retired-mount spawn rotation / spawn location /
# runtime-ready fields, NOT leftover
# BindRuntimeActors (retired live mount) /
# HandleDroneCityImpact, NOT leftover
# Mission01 CampaignSaveUserIndex field
...
# leftover Mission03 RoadHunterSpawnRotation sibling,
# leftover convoy-route-state enum #d34e,
# leftover Mission03 wave-state enum #0242,
# leftover Mission02 BreakwaterSpawnLocation #856,
# leftover Mission10 LastFlightSpawnLocation /
# LastFlightSpawnRotation, leftover radio-line-
# defaults #1dec, leftover GetDayBeatKit without
# UFUNCTION,
...
# Do NOT parse GetReadiness().
# Category is Skyguard|Mission03, not
# leftover Mission02 BreakwaterSpawnRotation #858,
# not leftover Mission03 RoadHunterSpawnLocation,
# not leftover Mission03 CampaignSaveUserIndex,
# not Mission10|Protection, not Mission10|Evacuation,
...
# Integration, not Mission01 / Mission02 /
...
ROAD_HUNTER_SPAWN_ROTATION_FIELD = (
    "FRotator RoadHunterSpawnRotation = "
    "FRotator(0.f, 210.f, 0.f);"
)
...
LOCKED_DECL = ROAD_HUNTER_SPAWN_ROTATION_FIELD
...
# an isolated Python RoadHunterSpawnRotation
...
LEFTOVER_MISSION02_BREAKWATER_SPAWN_ROTATION_NOT_LOCKED = (
    "ASkyguardMission02IntegrationDirector",
    "SkyguardMission02IntegrationDirector.h",
    "test_mission02_breakwater_spawn_rotation_field_decl_contract.py",
    "cursor/mission02-breakwater-spawn-rotation-field-decl-contract-c332",
    'Category="Skyguard|Mission02"',
    "BreakwaterSpawnRotation",
    BREAKWATER_SPAWN_ROTATION_FIELD,
)
LEFTOVER_MISSION03_ROAD_HUNTER_SPAWN_LOCATION_NOT_LOCKED = (
    "RoadHunterSpawnLocation",
    ROAD_HUNTER_SPAWN_LOCATION,
...
LEFTOVER_MISSION10_LAST_FLIGHT_SPAWN_ROTATION_NOT_LOCKED = (
    "LastFlightSpawnRotation",
    LAST_FLIGHT_SPAWN_ROTATION,
    "test_mission10_last_flight_spawn_rotation_field_decl_contract.py",
)
LEFTOVER_SAME_NAME_SPAWN_ROTATION_NOT_LOCKED = (
    "test_mission02_breakwater_spawn_rotation_field_decl_contract.py",
    "test_mission02_breakwater_spawn_location_field_decl_contract.py",
    "test_mission10_last_flight_spawn_rotation_field_decl_contract.py",
    "test_mission10_last_flight_spawn_location_field_decl_contract.py",
    "test_mission03_road_hunter_spawn_location_field_decl_contract.py",
)
...
class Mission03RoadHunterSpawnRotationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("RoadHunterSpawnRotation", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_road_hunter_spawn_rotation_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_road_hunter_spawn_rotation_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FRotator RoadHunterSpawnRotation"),
            LOCKED_DECL,
        )
        self.assertTrue(
            LOCKED_DECL.endswith("= FRotator(0.f, 210.f, 0.f);"),
            LOCKED_DECL,
        )
        self.assertIn("RoadHunterSpawnRotation", LOCKED_DECL)
        self.assertIn("= FRotator(0.f, 210.f, 0.f)", LOCKED_DECL)
        ...
        self.assertNotIn("BreakwaterSpawnRotation", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("RoadHunterSpawnRotation", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FRotator RoadHunterSpawnRotation"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("RoadHunterSpawnRotation", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 RoadHunterSpawnRotation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission03 RoadHunterSpawnRotation contains "
    ...
    def test_contract_is_road_hunter_spawn_rotation_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_road_hunter_spawn_rotation(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_road_hunter_spawn_location"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission03_road_hunter_spawn_rotation_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission02_breakwater_spawn_rotation_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission02IntegrationDirector "
    ...
    def test_leftover_same_name_spawn_rotation_contracts_stay_locked(
        self,
    ) -> None:
        for leftover in (
            "Scripts/tests/test_mission02_breakwater_spawn_rotation"
            ...
            "Scripts/tests/test_mission02_breakwater_spawn_location"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission10_last_flight_spawn_rotation"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission10_last_flight_spawn_location"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission03_road_hunter_spawn_location"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission03_campaign_save_user_index"
        ...
        self.assertNotIn(
            "Scripts/tests/test_mission03_road_hunter_spawn_rotation"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
