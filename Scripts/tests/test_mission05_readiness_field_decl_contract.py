...
# Category is Skyguard|Mission05, not
...
# drafts #674-#956, leftover Apache
...
class Mission05ReadinessFieldDeclContractTests(unittest.TestCase):
    ...
    def test_readiness_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FSkyguardMission05IntegrationReadiness "),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("Readiness", LOCKED_DECL)
        self.assertIn("FSkyguardMission05IntegrationReadiness", LOCKED_DECL)
    ...
    def test_contract_is_readiness_field_declaration_only(
        ...
        self.assertNotIn("return ", LOCKED_DECL)
        self.assertNotIn("{", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FSkyguardMission05IntegrationReadiness"))
        self.assertIn("Readiness", LOCKED_DECL)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_readiness_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_same_name_readiness_contracts_stay_locked(self) -> None:
        ...
        self.assertNotIn("EditAnywhere", UPROPERTY_MISSION05)
        self.assertNotIn("BlueprintReadWrite", UPROPERTY_MISSION05)
        self.assertIn("VisibleAnywhere", UPROPERTY_MISSION05)
        self.assertIn("BlueprintReadOnly", UPROPERTY_MISSION05)
