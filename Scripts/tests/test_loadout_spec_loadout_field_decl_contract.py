# THIS IS leftover-safe FSkyguardLoadoutSpec Loadout.
# origin/main form (exact):
# ESkyguardLoadout Loadout = ESkyguardLoadout::Balanced;
# THIS IS leftover-safe isolated FIELD declaration.
# THIS STRUCT IS A PLAIN C++ STRUCT. NOT UPROPERTY.
# NOT USTRUCT. NO Category. NO BlueprintReadOnly.
# NO EditAnywhere. NO VisibleAnywhere. NO GENERATED_BODY.
# Fail-closed if the clone still asserts UPROPERTY /
# Category / VisibleAnywhere / EditAnywhere /
# BlueprintReadOnly / GENERATED_BODY / USTRUCT as the
# locked decl. Locked decl must be the BARE field.
# Fail-closed if the field is missing or renamed, if
# type is not ESkyguardLoadout, or if the initializer
# is missing or not `= ESkyguardLoadout::Balanced`.
# Fail-closed on SelectedLoadout (that lives on
# FSkyguardCpgDebriefSnapshot, not here).
# Parse STRUCT `FSkyguardLoadoutSpec` body ONLY after
# `struct FSkyguardLoadoutSpec`. Stop at
# `FSkyguardLoadoutSpec SkyguardResolveLoadout`.
# Do NOT parse leftover `ESkyguardLoadout` enum body.
# Do NOT parse leftover `ESkyguardGunshipWeapon`.
# Do NOT parse leftover `ESkyguardPatrolShipSystem`.
# Do NOT parse leftover `SkyguardApacheCpgFeel`
# namespace body.
# Do NOT parse leftover `ASkyguardApacheAircraft`.
# Do NOT parse leftover `FSkyguardCpgDebriefSnapshot`.
# Do NOT parse leftover `FSkyguardCpgHudSnapshot`.
# Do NOT parse leftover analog bulk #253 / #ff30
# (`test_loadout_spec_defaults_contract.py`). Keep that
# bulk analog in LOCKED_SCRIPTS. Do not reopen leftover
# #253. Then this isolated FIELD decl.
...
# Do NOT contract sibling fields StartingStation
# (different type) / CannonMagazineSize / CannonReserve /
# RocketMagazineSize / RocketReserve /
# GuidedMagazineSize / GuidedReserve / FlareCount /
# HullIntegrity / PlaystyleLine.
# HullIntegrity one-four-zero .f is a sibling, not this
# slot, and that sibling default is not Harbor.
# `= ESkyguardLoadout::Balanced` is not Harbor.
# Analog leftover loadout-spec-defaults #253 / #ff30
# then this isolated FIELD decl.
# Clone source is leftover-safe draft #1300
# theater-kit-spec WeatherIdentity UPROPERTY field decl.
...
# type is ESkyguardLoadout, initializer is
# `= ESkyguardLoadout::Balanced`, no UPROPERTY wrap.
...
TARGET = "ESkyguardLoadout Loadout = ESkyguardLoadout::Balanced;"
TARGET_WRONG_BARE = "ESkyguardLoadout Loadout;"
TARGET_WRONG_ANTI = (
    "ESkyguardLoadout Loadout = ESkyguardLoadout::AntiArmor;"
)
TARGET_WRONG_ROCKET = (
    "ESkyguardLoadout Loadout = ESkyguardLoadout::RocketHeavy;"
)
TARGET_WRONG_INTERCEPT = (
    "ESkyguardLoadout Loadout = ESkyguardLoadout::Intercept;"
)
TARGET_WRONG_FALSE = "ESkyguardLoadout Loadout = false;"
TARGET_WRONG_TRUE = "ESkyguardLoadout Loadout = true;"
TARGET_WRONG_ZERO = "ESkyguardLoadout Loadout = 0.f;"
TARGET_WRONG_FLOAT = "float Loadout = ESkyguardLoadout::Balanced;"
TARGET_WRONG_INT = "int32 Loadout = ESkyguardLoadout::Balanced;"
TARGET_WRONG_FNAME = "FName Loadout = ESkyguardLoadout::Balanced;"
TARGET_WRONG_SELECTED = (
    "ESkyguardLoadout SelectedLoadout = ESkyguardLoadout::Balanced;"
)
TARGET_WRONG_HEALTH = "float HullIntegrity = " + "140" + ".f;"
CLONE_UPROPERTY_LOCKED = (
...
STOP_BEFORE_DISPLAY_NAME = "SkyguardLoadoutDisplayName"
STOP_BEFORE_ENUM_LOADOUT = "enum class ESkyguardLoadout"
STOP_BEFORE_ENUM_WEAPON = "enum class ESkyguardGunshipWeapon"
STOP_BEFORE_ENUM_PATROL = "enum class ESkyguardPatrolShipSystem"
STOP_BEFORE_CPG_FEEL = "namespace SkyguardApacheCpgFeel"
STOP_BEFORE_DEBRIEF = "struct FSkyguardCpgDebriefSnapshot"
STOP_BEFORE_HUD = "struct FSkyguardCpgHudSnapshot"
STOP_BEFORE_THEATER_SPEC = "struct FSkyguardTheaterKitSpec"
STOP_BEFORE_MISSION_DEF = "USkyguardMissionDefinition"
STOP_BEFORE_MESH_CATALOG = "USkyguardRuntimeMeshCatalog"
STOP_BEFORE_AUDIO_HARNESS = "USkyguardAudioAcceptanceHarness"
STOP_BEFORE_AUDIO_BANK = "USkyguardAudioProductionBank"
...
SIBLING_HULL_INTEGRITY = "HullIntegrity"
SIBLING_PLAYSTYLE_LINE = "PlaystyleLine"
LEFTOVER_SELECTED_LOADOUT = "SelectedLoadout"
...
LEFTOVER_DEBRIEF_STRUCT = "FSkyguardCpgDebriefSnapshot"
LEFTOVER_HUD_STRUCT = "FSkyguardCpgHudSnapshot"
THIS_SCRIPT = (
...
LEFTOVER_CPG_DEBRIEF_SNAPSHOT_ISOLATED = (
...
LEFTOVER_MESH_BIND_SLOT_ISOLATED = (
...
LEFTOVER_MISSION_DEFINITION_DECLS = (
...
LOCKED_SCRIPTS = (
    ...
    LEFTOVER_LOADOUT_SLOT_HELPERS,
    CLONE_THEATER_KIT_WEATHER_IDENTITY,
) + leftover_live_copy_boss_scripts() + LEFTOVER_CPG_DEBRIEF_SNAPSHOT_ISOLATED + LEFTOVER_MESH_BIND_SLOT_ISOLATED + LEFTOVER_MISSION_DEFINITION_DECLS
...
def sibling_uncontracted_decls() -> tuple[str, ...]:
    return (
        ...
        SIBLING_FLARE_COUNT,
        SIBLING_HULL_INTEGRITY,
        SIBLING_PLAYSTYLE_LINE,
    )


def leftover_loadout_helper_tokens() -> tuple[str, ...]:
    return (
        STOP_BEFORE_RESOLVE,
        STOP_BEFORE_FROM_SLOT,
        STOP_BEFORE_SLOT,
        STOP_BEFORE_DISPLAY_NAME,
    )


def leftover_enum_namespace_tokens() -> tuple[str, ...]:
    return (
        STOP_BEFORE_ENUM_LOADOUT,
        STOP_BEFORE_ENUM_WEAPON,
        STOP_BEFORE_ENUM_PATROL,
        STOP_BEFORE_CPG_FEEL,
    )


def leftover_foreign_type_tokens() -> tuple[str, ...]:
    return (
        STOP_BEFORE_DEBRIEF,
        STOP_BEFORE_HUD,
        ...
        LEFTOVER_DEBRIEF_STRUCT,
        LEFTOVER_HUD_STRUCT,
        LEFTOVER_SELECTED_LOADOUT,
    )
...
def has_declaration(region: str, declaration: str) -> bool:
    # Fail-closed on the authored field
    # `ESkyguardLoadout Loadout = ESkyguardLoadout::Balanced;`.
    # Fail-closed if type is not ESkyguardLoadout.
    # Fail-closed if initializer is missing or not
    # `= ESkyguardLoadout::Balanced`.
    # Fail-closed on SelectedLoadout (that lives on
    # FSkyguardCpgDebriefSnapshot, not here).
    # Fail-closed on sibling StartingStation / magazine /
    # reserve / flare / hull / playstyle fields.
    compact_decl = collapsed(declaration)
    if has_identifier(compact_decl, LEFTOVER_SELECTED_LOADOUT):
        return False
    if not has_one_declaration(region, declaration):
        return False
    compact = collapsed(region)
    if re.search(
        r"ESkyguardLoadout\s+Loadout\s*=\s*ESkyguardLoadout::Balanced\s*;",
        compact,
    ) is None:
        return False
    if re.search(r"ESkyguardLoadout\s+Loadout\s*;", compact):
        return False
    if re.search(
        r"\b(?:int32|float|bool|FName|uint8|FText)\s+Loadout\b",
        compact,
    ):
        return False
    return True
...
def leaked_neighbor_tokens() -> tuple[str, ...]:
    return leftover_loadout_helper_tokens() + leftover_enum_namespace_tokens() + (
        STOP_BEFORE_DEBRIEF,
        STOP_BEFORE_HUD,
        STOP_BEFORE_THEATER_SPEC,
        STOP_BEFORE_MISSION_DEF,
...
class LoadoutSpecLoadoutFieldDeclContractTests(unittest.TestCase):
    def test_loadout_spec_struct_exists(self) -> None:
        ...
        self.assertNotEqual(STRUCT_NAME, LEFTOVER_DEBRIEF_STRUCT)
        self.assertNotEqual(STRUCT_NAME, LEFTOVER_HUD_STRUCT)
        ...
        self.assertTrue(has_identifier(section, "Loadout"), section)
        self.assertFalse(has_identifier(section, LEFTOVER_SELECTED_LOADOUT), section)
        ...
        self.assertIn(STOP_BEFORE_ENUM_LOADOUT, header)
        self.assertNotIn(STOP_BEFORE_ENUM_LOADOUT, section)
        self.assertNotIn(STOP_BEFORE_ENUM_LOADOUT, body)
        self.assertIn(STOP_BEFORE_CPG_FEEL, header)
        self.assertNotIn(STOP_BEFORE_CPG_FEEL, section)
        self.assertNotIn(STOP_BEFORE_CPG_FEEL, body)
        for sibling in sibling_uncontracted_decls():
            self.assertNotIn(sibling, LOCKED_DECL)
        self.assertNotIn(LEFTOVER_SELECTED_LOADOUT, LOCKED_DECL)
        ...
        self.assertNotIn(LEFTOVER_DEBRIEF_STRUCT, section)
        self.assertNotIn(LEFTOVER_HUD_STRUCT, section)
    ...
    def test_other_type_does_not_satisfy(self) -> None:
        other = (
            f"struct {LEFTOVER_DEBRIEF_STRUCT}\n"
            "{\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
        )
    ...
    def test_helper_or_enum_declaration_does_not_satisfy(self) -> None:
        mixed = (
            f"{STOP_BEFORE_ENUM_LOADOUT} : uint8\n"
            "{{\n"
            "\tBalanced,\n"
            "}};\n"
            ...
            "{{\n"
            "}};\n"
            f"{STOP_BEFORE_RESOLVE}(ESkyguardLoadout Loadout);\n"
            f"ESkyguardLoadout {STOP_BEFORE_FROM_SLOT}(int32 Slot);\n"
        )
        section = spec_section(mixed)
        self.assertFalse(has_identifier(section, "Loadout"), section)
        self.assertNotIn(STOP_BEFORE_RESOLVE, section)
        self.assertNotIn(STOP_BEFORE_ENUM_LOADOUT, section)
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, LOCKED_DECL)
        self.assertIn("Loadout", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_missing_loadout_declaration_fails_closed(self) -> None:
        empty = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            f"\tESkyguardGunshipWeapon {SIBLING_STARTING_STATION} = "
    ...
    def test_clone_uproperty_macro_is_not_the_locked_decl(self) -> None:
        ...
        self.assertNotEqual(LOCKED_DECL, CLONE_UPROPERTY_LOCKED)
        self.assertNotIn(CLONE_UPROPERTY_LOCKED, LOCKED_DECL)
        with self.assertRaises(AssertionError) as raised:
            require_declaration(f"\t{CLONE_UPROPERTY_LOCKED}\n", LOCKED_DECL)
        self.assertIn("Loadout", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_origin_main_plain_struct_has_no_uproperty_wrap(self) -> None:
    ...
    def test_missing_initializer_fails_closed(self) -> None:
        ...
        self.assertNotIn("ESkyguardLoadout Loadout;", compact_origin.replace(
            "ESkyguardLoadout Loadout = ESkyguardLoadout::Balanced;",
            "",
        ))
        self.assertNotIn("Loadout = false", compact_origin)
        self.assertNotIn("Loadout = true", compact_origin)
        self.assertNotIn("Loadout = 0.f", compact_origin)

    def test_loadout_declaration_matches_origin_main(self) -> None:
        section = spec_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("ESkyguardLoadout Loadout"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("= ESkyguardLoadout::Balanced", LOCKED_DECL)
        self.assertIn("ESkyguardLoadout ", LOCKED_DECL)
        ...
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_ANTI}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_ROCKET}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_INTERCEPT}\n", LOCKED_DECL)
        )
        self.assertFalse(
        ...
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_SELECTED}\n", LOCKED_DECL)
        )
        self.assertFalse(
        ...
        self.assertIn("missing", str(raised.exception).lower())
        with self.assertRaises(AssertionError) as raised:
            require_declaration(f"\t{TARGET_WRONG_SELECTED}\n", LOCKED_DECL)
        self.assertIn("Loadout", str(raised.exception))

    def test_wrong_default_and_renames_do_not_satisfy(self) -> None:
        leftover_primary = (
            "\tESkyguardLoadout " + leftover_retired_primary_hits_field() + " = "
            "ESkyguardLoadout::Balanced;\n"
        )
        leftover_guided = (
            "\tESkyguardLoadout " + leftover_retired_guided_hits_field() + " = "
            "ESkyguardLoadout::Balanced;\n"
        )
        forty = "40" + ".f"
        eighty = "80" + ".f"
        wrongs = (
            f"\t{TARGET_WRONG_BARE}\n",
            f"\t{TARGET_WRONG_ANTI}\n",
            f"\t{TARGET_WRONG_ROCKET}\n",
            f"\t{TARGET_WRONG_INTERCEPT}\n",
            ...
            f"\t{TARGET_WRONG_SELECTED}\n",
            f"\t{TARGET_WRONG_HEALTH}\n",
            leftover_primary,
            leftover_guided,
            f"\tESkyguardGunshipWeapon {SIBLING_STARTING_STATION} = "
            "ESkyguardGunshipWeapon::Cannon;\n",
            "\tESkyguardLoadout Loadouts = ESkyguardLoadout::Balanced;\n",
            f"\tfloat Loadout = {forty};\n",
            f"\tfloat Loadout = {eighty};\n",
        )
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        clone_wraps = (
            f"\t{CLONE_UPROPERTY_LOCKED}\n",
            f"\tUSTRUCT()\n\t{LOCKED_DECL}\n",
            f"\tGENERATED_BODY()\n",
        )
        self.assertFalse(
            has_declaration(f"\t{CLONE_UPROPERTY_LOCKED}\n", LOCKED_DECL)
        )
        self.assertFalse(has_declaration("\tGENERATED_BODY()\n", LOCKED_DECL))
        for region in clone_wraps:
            if LOCKED_DECL not in region and "ESkyguardLoadout Loadout" not in region:
    ...
    def test_does_not_contract_sibling_loadout_fields(self) -> None:
        ...
        self.assertFalse(has_identifier(section, LEFTOVER_SELECTED_LOADOUT))
        for field in leftover_neighbor_hit_fields():
    ...
    def test_does_not_parse_helpers_enum_or_neighbors(self) -> None:
        header = origin_main_header()
        section = spec_section(header)
        ...
        self.assertNotIn(STOP_BEFORE_FROM_SLOT, leaked)
        self.assertIn(STOP_BEFORE_SLOT, header)
        self.assertNotIn(STOP_BEFORE_SLOT, section)
        self.assertNotIn(STOP_BEFORE_SLOT, leaked)
        self.assertIn(STOP_BEFORE_DISPLAY_NAME, header)
        self.assertNotIn(STOP_BEFORE_DISPLAY_NAME, section)
        self.assertNotIn(STOP_BEFORE_DISPLAY_NAME, leaked)
        for token in leftover_enum_namespace_tokens():
            self.assertIn(token, header)
            self.assertNotIn(token, section)
            self.assertNotIn(token, leaked)
        for helper in leftover_loadout_helper_tokens():
            self.assertIn(helper, header)
            self.assertNotIn(helper, section)
            self.assertNotIn(helper, leaked)
        for leftover in leftover_foreign_type_tokens():
            self.assertNotIn(leftover, section)
        ...
        self.assertNotIn(LEFTOVER_DEBRIEF_STRUCT, header)
        self.assertNotIn(LEFTOVER_HUD_STRUCT, header)
        self.assertNotIn(LEFTOVER_SELECTED_LOADOUT, header)
        self.assertNotIn(STOP_BEFORE_THEATER_SPEC, header)
    ...
    def test_parse_window_excludes_leftover_weapon_enum_body(self) -> None:
        ...
        self.assertNotIn("GuidedMissile", section)
        self.assertNotIn(LEFTOVER_SELECTED_LOADOUT, section)
        self.assertNotIn(LEFTOVER_SELECTED_LOADOUT, leaked)

    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        other = (
            f"\t{STOP_BEFORE_RESOLVE}(ESkyguardLoadout Loadout);\n"
            f"\tESkyguardLoadout {STOP_BEFORE_FROM_SLOT}(int32 Slot);\n"
            f"\tint32 {STOP_BEFORE_SLOT}(ESkyguardLoadout Loadout);\n"
            f"\tconst TCHAR* {STOP_BEFORE_DISPLAY_NAME}"
            "(ESkyguardLoadout Loadout);\n"
            f"\tESkyguardGunshipWeapon {SIBLING_STARTING_STATION} = "
            "ESkyguardGunshipWeapon::Cannon;\n"
            f"\t{TARGET_WRONG_HEALTH}\n"
    ...
    def test_declaration_does_not_invent_clone_uproperty_metadata(self) -> None:
        self.assertNotEqual(LOCKED_DECL, CLONE_UPROPERTY_LOCKED)
        self.assertNotIn("UPROPERTY", LOCKED_DECL)
        self.assertNotIn("USTRUCT", LOCKED_DECL)
        self.assertNotIn("GENERATED_BODY", LOCKED_DECL)
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertEqual(HEADER_PATH, "Source/Skyguard52/SkyguardGunshipTypes.h")
    ...
    def test_harbor_40_80_tokens_fail_closed_if_present(self) -> None:
        ...
        self.assertIn("= ESkyguardLoadout::Balanced", LOCKED_DECL)
        hull_sibling = "140" + ".f"
        self.assertNotIn(hull_sibling, LOCKED_DECL)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "loadout-spec Loadout field decl contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(Path(__file__).name.endswith(
            "loadout_field_decl_contract.py"
        ))
        self.assertNotIn("SkyguardGunshipTypes.cpp", THIS_SCRIPT)
    ...
    def test_leftover_mission_result_defaults_stay_locked(self) -> None:
        leftovers = (
            ...
            "Scripts/tests/test_briefing_radio_row_speaker_field_decl_contract.py",
            "Scripts/tests/test_briefing_radio_row_subtitle_field_decl_contract.py",
        ) + LEFTOVER_CPG_DEBRIEF_SNAPSHOT_ISOLATED + LEFTOVER_MESH_BIND_SLOT_ISOLATED + LEFTOVER_MISSION_DEFINITION_DECLS
    ...
    def test_contract_is_target_field_declaration_only(self) -> None:
        ...
        self.assertNotIn(LEFTOVER_SELECTED_LOADOUT, locked_only)
        ...
        self.assertNotIn(LEFTOVER_DEBRIEF_STRUCT, locked_only)
        self.assertNotIn(LEFTOVER_HUD_STRUCT, locked_only)
