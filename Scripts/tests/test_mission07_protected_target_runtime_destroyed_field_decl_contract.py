...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission07 ProtectedTargetRuntime
# bDestroyed. THIS IS NOT leftover Mission08 PTR
...
# Mission07 ProtectedTargetRuntime bDestroyed
...
class Mission07ProtectedTargetRuntimeDestroyedFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 bDestroyed field contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_protected_target_runtime"
                "_destroyed_field_decl_contract.py"
            )
        )
        self.assertIn(
