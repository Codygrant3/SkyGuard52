...
# Mission07 Integration GetObjectiveRuntime
...
# #675, NOT leftover objective-runtime fail-closed
...
# NOT leftover Mission06 GetObjectiveRuntime #698,
# NOT leftover Mission05 GetObjectiveRuntime #675,
# and NOT leftover objective-runtime fail-closed #6845.
LOCKED = {
...
class Mission07GetObjectiveRuntimeDeclContractTests(unittest.TestCase):
    ...
    def test_get_objective_runtime_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("StartPayloadWindow", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("AdvancePayloadWindow", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("TryJamActivePayload", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("NotifyAirfieldTargetDamage", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("GetPayloadWindow", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("GetTargetRuntime", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("GetSurvivingTargetCount", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("GetDayBeatKind", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("GetDayBeatIndex", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("TickDayBeatKit", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("HandleBossPhaseChanged", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("ASkyguardMission06IntegrationDirector", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("ESkyguardMission06WaveState", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("ESkyguardMission07WaveState", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("ESkyguardMission07ProtectedTarget", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("FSkyguardMission07ProtectedTargetRuntime", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("ESkyguardSearchSector", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("FSkyguardSearchTrackRuntime", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("ClassifyFalseTrack", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("ConfirmRadarGhostIdentification", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("NotifyProtectedTargetDamage", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("AdvanceReinforcementTimer", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("GetSearchSector", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("GetClassifiedFalseTrackCount", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("IsHostileContactConfirmed", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("GetProtectedTarget", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("GetReinforcementTimeRemaining", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("GetNightBeatKind", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("GetNightBeatIndex", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("TickNightBeatKit", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("ESkyguardAirfieldTarget", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", GET_OBJECTIVE_RUNTIME)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardRadarGhostBoss", GET_OBJECTIVE_RUNTIME)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 GetObjectiveRuntime method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission07 GetObjectiveRuntime contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_get_objective_runtime"
                "_decl_contract.py"
            )
        )
        self.assertIn(
