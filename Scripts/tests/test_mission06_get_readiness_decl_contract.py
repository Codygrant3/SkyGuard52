...
# Mission06 Integration GetReadiness METHOD on
# ASkyguardMission06IntegrationDirector. It is
# NOT leftover env-readiness #6b9d / #b931, NOT
# leftover Mission05 GetReadiness #681, NOT leftover
# Mission01 / Mission03 / Mission04 GetReadiness,
# NOT leftover payload-window-runtime-defaults #f114.
...
# NOT leftover Mission06 wave-state enum #fa65, NOT
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission06IntegrationDirector::GetReadiness",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission06GetReadinessDeclContractTests(unittest.TestCase):
    ...
    def test_get_readiness_declaration_matches_origin_main(self) -> None:
        ...
        self.assertIn("FSkyguardMission06IntegrationReadiness", GET_READINESS)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 GetReadiness method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                GET_READINESS.lower(),
                "mission06 GetReadiness contains "
