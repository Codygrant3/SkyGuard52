...
# c332, NOT leftover Mission10 RadioChatter field
# #796 / branch cursor/
# mission10-radio-chatter-field-decl-contract-
# c332, NOT leftover Mission05 AudioDirector field
# sibling / branch cursor/mission05-audio-
# director-field-decl-contract-c332, NOT leftover
# Mission04 Root #907 / SearchlightPort #908 /
# SearchlightStarboard / Briefing / AudioDirector
# siblings, NOT leftover
# radio-chatter fail-closed contracts / leftover
...
# drafts #674-#946, leftover Apache
...
# drafts #674-#946 including leftover Mission03
...
class Mission05RadioChatterFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 RadioChatter field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 RadioChatter field contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_radio_chatter_field"
                "_decl_contract.py"
            )
        )
        leftover_56_64 = (
    ...
    def test_readiness_struct_does_not_satisfy_radio_chatter(self) -> None:
        leftover = (
