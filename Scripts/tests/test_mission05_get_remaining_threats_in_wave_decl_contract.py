...
# INDEX_NONE or lock GetRemainingThreatsInWave construction
# in the .cpp. This is leftover-safe Mission05
# Waves GetRemainingThreatsInWave on
# ASkyguardMission05IntegrationDirector. It is
...
# HandleBossPhaseChanged without Blueprint
# category, NOT leftover Mission05 wave-state
# enum #ad28, NOT leftover Mission05
# protected-target enum #aaa2, NOT leftover
# Mission05 protected-target-runtime-defaults
# #ec8b, and NOT leftover storm-runtime-defaults
# #89c9 (struct defaults). Distinct from leftover
# Mission03 GetRemainingThreatsInWave and leftover
# Mission04 GetRemainingThreatsInWave #662. Distinct
# from leftover Mission05 StartNextWave #668,
# leftover Mission05 NotifyThreatDestroyed #669,
# leftover Mission05 InitializePlayableMission #666
# and leftover Mission05 ConfigureMissionDefinition
# #665. Not leftover Briefing / AudioDirector /
...
# HandleDroneCityImpact. Do not lock leftover
# HandleBossPhaseChanged. Do not lock sibling
# Integration / Waves / Storm / Protection /
# Objectives methods InitializePlayableMission /
# ConfigureMissionDefinition / BindRuntimeActors /
...
# GetWaveState / GetStormRuntime /
# GetProtectedTarget /
# GetSurvivingTargetCount / GetMissionId /
# ValidateMissionContract / GetStormRainBeatKit.
...
# Mission03 StartNextWave, leftover Mission04
# StartNextWave #649, leftover Mission05
# wave-state enum #ad28, leftover Mission05
# protected-target enum #aaa2, leftover Mission05
# protected-target-runtime-defaults #ec8b,
# leftover storm-runtime-defaults #89c9 struct,
# leftover BindRuntimeActors, leftover
# searchlight-track-runtime-defaults #7347.
# origin/main is a one-line method with an
...
# Category is Skyguard|Mission05|Waves, not
# Integration, not Storm, not Protection, not
# Environment, not leftover briefing-widget, not
# leftover MissionBriefingComponent methods, not
# leftover Mission03 Waves GetRemainingThreatsInWave,
# not leftover Mission04 Waves
# GetRemainingThreatsInWave #662, not leftover
# Mission05 Waves StartNextWave #668.
...
GET_REMAINING_THREATS_IN_WAVE_INLINE_BODY_NOT_LOCKED = (
...
# leftover theater-kit #59, leftover #107–#667, plus
# leftover Mission03 StartNextWave, leftover
# Mission04 StartNextWave #649, leftover Mission05
# InitializePlayableMission #666, leftover
# Mission05 ConfigureMissionDefinition #665,
# leftover Mission05 wave-state enum #ad28,
# leftover Mission05 protected-target enum #aaa2,
# leftover Mission05 protected-target-runtime-defaults
# #ec8b, leftover storm-runtime-defaults #89c9,
...
# contracts, leftover Mission03 StartNextWave,
# leftover Mission04 StartNextWave #649, leftover
# Mission05 InitializePlayableMission #666,
# leftover Mission05 ConfigureMissionDefinition
# #665, leftover Mission05 wave-state enum #ad28,
# leftover Mission05 protected-target enum/defaults,
# leftover storm-runtime-defaults #89c9, leftover
# BindRuntimeActors, leftover Harbor Mission02,
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission05IntegrationDirector::GetRemainingThreatsInWave",
    "SkyguardMission05IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission05GetRemainingThreatsInWaveDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission05|Waves", UFUNCTION_WAVES)
        ...
        self.assertNotIn("Storm", UFUNCTION_WAVES)
        self.assertNotIn("Protection", UFUNCTION_WAVES)
        self.assertNotIn("Searchlight", UFUNCTION_WAVES)
        self.assertNotIn("Substation", UFUNCTION_WAVES)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = "\tvoid GetRemainingThreatsInWave() const;\n"
        as_bool = "\tbool GetRemainingThreatsInWave() const;\n"
        as_const = (
            "\tint32 "
        ...
        with_arg = (
            "\tint32 "
            "GetRemainingThreatsInWave(int32 Amount = 1) const;\n"
        )
        renamed = (
            "\tint32 "
            "GetRemainingThreats() const;\n"
        )
        short_name = "\tFSkyguardMission05IntegrationReadiness Readiness;\n"
        ...
        leftover_remaining = f"\t{START_NEXT_WAVE}\n"
    ...
    def test_get_remaining_threats_in_wave_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            GET_REMAINING_THREATS_IN_WAVE.endswith(" const"),
            GET_REMAINING_THREATS_IN_WAVE,
        )
        self.assertFalse(
        ...
        self.assertNotIn("const;", GET_REMAINING_THREATS_IN_WAVE)
    ...
    def test_contract_does_not_lock_get_remaining_threats_in_wave_cpp_body(self) -> None:
        ...
        self.assertNotIn("return RemainingThreatsInWave", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("return WaveState", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("return Readiness", GET_REMAINING_THREATS_IN_WAVE)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardTempestBoss", GET_REMAINING_THREATS_IN_WAVE)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 GetRemainingThreatsInWave method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission05 GetRemainingThreatsInWave contains "
    ...
    def test_contract_is_get_remaining_threats_in_wave_declaration_only(
        ...
        self.assertTrue(GET_REMAINING_THREATS_IN_WAVE.startswith("int32 "))
        self.assertIn("GetRemainingThreatsInWave", GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn("GetRemainingThreatsInWave() const", GET_REMAINING_THREATS_IN_WAVE)
        self.assertTrue(GET_REMAINING_THREATS_IN_WAVE.endswith(" const"))
        self.assertFalse(GET_REMAINING_THREATS_IN_WAVE.endswith(";"))
        self.assertIn(UFUNCTION_WAVES, section)
    ...
    def test_leftover_mission03_get_remaining_threats_in_wave_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
    ...
    def test_leftover_mission04_get_remaining_threats_in_wave_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission04IntegrationDirector "
    ...
    def test_contract_does_not_relock_leftover_get_night_beat_kit(self) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        self.assertNotIn(GET_NIGHT_BEAT_KIT, locked_only)
        self.assertNotIn(GET_NIGHT_BEAT_KIT, GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetNightBeatKit", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("UFUNCTION", GET_NIGHT_BEAT_KIT)

    def test_contract_does_not_relock_leftover_mission05_initialize(
        self,
    ) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
    ...
    def test_contract_does_not_relock_leftover_bind_runtime_actors(
        self,
    ) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
    ...
    def test_contract_does_not_relock_leftover_mission05_wave_state_enum(
        self,
    ) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        for token in LEFTOVER_MISSION05_WAVE_STATE_ENUM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn(
            "Scripts/tests/test_mission05_wave_state_enum_contract.py",
    ...
    def test_contract_does_not_relock_leftover_mission05_protected_target(
        self,
    ) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        for token in LEFTOVER_MISSION05_PROTECTED_TARGET_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_storm_runtime_defaults(
        self,
    ) -> None:
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        for token in LEFTOVER_STORM_RUNTIME_DEFAULTS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn(
            "Scripts/tests/test_storm_runtime_defaults_contract.py",
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_get_remaining_threats_in_wave"
                "_decl_contract.py"
            )
        )
        self.assertIn(
