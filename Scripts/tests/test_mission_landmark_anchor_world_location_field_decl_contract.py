# THIS IS leftover-safe FSkyguardMissionLandmarkAnchor WorldLocation.
# origin/main form: one-line and split-line UPROPERTY wraps
# UPROPERTY(EditAnywhere, BlueprintReadOnly)
# then `FVector WorldLocation = FVector::ZeroVector;`
# (initializer IS `= FVector::ZeroVector`, no Category=).
# THIS IS leftover-safe isolated UPROPERTY with no Category.
# EditAnywhere IS present. BlueprintReadOnly IS present.
# Initializer IS `= FVector::ZeroVector`. There is NO Category=.
...
# if Category= is added, if the type is not FVector, or
# if the initializer is missing or not `= FVector::ZeroVector`.
# Accept one-line and split-line UPROPERTY wraps.
# Parse STRUCT `FSkyguardMissionLandmarkAnchor` body ONLY after
# `struct FSkyguardMissionLandmarkAnchor`. Stop at
# `struct FSkyguardMissionMapReadiness`.
# Do NOT parse leftover `FSkyguardMissionMapReadiness`
# isolated fields.
# Do NOT parse leftover `FSkyguardMissionObjectiveAnchor`
# (sibling struct; leftover ObjectiveAnchor WorldLocation
# #1386 is a different struct).
# Do NOT parse leftover `FSkyguardObjectiveDefinition`
# isolated ObjectiveId #1364.
...
# Do NOT parse leftover `ESkyguardMissionSkylineStyle`
# (that enum is BEFORE this struct; starting at the
# claimed struct keeps the skyline identity out of the
# parse window). Do NOT fail the whole header for the
# skyline identity token. Fail-closed only if that
# identity / Harbor 40/80 appear IN THE PARSE WINDOW
# or IN THIS TEST FILE.
# Do NOT contract sibling fields LandmarkId / Role /
# bMissionExclusive.
# THIS IS NOT leftover mission-landmark-anchor-defaults
# #203 / #4230. Analog leftover
# mission-landmark-anchor-defaults then this isolated
# WorldLocation field decl.
# THIS IS NOT leftover FSkyguardRoutePoint::WorldLocation
# #1340.
# THIS IS NOT leftover FSkyguardMissionObjectiveAnchor
# WorldLocation #1386.
# THIS IS NOT leftover LandmarkId isolated decl #1387.
# THIS IS NOT leftover mission-objective-anchor-defaults
# #201 / #692c.
# THIS IS NOT leftover ObjectiveAnchor isolated decls.
# THIS IS NOT leftover TheaterKit NamedLandmark.
# THIS IS NOT leftover TheaterKitSpec WeatherIdentity
# VisibleAnywhere / Category="Skyguard|Theater".
...
# bare FName LandmarkId / no `=`, retarget: type is
# FVector WorldLocation, initializer is
# `= FVector::ZeroVector`, specifiers are EditAnywhere +
...
STRUCT_NAME = "FSkyguardMissionLandmarkAnchor"
ACTOR_NAME = "ASkyguardMissionMapAssemblyDirector"
NAMESPACE_NAME = "SkyguardCampaignTheaterKit"
TARGET = "FVector WorldLocation = FVector::ZeroVector;"
TARGET_WRONG_EQ_NONE = "FVector WorldLocation = FVector::OneVector;"
TARGET_WRONG_FALSE = "FVector WorldLocation = false;"
TARGET_WRONG_TRUE = "FVector WorldLocation = true;"
TARGET_WRONG_ZERO = "FVector WorldLocation = FVector::Zero();"
TARGET_WRONG_FLOAT = "float WorldLocation = 0.f;"
TARGET_WRONG_HEALTH = "float Health = 160.f;"
TARGET_WRONG_EMPTY = "FVector WorldLocation;"
TARGET_WRONG_TWO = "FVector WorldLocation = FVector(0.f);"
TARGET_WRONG_TWO_POINT_ZERO = (
    "FVector WorldLocation = ZeroVector;"
)
TARGET_WRONG_NAME = "FName WorldLocation;"
...
LEFTOVER_MISSION_OBJECTIVE_ANCHOR_DEFAULTS = (
    "Scripts/tests/test_mission_objective_anchor_defaults"
    "_contract.py"
)
LEFTOVER_MISSION_OBJECTIVE_ANCHOR_DEFAULTS_PY = (
    "Scripts/tests/test_mission_objective_anchor_defaults.py"
)
LEFTOVER_MISSION_OBJECTIVE_ANCHOR_DEFAULTS_TESTS = (
    "Scripts/tests/test_mission_objective_anchor_defaults"
    "_tests.py"
)
LEFTOVER_MISSION_LANDMARK_ANCHOR_DEFAULTS = (
    "Scripts/tests/test_mission_landmark_anchor_defaults"
    "_contract.py"
)
LEFTOVER_MISSION_LANDMARK_ANCHOR_DEFAULTS_PY = (
    "Scripts/tests/test_mission_landmark_anchor_defaults.py"
)
LEFTOVER_MISSION_LANDMARK_ANCHOR_DEFAULTS_TESTS = (
    "Scripts/tests/test_mission_landmark_anchor_defaults"
    "_tests.py"
)
...
LEFTOVER_OBJECTIVE_DEFINITION_DEFAULTS = (
    "Scripts/tests/test_objective_definition_defaults"
    "_contract.py"
)
...
SIBLING_LANDMARK_ID = "LandmarkId"
...
SIBLING_ROLE = "Role"
SIBLING_MISSION_EXCLUSIVE = "bMissionExclusive"
SIBLING_ROLE_SCRIPT = (
    "Scripts/tests/test_mission_landmark_anchor_role"
    "_field_decl_contract.py"
)
SIBLING_LANDMARK_WORLD_LOCATION_SCRIPT = (
    "Scripts/tests/test_mission_landmark_anchor_landmark_id"
    "_field_decl_contract.py"
)
SIBLING_MISSION_EXCLUSIVE_SCRIPT = (
...
TARGET_WRONG_TEXT = "FText WorldLocation;"
...
STOP_BEFORE_MAP_READINESS = "struct FSkyguardMissionMapReadiness"
STOP_BEFORE_SKYLINE = "enum class ESkyguardMissionSkylineStyle"
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission_presentation_briefing_field_decl_contract.py",
    "Scripts/tests/test_mission_presentation_radio_chatter_field_decl_contract.py",
    "Scripts/tests/test_mission_presentation_success_debrief_field_decl_contract.py",
    "Scripts/tests/test_mission_presentation_failure_debrief_field_decl_contract.py",
    "Scripts/tests/test_mission_presentation_minimum_briefing_warmup_seconds_field_decl_contract.py",
    ...
    "Scripts/tests/test_mission_score_rules_completion_score_field_decl_contract.py",
    "Scripts/tests/test_mission_score_rules_perfect_accuracy_bonus_field_decl_contract.py",
    "Scripts/tests/test_mission_score_rules_no_damage_bonus_field_decl_contract.py",
    "Scripts/tests/test_mission_score_rules_bronze_threshold_field_decl_contract.py",
    "Scripts/tests/test_mission_score_rules_silver_threshold_field_decl_contract.py",
    "Scripts/tests/test_mission_score_rules_gold_threshold_field_decl_contract.py",
    ...
    "Scripts/tests/test_objective_definition_required_progress_field_decl_contract.py",
    "Scripts/tests/test_objective_definition_type_field_decl_contract.py",
    "Scripts/tests/test_objective_definition_required_for_mission_success_field_decl_contract.py",
    "Scripts/tests/test_objective_definition_score_reward_field_decl_contract.py",
    "Scripts/tests/test_objective_definition_failure_ends_mission_field_decl_contract.py",
    "Scripts/tests/test_objective_definition_defaults_contract.py",
    "Scripts/tests/test_boss_weak_point_definition_weak_point_id_field_decl_contract.py",
    "Scripts/tests/test_boss_weak_point_definition_required_weapon_field_decl_contract.py",
    "Scripts/tests/test_boss_weak_point_definition_exposes_weak_point_id_field_decl_contract.py",
    "Scripts/tests/test_boss_weak_point_definition_integrity_field_decl_contract.py",
    ...
    "Scripts/tests/test_boss_definition_defeat_objective_id_field_decl_contract.py",
    "Scripts/tests/test_boss_definition_weak_points_field_decl_contract.py",
    "Scripts/tests/test_boss_definition_maximum_breakup_pieces_field_decl_contract.py",
    ...
    "Scripts/tests/test_mission_map_readiness_route_point_count_field_decl_contract.py",
    "Scripts/tests/test_mission_map_readiness_objective_anchor_count_field_decl_contract.py",
    "Scripts/tests/test_mission_map_readiness_landmark_count_field_decl_contract.py",
    "Scripts/tests/test_mission_map_readiness_mission_exclusive_landmark_count_field_decl_contract.py",
    "Scripts/tests/test_mission_map_readiness_route_length_centimeters_field_decl_contract.py",
...
def leftover_skyline_identity() -> str:
...
def leftover_objective_anchor_defaults_scripts() -> tuple[str, ...]:
    return (
        LEFTOVER_MISSION_OBJECTIVE_ANCHOR_DEFAULTS,
        LEFTOVER_MISSION_OBJECTIVE_ANCHOR_DEFAULTS_PY,
        LEFTOVER_MISSION_OBJECTIVE_ANCHOR_DEFAULTS_TESTS,
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # Reject missing initializer, OneVector / Zero() /
    # Harbor 40/80 / leftover Health / bare FVector.
    # Do not accept sibling LandmarkId / Role /
    # bMissionExclusive. Do not accept leftover
    # FSkyguardRoutePoint::WorldLocation or leftover
    # FSkyguardMissionObjectiveAnchor WorldLocation
    # outside this struct window.
    if not has_one_declaration(region, declaration):
        return False
    compact = collapsed(region)
    if re.search(
        r"FVector\s+WorldLocation\s*=\s*FVector::ZeroVector\s*;",
        compact,
    ) is None:
        return False
    if re.search(
        r"FVector\s+WorldLocation\s*=\s*FVector::OneVector\b",
        compact,
    ):
        return False
    if re.search(
        r"FVector\s+WorldLocation\s*=\s*FVector::Zero\s*\(",
        compact,
    ):
        return False
    if re.search(
        r"FVector\s+WorldLocation\s*;",
        compact,
    ):
        return False
    if re.search(
        r"float\s+WorldLocation\b",
        compact,
    ):
        return False
    if re.search(
        r"FName\s+WorldLocation\b",
        compact,
    ):
        return False
    if re.search(
        r"FText\s+WorldLocation\b",
        compact,
    ):
        return False
    return True
...
def leaked_neighbor_tokens() -> tuple[str, ...]:
    return (
        ...
        leftover_skyline_identity(),
        STOP_BEFORE_MAP_READINESS,
        STOP_BEFORE_SKYLINE,
        ...
        "class ASkyguardCampaignTheaterKit",
        "ApplyTheaterKitToWorld",
    )
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    while True:
        ...
        if depth == 0 and re.match(
            r"\s*FVector\s+WorldLocation\b", compact[index:]
        ):
            return compact[start : index - 1]
        cursor = cursor + match.start() + 1
    raise AssertionError(
        "UPROPERTY for FVector WorldLocation is missing from "
...
def require_world_location_specifiers(section: str) -> str:
    ...
    if "EditAnywhere" not in specifiers:
        raise AssertionError(
            ...
            f"{HEADER_PATH} struct {STRUCT_NAME} WorldLocation UPROPERTY"
        )
    if "BlueprintReadWrite" in specifiers:
        raise AssertionError(
            "BlueprintReadWrite instead of BlueprintReadOnly on "
            f"origin/main:{HEADER_PATH} struct {STRUCT_NAME} WorldLocation"
        )
...
class MissionLandmarkAnchorWorldLocationFieldDeclContractTests(unittest.TestCase):
    def test_landmark_anchor_world_location_struct_exists(self) -> None:
        ...
        self.assertNotEqual(STRUCT_NAME, "FSkyguardMissionObjectiveAnchor")
        self.assertNotEqual(STRUCT_NAME, "FSkyguardMissionMapReadiness")
        self.assertNotEqual(STRUCT_NAME, "FSkyguardObjectiveDefinition")
        self.assertNotEqual(STRUCT_NAME, "FSkyguardObjectiveProgress")
        body = struct_body(header)
        self.assertTrue(body.startswith("{"), body)
        self.assertTrue(body.endswith("}"), body)
        section = spec_section(header)
        self.assertTrue(has_declaration(section, LOCKED_DECL), section)
        self.assertTrue(has_identifier(section, "WorldLocation"), section)
        self.assertIn("UPROPERTY", section)
        self.assertIn(STOP_BEFORE_OBJECTIVE_ANCHOR, header)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_ANCHOR, section)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_ANCHOR, body)
        self.assertIn(STOP_BEFORE_MAP_READINESS, header)
        self.assertNotIn(STOP_BEFORE_MAP_READINESS, section)
        self.assertNotIn(STOP_BEFORE_MAP_READINESS, body)
        self.assertIn(STOP_BEFORE_SKYLINE, header)
        self.assertNotIn(STOP_BEFORE_SKYLINE, section)
        self.assertNotIn(STOP_BEFORE_SKYLINE, body)
        self.assertIn(ACTOR_NAME, header)
        self.assertNotIn(ACTOR_NAME, section)
        self.assertNotIn(ACTOR_NAME, body)
        self.assertIn(STOP_BEFORE_MISSION_DEFINITION, header)
        self.assertNotIn(STOP_BEFORE_MISSION_DEFINITION, section)
        self.assertNotIn(STOP_BEFORE_MISSION_DEFINITION, body)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_DEFINITION, header)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_DEFINITION, section)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_PROGRESS, header)
    ...
    def test_missing_struct_fails_closed(self) -> None:
        with self.assertRaises(AssertionError) as raised:
            struct_body(
                "struct FSkyguardUnrelatedMissionLandmarkAnchor\n{\n};\n"
            )
    ...
    def test_other_type_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            spec_section(leftover_definition)
        self.assertIn(STRUCT_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        leftover_progress = (
            "struct FSkyguardObjectiveProgress\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            spec_section(leftover_progress)
        self.assertIn(STRUCT_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_objective_or_readiness_declaration_does_not_satisfy(self) -> None:
        mixed = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            "\tGENERATED_BODY()\n"
            "};\n"
            f"{STOP_BEFORE_OBJECTIVE_ANCHOR}\n"
            "{{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            f"\t{LOCKED_DECL}\n"
            "}}\n"
            f"{STOP_BEFORE_MAP_READINESS}\n"
            "{{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            f"\t{LOCKED_DECL}\n"
            "}}\n"
        ...
        self.assertFalse(has_identifier(section, "WorldLocation"), section)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_ANCHOR, section)
        self.assertNotIn(STOP_BEFORE_MAP_READINESS, section)
        self.assertNotIn(ACTOR_NAME, section)
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, LOCKED_DECL)
        self.assertIn("WorldLocation", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_missing_world_location_declaration_fails_closed(self) -> None:
        empty = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            f"\tFName {SIBLING_LANDMARK_ID};\n"
            f"\tFName {SIBLING_ROLE};\n"
            f"\tbool {SIBLING_MISSION_EXCLUSIVE} = false;\n"
            "};\n"
        )
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        specifiers = require_world_location_specifiers(section)
    ...
    def test_wrong_or_missing_initializer_fails_closed(self) -> None:
        ...
        self.assertNotIn(
            "WorldLocation = FVector::OneVector",
            compact_origin,
        )
        self.assertNotIn(
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(spec_section(empty), LOCKED_DECL)
        self.assertIn("WorldLocation", str(raised.exception))

    def test_world_location_declaration_matches_origin_main(self) -> None:
        section = spec_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FVector WorldLocation"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("= FVector::ZeroVector", LOCKED_DECL)
        self.assertNotIn("= FVector::OneVector", LOCKED_DECL)
        self.assertNotIn("= FVector::Zero()", LOCKED_DECL)
        self.assertNotIn("= ZeroVector;", LOCKED_DECL.replace(
            "= FVector::ZeroVector;",
            "",
        ))
    ...
    def test_wrong_default_and_renames_do_not_satisfy(self) -> None:
        ...
        wrongs = (
            ...
            f"\t{TARGET_WRONG_EMPTY}\n",
            f"\t{TARGET_WRONG_TWO}\n",
            f"\t{TARGET_WRONG_TWO_POINT_ZERO}\n",
            f"\t{TARGET_WRONG_NAME}\n",
            "\tFVector WorldLocations = FVector::ZeroVector;\n",
            "\tint32 WorldLocation;\n",
            "\tbool WorldLocation;\n",
            "\tFVector WorldLocation = FVector(" + forty + ");\n",
            "\tFVector WorldLocation = FVector(" + eighty + ");\n",
        )
    ...
    def test_dropped_edit_anywhere_or_read_write_fails_closed(self) -> None:
        origin = require_world_location_specifiers(
        ...
        with self.assertRaises(AssertionError) as raised:
            require_world_location_specifiers(spec_section(no_edit))
        ...
        with self.assertRaises(AssertionError) as raised:
            require_world_location_specifiers(spec_section(read_write))
        ...
        with self.assertRaises(AssertionError) as raised:
            require_world_location_specifiers(spec_section(visible))
        self.assertIn("EditAnywhere", str(raised.exception))
        with_category = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_world_location_specifiers(spec_section(with_category))
    ...
    def test_does_not_contract_sibling_landmark_fields(self) -> None:
        for sibling in sibling_uncontracted_decls():
            self.assertNotIn(sibling, LOCKED_DECL)
        for field in leftover_neighbor_hit_fields():
            self.assertNotIn(field, LOCKED_DECL)
    ...
    def test_does_not_parse_objective_readiness_or_neighbors(self) -> None:
        header = origin_main_header()
        section = spec_section(header)
        leaked = struct_body(header)
        self.assertIn(STOP_BEFORE_OBJECTIVE_ANCHOR, header)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_ANCHOR, section)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_ANCHOR, leaked)
        self.assertIn(STOP_BEFORE_MAP_READINESS, header)
        self.assertNotIn(STOP_BEFORE_MAP_READINESS, section)
        self.assertNotIn(STOP_BEFORE_MAP_READINESS, leaked)
        self.assertIn(STOP_BEFORE_SKYLINE, header)
        self.assertNotIn(STOP_BEFORE_SKYLINE, section)
        self.assertNotIn(STOP_BEFORE_SKYLINE, leaked)
        self.assertIn(STOP_BEFORE_MISSION_DEFINITION, header)
        self.assertNotIn(STOP_BEFORE_MISSION_DEFINITION, section)
        self.assertNotIn(STOP_BEFORE_MISSION_DEFINITION, leaked)
        self.assertIn(ACTOR_NAME, header)
        self.assertNotIn(ACTOR_NAME, section)
        self.assertNotIn(ACTOR_NAME, leaked)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_DEFINITION, header)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_DEFINITION, section)
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertNotIn("SkyguardMissionMapAssemblyDirector.cpp", THIS_SCRIPT)
    ...
    def test_harbor_40_80_tokens_fail_closed_if_present(self) -> None:
        ...
        for token in leftover_harbor_tokens():
            self.assertNotIn(token, section)
        skyline = leftover_skyline_identity()
        self.assertNotIn(skyline, locked_only)
        self.assertNotIn(skyline, LOCKED_DECL)
        self.assertNotIn(skyline, file_text)
        self.assertNotIn(skyline, section)
        leaked = struct_body(header)
        self.assertNotIn(skyline, leaked)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission-landmark-anchor WorldLocation field decl "
                f"contract contains {banned}; declaration is Apache "
                "CPG 30 mm / Hydra / Hellfire, not leftover live "
                "cop" + "y",
            )
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(Path(__file__).name.endswith(
            "mission_landmark_anchor_world_location_field_decl_contract.py"
        ))
        self.assertIn(LEFTOVER_LANDMARK_ID, LOCKED_SCRIPTS)
        self.assertEqual(
            SIBLING_LANDMARK_WORLD_LOCATION_SCRIPT,
            LEFTOVER_LANDMARK_ID,
        )
        self.assertNotEqual(THIS_SCRIPT, LEFTOVER_LANDMARK_ID)
        self.assertNotIn("SkyguardMissionMapAssemblyDirector.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardMissionTypes.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardMissionDefinition.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardCampaignTheaterKit.cpp", THIS_SCRIPT)
        ...
        self.assertIn(LEFTOVER_MISSION_OBJECTIVE_ANCHOR_DEFAULTS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_OBJECTIVE_ANCHOR_OBJECTIVE_ID, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_OBJECTIVE_ANCHOR_WORLD_LOCATION, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_LANDMARK_ID, LOCKED_SCRIPTS)
        self.assertIn(
            "Scripts/tests/test_route_point_world_location_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(LEFTOVER_MISSION_LANDMARK_ANCHOR_DEFAULTS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_MISSION_OBJECTIVE_ANCHOR_DEFAULTS, LOCKED_SCRIPTS)
        ...
        self.assertIn(SIBLING_ROLE_SCRIPT, LOCKED_SCRIPTS)
        self.assertIn(SIBLING_LANDMARK_WORLD_LOCATION_SCRIPT, LOCKED_SCRIPTS)
        self.assertIn(SIBLING_MISSION_EXCLUSIVE_SCRIPT, LOCKED_SCRIPTS)
    ...
    def test_leftover_mission_result_defaults_stay_locked(self) -> None:
        leftovers = (
            ...
            "Scripts/tests/test_boss_definition_defaults_contract.py",
            "Scripts/tests/test_mission_definition_mission_id_decl_contract.py",
            *leftover_objective_anchor_defaults_scripts(),
            "Scripts/tests/test_briefing_card_defaults_contract.py",
            "Scripts/tests/test_briefing_radio_row_defaults_contract.py",
            "Scripts/tests/test_how_to_fly_row_defaults_contract.py",
            "Scripts/tests/test_briefing_card_priority_field_decl_contract.py",
    ...
    def test_contract_is_target_field_declaration_only(self) -> None:
        ...
        self.assertNotIn("FSkyguardMissionObjectiveAnchor", locked_only)
        self.assertNotIn("FSkyguardMissionMapReadiness", locked_only)
        ...
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_ANCHOR, locked_only)
        self.assertNotIn(STOP_BEFORE_MAP_READINESS, locked_only)
        self.assertNotIn(STOP_BEFORE_SKYLINE, locked_only)
        self.assertNotIn(STOP_BEFORE_MISSION_DEFINITION, locked_only)
        self.assertNotIn(SIBLING_LANDMARK_ID, locked_only)
        self.assertNotIn(SIBLING_ROLE, locked_only)
        self.assertNotIn(SIBLING_MISSION_EXCLUSIVE, locked_only)
        for helper in namespace_helper_tokens():
