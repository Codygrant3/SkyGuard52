...
# INDEX_NONE or lock bRadarGhostReady
# construction in the .cpp. This is leftover-safe
# Mission07 IntegrationReadiness bRadarGhostReady
...
# FIELD #1001 / branch cursor/mission06-
# runway-breaker-ready-field-decl-contract-c332,
# NOT leftover Mission04 bBlackKiteReady
# FIELD #931 / branch cursor/mission04-
# black-kite-ready-field-decl-contract-c332,
# NOT leftover Mission07 director RadarGhostSpawnLocation
# #1023 / branch cursor/mission07-radar-
# ghost-spawn-location-field-decl-contract-c332,
# NOT leftover Mission07 director RadarGhostSpawnRotation
# #1024 / branch cursor/mission07-radar-
# ghost-spawn-rotation-field-decl-contract-c332,
# NOT leftover Mission07 bGunnerReady
# FIELD #1031 / branch cursor/mission07-
...
# BETWEEN bMapAssemblyReady and leftover bGunnerReady
# on this struct; leftover bGunnerReady sits immediately
# before this bRadarGhostReady field. Do not lock this
# contract onto leftover retired-runtime-ready or leftover
# bGunnerReady). Skip leftover
...
RADAR_GHOST_READY_TRUE = (
    "bool bRadarGhostReady = true;"
)
OBJECTIVES_READY = (
...
# an isolated Python bRadarGhostReady
...
class Mission07RadarGhostReadyFieldDeclContractTests(unittest.TestCase):
    def test_mission07_radar_ghost_struct_exists(self) -> None:
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bRadarGhostReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_radar_ghost_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_radar_ghost_ready_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bRadarGhostReady"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bRadarGhostReady", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bRadarGhostReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bRadarGhostReady"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bRadarGhostReady", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 bRadarGhostReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission07 bRadarGhostReady contains "
    ...
    def test_contract_is_radar_ghost_ready_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_radar_ghost_ready(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_contract_skips_leftover_retired_runtime_ready(self) -> None:
        ...
        self.assertNotEqual(LOCKED_DECL, RUNWAY_BREAKER_READY)
        self.assertNotEqual(LOCKED_DECL, BLACK_KITE_READY)
        self.assertNotIn(RADAR_GHOST_SPAWN_LOCATION, LOCKED_DECL)
        self.assertNotIn(RADAR_GHOST_SPAWN_ROTATION, LOCKED_DECL)
    ...
    def test_leftover_same_name_gunner_ready_contracts_stay_locked(
        ...
        self.assertNotIn(
            "Scripts/tests/test_mission07_radar_ghost_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        for leftover in LEFTOVER_MISSION07_WAVES_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION06_RUNWAY_BREAKER_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION04_BLACK_KITE_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        self.assertNotIn(
            "ASkyguardMission07IntegrationDirector",
