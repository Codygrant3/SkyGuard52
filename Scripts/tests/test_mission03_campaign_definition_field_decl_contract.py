...
# decl-contract-c332, NOT leftover Mission03 Briefing
# field #878 / branch cursor/mission03-briefing-
# field-decl-contract-c332, NOT leftover Mission02
# bCampaignDefinitionValid #862, NOT leftover
# Mission10 bCampaignDefinitionValid #811, NOT leftover
...
# Mission01 / Mission02 / Mission04-10 CampaignDefinition
...
class Mission03CampaignDefinitionFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 CampaignDefinition field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission03 CampaignDefinition contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission03_campaign_definition_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission02_campaign_definition_valid"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
