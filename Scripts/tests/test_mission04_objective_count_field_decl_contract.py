...
CLASS_NAME = "FSkyguardMission04IntegrationReadiness"
# Declaration presence only. Do not invent
# INDEX_NONE or lock ObjectiveCount
# construction in the .cpp. This is leftover-safe
# Mission04 IntegrationReadiness ObjectiveCount
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 default 0,
# one-line / split-line UPROPERTY wraps) on
# FSkyguardMission04IntegrationReadiness. It is
# an int32 count FIELD named ObjectiveCount, NOT a
# leftover Mission02 wave-state enum / leftover
# Mission02 GetWaveState. THIS IS NOT leftover
# Mission02 ObjectiveCount FIELD #873 / branch
# cursor/mission02-objective-count-field-decl-
# contract-c332. THIS IS NOT leftover Mission03
# ObjectiveCount FIELD #905 / branch cursor/
# mission03-objective-count-field-decl-contract-
# c332. THIS IS NOT leftover Mission10
# ObjectiveCount FIELD #823 / branch cursor/
# mission10-objective-count-field-decl-contract-
# c332. THIS IS NOT leftover Mission04
# bObjectivesReady FIELD #930 / branch cursor/
# mission04-objectives-ready-field-decl-contract-
# c332. THIS IS NOT leftover Mission03
# bObjectivesReady sibling / branch cursor/
# mission03-objectives-ready-field-decl-contract-
# c332. THIS IS NOT leftover Mission03
# bBriefingReady sibling / branch cursor/
# mission03-briefing-ready-field-decl-contract-
# c332. Skip leftover retired-mount runtime-ready
# struct field entirely. Skip leftover
# BindRuntimeActors / HandleDroneCityImpact /
# retired-mount spawn. Do not lock leftover
# GetObjectiveRuntime() methods. It is
# NOT leftover Mission10 bBriefingReady FIELD #819 /
# branch cursor/mission10-briefing-ready-field-decl-
# contract-c332, NOT leftover Mission10
# ObjectiveCount FIELD #823 / branch cursor/
# mission10-objective-count-field-decl-contract-c332,
# NOT leftover Mission10 WaveCount sibling / leftover
# Mission10 ProtectedGroupCount sibling, NOT leftover
# Mission02 GetObjectiveRuntime methods, NOT leftover
# director Readiness field #860, NOT leftover Mission02
# GetReadiness #837, NOT leftover Mission10
# bObjectivesReady #815, NOT leftover Mission02
# bObjectivesReady #867, NOT leftover retired-mount
# runtime-ready sibling readiness field (skip that
# field), NOT leftover Mission02 wave-state enum,
# NOT leftover Mission02 briefing-ready FIELD sibling / NOT leftover Mission01 Briefing
# component field #568 / leftover Mission02 Briefing
# director field #846, NOT leftover Mission10 Briefing
# #795 / leftover Mission10 bSortiePresentationReady
# #820 / leftover Mission10 bAudioReady #821, NOT leftover
# Mission02 waves-ready FIELD sibling / branch
# cursor/mission02-waves-ready-field-decl-contract-c332,
# NOT leftover Mission02 objectives-ready / breakwater-
# ready FIELD siblings, NOT leftover Mission10 bPhaseWavesReady FIELD
# #817 / branch cursor/mission10-phase-waves-ready-
# field-decl-contract-c332, NOT leftover Mission10
# bObjectivesReady #815, NOT leftover Mission10
# bMapAssemblyReady #812, NOT leftover Mission10
# bCampaignDefinitionValid #811, NOT leftover
# Mission10 bMissionDefinitionValid #810, NOT leftover
# Mission02 gunner-ready FIELD sibling / branch
# cursor/mission02-gunner-ready-field-decl-
# contract-c332, NOT leftover Mission10 bGunnerReady FIELD #814 /
# branch cursor/mission10-gunner-ready-field-decl-
# contract-c332, NOT leftover director Readiness
# field, NOT leftover Mission02 GetReadiness #837,
# NOT leftover Mission10 CampaignDefinition
# UPROPERTY #798 / branch cursor/mission10-
...
# field-decl-contract-c332, NOT leftover Mission10
# Readiness field #809 on the director / branch
...
# fields on the director, NOT leftover retired-mount
# runtime-ready sibling readiness field,
# NOT leftover Mission01 GetGunner method
# contracts / branch cursor/mission01-get-
# gunner-decl-contract-c332,
...
# struct section of
# FSkyguardMission04IntegrationReadiness only
# (not ASkyguardMission04IntegrationDirector,
# not leftover FSkyguardMission03IntegrationReadiness,
# not leftover FSkyguardSearchlightTrackRuntime,
# not leftover Mission02/03/10 ObjectiveCount).
...
# drafts #674-#935 including leftover Mission10
# bGunnerReady #814, leftover Apache
...
# and the locked FSkyguardMission04IntegrationReadiness
...
# Mission10 Readiness field #809. Do not reopen leftover
...
# drafts #674-#870 including leftover Mission10
# bBriefingReady #819 / leftover Mission10 Briefing
# #795 / leftover Mission10 bSortiePresentationReady
# #820 / leftover Mission10 bAudioReady #821 /
# leftover Mission10 bPhaseWavesReady #817 / leftover Mission10
# bGunnerReady #814 and leftover Mission02
# siblings #828-#859. Do not reopen leftover
# drafts #536-#673 or open drafts #674-#870.
...
# FSkyguardMission04IntegrationReadiness. This is NOT leftover
# Mission03 ObjectiveCount #905. This is NOT leftover
# Mission02 ObjectiveCount #873. This is NOT leftover
# Mission10 ObjectiveCount #823. This is NOT leftover
# Mission04 bObjectivesReady #930.
LOCKED = {
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission04_searchlights_ready_field_decl_contract.py",
    "Scripts/tests/test_mission04_waves_ready_field_decl_contract.py",
    "Scripts/tests/test_mission04_substation_ready_field_decl_contract.py",
    "Scripts/tests/test_mission04_black_kite_ready_field_decl_contract.py",
    ...
    "Scripts/tests/test_mission04_radio_line_count_field_decl_contract.py",
...
LEFTOVER_MISSION10_MISSION_DEFINITION_VALID_FIELD_NOT_LOCKED = (
...
LEFTOVER_MISSION10_GUNNER_READY_FIELD_NOT_LOCKED = (
...
LEFTOVER_MISSION10_PHASE_WAVES_READY_NOT_LOCKED = (
...
LEFTOVER_MISSION02_BREAKWATER_READY_NOT_LOCKED = (
    "test_mission02_breakwater_ready_field_decl_contract.py",
    "cursor/mission02-breakwater-ready-field-decl-contract-c332",
    "bBreakwaterReady",
)
LEFTOVER_MISSION10_BRIEFING_READY_FIELD_NOT_LOCKED = (
...
class Mission04ObjectiveCountFieldDeclContractTests(unittest.TestCase):
    def test_mission04_struct_exists(self) -> None:
    ...
    def test_contract_does_not_relock_leftover_mission02_wave_state(
        ...
        self.assertTrue(LOCKED_DECL.startswith("int32 ObjectiveCount"))
        self.assertNotIn("bPhaseWavesReady", LOCKED_DECL)
        self.assertNotIn("bWavesReady", LOCKED_DECL)
        self.assertNotIn("ESkyguardMission02WaveState", LOCKED_DECL)
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        # This Mission02 field default 0 is not Harbor 40/80.
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 ObjectiveCount field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 ObjectiveCount contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_objective_count"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_objectives_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission04_objectives_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission04_searchlights_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission10_phase_waves_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_gunner_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission10_objectives_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission02_objectives_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission02_breakwater_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission10_audio_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission02_briefing"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertNotIn("bWavesReady", LOCKED_DECL)
        self.assertNotIn("bAudioReady", LOCKED_DECL)
        self.assertNotIn("bSortiePresentationReady", LOCKED_DECL)
        self.assertIn(
    ...
    def test_sibling_count_fields_do_not_satisfy_objective_count(self) -> None:
        ...
        leftover_protected = "\tint32 ProtectedGroupCount = 0;\n"
        ...
        leftover_runtime = "\tUSkyguardObjectiveRuntime* GetObjectiveRuntime() const;\n"
        leftover_readiness = (
            "\tFSkyguardMission02IntegrationReadiness Readiness;\n"
        )
        ...
        leftover_wave_enum = "\tESkyguardMission02WaveState WaveState;\n"
