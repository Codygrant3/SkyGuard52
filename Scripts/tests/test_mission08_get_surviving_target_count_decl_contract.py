...
# Mission08 Protection GetSurvivingTargetCount METHOD
# on ASkyguardMission08IntegrationDirector. It is
# NOT leftover Mission07 GetSurvivingTargetCount
# #725, NOT leftover Mission06 GetSurvivingTargetCount
# #703, NOT leftover Mission05 GetSurvivingTargetCount
# #674, NOT leftover Mission07 IsCorePlayableReady
...
# GetProtectedTarget / IsCorePlayableReady /
...
# leftover Mission07 IsCorePlayableReady #715 / #743,
...
# Integration, not leftover Mission08 Integration, not
...
# protected-target-runtime-defaults #75e6 / #226,
# leftover hoist-window-runtime-defaults #ec79.
# Do not reopen open drafts #674–#743+.
...
class Mission08GetSurvivingTargetCountDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        as_const = "\tint32 GetSurvivingTargetCount();\n"
        with_arg = "\tint32 GetSurvivingTargetCount(int32 Amount) const;\n"
    ...
    def test_get_surviving_target_count_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("ESkyguardMission07WaveState", GET_SURVIVING_TARGET_COUNT)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 GetSurvivingTargetCount method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission08 GetSurvivingTargetCount contains "
    ...
    def test_leftover_mission08_is_core_playable_ready_does_not_satisfy(
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover, GET_SURVIVING_TARGET_COUNT)
        self.assertIn("GetSurvivingTargetCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission08_wave_state_enum(
        ...
        self.assertNotIn("ESkyguardMission08WaveState", GET_SURVIVING_TARGET_COUNT)
    ...
    def test_sibling_mission08_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("GetReadiness", GET_SURVIVING_TARGET_COUNT)
        self.assertNotIn("GetObjectiveRuntime", GET_SURVIVING_TARGET_COUNT)
        self.assertNotIn("ValidateWeaponRelease", GET_SURVIVING_TARGET_COUNT)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_get_surviving_target_count"
                "_decl_contract.py"
            )
        )
        self.assertIn(
