...
# INDEX_NONE or lock CompletedPasses
# construction in the .cpp. This is leftover-safe
# Mission04 SearchlightTrackRuntime CompletedPasses
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 default 0 / 100 / 0.f,
...
# GetSearchlightRuntime, HeldSeconds, bActive,
# bBossTracked, or RemainingSeconds as the subject),
# NOT leftover Mission04 SearchlightTrackRuntime
# RemainingSeconds FIELD / branch cursor/
# mission04-searchlight-track-remaining-
# seconds-field-decl-contract-c332,
# NOT leftover Mission04 SearchlightTrackRuntime
# bActive FIELD / branch cursor/mission04-
# searchlight-track-active-field-decl-
# contract-c332,
...
COMPLETED_PASSES_FIELD = (
    "int32 CompletedPasses = 0;"
)
LOCKED_DECL = COMPLETED_PASSES_FIELD
...
SEARCHLIGHT_TRACK_REMAINING_SECONDS_FIELD = (
    "float RemainingSeconds = 0.f;"
)
COMPLETED_PASSES_FIELD_HUNDRED = (
    "int32 CompletedPasses = 100;"
)
COMPLETED_PASSES_FIELD_ZERO = (
    "int32 CompletedPasses = 0;"
)
...
# an isolated Python CompletedPasses
...
# Alternate CompletedPasses defaults are accepted as declaration
# forms without becoming LOCKED_DECL.
...
def unlocked_neighbors() -> tuple[str, ...]:
    return (
        ...
        SEARCHLIGHT_TRACK_HELD_SECONDS_FIELD,
        SEARCHLIGHT_TRACK_REMAINING_SECONDS_FIELD,
        COMPLETED_PASSES_FIELD_HUNDRED,
...
class Mission04SearchlightTrackCompletedPassesFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("CompletedPasses", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_completed_passes_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_completed_passes_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 CompletedPasses"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= 0;"), LOCKED_DECL)
        self.assertIn("CompletedPasses", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_true = (
            "public:\n"
            f"\t{UPROPERTY_MISSION10}\n"
            f"\t{COMPLETED_PASSES_FIELD_HUNDRED}\n"
            "};\n"
        )
        wrap_true_one_line = (
            "public:\n"
        ...
        for header in (
            ...
            accepted = (
                ...
                else COMPLETED_PASSES_FIELD_HUNDRED
            )
            self.assertTrue(
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("CompletedPasses", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 CompletedPasses"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("CompletedPasses", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 CompletedPasses field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 CompletedPasses contains "
    ...
    def test_contract_is_completed_passes_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_completed_passes(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            ...
            "_completed_passes_field_decl_contract.py"
        )
