...
# Mission08 Integration ValidateMissionContract
# METHOD (declaration-only, split-line) on
# ASkyguardMission08IntegrationDirector.
# It is NOT leftover Mission07
# ValidateMissionContract #728, NOT leftover
# Mission06 ValidateMissionContract #707, NOT leftover
# Mission05 ValidateMissionContract #686, NOT leftover
# closed Mission04 ValidateMissionContract #667, NOT leftover
# Mission07 GetMissionId #727 / Mission06 #704 /
# Mission05 #680 / closed Mission04 #663, NOT leftover
# Mission08 wave-state enum #68fc / #237, NOT leftover
# Mission08 protected-target enum #a66a / #229,
# NOT leftover Mission08 protected-target-runtime-
# defaults #75e6 / #226, NOT leftover
...
# #721, NOT leftover Mission07 IsCorePlayableReady
# #715, NOT leftover Mission07 GetSurvivingTargetCount
# #725 / Mission06 #703 / Mission05 #674, NOT leftover
# Mission07 GetProtectedTarget #723 / Mission05 #678,
# NOT leftover Mission08 GetWaveState, NOT leftover
...
# GetMissionId / GetProtectedTarget. Do not
...
# Protection, not Mission01 / Mission02 / Mission03 /
...
# Mission07 ValidateMissionContract #728, not leftover
# Mission06 ValidateMissionContract #707, not leftover
# Mission05 ValidateMissionContract #686, not leftover
# closed Mission04 ValidateMissionContract #667, not leftover
# Mission07 Integration #717, not leftover
...
# ValidateMissionContract #728 / branch
# cursor/mission07-validate-mission-contract-decl-
# contract-c332. Do not reopen leftover Mission06
# ValidateMissionContract #707 / branch
# cursor/mission06-validate-mission-contract-decl-
# contract-c332. Do not reopen leftover Mission05
# ValidateMissionContract #686 / branch
# cursor/mission05-validate-mission-contract-decl-
# contract-c332. Do not reopen leftover closed
# Mission04 ValidateMissionContract #667. Do not
# reopen leftover Mission08
# protected-target enum #a66a / #229. Do not
# reopen leftover Mission08 protected-target-
# runtime-defaults #75e6 / #226. Do not reopen
# leftover Mission08 wave-state enum #68fc / #237.
# Do not reopen leftover drafts #56–#64,
...
LOCKED_DECL = VALIDATE_MISSION_CONTRACT
...
# leftover closed Mission04 ValidateMissionContract #667,
...
LEFTOVER_MISSION07_VALIDATE_NOT_LOCKED = (
    "test_mission07_validate_mission_contract_decl_contract.py",
    "ASkyguardMission07IntegrationDirector",
    "SkyguardMission07IntegrationDirector.h",
    'Category="Skyguard|Mission07|Integration"',
    "cursor/mission07-validate-mission-contract-decl-contract-c332",
)
LEFTOVER_MISSION06_VALIDATE_NOT_LOCKED = (
    "test_mission06_validate_mission_contract_decl_contract.py",
    "ASkyguardMission06IntegrationDirector",
    "SkyguardMission06IntegrationDirector.h",
    'Category="Skyguard|Mission06|Integration"',
    "cursor/mission06-validate-mission-contract-decl-contract-c332",
)
LEFTOVER_MISSION05_VALIDATE_NOT_LOCKED = (
    "test_mission05_validate_mission_contract_decl_contract.py",
    "ASkyguardMission05IntegrationDirector",
    "SkyguardMission05IntegrationDirector.h",
    'Category="Skyguard|Mission05|Integration"',
    "cursor/mission05-validate-mission-contract-decl-contract-c332",
)
LEFTOVER_MISSION04_VALIDATE_NOT_LOCKED = (
    "test_mission04_validate_mission_contract_decl_contract.py",
    "ASkyguardMission04IntegrationDirector",
    "SkyguardMission04IntegrationDirector.h",
    'Category="Skyguard|Mission04|Integration"',
...
class Mission08ValidateMissionContractDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_validate = f"\t{GET_PROTECTED_TARGET}\n"
    ...
    def test_validate_mission_contract_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("static bool "),
            LOCKED_DECL,
        )
        self.assertTrue(
        ...
        self.assertIn("ValidateMissionContract", LOCKED_DECL)
        self.assertIn("ValidateMissionContract(", LOCKED_DECL)
        self.assertIn(
            "const USkyguardMissionDefinition* Mission",
            LOCKED_DECL,
        )
        self.assertIn("TArray<FText>& OutErrors", LOCKED_DECL)
        ...
        self.assertNotIn("TSoftObjectPtr<USkyguardMissionDefinition>", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_INTEGRATION} {LOCKED_DECL}\n"
            "};\n"
        )
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(leftover_search, UFUNCTION_INTEGRATION)
        self.assertNotEqual(leftover_protection, UFUNCTION_INTEGRATION)
        ...
        self.assertNotEqual(leftover_m07_waves, UFUNCTION_INTEGRATION)
        ...
        self.assertNotIn(leftover_m07, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_search, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_protection, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_hoist, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_safety, UFUNCTION_INTEGRATION)
        self.assertNotIn("Mission01", UFUNCTION_INTEGRATION)
        self.assertNotIn("Mission03", UFUNCTION_INTEGRATION)
        self.assertNotIn("Mission04", UFUNCTION_INTEGRATION)
        self.assertNotIn("Mission05", UFUNCTION_INTEGRATION)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 GetRemainingThreatsInWave method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 GetRemainingThreatsInWave contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_validate_mission_contract"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_origin_main_accepts_split_line_without_locking_body(self) -> None:
        ...
        self.assertIn(UFUNCTION_INTEGRATION, section)
        self.assertIn("ValidateMissionContract(", section)
        self.assertIn("const USkyguardMissionDefinition* Mission", section)
        self.assertIn("TArray<FText>& OutErrors", section)
        self.assertNotIn("{", LOCKED_DECL)
        self.assertNotIn("return ", LOCKED_DECL)
        self.assertNotIn("return false", LOCKED_DECL)
        self.assertNotIn("return true", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_leftover_mission07_validate(self) -> None:
        locked_only = f"{LOCKED_DECL}\n"
        for token in LEFTOVER_MISSION07_VALIDATE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission06_validate(self) -> None:
        locked_only = f"{LOCKED_DECL}\n"
        for token in LEFTOVER_MISSION06_VALIDATE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission05_validate(self) -> None:
        locked_only = f"{LOCKED_DECL}\n"
        for token in LEFTOVER_MISSION05_VALIDATE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission04_validate(self) -> None:
        locked_only = f"{LOCKED_DECL}\n"
        for token in LEFTOVER_MISSION04_VALIDATE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        self.assertIn(
            "Scripts/tests/test_mission04_validate_mission_contract"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        leftover = (
