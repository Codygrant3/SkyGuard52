...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission08 HoistWindowRuntime
# bActive. THIS IS NOT leftover Mission09 ProtectedTargetRuntime
# bDestroyed #1125. THIS IS NOT leftover Mission09 ProtectedTargetRuntime
# Target #1124. THIS IS NOT leftover Mission09
# ProtectedTargetRuntime Integrity. THIS IS NOT leftover Mission08
# FSkyguardMission08IntegrationReadiness
...
# Mission08 HoistWindowRuntime bActive
...
# drafts #674-#1126. Do not reopen leftover
...
class Mission08HoistWindowRuntimeActiveFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 bActive field contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_hoist_window_runtime"
                "_active_field_decl_contract.py"
            )
        )
        self.assertIn(
