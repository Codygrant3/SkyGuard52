...
# INDEX_NONE or lock RaftsAnchor
# construction in the .cpp. This is leftover-safe
# Mission08 RaftsAnchor FIELD
...
# RescueVesselAnchor / Briefing / AudioDirector /
...
# an isolated Python RaftsAnchor
...
class Mission08RaftsAnchorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("RaftsAnchor", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_rafts_anchor_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_rafts_anchor_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertIn("RaftsAnchor", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("RaftsAnchor;", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 RaftsAnchor field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 RaftsAnchor field contains "
    ...
    def test_contract_is_rafts_anchor_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_rafts_anchor(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_rafts_anchor_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_readiness_struct_does_not_satisfy_rafts_anchor(self) -> None:
        leftover = (
    ...
    def test_hoist_window_runtime_struct_does_not_satisfy_rafts_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_protected_target_runtime_struct_does_not_satisfy_rafts_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_storm_runtime_struct_does_not_satisfy_rafts_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_airfield_target_runtime_struct_does_not_satisfy_rafts_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_struct_does_not_satisfy_rafts_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_declaration_accepts_origin_main_default_forms(self) -> None:
        ...
        stem = "TObjectPtr<USceneComponent> RaftsAnchor"
