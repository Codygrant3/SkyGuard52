...
# Mission03 Waves GetWaveState
# on ASkyguardMission03IntegrationDirector. It is
# NOT leftover Mission03 wave-state enum #0242
# (do not lock enum values), NOT leftover Harbor
# Mission02 / leftover ESkyguardMission02WaveState
# / leftover Harbor #6/#8/#9, NOT leftover
# BindRuntimeActors (retired live mount in the
# locked decl), NOT leftover GetAircraft (returns
# the retired live mount), and NOT leftover
...
# GetCurrentWaveIndex / GetRemainingThreatsInWave /
# GetConvoyRouteState / GetDayBeatKit. Do not lock
...
# Category is Skyguard|Mission03|Waves, not
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission03IntegrationDirector::GetWaveState",
    "SkyguardMission03IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission03GetWaveStateDeclContractTests(unittest.TestCase):
    ...
    def test_get_wave_state_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            GET_WAVE_STATE.startswith("ESkyguardMission03WaveState"),
            GET_WAVE_STATE,
        )
        self.assertTrue(
        ...
        self.assertNotIn("EnvironmentReadiness", GET_WAVE_STATE)
        self.assertNotIn("MissionMapReadiness", GET_WAVE_STATE)
        self.assertNotIn("Mission01IntegrationReadiness", GET_WAVE_STATE)
        self.assertNotIn("Mission03IntegrationReadiness", GET_WAVE_STATE)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("GetWaveState", GET_WAVE_STATE)
        self.assertTrue(GET_WAVE_STATE.startswith("ESkyguardMission03WaveState"))
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 GetWaveState method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission03 GetWaveState contains "
