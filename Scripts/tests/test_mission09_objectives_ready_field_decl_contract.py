...
# bObjectivesReady FIELD (declaration-only;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission09 readiness-struct
# bObjectivesReady. THIS IS NOT leftover Mission08
...
# same-name readiness-struct bObjectivesReady drafts.
...
# merge #665 #666 #668-#673, or open drafts #674-#1104.
...
# bCampaignRuntimeStarted #1103 / bMapAssemblyReady
# #1104.
...
# INDEX_NONE or lock bObjectivesReady
# construction in the .cpp. This is leftover-safe
# Mission09 IntegrationReadiness bObjectivesReady
...
OBJECTIVES_READY_TRUE = (
    "bool bObjectivesReady = true;"
)
LOCKED_DECL = OBJECTIVES_READY
...
# an isolated Python bObjectivesReady
...
class Mission09ObjectivesReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bObjectivesReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_objectives_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_objectives_ready_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bObjectivesReady"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bObjectivesReady", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bObjectivesReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bObjectivesReady"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bObjectivesReady", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 bObjectivesReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 bObjectivesReady contains "
    ...
    def test_contract_is_objectives_ready_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_objectives_ready(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
