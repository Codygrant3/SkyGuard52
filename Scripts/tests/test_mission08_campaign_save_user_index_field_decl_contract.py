...
# Mission08 CampaignSaveUserIndex FIELD
...
UPROPERTY_MISSION08_CLAMP = 'meta=(ClampMin="0")'
...
class Mission08CampaignSaveUserIndexFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn("Campaign", UPROPERTY_MISSION08)
        self.assertIn("Skyguard|Mission08|Campaign", UPROPERTY_MISSION08)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 CampaignSaveUserIndex field contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission08_campaign_save_user_index_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_campaign_save_user_index_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
