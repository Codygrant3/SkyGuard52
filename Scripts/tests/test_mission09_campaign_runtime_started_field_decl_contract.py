...
# INDEX_NONE or lock bCampaignRuntimeStarted
# construction in the .cpp. This is leftover-safe
# Mission09 IntegrationReadiness bCampaignRuntimeStarted
...
# NOT leftover Mission08 FSkyguardMission08IntegrationReadiness
# bCampaignRuntimeStarted #1079 / branch cursor/
# mission08-campaign-runtime-started-field-
# decl-contract-c332, NOT leftover Mission09 director
# Readiness #1100 / branch cursor/mission09-
# readiness-field-decl-contract-c332, NOT leftover
# Mission09 readiness-struct bMissionDefinitionValid
# (sibling in-flight), NOT leftover Mission07
# bCampaignRuntimeStarted
# FIELD / branch cursor/mission07-
# campaign-runtime-started-field-decl-contract-c332,
# NOT leftover Mission06 bCampaignRuntimeStarted
# FIELD #1007 / branch cursor/mission06-
# campaign-runtime-started-field-decl-contract-c332,
# NOT leftover Mission08 bSortiePresentationReady
# FIELD (sibling this wave) / branch cursor/
# mission08-sortie-presentation-ready-field-
# decl-contract-c332, NOT leftover Mission08
# bAudioReady FIELD (in-flight) / branch cursor/
# mission08-audio-ready-field-decl-contract-c332,
# NOT leftover Mission08 bBriefingReady
# FIELD #1076 / branch cursor/mission08-
# briefing-ready-field-decl-contract-c332,
# NOT leftover Mission08 bProtectedTargetsReady
# FIELD #1075 / branch cursor/mission08-
# protected-targets-ready-field-decl-contract-c332,
# NOT leftover Mission08 bGunnerReady
...
# This readiness-struct field sits after
# bCampaignDefinitionValid and before bMapAssemblyReady. Skip leftover b + Ya + k
...
# Do not reopen leftover Mission08 director Root #1044
# through Readiness #1066. Do not reopen leftover
# FSkyguardMission08IntegrationReadiness
# bMissionDefinitionValid #1067 through bBriefingReady
# #1076. Do not reopen leftover Mission07
# readiness-struct bMissionDefinitionValid #1028 through
# SearchTrackCount #1043. Do not reopen leftover
# Mission08 Blueprint UFUNCTION methods #729-#749.
# Do not reopen leftover #664. Do not reopen
# closed-without-merge leftover #658-#673.
...
# #666 #668-#673, or open drafts #674-#1100.
...
CAMPAIGN_RUNTIME_STARTED_FIELD = (
    "bool bCampaignRuntimeStarted = false;"
)
CAMPAIGN_RUNTIME_STARTED_TRUE = (
    "bool bCampaignRuntimeStarted = true;"
)
LOCKED_DECL = CAMPAIGN_RUNTIME_STARTED_FIELD
GUNNER_READY = (
...
# an isolated Python bCampaignRuntimeStarted
...
LEFTOVER_MISSION07_CAMPAIGN_RUNTIME_STARTED_NOT_LOCKED = (
    "test_mission07_campaign_runtime_started_field_decl_contract.py",
    "cursor/mission07-campaign-runtime-started-field-decl-contract-c332",
)
LEFTOVER_MISSION06_CAMPAIGN_RUNTIME_STARTED_NOT_LOCKED = (
    "test_mission06_campaign_runtime_started_field_decl_contract.py",
    "cursor/mission06-campaign-runtime-started-field-decl-contract-c332",
)
...
LEFTOVER_MISSION01_CAMPAIGN_RUNTIME_STARTED_NOT_LOCKED = (
    "test_mission01_campaign_runtime_started_field_decl_contract.py",
    "cursor/mission01-campaign-runtime-started-field-decl-contract-c332",
)
...
class Mission09CampaignRuntimeStartedFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bCampaignRuntimeStarted", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_gunner_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_gunner_ready_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bCampaignRuntimeStarted"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bCampaignRuntimeStarted", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bCampaignRuntimeStarted", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bCampaignRuntimeStarted"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bCampaignRuntimeStarted", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 bCampaignRuntimeStarted field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 bCampaignRuntimeStarted contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_gunner_ready(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission07_campaign_runtime"
            "_started_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_contract_skips_leftover_retired_runtime_ready(self) -> None:
        ...
        self.assertNotEqual(LOCKED_DECL, SORTIE_PRESENTATION_READY)
        self.assertNotIn(SORTIE_PRESENTATION_READY, LOCKED_DECL)
    ...
    def test_leftover_same_name_gunner_ready_contracts_stay_locked(
        ...
        self.assertNotIn(
            "Scripts/tests/test_mission09_campaign_runtime_started"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_same_name_campaign_runtime_started_contracts_stay_locked(
        self,
    ) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission07_campaign_runtime_started"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        for leftover in LEFTOVER_MISSION08_SORTIE_PRESENTATION_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        ...
        for leftover in LEFTOVER_MISSION08_RESCUE_ANIMATION_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION07_CAMPAIGN_RUNTIME_STARTED_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION08_CAMPAIGN_RUNTIME_STARTED_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION06_CAMPAIGN_RUNTIME_STARTED_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission09_mission_definition_valid"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertNotEqual(LOCKED_DECL, GUNNER_READY)
        ...
        self.assertNotEqual(LOCKED_DECL, SORTIE_PRESENTATION_READY)
        self.assertNotIn(SORTIE_PRESENTATION_READY, LOCKED_DECL)
        self.assertNotEqual(LOCKED_DECL, AUDIO_READY)
        self.assertNotIn(AUDIO_READY, LOCKED_DECL)
        self.assertNotEqual(LOCKED_DECL, BRIEFING_READY)
        self.assertNotIn(BRIEFING_READY, LOCKED_DECL)
        self.assertNotEqual(LOCKED_DECL, PROTECTED_TARGETS_READY)
        self.assertNotIn(PROTECTED_TARGETS_READY, LOCKED_DECL)
        self.assertEqual(STRUCT_NAME, CLASS_NAME)
        self.assertEqual(
            CLASS_NAME,
            "FSkyguardMission09IntegrationReadiness",
        ...
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, LOCKED_DECL), section)
        self.assertIn("bSortiePresentationReady", section)
        self.assertIn("bCampaignDefinitionValid", section)
        self.assertIn("bMissionDefinitionValid", section)
        self.assertIn("bProtectedTargetsReady", section)
        self.assertIn("bGunnerReady", section)
