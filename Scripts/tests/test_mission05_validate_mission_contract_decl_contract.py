...
# Mission05 Integration ValidateMissionContract
# METHOD on ASkyguardMission05IntegrationDirector. It
# is NOT leftover Mission04 ValidateMissionContract
# #667, NOT leftover Mission01 ValidateMissionContract,
# NOT leftover Mission03 ValidateMissionContract. It is
...
# GetRemainingThreatsInWave / GetMissionId /
...
# Waves / Searchlight / Substation / Objectives /
# Boss / Storm / Protection / Destruction /
# Briefing, not Environment, not leftover
# briefing-widget, not leftover
# MissionBriefingComponent methods, not leftover
# Mission01 Integration ValidateMissionContract,
# not leftover Mission03 Integration
# ValidateMissionContract, not leftover
# Mission04 Integration ValidateMissionContract
# #667, not leftover Mission05 GetSurvivingTargetCount.
...
LEFTOVER_MISSION05_GET_SURVIVING_NOT_LOCKED = (
...
# leftover Mission04 ValidateMissionContract #667,
# leftover Mission01 / Mission03
# ValidateMissionContract, leftover Mission05
# wave-state enum #ad28, leftover Mission05
# protected-target enum #aaa2, leftover Mission05
# protected-target-runtime-defaults #ec8b,
# leftover storm-runtime-defaults #89c9,
...
class Mission05ValidateMissionContractDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_validate = f"\t{GET_SURVIVING_TARGET_COUNT}\n"
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(leftover_storm, UFUNCTION_INTEGRATION)
        ...
        self.assertNotIn(leftover_storm, UFUNCTION_INTEGRATION)
    ...
    def test_contract_does_not_lock_validate_mission_contract_cpp_body(self) -> None:
        ...
        self.assertNotIn("return RemainingThreatsInWave", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("return WaveState", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("return Readiness", VALIDATE_MISSION_CONTRACT)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertNotIn("GetSurvivingTargetCount", locked_only)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardTempestBoss", VALIDATE_MISSION_CONTRACT)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 ValidateMissionContract method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission05 ValidateMissionContract contains "
    ...
    def test_contract_does_not_relock_leftover_get_night_beat_kit(self) -> None:
        ...
        self.assertNotIn(GET_NIGHT_BEAT_KIT, VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetNightBeatKit", VALIDATE_MISSION_CONTRACT)
    ...
    def test_contract_does_not_relock_leftover_mission05_remaining_threats(
        self,
    ) -> None:
        locked_only = f"{VALIDATE_MISSION_CONTRACT}\n"
        ...
        self.assertNotIn("GetRemainingThreatsInWave", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("Waves", UFUNCTION_INTEGRATION)
    ...
    def test_contract_does_not_relock_leftover_get_surviving_target_count(
        self,
    ) -> None:
        locked_only = f"{VALIDATE_MISSION_CONTRACT}\n"
        for token in LEFTOVER_MISSION05_GET_SURVIVING_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, VALIDATE_MISSION_CONTRACT)
        self.assertIn(
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_validate_mission_contract"
                "_decl_contract.py"
            )
        )
        self.assertIn(
