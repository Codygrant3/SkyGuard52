...
# Mission08 Integration GetObjectiveRuntime
...
# #717, leftover Mission07 ConfigureMissionDefinition,
...
# Mission05 / Mission06 / Mission07 / Waves /
...
# not leftover Mission06 Integration #695,
# not leftover Mission07 Integration #717, not leftover
...
# #658–#673. Do not reopen open drafts #674–#737.
...
LOCKED_DECL = GET_OBJECTIVE_RUNTIME
...
# leftover Mission06 GetObjectiveRuntime #698,
# leftover Mission04 GetObjectiveRuntime,
# leftover Mission06 InitializePlayableMission, leftover
...
CPP_AND_INVENTED = (
    ...
    "SkyguardMission08IntegrationDirector.cpp",
    "ASkyguardMission07IntegrationDirector::GetObjectiveRuntime",
...
class Mission08GetObjectiveRuntimeDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_bool = "\tvoid GetObjectiveRuntime() const;\n"
    ...
    def test_get_objective_runtime_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("USkyguardObjectiveRuntime*"),
            LOCKED_DECL,
        )
        self.assertTrue(
        ...
        self.assertIn("GetObjectiveRuntime", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("GetObjectiveRuntime", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("USkyguardObjectiveRuntime*"))
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 GetObjectiveRuntime method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 GetObjectiveRuntime contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_get_objective_runtime"
                "_decl_contract.py"
            )
        )
        self.assertIn(
