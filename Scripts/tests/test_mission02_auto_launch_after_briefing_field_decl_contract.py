...
# Mission02 bAutoLaunchAfterBriefing FIELD
...
# drafts #674-#851, leftover Apache
...
# leftover Mission01 / Mission03-10
# bAutoLaunchAfterBriefing / auto-launch-after-
# briefing field contracts, leftover Mission01 /
# Mission03-10 bAutoInitialize / auto-initialize
# field contracts, leftover
...
class Mission02AutoLaunchAfterBriefingFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission02_auto_launch_after_briefing_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_auto_launch_after_briefing_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
