# THIS IS leftover-safe FSkyguardTheaterKitSpec WeatherIdentity.
...
# then BARE `FName WeatherIdentity;` (no initializer).
...
class TheaterKitSpecWeatherIdentityFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "theater-kit-spec WeatherIdentity field decl contract "
