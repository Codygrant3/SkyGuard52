...
# Mission05 IntegrationReadiness bBriefingReady
...
# briefing-ready-field-decl-contract-c332,
# NOT leftover Mission04 bBriefingReady
# FIELD #936 / branch cursor/mission04-
# briefing-ready-field-decl-contract-c332,
...
# bBriefingReady FIELD #936, not leftover Mission02
# bBriefingReady FIELD #870, not leftover Mission03
# bBriefingReady FIELD #903, not leftover Mission10
# bBriefingReady FIELD #819, not leftover Mission04
...
BRIEFING_READY_FIELD = (
    "bool bBriefingReady = false;"
)
BRIEFING_READY_TRUE = (
    "bool bBriefingReady = true;"
)
LOCKED_DECL = BRIEFING_READY_FIELD
...
class Mission05BriefingReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 bBriefingReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 bBriefingReady contains "
    ...
    def test_leftover_same_name_briefing_ready_contracts_stay_locked(
        self,
    ) -> None:
        ...
        for leftover in LEFTOVER_MISSION04_BRIEFING_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
