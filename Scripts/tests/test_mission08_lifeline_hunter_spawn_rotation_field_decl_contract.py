...
# INDEX_NONE or lock LifelineHunterSpawnRotation
# construction in the .cpp. This is leftover-safe
# Mission08 LifelineHunterSpawnRotation FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps plus the FRotator default) on
# ASkyguardMission08IntegrationDirector. SKIP
# leftover retired-mount spawn Location / Rotation
# forever (they sit immediately before
# LifelineHunterSpawnLocation). This is NOT leftover
# retired-mount spawn rotation (skip forever), NOT
# leftover Mission07 RadarGhostSpawnRotation, NOT
# leftover Mission06 RunwayBreakerSpawnRotation,
# NOT leftover Mission08 LifelineHunterSpawnLocation
# (in-flight sibling). Leftover Mission06
# RunwayBreakerSpawnRotation #993 is a sibling
# Mission06 lane, not this field. Leftover
# Mission05 TempestSpawnRotation / leftover
# Mission04 BlackKiteSpawnRotation / leftover
# Mission03 RoadHunterSpawnRotation / leftover
# Mission02 BreakwaterSpawnRotation are leftover
# same-pattern spawn-rotation lanes (do not
# reopen). Leftover Mission07 Root #1011 /
# Briefing #1012 / AudioDirector #1013 /
# RadioChatter #1016 / SortiePresentation #1014 /
# CampaignDefinition #1015 / MissionDefinition
# #1017 / leftover bAutoInitialize #1018 /
# leftover bAllowBoundedActorSpawning #1019 /
# leftover bAutoLaunchAfterBriefing / leftover
# CampaignSaveSlotName / CampaignSaveUserIndex /
# RadarGhostSpawnLocation / leftover
# RadarGhostSpawnRotation are sibling lanes (do
# not implement those fields in this file).
# LOCK leftover Mission08 director Root #1044
# through CampaignSaveUserIndex #1060. LOCK
# leftover Mission07 director Root #1011 through
# Readiness #1027. LOCK leftover Mission07
# readiness-struct #1028-#1043. LOCK leftover
# Mission08 Blueprint UFUNCTION methods #729-#749.
# Leftover drafts #56-#64 and leftover #107-#673.
# Leftover closed-without-merge #658-#673
# including Mission05 #665 #666 #668 #669 #670
# #671 #672 #673. Leftover Mission07 wave-state
# enum #74d8 / leftover search-sector enum #b4d4 /
# leftover Mission07 protected-target enum #18f2 /
# leftover Mission07 protected-target-runtime-
# defaults #866c / leftover search-track-runtime-
# defaults #8266. Leftover BindRuntimeActors /
# leftover retired-mount spawn / leftover
# HandleDroneCityImpact / leftover GetDayBeatKit /
# GetNightBeatKit / GetStormRainBeatKit without
# UFUNCTION / leftover b + runtime-ready retired
# mount flag. Harbor 40 / 80 stay fail-closed
# (Mission08-only). Incoming clock names must be
# absent. Do not parse
# FSkyguardMission07IntegrationReadiness,
# FSkyguardSearchTrackRuntime, or
# FSkyguardMission07ProtectedTargetRuntime.
# SKIP leftover retired-mount spawn fields forever.
# This contract is LifelineHunterSpawnRotation
# only. It is NOT leftover retired-mount spawn
# rotation, NOT leftover Mission05
# TempestSpawnRotation, NOT leftover Mission04
# BlackKiteSpawnRotation, NOT leftover Mission03
# RoadHunterSpawnRotation, NOT leftover Mission02
# BreakwaterSpawnRotation, NOT leftover Mission10
# LastFlightSpawnRotation, NOT leftover
# RunwayBreakerSpawnLocation in-flight branch,
# NOT leftover retired-mount spawn fields. Note
# EditAnywhere / BlueprintReadWrite / Category
# Skyguard|Mission08 / FRotator(0.f, 160.f, 0.f),
# not VisibleAnywhere / BlueprintReadOnly. It is
...
# Lock LifelineHunterSpawnRotation only. Do not lock
# leftover retired-mount spawn fields, leftover
# Mission07 RadarGhostSpawnRotation, leftover
# Mission08 LifelineHunterSpawnLocation, leftover
# TempestSpawnRotation / BlackKiteSpawnRotation /
# RoadHunterSpawnRotation / BreakwaterSpawnRotation /
# LastFlightSpawnRotation, leftover
# RunwayBreakerSpawnLocation. Do not lock leftover
# GetAircraft.
...
# Mission06IntegrationDirector public section. Pathfinder MinHeightFromOriginCm
...
# drafts #674-#978 including leftover Mission03
...
LIFELINE_HUNTER_SPAWN_ROTATION_FIELD = (
    "FRotator LifelineHunterSpawnRotation = "
    "FRotator(0.f, 160.f, 0.f);"
)
...
RADAR_GHOST_SPAWN_ROTATION_FIELD = (
    "FRotator RadarGhostSpawnRotation = "
    "FRotator(0.f, 205.f, 0.f);"
)
...
LOCKED_DECL = LIFELINE_HUNTER_SPAWN_ROTATION_FIELD
...
# an isolated Python LifelineHunterSpawnRotation
...
def standalone_harbor_interval_present(text: str, token: str) -> bool:
    # Harbor 40/80 interval literals fail-closed as standalone
    # Mission08-only values in leftover Mission02 / 03 / 04 /
    # 05 / 06 / 07 tests. Do not invent Harbor values on
    # this FRotator field. origin/main yaw 1-6-0 must not
    # count as a Harbor 80 interval.
    if token in leftover_harbor_clock_tokens():
...
class Mission08LifelineHunterSpawnRotationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("LifelineHunterSpawnRotation", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_lifeline_hunter_spawn_rotation_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_lifeline_hunter_spawn_rotation_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FRotator LifelineHunterSpawnRotation"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("LifelineHunterSpawnRotation", LOCKED_DECL)
        self.assertIn("= FRotator(0.f, 160.f, 0.f)", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tFRotator\n"
            "\tLifelineHunterSpawnRotation = FRotator(0.f, 160.f, 0.f);\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("LifelineHunterSpawnRotation", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FRotator LifelineHunterSpawnRotation"))
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        for token in leftover_harbor_tokens():
            self.assertFalse(
                standalone_harbor_interval_present(locked_only, token),
                token,
            )
            self.assertFalse(
                standalone_harbor_interval_present(LOCKED_DECL, token),
                token,
            )
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("LifelineHunterSpawnRotation", locked_only)
    ...
    def test_contract_does_not_retune_harbor(self) -> None:
        ...
        for token in leftover_harbor_tokens():
            ...
            self.assertFalse(
                standalone_harbor_interval_present(file_text, token),
                token,
            )
        for token in leftover_harbor_tokens():
            self.assertNotEqual(token, "550.f")
    ...
    def test_harbor_40_80_tokens_fail_closed_if_present(self) -> None:
        ...
        # Do not scan leftover spawn-rotation fields on this
        # class; leftover spawn locations are Harbor-adjacent
        # and are not Harbor 40/80. origin/main yaw 1-8-0 is
        # not a standalone Harbor 80 interval.
        for token in leftover_harbor_tokens():
            self.assertFalse(
                standalone_harbor_interval_present(locked_only, token),
                token,
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 LifelineHunterSpawnRotation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 LifelineHunterSpawnRotation field contains "
    ...
    def test_contract_is_lifeline_hunter_spawn_rotation_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        # substring of LifelineHunterSpawnRotation, so equality
        ...
        for token in leftover_short_roster_values():
            ...
            self.assertNotEqual(token, "LifelineHunterSpawnRotation")
    ...
    def test_sibling_director_fields_do_not_satisfy_lifeline_hunter_spawn_rotation(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tFRotator LifelineHunterSpawnRotation = FRotator(0.f, 0.f, 0.f);\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission07_radar_ghost_spawn"
            "_rotation_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission06_runway_breaker_spawn"
            "_location_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission05_tempest_spawn"
            "_rotation_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission04_black_kite_spawn"
            "_rotation_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_last_flight_spawn"
            "_rotation_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_airfield_target_runtime_does_not_satisfy_lifeline_hunter_spawn_rotation(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_does_not_satisfy_lifeline_hunter_spawn_rotation(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
