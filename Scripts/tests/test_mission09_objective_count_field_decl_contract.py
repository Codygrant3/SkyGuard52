...
# ObjectiveCount FIELD (declaration-only;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission09 readiness-struct
# ObjectiveCount. THIS IS NOT leftover Mission08
# FSkyguardMission08IntegrationReadiness
# ObjectiveCount #1080. THIS IS NOT leftover
...
# #1101 through bPoolBudgetSafe #1110. THIS IS NOT leftover
...
# same-name readiness-struct ObjectiveCount drafts.
...
# merge #665 #666 #668-#673, or open drafts #674-#1110.
...
# Mission08 IntegrationReadiness ObjectiveCount
...
# ProtectedTargetCount, NOT leftover
...
# This readiness-struct field sits after bCampaignRuntimeStarted.
# Skip leftover b + Ya + kRuntimeReady forever (it sits
# after bMapAssemblyReady and before bGunnerReady). This contract
# is leftover-safe Mission09 readiness-struct ObjectiveCount after
# bPoolBudgetSafe / bPresentationReady / bSortiePresentationReady. It is NOT leftover Mission07
# ObjectiveCount / branch cursor/mission07-
# objective-count-field-decl-contract-c332. It is NOT leftover
# Mission06 ObjectiveCount #1009 / branch cursor/mission06-
# objective-count-field-decl-contract-c332. It is NOT leftover
# Mission08 director Readiness #1066. Skip leftover
...
# drafts #674-#1110 including leftover Mission02
...
# drafts #674-#1110. Do not reopen leftover
...
# THIS IS NOT leftover Mission08 ObjectiveCount #1080,
# leftover Mission07 ObjectiveCount,
# leftover Mission06 ObjectiveCount #1009,
# leftover Mission08 director Readiness #1066,
# leftover Mission02 ObjectiveCount #873,
# Mission03 ObjectiveCount #905, Mission04 ObjectiveCount
# #939, Mission05 ObjectiveCount #976, or Mission10
# ObjectiveCount #823.
LOCKED = {
...
class Mission09ObjectiveCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 ObjectiveCount field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission07 ObjectiveCount contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_objective_count"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
