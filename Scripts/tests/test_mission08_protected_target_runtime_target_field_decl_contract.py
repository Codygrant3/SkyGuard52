...
# FSkyguardMission09ProtectedTargetRuntime, or private
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission08 ProtectedTargetRuntime
# Target. THIS IS NOT leftover Mission08
# FSkyguardMission08IntegrationReadiness
# WaveCount #1081 / ProtectedTargetCount #1082.
...
# Mission08 ProtectedTargetRuntime Target
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly ESkyguardMission08ProtectedTarget
# default RescueHelicopter,
...
# the origin/main RescueHelicopter default,
...
class Mission08ProtectedTargetRuntimeTargetFieldDeclContractTests(unittest.TestCase):
    ...
    def test_target_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("ESkyguardMission08ProtectedTarget Target"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("RescueHelicopter;"), LOCKED_DECL)
        ...
        self.assertIn("ESkyguardMission08ProtectedTarget ", LOCKED_DECL)
        self.assertIn("RescueHelicopter", LOCKED_DECL)
        ...
        self.assertIn("ESkyguardMission08ProtectedTarget", LOCKED_DECL)
        self.assertTrue(
            LOCKED_DECL.startswith("ESkyguardMission08ProtectedTarget "),
            LOCKED_DECL,
        )
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_true_default = (
            "public:\n"
            f"\t{UPROPERTY_MISSION10}\n"
            "\tESkyguardMission08ProtectedTarget Target = ESkyguardMission08ProtectedTarget::RescueHelicopter;\n"
            "};\n"
        )
        header_wrap_type = (
            f"struct {CLASS_NAME}\n{{\n{wrap_type}"
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("Target", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("ESkyguardMission08ProtectedTarget Target"))
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 ProtectedTargetRuntime Target field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 ProtectedTargetRuntime Target contains "
    ...
    def test_contract_is_target_field_declaration_only(
        ...
        self.assertTrue(LOCKED_DECL.startswith("ESkyguardMission08ProtectedTarget Target"))
        self.assertIn("Target", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("RescueHelicopter;"))
