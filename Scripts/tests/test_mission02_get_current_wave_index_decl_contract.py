...
# Isolated leftover-safe Mission02 Waves GetCurrentWaveIndex
# METHOD declaration on
# ASkyguardMission02IntegrationDirector. Parse the
# PUBLIC class section only. Not
# FSkyguardMission02IntegrationReadiness, not the
# ESkyguardMission02WaveState enum definition, not
# private, not Mission01 / Mission03-10 directors.
# origin/main wrap is one-line inline body; accept
# one-line / split-line UFUNCTION wraps plus an
# inline body without locking a different body.
# Do NOT create leftover Mission02 wave-state enum.
# NOT leftover Mission03 GetCurrentWaveIndex #641 /
# leftover Mission03 GetWaveState #640 / leftover
# Mission04 GetWaveState #659 / leftover Mission05-09
# GetWaveState drafts / leftover Mission10 GetRoutePhase
# #775 / leftover Mission10 route-phase enum #701a.
# NOT leftover Mission02 GetWaveState sibling
# (in-flight). NOT leftover merged Mission02 C++
# bundle #102.
# NOT leftover Mission02 InitializePlayableMission #828
# / Configure #829 / StartNextWave #830 /
# NotifyThreatDestroyed #831 / NotifyFuelTerminalDamage
# #832 / NotifyProtectedAssetFailed #833 /
# SynchronizeRuntimeState #834 / IsCorePlayableReady
# #835 / GetReadiness / GetObjectiveRuntime siblings.
# Declaration presence only. Do not invent
# INDEX_NONE or lock GetCurrentWaveIndex
# construction in the .cpp. This is leftover-safe
# Mission02 Waves GetCurrentWaveIndex METHOD on
# ASkyguardMission02IntegrationDirector. It is
# NOT leftover Mission09 wave-state enum
# #20fc / #238, NOT leftover Mission08
# GetWaveState #741 / branch cursor/mission08-get-
# wave-state-decl-contract-c332, NOT leftover
# Mission07 GetWaveState #719, NOT leftover
# Mission06 GetWaveState #701, NOT leftover
# Mission05 GetWaveState #676, NOT leftover
# closed Mission04 GetWaveState #659 /
# Mission03 GetWaveState #640, NOT leftover
# IsCorePlayableReady, NOT leftover
# BindRuntimeActors (retired live mount), NOT
# leftover retired-mount spawn fields, NOT leftover
# HandleDroneCityImpact, NOT leftover Harbor
# Mission02 / Harbor #6/#8/#9, NOT leftover
# Mission09 protected-target enum #9246 / #228,
# NOT leftover Mission09 protected-target-runtime-
# defaults #bf28 / #225, NOT leftover Mission09
# pool-runtime-defaults #5426 / #243, NOT leftover
# Mission09 pool-budget-defaults #4537 / #242, NOT
# leftover Mission08 wave-state enum #68fc / #237,
# NOT leftover Mission08 protected-target enum
...
# leftover GetDayBeatKit / GetDayBeatKind /
# GetDayBeatIndex without UFUNCTION, leftover
# Mission08 GetReadiness #739 / Mission07 #718 /
# Mission06 #697 / Mission05 #681, leftover
# Mission08 IsCorePlayableReady #743 / Mission07
# #715 / Mission06 #696 / Mission05 #684,
...
# sibling Integration / Waves / Protection /
# Performance / Objectives methods
...
# GetReadiness / GetRemainingThreatsInWave /
# GetPoolRuntime / GetProtectedTarget /
# GetSurvivingTargetCount / GetObjectiveRuntime /
...
# leftover Mission01 GetWaveState,
# leftover Mission03 GetWaveState #640,
# leftover Mission04 GetWaveState #659,
# leftover Mission05 GetWaveState #676,
# leftover Mission06 GetWaveState #701,
# leftover Mission07 GetWaveState #719,
# leftover Mission08 GetWaveState #741,
...
# origin/main is a one-line inline body
# (`int32 GetCurrentWaveIndex()
# const { return CurrentWaveIndex; }`); accept that
...
# Category is Skyguard|Mission02|Waves, not
# Mission01 / Mission09 / Mission03 / Mission04 /
# Mission05 / Mission06 / Mission07 / Mission08 /
# Integration / Search / Protection / Payload /
# Targets / Objectives / Performance / Boss /
# Destruction / Briefing / Hoist / Rescue /
# Safety, not Environment,
...
# not leftover Mission08 Waves #741, not leftover
# Harbor Mission02.
...
# closed leftover drafts #658–#673 including
# Mission04 GetWaveState #659, leftover open
# drafts #674–#835+, leftover Apache
...
# Mission09IntegrationDirector public section and
...
# #668/#669. Do not reopen leftover Mission08
# GetWaveState #741. Do not reopen leftover
# Mission09 wave-state enum #20fc / #238 — THIS
# IS THE METHOD, NOT THE ENUM. Do not reopen
...
# Do not reopen leftover GetStormRainBeatKit
# without UFUNCTION. Do not reopen leftover
# Mission08 GetReadiness #739 / Mission07 #718 /
# Mission06 #697 / Mission05 #681. Do not reopen
# leftover Mission08 IsCorePlayableReady #743 /
# Mission07 #715 / Mission06 #696 / Mission05 #684.
# Do not reopen open drafts #674–#835+.
...
GET_WAVE_STATE = (
    "ESkyguardMission02WaveState GetWaveState() const"
)
...
LEFTOVER_MISSION07_GET_WAVE_STATE = (
    "ESkyguardMission07WaveState GetWaveState() const"
)
LEFTOVER_MISSION08_GET_WAVE_STATE = (
    "ESkyguardMission08WaveState GetWaveState() const"
)
LEFTOVER_MISSION09_GET_WAVE_STATE = (
...
# an isolated Python GetWaveState
...
LEFTOVER_MISSION07_GET_WAVE_STATE_NOT_LOCKED = (
    LEFTOVER_MISSION07_GET_WAVE_STATE,
...
LEFTOVER_MISSION08_GET_WAVE_STATE_NOT_LOCKED = (
    LEFTOVER_MISSION08_GET_WAVE_STATE,
    "test_mission08_get_wave_state_decl_contract.py",
    ...
    "cursor/mission08-get-wave-state-decl-contract-c332",
)
LEFTOVER_MISSION09_GET_WAVE_STATE_NOT_LOCKED = (
    LEFTOVER_MISSION09_GET_WAVE_STATE,
    ...
    "SkyguardMission09IntegrationDirector.h",
    'Category="Skyguard|Mission09|Waves"',
    "cursor/mission09-get-wave-state-decl-contract-c332",
)
LEFTOVER_MISSION10_GET_ROUTE_PHASE_NOT_LOCKED = (
    "test_mission10_get_route_phase_decl_contract.py",
    ...
    "cursor/mission10-get-route-phase-decl-contract-c332",
)
LEFTOVER_MISSION02_SIBLING_METHODS_NOT_LOCKED = (
    ...
    "test_mission02_get_mission_id_decl_contract.py",
)
LEFTOVER_MISSION03_GET_CURRENT_WAVE_INDEX_NOT_LOCKED = (
    GET_WAVE_STATE,
    "test_mission03_get_current_wave_index_decl_contract.py",
    "ASkyguardMission03IntegrationDirector",
    "SkyguardMission03IntegrationDirector.h",
    'Category="Skyguard|Mission03|Waves"',
    "cursor/mission03-get-current-wave-index-decl-contract-c332",
)
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission07IntegrationDirector::GetWaveState",
    "SkyguardMission07IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission02GetCurrentWaveIndexDeclContractTests(unittest.TestCase):
    def test_mission02_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, GET_CURRENT_WAVE_INDEX),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, GET_CURRENT_WAVE_INDEX)
        self.assertIn("GetCurrentWaveIndex", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, GET_CURRENT_WAVE_INDEX)
    ...
    def test_missing_get_current_wave_index_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission02IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, GET_CURRENT_WAVE_INDEX)
        self.assertIn("GetCurrentWaveIndex", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))

    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        macro_only = f"\t{UFUNCTION_WAVES}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, GET_CURRENT_WAVE_INDEX)
        self.assertIn("GetCurrentWaveIndex", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        section = public_section(origin_main_header())
        self.assertIn(UFUNCTION_WAVES, section)
        ...
        self.assertIn("Skyguard|Mission02|Waves", UFUNCTION_WAVES)
        self.assertNotIn("Mission01", UFUNCTION_WAVES)
        self.assertNotIn("Mission03", UFUNCTION_WAVES)
        self.assertNotIn("Mission04", UFUNCTION_WAVES)
        self.assertNotIn("Mission05", UFUNCTION_WAVES)
        self.assertNotIn("Mission06", UFUNCTION_WAVES)
        self.assertNotIn("Integration", UFUNCTION_WAVES)
        self.assertNotIn("Search", UFUNCTION_WAVES)
        self.assertNotIn("Protection", UFUNCTION_WAVES)
        self.assertNotIn("Payload", UFUNCTION_WAVES)
        self.assertNotIn("Targets", UFUNCTION_WAVES)
        self.assertNotIn("Objectives", UFUNCTION_WAVES)
        self.assertIn("BlueprintPure", UFUNCTION_WAVES)
        self.assertNotIn("Environment", UFUNCTION_WAVES)
        self.assertNotIn("Briefing", UFUNCTION_WAVES)
        self.assertNotIn("Mission09", UFUNCTION_WAVES)
        self.assertNotIn("Boss", UFUNCTION_WAVES)
        self.assertNotIn("Destruction", UFUNCTION_WAVES)
        self.assertNotIn("Apache", UFUNCTION_WAVES)
        self.assertNotIn("Mission06", UFUNCTION_WAVES)
        self.assertNotIn("Mission07", UFUNCTION_WAVES)
        self.assertNotIn("Mission08", UFUNCTION_WAVES)
        self.assertNotIn("Mission10", UFUNCTION_WAVES)
        self.assertNotIn("Performance", UFUNCTION_WAVES)
        self.assertNotIn("Encounter", UFUNCTION_WAVES)
        self.assertNotIn("Safety", UFUNCTION_WAVES)
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, UFUNCTION_WAVES)
            self.assertNotIn(invented, GET_CURRENT_WAVE_INDEX)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, GET_CURRENT_WAVE_INDEX)
        self.assertIn("GetCurrentWaveIndex", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tvoid GetCurrentWaveIndex() const;\n"
        )
        as_bool = "\tbool GetCurrentWaveIndex() const;\n"
        missing_const = (
            "\tint32 GetCurrentWaveIndex();\n"
        )
        with_arg = (
            "\tint32 "
            "GetCurrentWaveIndex(int32 Wave) const;\n"
        )
        renamed = (
            "\tint32 GetState() const;\n"
        )
        short_name = "\tint32 GetWave() const;\n"
        leftover_m08_type = f"\t{LEFTOVER_MISSION08_GET_WAVE_STATE}\n"
        leftover_m09_type = f"\t{LEFTOVER_MISSION09_GET_WAVE_STATE}\n"
        leftover_fuel = f"\t{NOTIFY_FUEL_TERMINAL_DAMAGE}\n"
        leftover_fuel_integrity = f"\t{GET_FUEL_TERMINAL_INTEGRITY}\n"
        leftover_breakwater = f"\t{GET_BREAKWATER}\n"
        leftover_wave_index = f"\t{GET_WAVE_STATE}\n"
        leftover_m07_type = f"\t{LEFTOVER_MISSION07_GET_WAVE_STATE}\n"
        ...
        leftover_wave_state = f"\t{GET_READINESS}\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, GET_CURRENT_WAVE_INDEX)
            self.assertIn("GetCurrentWaveIndex", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_get_current_wave_index_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, GET_CURRENT_WAVE_INDEX),
            GET_CURRENT_WAVE_INDEX,
        )
        self.assertTrue(has_declaration(section, GET_CURRENT_WAVE_INDEX))
        self.assertEqual(
            declaration_count(section, GET_CURRENT_WAVE_INDEX),
            1,
        )
        self.assertTrue(
            GET_CURRENT_WAVE_INDEX.startswith("int32 "),
            GET_CURRENT_WAVE_INDEX,
        )
        self.assertNotIn("ESkyguardMission02WaveState", GET_CURRENT_WAVE_INDEX)
        self.assertIn("GetCurrentWaveIndex", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn(";", GET_CURRENT_WAVE_INDEX)
        self.assertIn("return CurrentWaveIndex;", section)
        self.assertIn(UFUNCTION_WAVES, section)
        self.assertIn(" const", GET_CURRENT_WAVE_INDEX)
        self.assertIn("()", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("TArray<", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("TObjectPtr", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("TSoftObjectPtr", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("INDEX_NONE", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("UFUNCTION", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("{", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("}", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("return ", GET_CURRENT_WAVE_INDEX)
        self.assertIn(" const", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("Root", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("Briefing", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("AudioDirector", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("RadioChatter", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("SortiePresentation", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("CampaignDefinition", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("MissionDefinition", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("Readiness;", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("bAutoInitialize", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("bAllowBoundedActorSpawning", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("bAutoLaunchAfterBriefing", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("PathfinderSpawnLocation", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetAircraft", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("BindRuntimeActors", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("HandleDroneCityImpact", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("InitializePlayableMission", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("StartNextWave", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("AdvanceConvoyByDistance", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("NotifyConvoyDamage", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetReadiness", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetConvoyRouteState", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetDayBeatKit", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetNightBeatKit", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("StartSearchlightWindow", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("AdvanceSearchlightTrack", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("NotifySubstationDamage", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetRemainingThreatsInWave", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetSearchlightRuntime", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetSubstationIntegrity", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("StartPayloadWindow", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("AdvancePayloadWindow", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("TryJamActivePayload", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("NotifyAirfieldTargetDamage", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetPayloadWindow", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetTargetRuntime", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetSurvivingTargetCount", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetDayBeatKind", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetDayBeatIndex", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("TickDayBeatKit", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("HandleBossPhaseChanged", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ASkyguardMission06IntegrationDirector", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ASkyguardMission07IntegrationDirector", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ESkyguardMission06WaveState", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ESkyguardMission07WaveState", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ESkyguardMission02WaveState", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ESkyguardMission07ProtectedTarget", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ESkyguardMission08ProtectedTarget", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("FSkyguardMission07ProtectedTargetRuntime", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("FSkyguardMission08ProtectedTargetRuntime", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ESkyguardSearchSector", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("FSkyguardSearchTrackRuntime", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ClassifyFalseTrack", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ConfirmRadarGhostIdentification", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("NotifyProtectedTargetDamage", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("AdvanceReinforcementTimer", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetSearchSector", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetClassifiedFalseTrackCount", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("IsHostileContactConfirmed", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetProtectedTarget", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetReinforcementTimeRemaining", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetNightBeatKind", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetNightBeatIndex", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("TickNightBeatKit", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ESkyguardAirfieldTarget", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ConvoyRuntimeAnchor", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("RoadHunterSpawnLocation", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ASkyguardMission09IntegrationDirector", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ConfigureMissionDefinition", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("NotifyObjectiveProgress", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("NotifyProtectedAssetFailed", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("SynchronizeRuntimeState", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("NotifyThreatDestroyed", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("IsCorePlayableReady", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetObjectiveRuntime", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetGunner", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetPathfinder", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetMissionId", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ValidateMissionContract", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ConfigureFromMission", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("AdvanceBriefing", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("SetAssetsReady", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("AcknowledgeAndLaunch", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("CanLaunch", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetElapsedSeconds", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetBriefingState", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetMinimumWarmupSeconds", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetBriefingText", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetRadioChatter", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetPresentation", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetMissionTitle", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("AcknowledgeBriefing", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("LaunchSortie", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("HullCollider", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("OpticalTracker", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("WeaponServo", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("CountermeasurePod", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("MinHeightFromOriginCm", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("RadarNode", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ESkyguardMission09WaveState", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("HarborIndustrial", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("MaxIntegrity", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("CurrentIntegrity", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("FillAndFinalize", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("FillAndFail", GET_CURRENT_WAVE_INDEX)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, GET_CURRENT_WAVE_INDEX)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_WAVES} {GET_CURRENT_WAVE_INDEX}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{GET_CURRENT_WAVE_INDEX}\n}}\n"
        self.assertTrue(has_declaration(one_line, GET_CURRENT_WAVE_INDEX))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, GET_CURRENT_WAVE_INDEX),
            section,
    ...
    def test_environment_category_does_not_satisfy_waves(self) -> None:
        ...
        self.assertNotEqual(environment, UFUNCTION_WAVES)
        self.assertNotEqual(briefing, UFUNCTION_WAVES)
        self.assertNotIn(environment, UFUNCTION_WAVES)
        self.assertNotIn(briefing, UFUNCTION_WAVES)
        leftover_m01 = (
            'UFUNCTION(BlueprintCallable, '
        ...
        leftover_m08_integration = (
            'UFUNCTION(BlueprintPure, '
            'Category="Skyguard|Mission08|Integration")'
        )
        leftover_m08_waves_callable = (
            'UFUNCTION(BlueprintCallable, '
            'Category="Skyguard|Mission02|Waves")'
        )
        leftover_m08_hoist = (
        ...
        self.assertNotEqual(leftover_m01, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_m02, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_harbor, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_m03, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_m04, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_m05, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_m06, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_waves, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_m05_waves, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_integration, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_m07_ready, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_m08_integration, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_m08_waves_callable, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_m08_hoist, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_m08_safety, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_m08_protection, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_payload, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_targets, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_objectives, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m01, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m02, UFUNCTION_WAVES)
        self.assertNotIn(leftover_harbor, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m03, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m04, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m05, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m06, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m05_waves, UFUNCTION_WAVES)
        self.assertNotIn(leftover_integration, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m07_ready, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m08_integration, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m08_waves_callable, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m08_hoist, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m08_safety, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m08_protection, UFUNCTION_WAVES)
        self.assertNotIn("Mission01", UFUNCTION_WAVES)
        self.assertNotIn("Mission03", UFUNCTION_WAVES)
        self.assertNotIn("Mission04", UFUNCTION_WAVES)
        self.assertNotIn("Mission05", UFUNCTION_WAVES)
    ...
    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        locked_only = f"{GET_CURRENT_WAVE_INDEX}\n"
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, GET_CURRENT_WAVE_INDEX)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", GET_CURRENT_WAVE_INDEX)
        section = public_section(origin_main_header())
    ...
    def test_contract_does_not_lock_get_current_wave_index_cpp_body(self) -> None:
        ...
        self.assertNotIn("return ", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn(
            "ASkyguardMission02IntegrationDirector::GetCurrentWaveIndex",
            GET_CURRENT_WAVE_INDEX,
        )
        self.assertNotIn(
            "SkyguardMission02IntegrationDirector.cpp",
        ...
        self.assertNotIn("return false", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("return true", GET_CURRENT_WAVE_INDEX)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{GET_CURRENT_WAVE_INDEX}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_CURRENT_WAVE_INDEX)
        self.assertIn("GetCurrentWaveIndex", GET_CURRENT_WAVE_INDEX)
        self.assertTrue(GET_CURRENT_WAVE_INDEX.startswith("int32 "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, GET_CURRENT_WAVE_INDEX)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, GET_CURRENT_WAVE_INDEX)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("CurrentIntegrity", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("SkyguardApacheAircraft.h", GET_CURRENT_WAVE_INDEX)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", GET_CURRENT_WAVE_INDEX)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{GET_CURRENT_WAVE_INDEX}\n"
        self.assertEqual(
            require_declaration(locked_only, GET_CURRENT_WAVE_INDEX),
            GET_CURRENT_WAVE_INDEX,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_CURRENT_WAVE_INDEX)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ASkyguardIronRainBoss", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ASkyguardRadarGhostBoss", GET_CURRENT_WAVE_INDEX)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 GetWaveState method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{GET_CURRENT_WAVE_INDEX}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, GET_CURRENT_WAVE_INDEX.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                GET_CURRENT_WAVE_INDEX.lower(),
                "mission02 GetCurrentWaveIndex contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, GET_CURRENT_WAVE_INDEX)

    def test_contract_is_get_current_wave_index_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_get_current_wave_index(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, GET_CURRENT_WAVE_INDEX)
            )
            self.assertNotEqual(GET_CURRENT_WAVE_INDEX, leftover)
        self.assertIn(
    ...
    def test_leftover_harbor_mission02_initialize_does_not_satisfy(
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_init_only, GET_CURRENT_WAVE_INDEX)
        self.assertIn("GetCurrentWaveIndex", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission02_initialize_playable_mission"
    ...
    def test_leftover_handle_drone_city_impact_does_not_satisfy(self) -> None:
        ...
        self.assertIn("GetCurrentWaveIndex", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, GET_CURRENT_WAVE_INDEX))
        locked_only = f"{GET_CURRENT_WAVE_INDEX}\n"
    ...
    def test_contract_does_not_relock_leftover_handle_boss_phase_changed(
        ...
        for token in LEFTOVER_HANDLE_BOSS_PHASE_CHANGED_NOT_LOCKED:
            ...
            self.assertNotIn(token, GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("HandleBossPhaseChanged", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("HandleBossPhaseChanged", UFUNCTION_WAVES)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_get_current_wave_index"
                "_decl_contract.py"
            )
        )
        self.assertIn(
            "Scripts/tests/test_mission02_get_wave_state"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission03_get_current_wave_index"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission02_get_objective_runtime"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_get_remaining_threats_in_wave"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_get_hoist_runtime"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_get_wave_state"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_mission03_get_current_wave_index_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        for token in LEFTOVER_MISSION03_GET_CURRENT_WAVE_INDEX_NOT_LOCKED:
            self.assertNotIn(token, GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("Mission03", UFUNCTION_WAVES)
        leftover_same_name = (
            "\tint32 GetCurrentWaveIndex() const { "
        ...
        # Same-name leftover on the wrong class must not satisfy the
        # Mission02 public-section lock by itself.
        self.assertTrue(
            has_declaration(leftover_same_name, GET_CURRENT_WAVE_INDEX)
        )
        with self.assertRaises(AssertionError) as raised:
            public_section(
                "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
    ...
    def test_leftover_mission07_get_wave_state_does_not_satisfy(self) -> None:
        leftover = (
        ...
        for token in LEFTOVER_MISSION07_GET_WAVE_STATE_NOT_LOCKED:
            self.assertNotIn(token, GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("Mission07", UFUNCTION_WAVES)
        leftover_m07_ready_type = (
            "\tconst FSkyguardMission07IntegrationReadiness& "
            "GetReadiness() const;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m07_ready_type, GET_CURRENT_WAVE_INDEX)
        self.assertIn("GetCurrentWaveIndex", str(raised.exception))
    ...
    def test_contract_does_not_relock_leftover_mission08_wave_state_enum(
        ...
        self.assertNotIn("ESkyguardMission08WaveState", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ESkyguardMission02WaveState", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("Integration", UFUNCTION_WAVES)
    ...
    def test_contract_does_not_relock_leftover_hoist_window(self) -> None:
        ...
        self.assertNotIn("Hoist", UFUNCTION_WAVES)
    ...
    def test_sibling_mission08_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("NotifyThreatDestroyed", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("StartNextWave", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("StartHoistWindow", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("AdvanceHoistWindow", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("ValidateWeaponRelease", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("IsCorePlayableReady", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("SynchronizeRuntimeState", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetObjectiveRuntime", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetReadiness", GET_CURRENT_WAVE_INDEX)

    def test_leftover_mission08_get_wave_state_does_not_satisfy(self) -> None:
        leftover = (
            ...
            "\tUFUNCTION(BlueprintPure, "
            'Category="Skyguard|Mission08|Waves")\n'
            f"\t{LEFTOVER_MISSION08_GET_WAVE_STATE}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover)
        ...
        for token in LEFTOVER_MISSION08_GET_WAVE_STATE_NOT_LOCKED:
            self.assertNotIn(token, GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("Mission08", UFUNCTION_WAVES)
        leftover_m08_type = f"\t{LEFTOVER_MISSION08_GET_WAVE_STATE}\n"
        leftover_m09_type = f"\t{LEFTOVER_MISSION09_GET_WAVE_STATE}\n"
        ...
        leftover_wave_index = f"\t{GET_WAVE_STATE}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m08_type, GET_CURRENT_WAVE_INDEX)
        self.assertIn("GetCurrentWaveIndex", str(raised.exception))
    ...
    def test_contract_does_not_relock_leftover_mission09_pool(self) -> None:
        ...
        self.assertNotIn("Performance", UFUNCTION_WAVES)
        self.assertNotIn("GetPoolRuntime", GET_CURRENT_WAVE_INDEX)
    ...
    def test_sibling_mission09_methods_do_not_satisfy(self) -> None:
        ...
        for token in LEFTOVER_MISSION09_SIBLING_METHODS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("BindCampaignRuntime", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("GetPoolRuntime", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn(BIND_RUNTIME_ACTORS, GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("UFUNCTION", GET_DAY_BEAT_KIT)
        self.assertNotIn("UFUNCTION", GET_DAY_BEAT_KIND)
    ...
    def test_sibling_mission09_initialize_does_not_satisfy(self) -> None:
    ...
    def test_contract_does_not_relock_leftover_mission08_get_readiness(
        self,
    ) -> None:
        locked_only = f"{GET_CURRENT_WAVE_INDEX}\n"
        self.assertNotIn("GetReadiness", GET_CURRENT_WAVE_INDEX)
    ...
    def test_contract_does_not_relock_leftover_mission08_is_core_playable_ready(
        ...
        locked_only = f"{GET_CURRENT_WAVE_INDEX}\n"
        self.assertNotIn("IsCorePlayableReady", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn(IS_CORE_PLAYABLE_READY, locked_only)
        self.assertIn(
            "Scripts/tests/test_mission08_is_core_playable_ready"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
    ...
    def test_leftover_mission09_get_wave_state_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission09IntegrationDirector "
            ": public AActor\n"
            "{\n"
            ...
            "\tUFUNCTION(BlueprintPure, "
            'Category="Skyguard|Mission09|Waves")\n'
            f"\t{LEFTOVER_MISSION09_GET_WAVE_STATE}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover)
        ...
        for token in LEFTOVER_MISSION09_GET_WAVE_STATE_NOT_LOCKED:
            self.assertNotIn(token, GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("Mission09", UFUNCTION_WAVES)
        leftover_m09_type = f"\t{LEFTOVER_MISSION09_GET_WAVE_STATE}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m09_type, GET_CURRENT_WAVE_INDEX)
        self.assertIn("GetCurrentWaveIndex", str(raised.exception))

    def test_leftover_mission10_get_route_phase_does_not_satisfy(self) -> None:
        leftover = (
        ...
        for token in LEFTOVER_MISSION10_GET_ROUTE_PHASE_NOT_LOCKED:
            self.assertNotIn(token, GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("Mission10", UFUNCTION_WAVES)
        self.assertNotIn("GetRoutePhase", GET_CURRENT_WAVE_INDEX)
    ...
    def test_leftover_mission02_sibling_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("InitializePlayableMission", GET_CURRENT_WAVE_INDEX)
        self.assertNotIn("NotifyFuelTerminalDamage", GET_CURRENT_WAVE_INDEX)

    def test_locked_scripts_include_leftover_mission10_field_contracts(
        self,
    ) -> None:
        self.assertIn(
