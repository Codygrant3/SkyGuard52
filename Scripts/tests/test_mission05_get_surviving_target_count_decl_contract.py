...
# INDEX_NONE or lock GetSurvivingTargetCount construction
# in the .cpp. This is leftover-safe Mission05
# Protection GetSurvivingTargetCount on
...
# Integration / Waves / Searchlight / Substation /
# Objectives / Boss / Storm / Destruction /
# Briefing, not Environment, not leftover
# briefing-widget, not leftover
# MissionBriefingComponent methods, not leftover
# Mission03 Waves GetRemainingThreatsInWave,
# not leftover Mission04 Waves
# GetRemainingThreatsInWave #662, not leftover
# Mission05 Waves GetRemainingThreatsInWave, not
# leftover Mission05 GetProtectedTarget.
...
class Mission05GetSurvivingTargetCountDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = "\tvoid GetSurvivingTargetCount() const;\n"
        ...
        with_arg = (
            "\tint32 "
            "GetSurvivingTargetCount(int32 Amount = 1) const;\n"
        )
        renamed = (
            "\tint32 "
    ...
    def test_get_surviving_target_count_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            GET_SURVIVING_TARGET_COUNT.endswith(" const;"),
            GET_SURVIVING_TARGET_COUNT,
        )
        self.assertTrue(
    ...
    def test_contract_does_not_lock_get_surviving_target_count_cpp_body(self) -> None:
        ...
        self.assertNotIn("return RemainingThreatsInWave", GET_SURVIVING_TARGET_COUNT)
        self.assertNotIn("return WaveState", GET_SURVIVING_TARGET_COUNT)
        self.assertNotIn("return Readiness", GET_SURVIVING_TARGET_COUNT)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardTempestBoss", GET_SURVIVING_TARGET_COUNT)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 GetSurvivingTargetCount method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission05 GetSurvivingTargetCount contains "
    ...
    def test_contract_is_get_surviving_target_count_declaration_only(
        ...
        self.assertTrue(GET_SURVIVING_TARGET_COUNT.startswith("int32 "))
        self.assertIn("GetSurvivingTargetCount", GET_SURVIVING_TARGET_COUNT)
        self.assertIn("GetSurvivingTargetCount() const;", GET_SURVIVING_TARGET_COUNT)
        self.assertTrue(GET_SURVIVING_TARGET_COUNT.endswith(" const;"))
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tint32 "
            "GetSurvivingTargetCount() const { return RemainingThreatsInWave; }\n"
            "};\n"
        )
    ...
    def test_contract_does_not_relock_leftover_get_night_beat_kit(self) -> None:
        ...
        self.assertNotIn(GET_NIGHT_BEAT_KIT, GET_SURVIVING_TARGET_COUNT)
        self.assertNotIn("GetNightBeatKit", GET_SURVIVING_TARGET_COUNT)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_get_surviving_target_count"
                "_decl_contract.py"
            )
        )
        self.assertIn(
