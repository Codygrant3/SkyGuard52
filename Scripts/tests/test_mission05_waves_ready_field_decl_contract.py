...
# Mission05 IntegrationReadiness bWavesReady
...
# bWavesReady FIELD #865 / branch cursor/mission02-
...
# waves-ready-field-decl-contract-c332,
# NOT leftover Mission10 bPhaseWavesReady
# FIELD #817 / branch cursor/mission10-
# phase-waves-ready-field-decl-contract-c332,
# NOT leftover sibling Mission05 director field
# drafts #947-#962 and readiness-struct drafts
# through bGunnerReady #967 / bTempestReady #966 /
# bObjectivesReady,
...
class Mission05WavesReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        for header in (
            ...
            section = public_section(header)
            self.assertTrue(
                has_declaration(section, WAVES_READY_TRUE),
                section,
            )
            self.assertEqual(
                require_declaration(
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 bWavesReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 bWavesReady contains "
