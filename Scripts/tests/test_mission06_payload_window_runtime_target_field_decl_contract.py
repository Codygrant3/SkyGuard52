...
# Mission07 SearchTrackRuntime / Mission08
# HoistWindowRuntime / Mission09 pool
# structs, or private
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission06 PayloadWindowRuntime
# Target. THIS IS NOT leftover payload-window-
# runtime-defaults #215/#f114. THIS IS NOT leftover
# StartPayloadWindow / AdvancePayloadWindow /
# TryJamActivePayload / GetPayloadWindow. THIS IS
# NOT leftover airfield-target enum #222/#14d2.
# THIS IS NOT leftover airfield-target-runtime-
# defaults #217/#6ad8. THIS IS NOT leftover
# AirfieldTargetRuntime Target #1141 / Integrity
# #1139 / in-flight bDestroyed. THIS IS NOT leftover
# PayloadWindowRuntime bActive (in-flight sibling).
# THIS IS NOT leftover GetTargetRuntime #702 /
# NotifyAirfieldTargetDamage #693. THIS IS NOT leftover
# Mission07 PTR Target #1137 / Mission08 PTR Target
# #1129 / Mission09 PTR Target #1124. THIS IS NOT leftover
# Mission06 director Root / readiness drafts.
# THIS IS NOT leftover Mission07
# protected-target enum #223/#18f2. THIS IS NOT leftover
# Mission07 protected-target-runtime-defaults #221/#866c.
# THIS IS NOT leftover GetProtectedTarget #723. THIS IS NOT leftover
...
# SearchTrackCount #1043. LOCK leftover Mission07
# PTR Target #1137 / Integrity #1138 / bDestroyed
# #1140. LOCK leftover Mission08
...
# HoistWindowRuntime #1130-#1134. LOCK leftover
...
# Mission06 PayloadWindowRuntime Target
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly ESkyguardAirfieldTarget
# default Runway,
# one-line / split-line UPROPERTY wraps) on
# FSkyguardPayloadWindowRuntime. It is
...
# the origin/main Runway default,
...
# This PayloadWindowRuntime Target field sits after
# leftover bActive, before RemainingSeconds / bJammed.
# Skip leftover PayloadWindow bActive sibling. Skip leftover
# AirfieldTargetRuntime Target / Integrity / bDestroyed.
# Skip leftover
# b + Ya + kRuntimeReady forever (it sits after
# bMapAssemblyReady and before bGunnerReady). THIS IS NOT leftover Mission08
...
# Harbor 40/80 fail-closed in this NEW Mission06
...
# Parse FSkyguardPayloadWindowRuntime only.
...
LEFTOVER_AIRFIELD_TARGET_NOT_LOCKED = (
    "test_airfield_target_enum_contract.py",
    "test_airfield_target_runtime_defaults_contract.py",
    "cursor/airfield-target-enum-contract-14d2",
    "cursor/airfield-target-runtime-defaults-contract-6ad8",
)
...
LEFTOVER_SEARCH_TRACK_NOT_LOCKED = (
    ...
    "test_mission07_search_track_runtime_classified_false_field_decl_contract.py",
    ...
    "cursor/mission07-search-track-runtime-classified-false-field-decl-contract-c332",
)
...
class Mission06PayloadWindowRuntimeTargetFieldDeclContractTests(unittest.TestCase):
    def test_mission06_struct_exists(self) -> None:
        ...
        self.assertIn("bActive", section)
        self.assertIn("RemainingSeconds", section)
        self.assertIn("bJammed", section)
    ...
    def test_missing_target_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_target_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("ESkyguardAirfieldTarget Target"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("Runway;"), LOCKED_DECL)
        ...
        self.assertIn("Target", LOCKED_DECL)
        self.assertIn("ESkyguardAirfieldTarget ", LOCKED_DECL)
        self.assertIn("Runway", LOCKED_DECL)
        ...
        self.assertIn("ESkyguardAirfieldTarget", LOCKED_DECL)
        self.assertTrue(
            LOCKED_DECL.startswith("ESkyguardAirfieldTarget "),
            LOCKED_DECL,
        )
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("Target", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("ESkyguardAirfieldTarget Target"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("Target", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 PayloadWindowRuntime Target field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission06 PayloadWindowRuntime Target contains "
    ...
    def test_contract_is_target_field_declaration_only(
        ...
        self.assertTrue(LOCKED_DECL.startswith("ESkyguardAirfieldTarget Target"))
        self.assertIn("Target", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("Runway;"))
        self.assertTrue(LOCKED_DECL.endswith(";"))
        self.assertNotIn("GetProtectedGroup", LOCKED_DECL)
        self.assertNotIn("FSkyguardMission10ProtectedRuntime", LOCKED_DECL)
        self.assertIn(UPROPERTY_MISSION10, section)

    def test_sibling_director_fields_do_not_satisfy_target(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_payload_window_runtime"
                "_target_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_parse_director_class_or_storm_runtime(
        ...
        self.assertTrue(
            has_declaration(public_section(payload_only), LOCKED_DECL),
            payload_only,
        )
        airfield_only = (
        ...
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertEqual(CLASS_NAME, "FSkyguardPayloadWindowRuntime")
        self.assertNotEqual(CLASS_NAME, "FSkyguardAirfieldTargetRuntime")
        locked_only = f"{LOCKED_DECL}\n"
