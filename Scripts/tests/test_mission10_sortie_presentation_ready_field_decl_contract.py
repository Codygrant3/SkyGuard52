...
# Mission10 bSortiePresentationReady FIELD
...
# bEvacuationPresentationReady #816, NOT leftover
...
SORTIE_PRESENTATION_READY_FIELD = (
    "bool bSortiePresentationReady = false;"
)
LOCKED_DECL = SORTIE_PRESENTATION_READY_FIELD
...
# Mission10 SortiePresentation #797, leftover Mission01
# SortiePresentation #575, leftover Mission10 briefing-
# ready field, leftover Mission10 Briefing #795,
# leftover Mission01 Briefing #568, leftover
# Mission10 bEvacuationPresentationReady #816,
# leftover Mission10 Readiness #809, leftover Mission01
...
class Mission10SortiePresentationReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 bSortiePresentationReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission10 bSortiePresentationReady contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission10_sortie_presentation_ready_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_sortie_presentation_ready_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
