...
# Available FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly int32 = 48;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission09 PoolRuntime
# Available. THIS IS NOT leftover Mission08
...
# merge #665 #666 #668-#673, or open drafts #674-#1118.
...
# This PoolRuntime field sits first in the public section.
...
# drafts #674-#1118 including leftover Mission02
...
# drafts #674-#1118. Do not reopen leftover
...
class Mission09PoolRuntimeAvailableFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_available_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_available_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 Available"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("Available", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("Available", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 Available"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("Available", locked_only)
    ...
    def test_contract_is_available_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_available(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_pool_runtime_available"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
