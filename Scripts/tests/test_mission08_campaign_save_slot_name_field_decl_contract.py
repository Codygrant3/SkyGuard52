...
# THIS IS leftover-safe Mission08 CampaignSaveSlotName FIELD
...
# THIS IS NOT leftover Mission07 CampaignSaveSlotName
...
# director Root #1044 through bAllowBoundedActorSpawning
# #1057. LOCK leftover Mission01/02/03/04/05/06/07/10
...
# merge #665 #666 #668-#673, or open drafts #674-#1057.
...
# Mission08 CampaignSaveSlotName FIELD
...
class Mission08CampaignSaveSlotNameFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 CampaignSaveSlotName field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 CampaignSaveSlotName field contains "
