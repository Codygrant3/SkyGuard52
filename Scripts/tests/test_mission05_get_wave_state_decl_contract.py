...
# INDEX_NONE or lock GetWaveState construction
# in the .cpp. This is leftover-safe Mission05
# Waves GetWaveState on
...
# leftover Mission05 wave-state enum #ad28, NOT
# leftover Mission04 GetWaveState #659, NOT
# leftover Mission03 GetWaveState, NOT leftover
# Mission03 wave-state enum #0242, NOT leftover
# Mission04 wave-state enum #bb22. Distinct from
...
# GetStormRainBeatKit. Do not lock leftover Mission01
...
# #656, leftover Mission05 wave-state enum #ad28
# (do not add an enum-roster contract), leftover
# Mission05 protected-target enum #aaa2, leftover
# Mission05 protected-target-runtime-defaults
# #ec8b, leftover storm-runtime-defaults #89c9 struct,
# leftover HandleBossPhaseChanged without Blueprint
# category, leftover searchlight-track-runtime-defaults
# #7347 (do not lock GetSearchlightRuntime). Skip
# leftover #664. Do not reopen leftover #668/#669
# or closed #536-#673. Distinct from leftover
# Mission05 InitializePlayableMission #666 /
# ConfigureMissionDefinition #665 /
# NotifyThreatDestroyed #669 / StartNextWave #668 /
# NotifyProtectedTargetDamage #673.
# origin/main is a one-line inline body
# (`ESkyguardMission05WaveState GetWaveState()
...
# Integration / Searchlight / Substation /
# Objectives / Boss / Storm / Protection /
# Destruction / Briefing, not leftover
...
# GetWaveState method declaration
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission05IntegrationDirector::GetWaveState",
    "SkyguardMission05IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission05GetWaveStateDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        as_void = "\tvoid GetWaveState() const;\n"
        with_arg = (
            "\tESkyguardMission05WaveState GetWaveState(int32 Wave) const;\n"
        )
        renamed = "\tESkyguardMission05WaveState GetState() const;\n"
        short_name = "\tESkyguardMission05WaveState GetWave() const;\n"
    ...
    def test_get_wave_state_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            GET_WAVE_STATE.startswith("ESkyguardMission05WaveState "),
            GET_WAVE_STATE,
        )
        self.assertTrue(
            GET_WAVE_STATE.endswith(";"),
            GET_WAVE_STATE,
        )
    ...
    def test_environment_category_does_not_satisfy_waves(self) -> None:
        ...
        self.assertNotEqual(leftover_m05_protection, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_m05_waves, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_m05_storm, UFUNCTION_WAVES)
        ...
        self.assertNotIn(leftover_m05_protection, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m05_waves, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m05_storm, UFUNCTION_WAVES)
        self.assertNotIn("Mission01", UFUNCTION_WAVES)
        self.assertNotIn("Mission03", UFUNCTION_WAVES)
        self.assertNotIn("Mission04", UFUNCTION_WAVES)
        self.assertNotIn("Protection", UFUNCTION_WAVES)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardTempestBoss", GET_WAVE_STATE)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 GetWaveState method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission05 GetWaveState contains "
    ...
    def test_contract_is_get_wave_state_declaration_only(
        ...
        self.assertIn("GetWaveState", GET_WAVE_STATE)
        self.assertTrue(GET_WAVE_STATE.endswith(";"))
        self.assertIn(UFUNCTION_WAVES, section)
