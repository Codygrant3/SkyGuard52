...
# INDEX_NONE or lock PayloadImpactDamage
# construction in the .cpp. This is leftover-safe
# Mission06 PayloadImpactDamage FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps, ClampMin one-line or split-line,
# int32 default 100) on
# ASkyguardMission06IntegrationDirector. SKIP
# leftover retired-mount spawn fields forever.
# This contract is PayloadImpactDamage
# FIELD, not leftover payload-window-
# runtime-defaults #f114, not leftover
# Mission06 GetPayloadWindow, not leftover
...
# leftover Mission06 MaximumTargetIntegrity
# in-flight / branch cursor/mission06-maximum-
# target-integrity-field-decl-contract-c332.
# This contract is PayloadImpactDamage
# only. It is NOT leftover Mission05
...
# Mission04 MaximumSubstationIntegrity, NOT leftover
# Mission03 MaximumConvoyIntegrity, NOT leftover
# Mission02 MaximumFuelTerminalIntegrity, NOT leftover
# Mission10 MaximumProtectedIntegrity, NOT leftover
# Mission09 GetSurvivingTargetCount, NOT leftover
# RunwayBreakerSpawnLocation / RunwayBreakerSpawnRotation
# in-flight branches, NOT leftover TempestSpawnLocation,
...
# BlueprintReadWrite / Category Skyguard|Mission06 /
...
# Lock PayloadImpactDamage only. Do not lock
# leftover retired-mount spawn fields, leftover
# MaximumTargetIntegrity in-flight, leftover
# RunwayBreakerSpawnLocation / RunwayBreakerSpawnRotation,
# leftover TempestSpawnLocation / BlackKiteSpawnLocation /
# RoadHunterSpawnLocation / BreakwaterSpawnLocation /
# LastFlightSpawnLocation, leftover Mission05
# MaximumProtectedTargetIntegrity. Do not lock leftover
# GetAircraft.
...
# default. Parse the public
# class section of
# ASkyguardMission06IntegrationDirector only.
# Do not parse FSkyguardMission06IntegrationReadiness,
...
# Category is Skyguard|Mission06, not
...
# bAllowBoundedActorSpawning #987 /
# bAutoLaunchAfterBriefing #988 / CampaignSaveSlotName
# #989 / leftover CampaignSaveUserIndex /
# RunwayBreakerSpawnLocation #990 /
# RunwayBreakerSpawnRotation / leftover
# MaximumTargetIntegrity in-flight branches.
# Do not reopen leftover same-
# name integrity drafts. Do not reopen leftover same-
# name spawn-location drafts. Do not reopen leftover
# payload-window drafts. Do not reopen open
# drafts #674-#990.
...
UPROPERTY_MISSION06_CLAMP = 'meta=(ClampMin="1")'
...
LOCKED_DECL = PAYLOAD_IMPACT_DAMAGE_FIELD
...
# an isolated Python PayloadImpactDamage
...
class Mission06PayloadImpactDamageFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("PayloadImpactDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_payload_impact_damage_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        macro_only = f"\t{UPROPERTY_MISSION06}\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn(UPROPERTY_MISSION06, section)
        ...
        self.assertIn(UPROPERTY_MISSION06_CLAMP, section)
        self.assertIn('ClampMin="1"', section)
        self.assertNotIn("VisibleAnywhere", UPROPERTY_MISSION06)
        self.assertNotIn("BlueprintReadOnly", UPROPERTY_MISSION06)
        self.assertTrue(
            has_declaration(section, LOCKED_DECL),
            section,
        )
        ...
        self.assertNotIn("BlueprintCallable", UPROPERTY_MISSION06)
        self.assertNotIn("BlueprintPure", UPROPERTY_MISSION06)
        self.assertIn("Skyguard|Mission06", UPROPERTY_MISSION06)
        self.assertNotIn("Skyguard|Mission02|Protection", UPROPERTY_MISSION06)
        self.assertNotIn("Integration", UPROPERTY_MISSION06)
        self.assertNotIn("Mission01", UPROPERTY_MISSION06)
        self.assertNotIn("Mission02", UPROPERTY_MISSION06)
        self.assertNotIn("Mission03", UPROPERTY_MISSION06)
        self.assertNotIn("Mission04", UPROPERTY_MISSION06)
        self.assertNotIn("Mission05", UPROPERTY_MISSION06)
        self.assertNotIn("Protection", UPROPERTY_MISSION06)
        self.assertNotIn("Search", UPROPERTY_MISSION06)
        self.assertNotIn("Waves", UPROPERTY_MISSION06)
        self.assertNotIn("Payload", UPROPERTY_MISSION06)
        self.assertNotIn("Targets", UPROPERTY_MISSION06)
        self.assertNotIn("Objectives", UPROPERTY_MISSION06)
        self.assertNotIn("Environment", UPROPERTY_MISSION06)
        self.assertNotIn("Briefing", UPROPERTY_MISSION06)
        self.assertNotIn("Mission10", UPROPERTY_MISSION06)
        self.assertNotIn("Boss", UPROPERTY_MISSION06)
        self.assertNotIn("Destruction", UPROPERTY_MISSION06)
        self.assertNotIn("Apache", UPROPERTY_MISSION06)
        self.assertNotIn("Mission07", UPROPERTY_MISSION06)
        self.assertNotIn("Mission08", UPROPERTY_MISSION06)
        self.assertNotIn("Mission09", UPROPERTY_MISSION06)
        self.assertNotIn("Encounter", UPROPERTY_MISSION06)
        self.assertNotIn("Safety", UPROPERTY_MISSION06)
        self.assertNotIn("Performance", UPROPERTY_MISSION06)
        self.assertNotIn("Hoist", UPROPERTY_MISSION06)
        self.assertNotIn("Rescue", UPROPERTY_MISSION06)
        self.assertNotIn("Evacuation", UPROPERTY_MISSION06)
        self.assertNotIn("Campaign", UPROPERTY_MISSION06)
        self.assertNotIn("Skyguard|Mission06|Campaign", UPROPERTY_MISSION06)
        self.assertNotIn("ClampMin", UPROPERTY_MISSION06)
        self.assertNotIn("ClampMin", LOCKED_DECL)
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, UPROPERTY_MISSION06)
    ...
    def test_payload_impact_damage_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 PayloadImpactDamage"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("PayloadImpactDamage", LOCKED_DECL)
        ...
        self.assertNotIn("MaximumSubstationIntegrity", LOCKED_DECL)
        self.assertNotIn("MaximumConvoyIntegrity", LOCKED_DECL)
        self.assertNotIn("MaximumFuelTerminalIntegrity", LOCKED_DECL)
        self.assertNotIn("MaximumProtectedIntegrity", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION06} {LOCKED_DECL}\n"
            "};\n"
        )
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(environment, UPROPERTY_MISSION06)
        self.assertNotEqual(briefing, UPROPERTY_MISSION06)
        self.assertNotIn(environment, UPROPERTY_MISSION06)
        self.assertNotIn(briefing, UPROPERTY_MISSION06)
        leftover_m01 = (
            'UFUNCTION(BlueprintCallable, '
        ...
        self.assertNotEqual(leftover_m01, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m02, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_harbor, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m03, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m04, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m05, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m06, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_waves, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m05_waves, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_integration, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m07_ready, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m08_waves, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m08_hoist, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m08_safety, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m08_protection, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m08_ready, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m09_ready, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m09_waves, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m10_safety, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m09_protection, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m09_performance, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_m09_objectives, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_payload, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_targets, UPROPERTY_MISSION06)
        self.assertNotEqual(leftover_objectives, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m01, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m02, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_harbor, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m03, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m04, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m05, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m06, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m05_waves, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_integration, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m07_ready, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m08_waves, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m08_hoist, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m08_safety, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m08_protection, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m08_ready, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m09_ready, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m09_waves, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m10_safety, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m09_protection, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m09_performance, UPROPERTY_MISSION06)
        self.assertNotIn(leftover_m09_objectives, UPROPERTY_MISSION06)
        self.assertNotIn("Mission01", UPROPERTY_MISSION06)
        self.assertNotIn("Mission02", UPROPERTY_MISSION06)
        self.assertNotIn("Mission03", UPROPERTY_MISSION06)
        self.assertNotIn("Mission04", UPROPERTY_MISSION06)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("PayloadImpactDamage", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 PayloadImpactDamage"))
        self.assertNotIn("MaximumTargetIntegrity", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("PayloadImpactDamage", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 PayloadImpactDamage field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission06 PayloadImpactDamage field contains "
    ...
    def test_contract_is_payload_impact_damage_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        # substring of RunwayBreakerSpawnLocation, so equality
        ...
        for token in leftover_short_roster_values():
            ...
            self.assertNotEqual(token, "RunwayBreakerSpawnLocation")
    ...
    def test_sibling_director_fields_do_not_satisfy_payload_impact_damage(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tint32 PayloadImpactDamage = 1;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_contract_does_not_relock_leftover_handle_boss_phase_changed(
        ...
        for token in LEFTOVER_HANDLE_BOSS_PHASE_CHANGED_NOT_LOCKED:
            ...
            self.assertNotIn(token, LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", UPROPERTY_MISSION06)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission06_runway_breaker_spawn_location_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission06_campaign_save_user_index_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission06_maximum_target_integrity_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_airfield_target_runtime_does_not_satisfy_payload_impact_damage(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_does_not_satisfy_payload_impact_damage(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
