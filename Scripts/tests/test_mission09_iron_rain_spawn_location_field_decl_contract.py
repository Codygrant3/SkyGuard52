...
# THIS IS leftover-safe Mission09 IronRainSpawnLocation FIELD
# (declaration-only, one-line / split-line UPROPERTY wraps
# plus the FVector(72000.f, 8000.f, 7600.f) default) on
# ASkyguardMission09IntegrationDirector.
# THIS IS NOT leftover Mission08 director LifelineHunterSpawnLocation
# (same-pattern other mission; lock leftover Mission08 director
# Root #1044 through Readiness #1066). THIS IS NOT leftover
# live-mount spawn location / rotation (skip forever; they sit
# immediately before IronRainSpawnLocation). THIS IS NOT leftover
# Mission08/07/06/05/04/03/02/01/10 same-name IronRainSpawnLocation.
...
# FSkyguardMission09PoolRuntime fields.
...
# merge #665 #666 #668-#673, or open drafts #674-#1095.
...
# retired live-mount pointer), leftover live-mount spawn
# location / rotation, leftover runtime-ready flag,
# HandleDroneCityImpact, GetStormRainBeatKit without
# UFUNCTION. Do not create leftover Mission08 wave-state
# enum #68fc / leftover Mission08 protected-target enum
# #a66a / leftover Mission08 protected-target-runtime-
# defaults #75e6 / leftover hoist-window-runtime-defaults
# #ec79 / leftover Mission09 pool-runtime-defaults #5426 /
# leftover Mission09 pool-budget-defaults #4537.
# Declaration presence only. Do not invent
# INDEX_NONE or lock IronRainSpawnLocation
# construction in the .cpp. This is leftover-safe
# Mission09 IronRainSpawnLocation FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps plus the FVector default) on
# ASkyguardMission09IntegrationDirector. SKIP
# leftover retired-mount spawn location /
# leftover retired-mount spawn rotation forever
# (they sit immediately before
# IronRainSpawnLocation). This contract is
# IronRainSpawnLocation only. It is NOT leftover
# retired-mount spawn location (skip forever), NOT leftover
# Mission07 RadarGhostSpawnLocation, NOT leftover
# Mission08 RescueHelicopterAnchor #1045, NOT leftover
# Mission06 RunwayBreakerSpawnLocation #990 /
# leftover TempestSpawnLocation,
# NOT leftover BlackKiteSpawnLocation, NOT leftover
# RoadHunterSpawnLocation, NOT leftover
# BreakwaterSpawnLocation, NOT leftover
# LastFlightSpawnLocation, NOT leftover retired-
# mount spawn fields. Note EditAnywhere /
# BlueprintReadWrite / Category Skyguard|Mission08 /
# FVector(57000.f, -9000.f, 5400.f), not
# VisibleAnywhere / BlueprintReadOnly. It is
# NOT leftover Mission01 bAutoInitialize field
# #580 / branch cursor/mission01-auto-initialize-
# field-decl-contract-c332, NOT leftover Mission02
# bAutoInitialize field #852 / branch cursor/
# mission02-auto-initialize-field-decl-contract-
# c332, NOT leftover Mission03 bAutoInitialize
# field #885 / branch cursor/mission03-auto-
# initialize-field-decl-contract-c332, NOT leftover
# Mission04 bAutoInitialize field #915 / branch
# cursor/mission04-auto-initialize-field-decl-
# contract-c332, NOT leftover Mission05
# bAutoInitialize field #954 / branch cursor/
# mission05-auto-initialize-field-decl-contract-
# c332, NOT leftover Mission10 bAutoInitialize
# field #800 / branch cursor/mission10-auto-
# initialize-field-decl-contract-c332, NOT leftover
...
# Lock IronRainSpawnLocation only. Do not lock
# leftover retired-mount spawn fields, leftover
# Mission08 LifelineHunterSpawnLocation, leftover
# Mission07 RadarGhostSpawnLocation, leftover
# Mission08 RescueHelicopterAnchor #1045, leftover
# TempestSpawnLocation / BlackKiteSpawnLocation /
# RoadHunterSpawnLocation / BreakwaterSpawnLocation /
# LastFlightSpawnLocation, leftover
# RunwayBreakerSpawnRotation. Do not lock leftover
# GetAircraft.
...
# the FVector default, and nearby split-line
...
# DIRECTOR CLASS UPROPERTY section of
...
# FSkyguardMission08ProtectedTargetRuntime, private UPROPERTY(Transient),
# or Mission01 /
...
# Mission04 / Mission05 / leftover Mission06 /
# leftover Mission07 / leftover Mission08, not leftover Mission01
...
# leftover SortiePresentation / CampaignDefinition /
# MissionDefinition in-flight, leftover Mission06
# bAutoInitialize #986 / leftover
# bAllowBoundedActorSpawning /
# bAutoLaunchAfterBriefing / CampaignSaveSlotName
# in-flight branches. Do not reopen leftover same-
# name spawn-location drafts. Do not reopen open
# drafts #674-#1095.
...
RUNWAY_BREAKER_SPAWN_LOCATION = (
    "FVector RunwayBreakerSpawnLocation = "
    "FVector(78000.f, 22000.f, 6000.f);"
)
CAMPAIGN_SAVE_USER_INDEX_FIELD = (
    "int32 CampaignSaveUserIndex = 0;"
)
RUNWAY_BREAKER_SPAWN_ROTATION = (
    "FRotator RunwayBreakerSpawnRotation;"
)
TEMPEST_SPAWN_LOCATION = (
    "FVector TempestSpawnLocation = "
    "FVector(70000.f, 24000.f, 7600.f);"
)
BREAKWATER_SPAWN_LOCATION = "FVector BreakwaterSpawnLocation;"
...
RADAR_GHOST_SPAWN_LOCATION = (
    "FVector RadarGhostSpawnLocation = "
    "FVector(73000.f, 32000.f, 7200.f);"
)
...
# an isolated Python IronRainSpawnLocation
...
# merge #658-#673, leftover Mission05 closed-without-
# merge #665 #666 #668-#673, or open drafts #674-#1095.
# LOCK leftover Mission01/02/03/04/05/06/07/08/10 same-
# name director and readiness-struct drafts. LOCK leftover
...
# Blueprint UFUNCTION methods. LOCK leftover Mission09
# Root #1083 through CampaignSaveSlotName #1095.
# THIS IS NOT leftover Mission08 director
# LifelineHunterSpawnLocation. THIS IS NOT leftover
# Mission08/07/06/05/04/03/02/01/10 same-name
# IronRainSpawnLocation. THIS IS NOT leftover Mission09
# Blueprint UFUNCTION methods. THIS IS NOT leftover
# FSkyguardMission09IntegrationReadiness fields.
# Skip leftover BindRuntimeActors / leftover
# HandleDroneCityImpact / leftover GetStormRainBeatKit
# without UFUNCTION / leftover live-mount spawn
# location / leftover runtime-ready flag forever.
# Harbor 40/80 fail-closed in Mission02/03/04/05/06/07
# test files (Mission08/09-only). Incoming clock names
# must be absent.
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission01_iron_rain_spawn_location_field_decl_contract.py",
    "Scripts/tests/test_mission02_iron_rain_spawn_location_field_decl_contract.py",
    "Scripts/tests/test_mission03_iron_rain_spawn_location_field_decl_contract.py",
    "Scripts/tests/test_mission04_iron_rain_spawn_location_field_decl_contract.py",
    "Scripts/tests/test_mission05_iron_rain_spawn_location_field_decl_contract.py",
    "Scripts/tests/test_mission06_iron_rain_spawn_location_field_decl_contract.py",
    "Scripts/tests/test_mission07_iron_rain_spawn_location_field_decl_contract.py",
    "Scripts/tests/test_mission08_iron_rain_spawn_location_field_decl_contract.py",
    "Scripts/tests/test_mission10_iron_rain_spawn_location_field_decl_contract.py",
...
class Mission09IronRainSpawnLocationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_iron_rain_spawn_location_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_iron_rain_spawn_location_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FVector IronRainSpawnLocation"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("IronRainSpawnLocation", LOCKED_DECL)
        self.assertIn("= FVector(72000.f, 8000.f, 7600.f)", LOCKED_DECL)
        ...
        self.assertNotIn("RunwayBreakerSpawnLocation", LOCKED_DECL)
        self.assertNotIn("RunwayBreakerSpawnRotation", LOCKED_DECL)
        self.assertNotIn("RadarGhostSpawnLocation", LOCKED_DECL)
        self.assertNotIn("RadarGhostSpawnRotation", LOCKED_DECL)
        self.assertNotIn("LifelineHunterSpawnRotation", LOCKED_DECL)
        self.assertNotIn("RescueHelicopterAnchor", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tFVector\n"
            "\tIronRainSpawnLocation = FVector(72000.f, 8000.f, 7600.f);\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("IronRainSpawnLocation", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FVector IronRainSpawnLocation"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("IronRainSpawnLocation", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 LifelineHunterSpawnLocation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 LifelineHunterSpawnLocation field contains "
    ...
    def test_contract_is_iron_rain_spawn_location_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        # leftover roster token, so equality
        ...
        for token in leftover_short_roster_values():
            ...
            self.assertNotEqual(token, "IronRainSpawnLocation")
            self.assertNotEqual(token, "RadarGhostSpawnLocation")
    ...
    def test_sibling_director_fields_do_not_satisfy_iron_rain_spawn_location(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
        ...
        self.assertIn(
            "Scripts/tests/test_mission07_radar_ghost_spawn_location"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_rescue_helicopter_anchor"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tFVector LifelineHunterSpawnLocation = FVector(0.f, 0.f, 0.f);\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_iron_rain_spawn_location_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_airfield_target_runtime_does_not_satisfy_iron_rain_spawn_location(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_does_not_satisfy_runway_breaker_spawn_location(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
