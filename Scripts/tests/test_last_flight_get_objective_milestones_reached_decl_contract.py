...
# Python GetObjectiveMilestonesReached declaration
...
# IsWreckDiverted, GetCivilianSeparationMeters,
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardLastFlightBoss::GetObjectiveMilestonesReached",
    "SkyguardLastFlightBoss.cpp",
    "SetExposed",
...
class LastFlightGetObjectiveMilestonesReachedDeclContractTests(unittest.TestCase):
    def test_last_flight_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, GET_OBJECTIVE_MILESTONES_REACHED),
            section,
        )
    ...
    def test_other_class_does_not_satisfy(self) -> None:
        other = (
            ...
            "{\n"
            "public:\n"
            f"\t{GET_OBJECTIVE_MILESTONES_REACHED}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertIn("GetObjectiveMilestonesReached", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_missing_get_objective_milestones_reached_declaration_fails_closed(
        self,
    ) -> None:
        neighbors_only = (
            "\tASkyguardLastFlightBoss();\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertIn("GetObjectiveMilestonesReached", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertIn("GetObjectiveMilestonesReached", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("BlueprintPure", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("UFUNCTION", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("Category", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("BlueprintCallable", GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertIn("GetObjectiveMilestonesReached", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        missing_const = "\tint32 GetObjectiveMilestonesReached();\n"
        missing_parens = "\tint32 GetObjectiveMilestonesReached;\n"
        wrong_return_void = "\tvoid GetObjectiveMilestonesReached() const;\n"
        wrong_return_bool = "\tbool GetObjectiveMilestonesReached() const;\n"
        wrong_return_float = (
            "\tfloat GetObjectiveMilestonesReached() const;\n"
        )
        added_arg = (
            "\tint32 GetObjectiveMilestonesReached(int32 Extra) const;\n"
        )
        ...
        leftover_sep = f"\t{GET_CIVILIAN_SEPARATION_METERS}\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, GET_OBJECTIVE_MILESTONES_REACHED)
            self.assertIn("GetObjectiveMilestonesReached", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_get_objective_milestones_reached_declaration_matches_origin_main(
        self,
    ) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
        ...
        self.assertEqual(
            declaration_count(section, GET_OBJECTIVE_MILESTONES_REACHED),
            1,
        )
        self.assertTrue(
            GET_OBJECTIVE_MILESTONES_REACHED.startswith("int32 "),
            GET_OBJECTIVE_MILESTONES_REACHED,
        )
        self.assertTrue(
            GET_OBJECTIVE_MILESTONES_REACHED.endswith(";"),
            GET_OBJECTIVE_MILESTONES_REACHED,
        )
        self.assertIn(
        ...
        self.assertIn(" const", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("INDEX_NONE", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("{", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("}", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("return ", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn(
        ...
        self.assertNotIn("OpenGuidanceArrayExposure", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("IssueClimbCommand", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn(
            "DivertWreckFromCivilians",
            GET_OBJECTIVE_MILESTONES_REACHED,
        )
        ...
        self.assertNotIn("GetFinaleStage", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("IsClimbCommandIssued", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("IsWreckDiverted", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn(
            "GetCivilianSeparationMeters",
            GET_OBJECTIVE_MILESTONES_REACHED,
        )
        ...
        self.assertNotIn("GetChinMuzzleLocation", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("GetGunnerMount", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("FaceWorldLocation", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("PortGuidanceArray", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("SetSearchlightTracked", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("SetContactIdentified", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn(
            "SetFriendlySeparationMeters",
            GET_OBJECTIVE_MILESTONES_REACHED,
        )
        self.assertNotIn("SetLightningExposed", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn(
            "OpenUpperEngineExposure",
            GET_OBJECTIVE_MILESTONES_REACHED,
        )
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, GET_OBJECTIVE_MILESTONES_REACHED)

    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tint32\n"
            "\tGetObjectiveMilestonesReached() const;\n"
            "private:\n"
            "};\n"
        )
        wrap_name = (
            "public:\n"
            "\tint32 GetObjectiveMilestonesReached\n"
            "\t() const;\n"
            "private:\n"
            "};\n"
        )
        ...
        self.assertTrue(
            has_declaration(one_line, GET_OBJECTIVE_MILESTONES_REACHED)
        )
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, GET_OBJECTIVE_MILESTONES_REACHED),
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        locked_only = f"{GET_OBJECTIVE_MILESTONES_REACHED}\n"
        self.assertNotIn("INDEX_NONE", locked_only)
        self.assertNotIn("INDEX_NONE", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("return INDEX_NONE", locked_only)
        self.assertNotIn("NAME_None", GET_OBJECTIVE_MILESTONES_REACHED)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_get_objective_milestones_reached_cpp_body(
        self,
    ) -> None:
        locked_only = f"{GET_OBJECTIVE_MILESTONES_REACHED}\n"
        self.assertNotIn("{", GET_OBJECTIVE_MILESTONES_REACHED)
        ...
        self.assertNotIn("return false", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("return true", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn(
            "return ObjectiveMilestonesReached",
            GET_OBJECTIVE_MILESTONES_REACHED,
        )
        self.assertNotIn("SetExposed", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            GET_OBJECTIVE_MILESTONES_REACHED,
        )
        self.assertNotIn("SetBossPhase", GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_contract_does_not_relock_begin_terminal_strike_cycle_sibling(
        ...
        for token in ISSUE_CLIMB_COMMAND_NOT_LOCKED:
            ...
            self.assertNotIn(token, GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_contract_does_not_relock_weak_point_fields(self) -> None:
        ...
        self.assertNotIn("PortGuidanceArray", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("StarboardGuidanceArray", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("CommandCore", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("PortEngine", GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("SetSearchlightTracked", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("IsSearchlightTracked", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("ASkyguardBlackKiteBoss", GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            ...
            self.assertNotIn(token, GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("SetContactIdentified", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("IsContactIdentified", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("OpenOrbitExposure", GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        self.assertNotIn("OpenSensorExposure", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn(
            "ASkyguardLifelineHunterBoss",
            GET_OBJECTIVE_MILESTONES_REACHED,
        )
    ...
    def test_contract_does_not_relock_leftover_tempest(self) -> None:
        ...
        self.assertNotIn("ASkyguardTempestBoss", GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_contract_does_not_relock_leftover_iron_rain(self) -> None:
        ...
        self.assertNotIn("OpenDispenserBay", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("ASkyguardIronRainBoss", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn(
            "ASkyguardIronRainBoss::IssueClimbCommand",
            GET_OBJECTIVE_MILESTONES_REACHED,
        )
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        self.assertNotIn("ASkyguardPatrolShip", GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_contract_does_not_relock_mount_getters(self) -> None:
        ...
        for token in MOUNT_GETTERS_NOT_LOCKED:
            ...
            self.assertNotIn(token, GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("GetGunnerMount", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("GetChinTurret", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("GetSensorTurret", GET_OBJECTIVE_MILESTONES_REACHED)

    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        locked_only = f"{GET_OBJECTIVE_MILESTONES_REACHED}\n"
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("GetChinMuzzleLocation", GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("ESkyguardApacheSystem", GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_contract_does_not_relock_leftover_input_capture(self) -> None:
        ...
        self.assertNotIn("RecordPlayerEvent", GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("ASkyguardGunner", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("FillAndFinalize", GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("SkyguardRadarNode", GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn(
            "USkyguardBriefingWidget",
            GET_OBJECTIVE_MILESTONES_REACHED,
        )
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, GET_OBJECTIVE_MILESTONES_REACHED)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn(
            "ESkyguardMissionSkylineStyle",
            GET_OBJECTIVE_MILESTONES_REACHED,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("MinHeightFromOriginCm", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("MaxIntegrity", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn(
            "SkyguardApacheAircraft.h",
            GET_OBJECTIVE_MILESTONES_REACHED,
        )
        self.assertNotIn("SkyguardPathfinder", GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, GET_OBJECTIVE_MILESTONES_REACHED)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{GET_OBJECTIVE_MILESTONES_REACHED}\n"
        self.assertEqual(
            require_declaration(locked_only, GET_OBJECTIVE_MILESTONES_REACHED),
            GET_OBJECTIVE_MILESTONES_REACHED,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "last flight GetObjectiveMilestonesReached contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, GET_OBJECTIVE_MILESTONES_REACHED.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                GET_OBJECTIVE_MILESTONES_REACHED.lower(),
                "last flight GetObjectiveMilestonesReached contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, GET_OBJECTIVE_MILESTONES_REACHED)

    def test_contract_is_get_objective_milestones_reached_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertNotIn("return ", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertNotIn("{", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertTrue(GET_OBJECTIVE_MILESTONES_REACHED.startswith("int32 "))
        self.assertTrue(GET_OBJECTIVE_MILESTONES_REACHED.endswith(";"))
        self.assertIn(" const", GET_OBJECTIVE_MILESTONES_REACHED)
        self.assertIn(UFUNCTION_BOSS, section)
