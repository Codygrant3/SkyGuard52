...
# Mission05 Integration SynchronizeRuntimeState
...
# #635, or leftover Mission04 SynchronizeRuntimeState
# #656. Distinct from leftover briefing-widget /
...
# Mission04 Integration #656, not leftover
# Harbor Mission02 Integration, not leftover
# Mission05 Protection / Waves / Storm.
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission05IntegrationDirector::SynchronizeRuntimeState",
    "SkyguardMission05IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission05SynchronizeRuntimeStateDeclContractTests(unittest.TestCase):
    ...
    def test_synchronize_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("GetNightBeatKit", SYNCHRONIZE_RUNTIME_STATE)
        self.assertNotIn("StartSearchlightWindow", SYNCHRONIZE_RUNTIME_STATE)
        self.assertNotIn("AdvanceSearchlightTrack", SYNCHRONIZE_RUNTIME_STATE)
        self.assertNotIn("NotifySubstationDamage", SYNCHRONIZE_RUNTIME_STATE)
        self.assertNotIn("GetRemainingThreatsInWave", SYNCHRONIZE_RUNTIME_STATE)
        self.assertNotIn("GetSearchlightRuntime", SYNCHRONIZE_RUNTIME_STATE)
        self.assertNotIn("GetSubstationIntegrity", SYNCHRONIZE_RUNTIME_STATE)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", SYNCHRONIZE_RUNTIME_STATE)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", SYNCHRONIZE_RUNTIME_STATE)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 SynchronizeRuntimeState method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission05 SynchronizeRuntimeState contains "
    ...
    def test_leftover_handle_boss_phase_changed_does_not_satisfy(self) -> None:
        ...
        for token in LEFTOVER_HANDLE_BOSS_PHASE_CHANGED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, SYNCHRONIZE_RUNTIME_STATE)
        self.assertNotIn("HandleBossPhaseChanged", SYNCHRONIZE_RUNTIME_STATE)
