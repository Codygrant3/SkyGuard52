...
# THIS IS leftover-safe FSkyguardLandscapeFootprintSampleResult
# HeightDeltaCentimeters FIELD
# THIS IS NOT leftover FootprintSampleResult MaximumHeightCentimeters #1194.
# THIS IS NOT leftover FootprintSampleResult MinimumHeightCentimeters #1193.
# THIS IS NOT leftover FootprintSampleResult SupportedFraction #1192.
# THIS IS NOT leftover FootprintSampleResult MeanHeightCentimeters.
# THIS IS NOT leftover FootprintSampleResult Samples.
# THIS IS NOT leftover HeightSample HeightCentimeters #1187.
# THIS IS NOT leftover SampleLandscapeFootprint #627.
# LOCK leftover HeightSample Error #1188 script; do not edit it.
# Do not reopen leftover #536-#673, leftover Mission10 Integrity #826 /
# bDestroyed #827, leftover Mission05 #665 #666 #668-#673, or open drafts
# #674-#1194.
# THIS IS NOT leftover LandscapeHeightSample ValidSampleCount.
# THIS IS NOT leftover LandscapeHeightSample HeightCentimeters #1187.
# THIS IS NOT leftover LandscapeHeightSample HeightfieldSource #1186.
# THIS IS NOT leftover LandscapeHeightSample QueryLocation #1185.
...
# THIS IS NOT leftover FootprintSampleResult RequiredSampleCount #1190.
# THIS IS NOT leftover FootprintSampleResult ValidSampleCount #1191.
# THIS IS NOT leftover SampleLandscapeFootprint #627.
# THIS IS NOT leftover SampleLandscapeHeight #626.
# THIS IS NOT leftover landscape-footprint-sample-defaults #af83/#202.
# THIS IS NOT leftover landscape-height-sample-defaults #46a3/#200. (declaration-only; VisibleAnywhere /
# BlueprintReadOnly float HeightDeltaCentimeters = 0.f; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# Fail closed if the type or decl is missing, renamed, or
# Category= is added. Fail closed if the parse window
# includes FSkyguardLandscapeHeightSample. PARSE STRUCT public section only
# (after struct FSkyguardLandscapeFootprintSampleResult, before
# class USkyguardMission01LandscapeGroundingLibrary). Do NOT
# parse USkyguardMission01LandscapeGroundingLibrary. Do
# NOT parse ASkyguardMission01EnvironmentDirector.
# THIS IS NOT leftover SampleLandscapeHeight #626. THIS
# IS NOT leftover SampleLandscapeFootprint #627. THIS IS
# NOT leftover landscape-height-sample-defaults #46a3/#200.
# THIS IS NOT leftover landscape-footprint-sample-defaults
# #af83/#202. THIS IS NOT leftover LandscapeComponentCount
# #1176. LOCK leftover-safe LandscapeHeightSample bValid
# #1184 and QueryLocation #1185 siblings. LOCK leftover-safe sibling #1180
# bPCGGenerationAuthorized. LOCK leftover drafts #56-#64
# plus leftover enum/defaults PRs including leftover
# Mission01 environment-readiness-defaults #6b9d/#204. LOCK leftover Mission01 director OceanTiles #585 /
...
STRUCT_NAME = "FSkyguardLandscapeFootprintSampleResult"
CLASS_NAME = STRUCT_NAME
# THIS IS leftover-safe FSkyguardLandscapeFootprintSampleResult
# HeightDeltaCentimeters FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly float HeightDeltaCentimeters = 0.f; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# QueryLocation. THIS IS NOT leftover
...
# THIS IS leftover-safe FSkyguardLandscapeFootprintSampleResult
# HeightDeltaCentimeters FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# float HeightDeltaCentimeters = 0.f; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover Mission01 environment-readiness-defaults
...
# Do not reopen open drafts #674-#1194.
# THIS IS leftover-safe FSkyguardLandscapeFootprintSampleResult
# HeightDeltaCentimeters FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly float HeightDeltaCentimeters = 0.f; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# FSkyguardLandscapeFootprintSampleResult HeightDeltaCentimeters
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly float HeightDeltaCentimeters = 0.f;
...
# FSkyguardLandscapeFootprintSampleResult STRUCT
# public section only (after struct
# FSkyguardLandscapeFootprintSampleResult, before
...
# #b931, or private
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# QueryLocation. THIS IS NOT leftover mission-map-
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# QueryLocation. THIS IS NOT leftover Mission05
...
# merge #665 #666 #668-#673, or open drafts #674-#1194.
...
# Mission01 EnvironmentReadiness QueryLocation
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly float HeightDeltaCentimeters = 0.f;
# one-line / split-line UPROPERTY wraps;
# origin/main has NO Category) on
# FSkyguardMission01EnvironmentReadiness. It is
# leftover-safe FSkyguardLandscapeFootprintSampleResult
# HeightDeltaCentimeters FIELD (declaration-only). It is
...
# drafts #674-#1194 including leftover Mission02
...
# drafts #674-#1194. Do not reopen leftover
...
TARGET = "float HeightDeltaCentimeters = 0.f;"
TARGET_WRONG = "int32 HeightDeltaCentimeters = 0;"
LOCKED_DECL = TARGET
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_landscape_footprint_sample_required_sample_count_field_decl_contract.py",
    "Scripts/tests/test_landscape_footprint_sample_valid_sample_count_field_decl_contract.py",
    "Scripts/tests/test_landscape_footprint_sample_supported_fraction_field_decl_contract.py",
    "Scripts/tests/test_landscape_footprint_sample_minimum_height_centimeters_field_decl_contract.py",
    "Scripts/tests/test_landscape_footprint_sample_maximum_height_centimeters_field_decl_contract.py",
    "Scripts/tests/test_landscape_footprint_sample_mean_height_centimeters_field_decl_contract.py",
    "Scripts/tests/test_landscape_footprint_sample_samples_field_decl_contract.py",
...
def alternate_bool_defaults(declaration: str) -> tuple[str, ...]:
    ...
    if "= 0.f;" in declaration:
        forms.append(declaration.replace(" = 0.f;", ";"))
        forms.append(declaration.replace("= 0.f;", "= 0.0f;"))
        forms.append(declaration.replace("= 0.f;", "= 0.F;"))
    unique: list[str] = []
    for form in forms:
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*float\s+HeightDeltaCentimeters\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for float HeightDeltaCentimeters is missing from "
...
class LandscapeFootprintSampleHeightDeltaCentimetersFieldDeclContractTests(unittest.TestCase):
    def test_landscape_footprint_sample_result_struct_exists(self) -> None:
        ...
        self.assertIn("RequiredSampleCount", section)
        self.assertIn("ValidSampleCount", section)
        self.assertIn("HeightDeltaCentimeters", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("HeightDeltaCentimeters", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_height_delta_centimeters_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_height_delta_centimeters_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("float HeightDeltaCentimeters"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("HeightDeltaCentimeters", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("HeightDeltaCentimeters", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("float HeightDeltaCentimeters"))
    ...
    def test_contract_does_not_relock_leftover_environment_readiness(
        ...
        self.assertIn(
            "Scripts/tests/test_landscape_footprint_sample"
            "_required_sample_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_footprint_sample"
            "_valid_sample_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_footprint_sample"
            "_supported_fraction_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_footprint_sample"
            "_minimum_height_centimeters_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_footprint_sample"
            "_maximum_height_centimeters_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_footprint_sample"
            "_mean_height_centimeters_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_footprint_sample"
            "_samples_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_height_sample"
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("HeightDeltaCentimeters", locked_only)
    ...
    def test_contract_is_target_field_declaration_only(
        ...
        self.assertTrue(LOCKED_DECL.startswith("float HeightDeltaCentimeters"))
        self.assertIn("HeightDeltaCentimeters", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("0.f;"))
        self.assertTrue(LOCKED_DECL.endswith(";"))
        self.assertNotIn("GetProtectedGroup", LOCKED_DECL)
        self.assertNotIn("FSkyguardMission10ProtectedRuntime", LOCKED_DECL)
        self.assertIn(UPROPERTY_MISSION10, section)

    def test_sibling_director_fields_do_not_satisfy_height_delta_centimeters(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_landscape_footprint_sample"
            "_height_delta_centimeters_field_decl_contract.py"
        )
        leftover_valid = (
            "Scripts/tests/test_landscape_footprint_sample"
            "_valid_sample_count_field_decl_contract.py"
        ...
        self.assertIn(leftover_valid, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_landscape_footprint_sample"
                "_height_delta_centimeters_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_parser_does_not_land_on_anchors_or_director(self) -> None:
        ...
        match = CLASS_RE.search(header)
        self.assertIsNotNone(match, header)
        self.assertIn("FSkyguardLandscapeFootprintSampleResult", match.group(0))
        self.assertNotIn("FSkyguardLandscapeHeightSample", match.group(0))
