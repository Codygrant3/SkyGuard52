...
# Mission07 Waves GetRemainingThreatsInWave
# on ASkyguardMission07IntegrationDirector. It is
# NOT leftover Mission06 GetRemainingThreatsInWave
# #699, NOT leftover Mission05 GetRemainingThreatsInWave,
# NOT leftover Mission07 wave-state enum #74d8,
# NOT leftover objective-runtime fail-closed
# #6845, NOT leftover campaign GetObjectiveRuntime
# #313,
# NOT leftover Mission01 / Mission03 / Mission04
# GetObjectiveRuntime, NOT leftover env-readiness
...
# GetReadiness / IsCorePlayableReady /
# GetWaveState / GetObjectiveRuntime /
...
# Category is Skyguard|Mission07|Waves, not
# Integration, not Mission01 / Mission02 / Mission03 /
# Mission04 / Mission05 / Mission06 / Search /
...
# Waves, not leftover Harbor Mission02.
...
# an isolated Python GetRemainingThreatsInWave
# method declaration contract on
# ASkyguardMission07IntegrationDirector. It is
# NOT leftover Mission06 GetRemainingThreatsInWave #699,
# NOT leftover Mission05 GetRemainingThreatsInWave,
# and NOT leftover Mission07 wave-state enum #74d8.
LOCKED = {
...
class Mission07GetRemainingThreatsInWaveDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission07|Waves", UFUNCTION_WAVES)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        as_const = "\tUSkyguardObjectiveRuntime* GetRemainingThreatsInWave();\n"
        with_arg = "\tUSkyguardObjectiveRuntime* GetRemainingThreatsInWave(int32 Amount) const;\n"
        ...
        leftover_objective = f"\t{IS_CORE_PLAYABLE_READY}\n"
        ...
        leftover_remaining = f"\t{GET_OBJECTIVE_RUNTIME}\n"
    ...
    def test_get_remaining_threats_in_wave_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("ASkyguardMission06IntegrationDirector", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ESkyguardMission06WaveState", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ESkyguardMission07WaveState", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ESkyguardMission07ProtectedTarget", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("FSkyguardMission07ProtectedTargetRuntime", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ESkyguardSearchSector", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("FSkyguardSearchTrackRuntime", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ClassifyFalseTrack", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("ConfirmRadarGhostIdentification", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("NotifyProtectedTargetDamage", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("AdvanceReinforcementTimer", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetSearchSector", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetClassifiedFalseTrackCount", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("IsHostileContactConfirmed", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetProtectedTarget", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetReinforcementTimeRemaining", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetNightBeatKind", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("GetNightBeatIndex", GET_REMAINING_THREATS_IN_WAVE)
        self.assertNotIn("TickNightBeatKit", GET_REMAINING_THREATS_IN_WAVE)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardRadarGhostBoss", GET_REMAINING_THREATS_IN_WAVE)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 GetRemainingThreatsInWave method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission07 GetRemainingThreatsInWave contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission07_get_remaining_threats_in_wave"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_get_remaining_threats_in_wave"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission06_get_remaining_threats_in_wave_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_leftover_objective_runtime_fail_closed_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API USkyguardObjectiveRuntime "
            ": public UObject\n"
            "{\n"
            "public:\n"
            "\tvoid Reset();\n"
    ...
    def test_leftover_campaign_get_remaining_threats_in_wave_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API USkyguardCampaignSubsystem "
        ...
        self.assertIn("missing", str(raised.exception).lower())
        locked_only = f"{GET_REMAINING_THREATS_IN_WAVE}\n"
        for token in LEFTOVER_CAMPAIGN_GET_OBJECTIVE_RUNTIME_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_REMAINING_THREATS_IN_WAVE)
        self.assertIn(
            "Scripts/tests/test_get_objective_runtime_decl_contract.py",
