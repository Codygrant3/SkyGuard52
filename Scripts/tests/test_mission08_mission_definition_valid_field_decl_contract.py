...
# Mission08 IntegrationReadiness bMissionDefinitionValid
...
# (between struct FSkyguardMission07IntegrationReadiness
# and the following UCLASS /
# ASkyguardMission07IntegrationDirector; not
# ASkyguardMission07IntegrationDirector public
# fields already drafted through Root #1011 /
# CampaignSaveUserIndex #1022 / MissionDefinition #1017,
...
class Mission08MissionDefinitionValidFieldDeclContractTests(unittest.TestCase):
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 bMissionDefinitionValid contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_mission_definition"
                "_valid_field_decl_contract.py"
            )
        )
        self.assertIn(
