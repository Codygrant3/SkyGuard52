...
# Mission09 Briefing FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps) on
# ASkyguardMission09IntegrationDirector. It is
# NOT leftover Mission09 Root FIELD #1083 / branch
# cursor/mission09-root-field-decl-contract-c332,
# NOT leftover Mission09 SkylineAnchor FIELD #1084 /
# branch cursor/mission09-skyline-anchor-field-
# decl-contract-c332, NOT leftover Mission01-08/10
# Root, NOT leftover Mission01 Briefing #568, NOT
# leftover Mission02 Briefing #846, NOT leftover
# Mission03 Briefing #878, NOT leftover Mission04
# Briefing #910, NOT leftover Mission05 Briefing
# #949, NOT leftover Mission06 Briefing #980, NOT
# leftover Mission07 Briefing, NOT leftover
# Mission08 director Briefing #1050, NOT leftover
# Mission08 readiness-struct bBriefingReady #1076,
# NOT leftover Mission10 Briefing #795, NOT leftover
...
# methods.
# not leftover Mission09 Root / SkylineAnchor /
# PowerStationAnchor / MajorBridgeAnchor sibling
# director fields.
# not leftover AudioDirector /
...
# (including leftover-safe struct bBriefingReady if
# present), FSkyguardMission09ProtectedTargetRuntime,
...
# drafts #674-#1084, leftover Apache
...
# drafts #674-#1084 including leftover Mission03
...
# Root #1083 / SkylineAnchor #1084. This is NOT
# leftover Mission09 Root / SkylineAnchor, NOT
# leftover Mission01-08/10 director Briefing, NOT
# leftover Mission08 readiness-struct bBriefingReady
# #1076. This is leftover-safe Mission09 director
# Briefing. It is NOT leftover Mission09 Root,
...
class Mission09BriefingFieldDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_briefing = f"\t{SKYLINE_ANCHOR_FIELD}\n"
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertNotIn("SkylineAnchor", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 Briefing field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 Briefing field contains "
    ...
    def test_declaration_accepts_origin_main_default_forms(self) -> None:
        ...
        stem = "TObjectPtr<USkyguardMissionBriefingComponent> Briefing"
        ...
        self.assertEqual(LOCKED_DECL, "TObjectPtr<USkyguardMissionBriefingComponent> Briefing;")
