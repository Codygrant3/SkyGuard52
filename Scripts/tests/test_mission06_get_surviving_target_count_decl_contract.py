...
# Mission06 Targets GetSurvivingTargetCount on
# ASkyguardMission06IntegrationDirector. It is
# NOT leftover Mission05 GetSurvivingTargetCount
# #674, NOT leftover Mission05 GetRemainingThreatsInWave
...
# origin/main is a declaration-only method
...
# Mission05 / Integration / Payload / Waves /
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission06_handle_drone_city_impact_decl_contract.py",
    "Scripts/tests/test_mission06_bind_runtime_actors_decl_contract.py",
...
SIBLING_INTEGRATION_METHODS_NOT_LOCKED = (
    ...
    "test_mission06_get_payload_window_decl_contract.py",
    ...
    "test_mission06_handle_drone_city_impact_decl_contract.py",
    "test_mission06_bind_runtime_actors_decl_contract.py",
...
class Mission06GetSurvivingTargetCountDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        as_const = (
            "\tbool GetSurvivingTargetCount();\n"
        )
        with_arg = (
            "\tbool GetSurvivingTargetCount(int32 Amount) const;\n"
        )
    ...
    def test_get_surviving_target_count_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            GET_SURVIVING_TARGET_COUNT.endswith(";"),
            GET_SURVIVING_TARGET_COUNT,
        )
        self.assertIn("GetSurvivingTargetCount", GET_SURVIVING_TARGET_COUNT)
        self.assertIn("()", GET_SURVIVING_TARGET_COUNT)
        self.assertNotIn("ESkyguardAirfieldTarget Target", GET_SURVIVING_TARGET_COUNT)
        self.assertNotIn("int32 Damage", GET_SURVIVING_TARGET_COUNT)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_TARGETS} {GET_SURVIVING_TARGET_COUNT}\n"
            "};\n"
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 GetSurvivingTargetCount method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission06 GetSurvivingTargetCount contains "
    ...
    def test_contract_is_get_surviving_target_count_declaration_only(
        ...
        self.assertTrue(GET_SURVIVING_TARGET_COUNT.startswith("int32 "))
        self.assertIn("GetSurvivingTargetCount", GET_SURVIVING_TARGET_COUNT)
        self.assertTrue(GET_SURVIVING_TARGET_COUNT.endswith(";"))
        self.assertIn(UFUNCTION_TARGETS, section)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_get_surviving_target_count"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission01_get_surviving_target_count_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission01IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission03_get_surviving_target_count_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission04_get_surviving_target_count_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission04IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission05_get_surviving_target_count_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission05IntegrationDirector "
            ": public AActor\n"
            "{\n"
