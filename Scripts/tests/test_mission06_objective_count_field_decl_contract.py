...
# Mission06 IntegrationReadiness ObjectiveCount
...
# NOT leftover Mission01/07/08/09 ObjectiveCount
# same-name drafts,
...
# is ObjectiveCount after bCampaignRuntimeStarted. Skip leftover
...
class Mission06ObjectiveCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 ObjectiveCount field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission06 ObjectiveCount contains "
