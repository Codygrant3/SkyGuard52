...
class Mission07ReadinessFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("Skyguard|Mission05|Protection", UPROPERTY_MISSION07)
    ...
    def test_readiness_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FSkyguardMission07IntegrationReadiness "),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("Readiness", LOCKED_DECL)
        self.assertIn("FSkyguardMission07IntegrationReadiness", LOCKED_DECL)
    ...
    def test_contract_is_readiness_field_declaration_only(
        ...
        self.assertNotIn("return ", LOCKED_DECL)
        self.assertNotIn("{", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FSkyguardMission07IntegrationReadiness"))
        self.assertIn("Readiness", LOCKED_DECL)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_readiness_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_same_name_readiness_contracts_stay_locked(self) -> None:
        ...
        self.assertNotIn("EditAnywhere", UPROPERTY_MISSION07)
        self.assertNotIn("BlueprintReadWrite", UPROPERTY_MISSION07)
        self.assertIn("VisibleAnywhere", UPROPERTY_MISSION07)
        self.assertIn("BlueprintReadOnly", UPROPERTY_MISSION07)
