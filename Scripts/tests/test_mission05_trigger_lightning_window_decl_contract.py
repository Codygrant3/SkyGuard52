...
# INDEX_NONE or lock TriggerLightningWindow
# construction in the .cpp. This is leftover-safe
# Mission05 Storm TriggerLightningWindow METHOD
...
# isolated-test drafts #107–#667, leftover Apache
...
# TriggerLightningWindow method declaration
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission05IntegrationDirector::TriggerLightningWindow",
    "SkyguardMission05IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission05TriggerLightningWindowDeclContractTests(unittest.TestCase):
    def test_mission05_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, TRIGGER_LIGHTNING_WINDOW),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, TRIGGER_LIGHTNING_WINDOW)
        self.assertIn("TriggerLightningWindow", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, TRIGGER_LIGHTNING_WINDOW)
    ...
    def test_missing_trigger_lightning_window_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission05IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, TRIGGER_LIGHTNING_WINDOW)
        self.assertIn("TriggerLightningWindow", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, TRIGGER_LIGHTNING_WINDOW)
        self.assertIn("TriggerLightningWindow", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("BlueprintCallable", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("Category", TRIGGER_LIGHTNING_WINDOW)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, TRIGGER_LIGHTNING_WINDOW)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, TRIGGER_LIGHTNING_WINDOW)
        self.assertIn("TriggerLightningWindow", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = "\tvoid TriggerLightningWindow(float DurationSeconds);\n"
        as_const = "\tbool TriggerLightningWindow(float DurationSeconds) const;\n"
        with_arg = "\tbool TriggerLightningWindow(bool bForce);\n"
        renamed = "\tbool TriggerLightning();\n"
        short_name = "\tbool LightningWindow();\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, TRIGGER_LIGHTNING_WINDOW)
            self.assertIn("TriggerLightningWindow", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_trigger_lightning_window_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, TRIGGER_LIGHTNING_WINDOW),
            TRIGGER_LIGHTNING_WINDOW,
        )
        self.assertTrue(has_declaration(section, TRIGGER_LIGHTNING_WINDOW))
        self.assertEqual(
            declaration_count(section, TRIGGER_LIGHTNING_WINDOW),
            1,
        )
        self.assertTrue(
            TRIGGER_LIGHTNING_WINDOW.startswith("bool "),
            TRIGGER_LIGHTNING_WINDOW,
        )
        self.assertTrue(
            TRIGGER_LIGHTNING_WINDOW.endswith("(float DurationSeconds);"),
            TRIGGER_LIGHTNING_WINDOW,
        )
        self.assertIn("TriggerLightningWindow", TRIGGER_LIGHTNING_WINDOW)
        self.assertIn("DurationSeconds", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("TArray<", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("TObjectPtr", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("TSoftObjectPtr", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("INDEX_NONE", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("UFUNCTION", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("{", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("}", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("return ", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("const;", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("Root", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("Briefing", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("AudioDirector", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("RadioChatter", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("SortiePresentation", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("CampaignDefinition", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("MissionDefinition", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("Readiness", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("bAutoInitialize", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("bAllowBoundedActorSpawning", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("bAutoLaunchAfterBriefing", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("PathfinderSpawnLocation", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetAircraft", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("BindRuntimeActors", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("HandleDroneCityImpact", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("StartNextWave", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("NotifyThreatDestroyed", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("AdvanceConvoyByDistance", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("NotifyConvoyDamage", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetWaveState", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetConvoyRouteState", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetDayBeatKit", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetNightBeatKit", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("StartSearchlightWindow", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("AdvanceSearchlightTrack", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("NotifySubstationDamage", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetRemainingThreatsInWave", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetSearchlightRuntime", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetSubstationIntegrity", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("ConvoyRuntimeAnchor", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("RoadHunterSpawnLocation", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("ASkyguardMission02IntegrationDirector", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("ConfigureMissionDefinition", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("NotifyObjectiveProgress", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("NotifyProtectedAssetFailed", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("SynchronizeRuntimeState", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("IsCorePlayableReady", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetReadiness", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetObjectiveRuntime", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetGunner", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetPathfinder", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetMissionId", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("ValidateMissionContract", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("ConfigureFromMission", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("AdvanceBriefing", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("SetAssetsReady", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("AcknowledgeAndLaunch", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("CanLaunch", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetElapsedSeconds", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetBriefingState", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetMinimumWarmupSeconds", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetBriefingText", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetRadioChatter", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetPresentation", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetMissionTitle", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("AcknowledgeBriefing", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("LaunchSortie", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("HullCollider", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("OpticalTracker", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("WeaponServo", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("CountermeasurePod", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("MinHeightFromOriginCm", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("RadarNode", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("ESkyguardMission02WaveState", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("HarborIndustrial", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("MaxIntegrity", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("CurrentIntegrity", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("FillAndFinalize", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("FillAndFail", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("static ", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("InitializePlayableMission", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("ConfigureMissionDefinition", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("AdvanceLightningWindow", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("AdvanceTurbulence", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetStormRuntime", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("HandleBossPhaseChanged", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("NotifyProtectedTargetDamage", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetProtectedTarget", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetSurvivingTargetCount", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("GetStormRainBeatKit", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("ESkyguardMission05WaveState", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("ESkyguardMission05ProtectedTarget", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("FSkyguardStormRuntime", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("WindowSeconds", TRIGGER_LIGHTNING_WINDOW)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, TRIGGER_LIGHTNING_WINDOW)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tbool\n"
            "\tTriggerLightningWindow(float DurationSeconds);\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_STORM} {TRIGGER_LIGHTNING_WINDOW}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{TRIGGER_LIGHTNING_WINDOW}\n}}\n"
        self.assertTrue(has_declaration(one_line, TRIGGER_LIGHTNING_WINDOW))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, TRIGGER_LIGHTNING_WINDOW),
            section,
    ...
    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        locked_only = f"{TRIGGER_LIGHTNING_WINDOW}\n"
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, TRIGGER_LIGHTNING_WINDOW)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", TRIGGER_LIGHTNING_WINDOW)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_trigger_lightning_window_cpp_body(self) -> None:
        locked_only = f"{TRIGGER_LIGHTNING_WINDOW}\n"
        self.assertNotIn("{", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("}", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("return ", TRIGGER_LIGHTNING_WINDOW)
        ...
        self.assertNotIn("return false", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("return true", TRIGGER_LIGHTNING_WINDOW)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{TRIGGER_LIGHTNING_WINDOW}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, TRIGGER_LIGHTNING_WINDOW)
        self.assertIn("TriggerLightningWindow", TRIGGER_LIGHTNING_WINDOW)
        self.assertTrue(TRIGGER_LIGHTNING_WINDOW.startswith("bool "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, TRIGGER_LIGHTNING_WINDOW)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("CurrentIntegrity", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("SkyguardApacheAircraft.h", TRIGGER_LIGHTNING_WINDOW)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", TRIGGER_LIGHTNING_WINDOW)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{TRIGGER_LIGHTNING_WINDOW}\n"
        self.assertEqual(
            require_declaration(locked_only, TRIGGER_LIGHTNING_WINDOW),
            TRIGGER_LIGHTNING_WINDOW,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, TRIGGER_LIGHTNING_WINDOW)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", TRIGGER_LIGHTNING_WINDOW)
        self.assertNotIn("ASkyguardIronRainBoss", section)
        self.assertNotIn("ASkyguardRadarGhostBoss", section)
        self.assertNotIn("ASkyguardTempestBoss", TRIGGER_LIGHTNING_WINDOW)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 TriggerLightningWindow method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{TRIGGER_LIGHTNING_WINDOW}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, TRIGGER_LIGHTNING_WINDOW.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                TRIGGER_LIGHTNING_WINDOW.lower(),
                "mission05 TriggerLightningWindow contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, TRIGGER_LIGHTNING_WINDOW)

    def test_contract_is_trigger_lightning_window_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(TRIGGER_LIGHTNING_WINDOW.startswith("bool "))
        self.assertIn("TriggerLightningWindow", TRIGGER_LIGHTNING_WINDOW)
        self.assertTrue(TRIGGER_LIGHTNING_WINDOW.endswith(";"))
        self.assertIn(UFUNCTION_STORM, section)

    def test_sibling_director_fields_do_not_satisfy_trigger_lightning_window(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, TRIGGER_LIGHTNING_WINDOW)
            )
            self.assertNotEqual(TRIGGER_LIGHTNING_WINDOW, leftover)
        self.assertIn(
    ...
    def test_leftover_handle_drone_city_impact_does_not_satisfy(self) -> None:
        ...
        self.assertIn("TriggerLightningWindow", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, TRIGGER_LIGHTNING_WINDOW))
        locked_only = f"{TRIGGER_LIGHTNING_WINDOW}\n"
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tbool TriggerLightningWindow(float DurationSeconds) { return false; }\n"
            "};\n"
        )
