...
# Mission07 Integration GetMissionId METHOD on
# ASkyguardMission07IntegrationDirector. It is
# NOT leftover Mission06 GetMissionId #704, NOT
# leftover Mission06 ValidateMissionContract #707,
# NOT leftover ValidateMissionContract, NOT leftover
# GetNightBeatKit without UFUNCTION, NOT leftover
# Mission07 protected-target enum #18f2, NOT leftover
# Mission07 protected-target-runtime defaults #866c,
# NOT leftover Mission05 GetProtectedTarget, NOT
# leftover Mission07 GetProtectedTarget, NOT leftover
# Mission07 GetSearchSector, NOT leftover Mission07
# GetReadiness, NOT leftover env-readiness
...
# fields / retired-mount spawn names, NOT leftover
...
# GetSurvivingTargetCount / GetProtectedTarget /
...
# Category is Skyguard|Mission07|Integration, not
# Mission01 / Mission02 / Mission03 / Mission04 /
# Mission05 / Mission06 / Waves / Protection /
...
# drafts #674–#724, leftover Apache
...
# #658–#673. Do not reopen open drafts #674–#724.
# Do not reopen leftover Mission06 GetMissionId
# #704. Do not reopen leftover Mission06
# ValidateMissionContract #707.
...
class Mission07GetMissionIdDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission07|Integration", UFUNCTION_INTEGRATION)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_m05_type = (
            'static FName GetMissionId() { return TEXT("M05_StormCrossing"); }\n'
        )
        leftover_m04_type = (
            'static FName GetMissionId() { return TEXT("M04_NightEyes"); }\n'
        )
        leftover_m01_type = (
            'static FName GetMissionId() { return TEXT("M01_CoastalIntercept"); }\n'
        )
        leftover_env_type = (
            "\tstatic FName GetMissionId() const;\n"
        )
        ...
        leftover_mission_id = f"\t{GET_PROTECTED_TARGET}\n"
    ...
    def test_get_mission_id_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("FSkyguardMission07IntegrationReadiness", GET_MISSION_ID)
    ...
    def test_contract_does_not_lock_get_mission_id_cpp_body(self) -> None:
        ...
        self.assertIn("}", GET_MISSION_ID)
        self.assertIn("return ", GET_MISSION_ID)
        self.assertIn('TEXT("M07_SearchIntercept")', GET_MISSION_ID)
        self.assertNotIn(
            "ASkyguardMission07IntegrationDirector::GetMissionId",
            GET_MISSION_ID,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 GetMissionId method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission07 GetMissionId contains "
    ...
    def test_leftover_environment_get_mission_id_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_contract_does_not_relock_leftover_mission06_validate(
        self,
    ) -> None:
        locked_only = f"{GET_MISSION_ID}\n"
        for token in LEFTOVER_MISSION06_VALIDATE_MISSION_CONTRACT_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_MISSION_ID)
        self.assertIn(
    ...
    def test_locked_scripts_list_sibling_mission07_contracts(self) -> None:
        sibling_scripts = (
            "Scripts/tests/test_mission07_get_protected_target"
            "_decl_contract.py",
    ...
    def test_contract_does_not_relock_leftover_search_sector(self) -> None:
        ...
        self.assertNotIn("ESkyguardSearchSector", UFUNCTION_INTEGRATION)
        self.assertNotIn("Search", UFUNCTION_INTEGRATION)
        self.assertNotIn("Protection", UFUNCTION_INTEGRATION)
