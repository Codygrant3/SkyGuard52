...
CLASS_NAME = "ASkyguardMission05IntegrationDirector"
...
# Mission05 Objectives NotifyProtectedAssetFailed
# METHOD on ASkyguardMission05IntegrationDirector. It is
...
# Harbor Mission02 / Harbor #6/#8/#9, NOT leftover
# Mission05 wave-state enum #ad28, leftover
# Mission05 protected-target enum #aaa2, leftover
# Mission05 protected-target-runtime-defaults #ec8b,
# leftover storm-runtime-defaults #89c9 struct,
# leftover HandleBossPhaseChanged without Blueprint
# category, leftover searchlight-track-runtime-defaults
# #7347 (do not lock GetSearchlightRuntime). Distinct
# from leftover Mission05 NotifyThreatDestroyed #669
# / StartNextWave #668. Distinct from leftover
# Mission05 protected-target enum #aaa2 and leftover
# protected-target-runtime-defaults #ec8b
# (enum/struct contracts, not this method). Distinct
# from leftover Mission03 NotifyThreatDestroyed and
# leftover Mission04 NotifyThreatDestroyed #651.
# Distinct from leftover Mission05
# InitializePlayableMission #666 /
# ConfigureMissionDefinition #665. Distinct from
...
# lock sibling Integration / Waves / Storm /
# Protection / Objectives methods
...
# GetNightBeatKit / TriggerLightningWindow /
# AdvanceLightningWindow / AdvanceTurbulence /
# GetStormRuntime /
# GetProtectedTarget / GetSurvivingTargetCount /
# GetStormRainBeatKit. Do not lock leftover
# Mission01 GetGunner / GetPathfinder. Do not
...
# #648, leftover Mission03 NotifyThreatDestroyed,
# leftover Mission04 NotifyThreatDestroyed #651,
# leftover Mission05 InitializePlayableMission
# #666, leftover Mission05
# ConfigureMissionDefinition #665, leftover
...
# class section of
# ASkyguardMission05IntegrationDirector only.
# Category is Skyguard|Mission05|Objectives, not
# Protection, not Integration, not Waves, not Storm, not
...
# Mission03 Waves, not leftover Mission04 Waves
# #651, not leftover Mission05 Waves #669, not
# leftover Mission05 Protection #673, not leftover
# Harbor Mission02 Integration. Distinct from leftover
# Mission01 / Mission03 / Mission04
# NotifyProtectedAssetFailed #655. Do not
# lock leftover enum values of
# ESkyguardMission05ProtectedTarget (#aaa2).
# Stay off leftover drafts #56–#64, leftover Harbor
# #6/#8/#9, leftover theater-kit #59, leftover
# isolated-test drafts #107–#673, skip leftover #664,
# do not reopen leftover #536–#673, closed #668/#669, leftover Apache
...
# Mission05IntegrationDirector public section and
...
# Mission05 wave-state enum #ad28.
...
TRIGGER_LIGHTNING_WINDOW = (
    "bool TriggerLightningWindow(float DurationSeconds);"
)
ADVANCE_LIGHTNING_WINDOW = "bool AdvanceLightningWindow(float DeltaSeconds);"
ADVANCE_TURBULENCE = (
    "bool AdvanceTurbulence("
    "float DeltaSeconds, float Turbulence, bool bMaintainingAim);"
)
NOTIFY_PROTECTED_TARGET_DAMAGE = (
    "bool NotifyProtectedTargetDamage("
    "ESkyguardMission05ProtectedTarget Target, int32 Damage);"
)
GET_STORM_RUNTIME = (
...
TEMPEST_SPAWN_LOCATION = "FVector TempestSpawnLocation;"
TEMPEST_SPAWN_ROTATION = "FRotator TempestSpawnRotation;"
...
# SkyguardMission05IntegrationDirector production
# files. This lane only adds an isolated Python
# NotifyProtectedAssetFailed method declaration
# contract on ASkyguardMission05IntegrationDirector.
# Distinct from leftover Mission01/Mission03/Mission04
# NotifyProtectedAssetFailed #655.
LOCKED = {
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission05_trigger_lightning_window_decl_contract.py",
    "Scripts/tests/test_mission05_advance_lightning_window_decl_contract.py",
    "Scripts/tests/test_mission05_advance_turbulence_decl_contract.py",
    ...
    "Scripts/tests/test_mission05_get_storm_runtime_decl_contract.py",
...
SIBLING_INTEGRATION_METHODS_NOT_LOCKED = (
    ...
    GET_STORM_RAIN_BEAT_KIT,
    "TriggerLightningWindow",
    "AdvanceLightningWindow",
    "AdvanceTurbulence",
    "NotifyThreatDestroyed",
    "GetStormRuntime",
    "GetProtectedTarget",
...
LEFTOVER_SPAWN_FIELDS_NOT_LOCKED = (
    ...
    TEMPEST_SPAWN_LOCATION,
    TEMPEST_SPAWN_ROTATION,
)
...
LEFTOVER_MISSION03_NOTIFY_THREAT_DESTROYED_NOT_LOCKED = (
...
LEFTOVER_MISSION05_NOTIFY_PROTECTED_TARGET_DAMAGE_NOT_LOCKED = (
    "test_mission05_notify_protected_target_damage_decl_contract.py",
...
LEFTOVER_MISSION03_INITIALIZE_NOT_LOCKED = (
    ...
    'Category="Skyguard|Mission04|Integration"',
    'Category="Skyguard|Mission05|Storm"',
    'Category="Skyguard|Mission05|Waves"',
)
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission05IntegrationDirector::NotifyProtectedAssetFailed",
    "SkyguardMission05IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission05NotifyProtectedAssetFailedDeclContractTests(unittest.TestCase):
    ...
    def test_missing_notify_protected_asset_failed_declaration_fails_closed(self) -> None:
        neighbors_only = (
            ...
            f"\t{NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission05|Objectives", UFUNCTION_OBJECTIVES)
        ...
        self.assertNotIn("Searchlight", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Substation", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Protection", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Storm", UFUNCTION_OBJECTIVES)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        as_int = "\tint32 NotifyProtectedAssetFailed();\n"
        with_arg = "\tbool NotifyProtectedAssetFailed(int32 Amount = 1);\n"
        no_default = "\tbool NotifyProtectedAssetFailed(int32 Amount);\n"
        leftover_objective_shape = (
            "\tbool NotifyProtectedAssetFailed("
            "FName ObjectiveId, int32 Amount = 1);\n"
        )
        leftover_target_damage = f"\t{NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
        leftover_threat_shape = (
            "\tbool NotifyThreatDestroyed(int32 Amount = 1);\n"
        )
        leftover_enum_value = (
            "\tbool NotifyProtectedAssetFailed("
        ...
        leftover_failed = f"\t{NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
        ...
        leftover_lightning = f"\t{TRIGGER_LIGHTNING_WINDOW}\n"
        leftover_advance_lightning = f"\t{ADVANCE_LIGHTNING_WINDOW}\n"
        leftover_turbulence = f"\t{ADVANCE_TURBULENCE}\n"
        leftover_storm = f"\t{GET_STORM_RUNTIME}\n"
        leftover_surviving = f"\t{GET_SURVIVING_TARGET_COUNT}\n"
        leftover_boss = "\tvoid HandleBossPhaseChanged();\n"
        for region in (
            as_void,
            as_const,
            as_int,
    ...
    def test_notify_protected_asset_failed_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("int32 Amount", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("int32 Damage", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn(
            "ESkyguardMission05ProtectedTarget",
            NOTIFY_PROTECTED_ASSET_FAILED,
        )
        self.assertNotIn("int32 Amount = 1", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("FName ObjectiveId", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("OffshorePlatform", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("DistressedTrawler", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn(
            "NotifyThreatDestroyed",
            NOTIFY_PROTECTED_ASSET_FAILED,
        )
        self.assertNotIn("static ", NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_environment_category_does_not_satisfy_objectives(self) -> None:
        ...
        leftover_m04_integration = (
            'UFUNCTION(BlueprintCallable, '
            'Category="Skyguard|Mission04|Integration")'
        )
        leftover_m05_integration = (
            'UFUNCTION(BlueprintCallable, '
            'Category="Skyguard|Mission05|Integration")'
        )
        leftover_m05_waves = (
        ...
        leftover_m05_protection = (
            'UFUNCTION(BlueprintCallable, '
            'Category="Skyguard|Mission05|Protection")'
        )
        leftover_m04_objectives = (
            'UFUNCTION(BlueprintCallable, '
            'Category="Skyguard|Mission04|Objectives")'
        )
        leftover_m03_objectives = (
            'UFUNCTION(BlueprintCallable, '
            'Category="Skyguard|Mission03|Objectives")'
        )
        leftover_m01_objectives = (
            'UFUNCTION(BlueprintCallable, '
            'Category="Skyguard|Mission01|Objectives")'
        )
        ...
        self.assertNotEqual(leftover_m03_waves, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m04_waves, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m04_integration, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m05_integration, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m05_waves, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m05_storm, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m05_protection, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m04_objectives, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m03_objectives, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m01_objectives, UFUNCTION_OBJECTIVES)
        ...
        self.assertNotIn(leftover_m03_waves, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m04_waves, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m04_integration, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m05_integration, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m05_waves, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m05_storm, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m05_protection, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m04_objectives, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m03_objectives, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m01_objectives, UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission01", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission03", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission04", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Integration", UFUNCTION_OBJECTIVES)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertNotIn("NotifyProtectedTargetDamage", locked_only)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardTempestBoss", NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 NotifyProtectedAssetFailed method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission05 NotifyProtectedAssetFailed contains "
    ...
    def test_leftover_mission03_notify_threat_destroyed_does_not_satisfy(self) -> None:
        leftover = (
        ...
        for token in LEFTOVER_MISSION03_NOTIFY_THREAT_DESTROYED_NOT_LOCKED:
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)

    def test_leftover_mission04_notify_threat_destroyed_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_leftover_mission01_notify_protected_asset_failed_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission01IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission03_notify_protected_asset_failed_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission04_notify_protected_asset_failed_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission04IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_handle_boss_phase_changed_does_not_satisfy(self) -> None:
        region = "\tvoid HandleBossPhaseChanged(\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(region, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn("NotifyProtectedAssetFailed", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_wave_state_enum"
            "_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_protected_target_runtime_defaults"
            "_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_bind_runtime_actors"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_trigger_lightning_window"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission05_advance_lightning_window"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission05_advance_turbulence"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )

    def test_leftover_mission05_notify_threat_destroyed_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
    ...
    def test_leftover_mission05_notify_protected_target_damage_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission05IntegrationDirector "
        ...
        for token in LEFTOVER_MISSION05_NOTIFY_PROTECTED_TARGET_DAMAGE_NOT_LOCKED:
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)

    def test_leftover_mission05_start_next_wave_does_not_satisfy(self) -> None:
        region = f"\t{START_NEXT_WAVE}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(region, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn("NotifyProtectedAssetFailed", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_leftover_protected_target_enum_values_are_not_locked(
        self,
    ) -> None:
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        for token in (
