...
# in the .cpp. This is leftover-safe Mission06
# Waves StartNextWave on
# ASkyguardMission06IntegrationDirector. It is
# NOT leftover Mission05 StartNextWave #668,
# NOT leftover Mission03 / Mission04
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission06IntegrationDirector::StartNextWave",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission06StartNextWaveDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 StartNextWave method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission06 StartNextWave contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_start_next_wave"
                "_decl_contract.py"
            )
        )
        self.assertIn(
