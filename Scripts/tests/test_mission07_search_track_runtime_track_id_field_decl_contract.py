...
# TrackId FIELD (declaration-only;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission07 SearchTrackRuntime
# TrackId FIELD. THIS IS NOT leftover search-track-
...
# bActive #1130 / CoveredSeconds #1131. LOCK leftover
...
class Mission07SearchTrackRuntimeTrackIdFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("TrackId", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_active_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FName TrackId"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= NAME_None;"), LOCKED_DECL)
        ...
        self.assertIn("TrackId", LOCKED_DECL)
        self.assertNotIn("ESkyguardMission09ProtectedTarget ", LOCKED_DECL)
        self.assertIn("= NAME_None", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("TrackId", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FName TrackId"))
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 TrackId field contract "
    ...
    def test_contract_is_active_field_declaration_only(
        ...
        self.assertTrue(LOCKED_DECL.startswith("FName TrackId"))
        self.assertIn("TrackId", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("= NAME_None;"))
