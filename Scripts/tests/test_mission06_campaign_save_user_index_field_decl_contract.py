...
# int32 default 0) on
# ASkyguardMission06IntegrationDirector. Note
...
# Category is Skyguard|Mission06|Campaign, not
...
UPROPERTY_MISSION06_CLAMP = 'meta=(ClampMin="0")'
...
class Mission06CampaignSaveUserIndexFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn("Campaign", UPROPERTY_MISSION06)
        self.assertIn("Skyguard|Mission06|Campaign", UPROPERTY_MISSION06)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 CampaignSaveUserIndex field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission06 CampaignSaveUserIndex field contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_campaign_save_user_index_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
