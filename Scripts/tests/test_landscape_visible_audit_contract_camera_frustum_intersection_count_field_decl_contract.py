...
# ContractCameraFrustumIntersectionCount FIELD
...
# NO Category). Fail closed if the type or decl is missing,
# renamed, or Category= is added.
# THIS IS leftover-safe FSkyguardLandscapeVisibleAudit
# ContractCameraFrustumIntersectionCount. THIS IS NOT
# leftover Mission01 EnvironmentReadiness
# LandscapeComponentCount #1176. THIS IS NOT leftover
# landscape-visible-audit-defaults #0bce. THIS IS NOT
# leftover VisibleAudit #1199-#1206 (bSuccess /
# LandscapeComponentCount / VisibleComponentCount /
...
# GovernedMaterialParentMatchComponentCount). LOCK
# leftover VisibleAudit sibling scripts; do not edit
# them. LOCK leftover landscape-visible-
# audit-defaults #0bce. LOCK leftover Mission01
...
# THIS IS leftover-safe FSkyguardLandscapeVisibleAudit
# ContractCameraFrustumIntersectionCount FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# int32 ContractCameraFrustumIntersectionCount = 0; one-line /
...
# LandscapeComponentCount #1176.
# LOCK leftover-safe VisibleAudit bSuccess sibling.
# LOCK leftover-safe VisibleAudit LandscapeComponentCount sibling.
# LOCK in-flight VisibleComponentCount / RegisteredComponentCount
# scripts; do not edit them.
# LOCK leftover drafts #56-#64 plus leftover enum/defaults PRs
# including leftover landscape-footprint-sample-defaults
...
# Do not reopen leftover #536-#673, leftover Mission10
# Integrity #826 / bDestroyed #827, leftover Mission05
# #665 #666 #668-#673, or open drafts #674-#1200.
...
TARGET = "int32 ContractCameraFrustumIntersectionCount = 0;"
TARGET_WRONG = "float ContractCameraFrustumIntersectionCount = 0;"
LOCKED_DECL = TARGET
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*int32\s+ContractCameraFrustumIntersectionCount\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for int32 ContractCameraFrustumIntersectionCount is missing from "
...
class LandscapeVisibleAuditContractCameraFrustumIntersectionCountFieldDeclContractTests(unittest.TestCase):
    def test_landscape_visible_audit_struct_exists(self) -> None:
        ...
        self.assertIn("ContractCameraFrustumIntersectionCount", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("ContractCameraFrustumIntersectionCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_contract_camera_frustum_intersection_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_contract_camera_frustum_intersection_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 ContractCameraFrustumIntersectionCount"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("ContractCameraFrustumIntersectionCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("ContractCameraFrustumIntersectionCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 ContractCameraFrustumIntersectionCount"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("ContractCameraFrustumIntersectionCount", locked_only)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_landscape_visible_audit"
            "_contract_camera_frustum_intersection_count_field_decl_contract.py"
        )
