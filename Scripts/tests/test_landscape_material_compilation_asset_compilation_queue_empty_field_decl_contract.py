...
# bAssetCompilationQueueEmpty. THIS IS NOT leftover
# landscape-material-compilation-defaults #01d4. THIS IS NOT leftover
# landscape-capture-config-defaults #d6fd. THIS IS NOT leftover
# mission01-environment-authoring-result-defaults #df1a. THIS IS NOT
# leftover CaptureConfigurationResult public UPROPERTY #1214-#1224.
# THIS IS NOT leftover MaterialCompilation bSuccess #1223 /
...
# THIS IS NOT leftover CaptureConfig fields. THIS IS NOT leftover
# VisibleAudit fields. LOCK leftover landscape-material-compilation-defaults
# #01d4. LOCK leftover landscape-capture-config-defaults #d6fd. LOCK leftover
# mission01-environment-authoring-result-defaults #df1a. LOCK leftover
# CaptureConfigurationResult public UPROPERTY #1214-#1224. LOCK leftover
# MaterialCompilation bSuccess #1223 / LandscapeComponentCount #1227 /
# GeneratedMaterialInstanceCount #1225 / MaterialResourceCount #1226 /
# CompilationFinishedResourceCount #1228. LOCK leftover drafts #56-#64
# plus leftover enum/defaults PRs.
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# bAssetCompilationQueueEmpty FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# bool bAssetCompilationQueueEmpty = false; one-line /
...
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# bAssetCompilationQueueEmpty. THIS IS NOT leftover VisibleAudit
...
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# bAssetCompilationQueueEmpty. THIS IS NOT leftover VisibleAudit bSuccess #1199.
...
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# bAssetCompilationQueueEmpty FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bAssetCompilationQueueEmpty = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# BlueprintReadOnly bool bAssetCompilationQueueEmpty = false;
...
TARGET = "bool bAssetCompilationQueueEmpty = false;"
TARGET_WRONG = "bool bAssetCompilationQueueEmpty = true;"
LOCKED_DECL = TARGET
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*bool\s+bAssetCompilationQueueEmpty\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for bool bAssetCompilationQueueEmpty is missing from "
...
class LandscapeMaterialCompilationAssetCompilationQueueEmptyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bAssetCompilationQueueEmpty", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_asset_compilation_queue_empty_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_asset_compilation_queue_empty_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bAssetCompilationQueueEmpty"),
            LOCKED_DECL,
        )
        ...
        self.assertFalse(
            has_declaration(
                "\tbool bAssetCompilationQueueEmpty = true;\n",
                LOCKED_DECL,
            )
        )
        with self.assertRaises(AssertionError) as raised:
        ...
        self.assertIn("bAssetCompilationQueueEmpty", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bAssetCompilationQueueEmpty", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bAssetCompilationQueueEmpty"))
    ...
    def test_sibling_director_fields_do_not_satisfy_asset_compilation_queue_empty(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
