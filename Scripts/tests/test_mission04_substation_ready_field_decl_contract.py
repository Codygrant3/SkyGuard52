...
# INDEX_NONE or lock bSubstationReady
# construction in the .cpp. This is leftover-safe
# Mission04 IntegrationReadiness bSubstationReady
...
# director field #925 / branch cursor/mission04-
# maximum-substation-integrity-field-decl-
# contract-c332, NOT leftover Mission04
# GetSubstationIntegrity / NotifySubstationDamage
# method contracts, NOT leftover Mission04
# bObjectivesReady sibling / branch cursor/
# mission04-objectives-ready-field-decl-
# contract-c332,
...
# director fields through Readiness #926,
...
SUBSTATION_READY_TRUE = (
    "bool bSubstationReady = true;"
)
LOCKED_DECL = SUBSTATION_READY
...
# an isolated Python bSubstationReady
...
class Mission04SubstationReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bSubstationReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_substation_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_substation_ready_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bSubstationReady"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bSubstationReady", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bSubstationReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bSubstationReady"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bSubstationReady", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 bSubstationReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 bSubstationReady contains "
    ...
    def test_contract_is_substation_ready_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_maximum_substation"
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_campaign_definition_valid"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission04_mission_definition_valid"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
