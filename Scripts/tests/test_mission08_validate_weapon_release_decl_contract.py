...
# Mission08 Safety ValidateWeaponRelease METHOD
# on ASkyguardMission08IntegrationDirector. It is
# NOT leftover StartHoistWindow, NOT leftover
# hoist-window-runtime-defaults
# #ec79, NOT leftover AdvanceHoistWindow, NOT
# leftover BindRuntimeActors (retired live mount), NOT leftover
# Mission07 StartNextWave #708, NOT leftover
...
# UFUNCTION. Do not lock leftover StartHoistWindow
# as a sibling decl in THIS test. Do not lock
# leftover AdvanceHoistWindow. Do not lock
...
# Do not reopen open drafts #674–#732.
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission08IntegrationDirector::ValidateWeaponRelease",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission08ValidateWeaponReleaseDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("Mission10", UFUNCTION_SAFETY)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        as_const = "\tbool ValidateWeaponRelease(float FriendlySeparationMeters, bool bShotIntersectsFriendlyCorridor) const;\n"
        with_arg = "\tbool ValidateWeaponRelease();\n"
        renamed = "\tbool ValidateRelease();\n"
        short_name = "\tbool StartNextWave();\n"
        leftover_hoist_window = f"\t{START_HOIST_WINDOW}\n"
    ...
    def test_initialize_declaration_matches_origin_main(self) -> None:
        ...
        self.assertIn("float FriendlySeparationMeters", VALIDATE_WEAPON_RELEASE)
        self.assertIn(
            "bool bShotIntersectsFriendlyCorridor",
            VALIDATE_WEAPON_RELEASE,
        )
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_spaces = (
            "public:\n"
            "\tbool   ValidateWeaponRelease(float FriendlySeparationMeters, bool bShotIntersectsFriendlyCorridor);\n"
            "private:\n"
            "};\n"
        )
        wrap_tab = (
    ...
    def test_environment_category_does_not_satisfy_safety(self) -> None:
        ...
        self.assertNotEqual(leftover_m05_waves, UFUNCTION_SAFETY)
        self.assertNotEqual(leftover_integration, UFUNCTION_SAFETY)
        self.assertNotEqual(leftover_m07_waves, UFUNCTION_SAFETY)
        self.assertNotEqual(leftover_waves_m08, UFUNCTION_SAFETY)
        ...
        self.assertNotIn(leftover_m05_waves, UFUNCTION_SAFETY)
        self.assertNotIn(leftover_integration, UFUNCTION_SAFETY)
        self.assertNotIn(leftover_m07_waves, UFUNCTION_SAFETY)
        self.assertNotIn(leftover_waves_m08, UFUNCTION_SAFETY)
        self.assertNotIn(leftover_hoist, UFUNCTION_SAFETY)
        self.assertNotIn("Mission01", UFUNCTION_SAFETY)
        self.assertNotIn("Mission03", UFUNCTION_SAFETY)
        self.assertNotIn("Mission04", UFUNCTION_SAFETY)
        self.assertNotIn("Mission05", UFUNCTION_SAFETY)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 ValidateWeaponRelease method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission08 ValidateWeaponRelease contains "
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            ...
            "\tbool ValidateWeaponRelease("
            "float FriendlySeparationMeters, "
            "bool bShotIntersectsFriendlyCorridor) { return false; }\n"
            "};\n"
        )
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_validate_weapon_release"
                "_decl_contract.py"
            )
        )
        self.assertIn(
