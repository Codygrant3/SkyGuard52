...
# Mission08 Integration IsCorePlayableReady METHOD
# on ASkyguardMission08IntegrationDirector. It is
# NOT leftover Mission07 IsCorePlayableReady
# #715, NOT leftover BindRuntimeActors (retired
# live mount), NOT leftover GetReadiness, NOT leftover
# Mission06 IsCorePlayableReady
# #696, NOT leftover Mission05 IsCorePlayableReady,
# NOT leftover Mission01 / Mission03 / Mission04
# IsCorePlayableReady, NOT leftover env-readiness
# #6b9d/#b931, NOT leftover Mission08
# NotifyThreatDestroyed, NOT leftover Mission08
...
# Mission07 protected-target-runtime
...
# drafts #674–#735, leftover Apache
...
# protected-target-runtime-defaults #75e6 / #226,
# leftover hoist-window-runtime-defaults #ec79.
# Do not reopen open drafts #674–#735.
...
class Mission08IsCorePlayableReadyDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 IsCorePlayableReady method contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_is_core_playable_ready"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_is_core_playable_ready"
                "_decl_contract.py"
            )
        )
        self.assertIn(
