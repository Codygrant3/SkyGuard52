...
# only. It is NOT leftover same-name Mission05
# MaximumProtectedTargetIntegrity #961 / branch
# cursor/mission05-maximum-protected-target-
...
# RadarGhostSpawnRotation / ReinforcementDeadlineSeconds
...
UPROPERTY_MISSION07_CLAMP = 'meta=(ClampMin="1")'
...
class Mission07MaximumProtectedTargetIntegrityFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 MaximumProtectedTargetIntegrity field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission07 MaximumProtectedTargetIntegrity contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_maximum_protected_target_integrity_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission07_sibling_field_contracts_stay_locked(
        ...
        self.assertNotIn("ReinforcementDeadlineSeconds", locked_only)
        self.assertNotIn("ReinforcementDeadlineSeconds", LOCKED_DECL)
        self.assertNotIn("CampaignSaveSlotName", LOCKED_DECL)
