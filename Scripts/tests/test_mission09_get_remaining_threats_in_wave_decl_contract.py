...
# Mission09 Waves GetRemainingThreatsInWave
# METHOD (inline body) on
# ASkyguardMission09IntegrationDirector.
# It is NOT leftover Mission08
# GetRemainingThreatsInWave #742 / branch
# cursor/mission08-get-remaining-threats-in-wave-
# decl-contract-c332, NOT leftover Mission07
# GetRemainingThreatsInWave #721, NOT leftover
# Mission06 GetRemainingThreatsInWave #699, NOT
# leftover Mission05 GetRemainingThreatsInWave
# #677, NOT leftover closed Mission04
# GetRemainingThreatsInWave #662 / Mission03
# #639, NOT leftover Mission08 GetWaveState #741,
# NOT leftover Mission07 GetWaveState #719 /
# Mission06 #701 / Mission05 #676, NOT leftover
# Mission09 wave-state enum #20fc / #238, NOT
# leftover Mission09 GetWaveState if already
# drafted, NOT leftover Mission08 wave-state
# enum #68fc / #237, NOT leftover
# BindRuntimeActors (retired live mount), NOT
# leftover Mission01 / Mission03
# GetRemainingThreatsInWave, NOT leftover
# Mission07 GetObjectiveRuntime #717, NOT leftover
...
# Mission08, not leftover Mission08 Waves #742,
# Payload / Targets / Objectives / Search /
# Protection / Hoist / Safety / Boss /
...
# Mission07 Waves #721, not leftover Mission08
# Waves #742, not leftover Mission07
# Integration #717, not leftover Mission08
# Integration #739, not leftover
...
# GetRemainingThreatsInWave #742. Do not reopen
# leftover Mission07 GetRemainingThreatsInWave
# #721 / Mission06 #699 / Mission05 #677.
# Do not reopen leftover Mission09 wave-state
# enum #20fc / #238, leftover Mission09
# protected-target enum #9246 / #228, leftover
# Mission09 protected-target-runtime-defaults
# #bf28 / #225, leftover Mission09 pool-runtime-
# defaults #5426 / #243, leftover Mission09
# pool-budget-defaults #4537 / #242. Do not
# reopen leftover Mission08 GetWaveState #741 /
# Mission07 #719 / Mission06 #701 / Mission05
# #676, leftover Mission08 GetReadiness #739 /
# env-defaults #6b9d / #b931. Do not reopen
# leftover drafts #56–#64, leftover drafts
# #107–#673, leftover #664, closed-without-merge
# #658–#673 including Mission04
# GetRemainingThreatsInWave #662. Do not reopen
# open drafts #674–#757+.
...
LOCKED_DECL = GET_REMAINING_THREATS_IN_WAVE
...
# contract on ASkyguardMission08IntegrationDirector.
LOCKED = {
...
class Mission09GetRemainingThreatsInWaveDeclContractTests(unittest.TestCase):
    ...
    def test_get_remaining_threats_in_wave_declaration_matches_origin_main(self) -> None:
        ...
        self.assertIn("GetRemainingThreatsInWave", LOCKED_DECL)
        self.assertIn("GetRemainingThreatsInWave()", LOCKED_DECL)
    ...
    def test_environment_category_does_not_satisfy_waves(self) -> None:
        ...
        self.assertNotEqual(leftover_search, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_protection, UFUNCTION_WAVES)
        ...
        self.assertNotIn(leftover_m07, UFUNCTION_WAVES)
        self.assertNotIn(leftover_search, UFUNCTION_WAVES)
        self.assertNotIn(leftover_protection, UFUNCTION_WAVES)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertNotIn("GetProtectedTarget", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 GetRemainingThreatsInWave method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 GetRemainingThreatsInWave contains "
    ...
    def test_contract_is_get_remaining_threats_in_wave_declaration_only(
        ...
        self.assertTrue(LOCKED_DECL.startswith("int32 "))
        self.assertIn("GetRemainingThreatsInWave", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith(" const"))
        self.assertFalse(LOCKED_DECL.endswith(";"))
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_get_remaining_threats_in_wave"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_origin_main_requires_inline_remaining_threats_body(self) -> None:
        section = public_section(origin_main_header())
        self.assertIn(ORIGIN_MAIN_INLINE, section)
        self.assertIn("{ return RemainingThreatsInWave; }", section)
        self.assertIn(UFUNCTION_WAVES, section)
    ...
    def test_leftover_mission08_get_remaining_threats_in_wave_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
    ...
    def test_leftover_mission08_get_wave_state_and_readiness_do_not_satisfy(
        self,
    ) -> None:
        locked_only = f"{LOCKED_DECL}\n"
