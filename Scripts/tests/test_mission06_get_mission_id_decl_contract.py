...
# Mission06 Integration GetMissionId on
# ASkyguardMission06IntegrationDirector. It is
# NOT leftover Mission05 GetMissionId
# #680, NOT leftover Mission01 / Mission03 /
# Mission04 GetMissionId, NOT leftover
...
# ValidateMissionContract. Do not
...
# leftover Mission01 GetMissionId,
# leftover Mission03 GetMissionId,
# leftover Mission04 GetMissionId,
...
# #680, not leftover Mission05 Protection, not
...
# GetMissionId, leftover Mission06 wave-state
...
class Mission06GetMissionIdDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        with_arg = (
            "\tstatic FName GetMissionId(FName MissionId);\n"
        )
        ...
        leftover_mission_id = f"\t{GET_REMAINING_THREATS_IN_WAVE}\n"
    ...
    def test_get_mission_id_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("ESkyguardAirfieldTarget Target", GET_MISSION_ID)
        self.assertNotIn("int32 Damage", GET_MISSION_ID)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 GetMissionId method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission06 GetMissionId contains "
    ...
    def test_leftover_mission01_get_mission_id_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission01IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission03_get_mission_id_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission04_get_mission_id_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission04IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission05_get_mission_id_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission05IntegrationDirector "
            ": public AActor\n"
            "{\n"
