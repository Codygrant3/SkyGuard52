...
# NOT leftover AmbulanceAAnchor (in-flight sibling),
# NOT leftover AmbulanceBAnchor (in-flight sibling),
# NOT leftover FerryTerminalAnchor (in-flight sibling),
...
# AmbulanceAAnchor / AmbulanceBAnchor / FerryTerminalAnchor /
# RadioChatter /
...
# Category is Skyguard|Mission10|Evacuation, not
# Integration, not leftover Mission01, not leftover
# Mission03 convoy methods, not Mission02 / Mission04 /
...
# drafts #674–#790, leftover Apache
...
LOCKED_DECL = EVACUATION_SHIP_ANCHOR_FIELD
...
# an isolated Python EvacuationShipAnchor
...
LEFTOVER_MISSION10_SIBLING_METHODS_NOT_LOCKED = (
    ...
    "test_mission10_ambulance_a_anchor_field_decl_contract.py",
    "test_mission10_ambulance_b_anchor_field_decl_contract.py",
    "test_mission10_ferry_terminal_anchor_field_decl_contract.py",
...
class Mission10EvacuationShipAnchorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("EvacuationShipAnchor", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_evacuation_ship_anchor_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        macro_only = f"\t{UPROPERTY_EVACUATION}\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn(UPROPERTY_EVACUATION, section)
        ...
        self.assertNotIn("BlueprintCallable", UPROPERTY_EVACUATION)
        self.assertNotIn("BlueprintPure", UPROPERTY_EVACUATION)
        self.assertIn("Skyguard|Mission10|Evacuation", UPROPERTY_EVACUATION)
        self.assertNotIn("Integration", UPROPERTY_EVACUATION)
        self.assertNotIn("Mission01", UPROPERTY_EVACUATION)
        self.assertNotIn("Mission03", UPROPERTY_EVACUATION)
        self.assertNotIn("Mission04", UPROPERTY_EVACUATION)
        self.assertNotIn("Mission05", UPROPERTY_EVACUATION)
        self.assertNotIn("Mission06", UPROPERTY_EVACUATION)
        self.assertIn("Evacuation", UPROPERTY_EVACUATION)
        self.assertNotIn("Protection", UPROPERTY_EVACUATION)
        self.assertNotIn("Search", UPROPERTY_EVACUATION)
        self.assertNotIn("Waves", UPROPERTY_EVACUATION)
        self.assertNotIn("Payload", UPROPERTY_EVACUATION)
        self.assertNotIn("Targets", UPROPERTY_EVACUATION)
        self.assertNotIn("Objectives", UPROPERTY_EVACUATION)
        self.assertIn("VisibleAnywhere", UPROPERTY_EVACUATION)
        self.assertIn("BlueprintReadOnly", UPROPERTY_EVACUATION)
        self.assertNotIn("Environment", UPROPERTY_EVACUATION)
        self.assertNotIn("Briefing", UPROPERTY_EVACUATION)
        self.assertNotIn("Mission02", UPROPERTY_EVACUATION)
        self.assertNotIn("Boss", UPROPERTY_EVACUATION)
        self.assertNotIn("Destruction", UPROPERTY_EVACUATION)
        self.assertNotIn("Apache", UPROPERTY_EVACUATION)
        self.assertNotIn("Mission06", UPROPERTY_EVACUATION)
        self.assertNotIn("Mission07", UPROPERTY_EVACUATION)
        self.assertNotIn("Mission08", UPROPERTY_EVACUATION)
        self.assertNotIn("Mission09", UPROPERTY_EVACUATION)
        self.assertNotIn("Encounter", UPROPERTY_EVACUATION)
        self.assertNotIn("Safety", UPROPERTY_EVACUATION)
        self.assertNotIn("Performance", UPROPERTY_EVACUATION)
        self.assertNotIn("Hoist", UPROPERTY_EVACUATION)
        self.assertNotIn("Rescue", UPROPERTY_EVACUATION)
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, UPROPERTY_EVACUATION)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tUSceneComponent* EvacuationShipAnchor;\n"
        )
        as_const = (
            "\tconst TObjectPtr<USceneComponent>& "
    ...
    def test_evacuation_ship_anchor_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertIn("EvacuationShipAnchor", LOCKED_DECL)
        ...
        self.assertNotIn("AmbulanceBAnchor", LOCKED_DECL)
        self.assertNotIn("FerryTerminalAnchor", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction = (
            "public:\n"
            f"\t{UPROPERTY_EVACUATION}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
        )
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UPROPERTY_EVACUATION} {LOCKED_DECL}\n"
            "};\n"
        )
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(environment, UPROPERTY_EVACUATION)
        self.assertNotEqual(briefing, UPROPERTY_EVACUATION)
        self.assertNotIn(environment, UPROPERTY_EVACUATION)
        self.assertNotIn(briefing, UPROPERTY_EVACUATION)
        leftover_m01 = (
            'UFUNCTION(BlueprintCallable, '
        ...
        self.assertNotEqual(leftover_m01, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m02, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_harbor, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m03, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m04, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m05, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m06, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_waves, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m05_waves, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_integration, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m07_ready, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m08_waves, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m08_hoist, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m08_safety, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m08_protection, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m08_ready, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m09_ready, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m09_waves, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m10_safety, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m09_protection, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m09_performance, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_m09_objectives, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_payload, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_targets, UPROPERTY_EVACUATION)
        self.assertNotEqual(leftover_objectives, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m01, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m02, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_harbor, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m03, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m04, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m05, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m06, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m05_waves, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_integration, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m07_ready, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m08_waves, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m08_hoist, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m08_safety, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m08_protection, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m08_ready, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m09_ready, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m09_waves, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m10_safety, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m09_protection, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m09_performance, UPROPERTY_EVACUATION)
        self.assertNotIn(leftover_m09_objectives, UPROPERTY_EVACUATION)
        self.assertNotIn("Mission01", UPROPERTY_EVACUATION)
        self.assertNotIn("Mission03", UPROPERTY_EVACUATION)
        self.assertNotIn("Mission04", UPROPERTY_EVACUATION)
        self.assertNotIn("Mission05", UPROPERTY_EVACUATION)
    ...
    def test_contract_is_evacuation_ship_anchor_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_evacuation_ship_anchor(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_contract_does_not_relock_leftover_handle_boss_phase_changed(
        ...
        for token in LEFTOVER_HANDLE_BOSS_PHASE_CHANGED_NOT_LOCKED:
            ...
            self.assertNotIn(token, LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", UPROPERTY_EVACUATION)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_evacuation_ship_anchor"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
