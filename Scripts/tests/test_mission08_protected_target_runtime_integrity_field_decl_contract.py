...
# THIS IS leftover-safe Mission08 ProtectedTargetRuntime
...
# FSkyguardMission08ProtectedTargetRuntime STRUCT
# public section only (after struct
# FSkyguardMission08ProtectedTargetRuntime, before
...
# FSkyguardHoistWindowRuntime, leftover enum
...
# merge #665 #666 #668-#673, or open drafts #674-#1126.
...
# Mission08 ProtectedTargetRuntime Integrity
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 default 100,
# one-line / split-line UPROPERTY wraps) on
# FSkyguardMission08ProtectedTargetRuntime. It is
# leftover-safe Mission08 ProtectedTargetRuntime
...
# struct section of
# FSkyguardMission08ProtectedTargetRuntime only
# between struct FSkyguardMission08ProtectedTargetRuntime
# and struct FSkyguardHoistWindowRuntime / the following UCLASS /
...
# drafts #674-#1124 including leftover Mission02
...
# the locked FSkyguardMission08ProtectedTargetRuntime
...
# drafts #674-#1124. Do not reopen leftover
...
class Mission08ProtectedTargetRuntimeIntegrityFieldDeclContractTests(unittest.TestCase):
