...
# Mission08 IntegrationReadiness ProtectedTargetCount
...
# is leftover-safe Mission08 readiness-struct ProtectedTargetCount
...
# Mission09/10 protected-target counts. It is NOT leftover
...
# drafts #674-#1079 including leftover Mission02
...
# drafts #674-#1079. Do not reopen leftover
...
# Mission09/10 protected-target counts, leftover Mission08
# ObjectiveCount, leftover Mission08 WaveCount, leftover
# Mission08 director Readiness #1066, leftover Mission07
...
LEFTOVER_MISSION09_PROTECTED_TARGET_COUNT_NOT_LOCKED = (
    "test_mission09_protected_target_count_field_decl_contract.py",
    "cursor/mission09-protected-target-count-field-decl-contract-c332",
)
...
class Mission08ProtectedTargetCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 ProtectedTargetCount field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 ProtectedTargetCount contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_protected_target_count"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
