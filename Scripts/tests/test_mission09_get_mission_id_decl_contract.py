...
# Mission09 Integration GetMissionId METHOD on
# ASkyguardMission09IntegrationDirector. It is
# the METHOD, not leftover Mission08 GetMissionId
# #749 / branch cursor/mission08-get-mission-id-
# decl-contract-c332, not leftover Mission07
# GetMissionId #727, not leftover Mission06
# GetMissionId #704, not leftover Mission05
# GetMissionId #680, not leftover closed
# Mission04 GetMissionId #663, not leftover
# Mission09 pool-runtime-defaults #5426 / #243,
# not leftover Mission09 pool-budget-defaults
# #4537 / #242. It is NOT leftover Mission09
# GetReadiness, NOT leftover Mission08
# GetReadiness #739 / NOT leftover
...
# leftover Mission09 GetReadiness,
# leftover Mission08 GetMissionId #749,
...
# Rescue / Safety / Performance, not Environment,
...
# drafts #674–#763, leftover Apache
...
# #658–#673. Do not reopen open drafts #674–#763+.
...
class Mission09GetMissionIdDeclContractTests(unittest.TestCase):
    ...
    def test_contract_does_not_lock_get_mission_id_cpp_body(self) -> None:
        ...
        self.assertIn("}", GET_MISSION_ID)
        self.assertIn("return ", GET_MISSION_ID)
        self.assertIn('TEXT("M09_SaturationAttack")', GET_MISSION_ID)
        self.assertNotIn(
            "ASkyguardMission09IntegrationDirector::GetMissionId",
            GET_MISSION_ID,
        )
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertNotIn("GetPoolRuntime", locked_only)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardIronRainBoss", GET_MISSION_ID)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 GetMissionId method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission09 GetMissionId contains "
    ...
    def test_leftover_mission07_get_readiness_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m07_type, GET_MISSION_ID)
        self.assertIn("GetMissionId", str(raised.exception))
    ...
    def test_leftover_mission08_get_readiness_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m08_type, GET_MISSION_ID)
        self.assertIn("GetMissionId", str(raised.exception))
        self.assertNotIn(
            "cursor/mission08-get-readiness-decl-contract-c332",
            GET_MISSION_ID,
    ...
    def test_contract_does_not_relock_leftover_mission09_wave_state_enum(
        ...
        self.assertNotIn("ESkyguardMission09WaveState", GET_MISSION_ID)
        self.assertNotIn("Waves", UFUNCTION_INTEGRATION)
    ...
    def test_contract_does_not_relock_leftover_mission09_pool(self) -> None:
        ...
        self.assertNotIn("Performance", UFUNCTION_INTEGRATION)
        self.assertNotIn("GetReadiness", GET_MISSION_ID)
        self.assertNotIn("Available = 48", GET_MISSION_ID)
        self.assertNotIn("PeakActive", GET_MISSION_ID)
        self.assertNotIn("Recycled", GET_MISSION_ID)
        self.assertNotIn("PoolBudget", GET_MISSION_ID)
    ...
    def test_sibling_mission09_methods_do_not_satisfy(self) -> None:
        ...
        for token in LEFTOVER_MISSION09_SIBLING_METHODS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_MISSION_ID)
        self.assertNotIn("BindCampaignRuntime", GET_MISSION_ID)
        self.assertNotIn("GetReadiness", GET_MISSION_ID)
        self.assertNotIn(BIND_RUNTIME_ACTORS, GET_MISSION_ID)
        self.assertNotIn("UFUNCTION", GET_DAY_BEAT_KIT)
        self.assertNotIn("UFUNCTION", GET_DAY_BEAT_KIND)
    ...
    def test_contract_does_not_relock_leftover_mission08_get_mission_id(
        self,
    ) -> None:
        locked_only = f"{GET_MISSION_ID}\n"
        for token in LEFTOVER_MISSION08_GET_MISSION_ID_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_MISSION_ID)
        self.assertIn(
        ...
        self.assertNotIn("M08_RescueCover", GET_MISSION_ID)
        self.assertNotIn("Mission08", UFUNCTION_INTEGRATION)
    ...
    def test_locked_scripts_list_sibling_mission09_contracts(self) -> None:
        sibling_scripts = (
            "Scripts/tests/test_mission09_initialize_playable_mission"
            "_decl_contract.py",
            "Scripts/tests/test_mission09_configure_mission_definition"
        ...
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertNotIn("GetPoolRuntime", GET_MISSION_ID)
        self.assertNotIn("InitializePlayableMission", GET_MISSION_ID)
        self.assertNotIn("ConfigureMissionDefinition", GET_MISSION_ID)
        self.assertNotIn("BindCampaignRuntime", GET_MISSION_ID)
        self.assertNotIn("StartNextWave", GET_MISSION_ID)
