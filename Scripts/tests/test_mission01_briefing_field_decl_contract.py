...
# INDEX_NONE or lock Briefing construction in the
# .cpp. This is a FIELD contract on
# ASkyguardMission01IntegrationDirector, not leftover
# USkyguardMissionBriefingComponent public methods
# (already drafted) and not leftover briefing-widget
# getters. Keep Briefing distinct from sibling
# director fields Root / AudioDirector / RadioChatter /
...
# Briefing;`); accept that form and other
...
# isolated-test drafts #107–#565, leftover Apache
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission01IntegrationDirector::Briefing",
    "SkyguardMission01IntegrationDirector.cpp",
...
class Mission01BriefingFieldDeclContractTests(unittest.TestCase):
    def test_mission01_class_exists(self) -> None:
        ...
        self.assertTrue(has_declaration(section, BRIEFING_FIELD), section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, BRIEFING_FIELD)
        self.assertIn("Briefing", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(has_declaration(section, BRIEFING_FIELD))
    ...
    def test_missing_briefing_declaration_fails_closed(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, BRIEFING_FIELD)
        self.assertIn("Briefing", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, BRIEFING_FIELD)
        self.assertIn("Briefing", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertTrue(has_declaration(section, BRIEFING_FIELD), section)
        self.assertNotIn("UPROPERTY", BRIEFING_FIELD)
        self.assertNotIn("VisibleAnywhere", BRIEFING_FIELD)
        self.assertNotIn("BlueprintReadOnly", BRIEFING_FIELD)
        self.assertNotIn("Category", BRIEFING_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, BRIEFING_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, BRIEFING_FIELD)
        self.assertIn("Briefing", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = "\tUSkyguardMissionBriefingComponent* Briefing;\n"
        as_array = (
            "\tTArray<TObjectPtr<USkyguardMissionBriefingComponent>> "
            "Briefing;\n"
        )
        scene = "\tTObjectPtr<USceneComponent> Briefing;\n"
        audio = (
            "\tTObjectPtr<USkyguardAudioDirectorComponent> Briefing;\n"
        )
        weak = (
            "\tTWeakObjectPtr<USkyguardMissionBriefingComponent> "
            "Briefing;\n"
        )
        assigned = (
            "\tTObjectPtr<USkyguardMissionBriefingComponent> "
        ...
        soft = (
            "\tTSoftObjectPtr<USkyguardMissionBriefingComponent> "
            "Briefing;\n"
        )
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, BRIEFING_FIELD)
            self.assertIn("Briefing", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_briefing_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(has_declaration(section, BRIEFING_FIELD))
        self.assertEqual(declaration_count(section, BRIEFING_FIELD), 1)
        self.assertTrue(
            BRIEFING_FIELD.startswith(
                "TObjectPtr<USkyguardMissionBriefingComponent> "
            ),
            BRIEFING_FIELD,
        )
        self.assertTrue(BRIEFING_FIELD.endswith(";"), BRIEFING_FIELD)
        self.assertIn("Briefing", BRIEFING_FIELD)
        self.assertIn(
            "USkyguardMissionBriefingComponent",
            BRIEFING_FIELD,
        )
        self.assertIn("TObjectPtr<", BRIEFING_FIELD)
        self.assertNotIn("TArray<", BRIEFING_FIELD)
        self.assertNotIn("TSoftObjectPtr", BRIEFING_FIELD)
        self.assertNotIn("=", BRIEFING_FIELD)
        self.assertNotIn("INDEX_NONE", BRIEFING_FIELD)
        self.assertNotIn("UFUNCTION", BRIEFING_FIELD)
        self.assertNotIn("{", BRIEFING_FIELD)
        self.assertNotIn("}", BRIEFING_FIELD)
        self.assertNotIn("return ", BRIEFING_FIELD)
        self.assertNotIn("AudioDirector", BRIEFING_FIELD)
        self.assertNotIn("RadioChatter", BRIEFING_FIELD)
        self.assertNotIn("SortiePresentation", BRIEFING_FIELD)
        self.assertNotIn("CampaignDefinition", BRIEFING_FIELD)
        self.assertNotIn("MissionDefinition", BRIEFING_FIELD)
        self.assertNotIn("Readiness", BRIEFING_FIELD)
        self.assertNotIn("PathfinderSpawnLocation", BRIEFING_FIELD)
        self.assertNotIn("GetAircraft", BRIEFING_FIELD)
        self.assertNotIn("ConfigureFromMission", BRIEFING_FIELD)
        self.assertNotIn("AdvanceBriefing", BRIEFING_FIELD)
        self.assertNotIn("SetAssetsReady", BRIEFING_FIELD)
        self.assertNotIn("AcknowledgeAndLaunch", BRIEFING_FIELD)
        self.assertNotIn("CanLaunch", BRIEFING_FIELD)
        self.assertNotIn("GetElapsedSeconds", BRIEFING_FIELD)
        self.assertNotIn("GetBriefingState", BRIEFING_FIELD)
        self.assertNotIn("GetMinimumWarmupSeconds", BRIEFING_FIELD)
        self.assertNotIn("GetBriefingText", BRIEFING_FIELD)
        self.assertNotIn("GetRadioChatter", BRIEFING_FIELD)
        self.assertNotIn("GetPresentation", BRIEFING_FIELD)
        self.assertNotIn("GetMissionTitle", BRIEFING_FIELD)
        self.assertNotIn("AcknowledgeBriefing", BRIEFING_FIELD)
        self.assertNotIn("LaunchSortie", BRIEFING_FIELD)
        self.assertNotIn("HullCollider", BRIEFING_FIELD)
        self.assertNotIn("OpticalTracker", BRIEFING_FIELD)
        self.assertNotIn("WeaponServo", BRIEFING_FIELD)
        self.assertNotIn("CountermeasurePod", BRIEFING_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", BRIEFING_FIELD)
        self.assertNotIn("RadarNode", BRIEFING_FIELD)
        self.assertNotIn("ESkyguardMission02WaveState", BRIEFING_FIELD)
        self.assertNotIn("HarborIndustrial", BRIEFING_FIELD)
        self.assertNotIn("MaxIntegrity", BRIEFING_FIELD)
        self.assertNotIn("CurrentIntegrity", BRIEFING_FIELD)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, BRIEFING_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION01} {BRIEFING_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(declaration_count(section, BRIEFING_FIELD), 1)
        one_line = f"{{\npublic:\n\t{BRIEFING_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, BRIEFING_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, BRIEFING_FIELD), section)
        self.assertEqual(
            require_declaration(section, BRIEFING_FIELD),
    ...
    def test_assigned_briefing_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<USkyguardMissionBriefingComponent> "
            "Briefing = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, BRIEFING_FIELD)
        self.assertIn("Briefing", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, BRIEFING_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("Briefing", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, BRIEFING_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{BRIEFING_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, BRIEFING_FIELD)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            BRIEFING_FIELD.startswith("UFUNCTION"),
            BRIEFING_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, BRIEFING_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", BRIEFING_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_briefing_cpp_body(self) -> None:
        locked_only = f"{BRIEFING_FIELD}\n"
        self.assertNotIn("{", BRIEFING_FIELD)
        self.assertNotIn("}", BRIEFING_FIELD)
        self.assertNotIn("return ", BRIEFING_FIELD)
        ...
        self.assertNotIn("return false", BRIEFING_FIELD)
        self.assertNotIn("return true", BRIEFING_FIELD)
        self.assertNotIn("CreateDefaultSubobject", BRIEFING_FIELD)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{BRIEFING_FIELD}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, BRIEFING_FIELD)
        self.assertIn("Briefing", BRIEFING_FIELD)
        self.assertIn(
            "USkyguardMissionBriefingComponent",
            BRIEFING_FIELD,
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, BRIEFING_FIELD)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", BRIEFING_FIELD)
        self.assertNotIn("CurrentIntegrity", BRIEFING_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", BRIEFING_FIELD)
    ...
    def test_contract_does_not_open_leftover_briefing_component_header(
        ...
        self.assertNotIn(leftover_header, BRIEFING_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, BRIEFING_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", BRIEFING_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{BRIEFING_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, BRIEFING_FIELD),
            BRIEFING_FIELD,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, BRIEFING_FIELD)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 Briefing field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{BRIEFING_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, BRIEFING_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                BRIEFING_FIELD.lower(),
                "mission01 Briefing contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live cop" + "y",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, BRIEFING_FIELD)

    def test_contract_is_briefing_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertTrue(BRIEFING_FIELD.endswith(";"))
        self.assertNotIn("=", BRIEFING_FIELD)
        self.assertIn(UPROPERTY_MISSION01, section)

    def test_sibling_director_fields_do_not_satisfy_briefing(self) -> None:
        for leftover in (
            ROOT_FIELD,
            AUDIO_DIRECTOR_FIELD,
            RADIO_CHATTER_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, BRIEFING_FIELD))
            self.assertNotEqual(BRIEFING_FIELD, leftover)
        self.assertIn(
            "Scripts/tests/test_mission01_root_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
