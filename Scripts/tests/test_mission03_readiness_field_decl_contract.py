...
# drafts #674-#806+, leftover Apache
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission03IntegrationDirector::Readiness",
    "SkyguardMission10IntegrationDirector.cpp",
...
class Mission03ReadinessFieldDeclContractTests(unittest.TestCase):
    ...
    def test_readiness_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FSkyguardMission03IntegrationReadiness "),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("Readiness", LOCKED_DECL)
        self.assertIn("FSkyguardMission03IntegrationReadiness", LOCKED_DECL)
    ...
    def test_contract_is_readiness_field_declaration_only(
        ...
        self.assertNotIn("return ", LOCKED_DECL)
        self.assertNotIn("{", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FSkyguardMission03IntegrationReadiness"))
        self.assertIn("Readiness", LOCKED_DECL)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission03_readiness_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_same_name_readiness_contracts_stay_locked(self) -> None:
        ...
        self.assertNotIn("EditAnywhere", UPROPERTY_MISSION03)
        self.assertNotIn("BlueprintReadWrite", UPROPERTY_MISSION03)
