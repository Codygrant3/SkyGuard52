...
# .cpp. This is an Integration method contract on
# ASkyguardMission03IntegrationDirector, not leftover
# Mission01 ConfigureMissionDefinition #611,
# not leftover HandleDroneCityImpact, not leftover
# Harbor Mission02, not leftover
# BindRuntimeActors (retired live mount in that
# leftover decl) and not leftover GetAircraft
# (returns the retired live mount). Distinct from
# leftover Briefing (#568) / AudioDirector (#572) /
...
# Category="Skyguard|Mission03|Integration") is
...
GET_ROAD_HUNTER = (
    "ASkyguardRoadHunterBoss* GetRoadHunter() const { return RoadHunter; }"
)
...
# leftover theater-kit #59, leftover #107–#580, plus
...
# BindRuntimeActors, sibling Briefing /
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission03_environment_readiness_defaults_contract.py",
...
LEFTOVER_ENVIRONMENT_READINESS_NOT_LOCKED = (
    "test_mission03_environment_readiness_defaults_contract.py",
...
LEFTOVER_MISSION03_NEIGHBORS_NOT_LOCKED = (
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission03IntegrationDirector::ConfigureMissionDefinition",
    "SkyguardMission03IntegrationDirector.cpp",
...
class Mission03ConfigureMissionDefinitionDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 ConfigureMissionDefinition contract contains "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission03 ConfigureMissionDefinition contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live cop" + "y",
            )
            self.assertNotIn(banned, locked_only.lower())
