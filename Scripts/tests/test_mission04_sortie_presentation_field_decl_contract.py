...
# #908 / SearchlightStarboard #909 / Briefing siblings.
# THIS IS NOT leftover FSkyguardMission04IntegrationReadiness
...
# reopen open drafts #674-#909 (Mission04 Root #907,
# SearchlightPort #908, SearchlightStarboard #909). Briefing
# may already have a newer draft; do not reopen it. LOCK leftover Mission10 route-phase enum
...
# Skip leftover retired-mount spawn / runtime-ready entirely.
...
# Mission04 SortiePresentation FIELD
...
# drafts #674-#909, leftover Apache
...
# drafts #674-#909 including leftover Mission03
# RadioLineCount #904 / ObjectiveCount #905 / WaveCount #906 /
# leftover Mission04 Root #907 / SearchlightPort #908 /
# SearchlightStarboard #909. Briefing may already have a
# newer draft; do not reopen it.
...
class Mission04SortiePresentationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 SortiePresentation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 SortiePresentation field contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_sortie_presentation_field"
                "_decl_contract.py"
            )
        )
        leftover_56_64 = (
