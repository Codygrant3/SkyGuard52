...
# Mission02 Integration SortiePresentation
# FIELD (declaration-only, split-line) on
# ASkyguardMission02IntegrationDirector. It is
# NOT leftover Mission10 SortiePresentation field #797 /
# branch cursor/mission10-sortie-presentation-field-
# decl-contract-c332, NOT leftover Mission10
# bSortiePresentationReady #820, NOT leftover
# Mission02 UFUNCTION siblings #828-#844, NOT leftover
# Mission02 Root / Briefing / AudioDirector /
# RadioChatter field siblings, NOT leftover
# Mission01 SortiePresentation field #575 /
# branch cursor/mission01-sortie-presentation-field-
# decl-contract-c332, NOT leftover Mission01
# AudioDirector field #572 /
# branch cursor/mission01-audio-director-field-
# decl-contract-c332, NOT leftover Mission01
# Root field #574 /
...
# HighwayConvoyAnchor (in-flight sibling),
# NOT leftover BusAAnchor (in-flight sibling),
# NOT leftover BusBAnchor (in-flight sibling),
...
# methods.
# not leftover Briefing / AmbulanceAAnchor / Root /
# HighwayConvoyAnchor / BusAAnchor / BusBAnchor /
# AmbulanceBAnchor / FerryTerminalAnchor /
# EvacuationShipAnchor / RadioChatter /
# AudioDirector / CampaignDefinition /
...
# Category is Skyguard|Mission02, not leftover Mission10, not Evacuation, not
# Integration, not leftover Mission01, not leftover
...
# drafts #674–#846, leftover Apache
...
INVENTED_UPROPERTY = (
    ...
    'Category="Skyguard|Mission02|Protection"',
...
class Mission02SortiePresentationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn("VisibleAnywhere", UPROPERTY_MISSION02)
        self.assertIn("BlueprintReadOnly", UPROPERTY_MISSION02)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_ambulance = f"\t{AMBULANCE_A_ANCHOR_FIELD}\n"
    ...
    def test_contract_does_not_relock_leftover_sortie_presentation_fail_closed(
        ...
        for token in LEFTOVER_SORTIE_PRESENTATION_FAIL_CLOSED_NOT_LOCKED:
            ...
            self.assertNotIn(token, LOCKED_DECL)
        self.assertIn(
            "Scripts/tests/test_sortie_presentation"
            "_fail_closed.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_sortie_presentation_fail_closed"
            "_tests.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_sortie_presentation_state"
            "_enum_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertNotIn(
            "SkyguardSortiePresentationComponent.h", locked_only
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 SortiePresentation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 SortiePresentation contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_sortie_presentation(
        ...
        self.assertIn(
            "Scripts/tests/test_mission10_ambulance_a_anchor"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_ambulance_b_anchor"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_ferry_terminal_anchor"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_sortie_presentation"
                "_field_decl_contract.py"
            )
        )
