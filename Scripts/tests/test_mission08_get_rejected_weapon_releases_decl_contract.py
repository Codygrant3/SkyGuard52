...
# Mission08 Safety GetRejectedWeaponReleases
# METHOD (inline body) on
# ASkyguardMission08IntegrationDirector.
# It is NOT leftover ValidateWeaponRelease #735,
# NOT leftover BindRuntimeActors (retired live mount), NOT leftover
# hoist-window-runtime-defaults #ec79, NOT leftover
# Mission08 GetRemainingThreatsInWave, NOT leftover
# Mission08 GetWaveState, NOT leftover Mission08
...
# #721, NOT leftover Mission06
# GetRemainingThreatsInWave #699, NOT leftover
# Mission05 GetRemainingThreatsInWave, NOT leftover
...
# GetHoistRuntime / GetRemainingThreatsInWave /
...
# Mission07 Waves #721, not leftover Mission07
...
# #658–#673. Do not reopen open drafts #674–#741.
...
LOCKED_DECL = GET_REJECTED_WEAPON_RELEASES
...
# GetRejectedWeaponReleases method declaration
...
CPP_AND_INVENTED = (
    ...
    "SkyguardMission08IntegrationDirector.cpp",
    "ASkyguardMission07IntegrationDirector::GetRejectedWeaponReleases",
...
class Mission08GetRejectedWeaponReleasesDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Safety", UFUNCTION_SAFETY)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_bool = "\tvoid GetRejectedWeaponReleases() const;\n"
        as_const = "\tUSkyguardObjectiveRuntime* GetRejectedWeaponReleases();\n"
        with_arg = "\tUSkyguardObjectiveRuntime* GetRejectedWeaponReleases(int32 Amount) const;\n"
    ...
    def test_get_rejected_weapon_releases_declaration_matches_origin_main(self) -> None:
        ...
        self.assertIn("GetRejectedWeaponReleases", LOCKED_DECL)
        self.assertIn("GetRejectedWeaponReleases()", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_SAFETY} {LOCKED_DECL}\n"
            "};\n"
        )
    ...
    def test_environment_category_does_not_satisfy_safety(self) -> None:
        ...
        self.assertNotEqual(leftover_search, UFUNCTION_SAFETY)
        self.assertNotEqual(leftover_protection, UFUNCTION_SAFETY)
        self.assertNotEqual(leftover_hoist, UFUNCTION_SAFETY)
        self.assertNotEqual(leftover_waves_m08, UFUNCTION_SAFETY)
        self.assertNotEqual(leftover_callable_safety, UFUNCTION_SAFETY)
        ...
        self.assertNotIn(leftover_m07, UFUNCTION_SAFETY)
        self.assertNotIn(leftover_search, UFUNCTION_SAFETY)
        self.assertNotIn(leftover_protection, UFUNCTION_SAFETY)
        self.assertNotIn(leftover_hoist, UFUNCTION_SAFETY)
        self.assertNotIn(leftover_waves_m08, UFUNCTION_SAFETY)
        self.assertNotIn(leftover_callable_safety, UFUNCTION_SAFETY)
        self.assertNotIn("Mission01", UFUNCTION_SAFETY)
        self.assertNotIn("Mission03", UFUNCTION_SAFETY)
        self.assertNotIn("Mission04", UFUNCTION_SAFETY)
        self.assertNotIn("Mission05", UFUNCTION_SAFETY)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 GetRejectedWeaponReleases method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 GetRejectedWeaponReleases contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_get_rejected_weapon_releases"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_origin_main_requires_inline_rejected_weapon_releases_body(self) -> None:
        section = public_section(origin_main_header())
        self.assertIn(ORIGIN_MAIN_INLINE, section)
        self.assertIn("return RejectedWeaponReleases;", section)
        self.assertIn(UFUNCTION_SAFETY, section)
