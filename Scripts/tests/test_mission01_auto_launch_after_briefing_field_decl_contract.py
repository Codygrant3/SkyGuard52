...
# not leftover USkyguardMissionBriefingComponent
# public methods (already drafted) and not leftover
# briefing-widget getters. Keep
# bAutoLaunchAfterBriefing distinct from sibling
...
# bAllowBoundedActorSpawning. Do not lock leftover
...
# Category is Skyguard|Mission01, not
# Mission01|Campaign / Mission02 / Boss /
# Destruction. Stay off leftover drafts #56–#64,
# leftover Harbor #6/#8/#9, leftover theater-kit
# #59, leftover isolated-test drafts #107–#577,
...
# 550.f is Harbor-adjacent; do not treat as
# Harbor 40/80. LifelineHunter
# MinimumWeaponSeparationMeters = 450.f is
# Harbor-adjacent. Do not lock leftover
# ESkyguardMission02WaveState while leftover
# Harbor #6/#8/#9 remain open.
AUTO_LAUNCH_FIELD = "bool bAutoLaunchAfterBriefing = true;"
UPROPERTY_MISSION01 = (
...
ALLOW_BOUNDED_FIELD = "bool bAllowBoundedActorSpawning = true;"
...
# Bare "Briefing" is a substring of
# bAutoLaunchAfterBriefing. Use "Briefing;" / the
# full sibling field so this lock stays distinct
# from leftover Briefing (#568).
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission01IntegrationDirector::bAutoLaunchAfterBriefing",
    "SkyguardMission01IntegrationDirector.cpp",
...
class Mission01AutoLaunchAfterBriefingFieldDeclContractTests(unittest.TestCase):
    def test_mission01_class_exists(self) -> None:
        ...
        self.assertTrue(has_declaration(section, AUTO_LAUNCH_FIELD), section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, AUTO_LAUNCH_FIELD)
        self.assertIn("bAutoLaunchAfterBriefing", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(has_declaration(section, AUTO_LAUNCH_FIELD))

    def test_missing_auto_launch_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission01IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, AUTO_LAUNCH_FIELD)
        self.assertIn("bAutoLaunchAfterBriefing", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, AUTO_LAUNCH_FIELD)
        self.assertIn("bAutoLaunchAfterBriefing", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertTrue(has_declaration(section, AUTO_LAUNCH_FIELD), section)
        self.assertNotIn("UPROPERTY", AUTO_LAUNCH_FIELD)
        self.assertNotIn("EditAnywhere", AUTO_LAUNCH_FIELD)
        self.assertNotIn("BlueprintReadWrite", AUTO_LAUNCH_FIELD)
        self.assertNotIn("Category", AUTO_LAUNCH_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, AUTO_LAUNCH_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, AUTO_LAUNCH_FIELD)
        self.assertIn("bAutoLaunchAfterBriefing", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        unassigned = "\tbool bAutoLaunchAfterBriefing;\n"
        false_default = "\tbool bAutoLaunchAfterBriefing = false;\n"
        as_uint8 = "\tuint8 bAutoLaunchAfterBriefing = true;\n"
        as_int32 = "\tint32 bAutoLaunchAfterBriefing = true;\n"
        as_float = "\tfloat bAutoLaunchAfterBriefing = true;\n"
        inverted = "\tbool bAutoLaunchAfterBriefing = 1;\n"
        ...
        leftover_allow = f"\t{ALLOW_BOUNDED_FIELD}\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, AUTO_LAUNCH_FIELD)
            self.assertIn("bAutoLaunchAfterBriefing", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_auto_launch_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, AUTO_LAUNCH_FIELD),
            AUTO_LAUNCH_FIELD,
        )
        self.assertTrue(has_declaration(section, AUTO_LAUNCH_FIELD))
        self.assertEqual(declaration_count(section, AUTO_LAUNCH_FIELD), 1)
        self.assertTrue(
            AUTO_LAUNCH_FIELD.startswith("bool "),
            AUTO_LAUNCH_FIELD,
        )
        self.assertTrue(AUTO_LAUNCH_FIELD.endswith(";"), AUTO_LAUNCH_FIELD)
        self.assertIn("bAutoLaunchAfterBriefing", AUTO_LAUNCH_FIELD)
        self.assertIn("= true", AUTO_LAUNCH_FIELD)
        self.assertNotIn("false", AUTO_LAUNCH_FIELD)
        self.assertNotIn("TObjectPtr", AUTO_LAUNCH_FIELD)
        self.assertNotIn("TArray<", AUTO_LAUNCH_FIELD)
        self.assertNotIn("TSoftObjectPtr", AUTO_LAUNCH_FIELD)
        self.assertNotIn("INDEX_NONE", AUTO_LAUNCH_FIELD)
        self.assertNotIn("UFUNCTION", AUTO_LAUNCH_FIELD)
        self.assertNotIn("{", AUTO_LAUNCH_FIELD)
        self.assertNotIn("}", AUTO_LAUNCH_FIELD)
        self.assertNotIn("return ", AUTO_LAUNCH_FIELD)
        self.assertNotIn("AudioDirector", AUTO_LAUNCH_FIELD)
        self.assertNotIn("RadioChatter", AUTO_LAUNCH_FIELD)
        self.assertNotIn("SortiePresentation", AUTO_LAUNCH_FIELD)
        self.assertNotIn("CampaignDefinition", AUTO_LAUNCH_FIELD)
        self.assertNotIn("MissionDefinition", AUTO_LAUNCH_FIELD)
        self.assertNotIn("Readiness", AUTO_LAUNCH_FIELD)
        self.assertNotIn("bAutoInitialize", AUTO_LAUNCH_FIELD)
        self.assertNotIn("bAllowBoundedActorSpawning", AUTO_LAUNCH_FIELD)
        self.assertNotIn("PathfinderSpawnLocation", AUTO_LAUNCH_FIELD)
        self.assertNotIn("GetAircraft", AUTO_LAUNCH_FIELD)
        self.assertNotIn("ConfigureFromMission", AUTO_LAUNCH_FIELD)
        self.assertNotIn("AdvanceBriefing", AUTO_LAUNCH_FIELD)
        self.assertNotIn("SetAssetsReady", AUTO_LAUNCH_FIELD)
        self.assertNotIn("AcknowledgeAndLaunch", AUTO_LAUNCH_FIELD)
        self.assertNotIn("CanLaunch", AUTO_LAUNCH_FIELD)
        self.assertNotIn("GetElapsedSeconds", AUTO_LAUNCH_FIELD)
        self.assertNotIn("GetBriefingState", AUTO_LAUNCH_FIELD)
        self.assertNotIn("GetMinimumWarmupSeconds", AUTO_LAUNCH_FIELD)
        self.assertNotIn("GetBriefingText", AUTO_LAUNCH_FIELD)
        self.assertNotIn("GetRadioChatter", AUTO_LAUNCH_FIELD)
        self.assertNotIn("GetPresentation", AUTO_LAUNCH_FIELD)
        self.assertNotIn("GetMissionTitle", AUTO_LAUNCH_FIELD)
        self.assertNotIn("AcknowledgeBriefing", AUTO_LAUNCH_FIELD)
        self.assertNotIn("LaunchSortie", AUTO_LAUNCH_FIELD)
        self.assertNotIn("HullCollider", AUTO_LAUNCH_FIELD)
        self.assertNotIn("OpticalTracker", AUTO_LAUNCH_FIELD)
        self.assertNotIn("WeaponServo", AUTO_LAUNCH_FIELD)
        self.assertNotIn("CountermeasurePod", AUTO_LAUNCH_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", AUTO_LAUNCH_FIELD)
        self.assertNotIn("RadarNode", AUTO_LAUNCH_FIELD)
        self.assertNotIn("ESkyguardMission02WaveState", AUTO_LAUNCH_FIELD)
        self.assertNotIn("HarborIndustrial", AUTO_LAUNCH_FIELD)
        self.assertNotIn("MaxIntegrity", AUTO_LAUNCH_FIELD)
        self.assertNotIn("CurrentIntegrity", AUTO_LAUNCH_FIELD)
        self.assertNotIn(BRIEFING_FIELD, AUTO_LAUNCH_FIELD)
        self.assertNotIn("Briefing;", AUTO_LAUNCH_FIELD)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, AUTO_LAUNCH_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION01} {AUTO_LAUNCH_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            section = public_section(header)
            self.assertTrue(
                has_declaration(section, AUTO_LAUNCH_FIELD),
                section,
            )
            self.assertEqual(
                require_declaration(section, AUTO_LAUNCH_FIELD),
            ...
            self.assertEqual(
                declaration_count(section, AUTO_LAUNCH_FIELD),
                1,
            )
        one_line = f"{{\npublic:\n\t{AUTO_LAUNCH_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, AUTO_LAUNCH_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, AUTO_LAUNCH_FIELD), section)
        self.assertEqual(
            require_declaration(section, AUTO_LAUNCH_FIELD),
    ...
    def test_unassigned_auto_launch_does_not_satisfy(self) -> None:
        unassigned = "\tbool bAutoLaunchAfterBriefing;\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(unassigned, AUTO_LAUNCH_FIELD)
        self.assertIn("bAutoLaunchAfterBriefing", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(unassigned, AUTO_LAUNCH_FIELD))

    def test_false_default_does_not_satisfy(self) -> None:
        false_default = "\tbool bAutoLaunchAfterBriefing = false;\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(false_default, AUTO_LAUNCH_FIELD)
        self.assertIn("bAutoLaunchAfterBriefing", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(false_default, AUTO_LAUNCH_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("bAutoLaunchAfterBriefing", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, AUTO_LAUNCH_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{AUTO_LAUNCH_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, AUTO_LAUNCH_FIELD)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            AUTO_LAUNCH_FIELD.startswith("UFUNCTION"),
            AUTO_LAUNCH_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, AUTO_LAUNCH_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", AUTO_LAUNCH_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_auto_launch_cpp_body(self) -> None:
        locked_only = f"{AUTO_LAUNCH_FIELD}\n"
        self.assertNotIn("{", AUTO_LAUNCH_FIELD)
        self.assertNotIn("}", AUTO_LAUNCH_FIELD)
        self.assertNotIn("return ", AUTO_LAUNCH_FIELD)
        ...
        self.assertNotIn("return false", AUTO_LAUNCH_FIELD)
        self.assertNotIn("return true", AUTO_LAUNCH_FIELD)
        self.assertNotIn("CreateDefaultSubobject", AUTO_LAUNCH_FIELD)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{AUTO_LAUNCH_FIELD}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, AUTO_LAUNCH_FIELD)
        self.assertIn("bAutoLaunchAfterBriefing", AUTO_LAUNCH_FIELD)
        self.assertIn("bool ", AUTO_LAUNCH_FIELD)
        self.assertIn("= true", AUTO_LAUNCH_FIELD)
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, AUTO_LAUNCH_FIELD)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", AUTO_LAUNCH_FIELD)
        self.assertNotIn("CurrentIntegrity", AUTO_LAUNCH_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", AUTO_LAUNCH_FIELD)
    ...
    def test_contract_does_not_open_leftover_briefing_component_header(
        ...
        self.assertNotIn(leftover_header, AUTO_LAUNCH_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, AUTO_LAUNCH_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", AUTO_LAUNCH_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{AUTO_LAUNCH_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, AUTO_LAUNCH_FIELD),
            AUTO_LAUNCH_FIELD,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, AUTO_LAUNCH_FIELD)
        ...
        self.assertNotIn(BRIEFING_FIELD, locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 auto-launch-after-briefing field contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{AUTO_LAUNCH_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, AUTO_LAUNCH_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                AUTO_LAUNCH_FIELD.lower(),
                "mission01 auto-launch-after-briefing contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, AUTO_LAUNCH_FIELD)

    def test_contract_is_auto_launch_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertNotIn("return ", AUTO_LAUNCH_FIELD)
        self.assertNotIn("{", AUTO_LAUNCH_FIELD)
        self.assertTrue(AUTO_LAUNCH_FIELD.startswith("bool "))
        self.assertIn("bAutoLaunchAfterBriefing", AUTO_LAUNCH_FIELD)
        self.assertTrue(AUTO_LAUNCH_FIELD.endswith(";"))
        self.assertIn("= true", AUTO_LAUNCH_FIELD)
        self.assertIn(UPROPERTY_MISSION01, section)

    def test_sibling_director_fields_do_not_satisfy_auto_launch(self) -> None:
        for leftover in (
            ROOT_FIELD,
            BRIEFING_FIELD,
            AUDIO_DIRECTOR_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, AUTO_LAUNCH_FIELD))
            self.assertNotEqual(AUTO_LAUNCH_FIELD, leftover)
        self.assertIn(
            "Scripts/tests/test_mission01_briefing_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
