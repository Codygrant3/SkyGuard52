...
# Mission08 IntegrationReadiness bCampaignDefinitionValid
...
# bCampaignDefinitionValid FIELD / branch
...
# (between struct FSkyguardMission08IntegrationReadiness
# and the following UCLASS /
# ASkyguardMission08IntegrationDirector; not
# ASkyguardMission08IntegrationDirector public
...
class Mission08CampaignDefinitionValidFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 bCampaignDefinitionValid field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 bCampaignDefinitionValid contains "
