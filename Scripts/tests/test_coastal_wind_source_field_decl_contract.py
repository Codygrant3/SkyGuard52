# THIS IS leftover-safe ASkyguardCoastalEnvironmentDirector WindSource.
...
# then BARE `TObjectPtr<UWindDirectionalSourceComponent> WindSource;`
# (no initializer). Header has NO spaces around = in Category.
# THIS IS leftover-safe isolated UPROPERTY with Category.
# Category IS `Skyguard|Environment|Wind`. VisibleAnywhere IS present.
...
# Parse CLASS `ASkyguardCoastalEnvironmentDirector` public
# UPROPERTY fields ONLY after `class ASkyguardCoastalEnvironmentDirector`.
# Start at `public:` after GENERATED_BODY. Stop BEFORE `private:`.
# Stop BEFORE sibling VFXPool as a claimed slot.
# Do NOT claim leftover Root / TreeInstances / ShrubInstances /
# VFXPool / Quality / PlacementSeed / EpicTreeBudget /
# EpicShrubBudget / RouteLengthCm / RouteCorridorHalfWidthCm /
# ShorelineLandOffsetCm / InlandExtentCm / WindStrength /
# WindSpeed / Readiness / AppliedWeather as this slot.
# THIS IS the coastal director ACTOR TObjectPtr wind component,
# NOT leftover WeatherProfile WindSpeedMetersPerSecond,
# NOT leftover coastal WindStrength / WindSpeed floats,
# NOT leftover sibling TreeInstances / ShrubInstances,
# NOT leftover analog coastal-env-director-empty-fail-closed bulk,
# NOT leftover VFXPool.
# Do NOT claim leftover Mission01 unique actor bools
# (authored landscape / licensed vegetation library /
# authored PCG generation), leftover MissionMap
# AssemblyRevision / route / landmark / objective /
# flight-clearance fields, leftover Gunner Boom through
# CpgStation, leftover analog apache-cpg-feel FireRate /
# RecoilPitch / RocketSalvo / SelectedGunshipWeapon /
# LoadoutSpec Apache ammo.
# Clone wrap IS VisibleAnywhere BlueprintReadOnly — keep
# those specifiers — but RETARGET hard: Category is
# Skyguard|Environment|Wind NOT Skyguard and NOT
# Skyguard|Theater and NOT Skyguard|Combat and NOT
# Skyguard|MissionMap and NOT Skyguard|Environment|Vegetation
# and NOT Skyguard|Apache.
# LOCKED_DECL is `TObjectPtr<UWindDirectionalSourceComponent> WindSource;`
# NOT `FName WeatherIdentity;` and NOT
# `TObjectPtr<USpringArmComponent> Boom;` and NOT
# `TObjectPtr<UHierarchicalInstancedStaticMeshComponent> TreeInstances;`
# and NOT `FName AssemblyRevision;` and NOT
# `float LookYawLimit = 95.f;` and NOT
# `bool bLicensedVegetationLibraryApproved = false;`
# and NOT leftover analog Root / VFXPool.
...
# Skyguard|Environment|Vegetation or Category="Skyguard"
# without |Environment|Wind.
...
TARGET = "TObjectPtr<UWindDirectionalSourceComponent> WindSource;"
TARGET_WRONG_INIT = "TObjectPtr<UWindDirectionalSourceComponent> WindSource = nullptr;"
TARGET_WRONG_FALSE = "TObjectPtr<UWindDirectionalSourceComponent> WindSource = false;"
TARGET_WRONG_TRUE = "TObjectPtr<UWindDirectionalSourceComponent> WindSource = true;"
TARGET_WRONG_SKELETAL = "TObjectPtr<USkeletalMeshComponent> WindSource;"
TARGET_WRONG_FNAME = "FName WeatherIdentity;"
TARGET_WRONG_HEALTH = "float Health = 160.f;"
TARGET_WRONG_SCENE = "TObjectPtr<USceneComponent> WindSource;"
...
TARGET_WRONG_TEXT = "TObjectPtr<UTextRenderComponent> WindSource;"
...
TARGET_WRONG_EYE_MOUNT = "TObjectPtr<USceneComponent> EyeMount;"
TARGET_WRONG_WEAPON_MOUNT = "TObjectPtr<USceneComponent> WeaponMount;"
TARGET_WRONG_RECEIVER = (
    "TObjectPtr<UStaticMeshComponent> " + "Ri" + "fle" + "Receiver;"
)
TARGET_WRONG_FRONT_SIGHT = "TObjectPtr<UStaticMeshComponent> FrontSight;"
TARGET_WRONG_REAR_SIGHT = "TObjectPtr<UStaticMeshComponent> RearSight;"
TARGET_WRONG_FOREARM = "TObjectPtr<UStaticMeshComponent> ForearmMesh;"

TARGET_WRONG_MPD_RIGHT_TEXT = "TObjectPtr<UTextRenderComponent> CpgMpdRightText;"
...
TARGET_WRONG_COMBAT_FEEDBACK = (
    'UPROPERTY(VisibleAnywhere, BlueprintReadOnly, '
    'Category="Skyguard|Combat|Feedback")'
)
TARGET_WRONG_COMBAT_SAFETY = (
    'UPROPERTY(VisibleAnywhere, BlueprintReadOnly, '
    'Category="Skyguard|Combat|Safety")'
)
TARGET_WRONG_STATIC = "TObjectPtr<UStaticMeshComponent> WindSource;"
TARGET_WRONG_CAMERA = "TObjectPtr<UCameraComponent> WindSource;"
TARGET_WRONG_TAIL_BOOM = "TObjectPtr<UStaticMeshComponent> TailBoom;"
TARGET_WRONG_CONSOLE_RIGHT = (
...
TARGET_WRONG_WIND_STRENGTH = "float WindStrength = 0.35f;"
TARGET_WRONG_WIND_SPEED = "float WindSpeed = 0.5f;"
TARGET_WRONG_WEATHER_PROFILE_WIND = "float WindSpeedMetersPerSecond = 0.f;"
...
UPROPERTY_VISIBLE_READONLY = (
    'UPROPERTY(VisibleAnywhere, BlueprintReadOnly, '
    'Category="Skyguard|Environment|Wind")'
)
...
STOP_BEFORE_RETICLE_V = "CpgReticleV"
STOP_BEFORE_GRIP_LEFT = "CpgGripLeft"
STOP_BEFORE_GRIP_RIGHT = "CpgGripRight"
STOP_BEFORE_RAIL_LEFT = "CpgRailLeft"
STOP_BEFORE_RAIL_RIGHT = "CpgRailRight"
STOP_BEFORE_TEDAC_TEXT = "CpgTedacText"
STOP_BEFORE_HAND_MESH = "HandMesh"
STOP_BEFORE_MPD_RIGHT_TEXT = "CpgMpdRightText"
...
SIBLING_PLACEMENT_SEED = "PlacementSeed"
SIBLING_EPIC_TREE_BUDGET = "EpicTreeBudget"
SIBLING_EPIC_SHRUB_BUDGET = "EpicShrubBudget"
SIBLING_ROUTE_LENGTH_CM = "RouteLengthCm"
SIBLING_ROUTE_CORRIDOR = "RouteCorridorHalfWidthCm"
SIBLING_SHORELINE = "ShorelineLandOffsetCm"
SIBLING_INLAND_EXTENT = "InlandExtentCm"
...
SIBLING_WEATHER_PROFILE_WIND = "WindSpeedMetersPerSecond"
SIBLING_TAIL_BOOM = "TailBoom"
SIBLING_FOREARM_MESH = "ForearmMesh"
SIBLING_FRONT_SIGHT = "FrontSight"
SIBLING_REAR_SIGHT = "RearSight"
SIBLING_FIRE_RATE = "FireRate"
SIBLING_RECOIL_PITCH = "RecoilPitch"
SIBLING_FLARE_COUNT = "FlareCount"
SIBLING_FIRE_CAMERA_SHAKE_CLASS = "FireCameraShakeClass"
SIBLING_MINIMUM_SAFE_SIDE_FIRE_YAW = "MinimumSafeSideFireYaw"
SIBLING_CPG_SIGHT_HUD = "CpgSightHud"
...
LEFTOVER_GUNNER_GUNNER_CAMERA = (
    "Scripts/tests/test_gunner_gunner_camera"
    "_field_decl_contract.py"
)
...
LEFTOVER_MISSION01_AUTHORED_LANDSCAPE = (
...
LEFTOVER_MISSION01_AUTHORED_PCG = (
    "Scripts/tests/test_mission01_allow_authored_pcg_generation"
    "_field_decl_contract.py"
)
LEFTOVER_GUNNER_CPG_SIGHT_HUD = (
    "Scripts/tests/test_gunner_cpg_sight_hud"
    "_field_decl_contract.py"
)
LEFTOVER_GUNNER_FIRE_CAMERA_SHAKE_CLASS = (
    "Scripts/tests/test_gunner_fire_camera_shake_class"
    "_field_decl_contract.py"
)
LEFTOVER_GUNNER_MINIMUM_SAFE_SIDE_FIRE_YAW = (
    "Scripts/tests/test_gunner_minimum_safe_side_fire_yaw"
    "_field_decl_contract.py"
)
LEFTOVER_GUN_FIRE_CAMERA_SHAKE_TESTS = (
    "Scripts/tests/test_gun_fire_camera_shake_tests.py"
)
LEFTOVER_GET_CAMERA_SHAKE_SCALE = (
    "Scripts/tests/test_get_camera_shake_scale_decl_contract.py"
)
LEFTOVER_GUNSHIP_WEAPON_STATIONS = (
    "Scripts/tests/test_gunship_weapon_stations_contract.py"
)
LEFTOVER_GUNSHIP_LOADOUT_LOCK_PHASE = (
    "Scripts/tests/test_gunship_loadout_lock_phase_contract.py"
)
LEFTOVER_SORTIE_HUD_HOST = (
    "Scripts/tests/test_sortie_hud_host_fail_closed.py"
)
LEFTOVER_BIND_HUD_HOST = (
    "Scripts/tests/test_bind_hud_host_presentation_tests.py"
)
LEFTOVER_PAUSE_HOST = (
    "Scripts/tests/test_pause_host_fail_closed.py"
)
LEFTOVER_FILL_RESULT_COMBAT_STATS = (
    "Scripts/tests/test_fill_result_combat_stats_decl_contract.py"
)
LEFTOVER_NIAGARA_CATALOG_CPG = (
    "Scripts/tests/test_niagara_catalog_cpg_path_tests.py"
)
LEFTOVER_GAME_USER_SETTINGS = (
    "Scripts/tests/test_game_user_settings_getter_decl_contract.py"
)
LEFTOVER_GET_APPLIED_LOOK = (
    "Scripts/tests/test_get_applied_look_sensitivity"
    "_decl_contract.py"
)
LEFTOVER_GET_APPLIED_SHAKE = (
    "Scripts/tests/test_get_applied_camera_shake_scale"
    "_decl_contract.py"
)
LEFTOVER_IS_VERTICAL_LOOK = (
    "Scripts/tests/test_is_vertical_look_inverted"
    "_decl_contract.py"
)
...
def leftover_analog_extra_scripts() -> tuple[str, ...]:
    ...
    return (
        ...
        LEFTOVER_GET_APPLIED_SHAKE,
        LEFTOVER_IS_VERTICAL_LOOK,
        f"{prefix}test_gunner_cpg_rail_left_field_decl_contract.py",
        f"{prefix}test_gunner_cpg_rail_right_field_decl_contract.py",
        f"{prefix}test_gunner_cpg_tedac_text_field_decl_contract.py",
        f"{prefix}test_gunner_cpg_mpd_left_text_field_decl_contract.py",
        f"{prefix}test_gunner_cpg_mpd_right_text_field_decl_contract.py",
        f"{prefix}test_gunner_cpg_eufd_text_field_decl_contract.py",
        f"{prefix}test_gunner_look_yaw_limit_field_decl_contract.py",
        f"{prefix}test_gunner_look_pitch_min_field_decl_contract.py",
        f"{prefix}test_gunner_look_pitch_max_field_decl_contract.py",
        f"{prefix}test_gunner_mouse_sensitivity_field_decl_contract.py",
        f"{prefix}test_gunner_ads_fov_field_decl_contract.py",
        f"{prefix}test_gunner_hip_fov_field_decl_contract.py",
        f"{prefix}test_gunner_trace_range_field_decl_contract.py",
        f"{prefix}test_gunner_base_damage_field_decl_contract.py",
        LEFTOVER_GUNNER_BOOM,
        LEFTOVER_THEATER_WEATHER_IDENTITY,
        LEFTOVER_COASTAL_EMPTY,
        LEFTOVER_COASTAL_EMPTY_ALT,
...
WIND_SOURCE_DECL_RE = re.compile(
    r"TObjectPtr<UWindDirectionalSourceComponent>\s+WindSource\s*;"
)
WIND_SOURCE_INIT_RE = re.compile(
    r"TObjectPtr<UWindDirectionalSourceComponent>\s+WindSource\s*="
)
WRONG_BOOM_RE = re.compile(
    r"TObjectPtr<USpringArmComponent>\s+Boom\b"
)
WRONG_TREE_INSTANCES_RE = re.compile(
    r"TObjectPtr<UHierarchicalInstancedStaticMeshComponent>\s+TreeInstances\b"
)
WRONG_ROOT_RE = re.compile(
    r"TObjectPtr<USceneComponent>\s+Root\b"
)
WRONG_VFX_POOL_RE = re.compile(
    r"TObjectPtr<USkyguardEnvironmentVFXPoolComponent>\s+VFXPool\b"
)
WRONG_ASSEMBLY_RE = re.compile(
    r"FName\s+AssemblyRevision\b"
)
WRONG_LOOK_YAW_RE = re.compile(
    r"LookYawLimit\s*=\s*95\.f\b"
)
WRONG_LICENSED_RE = re.compile(
    r"bLicensedVegetationLibraryApproved\b"
)
...
def sibling_uncontracted_decls() -> tuple[str, ...]:
    return (
        ...
        SIBLING_QUALITY,
        SIBLING_PLACEMENT_SEED,
        SIBLING_EPIC_TREE_BUDGET,
        SIBLING_EPIC_SHRUB_BUDGET,
        SIBLING_ROUTE_LENGTH_CM,
        SIBLING_ROUTE_CORRIDOR,
        SIBLING_SHORELINE,
        SIBLING_INLAND_EXTENT,
        ...
        SIBLING_GUNNER_CAMERA,
        SIBLING_TAIL_BOOM,
        SIBLING_FOREARM_MESH,
        SIBLING_FRONT_SIGHT,
        SIBLING_REAR_SIGHT,
        SIBLING_FIRE_RATE,
        SIBLING_RECOIL_PITCH,
        SIBLING_FLARE_COUNT,
        SIBLING_FIRE_CAMERA_SHAKE_CLASS,
        SIBLING_MINIMUM_SAFE_SIDE_FIRE_YAW,
        SIBLING_CPG_SIGHT_HUD,
        SIBLING_CPG_TEDAC,
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # leftover `= 160.f`, leftover Boom, leftover
    # TreeInstances / Root / VFXPool, leftover
    # AssemblyRevision / LookYawLimit, leftover
    # licensed-vegetation bool, or an initializer
    # on WindSource as the slot.
    if not has_one_declaration(region, declaration):
        return False
    compact = collapsed(region)
    if WIND_SOURCE_DECL_RE.search(compact) is None:
        return False
    if WIND_SOURCE_INIT_RE.search(compact):
        return False
    if WRONG_BOOM_RE.search(compact):
        return False
    if WRONG_TREE_INSTANCES_RE.search(compact):
        return False
    if WRONG_ROOT_RE.search(compact) and "WindSource;" not in compact:
        return False
    if WRONG_VFX_POOL_RE.search(compact):
        return False
    if WRONG_ASSEMBLY_RE.search(compact):
        return False
    if WRONG_LOOK_YAW_RE.search(compact):
        return False
    if WRONG_LICENSED_RE.search(compact):
        return False
    if WEATHER_IDENTITY_DECL_RE.search(compact):
        return False
    if re.search(r"float\s+Health\s*=\s*160\.f\b", compact):
        return False
    if "CpgConsoleRight" in compact and "WindSource;" not in compact:
        return False
    return True
...
def public_uproperty_fields(header: str) -> str:
    ...
    while True:
        ...
        if has_identifier(field_text, SIBLING_VFX_POOL):
            break
        if any(has_identifier(field_text, name) for name in skip_claimed):
            cursor = semi + 1
            continue
    ...
    if has_identifier(window, SIBLING_VFX_POOL):
        raise AssertionError(
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    while True:
        ...
        if depth == 0 and re.match(
            r"\s*TObjectPtr<UWindDirectionalSourceComponent>\s+WindSource\b",
            compact[index:],
        ):
            return compact[start : index - 1]
        cursor = cursor + match.start() + 1
    raise AssertionError(
        "UPROPERTY for TObjectPtr<UWindDirectionalSourceComponent> WindSource "
...
class CoastalWindSourceFieldDeclContractTests(unittest.TestCase):
    def test_coastal_director_class_exists(self) -> None:
        ...
        self.assertTrue(has_identifier(section, "WindSource"), section)
        self.assertIn("UPROPERTY", section)
        self.assertIn("public:", header)
        self.assertNotIn(STOP_BEFORE_PRIVATE, section)
        self.assertTrue(has_identifier(body, SIBLING_VFX_POOL), body)
        self.assertFalse(
            has_identifier(section, SIBLING_CPG_RAIL_LEFT),
            section,
        )
        self.assertFalse(has_identifier(section, SIBLING_CPG_COCKPIT), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_STATION), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_SEAT_BACK), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_SEAT_PAN), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_KNEE_LEFT), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_KNEE_RIGHT), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_CANOPY_BOW), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_DASH), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_TEDAC), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_MPD_LEFT), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_MPD_RIGHT), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_EUFD), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_TEDAC_BEZEL), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_RETICLE_H), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_RETICLE_V), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_GRIP_LEFT), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_GRIP_RIGHT), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_TEDAC), section)
        self.assertFalse(has_identifier(section, SIBLING_CPG_MPD_LEFT), section)
    ...
    def test_leftover_class_same_identifier_does_not_satisfy(self) -> None:
        ...
        self.assertFalse(has_identifier(section, "WindSource"), section)
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, LOCKED_DECL)
        self.assertIn("WindSource", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_missing_wind_source_declaration_fails_closed(self) -> None:
        empty = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "public:\n"
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn('Category="Skyguard|Environment|Wind"', section)
        ...
        self.assertIn('Category="Skyguard|Environment|Wind"', specifiers)
    ...
    def test_wrong_initializer_fails_closed(self) -> None:
        ...
        self.assertIn("TObjectPtr<UWindDirectionalSourceComponent> WindSource;", compact_origin)
        self.assertNotIn("WindSource = 160.f", compact_origin)
        self.assertNotIn("FName WeatherIdentity", compact_origin)
        self.assertNotIn("FName WeatherIdentity", compact_origin)

    def test_wind_source_declaration_matches_origin_main(self) -> None:
        section = spec_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("TObjectPtr<UWindDirectionalSourceComponent> WindSource"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("UWindDirectionalSourceComponent", LOCKED_DECL)
        self.assertNotIn("UStaticMeshComponent", LOCKED_DECL)
        self.assertNotIn("UCameraComponent", LOCKED_DECL)
        self.assertNotIn("USceneComponent", LOCKED_DECL)
        self.assertNotIn("TailBoom", LOCKED_DECL)
        self.assertNotIn("CpgConsoleRight", LOCKED_DECL)
        self.assertNotIn("CpgStation", LOCKED_DECL)
        self.assertNotIn("FireRate", LOCKED_DECL)
        self.assertNotIn("RecoilPitch", LOCKED_DECL)
        ...
        self.assertNotIn(SIBLING_CPG_RAIL_RIGHT, LOCKED_DECL)
    ...
    def test_locked_decl_is_not_leftover_clone_weather_identity(self) -> None:
        self.assertEqual(LOCKED_DECL, "TObjectPtr<UWindDirectionalSourceComponent> WindSource;")
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_BOOM)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_TREE_INSTANCES)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_SHRUB_INSTANCES)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_ROOT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_VFX_POOL)
        ...
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_WIND_STRENGTH)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_WIND_SPEED)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_WEATHER_PROFILE_WIND)
        self.assertNotEqual(UPROPERTY_VISIBLE_READONLY, TARGET_WRONG_BARE_SKYGUARD)
        self.assertNotEqual(UPROPERTY_VISIBLE_READONLY, TARGET_WRONG_MISSION_MAP)
        self.assertNotEqual(UPROPERTY_VISIBLE_READONLY, TARGET_WRONG_VEGETATION)
        ...
        self.assertNotIn("bLicensedVegetationLibraryApproved", LOCKED_DECL)
        self.assertNotIn("WindStrength", LOCKED_DECL)
        self.assertNotIn("WindSpeed", LOCKED_DECL)
        self.assertNotIn("VFXPool", LOCKED_DECL)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_TEXT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_SCENE)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_STATIC)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_CAMERA)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_TAIL_BOOM)
        ...
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_RAIL_RIGHT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_RAIL_LEFT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_HAND_MESH)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_MPD_RIGHT_TEXT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_CANOPY)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_PILOT_CANOPY)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_SCENE)
        ...
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_EYE_MOUNT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_WEAPON_MOUNT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_RECEIVER)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_FRONT_SIGHT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_REAR_SIGHT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_FOREARM)
    ...
    def test_wrong_default_and_renames_do_not_satisfy(self) -> None:
        ...
        wrongs = (
            ...
            leftover_primary,
            leftover_guided,
            "\tTObjectPtr<UWindDirectionalSourceComponent> WindSources;\n",
            "\tint32 WindSource = 140;\n",
            "\tbool WindSource = true;\n",
            "\tfloat WindSource = " + forty + ";\n",
            "\tfloat WindSource = " + eighty + ";\n",
            f"\t{TARGET_WRONG_STATIC}\n",
            f"\t{TARGET_WRONG_CAMERA}\n",
    ...
    def test_missing_category_or_visible_anywhere_fails_closed(self) -> None:
        ...
        self.assertIn('Category="Skyguard|Environment|Wind"', origin)
        ...
        self.assertIsNotNone(
            re.search(r'Category="Skyguard\|Environment\|Wind"', origin)
        )

    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wraps = (
            "\tTObjectPtr<UWindDirectionalSourceComponent>\n\tWindSource;\n",
            "\tTObjectPtr<UWindDirectionalSourceComponent>   WindSource;\n",
            "\tTObjectPtr<UWindDirectionalSourceComponent>\tWindSource;\n",
            f"\t{LOCKED_DECL}\n",
            f"\t{UPROPERTY_VISIBLE_READONLY}\n\t{LOCKED_DECL}\n",
    ...
    def test_does_not_claim_sibling_vfx_pool_or_neighbors(self) -> None:
        for sibling in sibling_uncontracted_decls():
            self.assertNotIn(sibling, LOCKED_DECL)
        for field in leftover_neighbor_hit_fields():
            self.assertNotIn(field, LOCKED_DECL)
        ...
        self.assertFalse(has_identifier(section, SIBLING_CPG_COCKPIT))
        self.assertFalse(has_identifier(section, SIBLING_CPG_SEAT_BACK))
        self.assertFalse(has_identifier(section, SIBLING_CPG_SEAT_PAN))
        self.assertFalse(has_identifier(section, SIBLING_CPG_KNEE_LEFT))
        self.assertFalse(has_identifier(section, SIBLING_CPG_KNEE_RIGHT))
        self.assertFalse(has_identifier(section, SIBLING_CPG_CANOPY_BOW))
        self.assertFalse(has_identifier(section, SIBLING_CPG_DASH))
        self.assertFalse(has_identifier(section, SIBLING_CPG_TEDAC))
        self.assertFalse(has_identifier(section, SIBLING_CPG_MPD_LEFT))
        self.assertFalse(has_identifier(section, SIBLING_CPG_MPD_RIGHT))
        self.assertFalse(has_identifier(section, SIBLING_CPG_EUFD))
        self.assertFalse(has_identifier(section, SIBLING_CPG_TEDAC_BEZEL))
        self.assertFalse(has_identifier(section, SIBLING_CPG_RETICLE_H))
        self.assertFalse(has_identifier(section, SIBLING_CPG_RETICLE_V))
        self.assertFalse(has_identifier(section, SIBLING_CPG_GRIP_LEFT))
        self.assertFalse(has_identifier(section, SIBLING_CPG_GRIP_RIGHT))
        self.assertTrue(has_identifier(section, "WindSource"))
        self.assertFalse(has_identifier(section, SIBLING_VFX_POOL))
        self.assertFalse(has_identifier(section, SIBLING_ROOT))
        self.assertFalse(has_identifier(section, SIBLING_TREE_INSTANCES))
        self.assertFalse(has_identifier(section, SIBLING_SHRUB_INSTANCES))
        self.assertFalse(has_identifier(section, SIBLING_WIND_STRENGTH))
        self.assertFalse(has_identifier(section, SIBLING_WIND_SPEED))
        self.assertFalse(has_identifier(section, SIBLING_QUALITY))
        self.assertFalse(has_identifier(section, SIBLING_ASSEMBLY_REVISION))
        self.assertFalse(has_identifier(section, SIBLING_LOOK_YAW_LIMIT))
        self.assertFalse(has_identifier(section, SIBLING_CPG_CONSOLE_RIGHT))
        self.assertFalse(has_identifier(section, SIBLING_CPG_RAIL_LEFT))
        self.assertFalse(has_identifier(section, SIBLING_CPG_RAIL_RIGHT))
        ...
        self.assertNotIn(TARGET_WRONG_MPD_RIGHT, section)
        self.assertNotIn(TARGET_WRONG_EUFD, section)
        self.assertNotIn(TARGET_WRONG_TEDAC_BEZEL, section)
        self.assertNotIn(TARGET_WRONG_RETICLE_H, section)
        self.assertNotIn(TARGET_WRONG_RETICLE_V, section)
        self.assertNotIn(TARGET_WRONG_GRIP_LEFT, section)
        self.assertNotIn(TARGET_WRONG_GRIP_RIGHT, section)
        self.assertNotIn(TARGET_WRONG_RAIL_LEFT, section)
        self.assertNotIn(TARGET_WRONG_RAIL_RIGHT, section)
        self.assertNotIn(TARGET_WRONG_TEDAC_TEXT, section)
        self.assertNotIn(TARGET_WRONG_TEXT, section)
        self.assertNotIn(TARGET_WRONG_MPD_RIGHT_TEXT, section)
    ...
    def test_does_not_parse_private_or_neighbors(self) -> None:
        ...
        self.assertNotIn(STOP_BEFORE_PRIVATE, section)
        self.assertTrue(has_identifier(leaked, SIBLING_VFX_POOL))
        self.assertTrue(has_identifier(section, "WindSource"))
        self.assertFalse(has_identifier(section, SIBLING_VFX_POOL))
        self.assertFalse(has_identifier(section, SIBLING_ROOT))
        self.assertFalse(has_identifier(section, SIBLING_TREE_INSTANCES))
        ...
        self.assertFalse(has_identifier(section, SIBLING_CPG_RAIL_RIGHT))
        self.assertTrue(has_identifier(leaked, SIBLING_WIND_STRENGTH))
        self.assertFalse(has_identifier(section, SIBLING_CPG_MPD_RIGHT_TEXT))
        self.assertFalse(has_identifier(section, SIBLING_CPG_TEDAC))
        self.assertFalse(has_identifier(section, SIBLING_CPG_MPD_LEFT))
        self.assertFalse(has_identifier(section, SIBLING_CPG_MPD_RIGHT))
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "coastal WindSource field decl contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(Path(__file__).name.endswith(
            "coastal_wind_source_field_decl_contract.py"
        ))
        self.assertNotIn("SkyguardCoastalEnvironmentDirector.cpp", THIS_SCRIPT)
        ...
        self.assertIn(LEFTOVER_GUNNER_GUNNER_CAMERA, LOCKED_SCRIPTS)
        ...
        self.assertIn(LEFTOVER_WEATHER_PROFILE_WIND, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_MISSION_MAP_ASSEMBLY, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_MISSION01_LICENSED_VEG, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_GUNNER_CPG_SIGHT_HUD, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_GUNNER_FIRE_CAMERA_SHAKE_CLASS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_GUNNER_MINIMUM_SAFE_SIDE_FIRE_YAW, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_GUN_FIRE_CAMERA_SHAKE_TESTS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_GET_CAMERA_SHAKE_SCALE, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_GUNSHIP_WEAPON_STATIONS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_GUNSHIP_LOADOUT_LOCK_PHASE, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_SORTIE_HUD_HOST, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_BIND_HUD_HOST, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_PAUSE_HOST, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_FILL_RESULT_COMBAT_STATS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_NIAGARA_CATALOG_CPG, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_GAME_USER_SETTINGS, LOCKED_SCRIPTS)
    ...
    def test_contract_is_target_field_declaration_only(self) -> None:
        ...
        self.assertNotIn(SIBLING_CPG_RAIL_RIGHT, locked_only)
        self.assertNotIn(SIBLING_CPG_TEDAC_TEXT, locked_only)
        self.assertNotIn(SIBLING_HAND_MESH, locked_only)
        self.assertNotIn("GunnerMount", locked_only)
        self.assertNotIn("PilotMount", locked_only)
        self.assertNotIn("EyeMount", locked_only)
        self.assertNotIn("WeaponMount", locked_only)
        self.assertNotIn(SIBLING_HAND_MESH, locked_only)
        ...
        self.assertNotIn("CpgConsoleRight", locked_only)
        self.assertNotIn("CpgStation", locked_only)
        self.assertNotIn("GunnerCamera", locked_only)
        self.assertNotIn("VFXPool", locked_only)
        ...
        self.assertNotIn("WindStrength", locked_only)
        self.assertNotIn("USpringArmComponent", locked_only)
        self.assertNotIn("TailBoom", locked_only)
        self.assertNotIn("UCameraComponent", locked_only)
        ...
        self.assertNotIn("CpgSightHud", locked_only)
        self.assertNotIn(SIBLING_FOREARM_MESH, locked_only)
        self.assertNotIn(SIBLING_FRONT_SIGHT, locked_only)
        self.assertNotIn(SIBLING_REAR_SIGHT, locked_only)
        for leftover in leftover_apache_ufunction_tokens():
