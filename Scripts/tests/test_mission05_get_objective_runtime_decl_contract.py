...
# Mission05 Integration GetObjectiveRuntime
# on ASkyguardMission05IntegrationDirector. It is
# NOT leftover Mission04 GetObjectiveRuntime #660,
# NOT leftover Mission01 GetObjectiveRuntime #617,
# NOT leftover Mission03 GetObjectiveRuntime #638,
# NOT leftover objective-runtime fail-closed #6845,
# NOT leftover campaign GetObjectiveRuntime #313.
...
# leftover HandleBossPhaseChanged (UFUNCTION()
# not Blueprint), leftover GetSearchlightRuntime
# #7347, leftover GetNightBeatKit without
# UFUNCTION. Distinct from leftover briefing-widget /
...
# NotifyProtectedTargetDamage. Do not lock leftover
# Mission01 GetGunner / GetPathfinder. Do not lock
...
# leftover Mission01 GetObjectiveRuntime #617,
# leftover Mission03 GetObjectiveRuntime #638,
# leftover Mission04 GetObjectiveRuntime #660,
# leftover objective-runtime fail-closed #6845,
# leftover campaign GetObjectiveRuntime #313,
...
# NotifyThreatDestroyed #669. Skip leftover #664.
# Stay off leftover drafts #536–#673. Do not reopen
# closed #668/#669. leftover
...
# #660, leftover objective-runtime fail-closed
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission05IntegrationDirector::GetObjectiveRuntime",
    "SkyguardMission05IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission05GetObjectiveRuntimeDeclContractTests(unittest.TestCase):
    ...
    def test_get_objective_runtime_declaration_matches_origin_main(self) -> None:
        ...
        self.assertIn("()", GET_OBJECTIVE_RUNTIME)
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(leftover_m05_objectives, UFUNCTION_INTEGRATION)
        self.assertNotEqual(leftover_searchlight, UFUNCTION_INTEGRATION)
        self.assertNotEqual(leftover_substation, UFUNCTION_INTEGRATION)
        ...
        self.assertNotIn(leftover_m05_objectives, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_searchlight, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_substation, UFUNCTION_INTEGRATION)
        self.assertNotIn("Mission01", UFUNCTION_INTEGRATION)
        self.assertNotIn("Mission03", UFUNCTION_INTEGRATION)
        self.assertNotIn("Mission04", UFUNCTION_INTEGRATION)
        self.assertNotIn("Protection", UFUNCTION_INTEGRATION)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardTempestBoss", GET_OBJECTIVE_RUNTIME)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 GetObjectiveRuntime method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission05 GetObjectiveRuntime contains "
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tUSkyguardObjectiveRuntime* GetObjectiveRuntime() const { return nullptr; }\n"
            "};\n"
        )
    ...
    def test_leftover_handle_boss_phase_changed_does_not_satisfy(self) -> None:
        ...
        for token in LEFTOVER_HANDLE_BOSS_PHASE_CHANGED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("HandleBossPhaseChanged", GET_OBJECTIVE_RUNTIME)
    ...
    def test_leftover_is_core_playable_ready_does_not_satisfy(self) -> None:
        region = f"\t{IS_CORE_PLAYABLE_READY}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(region, GET_OBJECTIVE_RUNTIME)
        self.assertIn("GetObjectiveRuntime", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
