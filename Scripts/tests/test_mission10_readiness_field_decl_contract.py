...
class Mission10ReadinessFieldDeclContractTests(unittest.TestCase):
    ...
    def test_readiness_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FSkyguardMission10IntegrationReadiness "),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("Readiness", LOCKED_DECL)
        self.assertIn("FSkyguardMission10IntegrationReadiness", LOCKED_DECL)
    ...
    def test_contract_is_readiness_field_declaration_only(
        ...
        self.assertNotIn("return ", LOCKED_DECL)
        self.assertNotIn("{", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FSkyguardMission10IntegrationReadiness"))
        self.assertIn("Readiness", LOCKED_DECL)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_readiness_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
