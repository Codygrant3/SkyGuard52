...
# INDEX_NONE or lock SurvivorsAnchor
# construction in the .cpp. This is leftover-safe
# Mission08 SurvivorsAnchor FIELD
...
# cursor/mission08-root-field-decl-contract-c332,
# NOT leftover Mission08 RescueHelicopterAnchor
# #1045, NOT leftover Mission08 HoistCableAnchor
# #1046, NOT leftover Mission10
...
# RescueHelicopterAnchor #1045 /
# HoistCableAnchor #1046 / leftover RaftsAnchor
# (this-wave sibling) /
...
# not leftover Mission08 Root #1044,
# not leftover Mission08 RescueHelicopterAnchor #1045,
# not leftover Mission08 HoistCableAnchor #1046,
...
# methods #729-#749. Lock leftover Mission05
# closed-without-merge #665 #666 #668-#673. Do not
# reopen leftover #664. Do not lock leftover Mission08
# Root #1044 / RescueHelicopterAnchor #1045 /
# HoistCableAnchor #1046. RaftsAnchor stays a
# this-wave sibling.
...
# an isolated Python SurvivorsAnchor
# field declaration contract on
# ASkyguardMission08IntegrationDirector.
# NOT leftover Mission08 RescueHelicopterAnchor
# #1045, NOT leftover Mission08 Root #1044,
# NOT leftover Mission08 HoistCableAnchor #1046,
# NOT leftover Mission08 GetProtectedTarget #746.
LOCKED = {
...
class Mission08SurvivorsAnchorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("SurvivorsAnchor", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_survivors_anchor_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_survivors_anchor_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertIn("SurvivorsAnchor", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("SurvivorsAnchor;", locked_only)
    ...
    def test_contract_is_survivors_anchor_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_survivors_anchor(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_survivors_anchor_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_readiness_struct_does_not_satisfy_survivors_anchor(self) -> None:
        leftover = (
    ...
    def test_hoist_window_runtime_struct_does_not_satisfy_survivors_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_protected_target_runtime_struct_does_not_satisfy_survivors_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_storm_runtime_struct_does_not_satisfy_survivors_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_airfield_target_runtime_struct_does_not_satisfy_survivors_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_struct_does_not_satisfy_survivors_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_declaration_accepts_origin_main_default_forms(self) -> None:
        ...
        stem = "TObjectPtr<USceneComponent> SurvivorsAnchor"
