# THIS IS leftover-safe FSkyguardLandscapeVisibleAudit
...
# section only (after struct FSkyguardLandscapeVisibleAudit, before
...
STRUCT_NAME = "FSkyguardLandscapeVisibleAudit"
...
class LandscapeVisibleAuditErrorFieldDeclContractTests(unittest.TestCase):
    def test_landscape_visible_audit_struct_exists(self) -> None:
        ...
        self.assertIn("BoundsMinimum", section)
        ...
        self.assertIn("VisibleComponentCount", section)
        self.assertIn("RegisteredComponentCount", section)
    ...
    def test_parser_does_not_land_on_anchors_or_director(self) -> None:
        ...
        match = CLASS_RE.search(header)
        self.assertIsNotNone(match, header)
        self.assertIn("FSkyguardLandscapeVisibleAudit", match.group(0))
