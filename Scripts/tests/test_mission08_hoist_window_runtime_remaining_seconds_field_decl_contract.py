...
# hoist-window-runtime-defaults #214/#ec79. THIS IS NOT leftover
# StartHoistWindow #732 / AdvanceHoistWindow #734 /
# GetHoistRuntime #744. THIS IS NOT leftover Mission04
# searchlight-track RemainingSeconds #943. THIS IS NOT leftover
# CoveredSeconds. THIS IS NOT leftover Mission08
# ProtectedTargetRuntime Target #1129 / Integrity #1127 /
# bDestroyed #1128. THIS IS NOT leftover
...
# merge #665 #666 #668-#673, or open drafts #674-#1129.
...
# Mission08 HoistWindowRuntime RemainingSeconds
...
# This HoistWindowRuntime field sits after bActive and before
# CoveredSeconds in the public section.
# Skip leftover b + Ya + kRuntimeReady forever (it sits
# after bMapAssemblyReady and before bGunnerReady). This contract
# is RemainingSeconds after bActive and before CoveredSeconds.
# THIS IS NOT leftover CoveredSeconds. THIS IS NOT leftover
# Mission04 searchlight-track RemainingSeconds #943. THIS IS NOT
# leftover Mission09 protected-target enum #9246 / leftover
# protected-target-runtime-defaults #225 / leftover #bf28 /
# leftover ProtectedTargetRuntime Target #1129 / leftover
# Mission08 ProtectedTargetRuntime Integrity #1127 / leftover
# Mission08 ProtectedTargetRuntime bDestroyed #1128 / leftover
...
# drafts #674-#1129 including leftover Mission02
...
# fields. Do not parse FSkyguardMission08ProtectedTargetRuntime.
...
# drafts #674-#1129. Do not reopen leftover
...
REMAINING_SECONDS_WRONG = (
    "int32 RemainingSeconds = 0;"
)
COVERED_SECONDS_LEFTOVER = (
...
LEFTOVER_HOIST_WINDOW_NOT_LOCKED = (
    ...
    "test_mission08_advance_hoist_window_decl_contract.py",
    "test_mission08_get_hoist_runtime_decl_contract.py",
    "test_mission04_searchlight_track_remaining_seconds"
    "_field_decl_contract.py",
    "test_mission08_protected_target_runtime_integrity"
    "_field_decl_contract.py",
    "test_mission08_protected_target_runtime_target"
    "_field_decl_contract.py",
    "test_mission08_protected_target_runtime_destroyed"
    "_field_decl_contract.py",
)
...
class Mission08HoistWindowRuntimeRemainingSecondsFieldDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_bool = "\tbool RemainingSeconds = false;\n"
        leftover_enum = (
            "\tESkyguardMission08ProtectedTarget RemainingSeconds = "
            "ESkyguardMission08ProtectedTarget::RescueHelicopter;\n"
        )
        leftover_zero = f"\t{REMAINING_SECONDS_WRONG}\n"
        leftover_int32 = f"\t{INTEGRITY_LEFTOVER}\n"
        leftover_covered = f"\t{COVERED_SECONDS_LEFTOVER}\n"
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission08_hoist_window_runtime_remaining_seconds"
            "_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_hoist_window_runtime_remaining_seconds"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_parse_director_class_or_storm_runtime(
        ...
        with self.assertRaises(AssertionError) as raised:
            public_section(searchlight_only)
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        locked_only = f"{LOCKED_DECL}\n"
    ...
    def test_leftover_same_name_wave_count_contracts_stay_locked(
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_searchlight_track_remaining"
