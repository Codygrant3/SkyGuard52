...
# THIS IS NOT leftover Mission04 SearchlightStarboard sibling.
# THIS IS NOT leftover searchlight-track-runtime-defaults #7347.
# THIS IS NOT leftover Mission04 StartSearchlightWindow /
# AdvanceSearchlightTrack methods. THIS IS NOT leftover
# Mission01 Root #574 / Mission02 Root #845 / Mission03 Root
# #875 / Mission10 Root #786 / leftover environment-root #592.
...
# reopen open drafts #674-#906 (Mission03 RadioLineCount is
# #904, ObjectiveCount #905, WaveCount #906). LOCK leftover
# Mission10 route-phase enum #701a, leftover Mission10
# protected-group enum #6f9d, leftover Mission10 protected-
# runtime-defaults #7898. LOCK leftover convoy-route-state
# enum #d34e, leftover Mission03 wave-state enum #0242,
# leftover searchlight-track-runtime-defaults #7347. LOCK
# leftover radio-line-defaults #1dec. Skip leftover retired-
# mount spawn / runtime-ready entirely.
# Declaration presence only. Do not invent
# INDEX_NONE or lock Root
# construction in the .cpp. This is leftover-safe
# Mission04 SearchlightPort FIELD
...
# private, leftover Mission03 directors, or Mission01 / Mission02 / Mission05-10 directors.
...
# Mission03 ObjectiveCount FIELD, not leftover Mission03 Root,
...
LOCKED_DECL = SEARCHLIGHT_PORT_FIELD
...
# an isolated Python SearchlightPort
...
class Mission04SearchlightPortFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_searchlight_port_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_root_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("TObjectPtr<USpotLightComponent> "),
            LOCKED_DECL,
        )
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("SearchlightPort", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("TObjectPtr<USpotLightComponent>"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("SearchlightPort;", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 SearchlightPort field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 SearchlightPort field contains "
    ...
    def test_contract_is_searchlight_port_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_searchlight_port(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tTObjectPtr<USpotLightComponent> SearchlightPort = nullptr;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_searchlight_port_field"
                "_decl_contract.py"
            )
        )
        leftover_56_64 = (
    ...
    def test_readiness_struct_does_not_satisfy_searchlight_port(self) -> None:
        leftover = (
    ...
    def test_searchlight_track_runtime_struct_does_not_satisfy(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
