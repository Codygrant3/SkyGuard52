...
# INDEX_NONE or lock FuelControlStarboard construction
...
# FuelControlStarboard;`); accept that form and other
...
# FuelControlStarboard field declaration contract on
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardIronRainBoss::FuelControlStarboard",
    "SkyguardIronRainBoss.cpp",
    "SetExposed",
...
class IronRainFuelControlStarboardFieldDeclContractTests(unittest.TestCase):
    def test_iron_rain_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, FUEL_CONTROL_STARBOARD_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertIn("FuelControlStarboard", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_missing_fuel_control_starboard_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardIronRainBoss();\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertIn("FuelControlStarboard", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertIn("FuelControlStarboard", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UPROPERTY", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("VisibleAnywhere", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("BlueprintReadOnly", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("Category", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("BlueprintPure", UPROPERTY_PORT)
        self.assertNotIn("BlueprintCallable", UPROPERTY_PORT)
        self.assertIn("Skyguard|Mission09|Boss", UPROPERTY_PORT)
        self.assertIn("Mission09", UPROPERTY_PORT)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertIn("FuelControlStarboard", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUSkyguardBossWeakPointComponent* FuelControlStarboard;\n"
        )
        as_array = (
        ...
        scene = (
            "\tTObjectPtr<USceneComponent> FuelControlStarboard;\n"
        )
        mesh = (
            "\tTObjectPtr<UStaticMeshComponent> FuelControlStarboard;\n"
        )
        weak = (
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, FUEL_CONTROL_STARBOARD_FIELD)
            self.assertIn("FuelControlStarboard", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_fuel_control_starboard_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, FUEL_CONTROL_STARBOARD_FIELD),
            FUEL_CONTROL_STARBOARD_FIELD,
        )
        self.assertTrue(has_declaration(section, FUEL_CONTROL_STARBOARD_FIELD))
        self.assertEqual(declaration_count(section, FUEL_CONTROL_STARBOARD_FIELD), 1)
        self.assertTrue(
            FUEL_CONTROL_STARBOARD_FIELD.startswith(
                "TObjectPtr<USkyguardBossWeakPointComponent> "
            ),
            FUEL_CONTROL_STARBOARD_FIELD,
        )
        self.assertTrue(FUEL_CONTROL_STARBOARD_FIELD.endswith(";"), FUEL_CONTROL_STARBOARD_FIELD)
        self.assertIn("FuelControlStarboard", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            FUEL_CONTROL_STARBOARD_FIELD,
        )
        self.assertIn("TObjectPtr<", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("TArray<", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("=", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("INDEX_NONE", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("UFUNCTION", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("{", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("}", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("return ", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("CommandAntenna;", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("ControlLinkage", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("NoseCamera", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("DebrisCenter", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("DebrisTail", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("DebrisNose", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("DebrisSpine", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("AdvanceEncounter", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("ResetEncounterState", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("IsRouteStateSafe", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("GetRouteProgress", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("GetEffectiveSpeedMultiplier", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("IsAttackTelegraphActive", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("GetTelegraphsTriggered", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("RadarNode", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("BeginTerminalStrikeCycle", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("OpenGuidanceArrayExposure", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("IssueClimbCommand", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("DivertWreckFromCivilians", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("SetCivilianSeparationMeters", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("GetCivilianSeparationMeters", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("GetFinaleStage", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("IsClimbCommandIssued", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("IsWreckDiverted", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("GetObjectiveMilestonesReached", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("ESkyguardLastFlightStage", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("GetGunnerMount", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("FaceWorldLocation", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("PortGuidanceArray", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("DebrisArmorPort", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("SetSearchlightTracked", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("SetContactIdentified", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("SetLightningExposed", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("HullCollider", FUEL_CONTROL_STARBOARD_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_PORT} {FUEL_CONTROL_STARBOARD_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(
                declaration_count(section, FUEL_CONTROL_STARBOARD_FIELD),
                1,
            )
        one_line = f"{{\npublic:\n\t{FUEL_CONTROL_STARBOARD_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, FUEL_CONTROL_STARBOARD_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, FUEL_CONTROL_STARBOARD_FIELD),
            section,
    ...
    def test_assigned_fuel_control_starboard_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<USkyguardBossWeakPointComponent> "
            "FuelControlStarboard = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertIn("FuelControlStarboard", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, FUEL_CONTROL_STARBOARD_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("FuelControlStarboard", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, FUEL_CONTROL_STARBOARD_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{FUEL_CONTROL_STARBOARD_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, FUEL_CONTROL_STARBOARD_FIELD)
        ...
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_PORT, section)
        self.assertTrue(has_declaration(section, FUEL_CONTROL_STARBOARD_FIELD), section)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            FUEL_CONTROL_STARBOARD_FIELD.startswith("UFUNCTION"),
            FUEL_CONTROL_STARBOARD_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, FUEL_CONTROL_STARBOARD_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", FUEL_CONTROL_STARBOARD_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_fuel_control_starboard_cpp_body(self) -> None:
        locked_only = f"{FUEL_CONTROL_STARBOARD_FIELD}\n"
        self.assertNotIn("{", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("}", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("return ", FUEL_CONTROL_STARBOARD_FIELD)
        ...
        self.assertNotIn("SkyguardIronRainBoss.cpp", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("SkyguardIronRainBoss.cpp", locked_only)
        self.assertNotIn("return false", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("return true", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("CreateDefaultSubobject", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("SetExposed", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            FUEL_CONTROL_STARBOARD_FIELD,
        )
        self.assertNotIn("SetBossPhase", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", FUEL_CONTROL_STARBOARD_FIELD)

    def test_contract_does_not_relock_sibling_tempest_fields(self) -> None:
        locked_only = f"{FUEL_CONTROL_STARBOARD_FIELD}\n"
        for token in SIBLING_TEMPEST_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("PortDischargeBoom", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("StarboardDischargeBoom", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("EngineIntake", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("DebrisPortPanel", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("DebrisStarboardPanel", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("DebrisIntakePanel", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("RequiredLockStabilitySeconds", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            FUEL_CONTROL_STARBOARD_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_encounter_controller(
        ...
        for token in LEFTOVER_ENCOUNTER_CONTROLLER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("EncounterController", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_leftover_control_servo(self) -> None:
        ...
        for token in LEFTOVER_CONTROL_SERVO_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("ControlServo", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_sibling_iron_rain_fields(self) -> None:
        ...
        for token in SIBLING_IRON_RAIN_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("DispenserPort", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("DispenserCenter", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("MaxReleasesPerBay", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertIn("FuelControlStarboard", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_leftover_dispenser_starboard(
        ...
        for token in LEFTOVER_DISPENSER_STARBOARD_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("DispenserStarboard", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_leftover_get_maneuver(self) -> None:
        ...
        for token in LEFTOVER_GET_MANEUVER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("GetManeuver", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_open_first_window(), FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn(leftover_open_final_window(), locked_only)
        self.assertNotIn(leftover_open_final_window(), FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn(leftover_arm_command_core_path(), locked_only)
        self.assertNotIn(leftover_arm_command_core_path(), FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn(leftover_apply_strike(), locked_only)
        self.assertNotIn(leftover_apply_strike(), FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn(leftover_is_lock_eligible(), locked_only)
        self.assertNotIn(leftover_is_lock_eligible(), FUEL_CONTROL_STARBOARD_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, locked_only)
            self.assertNotIn(name, FUEL_CONTROL_STARBOARD_FIELD)
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_leftover_debris_getters(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("GetDefeatDebrisPieceCount", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("GetMaxDefeatDebrisPieces", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("SetSearchlightTracked", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("ASkyguardBlackKiteBoss", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            ...
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("SetContactIdentified", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("OpenOrbitExposure", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_NOT_LOCKED:
            ...
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest_methods(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("SetLightningExposed", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("ApplyCorrectiveBankGust", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("IsLightningExposed", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("GetLockStabilitySeconds", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn(leftover_advance_stabilized_lock(), FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn(leftover_arm_break_finish(), FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn(leftover_is_break_finish_armed(), FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        for token in LEFTOVER_PATROL_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("ASkyguardPatrolShip", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        ...
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            ...
            self.assertNotIn(neighbor, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("ASkyguardGunner", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("SkyguardRadarNode", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            ...
            self.assertNotIn(token, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("MaxIntegrity", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("CurrentIntegrity", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn(
            "SkyguardPathfinderEncounterController.h",
            FUEL_CONTROL_STARBOARD_FIELD,
        )
    ...
    def test_contract_does_not_open_leftover_weak_point_component_header(
        ...
        self.assertNotIn(leftover_header, FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, FUEL_CONTROL_STARBOARD_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", FUEL_CONTROL_STARBOARD_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{FUEL_CONTROL_STARBOARD_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, FUEL_CONTROL_STARBOARD_FIELD),
            FUEL_CONTROL_STARBOARD_FIELD,
        )
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardIronRainBoss::FuelControlStarboard", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "iron rain FuelControlStarboard field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{FUEL_CONTROL_STARBOARD_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, FUEL_CONTROL_STARBOARD_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                FUEL_CONTROL_STARBOARD_FIELD.lower(),
                "iron rain FuelControlStarboard contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, FUEL_CONTROL_STARBOARD_FIELD)

    def test_contract_is_fuel_control_starboard_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertTrue(FUEL_CONTROL_STARBOARD_FIELD.endswith(";"))
        self.assertNotIn("=", FUEL_CONTROL_STARBOARD_FIELD)
        self.assertIn(UPROPERTY_PORT, section)
