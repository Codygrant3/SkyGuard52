...
# INDEX_NONE or lock HoistCableAnchor
# construction in the .cpp. This is leftover-safe
# Mission08 HoistCableAnchor FIELD
...
# NOT leftover Mission08 Root / RescueHelicopterAnchor
# this-wave siblings, NOT leftover hoist-window-
# runtime-defaults #ec79, NOT leftover Mission08
# StartHoistWindow #732 / AdvanceHoistWindow #734 /
# GetHoistRuntime #744, NOT leftover Mission06 Root field
...
# Mission03 / Mission04 / Mission05 / Mission06 / Mission07 / Mission09-10 directors.
...
# drafts #674-#978, leftover Apache
...
# drafts #674-#1043 including leftover Mission03
...
RESCUE_HELICOPTER_ANCHOR_FIELD = (
    "TObjectPtr<USceneComponent> RescueHelicopterAnchor;"
)
HOIST_CABLE_ANCHOR_FIELD = (
    "TObjectPtr<USceneComponent> HoistCableAnchor;"
)
BRIEFING_FIELD = (
...
LOCKED_DECL = HOIST_CABLE_ANCHOR_FIELD
...
# an isolated Python HoistCableAnchor
...
class Mission08HoistCableAnchorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_hoist_cable_anchor_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        macro_only = f"\t{UPROPERTY_MISSION08_RESCUE}\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn(UPROPERTY_MISSION08_RESCUE, section)
        ...
        self.assertNotIn("BlueprintCallable", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("BlueprintPure", UPROPERTY_MISSION08_RESCUE)
        self.assertIn("Skyguard|Mission08|Rescue", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Skyguard|Mission02|Protection", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Integration", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Mission01", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Mission02", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Mission03", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Mission04", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Mission05", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Protection", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Search", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Waves", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Payload", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Targets", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Objectives", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Environment", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Briefing", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Mission10", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Boss", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Destruction", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Apache", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Mission06", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Mission07", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Mission09", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Encounter", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Safety", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Performance", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Hoist", UPROPERTY_MISSION08_RESCUE)
        self.assertIn("Rescue", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Evacuation", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Campaign", UPROPERTY_MISSION08_RESCUE)
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, UPROPERTY_MISSION08_RESCUE)
    ...
    def test_hoist_cable_anchor_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertIn("HoistCableAnchor", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION08_RESCUE} {LOCKED_DECL}\n"
            "};\n"
        )
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(environment, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(briefing, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(environment, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(briefing, UPROPERTY_MISSION08_RESCUE)
        leftover_m01 = (
            'UFUNCTION(BlueprintCallable, '
        ...
        self.assertNotEqual(leftover_m01, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m02, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_harbor, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m03, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m04, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m05, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m06, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_waves, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m05_waves, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_integration, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m07_ready, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m08_waves, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m08_hoist, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m08_safety, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m08_protection, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m08_ready, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m09_ready, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m09_waves, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m10_safety, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m09_protection, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m09_performance, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_m09_objectives, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_payload, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_targets, UPROPERTY_MISSION08_RESCUE)
        self.assertNotEqual(leftover_objectives, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m01, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m02, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_harbor, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m03, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m04, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m05, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m06, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m05_waves, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_integration, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m07_ready, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m08_waves, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m08_hoist, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m08_safety, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m08_protection, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m08_ready, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m09_ready, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m09_waves, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m10_safety, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m09_protection, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m09_performance, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn(leftover_m09_objectives, UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Mission01", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Mission02", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Mission03", UPROPERTY_MISSION08_RESCUE)
        self.assertNotIn("Mission04", UPROPERTY_MISSION08_RESCUE)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 HoistCableAnchor field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 HoistCableAnchor field contains "
    ...
    def test_contract_is_hoist_cable_anchor_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_hoist_cable_anchor(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_contract_does_not_relock_leftover_handle_boss_phase_changed(
        ...
        for token in LEFTOVER_HANDLE_BOSS_PHASE_CHANGED_NOT_LOCKED:
            ...
            self.assertNotIn(token, LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", UPROPERTY_MISSION08_RESCUE)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_hoist_cable_anchor_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission07_get_readiness_does_not_satisfy(self) -> None:
        ...
        self.assertIn("HoistCableAnchor", str(raised.exception))
        self.assertFalse(has_declaration(leftover_section, LOCKED_DECL))
        self.assertIn(
            "Scripts/tests/test_mission07_get_readiness"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
    ...
    def test_readiness_struct_does_not_satisfy_hoist_cable_anchor(self) -> None:
        leftover = (
    ...
    def test_search_track_runtime_struct_does_not_satisfy_hoist_cable_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_protected_target_runtime_struct_does_not_satisfy_hoist_cable_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_storm_runtime_struct_does_not_satisfy_hoist_cable_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_airfield_target_runtime_struct_does_not_satisfy_hoist_cable_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_struct_does_not_satisfy_hoist_cable_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_leftover_mission07_root_does_not_satisfy(self) -> None:
        ...
        self.assertNotEqual(LOCKED_DECL, ROOT_FIELD)
        self.assertFalse(has_declaration("\t" + ROOT_FIELD + "\n", LOCKED_DECL))

    def test_this_wave_sibling_anchors_do_not_satisfy(self) -> None:
        for leftover in (
            ROOT_FIELD,
            RESCUE_HELICOPTER_ANCHOR_FIELD,
    ...
    def test_hoist_window_runtime_struct_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
