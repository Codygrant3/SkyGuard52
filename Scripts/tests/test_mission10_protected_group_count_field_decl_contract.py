...
# INDEX_NONE or lock ProtectedGroupCount
# construction in the .cpp. This is leftover-safe
# Mission10 ProtectedGroupCount FIELD
...
# NOT leftover Mission10 bBriefingReady field /
...
# CampaignDefinition field #577 / branch cursor/
# mission01-campaign-definition-field-decl-
# contract-c332, NOT leftover Mission10
# bCampaignDefinitionValid field #811 / branch
# cursor/mission10-campaign-definition-valid-
# field-decl-contract-c332, NOT leftover
# Mission10 AudioDirector field #794 / branch
# cursor/mission10-audio-director-field-decl-
# contract-c332, NOT leftover Mission10
# SortiePresentation field #797 / branch cursor/
# mission10-sortie-presentation-field-decl-
# contract-c332, NOT leftover Mission10
# MissionDefinition field #799 / branch cursor/
# mission10-mission-definition-field-decl-
# contract-c332, NOT leftover Mission01
# environment-root field #592 / branch cursor/
# mission01-environment-root-field-decl-
# contract-c332, NOT leftover Mission10 Briefing field #795 /
...
# readiness-field-decl-contract-c332, NOT leftover Mission10 bProtectedGroupsReady #818, NOT leftover
# Mission10 campaign-runtime-started field, NOT leftover
...
# drafts #674-#822+, leftover Apache
...
PROTECTED_GROUP_COUNT_FIELD = (
    "int32 ProtectedGroupCount = 0;"
)
LOCKED_DECL = PROTECTED_GROUP_COUNT_FIELD
...
# an isolated Python ProtectedGroupCount
# field declaration contract on
# FSkyguardMission10IntegrationReadiness. Do not reopen leftover
# Mission10 bProtectedGroupsReady #818, leftover Mission10
# campaign-runtime-started field, leftover Mission10
# GetProtectedGroup #782, leftover Mission10
# GetSurvivingProtectedGroupCount #783, leftover Mission10
# NotifyProtectedGroupDamage #774, leftover Mission10 Readiness
# #809, leftover Mission10 protected-group enum #6f9d, leftover
# Mission10 protected-runtime-defaults #7898, leftover
# Mission10 Briefing #795, leftover Mission01 Briefing #568,
# leftover Mission10 bBriefingReady, leftover Mission10
# CampaignDefinition #798, leftover Mission01 CampaignDefinition
# #577, leftover Mission10 bCampaignDefinitionValid #811, leftover
# Mission10 AudioDirector #794, leftover Mission10 SortiePresentation
# #797, leftover Mission10 MissionDefinition #799, leftover Mission01
# environment-root #592, leftover Mission10 Readiness #809, leftover Mission01
...
class Mission10ProtectedGroupCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_protected_group_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_protected_group_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 ProtectedGroupCount"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("ProtectedGroupCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("ProtectedGroupCount", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 ProtectedGroupCount field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission10 ProtectedGroupCount contains "
    ...
    def test_contract_is_protected_group_count_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertNotIn("return ", LOCKED_DECL)
        self.assertNotIn("{", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 ProtectedGroupCount"))
        self.assertIn("ProtectedGroupCount", LOCKED_DECL)
    ...
    def test_sibling_director_fields_do_not_satisfy_protected_group_count(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_protected_group_count_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
