...
# (leftover LandscapeComponentCount #1176).
# Do NOT parse FSkyguardLandscapeVisibleAudit
# (leftover LandscapeComponentCount #1200).
# Do NOT parse FSkyguardLandscapeCaptureConfigurationResult
# (leftover ShowOnlyLandscapeComponentCount #1216).
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# LandscapeComponentCount. THIS IS NOT leftover VisibleAudit
...
# THIS IS NOT leftover CaptureConfig ShowOnlyLandscapeComponentCount #1216.
# THIS IS NOT leftover AuthoringResult LandscapeComponentCount.
# LOCK leftover landscape-material-compilation-defaults #01d4.
# LOCK leftover VisibleAudit LandscapeComponentCount #1200.
...
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# bSuccess FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# bool bSuccess = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# bSuccess. THIS IS NOT leftover VisibleAudit bSuccess #1199.
...
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# bSuccess FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bSuccess = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# Fail closed if the type or decl is missing, renamed, or
...
# BlueprintReadOnly bool bSuccess = false;
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_landscape_capture_config_show_only_landscape_component_count_field_decl_contract.py",
...
def has_declaration(region: str, declaration: str) -> bool:
    # Fail-closed on the authored default. Do not accept a wrong
    # type/default for FSkyguardLandscapeMaterialCompilationResult::
    # LandscapeComponentCount (must be int32 = 0).
    # THIS IS NOT leftover VisibleAudit LandscapeComponentCount #1200.
    # THIS IS NOT leftover EnvironmentReadiness LandscapeComponentCount #1176.
...
class LandscapeMaterialCompilationLandscapeComponentCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_landscape_component_count_declaration_matches_origin_main(self) -> None:
        ...
        self.assertFalse(
            has_declaration(
                "\tfloat LandscapeComponentCount = 0;\n",
                LOCKED_DECL,
            )
        )
        with self.assertRaises(AssertionError) as raised:
