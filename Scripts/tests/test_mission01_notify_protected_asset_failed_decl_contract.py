...
# Integration METHOD contract on
...
# Do not lock leftover Harbor ProtectAsset
# contracts. origin/main is a one-line method
# (`bool NotifyProtectedAssetFailed();`); accept
# that form, other one-line / split-line wraps,
# and an inline body without locking the body. Nearby origin/main
...
LEFTOVER_HARBOR_PROTECT_ASSET_NOT_LOCKED = (
    "SkyguardProtectAsset.h",
    "SkyguardProtectAsset.cpp",
    "ASkyguardProtectAsset",
    "test_protect_asset_decl_contract.py",
    "test_harbor_protect_asset_decl_contract.py",
)
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission01IntegrationDirector::NotifyProtectedAssetFailed",
    "SkyguardMission01IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission01NotifyProtectedAssetFailedDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        with_arg = "\tbool NotifyProtectedAssetFailed(bool bFailed);\n"
        with_name = (
            "\tbool NotifyProtectedAssetFailed(FName ObjectiveId);\n"
        )
        renamed = "\tbool NotifyProtectedAsset();\n"
        short_name = "\tbool NotifyFailed();\n"
        leftover_configure = f"\t{CONFIGURE_MISSION_DEFINITION}\n"
        leftover_init = f"\t{INITIALIZE_PLAYABLE_MISSION}\n"
        leftover_failed = f"\t{NOTIFY_OBJECTIVE_PROGRESS}\n"
    ...
    def test_notify_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("FName", NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_INTEGRATION} {NOTIFY_PROTECTED_ASSET_FAILED}\n"
            "};\n"
        )
    ...
    def test_contract_does_not_relock_leftover_harbor_scripts(self) -> None:
        ...
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        for token in LEFTOVER_HARBOR_PROTECT_ASSET_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 NotifyProtectedAssetFailed method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission01 NotifyProtectedAssetFailed contains "
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        self.assertNotIn("}", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("return ", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("return Other", NOTIFY_PROTECTED_ASSET_FAILED)
