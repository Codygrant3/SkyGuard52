...
# THIS IS leftover-safe Mission09 CampaignSaveUserIndex FIELD
# (declaration-only, one-line / split-line UPROPERTY wraps,
# including the meta ClampMin line; accept = 0) on
# ASkyguardMission09IntegrationDirector.
# THIS IS NOT leftover Mission08 director CampaignSaveUserIndex
# (same-name other mission; lock leftover Mission08 director
# Root #1044 through Readiness #1066). THIS IS NOT leftover
# Mission09 CampaignSaveSlotName #1095 / leftover Mission09
# CampaignDefinition #1091. THIS IS NOT leftover
# Mission07/06/05/04/03/02/01/10 same-name CampaignSaveUserIndex
# director-field drafts. THIS IS NOT leftover Mission09 Root
# #1083 through bAllowBoundedActorSpawning #1094 / leftover
# Mission09 CampaignSaveSlotName #1095. THIS IS NOT leftover
# Mission09 Blueprint UFUNCTION methods. THIS IS NOT leftover
# FSkyguardMission09IntegrationReadiness fields. THIS IS NOT
# leftover spawn-location / spawn-rotation fields and leftover
...
# defaults #5426 / leftover Mission09 pool-budget-defaults #4537.
...
# bMissionDefinitionValid #1067 through ProtectedTargetCount
# #1082. LOCK leftover Mission09 Blueprint UFUNCTION methods.
# LOCK leftover Mission09 Root #1083 through CampaignSaveSlotName
# #1095.
...
# Mission09 CampaignSaveUserIndex FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps, ClampMin on the next line,
# int32 default 0) on
# ASkyguardMission09IntegrationDirector. Note
# EditAnywhere / BlueprintReadWrite /
# Category Skyguard|Mission09|Campaign /
# int32 = 0, not VisibleAnywhere /
...
# origin/main is a split-line field
# (`int32 CampaignSaveUserIndex = 0;` with
# ClampMin meta on the UPROPERTY wrap);
...
# Category is Skyguard|Mission09|Campaign, not
...
# drafts #674-#1095, leftover Apache
...
# drafts #674-#1095 including leftover Mission03
...
UPROPERTY_MISSION09_CLAMP = 'meta=(ClampMin="0")'
...
LOCKED_DECL = CAMPAIGN_SAVE_USER_INDEX_FIELD
...
# an isolated Python CampaignSaveUserIndex
...
LEFTOVER_MISSION09_CAMPAIGN_SAVE_SLOT_NAME_NOT_LOCKED = (
    CAMPAIGN_SAVE_SLOT_NAME_FIELD,
    "test_mission09_campaign_save_slot_name_field_decl_contract.py",
)
...
class Mission09CampaignSaveUserIndexFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_campaign_save_user_index_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn(UPROPERTY_MISSION09_CLAMP, section)
        self.assertIn('ClampMin="0"', section)
        ...
        self.assertIn("Campaign", UPROPERTY_MISSION09)
        self.assertIn("Skyguard|Mission09|Campaign", UPROPERTY_MISSION09)
    ...
    def test_campaign_save_user_index_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 CampaignSaveUserIndex"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("CampaignSaveUserIndex", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("CampaignSaveUserIndex", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 CampaignSaveUserIndex"))
    ...
    def test_harbor_40_80_tokens_fail_closed_if_present(self) -> None:
        ...
        # locked declaration only (Mission08/09-only retune).
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 CampaignSaveUserIndex field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 CampaignSaveUserIndex field contains "
    ...
    def test_contract_is_campaign_save_user_index_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission09_campaign_save_user_index_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_campaign_save_user_index_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_airfield_target_runtime_does_not_satisfy_campaign_save_user_index(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_does_not_satisfy_campaign_save_user_index(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_search_track_runtime_does_not_satisfy_campaign_save_user_index(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_protected_target_runtime_does_not_satisfy_campaign_save_user_index(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_leftover_mission08_sibling_campaign_fields_stay_locked(
        ...
        for leftover in (
            ...
            "_field_decl_contract.py",
            "Scripts/tests/test_mission09_root_field"
            "_decl_contract.py",
