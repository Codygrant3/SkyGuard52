...
# Mission07 IntegrationReadiness bBriefingReady
...
# bBriefingReady FIELD (declaration-only). It is
# NOT leftover Mission06 bBriefingReady
# FIELD #1004 / branch cursor/mission06-
# briefing-ready-field-decl-contract-c332,
# NOT leftover Mission07 director Briefing
# FIELD #1012 / branch cursor/mission07-
...
# bSearchRuntimeReady / bProtectedTargetsReady
...
# This readiness-struct field sits after bProtectedTargetsReady.
# Skip leftover b + Ya + kRuntimeReady forever (it sits
# after bMapAssemblyReady and before bGunnerReady). This contract
# is bBriefingReady after bProtectedTargetsReady. Skip leftover
...
class Mission07BriefingReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 bBriefingReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission07 bBriefingReady contains "
