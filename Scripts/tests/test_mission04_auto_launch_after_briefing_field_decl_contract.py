...
# Mission04 bAutoLaunchAfterBriefing FIELD
...
# #582 / branch cursor/mission01-auto-launch-
...
# / branch cursor/mission03-auto-launch-
# after-briefing-field-decl-contract-c332, NOT leftover
# Mission10 auto-launch-after-briefing FIELD
# / branch cursor/mission10-auto-launch-
# after-briefing-field-decl-contract-c332, NOT leftover
...
class Mission04AutoLaunchAfterBriefingFieldDeclContractTests(unittest.TestCase):
    ...
    def test_readiness_struct_does_not_satisfy_director_field_lock(self) -> None:
        header = origin_main_header()
        match = re.search(
            r"struct\s+FSkyguardMission04IntegrationReadiness\b.*?\{(.*?)\n\};",
            header,
            re.S,
        )
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_auto_launch_after_briefing_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
