...
# bLightningActive FIELD (declaration-only;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission05 StormRuntime
# bLightningActive FIELD (declaration-only). THIS IS NOT leftover
...
# INDEX_NONE or lock bLightningActive
# construction in the .cpp. This is leftover-safe
# Mission05 StormRuntime bLightningActive
...
# bLightningActive FIELD (declaration-only). It is
...
# This StormRuntime field sits after Turbulence and before
# LightningRemainingSeconds in the public section.
# Skip leftover b + Ya + kRuntimeReady forever (it sits
# after bMapAssemblyReady and before bGunnerReady). This contract
# is bLightningActive after Turbulence and before
# LightningRemainingSeconds. THIS IS NOT leftover storm-
# runtime-defaults #89c9. THIS IS NOT leftover GetStormRuntime
# / AdvanceTurbulence / TriggerLightningWindow /
# AdvanceLightningWindow. THIS IS NOT leftover in-flight
# StormRuntime Turbulence. THIS IS NOT leftover Mission05 PTR
# Target #1147 / Integrity #1148 / bDestroyed #1149. THIS IS NOT
...
# parse leftover FSkyguardMission05ProtectedTargetRuntime. Pathfinder MinHeightFromOriginCm
...
LIGHTNING_ACTIVE_WRONG = (
    "int32 bLightningActive = 0;"
)
LOCKED_DECL = LIGHTNING_ACTIVE
...
# an isolated Python StormRuntime
# bLightningActive field declaration contract on
...
LEFTOVER_STORM_RUNTIME_NOT_LOCKED = (
    ...
    "test_mission05_storm_runtime_turbulence_field_decl_contract.py",
    "test_mission05_get_storm_runtime_decl_contract.py",
    "test_mission05_advance_turbulence_decl_contract.py",
...
class Mission05StormRuntimeLightningActiveFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bLightningActive", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_lightning_active_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_zero = f"\t{LIGHTNING_ACTIVE_WRONG}\n"
    ...
    def test_integrity_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bLightningActive"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bLightningActive", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bLightningActive", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bLightningActive"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bLightningActive", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 StormRuntime lightning-active field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 StormRuntime lightning-active contains "
    ...
    def test_contract_is_lightning_active_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_integrity(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission05_storm_runtime_lightning_active"
            "_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_storm_runtime_lightning_active"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_parse_director_class_or_ptr_runtime(
        self,
    ) -> None:
        header = origin_main_header()
        match = CLASS_RE.search(header)
        ...
        self.assertNotIn("OffshorePlatform", section)
        self.assertNotIn("DistressedTrawler", section)
        self.assertNotIn("bDestroyed", section)
        self.assertNotIn("Integrity = 100", section)
        self.assertNotIn(
            "ASkyguardMission07IntegrationDirector",
            section,
        )
        ...
        self.assertTrue(
            has_declaration(storm_section, LOCKED_DECL),
            storm_section,
        )
        ptr_only = (
    ...
    def test_leftover_same_name_wave_count_contracts_stay_locked(
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_storm_runtime_turbulence"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
