...
# Mission05 IntegrationReadiness bAudioReady
...
# bAudioReady FIELD #869 / branch cursor/mission02-
...
# NOT leftover Mission05 director AudioDirector
# UPROPERTY #948 / branch cursor/mission05-
# audio-director-field-decl-contract-c332,
# NOT leftover Mission05 director field drafts
# Root #947 through TempestSpawnRotation #962,
...
# drafts #674-#971 including leftover Mission02
...
AUDIO_READY_FIELD_TRUE = (
    "bool bAudioReady = true;"
)
LOCKED_DECL = AUDIO_READY_FIELD
...
# bMapAssemblyReady stay leftover-only.
LOCKED = {
...
class Mission05AudioReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        for header in (
            ...
            section = public_section(header)
            self.assertTrue(
                has_declaration(section, AUDIO_READY_FIELD_TRUE),
                section,
            )
            self.assertEqual(
                require_declaration(
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 bAudioReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 bAudioReady contains "
    ...
    def test_leftover_same_name_audio_ready_contracts_stay_locked(
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_audio_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission02_audio_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission03_audio_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_audio_director"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
