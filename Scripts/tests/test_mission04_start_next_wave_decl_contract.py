...
# Integration, not Searchlight, not Substation,
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission04IntegrationDirector::StartNextWave",
    "SkyguardMission04IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission04StartNextWaveDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("BlueprintPure", START_NEXT_WAVE)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        as_int = "\tint32 StartNextWave();\n"
        with_arg = "\tbool StartNextWave(int32 Amount = 1);\n"
        ...
        as_void_name = "\tvoid StartNextWave() const;\n"
    ...
    def test_start_next_wave_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("static ", START_NEXT_WAVE)
        self.assertNotIn(
            "const USkyguardMissionDefinition* Mission",
            START_NEXT_WAVE,
        )
        ...
        self.assertNotIn("EnvironmentReadiness", START_NEXT_WAVE)
        self.assertNotIn("MissionMapReadiness", START_NEXT_WAVE)
        ...
        self.assertNotIn("TSoftObjectPtr<USkyguardMissionDefinition>", START_NEXT_WAVE)
        ...
        self.assertNotIn("ValidateDefinition", START_NEXT_WAVE)
        ...
        self.assertNotIn("ESkyguardMission03WaveState", START_NEXT_WAVE)
        self.assertNotIn("NotifyThreatDestroyed", START_NEXT_WAVE)
        self.assertNotIn("GetWaveState", START_NEXT_WAVE)
        self.assertNotIn("GetCurrentWaveIndex", START_NEXT_WAVE)
        ...
        self.assertNotIn("ESkyguardMission04WaveState", START_NEXT_WAVE)
    ...
    def test_environment_category_does_not_satisfy_waves(self) -> None:
        ...
        self.assertNotEqual(searchlight, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_mission03, UFUNCTION_WAVES)
        self.assertNotIn(environment, UFUNCTION_WAVES)
        self.assertNotIn(briefing, UFUNCTION_WAVES)
        self.assertNotIn(integration, UFUNCTION_WAVES)
        self.assertNotIn(searchlight, UFUNCTION_WAVES)
        self.assertNotIn(leftover_mission03, UFUNCTION_WAVES)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 StartNextWave method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission04 StartNextWave contains "
    ...
    def test_contract_is_start_next_wave_declaration_only(
        ...
        self.assertNotIn("TArray<FText>& OutErrors", START_NEXT_WAVE)
        self.assertNotIn("static ", START_NEXT_WAVE)
        self.assertTrue(
            START_NEXT_WAVE.endswith(");"),
            START_NEXT_WAVE,
    ...
    def test_leftover_mission_definition_validate_does_not_satisfy(self) -> None:
        ...
        self.assertNotIn(MISSION_DEFINITION_VALIDATE, START_NEXT_WAVE)
        self.assertIn(
            "Scripts/tests/test_mission_definition_validate_definition"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
