...
# Mission08 Waves StartNextWave
# on ASkyguardMission08IntegrationDirector. It is
# NOT leftover Mission07 StartNextWave
...
class Mission08StartNextWaveDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 StartNextWave method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission08 StartNextWave contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_start_next_wave"
                "_decl_contract.py"
            )
        )
        self.assertIn(
