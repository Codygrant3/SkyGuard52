...
# RoutePointCount FIELD (declaration-only;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe MissionMapReadiness
# RoutePointCount. THIS IS NOT leftover mission-map-
...
# UPROPERTY(Transient).
# THIS IS leftover-safe MissionMapReadiness
# RoutePointCount. THIS IS NOT leftover Mission05
...
# BlueprintReadOnly int32 RoutePointCount = 0;
...
# RoutePointCount FIELD (declaration-only). It is
...
TARGET = "int32 RoutePointCount = 0;"
TARGET_WRONG = "int32 RoutePointCount = 1;"
LOCKED_DECL = TARGET
...
class MissionMapReadinessRoutePointCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("RoutePointCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_route_point_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_route_point_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 RoutePointCount"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("RoutePointCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("RoutePointCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 RoutePointCount"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("RoutePointCount", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_route_point_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
