...
# GeneratedPCGComponentCount. THIS IS NOT leftover LandscapeComponentCount
# #1238. THIS IS NOT leftover GraphNodeCount #1237. THIS IS NOT leftover
# GraphEdgeCount #1240. THIS IS NOT leftover MaterialCompilation
# GeneratedMaterialInstanceCount #1225. THIS IS NOT leftover
# mission01-environment-authoring-result-defaults #df1a. Distinct from
# sibling GeneratedPCGInstanceCount (next leftover-safe int32).
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGComponentCount FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# int32 GeneratedPCGComponentCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# Fail closed if the type or decl is missing, renamed, or
# Category= is added. Parse STRUCT public section only AFTER
...
# #df1a, leftover AuthoringResult through #1241, leftover
# MaterialCompilation through Error #1232, leftover
# LandscapeComponentCount #1238 / GraphNodeCount #1237 /
# GraphEdgeCount #1240 / MaterialCompilation
# GeneratedMaterialInstanceCount #1225.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGComponentCount. THIS IS NOT leftover mission01-environment-authoring-
# result-defaults #df1a. THIS IS NOT leftover director AuthoredPCGGraph
# #594. THIS IS NOT leftover AuthoringResult Graph (TObjectPtr) #1234.
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGComponentCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 GeneratedPCGComponentCount = 0; one-line / split-line
# UPROPERTY wraps; origin/main has NO Category).
# Fail closed if the type or decl is missing, renamed, or Category=
# is added. Parse STRUCT public section only AFTER
# struct FSkyguardMission01EnvironmentAuthoringResult and BEFORE
# class USkyguardMission01EnvironmentAuthoringLibrary.
# Do NOT parse USkyguardMission01EnvironmentAuthoringLibrary methods.
# Do NOT parse ASkyguardMission01EnvironmentDirector.
...
# LOCK leftover drafts #56-#64 plus leftover enum/defaults PRs
# including leftover mission01-environment-authoring-result-defaults
# #df1a, leftover landscape-material-compilation-defaults #01d4,
# leftover director AuthoredPCGGraph #594, leftover AuthoringResult
# bSuccess #1235 / Landscape #1233 / Graph #1234, leftover
# MaterialCompilation through Error #1232. LOCK leftover
# EnvironmentReadiness bAuthoredPCGGraphBound. LOCK in-flight
# leftover-safe EnvironmentAuthoringResult Success / Landscape /
# Graph field siblings; do not edit them.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGComponentCount. THIS IS NOT leftover mission01-environment-authoring-result-
# defaults #df1a. THIS IS NOT leftover director AuthoredPCGGraph #594.
# THIS IS NOT leftover EnvironmentReadiness bAuthoredPCGGraphBound.
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGComponentCount FIELD (declaration-only; VisibleAnywhere / BlueprintReadOnly
# int32 GeneratedPCGComponentCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# Fail closed if the type or decl is missing, renamed, or Category=
# is added. Parse STRUCT public section only AFTER
...
# including leftover mission01-environment-authoring-result-defaults
# #df1a, leftover landscape-material-compilation-defaults #01d4,
# leftover director AuthoredPCGGraph #594, leftover
# CaptureConfigurationResult #1214-#1224, leftover MaterialCompilation
# through Error #1232. LOCK leftover EnvironmentReadiness
# bAuthoredPCGGraphBound. LOCK in-flight leftover-safe
# EnvironmentAuthoringResult Success / Landscape field siblings;
# do not edit them.
# Harbor 40/80 fail-closed in this Mission01-related test file.
# Ban retired live-copy tokens via split tokens
# (b + Ya + kRuntimeReady). Stay Apache CPG 30 mm / Hydra /
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGComponentCount. THIS IS NOT leftover VisibleAudit
# GeneratedMaterialInstanceReadyComponentCount #1205. THIS IS NOT
# leftover CaptureConfig GeneratedMaterialInstanceReadyComponentCount
# #1218. THIS IS NOT leftover landscape-material-compilation-defaults
# #01d4. LOCK leftover VisibleAudit
# GeneratedMaterialInstanceReadyComponentCount #1205. LOCK leftover
# CaptureConfig GeneratedMaterialInstanceReadyComponentCount #1218.
# LOCK leftover landscape-material-compilation-defaults #01d4.
# Do NOT parse FSkyguardLandscapeVisibleAudit (leftover
# GeneratedMaterialInstanceReadyComponentCount #1205 is a DIFFERENT
# field). Do NOT parse FSkyguardLandscapeCaptureConfigurationResult
# (leftover GeneratedMaterialInstanceReadyComponentCount #1218 is a
# DIFFERENT field).
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGComponentCount FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# int32 GeneratedPCGComponentCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# DEFAULT IS `= 0` NOT `= 1`. Fail closed if the type
# or decl is missing, renamed, or Category= is added. Parse STRUCT public section only AFTER
# struct FSkyguardMission01EnvironmentAuthoringResult and BEFORE
# class USkyguardMission01EnvironmentAuthoringLibrary.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGComponentCount. THIS IS NOT leftover VisibleAudit bSuccess #1199.
...
# int32 GeneratedPCGComponentCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# DEFAULT IS `= 0` NOT `= 1` (NOT leftover
...
# Do NOT parse FSkyguardLandscapeVisibleAudit (leftover bSuccess #1199).
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGComponentCount. THIS IS NOT leftover
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGComponentCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 GeneratedPCGComponentCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# Fail closed if the type or decl is missing, renamed, or
...
# BlueprintReadOnly int32 GeneratedPCGComponentCount = 0;
...
# #b931, or private
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
...
TARGET = "int32 GeneratedPCGComponentCount = 0;"
TARGET_WRONG = "int32 GeneratedPCGComponentCount = 1;"
LOCKED_DECL = TARGET
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_landscape_visible_audit_generated_material_instance_ready_component_count_field_decl_contract.py",
    "Scripts/tests/test_landscape_capture_config_generated_material_instance_ready_component_count_field_decl_contract.py",
    "Scripts/tests/test_landscape_material_compilation_defaults_contract.py",
...
def has_declaration(region: str, declaration: str) -> bool:
    # Fail-closed on the authored int32 default. Do not accept a
    # renamed or nonzero default for
    # FSkyguardMission01EnvironmentAuthoringResult::GeneratedPCGComponentCount
    # (must be int32 GeneratedPCGComponentCount = 0;).
    # THIS IS NOT leftover VisibleAudit bSuccess #1199.
    # THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*int32\s+GeneratedPCGComponentCount\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for int32 GeneratedPCGComponentCount is missing from "
...
class Mission01EnvironmentAuthoringResultGeneratedPCGComponentCountFieldDeclContractTests(unittest.TestCase):
    def test_mission01_environment_authoring_result_struct_exists(self) -> None:
        ...
        self.assertIn("GeneratedPCGComponentCount", section)
        self.assertIn("Landscape", section)
        self.assertIn("LandscapeComponentCount", section)
        self.assertIn("VisibleAudit", section)
        self.assertNotIn("GeneratedMaterialInstanceCount", section)
        self.assertNotIn("MaterialResourceCount", section)
        self.assertNotIn("CompilationFinishedResourceCount", section)
        ...
        self.assertNotIn("bValid", LOCKED_DECL)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("GeneratedPCGComponentCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_generated_pcg_component_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_generated_pcg_component_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 GeneratedPCGComponentCount"),
            LOCKED_DECL,
        )
        ...
        self.assertFalse(
            has_declaration(
                "\tint32 GeneratedPCGComponentCount = 1;\n",
                LOCKED_DECL,
            )
        )
        with self.assertRaises(AssertionError) as raised:
        ...
        self.assertIn("GeneratedPCGComponentCount", LOCKED_DECL)
        self.assertNotIn("TObjectPtr<UPCGGraph> Graph;", LOCKED_DECL)
        self.assertNotIn("GraphEdgeCount", LOCKED_DECL)
        self.assertNotIn("GraphNodeCount", LOCKED_DECL)
        self.assertNotIn("LandscapeComponentCount", LOCKED_DECL)
        self.assertNotIn("GeneratedPCGInstanceCount", LOCKED_DECL)
        ...
        self.assertNotIn("TObjectPtr<UPCGGraph>", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("GeneratedPCGComponentCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 GeneratedPCGComponentCount"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("GeneratedPCGComponentCount", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_generated_pcg_component_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_landscape_material_compilation"
            "_generated_material_instance_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
        ...
        self.assertIn(
            "Scripts/tests/test_landscape_capture_config"
            "_view_mode_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_capture_config"
