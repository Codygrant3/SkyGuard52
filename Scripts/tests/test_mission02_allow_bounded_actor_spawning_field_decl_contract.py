...
# NOT leftover Mission10 bAllowBoundedActorSpawning field
...
# Do not parse FSkyguardMission02IntegrationReadiness,
# private, or Mission01 / Mission03-10 directors.
...
# bAllowBoundedActorSpawning #581, not leftover Mission10
# bAllowBoundedActorSpawning #801, not leftover Mission01
...
# drafts #674-#851 including leftover Mission02
# siblings #828-#850 and leftover Mission10
# bAllowBoundedActorSpawning #801.
...
# Mission01 / Mission03-10 bAutoInitialize /
# auto-initialize field contracts, leftover
# Mission01 / Mission03-10 bAllowBoundedActorSpawning /
# allow-bounded-actor-spawning field contracts,
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission02IntegrationDirector::bAllowBoundedActorSpawning",
    "SkyguardMission10IntegrationDirector.cpp",
...
class Mission02AllowBoundedActorSpawningFieldDeclContractTests(unittest.TestCase):
    ...
    def test_sibling_director_fields_do_not_satisfy_allow_bounded_actor_spawning(
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_allow_bounded_actor_spawning"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_allow_bounded_actor_spawning_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
