...
# Mission04 MissionDefinition FIELD
...
# CampaignDefinition sibling / leftover Mission03
# bMissionDefinitionValid, NOT leftover
# Mission04 Root #907 / SearchlightPort #908 /
# SearchlightStarboard #909 / Briefing #910 /
# AudioDirector #911 / RadioChatter #912 /
# SortiePresentation #913, NOT leftover
...
# SortiePresentation /
# CampaignDefinition / AudioDirector /
...
# split-line UPROPERTY wraps. Do NOT require
# VisibleAnywhere / BlueprintReadOnly for this
# field. Parse the public
# class section of
# ASkyguardMission04IntegrationDirector only.
# Do not parse FSkyguardMission04IntegrationReadiness,
# private, or Mission01 / Mission02 / Mission03 / Mission05-10 directors.
...
# drafts #674-#913, leftover Apache
...
# drafts #674-#913 including leftover Mission03
# ObjectiveCount #905 / WaveCount #906 / RadioLineCount #904,
# leftover Mission04 Root #907 / SearchlightPort #908 /
# SearchlightStarboard #909 / Briefing #910 /
# AudioDirector #911 / RadioChatter #912 /
# SortiePresentation #913. CampaignDefinition may
# already have a newer draft; do not reopen it.
...
class Mission04MissionDefinitionFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("Skyguard|Mission02|Protection", UPROPERTY_MISSION04)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 MissionDefinition field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 MissionDefinition field contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_mission_definition_field"
                "_decl_contract.py"
            )
        )
        leftover_56_64 = (
