...
# INDEX_NONE or lock RadioChatter
# construction in the .cpp. This is leftover-safe
# Mission09 RadioChatter FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps) on
# ASkyguardMission09IntegrationDirector. It is
# NOT leftover Mission01 RadioChatter field
# #576 / branch cursor/mission01-radio-chatter-
# field-decl-contract-c332, NOT leftover Mission02
# RadioChatter field #848 / branch cursor/
# mission02-radio-chatter-field-decl-contract-
# c332, NOT leftover Mission03 RadioChatter field
# #879 / branch cursor/mission03-radio-chatter-
# field-decl-contract-c332, NOT leftover Mission04
# RadioChatter field #912 / branch cursor/
# mission04-radio-chatter-field-decl-contract-
# c332, NOT leftover Mission05 RadioChatter field
# #950 / branch cursor/mission05-radio-chatter-
# field-decl-contract-c332, NOT leftover Mission06
# RadioChatter field #982 / branch cursor/
# mission06-radio-chatter-field-decl-contract-
# c332, NOT leftover Mission07 RadioChatter field
# / branch cursor/mission07-radio-chatter-field-
# decl-contract-c332, NOT leftover Mission08
# director RadioChatter #1052 / branch cursor/
# mission08-radio-chatter-field-decl-contract-
# c332, NOT leftover Mission10 RadioChatter
# field #796 / branch cursor/mission10-radio-
# chatter-field-decl-contract-c332, NOT leftover
# Mission09 Root field #1083 / branch cursor/
# mission09-root-field-decl-contract-c332, NOT leftover
# Mission09 SkylineAnchor #1084 / branch cursor/
# mission09-skyline-anchor-field-decl-contract-
# c332, NOT leftover Mission09 MajorBridgeAnchor
# #1085 / branch cursor/mission09-major-bridge-
# anchor-field-decl-contract-c332, NOT leftover
# Mission09 Briefing #1086 / branch cursor/
# mission09-briefing-field-decl-contract-c332,
# NOT leftover Mission09 AudioDirector #1087 /
# branch cursor/mission09-audio-director-field-
# decl-contract-c332, NOT leftover Mission08 Root field
# #1044 / branch cursor/mission08-root-field-
# decl-contract-c332, NOT leftover Mission07 Root field
# #1011 / branch cursor/mission07-root-field-
# decl-contract-c332, NOT leftover Mission06 Root field
# #981 / branch cursor/mission06-root-field-
# decl-contract-c332, NOT leftover Mission05 Root field
# #947 / branch cursor/mission05-root-field-
# decl-contract-c332, NOT leftover Mission04 Root field
# #907 / branch cursor/mission04-root-field-
# decl-contract-c332, NOT leftover Mission03 Root field
...
# #574 / leftover environment-root
# #592 / branch cursor/mission01-root-field-
# decl-contract-c332 (closed, do not reopen)
# #536-#673), NOT leftover Mission05 closed-without-merge
...
# methods.
# not leftover Root / Briefing /
# AudioDirector / SortiePresentation /
...
# (do not parse leftover-safe struct fields),
...
# leftover FSkyguardHoistWindowRuntime, leftover FSkyguardMission08ProtectedTargetRuntime,
# leftover FSkyguardSearchTrackRuntime, leftover
# FSkyguardMission07ProtectedTargetRuntime,
# FSkyguardAirfieldTargetRuntime, FSkyguardPayloadWindowRuntime,
# private, or Mission01 / Mission02 /
# Mission03 / Mission04 / Mission05 / Mission06 / Mission07 / Mission08 / Mission10 directors.
...
# leftover Mission08, not leftover Mission01
...
# drafts #674-#1087, leftover Apache
...
# drafts #674-#1087 including leftover Mission03
# ObjectiveCount #905 / WaveCount #906 / RadioLineCount #904,
# leftover Mission09 Root #1083 / SkylineAnchor #1084 /
# MajorBridgeAnchor #1085 / Briefing #1086 / AudioDirector #1087.
...
LOCKED_DECL = RADIO_CHATTER_FIELD
...
# an isolated Python RadioChatter
# field declaration contract on
# ASkyguardMission09IntegrationDirector.
# Lock leftover same-name Mission01/02/03/04/05/
# 06/07/08/10 director RadioChatter drafts. Lock leftover Mission07
# director Root #1011 through Readiness #1027. Lock
...
# Mission08 director Root #1044 through Readiness
# #1066. Lock leftover FSkyguardMission08IntegrationReadiness
...
# #1085 / Briefing #1086 / AudioDirector #1087. Lock leftover
# Mission09 Blueprint UFUNCTION methods
# InitializePlayableMission through
# ValidateMissionContract.
# This is NOT leftover Mission08 GetReadiness #739,
# NOT leftover Mission08 InitializePlayableMission
# #729, NOT leftover Mission08 RescueHelicopterAnchor
# / HoistCableAnchor sibling director fields.
LOCKED = {
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission06IntegrationDirector::Root",
    "ASkyguardMission07IntegrationDirector::Root",
    "ASkyguardMission08IntegrationDirector::Root",
    "ASkyguardMission09IntegrationDirector::Root",
...
class Mission09RadioChatterFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_radio_chatter_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_radio_chatter_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("TObjectPtr<USkyguardRadioChatterComponent> "),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("RadioChatter", LOCKED_DECL)
        self.assertIn("USkyguardRadioChatterComponent", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("RadioChatter", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("TObjectPtr<USkyguardRadioChatterComponent>"))
    ...
    def test_harbor_40_80_tokens_fail_closed_if_present(self) -> None:
        ...
        # Leftover Mission06 RunwayBreakerSpawnRotation yaw is
        # Harbor-adjacent, not Harbor interval retune, and is not locked.
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 RadioChatter field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 RadioChatter field contains "
    ...
    def test_contract_is_radio_chatter_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_radio_chatter(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_rescue_helicopter"
            "_anchor_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_hoist_cable"
            "_anchor_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_radio_chatter_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_audio_ready_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission09_skyline_anchor_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission09_major_bridge_anchor_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_radio_chatter_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_radio_chatter_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission04_radio_chatter_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission10_radio_chatter_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_search_track_runtime_struct_does_not_satisfy_root(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_protected_target_runtime_struct_does_not_satisfy_root(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_leftover_mission07_root_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission07IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        self.assertNotIn("ASkyguardMission07IntegrationDirector", LOCKED_DECL)
        self.assertNotIn('Category="Skyguard|Mission07"', LOCKED_DECL)

    def test_leftover_mission08_root_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission08IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_objective_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertNotIn("ASkyguardMission08IntegrationDirector", LOCKED_DECL)
        self.assertNotIn('Category="Skyguard|Mission08"', LOCKED_DECL)

    def test_hoist_window_runtime_struct_does_not_satisfy_root(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_leftover_mission04_root_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission04IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission05_root_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission05IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission06_root_does_not_satisfy(self) -> None:
        leftover = (
        ...
        self.assertNotIn("ASkyguardMission06IntegrationDirector", LOCKED_DECL)
        self.assertNotIn('Category="Skyguard|Mission06"', LOCKED_DECL)

    def test_storm_runtime_struct_does_not_satisfy_root(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_airfield_target_runtime_struct_does_not_satisfy_root(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_struct_does_not_satisfy_root(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_declaration_accepts_origin_main_default_forms(self) -> None:
        ...
        stem = "TObjectPtr<USkyguardRadioChatterComponent> RadioChatter"
        ...
        self.assertEqual(LOCKED_DECL, "TObjectPtr<USkyguardRadioChatterComponent> RadioChatter;")
