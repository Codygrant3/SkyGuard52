...
# Mission06 IntegrationReadiness WaveCount
...
# is WaveCount after ObjectiveCount. Skip leftover
...
class Mission06WaveCountFieldDeclContractTests(unittest.TestCase):
