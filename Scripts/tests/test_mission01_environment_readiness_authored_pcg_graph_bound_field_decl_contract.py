...
# bAuthoredPCGGraphBound FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bAuthoredPCGGraphBound = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover director AuthoredPCGGraph #594
# (ASkyguardMission01EnvironmentDirector::AuthoredPCGGraph,
# TSoftObjectPtr<UPCGGraphInterface>, different name on the
# director class). THIS IS NOT leftover Mission01
# environment-readiness-defaults #6b9d/#204. THIS IS NOT leftover
# director OceanTiles #585 / BeachTiles #586 / LandTiles #587 /
# RouteExclusion #588 / ProductionLandscape #591. THIS IS NOT
# leftover HasContinuousCoastline #623 / leftover
# IsPointAllowedForPCG #622. THIS IS NOT leftover
# LandscapeComponentCount sibling #1176. LOCK leftover #56-#64.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bAuthoredPCGGraphBound FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# bool bAuthoredPCGGraphBound = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover Mission01 environment-readiness-defaults
...
# FSkyguardMission01EnvironmentReadiness bAuthoredPCGGraphBound
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bAuthoredPCGGraphBound = false;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# LandscapeComponentCount. THIS IS NOT leftover mission-map-
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# LandscapeComponentCount. THIS IS NOT leftover Mission05
...
# Mission01 EnvironmentReadiness bAuthoredPCGGraphBound
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bAuthoredPCGGraphBound = false;
# one-line / split-line UPROPERTY wraps;
...
# bAuthoredPCGGraphBound FIELD (declaration-only). It is
...
TARGET = "bool bAuthoredPCGGraphBound = false;"
TARGET_WRONG = "bool bAuthoredPCGGraphBound = true;"
LOCKED_DECL = TARGET
...
class Mission01EnvironmentReadinessAuthoredPcgGraphBoundFieldDeclContractTests(unittest.TestCase):
    def test_environment_readiness_struct_exists(self) -> None:
        ...
        self.assertIn("bAuthoredPCGGraphBound", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bAuthoredPCGGraphBound", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_authored_pcg_graph_bound_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_authored_pcg_graph_bound_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bAuthoredPCGGraphBound"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bAuthoredPCGGraphBound", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bAuthoredPCGGraphBound", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bAuthoredPCGGraphBound"))
    ...
    def test_contract_does_not_relock_leftover_environment_readiness(
        ...
        self.assertNotIn("bContinuousCoastline", LOCKED_DECL)
        self.assertNotIn("bRouteExclusionValid", LOCKED_DECL)
        self.assertNotIn(
            "TSoftObjectPtr<UPCGGraphInterface> AuthoredPCGGraph",
            LOCKED_DECL,
        )
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bAuthoredPCGGraphBound", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_authored_pcg_graph_bound(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
