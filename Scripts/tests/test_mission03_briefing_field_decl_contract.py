...
# Mission03 Integration Briefing
...
class Mission03BriefingFieldDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        as_const = (
            "\tconst TObjectPtr<USkyguardMissionBriefingComponent>& "
            "Briefing;\n"
        )
        with_arg = (
            "\tTArray<TObjectPtr<USkyguardMissionBriefingComponent>> "
            "Briefing;\n"
        )
        renamed = (
    ...
    def test_readiness_struct_does_not_satisfy_briefing(self) -> None:
        leftover = (
