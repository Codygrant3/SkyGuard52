...
# Mission09 Protection NotifyProtectedTargetDamage
# METHOD on ASkyguardMission09IntegrationDirector. THIS
# is NotifyProtectedTargetDamage, NOT leftover
# Mission09 protected-target enum #9246 / #228, NOT
# leftover Mission09 protected-target-runtime-defaults
# #bf28 / #225, NOT leftover Mission08
# NotifyProtectedTargetDamage #736 / branch
# cursor/mission08-notify-protected-target-damage-
# decl-contract-c332, NOT leftover Mission07
# NotifyProtectedTargetDamage #711, NOT leftover
# closed Mission05 NotifyProtectedTargetDamage #673,
# NOT leftover BindRuntimeActors. It is NOT leftover BindRuntimeActors
...
# UFUNCTION. Do not lock leftover BindCampaignRuntime.
# Do not lock sibling Integration / Waves /
# Protection / Performance / Objectives methods
# InitializePlayableMission /
# ConfigureMissionDefinition / BindCampaignRuntime /
...
# Category is Skyguard|Mission09|Protection, not
# Mission01 / Mission02 / Mission03 / Mission04 /
# Mission05 / Mission06 / Mission07 / Mission08 /
# Integration / Waves / Search / Payload / Targets /
# Objectives / Hoist / Safety / Rescue / Boss /
# Destruction / Briefing / Performance, not Environment,
...
# drafts #674–#748+, leftover Apache
...
REQUIRED_DECL = NOTIFY_PROTECTED_TARGET_DAMAGE
...
# THIS is NotifyProtectedTargetDamage, NOT leftover
# BindRuntimeActors, NOT leftover Mission08 / Mission07
# / closed Mission05 NotifyProtectedTargetDamage.
LOCKED = {
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission09IntegrationDirector::NotifyProtectedTargetDamage",
    "SkyguardMission08IntegrationDirector.cpp",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission09NotifyProtectedTargetDamageDeclContractTests(unittest.TestCase):
    ...
    def test_missing_notify_protected_target_damage_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission09|Protection", UFUNCTION_PROTECTION)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        missing_arg = "\tbool NotifyProtectedTargetDamage();\n"
        as_void = (
    ...
    def test_notify_protected_target_damage_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, REQUIRED_DECL),
            REQUIRED_DECL,
        ...
        self.assertIn("NotifyProtectedTargetDamage", REQUIRED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tbool\n"
            "\tNotifyProtectedTargetDamage(ESkyguardMission09ProtectedTarget Target, int32 Damage);\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
            "public:\n"
            "\tbool   NotifyProtectedTargetDamage(ESkyguardMission09ProtectedTarget Target, int32 Damage);\n"
            "private:\n"
            "};\n"
        )
        wrap_tab = (
    ...
    def test_contract_does_not_lock_bind_campaign_runtime_cpp_body(self) -> None:
        locked_only = f"{REQUIRED_DECL}\n"
        self.assertNotIn("{", REQUIRED_DECL)
        self.assertNotIn("}", REQUIRED_DECL)
        self.assertNotIn("return ", REQUIRED_DECL)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 NotifyProtectedTargetDamage method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                REQUIRED_DECL.lower(),
                "mission09 NotifyProtectedTargetDamage contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_notify_protected_target_damage"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission08_notify_protected_target_damage(
        self,
    ) -> None:
        locked_only = f"{REQUIRED_DECL}\n"
    ...
    def test_leftover_bind_campaign_runtime_does_not_satisfy(self) -> None:
        region = f"\t{BIND_CAMPAIGN_RUNTIME}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(region, REQUIRED_DECL)
        self.assertIn("NotifyProtectedTargetDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
