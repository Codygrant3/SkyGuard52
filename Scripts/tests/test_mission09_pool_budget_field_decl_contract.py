...
# THIS IS leftover-safe Mission09 DIRECTOR CLASS PoolBudget FIELD
...
# THIS IS NOT leftover Mission09 pool-budget-defaults #4537 /
# branch cursor/mission09-pool-budget-defaults-contract-4537
# (do not spawn/reopen that). THIS IS NOT leftover Mission09
# pool-runtime-defaults #5426 / branch
# cursor/mission09-pool-runtime-defaults-contract-5426.
# THIS IS NOT leftover Mission08 DIRECTOR CLASS Readiness
# FIELD #1066 / branch cursor/mission08-readiness-field-
# decl-contract-c332. THIS IS NOT leftover Mission09
# director Readiness (sibling, do not take that field).
# THIS IS NOT leftover Mission05 Readiness #960 / branch
# cursor/mission05-readiness-field-decl-contract-c332.
# THIS IS NOT leftover Mission06 Readiness #995 / branch
# cursor/mission06-readiness-field-decl-contract-c332.
# THIS IS NOT leftover Mission07 Readiness #1027 / branch
# cursor/mission07-readiness-field-decl-contract-c332.
# THIS IS NOT leftover Mission04 Readiness #926 / branch
# cursor/mission04-readiness-field-decl-contract-c332.
# THIS IS NOT leftover Mission02 Readiness #860 / branch
# cursor/mission02-readiness-field-decl-contract-c332.
# THIS IS NOT leftover Mission01 Readiness #579 / branch
# cursor/mission01-readiness-field-decl-contract-c332.
# THIS IS NOT leftover Mission10 Readiness #809 / branch
# cursor/mission10-readiness-field-decl-contract-c332.
# THIS IS NOT leftover FSkyguardMission09IntegrationReadiness
# struct members. THIS IS NOT leftover
# FSkyguardMission09PoolBudget struct body
# (MaxActiveThreats / PoolCapacity / MaxActiveDecoys /
# MaxSimultaneousExplosions). THIS IS NOT leftover
# FSkyguardMission09PoolRuntime / leftover
# FSkyguardMission09ProtectedTargetRuntime. THIS IS NOT
# leftover MaximumProtectedTargetIntegrity / leftover
# IronRainSpawnLocation. Skip leftover spawn location /
# rotation and leftover runtime-ready flag forever.
...
# merge #665 #666 #668-#673, or open drafts #674-#1098.
# LOCK leftover Mission01/02/03/04/05/06/07/08/10
...
# LOCK leftover Mission09 pool-budget-defaults #4537 /
...
# UPROPERTY(Transient). Do not lock .cpp construction.
# Accept one-line or split-line UPROPERTY wraps.
# Fail-closed if the type or declaration is missing.
# Note EditAnywhere / BlueprintReadWrite / Category
# Skyguard|Mission09|Performance / type
# FSkyguardMission09PoolBudget, not VisibleAnywhere /
# BlueprintReadOnly / FSkyguardMission09IntegrationReadiness /
# FSkyguardMission09PoolRuntime / int32.
# Harbor clock tokens fail closed in Mission02/03/04/05/06/07
# test files; this contract is Mission08/09-only. Incoming
# clock names must be absent. Apache CPG lock stays 30 mm /
# Hydra / Hellfire.
# Skip leftover BindRuntimeActors (takes retired live-mount
# pointer) / leftover HandleDroneCityImpact / leftover
# GetStormRainBeatKit without UFUNCTION / leftover spawn
# location / leftover runtime-ready flag forever.
# Declaration presence only. Do not invent
# INDEX_NONE or lock PoolBudget
# construction in the .cpp. This is leftover-safe
# Mission09 DIRECTOR CLASS PoolBudget FIELD
# (EditAnywhere / BlueprintReadWrite,
# declaration-only, one-line / split-line
# UPROPERTY wraps) on
# ASkyguardMission09IntegrationDirector. It is
# NOT leftover Mission06 Readiness field
# #995 / branch cursor/mission06-readiness-
# field-decl-contract-c332, NOT leftover
...
# bAutoLaunchAfterBriefing #1020 / leftover
# CampaignSaveSlotName #1021 / leftover
# CampaignSaveUserIndex #1022 / leftover
# RadarGhostSpawnLocation /
# RadarGhostSpawnRotation /
# MaximumProtectedTargetIntegrity /
# ReinforcementDeadlineSeconds sibling lanes,
# NOT leftover Mission05 Readiness field
# #960 / branch cursor/mission05-readiness-
# field-decl-contract-c332, NOT leftover
# FSkyguardMission07IntegrationReadiness
# member fields, NOT leftover
# FSkyguardAirfieldTargetRuntime, NOT leftover
# FSkyguardPayloadWindowRuntime, NOT leftover
# GetReadiness UFUNCTION. It is
# NOT leftover Mission02 Readiness field
# #860 / branch cursor/mission02-readiness-
# field-decl-contract-c332, NOT leftover
# Mission03 Readiness field
# #890 / branch cursor/mission03-readiness-
# field-decl-contract-c332, NOT leftover
# Mission04 Readiness field
# #926 / branch cursor/mission04-readiness-
# field-decl-contract-c332, NOT leftover
# Mission05 director field drafts Root #947
# through TempestSpawnLocation /
# CampaignSaveSlotName / CampaignSaveUserIndex /
# bAutoLaunchAfterBriefing #956, NOT leftover
# Mission05 wave-state enum #ad28 / leftover
# Mission05 protected-target enum #aaa2 /
# leftover Mission05 protected-target-runtime-
# defaults #ec8b / leftover storm-runtime-
# defaults #89c9, NOT leftover Mission05
# closed-without-merge #665 #666 #668 #669
# #670 #671 #672 #673, NOT leftover
# FSkyguardStormRuntime members, NOT leftover
# FSkyguardMission07IntegrationReadiness
# struct members, NOT leftover
# Mission04 GetReadiness method
# #658 / branch cursor/mission04-get-readiness-
# decl-contract-c332 (CLOSED leftover; do not
# reopen #658-#673), NOT leftover
# Mission01 Readiness field
# #579 / branch cursor/mission01-readiness-
# field-decl-contract-c332 (closed, do not
# reopen #536-#673), NOT leftover Mission10
# GetReadiness method #776 / branch
# cursor/mission10-get-readiness-decl-
# contract-c332, NOT leftover Mission10
# Readiness field #809 / branch
# cursor/mission10-readiness-field-
# decl-contract-c332, NOT leftover
# Mission02 GetReadiness #837 / branch
# cursor/mission02-get-readiness-decl-
# contract-c332, NOT leftover
# FSkyguardMission07IntegrationReadiness
# member fields, NOT leftover Mission01 Root
# field #574 / branch cursor/mission01-root-
# field-decl-contract-c332, NOT leftover
# Mission10 route-phase
...
# Do not parse FSkyguardMission09PoolBudget
# struct body, FSkyguardMission09PoolRuntime,
# FSkyguardMission09IntegrationReadiness
# member fields, FSkyguardAirfieldTargetRuntime,
# or FSkyguardPayloadWindowRuntime.
# Category is Skyguard|Mission09|Performance, not
...
# Integration, not Mission01 / Mission02 / Mission03 /
# Mission05 / Mission06 / Mission08 /
# Mission08 / Mission09, not leftover Mission01
# Root #574, not leftover Mission01 Readiness
# #579, not leftover Mission10 GetReadiness
# #776, not leftover Mission09
...
# drafts #674-#1098, leftover Apache
...
LEFTOVER_SAME_NAME_READINESS_FIELD_NOT_LOCKED = (
    ...
    "test_mission09_readiness_field_decl_contract.py",
    "test_mission10_readiness_field_decl_contract.py",
)
...
class Mission09PoolBudgetFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("PoolBudget", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_pool_budget_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission09|Performance", UPROPERTY_MISSION09)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_m09_readiness_type = (
            "\tFSkyguardMission09IntegrationReadiness Readiness;\n"
        )
        leftover_m09_pool_runtime_type = (
    ...
    def test_pool_budget_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FSkyguardMission09PoolBudget "),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("PoolBudget", LOCKED_DECL)
        self.assertIn("FSkyguardMission09PoolBudget", LOCKED_DECL)
        ...
        self.assertIn("FSkyguardMission09PoolBudget", LOCKED_DECL)
        self.assertNotIn("ASkyguardMission09IntegrationDirector", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("PoolBudget;", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 PoolBudget field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 PoolBudget field contains "
    ...
    def test_contract_is_pool_budget_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertNotIn("return ", LOCKED_DECL)
        self.assertNotIn("{", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FSkyguardMission09PoolBudget"))
        self.assertIn("PoolBudget", LOCKED_DECL)
    ...
    def test_sibling_director_fields_do_not_satisfy_pool_budget(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission09_pool_budget_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_pool_budget_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission08_get_readiness_does_not_satisfy(self) -> None:
        leftover = (
            ...
            "\tUFUNCTION(BlueprintPure, "
            'Category="Skyguard|Mission08|Integration")\n'
            "\tconst FSkyguardMission09PoolBudget& "
            "GetReadiness() const { return Readiness; }\n"
            "};\n"
        )
        section = public_section(leftover)
    ...
    def test_leftover_same_name_readiness_contracts_stay_locked(self) -> None:
        ...
        self.assertIn("EditAnywhere", UPROPERTY_MISSION09)
        self.assertIn("BlueprintReadWrite", UPROPERTY_MISSION09)
        self.assertNotIn("VisibleAnywhere", UPROPERTY_MISSION09)
        self.assertNotIn("BlueprintReadOnly", UPROPERTY_MISSION09)

    def test_contract_does_not_parse_pool_budget_struct(self) -> None:
        header = origin_main_header()
        struct_only = (
            "USTRUCT(BlueprintType)\n"
            "struct FSkyguardMission09PoolBudget\n"
        ...
        self.assertIsNone(
            re.search(
                r"class\s+(?:SKYGUARD52_API\s+)?"
                r"FSkyguardMission09PoolBudget\b",
                header,
            )
        )
        self.assertIn(
        ...
        section = public_section(header)
        self.assertTrue(has_declaration(section, LOCKED_DECL), section)
        self.assertNotIn("int32 MaxActiveThreats = 24;", LOCKED_DECL)
        self.assertNotIn("int32 PoolCapacity = 48;", LOCKED_DECL)
        self.assertNotIn("int32 MaxActiveDecoys = 12;", LOCKED_DECL)
        self.assertNotIn("int32 MaxSimultaneousExplosions = 6;", LOCKED_DECL)
        self.assertNotIn("bool bMissionDefinitionValid = false;", LOCKED_DECL)
        self.assertNotIn("USTRUCT", LOCKED_DECL)
