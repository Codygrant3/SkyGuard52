...
# INDEX_NONE or lock bCampaignDefinitionValid
# construction in the .cpp. THIS IS leftover-safe
# Mission09 IntegrationReadiness bCampaignDefinitionValid
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool default false,
# one-line / split-line UPROPERTY wraps; no Category)
# on FSkyguardMission09IntegrationReadiness.
# THIS IS NOT leftover Mission08
# FSkyguardMission08IntegrationReadiness
# bCampaignDefinitionValid #1068 / branch
# cursor/mission08-campaign-definition-valid-
# field-decl-contract-c332.
# THIS IS NOT leftover Mission07 same-name
# readiness-struct field / branch
# cursor/mission07-campaign-definition-valid-
# field-decl-contract-c332.
# THIS IS NOT leftover Mission09 director
# CampaignDefinition #1091 / branch
# cursor/mission09-campaign-definition-field-
# decl-contract-c332.
# THIS IS NOT leftover Mission09 director
# Readiness #1100 / branch
# cursor/mission09-readiness-field-decl-
# contract-c332.
# THIS IS NOT leftover Mission09 readiness-struct
# bMissionDefinitionValid (sibling in-flight
# cursor/mission09-mission-definition-valid-
# field-decl-contract-c332).
# NOT leftover Mission08 director CampaignDefinition
# FIELD #1055 / branch cursor/mission08-
# campaign-definition-field-decl-contract-c332,
# NOT leftover Mission08 director Readiness
# #1066 / branch cursor/mission08-readiness-
# field-decl-contract-c332,
# NOT leftover Mission06 bCampaignDefinitionValid
# FIELD #997 / branch cursor/mission06-
# campaign-definition-valid-field-decl-contract-c332,
# NOT leftover Mission05 bCampaignDefinitionValid
# FIELD / branch cursor/mission05-
# campaign-definition-valid-field-decl-contract-c332,
...
# campaign-definition-valid-field-decl-contract-c332,
# NOT leftover Mission07 director CampaignDefinition
# FIELD #1015 / branch cursor/mission07-
# campaign-definition-field-decl-contract-c332,
# NOT leftover Mission07 director Readiness field
# #1027 / branch cursor/mission07-readiness-field-
# decl-contract-c332, NOT leftover Mission07
# director MissionDefinition FIELD #1017, NOT leftover
# Mission07 readiness-struct bMissionDefinitionValid
# #1028 through SearchTrackCount #1043
# (cursor/mission07-mission-definition-valid-
# field-decl-contract-c332), NOT leftover Mission08
# readiness-struct bMissionDefinitionValid
# (sibling this wave cursor/mission08-mission-
# definition-valid-field-decl-contract-c332),
# NOT leftover Mission08 Blueprint UFUNCTION
# methods #729-#749, NOT leftover Mission08
# director Root #1044 through
# MaximumProtectedTargetIntegrity #1065,
# NOT leftover
# Mission07 readiness-struct bMapAssemblyReady
# (sibling cursor/mission07-map-assembly-ready-
# field-decl-contract-c332), NOT leftover Mission06
# bMissionDefinitionValid #996 / bMapAssemblyReady
# #998, NOT leftover Mission07
...
# MaximumProtectedTargetIntegrity #1065 /
# CampaignDefinition #1055 / MissionDefinition /
# Readiness sibling this wave,
...
# not leftover Mission01/02/03/04/05/06/07/08/10 readiness structs).
...
# drafts #674-#991 including leftover Mission02
...
# drafts #536-#673. LOCK leftover drafts
# #56-#64 and leftover #107-#673. Do not reopen
# leftover #664, leftover closed-without-merge
# #658-#673, leftover Mission05 closed-without-merge
# #665 #666 #668-#673, or open drafts #674-#1100.
...
# through Readiness #1066. LOCK leftover
# FSkyguardMission08IntegrationReadiness
# bMissionDefinitionValid #1067 through
# ProtectedTargetCount #1082. LOCK leftover
# Mission09 Blueprint UFUNCTION methods. LOCK
# leftover Mission09 director Root #1083 through
# director Readiness #1100. Do not reopen leftover
...
# drafts #674-#991. Do not reopen leftover
...
CAMPAIGN_DEFINITION_VALID = (
    "bool bCampaignDefinitionValid = false;"
)
LOCKED_DECL = CAMPAIGN_DEFINITION_VALID
...
# an isolated Python bCampaignDefinitionValid
# field declaration contract on
# FSkyguardMission09IntegrationReadiness.
# Harbor interval retune tokens fail-closed in
# Mission02 / Mission03 / Mission04 / Mission05 /
# Mission06 / Mission07 test files (this
# contract is Mission09-only).
LOCKED = {
...
LEFTOVER_MISSION07_DIRECTOR_FIELDS_NOT_LOCKED = (
    ...
    "cursor/mission07-campaign-definition-field-decl-contract-c332",
...
class Mission09CampaignDefinitionValidFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bCampaignDefinitionValid", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_campaign_definition_valid_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_campaign_definition_valid_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bCampaignDefinitionValid"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bCampaignDefinitionValid", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tbool\n"
            "\tbCampaignDefinitionValid = false;\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
        ...
        wrap_true_default = (
            "public:\n"
            f"\t{UPROPERTY_MISSION10}\n"
            "\tbool bCampaignDefinitionValid = true;\n"
            "};\n"
        )
        header_wrap_type = (
            f"struct {CLASS_NAME}\n{{\n{wrap_type}"
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bCampaignDefinitionValid", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bCampaignDefinitionValid"))
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        # This Mission08 field default false is not Harbor 40/80.
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bCampaignDefinitionValid", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 bCampaignDefinitionValid field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 bCampaignDefinitionValid contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_campaign_definition"
                "_valid_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission10_sibling_methods_do_not_satisfy(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission07_campaign_definition_valid"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_contract_does_not_parse_director_class_or_storm_runtime(
        ...
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover_protected)
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        hoist_only = (
