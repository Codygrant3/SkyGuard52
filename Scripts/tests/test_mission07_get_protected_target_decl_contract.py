...
# Mission07 Protection GetProtectedTarget METHOD on
# ASkyguardMission07IntegrationDirector. It is
# NOT leftover Mission07 protected-target enum #18f2,
# NOT leftover Mission07 protected-target-runtime
# defaults #866c, NOT leftover Mission05
# GetProtectedTarget, NOT leftover Mission07
# GetSearchSector, NOT leftover Mission07 GetReadiness,
...
# an isolated Python GetProtectedTarget
...
class Mission07GetProtectedTargetDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        with_arg = (
            "\tFSkyguardMission07ProtectedTargetRuntime "
            "GetProtectedTarget(int32 Amount) const;\n"
        )
        renamed = (
            "\tFSkyguardMission07ProtectedTargetRuntime GetProtectedState() const;\n"
        )
        short_name = "\tbool GetProtectedTarget() const;\n"
        leftover_m06_type = (
            "\tFSkyguardMission06ProtectedTargetRuntime GetProtectedTarget("
            "ESkyguardMission06ProtectedTarget Target) const;\n"
        )
        leftover_m05_type = (
        ...
        leftover_m04_type = (
            "\tFSkyguardMission04ProtectedTargetRuntime GetProtectedTarget("
            "ESkyguardMission04ProtectedTarget Target) const;\n"
        )
        leftover_m01_type = (
            "\tFSkyguardMission01ProtectedTargetRuntime GetProtectedTarget("
            "ESkyguardMission01ProtectedTarget Target) const;\n"
        )
        leftover_env_type = (
            "\tFSkyguardMission01EnvironmentProtectedTargetRuntime "
            "GetProtectedTarget() const;\n"
        )
    ...
    def test_get_protected_target_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            GET_PROTECTED_TARGET.startswith(
                "FSkyguardMission07ProtectedTargetRuntime"
            ),
            GET_PROTECTED_TARGET,
        )
        ...
        self.assertNotIn("StartPayloadWindow", GET_PROTECTED_TARGET)
        self.assertNotIn("AdvancePayloadWindow", GET_PROTECTED_TARGET)
        self.assertNotIn("TryJamActivePayload", GET_PROTECTED_TARGET)
        self.assertNotIn("NotifyAirfieldTargetDamage", GET_PROTECTED_TARGET)
        self.assertNotIn("GetPayloadWindow", GET_PROTECTED_TARGET)
        self.assertNotIn("GetTargetRuntime", GET_PROTECTED_TARGET)
        self.assertNotIn("GetSurvivingTargetCount", GET_PROTECTED_TARGET)
        self.assertNotIn("GetSearchSector", GET_PROTECTED_TARGET)
        self.assertNotIn("GetDayBeatKind", GET_PROTECTED_TARGET)
        self.assertNotIn("GetDayBeatIndex", GET_PROTECTED_TARGET)
        self.assertNotIn("TickDayBeatKit", GET_PROTECTED_TARGET)
        self.assertNotIn("HandleBossPhaseChanged", GET_PROTECTED_TARGET)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", GET_PROTECTED_TARGET)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", GET_PROTECTED_TARGET)
        self.assertNotIn("ASkyguardMission06IntegrationDirector", GET_PROTECTED_TARGET)
        self.assertNotIn("ESkyguardMission06WaveState", GET_PROTECTED_TARGET)
        self.assertNotIn("ESkyguardMission07WaveState", GET_PROTECTED_TARGET)
        self.assertNotIn("FSkyguardMission07IntegrationReadiness", GET_PROTECTED_TARGET)
        self.assertNotIn("FSkyguardSearchTrackRuntime", GET_PROTECTED_TARGET)
        self.assertNotIn("ClassifyFalseTrack", GET_PROTECTED_TARGET)
        self.assertNotIn("ConfirmRadarGhostIdentification", GET_PROTECTED_TARGET)
        self.assertNotIn("NotifyProtectedTargetDamage", GET_PROTECTED_TARGET)
        self.assertNotIn("AdvanceReinforcementTimer", GET_PROTECTED_TARGET)
        self.assertNotIn("GetReadiness", GET_PROTECTED_TARGET)
        self.assertNotIn("GetClassifiedFalseTrackCount", GET_PROTECTED_TARGET)
        self.assertNotIn("IsHostileContactConfirmed", GET_PROTECTED_TARGET)
        self.assertNotIn("GetReinforcementTimeRemaining", GET_PROTECTED_TARGET)
        self.assertNotIn("GetNightBeatKind", GET_PROTECTED_TARGET)
        self.assertNotIn("GetNightBeatIndex", GET_PROTECTED_TARGET)
        self.assertNotIn("TickNightBeatKit", GET_PROTECTED_TARGET)
        self.assertNotIn("ESkyguardAirfieldTarget", GET_PROTECTED_TARGET)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", GET_PROTECTED_TARGET)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_origin_body = (
            ...
            "\t\tESkyguardMission07ProtectedTarget Target) const\n"
            "\t{\n"
            "\t\treturn FSkyguardMission07ProtectedTargetRuntime();\n"
            "\t}\n"
            "};\n"
        )
        wrap_ufunction = (
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("GetProtectedTarget", GET_PROTECTED_TARGET)
        self.assertTrue(GET_PROTECTED_TARGET.startswith("FSkyguardMission07ProtectedTargetRuntime"))
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardRadarGhostBoss", GET_PROTECTED_TARGET)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 GetProtectedTarget method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission07 GetProtectedTarget contains "
    ...
    def test_leftover_environment_get_protected_target_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_get_protected_target"
                "_decl_contract.py"
            )
        )
        self.assertIn(
