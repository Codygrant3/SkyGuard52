...
# INDEX_NONE or lock NotifyAirfieldTargetDamage
# construction in the .cpp. This is leftover-safe
# Mission06 Targets NotifyAirfieldTargetDamage on
...
# #f114, NOT leftover Mission05
# NotifyProtectedTargetDamage #673, NOT leftover
# Mission04 NotifySubstationDamage, NOT leftover
# Mission06 wave-state enum #fa65, NOT leftover
# Mission05 StartNextWave #668, NOT leftover
# Mission03 / Mission04 StartNextWave, NOT leftover
# Mission01 / Mission03 / Mission04 / Mission05
...
# leftover Harbor Mission02 / Harbor #6/#8/#9,
...
# leftover Mission05 NotifyProtectedTargetDamage
# #673, leftover Mission04 NotifySubstationDamage,
# leftover Mission05 StartNextWave #668,
# leftover Mission03 StartNextWave, leftover
# Mission04 StartNextWave, leftover Mission04
# wave-state enum #bb22, leftover Mission06
# wave-state enum #fa65, leftover airfield-target
# enum #14d2 (do not add an enum-roster
# contract), leftover
...
# Integration, not leftover Mission05 Integration
# #666, not leftover Mission05 Protection #673, not
...
# NotifyAirfieldTargetDamage method declaration
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission06IntegrationDirector::NotifyAirfieldTargetDamage",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission06NotifyAirfieldTargetDamageDeclContractTests(unittest.TestCase):
    def test_mission06_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, NOTIFY_AIRFIELD_TARGET_DAMAGE),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertIn("NotifyAirfieldTargetDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, NOTIFY_AIRFIELD_TARGET_DAMAGE)
    ...
    def test_missing_initialize_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission06IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertIn("NotifyAirfieldTargetDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertIn("NotifyAirfieldTargetDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("BlueprintCallable", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("Category", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("BlueprintPure", UFUNCTION_TARGETS)
        ...
        self.assertIn("BlueprintCallable", UFUNCTION_TARGETS)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, NOTIFY_AIRFIELD_TARGET_DAMAGE)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertIn("NotifyAirfieldTargetDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tvoid NotifyAirfieldTargetDamage("
            "ESkyguardAirfieldTarget Target, "
            "int32 Damage);\n"
        )
        as_const = (
        ...
        renamed = "\tbool NotifyAirfield();\n"
        short_name = "\tbool AirfieldTargetDamage();\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, NOTIFY_AIRFIELD_TARGET_DAMAGE)
            self.assertIn("NotifyAirfieldTargetDamage", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_initialize_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(has_declaration(section, NOTIFY_AIRFIELD_TARGET_DAMAGE))
        self.assertEqual(
            declaration_count(section, NOTIFY_AIRFIELD_TARGET_DAMAGE),
            1,
        )
        self.assertTrue(
            NOTIFY_AIRFIELD_TARGET_DAMAGE.startswith("bool "),
            NOTIFY_AIRFIELD_TARGET_DAMAGE,
        )
        self.assertTrue(
            NOTIFY_AIRFIELD_TARGET_DAMAGE.endswith(";"),
            NOTIFY_AIRFIELD_TARGET_DAMAGE,
        )
        self.assertIn("NotifyAirfieldTargetDamage", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertIn("ESkyguardAirfieldTarget Target", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertIn("int32 Damage", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("TArray<", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("TObjectPtr", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("TSoftObjectPtr", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("INDEX_NONE", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("UFUNCTION", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("{", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("}", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("return ", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("const;", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("Root", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("Briefing", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("AudioDirector", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("RadioChatter", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("SortiePresentation", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("CampaignDefinition", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("MissionDefinition", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("Readiness", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("bAutoInitialize", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("bAllowBoundedActorSpawning", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("bAutoLaunchAfterBriefing", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("PathfinderSpawnLocation", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetAircraft", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("BindRuntimeActors", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("HandleDroneCityImpact", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("InitializePlayableMission", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("NotifyThreatDestroyed", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("AdvanceConvoyByDistance", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("NotifyConvoyDamage", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetWaveState", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetConvoyRouteState", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetDayBeatKit", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetNightBeatKit", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("StartSearchlightWindow", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("AdvanceSearchlightTrack", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("NotifySubstationDamage", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetRemainingThreatsInWave", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetSearchlightRuntime", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetSubstationIntegrity", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("StartNextWave", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("AdvancePayloadWindow", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("TryJamActivePayload", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("StartPayloadWindow", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetPayloadWindow", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetTargetRuntime", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetSurvivingTargetCount", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetDayBeatKind", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetDayBeatIndex", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("TickDayBeatKit", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("HandleBossPhaseChanged", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("ESkyguardMission06WaveState", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertIn("ESkyguardAirfieldTarget", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("ConvoyRuntimeAnchor", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("RoadHunterSpawnLocation", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("ASkyguardMission02IntegrationDirector", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("ConfigureMissionDefinition", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("NotifyObjectiveProgress", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("NotifyProtectedAssetFailed", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("SynchronizeRuntimeState", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("IsCorePlayableReady", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetReadiness", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetObjectiveRuntime", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetGunner", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetPathfinder", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetMissionId", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("ValidateMissionContract", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("ConfigureFromMission", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("AdvanceBriefing", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("SetAssetsReady", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("AcknowledgeAndLaunch", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("CanLaunch", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetElapsedSeconds", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetBriefingState", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetMinimumWarmupSeconds", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetBriefingText", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetRadioChatter", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetPresentation", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("GetMissionTitle", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("AcknowledgeBriefing", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("LaunchSortie", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("HullCollider", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("OpticalTracker", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("WeaponServo", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("CountermeasurePod", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("MinHeightFromOriginCm", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("RadarNode", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("ESkyguardMission02WaveState", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("HarborIndustrial", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("MaxIntegrity", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("CurrentIntegrity", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("FillAndFinalize", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("FillAndFail", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, NOTIFY_AIRFIELD_TARGET_DAMAGE)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_TARGETS} {NOTIFY_AIRFIELD_TARGET_DAMAGE}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{NOTIFY_AIRFIELD_TARGET_DAMAGE}\n}}\n"
        self.assertTrue(has_declaration(one_line, NOTIFY_AIRFIELD_TARGET_DAMAGE))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, NOTIFY_AIRFIELD_TARGET_DAMAGE),
            section,
    ...
    def test_environment_category_does_not_satisfy_targets(self) -> None:
        self.assertNotIn("Environment", UFUNCTION_TARGETS)
        self.assertNotIn("Briefing", UFUNCTION_TARGETS)
        environment = (
            'UFUNCTION(BlueprintCallable, '
    ...
    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        locked_only = f"{NOTIFY_AIRFIELD_TARGET_DAMAGE}\n"
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, NOTIFY_AIRFIELD_TARGET_DAMAGE)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        section = public_section(origin_main_header())
    ...
    def test_contract_does_not_lock_initialize_cpp_body(self) -> None:
        ...
        self.assertNotIn("return false", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("return true", NOTIFY_AIRFIELD_TARGET_DAMAGE)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{NOTIFY_AIRFIELD_TARGET_DAMAGE}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertIn("NotifyAirfieldTargetDamage", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertTrue(NOTIFY_AIRFIELD_TARGET_DAMAGE.startswith("bool "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("CurrentIntegrity", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("SkyguardApacheAircraft.h", NOTIFY_AIRFIELD_TARGET_DAMAGE)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", NOTIFY_AIRFIELD_TARGET_DAMAGE)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{NOTIFY_AIRFIELD_TARGET_DAMAGE}\n"
        self.assertEqual(
            require_declaration(locked_only, NOTIFY_AIRFIELD_TARGET_DAMAGE),
            NOTIFY_AIRFIELD_TARGET_DAMAGE,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, NOTIFY_AIRFIELD_TARGET_DAMAGE)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", NOTIFY_AIRFIELD_TARGET_DAMAGE)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 NotifyAirfieldTargetDamage method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{NOTIFY_AIRFIELD_TARGET_DAMAGE}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, NOTIFY_AIRFIELD_TARGET_DAMAGE.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                NOTIFY_AIRFIELD_TARGET_DAMAGE.lower(),
                "mission06 NotifyAirfieldTargetDamage contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, NOTIFY_AIRFIELD_TARGET_DAMAGE)

    def test_contract_is_notify_airfield_target_damage_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(NOTIFY_AIRFIELD_TARGET_DAMAGE.startswith("bool "))
        self.assertIn("NotifyAirfieldTargetDamage", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertTrue(NOTIFY_AIRFIELD_TARGET_DAMAGE.endswith(";"))
        self.assertIn(UFUNCTION_TARGETS, section)
    ...
    def test_sibling_director_fields_do_not_satisfy_initialize(
        ...
        for leftover in (
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, NOTIFY_AIRFIELD_TARGET_DAMAGE)
            )
            self.assertNotEqual(NOTIFY_AIRFIELD_TARGET_DAMAGE, leftover)
        self.assertIn(
    ...
    def test_leftover_handle_drone_city_impact_does_not_satisfy(self) -> None:
        ...
        self.assertIn("NotifyAirfieldTargetDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, NOTIFY_AIRFIELD_TARGET_DAMAGE))
        locked_only = f"{NOTIFY_AIRFIELD_TARGET_DAMAGE}\n"
    ...
    def test_contract_does_not_relock_leftover_mission05_protected_target_damage(
        ...
        self.assertNotIn("NotifyProtectedTargetDamage", NOTIFY_AIRFIELD_TARGET_DAMAGE)
        self.assertNotIn("Protection", UFUNCTION_TARGETS)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_notify_airfield_target_damage"
                "_decl_contract.py"
            )
        )
        self.assertIn(
