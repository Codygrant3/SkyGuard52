...
# or lock the IsWreckDiverted body.
# origin/main is inline
# (`bool IsWreckDiverted() const`
# with `{ return bWreckDiverted; }` possibly on the
...
# locking the body. The inline return of the wreck
# diverted flag is not a required token of this
...
IS_WRECK_DIVERTED = "bool IsWreckDiverted() const;"
UFUNCTION_BOSS = (
...
# Python IsWreckDiverted declaration
...
# .cpp IsWreckDiverted body / invented
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardLastFlightBoss::IsWreckDiverted",
    "SkyguardLastFlightBoss.cpp",
    "SetExposed",
...
def leftover_short_roster_values() -> tuple[str, ...]:
    ...
    # enum value. IsWreckDiverted is the locked
...
class LastFlightIsWreckDivertedDeclContractTests(unittest.TestCase):
    def test_last_flight_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, IS_WRECK_DIVERTED),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, IS_WRECK_DIVERTED)
        self.assertIn("IsWreckDiverted", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, IS_WRECK_DIVERTED)
    ...
    def test_missing_is_wreck_diverted_declaration_fails_closed(
        self,
    ) -> None:
        neighbors_only = (
            "\tASkyguardLastFlightBoss();\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, IS_WRECK_DIVERTED)
        self.assertIn("IsWreckDiverted", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, IS_WRECK_DIVERTED)
        self.assertIn("IsWreckDiverted", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("BlueprintPure", IS_WRECK_DIVERTED)
        self.assertNotIn("UFUNCTION", IS_WRECK_DIVERTED)
        self.assertNotIn("Category", IS_WRECK_DIVERTED)
        self.assertNotIn("BlueprintCallable", IS_WRECK_DIVERTED)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, IS_WRECK_DIVERTED)
        self.assertIn("IsWreckDiverted", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        missing_parens = "\tbool IsWreckDiverted const;\n"
        missing_const = "\tbool IsWreckDiverted();\n"
        wrong_return_void = "\tvoid IsWreckDiverted() const;\n"
        wrong_return_int = "\tint32 IsWreckDiverted() const;\n"
        added_arg = "\tbool IsWreckDiverted(bool bValue) const;\n"
        ...
        leftover_wreck = f"\t{IS_CLIMB_COMMAND_ISSUED}\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, IS_WRECK_DIVERTED)
            self.assertIn("IsWreckDiverted", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_is_wreck_diverted_declaration_matches_origin_main(
        self,
    ) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
        ...
        self.assertEqual(
            declaration_count(section, IS_WRECK_DIVERTED),
            1,
        )
        self.assertTrue(
            IS_WRECK_DIVERTED.startswith("bool "),
            IS_WRECK_DIVERTED,
        )
        self.assertTrue(
            IS_WRECK_DIVERTED.endswith(";"),
            IS_WRECK_DIVERTED,
        )
        self.assertIn("IsWreckDiverted()", IS_WRECK_DIVERTED)
        self.assertIn(" const", IS_WRECK_DIVERTED)
        self.assertNotIn("INDEX_NONE", IS_WRECK_DIVERTED)
        self.assertNotIn("{", IS_WRECK_DIVERTED)
        self.assertNotIn("}", IS_WRECK_DIVERTED)
        self.assertNotIn("return ", IS_WRECK_DIVERTED)
        self.assertNotIn("return bWreckDiverted", IS_WRECK_DIVERTED)
        self.assertNotIn("IssueClimbCommand", IS_WRECK_DIVERTED)
        self.assertNotIn(
            "BeginTerminalStrikeCycle",
            IS_WRECK_DIVERTED,
        )
        self.assertNotIn("OpenGuidanceArrayExposure", IS_WRECK_DIVERTED)
        self.assertNotIn(
            "DivertWreckFromCivilians",
            IS_WRECK_DIVERTED,
        )
        ...
        self.assertNotIn("GetChinMuzzleLocation", IS_WRECK_DIVERTED)
        self.assertNotIn("GetGunnerMount", IS_WRECK_DIVERTED)
        self.assertNotIn("FaceWorldLocation", IS_WRECK_DIVERTED)
        self.assertNotIn("PortGuidanceArray", IS_WRECK_DIVERTED)
        self.assertNotIn("SetSearchlightTracked", IS_WRECK_DIVERTED)
        self.assertNotIn("SetContactIdentified", IS_WRECK_DIVERTED)
        self.assertNotIn(
            "SetFriendlySeparationMeters",
            IS_WRECK_DIVERTED,
        )
        self.assertNotIn("SetLightningExposed", IS_WRECK_DIVERTED)
        self.assertNotIn(
            "OpenUpperEngineExposure",
            IS_WRECK_DIVERTED,
        )
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, IS_WRECK_DIVERTED)
    ...
    def test_declaration_accepts_origin_main_inline_and_prototype(self) -> None:
        ...
        self.assertTrue(
            has_declaration(one_line_prototype, IS_WRECK_DIVERTED)
        )
        self.assertEqual(
            require_declaration(one_line_prototype, IS_WRECK_DIVERTED),
            IS_WRECK_DIVERTED,
        )
        exact_inline = LIVE_INLINE_IS_WRECK_DIVERTED
        self.assertTrue(has_declaration(exact_inline, IS_WRECK_DIVERTED))
        self.assertEqual(
            require_declaration(exact_inline, IS_WRECK_DIVERTED),
            IS_WRECK_DIVERTED,
        )
        self.assertEqual(
            declaration_count(exact_inline, IS_WRECK_DIVERTED),
            1,
        )
        section = public_section(origin_main_header())
        self.assertTrue(
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tbool\n"
            "\tIsWreckDiverted() const;\n"
            "private:\n"
            "};\n"
        )
        wrap_name = (
            "public:\n"
            "\tbool IsWreckDiverted(\n"
            "\t) const;\n"
            "private:\n"
            "};\n"
        )
        ...
        self.assertTrue(
            has_declaration(one_line, IS_WRECK_DIVERTED)
        )
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, IS_WRECK_DIVERTED),
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        self.assertNotIn("return ", IS_WRECK_DIVERTED)
        self.assertNotIn("return bWreckDiverted", IS_WRECK_DIVERTED)
        self.assertNotIn("return Other", IS_WRECK_DIVERTED)

    def test_declaration_does_not_invent_index_none(self) -> None:
        locked_only = f"{IS_WRECK_DIVERTED}\n"
        self.assertNotIn("INDEX_NONE", locked_only)
        self.assertNotIn("INDEX_NONE", IS_WRECK_DIVERTED)
        self.assertNotIn("return INDEX_NONE", locked_only)
        self.assertNotIn("NAME_None", IS_WRECK_DIVERTED)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_is_wreck_diverted_cpp_body(
        self,
    ) -> None:
        locked_only = f"{IS_WRECK_DIVERTED}\n"
        self.assertNotIn("{", IS_WRECK_DIVERTED)
        ...
        self.assertNotIn("return ", IS_WRECK_DIVERTED)
        self.assertNotIn("return bWreckDiverted", IS_WRECK_DIVERTED)
        self.assertNotIn("return bWreckDiverted", locked_only)
        self.assertNotIn(
            "ASkyguardLastFlightBoss::IsWreckDiverted",
            IS_WRECK_DIVERTED,
        )
        ...
        self.assertNotIn("return false", IS_WRECK_DIVERTED)
        self.assertNotIn("return true", IS_WRECK_DIVERTED)
        self.assertNotIn("SetExposed", IS_WRECK_DIVERTED)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            IS_WRECK_DIVERTED,
        )
        self.assertNotIn("SetBossPhase", IS_WRECK_DIVERTED)
    ...
    def test_contract_does_not_relock_begin_terminal_strike_cycle_sibling(
        ...
        for token in BEGIN_TERMINAL_STRIKE_CYCLE_NOT_LOCKED:
            ...
            self.assertNotIn(token, IS_WRECK_DIVERTED)
        self.assertNotIn(
            "BeginTerminalStrikeCycle",
            IS_WRECK_DIVERTED,
        )
    ...
    def test_contract_does_not_relock_get_finale_stage_sibling(self) -> None:
        ...
        for token in GET_FINALE_STAGE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_WRECK_DIVERTED)
        self.assertNotIn("GetFinaleStage", IS_WRECK_DIVERTED)
        self.assertNotIn("GetFinaleStage", locked_only)
        self.assertNotIn("ESkyguardLastFlightStage", IS_WRECK_DIVERTED)
    ...
    def test_contract_does_not_relock_leftover_getters(self) -> None:
        ...
        for token in GETTERS_NOT_LOCKED:
            ...
            self.assertNotIn(token, IS_WRECK_DIVERTED)
        self.assertNotIn("GetFinaleStage", IS_WRECK_DIVERTED)
        self.assertNotIn("IsClimbCommandIssued", IS_WRECK_DIVERTED)
        self.assertNotIn(
            "GetCivilianSeparationMeters",
            IS_WRECK_DIVERTED,
        )
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, IS_WRECK_DIVERTED)
    ...
    def test_contract_does_not_relock_weak_point_fields(self) -> None:
        ...
        self.assertNotIn("PortGuidanceArray", IS_WRECK_DIVERTED)
        self.assertNotIn("StarboardGuidanceArray", IS_WRECK_DIVERTED)
        self.assertNotIn("CommandCore", IS_WRECK_DIVERTED)
        self.assertNotIn("PortEngine", IS_WRECK_DIVERTED)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, IS_WRECK_DIVERTED)
        self.assertNotIn("SetSearchlightTracked", IS_WRECK_DIVERTED)
        self.assertNotIn("IsSearchlightTracked", IS_WRECK_DIVERTED)
        self.assertNotIn("ASkyguardBlackKiteBoss", IS_WRECK_DIVERTED)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            ...
            self.assertNotIn(token, IS_WRECK_DIVERTED)
        self.assertNotIn("SetContactIdentified", IS_WRECK_DIVERTED)
        self.assertNotIn("IsContactIdentified", IS_WRECK_DIVERTED)
        self.assertNotIn("OpenOrbitExposure", IS_WRECK_DIVERTED)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        self.assertNotIn("OpenSensorExposure", IS_WRECK_DIVERTED)
        self.assertNotIn(
            "ASkyguardLifelineHunterBoss",
            IS_WRECK_DIVERTED,
        )
    ...
    def test_contract_does_not_relock_leftover_tempest(self) -> None:
        ...
        self.assertNotIn("ASkyguardTempestBoss", IS_WRECK_DIVERTED)
    ...
    def test_contract_does_not_relock_leftover_iron_rain(self) -> None:
        ...
        self.assertNotIn("OpenDispenserBay", IS_WRECK_DIVERTED)
        self.assertNotIn("ASkyguardIronRainBoss", IS_WRECK_DIVERTED)
        self.assertNotIn(
            "ASkyguardIronRainBoss::IssueClimbCommand",
            IS_WRECK_DIVERTED,
        )
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        self.assertNotIn("ASkyguardPatrolShip", IS_WRECK_DIVERTED)
    ...
    def test_contract_does_not_relock_mount_getters(self) -> None:
        ...
        for token in MOUNT_GETTERS_NOT_LOCKED:
            ...
            self.assertNotIn(token, IS_WRECK_DIVERTED)
        self.assertNotIn("GetGunnerMount", IS_WRECK_DIVERTED)
        self.assertNotIn("GetChinTurret", IS_WRECK_DIVERTED)
        self.assertNotIn("GetSensorTurret", IS_WRECK_DIVERTED)

    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        locked_only = f"{IS_WRECK_DIVERTED}\n"
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, IS_WRECK_DIVERTED)
        self.assertNotIn("GetChinMuzzleLocation", IS_WRECK_DIVERTED)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_WRECK_DIVERTED)
        self.assertNotIn("ESkyguardApacheSystem", IS_WRECK_DIVERTED)
    ...
    def test_contract_does_not_relock_leftover_input_capture(self) -> None:
        ...
        self.assertNotIn("RecordPlayerEvent", IS_WRECK_DIVERTED)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_WRECK_DIVERTED)
        self.assertNotIn("ASkyguardGunner", IS_WRECK_DIVERTED)
        self.assertNotIn("FillAndFinalize", IS_WRECK_DIVERTED)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_WRECK_DIVERTED)
        self.assertNotIn("SkyguardRadarNode", IS_WRECK_DIVERTED)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", IS_WRECK_DIVERTED)
        self.assertNotIn(
            "USkyguardBriefingWidget",
            IS_WRECK_DIVERTED,
        )
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, IS_WRECK_DIVERTED)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", IS_WRECK_DIVERTED)
        self.assertNotIn(
            "ESkyguardMissionSkylineStyle",
            IS_WRECK_DIVERTED,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_WRECK_DIVERTED)
        self.assertNotIn("MinHeightFromOriginCm", IS_WRECK_DIVERTED)
        self.assertNotIn("MaxIntegrity", IS_WRECK_DIVERTED)
        self.assertNotIn(
            "SkyguardApacheAircraft.h",
            IS_WRECK_DIVERTED,
        )
        self.assertNotIn("SkyguardPathfinder", IS_WRECK_DIVERTED)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, IS_WRECK_DIVERTED)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{IS_WRECK_DIVERTED}\n"
        self.assertEqual(
            require_declaration(locked_only, IS_WRECK_DIVERTED),
            IS_WRECK_DIVERTED,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "last flight IsWreckDiverted contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, IS_WRECK_DIVERTED.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                IS_WRECK_DIVERTED.lower(),
                "last flight IsWreckDiverted contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, IS_WRECK_DIVERTED)

    def test_contract_is_is_wreck_diverted_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertNotIn("return bWreckDiverted", IS_WRECK_DIVERTED)
        self.assertNotIn("{", IS_WRECK_DIVERTED)
        self.assertTrue(IS_WRECK_DIVERTED.startswith("bool "))
        self.assertTrue(IS_WRECK_DIVERTED.endswith(";"))
        self.assertIn(" const", IS_WRECK_DIVERTED)
        self.assertIn(UFUNCTION_BOSS, section)
