...
# Mission02 Integration Briefing
...
class Mission02BriefingFieldDeclContractTests(unittest.TestCase):
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 Briefing field contains "
