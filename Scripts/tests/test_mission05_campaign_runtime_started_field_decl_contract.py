...
# Mission05 IntegrationReadiness bCampaignRuntimeStarted
...
# (skip leftover runtime-ready forever),
...
# campaign-runtime-started-field-decl-contract-c332,
# NOT leftover Mission05 director Briefing
# UPROPERTY #949 / branch cursor/mission05-
# briefing-field-decl-contract-c332,
# NOT leftover Mission05 map-assembly-ready
# sibling / branch cursor/mission05-
# map-assembly-ready-field-decl-contract-c332,
# NOT leftover Mission05 gunner-ready sibling
# #967 / branch cursor/mission05-
# gunner-ready-field-decl-contract-c332,
# NOT leftover Mission05 tempest-ready sibling
# #966 / branch cursor/mission05-
# tempest-ready-field-decl-contract-c332,
# NOT leftover Mission05 objectives-ready sibling
# #968 / branch cursor/mission05-
# objectives-ready-field-decl-contract-c332,
# NOT leftover Mission05 storm-runtime-ready
# sibling #969 / branch cursor/mission05-
# storm-runtime-ready-field-decl-contract-c332,
# NOT leftover Mission05 protected-targets-ready
# sibling #970 / branch cursor/mission05-
# protected-targets-ready-field-decl-contract-c332,
# NOT leftover Mission05 waves-ready sibling
# #971 / branch cursor/mission05-
# waves-ready-field-decl-contract-c332,
# NOT leftover Mission05 mission-definition-valid
# sibling / branch cursor/mission05-
# mission-definition-valid-field-decl-contract-c332,
# NOT leftover Mission05 campaign-definition-valid
# sibling / branch cursor/mission05-
...
# bCampaignRuntimeStarted FIELD #941, not leftover Mission02
# bCampaignRuntimeStarted FIELD #872, not leftover Mission03
# bCampaignRuntimeStarted FIELD #902, not leftover Mission10
# bCampaignRuntimeStarted FIELD #822, not leftover Mission04
# bMapAssemblyReady FIELD #928, not leftover
# Mission03 bMissionDefinitionValid sibling, not leftover
# Mission05 bMapAssemblyReady / bMissionDefinitionValid /
# bCampaignDefinitionValid sibling drafts, not leftover
...
# drafts #674-#973 including leftover Mission02
...
class Mission05CampaignRuntimeStartedFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 bCampaignRuntimeStarted field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 bCampaignRuntimeStarted contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_campaign_runtime_started"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_same_name_campaign_runtime_started_contracts_stay_locked(
        ...
        for leftover in LEFTOVER_MISSION04_CAMPAIGN_RUNTIME_STARTED_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
