...
# AudioDirector field #794 / branch cursor/
# mission10-audio-director-field-decl-contract-
# c332, NOT leftover Mission03 bAudioReady #901 /
...
class Mission04AudioDirectorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_audio_director_field"
                "_decl_contract.py"
            )
        )
        leftover_56_64 = (
