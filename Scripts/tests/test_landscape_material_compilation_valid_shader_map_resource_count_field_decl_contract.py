...
# ValidShaderMapResourceCount FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# int32 ValidShaderMapResourceCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover landscape-material-compilation-defaults #01d4.
# THIS IS NOT leftover GeneratedMaterialInstanceCount sibling.
# THIS IS NOT leftover MaterialResourceCount sibling.
# THIS IS NOT leftover LandscapeComponentCount sibling.
# THIS IS NOT leftover compilation-success sibling.
# THIS IS NOT leftover CaptureConfig Error sibling.
# LOCK leftover #56-#64 plus leftover enum/defaults PRs.
# LOCK leftover landscape-material-compilation-defaults #01d4.
# LOCK leftover success / material-resource-count /
# generated-material-instance-count / landscape-component-count /
# defaults / capture-config-error siblings.
...
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# ValidShaderMapResourceCount. THIS IS NOT leftover VisibleAudit
...
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# ValidShaderMapResourceCount. THIS IS NOT leftover VisibleAudit bSuccess #1199.
...
# Do NOT parse FSkyguardLandscapeVisibleAudit (leftover bSuccess #1199).
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# ValidShaderMapResourceCount. THIS IS NOT leftover
...
# THIS IS leftover-safe FSkyguardLandscapeMaterialCompilationResult
# ValidShaderMapResourceCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 ValidShaderMapResourceCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# BlueprintReadOnly int32 ValidShaderMapResourceCount = 0;
...
TARGET = "int32 ValidShaderMapResourceCount = 0;"
TARGET_WRONG = "int32 ValidShaderMapResourceCount = 1;"
LOCKED_DECL = TARGET
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # ValidShaderMapResourceCount (must be = 0, not = 1).
    # THIS IS NOT leftover VisibleAudit bSuccess #1199.
    # THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*int32\s+ValidShaderMapResourceCount\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for int32 ValidShaderMapResourceCount is missing from "
...
class LandscapeMaterialCompilationValidShaderMapResourceCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("ValidShaderMapResourceCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_valid_shader_map_resource_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_valid_shader_map_resource_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 ValidShaderMapResourceCount"),
            LOCKED_DECL,
        )
        ...
        self.assertFalse(
            has_declaration(
                "\tint32 ValidShaderMapResourceCount = 1;\n",
                LOCKED_DECL,
            )
        )
        with self.assertRaises(AssertionError) as raised:
        ...
        self.assertIn("ValidShaderMapResourceCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("ValidShaderMapResourceCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 ValidShaderMapResourceCount"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("ValidShaderMapResourceCount", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_valid_shader_map_resource_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
