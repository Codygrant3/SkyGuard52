...
# Mission06 Integration ConfigureMissionDefinition
# on ASkyguardMission06IntegrationDirector. It is
# NOT leftover Mission05 ConfigureMissionDefinition
# #665, NOT leftover Mission01 / Mission03 /
...
# #665, not leftover Harbor Mission02 Integration.
...
class Mission06ConfigureMissionDefinitionDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 ConfigureMissionDefinition method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission06 ConfigureMissionDefinition contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_configure_mission_definition"
                "_decl_contract.py"
            )
        )
        self.assertIn(
