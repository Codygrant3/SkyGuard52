...
CLASS_NAME = "FSkyguardMission03IntegrationReadiness"
# Declaration presence only. Do not invent
# INDEX_NONE or lock RadioLineCount
# construction in the .cpp. This is leftover-safe
# Mission03 IntegrationReadiness RadioLineCount
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 default 0,
# one-line / split-line UPROPERTY wraps) on
# FSkyguardMission03IntegrationReadiness. It is
# an int32 readiness FIELD named RadioLineCount, NOT a
# leftover Mission02 RadioLineCount FIELD #874 / branch
# cursor/mission02-radio-line-count-field-decl-contract-c332,
# NOT leftover Mission10 RadioLineCount sibling, NOT leftover
# radio-line-defaults #1dec / branch
# cursor/radio-line-defaults-contract-1dec, NOT leftover
# Mission03 director RadioChatter field #879 / branch
# cursor/mission03-radio-chatter-field-decl-contract-c332,
# NOT leftover Mission03 bBriefingReady FIELD / branch
# cursor/mission03-briefing-ready-field-decl-contract-c332,
# NOT leftover Mission01 RadioLineCount sibling on
# FSkyguardMission01IntegrationReadiness, NOT leftover
# Mission03 ObjectiveCount / WaveCount siblings, NOT leftover
# Mission02 WaveCount FIELD #871 / branch
# cursor/mission02-wave-count-field-decl-contract-c332,
# NOT leftover Mission02 ObjectiveCount FIELD #873 /
# branch cursor/mission02-objective-count-field-decl-
# contract-c332, NOT leftover Mission02 RadioChatter
# director field #848 / leftover Mission01 RadioChatter
# #576 / leftover Mission10 RadioChatter #796, NOT leftover
# Mission02 wave-state enum / leftover
...
# struct section of
# FSkyguardMission03IntegrationReadiness only
# (not ASkyguardMission03IntegrationDirector).
...
# FSkyguardMission03IntegrationReadiness public section. Pathfinder MinHeightFromOriginCm
...
# an isolated Python RadioLineCount
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission01_radio_line_count_field_decl_contract.py",
    ...
    "Scripts/tests/test_mission10_radio_line_count_field_decl_contract.py",
...
LEFTOVER_MISSION02_OBJECTIVE_COUNT_FIELD_NOT_LOCKED = (
...
LEFTOVER_MISSION01_RADIO_LINE_COUNT_NOT_LOCKED = (
    "test_mission01_radio_line_count_field_decl_contract.py",
...
class Mission03RadioLineCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_radio_line_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_radio_line_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 RadioLineCount"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= 0;"), LOCKED_DECL)
        self.assertIn("RadioLineCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("RadioLineCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 RadioLineCount"))
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        # This Mission03 field default 0 is not Harbor 40/80.
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("RadioLineCount", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 RadioLineCount field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission03 RadioLineCount contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission03_radio_line_count"
            "_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission03_radio_line_count"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
            "Scripts/tests/test_mission02_radio_line_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_radio_chatter"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_radio_line_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_sibling_count_fields_do_not_satisfy(self) -> None:
        leftover_wave = "\tint32 WaveCount = 0;\n"
        leftover_objective = "\tint32 ObjectiveCount = 0;\n"
        leftover_protected = "\tint32 ProtectedGroupCount = 0;\n"
        leftover_bool = "\tbool bWavesReady = false;\n"
        leftover_wrong_default = "\tint32 RadioLineCount = 1;\n"
        leftover_untyped = "\tRadioLineCount = 0;\n"
        leftover_as_bool = "\tbool RadioLineCount = false;\n"
        leftover_defaults = (
            "\tFSkyguardRadioLine MakeRadioLine("
            "ESkyguardPilotLine Event);\n"
        )
        leftover_m01 = (
        ...
        for token in LEFTOVER_MISSION02_WAVE_COUNT_FIELD_NOT_LOCKED:
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION02_OBJECTIVE_COUNT_FIELD_NOT_LOCKED:
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_RADIO_LINE_DEFAULTS_NOT_LOCKED:
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION01_RADIO_LINE_COUNT_NOT_LOCKED:
            self.assertNotIn(token, LOCKED_DECL)
        self.assertIn(
            "Scripts/tests/test_mission02_wave_count"
            "_field_decl_contract.py",
