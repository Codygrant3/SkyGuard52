...
# THIS IS leftover-safe Mission09 director bAutoInitialize FIELD
# (declaration-only, one-line / split-line UPROPERTY wraps,
# bool default true) on
# ASkyguardMission09IntegrationDirector. Note
# EditAnywhere / BlueprintReadWrite / bool =
# true, not VisibleAnywhere /
# BlueprintReadOnly / TSoftObjectPtr.
# THIS IS NOT leftover Mission01 bAutoInitialize #580.
# THIS IS NOT leftover Mission02 bAutoInitialize #852.
# THIS IS NOT leftover Mission03 bAutoInitialize #885.
# THIS IS NOT leftover Mission04 bAutoInitialize #915.
# THIS IS NOT leftover Mission05 bAutoInitialize #954.
# THIS IS NOT leftover Mission06 bAutoInitialize #986.
# THIS IS NOT leftover Mission07 bAutoInitialize.
# THIS IS NOT leftover Mission08 director bAutoInitialize
# #1056 / branch cursor/mission08-auto-initialize-
# field-decl-contract-c332. THIS IS NOT leftover
# Mission10 bAutoInitialize #800.
# LOCK leftover same-name Mission01/02/03/04/05/06/07/08/10
# director bAutoInitialize drafts.
...
# INDEX_NONE or lock bAutoInitialize
# construction in the .cpp. This is leftover-safe
# Mission09 director bAutoInitialize FIELD
...
# NOT leftover Mission08 director bAutoInitialize
# #1056 / branch cursor/mission08-auto-initialize-
# field-decl-contract-c332, NOT leftover Mission01
# bAutoInitialize field
...
# c332, NOT leftover Mission06 bAutoInitialize
# field #986 / branch cursor/mission06-auto-
# initialize-field-decl-contract-c332, NOT leftover
# Mission10 bAutoInitialize
# field #800 / branch cursor/mission10-auto-
# initialize-field-decl-contract-c332, NOT leftover
# Mission07 Root #1011 / Briefing #1012 /
# AudioDirector #1013 / RadioChatter /
# SortiePresentation #1014 / CampaignDefinition /
# MissionDefinition sibling field lanes, NOT leftover
...
# leftover Mission06 / leftover Mission07 / leftover Mission09-10 directors.
...
LOCKED_DECL = AUTO_INITIALIZE_FIELD
...
# an isolated Python bAutoInitialize
...
class Mission09AutoInitializeFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_auto_initialize_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_auto_initialize_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertIn("bAutoInitialize", LOCKED_DECL)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 bAutoInitialize field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 bAutoInitialize field contains "
    ...
    def test_contract_is_auto_initialize_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_auto_initialize(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_airfield_target_runtime_does_not_satisfy_auto_initialize(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_does_not_satisfy_auto_initialize(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_leftover_mission06_auto_initialize_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_search_track_runtime_does_not_satisfy_auto_initialize(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_protected_target_runtime_does_not_satisfy_auto_initialize(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_leftover_mission08_auto_initialize_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission08IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission09_campaign_definition_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            f"class SKYGUARD52_API {CLASS_NAME} "
        ...
        self.assertIn(
            "Scripts/tests/test_mission09_mission_definition_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertNotIn("CampaignDefinition", LOCKED_DECL)
    ...
    def test_private_transient_does_not_satisfy_auto_initialize(
        self,
    ) -> None:
        leftover = (
            f"class SKYGUARD52_API {CLASS_NAME} "
