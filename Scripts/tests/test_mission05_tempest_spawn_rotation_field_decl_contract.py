...
# INDEX_NONE or lock TempestSpawnRotation
# construction in the .cpp. This is leftover-safe
# Mission05 TempestSpawnRotation FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps plus the FRotator default)
# on ASkyguardMission05IntegrationDirector.
# SKIP leftover retired-mount spawn fields
# forever. This contract is TempestSpawnRotation
# only. It is NOT leftover Mission04
# BlackKiteSpawnRotation #922 / branch
# cursor/mission04-black-kite-spawn-rotation-
# field-decl-contract-c332, NOT leftover
# Mission04 BlackKiteSpawnLocation field drafts,
# NOT leftover Mission03 RoadHunterSpawnRotation
# #891 / branch cursor/mission03-road-hunter-
# spawn-rotation-field-decl-contract-c332,
# NOT leftover Mission03 RoadHunterSpawnLocation
# field drafts, NOT leftover Mission02
# BreakwaterSpawnRotation #858 / branch
# cursor/mission02-breakwater-spawn-rotation-
# field-decl-contract-c332, NOT leftover
# Mission02 BreakwaterSpawnLocation field drafts,
# NOT leftover Mission10 LastFlightSpawnRotation
# #806 / branch cursor/mission10-last-flight-
# spawn-rotation-field-decl-contract-c332,
# NOT leftover Mission10 LastFlightSpawnLocation
# field drafts, NOT leftover
# BindRuntimeActors / HandleDroneCityImpact, NOT
# leftover GetStormRainBeatKit without UFUNCTION,
...
# TempestSpawnLocation (in-flight
# cursor/mission05-tempest-spawn-location-field-
# decl-contract-c332).
...
# FRotator(0.f, 195.f, 0.f), not
# VisibleAnywhere / BlueprintReadOnly. It is
...
# leftover TempestSpawnLocation /
# leftover BlackKiteSpawnLocation /
...
UPROPERTY_MISSION05_CLAMP = 'meta=(ClampMin="0")'
...
LOCKED_DECL = TEMPEST_SPAWN_ROTATION_FIELD
...
# an isolated Python TempestSpawnRotation
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission03_road_hunter_spawn_rotation_field_decl_contract.py",
...
class Mission05TempestSpawnRotationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("TempestSpawnRotation", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_tempest_spawn_rotation_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_tempest_spawn_rotation_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FRotator TempestSpawnRotation"),
            LOCKED_DECL,
        )
        self.assertTrue(
            LOCKED_DECL.endswith("= FRotator(0.f, 195.f, 0.f);"),
            LOCKED_DECL,
        )
        self.assertIn("TempestSpawnRotation", LOCKED_DECL)
        self.assertIn("= FRotator(0.f, 195.f, 0.f)", LOCKED_DECL)
        self.assertIn("FRotator", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tFRotator\n"
            "\tTempestSpawnRotation = FRotator(0.f, 195.f, 0.f);\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("TempestSpawnRotation", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FRotator TempestSpawnRotation"))
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 TempestSpawnRotation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 TempestSpawnRotation contains "
    ...
    def test_contract_is_tempest_spawn_rotation_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_tempest_spawn_rotation(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission05_tempest_spawn_rotation_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_tempest_spawn_rotation_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_same_name_spawn_location_contracts_stay_locked(
        ...
        for leftover in (
            ...
            "_decl_contract.py",
            "Scripts/tests/test_mission04_black_kite_spawn_rotation_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission03_road_hunter_spawn_location_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission03_road_hunter_spawn_rotation_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission02_breakwater_spawn_location_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission02_breakwater_spawn_rotation_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_last_flight_spawn_location_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_last_flight_spawn_rotation_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission05_tempest_spawn_location_field"
            "_decl_contract.py",
        ):
        ...
        self.assertNotIn("TempestSpawnLocation", LOCKED_DECL)
        self.assertNotIn("BlackKiteSpawnRotation", locked_only)
        self.assertNotIn("RoadHunterSpawnRotation", locked_only)
        self.assertNotIn("BreakwaterSpawnRotation", locked_only)
        self.assertNotIn("LastFlightSpawnRotation", locked_only)
        for token in leftover_spawn_name_tokens():
            self.assertNotIn(token, LOCKED_DECL)
    ...
    def test_storm_runtime_struct_does_not_satisfy_tempest_spawn_rotation(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_readiness_struct_does_not_satisfy_tempest_spawn_rotation(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
