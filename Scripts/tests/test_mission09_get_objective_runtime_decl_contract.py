...
# Mission09 Integration GetObjectiveRuntime
...
# leftover Mission08 GetObjectiveRuntime #740,
...
# Integration GetObjectiveRuntime method), leftover
...
class Mission09GetObjectiveRuntimeDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_core = f"\t{IS_CORE_PLAYABLE_READY}\n"
    ...
    def test_get_objective_runtime_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("Amount", LOCKED_DECL)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 GetObjectiveRuntime method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 GetObjectiveRuntime contains "
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tUSkyguardObjectiveRuntime* GetObjectiveRuntime() const { return false; }\n"
            "};\n"
        )
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_get_objective_runtime"
                "_decl_contract.py"
            )
        )
        self.assertIn(
