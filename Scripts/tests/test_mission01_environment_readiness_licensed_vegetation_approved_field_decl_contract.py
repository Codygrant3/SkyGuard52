...
# bLicensedVegetationApproved FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bLicensedVegetationApproved = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# PARSE FSkyguardMission01EnvironmentReadiness STRUCT public section
# only (after struct FSkyguardMission01EnvironmentReadiness, before
# class ASkyguardMission01EnvironmentDirector). Do NOT parse
# ASkyguardMission01EnvironmentDirector. THIS IS NOT leftover
# director ProductionLandscape #591 (different name on the director
# class). THIS IS NOT leftover Mission01 environment-readiness-
# defaults #6b9d/#204. THIS IS NOT leftover director OceanTiles
# #585 / BeachTiles #586 / LandTiles #587 / RouteExclusion #588 /
# AuthoredPCGGraph #594. THIS IS NOT leftover HasContinuousCoastline
# #623 / IsPointAllowedForPCG #622. THIS IS NOT leftover
# FSkyguardLandscapeVisibleAudit::LandscapeComponentCount.
# THIS IS NOT leftover LandscapeComponentCount sibling #1176.
# LOCK leftover #56-#64 plus leftover enum/defaults PRs including
# leftover Mission01 environment-readiness-defaults #6b9d/#204,
# leftover Mission01 director OceanTiles #585 / BeachTiles #586 /
# LandTiles #587 / RouteExclusion #588 / ProductionLandscape #591 /
# AuthoredPCGGraph #594, leftover HasContinuousCoastline #623,
# leftover IsPointAllowedForPCG #622, leftover environment-
# readiness-defaults #b931, leftover coastal-env-director-empty-
# fail-closed #321b, leftover environment-vfx-pool-fail-closed
# #0a95, leftover mission-map-readiness-defaults #3a2a.
...
# Hydra / Hellfire.
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bLicensedVegetationApproved FIELD. THIS IS NOT leftover
# director class ASkyguardMission01EnvironmentDirector. THIS IS
# NOT leftover Mission01 environment-readiness-defaults
# #6b9d/#204. THIS IS NOT leftover director OceanTiles #585 /
# BeachTiles #586 / LandTiles #587 / RouteExclusion #588 /
# ProductionLandscape #591 / AuthoredPCGGraph #594. THIS IS NOT
# leftover HasContinuousCoastline #623 / IsPointAllowedForPCG
# #622. THIS IS NOT leftover LandscapeComponentCount sibling
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bLicensedVegetationApproved FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# bool bLicensedVegetationApproved = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover Mission01 environment-readiness-defaults
...
# FSkyguardMission01EnvironmentReadiness bLicensedVegetationApproved
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bLicensedVegetationApproved = false;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bLicensedVegetationApproved. THIS IS NOT leftover mission-map-
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bLicensedVegetationApproved. THIS IS NOT leftover Mission05
...
# Mission01 EnvironmentReadiness bLicensedVegetationApproved
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bLicensedVegetationApproved = false;
# one-line / split-line UPROPERTY wraps;
...
# bLicensedVegetationApproved FIELD (declaration-only). It is
...
TARGET = "bool bLicensedVegetationApproved = false;"
TARGET_WRONG = "bool bLicensedVegetationApproved = true;"
LOCKED_DECL = TARGET
...
class Mission01EnvironmentReadinessLicensedVegetationApprovedFieldDeclContractTests(unittest.TestCase):
    def test_environment_readiness_struct_exists(self) -> None:
        ...
        self.assertIn("bLicensedVegetationApproved", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bLicensedVegetationApproved", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_licensed_vegetation_approved_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_licensed_vegetation_approved_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bLicensedVegetationApproved"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bLicensedVegetationApproved", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bLicensedVegetationApproved", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bLicensedVegetationApproved"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bLicensedVegetationApproved", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_licensed_vegetation_approved(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
