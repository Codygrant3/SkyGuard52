...
# Mission10 MinimumWeaponSeparationMeters FIELD
# (declaration-only; EditAnywhere /
# BlueprintReadWrite float default 550.f,
# Safety category, ClampMin 1.0,
# one-line / split-line UPROPERTY wraps) on
# ASkyguardMission10IntegrationDirector. It is
# NOT leftover LastFlightSpawnLocation sibling field,
# NOT leftover LastFlightSpawnRotation sibling field,
# NOT leftover LifelineHunter MinimumWeaponSeparationMeters
# 450.f Harbor-adjacent field, NOT leftover LastFlight
# MinimumCivilianSeparationMeters 550.f Harbor-adjacent,
...
# with Safety ClampMin="1.0");
# accept that form, other one-line / split-line wraps,
# the origin/main `= 550.f` default, ClampMin meta,
...
# not Mission10|Objectives,
# not Mission10|Campaign, not leftover Mission08 Safety,
...
MINIMUM_WEAPON_SEPARATION_METERS = (
    "float MinimumWeaponSeparationMeters = 550.f;"
)
LOCKED_DECL = MINIMUM_WEAPON_SEPARATION_METERS
...
class Mission10MinimumWeaponSeparationMetersFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn("Safety", UPROPERTY_MISSION10)
        self.assertIn("Skyguard|Mission10|Safety", UPROPERTY_MISSION10)
    ...
    def test_minimum_weapon_separation_meters_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(LOCKED_DECL.endswith("= 550.f;"), LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tfloat\n"
            "\tMinimumWeaponSeparationMeters = 550.f;\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        # This Mission10 field default 550.f is not Harbor 40/80.
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 MinimumWeaponSeparationMeters field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission10 MinimumWeaponSeparationMeters contains "
