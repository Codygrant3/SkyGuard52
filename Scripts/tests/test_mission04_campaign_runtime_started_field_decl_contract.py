...
# Mission04 IntegrationReadiness bCampaignRuntimeStarted
...
# NOT leftover Mission04 Briefing-ready sibling /
# branch cursor/mission04-briefing-ready-field-
# decl-contract-c332, NOT leftover Mission04
# Audio-ready sibling / branch cursor/mission04-
# audio-ready-field-decl-contract-c332, NOT leftover
# Mission04 Sortie-presentation-ready sibling,
# NOT leftover Mission04 CampaignDefinition director
# field, NOT leftover Mission04 CampaignSaveSlotName
# #918 / branch cursor/mission04-campaign-save-
# slot-name-field-decl-contract-c332, NOT leftover
# Mission04 CampaignSaveUserIndex #920 / branch
# cursor/mission04-campaign-save-user-index-field-
# decl-contract-c332, NOT leftover Mission03
# bCampaignRuntimeStarted FIELD #902, NOT leftover
# Mission02 bCampaignRuntimeStarted FIELD #872,
# NOT leftover Mission10 bCampaignRuntimeStarted
# FIELD #822, NOT leftover Mission01/02/03/10 same-
# name Readiness drafts, NOT leftover Mission02/03/10
# same-name readiness-struct field drafts.
...
# campaign-runtime-started-field-decl-contract-c332,
# NOT leftover Mission04 Briefing director
# FIELD #910 / branch cursor/mission04-
# briefing-field-decl-contract-c332,
# NOT leftover Mission04 bSearchlightsReady sibling /
# branch cursor/mission04-searchlights-ready-field-
# decl-contract-c332,
# NOT leftover Mission04 bWavesReady sibling /
# branch cursor/mission04-waves-ready-field-
# decl-contract-c332,
# NOT leftover Mission04 bSubstationReady sibling /
# branch cursor/mission04-substation-ready-field-
# decl-contract-c332,
# NOT leftover searchlight-track-runtime-defaults
# #7347 / branch cursor/searchlight-track-
# runtime-defaults-contract-7347 (do not lock
# FSkyguardSearchlightTrackRuntime or
...
# not FSkyguardSearchlightTrackRuntime, not leftover
...
# drafts #674-#932 including leftover Mission02
...
CAMPAIGN_RUNTIME_STARTED = (
    "bool bCampaignRuntimeStarted = false;"
)
LOCKED_DECL = CAMPAIGN_RUNTIME_STARTED
...
LEFTOVER_MISSION04_SUBSTATION_READY_NOT_LOCKED = (
    "test_mission04_substation_ready_field_decl_contract.py",
    "cursor/mission04-substation-ready-field-decl-contract-c332",
    "bSubstationReady",
)
...
class Mission04CampaignRuntimeStartedFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_campaign_runtime_started_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_campaign_runtime_started_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_true = (
            "public:\n"
            f"\t{UPROPERTY_MISSION10}\n"
            f"\t{CAMPAIGN_RUNTIME_STARTED_TRUE}\n"
            "};\n"
        )
        wrap_true_one_line = (
            "public:\n"
        ...
        for header in (
            ...
            section = public_section(header)
            self.assertTrue(
                has_declaration(section, CAMPAIGN_RUNTIME_STARTED_TRUE),
                section,
            )
            self.assertEqual(
                require_declaration(
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 bCampaignRuntimeStarted field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 bCampaignRuntimeStarted contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_campaign_runtime_started(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_campaign_runtime_started"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_campaign_runtime_started"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_substation_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
