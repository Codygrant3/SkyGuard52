...
# AFTER struct FSkyguardLandscapeVisibleAudit and BEFORE
...
# (wrong header; leftover LandscapeComponentCount #1176).
...
# THIS IS NOT leftover VisibleAudit bSuccess (in-flight sibling;
# LOCK that script; do not edit it).
# THIS IS NOT leftover landscape-footprint-sample-defaults
# #af83/#202. THIS IS NOT leftover
# landscape-height-sample-defaults #46a3/#200.
...
# #665 #666 #668-#673, or open drafts #674-#1197.
...
# LandscapeComponentCount later; this ticket is LandscapeComponentCount only).
# LOCK leftover landscape-visible-audit-defaults #0bce.
...
# Do not reopen leftover #536-#673, leftover Mission10
# Integrity #826 / bDestroyed #827, leftover Mission05
# #665 #666 #668-#673, or open drafts #674-#1196.
# Harbor 40/80 fail-closed in this Mission01 test file
...
# LandscapeComponentCount #1176. THIS IS leftover-safe
# FSkyguardLandscapeVisibleAudit LandscapeComponentCount. THIS IS NOT leftover VisibleAudit bSuccess.
...
class LandscapeVisibleAuditLandscapeComponentCountFieldDeclContractTests(unittest.TestCase):
