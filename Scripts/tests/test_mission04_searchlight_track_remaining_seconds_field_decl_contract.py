...
# INDEX_NONE or lock RemainingSeconds
# construction in the .cpp. This is leftover-safe
# Mission04 SearchlightTrackRuntime RemainingSeconds
...
LOCKED_DECL = REMAINING_SECONDS_FIELD
...
# an isolated Python RemainingSeconds
...
# Alternate RemainingSeconds defaults are accepted as declaration
...
class Mission04SearchlightTrackRemainingSecondsFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("RemainingSeconds", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_remaining_seconds_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_remaining_seconds_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("float RemainingSeconds"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= 0.f;"), LOCKED_DECL)
        self.assertIn("RemainingSeconds", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_true = (
            "public:\n"
            f"\t{UPROPERTY_MISSION10}\n"
            f"\t{REMAINING_SECONDS_FIELD_HUNDRED}\n"
            "};\n"
        )
        wrap_true_one_line = (
            "public:\n"
        ...
        wrap_zero = (
            "public:\n"
            f"\t{UPROPERTY_MISSION10}\n"
            f"\t{REMAINING_SECONDS_FIELD_ZERO}\n"
            "};\n"
        )
        for header in (
            f"struct {CLASS_NAME}\n{{\n{wrap_true}",
            ...
            accepted = (
                ...
                else REMAINING_SECONDS_FIELD_HUNDRED
            )
            self.assertTrue(
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("RemainingSeconds", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("float RemainingSeconds"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("RemainingSeconds", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 RemainingSeconds field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 RemainingSeconds contains "
    ...
    def test_contract_is_remaining_seconds_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_remaining_seconds(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
