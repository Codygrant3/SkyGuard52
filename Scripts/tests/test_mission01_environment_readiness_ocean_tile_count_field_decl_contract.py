...
# OceanTileCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 OceanTileCount = 0; one-line /
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# OceanTileCount FIELD (declaration-only;
...
# FSkyguardMission01EnvironmentReadiness OceanTileCount
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 OceanTileCount = 0;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# OceanTileCount. THIS IS NOT leftover mission-map-
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# OceanTileCount. THIS IS NOT leftover Mission05
...
# Mission01 EnvironmentReadiness OceanTileCount
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 OceanTileCount = 0;
# one-line / split-line UPROPERTY wraps;
...
# OceanTileCount FIELD (declaration-only). It is
...
TARGET = "int32 OceanTileCount = 0;"
TARGET_WRONG = "int32 OceanTileCount = 1;"
LOCKED_DECL = TARGET
...
class Mission01EnvironmentReadinessOceanTileCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("OceanTileCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_ocean_tile_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_ocean_tile_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 OceanTileCount"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("OceanTileCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("OceanTileCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 OceanTileCount"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("OceanTileCount", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_ocean_tile_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
