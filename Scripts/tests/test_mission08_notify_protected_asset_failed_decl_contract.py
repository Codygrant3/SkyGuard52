...
# Mission08 Objectives NotifyProtectedAssetFailed
# METHOD on ASkyguardMission08IntegrationDirector. It is
# NOT leftover Mission07 NotifyProtectedAssetFailed
# #712, NOT leftover Mission05 NotifyProtectedAssetFailed,
# NOT leftover Mission01 / Mission03 / Mission04 /
# Mission06 NotifyProtectedAssetFailed, NOT leftover
# NotifyProtectedTargetDamage, NOT leftover Mission08
# InitializePlayableMission, NOT leftover
...
# leftover Mission05 NotifyProtectedAssetFailed,
# leftover Mission06 NotifyProtectedAssetFailed,
...
# Category is Skyguard|Mission08|Objectives, not
# Mission01 / Mission02 / Mission03 / Mission04 /
# Mission05 / Mission06 / Mission07 / Integration /
# Search / Protection / Payload / Targets /
# Waves / Boss / Destruction / Briefing /
# Hoist / Safety / Rescue, not Environment,
...
# Mission06 Objectives, not leftover Mission05
# Objectives, not leftover Mission07 Objectives #712,
# not leftover Harbor Mission02.
...
# drafts #674–#733, leftover Apache
...
# Mission08IntegrationDirector public section and
...
# NotifyProtectedAssetFailed #712. Do not reopen leftover
...
# Do not reopen open drafts #674–#733.
...
class Mission08NotifyProtectedAssetFailedDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission08|Objectives", UFUNCTION_OBJECTIVES)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        short_name = "\tbool ThreatDestroyed();\n"
    ...
    def test_environment_category_does_not_satisfy_waves(self) -> None:
        ...
        self.assertNotEqual(leftover_m07_waves, UFUNCTION_OBJECTIVES)
        ...
        self.assertNotIn(leftover_m07_waves, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_hoist, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_safety, UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission01", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission03", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission04", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission05", UFUNCTION_OBJECTIVES)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 NotifyProtectedAssetFailed method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission08 NotifyProtectedAssetFailed contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_notify_threat_destroyed(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_notify_protected_asset_failed"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_hoist_window(self) -> None:
        ...
        self.assertNotIn("Hoist", UFUNCTION_OBJECTIVES)
        self.assertNotIn("UFUNCTION", START_HOIST_WINDOW)
