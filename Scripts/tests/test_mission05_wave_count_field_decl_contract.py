...
# Mission05 IntegrationReadiness WaveCount
...
# WaveCount FIELD #871 / branch cursor/mission02-
# wave-count-field-decl-contract-c332,
# NOT leftover Mission03 WaveCount
# WaveCount FIELD #906 / branch cursor/mission03-
# wave-count-field-decl-contract-c332,
# NOT leftover Mission04 WaveCount
# WaveCount FIELD #940 / branch cursor/mission04-
# wave-count-field-decl-contract-c332,
# NOT leftover Mission10 WaveCount
# WaveCount FIELD #824 / branch cursor/mission10-
# wave-count-field-decl-contract-c332,
...
# Mission04 WaveCount #940, leftover Mission10
# WaveCount #824, leftover Mission05 waves-ready
# #971, leftover Mission05 wave-state enum #ad28.
# Sibling Mission05 readiness-struct drafts
# bMissionDefinitionValid through bSortiePresentationReady
# / bAudioReady / bBriefingReady / bWavesReady /
# bProtectedTargetsReady / bStormRuntimeReady /
# bObjectivesReady / bGunnerReady stay leftover-only.
LOCKED = {
...
LEFTOVER_SAME_NAME_WAVE_COUNT_NOT_LOCKED = (
    ...
    "test_mission09_wave_count_field_decl_contract.py",
    "test_mission10_wave_count_field_decl_contract.py",
)
...
class Mission05WaveCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        for header in (
            ...
            section = public_section(header)
            self.assertTrue(
                has_declaration(section, WAVE_COUNT_NONZERO),
                section,
            )
            self.assertEqual(
                require_declaration(
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 WaveCount field contract "
    ...
    def test_contract_is_wave_count_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_wave_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_leftover_same_name_wave_count_contracts_stay_locked(
        ...
        for leftover in LEFTOVER_MISSION04_WAVE_COUNT_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
