...
STRUCT_NAME = "FSkyguardStormRuntime"
CLASS_NAME = STRUCT_NAME
# THIS IS leftover-safe Mission05 StormRuntime
# LightningRemainingSeconds FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly float = 0.f;
# one-line / split-line UPROPERTY wraps; origin/main
# has NO Category). PARSE
# FSkyguardStormRuntime STRUCT
# public section only (after struct
# FSkyguardStormRuntime, before
...
# FSkyguardMission05ProtectedTargetRuntime, leftover enum
# ESkyguardMission05ProtectedTarget type body,
# leftover ASkyguardMission07IntegrationDirector,
# leftover FSkyguardMission07IntegrationReadiness,
# FSkyguardSearchTrackRuntime, leftover enum
# ESkyguardMission07ProtectedTarget type body, leftover
# Mission08/09 structs, leftover HoistWindowRuntime,
# leftover FSkyguardMission08IntegrationReadiness,
# leftover FSkyguardMission09PoolBudget, leftover
...
# ESkyguardMission08ProtectedTarget / leftover
# ESkyguardMission09ProtectedTarget type body, or private
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission05 StormRuntime
# LightningRemainingSeconds FIELD (declaration-only). THIS IS NOT leftover
# Mission05 protected-target enum #aaa2. THIS IS NOT leftover
# Mission05 protected-target-runtime-defaults #ec8b. THIS IS
# NOT leftover Mission05 closed-without-merge #665 #666
# #668-#673. THIS IS NOT leftover Mission05 director /
# readiness UPROPERTY or leftover Mission05 methods. THIS
# IS NOT leftover GetProtectedTarget /
# NotifyProtectedTargetDamage. THIS IS NOT leftover
# Mission06 Airfield Integrity #1139 / leftover Mission07
# PTR Integrity #1138 / leftover Mission08 PTR Integrity
# #1127 / leftover Mission09 PTR Integrity #1126 / leftover
# in-flight Mission05 PTR Target. THIS IS NOT leftover
# Mission07 director MaximumProtectedTargetIntegrity.
# THIS IS NOT leftover Mission08 PTR Integrity #1127 /
# Mission09 PTR Integrity #1126. THIS IS NOT leftover
# Mission07 protected-target enum #223/#18f2. THIS IS NOT
# leftover Mission07 protected-target-runtime-defaults
# #221/#866c. THIS IS NOT leftover Mission07 director Root
# #1011 through Readiness #1027. THIS IS NOT leftover
# Mission07 readiness-struct #1028 through SearchTrackCount
# #1043. THIS IS NOT leftover GetProtectedTarget #723.
# THIS IS NOT leftover Mission08 Blueprint UFUNCTION
# methods #729-#749. THIS IS NOT leftover hoist-window-
# runtime-defaults #214/#ec79. THIS IS NOT leftover Mission08
# FSkyguardMission08IntegrationReadiness
# WaveCount #1081. THIS IS NOT leftover
# Mission08 same-name readiness-struct field.
...
# #1101 through ObjectiveCount #1113. THIS IS NOT leftover
...
# merge #665 #666 #668-#673, or open drafts #674-#1149.
...
# ProtectedTargetCount #1082. LOCK leftover Mission08
# PTR #1127-#1129, leftover HoistWindowRuntime
# #1130-#1132/#1134. LOCK leftover Mission07
# SearchTrackRuntime TrackId/Sector and leftover
# Mission07 PTR Target. LOCK leftover Mission09
...
# ProtectedTargetCount #1115. LOCK leftover Mission09
# PoolBudget/PoolRuntime/ProtectedTargetRuntime field
# drafts #1116-#1126. LOCK leftover Mission07 Blueprint
# UFUNCTION methods. LOCK leftover Mission10 methods/
# fields #768-#825. LOCK leftover Apache closed
# #411-#426.
...
# INDEX_NONE or lock Integrity
# construction in the .cpp. This is leftover-safe
# Mission05 StormRuntime LightningRemainingSeconds
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly float default 0.f,
# one-line / split-line UPROPERTY wraps) on
# FSkyguardStormRuntime. It is
# leftover-safe Mission05 StormRuntime
# LightningRemainingSeconds FIELD (declaration-only). It is
...
# struct section of
# FSkyguardStormRuntime only
# between struct FSkyguardStormRuntime
# and struct FSkyguardMission05IntegrationReadiness / the following UCLASS /
# leftover ASkyguardMission05IntegrationDirector (not
...
# FSkyguardMission05ProtectedTargetRuntime members, not leftover
...
# This StormRuntime field sits after bLightningActive and before
# LightningFlashCount in the public section.
# Skip leftover b + Ya + kRuntimeReady forever (it sits
# after bMapAssemblyReady and before bGunnerReady). This contract
# is LightningRemainingSeconds after bLightningActive and before LightningFlashCount. THIS IS NOT
# leftover Mission09 protected-target enum #9246 / leftover
# protected-target-runtime-defaults #225 / leftover #bf28 /
# leftover ProtectedTargetRuntime Target #1124 / leftover
# Mission08 PTR Integrity #1127 / leftover
# Mission09 ProtectedTargetRuntime Integrity #1126 / leftover
# Mission09 ProtectedTargetRuntime bDestroyed / leftover
# Mission07 director MaximumProtectedTargetIntegrity /
# Mission08 director MaximumProtectedTargetIntegrity #1065 /
# leftover Mission09 director MaximumProtectedTargetIntegrity #1097. Skip leftover
...
# drafts #674-#1149 including leftover Mission02
...
# 06/07 test files (Mission08/09-only).
...
# the locked FSkyguardStormRuntime
# public section. Do not parse
# ASkyguardMission05IntegrationDirector director-class
# fields. Do not parse FSkyguardMission05IntegrationReadiness.
# Do not parse leftover ASkyguardMission07IntegrationDirector.
...
# Do not parse leftover FSkyguardMission05ProtectedTargetRuntime.
# Do not parse leftover FSkyguardMission09ProtectedTargetRuntime
# fields. Do not parse private UPROPERTY(Transient).
# Do not parse FSkyguardAirfieldTargetRuntime.
# Do not parse FSkyguardPayloadWindowRuntime. Do
# parse FSkyguardStormRuntime public section only. Pathfinder MinHeightFromOriginCm
...
# drafts #674-#1149. Do not reopen leftover
...
LIGHTNING_REMAINING_SECONDS = (
    "float LightningRemainingSeconds = 0.f;"
)
LIGHTNING_REMAINING_SECONDS_WRONG = (
    "float LightningRemainingSeconds = 1.f;"
)
LOCKED_DECL = LIGHTNING_REMAINING_SECONDS
...
# an isolated Python LightningRemainingSeconds
...
# LOCK leftover Mission01/02/03/04/05/06/07/08/09/10 same-name
# director and readiness-struct drafts. LOCK leftover
# Mission05 methods. LOCK leftover Mission06 methods and
# AirfieldTargetRuntime #1139/#1141/#1142 and
# PayloadWindowRuntime #1143/#1144/#1145/#1146. LOCK leftover
# Mission07 director Root #1011 through Readiness #1027.
# LOCK leftover Mission07 PTR #1137/#1138/#1140.
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission08_hoist_window_runtime_active_field_decl_contract.py",
    "Scripts/tests/test_mission08_hoist_window_runtime_covered_seconds_field_decl_contract.py",
    "Scripts/tests/test_mission08_hoist_window_runtime_remaining_seconds_field_decl_contract.py",
    "Scripts/tests/test_mission05_protected_target_runtime_target_field_decl_contract.py",
    ...
    "Scripts/tests/test_mission06_payload_window_runtime_remaining_seconds_field_decl_contract.py",
    "Scripts/tests/test_mission06_payload_window_runtime_jammed_field_decl_contract.py",
    ...
    "Scripts/tests/test_mission08_hoist_window_runtime_completed_windows_field_decl_contract.py",
    "Scripts/tests/test_mission05_protected_target_runtime_integrity_field_decl_contract.py",
    "Scripts/tests/test_mission05_protected_target_runtime_destroyed_field_decl_contract.py",
    "Scripts/tests/test_mission05_storm_runtime_turbulence_field_decl_contract.py",
    "Scripts/tests/test_mission05_storm_runtime_lightning_active_field_decl_contract.py",
...
class Mission05StormRuntimeLightningRemainingSecondsFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("LightningRemainingSeconds", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_lightning_remaining_seconds_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_bool = "\tbool Integrity = false;\n"
        leftover_enum = (
            "\tESkyguardMission08ProtectedTarget Integrity = "
            "ESkyguardMission08ProtectedTarget::RescueHelicopter;\n"
        )
        leftover_zero = f"\t{LIGHTNING_REMAINING_SECONDS_WRONG}\n"
    ...
    def test_lightning_remaining_seconds_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("float LightningRemainingSeconds"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("LightningRemainingSeconds", LOCKED_DECL)
        ...
        self.assertNotIn("FSkyguardMission06AirfieldTargetRuntime", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("LightningRemainingSeconds", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("float LightningRemainingSeconds"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("LightningRemainingSeconds", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 LightningRemainingSeconds field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 LightningRemainingSeconds contains "
    ...
    def test_contract_is_lightning_remaining_seconds_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_lightning_remaining_seconds(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission05_storm_runtime_lightning_remaining_seconds"
            "_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_storm_runtime_lightning_remaining_seconds"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_parse_director_class_or_protected_target_runtime(
        self,
    ) -> None:
        header = origin_main_header()
        match = CLASS_RE.search(header)
        ...
        storm_section = public_section(storm_only)
        self.assertTrue(has_declaration(storm_section, LOCKED_DECL))
        ptr_only = (
    ...
    def test_leftover_same_name_wave_count_contracts_stay_locked(
        ...
        self.assertIn(
            "Scripts/tests/test_mission09_protected_target_runtime_integrity"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission09_protected_target_runtime_target"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission09_protected_target_runtime_destroyed"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_hoist_window_runtime"
            "_active_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_hoist_window_runtime"
            "_covered_seconds_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_hoist_window_runtime"
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_storm_runtime"
            "_turbulence_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission05_storm_runtime"
            "_lightning_active_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission06_payload_window_runtime"
            "_jammed_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission07_protected_target_runtime"
