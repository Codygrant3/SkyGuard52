...
# INDEX_NONE or lock bRunwayBreakerReady
# construction in the .cpp. This is leftover-safe
# Mission06 IntegrationReadiness bRunwayBreakerReady
...
# This readiness-struct field sits after bGunnerReady.
# Skip leftover b + Ya + kRuntimeReady forever (it sits
# after bMapAssemblyReady and before bGunnerReady). Skip leftover
...
LOCKED_DECL = RUNWAY_BREAKER_READY
...
# an isolated Python bRunwayBreakerReady
...
class Mission06RunwayBreakerReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bRunwayBreakerReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_runway_breaker_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_runway_breaker_ready_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bRunwayBreakerReady"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bRunwayBreakerReady", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bRunwayBreakerReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bRunwayBreakerReady"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bRunwayBreakerReady", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 bRunwayBreakerReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission06 bRunwayBreakerReady contains "
