...
# WaveCount FIELD (declaration-only;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission09 readiness-struct
# WaveCount. THIS IS NOT leftover Mission08
...
# WaveCount FIELD (declaration-only). It is
...
# is WaveCount after ObjectiveCount and before ProtectedTargetCount. Skip leftover
...
class Mission09WaveCountFieldDeclContractTests(unittest.TestCase):
