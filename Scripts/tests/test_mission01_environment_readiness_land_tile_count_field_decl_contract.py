...
# LandTileCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 LandTileCount = 0; one-line /
...
# LandTiles #587 (ASkyguardMission01EnvironmentDirector::
# LandTiles). THIS IS NOT leftover OceanTileCount
# sibling #1170. THIS IS NOT leftover FSkyguardEnvironmentReadiness
# BoundCapabilityCount #1167 / TreeInstanceCount #1165.
# THIS IS NOT leftover environment-readiness-defaults #b931.
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# LandTileCount FIELD (declaration-only;
...
# FSkyguardMission01EnvironmentReadiness LandTileCount
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 LandTileCount = 0;
...
# director LandTiles #587. THIS IS NOT leftover
# OceanTileCount sibling #1170. THIS IS NOT leftover
# BoundCapabilityCount sibling (in-flight; LOCK
# that script; do not edit it). LOCK in-flight
# leftover-safe BeachTileCount /
# bAuthoredLandscapeSurfaceExposed sibling
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# LandTileCount. THIS IS NOT leftover mission-map-
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# LandTileCount. THIS IS NOT leftover Mission05
...
# Mission01 EnvironmentReadiness LandTileCount
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 LandTileCount = 0;
# one-line / split-line UPROPERTY wraps;
...
# LandTileCount FIELD (declaration-only). It is
...
TARGET = "int32 LandTileCount = 0;"
TARGET_WRONG = "int32 LandTileCount = 1;"
LOCKED_DECL = TARGET
...
class Mission01EnvironmentReadinessLandTileCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("LandTileCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_land_tile_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_land_tile_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 LandTileCount"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("LandTileCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("LandTileCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 LandTileCount"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("LandTileCount", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_land_tile_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
