...
# lines as KindAt( / const FSkyguardDaySortieBeatKit& Kit, /
# int32 Index);
KIND_AT = (
...
KIND_AT_HEAD = "KindAt("
KIND_AT_KIT = "const FSkyguardDaySortieBeatKit& Kit,"
...
# on-main BrokenHighway() sequences, Beats[7] (#251), beat-kind enum
# (#244), beat defaults (#249), and kit FName fields (#256) stay
# sibling-only.
LOCKED_SCRIPTS = (
...
class DaySortieKindAtContractTests(unittest.TestCase):
    ...
    def test_contract_does_not_read_cpp_or_kind_tables(self) -> None:
        ...
        self.assertNotIn("SkyguardDaySortieBeatKit::KindAt", body)
    ...
    def test_declaration_bans_igla_yak_rifle(self) -> None:
        ...
        for banned in BANNED:
            self.assertNotIn(
                banned,
                lowered,
                f"day-sortie KindAt contains {banned}; "
