...
# Mission02 Integration AudioDirector
# FIELD (declaration-only, split-line) on
# ASkyguardMission02IntegrationDirector. It is
# NOT leftover Mission10 AudioDirector field #794 /
# branch cursor/mission10-audio-director-field-
# decl-contract-c332, NOT leftover Mission01
# AudioDirector field #572, NOT leftover Mission03-
...
# leftover FSkyguardMission02IntegrationReadiness
...
# Category is Skyguard|Mission02, not leftover Mission10, not
...
# drafts #674–#792, leftover Apache
...
class Mission02AudioDirectorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 AudioDirector field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 AudioDirector field contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_audio_director_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
