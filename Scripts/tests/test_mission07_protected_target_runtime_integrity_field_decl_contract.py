...
STRUCT_NAME = "FSkyguardMission07ProtectedTargetRuntime"
CLASS_NAME = STRUCT_NAME
# THIS IS leftover-safe Mission07 ProtectedTargetRuntime
...
# FSkyguardMission07ProtectedTargetRuntime STRUCT
# public section only (after struct
# FSkyguardMission07ProtectedTargetRuntime, before
...
# merge #665 #666 #668-#673, or open drafts #674-#1135.
...
# Mission07 ProtectedTargetRuntime Integrity
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 default 100,
# one-line / split-line UPROPERTY wraps) on
# FSkyguardMission07ProtectedTargetRuntime. It is
# leftover-safe Mission07 ProtectedTargetRuntime
...
# struct section of
# FSkyguardMission07ProtectedTargetRuntime only
# between struct FSkyguardMission07ProtectedTargetRuntime
# and struct FSkyguardMission07IntegrationReadiness / the following UCLASS /
...
# drafts #674-#1135 including leftover Mission02
...
# drafts #674-#1135. Do not reopen leftover
...
class Mission07ProtectedTargetRuntimeIntegrityFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 Integrity field contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission07_protected_target_runtime_integrity"
            "_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_protected_target_runtime_integrity"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
