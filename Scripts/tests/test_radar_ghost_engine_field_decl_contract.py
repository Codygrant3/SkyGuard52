...
# RadarGhost Engine is distinct from leftover Pathfinder
# Engine. Do not open SkyguardPathfinderBoss.h as the
# locked header.
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardRadarGhostBoss::Engine",
    "SkyguardRadarGhostBoss.cpp",
    "SetExposed",
...
class RadarGhostEngineFieldDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_radar_receiver = f"\t{RADAR_RECEIVER_FIELD}\n"
    ...
    def test_contract_does_not_lock_engine_cpp_body(self) -> None:
        ...
        self.assertNotIn("SkyguardRadarGhostBoss.cpp", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        self.assertNotIn("IsContactIdentified", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_sibling_radar_ghost_fields(self) -> None:
        ...
        for token in SIBLING_RADAR_GHOST_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("SignatureModulator", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_dispenser_port(self) -> None:
        ...
        for token in LEFTOVER_DISPENSER_PORT_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("DispenserPort", ENGINE_FIELD)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardRadarGhostBoss::Engine", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "radar ghost Engine field contract contains "
