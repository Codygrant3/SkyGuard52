...
# Mission05 MissionDefinition FIELD
...
# MissionDefinition field #799 / branch cursor/
# mission10-mission-definition-field-decl-
# contract-c332, NOT leftover Mission05
# CampaignDefinition sibling, NOT leftover Mission05
# AudioDirector sibling, NOT leftover Mission03
# bMissionDefinitionValid / leftover Mission03
# bCampaignRuntimeStarted #902, NOT leftover
# Mission04 Root #907 / SearchlightPort #908 /
# SearchlightStarboard #909 / Briefing #910 /
# AudioDirector #911, NOT leftover Mission03 Root field
...
# Root / SearchlightPort / SearchlightStarboard /
# CampaignDefinition /
...
# Skip leftover Mission05 closed-without-merge
# #665 #666 #668 #669 #670 #671 #672 #673. Skip leftover
# Mission05 wave-state enum #ad28, leftover Mission05
# protected-target enum #aaa2, leftover Mission05
# protected-target-runtime-defaults #ec8b, leftover
# storm-runtime-defaults #89c9.
# Do not lock leftover bMissionDefinitionValid or
# bCampaignDefinitionValid / bCampaignRuntimeStarted.
# Do not lock leftover FSkyguardMission05IntegrationReadiness
# fields. Do not lock leftover Mission05 CampaignDefinition.
...
# drafts #674-#948, leftover Apache
...
# drafts #674-#948 including leftover Mission03
...
class Mission05MissionDefinitionFieldDeclContractTests(unittest.TestCase):
    ...
    def test_mission_definition_declaration_matches_origin_main(self) -> None:
        ...
        self.assertIn("TSoftObjectPtr", LOCKED_DECL)
        self.assertTrue(
            LOCKED_DECL.startswith("TSoftObjectPtr<"),
            LOCKED_DECL,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 MissionDefinition field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 MissionDefinition field contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_mission_definition_field"
                "_decl_contract.py"
            )
        )
        leftover_56_64 = (
    ...
    def test_storm_runtime_struct_does_not_satisfy_mission_definition(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_leftover_mission04_campaign_definition_does_not_satisfy(self) -> None:
        leftover = (
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission04_campaign_definition_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_campaign_definition_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_mission_definition_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
