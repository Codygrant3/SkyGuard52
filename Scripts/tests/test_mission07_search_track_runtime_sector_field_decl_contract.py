...
# THIS IS leftover-safe Mission07 SearchTrackRuntime
# Sector FIELD (declaration-only;
...
# FSkyguardSearchTrackRuntime STRUCT
# public section only (after struct
# FSkyguardSearchTrackRuntime, before
...
# FSkyguardMission07ProtectedTargetRuntime, leftover
# Mission08 HoistWindowRuntime / ProtectedTargetRuntime,
# leftover enum ESkyguardSearchSector type body, leftover
# FSkyguardMission09ProtectedTargetRuntime, leftover
# FSkyguardMission09IntegrationReadiness,
# FSkyguardMission09PoolBudget,
# FSkyguardMission09PoolRuntime, leftover Mission09
# structs, leftover Mission08 structs, or private
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission07 SearchTrackRuntime
# Sector FIELD. THIS IS NOT leftover SearchTrackRuntime
# TrackId #1133. THIS IS NOT leftover search-track-
# runtime-defaults #219/#8266. THIS IS NOT leftover
# search-sector enum #b4d4. THIS IS NOT leftover
# Mission07 SearchTrackCount readiness field #1043.
# THIS IS NOT leftover ClassifyFalseTrack #710 /
# GetClassifiedFalseTrackCount #722 / GetSearchSector
# #720. THIS IS NOT leftover Mission07 director Root
# #1011 through Readiness #1027. THIS IS NOT leftover
# Mission07 readiness-struct #1028 through
# SearchTrackCount #1043. THIS IS NOT leftover
# Mission07 Blueprint UFUNCTION methods. THIS IS NOT
# leftover Mission07 protected-target enum #18f2 /
# leftover Mission07 protected-target-runtime-defaults
# #866c. THIS IS NOT leftover Mission09
# ProtectedTargetRuntime Integrity. THIS IS NOT leftover
...
# merge #665 #666 #668-#673, or open drafts #674-#1133.
...
# bActive #1130 / CoveredSeconds #1131 / RemainingSeconds #1132. LOCK leftover
# Mission09 Blueprint UFUNCTION methods. LOCK leftover
# Mission09 director Root #1083 through director
# Readiness #1100. LOCK leftover Mission09 readiness-
# struct bMissionDefinitionValid #1101 through
# ProtectedTargetCount #1115. LOCK leftover Mission09
# PoolBudget/PoolRuntime/ProtectedTargetRuntime field
# drafts #1116-#1126. LOCK leftover Mission10 methods/
...
# INDEX_NONE construction in the .cpp. Accept
# = ESkyguardSearchSector::SectorA on this ESkyguardSearchSector field. This is leftover-safe
# Mission07 SearchTrackRuntime TrackId
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly ESkyguardSearchSector default SectorA,
# one-line / split-line UPROPERTY wraps) on
# FSkyguardSearchTrackRuntime. It is
# leftover-safe Mission07 SearchTrackRuntime
# Sector FIELD (declaration-only). It is
...
# This HoistWindowRuntime field sits first in the public
# section, before RemainingSeconds / CoveredSeconds /
# CompletedWindows. Skip leftover
# b + Ya + kRuntimeReady forever (it sits after
# bMapAssemblyReady and before bGunnerReady). This contract
# is bActive before RemainingSeconds. THIS IS NOT leftover Mission08
# ProtectedTargetRuntime Target #1129 / Integrity #1127 /
# bDestroyed #1128. THIS IS NOT leftover hoist-window-
# runtime-defaults #214/#ec79. THIS IS NOT leftover
# StartHoistWindow #732 / AdvanceHoistWindow #734 /
# GetHoistRuntime #744. THIS IS NOT leftover Mission09
# protected-target enum #9246 / leftover protected-target-
# runtime-defaults #225 / leftover #bf28. THIS IS NOT leftover
# Target #1124 / leftover Integrity sibling field. Skip leftover
...
# drafts #674-#1126 including leftover Mission02
...
# drafts #674-#1133. Do not reopen leftover
...
class Mission07SearchTrackRuntimeSectorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("Sector", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_active_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("ESkyguardSearchSector Sector"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= ESkyguardSearchSector::SectorA;"), LOCKED_DECL)
        ...
        self.assertIn("Sector", LOCKED_DECL)
        self.assertNotIn("ESkyguardMission09ProtectedTarget ", LOCKED_DECL)
        self.assertIn("= ESkyguardSearchSector::SectorA", LOCKED_DECL)
        self.assertNotIn("int32", LOCKED_DECL)
        self.assertIn("ESkyguardSearchSector ", LOCKED_DECL)
        ...
        self.assertNotIn("ESkyguardMission09ProtectedTarget", LOCKED_DECL)
        self.assertTrue(
            LOCKED_DECL.startswith("ESkyguardSearchSector "),
            LOCKED_DECL,
        )
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertIn("ESkyguardSearchSector::SectorA", section)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("Sector", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("ESkyguardSearchSector Sector"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("Sector", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 Sector field contract "
    ...
    def test_contract_is_active_field_declaration_only(
        ...
        self.assertTrue(LOCKED_DECL.startswith("ESkyguardSearchSector Sector"))
        self.assertIn("Sector", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("= ESkyguardSearchSector::SectorA;"))
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_search_track_runtime"
                "_sector_field_decl_contract.py"
            )
        )
        self.assertIn(
