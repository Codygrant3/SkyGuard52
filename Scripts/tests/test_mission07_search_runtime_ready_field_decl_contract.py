...
# INDEX_NONE or lock bSearchRuntimeReady
# construction in the .cpp. This is leftover-safe
# Mission07 IntegrationReadiness bSearchRuntimeReady
...
# bSearchRuntimeReady FIELD (declaration-only). It is
# NOT leftover Mission04 bSearchlightsReady #935 /
# branch cursor/mission04-searchlights-ready-
# field-decl-contract-c332. It is NOT leftover
# Mission07 GetSearchSector #720. It is NOT leftover
# search-track-runtime-defaults #8266 / leftover
# search-sector enum #b4d4. It is NOT leftover
# Mission07 director Readiness #1027. It is NOT
# leftover Mission07 bWavesReady FIELD #1034 /
# branch cursor/mission07-waves-ready-field-
# decl-contract-c332. It is NOT leftover-safe
# Mission07 readiness-struct bProtectedTargetsReady
# / bBriefingReady siblings spawned this wave.
# It is
...
# FIELD #1027, NOT leftover Mission07 wave-state
# enum #74d8, NOT leftover Mission07 readiness-struct
# bRadarGhostReady / bObjectivesReady / bGunnerReady
# #1031 siblings spawned this wave,
# NOT leftover Mission07 director Readiness
...
# struct). This contract is bSearchRuntimeReady after
# bWavesReady. Skip leftover
...
# drafts #674-#1034 including leftover Mission02
...
SEARCH_RUNTIME_READY_TRUE = (
    "bool bSearchRuntimeReady = true;"
)
LOCKED_DECL = SEARCH_RUNTIME_READY
...
# an isolated Python bSearchRuntimeReady
...
LEFTOVER_MISSION04_SEARCHLIGHTS_READY_NOT_LOCKED = (
    "test_mission04_searchlights_ready_field_decl_contract.py",
    "cursor/mission04-searchlights-ready-field-decl-contract-c332",
)
OBJECTIVES_READY = (
...
class Mission07SearchRuntimeReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bSearchRuntimeReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_search_runtime_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_search_runtime_ready_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bSearchRuntimeReady"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bSearchRuntimeReady", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bSearchRuntimeReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bSearchRuntimeReady"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bSearchRuntimeReady", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 bSearchRuntimeReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission07 bSearchRuntimeReady contains "
    ...
    def test_contract_is_search_runtime_ready_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_search_runtime_ready(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission07_search"
            "_runtime_ready_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_search"
                "_runtime_ready_field_decl_contract.py"
            )
        )
        self.assertIn(
            "Scripts/tests/test_mission07_waves"
            "_ready_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission07_protected"
            "_targets_ready_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission07_briefing"
            "_ready_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission04_searchlights"
            "_ready_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_same_name_waves_ready_contracts_stay_locked(
        ...
        self.assertNotIn(
            "Scripts/tests/test_mission07_search_runtime"
            "_ready_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        for leftover in LEFTOVER_MISSION07_BRIEFING_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION04_SEARCHLIGHTS_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        ...
        self.assertNotEqual(LOCKED_DECL, SEARCHLIGHTS_READY)
        ...
        self.assertNotIn(SEARCHLIGHTS_READY, LOCKED_DECL)
