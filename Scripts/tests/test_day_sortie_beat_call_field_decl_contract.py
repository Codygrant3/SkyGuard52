# THIS IS leftover-safe FSkyguardDaySortieBeat Call.
...
# Do NOT parse leftover `FSkyguardNightSortieBeat` or
...
# #247 / #5bf1 (keep analog bulk locked).
...
# #6893 (keep analog bulk locked).
# THIS IS NOT leftover NightSortieBeat isolated Kind / Call /
# Threat drafts (keep those files in LOCKED_SCRIPTS).
...
# test_day_sortie_beat_kit_contract.py (keep that file
...
STOP_BEFORE_NIGHT = "FSkyguardNightSortieBeat"
...
LEFTOVER_DAY_SORTIE_BEAT_KIND_ENUM = (
    "Scripts/tests/test_day_sortie_beat_kind_enum_contract.py"
)
LEFTOVER_NIGHT_SORTIE_BEAT_KIND_FIELD = (
    "Scripts/tests/test_night_sortie_beat_kind"
    "_field_decl_contract.py"
)
LEFTOVER_NIGHT_SORTIE_BEAT_CALL_FIELD = (
    "Scripts/tests/test_night_sortie_beat_call"
    "_field_decl_contract.py"
)
LEFTOVER_NIGHT_SORTIE_BEAT_THREAT_FIELD = (
...
class DaySortieBeatCallFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "day-sortie-beat Call field decl contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(LEFTOVER_DAY_SORTIE_BEAT_KIND_ENUM, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_NIGHT_SORTIE_BEAT_KIND_FIELD, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_NIGHT_SORTIE_BEAT_CALL_FIELD, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_NIGHT_SORTIE_BEAT_THREAT_FIELD, LOCKED_SCRIPTS)
    ...
    def test_contract_is_target_field_declaration_only(self) -> None:
        ...
        self.assertNotIn(STOP_BEFORE_NIGHT, locked_only)
