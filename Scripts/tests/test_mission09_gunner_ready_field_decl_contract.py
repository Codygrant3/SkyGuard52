...
# bGunnerReady FIELD (declaration-only;
...
# bGunnerReady. THIS IS NOT leftover
...
# struct bGunnerReady drafts. THIS IS NOT leftover
...
# forever; it sits immediately before bGunnerReady
# in this same struct -- do not test it; never write
# that live-mount token contiguously). THIS IS NOT leftover
...
# INDEX_NONE or lock bGunnerReady
# construction in the .cpp. This is leftover-safe
# Mission09 IntegrationReadiness bGunnerReady
...
# an isolated Python bGunnerReady
...
class Mission09GunnerReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bGunnerReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_gunner_ready_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bGunnerReady"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bGunnerReady", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bGunnerReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bGunnerReady"))
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 bGunnerReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 bGunnerReady contains "
