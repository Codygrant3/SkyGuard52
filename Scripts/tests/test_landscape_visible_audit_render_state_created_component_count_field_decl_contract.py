...
# RenderStateCreatedComponentCount FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# int32 RenderStateCreatedComponentCount = 0; one-line /
...
TARGET = "int32 RenderStateCreatedComponentCount = 0;"
TARGET_WRONG = "float RenderStateCreatedComponentCount = 0;"
LOCKED_DECL = TARGET
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*int32\s+RenderStateCreatedComponentCount\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for int32 RenderStateCreatedComponentCount is missing from "
...
class LandscapeVisibleAuditRenderStateCreatedComponentCountFieldDeclContractTests(unittest.TestCase):
    def test_landscape_visible_audit_struct_exists(self) -> None:
        ...
        self.assertIn("RenderStateCreatedComponentCount", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("RenderStateCreatedComponentCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_render_state_created_component_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_render_state_created_component_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 RenderStateCreatedComponentCount"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("RenderStateCreatedComponentCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("RenderStateCreatedComponentCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 RenderStateCreatedComponentCount"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("RenderStateCreatedComponentCount", locked_only)
