...
# bMissionDefinitionValid FIELD (declaration-only;
...
# bMissionDefinitionValid #1067. THIS IS NOT leftover
# Mission07 FSkyguardMission07IntegrationReadiness
# bMissionDefinitionValid #1028. THIS IS NOT leftover
...
# struct bMissionDefinitionValid drafts. THIS IS NOT
# leftover Mission09 Root #1083 through
...
# b + Ya + kRuntimeReady forever; it sits later in this
# same struct between bMapAssemblyReady and bGunnerReady
...
# director Root #1083 through CampaignSaveUserIndex
# #1098.
...
# INDEX_NONE or lock bMissionDefinitionValid
# construction in the .cpp. This is leftover-safe
# Mission09 IntegrationReadiness bMissionDefinitionValid
...
# CampaignSaveUserIndex #1098 / MissionDefinition #1092,
...
# drafts #674-#1098 including leftover Mission02
...
# drafts #674-#1098. Do not reopen leftover
...
MISSION_DEFINITION_VALID = (
    "bool bMissionDefinitionValid = false;"
)
LOCKED_DECL = MISSION_DEFINITION_VALID
...
# an isolated Python bMissionDefinitionValid
...
class Mission09MissionDefinitionValidFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bMissionDefinitionValid", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_mission_definition_valid_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_mission_definition_valid_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bMissionDefinitionValid"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bMissionDefinitionValid", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_true_default = (
            "public:\n"
            f"\t{UPROPERTY_MISSION10}\n"
            "\tbool bMissionDefinitionValid = true;\n"
            "};\n"
        )
        header_wrap_type = (
            f"struct {CLASS_NAME}\n{{\n{wrap_type}"
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bMissionDefinitionValid", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bMissionDefinitionValid"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bMissionDefinitionValid", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 bMissionDefinitionValid field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 bMissionDefinitionValid contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_mission_definition"
                "_valid_field_decl_contract.py"
            )
        )
        self.assertIn(
