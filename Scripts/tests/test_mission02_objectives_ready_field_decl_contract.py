...
# Mission02 IntegrationReadiness bObjectivesReady
...
# NOT leftover Mission10 bObjectivesReady FIELD #815 /
# branch cursor/mission10-objectives-ready-field-decl-
...
# bObjectivesReady #815, leftover Apache
...
# drafts #674-#861 including leftover Mission10
# bObjectivesReady #815 and leftover Mission02
# siblings #828-#859.
...
LEFTOVER_MISSION10_OBJECTIVES_READY_FIELD_NOT_LOCKED = (
...
class Mission02ObjectivesReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 bObjectivesReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 bObjectivesReady contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_objectives_ready"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_objectives_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
