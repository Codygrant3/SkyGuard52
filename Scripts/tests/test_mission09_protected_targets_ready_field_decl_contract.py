...
# bProtectedTargetsReady FIELD (declaration-only;
...
# bProtectedTargetsReady. THIS IS NOT leftover
# Mission07 FSkyguardMission07IntegrationReadiness
# bProtectedTargetsReady. THIS IS NOT leftover
# Mission09 director fields. THIS IS
# NOT leftover Mission09 director Readiness field
# #1100 / branch cursor/mission09-readiness-
# field-decl-contract-c332. THIS IS NOT leftover
# Mission09 director Root #1083. THIS IS NOT leftover
# Mission06/05/04/03/02/01/10 same-name readiness-
# struct bProtectedTargetsReady drafts. THIS IS NOT leftover
# Mission09 director Root #1083 through director
# Readiness #1100. THIS IS NOT leftover
# Mission09 Blueprint UFUNCTION methods. THIS IS NOT
# leftover director-class public UPROPERTY fields.
# THIS IS NOT leftover spawn-location / leftover
# runtime-ready flag (skip leftover b + Ya + kRuntimeReady
# forever; it sits BETWEEN bMapAssemblyReady and
# bGunnerReady on this same struct -- do not test it;
# never write that live-mount token contiguously).
# THIS IS NOT leftover Mission08/09 wave-state enums,
# protected-target enums, protected-target-runtime-
# defaults, leftover hoist-window-runtime-defaults
# #ec79, leftover Mission09 pool-runtime-defaults
# #5426 / leftover Mission09 pool-budget-defaults #4537.
...
# merge #665 #666 #668-#673, or open drafts #674-#1106.
...
# bMissionDefinitionValid #1101 through bIronRainReady
# #1106.
...
# INDEX_NONE or lock bProtectedTargetsReady
# construction in the .cpp. This is leftover-safe
# Mission09 IntegrationReadiness bProtectedTargetsReady
...
# NOT leftover Mission07 bProtectedTargetsReady
# FIELD / branch cursor/mission07-
# gunner-ready-field-decl-contract-c332,
# NOT leftover Mission08 director Readiness
# FIELD #1066 / branch cursor/mission08-
# readiness-field-decl-contract-c332,
# NOT leftover Mission08 bMissionDefinitionValid
# FIELD #1067 / branch cursor/mission08-
# mission-definition-valid-field-decl-contract-c332,
# NOT leftover Mission08 bCampaignDefinitionValid
# FIELD #1068 / branch cursor/mission08-
# campaign-definition-valid-field-decl-contract-c332,
# NOT leftover Mission08 bMapAssemblyReady
# FIELD (sibling this wave) / branch cursor/
# mission08-map-assembly-ready-field-decl-
# contract-c332, NOT leftover b + Ya + k
# RuntimeReady (skip forever; sits BETWEEN
# bMapAssemblyReady and leftover bGunnerReady), NOT leftover
# bLifelineHunterReady, NOT leftover Mission08
# MaximumProtectedTargetIntegrity #1065,
# NOT leftover Mission08 director Root #1044
# through MaximumProtectedTargetIntegrity #1065,
# NOT leftover Mission06 bProtectedTargetsReady
# FIELD #999 / branch cursor/mission06-
# gunner-ready-field-decl-contract-c332,
...
# NOT leftover Mission02 bProtectedTargetsReady
# FIELD #864 / branch cursor/mission02-
# gunner-ready-field-decl-contract-c332,
# NOT leftover Mission03 bProtectedTargetsReady
# FIELD #894 / branch cursor/mission03-
# gunner-ready-field-decl-contract-c332,
# NOT leftover Mission04 bProtectedTargetsReady
# FIELD #932 / branch cursor/mission04-
# gunner-ready-field-decl-contract-c332,
# NOT leftover Mission05 bProtectedTargetsReady
# FIELD #967 / branch cursor/mission05-
# gunner-ready-field-decl-contract-c332,
# NOT leftover Mission10 bProtectedTargetsReady
...
# (not ASkyguardMission09IntegrationDirector public
...
# BETWEEN bMapAssemblyReady and leftover bGunnerReady on this
# struct; do not lock this contract onto that leftover
# field). Skip leftover
...
# drafts #674-#1106 including leftover Mission02
...
# drafts #674-#1106. Do not reopen leftover
...
PROTECTED_TARGETS_READY = (
    "bool bProtectedTargetsReady = false;"
)
PROTECTED_TARGETS_READY_TRUE = (
    "bool bProtectedTargetsReady = true;"
)
LOCKED_DECL = PROTECTED_TARGETS_READY
...
# an isolated Python bProtectedTargetsReady
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission04_protected_targets_ready_field_decl_contract.py",
    "Scripts/tests/test_mission03_protected_targets_ready_field_decl_contract.py",
    "Scripts/tests/test_mission02_protected_targets_ready_field_decl_contract.py",
    "Scripts/tests/test_mission01_protected_targets_ready_field_decl_contract.py",
    "Scripts/tests/test_mission10_protected_targets_ready_field_decl_contract.py",
...
LEFTOVER_MISSION09_READINESS_STRUCT_SIBLINGS_NOT_LOCKED = (
    "test_mission09_mission_definition_valid_field_decl_contract.py",
    "test_mission09_campaign_definition_valid_field_decl_contract.py",
    ...
    "cursor/mission09-campaign-definition-valid-field-decl-contract-c332",
    "cursor/mission09-campaign-runtime-started-field-decl-contract-c332",
...
LEFTOVER_MISSION07_PROTECTED_TARGETS_READY_NOT_LOCKED = (
    "test_mission07_protected_targets_ready_field_decl_contract.py",
    "cursor/mission07-protected-targets-ready-field-decl-contract-c332",
)
LEFTOVER_MISSION05_PROTECTED_TARGETS_READY_NOT_LOCKED = (
    "test_mission05_protected_targets_ready_field_decl_contract.py",
    "cursor/mission05-protected-targets-ready-field-decl-contract-c332",
)
...
LEFTOVER_SAME_NAME_PROTECTED_TARGETS_READY_NOT_LOCKED = (
    "test_mission01_protected_targets_ready_field_decl_contract.py",
    "test_mission02_protected_targets_ready_field_decl_contract.py",
    "test_mission03_protected_targets_ready_field_decl_contract.py",
    "test_mission04_protected_targets_ready_field_decl_contract.py",
    "test_mission05_protected_targets_ready_field_decl_contract.py",
    "test_mission06_protected_targets_ready_field_decl_contract.py",
    "test_mission07_protected_targets_ready_field_decl_contract.py",
    "test_mission08_protected_targets_ready_field_decl_contract.py",
    "test_mission10_protected_targets_ready_field_decl_contract.py",
)
LEFTOVER_MISSION08_LIFELINE_HUNTER_READY_NOT_LOCKED = (
    "test_mission08_lifeline_hunter_ready_field_decl_contract.py",
    "cursor/mission08-lifeline-hunter-ready-field-decl-contract-c332",
)
...
LEFTOVER_MISSION07_RADAR_GHOST_READY_NOT_LOCKED = (
    "test_mission07_radar_ghost_ready_field_decl_contract.py",
    "cursor/mission07-radar-ghost-ready-field-decl-contract-c332",
)
LEFTOVER_MISSION09_DIRECTOR_FIELDS_NOT_LOCKED = (
    ...
    "cursor/mission09-root-field-decl-contract-c332",
...
class Mission09ProtectedTargetsReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_protected_targets_ready_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bProtectedTargetsReady"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bProtectedTargetsReady", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bProtectedTargetsReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bProtectedTargetsReady"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bProtectedTargetsReady", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 bProtectedTargetsReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 bProtectedTargetsReady contains "
    ...
    def test_contract_is_protected_targets_ready_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_contract_does_not_parse_director_class_or_storm_runtime(
        ...
        self.assertNotIn("FSkyguardMission09ProtectedTargetRuntime", section)
        self.assertNotIn("FSkyguardMission09PoolBudget", section)
        self.assertNotIn("FSkyguardMission09PoolRuntime", section)
        ...
        for token in LEFTOVER_SAME_NAME_GUNNER_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_SAME_NAME_PROTECTED_TARGETS_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION08_PROTECTED_TARGETS_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION07_PROTECTED_TARGETS_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
    ...
    def test_contract_skips_leftover_retired_runtime_ready(self) -> None:
        ...
        self.assertNotEqual(LOCKED_DECL, GUNNER_READY)
        self.assertNotIn(GUNNER_READY, LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bProtectedTargetsReady"))

    def test_leftover_same_name_ready_contracts_stay_locked(
        self,
    ) -> None:
        for leftover in LEFTOVER_SAME_NAME_GUNNER_READY_NOT_LOCKED:
            self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_SAME_NAME_PROTECTED_TARGETS_READY_NOT_LOCKED:
            self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION08_PROTECTED_TARGETS_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION07_PROTECTED_TARGETS_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION05_PROTECTED_TARGETS_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION06_PROTECTED_TARGETS_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION08_LIFELINE_HUNTER_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        ...
        for leftover in LEFTOVER_MISSION08_BRIEFING_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION07_RADAR_GHOST_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        self.assertNotIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission09_gunner_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_protected_targets_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        for leftover in LEFTOVER_MISSION09_READINESS_STRUCT_SIBLINGS_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION09_DIRECTOR_FIELDS_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        self.assertIn(
