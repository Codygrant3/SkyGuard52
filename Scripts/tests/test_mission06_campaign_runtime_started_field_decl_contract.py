...
# Mission06 IntegrationReadiness bCampaignRuntimeStarted
...
class Mission06CampaignRuntimeStartedFieldDeclContractTests(unittest.TestCase):
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission06 bCampaignRuntimeStarted contains "
