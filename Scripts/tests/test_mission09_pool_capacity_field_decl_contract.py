...
# PoolCapacity FIELD (declaration-only;
# EditAnywhere / BlueprintReadWrite int32 = 48;
# ClampMin 1 / ClampMax 96; one-line / split-line
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission09 PoolBudget
# PoolCapacity. THIS IS NOT leftover Mission08
...
# BlueprintReadWrite int32 default 48,
# ClampMin 1 / ClampMax 96, one-line / split-line
# UPROPERTY wraps) on
# FSkyguardMission09PoolBudget. It is
# leftover-safe Mission09 PoolBudget
# PoolCapacity FIELD (declaration-only). It is
...
# This field has no Category. Accept ClampMin 1 / ClampMax 96.
...
# is PoolCapacity after MaxActiveThreats and before MaxActiveDecoys. Skip leftover
...
UPROPERTY_MISSION10_CLAMP = 'meta=(ClampMin="1", ClampMax="96")'
...
POOL_CAPACITY_WRONG = (
    "int32 PoolCapacity = 24;"
)
LOCKED_DECL = POOL_CAPACITY
...
# an isolated Python PoolCapacity
...
class Mission09PoolCapacityFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("PoolCapacity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_pool_capacity_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn('ClampMax="96"', UPROPERTY_MISSION10)
        self.assertTrue(
            has_declaration(section, LOCKED_DECL),
            section,
        )
    ...
    def test_pool_capacity_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 PoolCapacity"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= 48;"), LOCKED_DECL)
        ...
        self.assertIn("EditAnywhere", UPROPERTY_MISSION10)
        self.assertIn("BlueprintReadWrite", UPROPERTY_MISSION10)
        self.assertIn("PoolCapacity", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("PoolCapacity", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 PoolCapacity"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("PoolCapacity", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 PoolCapacity field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 PoolCapacity contains "
    ...
    def test_contract_is_pool_capacity_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(LOCKED_DECL.startswith("int32 PoolCapacity"))
        self.assertIn("PoolCapacity", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("= 48;"))
        self.assertTrue(LOCKED_DECL.endswith(";"))
        self.assertNotIn("GetProtectedGroup", LOCKED_DECL)
        self.assertNotIn("FSkyguardMission10ProtectedRuntime", LOCKED_DECL)
        self.assertIn(UPROPERTY_MISSION10, section)

    def test_sibling_director_fields_do_not_satisfy_pool_capacity(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
