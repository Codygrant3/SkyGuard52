...
# Mission05 CampaignDefinition FIELD
...
# AudioDirector sibling, NOT leftover Mission04
# MissionDefinition sibling, NOT leftover Mission03
...
# Do not lock leftover bCampaignDefinitionValid or
# bCampaignRuntimeStarted. Do not lock leftover
...
class Mission05CampaignDefinitionFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 CampaignDefinition field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 CampaignDefinition field contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_campaign_definition_field"
                "_decl_contract.py"
            )
        )
        leftover_56_64 = (
    ...
    def test_storm_runtime_struct_does_not_satisfy_campaign_definition(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
