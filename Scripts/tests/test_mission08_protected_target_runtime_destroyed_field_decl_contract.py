...
# Mission08 ProtectedTargetRuntime bDestroyed
...
class Mission08ProtectedTargetRuntimeDestroyedFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 bDestroyed field contract "
