# THIS IS leftover-safe USkyguardEnvironmentVFXPoolComponent
# GetActivationCount.
# origin/main form: one-line and split-line UFUNCTION wraps
# UFUNCTION(BlueprintPure, Category="Skyguard|Environment|VFX")
# wrapping `int32 GetActivationCount() const { return ActivationCount; }`.
# LOCKED_DECL may be declaration-only
# `int32 GetActivationCount() const;` if the matcher strips
# inline bodies, OR the full origin/main inline form.
# Accept declaration-only AND the origin/main inline body.
# Do NOT fail-closed on `{ return ActivationCount; }` the way
# the clone fail-closed TARGET_WRONG_BODY for
# GetResolvedProductionLoopRouteCount.
# THIS IS leftover-safe unique analog Category
# Skyguard|Environment|VFX (unique unused 3-segment suffix
# VFX). This is leftover-safe unique analog, NOT
# leftover analog Environment without |VFX.
# BlueprintPure IS present. const IS present.
...
# Skyguard|Environment WITHOUT the unique leftover-safe
# suffix |VFX, or Skyguard|Environment|Performance
# (leftover unique FIELD), or Skyguard|Apache without
# |Damage / Skyguard|Combat without |Sortie/|Feedback/|Safety
# / Skyguard|Theater / Skyguard|MissionMap /
# Skyguard|Audio|Acceptance / Skyguard|Audio|Development /
# still Category="Skyguard" without a leftover-safe unique
# Category path / Category="Skyguard|Audio" without
# |Production / Category="Skyguard|Boss|Encounter" without a
# leftover-safe unique suffix / Category="Settings" without
# Skyguard| / Category="Skyguard|Mission01|Environment|Validation"
# / Category="Skyguard|Mission01|Environment|Authoring"
# / Category="Skyguard|Presentation|HUD".
# Accept one-line and split-line UFUNCTION wraps.
# Parse class `USkyguardEnvironmentVFXPoolComponent` public
# section ONLY after `class USkyguardEnvironmentVFXPoolComponent`
# / `GENERATED_BODY`. Start at `public:`. Stop BEFORE
# `protected:` and BEFORE `private:`. Stop BEFORE first
# public UPROPERTY (`PoolCapacity`).
# Environment|VFX UFUNCTIONs sit early in public, before
# UPROPERTY.
# Do NOT claim sibling Environment|VFX UFUNCTION
# GetAllocatedPoolSize / ActivatePooledEffect /
# DeactivateAllEffects (other workers; leave uncontracted).
# Do NOT claim leftover analog Mission09 PoolCapacity.
# Do NOT claim leftover analog environment-vfx-pool-fail-closed
# bulk (behavioral; wrap Category VFX UFUNCTION declaration
# only).
# Do NOT claim leftover analog EnvironmentReadiness VFXPoolSize.
# Word-boundary match GetActivationCount vs GetAllocatedPoolSize.
# Identifier GetActivationCount is NOT leftover analog
# GetAllocatedPoolSize and NOT leftover analog GetSortieHits.
# THIS identifier is GetActivationCount.
# Do NOT claim leftover unique Gunner FIELD Boom /
# LookYawLimit / FireCameraShakeClass /
# MinimumSafeSideFireYaw / CPG kit.
# Do NOT claim leftover analog apache-cpg-feel
...
# Do NOT claim leftover unique IronRain
# MaxReleasesPerBay / LastFlight
...
# GetActiveRHIAndFeatureLevel — RETARGET method/return.
# KEEP BlueprintPure.
# Clone leftover unique BlueprintPure GetSortieHits
# Category Skyguard|Combat|Sortie — RETARGET Category
# Combat|Sortie -> Skyguard|Environment|VFX. KEEP BlueprintPure.
# RETARGET `int32 GetSortieHits() const;` ->
# `int32 GetActivationCount() const;`
# FAIL-CLOSED if LOCKED_DECL is `int32 GetSortieHits() const;`.
# FAIL-CLOSED if LOCKED_DECL is `int32 GetAllocatedPoolSize() const;`.
# Clone leftover unique Validation BlueprintCallable —
# RETARGET method; this slot is BlueprintPure not
# BlueprintCallable.
# Clone leftover unique BlueprintCallable EnsureDefaultEntries
# Category Production — RETARGET Category Production ->
# Skyguard|Environment|VFX. KEEP BlueprintPure not
# BlueprintCallable.
# Clone #1300 is Category Theater wrapping FName
# WeatherIdentity with no initializer — RETARGET hard.
# LOCKED_DECL is `int32 GetActivationCount() const;`
# NOT `int32 GetSortieHits() const;` and NOT
# `int32 GetAllocatedPoolSize() const;` and NOT
# `void DeactivateAllEffects();` and NOT
# `bool ActivatePooledEffect(` and NOT
# `int32 PoolCapacity = 12;` and NOT
# `int32 GetResolvedProductionLoopRouteCount() const;`
# and NOT `FName WeatherIdentity;` and NOT
...
# `void EnsureDefaultEntries();` and NOT `Hits =`
# and NOT leftover `float FireRate = 12.0f` and NOT
# `float RecoilPitch = 0.92f` and NOT
# `float RouteLengthCm = 45000.f` and NOT `160.f`.
# Fail-closed if this test still asserts
# GetSortieHits / GetAllocatedPoolSize / DeactivateAllEffects /
# ActivatePooledEffect / PoolCapacity = 12 /
# GetResolvedProductionLoopRouteCount / WeatherIdentity /
# GetLampInstanceCount / ResetSortieCombatStats /
# GetInvertVerticalLook / bSuccess = false /
# EnsureDefaultEntries / Hits = / FireRate=12.0f
# AS THE LOCKED DECL.
...
HEADER_PATH = "Source/Skyguard52/SkyguardEnvironmentVFXPoolComponent.h"
CLASS_NAME = "USkyguardEnvironmentVFXPoolComponent"
TARGET = "int32 GetActivationCount() const;"
TARGET_WRONG_BARE = "int32 GetActivationCount();"
TARGET_WRONG_INIT = "int32 GetActivationCount() = nullptr;"
TARGET_WRONG_FALSE = "bool bLicensedVegetationLibraryApproved = false;"
TARGET_WRONG_TRUE = "int32 GetActivationCount() = true;"
TARGET_WRONG_ZERO = "int32 GetActivationCount() = 0.f;"
TARGET_WRONG_NO_CONST = "int32 GetActivationCount();"
TARGET_WRONG_FLOAT = "float GetActivationCount() const;"
TARGET_WRONG_FNAME_RET = "FName GetActivationCount() const;"
...
TARGET_WRONG_RESET = "void DeactivateAllEffects();"
TARGET_WRONG_FILL = "bool ActivatePooledEffect("
TARGET_WRONG_DAMAGE = "int32 PoolCapacity = 12;"
...
TARGET_WRONG_SORTIE_HITS = "int32 GetSortieHits() const;"
TARGET_WRONG_ACTIVATION = "int32 GetAllocatedPoolSize() const;"
TARGET_WRONG_DEACTIVATE = "void DeactivateAllEffects();"
TARGET_WRONG_ACTIVATE = "bool ActivatePooledEffect("
...
LEFTOVER_GET_ACTIVE_RHI = (
    "Scripts/tests/test_mission01_get_active_rhi_and_feature_level"
    "_decl_contract.py"
)
LEFTOVER_ENSURE_DEFAULT_ENTRIES = (
    "Scripts/tests/test_audio_production_bank_ensure_default_entries"
    "_decl_contract.py"
)
LEFTOVER_ENV_VFX_POOL_FAIL_CLOSED = (
    "Scripts/tests/test_environment_vfx_pool_fail_closed.py"
)
LEFTOVER_GET_ALLOCATED_POOL_SIZE = (
    "Scripts/tests/test_environment_vfx_get_allocated_pool_size"
    "_decl_contract.py"
)
LEFTOVER_ENV_READINESS_VFX_POOL_SIZE = (
    "Scripts/tests/test_environment_readiness_vfx_pool_size"
    "_field_decl_contract.py"
)
LEFTOVER_MISSION09_POOL_CAPACITY = (
    "Scripts/tests/test_mission09_pool_capacity"
    "_field_decl_contract.py"
)
TARGET_WRONG_SKELETAL = "TObjectPtr<USkeletalMeshComponent> GetActivationCount;"
...
TARGET_WRONG_SCENE = "TObjectPtr<USceneComponent> GetActivationCount;"
...
TARGET_WRONG_MESH = "TObjectPtr<UStaticMeshComponent> GetActivationCount;"
...
STOP_BEFORE_SKYLINE_STYLE = "PoolCapacity"
...
SIBLING_LOOK_YAW_LIMIT = "PoolCapacity"
...
THIS_SCRIPT = (
    "Scripts/tests/test_environment_vfx_get_activation_count"
    "_decl_contract.py"
)
...
SIBLING_GET_SORTIE_SHOTS = "GetAllocatedPoolSize"
SIBLING_RESET_SORTIE = "DeactivateAllEffects"
SIBLING_FILL_SORTIE = "ActivatePooledEffect"
SIBLING_GET_SORTIE_DAMAGE = "SmokeSystem"
SIBLING_FIRE_CAMERA = "SparksSystem"
SIBLING_MIN_SAFE_YAW = "ExplosionSystem"
...
GET_SORTIE_HITS_RE = re.compile(
    r"int32\s+GetActivationCount\s*\(\s*\)\s*const\s*"
    r"(?:;|\{[^}]*return\s+ActivationCount\s*;\s*\})"
)
GET_SORTIE_HITS_WRONG_TYPE_RE = re.compile(
    r"(?:float|FName|bool|FLinearColor|void)\s+"
    r"GetActivationCount\b"
)
...
GET_SORTIE_HITS_NO_CONST_RE = re.compile(
    r"int32\s+GetActivationCount\s*\(\s*\)\s*;"
)
...
def has_one_declaration(region: str, declaration: str) -> bool:
    ...
    pattern = re.compile(
        re.escape(stem)
        + r"\s*(?:;|\{[^}]*return\s+ActivationCount\s*;\s*\})"
    )
    return pattern.search(compact_region) is not None


def has_declaration(region: str, declaration: str) -> bool:
    # Fail-closed on authored `int32 GetActivationCount() const;`
    # OR origin/main inline `{ return ActivationCount; }`.
    ...
    # leftover GetAllocatedPoolSize / DeactivateAllEffects /
...
def public_section(header: str) -> str:
    ...
    event = re.search(r"\bPoolCapacity\b", section)
...
def attached_ufunction_specifiers(section: str) -> str:
    ...
    while True:
        ...
        if depth == 0 and re.match(
            r"\s*int32\s+GetActivationCount\b",
            compact[index:],
        ):
            return compact[start : index - 1]
        cursor = cursor + match.start() + 1
    raise AssertionError(
        "UFUNCTION for int32 GetActivationCount "
...
class EnvironmentVFXGetActivationCountDeclContractTests(unittest.TestCase):
    def test_environment_vfx_pool_class_exists(self) -> None:
        ...
        self.assertTrue(has_identifier(section, "GetActivationCount"), section)
        ...
        self.assertEqual(CLASS_NAME, "USkyguardEnvironmentVFXPoolComponent")
        self.assertEqual(HEADER_PATH, "Source/Skyguard52/SkyguardEnvironmentVFXPoolComponent.h")
    ...
    def test_leftover_class_same_identifier_does_not_satisfy(self) -> None:
        ...
        self.assertFalse(has_identifier(section, "GetActivationCount"), section)
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, LOCKED_DECL)
        self.assertIn("GetActivationCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_missing_get_activation_count_declaration_fails_closed(self) -> None:
        empty = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "public:\n"
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn('Category="Skyguard|Environment|VFX"', section)
        ...
        self.assertIn('Skyguard|Environment|VFX', section)
        ...
        self.assertIn('Category="Skyguard|Environment|VFX"', specifiers)
        self.assertNotIn("BlueprintCallable", specifiers)
        self.assertNotIn('Skyguard|MissionMap', specifiers)
        self.assertIn('Skyguard|Environment|VFX', specifiers)
    ...
    def test_missing_const_or_wrong_return_fails_closed(self) -> None:
        ...
        self.assertNotIn(
            collapsed("int32 GetActivationCount();"),
            compact_origin,
        )
    ...
    def test_get_activation_count_declaration_matches_origin_main(self) -> None:
        section = spec_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 GetActivationCount"),
            LOCKED_DECL,
        )
    ...
    def test_locked_decl_is_not_leftover_clone_weather_identity(self) -> None:
        ...
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_SORTIE_HITS)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_ACTIVATION)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_DEACTIVATE)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_ACTIVATE)
        ...
        self.assertNotIn("GetAllocatedPoolSize", LOCKED_DECL)
        self.assertNotIn("DeactivateAllEffects", LOCKED_DECL)
        self.assertNotIn("ActivatePooledEffect", LOCKED_DECL)
    ...
    def test_wrong_default_and_renames_do_not_satisfy(self) -> None:
        ...
        wrongs = (
            ...
            leftover_primary,
            leftover_guided,
            "\tint32 GetActivationCounts() const;\n",
            "\tfloat GetActivationCount() const;\n",
            "\tFName GetActivationCount() const;\n",
            "\tint32 GetActivationCount() const { return " + forty + "; }\n",
            "\tint32 GetActivationCount() const { return " + eighty + "; }\n",
            f"\t{TARGET_WRONG_LAMP}\n",
            f"\t{TARGET_WRONG_PEAK}\n",
    ...
    def test_missing_category_or_blueprint_pure_fails_closed(self) -> None:
        ...
        self.assertIn('Category="Skyguard|Environment|VFX"', origin)
        self.assertNotIn('Skyguard|Apache', origin)
        self.assertNotIn('Skyguard|MissionMap', origin)
        self.assertIn('Skyguard|Environment|VFX', origin)
        ...
        self.assertNotIn('Category="Skyguard|Environment|VFX"', apache_specs)
        ...
        self.assertNotIn('Category="Skyguard|Environment|VFX"', theater_specs)
        self.assertIn('Category="Skyguard|Environment|VFX"', origin)
        self.assertNotIn('Skyguard|Apache', origin)
        ...
        self.assertNotIn('Category="Skyguard|Environment|VFX"', budget_specs)
        leftover_acceptance = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "public:\n"
        ...
        self.assertNotIn('Category="Skyguard|Environment|VFX"', acceptance_specs)
        leftover_perf = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "public:\n"
        ...
        self.assertNotIn('Category="Skyguard|Environment|VFX"', perf_specs)
        leftover_hud = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "public:\n"
        ...
        hud_specs = attached_uproperty_specifiers(
            spec_section(leftover_hud)
        )
        self.assertIn('Category="Skyguard|Presentation|HUD"', hud_specs)
        self.assertNotIn('Category="Skyguard|Environment|VFX"', hud_specs)
        ...
        self.assertNotIn('Category="Skyguard|Environment|VFX"', development_specs)
        leftover_env_bare = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "public:\n"
            f"\t{UFUNCTION_ENVIRONMENT_BARE}\n"
            f"\t{LOCKED_DECL}\n"
            f"{STOP_BEFORE_PRIVATE}\n"
            "};\n"
        )
        env_bare_specs = attached_uproperty_specifiers(
            spec_section(leftover_env_bare)
        )
        self.assertIn('Category="Skyguard|Environment"', env_bare_specs)
        self.assertNotIn('Category="Skyguard|Environment|VFX"', env_bare_specs)
        leftover_validation = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "public:\n"
        ...
        validation_specs = attached_uproperty_specifiers(
        ...
        self.assertNotIn('Category="Skyguard|Environment|VFX"', validation_specs)
        leftover_authoring = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "public:\n"
        ...
        authoring_specs = attached_uproperty_specifiers(
        ...
        self.assertNotIn('Category="Skyguard|Environment|VFX"', authoring_specs)
        ...
        self.assertNotIn('Category="Skyguard|Environment|VFX"', settings_bare_specs)
        leftover_combat_bare = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "public:\n"
            f"\t{UFUNCTION_COMBAT_BARE}\n"
            f"\t{LOCKED_DECL}\n"
            f"{STOP_BEFORE_PRIVATE}\n"
            "};\n"
        )
        ...
        self.assertNotIn('Category="Skyguard|Environment|VFX"', combat_bare_specs)
        origin_specs = attached_uproperty_specifiers(
            spec_section(origin_main_header())
        )
        self.assertIn('Category="Skyguard|Environment|VFX"', origin_specs)
        self.assertNotIn('Category="Skyguard|Environment|Performance"', origin_specs)
        self.assertNotIn('Category="Skyguard|Presentation|HUD"', origin_specs)
        self.assertNotIn(
            'Category="Skyguard|Mission01|Environment|Validation"',
            origin_specs,
        )
        ...
        self.assertIsNone(
            re.search(r'Category="Skyguard\|Environment"(?!\|)', origin_specs)
        )
        leftover_instance = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
        ...
        self.assertNotIn('Skyguard|Mission01|Environment|Authoring', origin)
        self.assertNotIn('Skyguard|Presentation|HUD', origin)
        self.assertIsNone(
            re.search(r'Category="Skyguard\|Environment"(?!\|)', origin)
        )
        ...
        self.assertNotIn('Category="Skyguard|Environment|VFX"', audio_only_specs)
        self.assertIn('Category="Skyguard|Environment|VFX"', origin)
        leftover_callable = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
        ...
        self.assertNotIn('Category="Skyguard|Environment|VFX"', feedback_specs)
        leftover_safety = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "public:\n"
        ...
        self.assertNotIn('Category="Skyguard|Environment|VFX"', safety_specs)
        leftover_boss = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "public:\n"
        ...
        self.assertNotIn('Category="Skyguard|Environment|VFX"', boss_specs)
        wraps = (
            "\tint32\n\tGetActivationCount() const;\n",
            "\tint32   GetActivationCount() const;\n",
            "\tint32\tGetActivationCount() const;\n",
            f"\t{LOCKED_DECL}\n",
            f"\t{UPROPERTY_EDIT_READWRITE}\n\t{LOCKED_DECL}\n",
    ...
    def test_does_not_claim_sibling_ufunctions_or_neighbors(self) -> None:
        self.assertFalse(
            has_identifier(TARGET_WRONG_ACTIVATION, "GetActivationCount")
        )
        self.assertTrue(
            has_identifier(LOCKED_DECL, "GetActivationCount")
        )
        self.assertFalse(has_identifier(LOCKED_DECL, "GetAllocatedPoolSize"))
        ...
        self.assertTrue(has_identifier(section, "GetActivationCount"))
    ...
    def test_does_not_parse_private_or_neighbors(self) -> None:
        ...
        self.assertNotIn(STOP_BEFORE_PRIVATE, section)
        self.assertTrue(has_identifier(leaked, "GetActivationCount"))
        self.assertTrue(has_identifier(section, "GetActivationCount"))
        self.assertTrue(has_identifier(leaked, STOP_BEFORE_SKYLINE_STYLE))
        self.assertFalse(has_identifier(section, STOP_BEFORE_SKYLINE_STYLE))
        self.assertTrue(has_identifier(leaked, SIBLING_GET_SORTIE_SHOTS))
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertNotIn("SkyguardEnvironmentVFXPoolComponent.cpp", THIS_SCRIPT)
        self.assertIn("SkyguardEnvironmentVFXPoolComponent.h", HEADER_PATH)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "environment VFX GetActivationCount decl contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(Path(__file__).name.endswith(
            "environment_vfx_get_activation_count_decl_contract.py"
        ))
        self.assertNotIn("SkyguardEnvironmentVFXPoolComponent.cpp", THIS_SCRIPT)
