...
# Mission06 IntegrationReadiness ProtectedTargetCount
...
# After this field, leftover-safe Mission06 readiness-struct
# UPROPERTY is exhausted. Do not spawn leftover Mission06
# wave-state enum or leftover airfield/payload defaults.
# Skip leftover b + Ya + kRuntimeReady forever (it sits
# after bMapAssemblyReady and before bGunnerReady). This contract
# is ProtectedTargetCount after WaveCount. Skip leftover
...
class Mission06ProtectedTargetCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 bCampaignRuntimeStarted field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission06 ProtectedTargetCount contains "
