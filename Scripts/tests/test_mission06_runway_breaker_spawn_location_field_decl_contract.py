...
# INDEX_NONE or lock RunwayBreakerSpawnLocation
# construction in the .cpp. This is leftover-safe
# Mission06 RunwayBreakerSpawnLocation FIELD
...
# This contract is RunwayBreakerSpawnLocation
# only. It is NOT leftover TempestSpawnLocation,
...
# FVector(78000.f, 22000.f, 6000.f), not
...
# Lock RunwayBreakerSpawnLocation only. Do not lock
...
LOCKED_DECL = RUNWAY_BREAKER_SPAWN_LOCATION
...
# an isolated Python RunwayBreakerSpawnLocation
...
class Mission06RunwayBreakerSpawnLocationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("RunwayBreakerSpawnLocation", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_runway_breaker_spawn_location_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_runway_breaker_spawn_location_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FVector RunwayBreakerSpawnLocation"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("RunwayBreakerSpawnLocation", LOCKED_DECL)
        self.assertIn("= FVector(78000.f, 22000.f, 6000.f)", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tFVector\n"
            "\tRunwayBreakerSpawnLocation = FVector(78000.f, 22000.f, 6000.f);\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("RunwayBreakerSpawnLocation", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FVector RunwayBreakerSpawnLocation"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("RunwayBreakerSpawnLocation", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 RunwayBreakerSpawnLocation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission06 RunwayBreakerSpawnLocation field contains "
    ...
    def test_contract_is_runway_breaker_spawn_location_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_runway_breaker_spawn_location(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tFVector RunwayBreakerSpawnLocation = FVector(0.f, 0.f, 0.f);\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_airfield_target_runtime_does_not_satisfy_runway_breaker_spawn_location(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
