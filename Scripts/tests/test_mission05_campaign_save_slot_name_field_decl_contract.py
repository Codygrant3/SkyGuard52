...
# Mission05 CampaignSaveSlotName FIELD
...
# #583 / branch cursor/mission01-campaign-
# save-slot-name-field-decl-contract-c332, NOT leftover
# Mission02 CampaignSaveSlotName field
# #855 / branch cursor/mission02-campaign-
# save-slot-name-field-decl-contract-c332, NOT leftover
# Mission03 campaign-save-slot-name FIELD
# / branch cursor/mission03-campaign-save-
# slot-name-field-decl-contract-c332, NOT leftover
# Mission10 CampaignSaveSlotName field / branch
# cursor/mission10-campaign-save-slot-name-
# field-decl-contract-c332, NOT leftover
# Mission04 CampaignSaveSlotName field
# #919 / branch cursor/mission04-campaign-
# save-slot-name-field-decl-contract-c332, NOT leftover
...
# bAllowBoundedActorSpawning #955 / in-flight
# bAutoLaunchAfterBriefing, NOT leftover
# Mission05 closed-without-merge #665 #666 #668
# #669 #670 #671 #672 #673, NOT leftover
# Mission05 wave-state enum #ad28 / protected-
# target enum #aaa2 / protected-target-runtime-
# defaults #ec8b / storm-runtime-defaults #89c9,
# NOT leftover campaign-save-slot-name method
# contracts, NOT leftover
# Mission01 CampaignDefinition field #577, NOT leftover
# Mission01 bAutoInitialize #580 / leftover
# Mission01 bAllowBoundedActorSpawning #581 /
# leftover Mission01 bAutoLaunchAfterBriefing #582,
# leftover environment-root #592, NOT leftover
# Mission04 Root #907 / leftover Mission04
# CampaignDefinition #914 / leftover Mission04
# MissionDefinition #916 / leftover Mission04
# bAutoInitialize #915 / leftover Mission04
# bAllowBoundedActorSpawning, NOT leftover
# FSkyguardMission05IntegrationReadiness fields,
# NOT leftover Mission01 Root field
# #574 / branch cursor/mission01-root-field-
# decl-contract-c332 (closed, do not reopen
# #536-#673), NOT leftover radio-chatter
...
# not leftover Mission01 Campaign, not leftover
# Mission02 Campaign, not
# Integration, not Mission01 / Mission02 /
# Mission03 / Mission05 / Mission06 / Mission07 /
# Mission08 / Mission09 / Mission10, not leftover Mission01
# Root #574, not leftover Mission09
...
# Mission03 CampaignSaveUserIndex sibling, leftover
...
# drafts #674-#916, leftover Apache
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission10IntegrationDirector::CampaignDefinition",
    "ASkyguardMission10IntegrationDirector::CampaignSaveSlotName",
    "ASkyguardMission02IntegrationDirector::CampaignSaveSlotName",
    "ASkyguardMission04IntegrationDirector::CampaignSaveSlotName",
    "ASkyguardMission03IntegrationDirector::CampaignSaveSlotName",
    "ASkyguardMission01IntegrationDirector::CampaignSaveSlotName",
    "GetCampaignSaveSlotName",
    "SetCampaignSaveSlotName",
    "SkyguardMission10IntegrationDirector.cpp",
...
class Mission05CampaignSaveSlotNameFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("Skyguard|Mission05|Protection", UPROPERTY_MISSION05)
    ...
    def test_campaign_save_slot_name_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FString CampaignSaveSlotName"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(';'), LOCKED_DECL)
        self.assertTrue(
            LOCKED_DECL.endswith('= TEXT("Skyguard52Campaign");'),
            LOCKED_DECL,
        )
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("CampaignSaveSlotName", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FString CampaignSaveSlotName"))
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("bCampaignDefinitionValid", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 CampaignSaveSlotName field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 CampaignSaveSlotName contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_campaign_save_slot_name_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_briefing"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission05_radio_chatter"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_campaign_definition"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_auto_initialize"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_campaign_save_slot_name"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
