...
# Mission03 Integration IsCorePlayableReady
...
# leftover Environment GetReadiness, or leftover
# Mission01 IsCorePlayableReady #613. Distinct
# from leftover briefing-widget /
...
# #613, leftover Environment GetReadiness.
...
# #613, leftover Environment GetReadiness, leftover
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission03IntegrationDirector::IsCorePlayableReady",
    "SkyguardMission03IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission03IsCorePlayableReadyDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 IsCorePlayableReady method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission03 IsCorePlayableReady contains "
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tbool IsCorePlayableReady() const { return true; }\n"
            "};\n"
        )
