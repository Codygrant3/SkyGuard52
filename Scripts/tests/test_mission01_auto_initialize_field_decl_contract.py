...
# INDEX_NONE or lock bAutoInitialize construction in
# the .cpp. This is a FIELD contract on
# ASkyguardMission01IntegrationDirector, not leftover
# Briefing (#568) / AudioDirector (#572) / Root
# (#574) / RadioChatter (#576) / SortiePresentation
# (#575) / CampaignDefinition / MissionDefinition
# (in flight) / Readiness (in flight) sibling
# director fields. Keep bAutoInitialize distinct
# from bAllowBoundedActorSpawning /
# bAutoLaunchAfterBriefing. Do not lock leftover
...
# (`bool bAutoInitialize = true;`); accept that
...
# Category is Skyguard|Mission01, not Mission02 /
# Boss / Destruction.
# Stay off leftover drafts #56–#64, leftover Harbor
# #6/#8/#9, leftover theater-kit #59, leftover
# isolated-test drafts #107–#576, leftover Apache
...
# CampaignDefinition field contracts stay
# sibling-only.
LOCKED_SCRIPTS = (
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission01IntegrationDirector::bAutoInitialize",
    "SkyguardMission01IntegrationDirector.cpp",
...
class Mission01AutoInitializeFieldDeclContractTests(unittest.TestCase):
    def test_mission01_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, AUTO_INITIALIZE_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, AUTO_INITIALIZE_FIELD)
        self.assertIn("bAutoInitialize", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(has_declaration(section, AUTO_INITIALIZE_FIELD))
    ...
    def test_missing_auto_initialize_declaration_fails_closed(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, AUTO_INITIALIZE_FIELD)
        self.assertIn("bAutoInitialize", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, AUTO_INITIALIZE_FIELD)
        self.assertIn("bAutoInitialize", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UPROPERTY", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("EditAnywhere", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("BlueprintReadWrite", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("Category", AUTO_INITIALIZE_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, AUTO_INITIALIZE_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, AUTO_INITIALIZE_FIELD)
        self.assertIn("bAutoInitialize", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        unassigned = "\tbool bAutoInitialize;\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, AUTO_INITIALIZE_FIELD)
            self.assertIn("bAutoInitialize", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_auto_initialize_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(has_declaration(section, AUTO_INITIALIZE_FIELD))
        self.assertEqual(
            declaration_count(section, AUTO_INITIALIZE_FIELD),
            1,
        )
        self.assertTrue(
            AUTO_INITIALIZE_FIELD.startswith("bool "),
            AUTO_INITIALIZE_FIELD,
        )
        self.assertTrue(AUTO_INITIALIZE_FIELD.endswith(";"), AUTO_INITIALIZE_FIELD)
        self.assertIn("bAutoInitialize", AUTO_INITIALIZE_FIELD)
        self.assertIn("= true", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("TArray<", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("TObjectPtr", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("TSoftObjectPtr", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("INDEX_NONE", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("UFUNCTION", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("{", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("}", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("return ", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("Root", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("Briefing", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("AudioDirector", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("RadioChatter", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("SortiePresentation", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("CampaignDefinition", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("MissionDefinition", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("Readiness", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("bAllowBoundedActorSpawning", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("bAutoLaunchAfterBriefing", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("PathfinderSpawnLocation", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("GetAircraft", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("ConfigureFromMission", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("AdvanceBriefing", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("SetAssetsReady", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("AcknowledgeAndLaunch", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("CanLaunch", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("GetElapsedSeconds", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("GetBriefingState", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("GetMinimumWarmupSeconds", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("GetBriefingText", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("GetRadioChatter", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("GetPresentation", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("GetMissionTitle", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("AcknowledgeBriefing", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("LaunchSortie", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("HullCollider", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("OpticalTracker", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("WeaponServo", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("CountermeasurePod", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("RadarNode", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("ESkyguardMission02WaveState", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("HarborIndustrial", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("MaxIntegrity", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("CurrentIntegrity", AUTO_INITIALIZE_FIELD)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, AUTO_INITIALIZE_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION01} {AUTO_INITIALIZE_FIELD}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{AUTO_INITIALIZE_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, AUTO_INITIALIZE_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, AUTO_INITIALIZE_FIELD),
            section,
    ...
    def test_unassigned_auto_initialize_does_not_satisfy(self) -> None:
        unassigned = "\tbool bAutoInitialize;\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(unassigned, AUTO_INITIALIZE_FIELD)
        self.assertIn("bAutoInitialize", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(unassigned, AUTO_INITIALIZE_FIELD))

    def test_false_auto_initialize_does_not_satisfy(self) -> None:
        assigned_false = "\tbool bAutoInitialize = false;\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned_false, AUTO_INITIALIZE_FIELD)
        self.assertIn("bAutoInitialize", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(
            has_declaration(assigned_false, AUTO_INITIALIZE_FIELD)
        )
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("bAutoInitialize", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, AUTO_INITIALIZE_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{AUTO_INITIALIZE_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, AUTO_INITIALIZE_FIELD)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            AUTO_INITIALIZE_FIELD.startswith("UFUNCTION"),
            AUTO_INITIALIZE_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", AUTO_INITIALIZE_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_auto_initialize_cpp_body(self) -> None:
        locked_only = f"{AUTO_INITIALIZE_FIELD}\n"
        self.assertNotIn("{", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("}", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("return ", AUTO_INITIALIZE_FIELD)
        ...
        self.assertNotIn("return false", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("return true", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("CreateDefaultSubobject", AUTO_INITIALIZE_FIELD)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{AUTO_INITIALIZE_FIELD}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, AUTO_INITIALIZE_FIELD)
        self.assertIn("bAutoInitialize", AUTO_INITIALIZE_FIELD)
        self.assertIn("= true", AUTO_INITIALIZE_FIELD)
        self.assertTrue(AUTO_INITIALIZE_FIELD.startswith("bool "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, AUTO_INITIALIZE_FIELD)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("CurrentIntegrity", AUTO_INITIALIZE_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", AUTO_INITIALIZE_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, AUTO_INITIALIZE_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", AUTO_INITIALIZE_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{AUTO_INITIALIZE_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, AUTO_INITIALIZE_FIELD),
            AUTO_INITIALIZE_FIELD,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, AUTO_INITIALIZE_FIELD)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertEqual(declaration_count(section, AUTO_INITIALIZE_FIELD), 1)
        self.assertNotIn(
            "SkyguardMission01IntegrationDirector.cpp",
            section,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 bAutoInitialize field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{AUTO_INITIALIZE_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, AUTO_INITIALIZE_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                AUTO_INITIALIZE_FIELD.lower(),
                "mission01 bAutoInitialize contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live cop" + "y",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, AUTO_INITIALIZE_FIELD)

    def test_contract_is_auto_initialize_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertIn("bAutoInitialize", AUTO_INITIALIZE_FIELD)
        self.assertIn("= true", AUTO_INITIALIZE_FIELD)
        self.assertTrue(AUTO_INITIALIZE_FIELD.endswith(";"))
        self.assertIn(UPROPERTY_MISSION01, section)
    ...
    def test_sibling_director_fields_do_not_satisfy_auto_initialize(
        ...
        for leftover in (
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, AUTO_INITIALIZE_FIELD))
            self.assertNotEqual(AUTO_INITIALIZE_FIELD, leftover)
        self.assertIn(
