...
# Mission06 Integration GetObjectiveRuntime
# on ASkyguardMission06IntegrationDirector. It is
# NOT leftover Mission05 GetObjectiveRuntime
# #675, NOT leftover Mission01 / Mission03 /
# Mission04 GetObjectiveRuntime, NOT leftover
# objective-runtime fail-closed #6845, NOT leftover
# campaign GetObjectiveRuntime #313, NOT leftover
...
# #675, not leftover Harbor Mission02 Integration.
...
# #668/#669. Do not reopen leftover Mission05
# GetObjectiveRuntime #675.
...
# GetObjectiveRuntime, leftover objective-runtime
# fail-closed #6845, leftover campaign
# GetObjectiveRuntime #313,
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission06IntegrationDirector::GetObjectiveRuntime",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission06GetObjectiveRuntimeDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_objective = f"\t{NOTIFY_THREAT_DESTROYED}\n"
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 GetObjectiveRuntime method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission06 GetObjectiveRuntime contains "
    ...
    def test_leftover_mission05_get_objective_runtime_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission05IntegrationDirector "
    ...
    def test_leftover_mission03_get_objective_runtime_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
    ...
    def test_leftover_mission04_get_objective_runtime_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission04IntegrationDirector "
    ...
    def test_contract_does_not_relock_leftover_mission06_wave_state_enum(
        ...
        self.assertNotIn("ESkyguardMission06WaveState", UFUNCTION_INTEGRATION)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_get_objective_runtime"
                "_decl_contract.py"
            )
        )
        self.assertIn(
