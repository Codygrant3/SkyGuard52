...
# Mission03 bAllowBoundedActorSpawning FIELD
...
# NOT leftover Mission02 bAllowBoundedActorSpawning field
...
# #801 / branch cursor/mission10-allow-bounded-
# actor-spawning-field-decl-contract-c332, NOT leftover
# Mission01 bAllowBoundedActorSpawning field
...
# Integration, not Mission01 / Mission02 / Mission10 /
# Mission04 / Mission05 / Mission06 / Mission07 /
# Mission08 / Mission09, not leftover Mission01
# Root #574, not leftover Mission01
# bAllowBoundedActorSpawning #581, not leftover Mission02
# bAllowBoundedActorSpawning #854, not leftover Mission10
# bAllowBoundedActorSpawning, not leftover Mission03
# bAutoInitialize sibling, not leftover Mission01
...
# drafts #674-#850, leftover Apache
...
# drafts #674-#881 including leftover Mission02
# bAllowBoundedActorSpawning #854, leftover Mission03
# CampaignDefinition #881, leftover Mission03
# bAutoInitialize sibling, leftover Mission03 wave-state
# enum #0242, leftover convoy-route-state enum #d34e,
# leftover GetDayBeatKit without UFUNCTION, leftover
...
# protected-runtime-defaults #7898, leftover Mission10
# bAllowBoundedActorSpawning. Do not reopen PRs
# #536-#673 or open drafts #674-#881.
...
# Mission02 bAutoInitialize field contract, leftover
# Mission01 / Mission02 / Mission04-10 bAutoInitialize /
# auto-initialize field contracts, leftover Mission03
# bAutoInitialize sibling, leftover
# Mission01 / Mission02 / Mission04-10 bAllowBoundedActorSpawning /
# allow-bounded-actor-spawning field contracts including leftover
# Mission02 bAllowBoundedActorSpawning #854, leftover Mission01
# #581, leftover Mission10, leftover GetDayBeatKit without
# UFUNCTION, leftover convoy-route-state enum #d34e, leftover
# Mission03 wave-state enum #0242, leftover BindRuntimeActors /
# HandleDroneCityImpact, leftover Mission10 route-phase enum
# #701a, leftover Mission10 protected-group enum #6f9d,
# leftover Mission10 protected-runtime-defaults #7898, leftover
# Mission03 CampaignDefinition #881,
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission03IntegrationDirector::bAllowBoundedActorSpawning",
    "SkyguardMission10IntegrationDirector.cpp",
...
class Mission03AllowBoundedActorSpawningFieldDeclContractTests(unittest.TestCase):
    ...
    def test_allow_bounded_actor_spawning_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bAllowBoundedActorSpawning"),
            LOCKED_DECL,
        )
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bAllowBoundedActorSpawning", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bAllowBoundedActorSpawning"))
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission03_allow_bounded_actor_spawning_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
