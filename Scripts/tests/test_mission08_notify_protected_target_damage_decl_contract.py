...
# INDEX_NONE or lock NotifyProtectedTargetDamage
# construction in the .cpp. This is leftover-safe
# Mission08 Protection NotifyProtectedTargetDamage
# METHOD on ASkyguardMission08IntegrationDirector.
# It is NOT leftover Mission08 protected-target enum
# #a66a / #229, NOT leftover Mission08
# protected-target-runtime-defaults #75e6 / #226,
# NOT leftover Mission05 NotifyProtectedTargetDamage
# #673, NOT leftover Mission07
# NotifyProtectedTargetDamage #711, NOT leftover
# hoist-window-runtime-defaults #ec79, NOT leftover
# AdvanceHoistWindow, NOT leftover StartHoistWindow,
# NOT leftover BindRuntimeActors (retired live mount),
# NOT leftover Mission07 StartNextWave #708, NOT leftover
# Mission05 StartNextWave #668, NOT leftover
# Mission03 / Mission04 / Mission06 StartNextWave,
# NOT leftover Mission08 InitializePlayableMission,
# NOT leftover Mission08 StartNextWave, NOT leftover
...
# UFUNCTION. Do not lock leftover AdvanceHoistWindow
# as a sibling decl in THIS test. Do not lock
...
# NotifyThreatDestroyed / AdvanceHoistWindow /
...
# leftover Mission06 StartNextWave #687,
# leftover Mission07 StartNextWave #708,
# leftover Mission08 StartNextWave,
...
# Category is Skyguard|Mission08|Protection, not
# Mission01 / Mission02 / Mission03 / Mission04 /
# Mission05 / Mission06 / Mission07 / Integration /
# Waves / Search / Hoist / Payload / Targets /
# Objectives / Boss / Destruction / Briefing /
# Safety / Rescue, not Environment,
...
# Mission06 Waves #687, not leftover Mission05
# Waves #668, not leftover Mission07 Waves #708,
...
# drafts #674–#732, leftover Apache
...
# StartNextWave #708. Do not reopen leftover
...
# Do not reopen leftover Mission05
# NotifyProtectedTargetDamage #673. Do not reopen
# leftover Mission07 NotifyProtectedTargetDamage
# #711. Do not reopen open drafts #674–#732.
...
LEFTOVER_MISSION07_NOTIFY_PROTECTED_TARGET_DAMAGE = (
    "bool NotifyProtectedTargetDamage("
...
# an isolated Python NotifyProtectedTargetDamage
...
LEFTOVER_MISSION07_NOTIFY_PROTECTED_TARGET_DAMAGE_NOT_LOCKED = (
    LEFTOVER_MISSION07_NOTIFY_PROTECTED_TARGET_DAMAGE,
    "test_mission07_notify_protected_target_damage_decl_contract.py",
    'Category="Skyguard|Mission07|Protection"',
)
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission08IntegrationDirector::NotifyProtectedTargetDamage",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission08NotifyProtectedTargetDamageDeclContractTests(unittest.TestCase):
    def test_mission08_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, NOTIFY_PROTECTED_TARGET_DAMAGE),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertIn("NotifyProtectedTargetDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, NOTIFY_PROTECTED_TARGET_DAMAGE)
    ...
    def test_missing_notify_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission08IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertIn("NotifyProtectedTargetDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertIn("NotifyProtectedTargetDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("BlueprintCallable", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("Category", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("BlueprintPure", UFUNCTION_PROTECTION)
        self.assertIn("Skyguard|Mission08|Protection", UFUNCTION_PROTECTION)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, NOTIFY_PROTECTED_TARGET_DAMAGE)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertIn("NotifyProtectedTargetDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tvoid NotifyProtectedTargetDamage("
            "ESkyguardMission08ProtectedTarget Target, "
            "int32 Damage);\n"
        )
        as_const = (
        ...
        renamed = "\tbool NotifyProtectedAssetFailed();\n"
        short_name = "\tbool NotifyProtectedTarget();\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, NOTIFY_PROTECTED_TARGET_DAMAGE)
            self.assertIn("NotifyProtectedTargetDamage", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_notify_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, NOTIFY_PROTECTED_TARGET_DAMAGE),
            NOTIFY_PROTECTED_TARGET_DAMAGE,
        )
        self.assertTrue(has_declaration(section, NOTIFY_PROTECTED_TARGET_DAMAGE))
        self.assertEqual(
            declaration_count(section, NOTIFY_PROTECTED_TARGET_DAMAGE),
            1,
        )
        self.assertTrue(
            NOTIFY_PROTECTED_TARGET_DAMAGE.startswith("bool "),
            NOTIFY_PROTECTED_TARGET_DAMAGE,
        )
        self.assertTrue(
            NOTIFY_PROTECTED_TARGET_DAMAGE.endswith(";"),
            NOTIFY_PROTECTED_TARGET_DAMAGE,
        )
        self.assertIn("NotifyProtectedTargetDamage", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertIn("ESkyguardMission08ProtectedTarget Target", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertIn("int32 Damage", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("TArray<", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("TObjectPtr", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("TSoftObjectPtr", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("INDEX_NONE", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("UFUNCTION", ADVANCE_HOIST_WINDOW)
        self.assertNotIn("{", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("}", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("return ", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("const;", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("Root", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("Briefing", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("AudioDirector", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("RadioChatter", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("SortiePresentation", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("CampaignDefinition", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("MissionDefinition", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("Readiness", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("bAutoInitialize", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("bAllowBoundedActorSpawning", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("bAutoLaunchAfterBriefing", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("PathfinderSpawnLocation", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetAircraft", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("BindRuntimeActors", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("HandleDroneCityImpact", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("InitializePlayableMission", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("NotifyThreatDestroyed", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("AdvanceConvoyByDistance", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("NotifyConvoyDamage", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetWaveState", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetConvoyRouteState", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetDayBeatKit", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetNightBeatKit", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("StartSearchlightWindow", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("AdvanceSearchlightTrack", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("NotifySubstationDamage", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetRemainingThreatsInWave", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetSearchlightRuntime", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetSubstationIntegrity", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("StartPayloadWindow", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("AdvancePayloadWindow", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("TryJamActivePayload", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("NotifyAirfieldTargetDamage", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetPayloadWindow", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetTargetRuntime", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetSurvivingTargetCount", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetDayBeatKind", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetDayBeatIndex", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("TickDayBeatKit", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("HandleBossPhaseChanged", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ASkyguardMission06IntegrationDirector", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ESkyguardMission06WaveState", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ESkyguardMission07WaveState", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ESkyguardMission07ProtectedTarget", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("FSkyguardMission07ProtectedTargetRuntime", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ESkyguardSearchSector", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("FSkyguardSearchTrackRuntime", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ClassifyFalseTrack", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ConfirmRadarGhostIdentification", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("StartHoistWindow", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("AdvanceReinforcementTimer", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetSearchSector", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetClassifiedFalseTrackCount", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("IsHostileContactConfirmed", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetProtectedTarget", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetReinforcementTimeRemaining", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetNightBeatKind", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetNightBeatIndex", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("TickNightBeatKit", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ESkyguardAirfieldTarget", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ConvoyRuntimeAnchor", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("RoadHunterSpawnLocation", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ASkyguardMission02IntegrationDirector", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ConfigureMissionDefinition", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("NotifyObjectiveProgress", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("NotifyProtectedAssetFailed", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("SynchronizeRuntimeState", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("IsCorePlayableReady", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetReadiness", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetObjectiveRuntime", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetGunner", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetPathfinder", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetMissionId", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ValidateMissionContract", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ConfigureFromMission", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("AdvanceBriefing", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("SetAssetsReady", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("AcknowledgeAndLaunch", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("CanLaunch", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetElapsedSeconds", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetBriefingState", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetMinimumWarmupSeconds", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetBriefingText", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetRadioChatter", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetPresentation", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("GetMissionTitle", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("AcknowledgeBriefing", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("LaunchSortie", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("HullCollider", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("OpticalTracker", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("WeaponServo", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("CountermeasurePod", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("MinHeightFromOriginCm", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("RadarNode", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ESkyguardMission02WaveState", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("HarborIndustrial", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("MaxIntegrity", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("CurrentIntegrity", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("FillAndFinalize", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("FillAndFail", NOTIFY_PROTECTED_TARGET_DAMAGE)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, NOTIFY_PROTECTED_TARGET_DAMAGE)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_spaces = (
            "public:\n"
            "\tbool   NotifyProtectedTargetDamage(ESkyguardMission08ProtectedTarget Target, int32 Damage);\n"
            "private:\n"
            "};\n"
        )
        wrap_tab = (
            "public:\n"
            "\tbool\t"
            "NotifyProtectedTargetDamage(ESkyguardMission08ProtectedTarget Target, int32 Damage);\n"
            "};\n"
        )
        wrap_indent = (
            "public:\n"
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_PROTECTION} {NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{NOTIFY_PROTECTED_TARGET_DAMAGE}\n}}\n"
        self.assertTrue(has_declaration(one_line, NOTIFY_PROTECTED_TARGET_DAMAGE))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, NOTIFY_PROTECTED_TARGET_DAMAGE),
            section,
    ...
    def test_environment_category_does_not_satisfy_protection(self) -> None:
        ...
        self.assertNotEqual(leftover_m07_waves, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_waves_m08, UFUNCTION_PROTECTION)
        ...
        self.assertNotIn(leftover_m07_waves, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_waves_m08, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_safety, UFUNCTION_PROTECTION)
        self.assertNotIn("Mission01", UFUNCTION_PROTECTION)
        self.assertNotIn("Mission03", UFUNCTION_PROTECTION)
        self.assertNotIn("Mission04", UFUNCTION_PROTECTION)
        self.assertNotIn("Mission05", UFUNCTION_PROTECTION)
    ...
    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        locked_only = f"{NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, NOTIFY_PROTECTED_TARGET_DAMAGE)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", NOTIFY_PROTECTED_TARGET_DAMAGE)
        section = public_section(origin_main_header())
    ...
    def test_contract_does_not_lock_initialize_cpp_body(self) -> None:
        ...
        self.assertNotIn("return false", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("return true", NOTIFY_PROTECTED_TARGET_DAMAGE)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertIn("NotifyProtectedTargetDamage", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertTrue(NOTIFY_PROTECTED_TARGET_DAMAGE.startswith("bool "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("CurrentIntegrity", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("SkyguardApacheAircraft.h", NOTIFY_PROTECTED_TARGET_DAMAGE)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", NOTIFY_PROTECTED_TARGET_DAMAGE)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
        self.assertEqual(
            require_declaration(locked_only, NOTIFY_PROTECTED_TARGET_DAMAGE),
            NOTIFY_PROTECTED_TARGET_DAMAGE,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, NOTIFY_PROTECTED_TARGET_DAMAGE)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("ASkyguardIronRainBoss", section)
        self.assertNotIn("ASkyguardRadarGhostBoss", NOTIFY_PROTECTED_TARGET_DAMAGE)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 NotifyProtectedTargetDamage method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, NOTIFY_PROTECTED_TARGET_DAMAGE.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                NOTIFY_PROTECTED_TARGET_DAMAGE.lower(),
                "mission08 NotifyProtectedTargetDamage contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, NOTIFY_PROTECTED_TARGET_DAMAGE)

    def test_contract_is_notify_protected_target_damage_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(NOTIFY_PROTECTED_TARGET_DAMAGE.startswith("bool "))
        self.assertIn("NotifyProtectedTargetDamage", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertTrue(NOTIFY_PROTECTED_TARGET_DAMAGE.endswith(";"))
        self.assertIn(UFUNCTION_PROTECTION, section)

    def test_sibling_director_fields_do_not_satisfy_notify_protected_target_damage(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, NOTIFY_PROTECTED_TARGET_DAMAGE)
            )
            self.assertNotEqual(NOTIFY_PROTECTED_TARGET_DAMAGE, leftover)
        self.assertIn(
    ...
    def test_leftover_handle_drone_city_impact_does_not_satisfy(self) -> None:
        ...
        self.assertIn("NotifyProtectedTargetDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, NOTIFY_PROTECTED_TARGET_DAMAGE))
        locked_only = f"{NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tbool NotifyProtectedTargetDamage(ESkyguardMission08ProtectedTarget Target, int32 Damage) { return false; }\n"
            "};\n"
        )
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_notify_protected_target_damage"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission07_protected_target(
        ...
        self.assertIn("Protection", UFUNCTION_PROTECTION)
    ...
    def test_contract_does_not_relock_leftover_mission08_wave_state_enum(
        ...
        self.assertNotIn("ESkyguardMission08WaveState", NOTIFY_PROTECTED_TARGET_DAMAGE)
    ...
    def test_contract_does_not_relock_leftover_mission05_notify_protected_target_damage(
        self,
    ) -> None:
        locked_only = f"{NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
    ...
    def test_contract_does_not_relock_leftover_mission07_notify_protected_target_damage(
        self,
    ) -> None:
        locked_only = f"{NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
        for token in LEFTOVER_MISSION07_NOTIFY_PROTECTED_TARGET_DAMAGE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertIn(
            "Scripts/tests/test_mission07_notify_protected_target_damage"
        ...
        leftover_m07 = (
            ...
            "\tUFUNCTION(BlueprintCallable, "
            'Category="Skyguard|Mission07|Protection")\n'
            f"\t{LEFTOVER_MISSION07_NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_sibling_mission08_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("ConfigureMissionDefinition", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("NotifyThreatDestroyed", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("StartNextWave", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("AdvanceHoistWindow", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("StartHoistWindow", NOTIFY_PROTECTED_TARGET_DAMAGE)
