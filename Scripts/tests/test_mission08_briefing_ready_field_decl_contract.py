...
# INDEX_NONE or lock bBriefingReady
# construction in the .cpp. This is leftover-safe
# Mission08 IntegrationReadiness bBriefingReady
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool default false,
# one-line / split-line UPROPERTY wraps) on
# FSkyguardMission08IntegrationReadiness. Cloned
# from leftover-safe Mission07 readiness-struct
# bBriefingReady (cursor/mission07-briefing-
# ready-field-decl-contract-c332 — STRUCT field,
# not director Briefing) and leftover-safe
# Mission08 bGunnerReady (cursor/mission08-
# gunner-ready-field-decl-contract-c332). It is
# NOT leftover Mission08 director Briefing
# FIELD #1050 / branch cursor/mission08-
# briefing-field-decl-contract-c332,
# NOT leftover Mission07 bBriefingReady
# FIELD / branch cursor/mission07-
# briefing-ready-field-decl-contract-c332,
# NOT leftover bProtectedTargetsReady
# (sibling this wave) / branch cursor/
# mission08-protected-targets-ready-field-
# decl-contract-c332, NOT leftover
# bRescueAnimationReady #1074 / branch
# cursor/mission08-rescue-animation-ready-
# field-decl-contract-c332, NOT leftover
# bObjectivesReady #1072 / bWavesReady #1073,
# NOT leftover b + Ya + k RuntimeReady
# (skip forever), NOT leftover director
# Readiness #1066, NOT leftover retired-mount
# spawn, NOT leftover Mission07 bGunnerReady
# FIELD / branch cursor/mission07-
...
# field-decl-contract-c332, NOT leftover
# bWavesReady (in-flight) / branch cursor/
# mission08-waves-ready-field-decl-contract-
# c332, NOT leftover bProtectedTargetsReady,
# NOT leftover Mission08 director
...
# This readiness-struct field sits after leftover
# bRescueAnimationReady #1074 and this-wave sibling
# bProtectedTargetsReady. Skip leftover b + Ya + k
# RuntimeReady forever (it sits BETWEEN bMapAssemblyReady
# and bGunnerReady on this struct; do not lock this
# contract onto that leftover field). Skip leftover
...
# an isolated Python bBriefingReady
# field declaration contract on
# FSkyguardMission08IntegrationReadiness.
# Parse the READINESS STRUCT public
# section only. Do not parse the director
# class, hoist-window runtime, protected-
# target runtime, or private Transient.
LOCKED = {
...
LEFTOVER_MISSION07_BRIEFING_READY_NOT_LOCKED = (
    "test_mission07_briefing_ready_field_decl_contract.py",
    "cursor/mission07-briefing-ready-field-decl-contract-c332",
)
LEFTOVER_MISSION01_BRIEFING_READY_NOT_LOCKED = (
    "test_mission01_briefing_ready_field_decl_contract.py",
    "cursor/mission01-briefing-ready-field-decl-contract-c332",
)
...
LEFTOVER_MISSION09_BRIEFING_READY_NOT_LOCKED = (
    "test_mission09_briefing_ready_field_decl_contract.py",
    "cursor/mission09-briefing-ready-field-decl-contract-c332",
)
...
class Mission08BriefingReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bBriefingReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_briefing_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_briefing_ready_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bBriefingReady"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bBriefingReady", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bBriefingReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bBriefingReady"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bBriefingReady", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 bBriefingReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 bBriefingReady contains "
    ...
    def test_contract_is_briefing_ready_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_briefing_ready(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_leftover_same_name_ready_contracts_stay_locked(
        ...
        for leftover in LEFTOVER_SAME_NAME_BRIEFING_READY_NOT_LOCKED:
            self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION07_BRIEFING_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        self.assertIn(
            "Scripts/tests/test_mission08_briefing"
