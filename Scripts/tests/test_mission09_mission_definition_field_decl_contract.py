...
# INDEX_NONE or lock MissionDefinition
# construction in the .cpp. This is leftover-safe
# Mission09 MissionDefinition FIELD
# (declaration-only, EditAnywhere /
# BlueprintReadWrite / TSoftObjectPtr, one-line
# / split-line UPROPERTY wraps) on
# ASkyguardMission09IntegrationDirector. It is
# NOT leftover Mission08 director MissionDefinition
# #1054 / branch cursor/mission08-mission-
# definition-field-decl-contract-c332, NOT leftover
# Mission08 readiness-struct bMissionDefinitionValid
# #1067, NOT leftover Mission07 MissionDefinition field
# / branch cursor/mission07-mission-
# definition-field-decl-contract-c332, NOT leftover
# Mission08 Briefing #1050 / branch cursor/
# mission08-briefing-field-decl-contract-c332,
# NOT leftover Mission08 bMissionDefinitionValid
# readiness-struct field, NOT leftover Mission08
# ConfigureMissionDefinition #730 / branch cursor/
# mission08-configure-mission-definition-decl-
# contract-c332, NOT leftover Mission10
# MissionDefinition field
# #799 / branch cursor/
# mission10-mission-definition-field-decl-
# contract-c332, NOT leftover Mission01 / Mission02 /
# Mission03 / Mission04 / Mission05 / Mission06 /
# Mission07 same-name MissionDefinition director-field
# drafts. LOCK leftover Mission07 director Root
# #1011 through Readiness #1027. LOCK leftover
# Mission07 readiness-struct #1028-#1043. LOCK leftover
# Mission08 Blueprint UFUNCTION methods #729-#749.
# LOCK leftover Mission08 director Root #1044 through
# RadioChatter #1052. LOCK leftover drafts #56-#64
# and leftover #107-#673. Do not reopen leftover
# #664, leftover closed-without-merge #658-#673,
# leftover Mission05 closed-without-merge #665 #666
# #668-#673, or open drafts #674-#1089.
# NOT leftover Mission01 MissionDefinition field
# #578 / branch cursor/mission01-mission-
# definition-field-decl-contract-c332, NOT leftover
# Mission02 MissionDefinition field #851 / branch
# cursor/mission02-mission-definition-field-
# decl-contract-c332, NOT leftover Mission03
# MissionDefinition field #882 / branch cursor/
# mission03-mission-definition-field-decl-
# contract-c332, NOT leftover Mission04
# MissionDefinition field #916 / branch cursor/
# mission04-mission-definition-field-decl-
# contract-c332, NOT leftover Mission05
# MissionDefinition field #953 / branch cursor/
# mission05-mission-definition-field-decl-
# contract-c332, NOT leftover Mission06
# MissionDefinition field #985 / branch cursor/
# mission06-mission-definition-field-decl-
# contract-c332, NOT leftover Mission10
# MissionDefinition field
# #799 / branch cursor/
# mission10-mission-definition-field-decl-
# contract-c332, NOT leftover Mission06 AudioDirector
# draft #979 / branch cursor/
...
# RadioChatter branch cursor/mission06-radio-
# chatter-field-decl-contract-c332, NOT leftover
# Mission06 SortiePresentation in-flight branch
# cursor/mission06-sortie-presentation-field-
# decl-contract-c332, NOT leftover Mission06
# CampaignDefinition in-flight branch cursor/
# mission06-campaign-definition-field-decl-
# contract-c332, NOT leftover Mission07 Root
# #1011 / branch cursor/mission07-root-field-
# decl-contract-c332, NOT leftover Mission07
# Briefing #1012 / branch cursor/mission07-
# briefing-field-decl-contract-c332, NOT leftover
# Mission07 AudioDirector #1013 / branch cursor/
# mission07-audio-director-field-decl-contract-
# c332, NOT leftover Mission07 RadioChatter
# branch cursor/mission07-radio-chatter-field-
# decl-contract-c332, NOT leftover Mission07
# SortiePresentation #1014 / branch cursor/
# mission07-sortie-presentation-field-decl-
# contract-c332, NOT leftover Mission07
# CampaignDefinition branch cursor/mission07-
# campaign-definition-field-decl-contract-c332,
# NOT leftover Mission04 bAudioReady #937 /
...
# retired-mount spawn fields
# (leftover_spawn_name_tokens) / leftover b
# + Ya + kRuntimeReady, NOT leftover
...
# drafts #674-#1089, leftover Apache
...
# GetRemainingThreatsInWave #662 / leftover
# Mission05 #665 #666 #668 #669 #670 #671 #672
# #673. Do not reopen open
# drafts #674-#1089 including leftover Mission03
...
LOCKED_DECL = MISSION_DEFINITION_FIELD
...
# an isolated Python MissionDefinition
...
class Mission09MissionDefinitionFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_mission_definition_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_mission_definition_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("TSoftObjectPtr<USkyguardMissionDefinition> "),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("MissionDefinition", LOCKED_DECL)
        self.assertIn("USkyguardMissionDefinition", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("MissionDefinition", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("TSoftObjectPtr<USkyguardMissionDefinition>"))
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("bMissionDefinitionValid", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 MissionDefinition field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 MissionDefinition field contains "
    ...
    def test_contract_is_mission_definition_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_mission_definition(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_leftover_mission10_mission_definition_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_mission_definition_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission09_audio_director_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_mission08_mission_definition_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission08IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission07_mission_definition_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_leftover_mission01_mission_definition_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission01IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission01_mission_definition_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )

    def test_leftover_mission02_mission_definition_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission02IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission03_mission_definition_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission04_mission_definition_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_leftover_mission06_mission_definition_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_leftover_mission05_mission_definition_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_airfield_target_runtime_does_not_satisfy_mission_definition(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_does_not_satisfy_mission_definition(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
