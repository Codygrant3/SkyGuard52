...
# INDEX_NONE or lock AudioDirector
# construction in the .cpp. This is leftover-safe
# Mission09 AudioDirector FIELD
...
# AudioDirector field #979 / branch cursor/
# mission06-audio-director-field-decl-contract-
# c332, NOT leftover Mission07 AudioDirector field
# / branch cursor/mission07-audio-director-field-
# decl-contract-c332, NOT leftover Mission08
# director AudioDirector #1051 / branch cursor/
# mission08-audio-director-field-decl-contract-
# c332, NOT leftover Mission08 readiness-struct
# bAudioReady #1077 / branch cursor/mission08-
# audio-ready-field-decl-contract-c332, NOT leftover
# Mission10 AudioDirector field #794 / branch cursor/
...
# (including leftover-safe struct bAudioReady if present),
...
# drafts #674-#1080, leftover Apache
...
LOCKED_DECL = AUDIO_DIRECTOR_FIELD
...
# #1085. Lock leftover Mission09 Blueprint UFUNCTION
...
class Mission09AudioDirectorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_audio_director_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_audio_director_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("TObjectPtr<USkyguardAudioDirectorComponent> "),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("AudioDirector", LOCKED_DECL)
        self.assertIn("USkyguardAudioDirectorComponent", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("AudioDirector", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("TObjectPtr<USkyguardAudioDirectorComponent>"))
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 AudioDirector field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 AudioDirector field contains "
    ...
    def test_contract_is_audio_director_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_audio_director(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_audio_director_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_declaration_accepts_origin_main_default_forms(self) -> None:
        ...
        stem = "TObjectPtr<USkyguardAudioDirectorComponent> AudioDirector"
        ...
        self.assertEqual(LOCKED_DECL, "TObjectPtr<USkyguardAudioDirectorComponent> AudioDirector;")
