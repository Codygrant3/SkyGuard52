...
def public_section(header: str) -> str:
    ...
    if public is None:
        ...
        if "struct FSkyguardLandscapeHeightSample" in body or (
            "struct FSkyguardLandscapeHeightSample" in section
        ):
            raise AssertionError(
...
class LandscapeFootprintSampleSuccessFieldDeclContractTests(unittest.TestCase):
    def test_landscape_footprint_sample_result_struct_exists(self) -> None:
        ...
        self.assertNotIn("LandscapeComponentCount", section)
