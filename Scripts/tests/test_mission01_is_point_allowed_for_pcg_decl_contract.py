...
# INDEX_NONE or lock IsPointAllowedForPCG
# construction in the .cpp. This is a leftover-safe
# Environment METHOD contract on
...
# (`bool IsPointAllowedForPCG(const FVector& WorldPoint) const;`); accept that
...
# IsPointAllowedForPCG method declaration
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission01EnvironmentDirector::IsPointAllowedForPCG",
    "SkyguardMission01EnvironmentDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission01IsPointAllowedForPCGDeclContractTests(unittest.TestCase):
    def test_mission01_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, IS_POINT_ALLOWED_FOR_PCG),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, IS_POINT_ALLOWED_FOR_PCG)
        self.assertIn("IsPointAllowedForPCG", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, IS_POINT_ALLOWED_FOR_PCG)
    ...
    def test_missing_is_point_allowed_for_pcg_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission01EnvironmentDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, IS_POINT_ALLOWED_FOR_PCG)
        self.assertIn("IsPointAllowedForPCG", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, IS_POINT_ALLOWED_FOR_PCG)
        self.assertIn("IsPointAllowedForPCG", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("BlueprintCallable", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("BlueprintPure", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("Category", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("BlueprintCallable", UFUNCTION_ENVIRONMENT)
        self.assertIn("Skyguard|Mission01|Environment", UFUNCTION_ENVIRONMENT)
        self.assertIn("BlueprintPure", UFUNCTION_ENVIRONMENT)
        ...
        self.assertNotIn("|PCG", UFUNCTION_ENVIRONMENT)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, IS_POINT_ALLOWED_FOR_PCG)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, IS_POINT_ALLOWED_FOR_PCG)
        self.assertIn("IsPointAllowedForPCG", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tvoid IsPointAllowedForPCG(const FVector& WorldPoint) const;\n"
        )
        missing_const = (
            "\tbool IsPointAllowedForPCG(const FVector& WorldPoint);\n"
        )
        extra_arg = (
            "\tbool IsPointAllowedForPCG("
        ...
        as_int = (
            "\tint32 IsPointAllowedForPCG(const FVector& WorldPoint) const;\n"
        )
        ...
        missing_arg = "\tbool IsPointAllowedForPCG() const;\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, IS_POINT_ALLOWED_FOR_PCG)
            self.assertIn("IsPointAllowedForPCG", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_is_point_allowed_for_pcg_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, IS_POINT_ALLOWED_FOR_PCG),
            IS_POINT_ALLOWED_FOR_PCG,
        )
        self.assertTrue(has_declaration(section, IS_POINT_ALLOWED_FOR_PCG))
        self.assertEqual(
            declaration_count(section, IS_POINT_ALLOWED_FOR_PCG),
            1,
        )
        self.assertTrue(
            IS_POINT_ALLOWED_FOR_PCG.startswith("bool "),
            IS_POINT_ALLOWED_FOR_PCG,
        )
        self.assertTrue(
            IS_POINT_ALLOWED_FOR_PCG.endswith(";"),
            IS_POINT_ALLOWED_FOR_PCG,
        )
        self.assertIn("IsPointAllowedForPCG", IS_POINT_ALLOWED_FOR_PCG)
        self.assertIn(
            "IsPointAllowedForPCG(const FVector& WorldPoint)",
            IS_POINT_ALLOWED_FOR_PCG,
        )
        self.assertTrue(
            IS_POINT_ALLOWED_FOR_PCG.endswith(" const;"),
            IS_POINT_ALLOWED_FOR_PCG,
        )
        self.assertNotIn("TArray<", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("TObjectPtr", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("TSoftObjectPtr", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("INDEX_NONE", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("UFUNCTION", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("{", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("}", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("return ", IS_POINT_ALLOWED_FOR_PCG)
        self.assertIn(" const;", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("void ", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("Root", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("Briefing", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("AudioDirector", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("RadioChatter", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("SortiePresentation", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("CampaignDefinition", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("MissionDefinition", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("Readiness", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("bAutoInitialize", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("bAllowBoundedActorSpawning", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("bAutoLaunchAfterBriefing", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("PathfinderSpawnLocation", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("GetAircraft", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("BindRuntimeActors", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("HandleDroneCityImpact", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("ConfigureMissionDefinition", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("InitializePlayableMission", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("NotifyProtectedAssetFailed", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("SynchronizeRuntimeState", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("NotifyObjectiveProgress", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("GetReadiness", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("GetObjectiveRuntime", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("GetGunner", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("GetPathfinder", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("GetMissionId", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("ValidateMissionContract", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("ConfigureFromMission", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("AdvanceBriefing", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("SetAssetsReady", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("AcknowledgeAndLaunch", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("CanLaunch", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("GetElapsedSeconds", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("GetBriefingState", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("GetMinimumWarmupSeconds", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("GetBriefingText", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("GetRadioChatter", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("GetPresentation", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("GetMissionTitle", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("AcknowledgeBriefing", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("LaunchSortie", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("HullCollider", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("OpticalTracker", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("WeaponServo", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("CountermeasurePod", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("MinHeightFromOriginCm", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("RadarNode", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("ESkyguardMission02WaveState", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("HarborIndustrial", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("MaxIntegrity", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("CurrentIntegrity", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("FillAndFinalize", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("FillAndFail", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("IsRouteExclusionSafe", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("bRouteExclusionValid", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn(
            "bLicensedVegetationLibraryApproved",
            IS_POINT_ALLOWED_FOR_PCG,
        )
        self.assertNotIn("bAllowAuthoredPCGGeneration", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("bProductionLandscapeBound", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("bUseAuthoredLandscapeSurface", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("RebuildProductionLayout", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("HasContinuousCoastline", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn(
            "RefreshAuthoredEnvironmentBindings",
            IS_POINT_ALLOWED_FOR_PCG,
        )
        self.assertNotIn("IsAuthoredEnvironmentReady", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("IsPCGGenerationAuthorized", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("IsCorePlayableReady", IS_POINT_ALLOWED_FOR_PCG)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, IS_POINT_ALLOWED_FOR_PCG)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tbool\n"
            "\tIsPointAllowedForPCG(const FVector& WorldPoint) const;\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_ENVIRONMENT} {IS_POINT_ALLOWED_FOR_PCG}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{IS_POINT_ALLOWED_FOR_PCG}\n}}\n"
        self.assertTrue(has_declaration(one_line, IS_POINT_ALLOWED_FOR_PCG))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, IS_POINT_ALLOWED_FOR_PCG),
            section,
    ...
    def test_integration_category_does_not_satisfy_environment(self) -> None:
        ...
        self.assertNotEqual(leftover_callable, UFUNCTION_ENVIRONMENT)
        self.assertNotEqual(leftover_pcg, UFUNCTION_ENVIRONMENT)
        self.assertNotEqual(leftover_landscape, UFUNCTION_ENVIRONMENT)
        self.assertNotIn(integration, UFUNCTION_ENVIRONMENT)
        self.assertNotIn(briefing, UFUNCTION_ENVIRONMENT)
        self.assertNotIn(leftover_callable, UFUNCTION_ENVIRONMENT)
        self.assertNotIn(leftover_pcg, UFUNCTION_ENVIRONMENT)
    ...
    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        locked_only = f"{IS_POINT_ALLOWED_FOR_PCG}\n"
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, IS_POINT_ALLOWED_FOR_PCG)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", IS_POINT_ALLOWED_FOR_PCG)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_is_point_allowed_for_pcg_cpp_body(self) -> None:
        locked_only = f"{IS_POINT_ALLOWED_FOR_PCG}\n"
        self.assertNotIn("{", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("}", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("return ", IS_POINT_ALLOWED_FOR_PCG)
        ...
        self.assertNotIn("return false", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("return true", IS_POINT_ALLOWED_FOR_PCG)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{IS_POINT_ALLOWED_FOR_PCG}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_POINT_ALLOWED_FOR_PCG)
        self.assertIn("IsPointAllowedForPCG", IS_POINT_ALLOWED_FOR_PCG)
        self.assertTrue(IS_POINT_ALLOWED_FOR_PCG.startswith("bool "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, IS_POINT_ALLOWED_FOR_PCG)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("CurrentIntegrity", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("SkyguardApacheAircraft.h", IS_POINT_ALLOWED_FOR_PCG)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", IS_POINT_ALLOWED_FOR_PCG)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{IS_POINT_ALLOWED_FOR_PCG}\n"
        self.assertEqual(
            require_declaration(locked_only, IS_POINT_ALLOWED_FOR_PCG),
            IS_POINT_ALLOWED_FOR_PCG,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, IS_POINT_ALLOWED_FOR_PCG)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 IsPointAllowedForPCG method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{IS_POINT_ALLOWED_FOR_PCG}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, IS_POINT_ALLOWED_FOR_PCG.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                IS_POINT_ALLOWED_FOR_PCG.lower(),
                "mission01 IsPointAllowedForPCG contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, IS_POINT_ALLOWED_FOR_PCG)

    def test_contract_is_is_point_allowed_for_pcg_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertIn(" const;", IS_POINT_ALLOWED_FOR_PCG)
        self.assertTrue(IS_POINT_ALLOWED_FOR_PCG.endswith(";"))
        self.assertIn(UFUNCTION_ENVIRONMENT, section)

    def test_sibling_director_fields_do_not_satisfy_is_point_allowed_for_pcg(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, IS_POINT_ALLOWED_FOR_PCG)
            )
            self.assertNotEqual(IS_POINT_ALLOWED_FOR_PCG, leftover)
        self.assertIn(
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        self.assertNotIn("}", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("return ", IS_POINT_ALLOWED_FOR_PCG)
        self.assertNotIn("return Other", IS_POINT_ALLOWED_FOR_PCG)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission01_is_point_allowed_for_pcg"
            "_decl_contract.py"
        )
