...
# then BARE `void SetSpawningEnabled(bool bEnabled);`
# (declaration-only, no inline body required).
# KEEP BlueprintCallable. KEEP the bool bEnabled arg.
# const IS absent. Return type IS void. Declaration-only.
# THIS IS leftover-safe unique analog Category
# Skyguard|Spawning wrapping the Category Spawning
# UFUNCTION declaration only.
# Word-boundary match SetSpawningEnabled vs leftover
# analog field bSpawningEnabled vs leftover analog
# CountActiveDrones vs leftover analog Mission*
# bAllowBoundedActorSpawning.
# Identifier SetSpawningEnabled is NOT leftover analog
# field bSpawningEnabled, NOT leftover analog Mission*
# bAllowBoundedActorSpawning (#854/#884/#917/#955/#987/
# #1019/#1057/#801), NOT leftover analog CountActiveDrones,
# NOT leftover analog drone-spawner-empty-fail-closed bulk
# #161/#df16 (behavioral; wrap Category Spawning
# UFUNCTION declaration only).
# LOCKED_DECL is NOT leftover int32 MaxActiveDrones = 12
# (leftover analog PoolCapacity = 12 — FAIL CLOSED).
# LOCKED_DECL is NOT leftover float SpawnInterval = 1.85f.
# Those two fields wrap Category="Skyguard" without a
# leftover-safe unique path — FAIL CLOSED.
...
# bool bEnabled arg is missing, if the return type is
# not void, or if Category is
...
# without a leftover-safe unique path /
# Category="Skyguard|Audio" without |Production /
# Category="Skyguard|Boss|Encounter" without a
# leftover-safe unique suffix / Category="Settings"
# without Skyguard| / Category="Skyguard|Presentation|HUD" /
# Category="Skyguard|Pause" / Category="Skyguard|Radio" /
# Category="Skyguard|Environment|VFX" /
# Category="Skyguard|Mission01|Environment|Validation" /
# Category="Skyguard|Presentation"
# without leftover-safe unique |HUD suffix for a HUD slot.
# Accept one-line and split-line UFUNCTION wraps.
# Parse CLASS `ASkyguardDroneSpawner` public
# section ONLY after `class ASkyguardDroneSpawner`
# / GENERATED_BODY. Start at that class `public:`.
# Stop BEFORE first public UPROPERTY (`bSpawningEnabled`).
# Do NOT parse leftover analog CountActiveDrones
# (protected, no UFUNCTION).
# Isolate THIS UFUNCTION window so sibling constructor /
# BeginPlay / Tick and leftover analog Spawning
# UPROPERTY slots stay uncontracted. Do NOT wrap
# MaxActiveDrones / SpawnInterval / HeavyLaneModulo /
# bMixedThreatRoster / LightSpeedMin / LightSpeedMax /
# HeavyCruiseSpeed.
# Clone leftover unique BlueprintCallable #1680 SHA
# 27ffb2a529b5067ad204e9c35e46f650a02403a4 RETARGET
# Category Production -> Skyguard|Spawning and method
# to SetSpawningEnabled KEEP bool arg.
# FAIL-CLOSED if LOCKED_DECL is void EnsureDefaultEntries();.
# Clone leftover unique ClearQueue #1716 SHA
# a4eab961fce0e8e448351e110c7e9e9253a6a47d RETARGET
# (no-args — KEEP bool bEnabled here).
# FAIL-CLOSED if LOCKED_DECL is void ClearQueue();.
# Clone leftover unique EnqueueLine #1712 SHA
# 00ced672bd099ca5a9490843ad5bafdeb1901c31 RETARGET
# KEEP args. FAIL-CLOSED if LOCKED_DECL is
# bool EnqueueLine(const FSkyguardRadioLine& Line);.
# Clone leftover unique BindPresentation #1707 SHA
# 6a4d0db188a528053b7608035a2622d1de65be49 RETARGET
# KEEP args. FAIL-CLOSED if LOCKED_DECL is void BindPresentation(.
# Clone leftover unique Validation #1694 SHA
# e8a9961586c6ed5d538c813bb93d824c79b24db2 RETARGET
# method/return/args. KEEP BlueprintCallable KEEP arg.
# Clone leftover unique TogglePause #1711 SHA
# 8eb7b06cfe209a463f8195a4a5fc90d421d8a8dc RETARGET
# KEEP BlueprintCallable.
# FAIL-CLOSED if LOCKED_DECL is void TogglePause();.
# Clone #1300 SHA c4679feb43f4b97d3a814c088e3b6c344e15831f
# is Category Theater wrapping FName WeatherIdentity
# — RETARGET hard.
# LOCKED_DECL is void SetSpawningEnabled(bool bEnabled);
# NOT FName WeatherIdentity; and NOT int32 GetSortieHits() const;
# and NOT void ResetSortieCombatStats(); and NOT
# bool GetInvertVerticalLook() const; and NOT
# bool bSuccess = false; and NOT void EnsureDefaultEntries();
# and NOT void TogglePause(); and NOT void BindPresentation(;
# and NOT void ClearQueue(); and NOT
# bool EnqueueLine(const FSkyguardRadioLine& Line);
# and NOT leftover analog int32 PoolCapacity = 12
# and NOT leftover int32 MaxActiveDrones = 12
# and NOT leftover float SpawnInterval = 1.85f
# and NOT leftover analog field bSpawningEnabled
# and NOT leftover analog CountActiveDrones
# and NOT leftover analog bAllowBoundedActorSpawning
# and NOT FireRate = 12.0f / RecoilPitch = 0.92f / 160.f /
# RouteLengthCm = 45000.f and NOT leftover Boom
# and NOT leftover VegetationStartCullDistanceCm.
# Fail-closed if this test still asserts FName
# WeatherIdentity / GetSortieHits / ResetSortieCombatStats /
# GetInvertVerticalLook / bSuccess = false /
# void EnsureDefaultEntries() / void TogglePause() /
# void BindPresentation( / void ClearQueue() /
# bool EnqueueLine( / int32 PoolCapacity = 12 /
# int32 MaxActiveDrones = 12 / float SpawnInterval = 1.85f /
# FireRate = 12.0f / RecoilPitch = 0.92f / leftover Boom /
# leftover VegetationStartCullDistanceCm
# AS THE LOCKED DECL.
...
LEFTOVER_RADIO_CHATTER_CLASS = "USkyguardRadioChatterComponent"
LEFTOVER_HUD_HOST_CLASS = "USkyguardSortieHudHostComponent"
LEFTOVER_PAUSE_HOST_CLASS = "USkyguardPauseHostComponent"
LEFTOVER_RADIO_LINE_STRUCT = "FSkyguardRadioLine"
...
TARGET = "void SetSpawningEnabled(bool bEnabled);"
TARGET_SPLIT = (
    "void SetSpawningEnabled(\n"
    "\tbool bEnabled);"
)
TARGET_INLINE = TARGET
TARGET_WRONG_BARE = "void SetSpawningEnabled();"
TARGET_WRONG_NO_CONST = (
    "void SetSpawningEnabled(bool bEnabled) const;"
)
TARGET_WRONG_REFRESH = "void PrimeLines(const TArray<FSkyguardRadioLine>& Lines);"
TARGET_WRONG_REBIND = "void AdvanceRadioState(float DeltaSeconds);"
TARGET_WRONG_GET_BOUND = "void ClearQueue();"
TARGET_WRONG_GET_BOUND_INLINE = (
    "int32 GetQueuedLineCount() const { return Queue.Num(); }"
)
TARGET_WRONG_ACTIVATION = "FName GetCurrentLineId() const;"
TARGET_WRONG_TOGGLE_PAUSE = "void TogglePause();"
TARGET_WRONG_BIND_PRESENTATION = "void BindPresentation("
...
TARGET_WRONG_FLOAT = (
    "float SetSpawningEnabled(bool bEnabled);"
)
TARGET_WRONG_INT = "int32 GetSortieHits() const;"
TARGET_WRONG_RENAME = "void SetSpawningEnable(bool bEnabled);"
...
TARGET_WRONG_TRUE = "bool SetSpawningEnabled = true;"
TARGET_WRONG_ZERO = "bool SetSpawningEnabled = 0.f;"
...
UFUNCTION_PURE = (
    'UFUNCTION(BlueprintPure, Category="Skyguard|Spawning")'
)
UFUNCTION_HUD = (
...
STOP_BEFORE_EVENT_DEFINITIONS = "bSpawningEnabled"
SIBLING_INITIALIZE_REQUIRED = "BeginPlay"
SIBLING_EVALUATE_READINESS = "Tick"
SIBLING_CONFIGURE_ROUTING = "CountActiveDrones"
SIBLING_UNBOUND_CATEGORIES = "MaxActiveDrones"
SIBLING_FIND_ENTRY = "SpawnInterval"
SIBLING_GET_REQUIRED = "HeavyLaneModulo"
SIBLING_GET_DISPLAY = "bMixedThreatRoster"
SIBLING_ENTRIES = "BeginPlay"
SIBLING_ROUTING = "Tick"
SIBLING_SPAWNING_FIELD = "bSpawningEnabled"
...
TARGET_WRONG_ENQUEUE = (
    "bool EnqueueLine(const FSkyguardRadioLine& Line);"
)
TARGET_WRONG_CLEAR_QUEUE = "void ClearQueue();"
...
STOP_BEFORE_SKYLINE_STYLE = "SpawnInterval"
...
LOCKED = {
    ...
    "SkyguardPauseHostComponent.h",
    "SkyguardPauseHostComponent.cpp",
...
def leftover_analog_extra_scripts() -> tuple[str, ...]:
    ...
    return (
        ...
        f"{prefix}test_pause_host_toggle_pause_decl_contract.py",
        f"{prefix}test_radio_line_line_id_field_decl_contract.py",
        f"{prefix}test_radio_line_speaker_field_decl_contract.py",
        f"{prefix}test_radio_line_subtitle_field_decl_contract.py",
        f"{prefix}test_radio_line_sound_field_decl_contract.py",
        f"{prefix}test_radio_line_priority_field_decl_contract.py",
        f"{prefix}test_radio_line_estimated_duration_seconds"
        "_field_decl_contract.py",
        f"{prefix}test_radio_line_cooldown_seconds"
        "_field_decl_contract.py",
        f"{prefix}test_radio_chatter_enqueue_line"
        "_decl_contract.py",
        f"{prefix}test_radio_chatter_clear_queue"
        "_decl_contract.py",
        f"{prefix}test_radio_chatter_prime_lines"
        "_decl_contract.py",
        f"{prefix}test_pause_host_toggle_pause"
        "_decl_contract.py",
...
LOCKED_SCRIPTS = (
    ...
    "_decl_contract.py",
    "Scripts/tests/test_pause_host_toggle_pause"
    "_decl_contract.py",
...
METHOD_SIGNATURE_RE = re.compile(
    r"\bvoid\s+SetSpawningEnabled\("
    r"bool\s+bEnabled\)(?:;|\{)"
)
SET_SPAWNING_ENABLED_IDENT_RE = re.compile(
    r"\bSetSpawningEnabled\b"
)
ENQUEUE_LINE_IDENT_RE = re.compile(r"\bEnqueueLine\b")
PRIME_LINES_IDENT_RE = re.compile(r"\bPrimeLines\b")
ADVANCE_RADIO_IDENT_RE = re.compile(r"\bAdvanceRadioState\b")
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # KEEP bool bEnabled. Reject leftover analog no-args
    # ClearQueue. Accept origin/main split-line
    # trailing-semicolon form. Do not accept a method const
    # qualifier, a bool/float/int32 rename, leftover unique
    # EnsureDefaultEntries / TogglePause / BindPresentation /
    # ClearQueue / EnqueueLine / GetSortieHits, leftover analog
    # field bSpawningEnabled, leftover analog CountActiveDrones,
    # leftover analog bAllowBoundedActorSpawning, leftover analog
    # MaxActiveDrones = 12 / SpawnInterval = 1.85f / PoolCapacity
    # = 12, leftover FName WeatherIdentity, leftover TObjectPtr
    # ProductionBank, leftover FireRate / RecoilPitch, leftover
    # Boom, leftover VegetationStartCullDistanceCm, or Harbor 40 / 80.
    del declaration
    compact = collapsed(region)
    if METHOD_SIGNATURE_RE.search(compact) is None:
        return False
    if re.search(
        r"\bSetSpawningEnabled\s*\([^)]*\)\s*const\b",
        compact,
    ):
        return False
    if re.search(r"\bbool\s+SetSpawningEnabled\b", compact):
        return False
    if re.search(r"\bfloat\s+SetSpawningEnabled\b", compact):
        return False
    if re.search(r"\bint32\s+SetSpawningEnabled\b", compact):
        return False
    if re.search(r"\bvoid\s+SetSpawningEnabled\s*\(\s*\)", compact):
        return False
    if re.search(r"\bvoid\s+EnsureDefaultEntries\s*\(", compact):
        return False
    if re.search(r"\bvoid\s+TogglePause\s*\(", compact):
        return False
    if re.search(r"\bvoid\s+BindPresentation\s*\(", compact):
        return False
    if re.search(r"\bvoid\s+ClearQueue\s*\(", compact):
        return False
    if re.search(r"\bbool\s+EnqueueLine\s*\(", compact):
        return False
    if re.search(r"\bint32\s+GetSortieHits\s*\(", compact):
        return False
    if re.search(r"PoolCapacity\s*=\s*12\b", compact):
        return False
    if re.search(r"MaxActiveDrones\s*=\s*12\b", compact):
    ...
    if re.search(r"SpawnInterval\s*=\s*1\.85f\b", compact):
        return False
    if re.search(r"\bbSpawningEnabled\b", compact) and (
        SET_SPAWNING_ENABLED_IDENT_RE.search(compact) is None
    ):
        return False
    if re.search(r"\bCountActiveDrones\b", compact):
        return False
    if re.search(r"\bbAllowBoundedActorSpawning\b", compact):
        return False
    if GET_BOUND_PRESENTATION_IDENT_RE.search(compact) and (
...
def attached_ufunction_specifiers(section: str) -> str:
    ...
    while True:
        ...
        if depth == 0 and re.match(
            r"\s*void\s+SetSpawningEnabled\b",
            compact[index:],
        ):
            return compact[start : index - 1]
        cursor = cursor + match.start() + 1
    raise AssertionError(
        "UFUNCTION for SetSpawningEnabled "
...
class DroneSpawnerSetSpawningEnabledDeclContractTests(
    unittest.TestCase
):
    def test_drone_spawner_class_exists(self) -> None:
        ...
        self.assertNotEqual(CLASS_NAME, LEFTOVER_HUD_HOST_CLASS)
        self.assertNotEqual(CLASS_NAME, LEFTOVER_PAUSE_HOST_CLASS)
        self.assertNotEqual(CLASS_NAME, LEFTOVER_RADIO_CHATTER_CLASS)
        self.assertNotEqual(CLASS_NAME, LEFTOVER_RADIO_LINE_STRUCT)
        self.assertNotEqual(
            HEADER_PATH,
            "Source/Skyguard52/SkyguardSortieHudHostComponent.h",
        )
        self.assertNotEqual(
            HEADER_PATH,
            "Source/Skyguard52/SkyguardPauseHostComponent.h",
        )
        body = class_body(header)
        ...
        self.assertTrue(
            has_identifier(section, "SetSpawningEnabled"),
            section,
        )
        ...
        self.assertTrue(has_identifier(body, "CountActiveDrones"), body)
    ...
    def test_missing_set_spawning_enabled_declaration_fails_closed(
        self,
    ) -> None:
        empty = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertTrue("|Spawning" in specifiers)
        ...
        self.assertTrue("|Spawning" in specifiers)
        self.assertNotIn("|HUD", specifiers)
        self.assertNotIn("|Pause", specifiers)
        self.assertNotIn("|Radio", specifiers)
        self.assertNotIn("|Validation", specifiers)
        self.assertNotEqual(
            specifiers,
    ...
    def test_missing_or_wrong_signature_fails_closed(self) -> None:
        ...
        self.assertNotIn("GetBoundPresentation", collapsed(LOCKED_DECL))
        self.assertTrue(
            SET_SPAWNING_ENABLED_IDENT_RE.search(LOCKED_DECL)
        )
        self.assertIsNone(
            PRIME_LINES_IDENT_RE.search(LOCKED_DECL)
        )
        self.assertFalse(
            has_identifier(
        ...
        self.assertFalse(
            has_identifier(
                "bool bAllowBoundedActorSpawning = false;",
                "SetSpawningEnabled",
            )
        )
        self.assertNotIn(
            "SetSpawningEnabled()const",
    ...
    def test_set_spawning_enabled_declaration_matches_origin_main(
        self,
    ) -> None:
        section = spec_section(origin_main_header())
        self.assertEqual(
        ...
        self.assertIsNone(re.search(r"\)\s*const\b", LOCKED_DECL))
        self.assertNotIn("static ", LOCKED_DECL)
        self.assertTrue(has_identifier(LOCKED_DECL, "bEnabled"))
        self.assertIn(
            "bool bEnabled",
            LOCKED_DECL,
        )
        ...
        self.assertNotIn("FSkyguardRadioLine", LOCKED_DECL)
    ...
    def test_locked_decl_is_not_leftover_clone_weather_identity(self) -> None:
        ...
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_TOGGLE_PAUSE)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_BIND_PRESENTATION)
        ...
        self.assertFalse(LOCKED_DECL.startswith("void BindPresentation("))
        ...
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_ARCADE_ENABLED)
        self.assertIn("bool bEnabled", LOCKED_DECL)
        self.assertTrue(has_identifier(LOCKED_DECL, "bEnabled"))
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_BOOM)
    ...
    def test_wrong_default_and_renames_do_not_satisfy(self) -> None:
        ...
        wrongs = (
            ...
            leftover_primary,
            leftover_guided,
            "\tbool SetSpawningEnabledX(bool bEnabled);\n",
            "\tint32 SetSpawningEnabled = 1;\n",
            "\tFName SetSpawningEnabled = NAME_None;\n",
            "\tvoid SetSpawningEnabled() = "
            + forty
            + ";\n",
            "\tvoid SetSpawningEnabled() = "
            ...
            f"\t{TARGET_WRONG_TOGGLE_PAUSE}\n",
            f"\t{TARGET_WRONG_BIND_PRESENTATION}\n",
            ...
            f"\t{TARGET_WRONG_ENQUEUE}\n",
            f"\t{TARGET_WRONG_CLEAR_QUEUE}\n",
    ...
    def test_does_not_parse_private_or_neighbors(self) -> None:
        ...
        self.assertNotIn(STOP_BEFORE_PRIVATE, section)
        self.assertTrue(
            has_identifier(leaked, "SetSpawningEnabled")
        )
        self.assertTrue(
            has_identifier(section, "SetSpawningEnabled")
        )
        ...
        self.assertTrue(has_identifier(leaked, STOP_BEFORE_SKYLINE_STYLE))
        self.assertFalse(has_identifier(section, STOP_BEFORE_SKYLINE_STYLE))
        self.assertTrue(has_identifier(leaked, "CountActiveDrones"))
        self.assertFalse(has_identifier(section, "CountActiveDrones"))
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertNotIn("SkyguardRadioChatterComponent.h", HEADER_PATH)
        ...
        self.assertNotEqual(
            HEADER_PATH,
            "Source/Skyguard52/SkyguardRadioChatterComponent.h",
        )
        self.assertNotIn("SkyguardSortieHudHostComponent.h", HEADER_PATH)
        self.assertNotIn("SkyguardPauseHostComponent.h", HEADER_PATH)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(Path(__file__).name.endswith(
            "drone_spawner_set_spawning_enabled"
            "_decl_contract.py"
        ))
    ...
    def test_contract_is_target_method_declaration_only(self) -> None:
        ...
        self.assertNotEqual(locked_only.strip(), TARGET_WRONG_ARCADE_ENABLED)
        self.assertIn("bool bEnabled", locked_only)
        self.assertTrue(has_identifier(locked_only, "bEnabled"))
        ...
        self.assertNotIn("TogglePause", LOCKED_DECL)
        self.assertNotIn("BindPresentation", LOCKED_DECL)
        self.assertNotIn("PrimeLines", LOCKED_DECL)
        self.assertNotIn("AdvanceRadioState", LOCKED_DECL)
        self.assertNotIn("ClearQueue", LOCKED_DECL)
        self.assertNotIn("GetQueuedLineCount", LOCKED_DECL)
        self.assertNotIn("GetCurrentLineId", LOCKED_DECL)
        self.assertNotIn("GetDroppedLineCount", LOCKED_DECL)
        self.assertNotIn("GetPlayedLineCount", LOCKED_DECL)
        self.assertNotIn("OnLineStarted", LOCKED_DECL)
        self.assertNotIn("MaxQueuedLines", LOCKED_DECL)
        self.assertNotIn("LineId", LOCKED_DECL)
        self.assertNotIn("Speaker", LOCKED_DECL)
        self.assertNotIn("Subtitle", LOCKED_DECL)
        self.assertNotIn("EstimatedDurationSeconds", LOCKED_DECL)
        self.assertNotIn("CooldownSeconds", LOCKED_DECL)
        ...
        self.assertTrue(has_identifier(LOCKED_DECL, "bEnabled"))
        self.assertIn("SetSpawningEnabled", LOCKED_DECL)
        self.assertNotIn("EnqueueLine", LOCKED_DECL)
        for leftover in leftover_apache_ufunction_tokens():
            self.assertNotIn(leftover, locked_only)

    def test_word_boundary_set_spawning_enabled_vs_field_and_count(
        self,
    ) -> None:
        self.assertTrue(
            has_identifier(
        ...
        self.assertFalse(
            has_identifier(LOCKED_DECL, "bSpawningEnabled")
        )
        self.assertFalse(
            has_identifier(LOCKED_DECL, "CountActiveDrones")
        )
        self.assertFalse(has_identifier(LOCKED_DECL, "ClearQueue"))
        self.assertFalse(has_identifier(LOCKED_DECL, "EnqueueLine"))
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_SPAWNING_FIELD)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_COUNT_ACTIVE)
        ...
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_GET_BOUND)
        section = spec_section(origin_main_header())
        self.assertTrue(has_identifier(section, "SetSpawningEnabled"), section)
        self.assertFalse(has_identifier(section, "bSpawningEnabled"), section)
        self.assertFalse(
            has_identifier(section, "CountActiveDrones"),
            section,
        )
    ...
    def test_does_not_parse_spawning_field_or_count_active_as_this_slot(self) -> None:
        header = origin_main_header()
        class_token = f"class SKYGUARD52_API {CLASS_NAME}"
        self.assertIn(class_token, header)
        body = class_body(header)
        section = spec_section(header)
        self.assertTrue(body.startswith("{"), body)
        ...
        self.assertTrue(has_identifier(body, "CountActiveDrones"))
        ...
        self.assertNotIn("CountActiveDrones", LOCKED_DECL)
    ...
    def test_locked_decl_is_not_clone_ensure_toggle_hits_or_bind(
        self,
    ) -> None:
        self.assertEqual(LOCKED_DECL, TARGET)
        self.assertNotEqual(LOCKED_DECL, "void EnsureDefaultEntries();")
        self.assertNotEqual(LOCKED_DECL, "void TogglePause();")
        self.assertNotEqual(LOCKED_DECL, "int32 GetSortieHits() const;")
        self.assertFalse(LOCKED_DECL.startswith("void BindPresentation("))
        self.assertNotEqual(
            LOCKED_DECL,
        ...
        self.assertNotEqual(LOCKED_DECL, "void ClearQueue();")
        self.assertNotEqual(
            LOCKED_DECL,
            "bool EnqueueLine(const FSkyguardRadioLine& Line);",
        )
        ...
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_SPAWN_INTERVAL)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_SPAWNING_FIELD)
        self.assertNotEqual(LOCKED_DECL, "int32 PoolCapacity = 12;")
        forty = "40" + ".f"
        eighty = "80" + ".f"
        self.assertNotIn(forty, LOCKED_DECL)
        self.assertNotIn(eighty, LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("void SetSpawningEnabled("))
        self.assertIn("bool bEnabled", LOCKED_DECL)
        self.assertIsNone(re.search(r"\)\s*const\b", LOCKED_DECL))
        self.assertIn(
            'Category="Skyguard|Spawning"',
        ...
        self.assertNotIn('Category="Skyguard|Spawning"', pause_specs)
        leftover_radio = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "public:\n"
        ...
        radio_specs = attached_ufunction_specifiers(
            spec_section(leftover_radio)
        )
        self.assertIn('Category="Skyguard|Radio"', radio_specs)
        self.assertNotIn('Category="Skyguard|Spawning"', radio_specs)
        leftover_hud = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "public:\n"
        ...
        hud_specs = attached_ufunction_specifiers(
            spec_section(leftover_hud)
        )
        self.assertIn(
            'Category="Skyguard|Presentation|HUD"',
            hud_specs,
        )
        self.assertNotIn('Category="Skyguard|Spawning"', hud_specs)
