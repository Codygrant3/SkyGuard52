...
# (`ESkyguardMission09WaveState GetWaveState()
...
# drafts #674–#755+, leftover Apache
...
# Do not reopen open drafts #674–#755+.
...
class Mission09GetWaveStateDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        renamed = (
            "\tESkyguardMission09WaveState GetState() const;\n"
        )
        short_name = "\tESkyguardMission09WaveState GetWave() const;\n"
    ...
    def test_get_wave_state_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            GET_WAVE_STATE.startswith("ESkyguardMission09WaveState "),
            GET_WAVE_STATE,
        )
        self.assertIn("ESkyguardMission09WaveState", GET_WAVE_STATE)
        ...
        self.assertNotIn("ASkyguardMission02IntegrationDirector", GET_WAVE_STATE)
        ...
        self.assertNotIn("ESkyguardMission02WaveState", GET_WAVE_STATE)
    ...
    def test_contract_does_not_lock_get_wave_state_cpp_body(self) -> None:
        ...
        self.assertNotIn("return ", GET_WAVE_STATE)
        self.assertNotIn(
            "ASkyguardMission09IntegrationDirector::GetWaveState",
            GET_WAVE_STATE,
        )
        self.assertNotIn(
            "SkyguardMission09IntegrationDirector.cpp",
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("GetWaveState", GET_WAVE_STATE)
        self.assertTrue(GET_WAVE_STATE.startswith("ESkyguardMission09WaveState "))
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 GetWaveState method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission09 GetWaveState contains "
