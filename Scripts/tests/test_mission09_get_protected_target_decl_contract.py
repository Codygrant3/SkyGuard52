...
# Mission09 Protection GetProtectedTarget
# METHOD (declaration-only, split-line) on
# ASkyguardMission09IntegrationDirector.
# It is NOT leftover Mission09 protected-target
# enum #9246 / #228, NOT leftover Mission09
# protected-target-runtime-defaults #bf28 / #225,
# NOT leftover Mission08 GetProtectedTarget #746 /
# branch cursor/mission08-get-protected-target-
# decl-contract-c332, NOT leftover Mission07
# GetProtectedTarget #723, NOT leftover
...
# GetRemainingThreatsInWave / GetSurvivingTargetCount /
...
# origin/main is a split-line declaration
...
# Mission07 Protection #723, not leftover Mission05
# Protection #678, not leftover Mission07
...
# GetProtectedTarget #723 / branch
# cursor/mission07-get-protected-target-decl-
# contract-c332. Do not reopen leftover Mission05
# GetProtectedTarget #678 / branch
# cursor/mission05-get-protected-target-decl-
# contract-c332. Do not reopen leftover Mission08
# GetProtectedTarget #746 / branch
# cursor/mission08-get-protected-target-decl-
# contract-c332. Do not reopen leftover Mission08
...
# #228 (THIS IS THE METHOD, NOT THE ENUM), leftover
...
LOCKED_DECL = GET_PROTECTED_TARGET
...
class Mission09GetProtectedTargetDeclContractTests(unittest.TestCase):
    ...
    def test_get_protected_target_declaration_matches_origin_main(self) -> None:
        ...
        self.assertIn("GetProtectedTarget", LOCKED_DECL)
        self.assertIn("GetProtectedTarget(", LOCKED_DECL)
        self.assertIn(
            "ESkyguardMission09ProtectedTarget Target",
            LOCKED_DECL,
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 GetProtectedTarget contains "
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        origin_inline = (
            ...
            "\t\tESkyguardMission09ProtectedTarget Target) const\n"
            "\t{\n"
            "\t\treturn FSkyguardMission09ProtectedTargetRuntime();\n"
            "\t}\n"
            "};\n"
        )
        one_line_inline = (
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_get_protected_target"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_origin_main_accepts_split_line_without_locking_body(self) -> None:
        ...
        self.assertIn(UFUNCTION_PROTECTION, section)
        self.assertIn("GetProtectedTarget(", section)
        self.assertIn("ESkyguardMission09ProtectedTarget Target", section)
        self.assertIn("FSkyguardMission09ProtectedTargetRuntime", section)
        self.assertNotIn("{", LOCKED_DECL)
        self.assertNotIn("return ", LOCKED_DECL)
        self.assertNotIn("return false", LOCKED_DECL)
        self.assertNotIn("return true", LOCKED_DECL)
