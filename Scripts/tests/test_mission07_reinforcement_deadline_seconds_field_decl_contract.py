...
# INDEX_NONE or lock ReinforcementDeadlineSeconds
# construction in the .cpp. This is leftover-safe
# Mission07 ReinforcementDeadlineSeconds FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps, ClampMin one-line or split-line,
# float default 45.f) on
# ASkyguardMission07IntegrationDirector.
# SKIP leftover retired-mount spawn fields
# forever. This contract is
# ReinforcementDeadlineSeconds only. It is NOT leftover
# Mission07 MaximumProtectedTargetIntegrity sibling /
# branch cursor/mission07-maximum-protected-target-
# integrity-field-decl-contract-c332, NOT leftover
# same-name Mission05 MaximumProtectedTargetIntegrity
...
# Leftover Mission07 Root #1011 / Briefing #1012 /
# AudioDirector #1013 / RadioChatter #1016 /
# SortiePresentation #1014 / CampaignDefinition #1015 /
# MissionDefinition #1017 / leftover bAutoInitialize
# #1018 / leftover bAllowBoundedActorSpawning #1019 /
# leftover bAutoLaunchAfterBriefing #1020 / leftover
# CampaignSaveSlotName #1021 / leftover
# CampaignSaveUserIndex / RadarGhostSpawnLocation /
# RadarGhostSpawnRotation / MaximumProtectedTargetIntegrity
# / Readiness are sibling lanes (do not implement those
# fields in this file).
# Do not reopen leftover drafts #56-#64, leftover
# #107-#673, leftover drafts #536-#673. Do not
# open leftover drafts #674-#956.
# Note EditAnywhere / BlueprintReadWrite /
# Category Skyguard|Mission07 /
# float = 45.f / ClampMin 1.0, not
...
# the `= 45.f` default, and nearby split-line
...
# split-line UPROPERTY wraps plus the `= 45.f`
...
# FSkyguardStormRuntime, private, or Mission01-06 /
# Mission08-10 directors.
# Category is Skyguard|Mission07, not leftover
...
UPROPERTY_MISSION07_CLAMP = 'meta=(ClampMin="1.0")'
...
MAXIMUM_TARGET_INTEGRITY_FIELD = (
    "int32 MaximumTargetIntegrity = 100;"
)
REINFORCEMENT_DEADLINE_SECONDS_FIELD = (
    "float ReinforcementDeadlineSeconds = 45.f;"
)
...
LOCKED_DECL = REINFORCEMENT_DEADLINE_SECONDS_FIELD
...
# an isolated Python ReinforcementDeadlineSeconds
...
class Mission07ReinforcementDeadlineSecondsFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_reinforcement_deadline_seconds_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn(UPROPERTY_MISSION07_CLAMP, section)
        self.assertIn('ClampMin="1.0"', section)
        self.assertNotIn("VisibleAnywhere", UPROPERTY_MISSION07)
        self.assertNotIn("BlueprintReadOnly", UPROPERTY_MISSION07)
        self.assertTrue(
            has_declaration(section, LOCKED_DECL),
            section,
        )
        ...
        self.assertNotIn("Skyguard|Mission10|Protection", UPROPERTY_MISSION07)
        ...
        self.assertNotIn("Skyguard|Mission07|Campaign", UPROPERTY_MISSION07)
        self.assertNotIn("ClampMin", UPROPERTY_MISSION07)
    ...
    def test_reinforcement_deadline_seconds_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("float ReinforcementDeadlineSeconds"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("ReinforcementDeadlineSeconds", LOCKED_DECL)
        self.assertIn("= 45.f", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("ReinforcementDeadlineSeconds", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("float ReinforcementDeadlineSeconds"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("ReinforcementDeadlineSeconds", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 ReinforcementDeadlineSeconds field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission07 ReinforcementDeadlineSeconds contains "
    ...
    def test_contract_is_reinforcement_deadline_seconds_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_reinforcement_deadline_seconds(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tfloat ReinforcementDeadlineSeconds = 1.f;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_reinforcement_deadline_seconds_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_parse_readiness_struct(self) -> None:
        ...
        self.assertIsNone(
            re.search(
                ...
                r"FSkyguardMission07IntegrationReadiness\b",
                header,
            )
        )
        self.assertIn(
    ...
    def test_storm_runtime_struct_does_not_satisfy_reinforcement_deadline_seconds(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_readiness_struct_does_not_satisfy_reinforcement_deadline_seconds(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_leftover_mission07_sibling_field_contracts_stay_locked(
        self,
    ) -> None:
        for leftover in (
            "Scripts/tests/test_mission07_root_field_decl_contract.py",
            ...
            "_decl_contract.py",
            "Scripts/tests/test_mission07_campaign_save_user_index_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission07_radar_ghost_spawn_location"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission07_radar_ghost_spawn_rotation"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission07_maximum_protected_target"
            "_integrity_field_decl_contract.py",
        ):
            self.assertIn(leftover, LOCKED_SCRIPTS)
        locked_only = f"{LOCKED_DECL}\n"
        self.assertNotIn("RadarGhostSpawnLocation", locked_only)
        self.assertNotIn("RadarGhostSpawnRotation", locked_only)
        self.assertNotIn("MaximumProtectedTargetIntegrity", locked_only)
        self.assertNotIn("MaximumProtectedTargetIntegrity", LOCKED_DECL)
        self.assertNotIn("CampaignSaveSlotName", LOCKED_DECL)
        self.assertNotIn("CampaignSaveUserIndex", LOCKED_DECL)

    def test_search_track_runtime_does_not_satisfy_reinforcement_deadline_seconds(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_protected_target_runtime_does_not_satisfy_reinforcement_deadline_seconds(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
