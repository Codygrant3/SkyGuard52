...
CLASS_NAME = "ASkyguardMission08IntegrationDirector"
# Declaration presence only. Do not invent
# INDEX_NONE or lock MinimumWeaponSeparationMeters
# construction in the .cpp. This is leftover-safe
# Mission08 MinimumWeaponSeparationMeters FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps, ClampMin same-line or wrap,
# float default 450.f / 450.0f) on
# ASkyguardMission08IntegrationDirector. Note
# EditAnywhere / BlueprintReadWrite /
# Category Skyguard|Mission08|Safety /
# float = 450.f, not VisibleAnywhere /
# BlueprintReadOnly / TObjectPtr. It is
# NOT leftover RequiredCoveredSeconds sibling
# this wave, NOT leftover LifelineHunterSpawnLocation
# #1061, NOT leftover LifelineHunterSpawnRotation
# (in-flight), NOT leftover CampaignSaveSlotName
# #1059, NOT leftover CampaignSaveUserIndex #1060,
# NOT leftover MaximumProtectedTargetIntegrity,
# NOT leftover Readiness, NOT leftover
# retired-mount spawn fields (skip leftover
# spawn location / spawn rotation forever).
# NOT leftover Mission01 CampaignSaveUserIndex field
# (same-name leftover, do not reopen),
# NOT leftover Mission01 CampaignSaveUserIndex field
...
# #1044 through CampaignSaveUserIndex #1060 /
# LifelineHunterSpawnLocation #1061.
...
# with ClampMin meta on the same Category line);
# accept that form, other one-line / split-line wraps,
# ClampMin on the same line as Category or a wrap
# line, and 450.f / 450.0f float default spellings
...
# class section of
# ASkyguardMission08IntegrationDirector only.
...
# leftover Mission06 / leftover Mission07 / Mission09-10 directors.
# Category is Skyguard|Mission08|Safety, not
...
# Search / Waves / Hoist / Campaign / Boss / Destruction /
...
# Mission08 MinimumWeaponSeparationMeters =
# 450.f is Harbor-adjacent, not Harbor 40/80, and
# is the locked field. Do not lock leftover
...
UPROPERTY_MISSION08_CLAMP = 'meta=(ClampMin="1.0")'
...
LOCKED_DECL = MINIMUM_WEAPON_SEPARATION_FIELD
...
# an isolated Python MinimumWeaponSeparationMeters
...
LEFTOVER_MISSION08_LIFELINE_HUNTER_SPAWN_NOT_LOCKED = (
    LIFELINE_HUNTER_SPAWN_LOCATION,
    LIFELINE_HUNTER_SPAWN_ROTATION,
...
LEFTOVER_MISSION10_MINIMUM_WEAPON_SEPARATION_NOT_LOCKED = (
    "ASkyguardMission10IntegrationDirector",
    "SkyguardMission10IntegrationDirector.h",
    "test_mission10_minimum_weapon_separation_meters_field_decl_contract.py",
    "cursor/mission10-minimum-weapon-separation-meters-field-decl-contract-c332",
    'Category="Skyguard|Mission10|Safety"',
)
...
def normalize_float_spellings(text: str) -> str:
    # Accept origin/main 450.f and equivalent 450.0f.
    return re.sub(r"\b(\d+)\.0f\b", r"\1.f", text)


def has_declaration(region: str, declaration: str) -> bool:
    region = normalize_float_spellings(region)
    declaration = normalize_float_spellings(declaration)
...
class Mission08MinimumWeaponSeparationMetersFieldDeclContractTests(unittest.TestCase):
    def test_mission08_class_exists(self) -> None:
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("MinimumWeaponSeparationMeters", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_minimum_weapon_separation_meters_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        macro_only = f"\t{UPROPERTY_MISSION08}\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn(UPROPERTY_MISSION08_CLAMP, section)
        self.assertIn('ClampMin="1.0"', section)
        ...
        self.assertNotIn("BlueprintCallable", UPROPERTY_MISSION08)
        self.assertNotIn("BlueprintPure", UPROPERTY_MISSION08)
        self.assertIn("Skyguard|Mission08", UPROPERTY_MISSION08)
        self.assertNotIn("Skyguard|Mission02|Protection", UPROPERTY_MISSION08)
        self.assertNotIn("Integration", UPROPERTY_MISSION08)
        self.assertNotIn("Mission01", UPROPERTY_MISSION08)
        self.assertNotIn("Mission02", UPROPERTY_MISSION08)
        self.assertNotIn("Mission03", UPROPERTY_MISSION08)
        self.assertNotIn("Mission04", UPROPERTY_MISSION08)
        self.assertNotIn("Mission05", UPROPERTY_MISSION08)
        self.assertNotIn("Protection", UPROPERTY_MISSION08)
        self.assertNotIn("Search", UPROPERTY_MISSION08)
        self.assertNotIn("Waves", UPROPERTY_MISSION08)
        self.assertNotIn("Payload", UPROPERTY_MISSION08)
        self.assertNotIn("Targets", UPROPERTY_MISSION08)
        self.assertNotIn("Objectives", UPROPERTY_MISSION08)
        self.assertNotIn("Environment", UPROPERTY_MISSION08)
        self.assertNotIn("Briefing", UPROPERTY_MISSION08)
        self.assertNotIn("Mission10", UPROPERTY_MISSION08)
        self.assertNotIn("Boss", UPROPERTY_MISSION08)
        self.assertNotIn("Destruction", UPROPERTY_MISSION08)
        self.assertNotIn("Apache", UPROPERTY_MISSION08)
        self.assertNotIn("Mission06", UPROPERTY_MISSION08)
        self.assertNotIn("Mission07", UPROPERTY_MISSION08)
        self.assertNotIn("Mission09", UPROPERTY_MISSION08)
        self.assertNotIn("Encounter", UPROPERTY_MISSION08)
        self.assertIn("Safety", UPROPERTY_MISSION08)
        self.assertNotIn("Performance", UPROPERTY_MISSION08)
        self.assertNotIn("Hoist", UPROPERTY_MISSION08)
        self.assertNotIn("Rescue", UPROPERTY_MISSION08)
        self.assertNotIn("Evacuation", UPROPERTY_MISSION08)
        self.assertNotIn("Campaign", UPROPERTY_MISSION08)
        self.assertIn("Skyguard|Mission08|Safety", UPROPERTY_MISSION08)
        self.assertNotIn("ClampMin", UPROPERTY_MISSION08)
        self.assertNotIn("ClampMin", LOCKED_DECL)
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, UPROPERTY_MISSION08)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_weapon_sep = f"\t{REQUIRED_COVERED_SECONDS_FIELD}\n"
        leftover_user_index = f"\t{CAMPAIGN_SAVE_USER_INDEX_FIELD}\n"
    ...
    def test_minimum_weapon_separation_meters_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("float MinimumWeaponSeparationMeters"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("MinimumWeaponSeparationMeters", LOCKED_DECL)
        self.assertIn("= 450.f", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION08} {LOCKED_DECL}\n"
            "};\n"
        )
        ...
        wrap_origin_default_450_0f = (
            "public:\n"
            f"\t{UPROPERTY_MISSION08}, {UPROPERTY_MISSION08_CLAMP})\n"
            "\tfloat MinimumWeaponSeparationMeters = 450.0f;\n"
            "};\n"
        )
        header_wrap_type = (
            f"class SKYGUARD52_API {CLASS_NAME} "
        ...
        header_wrap_origin_default_450_0f = (
            f"class SKYGUARD52_API {CLASS_NAME} "
            f": public AActor\n{{\n{wrap_origin_default_450_0f}"
        )
        for header in (
    ...
    def test_declaration_accepts_origin_main_default_forms(self) -> None:
        ...
        for wrap in accepted:
            ...
            accepted_section = public_section(accepted_header)
            self.assertTrue(
                has_declaration(accepted_section, LOCKED_DECL),
                accepted_section,
            )
        for wrap in wraps[2:]:
            region = f"\t{wrap}\n"
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(environment, UPROPERTY_MISSION08)
        self.assertNotEqual(briefing, UPROPERTY_MISSION08)
        self.assertNotIn(environment, UPROPERTY_MISSION08)
        self.assertNotIn(briefing, UPROPERTY_MISSION08)
        leftover_m01 = (
            'UFUNCTION(BlueprintCallable, '
        ...
        self.assertNotEqual(leftover_m01, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m02, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_harbor, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m03, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m04, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m05, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m06, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_waves, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m05_waves, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_integration, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m07_ready, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m08_waves, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m08_hoist, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m08_safety, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m08_protection, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m08_ready, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m09_ready, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m09_waves, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m10_safety, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m09_protection, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m09_performance, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_m09_objectives, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_payload, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_targets, UPROPERTY_MISSION08)
        self.assertNotEqual(leftover_objectives, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m01, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m02, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_harbor, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m03, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m04, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m05, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m06, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m05_waves, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_integration, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m07_ready, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m08_waves, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m08_hoist, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m08_safety, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m08_protection, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m08_ready, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m09_ready, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m09_waves, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m10_safety, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m09_protection, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m09_performance, UPROPERTY_MISSION08)
        self.assertNotIn(leftover_m09_objectives, UPROPERTY_MISSION08)
        self.assertNotIn("Mission01", UPROPERTY_MISSION08)
        self.assertNotIn("Mission02", UPROPERTY_MISSION08)
        self.assertNotIn("Mission03", UPROPERTY_MISSION08)
        self.assertNotIn("Mission04", UPROPERTY_MISSION08)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("MinimumWeaponSeparationMeters", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("float MinimumWeaponSeparationMeters"))
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        # Leftover LastFlight MinimumCivilianSeparationMeters = 550.f
        # is Harbor-adjacent, not Harbor 40/80, and is not locked.
        self.assertNotIn("550.f", LOCKED_DECL)
        self.assertNotIn("MinimumCivilianSeparationMeters", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("MinimumWeaponSeparationMeters", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 MinimumWeaponSeparationMeters field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 MinimumWeaponSeparationMeters field contains "
    ...
    def test_contract_is_minimum_weapon_separation_meters_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_minimum_weapon_separation_meters(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_contract_does_not_relock_leftover_handle_boss_phase_changed(
        ...
        for token in LEFTOVER_HANDLE_BOSS_PHASE_CHANGED_NOT_LOCKED:
            ...
            self.assertNotIn(token, LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", UPROPERTY_MISSION08)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission08_minimum_weapon_separation_meters_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_minimum_weapon_separation_meters_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_airfield_target_runtime_does_not_satisfy_minimum_weapon_separation_meters(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_does_not_satisfy_minimum_weapon_separation_meters(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_search_track_runtime_does_not_satisfy_minimum_weapon_separation_meters(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_protected_target_runtime_does_not_satisfy_minimum_weapon_separation_meters(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_leftover_mission08_sibling_campaign_fields_stay_locked(
        ...
        self.assertNotIn("MaximumProtectedTargetIntegrity", LOCKED_DECL)

    def test_leftover_mission08_campaign_save_user_index_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            f"class SKYGUARD52_API {CLASS_NAME} "
        ...
        for token in LEFTOVER_MISSION08_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED:
            self.assertNotIn(token, LOCKED_DECL)

    def test_leftover_mission08_required_covered_seconds_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            f"class SKYGUARD52_API {CLASS_NAME} "
            ...
            'Category="Skyguard|Mission08|Hoist", '
            'meta=(ClampMin="0.1"))\n'
            f"\t{REQUIRED_COVERED_SECONDS_FIELD}\n"
            "};\n"
        )
        section = public_section(leftover)
        with self.assertRaises(AssertionError) as raised:
        ...
        for token in LEFTOVER_MISSION08_REQUIRED_COVERED_SECONDS_NOT_LOCKED:
            self.assertNotIn(token, LOCKED_DECL)

    def test_leftover_mission08_lifeline_hunter_spawn_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            f"class SKYGUARD52_API {CLASS_NAME} "
            ...
            "{\n"
            "public:\n"
            f"\t{LIFELINE_HUNTER_SPAWN_LOCATION}\n"
            f"\t{LIFELINE_HUNTER_SPAWN_ROTATION}\n"
            "};\n"
        )
        section = public_section(leftover)
        with self.assertRaises(AssertionError) as raised:
        ...
        for token in LEFTOVER_MISSION08_LIFELINE_HUNTER_SPAWN_NOT_LOCKED:
            self.assertNotIn(token, LOCKED_DECL)

    def test_leftover_mission10_minimum_weapon_separation_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission10IntegrationDirector "
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission10_minimum_weapon_separation_meters"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        for token in LEFTOVER_MISSION10_MINIMUM_WEAPON_SEPARATION_NOT_LOCKED:
            self.assertNotIn(token, LOCKED_DECL)
