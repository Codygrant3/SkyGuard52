...
# merge #665 #666 #668-#673, or open drafts #674-#1138.
...
# drafts #674-#1138 including leftover Mission02
...
# drafts #674-#1138. Do not reopen leftover
...
class Mission06AirfieldTargetRuntimeIntegrityFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_airfield_target_runtime_integrity"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
