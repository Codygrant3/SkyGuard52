...
# Mission05 bAutoInitialize FIELD
...
# NOT leftover Mission04 bAutoInitialize field
# #915 / branch cursor/mission04-auto-initialize-
...
# drafts #674-#950 including leftover Mission04
# RadioChatter #912, SortiePresentation #913,
# AudioDirector #911, Briefing #910, leftover
# Mission04 bAutoInitialize #915, leftover Apache
...
# #669 #670 #671 #672 #673. Do not reopen leftover
...
# Lock leftover Mission01 / Mission02 / Mission03 /
# Mission04 / Mission10 same-name Readiness drafts
# and leftover Mission02 / Mission03 / Mission04 /
# Mission10 same-name director bAutoInitialize
# field drafts. Do not reopen open
# drafts #674-#950.
...
# Mission10 same-name director bAutoInitialize
# field contracts, leftover Mission01 / Mission02 /
# Mission03 / Mission04 / Mission10 same-name
# Readiness field drafts, leftover
...
class Mission05AutoInitializeFieldDeclContractTests(unittest.TestCase):
    ...
    def test_readiness_or_storm_struct_does_not_satisfy_director_lock(
        self,
    ) -> None:
        leftover_structs = (
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bAutoInitialize = true;", locked_only)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_auto_initialize_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission02_readiness"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission03_readiness"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission04_readiness"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_readiness"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_protected_target"
            "_runtime_defaults_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
