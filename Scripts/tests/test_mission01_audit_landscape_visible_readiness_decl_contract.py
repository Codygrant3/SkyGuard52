# THIS IS leftover-safe USkyguardMission01EnvironmentAuthoringLibrary
# AuditLandscapeVisibleReadiness.
# origin/main form: split-line BlueprintCallable wrap
# UFUNCTION(BlueprintCallable, Category="Skyguard|Mission01|Environment|Validation")
# then static struct-return
...
# Comment on origin/main: "Read-only live render-readiness audit."
# THIS IS leftover-safe unique analog library UFUNCTION wrapping unused
# Category path Skyguard|Mission01|Environment|Validation.
# Leftover unique LandscapeVisibleAudit FIELD drafts (#1199-#1213
# including bSuccess #1199) wrap struct members with NO Category and
# explicitly do NOT parse this library
# (`Do NOT parse USkyguardMission01EnvironmentAuthoringLibrary`).
# Identifier AuditLandscapeVisibleReadiness is NOT leftover analog
# VisibleAudit field bSuccess / LandscapeComponentCount and NOT leftover
# unique SampleLandscapeHeight and NOT leftover unique Authoring
# AuditGovernedLandscapeAndGraph.
# Category IS `Skyguard|Mission01|Environment|Validation`.
# BlueprintCallable IS present. BlueprintPure IS absent. const IS absent.
# static IS present. method const IS absent.
# Return type IS FSkyguardLandscapeVisibleAudit.
# Args are ALandscape* Landscape, UMaterialInterface* GovernedMaterial
# (NOT Director-only / HeightmapSourcePath / GraphPackagePath).
...
# return type is not FSkyguardLandscapeVisibleAudit,
# if static is missing, or if Category is
...
# Category="Skyguard|Mission01|Environment" without |Validation /
# Category="Skyguard|Mission01|Environment|Authoring" /
# |Grounding / |Landscape / |PCG / |Layout / |Materials /
# |Visibility / bare Environment / Theater / MissionMap.
# Accept one-line and split-line UFUNCTION wraps.
# Compact whitespace when matching.
# Parse CLASS `USkyguardMission01EnvironmentAuthoringLibrary` public
# section ONLY after `class USkyguardMission01EnvironmentAuthoringLibrary`
# / GENERATED_BODY. Start at `public:`. Stop BEFORE `private:`.
# Do NOT parse struct `FSkyguardLandscapeVisibleAudit`
# (leftover unique FIELD drafts #1199-#1213). Do NOT parse
# AuthoringResult / MaterialCompilation / CaptureConfiguration structs.
# Do NOT parse `ASkyguardMission01EnvironmentDirector`.
# Do NOT claim siblings GetActiveRHIAndFeatureLevel /
...
# Do NOT claim leftover unique Authoring UFUNCTIONs
# AuthorGovernedLandscapeAndGraph /
# AuthorGovernedLandscapeWithExistingGraph /
# AuditGovernedLandscapeAndGraph.
# Do NOT claim leftover unique Grounding SampleLandscapeHeight /
# SampleLandscapeFootprint.
# Clone leftover unique Authoring UFUNCTION
# AuditGovernedLandscapeAndGraph — RETARGET Category Authoring ->
# Validation. KEEP BlueprintCallable (NOT BlueprintPure).
# RETARGET return FSkyguardMission01EnvironmentAuthoringResult ->
# FSkyguardLandscapeVisibleAudit. RETARGET method
# AuditGovernedLandscapeAndGraph -> AuditLandscapeVisibleReadiness.
# RETARGET args Director-only -> ALandscape* Landscape,
# UMaterialInterface* GovernedMaterial.
# Also clone AuthorGovernedLandscapeAndGraph RETARGET similarly.
# Clone leftover unique BlueprintCallable EnsureDefaultEntries
# Category Production — RETARGET Production -> Validation.
# KEEP BlueprintCallable. LOCKED_DECL is NOT
# `void EnsureDefaultEntries();`.
# Clone leftover unique BlueprintPure GetSortieHits Category
# Skyguard|Combat|Sortie — RETARGET Category Combat|Sortie ->
# Skyguard|Mission01|Environment|Validation. KEEP BlueprintCallable
# (NOT BlueprintPure). LOCKED_DECL is NOT `int32 GetSortieHits() const;`.
# Clone #1300 is Category Theater wrapping FName
# WeatherIdentity with no initializer — RETARGET hard.
# LOCKED_DECL is static struct-return AuditLandscapeVisibleReadiness
# with ALandscape* Landscape, UMaterialInterface* GovernedMaterial
# NOT `FName WeatherIdentity;` and NOT GetLampInstanceCount
# and NOT AreResolvedProductionLoopRoutesComplete and NOT
# InitializeRequiredEntries and NOT GetResolvedProductionLoopRouteCount
# and NOT GlobalVoiceLimit = 24 and NOT OpenCockpitWindLoop and NOT
# EngineIdleLoop and NOT IsDestroyed leftover analog and NOT
# FireRate = 12.0f / RecoilPitch = 0.92f and NOT leftover Boom
# and NOT leftover VegetationStartCullDistanceCm
# and NOT TObjectPtr ProductionBank
# and NOT int32 GetSortieHits() const;
# and NOT void ResetSortieCombatStats();
# and NOT bool GetInvertVerticalLook() const;
# and NOT float GetAppliedLookSensitivity() const;
# and NOT bool bSuccess = false;
# and NOT AuditGovernedLandscapeAndGraph
# and NOT AuthorGovernedLandscapeAndGraph
# and NOT AuthorGovernedLandscapeWithExistingGraph
# and NOT SampleLandscapeHeight / SampleLandscapeFootprint
# and NOT GetActiveRHIAndFeatureLevel
# and NOT PrepareGovernedLandscapeForVisibleValidation
# and NOT FinishLandscapeMaterialCompilation
# and NOT AuditLandscapeMaterialCompilation
# and NOT BeginTransientLandscapeDiagnosticMaterialDeferred
# and NOT ConfigureLandscapeSceneCaptureDiagnostic
# and NOT SetTransientLandscapeDiagnosticMaterial
# and NOT SetTransientLandscapeDiagnosticMaterialSynchronized
# and NOT float RouteLengthCm = 45000.f
# and NOT float Health = 160.f
# and NOT void EnsureDefaultEntries();
# and NOT `160.f`.
...
# GlobalVoiceLimit = 24 / OpenCockpitWindLoop /
# EngineIdleLoop / IsDestroyed leftover analog /
# FireRate = 12.0f / RecoilPitch = 0.92f / leftover Boom /
# leftover VegetationStartCullDistanceCm /
# TObjectPtr ProductionBank / GetSortieHits /
# ResetSortieCombatStats / GetInvertVerticalLook /
# GetAppliedLookSensitivity / bSuccess = false /
# AuditGovernedLandscapeAndGraph /
# AuthorGovernedLandscapeAndGraph /
# AuthorGovernedLandscapeWithExistingGraph /
# SampleLandscapeHeight / SampleLandscapeFootprint /
...
CLASS_NAME = "USkyguardMission01EnvironmentAuthoringLibrary"
LEFTOVER_AUDIO_DIRECTOR_CLASS = "USkyguardAudioDirectorComponent"
TARGET = "static FSkyguardLandscapeVisibleAudit AuditLandscapeVisibleReadiness(ALandscape* Landscape, UMaterialInterface* GovernedMaterial);"
TARGET_INLINE = (
...
TARGET_WRONG_BARE = (
    ...
    "AuditLandscapeVisibleReadiness("
    "ALandscape* Landscape, "
    "UMaterialInterface* GovernedMaterial) const;"
)
TARGET_WRONG_NO_CONST = (
    "bool AuditLandscapeVisibleReadiness();"
)
TARGET_WRONG_VOID = "bool AreResolvedProductionLoopRoutesComplete() const;"
TARGET_WRONG_FLOAT = "float AuditLandscapeVisibleReadiness();"
TARGET_WRONG_INT = "int32 AuditLandscapeVisibleReadiness();"
TARGET_WRONG_RENAME = "void EnsureDefaultEntry();"
...
TARGET_WRONG_TRUE = "bool AuditLandscapeVisibleReadiness = true;"
TARGET_WRONG_ZERO = "bool AuditLandscapeVisibleReadiness = 0.f;"
...
THIS_SCRIPT = (
    "Scripts/tests/test_mission01_audit_landscape_visible_readiness"
    "_decl_contract.py"
)
...
def leftover_analog_extra_scripts() -> tuple[str, ...]:
    ...
    return (
        ...
        "_decl_contract.py",
        "Scripts/tests/test_gunner_get_sortie_hits_decl_contract.py",
        "Scripts/tests/test_gunner_reset_sortie_combat_stats"
        "_decl_contract.py",
        "Scripts/tests/test_mission01_sample_landscape_height"
        "_decl_contract.py",
        "Scripts/tests/test_mission01_sample_landscape_footprint"
        "_decl_contract.py",
        "Scripts/tests/test_mission01_environment_authoring_result_success"
        "_field_decl_contract.py",
        "Scripts/tests/test_mission01_environment_authoring_result_landscape"
        "_field_decl_contract.py",
        "Scripts/tests/test_mission01_environment_authoring_result_graph"
        "_field_decl_contract.py",
...
METHOD_SIGNATURE_RE = re.compile(
    r"\bstatic\s+FSkyguardLandscapeVisibleAudit\s+"
    r"AuditLandscapeVisibleReadiness\s*\(\s*"
    r"ALandscape\s*\*\s*Landscape\s*,\s*"
    r"UMaterialInterface\s*\*\s*GovernedMaterial\s*\)\s*"
    r"(?:;|\{)"
)
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # static FSkyguardLandscapeVisibleAudit
    # AuditLandscapeVisibleReadiness(Landscape, GovernedMaterial).
    # Accept origin/main trailing-semicolon form and an
    # inline body without locking the body. Do not accept a
    # const qualifier, a void/bool/float/int32 rename, extra
    # HeightmapSourcePath / GraphPackagePath params,
    ...
    # VegetationStartCullDistanceCm, leftover GetSortieHits /
    # ResetSortieCombatStats, leftover
    # AuthorGovernedLandscapeAndGraph /
    # SampleLandscapeHeight, leftover bSuccess = false,
    # or Harbor 40 / 80.
    del declaration
    ...
    if METHOD_SIGNATURE_RE.search(compact) is None:
        return False
    if re.search(
        r"\bAuditLandscapeVisibleReadiness\s*\([^)]*\)\s*const\b",
        compact,
    ):
        return False
    if re.search(r"\bvoid\s+AuditLandscapeVisibleReadiness\b", compact):
        return False
    if re.search(r"\bbool\s+AuditLandscapeVisibleReadiness\b", compact):
        return False
    if re.search(r"\bfloat\s+AuditLandscapeVisibleReadiness\b", compact):
        return False
    if re.search(r"\bint32\s+AuditLandscapeVisibleReadiness\b", compact):
        return False
    if re.search(
        r"\bAuditLandscapeVisibleReadiness\s*\(\s*\)",
        compact,
    ):
        return False
    if re.search(
        r"\bAuditLandscapeVisibleReadiness\s*\((?:(?!\)).)*"
        r"ASkyguardMission01EnvironmentDirector",
        compact,
    ):
        return False
    if re.search(
        r"\bAuditLandscapeVisibleReadiness\s*\((?:(?!\)).)*HeightmapSourcePath",
        compact,
    ):
        return False
    if re.search(
        r"\bAuditLandscapeVisibleReadiness\s*\((?:(?!\)).)*GraphPackagePath",
        compact,
    ):
        return False
    if re.search(
        r"\bAuditLandscapeVisibleReadiness\s*\((?:(?!\)).)*"
        r"ExpectedParentMaterial",
        compact,
    ):
        return False
...
def attached_ufunction_specifiers(section: str) -> str:
    ...
    while True:
        ...
        if depth == 0 and re.match(
            r"\s*static\s+FSkyguardLandscapeVisibleAudit\s+"
            r"AuditLandscapeVisibleReadiness\b",
            compact[index:],
        ):
            return compact[start : index - 1]
        cursor = cursor + match.start() + 1
    raise AssertionError(
        "UFUNCTION for static FSkyguardLandscapeVisibleAudit "
...
class Mission01AuditLandscapeVisibleReadinessDeclContractTests(
    unittest.TestCase
):
    def test_mission01_environment_authoring_library_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_identifier(section, "AuditLandscapeVisibleReadiness"),
            section,
        )
        self.assertIn("Read-only live render-readiness audit.", section)
        self.assertIn("UFUNCTION", section)
        self.assertIn(STOP_BEFORE_PUBLIC, header)
        self.assertNotIn(STOP_BEFORE_PRIVATE, section)
        self.assertTrue(has_identifier(body, "GENERATED_BODY"), body)
        self.assertFalse(has_identifier(section, "GENERATED_BODY"), section)
        self.assertIn(
        ...
        self.assertTrue(
            has_identifier(body, "AuthorGovernedLandscapeAndGraph"),
            body,
        )
        self.assertFalse(
            has_identifier(LOCKED_DECL, "AuthorGovernedLandscapeAndGraph"),
        )
        self.assertFalse(
            has_identifier(LOCKED_DECL, "AuthorGovernedLandscapeWithExistingGraph"),
        )
        self.assertNotEqual(CLASS_NAME, "ASkyguardMission01EnvironmentDirector")
        self.assertNotEqual(
            CLASS_NAME,
        ...
        self.assertFalse(has_identifier(section, "HasValidSha256"), section)
    ...
    def test_missing_ensure_default_entries_declaration_fails_closed(
        self,
    ) -> None:
        empty = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn('Category="Skyguard|Mission01|Environment|Validation"', section)
        ...
        self.assertIn('Category="Skyguard|Mission01|Environment|Validation"', specifiers)
        self.assertNotIn("BlueprintPure", specifiers)
        self.assertNotIn("|Authoring", specifiers)
        self.assertNotIn("|Grounding", specifiers)
        self.assertNotIn("GetSortieHits", specifiers)
        self.assertNotIn("ResetSortieCombatStats", specifiers)
        ...
        self.assertTrue("|Validation" in specifiers)
        self.assertNotEqual(
            specifiers,
    ...
    def test_missing_or_wrong_signature_fails_closed(self) -> None:
        ...
        self.assertNotIn(
            "AuditLandscapeVisibleReadiness()const;",
    ...
    def test_ensure_default_entries_declaration_matches_origin_main(
        self,
    ) -> None:
        section = spec_section(origin_main_header())
        self.assertEqual(
        ...
        self.assertIn("static ", LOCKED_DECL)
        self.assertIn(
    ...
    def test_locked_decl_is_not_leftover_clone_weather_identity(self) -> None:
        self.assertEqual(
            LOCKED_DECL,
            "static FSkyguardLandscapeVisibleAudit AuditLandscapeVisibleReadiness(ALandscape* Landscape, UMaterialInterface* GovernedMaterial);",
        )
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_LOOK_YAW)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_MISSION_ID)
        ...
        self.assertNotIn("AuthorGovernedLandscapeWithExistingGraph", LOCKED_DECL)
        self.assertNotIn("SampleLandscapeHeight", LOCKED_DECL)
        self.assertNotIn("SampleLandscapeFootprint", LOCKED_DECL)
        self.assertNotIn("GetActiveRHIAndFeatureLevel", LOCKED_DECL)
        self.assertNotIn("AuditGovernedLandscapeAndGraph", LOCKED_DECL)
        self.assertNotIn("AuditLandscapeMaterialCompilation", LOCKED_DECL)
        self.assertNotIn("PrepareGovernedLandscapeForVisibleValidation", LOCKED_DECL)
        self.assertNotIn("FinishLandscapeMaterialCompilation", LOCKED_DECL)
        self.assertNotIn("BeginTransientLandscapeDiagnosticMaterialDeferred", LOCKED_DECL)
        self.assertNotIn("ConfigureLandscapeSceneCaptureDiagnostic", LOCKED_DECL)
        self.assertNotIn("SetTransientLandscapeDiagnosticMaterial", LOCKED_DECL)
        self.assertNotIn("SetTransientLandscapeDiagnosticMaterialSynchronized", LOCKED_DECL)
        ...
        self.assertNotIn("HeightmapSourcePath", LOCKED_DECL)
        self.assertNotIn("GraphPackagePath", LOCKED_DECL)
        self.assertNotIn("RouteLengthCm", LOCKED_DECL)
        self.assertNotIn("ASkyguardMission01EnvironmentDirector", LOCKED_DECL)
        self.assertNotIn("Director", LOCKED_DECL)
        self.assertIn("ALandscape", LOCKED_DECL)
        self.assertIn("UMaterialInterface", LOCKED_DECL)
        self.assertIn("GovernedMaterial", LOCKED_DECL)
        ...
        self.assertNotEqual(LOCKED_DECL, "bool bSuccess = false;")
        self.assertNotEqual(LOCKED_DECL, "void EnsureDefaultEntries();")
        self.assertNotEqual(LOCKED_DECL, "FName WeatherIdentity;")
        self.assertNotEqual(LOCKED_DECL, "float Health = 160.f;")
    ...
    def test_wrong_default_and_renames_do_not_satisfy(self) -> None:
        ...
        wrongs = (
            ...
            leftover_primary,
            leftover_guided,
            "\tvoid AuditLandscapeVisibleReadinesss();\n",
            "\tint32 AuditLandscapeVisibleReadiness = 1;\n",
            "\tFName AuditLandscapeVisibleReadiness = NAME_None;\n",
            "\tvoid AuditLandscapeVisibleReadiness() = "
            + forty
            + ";\n",
            "\tvoid AuditLandscapeVisibleReadiness() = "
            + eighty
            ...
            "\tstatic FSkyguardLandscapeFootprintSampleResult "
            "SampleLandscapeFootprint(\n"
            "\t\tALandscapeProxy* Landscape,\n"
    ...
    def test_missing_category_or_blueprint_callable_fails_closed(self) -> None:
        ...
        self.assertIn('Category="Skyguard|Mission01|Environment|Validation"', origin)
        ...
        self.assertNotIn('Skyguard|Combat', origin)
        self.assertNotIn('|Authoring', origin)
        self.assertNotIn('|Grounding', origin)
        self.assertNotIn('|Landscape', origin)
        self.assertNotIn('|PCG', origin)
        self.assertNotIn('|Layout', origin)
        self.assertNotIn('|Materials', origin)
        self.assertNotIn('|Visibility', origin)
        self.assertNotIn('Category="Settings"', origin)
        self.assertNotIn('Skyguard|Boss|Encounter', origin)
        self.assertIsNone(
            re.search(
                r'Category="Skyguard\|Mission01\|Environment"(?!\|)',
                origin,
            )
        )
        ...
        environment_specs = attached_ufunction_specifiers(
            spec_section(leftover_environment)
        )
        self.assertIn(
            'Category="Skyguard|Mission01|Environment"',
            environment_specs,
        ...
        leftover_grounding = (
            ...
            'Category="Skyguard|Mission01|Environment|Grounding")\n'
            f"\t{LOCKED_DECL}\n"
            f"{STOP_BEFORE_PRIVATE}\n"
            "};\n"
        )
        ...
        combat_sortie_specs = attached_ufunction_specifiers(
            spec_section(leftover_combat_sortie)
        )
        self.assertIn(
            'Category="Skyguard|Combat|Sortie"',
            combat_sortie_specs,
        ...
        visibility_specs = attached_ufunction_specifiers(
            spec_section(leftover_visibility)
        )
        self.assertIn(
            'Category="Skyguard|Mission01|Environment|Visibility"',
            visibility_specs,
    ...
    def test_does_not_claim_sibling_initialize_required_entries_or_neighbors(
        self,
    ) -> None:
        for sibling in sibling_uncontracted_decls():
            self.assertFalse(has_identifier(LOCKED_DECL, sibling), sibling)
        ...
        self.assertTrue(
            has_identifier(leaked, "AuthorGovernedLandscapeAndGraph")
        )
        self.assertFalse(
            has_identifier(LOCKED_DECL, "AuthorGovernedLandscapeAndGraph")
        )
        ...
        self.assertTrue(has_identifier(leaked, "GENERATED_BODY"))
        self.assertFalse(has_identifier(section, "GENERATED_BODY"))
    ...
    def test_does_not_parse_private_or_neighbors(self) -> None:
        ...
        self.assertNotIn(STOP_BEFORE_PRIVATE, section)
        self.assertTrue(
            has_identifier(leaked, "AuditLandscapeVisibleReadiness")
        )
        self.assertTrue(
            has_identifier(section, "AuditLandscapeVisibleReadiness")
        )
        ...
        self.assertTrue(has_identifier(leaked, "GENERATED_BODY"))
        self.assertFalse(has_identifier(section, "GENERATED_BODY"))
        self.assertFalse(has_identifier(section, "HasValidSha256"))
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertIn("SkyguardMission01EnvironmentAuthoringLibrary.h", HEADER_PATH)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 audit landscape visible readiness "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(Path(__file__).name.endswith(
            "mission01_audit_landscape_visible_readiness"
            "_decl_contract.py"
        ))
        self.assertNotIn("SkyguardMission01EnvironmentAuthoringLibrary.cpp", THIS_SCRIPT)
    ...
    def test_contract_is_target_method_declaration_only(self) -> None:
        ...
        self.assertNotIn("AuthorGovernedLandscapeAndGraph", locked_only)
        self.assertNotIn("AuthorGovernedLandscapeWithExistingGraph", locked_only)
        self.assertNotIn("SampleLandscapeHeight", locked_only)
        self.assertNotIn("SampleLandscapeFootprint", locked_only)
        self.assertNotIn("GetActiveRHIAndFeatureLevel", locked_only)
        self.assertNotIn("AuditGovernedLandscapeAndGraph", locked_only)
        self.assertNotIn("AuditLandscapeMaterialCompilation", locked_only)
        self.assertNotIn("PrepareGovernedLandscapeForVisibleValidation", locked_only)
        self.assertNotIn("FinishLandscapeMaterialCompilation", locked_only)
        self.assertNotIn("BeginTransientLandscapeDiagnosticMaterialDeferred", locked_only)
        self.assertNotIn("ConfigureLandscapeSceneCaptureDiagnostic", locked_only)
        self.assertNotIn("SetTransientLandscapeDiagnosticMaterial", locked_only)
        self.assertNotIn("SetTransientLandscapeDiagnosticMaterialSynchronized", locked_only)
        self.assertNotIn("EnsureDefaultEntries", locked_only)
        self.assertNotIn("GetSortieHits", locked_only)
        self.assertNotIn("ResetSortieCombatStats", locked_only)
        self.assertNotIn("GetInvertVerticalLook", locked_only)
        self.assertNotIn("GetAppliedLookSensitivity", locked_only)
        self.assertNotIn("bSuccess", locked_only)
        self.assertNotIn("HeightmapSourcePath", locked_only)
        self.assertNotIn("GraphPackagePath", locked_only)
        self.assertNotIn("RouteLengthCm", locked_only)
        self.assertNotIn("ASkyguardMission01EnvironmentDirector", locked_only)
        self.assertNotIn("Director", locked_only)
        self.assertIn("ALandscape", locked_only)
        self.assertIn("UMaterialInterface", locked_only)
        self.assertIn("GovernedMaterial", locked_only)
