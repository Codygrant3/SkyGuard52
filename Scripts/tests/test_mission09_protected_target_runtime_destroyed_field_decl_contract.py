...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission09 ProtectedTargetRuntime
# bDestroyed. THIS IS NOT leftover Mission09 ProtectedTargetRuntime
...
# Mission09 ProtectedTargetRuntime bDestroyed
...
# is bDestroyed after Integrity. THIS IS NOT leftover Mission09
...
class Mission09ProtectedTargetRuntimeDestroyedFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 bDestroyed field contract "
