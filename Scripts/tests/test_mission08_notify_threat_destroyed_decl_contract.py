...
# Mission08 Waves NotifyThreatDestroyed
# on ASkyguardMission08IntegrationDirector. It is
# NOT leftover Mission07 NotifyThreatDestroyed
# #713, NOT leftover Mission05 NotifyThreatDestroyed
# #669, NOT leftover Mission03 / Mission04 /
# Mission06 NotifyThreatDestroyed, NOT leftover Mission08
...
# Category is Skyguard|Mission08|Waves, not
...
# Waves #669, not leftover Mission07 Waves #713,
...
# drafts #674–#728, leftover Apache
...
# NotifyThreatDestroyed #713. Do not reopen leftover
...
# Do not reopen open drafts #674–#728.
...
class Mission08NotifyThreatDestroyedDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission08|Waves", UFUNCTION_WAVES)
    ...
    def test_environment_category_does_not_satisfy_waves(self) -> None:
        ...
        self.assertNotEqual(leftover_m07_waves, UFUNCTION_WAVES)
        ...
        self.assertNotIn(leftover_m07_waves, UFUNCTION_WAVES)
        self.assertNotIn(leftover_hoist, UFUNCTION_WAVES)
        self.assertNotIn(leftover_safety, UFUNCTION_WAVES)
        self.assertNotIn("Mission01", UFUNCTION_WAVES)
        self.assertNotIn("Mission03", UFUNCTION_WAVES)
        self.assertNotIn("Mission04", UFUNCTION_WAVES)
        self.assertNotIn("Mission05", UFUNCTION_WAVES)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 NotifyThreatDestroyed method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission08 NotifyThreatDestroyed contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_notify_threat_destroyed"
                "_decl_contract.py"
            )
        )
        self.assertIn(
