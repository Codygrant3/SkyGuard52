...
# GraphNodeSettingClasses. THIS IS NOT leftover mission01-environment-authoring-result-defaults
# #df1a. THIS IS NOT leftover AuthoredPCGGraph #594. Distinct from sibling
# Graph (TObjectPtr) #1234, GraphNodeCount, and GraphEdgeCount.
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeSettingClasses FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly TArray<FString> GraphNodeSettingClasses; one-line / split-line
# UPROPERTY wraps; origin/main has NO Category and NO initializer).
...
# including leftover mission01-environment-authoring-result-defaults #df1a,
# leftover landscape-material-compilation-defaults #01d4, leftover
# director AuthoredPCGGraph #594, leftover AuthoringResult Landscape
# #1233 / Graph #1234 / bSuccess #1235 / VisibleAudit #1236, leftover MaterialCompilation
# through Error #1232. LOCK leftover-safe Success / Landscape / Graph / VisibleAudit /
# LandscapeComponentCount / GraphNodeCount / GraphEdgeCount field
# siblings; do not edit them. THIS IS NOT leftover Graph #1234.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeSettingClasses. THIS IS NOT leftover mission01-environment-authoring-
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeSettingClasses. THIS IS NOT leftover mission01-environment-authoring-result-
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeSettingClasses FIELD (declaration-only; VisibleAnywhere / BlueprintReadOnly
# TArray<FString> GraphNodeSettingClasses; one-line /
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeSettingClasses. THIS IS NOT leftover VisibleAudit
...
# DIFFERENT field).
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeSettingClasses FIELD (declaration-only;
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeSettingClasses. THIS IS NOT leftover VisibleAudit bSuccess #1199.
...
# TArray<FString> GraphNodeSettingClasses; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# BARE decl, NO initializer (NOT leftover
...
# Do NOT parse FSkyguardLandscapeVisibleAudit (leftover bSuccess #1199).
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeSettingClasses. THIS IS NOT leftover
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeSettingClasses FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly TArray<FString> GraphNodeSettingClasses; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# BlueprintReadOnly TArray<FString> GraphNodeSettingClasses;
...
TARGET = "TArray<FString> GraphNodeSettingClasses;"
TARGET_WRONG = "TArray<FString> GraphNodeSettingClasses = {};"
LOCKED_DECL = TARGET
...
def has_declaration(region: str, declaration: str) -> bool:
    # Fail-closed on the authored bare TArray. Do not accept an
    # initializer for
    # FSkyguardMission01EnvironmentAuthoringResult::GraphNodeSettingClasses
    # (must be bare TArray<FString> GraphNodeSettingClasses;).
    # THIS IS NOT leftover VisibleAudit bSuccess #1199.
    # THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*TArray\s*<\s*FString\s*>\s+GraphNodeSettingClasses\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for TArray<FString> GraphNodeSettingClasses is missing from "
...
class Mission01EnvironmentAuthoringResultGraphNodeSettingClassesFieldDeclContractTests(unittest.TestCase):
    def test_mission01_environment_authoring_result_struct_exists(self) -> None:
        ...
        self.assertIn("GraphEdgeCount", section)
        self.assertIn("GraphNodeSettingClasses", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("GraphNodeSettingClasses", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_graph_node_setting_classes_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_graph_node_setting_classes_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("TArray<FString> GraphNodeSettingClasses"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("GraphNodeSettingClasses", LOCKED_DECL)
        ...
        self.assertIn("TArray<FString>", LOCKED_DECL)
        ...
        self.assertNotIn("(", LOCKED_DECL)
        self.assertIn("TArray<", LOCKED_DECL)
        self.assertNotIn("ESkyguardMission05ProtectedTarget", LOCKED_DECL)
        self.assertTrue(
            LOCKED_DECL.startswith("TArray<FString> "),
            LOCKED_DECL,
        )
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("GraphNodeSettingClasses", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("TArray<FString> GraphNodeSettingClasses"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("GraphNodeSettingClasses", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_graph_node_setting_classes(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
