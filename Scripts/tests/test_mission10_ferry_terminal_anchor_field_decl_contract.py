...
# INDEX_NONE or lock FerryTerminalAnchor
# construction in the .cpp. This is leftover-safe
# Mission10 Evacuation FerryTerminalAnchor
...
# Root field sibling, NOT leftover Mission10
# HighwayConvoyAnchor / BusAAnchor / BusBAnchor /
# AmbulanceAAnchor (in-flight) / AmbulanceBAnchor
# (sibling refill) field siblings,
...
# drafts #674–#786+, leftover Apache
...
LOCKED_DECL = FERRY_TERMINAL_ANCHOR_FIELD
...
# an isolated Python FerryTerminalAnchor
...
class Mission10FerryTerminalAnchorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("FerryTerminalAnchor", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_ferry_terminal_anchor_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tUSceneComponent* FerryTerminalAnchor;\n"
        )
        as_const = (
    ...
    def test_ferry_terminal_anchor_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertIn("FerryTerminalAnchor", LOCKED_DECL)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 FerryTerminalAnchor field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission10 FerryTerminalAnchor contains "
    ...
    def test_contract_is_ferry_terminal_anchor_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_ferry_terminal_anchor(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_ferry_terminal_anchor"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
