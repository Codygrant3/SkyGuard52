...
# Mission03 MissionDefinition FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps) on
# ASkyguardMission03IntegrationDirector. Note
# EditAnywhere / BlueprintReadWrite /
# TSoftObjectPtr, not VisibleAnywhere /
# BlueprintReadOnly / TObjectPtr. It is
# NOT leftover Mission02 MissionDefinition field
# #851 / branch cursor/mission02-mission-definition-
# field-decl-contract-c332, NOT leftover Mission10
# MissionDefinition field #799 / branch
# cursor/mission10-mission-definition-field-decl-
# contract-c332, NOT leftover Mission10
# bMissionDefinitionValid #810, NOT leftover
# Mission02 bMissionDefinitionValid #861, NOT leftover
# Mission03 CampaignDefinition sibling, NOT leftover
# Mission03 wave-state enum #0242, NOT leftover
# convoy-route-state enum #d34e, NOT leftover
...
# Blueprint category. NOT leftover Mission02
# UFUNCTION siblings #828-#844, NOT leftover
# Mission02 Root #845 / Briefing #846 /
# AudioDirector #847 / RadioChatter /
# SortiePresentation / CampaignDefinition field
# siblings. Distinct from leftover
# briefing-widget / MissionBriefingComponent
# methods.
# not leftover Briefing / AudioDirector /
# Root / RadioChatter / SortiePresentation /
# CampaignDefinition / Readiness /
...
# Category is Skyguard|Mission03, not leftover Mission02, not
...
# Integration, not leftover Mission01 / leftover Mission02 /
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission03IntegrationDirector::MissionDefinition",
    "SkyguardMission10IntegrationDirector.cpp",
...
class Mission03MissionDefinitionFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission03_mission_definition_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission03_mission_definition_field"
                "_decl_contract.py"
            )
        )
    ...
    def test_leftover_mission_definition_valid_does_not_satisfy(self) -> None:
        leftover = "\tbool bMissionDefinitionValid = false;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_leftover_same_name_mission_definition_scripts_stay_sibling_only(
        self,
    ) -> None:
        for stem in (
            ...
            self.assertIn(f"Scripts/tests/{stem}", LOCKED_SCRIPTS)
            self.assertNotIn(stem, LOCKED_DECL)


    def test_readiness_struct_does_not_satisfy_mission_definition(self) -> None:
        leftover = (
    ...
    def test_leftover_mission02_mission_definition_does_not_satisfy(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_campaign_definition_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission02_mission_definition_valid"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
