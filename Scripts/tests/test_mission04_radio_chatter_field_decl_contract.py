...
# THIS IS NOT leftover Mission01 RadioChatter #576 / branch
# cursor/mission01-radio-chatter-field-decl-contract-c332.
# THIS IS NOT leftover Mission02 RadioChatter #848 / branch
# cursor/mission02-radio-chatter-field-decl-contract-c332.
# THIS IS NOT leftover Mission03 RadioChatter #879 / branch
# cursor/mission03-radio-chatter-field-decl-contract-c332.
# THIS IS NOT leftover Mission10 RadioChatter #796 / branch
# cursor/mission10-radio-chatter-field-decl-contract-c332.
# THIS IS NOT leftover Mission03 RadioLineCount #904 /
# leftover Mission02 RadioLineCount #874 / leftover
# radio-line-defaults #1dec.
# THIS IS NOT leftover radio-chatter-empty-fail-closed /
# leftover radio-chatter-empty-queue / leftover
# radio-chatter-empty-line.
...
class Mission04RadioChatterFieldDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_radio = f"\t{BRIEFING_FIELD}\n"
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 RadioChatter field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 RadioChatter field contains "
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tTObjectPtr<USkyguardRadioChatterComponent> RadioChatter = nullptr;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_radio_chatter_field"
                "_decl_contract.py"
            )
        )
        leftover_56_64 = (
