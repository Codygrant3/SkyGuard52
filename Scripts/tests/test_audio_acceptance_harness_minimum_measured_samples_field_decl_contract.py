# THIS IS leftover-safe USkyguardAudioAcceptanceHarness MinimumMeasuredSamples.
...
# then `int32 MinimumMeasuredSamples = 600;` (HAS initializer; HAS spaces around =).
# THIS IS leftover-safe isolated UPROPERTY with Category.
# Category IS `Skyguard|Audio|Acceptance`. EditAnywhere IS present.
# BlueprintReadWrite IS present. Default IS `= 600`.
# THIS IS leftover-safe unique harness THRESHOLD int32, not leftover
# FSkyguardAudibleAcceptanceReceipt.SampleCount #1436
# (`int32 SampleCount = 0;` BlueprintReadOnly, no Category).
# It is NOT leftover sibling MaximumAllowedVoices /
# MaximumAudioThreadMs / MaximumTruePeakDbTP as a claimed slot.
# It is NOT leftover analog audio-harness-fail-closed #116/#f96c
# C++ bulk (keep bulk in LOCKED_SCRIPTS).
# Do NOT claim leftover receipt SampleCount / PeakActiveVoices /
# MaximumAudioThreadMs / MaximumTruePeakDbTP as this slot.
# Do NOT claim leftover sibling MaximumAllowedVoices as this slot.
# Do NOT parse leftover analog audio-harness-fail-closed bulk,
# leftover analog audio-director *, leftover analog
# audio-production-bank-empty-fail-closed, leftover analog
# audible-acceptance-receipt fields #1435-#1446, leftover analog
# coastal unique actor UPROPERTY #1640-#1647, leftover analog
# Mission01 unique actor bools #1637-#1639, leftover analog
# MissionMap actor fields #1630-#1636, leftover analog gunner
# Boom #1629, leftover analog Apache TObjectPtr through EyeMount #1592.
...
# or stay Category="Skyguard" without |Audio|Acceptance.
# Accept one-line and split-line UPROPERTY wraps.
# Parse CLASS `USkyguardAudioAcceptanceHarness` public UPROPERTY
# fields ONLY after `class USkyguardAudioAcceptanceHarness`.
# Start at `public:` after GENERATED_BODY. Stop BEFORE `private:`.
# Stop BEFORE sibling MaximumAllowedVoices as a claimed slot.
...
# Clone #1647 wraps `int32 VegetationStartCullDistanceCm = 8000;`
# Category Skyguard|Environment|Performance ClampMin "1000"
# — RETARGET to `int32 MinimumMeasuredSamples = 600;`
# Category Skyguard|Audio|Acceptance ClampMin "60".
# Clone #1300 is Category Theater wrapping FName WeatherIdentity
# with NO initializer — RETARGET hard.
# LOCKED_DECL is `int32 MinimumMeasuredSamples = 600;` NOT
# leftover `int32 SampleCount = 0;` and NOT
# `int32 VegetationStartCullDistanceCm = 8000;` and NOT
# `FName WeatherIdentity;` / `FName AssemblyRevision` and NOT
# leftover analog `float FireRate = 12.0f` /
# `float RecoilPitch = 0.92f` and NOT
# `int32 PlacementSeed = 5201;` / `int32 EpicTreeBudget = 240;` /
# `float TraceRange = 32000.f;` / `float LookYawLimit = 95.f;`
# AS THE LOCKED DECL.
# Fail-closed if this test still asserts FName
# WeatherIdentity / Category="Skyguard|Theater" / 160.f
# / LookYawLimit = 95.f / FName AssemblyRevision /
# Mission01 bools / coastal TreeInstances / PlacementSeed /
# `int32 VegetationStartCullDistanceCm = 8000;` /
# `float TraceRange = 32000.f;` / `int32 SampleCount = 0;`
# AS THE LOCKED DECL.
# Fail-closed if locked wrap Category is Skyguard|Apache /
# Skyguard|Combat / Skyguard|Theater / Skyguard|MissionMap /
# Skyguard|Environment|Performance / Skyguard|Environment|Vegetation
# or still Category="Skyguard" without |Audio|Acceptance.
# Fail-closed if LOCKED_DECL is TObjectPtr / FName WeatherIdentity /
# leftover SampleCount / leftover MaximumAllowedVoices.
# Harbor leftover is only the split 40 / 80 float tokens.
# MinimumMeasuredSamples is 600 not Harbor 40 / 80.
...
CLASS_NAME = "USkyguardAudioAcceptanceHarness"
TARGET = "int32 MinimumMeasuredSamples = 600;"
TARGET_WRONG_BARE = "int32 MinimumMeasuredSamples;"
TARGET_WRONG_INIT = "int32 MinimumMeasuredSamples = nullptr;"
TARGET_WRONG_FALSE = "int32 MinimumMeasuredSamples = false;"
TARGET_WRONG_TRUE = "int32 MinimumMeasuredSamples = true;"
TARGET_WRONG_ZERO = "int32 MinimumMeasuredSamples = 0;"
TARGET_WRONG_SKELETAL = "TObjectPtr<USkeletalMeshComponent> MinimumMeasuredSamples;"
...
TARGET_WRONG_SCENE = "TObjectPtr<USceneComponent> MinimumMeasuredSamples;"
...
TARGET_WRONG_MESH = "TObjectPtr<UStaticMeshComponent> MinimumMeasuredSamples;"
...
TARGET_WRONG_SAMPLE_COUNT = "int32 SampleCount = 0;"
TARGET_WRONG_VOICES = "int32 MaximumAllowedVoices = 48;"
TARGET_WRONG_THREAD_MS = "float MaximumAudioThreadMs = 2.f;"
TARGET_WRONG_TRUE_PEAK = "float MaximumTruePeakDbTP = -1.f;"
TARGET_WRONG_PEAK_VOICES = "int32 PeakActiveVoices = 0;"
TARGET_WRONG_REVISION = "FName AssemblyRevision;"
TARGET_WRONG_MISSION01_BOOL = "bool bAllowAuthoredPCGGeneration = false;"
...
STOP_BEFORE_LOOK_PITCH_MIN = "MaximumAllowedVoices"
STOP_BEFORE_EPIC_SHRUB = "MaximumAllowedVoices"
...
SIBLING_LOOK_PITCH_MIN = "MaximumAllowedVoices"
SIBLING_MAX_VOICES = "MaximumAllowedVoices"
SIBLING_MAX_THREAD_MS = "MaximumAudioThreadMs"
SIBLING_MAX_TRUE_PEAK = "MaximumTruePeakDbTP"
SIBLING_SAMPLE_COUNT = "SampleCount"
SIBLING_PEAK_VOICES = "PeakActiveVoices"
SIBLING_RECEIPT = "Receipt"
...
LEFTOVER_RECEIPT_STRUCT = "FSkyguardAudibleAcceptanceReceipt"
THIS_SCRIPT = (
...
LEFTOVER_AUDIO_HARNESS_FAIL_CLOSED_TESTS = (
    "Scripts/tests/test_audio_harness_fail_closed_tests.py"
)
LEFTOVER_AUDIO_HARNESS_FAIL_CLOSED_CONTRACT = (
...
LEFTOVER_AUDIO_PRODUCTION_BANK_TESTS = (
    "Scripts/tests/test_audio_production_bank_empty_fail_closed_tests.py"
)
LEFTOVER_AUDIO_PRODUCTION_BANK_CONTRACT = (
    "Scripts/tests/test_audio_production_bank_empty_fail_closed_contract.py"
)
LEFTOVER_AUDIBLE_RECEIPT_SAMPLE_COUNT = (
    "Scripts/tests/test_audible_acceptance_receipt_sample_count"
    "_field_decl_contract.py"
)
LEFTOVER_AUDIBLE_RECEIPT_PEAK_VOICES = (
    "Scripts/tests/test_audible_acceptance_receipt_peak_active_voices"
    "_field_decl_contract.py"
)
LEFTOVER_AUDIBLE_RECEIPT_THREAD_MS = (
    "Scripts/tests/test_audible_acceptance_receipt_maximum_audio_thread_ms"
    "_field_decl_contract.py"
)
LEFTOVER_AUDIBLE_RECEIPT_TRUE_PEAK = (
    "Scripts/tests/test_audible_acceptance_receipt_maximum_true_peak_dbtp"
    "_field_decl_contract.py"
)
...
SAMPLE_COUNT_LEFTOVER_DECL_RE = re.compile(
    r"int32\s+SampleCount\s*=\s*0\s*;"
)
ASSEMBLY_REVISION_DECL_RE = re.compile(
    r"FName\s+AssemblyRevision\b"
)
TARGET_BARE_RE = re.compile(
    r"int32\s+MinimumMeasuredSamples\s*;"
)
TARGET_WRONG_INIT_RE = re.compile(
    r"int32\s+MinimumMeasuredSamples\s*="
)
...
END_CULL_LEFTOVER_DECL_RE = re.compile(
...
def sibling_uncontracted_decls() -> tuple[str, ...]:
    return (
        ...
        SIBLING_MAX_VOICES,
        SIBLING_MAX_THREAD_MS,
        SIBLING_MAX_TRUE_PEAK,
...
def has_declaration(region: str, declaration: str) -> bool:
    # Fail-closed on authored `int32 MinimumMeasuredSamples = 600;`.
    ...
    # leftover receipt SampleCount = 0, leftover coastal
    # VegetationStartCullDistanceCm = 8000, leftover sibling
    # MaximumAllowedVoices, leftover AssemblyRevision, leftover
    # TObjectPtr, or a bare MinimumMeasuredSamples without
    # the 600 initializer as the slot.
    if not has_one_declaration(region, declaration):
        return False
    compact = collapsed(region)
    if TARGET_DECL_RE.search(compact) is None:
        return False
    if TARGET_BARE_RE.search(compact):
        return False
    ...
    if START_CULL_LEFTOVER_DECL_RE.search(compact):
        return False
    if SAMPLE_COUNT_LEFTOVER_DECL_RE.search(compact):
        return False
    if ASSEMBLY_REVISION_DECL_RE.search(compact):
        return False
    if END_CULL_LEFTOVER_DECL_RE.search(compact):
        return False
...
def public_uproperty_fields(header: str) -> str:
    ...
    while True:
        ...
        if ident == STOP_BEFORE_LOOK_PITCH_MIN:
            break
        if ident != "MinimumMeasuredSamples":
            cursor = semi + 1
            continue
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    while True:
        ...
        if depth == 0 and re.match(
            r"\s*int32\s+MinimumMeasuredSamples\b",
            compact[index:],
        ):
            return compact[start : index - 1]
        cursor = cursor + match.start() + 1
    raise AssertionError(
        "UPROPERTY for int32 MinimumMeasuredSamples "
...
class AudioAcceptanceHarnessMinimumMeasuredSamplesFieldDeclContractTests(unittest.TestCase):
    def test_harness_class_exists(self) -> None:
        ...
        self.assertTrue(has_identifier(section, "MinimumMeasuredSamples"), section)
        ...
        self.assertTrue(has_identifier(body, SIBLING_MAX_THREAD_MS), body)
        self.assertFalse(has_identifier(section, SIBLING_CPG_EUFD_TEXT), section)
        self.assertTrue(has_identifier(body, SIBLING_MAX_TRUE_PEAK), body)
        self.assertFalse(
            has_identifier(section, SIBLING_CPG_MPD_RIGHT_TEXT),
            section,
        )
        self.assertTrue(has_identifier(body, SIBLING_RECEIPT), body)
        self.assertFalse(has_identifier(section, SIBLING_CPG_TEDAC_TEXT), section)
        self.assertTrue(has_identifier(header, SIBLING_SAMPLE_COUNT), header)
        self.assertFalse(has_identifier(section, SIBLING_SAMPLE_COUNT), section)
        self.assertFalse(has_identifier(section, SIBLING_FIRE_RATE), section)
        self.assertFalse(has_identifier(section, SIBLING_MAX_VOICES), section)
        self.assertFalse(has_identifier(section, SIBLING_RECOIL_PITCH), section)
        self.assertNotEqual(CLASS_NAME, LEFTOVER_RECEIPT_STRUCT)
        self.assertFalse(
        ...
        self.assertNotIn(LEFTOVER_RECEIPT_STRUCT, section)
    ...
    def test_leftover_class_same_identifier_does_not_satisfy(self) -> None:
        ...
        self.assertFalse(has_identifier(section, "MinimumMeasuredSamples"), section)
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, LOCKED_DECL)
        self.assertIn("MinimumMeasuredSamples", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_missing_minimum_measured_samples_declaration_fails_closed(self) -> None:
        empty = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "public:\n"
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn('Category="Skyguard|Audio|Acceptance"', section)
        self.assertNotIn('Category="Skyguard|Environment|Vegetation"', section)
        self.assertNotIn('Category="Skyguard|Environment|Performance"', section)
        ...
        self.assertIn('Category="Skyguard|Audio|Acceptance"', specifiers)
        self.assertNotIn('Category="Skyguard|Environment|Vegetation"', specifiers)
        self.assertNotIn('Category="Skyguard|Environment|Performance"', specifiers)
        ...
        self.assertIn('ClampMin="60"', specifiers)
    ...
    def test_bare_or_wrong_initializer_fails_closed(self) -> None:
        ...
        self.assertIn("int32 MinimumMeasuredSamples = 600;", compact_origin)
        self.assertNotIn("MinimumMeasuredSamples = 160", compact_origin)
        self.assertNotIn("int32 PlacementSeed = 5201;", compact_origin)
        self.assertNotIn("int32 EpicTreeBudget = 240;", compact_origin)
        self.assertNotIn("int32 MaximumAllowedVoices = 32000;", compact_origin)
        self.assertNotIn("int32 MaximumAllowedVoices = 48;", compact_origin)
        self.assertNotIn("int32 SampleCount = 0;", compact_origin)
    ...
    def test_minimum_measured_samples_declaration_matches_origin_main(self) -> None:
        section = spec_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 MinimumMeasuredSamples"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("=", LOCKED_DECL)
        self.assertIn("600", LOCKED_DECL)
    ...
    def test_locked_decl_is_not_leftover_clone_weather_identity(self) -> None:
        self.assertEqual(LOCKED_DECL, "int32 MinimumMeasuredSamples = 600;")
        self.assertNotEqual(LOCKED_DECL, "float LookYawLimit = 95.f;")
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_SAMPLE_COUNT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_START_CULL)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_VOICES)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_THREAD_MS)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_TRUE_PEAK)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_PEAK_VOICES)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_REVISION)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_MISSION01_BOOL)
    ...
    def test_wrong_default_and_renames_do_not_satisfy(self) -> None:
        ...
        wrongs = (
            ...
            leftover_primary,
            leftover_guided,
            "\tint32 MinimumMeasuredSampless = 600;\n",
            "\tfloat MinimumMeasuredSamples = 600.f;\n",
            "\tbool MinimumMeasuredSamples = true;\n",
            "\tint32 MinimumMeasuredSamples = " + forty + ";\n",
            "\tint32 MinimumMeasuredSamples = " + eighty + ";\n",
            f"\t{TARGET_WRONG_SEED}\n",
            f"\t{TARGET_WRONG_EPIC_TREE}\n",
            f"\t{TARGET_WRONG_END_CULL}\n",
            f"\t{TARGET_WRONG_START_CULL}\n",
            f"\t{TARGET_WRONG_SAMPLE_COUNT}\n",
            f"\t{TARGET_WRONG_VOICES}\n",
            f"\t{TARGET_WRONG_REVISION}\n",
            f"\t{TARGET_WRONG_MISSION01_BOOL}\n",
    ...
    def test_missing_category_or_edit_anywhere_fails_closed(self) -> None:
        ...
        self.assertIn('Category="Skyguard|Audio|Acceptance"', origin)
        self.assertNotIn('Category="Skyguard|Environment|Vegetation"', origin)
        self.assertNotIn('Category="Skyguard|Environment|Performance"', origin)
        ...
        self.assertNotIn('Category="Skyguard|Audio|Acceptance"', apache_specs)
        self.assertIn('Category="Skyguard|Apache"', apache_specs)
        theater = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
    ...
    def test_does_not_claim_sibling_maximum_allowed_voices_or_neighbors(self) -> None:
        for sibling in sibling_uncontracted_decls():
            self.assertFalse(has_identifier(LOCKED_DECL, sibling), sibling)
        for field in leftover_neighbor_hit_fields():
            self.assertNotIn(field, LOCKED_DECL)
        ...
        self.assertTrue(has_identifier(section, "MinimumMeasuredSamples"))
    ...
    def test_does_not_parse_private_or_neighbors(self) -> None:
        ...
        self.assertNotIn(STOP_BEFORE_PRIVATE, section)
        self.assertTrue(has_identifier(leaked, "MinimumMeasuredSamples"))
        self.assertTrue(has_identifier(section, "MinimumMeasuredSamples"))
        self.assertTrue(has_identifier(leaked, STOP_BEFORE_LOOK_PITCH_MIN))
        self.assertFalse(has_identifier(section, STOP_BEFORE_LOOK_PITCH_MIN))
        self.assertTrue(has_identifier(leaked, SIBLING_MAX_THREAD_MS))
        self.assertFalse(has_identifier(section, SIBLING_CPG_EUFD_TEXT))
        self.assertTrue(has_identifier(leaked, SIBLING_MAX_TRUE_PEAK))
        self.assertFalse(has_identifier(section, SIBLING_FIRE_RATE))
        self.assertTrue(has_identifier(leaked, SIBLING_RECEIPT))
        self.assertFalse(has_identifier(section, SIBLING_RECOIL_PITCH))
        self.assertFalse(has_identifier(section, SIBLING_SAMPLE_COUNT))
        self.assertFalse(has_identifier(section, SIBLING_MAX_VOICES))
    ...
    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        ...
        self.assertIn('ClampMin="60"', UPROPERTY_EDIT_READWRITE)
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertIn("SkyguardAudioAcceptanceHarness.h", HEADER_PATH)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "audio acceptance harness minimum-measured-samples field decl contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(Path(__file__).name.endswith(
            "audio_acceptance_harness_minimum_measured_samples_field_decl_contract.py"
        ))
        self.assertNotIn("SkyguardAudioAcceptanceHarness.cpp", THIS_SCRIPT)
        ...
        self.assertIn(LEFTOVER_AUDIO_HARNESS_FAIL_CLOSED_CONTRACT, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_AUDIO_PRODUCTION_BANK, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_AUDIBLE_RECEIPT_SAMPLE_COUNT, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_AUDIBLE_RECEIPT_PEAK_VOICES, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_AUDIBLE_RECEIPT_THREAD_MS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_AUDIBLE_RECEIPT_TRUE_PEAK, LOCKED_SCRIPTS)
    ...
    def test_contract_is_target_field_declaration_only(self) -> None:
        ...
        self.assertNotIn("SampleCount", locked_only)
        self.assertNotIn("PeakActiveVoices", locked_only)
        self.assertNotIn("MaximumAudioThreadMs", locked_only)
        self.assertNotIn("MaximumTruePeakDbTP", locked_only)
        ...
        self.assertNotIn(LEFTOVER_RECEIPT_STRUCT, locked_only)
        for leftover in leftover_apache_ufunction_tokens():
