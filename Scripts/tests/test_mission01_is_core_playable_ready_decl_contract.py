...
# MissionBriefingComponent methods. Distinct from
# leftover environment-readiness defaults #6b9d /
# #b931. Do not lock leftover HandleDroneCityImpact;
# it is not this method. Not leftover Briefing (#568)
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission01IntegrationDirector::IsCorePlayableReady",
    "SkyguardMission01IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission01IsCorePlayableReadyDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        extra_arg = "\tbool IsCorePlayableReady(int32 Amount) const;\n"
        extra_args = (
            "\tbool IsCorePlayableReady("
            "FName ObjectiveId, int32 Amount = 1) const;\n"
        )
        as_int = "\tint32 IsCorePlayableReady() const;\n"
        renamed = "\tbool IsPlayableReady() const;\n"
        short_name = "\tbool IsCoreReady() const;\n"
        getter = "\tbool GetCorePlayableReady() const;\n"
    ...
    def test_is_core_playable_ready_declaration_matches_origin_main(self) -> None:
        ...
        self.assertIn("IsCorePlayableReady()", IS_CORE_PLAYABLE_READY)
        self.assertTrue(
            IS_CORE_PLAYABLE_READY.endswith(" const;"),
            IS_CORE_PLAYABLE_READY,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 IsCorePlayableReady method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission01 IsCorePlayableReady contains "
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        self.assertNotIn("}", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("return ", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("return Other", IS_CORE_PLAYABLE_READY)
