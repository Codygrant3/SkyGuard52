...
# values, or lock a specific GetObjectiveRuntime body.
...
# This lane only adds an isolated Python GetObjectiveRuntime
# declaration contract. Do not add leftover
# SkyguardObjectiveRuntime.h as a file this lane edits.
# Stay off leftover objective-runtime fail-closed (#6845 /
# test_objective_runtime_*), leftover route-runtime
# fail-closed, GetRouteRuntime / GetActiveMission
# (in-flight siblings), TravelToNextMission (in-flight
# sibling), leftover CPG debrief #284/#195/#130/#8ccd,
...
# GetRouteRuntime / GetActiveMission are in-flight siblings.
...
# Leftover objective-runtime / route-runtime fail-closed
# tokens stay unlocked. Do not require them and do not
# treat leftover SkyguardObjectiveRuntime.h as this
# lane's edit surface.
...
# INDEX_NONE or lock a specific GetObjectiveRuntime body.
CPP_AND_INVENTED = (
    "INDEX_NONE",
    "NAME_None",
    "return nullptr",
    ...
    "return 0",
    "return -1",
    "USkyguardCampaignSubsystem::GetObjectiveRuntime",
    "SkyguardCampaignSubsystem.cpp",
)
SIBLING_TYPES = (
    "FSkyguardMission0NIntegrationReadiness",
...
class GetObjectiveRuntimeDeclContractTests(unittest.TestCase):
    def test_campaign_subsystem_class_exists(self) -> None:
        ...
        self.assertTrue(has_declaration(section, GET_OBJECTIVE_RUNTIME), section)
    ...
    def test_missing_get_objective_runtime_declaration_fails_closed(
        self,
    ) -> None:
        neighbors_only = (
    ...
    def test_neighbor_getters_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_getters, GET_OBJECTIVE_RUNTIME)
        self.assertIn("GetObjectiveRuntime", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_get_objective_runtime_declaration_matches_origin_main(
        self,
    ) -> None:
        ...
        self.assertEqual(declaration_count(section, GET_OBJECTIVE_RUNTIME), 1)
        self.assertTrue(
            GET_OBJECTIVE_RUNTIME.endswith("const"),
            GET_OBJECTIVE_RUNTIME,
        )
        self.assertTrue(
        ...
        self.assertIn("GetObjectiveRuntime() const", GET_OBJECTIVE_RUNTIME)
    ...
    def test_declaration_accepts_inline_body_form(self) -> None:
        ...
        self.assertTrue(
            has_declaration(INLINE_BODY_FORM, GET_OBJECTIVE_RUNTIME)
        )
        self.assertNotIn("{", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("return ObjectiveRuntime", GET_OBJECTIVE_RUNTIME)
        self.assertNotEqual(GET_OBJECTIVE_RUNTIME, INLINE_BODY_FORM)
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, GET_OBJECTIVE_RUNTIME), section)
    ...
    def test_declaration_does_not_require_inline_body(self) -> None:
        ...
        self.assertNotIn("return ObjectiveRuntime", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("return ", GET_OBJECTIVE_RUNTIME)
        semicolon_only = f"{GET_OBJECTIVE_RUNTIME};\n"
        self.assertEqual(
            require_declaration(semicolon_only, GET_OBJECTIVE_RUNTIME),
            GET_OBJECTIVE_RUNTIME,
        )
        self.assertNotIn(INLINE_BODY_FORM, GET_OBJECTIVE_RUNTIME)
    ...
    def test_contract_does_not_relock_configure_campaign(self) -> None:
        ...
        self.assertNotIn("ConfigureCampaign", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("ConfigureCampaign", locked_only)
        self.assertNotIn("USkyguardCampaignDefinition", GET_OBJECTIVE_RUNTIME)
    ...
    def test_contract_does_not_relock_can_start_mission(self) -> None:
        ...
        for neighbor in CAN_START_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("CanStartMission", GET_OBJECTIVE_RUNTIME)
    ...
    def test_contract_does_not_relock_start_mission(self) -> None:
        ...
        for neighbor in START_MISSION_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("StartMission", GET_OBJECTIVE_RUNTIME)
    ...
    def test_contract_does_not_relock_unlock_or_slot_helpers(self) -> None:
        ...
        for neighbor in UNLOCK_AND_SLOT_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("IsMissionUnlocked", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("IsValidCampaignSlotName", GET_OBJECTIVE_RUNTIME)
    ...
    def test_contract_does_not_relock_score_or_medal_tier(self) -> None:
        ...
        for neighbor in SCORE_AND_TIER_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("CalculateMissionScore", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("CalculateMedalTier", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("GetEarnedCampaignMedals", GET_OBJECTIVE_RUNTIME)
    ...
    def test_contract_does_not_relock_debrief_or_travel(self) -> None:
        ...
        for neighbor in DEBRIEF_TRAVEL_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("AcknowledgeDebrief", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("CanTravelToNextMission", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("GetNextMissionMapPackageName", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("TravelToNextMission", GET_OBJECTIVE_RUNTIME)
    ...
    def test_contract_does_not_relock_fill_result_combat_stats(self) -> None:
        ...
        for neighbor in FILL_COMBAT_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("FillResultCombatStats", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("ASkyguardGunner", GET_OBJECTIVE_RUNTIME)
    ...
    def test_contract_does_not_relock_get_route_or_active_mission(self) -> None:
        ...
        for neighbor in RUNTIME_NEIGHBORS_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("GetActiveMission", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("GetRouteRuntime", GET_OBJECTIVE_RUNTIME)
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertNotIn("return nullptr", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("return INDEX_NONE", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("INDEX_NONE", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("{", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("}", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("return ObjectiveRuntime", GET_OBJECTIVE_RUNTIME)
    ...
    def test_contract_does_not_require_rifle_or_igla(self) -> None:
        ...
        self.assertNotEqual(GET_OBJECTIVE_RUNTIME, "Rifle")
        self.assertNotEqual(GET_OBJECTIVE_RUNTIME, "Igla")
    ...
    def test_declaration_bans_igla_yak_rifle(self) -> None:
        ...
        for banned in BANNED:
            self.assertNotIn(
                banned,
                lowered,
                f"GetObjectiveRuntime contains {banned}; "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn("D:/Skyguard52", GET_OBJECTIVE_RUNTIME)

    def test_contract_is_get_objective_runtime_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
