...
# Mission04 CampaignDefinition FIELD
...
# drafts #674-#911 including leftover Mission03
...
class Mission04CampaignDefinitionFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_campaign_definition_field"
                "_decl_contract.py"
            )
        )
        leftover_56_64 = (
