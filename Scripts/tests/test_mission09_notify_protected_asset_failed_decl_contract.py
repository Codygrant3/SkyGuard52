...
# Mission09 Objectives NotifyProtectedAssetFailed
# METHOD on ASkyguardMission09IntegrationDirector. It is
# NOT leftover Mission08 NotifyProtectedAssetFailed
...
# leftover Mission07 protected-target-runtime
...
# BindCampaignRuntime / StartNextWave /
# BindRuntimeActors / StartPayloadWindow /
...
# Category is Skyguard|Mission09|Objectives, not
...
# Mission09 Integration / Protection / Performance /
# Waves. Stay off leftover drafts #56–#64, leftover Harbor
...
# drafts #674–#752+, leftover Apache
...
# leftover Mission08 NotifyProtectedTargetDamage
# #736 / Mission07 #711 / closed #673. Do not
# reopen leftover GetStormRainBeatKit without
# UFUNCTION. Do not reopen leftover Mission08
...
# defaults #ec79. Do not reopen open drafts
# #674–#752+.
...
# leftover Mission05 NotifyProtectedAssetFailed #682,
# leftover Mission04 NotifyProtectedAssetFailed #655,
# leftover Mission06 NotifyProtectedAssetFailed #694,
# leftover Mission07 NotifyProtectedAssetFailed #712,
# leftover Mission08 NotifyProtectedAssetFailed #737,
# leftover Mission01 NotifyProtectedAssetFailed #612,
# leftover Mission03 NotifyProtectedAssetFailed #634,
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission09IntegrationDirector::NotifyProtectedAssetFailed",
    "SkyguardMission08IntegrationDirector.cpp",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission09NotifyProtectedAssetFailedDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission09|Objectives", UFUNCTION_OBJECTIVES)
    ...
    def test_environment_category_does_not_satisfy_objectives(self) -> None:
        ...
        self.assertNotEqual(leftover_m09_integration, UFUNCTION_OBJECTIVES)
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertNotIn(
            "ASkyguardMission08IntegrationDirector::NotifyProtectedAssetFailed",
            section,
        )
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("{", NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 NotifyProtectedAssetFailed method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission09 NotifyProtectedAssetFailed contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_notify_protected_asset_failed"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission08_start_next_wave(
        ...
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        self.assertNotIn("StartNextWave", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn(START_NEXT_WAVE, locked_only)
        self.assertIn(
            "Scripts/tests/test_mission08_start_next_wave"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
