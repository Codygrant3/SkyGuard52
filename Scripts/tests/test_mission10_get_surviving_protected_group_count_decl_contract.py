...
# INDEX_NONE or lock GetSurvivingProtectedGroupCount
# construction in the .cpp. This is leftover-safe
# Mission10 Protection GetSurvivingProtectedGroupCount
# METHOD (declaration-only) on
# ASkyguardMission10IntegrationDirector. It is
# NOT leftover Mission09 GetSurvivingTargetCount
# #766 / branch cursor/mission09-get-surviving-
# target-count-decl-contract-c332, NOT leftover
# Mission08 GetSurvivingTargetCount #747, NOT
# leftover Mission07 GetSurvivingTargetCount
# #725, NOT leftover Mission06
# GetSurvivingTargetCount #703, NOT leftover
# Mission05 GetSurvivingTargetCount #674, NOT
# leftover Mission10 GetProtectedGroup METHOD,
# NOT leftover Mission10 GetRemainingThreatsInWave
# #779, NOT leftover
...
# GetProtectedGroup / GetProtectedTarget /
...
# leftover Mission09 GetSurvivingTargetCount #766,
...
# origin/main may be a bare semicolon declaration
# (`int32 GetSurvivingProtectedGroupCount() const;`)
# or an inline body; accept both without locking a
# different body. Nearby origin/main
...
# Waves / Hoist / Safety / Boss / Destruction /
...
# Objectives, not leftover Mission10 Integration / Waves.
...
# drafts #674–#780, leftover Apache
...
# leftover Mission08 GetSurvivingTargetCount #747,
# leftover Mission09 GetSurvivingTargetCount #766,
# leftover Mission10 GetRemainingThreatsInWave #779,
...
# an isolated Python GetSurvivingProtectedGroupCount
...
LEFTOVER_MISSION05_GET_SURVIVING_TARGET_COUNT_NOT_LOCKED = (
    ...
    "GetSurvivingTargetCount",
    'Category="Skyguard|Mission05|Protection"',
    "cursor/mission05-get-surviving-target-count-decl-contract-c332",
)
LEFTOVER_MISSION06_GET_SURVIVING_TARGET_COUNT_NOT_LOCKED = (
    ...
    "cursor/mission06-get-surviving-target-count-decl-contract-c332",
)
LEFTOVER_MISSION07_GET_SURVIVING_TARGET_COUNT_NOT_LOCKED = (
    ...
    "SkyguardMission07IntegrationDirector.h",
    'Category="Skyguard|Mission07|Protection"',
    "cursor/mission07-get-surviving-target-count-decl-contract-c332",
)
...
LEFTOVER_MISSION09_GET_SURVIVING_TARGET_COUNT_NOT_LOCKED = (
    "test_mission09_get_surviving_target_count_decl_contract.py",
    "ASkyguardMission09IntegrationDirector",
    "SkyguardMission09IntegrationDirector.h",
    'Category="Skyguard|Mission09|Protection"',
    "cursor/mission09-get-surviving-target-count-decl-contract-c332",
)
...
CPP_AND_INVENTED = (
    ...
    "SkyguardMission09IntegrationDirector.cpp",
    "ASkyguardMission10IntegrationDirector::GetSurvivingProtectedGroupCount",
...
class Mission10GetSurvivingProtectedGroupCountDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("GetSurvivingProtectedGroupCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_get_surviving_protected_group_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tvoid GetSurvivingProtectedGroupCount() const;\n"
        )
        as_const = (
        ...
        with_arg = (
            "\tconst FSkyguardMission09IntegrationReadiness& "
            "GetSurvivingProtectedGroupCount(int32 Amount) const;\n"
        )
        renamed = (
            "\tconst FSkyguardMission09IntegrationReadiness& "
            "GetReadyState() const;\n"
        )
        short_name = "\tbool GetSurvivingProtectedGroupCount() const;\n"
        leftover_m06_type = (
    ...
    def test_get_surviving_protected_group_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertIn("GetSurvivingProtectedGroupCount", LOCKED_DECL)
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(leftover_m07_ready, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m08_waves, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m08_hoist, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m08_safety, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m08_protection, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m08_ready, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m09_ready, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m09_waves, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m10_safety, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m09_protection, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m09_performance, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m09_objectives, UFUNCTION_PROTECTION)
        ...
        self.assertNotIn(leftover_m07_ready, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_m08_waves, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_m08_hoist, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_m08_safety, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_m08_protection, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_m08_ready, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_m09_ready, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_m09_waves, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_m10_safety, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_m09_protection, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_m09_performance, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_m09_objectives, UFUNCTION_PROTECTION)
        self.assertNotIn("Mission01", UFUNCTION_PROTECTION)
        self.assertNotIn("Mission03", UFUNCTION_PROTECTION)
        self.assertNotIn("Mission04", UFUNCTION_PROTECTION)
        self.assertNotIn("Mission05", UFUNCTION_PROTECTION)
    ...
    def test_contract_does_not_lock_get_surviving_protected_group_count_cpp_body(self) -> None:
        locked_only = f"{LOCKED_DECL}\n"
        self.assertNotIn("{", LOCKED_DECL)
        self.assertNotIn("}", LOCKED_DECL)
        self.assertNotIn("return ", LOCKED_DECL)
    ...
    def test_sibling_director_fields_do_not_satisfy_get_surviving_protected_group_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tint32 GetSurvivingProtectedGroupCount() const { return 0; }\n"
            "};\n"
        )
    ...
    def test_leftover_environment_get_readiness_does_not_satisfy(self) -> None:
        leftover = (
            ...
            'Category="Skyguard|Mission01|Environment")\n'
            "\tconst FSkyguardMission01EnvironmentReadiness& "
            "GetSurvivingProtectedGroupCount() const { return 0; }\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover)
