...
# INDEX_NONE or lock SearchTrackCount
# construction in the .cpp. This is leftover-safe
# Mission07 IntegrationReadiness SearchTrackCount
...
# NOT leftover Mission06 ProtectedTargetCount
# FIELD #1008 / branch cursor/mission06-
# protected-target-count-field-decl-contract-c332,
# NOT leftover Mission07 bSearchRuntimeReady
# FIELD #1036 / branch cursor/mission07-
# search-runtime-ready-field-decl-contract-c332,
# NOT leftover search-track-runtime-defaults
# #8266 / leftover search-sector enum #b4d4,
# NOT leftover Mission07 director Readiness
# FIELD #1027, NOT leftover Mission07
# ObjectiveCount / WaveCount siblings this wave,
# NOT leftover Mission05 ProtectedTargetCount
# FIELD #978 / branch cursor/mission05-
# protected-target-count-field-decl-contract-c332,
...
# NOT leftover Mission10 ProtectedGroupCount
# FIELD #825 / branch cursor/mission10-
# protected-group-count-field-decl-contract-c332,
...
# leftover director Readiness #1027, not leftover
# FSkyguardSearchTrackRuntime, not leftover
# FSkyguardMission07ProtectedTargetRuntime, not leftover
# ASkyguardMission06IntegrationDirector public
...
# After this field, leftover-safe Mission07 readiness-struct
# UPROPERTY is exhausted. Do not spawn leftover Mission07
# wave-state enum or leftover search-track defaults.
# Skip leftover b + Ya + kRuntimeReady forever (it sits
# after bMapAssemblyReady and before bGunnerReady). This contract
# is SearchTrackCount after WaveCount. It is NOT leftover
# Mission06 ProtectedTargetCount #1008. Skip leftover
# Mission07 bSearchRuntimeReady #1036. Skip leftover
...
# drafts #674-#1004 including leftover Mission02
...
# fields. Do not parse FSkyguardSearchTrackRuntime.
# Do not parse FSkyguardMission07ProtectedTargetRuntime. Do not parse FSkyguardAirfieldTargetRuntime.
...
# drafts #674-#1040. Do not reopen leftover
# Mission07 director field drafts Root #1011
# through Readiness #1027 / leftover Mission07
# readiness-struct bMissionDefinitionValid #1028
# through bCampaignRuntimeStarted #1040. Do not
# reopen leftover Mission06 ProtectedTargetCount
# #1008 / ObjectiveCount #1009 / WaveCount #1010.
# Do not reopen leftover Mission06 director field
# drafts Root #981
...
SEARCH_TRACK_COUNT_ONE = (
    "int32 SearchTrackCount = 1;"
)
LOCKED_DECL = SEARCH_TRACK_COUNT_FIELD
...
# an isolated Python SearchTrackCount
# field declaration contract on
# FSkyguardMission07IntegrationReadiness.
# THIS IS NOT leftover Mission06 ProtectedTargetCount
# #1008, NOT leftover Mission07 bSearchRuntimeReady
# #1036, NOT leftover Mission07 director Readiness
# #1027, NOT leftover search-track-runtime-defaults
# #8266, NOT leftover Mission05 ProtectedTargetCount
# #978, NOT leftover Mission06 bProtectedTargetsReady
# #1002, NOT leftover Mission10 ProtectedGroupCount.
LOCKED = {
...
class Mission07SearchTrackCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("SearchTrackCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_search_track_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_search_track_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 SearchTrackCount"),
            LOCKED_DECL,
        )
        ...
        self.assertNotIn("bSearchRuntimeReady", LOCKED_DECL)
        self.assertNotIn("bCampaignRuntimeStarted", LOCKED_DECL)
        self.assertNotIn("bProtectedTargetsReady", LOCKED_DECL)
        ...
        self.assertIn("SearchTrackCount", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        for header in (
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertTrue(
                has_declaration(section, SEARCH_TRACK_COUNT_ONE),
                section,
            )
        one_line = f"{{\npublic:\n\t{LOCKED_DECL}\n}}\n"
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("SearchTrackCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 SearchTrackCount"))
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 SearchTrackCount field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission07 SearchTrackCount contains "
    ...
    def test_contract_is_search_track_count_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_search_track_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission07_search_track"
            "_count_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertIn(
            "Scripts/tests/test_mission06_protected_target_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_same_name_search_track_count_contracts_stay_locked(
        self,
    ) -> None:
    ...
    def test_sibling_count_fields_do_not_satisfy_search_track_count(self) -> None:
        ...
        leftover_started = "\tbool bCampaignRuntimeStarted = false;\n"
        leftover_ready = "\tbool bProtectedTargetsReady = false;\n"
        leftover_search_ready = "\tbool bSearchRuntimeReady = false;\n"
        leftover_m06_count = "\tint32 ProtectedTargetCount = 0;\n"
        leftover_m05 = (
        ...
        leftover_wrong_default = "\tint32 SearchTrackCount = 1;\n"
        leftover_untyped = "\tSearchTrackCount = 0;\n"
        leftover_as_bool = "\tbool SearchTrackCount = false;\n"
        leftover_runtime = (
            "\tUSkyguardObjectiveRuntime* GetObjectiveRuntime() const;\n"
        )
        leftover_readiness = (
        ...
        leftover_wave_enum = "\tESkyguardMission06WaveState WaveState;\n"
        leftover_runtime_ready = (
            "\tbool b" + "Ya" + "kRuntimeReady = false;\n"
        )
        leftover_airfield = "\tFSkyguardAirfieldTargetRuntime TargetRuntime;\n"
        leftover_payload = "\tFSkyguardPayloadWindowRuntime PayloadWindow;\n"
        leftover_director = (
            "class SKYGUARD52_API ASkyguardMission07IntegrationDirector "
            ": public AActor\n"
            "{\n"
