...
# This is leftover-safe Mission03 IntegrationReadiness
# bConvoyRouteReady FIELD only. It is
# NOT leftover convoy-route-state enum #d34e /
# branch cursor/convoy-route-state-enum-contract-d34e,
# NOT leftover GetConvoyRouteState(),
# NOT leftover Mission03 director ConvoyRuntimeAnchor
# FIELD / branch cursor/mission03-convoy-runtime-
# anchor-field-decl-contract-c332,
...
# bRoadHunterReady / bWavesReady siblings.
# There is no leftover Mission02 bConvoyRouteReady.
# Skip leftover retired-mount runtime-ready
# struct field entirely. Skip leftover
# BindRuntimeActors / HandleDroneCityImpact /
# retired-mount spawn.
# Declaration presence only. Do not invent
# INDEX_NONE or lock bConvoyRouteReady
# construction in the .cpp. This is leftover-safe
# Mission03 IntegrationReadiness bConvoyRouteReady
...
# drafts #674-#861 including leftover Mission02
...
CONVOY_ROUTE_READY_FIELD = (
    "bool bConvoyRouteReady = false;"
)
LOCKED_DECL = CONVOY_ROUTE_READY_FIELD
...
# an isolated Python bConvoyRouteReady
...
CONVOY_ROUTE_READY_FIELD_TRUE = (
    "bool bConvoyRouteReady = true;"
)
...
class Mission03ConvoyRouteReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bConvoyRouteReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_convoy_route_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_convoy_route_ready_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bConvoyRouteReady"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= false;"), LOCKED_DECL)
        self.assertIn("bConvoyRouteReady", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_true = (
            "public:\n"
            f"\t{UPROPERTY_MISSION10}\n"
            f"\t{CONVOY_ROUTE_READY_FIELD_TRUE}\n"
            "};\n"
        )
        wrap_true_one_line = (
            "public:\n"
        ...
        for header in (
            ...
            section = public_section(header)
            self.assertTrue(
                has_declaration(section, CONVOY_ROUTE_READY_FIELD_TRUE),
                section,
            )
            self.assertEqual(
                require_declaration(
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bConvoyRouteReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bConvoyRouteReady"))
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        # This Mission03 field default false is not Harbor 40/80.
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bConvoyRouteReady", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 bConvoyRouteReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission03 bConvoyRouteReady contains "
    ...
    def test_contract_is_convoy_route_ready_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_convoy_route_ready(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission03_convoy_route_ready"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
