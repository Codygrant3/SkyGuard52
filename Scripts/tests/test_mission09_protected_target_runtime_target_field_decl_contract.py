...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission09 ProtectedTargetRuntime
# Target. THIS IS NOT leftover Mission08
...
# merge #665 #666 #668-#673, or open drafts #674-#1121.
...
# Mission09 ProtectedTargetRuntime Target
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly ESkyguardMission09ProtectedTarget
# default MetropolitanSkyline,
...
# the origin/main MetropolitanSkyline default,
...
# is Target before Integrity. THIS IS NOT leftover Mission09
...
# drafts #674-#1121 including leftover Mission02
...
# drafts #674-#1121. Do not reopen leftover
...
class Mission09ProtectedTargetRuntimeTargetFieldDeclContractTests(unittest.TestCase):
    ...
    def test_target_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("ESkyguardMission09ProtectedTarget Target"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("MetropolitanSkyline;"), LOCKED_DECL)
        ...
        self.assertIn("ESkyguardMission09ProtectedTarget ", LOCKED_DECL)
        self.assertIn("MetropolitanSkyline", LOCKED_DECL)
        ...
        self.assertIn("ESkyguardMission09ProtectedTarget", LOCKED_DECL)
        self.assertTrue(
            LOCKED_DECL.startswith("ESkyguardMission09ProtectedTarget "),
            LOCKED_DECL,
        )
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tESkyguardMission09ProtectedTarget\n"
            "\tTarget = ESkyguardMission09ProtectedTarget::MetropolitanSkyline;\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
        ...
        wrap_true_default = (
            "public:\n"
            f"\t{UPROPERTY_MISSION10}\n"
            "\tESkyguardMission09ProtectedTarget Target = ESkyguardMission09ProtectedTarget::MetropolitanSkyline;\n"
            "};\n"
        )
        header_wrap_type = (
            f"struct {CLASS_NAME}\n{{\n{wrap_type}"
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("Target", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("ESkyguardMission09ProtectedTarget Target"))
    ...
    def test_contract_is_target_field_declaration_only(
        ...
        self.assertTrue(LOCKED_DECL.startswith("ESkyguardMission09ProtectedTarget Target"))
        self.assertIn("Target", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("MetropolitanSkyline;"))
