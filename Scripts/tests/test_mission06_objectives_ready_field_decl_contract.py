...
# Mission06 IntegrationReadiness bObjectivesReady
...
# This readiness-struct field sits after bRunwayBreakerReady.
# Skip leftover b + Ya + kRuntimeReady forever (it sits
# after bMapAssemblyReady and before bGunnerReady). This contract
# is bObjectivesReady after bRunwayBreakerReady. Skip leftover
...
# drafts #674-#998. Do not reopen leftover
...
class Mission06ObjectivesReadyFieldDeclContractTests(unittest.TestCase):
