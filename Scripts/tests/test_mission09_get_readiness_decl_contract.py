...
# Mission09 Integration GetReadiness METHOD on
# ASkyguardMission09IntegrationDirector. It is
# NOT leftover Mission08 GetReadiness #739 /
...
class Mission09GetReadinessDeclContractTests(unittest.TestCase):
    ...
    def test_get_readiness_declaration_matches_origin_main(self) -> None:
        ...
        self.assertIn("FSkyguardMission09IntegrationReadiness", GET_READINESS)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 GetReadiness method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                GET_READINESS.lower(),
                "mission09 GetReadiness contains "
