...
# Mission05 Waves NotifyThreatDestroyed on
...
# NotifyProtectedTargetDamage / GetStormRuntime /
...
# form, other one-line / split-line wraps, the
# default argument, and an inline body without
...
# NotifyThreatDestroyed method declaration
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission05IntegrationDirector::NotifyThreatDestroyed",
    "SkyguardMission05IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission05NotifyThreatDestroyedDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        as_int = "\tint32 NotifyThreatDestroyed(int32 Amount = 1);\n"
        with_arg = "\tbool NotifyThreatDestroyed();\n"
        no_default = "\tbool NotifyThreatDestroyed(int32 Amount);\n"
    ...
    def test_notify_threat_destroyed_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            NOTIFY_THREAT_DESTROYED.endswith("(int32 Amount = 1);"),
            NOTIFY_THREAT_DESTROYED,
        )
        self.assertIn("int32 Amount = 1", NOTIFY_THREAT_DESTROYED)
        self.assertNotIn("FName ObjectiveId", NOTIFY_THREAT_DESTROYED)
        self.assertNotIn("static ", NOTIFY_THREAT_DESTROYED)
    ...
    def test_environment_category_does_not_satisfy_waves(self) -> None:
        ...
        self.assertNotEqual(leftover_m04_integration, UFUNCTION_WAVES)
        self.assertNotEqual(leftover_m05_integration, UFUNCTION_WAVES)
        ...
        self.assertNotIn(leftover_m04_integration, UFUNCTION_WAVES)
        self.assertNotIn(leftover_m05_integration, UFUNCTION_WAVES)
        self.assertNotIn("Mission01", UFUNCTION_WAVES)
        self.assertNotIn("Mission03", UFUNCTION_WAVES)
        self.assertNotIn("Mission04", UFUNCTION_WAVES)
        self.assertNotIn("Integration", UFUNCTION_WAVES)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardTempestBoss", NOTIFY_THREAT_DESTROYED)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 NotifyThreatDestroyed method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission05 NotifyThreatDestroyed contains "
