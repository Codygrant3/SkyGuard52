...
# Mission05 Integration GetReadiness
...
# GetReadiness. It is NOT leftover BindRuntimeActors
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission05IntegrationDirector::GetReadiness",
    "SkyguardMission05IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission05GetReadinessDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        with_arg = (
            "\tconst FSkyguardMission05IntegrationReadiness& "
            "GetReadiness(float DeltaSeconds) const;\n"
        )
        renamed = (
            "\tconst FSkyguardMission05IntegrationReadiness& "
            "GetReadyState() const;\n"
    ...
    def test_get_readiness_declaration_matches_origin_main(self) -> None:
        ...
        self.assertIn("FSkyguardMission05IntegrationReadiness", GET_READINESS)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardTempestBoss", GET_READINESS)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 GetReadiness method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                GET_READINESS.lower(),
                "mission05 GetReadiness contains "
