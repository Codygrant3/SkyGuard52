...
CLASS_NAME = "FSkyguardSearchlightTrackRuntime"
# Declaration presence only. Do not invent
# INDEX_NONE or lock bBossTracked
# construction in the .cpp. This is leftover-safe
# Mission04 SearchlightTrackRuntime bBossTracked
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool default false / true,
# one-line / split-line UPROPERTY wraps) on
# FSkyguardSearchlightTrackRuntime. Parse the
# searchlight track runtime STRUCT public
# UPROPERTY section, not the director class,
# not FSkyguardMission04IntegrationReadiness.
# It is NOT leftover searchlight-track-runtime-
# defaults #7347 / branch cursor/searchlight-
# track-runtime-defaults-contract-7347 (do not
# lock defaults construction or
# GetSearchlightRuntime),
# NOT leftover Mission04 bSearchlightsReady
# FIELD #935 / branch cursor/mission04-
# searchlights-ready-field-decl-contract-c332,
# NOT leftover Mission04 RequiredTrackSeconds
# FIELD #923 / branch cursor/mission04-
# required-track-seconds-field-decl-contract-c332,
# NOT leftover Mission04 MissedTrackDamage
# FIELD #924 / branch cursor/mission04-
# missed-track-damage-field-decl-contract-c332,
# NOT leftover Mission04 StartSearchlightWindow /
# AdvanceSearchlightTrack method contracts,
# NOT leftover BlackKite IsSearchlightTracked /
# SetSearchlightTracked method contracts,
# NOT leftover Mission04 SearchlightPort director
# FIELD #908 / branch cursor/mission04-
# searchlight-port-field-decl-contract-c332,
# NOT leftover Mission04 SearchlightStarboard
# director FIELD #909 / branch cursor/mission04-
# searchlight-starboard-field-decl-contract-c332,
# NOT leftover Mission04 StartSearchlightWindow /
# AdvanceSearchlightTrack method contracts,
# NOT leftover Mission04 bBlackKiteReady sibling /
# branch cursor/mission04-black-kite-ready-field-
# decl-contract-c332,
# NOT leftover Mission04 bObjectivesReady sibling /
# branch cursor/mission04-objectives-ready-field-
# decl-contract-c332,
# NOT leftover Mission04 bGunnerReady sibling /
# branch cursor/mission04-gunner-ready-field-
# decl-contract-c332,
# NOT leftover Mission04 bMapAssemblyReady sibling /
# branch cursor/mission04-map-assembly-ready-
# field-decl-contract-c332,
# NOT leftover Mission04 BlackKiteSpawnLocation
# director FIELD #921 / branch cursor/mission04-
# black-kite-spawn-location-field-decl-contract-c332,
# NOT leftover Mission04 BlackKiteSpawnRotation
# director FIELD #922 / branch cursor/mission04-
# black-kite-spawn-rotation-field-decl-contract-c332,
# NOT leftover Mission04 bMapAssemblyReady
# sibling / branch cursor/mission04-
# map-assembly-ready-field-decl-contract-c332,
# NOT leftover Mission02/03/10 bGunnerReady
# FIELD #864/#894/#814 / branches cursor/mission02-
# gunner-ready-field-decl-contract-c332,
# cursor/mission03-gunner-ready-field-decl-
# contract-c332, cursor/mission10-gunner-ready-
# field-decl-contract-c332,
...
# struct section of
# FSkyguardSearchlightTrackRuntime only
# (not ASkyguardMission04IntegrationDirector,
# not leftover FSkyguardMission04IntegrationReadiness,
# not leftover director BlackKiteSpawnLocation /
# BlackKiteSpawnRotation FVector/FRotator fields,
# not leftover bSearchlightsReady #935, not leftover
# FSkyguardMission03IntegrationReadiness, not leftover
# director CampaignDefinition TSoftObjectPtr #881,
# not leftover GetReadiness(), not leftover
# Mission02/03/10 readiness structs, not leftover
# Mission04 Readiness director field #926, not leftover
...
SEARCHLIGHTS_READY_FIELD = (
    "bool bSearchlightsReady = false;"
)
BOSS_TRACKED_FIELD = (
    "bool bBossTracked = false;"
)
LOCKED_DECL = BOSS_TRACKED_FIELD
...
# an isolated Python bBossTracked
# field declaration contract on
# FSkyguardSearchlightTrackRuntime. This is NOT leftover
# Mission04 bSearchlightsReady #935. This is NOT leftover
# Mission04 BlackKiteSpawnLocation #921. This is NOT leftover
# Mission04 BlackKiteSpawnRotation #922. This is NOT leftover
# Mission04 Readiness director field #926. This is NOT leftover
# Mission04 bMapAssemblyReady sibling. This is NOT leftover
# Mission02/03/10 bGunnerReady #864/#894/#814.
LOCKED = {
...
SEARCHLIGHTS_READY_FIELD_TRUE = (
    "bool bSearchlightsReady = true;"
)
BOSS_TRACKED_FIELD_TRUE = (
    "bool bBossTracked = true;"
)
...
SIBLING_SEARCHLIGHT_TRACK_FIELDS_NOT_LOCKED = (
    "bool bActive = false;",
...
LEFTOVER_MISSION04_BLACK_KITE_SPAWN_NOT_LOCKED = (
    ...
    "cursor/mission04-black-kite-spawn-location-field-decl-contract-c332",
    "cursor/mission04-black-kite-spawn-rotation-field-decl-contract-c332",
    "BlackKiteSpawnLocation",
    "BlackKiteSpawnRotation",
)
...
LEFTOVER_MISSION04_BLACK_KITE_READY_NOT_LOCKED = (
    "test_mission04_black_kite_ready_field_decl_contract.py",
    "cursor/mission04-black-kite-ready-field-decl-contract-c332",
    "bBlackKiteReady",
)
...
LEFTOVER_MISSION04_SEARCHLIGHT_PORT_NOT_LOCKED = (
    "test_mission04_searchlight_port_field_decl_contract.py",
    "cursor/mission04-searchlight-port-field-decl-contract-c332",
    SEARCHLIGHT_PORT_FIELD,
    "SearchlightPort",
)
LEFTOVER_MISSION04_SEARCHLIGHT_STARBOARD_NOT_LOCKED = (
    "test_mission04_searchlight_starboard_field_decl_contract.py",
    "cursor/mission04-searchlight-starboard-field-decl-contract-c332",
    SEARCHLIGHT_STARBOARD_FIELD,
...
class Mission04SearchlightTrackBossTrackedFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bBossTracked", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_boss_tracked_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_boss_tracked_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bBossTracked"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= false;"), LOCKED_DECL)
        self.assertIn("bBossTracked", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        for header in (
            ...
            section = public_section(header)
            self.assertTrue(
                has_declaration(section, BOSS_TRACKED_FIELD_TRUE),
                section,
            )
            self.assertEqual(
                require_declaration(
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bBossTracked", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bBossTracked"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bBossTracked", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 bBossTracked field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 bBossTracked contains "
    ...
    def test_contract_is_boss_tracked_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_boss_tracked(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission04_searchlight_track_boss_tracked"
            "_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_searchlight_track_boss_tracked"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
            "Scripts/tests/test_mission04_black_kite_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_searchlight_port"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_black_kite_is_searchlight_tracked"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_black_kite_set_searchlight_tracked"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission04_searchlight_starboard"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_searchlight_track_runtime"
            "_defaults_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission04_start_searchlight_window"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_parses_searchlight_track_runtime_not_readiness_or_director(
        self,
    ) -> None:
        header = origin_main_header()
        self.assertEqual(CLASS_NAME, "FSkyguardSearchlightTrackRuntime")
        self.assertNotEqual(
            CLASS_NAME,
            "FSkyguardMission04IntegrationReadiness",
        )
        ...
        self.assertTrue(
            header[match.start(): match.start() + 8].startswith("struct"),
            header[match.start(): match.start() + 40],
        )
        section = public_section(header)
        self.assertTrue(has_declaration(section, LOCKED_DECL), section)
        self.assertTrue(
            has_declaration(section, "bool bActive = false;"),
            section,
        )
        self.assertIn("RemainingSeconds", section)
        self.assertIn("HeldSeconds", section)
        self.assertIn("CompletedPasses", section)
        self.assertNotIn("bSearchlightsReady", section)
        self.assertNotIn("bCampaignRuntimeStarted", section)
        self.assertNotIn("InitializePlayableMission", section)
        self.assertNotIn("SearchlightPort", section)
        self.assertNotIn(
            "ASkyguardMission04IntegrationDirector",
            section,
        )
        ...
        with self.assertRaises(AssertionError) as raised:
            public_section(readiness)
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        director = (
            "class ASkyguardMission04IntegrationDirector "
            ": public AActor\n"
            "{\n"
            "public:\n"
            f"\t{LOCKED_DECL}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            public_section(director)
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_declaration_accepts_alternate_default_literals(self) -> None:
        forms = (
            BOSS_TRACKED_FIELD,
            BOSS_TRACKED_FIELD_TRUE,
            "bool bBossTracked = 0;",
            "bool bBossTracked = 100;",
            "bool bBossTracked = 0.f;",
            'FString CampaignSaveSlotName = TEXT("Skyguard52Campaign");',
            "FVector HeldOffset = FVector(0.f, 0.f, 0.f);",
            "FRotator HeldSpin = FRotator(0.f, 0.f, 0.f);",
        )
        for form in forms:
            header = (
                f"struct {CLASS_NAME}\n"
            ...
            section = public_section(header)
            self.assertTrue(has_declaration(section, form), section)
            self.assertEqual(require_declaration(section, form), form)
            self.assertNotIn("{", form)
            self.assertNotIn("return ", form)
        self.assertEqual(LOCKED_DECL, BOSS_TRACKED_FIELD)
        self.assertNotEqual(LOCKED_DECL, "bool bBossTracked = 0;")
        self.assertNotEqual(LOCKED_DECL, "bool bBossTracked = 100;")
        self.assertNotEqual(LOCKED_DECL, "bool bBossTracked = 0.f;")
        wrap_zero = (
            f"struct {CLASS_NAME}\n"
            "{\n"
            "public:\n"
        ...
        section = public_section(wrap_zero)
        self.assertTrue(
            has_declaration(section, "bool bBossTracked = 0;"),
            section,
        )

    def test_sibling_searchlight_track_fields_do_not_satisfy(self) -> None:
        for leftover in SIBLING_SEARCHLIGHT_TRACK_FIELDS_NOT_LOCKED:
            if leftover.startswith("test_"):
                continue
            region = f"\t{leftover}\n"
            with self.assertRaises(AssertionError) as raised:
            ...
            self.assertFalse(has_declaration(region, LOCKED_DECL))
        locked_only = f"{LOCKED_DECL}\n"
        for token in SIBLING_SEARCHLIGHT_TRACK_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        self.assertNotIn(SEARCHLIGHTS_READY_FIELD, LOCKED_DECL)
        self.assertNotIn("bSearchlightsReady", LOCKED_DECL)
        self.assertNotIn("bActive", LOCKED_DECL)
        self.assertNotIn("RemainingSeconds", LOCKED_DECL)
        self.assertNotIn("HeldSeconds", LOCKED_DECL)
        self.assertNotIn("CompletedPasses", LOCKED_DECL)
