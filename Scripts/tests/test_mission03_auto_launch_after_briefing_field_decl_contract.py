...
# Mission03 bAutoLaunchAfterBriefing FIELD
# (declaration-only; EditAnywhere /
# BlueprintReadWrite bool default true,
...
# NOT leftover Mission02 bAutoLaunchAfterBriefing
# field #853 / branch cursor/mission02-auto-
...
# field leftover / branch cursor/mission10-auto-
# launch-after-briefing-field-decl-contract-c332,
# NOT leftover Mission03 Briefing field
# #878 / branch cursor/mission03-briefing-
# field-decl-contract-c332,
# NOT leftover Mission03 CampaignDefinition
# field #881 / branch cursor/mission03-campaign-
# definition-field-decl-contract-c332,
# NOT leftover convoy-route-state enum
# #d34e / branch cursor/convoy-route-state-
# enum-contract-d34e, NOT leftover Mission03
# wave-state enum #0242 / branch
# cursor/mission03-wave-state-enum-contract-0242,
# NOT leftover Mission10 bAutoInitialize field
...
# the `= true` default, and nearby split-line
...
# drafts #674-#881, leftover Apache
...
# leftover Mission01 / Mission02 / Mission04-10
# bAutoLaunchAfterBriefing / auto-launch-after-
# briefing field contracts, leftover Mission01 /
# Mission02 / Mission04-10 bAutoInitialize / auto-initialize
# field contracts, leftover Mission03 Briefing #878,
# leftover Mission03 CampaignDefinition #881, leftover
# Mission03 wave-state enum #0242, leftover convoy-
# route-state enum #d34e, leftover
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission03IntegrationDirector::bAutoLaunchAfterBriefing",
    "ASkyguardMission02IntegrationDirector::bAutoLaunchAfterBriefing",
    "SkyguardMission10IntegrationDirector.cpp",
...
class Mission03AutoLaunchAfterBriefingFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 bAutoLaunchAfterBriefing field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission03 bAutoLaunchAfterBriefing contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission03_auto_launch_after_briefing_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission03_auto_launch_after_briefing_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission09_auto_launch_after_briefing"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
