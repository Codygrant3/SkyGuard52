...
# Mission05 Integration static GetMissionId
# METHOD on ASkyguardMission05IntegrationDirector. It is
# NOT leftover environment-readiness defaults #6b9d /
# #b931, NOT leftover Environment GetReadiness, NOT
# leftover Mission04 GetMissionId #663, NOT leftover
# Mission01 GetMissionId / leftover Mission03
# GetMissionId. It is NOT leftover BindRuntimeActors
...
# from leftover Mission01 / Mission03 GetMissionId and
# leftover Mission04 GetMissionId #663. Distinct from leftover
...
# GetReadiness / ValidateMissionContract /
...
# leftover Mission01 GetMissionId, leftover
# Mission03 GetMissionId, leftover Mission04
# GetMissionId #663, leftover Mission05
...
# (do not lock GetSearchlightRuntime). Do not lock
# leftover GetNightBeatKit without UFUNCTION.
# origin/main is a one-line method with an inline
...
# Category is Skyguard|Mission05|Integration, not
...
# not Protection, not Destruction, not Briefing,
...
# Mission04 Integration GetMissionId #663, not leftover
...
GET_MISSION_ID = "static FName GetMissionId()"
M01_GET_MISSION_ID = (
...
# GetMissionId method declaration
# contract on ASkyguardMission05IntegrationDirector.
# Distinct from leftover Mission01 / Mission03
# GetMissionId and leftover Mission04 GetMissionId #663.
LOCKED = {
...
class Mission05GetMissionIdDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission05|Integration", UFUNCTION_INTEGRATION)
        ...
        self.assertNotIn("Storm", UFUNCTION_INTEGRATION)
        self.assertNotIn("Waves", UFUNCTION_INTEGRATION)
        self.assertNotIn("Searchlight", UFUNCTION_INTEGRATION)
        self.assertNotIn("Substation", UFUNCTION_INTEGRATION)
    ...
    def test_get_mission_id_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            GET_MISSION_ID.endswith("GetMissionId()"),
            GET_MISSION_ID,
        )
        self.assertIn("GetMissionId", GET_MISSION_ID)
        self.assertNotIn("{", GET_MISSION_ID)
        self.assertNotIn("}", GET_MISSION_ID)
        self.assertNotIn("return ", GET_MISSION_ID)
        self.assertIn("GetMissionId()", GET_MISSION_ID)
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(leftover_m05_protection, UFUNCTION_INTEGRATION)
        self.assertNotEqual(leftover_m05_storm, UFUNCTION_INTEGRATION)
        ...
        self.assertNotIn(leftover_m05_protection, UFUNCTION_INTEGRATION)
        self.assertNotIn(leftover_m05_storm, UFUNCTION_INTEGRATION)
    ...
    def test_contract_does_not_lock_get_mission_id_cpp_body(self) -> None:
        ...
        self.assertNotIn("TEXT(", GET_MISSION_ID)
        self.assertNotIn("M05_StormFront", GET_MISSION_ID)
        self.assertNotIn("M04_NightBlackout", GET_MISSION_ID)
        self.assertNotIn("M01_CoastalIntercept", GET_MISSION_ID)
        self.assertNotIn("M03_ConvoyEscort", GET_MISSION_ID)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardTempestBoss", GET_MISSION_ID)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 GetMissionId method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission05 GetMissionId contains "
    ...
    def test_contract_is_get_mission_id_declaration_only(
        ...
        self.assertIn("GetMissionId", GET_MISSION_ID)
        self.assertIn("GetMissionId()", GET_MISSION_ID)
        self.assertTrue(GET_MISSION_ID.endswith("GetMissionId()"))
        self.assertFalse(GET_MISSION_ID.endswith(";"))
        self.assertNotIn("{", GET_MISSION_ID)
        self.assertIn(UFUNCTION_INTEGRATION, section)
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tstatic FName "
            "GetMissionId() { return TEXT(\"M05_StormFront\"); }\n"
            "};\n"
        )
    ...
    def test_leftover_mission01_get_mission_id_payload_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission01IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission03_get_mission_id_payload_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission04_get_mission_id_payload_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission04IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_locked_scripts_include_sibling_mission05_contracts(self) -> None:
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_get_night_beat_kit(self) -> None:
        ...
        self.assertNotIn(GET_NIGHT_BEAT_KIT, GET_MISSION_ID)
        self.assertNotIn("GetNightBeatKit", GET_MISSION_ID)
