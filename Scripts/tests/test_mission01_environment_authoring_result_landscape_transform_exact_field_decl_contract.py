...
# bLandscapeTransformExact. THIS IS NOT leftover bLandscapeGuidValid.
# THIS IS NOT leftover bSuccess #1235. THIS IS NOT leftover
# mission01-environment-authoring-result-defaults #df1a.
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bLandscapeTransformExact FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# bool bLandscapeTransformExact = false; one-line /
...
# LandscapeComponentCount #1238, leftover MaterialCompilation
# through Error #1232.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bLandscapeTransformExact. THIS IS NOT leftover
# mission01-environment-authoring-result-defaults #df1a.
# THIS IS NOT leftover AuthoringResult bSuccess #1235.
# THIS IS NOT leftover bLandscapeGuidValid.
...
# bSuccess #1235 / VisibleAudit #1236 / GraphNodeCount #1237 /
# LandscapeComponentCount #1238 / GraphNodeSettingClasses /
# leftover bLandscapeGuidValid.
...
# bool bLandscapeTransformExact = false. Fail closed if type/decl
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bLandscapeTransformExact. THIS IS NOT leftover MaterialCompilation bSuccess #1223.
...
# Do NOT parse FSkyguardLandscapeCaptureConfigurationResult (leftover bSuccess #1214).
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bLandscapeTransformExact. THIS IS NOT leftover VisibleAudit bSuccess #1199.
# THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
# THIS IS NOT leftover landscape-capture-config-defaults #d6fd.
# THIS IS NOT leftover landscape-visible-audit-defaults #0bce.
# THIS IS NOT leftover landscape-material-compilation-defaults #01d4.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bLandscapeTransformExact FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bLandscapeTransformExact = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# BlueprintReadOnly bool bLandscapeTransformExact = false;
...
TARGET = "bool bLandscapeTransformExact = false;"
TARGET_WRONG = "bool bLandscapeTransformExact = true;"
LOCKED_DECL = TARGET
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # bLandscapeTransformExact (must be = false, not = true).
    # THIS IS NOT leftover VisibleAudit bSuccess #1199.
    # THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*bool\s+bLandscapeTransformExact\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for bool bLandscapeTransformExact is missing from "
...
class Mission01EnvironmentAuthoringResultLandscapeTransformExactFieldDeclContractTests(unittest.TestCase):
    def test_mission01_environment_authoring_result_struct_exists(self) -> None:
        ...
        self.assertIn("bLandscapeTransformExact", section)
        ...
        self.assertNotIn("bValid", section.replace("bLandscapeTransformExact", ""))
        ...
        self.assertNotIn("bSuccess", LOCKED_DECL.replace("bLandscapeTransformExact", ""))
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bLandscapeTransformExact", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_landscape_transform_exact_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_landscape_transform_exact_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bLandscapeTransformExact"),
            LOCKED_DECL,
        )
        ...
        self.assertFalse(
            has_declaration(
                "\tbool bLandscapeTransformExact = true;\n",
                LOCKED_DECL,
            )
        )
        with self.assertRaises(AssertionError) as raised:
        ...
        self.assertIn("bLandscapeTransformExact", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bLandscapeTransformExact", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bLandscapeTransformExact"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bLandscapeTransformExact", locked_only)
