...
# INDEX_NONE or lock MaximumTargetIntegrity
# construction in the .cpp. This is leftover-safe
# Mission06 MaximumTargetIntegrity FIELD
...
# This contract is MaximumTargetIntegrity
...
# Lock MaximumTargetIntegrity only. Do not lock
...
LOCKED_DECL = MAXIMUM_TARGET_INTEGRITY_FIELD
...
# an isolated Python MaximumTargetIntegrity
...
class Mission06MaximumTargetIntegrityFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("MaximumTargetIntegrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_maximum_target_integrity_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_maximum_target_integrity_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 MaximumTargetIntegrity"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("MaximumTargetIntegrity", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("MaximumTargetIntegrity", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 MaximumTargetIntegrity"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("MaximumTargetIntegrity", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 MaximumTargetIntegrity field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission06 MaximumTargetIntegrity field contains "
    ...
    def test_contract_is_maximum_target_integrity_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_maximum_target_integrity(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tint32 MaximumTargetIntegrity = 1;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_airfield_target_runtime_does_not_satisfy_maximum_target_integrity(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_does_not_satisfy_maximum_target_integrity(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
