...
# Mission05 Protection NotifyProtectedTargetDamage
...
# Category is Skyguard|Mission05|Protection, not
# Integration, not Waves, not Storm, not
...
# leftover Harbor Mission02 Integration. Do not
...
# NotifyProtectedTargetDamage method declaration
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission05IntegrationDirector::NotifyProtectedTargetDamage",
    "SkyguardMission05IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission05NotifyProtectedTargetDamageDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", NOTIFY_PROTECTED_TARGET_DAMAGE)
        ...
        self.assertIn("Skyguard|Mission05|Protection", UFUNCTION_PROTECTION)
        ...
        self.assertNotIn("Searchlight", UFUNCTION_PROTECTION)
        self.assertNotIn("Substation", UFUNCTION_PROTECTION)
        self.assertNotIn("Objectives", UFUNCTION_PROTECTION)
        self.assertNotIn("Storm", UFUNCTION_PROTECTION)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        as_const = (
            "\tbool NotifyProtectedTargetDamage("
            "ESkyguardMission05ProtectedTarget Target, int32 Damage) const;\n"
        )
        as_int = (
            "\tint32 NotifyProtectedTargetDamage("
            "ESkyguardMission05ProtectedTarget Target, int32 Damage);\n"
        )
        with_arg = "\tbool NotifyProtectedTargetDamage();\n"
        no_default = "\tbool NotifyProtectedTargetDamage(int32 Damage);\n"
        leftover_objective_shape = (
            "\tbool NotifyProtectedTargetDamage("
            "FName ObjectiveId, int32 Damage);\n"
        )
    ...
    def test_notify_protected_target_damage_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            NOTIFY_PROTECTED_TARGET_DAMAGE.endswith(", int32 Damage);"),
            NOTIFY_PROTECTED_TARGET_DAMAGE,
        )
        self.assertIn(
        ...
        self.assertNotIn("int32 Amount = 1", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("FName ObjectiveId", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("OffshorePlatform", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("DistressedTrawler", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn(
            "NotifyThreatDestroyed",
            NOTIFY_PROTECTED_TARGET_DAMAGE,
        )
        self.assertNotIn("static ", NOTIFY_PROTECTED_TARGET_DAMAGE)
    ...
    def test_environment_category_does_not_satisfy_protection(self) -> None:
        ...
        self.assertNotEqual(leftover_m03_waves, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m04_waves, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m04_integration, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m05_integration, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m05_waves, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m05_storm, UFUNCTION_PROTECTION)
        ...
        self.assertNotIn(leftover_m03_waves, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_m04_waves, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_m04_integration, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_m05_integration, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_m05_waves, UFUNCTION_PROTECTION)
        self.assertNotIn(leftover_m05_storm, UFUNCTION_PROTECTION)
        self.assertNotIn("Mission01", UFUNCTION_PROTECTION)
        self.assertNotIn("Mission03", UFUNCTION_PROTECTION)
        self.assertNotIn("Mission04", UFUNCTION_PROTECTION)
        self.assertNotIn("Integration", UFUNCTION_PROTECTION)
    ...
    def test_contract_does_not_lock_notify_protected_target_damage_cpp_body(self) -> None:
        locked_only = f"{NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
        self.assertNotIn("{", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("}", NOTIFY_PROTECTED_TARGET_DAMAGE)
        self.assertNotIn("return ", NOTIFY_PROTECTED_TARGET_DAMAGE)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardTempestBoss", NOTIFY_PROTECTED_TARGET_DAMAGE)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 NotifyProtectedTargetDamage method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission05 NotifyProtectedTargetDamage contains "
