...
# or lock the IsDisabledDescent body.
# origin/main is inline
# (`bool IsDisabledDescent() const`
# with `{ return bDisabledDescent; }` possibly on the
...
# locking the body. The inline return of the disabled
# descent flag is not a required token of this
...
# RedirectDisabledDrone siblings. Stay off leftover
...
# leftover isolated-test drafts #107–#436 including
...
# OpenOrbitExposure. Harbor interval retune tokens
# fail closed in this file and the locked declaration
# only. Do not scan the Apache public section for
# those tokens. Harbor clock names may be scanned in
# this relevant public section and must be absent.
...
# Python IsDisabledDescent declaration contract on
# ASkyguardLifelineHunterBoss. Stay off leftover
# OpenSensorExposure / SetFriendlySeparationMeters /
# RedirectDisabledDrone, leftover emergency-finish
...
# siblings, leftover ApacheSystem enum values,
# leftover roster enum values, leftover Harbor
# clocks, leftover skyline HarborIndustrial,
...
# sortie-hud-host fail-closed, leftover Mission08
# neighbors, and dirty workspace paths.
LOCKED = {
...
# OpenSensorExposure / SetFriendlySeparationMeters /
# RedirectDisabledDrone siblings, leftover apache
...
# MinHeightFromOriginCm, leftover Apache
# MaxIntegrity, leftover GetFriendlySeparationMeters
# / IsCrashRedirected siblings, and leftover
...
# SetFriendlySeparationMeters / RedirectDisabledDrone
...
GET_FRIENDLY_SEPARATION_NOT_LOCKED = (
    GET_FRIENDLY_SEPARATION_METERS,
...
# .cpp IsDisabledDescent body / invented INDEX_NONE
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardLifelineHunterBoss::IsDisabledDescent",
    "SkyguardLifelineHunterBoss.cpp",
)
SIBLING_TYPES = (
...
class LifelineHunterIsDisabledDescentDeclContractTests(unittest.TestCase):
    def test_lifeline_hunter_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, IS_DISABLED_DESCENT),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, IS_DISABLED_DESCENT)
        self.assertIn("IsDisabledDescent", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(has_declaration(section, IS_DISABLED_DESCENT))

    def test_missing_is_disabled_descent_declaration_fails_closed(
        self,
    ) -> None:
        neighbors_only = (
            "\tASkyguardLifelineHunterBoss();\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, IS_DISABLED_DESCENT)
        self.assertIn("IsDisabledDescent", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, IS_DISABLED_DESCENT)
        self.assertIn("IsDisabledDescent", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("BlueprintPure", IS_DISABLED_DESCENT)
        self.assertNotIn("UFUNCTION", IS_DISABLED_DESCENT)
        self.assertNotIn("Category", IS_DISABLED_DESCENT)
        self.assertNotIn("BlueprintCallable", IS_DISABLED_DESCENT)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, IS_DISABLED_DESCENT)
        self.assertIn("IsDisabledDescent", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        missing_parens = "\tbool IsDisabledDescent const;\n"
        missing_const = "\tbool IsDisabledDescent();\n"
        wrong_return_void = "\tvoid IsDisabledDescent() const;\n"
        wrong_return_int = "\tint32 IsDisabledDescent() const;\n"
        added_arg = "\tbool IsDisabledDescent(bool bValue) const;\n"
        ...
        leftover_get = f"\t{GET_FRIENDLY_SEPARATION_METERS}\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, IS_DISABLED_DESCENT)
            self.assertIn("IsDisabledDescent", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_is_disabled_descent_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, IS_DISABLED_DESCENT),
            IS_DISABLED_DESCENT,
        )
        self.assertTrue(has_declaration(section, IS_DISABLED_DESCENT))
        self.assertEqual(
            declaration_count(section, IS_DISABLED_DESCENT),
            1,
        )
        self.assertTrue(
            IS_DISABLED_DESCENT.startswith("bool "),
            IS_DISABLED_DESCENT,
        )
        self.assertTrue(
            IS_DISABLED_DESCENT.endswith(";"),
            IS_DISABLED_DESCENT,
        )
        self.assertIn("IsDisabledDescent()", IS_DISABLED_DESCENT)
        self.assertIn(" const", IS_DISABLED_DESCENT)
        self.assertNotIn("INDEX_NONE", IS_DISABLED_DESCENT)
        self.assertNotIn("{", IS_DISABLED_DESCENT)
        self.assertNotIn("}", IS_DISABLED_DESCENT)
        self.assertNotIn("return ", IS_DISABLED_DESCENT)
        self.assertNotIn("return bDisabledDescent", IS_DISABLED_DESCENT)
        self.assertNotIn("OpenSensorExposure", IS_DISABLED_DESCENT)
        self.assertNotIn("SetFriendlySeparationMeters", IS_DISABLED_DESCENT)
        self.assertNotIn("RedirectDisabledDrone", IS_DISABLED_DESCENT)
        self.assertNotIn("IsCrashRedirected", IS_DISABLED_DESCENT)
        self.assertNotIn("GetFriendlySeparationMeters", IS_DISABLED_DESCENT)
        self.assertNotIn("GetChinMuzzleLocation", IS_DISABLED_DESCENT)
        self.assertNotIn("GetGunnerMount", IS_DISABLED_DESCENT)
        self.assertNotIn("FaceWorldLocation", IS_DISABLED_DESCENT)
        self.assertNotIn("OpticalTracker", IS_DISABLED_DESCENT)
        self.assertNotIn(
            "MinimumWeaponSeparationMeters",
            IS_DISABLED_DESCENT,
        )
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, IS_DISABLED_DESCENT)

    def test_declaration_accepts_origin_main_inline_and_prototype(self) -> None:
        one_line_prototype = f"{{\npublic:\n\t{IS_DISABLED_DESCENT}\n}}\n"
        self.assertTrue(
            has_declaration(one_line_prototype, IS_DISABLED_DESCENT)
        )
        self.assertEqual(
            require_declaration(one_line_prototype, IS_DISABLED_DESCENT),
            IS_DISABLED_DESCENT,
        )
        exact_inline = (
            "bool IsDisabledDescent() const { return bDisabledDescent; }"
        )
        self.assertTrue(has_declaration(exact_inline, IS_DISABLED_DESCENT))
        self.assertEqual(
            require_declaration(exact_inline, IS_DISABLED_DESCENT),
            IS_DISABLED_DESCENT,
        )
        self.assertEqual(
            declaration_count(exact_inline, IS_DISABLED_DESCENT),
            1,
        )
        section = public_section(origin_main_header())
        self.assertTrue(
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tbool\n"
            "\tIsDisabledDescent() const;\n"
            "private:\n"
            "};\n"
        )
        wrap_name = (
            "public:\n"
            "\tbool IsDisabledDescent(\n"
            "\t) const;\n"
            "private:\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{IS_DISABLED_DESCENT}\n}}\n"
        self.assertTrue(has_declaration(one_line, IS_DISABLED_DESCENT))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, IS_DISABLED_DESCENT),
            section,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        self.assertNotIn("return ", IS_DISABLED_DESCENT)
        self.assertNotIn("return bDisabledDescent", IS_DISABLED_DESCENT)
        self.assertNotIn("return Other", IS_DISABLED_DESCENT)

    def test_declaration_does_not_invent_index_none(self) -> None:
        locked_only = f"{IS_DISABLED_DESCENT}\n"
        self.assertNotIn("INDEX_NONE", locked_only)
        self.assertNotIn("INDEX_NONE", IS_DISABLED_DESCENT)
        self.assertNotIn("return INDEX_NONE", locked_only)
        self.assertNotIn("NAME_None", IS_DISABLED_DESCENT)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_is_disabled_descent_cpp_body(self) -> None:
        locked_only = f"{IS_DISABLED_DESCENT}\n"
        self.assertNotIn("{", IS_DISABLED_DESCENT)
        self.assertNotIn("}", IS_DISABLED_DESCENT)
        self.assertNotIn("return ", IS_DISABLED_DESCENT)
        self.assertNotIn("return bDisabledDescent", IS_DISABLED_DESCENT)
        self.assertNotIn("return bDisabledDescent", locked_only)
        self.assertNotIn(
            "ASkyguardLifelineHunterBoss::IsDisabledDescent",
            IS_DISABLED_DESCENT,
        )
        ...
        self.assertNotIn("return false", IS_DISABLED_DESCENT)
        self.assertNotIn("return true", IS_DISABLED_DESCENT)
    ...
    def test_contract_does_not_relock_open_sensor_exposure_sibling(self) -> None:
        ...
        for token in OPEN_SENSOR_EXPOSURE_NOT_LOCKED:
            ...
            self.assertNotIn(token, IS_DISABLED_DESCENT)
        self.assertNotIn("OpenSensorExposure", IS_DISABLED_DESCENT)
    ...
    def test_contract_does_not_relock_get_friendly_separation_meters_sibling(
        self,
    ) -> None:
        locked_only = f"{IS_DISABLED_DESCENT}\n"
        for token in GET_FRIENDLY_SEPARATION_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_DISABLED_DESCENT)
        self.assertNotIn("GetFriendlySeparationMeters", IS_DISABLED_DESCENT)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_open_safe_window(), IS_DISABLED_DESCENT)
        ...
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, IS_DISABLED_DESCENT)
    ...
    def test_contract_does_not_relock_weak_point_fields(self) -> None:
        ...
        self.assertNotIn("OpticalTracker", IS_DISABLED_DESCENT)
        self.assertNotIn("WeaponServo", IS_DISABLED_DESCENT)
        self.assertNotIn("CountermeasurePod", IS_DISABLED_DESCENT)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_DISABLED_DESCENT)
        self.assertNotIn("SetSearchlightTracked", IS_DISABLED_DESCENT)
        self.assertNotIn("IsSearchlightTracked", IS_DISABLED_DESCENT)
        self.assertNotIn("ASkyguardBlackKiteBoss", IS_DISABLED_DESCENT)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_DISABLED_DESCENT)
        self.assertNotIn("SetContactIdentified", IS_DISABLED_DESCENT)
        self.assertNotIn("IsContactIdentified", IS_DISABLED_DESCENT)
        self.assertNotIn("OpenOrbitExposure", IS_DISABLED_DESCENT)
    ...
    def test_contract_does_not_relock_mount_getters(self) -> None:
        ...
        for token in MOUNT_GETTERS_NOT_LOCKED:
            ...
            self.assertNotIn(token, IS_DISABLED_DESCENT)
        self.assertNotIn("GetGunnerMount", IS_DISABLED_DESCENT)
        self.assertNotIn("GetChinTurret", IS_DISABLED_DESCENT)
        self.assertNotIn("GetSensorTurret", IS_DISABLED_DESCENT)

    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        locked_only = f"{IS_DISABLED_DESCENT}\n"
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, IS_DISABLED_DESCENT)
        self.assertNotIn("GetChinMuzzleLocation", IS_DISABLED_DESCENT)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_DISABLED_DESCENT)
        self.assertNotIn("ESkyguardApacheSystem", IS_DISABLED_DESCENT)
    ...
    def test_contract_does_not_relock_leftover_input_capture(self) -> None:
        ...
        self.assertNotIn("RecordPlayerEvent", IS_DISABLED_DESCENT)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_DISABLED_DESCENT)
        self.assertNotIn("ASkyguardGunner", IS_DISABLED_DESCENT)
        self.assertNotIn("FillAndFinalize", IS_DISABLED_DESCENT)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_DISABLED_DESCENT)
        self.assertNotIn("SkyguardRadarNode", IS_DISABLED_DESCENT)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", IS_DISABLED_DESCENT)
        self.assertNotIn("USkyguardBriefingWidget", IS_DISABLED_DESCENT)
        self.assertNotIn(
            "test_debrief_widget_travel_next_decl_contract.py",
            IS_DISABLED_DESCENT,
        )
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, IS_DISABLED_DESCENT)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", IS_DISABLED_DESCENT)
        self.assertNotIn("ESkyguardMissionSkylineStyle", IS_DISABLED_DESCENT)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_DISABLED_DESCENT)
        self.assertNotIn("MinHeightFromOriginCm", IS_DISABLED_DESCENT)
        self.assertNotIn("MaxIntegrity", IS_DISABLED_DESCENT)
        self.assertNotIn("SkyguardApacheAircraft.h", IS_DISABLED_DESCENT)
        self.assertNotIn("SkyguardPathfinder", IS_DISABLED_DESCENT)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, IS_DISABLED_DESCENT)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", IS_DISABLED_DESCENT)
    ...
    def test_minimum_weapon_separation_is_not_harbor_40_80(self) -> None:
        ...
        self.assertNotIn(adjacent, IS_DISABLED_DESCENT)
        self.assertNotIn("MinimumWeaponSeparationMeters", IS_DISABLED_DESCENT)
        self.assertNotIn("450.f", IS_DISABLED_DESCENT)
        for token in leftover_harbor_tokens():
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{IS_DISABLED_DESCENT}\n"
        self.assertEqual(
            require_declaration(locked_only, IS_DISABLED_DESCENT),
            IS_DISABLED_DESCENT,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "lifeline hunter IsDisabledDescent contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, IS_DISABLED_DESCENT.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                IS_DISABLED_DESCENT.lower(),
                "lifeline hunter IsDisabledDescent contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, IS_DISABLED_DESCENT)

    def test_contract_is_is_disabled_descent_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertNotIn("return bDisabledDescent", IS_DISABLED_DESCENT)
        self.assertNotIn("{", IS_DISABLED_DESCENT)
        self.assertTrue(IS_DISABLED_DESCENT.startswith("bool "))
        self.assertTrue(IS_DISABLED_DESCENT.endswith(";"))
        self.assertIn(" const", IS_DISABLED_DESCENT)
        self.assertIn(UFUNCTION_BOSS, section)
