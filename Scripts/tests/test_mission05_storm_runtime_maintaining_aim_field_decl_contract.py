...
# bMaintainingAim FIELD (declaration-only;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission05 StormRuntime
# bMaintainingAim. THIS IS NOT leftover storm-runtime-
...
# Turbulence #1150 / bLightningActive #1151 /
# LightningRemainingSeconds #1152 / LightningFlashCount
# #1153. LOCK those sibling scripts. THIS IS NOT leftover
# Mission05 PTR Target #1147 / Integrity #1148 /
# bDestroyed #1149. THIS IS NOT leftover Mission05
...
# merge #665 #666 #668-#673, or open drafts #674-#1153.
...
# This StormRuntime field sits last in the public
# section, after LightningFlashCount. Skip leftover
# b + Ya + kRuntimeReady forever (it sits after
# bMapAssemblyReady and before bGunnerReady). This contract
# is bMaintainingAim after LightningFlashCount. THIS IS NOT leftover Mission08
...
# drafts #674-#1153 including leftover Mission02
...
# drafts #674-#1153. Do not reopen leftover
...
MAINTAINING_AIM_TRUE = (
    "bool bMaintainingAim = true;"
)
LOCKED_DECL = MAINTAINING_AIM
...
# an isolated Python bMaintainingAim
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission05_storm_runtime_lightning_flash_count_field_decl_contract.py",
...
class Mission05StormRuntimeMaintainingAimFieldDeclContractTests(unittest.TestCase):
    def test_mission05_storm_runtime_struct_exists(self) -> None:
        ...
        self.assertIn("LightningFlashCount", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bMaintainingAim", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_maintaining_aim_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_maintaining_aim_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bMaintainingAim"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bMaintainingAim", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bMaintainingAim", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bMaintainingAim"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bMaintainingAim", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 StormRuntime Turbulence field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 StormRuntime bMaintainingAim contains "
    ...
    def test_contract_is_maintaining_aim_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_maintaining_aim(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            ...
            "_maintaining_aim_field_decl_contract.py"
        )
