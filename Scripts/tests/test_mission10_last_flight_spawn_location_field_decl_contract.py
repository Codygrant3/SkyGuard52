...
# INDEX_NONE or lock LastFlightSpawnLocation
# construction in the .cpp. This is leftover-safe
# Mission10 LastFlightSpawnLocation FIELD
...
LOCKED_DECL = LAST_FLIGHT_SPAWN_LOCATION
...
# an isolated Python LastFlightSpawnLocation
...
class Mission10LastFlightSpawnLocationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_auto_launch_after_briefing_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FVector LastFlightSpawnLocation"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= FVector(81000.f, -13000.f, 7800.f);"), LOCKED_DECL)
        self.assertIn("LastFlightSpawnLocation", LOCKED_DECL)
        self.assertIn("FVector ", LOCKED_DECL)
        self.assertIn("= FVector(81000.f, -13000.f, 7800.f)", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("LastFlightSpawnLocation", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FVector LastFlightSpawnLocation"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("LastFlightSpawnLocation", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 LastFlightSpawnLocation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission10 LastFlightSpawnLocation contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_last_flight_spawn_location(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_last_flight_spawn_location_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
