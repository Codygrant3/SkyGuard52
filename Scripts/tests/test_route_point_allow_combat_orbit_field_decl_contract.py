...
# the type is not bool, if Category= is added, if the
# initializer is missing or not `= true` (reject false /
# 1 / 0), or if Harbor 40/80 appears in the accepted decl.
# Accept one-line and split-line UPROPERTY wraps.
# Parse STRUCT `FSkyguardRoutePoint` body ONLY after
# `struct FSkyguardRoutePoint`. Stop at
# `struct FSkyguardRouteDefinition` and later structs.
# Do NOT parse `FSkyguardRouteDefinition` (leftover
# route-definition-fields #192 / #dbff).
# Do NOT parse `USkyguardMissionDefinition` (leftover
# mission-definition field decls #350+).
# Do NOT parse leftover route-point-defaults #180 / #0ac5.
# Do NOT parse leftover mission-types-defaults-tests #153 / #f47d
# (keep that bulk file in LOCKED_SCRIPTS).
# Do NOT contract sibling fields PointId / WorldLocation /
# TargetAirspeedKph / LookAheadSeconds.
# PointId leftover draft being opened
# cursor/route-point-point-id-field-decl-contract-c332
# (`FName PointId;` no initializer).
# WorldLocation leftover draft being opened
# cursor/route-point-world-location-field-decl-contract-c332
# (`FVector WorldLocation = FVector::ZeroVector;`).
# TargetAirspeedKph in-flight
# cursor/route-point-target-airspeed-kph-field-decl-contract-c332
# (`float TargetAirspeedKph = 220.f;`).
# LookAheadSeconds in-flight
# cursor/route-point-look-ahead-seconds-field-decl-contract-c332
# (`float LookAheadSeconds = 2.f;`).
# Do NOT reopen leftover RadioLine isolated fields #1332-#1338.
# Do NOT reopen leftover radio-line-defaults #172 / #1dec,
# leftover radio-chatter empty fail-closed, leftover TheaterKit
# #1299-#1331, leftover #59. Keep leftover bulk
# test_campaign_theater_kit_contract.py locked.
# Analog: leftover route-point-defaults #180 then this isolated
# bAllowCombatOrbit decl, same as leftover radio-line-defaults
# #172 then isolated RadioLine fields, same as leftover
# briefing-card-defaults then CardId.
# If a clone asserts FName / FText / FVector / float / no `=` /
# Category="Skyguard|Theater" / VisibleAnywhere /
# BlueprintReadWrite / ClampMin / `= FVector::ZeroVector`,
# retarget: type is bool, initializer is `= true`,
...
STRUCT_NAME = "FSkyguardRoutePoint"
COMPONENT_NAME = "USkyguardMissionDefinition"
ACTOR_NAME = "ASkyguardCampaignTheaterKit"
NAMESPACE_NAME = "SkyguardCampaignTheaterKit"
TARGET = "bool bAllowCombatOrbit = true;"
TARGET_WRONG_EQ_NONE = "bool bAllowCombatOrbit = false;"
TARGET_WRONG_FALSE = "bool bAllowCombatOrbit = false;"
TARGET_WRONG_TRUE = "bool bAllowCombatOrbit = 1;"
TARGET_WRONG_ZERO = "bool bAllowCombatOrbit = 0;"
TARGET_WRONG_FLOAT = "float bAllowCombatOrbit = 1.f;"
TARGET_WRONG_HEALTH = "float Health = 160.f;"
TARGET_WRONG_EMPTY = "bool bAllowCombatOrbit;"
TARGET_WRONG_TWO = "bool bAllowCombatOrbit = True;"
TARGET_WRONG_TWO_POINT_ZERO = (
    "int32 bAllowCombatOrbit = 1;"
)
...
UPROPERTY_EDIT_WRITE = UPROPERTY_EDIT_READONLY
UPROPERTY_VISIBLE_READONLY = UPROPERTY_EDIT_READONLY
STOP_BEFORE_ROUTE_DEF = "struct FSkyguardRouteDefinition"
STOP_BEFORE_MISSION_DEF = "USkyguardMissionDefinition"
STOP_BEFORE_DELEGATE = STOP_BEFORE_ROUTE_DEF
STOP_BEFORE_COMPONENT = STOP_BEFORE_MISSION_DEF
STOP_BEFORE_NAMESPACE = STOP_BEFORE_ROUTE_DEF
STOP_BEFORE_ACTOR = STOP_BEFORE_MISSION_DEF
...
SIBLING_POINT_ID = "PointId"
SIBLING_WORLD_LOCATION = "WorldLocation"
SIBLING_TARGET_AIRSPEED = "TargetAirspeedKph"
SIBLING_LOOK_AHEAD = "LookAheadSeconds"
SIBLING_LINE_ID = SIBLING_POINT_ID
SIBLING_SPEAKER = SIBLING_TARGET_AIRSPEED
SIBLING_SUBTITLE = SIBLING_LOOK_AHEAD
SIBLING_SOUND = SIBLING_WORLD_LOCATION
SIBLING_PRIORITY = SIBLING_POINT_ID
SIBLING_COOLDOWN = SIBLING_TARGET_AIRSPEED
SIBLING_KIT_ID = SIBLING_POINT_ID
SIBLING_LANDMARK_SET = SIBLING_TARGET_AIRSPEED
SIBLING_BUILDING_KIT = SIBLING_LOOK_AHEAD
SIBLING_BUILDING_TINT = SIBLING_WORLD_LOCATION
SIBLING_LAMP_TREATMENT = SIBLING_POINT_ID
SIBLING_LAMP_COLOR = SIBLING_TARGET_AIRSPEED
SIBLING_LAMP_INTENSITY = SIBLING_LOOK_AHEAD
SIBLING_ROAD_TREATMENT = SIBLING_WORLD_LOCATION
SIBLING_ROAD_TINT = SIBLING_POINT_ID
SIBLING_NAMED_LANDMARK = SIBLING_TARGET_AIRSPEED
SIBLING_LANDMARK_TINT = SIBLING_LOOK_AHEAD
SIBLING_SILHOUETTE_KIT = SIBLING_WORLD_LOCATION
SIBLING_SILHOUETTE_TINT = SIBLING_POINT_ID
SIBLING_LANDMARK_MESH_INDEX = SIBLING_TARGET_AIRSPEED
SIBLING_LANDMARK_SCALE = SIBLING_LOOK_AHEAD
...
LEFTOVER_ROUTE_POINT_AIRSPEED = (
    "Scripts/tests/test_route_point_target_airspeed_kph"
    "_field_decl_contract.py"
)
LEFTOVER_ROUTE_POINT_LOOK_AHEAD = (
...
LEFTOVER_RADIO_LINE_ESTIMATED_DURATION = (
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_theater_kit_spec_landmark_set_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_spec_building_kit_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_spec_building_tint_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_spec_lamp_treatment_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_spec_lamp_color_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_spec_lamp_intensity_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_spec_road_treatment_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_spec_road_tint_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_spec_named_landmark_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_spec_landmark_tint_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_spec_silhouette_kit_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_spec_silhouette_tint_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_spec_landmark_mesh_index_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_spec_landmark_scale_field_decl_contract.py",
    ...
    "Scripts/tests/test_theater_kit_building_instances_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_road_instances_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_lamp_instances_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_silhouette_instances_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_named_landmark_mesh_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_applied_spec_field_decl_contract.py",
    "Scripts/tests/test_theater_kit_get_applied_kit_id_decl_contract.py",
    "Scripts/tests/test_theater_kit_get_applied_weather_identity_decl_contract.py",
    "Scripts/tests/test_theater_kit_get_building_tint_decl_contract.py",
    "Scripts/tests/test_theater_kit_get_named_landmark_decl_contract.py",
    "Scripts/tests/test_theater_kit_get_applied_spec_decl_contract.py",
    "Scripts/tests/test_theater_kit_get_building_instance_count_decl_contract.py",
    "Scripts/tests/test_theater_kit_get_road_instance_count_decl_contract.py",
    "Scripts/tests/test_theater_kit_get_silhouette_instance_count_decl_contract.py",
    "Scripts/tests/test_theater_kit_get_lamp_instance_count_decl_contract.py",
    "Scripts/tests/test_theater_kit_apply_theater_kit_decl_contract.py",
    "Scripts/tests/test_radio_chatter_empty_fail_closed.py",
    "Scripts/tests/test_radio_chatter_empty_fail_closed_tests.py",
    "Scripts/tests/test_radio_chatter_empty_fail_closed_contract.py",
    "Scripts/tests/test_radio_chatter_empty_queue_fail_closed.py",
...
def leftover_component_tokens() -> tuple[str, ...]:
    return (
        "PrimeLines",
        "EnqueueLine",
        "AdvanceRadioState",
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # Reject missing initializer, false / 1 / 0 /
    # Harbor 40/80 / leftover Health / bare bool.
    # Do not accept sibling PointId / WorldLocation /
    # TargetAirspeedKph / LookAheadSeconds fields.
    if not has_one_declaration(region, declaration):
        return False
    compact = collapsed(region)
    if re.search(
        r"bool\s+bAllowCombatOrbit\s*=\s*true\s*;",
        compact,
    ) is None:
        return False
    if re.search(
        r"bool\s+bAllowCombatOrbit\s*=\s*false\b",
        compact,
    ):
        return False
    if re.search(
        r"bool\s+bAllowCombatOrbit\s*=\s*1\b",
        compact,
    ):
        return False
    if re.search(
        r"bool\s+bAllowCombatOrbit\s*=\s*0\b",
        compact,
    ):
        return False
    if re.search(
        r"bool\s+bAllowCombatOrbit\s*;",
        compact,
    ):
        return False
    if re.search(
        r"float\s+bAllowCombatOrbit\b",
        compact,
    ):
        return False
    if re.search(
        r"FName\s+bAllowCombatOrbit\b",
        compact,
    ):
        return False
    if re.search(
        r"FVector\s+bAllowCombatOrbit\b",
        compact,
    ):
        return False
    if re.search(
        r"int32\s+bAllowCombatOrbit\b",
        compact,
    ):
        return False
    if re.search(
        r"FText\s+bAllowCombatOrbit\b",
        compact,
    ):
        return False
    return True
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    while True:
        ...
        if depth == 0 and re.match(
            r"\s*bool\s+bAllowCombatOrbit\b", compact[index:]
        ):
            return compact[start : index - 1]
        cursor = cursor + match.start() + 1
    raise AssertionError(
        "UPROPERTY for bool bAllowCombatOrbit is missing from "
...
class RoutePointAllowCombatOrbitFieldDeclContractTests(unittest.TestCase):
    def test_route_point_struct_exists(self) -> None:
        ...
        self.assertTrue(
            has_identifier(section, "bAllowCombatOrbit"),
            section,
        )
        self.assertIn("UPROPERTY", section)
        self.assertIn(STOP_BEFORE_ROUTE_DEF, header)
        self.assertNotIn(STOP_BEFORE_ROUTE_DEF, section)
        self.assertNotIn(STOP_BEFORE_ROUTE_DEF, body)
        ...
        self.assertNotIn("struct FSkyguardObjectiveDefinition", section)
        self.assertNotIn("struct FSkyguardObjectiveDefinition", body)
        self.assertIn("RouteId", header)
        self.assertNotIn("RouteId", section)
        self.assertNotIn("RouteId", body)
    ...
    def test_actor_or_namespace_declaration_does_not_satisfy(self) -> None:
        mixed = (
            ...
            "{{\n"
            f"\tconst FSkyguardRouteDefinition& {RESOLVE}"
        ...
        self.assertIn("bAllowCombatOrbit", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_missing_allow_combat_orbit_declaration_fails_closed(self) -> None:
        empty = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            f"\tFName {SIBLING_KIT_ID};\n"
            "};\n"
        )
    ...
    def test_wrong_or_missing_initializer_fails_closed(self) -> None:
        ...
        self.assertNotIn(
            "bAllowCombatOrbit = 0.f",
            compact_origin,
        )
        self.assertNotIn(
            "bAllowCombatOrbit = 160.f",
            compact_origin,
        )
        self.assertNotIn(
            "bAllowCombatOrbit = FVector::ZeroVector",
            compact_origin,
        )

    def test_allow_combat_orbit_declaration_matches_origin_main(self) -> None:
        section = spec_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
    ...
    def test_wrong_default_and_renames_do_not_satisfy(self) -> None:
        ...
        wrongs = (
            ...
            leftover_guided,
            f"\tFName {SIBLING_KIT_ID};\n",
            "\tbool bAllowCombatOrbi = true;\n",
            "\tint32 bAllowCombatOrbit = 2;\n",
            "\tFName bAllowCombatOrbit;\n",
            "\tFText bAllowCombatOrbit;\n",
            f"\t{TARGET_WRONG_TWO}\n",
            f"\t{TARGET_WRONG_TWO_POINT_ZERO}\n",
            f"\t{TARGET_WRONG_EMPTY}\n",
            "\tbool bAllowCombatOrbit = " + forty + ";\n",
            "\tbool bAllowCombatOrbit = " + eighty + ";\n",
            "\tFName PointId;\n",
            "\tFVector WorldLocation = FVector::ZeroVector;\n",
            "\tfloat TargetAirspeedKph = 220.f;\n",
            "\tfloat LookAheadSeconds = 2.f;\n",
    ...
    def test_dropped_edit_anywhere_or_read_only_fails_closed(self) -> None:
        ...
        self.assertIn("EditAnywhere", dropped)
        self.assertIn("BlueprintReadWrite", dropped)
        self.assertNotIn("BlueprintReadOnly", dropped)
        self.assertIn("BlueprintReadOnly", origin)
        no_edit = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
        ...
        no_edit_specs = attached_uproperty_specifiers(
            spec_section(no_edit)
        )
        self.assertNotIn("EditAnywhere", no_edit_specs)
        self.assertIn("EditAnywhere", origin)
        visible_only = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
        ...
        visible_specs = attached_uproperty_specifiers(
            spec_section(visible_only)
        )
        self.assertIn("VisibleAnywhere", visible_specs)
        self.assertIn("BlueprintReadOnly", visible_specs)
        self.assertNotIn("EditAnywhere", visible_specs)
        self.assertNotIn("BlueprintReadWrite", visible_specs)
        self.assertIn("EditAnywhere", origin)
        self.assertIn("BlueprintReadOnly", origin)
        campaign = (
            f"struct {STRUCT_NAME}\n"
        ...
        clamp_specs = attached_uproperty_specifiers(
            spec_section(added_clamp)
        )
        self.assertIn("ClampMin", clamp_specs)
        self.assertNotIn("ClampMin", origin)
        harbor = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            "\tbool bAllowCombatOrbit = "
            + "40" + ".f;\n"
            "};\n"
        )
        harbor_section = spec_section(harbor)
        with self.assertRaises(AssertionError):
            require_declaration(harbor_section, LOCKED_DECL)
    ...
    def test_does_not_contract_sibling_route_point_fields(self) -> None:
        for sibling in sibling_uncontracted_decls():
            self.assertNotIn(sibling, LOCKED_DECL)
        for field in leftover_neighbor_hit_fields():
            self.assertNotIn(field, LOCKED_DECL)
    ...
    def test_does_not_parse_actor_namespace_or_neighbors(self) -> None:
        header = origin_main_header()
        section = spec_section(header)
        leaked = struct_body(header)
        self.assertIn(STOP_BEFORE_ROUTE_DEF, header)
        self.assertNotIn(STOP_BEFORE_ROUTE_DEF, section)
        self.assertNotIn(STOP_BEFORE_ROUTE_DEF, leaked)
        self.assertNotIn(COMPONENT_NAME, header)
        self.assertNotIn(COMPONENT_NAME, section)
        ...
        self.assertIn("struct FSkyguardObjectiveDefinition", header)
        self.assertNotIn("struct FSkyguardObjectiveDefinition", section)
        self.assertNotIn("struct FSkyguardObjectiveDefinition", leaked)
        self.assertNotIn(ACTOR_NAME, header)
        self.assertNotIn(ACTOR_NAME, section)
        self.assertNotIn(ACTOR_NAME, leaked)
        self.assertNotIn(STOP_BEFORE_APPLY, header)
        self.assertNotIn(STOP_BEFORE_APPLY, section)
        self.assertNotIn(STOP_BEFORE_APPLY, leaked)
        for helper in leftover_component_tokens():
            self.assertNotIn(helper, header)
            self.assertNotIn(helper, section)
            self.assertNotIn(helper, leaked)
        self.assertIn("RouteId", header)
        self.assertNotIn("RouteId", section)
        self.assertNotIn("RouteId", leaked)
    ...
    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        ...
        self.assertNotIn("meta=", UPROPERTY_EDIT_READONLY)
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertNotIn("SkyguardMissionDefinition.h", HEADER_PATH)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "route-point bAllowCombatOrbit field decl "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(LEFTOVER_RADIO_LINE_SUBTITLE, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_RADIO_LINE_LINE_ID, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_RADIO_LINE_SPEAKER, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_RADIO_LINE_SOUND, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_RADIO_LINE_PRIORITY, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_RADIO_LINE_COOLDOWN, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_RADIO_LINE_ESTIMATED_DURATION, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_PILOT_MAKE_RADIO_LINE, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_ROUTE_POINT_DEFAULTS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_ROUTE_POINT_DEFAULTS_PY, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_ROUTE_POINT_DEFAULTS_TESTS, LOCKED_SCRIPTS)
        ...
        self.assertIn(LEFTOVER_ROUTE_POINT_AIRSPEED, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_ROUTE_POINT_LOOK_AHEAD, LOCKED_SCRIPTS)
        ...
        self.assertIn(LEFTOVER_MISSION_DEFINITION_OBJECTIVES, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_MISSION_DEFINITION_WAVES, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_MISSION_DEFINITION_WEATHER, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_MISSION_DEFINITION_SCORE_RULES, LOCKED_SCRIPTS)
        self.assertTrue(Path(__file__).name.endswith(
            "allow_combat_orbit_field_decl_contract.py"
        ))
        self.assertNotIn("SkyguardCampaignTheaterKit.cpp", THIS_SCRIPT)
    ...
    def test_contract_is_target_field_declaration_only(self) -> None:
        ...
        self.assertNotIn(STOP_BEFORE_ROUTE_DEF, locked_only)
        self.assertNotIn(STOP_BEFORE_MISSION_DEF, locked_only)
        self.assertNotIn("FSkyguardRouteDefinition", locked_only)
        self.assertNotIn("USkyguardMissionDefinition", locked_only)
        self.assertNotIn("PointId", locked_only)
        self.assertNotIn("WorldLocation", locked_only)
        self.assertNotIn("TargetAirspeedKph", locked_only)
        self.assertNotIn("LookAheadSeconds", locked_only)
        for helper in namespace_helper_tokens():
