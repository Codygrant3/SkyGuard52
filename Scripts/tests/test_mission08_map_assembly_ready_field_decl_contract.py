...
# Mission08 IntegrationReadiness bMapAssemblyReady
...
# cursor/mission07-map-assembly-ready-field-
# decl-contract-c332, NOT leftover Mission08
# director Root #1044 through
# MaximumProtectedTargetIntegrity #1065 /
# leftover director Readiness #1066, NOT leftover
# Mission08 bMissionDefinitionValid #1067 /
# leftover Mission08 bCampaignDefinitionValid
# #1068, NOT leftover Mission08 Blueprint
# UFUNCTION methods #729-#749, NOT leftover
# Mission07 readiness-struct bMissionDefinitionValid
# #1028 through SearchTrackCount #1043, NOT leftover
# this-wave sibling bGunnerReady / branch
# cursor/mission08-gunner-ready-field-decl-
# contract-c332. Skip leftover b + Ya +
# kRuntimeReady forever (it sits immediately
# after bMapAssemblyReady, before bGunnerReady).
# Skip leftover retired-mount spawn forever.
# NOT leftover Mission06 bMapAssemblyReady
# FIELD #998 / branch cursor/mission06-
...
# leftover MaximumProtectedTargetIntegrity #1065 /
# leftover director Readiness #1066 / leftover
# bMissionDefinitionValid #1067 / leftover
# bCampaignDefinitionValid #1068 / leftover
# Mission08 Blueprint UFUNCTION methods #729-#749,
# leftover Mission07 director fields through Root #1011 /
# leftover Mission07 director Briefing #1012 /
# AudioDirector #1013 / SortiePresentation #1014 /
# CampaignDefinition #1015 / RadioChatter #1016 /
...
# CampaignSaveUserIndex #1022 / RadarGhostSpawnLocation
# #1023 / RadarGhostSpawnRotation #1024 /
# MaximumProtectedTargetIntegrity #1025 /
# ReinforcementDeadlineSeconds #1026 / leftover director
# Readiness #1027 / leftover bMissionDefinitionValid
# (in-flight) / leftover bCampaignDefinitionValid
# (this-wave sibling),
...
# drafts #674-#993 including leftover Mission02
...
# Do not parse leftover ASkyguardMission06IntegrationDirector
...
# drafts #674-#993. Do not reopen leftover
...
THIS_WAVE_GUNNER_READY_NOT_LOCKED = (
...
class Mission08MapAssemblyReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 bMapAssemblyReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission07 bMapAssemblyReady contains "
    ...
    def test_contract_does_not_parse_director_class_or_storm_runtime(
        ...
        for token in LEFTOVER_MISSION08_CAMPAIGN_DEFINITION_VALID_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION08_READINESS_FIELD_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION08_MAXIMUM_PROTECTED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in THIS_WAVE_GUNNER_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
