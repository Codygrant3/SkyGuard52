...
# INDEX_NONE or lock OceanTiles construction in
# the .cpp. This is a FIELD contract on
# ASkyguardMission01EnvironmentDirector, the first
# environment-director tile field. Do not lock
# sibling environment fields Root / BeachTiles /
...
# Integration director fields (#568/#572/#574-#582),
...
# OceanTiles;`); accept that form and other
...
# Stay off leftover drafts #56–#64 / #107–#582,
...
# OceanTiles field declaration contract on
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission01EnvironmentDirector::OceanTiles",
    "SkyguardMission01EnvironmentDirector.cpp",
...
class Mission01OceanTilesFieldDeclContractTests(unittest.TestCase):
    def test_mission01_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, OCEAN_TILES_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, OCEAN_TILES_FIELD)
        self.assertIn("OceanTiles", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(has_declaration(section, OCEAN_TILES_FIELD))

    def test_missing_ocean_tiles_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission01EnvironmentDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BEACH_TILES_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, OCEAN_TILES_FIELD)
        self.assertIn("OceanTiles", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, OCEAN_TILES_FIELD)
        self.assertIn("OceanTiles", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UPROPERTY", OCEAN_TILES_FIELD)
        self.assertNotIn("VisibleAnywhere", OCEAN_TILES_FIELD)
        self.assertNotIn("BlueprintReadOnly", OCEAN_TILES_FIELD)
        self.assertNotIn("Category", OCEAN_TILES_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, OCEAN_TILES_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, OCEAN_TILES_FIELD)
        self.assertIn("OceanTiles", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUHierarchicalInstancedStaticMeshComponent* OceanTiles;\n"
        )
        as_array = (
            "\tTArray<TObjectPtr<"
        ...
        scene = "\tTObjectPtr<USceneComponent> OceanTiles;\n"
        static_mesh = (
            "\tTObjectPtr<UStaticMeshComponent> OceanTiles;\n"
        )
        weak = (
            "\tTWeakObjectPtr<"
            "UHierarchicalInstancedStaticMeshComponent> "
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, OCEAN_TILES_FIELD)
            self.assertIn("OceanTiles", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_ocean_tiles_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, OCEAN_TILES_FIELD),
            OCEAN_TILES_FIELD,
        )
        self.assertTrue(has_declaration(section, OCEAN_TILES_FIELD))
        self.assertEqual(
            declaration_count(section, OCEAN_TILES_FIELD),
            1,
        )
        self.assertTrue(
            OCEAN_TILES_FIELD.startswith(
                "TObjectPtr<UHierarchicalInstancedStaticMeshComponent> "
            ),
            OCEAN_TILES_FIELD,
        )
        self.assertTrue(OCEAN_TILES_FIELD.endswith(";"), OCEAN_TILES_FIELD)
        self.assertIn("OceanTiles", OCEAN_TILES_FIELD)
        self.assertIn(
            "UHierarchicalInstancedStaticMeshComponent",
            OCEAN_TILES_FIELD,
        )
        self.assertIn("TObjectPtr<", OCEAN_TILES_FIELD)
        self.assertNotIn("TArray<", OCEAN_TILES_FIELD)
        self.assertNotIn("TSoftObjectPtr", OCEAN_TILES_FIELD)
        self.assertNotIn("=", OCEAN_TILES_FIELD)
        self.assertNotIn("INDEX_NONE", OCEAN_TILES_FIELD)
        self.assertNotIn("UFUNCTION", OCEAN_TILES_FIELD)
        self.assertNotIn("{", OCEAN_TILES_FIELD)
        self.assertNotIn("}", OCEAN_TILES_FIELD)
        self.assertNotIn("return ", OCEAN_TILES_FIELD)
        self.assertNotIn("BeachTiles", OCEAN_TILES_FIELD)
        self.assertNotIn("LandTiles", OCEAN_TILES_FIELD)
        self.assertNotIn("RouteExclusion", OCEAN_TILES_FIELD)
        self.assertNotIn("LandScatterBounds", OCEAN_TILES_FIELD)
        self.assertNotIn("InlandVegetationPCG", OCEAN_TILES_FIELD)
        self.assertNotIn("ProductionLandscape", OCEAN_TILES_FIELD)
        self.assertNotIn("AuthoredPCGGraph", OCEAN_TILES_FIELD)
        self.assertNotIn("GetReadiness", OCEAN_TILES_FIELD)
        self.assertNotIn("Briefing", OCEAN_TILES_FIELD)
        self.assertNotIn("AudioDirector", OCEAN_TILES_FIELD)
        self.assertNotIn("RadioChatter", OCEAN_TILES_FIELD)
        self.assertNotIn("SortiePresentation", OCEAN_TILES_FIELD)
        self.assertNotIn("CampaignDefinition", OCEAN_TILES_FIELD)
        self.assertNotIn("MissionDefinition", OCEAN_TILES_FIELD)
        self.assertNotIn("Readiness", OCEAN_TILES_FIELD)
        self.assertNotIn("bAllowBoundedActorSpawning", OCEAN_TILES_FIELD)
        self.assertNotIn("bAutoLaunchAfterBriefing", OCEAN_TILES_FIELD)
        self.assertNotIn("PathfinderSpawnLocation", OCEAN_TILES_FIELD)
        self.assertNotIn("GetAircraft", OCEAN_TILES_FIELD)
        self.assertNotIn("ConfigureFromMission", OCEAN_TILES_FIELD)
        self.assertNotIn("AdvanceBriefing", OCEAN_TILES_FIELD)
        self.assertNotIn("SetAssetsReady", OCEAN_TILES_FIELD)
        self.assertNotIn("AcknowledgeAndLaunch", OCEAN_TILES_FIELD)
        self.assertNotIn("CanLaunch", OCEAN_TILES_FIELD)
        self.assertNotIn("GetElapsedSeconds", OCEAN_TILES_FIELD)
        self.assertNotIn("GetBriefingState", OCEAN_TILES_FIELD)
        self.assertNotIn("GetMinimumWarmupSeconds", OCEAN_TILES_FIELD)
        self.assertNotIn("GetBriefingText", OCEAN_TILES_FIELD)
        self.assertNotIn("GetRadioChatter", OCEAN_TILES_FIELD)
        self.assertNotIn("GetPresentation", OCEAN_TILES_FIELD)
        self.assertNotIn("GetMissionTitle", OCEAN_TILES_FIELD)
        self.assertNotIn("AcknowledgeBriefing", OCEAN_TILES_FIELD)
        self.assertNotIn("LaunchSortie", OCEAN_TILES_FIELD)
        self.assertNotIn("HullCollider", OCEAN_TILES_FIELD)
        self.assertNotIn("OpticalTracker", OCEAN_TILES_FIELD)
        self.assertNotIn("WeaponServo", OCEAN_TILES_FIELD)
        self.assertNotIn("CountermeasurePod", OCEAN_TILES_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", OCEAN_TILES_FIELD)
        self.assertNotIn("RadarNode", OCEAN_TILES_FIELD)
        self.assertNotIn("ESkyguardMission02WaveState", OCEAN_TILES_FIELD)
        self.assertNotIn("HarborIndustrial", OCEAN_TILES_FIELD)
        self.assertNotIn("MaxIntegrity", OCEAN_TILES_FIELD)
        self.assertNotIn("CurrentIntegrity", OCEAN_TILES_FIELD)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, OCEAN_TILES_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_ENVIRONMENT} {OCEAN_TILES_FIELD}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{OCEAN_TILES_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, OCEAN_TILES_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, OCEAN_TILES_FIELD),
            section,
    ...
    def test_assigned_ocean_tiles_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<UHierarchicalInstancedStaticMeshComponent> "
            "OceanTiles = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, OCEAN_TILES_FIELD)
        self.assertIn("OceanTiles", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, OCEAN_TILES_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("OceanTiles", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, OCEAN_TILES_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{OCEAN_TILES_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, OCEAN_TILES_FIELD)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            OCEAN_TILES_FIELD.startswith("UFUNCTION"),
            OCEAN_TILES_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", OCEAN_TILES_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_ocean_tiles_cpp_body(self) -> None:
        locked_only = f"{OCEAN_TILES_FIELD}\n"
        self.assertNotIn("{", OCEAN_TILES_FIELD)
        self.assertNotIn("}", OCEAN_TILES_FIELD)
        self.assertNotIn("return ", OCEAN_TILES_FIELD)
        ...
        self.assertNotIn("return false", OCEAN_TILES_FIELD)
        self.assertNotIn("return true", OCEAN_TILES_FIELD)
        self.assertNotIn("CreateDefaultSubobject", OCEAN_TILES_FIELD)
    ...
    def test_contract_does_not_relock_sibling_environment_fields(self) -> None:
        ...
        for token in SIBLING_ENVIRONMENT_FIELDS_NOT_LOCKED:
            ...
            self.assertNotIn(token, OCEAN_TILES_FIELD)
        self.assertIn("OceanTiles", OCEAN_TILES_FIELD)
        self.assertIn(
            "UHierarchicalInstancedStaticMeshComponent",
            OCEAN_TILES_FIELD,
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, OCEAN_TILES_FIELD)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", OCEAN_TILES_FIELD)
        self.assertNotIn("CurrentIntegrity", OCEAN_TILES_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", OCEAN_TILES_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, OCEAN_TILES_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", OCEAN_TILES_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{OCEAN_TILES_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, OCEAN_TILES_FIELD),
            OCEAN_TILES_FIELD,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, OCEAN_TILES_FIELD)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertEqual(declaration_count(section, OCEAN_TILES_FIELD), 1)
        self.assertNotIn(
            "SkyguardMission01EnvironmentDirector.cpp",
            section,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 OceanTiles field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{OCEAN_TILES_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, OCEAN_TILES_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                OCEAN_TILES_FIELD.lower(),
                "mission01 OceanTiles contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live cop" + "y",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, OCEAN_TILES_FIELD)

    def test_contract_is_ocean_tiles_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertIn("OceanTiles", OCEAN_TILES_FIELD)
        self.assertNotIn("=", OCEAN_TILES_FIELD)
        self.assertTrue(OCEAN_TILES_FIELD.endswith(";"))
        self.assertIn(UPROPERTY_ENVIRONMENT, section)

    def test_sibling_environment_fields_do_not_satisfy_ocean_tiles(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, OCEAN_TILES_FIELD))
            self.assertNotEqual(OCEAN_TILES_FIELD, leftover)
