...
# THIS IS leftover-safe Mission08 CampaignDefinition FIELD
...
# director Root #1044 through RadioChatter #1052.
...
# merge #665 #666 #668-#673, or open drafts #674-#1052.
...
# Mission08 CampaignDefinition FIELD
...
# drafts #674-#1052 including leftover Mission06
...
class Mission08CampaignDefinitionFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_campaign_definition_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
