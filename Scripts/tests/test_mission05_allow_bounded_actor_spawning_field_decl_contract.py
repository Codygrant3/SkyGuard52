...
# Mission05 bAllowBoundedActorSpawning FIELD
...
# actor-spawning-field-decl-contract-c332, NOT leftover
# Mission05 AudioDirector field sibling, NOT leftover
# Mission05 closed-without-merge #665 #666 #668
# #669 #670 #671 #672 #673, NOT leftover
# FSkyguardMission05IntegrationReadiness fields,
# FSkyguardStormRuntime fields, NOT leftover
# Mission05 wave-state enum #ad28, NOT leftover
# Mission05 protected-target enum #aaa2, NOT leftover
# Mission05 protected-target-runtime-defaults #ec8b,
# NOT leftover storm-runtime-defaults #89c9, NOT leftover
# FSkyguardMission05IntegrationReadiness fields,
...
# methods.
# not leftover Root / Briefing / AudioDirector /
# SearchlightPort / SearchlightStarboard / RadioChatter /
# SortiePresentation /
...
class Mission05AllowBoundedActorSpawningFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 allow-bounded field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 allow-bounded field contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_allow_bounded_actor_spawning"
                "_field_decl_contract.py"
            )
        )
        leftover_56_64 = (
