...
# Mission09 Waves NotifyThreatDestroyed
# on ASkyguardMission09IntegrationDirector. It is
# NOT leftover Mission08 NotifyThreatDestroyed
...
# Category is Skyguard|Mission09|Waves, not
...
# drafts #674–#749+, leftover Apache
...
# Do not reopen open drafts #674–#749+.
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission09IntegrationDirector::NotifyThreatDestroyed",
    "SkyguardMission08IntegrationDirector.cpp",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission09NotifyThreatDestroyedDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission09|Waves", UFUNCTION_WAVES)
    ...
    def test_environment_category_does_not_satisfy_waves(self) -> None:
        ...
        self.assertNotEqual(leftover_m09_integration, UFUNCTION_WAVES)
    ...
    def test_contract_does_not_lock_notify_threat_destroyed_cpp_body(self) -> None:
        locked_only = f"{NOTIFY_THREAT_DESTROYED}\n"
        self.assertNotIn("{", NOTIFY_THREAT_DESTROYED)
        self.assertNotIn("}", NOTIFY_THREAT_DESTROYED)
        self.assertNotIn("return ", NOTIFY_THREAT_DESTROYED)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 NotifyThreatDestroyed method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission09 NotifyThreatDestroyed contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_notify_threat_destroyed"
                "_decl_contract.py"
            )
        )
        self.assertIn(
