...
# THIS IS leftover-safe Mission06 AirfieldTargetRuntime
# bDestroyed FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly bool = false;
# one-line / split-line UPROPERTY wraps; origin/main
# has NO Category). PARSE
# FSkyguardAirfieldTargetRuntime STRUCT
# public section only (after struct
# FSkyguardAirfieldTargetRuntime, before
# struct FSkyguardPayloadWindowRuntime).
# Do NOT parse ASkyguardMission07IntegrationDirector,
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission06 AirfieldTargetRuntime
# bDestroyed FIELD (declaration-only). THIS IS NOT leftover
# airfield-target enum #222/#14d2. THIS IS NOT leftover
# airfield-target-runtime-defaults #217/#6ad8. THIS IS NOT
# leftover GetTargetRuntime / NotifyAirfieldTargetDamage.
# THIS IS NOT leftover Mission07 PTR bDestroyed #1140,
# leftover Mission08 PTR bDestroyed #1128, leftover
# Mission09 PTR bDestroyed #1125. THIS IS NOT leftover
# Mission06 AirfieldTargetRuntime Target #1141 or
# Integrity #1139 (LOCK those sibling scripts). THIS IS
# NOT leftover payload-window-runtime-defaults #215/#f114.
# THIS IS NOT leftover Mission07 director MaximumProtectedTargetIntegrity.
...
# merge #665 #666 #668-#673, or open drafts #674-#1141.
...
# PTR #1127-#1129 / leftover Mission08 PTR
# bDestroyed #1128. LOCK leftover HoistWindowRuntime
# #1130-#1132/#1134. LOCK leftover Mission07
# SearchTrackRuntime TrackId/Sector and leftover
# Mission07 PTR Target / leftover Mission07 PTR
# bDestroyed #1140. LOCK leftover Mission06
# AirfieldTargetRuntime Target #1141 and leftover
# Integrity #1139 sibling scripts. LOCK leftover Mission09
...
# INDEX_NONE or lock bDestroyed
# construction in the .cpp. This is leftover-safe
# Mission06 AirfieldTargetRuntime bDestroyed
...
# leftover-safe Mission06 AirfieldTargetRuntime
# bDestroyed FIELD (declaration-only). It is
...
# struct section of
# FSkyguardAirfieldTargetRuntime only
# between struct FSkyguardAirfieldTargetRuntime
# and struct FSkyguardPayloadWindowRuntime / the following UCLASS /
...
# This AirfieldTargetRuntime field sits after Integrity in the
# public section (last public field).
# Skip leftover b + Ya + kRuntimeReady forever (it sits
# after bMapAssemblyReady and before bGunnerReady). This contract
# is bDestroyed after Integrity. THIS IS NOT leftover Target /
# Integrity siblings. THIS IS NOT
...
# drafts #674-#1141 including leftover Mission02
...
# the locked FSkyguardAirfieldTargetRuntime
...
# drafts #674-#1141. Do not reopen leftover
...
class Mission06AirfieldTargetRuntimeDestroyedFieldDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_airfield_integrity = "\tint32 Integrity = 100;\n"
        leftover_target = (
    ...
    def test_destroyed_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bDestroyed"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bDestroyed", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bDestroyed", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bDestroyed"))
        self.assertIn("bool", LOCKED_DECL)
        self.assertNotIn("ESkyguardAirfieldTarget", LOCKED_DECL)
        self.assertNotIn("Category=", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bDestroyed", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 bDestroyed field contract "
    ...
    def test_sibling_director_fields_do_not_satisfy_destroyed(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission06_airfield_target_runtime_destroyed"
            "_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_airfield_target_runtime_destroyed"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission06_airfield_target_runtime_integrity"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission06_airfield_target_runtime_target"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission07_protected_target_runtime_destroyed"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_contract_does_not_parse_director_class_or_storm_runtime(
        ...
        airfield_section = public_section(airfield_only)
        self.assertTrue(
            has_declaration(airfield_section, LOCKED_DECL),
            airfield_section,
        )
        mission07_ptr_only = (
