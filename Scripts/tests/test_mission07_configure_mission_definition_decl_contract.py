...
# Mission07 Integration ConfigureMissionDefinition
# on ASkyguardMission07IntegrationDirector. It is
# NOT leftover Mission06 ConfigureMissionDefinition
# #688, NOT leftover Mission05
...
# Mission05 / Mission06 / Waves / Payload /
# Targets / Objectives / Search / Protection /
# Boss / Destruction / Briefing, not
...
# not leftover Harbor Mission02 Integration.
...
# SkyguardMission07IntegrationDirector production
# files. This lane only adds an isolated Python
# ConfigureMissionDefinition method declaration
# contract on ASkyguardMission07IntegrationDirector.
LOCKED = {
...
class Mission07ConfigureMissionDefinitionDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 ConfigureMissionDefinition method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission07 ConfigureMissionDefinition contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_configure_mission_definition"
                "_decl_contract.py"
            )
        )
        self.assertIn(
