...
# Category is Skyguard|Mission02|Campaign, not
...
UPROPERTY_MISSION02_CLAMP = 'meta=(ClampMin="0")'
...
class Mission02CampaignSaveUserIndexFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn('Category="Skyguard|Mission02|Campaign"', section)
        ...
        self.assertIn("Campaign", UPROPERTY_MISSION02)
        self.assertIn("Skyguard|Mission02|Campaign", UPROPERTY_MISSION02)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 CampaignSaveUserIndex field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 CampaignSaveUserIndex contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission02_campaign_save_user_index_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_campaign_save_user_index_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
