...
# INDEX_NONE or lock NotifyProtectedGroupDamage
# construction in the .cpp. This is leftover-safe
# Mission10 Protection NotifyProtectedGroupDamage
# METHOD on ASkyguardMission10IntegrationDirector.
# THIS is NotifyProtectedGroupDamage, NOT leftover
# Mission10 protected-group enum #6f9d, NOT leftover
# Mission10 protected-runtime-defaults #7898, NOT
# leftover NotifyProtectedTargetDamage Mission09
# #755 / branch cursor/mission09-notify-protected-
# target-damage-decl-contract-c332, NOT leftover
# Mission08 NotifyProtectedTargetDamage #736 /
# branch cursor/mission08-notify-protected-target-
# damage-decl-contract-c332, NOT leftover closed
# Mission05 NotifyProtectedTargetDamage #673, NOT
# leftover Mission09 NotifyThreatDestroyed #754,
# NOT leftover Mission08 NotifyThreatDestroyed
# #733, NOT leftover Mission10 NotifyThreatDestroyed
# #770, NOT leftover Mission01 / Mission03 /
...
# #7898. Do not invent leftover GetDayBeatKit / GetDayBeatKind /
...
# leftover Mission09 NotifyThreatDestroyed #754,
# leftover Mission10 NotifyThreatDestroyed #770,
# leftover Mission09 NotifyProtectedTargetDamage #755,
# leftover Mission08 NotifyProtectedTargetDamage #736,
# leftover closed Mission05 NotifyProtectedTargetDamage #673,
...
# an isolated Python NotifyProtectedGroupDamage
...
REQUIRED_DECL = NOTIFY_PROTECTED_GROUP_DAMAGE
LEFTOVER_MISSION09_NOTIFY_PROTECTED_TARGET_DAMAGE = (
    "bool NotifyProtectedTargetDamage("
    "ESkyguardMission09ProtectedTarget Target, "
    "int32 Damage);"
)
LEFTOVER_MISSION08_NOTIFY_PROTECTED_TARGET_DAMAGE = (
    "bool NotifyProtectedTargetDamage("
    "ESkyguardMission08ProtectedTarget Target, "
    "int32 Damage);"
)
LEFTOVER_MISSION05_NOTIFY_PROTECTED_TARGET_DAMAGE = (
    "bool NotifyProtectedTargetDamage("
...
LEFTOVER_MISSION08_NOTIFY_PROTECTED_TARGET_DAMAGE_NOT_LOCKED = (
    LEFTOVER_MISSION08_NOTIFY_PROTECTED_TARGET_DAMAGE,
    "test_mission08_notify_protected_target_damage_decl_contract.py",
    'Category="Skyguard|Mission08|Protection"',
    "cursor/mission08-notify-protected-target-damage-decl-contract-c332",
)
LEFTOVER_MISSION09_NOTIFY_PROTECTED_TARGET_DAMAGE_NOT_LOCKED = (
    LEFTOVER_MISSION09_NOTIFY_PROTECTED_TARGET_DAMAGE,
    "test_mission09_notify_protected_target_damage_decl_contract.py",
    'Category="Skyguard|Mission09|Protection"',
    "cursor/mission09-notify-protected-target-damage-decl-contract-c332",
)
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission10IntegrationDirector::NotifyProtectedGroupDamage",
    "SkyguardMission10IntegrationDirector.cpp",
    "SkyguardMission09IntegrationDirector.cpp",
    "SkyguardMission08IntegrationDirector.cpp",
    "SkyguardMission06IntegrationDirector.cpp",
...
class Mission10NotifyProtectedGroupDamageDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("NotifyProtectedGroupDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, REQUIRED_DECL)
    ...
    def test_missing_notify_protected_group_damage_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission10IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("BlueprintPure", UFUNCTION_PROTECTION)
        self.assertIn("Skyguard|Mission10|Protection", UFUNCTION_PROTECTION)
        ...
        self.assertNotIn("Mission07", UFUNCTION_PROTECTION)
        self.assertNotIn("Mission08", UFUNCTION_PROTECTION)
        self.assertNotIn("Hoist", UFUNCTION_PROTECTION)
        self.assertNotIn("Performance", UFUNCTION_PROTECTION)
        self.assertNotIn("Safety", UFUNCTION_PROTECTION)
        self.assertNotIn("Rescue", UFUNCTION_PROTECTION)
        self.assertIn("BlueprintCallable", UFUNCTION_PROTECTION)
        ...
        self.assertNotIn("Mission06", UFUNCTION_PROTECTION)
        self.assertNotIn("Mission07", UFUNCTION_PROTECTION)
        self.assertNotIn("Mission09", UFUNCTION_PROTECTION)
        self.assertNotIn("Evacuation", UFUNCTION_PROTECTION)
        self.assertNotIn("Campaign", UFUNCTION_PROTECTION)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tvoid NotifyProtectedGroupDamage("
            "ESkyguardMission10ProtectedGroup Group, "
            "int32 Damage);\n"
        )
        as_const = (
        ...
        with_arg = "\tbool NotifyProtectedGroupDamage(int32 Damage);\n"
        renamed = (
            "\tbool NotifyProtectedTargetDamage("
            "ESkyguardMission09ProtectedTarget Target, "
            "int32 Damage);\n"
        )
        short_name = "\tbool NotifyProtectedGroup();\n"
    ...
    def test_notify_protected_group_damage_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, REQUIRED_DECL),
            REQUIRED_DECL,
        ...
        self.assertIn("NotifyProtectedGroupDamage", REQUIRED_DECL)
        self.assertIn("ESkyguardMission10ProtectedGroup Group", REQUIRED_DECL)
        self.assertIn("int32 Damage", REQUIRED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tbool\n"
            "\tNotifyProtectedGroupDamage(ESkyguardMission10ProtectedGroup Group, int32 Damage);\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
            "public:\n"
            "\tbool   NotifyProtectedGroupDamage(ESkyguardMission10ProtectedGroup Group, int32 Damage);\n"
            "private:\n"
            "};\n"
        )
        wrap_tab = (
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_PROTECTION} {REQUIRED_DECL}\n"
            "};\n"
        )
    ...
    def test_environment_category_does_not_satisfy_protection(self) -> None:
        ...
        self.assertNotEqual(leftover_m07, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m08, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m09, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m09_waves, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m10_integration, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m10_safety, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m10_waves, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_m09_pool, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_hoist, UFUNCTION_PROTECTION)
        self.assertNotEqual(leftover_safety, UFUNCTION_PROTECTION)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("NotifyProtectedGroupDamage", REQUIRED_DECL)
        self.assertTrue(REQUIRED_DECL.startswith("bool "))
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 NotifyProtectedGroupDamage method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                REQUIRED_DECL.lower(),
                "mission10 NotifyProtectedGroupDamage contains "
    ...
    def test_contract_is_notify_protected_group_damage_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_notify_protected_group_damage"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_notify_protected_target_damage(
        self,
    ) -> None:
        locked_only = f"{REQUIRED_DECL}\n"
        for leftover_decl in (
            LEFTOVER_MISSION09_NOTIFY_PROTECTED_TARGET_DAMAGE,
            LEFTOVER_MISSION08_NOTIFY_PROTECTED_TARGET_DAMAGE,
            LEFTOVER_MISSION05_NOTIFY_PROTECTED_TARGET_DAMAGE,
        ):
            self.assertNotIn(leftover_decl, locked_only)
            self.assertNotIn(leftover_decl, REQUIRED_DECL)
            region = f"\t{leftover_decl}\n"
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, REQUIRED_DECL)
            self.assertIn("NotifyProtectedGroupDamage", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, REQUIRED_DECL))
        for token in LEFTOVER_MISSION09_NOTIFY_PROTECTED_TARGET_DAMAGE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REQUIRED_DECL)
        for token in LEFTOVER_MISSION08_NOTIFY_PROTECTED_TARGET_DAMAGE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, REQUIRED_DECL)
        ...
        leftover_m09 = (
            ...
            "\tUFUNCTION(BlueprintCallable, "
            'Category="Skyguard|Mission09|Protection")\n'
            f"\t{LEFTOVER_MISSION09_NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover_m09)
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        leftover_m08 = (
            "class SKYGUARD52_API ASkyguardMission08IntegrationDirector "
            ...
            "\tUFUNCTION(BlueprintCallable, "
            'Category="Skyguard|Mission08|Protection")\n'
            f"\t{LEFTOVER_MISSION08_NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
        ...
        leftover_m05 = (
            ...
            "\tUFUNCTION(BlueprintCallable, "
            'Category="Skyguard|Mission05|Protection")\n'
            f"\t{LEFTOVER_MISSION05_NOTIFY_PROTECTED_TARGET_DAMAGE}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover_m05)
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertNotIn("NotifyProtectedTargetDamage", REQUIRED_DECL)
        self.assertNotIn("Mission09", UFUNCTION_PROTECTION)
        self.assertNotIn("Mission08", UFUNCTION_PROTECTION)
