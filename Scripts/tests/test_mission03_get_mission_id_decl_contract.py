...
# Mission03 Integration GetMissionId
...
# GetConvoyRouteAlpha / GetConvoyWorldLocation /
# GetConvoyIntegrity / GetDayBeatKit. Do not lock
...
# #614, leftover Mission01 GetMissionId #620,
...
# Waves, not Convoy, not Environment, not
...
# isolated-test drafts #107–#644, leftover Apache
...
# leftover theater-kit #59, leftover #107–#644, plus
...
class Mission03GetMissionIdDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_mission_id = f"\t{GET_CONVOY_ROUTE_ALPHA}\n"
    ...
    def test_get_mission_id_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("GetConvoyWorldLocation", GET_MISSION_ID)
        self.assertNotIn("GetConvoyIntegrity", GET_MISSION_ID)
        ...
        self.assertNotIn("GetConvoyRouteAlpha", GET_MISSION_ID)
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(leftover_convoy, UFUNCTION_INTEGRATION)
        ...
        self.assertNotIn(leftover_convoy, UFUNCTION_INTEGRATION)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertNotIn("GetConvoyRouteAlpha", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 GetMissionId method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission03 GetMissionId contains "
