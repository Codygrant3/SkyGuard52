...
# Mission06 Waves NotifyThreatDestroyed
# on ASkyguardMission06IntegrationDirector. It is
# NOT leftover Mission05 NotifyThreatDestroyed
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission06IntegrationDirector::NotifyThreatDestroyed",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission06NotifyThreatDestroyedDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 NotifyThreatDestroyed method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission06 NotifyThreatDestroyed contains "
    ...
    def test_contract_does_not_relock_leftover_mission06_wave_state_enum(
        ...
        self.assertNotIn("ESkyguardMission06WaveState", UFUNCTION_WAVES)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_notify_threat_destroyed"
                "_decl_contract.py"
            )
        )
        self.assertIn(
