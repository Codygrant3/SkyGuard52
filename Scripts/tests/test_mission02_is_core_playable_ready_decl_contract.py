...
# INDEX_NONE or lock IsCorePlayableReady
# construction in the .cpp. This is leftover-safe
# Mission02 Integration IsCorePlayableReady
# METHOD on ASkyguardMission02IntegrationDirector. It is
# NOT leftover Mission10 IsCorePlayableReady
# #768 / branch cursor/mission10-is-core-
# playable-ready-decl-contract-c332, NOT leftover
# Mission02 InitializePlayableMission #828 /
# ConfigureMissionDefinition #829 / StartNextWave
# #830 / NotifyThreatDestroyed #831 /
# NotifyFuelTerminalDamage siblings, NOT leftover
# Mission09 IsCorePlayableReady
# #759 / branch cursor/mission09-is-core-
# playable-ready-decl-contract-c332, NOT leftover
# Mission08 IsCorePlayableReady
# #743 / branch cursor/mission08-is-core-
# playable-ready-decl-contract-c332, NOT leftover
# Mission07 IsCorePlayableReady #715,
# NOT leftover Mission06 IsCorePlayableReady
# #696, NOT leftover Mission05 IsCorePlayableReady
# #684, NOT leftover closed Mission04 #657 /
# Mission03 #636 / Mission01 #613
...
# leftover Mission10 route-phase enum #701a, NOT
# leftover Mission10 protected-group enum #6f9d,
# NOT leftover Mission10 protected-runtime-
# defaults #7898, NOT leftover GetDayBeatKit
# work, NOT leftover Harbor Mission02 / Harbor #6/#8/#9, NOT
...
# leftover Mission05 IsCorePlayableReady #684,
# leftover Mission09 IsCorePlayableReady #759,
# leftover Mission08 IsCorePlayableReady #743,
# leftover Mission07 IsCorePlayableReady #715,
# leftover Mission06 IsCorePlayableReady #696,
...
# (`bool IsCorePlayableReady() const;`); accept that
...
# Mission05 / Mission06 / Mission07 / Mission08 / Mission09 / Search /
# Protection / Payload / Targets / Waves / Objectives /
...
# Mission09 Integration #747 / Protection / Performance /
# Waves, not leftover Mission10 Waves / Protection /
# Objectives / Evacuation / Campaign / Safety. Stay off leftover drafts #56–#64, leftover Harbor
...
# drafts #674–#774+, leftover Apache
...
# #b931 (this is NOT those defaults; this is the
# Integration IsCorePlayableReady method), leftover
# skyline style HarborIndustrial
...
# Mission02IntegrationDirector public section.
...
# IsCorePlayableReady #743. Do not reopen leftover
# Mission09 IsCorePlayableReady #759. Do not reopen
# leftover Mission10 route-phase enum #701a,
# leftover Mission10 protected-group enum #6f9d,
...
# an isolated Python IsCorePlayableReady
...
LEFTOVER_MISSION10_IS_CORE_PLAYABLE_READY_NOT_LOCKED = (
    "test_mission10_is_core_playable_ready_decl_contract.py",
    "ASkyguardMission10IntegrationDirector",
    "SkyguardMission10IntegrationDirector.h",
    'Category="Skyguard|Mission10|Integration"',
    "cursor/mission10-is-core-playable-ready-decl-contract-c332",
)
...
LEFTOVER_MISSION08_IS_CORE_PLAYABLE_READY_NOT_LOCKED = (
    ...
    "SkyguardMission08IntegrationDirector.h",
    'Category="Skyguard|Mission08|Integration"',
    "cursor/mission08-is-core-playable-ready-decl-contract-c332",
)
LEFTOVER_MISSION09_IS_CORE_PLAYABLE_READY_NOT_LOCKED = (
    ...
    "cursor/mission09-is-core-playable-ready-decl-contract-c332",
)
MISSION10_VALIDATE_WEAPON_RELEASE = (
    "bool ValidateWeaponRelease("
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission02IntegrationDirector::IsCorePlayableReady",
    "SkyguardMission02IntegrationDirector.cpp",
    "SkyguardMission09IntegrationDirector.cpp",
    "SkyguardMission08IntegrationDirector.cpp",
    "SkyguardMission06IntegrationDirector.cpp",
...
class Mission02IsCorePlayableReadyDeclContractTests(unittest.TestCase):
    def test_mission02_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, IS_CORE_PLAYABLE_READY),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, IS_CORE_PLAYABLE_READY)
        self.assertIn("IsCorePlayableReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, IS_CORE_PLAYABLE_READY)
    ...
    def test_missing_is_core_playable_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission02IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, IS_CORE_PLAYABLE_READY)
        self.assertIn("IsCorePlayableReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, IS_CORE_PLAYABLE_READY)
        self.assertIn("IsCorePlayableReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("BlueprintCallable", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("Category", IS_CORE_PLAYABLE_READY)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, IS_CORE_PLAYABLE_READY)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, IS_CORE_PLAYABLE_READY)
        self.assertIn("IsCorePlayableReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = "\tvoid IsCorePlayableReady() const;\n"
        as_const = "\tbool IsCorePlayableReady();\n"
        with_arg = "\tbool IsCorePlayableReady(int32 Amount) const;\n"
        renamed = "\tbool IsPlayableReady() const;\n"
        short_name = "\tbool CorePlayableReady() const;\n"
        ...
        leftover_ready = f"\t{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, IS_CORE_PLAYABLE_READY)
            self.assertIn("IsCorePlayableReady", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_is_core_playable_ready_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, IS_CORE_PLAYABLE_READY),
            IS_CORE_PLAYABLE_READY,
        )
        self.assertTrue(has_declaration(section, IS_CORE_PLAYABLE_READY))
        self.assertEqual(
            declaration_count(section, IS_CORE_PLAYABLE_READY),
            1,
        )
        self.assertTrue(
            IS_CORE_PLAYABLE_READY.startswith("bool "),
            IS_CORE_PLAYABLE_READY,
        )
        self.assertTrue(
            IS_CORE_PLAYABLE_READY.endswith(";"),
            IS_CORE_PLAYABLE_READY,
        )
        self.assertIn("IsCorePlayableReady", IS_CORE_PLAYABLE_READY)
        self.assertIn("()", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("int32", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("Amount", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("TArray<", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("TObjectPtr", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("TSoftObjectPtr", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("INDEX_NONE", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("UFUNCTION", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("{", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("}", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("return ", IS_CORE_PLAYABLE_READY)
        self.assertIn(" const;", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("Root", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("Briefing", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("AudioDirector", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("RadioChatter", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("SortiePresentation", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("CampaignDefinition", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("MissionDefinition", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("Readiness", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("bAutoInitialize", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("bAllowBoundedActorSpawning", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("bAutoLaunchAfterBriefing", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("PathfinderSpawnLocation", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetAircraft", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("BindRuntimeActors", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("HandleDroneCityImpact", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("StartNextWave", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("InitializePlayableMission", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("AdvanceConvoyByDistance", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("NotifyConvoyDamage", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetWaveState", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetConvoyRouteState", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetDayBeatKit", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetNightBeatKit", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("StartSearchlightWindow", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("AdvanceSearchlightTrack", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("NotifySubstationDamage", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetRemainingThreatsInWave", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetSearchlightRuntime", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetSubstationIntegrity", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("StartPayloadWindow", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("AdvancePayloadWindow", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("TryJamActivePayload", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("NotifyAirfieldTargetDamage", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetPayloadWindow", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetTargetRuntime", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetSurvivingTargetCount", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetDayBeatKind", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetDayBeatIndex", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("TickDayBeatKit", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("HandleBossPhaseChanged", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ASkyguardMission06IntegrationDirector", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ESkyguardMission06WaveState", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ESkyguardMission07WaveState", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ASkyguardMission07IntegrationDirector", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ASkyguardMission08IntegrationDirector", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ESkyguardMission08WaveState", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ESkyguardMission09WaveState", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ESkyguardMission09ProtectedTarget", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("FSkyguardMission09ProtectedTargetRuntime", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("FSkyguardMission09PoolRuntime", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("FSkyguardMission09PoolBudget", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("BindCampaignRuntime", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetPoolRuntime", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("IronRainSpawnLocation", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ESkyguardMission08ProtectedTarget", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("FSkyguardMission08ProtectedTargetRuntime", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("FSkyguardHoistWindowRuntime", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("StartHoistWindow", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("AdvanceHoistWindow", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ValidateWeaponRelease", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetHoistRuntime", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetRejectedWeaponReleases", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetStormRainBeatKit", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ApplyStormRainPlayContract", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetStormRainBeatKind", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("TickStormRainBeatKit", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("RescueHelicopterAnchor", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("LifelineHunterSpawnLocation", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ESkyguardMission07ProtectedTarget", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("FSkyguardMission07ProtectedTargetRuntime", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ESkyguardSearchSector", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("FSkyguardSearchTrackRuntime", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ClassifyFalseTrack", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ConfirmRadarGhostIdentification", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("NotifyProtectedTargetDamage", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("AdvanceReinforcementTimer", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetSearchSector", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetClassifiedFalseTrackCount", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("IsHostileContactConfirmed", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetProtectedTarget", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetReinforcementTimeRemaining", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetNightBeatKind", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetNightBeatIndex", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("TickNightBeatKit", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ESkyguardAirfieldTarget", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ConvoyRuntimeAnchor", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("RoadHunterSpawnLocation", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ASkyguardMission02IntegrationDirector", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ConfigureMissionDefinition", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("NotifyObjectiveProgress", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("NotifyThreatDestroyed", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("SynchronizeRuntimeState", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("NotifyProtectedAssetFailed", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetReadiness", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetObjectiveRuntime", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetGunner", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetPathfinder", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetMissionId", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ValidateMissionContract", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ConfigureFromMission", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("AdvanceBriefing", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("SetAssetsReady", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("AcknowledgeAndLaunch", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("CanLaunch", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetElapsedSeconds", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetBriefingState", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetMinimumWarmupSeconds", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetBriefingText", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetRadioChatter", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetPresentation", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetMissionTitle", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("AcknowledgeBriefing", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("LaunchSortie", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("HullCollider", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("OpticalTracker", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("WeaponServo", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("CountermeasurePod", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("MinHeightFromOriginCm", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("RadarNode", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ESkyguardMission02WaveState", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("HarborIndustrial", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("MaxIntegrity", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("CurrentIntegrity", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("FillAndFinalize", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("FillAndFail", IS_CORE_PLAYABLE_READY)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, IS_CORE_PLAYABLE_READY)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_INTEGRATION} {IS_CORE_PLAYABLE_READY}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{IS_CORE_PLAYABLE_READY}\n}}\n"
        self.assertTrue(has_declaration(one_line, IS_CORE_PLAYABLE_READY))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, IS_CORE_PLAYABLE_READY),
            section,
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(leftover_m09_integration, UFUNCTION_INTEGRATION)
    ...
    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        locked_only = f"{IS_CORE_PLAYABLE_READY}\n"
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, IS_CORE_PLAYABLE_READY)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", IS_CORE_PLAYABLE_READY)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_is_core_playable_ready_cpp_body(self) -> None:
        locked_only = f"{IS_CORE_PLAYABLE_READY}\n"
        self.assertNotIn("{", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("}", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("return ", IS_CORE_PLAYABLE_READY)
        ...
        self.assertNotIn("return false", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("return true", IS_CORE_PLAYABLE_READY)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{IS_CORE_PLAYABLE_READY}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_CORE_PLAYABLE_READY)
        self.assertIn("IsCorePlayableReady", IS_CORE_PLAYABLE_READY)
        self.assertTrue(IS_CORE_PLAYABLE_READY.startswith("bool "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, IS_CORE_PLAYABLE_READY)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, IS_CORE_PLAYABLE_READY)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("CurrentIntegrity", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("SkyguardApacheAircraft.h", IS_CORE_PLAYABLE_READY)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", IS_CORE_PLAYABLE_READY)
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        self.assertNotIn("550.f", IS_CORE_PLAYABLE_READY)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{IS_CORE_PLAYABLE_READY}\n"
        self.assertEqual(
            require_declaration(locked_only, IS_CORE_PLAYABLE_READY),
            IS_CORE_PLAYABLE_READY,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, IS_CORE_PLAYABLE_READY)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ASkyguardIronRainBoss", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ASkyguardRadarGhostBoss", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ASkyguardTempestBoss", section)
        self.assertNotIn("ASkyguardLastFlightBoss", IS_CORE_PLAYABLE_READY)
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertNotIn(
            "ASkyguardMission08IntegrationDirector::IsCorePlayableReady",
            section,
        )
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("{", IS_CORE_PLAYABLE_READY)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 IsCorePlayableReady method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{IS_CORE_PLAYABLE_READY}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, IS_CORE_PLAYABLE_READY.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                IS_CORE_PLAYABLE_READY.lower(),
                "mission02 IsCorePlayableReady contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, IS_CORE_PLAYABLE_READY)

    def test_contract_is_is_core_playable_ready_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(IS_CORE_PLAYABLE_READY.startswith("bool "))
        self.assertIn("IsCorePlayableReady", IS_CORE_PLAYABLE_READY)
        self.assertTrue(IS_CORE_PLAYABLE_READY.endswith(";"))
        self.assertIn(UFUNCTION_INTEGRATION, section)

    def test_sibling_director_fields_do_not_satisfy_is_core_playable_ready(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, IS_CORE_PLAYABLE_READY)
            )
            self.assertNotEqual(IS_CORE_PLAYABLE_READY, leftover)
        self.assertIn(
    ...
    def test_leftover_mission10_is_core_playable_ready_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
        ...
        for token in LEFTOVER_MISSION10_IS_CORE_PLAYABLE_READY_NOT_LOCKED:
            self.assertNotIn(token, IS_CORE_PLAYABLE_READY)
        self.assertNotIn("Mission10", UFUNCTION_INTEGRATION)
    ...
    def test_leftover_mission02_sibling_methods_do_not_satisfy(self) -> None:
        for leftover in (
            ...
            self.assertIn("IsCorePlayableReady", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, IS_CORE_PLAYABLE_READY))
        locked_only = f"{IS_CORE_PLAYABLE_READY}\n"
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tbool IsCorePlayableReady() const { return false; }\n"
            "};\n"
        )
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission02_is_core_playable_ready"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_is_core_playable_ready"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_sibling_mission09_initialize_does_not_satisfy(self) -> None:
        ...
        self.assertNotEqual(leftover_integration, UFUNCTION_INTEGRATION)
        self.assertNotIn("Objectives", UFUNCTION_INTEGRATION)



    def test_leftover_mission01_is_core_playable_ready_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission01IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission03_is_core_playable_ready_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission04_is_core_playable_ready_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission04IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission05_is_core_playable_ready_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission05IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission06_is_core_playable_ready_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission06IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        for token in LEFTOVER_MISSION06_IS_CORE_PLAYABLE_READY_NOT_LOCKED:
            self.assertNotIn(token, IS_CORE_PLAYABLE_READY)

    def test_leftover_mission07_is_core_playable_ready_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission07IntegrationDirector "
        ...
        for token in LEFTOVER_MISSION07_IS_CORE_PLAYABLE_READY_NOT_LOCKED:
            self.assertNotIn(token, IS_CORE_PLAYABLE_READY)
        self.assertNotIn("Mission07", UFUNCTION_INTEGRATION)

    def test_leftover_mission08_is_core_playable_ready_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission08IntegrationDirector "
    ...
    def test_leftover_mission09_is_core_playable_ready_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
        ...
        self.assertIn("missing", str(raised.exception).lower())
        locked_only = f"{IS_CORE_PLAYABLE_READY}\n"
        for token in LEFTOVER_MISSION09_IS_CORE_PLAYABLE_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, IS_CORE_PLAYABLE_READY)
        self.assertIn(
            "Scripts/tests/test_mission09_is_core_playable_ready"
    ...
    def test_contract_does_not_relock_leftover_mission10_route_phase_enum(
        ...
        self.assertNotIn("GetRoutePhase", IS_CORE_PLAYABLE_READY)
    ...
    def test_contract_does_not_relock_leftover_mission10_protected_group(
        ...
        self.assertNotIn("Protection", UFUNCTION_INTEGRATION)
        self.assertNotIn("GetProtectedGroup", IS_CORE_PLAYABLE_READY)
    ...
    def test_leftover_mission10_sibling_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("HandleDroneCityImpact", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("UFUNCTION", GET_DAY_BEAT_KIT)
        self.assertNotIn("StartPhaseWave", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("InitializePlayableMission", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("GetRoutePhase", IS_CORE_PLAYABLE_READY)
        self.assertNotIn("ValidateWeaponRelease", IS_CORE_PLAYABLE_READY)
    ...
    def test_sibling_mission10_initialize_does_not_satisfy(self) -> None:
        ...
        self.assertNotEqual(leftover_callable, UFUNCTION_INTEGRATION)
        self.assertNotIn("BlueprintCallable", UFUNCTION_INTEGRATION)
        self.assertNotIn("Objectives", UFUNCTION_INTEGRATION)
