...
# Mission10 bAutoLaunchAfterBriefing FIELD
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission10IntegrationDirector::bAutoLaunchAfterBriefing",
    "SkyguardMission10IntegrationDirector.cpp",
...
class Mission10AutoLaunchAfterBriefingFieldDeclContractTests(unittest.TestCase):
    ...
    def test_auto_launch_after_briefing_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bAutoLaunchAfterBriefing"),
            LOCKED_DECL,
        )
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bAutoLaunchAfterBriefing", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bAutoLaunchAfterBriefing"))
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 bAutoLaunchAfterBriefing field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission10 bAutoLaunchAfterBriefing contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission10_auto_launch_after_briefing_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_auto_launch_after_briefing_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
