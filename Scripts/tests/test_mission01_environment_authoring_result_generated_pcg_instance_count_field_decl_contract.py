...
# GeneratedPCGInstanceCount. DEFAULT IS `= 0` NOT `= 1` / `= false`.
# If a clone asserts Category= and origin/main has none, drop that
# assertion. If a clone asserts `= false` and origin/main has `= 0`,
# accept `= 0`.
# THIS IS NOT leftover GeneratedPCGComponentCount #1247.
# THIS IS NOT leftover LandscapeComponentCount #1238.
# THIS IS NOT leftover MaterialCompilation GeneratedMaterialInstanceCount #1225.
# THIS IS NOT leftover GraphNodeCount #1237 / GraphEdgeCount #1240.
# THIS IS NOT leftover mission01-environment-authoring-result-defaults #df1a.
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGInstanceCount FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# int32 GeneratedPCGInstanceCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# Fail closed if type/decl missing, renamed, Category= is added,
# or default is not 0.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGInstanceCount. DEFAULT IS `= true` NOT `= false`.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGInstanceCount. THIS IS NOT leftover Mission01
...
# int32 GeneratedPCGInstanceCount = 0. Fail closed if type/decl
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGInstanceCount. THIS IS NOT leftover
# mission01-environment-authoring-result-defaults #df1a.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGInstanceCount. THIS IS NOT leftover MaterialCompilation bSuccess #1223.
...
# Do NOT parse FSkyguardLandscapeCaptureConfigurationResult (leftover bSuccess #1214).
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGInstanceCount. THIS IS NOT leftover VisibleAudit bSuccess #1199.
# THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
# THIS IS NOT leftover landscape-capture-config-defaults #d6fd.
# THIS IS NOT leftover landscape-visible-audit-defaults #0bce.
# THIS IS NOT leftover landscape-material-compilation-defaults #01d4.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GeneratedPCGInstanceCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 GeneratedPCGInstanceCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# BlueprintReadOnly int32 GeneratedPCGInstanceCount = 0;
...
TARGET = "int32 GeneratedPCGInstanceCount = 0;"
TARGET_WRONG = "int32 GeneratedPCGInstanceCount = 1;"
LOCKED_DECL = TARGET
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # GeneratedPCGInstanceCount (must be = 0, not = 1).
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*int32\s+GeneratedPCGInstanceCount\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for int32 GeneratedPCGInstanceCount is missing from "
...
class Mission01EnvironmentAuthoringResultGeneratedPCGInstanceCountFieldDeclContractTests(unittest.TestCase):
    def test_mission01_environment_authoring_result_struct_exists(self) -> None:
        ...
        self.assertIn("bLicensedMeshSlotsEmpty", section)
        ...
        self.assertNotIn("bValid", section.replace("GeneratedPCGInstanceCount", ""))
        ...
        self.assertNotIn("bSuccess", LOCKED_DECL.replace("GeneratedPCGInstanceCount", ""))
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("GeneratedPCGInstanceCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_generated_pcg_instance_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_generated_pcg_instance_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 GeneratedPCGInstanceCount"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("0;"), LOCKED_DECL)
        self.assertNotIn("= 1", LOCKED_DECL)
        self.assertIn("= 0", LOCKED_DECL)
        self.assertFalse(
            has_declaration(
                "\tint32 GeneratedPCGInstanceCount = 1;\n",
                LOCKED_DECL,
            )
        )
        with self.assertRaises(AssertionError) as raised:
        ...
        self.assertIn("GeneratedPCGInstanceCount", LOCKED_DECL)
        self.assertNotIn("GeneratedPCGComponentCount", LOCKED_DECL)
        self.assertNotIn("LandscapeComponentCount", LOCKED_DECL)
        self.assertNotIn("GeneratedMaterialInstanceCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("GeneratedPCGInstanceCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 GeneratedPCGInstanceCount"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("GeneratedPCGInstanceCount", locked_only)
    ...
    def test_contract_is_target_field_declaration_only(
        ...
        self.assertTrue(LOCKED_DECL.startswith("int32 GeneratedPCGInstanceCount"))
        self.assertIn("GeneratedPCGInstanceCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("0;"))
