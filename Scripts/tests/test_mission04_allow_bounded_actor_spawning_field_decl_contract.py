...
# Mission04 bAllowBoundedActorSpawning FIELD
...
# actor-spawning-field-decl-contract-c332, NOT leftover
# Mission03 allow-bounded-actor-spawning FIELD
# / branch cursor/mission03-allow-bounded-
# actor-spawning-field-decl-contract-c332, NOT leftover
# Mission10 bAllowBoundedActorSpawning field
# / branch cursor/mission10-allow-bounded-
# actor-spawning-field-decl-contract-c332, NOT leftover
# Mission04 bAutoInitialize / bAutoLaunchAfterBriefing
# siblings, NOT leftover Mission04 Root #907 /
# CampaignDefinition #914 / MissionDefinition /
# RadioChatter #912 / SortiePresentation #913,
# NOT leftover FSkyguardMission04IntegrationReadiness
# fields, NOT leftover Mission10 bAutoInitialize field
...
# drafts #674-#914 including leftover Mission04
# CampaignDefinition #914, RadioChatter #912,
# SortiePresentation #913, AudioDirector #911,
# Briefing #910. MissionDefinition / bAutoInitialize
# may already have newer drafts; do not reopen them.
# leftover Apache
...
# Mission01 / Mission02 / Mission03 / Mission10
# allow-bounded-actor-spawning field contracts, leftover
# Mission04 / Mission01 / Mission02 / Mission05-10
# bAutoInitialize / auto-initialize field contracts, leftover
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission04IntegrationDirector::bAllowBoundedActorSpawning",
    "SkyguardMission10IntegrationDirector.cpp",
...
class Mission04AllowBoundedActorSpawningFieldDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_allow = f"\t{AUTO_INITIALIZE_FIELD}\n"
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bAllowBoundedActorSpawning = true;", locked_only)
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tbool bAllowBoundedActorSpawning = false;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_allow_bounded_actor_spawning"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_allow_bounded_actor"
            "_spawning_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission10_allow_bounded_actor"
            "_spawning_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
