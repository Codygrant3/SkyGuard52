...
# Mission02 IntegrationReadiness WaveCount
...
# an int32 readiness FIELD named WaveCount, NOT a
...
class Mission02WaveCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 WaveCount field contract "
