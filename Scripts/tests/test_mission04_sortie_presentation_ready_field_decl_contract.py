...
# Mission04 IntegrationReadiness bSortiePresentationReady
...
# SortiePresentation field #913 / branch
# cursor/mission04-sortie-presentation-
...
# NOT leftover Mission03 director
# SortiePresentation field #880 / branch
# cursor/mission03-sortie-presentation-
# field-decl-contract-c332, NOT leftover
# Mission02 bSortiePresentationReady
# FIELD #868 / branch cursor/mission02-
# sortie-presentation-ready-field-decl-contract-c332,
# NOT leftover Mission10 bSortiePresentationReady
# FIELD #820 / branch cursor/mission10-
# sortie-presentation-ready-field-decl-contract-c332,
# NOT leftover ObjectiveCount sibling
# / branch cursor/mission03-objective-
# count-field-decl-contract-c332,
...
# NOT leftover Mission03 bRoadHunterReady
# sibling / branch cursor/mission03-
# road-hunter-ready-field-decl-contract-c332,
# NOT leftover Mission03 bMissionDefinitionValid
# sibling, NOT leftover retired-mount
# runtime-ready struct field (skip entirely),
# NOT leftover BindRuntimeActors /
# HandleDroneCityImpact / retired-mount spawn,
# NOT leftover GetReadiness() or leftover
# GetObjectiveRuntime() methods,
# NOT leftover Mission02 bBreakwaterReady
# FIELD #866 / branch cursor/mission02-
# breakwater-ready-field-decl-contract-c332,
# NOT leftover Mission02 bGunnerReady
# FIELD #864 / branch cursor/mission02-
# gunner-ready-field-decl-contract-c332,
# NOT leftover Mission03 RoadHunterSpawnLocation
# FIELD #888 / branch cursor/mission03-
# road-hunter-spawn-location-field-decl-contract-c332,
# NOT leftover Mission03 RoadHunterSpawnRotation
# FIELD #891 / branch cursor/mission03-
# road-hunter-spawn-rotation-field-decl-contract-c332,
# NOT leftover Mission03 bMissionDefinitionValid
...
# director SortiePresentation #913, not leftover
# Mission04 Readiness director field #926, not leftover
# GetReadiness, not leftover
# ASkyguardMission02IntegrationDirector,
# not leftover Mission01/02/03/10 readiness structs).
...
LEFTOVER_MISSION04_SORTIE_PRESENTATION_FIELD_NOT_LOCKED = (
...
LEFTOVER_MISSION03_DIRECTOR_FIELDS_NOT_LOCKED = (
    ...
    "test_mission03_road_hunter_spawn_rotation_field_decl_contract.py",
...
class Mission04SortiePresentationReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 bSortiePresentationReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 bSortiePresentationReady contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_sortie_presentation"
                "_ready_field_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_convoy_route_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_road_hunter_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission_definition_or_readiness(
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_road_hunter_spawn"
