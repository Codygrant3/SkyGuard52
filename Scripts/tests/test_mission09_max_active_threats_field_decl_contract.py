...
# THIS IS leftover-safe Mission09 PoolBudget-struct
# MaxActiveThreats FIELD (declaration-only;
# EditAnywhere / BlueprintReadWrite int32 = 24;
# ClampMin 1 / ClampMax 32; one-line / split-line
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission09 PoolBudget-struct
# MaxActiveThreats. THIS IS NOT leftover Mission08
...
# INDEX_NONE or lock MaxActiveThreats
# construction in the .cpp. This is leftover-safe
# Mission09 PoolBudget MaxActiveThreats
# FIELD (declaration-only; EditAnywhere /
# BlueprintReadWrite int32 default 24,
# ClampMin 1 / ClampMax 32, one-line / split-line
# UPROPERTY wraps) on
# FSkyguardMission09PoolBudget. It is
# leftover-safe Mission09 PoolBudget-struct
# MaxActiveThreats FIELD (declaration-only). It is
...
# with EditAnywhere / BlueprintReadWrite / ClampMin 1 / ClampMax 32);
# accept that form, other one-line / split-line wraps,
# the origin/main `= 24` default,
...
# This field has no Category. Accept ClampMin 1,
# ClampMax 32, and default = 24.
# This PoolBudget-struct field sits first, before PoolCapacity.
# Skip leftover b + Ya + kRuntimeReady forever (it sits
# after bMapAssemblyReady and before bGunnerReady). This contract
# is MaxActiveThreats on FSkyguardMission09PoolBudget. Skip leftover
...
UPROPERTY_MISSION10_CLAMP = 'meta=(ClampMin="1", ClampMax="32")'
...
MAX_ACTIVE_THREATS_OTHER = (
    "int32 MaxActiveThreats = 1;"
)
LOCKED_DECL = MAX_ACTIVE_THREATS
...
# an isolated Python MaxActiveThreats
...
class Mission09MaxActiveThreatsFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("MaxActiveThreats", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_max_active_threats_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn('ClampMax="32"', UPROPERTY_MISSION10)
    ...
    def test_max_active_threats_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 MaxActiveThreats"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= 24;"), LOCKED_DECL)
        ...
        self.assertIn("BlueprintReadWrite", UPROPERTY_MISSION10)
        self.assertIn("ClampMin", UPROPERTY_MISSION10)
        self.assertIn("ClampMax", UPROPERTY_MISSION10)
        self.assertIn('ClampMin="1"', UPROPERTY_MISSION10)
        self.assertIn('ClampMax="32"', UPROPERTY_MISSION10)
        self.assertIn("MaxActiveThreats", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("MaxActiveThreats", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 MaxActiveThreats"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("MaxActiveThreats", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 MaxActiveThreats field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 MaxActiveThreats contains "
    ...
    def test_contract_is_max_active_threats_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(LOCKED_DECL.startswith("int32 MaxActiveThreats"))
        self.assertIn("MaxActiveThreats", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("= 24;"))
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_max_active_threats"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_same_name_wave_count_contracts_stay_locked(
        ...
        self.assertIn(
            "Scripts/tests/test_mission09_maximum_protected_target"
