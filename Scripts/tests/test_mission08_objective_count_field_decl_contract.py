...
# is leftover-safe Mission08 readiness-struct ObjectiveCount after
# bCampaignRuntimeStarted. It is NOT leftover Mission07
...
# drafts #674-#1007 including leftover Mission02
...
# drafts #674-#1007. Do not reopen leftover
...
# THIS IS NOT leftover Mission07 ObjectiveCount,
...
class Mission08ObjectiveCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_objective_count"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
