...
# Mission06 Waves GetWaveState METHOD on
# ASkyguardMission06IntegrationDirector. It is
# NOT leftover Mission06 wave-state enum #fa65,
# NOT leftover Mission05 GetWaveState #676, NOT
# leftover Mission03 / Mission04 GetWaveState, NOT
...
# NOT leftover airfield-target enum #14d2, NOT leftover
...
# leftover Mission03 GetWaveState, leftover
# Mission04 GetWaveState, leftover Mission05
# GetWaveState #676, leftover Mission06
# InitializePlayableMission, leftover Mission06
# ConfigureMissionDefinition, leftover Mission06
# IsCorePlayableReady, leftover Mission06
...
# (`ESkyguardMission06WaveState GetWaveState()
# const { return WaveState; }`); accept that
# form, other one-line / split-line wraps, and
...
# not leftover Mission05 Waves #676, not leftover
# Harbor Mission02 Integration. Do not reopen
# leftover Mission06 wave-state enum #fa65. Do
# not reopen leftover Mission05 GetWaveState #676.
...
# #668/#669/#676. Closed leftover #658–#673.
...
# leftover Mission05 GetWaveState #676, leftover
# Mission03 / Mission04 GetWaveState,
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission06IntegrationDirector::GetWaveState",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission06GetWaveStateDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        renamed = (
            "\tESkyguardMission06WaveState GetState() const;\n"
        )
        short_name = "\tESkyguardMission06WaveState GetWave() const;\n"
    ...
    def test_get_wave_state_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            GET_WAVE_STATE.startswith("ESkyguardMission06WaveState "),
            GET_WAVE_STATE,
        )
        self.assertIn("ESkyguardMission06WaveState", GET_WAVE_STATE)
        ...
        self.assertNotIn("FSkyguardMission06IntegrationReadiness", GET_WAVE_STATE)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("GetWaveState", GET_WAVE_STATE)
        self.assertTrue(GET_WAVE_STATE.startswith("ESkyguardMission06WaveState "))
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 GetWaveState method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission06 GetWaveState contains "
    ...
    def test_leftover_environment_director_does_not_satisfy(self) -> None:
        leftover = (
