...
# Mission04 Waves NotifyThreatDestroyed on
...
# leftover Mission03 NotifyThreatDestroyed #631.
...
# #628, leftover Mission03 NotifyThreatDestroyed
# #631, leftover Mission04 wave-state enum #bb22,
...
# leftover theater-kit #59, leftover #107–#647, plus
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission04IntegrationDirector::NotifyThreatDestroyed",
    "SkyguardMission04IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission04NotifyThreatDestroyedDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 NotifyThreatDestroyed method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission04 NotifyThreatDestroyed contains "
