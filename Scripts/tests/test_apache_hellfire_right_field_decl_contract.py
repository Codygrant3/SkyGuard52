# THIS IS leftover-safe ASkyguardApacheAircraft HellfireRight.
...
# then BARE `TObjectPtr<UStaticMeshComponent> HellfireRight;`
# (no initializer).
...
# Parse CLASS `ASkyguardApacheAircraft` protected UPROPERTY
# fields ONLY after `class ASkyguardApacheAircraft`.
# Start at `protected:`. Stop BEFORE `private:`.
# Stop BEFORE sibling GunnerMount as a claimed slot.
# Do NOT claim HellfireLeft / HydraLeft / HydraRight /
# PylonLeft / PylonRight / GunnerMount / PilotMount /
# EyeMount / WeaponMount / HullCollider / RotorPower.
# THIS IS leftover-safe ASkyguardApacheAircraft.HellfireRight.
# It is NOT leftover HellfireLeft (in-flight sibling),
# NOT leftover HydraLeft, NOT leftover HydraRight,
# NOT leftover PylonRight, NOT leftover analog
# apache-hull-collider, NOT leftover analog
# apache-mount-fail-closed, NOT leftover analog
# apache-aircraft-empty-fail-closed, NOT leftover analog
# apache-cpg-feel, NOT leftover gunship-weapon-stations,
# NOT leftover LoadoutSpec GuidedReserve /
# GuidedMagazineSize, NOT leftover StormRainBeatKit
# bHydraForClusters.
# Do NOT parse leftover analog apache-is-canopy-glass-cracked
# UFUNCTION, leftover analog Canopy field, leftover analog
# EngineRight / EngineLeft / RadarDome / HorizontalTail.
# Type is TObjectPtr<UStaticMeshComponent>, NOT
# TObjectPtr<USceneComponent>.
# Do NOT parse leftover Apache UFUNCTION decls,
# including GetRotorRPM / SetRotorPower /
# AimChinTurret / SetSensorView / IsCanopyGlassCracked.
...
# Do NOT parse leftover analog apache-silhouette-mesh-field,
# leftover analog apache-aircraft-root-field,
# leftover analog apache-canopy-field,
# leftover analog apache-nose-field,
# leftover analog apache-engine-right-field,
# leftover analog apache-engine-left-field,
# leftover analog apache-radar-dome-field,
# leftover analog apache-main-rotor-cross-field,
# leftover analog apache-horizontal-tail-field,
# leftover analog apache-hover-bob-centimeters-field,
# leftover analog apache-rotor-power-field,
# leftover analog apache-gear-nose-field.
# HellfireLeft / HydraLeft / HydraRight / PylonRight /
# GunnerMount are sibling slots being opened, not this slot.
# Do NOT parse leftover ProtectAsset MaxIntegrity / CurrentIntegrity.
# Do NOT parse leftover analog apache-max-integrity-field or
# leftover analog apache-current-integrity-field (keep those
# isolated sibling field decls in LOCKED_SCRIPTS).
# Do NOT parse leftover ArcadeLook UPROPERTY,
# leftover GuidedLockRules, leftover CampaignMissionSpec,
# leftover Harbor Breaker Approach/Contact/Shore, leftover
...
# Skyguard|Apache NOT Skyguard|Theater.
# LOCKED_DECL is `TObjectPtr<UStaticMeshComponent> HellfireRight;`
# NOT `FName WeatherIdentity;` and NOT
# `TObjectPtr<USceneComponent> HellfireRight;` and NOT
# leftover `HellfireLeft` / leftover `HydraLeft` / leftover
# `HydraRight` / leftover `PylonRight` / leftover
# `GunnerMount` and NOT leftover LoadoutSpec
# `GuidedReserve` / `GuidedMagazineSize` and NOT leftover
# StormRainBeatKit `bHydraForClusters` and NOT
...
TARGET = "TObjectPtr<UStaticMeshComponent> HellfireRight;"
TARGET_WRONG_INIT = "TObjectPtr<UStaticMeshComponent> HellfireRight = nullptr;"
TARGET_WRONG_FALSE = "TObjectPtr<UStaticMeshComponent> HellfireRight = false;"
TARGET_WRONG_TRUE = "TObjectPtr<UStaticMeshComponent> HellfireRight = true;"
TARGET_WRONG_SKELETAL = "TObjectPtr<USkeletalMeshComponent> HellfireRight;"
TARGET_WRONG_FNAME = "FName WeatherIdentity;"
TARGET_WRONG_HEALTH = "float Health = 160.f;"
TARGET_WRONG_SCENE = "TObjectPtr<USceneComponent> HellfireRight;"
TARGET_WRONG_FUSELAGE = "TObjectPtr<UStaticMeshComponent> Fuselage;"
TARGET_WRONG_NOSE = "TObjectPtr<UStaticMeshComponent> Nose;"
TARGET_WRONG_CANOPY = "TObjectPtr<UStaticMeshComponent> Canopy;"
TARGET_WRONG_TAIL_BOOM = "TObjectPtr<UStaticMeshComponent> TailBoom;"
TARGET_WRONG_HORIZONTAL_TAIL = "TObjectPtr<UStaticMeshComponent> HorizontalTail;"
TARGET_WRONG_TAIL_ROTOR = "TObjectPtr<UStaticMeshComponent> TailRotor;"
TARGET_WRONG_STUB_WING_LEFT = "TObjectPtr<UStaticMeshComponent> StubWingLeft;"
TARGET_WRONG_STUB_WING_RIGHT = "TObjectPtr<UStaticMeshComponent> StubWingRight;"
TARGET_WRONG_MAIN_ROTOR = "TObjectPtr<UStaticMeshComponent> MainRotor;"
TARGET_WRONG_MAIN_ROTOR_CROSS = "TObjectPtr<UStaticMeshComponent> MainRotorCross;"
TARGET_WRONG_VERTICAL_TAIL = "TObjectPtr<UStaticMeshComponent> VerticalTail;"
...
TARGET_WRONG_NIGHT_VISION = "TObjectPtr<UStaticMeshComponent> NightVisionTurret;"
TARGET_WRONG_CHIN_TURRET = "TObjectPtr<USceneComponent> ChinTurret;"
TARGET_WRONG_CHIN_HOUSING = "TObjectPtr<UStaticMeshComponent> ChinHousing;"
TARGET_WRONG_CHIN_BARREL = "TObjectPtr<UStaticMeshComponent> ChinBarrel;"
TARGET_WRONG_ROTOR_MAST = "TObjectPtr<UStaticMeshComponent> RotorMast;"
TARGET_WRONG_RADAR_DOME = "TObjectPtr<UStaticMeshComponent> RadarDome;"
TARGET_WRONG_ENGINE_LEFT = "TObjectPtr<UStaticMeshComponent> EngineLeft;"
TARGET_WRONG_GEAR_LEFT = "TObjectPtr<UStaticMeshComponent> GearLeft;"
TARGET_WRONG_GEAR_RIGHT = "TObjectPtr<UStaticMeshComponent> GearRight;"
TARGET_WRONG_ENGINE_RIGHT = "TObjectPtr<UStaticMeshComponent> EngineRight;"
TARGET_WRONG_SENSOR_BALL = "TObjectPtr<UStaticMeshComponent> SensorBall;"
TARGET_WRONG_GEAR_NOSE = "TObjectPtr<UStaticMeshComponent> GearNose;"
TARGET_WRONG_PYLON_LEFT = "TObjectPtr<UStaticMeshComponent> PylonLeft;"
TARGET_WRONG_PYLON_RIGHT = "TObjectPtr<UStaticMeshComponent> PylonRight;"
TARGET_WRONG_HYDRA_LEFT = "TObjectPtr<UStaticMeshComponent> HydraLeft;"
TARGET_WRONG_HYDRA_RIGHT = "TObjectPtr<UStaticMeshComponent> HydraRight;"
...
TARGET_WRONG_GUIDED_RESERVE = "int32 GuidedReserve = 6;"
TARGET_WRONG_GUIDED_MAGAZINE = "int32 GuidedMagazineSize = 2;"
TARGET_WRONG_ROCKET_RESERVE = "int32 RocketReserve = 24;"
TARGET_WRONG_ROCKET_MAGAZINE = "int32 RocketMagazineSize = 14;"
TARGET_WRONG_HYDRA_FOR_CLUSTERS = "bool bHydraForClusters = true;"
...
STOP_BEFORE_NIGHT_VISION = "NightVisionTurret"
STOP_BEFORE_RADAR_DOME = "RadarDome"
STOP_BEFORE_GEAR_LEFT = "GearLeft"
...
SIBLING_NOSE = "Nose"
SIBLING_CANOPY = "Canopy"
SIBLING_TAIL_BOOM = "TailBoom"
SIBLING_HORIZONTAL_TAIL = "HorizontalTail"
SIBLING_TAIL_ROTOR = "TailRotor"
SIBLING_STUB_WING_LEFT = "StubWingLeft"
SIBLING_STUB_WING_RIGHT = "StubWingRight"
SIBLING_MAIN_ROTOR = "MainRotor"
SIBLING_MAIN_ROTOR_CROSS = "MainRotorCross"
SIBLING_VERTICAL_TAIL = "VerticalTail"
SIBLING_PILOT_CANOPY = "PilotCanopy"
...
SIBLING_NIGHT_VISION = "NightVisionTurret"
SIBLING_CHIN_TURRET = "ChinTurret"
SIBLING_CHIN_HOUSING = "ChinHousing"
SIBLING_CHIN_BARREL = "ChinBarrel"
SIBLING_ROTOR_MAST = "RotorMast"
SIBLING_RADAR_DOME = "RadarDome"
SIBLING_ENGINE_LEFT = "EngineLeft"
SIBLING_GEAR_LEFT = "GearLeft"
SIBLING_GEAR_RIGHT = "GearRight"
SIBLING_ENGINE_RIGHT = "EngineRight"
SIBLING_SENSOR_BALL = "SensorBall"
SIBLING_GEAR_NOSE = "GearNose"
SIBLING_PYLON_LEFT = "PylonLeft"
SIBLING_PYLON_RIGHT = "PylonRight"
SIBLING_HYDRA_LEFT = "HydraLeft"
SIBLING_HYDRA_RIGHT = "HydraRight"
SIBLING_HELLFIRE_LEFT = "HellfireLeft"
SIBLING_GUNNER_MOUNT = "GunnerMount"
SIBLING_PILOT_MOUNT = "PilotMount"
SIBLING_EYE_MOUNT = "EyeMount"
...
LEFTOVER_APACHE_GEAR_NOSE = (
    "Scripts/tests/test_apache_gear_nose"
    "_field_decl_contract.py"
)
...
LEFTOVER_APACHE_HYDRA_LEFT = (
    "Scripts/tests/test_apache_hydra_left"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_HYDRA_RIGHT = (
    "Scripts/tests/test_apache_hydra_right"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_PYLON_LEFT = (
    "Scripts/tests/test_apache_pylon_left"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_PYLON_RIGHT = (
    "Scripts/tests/test_apache_pylon_right"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_GEAR_LEFT = (
    "Scripts/tests/test_apache_gear_left"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_GEAR_RIGHT = (
    "Scripts/tests/test_apache_gear_right"
    "_field_decl_contract.py"
)
...
LEFTOVER_STORM_RAIN_HYDRA_FOR_CLUSTERS = (
...
LEFTOVER_APACHE_ROTOR_MAST = (
    "Scripts/tests/test_apache_rotor_mast"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_MAIN_ROTOR = (
    "Scripts/tests/test_apache_main_rotor"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_TAIL_ROTOR = (
    "Scripts/tests/test_apache_tail_rotor"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_CHIN_TURRET = (
    "Scripts/tests/test_apache_chin_turret"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_CHIN_HOUSING = (
    "Scripts/tests/test_apache_chin_housing"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_CHIN_BARREL = (
    "Scripts/tests/test_apache_chin_barrel"
    "_field_decl_contract.py"
)
...
LEFTOVER_APACHE_NIGHT_VISION = (
    "Scripts/tests/test_apache_night_vision_turret"
    "_field_decl_contract.py"
)
...
LEFTOVER_APACHE_ENGINE_LEFT = (
    "Scripts/tests/test_apache_engine_left"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_ENGINE_RIGHT = (
    "Scripts/tests/test_apache_engine_right"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_RADAR_DOME = (
    "Scripts/tests/test_apache_radar_dome"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_MAIN_ROTOR_CROSS = (
    "Scripts/tests/test_apache_main_rotor_cross"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_HORIZONTAL_TAIL = (
    "Scripts/tests/test_apache_horizontal_tail"
    "_field_decl_contract.py"
)
...
LEFTOVER_APACHE_VERTICAL_TAIL = (
    "Scripts/tests/test_apache_vertical_tail"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_STUB_WING_LEFT = (
    "Scripts/tests/test_apache_stub_wing_left"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_TAIL_BOOM = (
    "Scripts/tests/test_apache_tail_boom"
    "_field_decl_contract.py"
)
LEFTOVER_APACHE_FUSELAGE = (
    "Scripts/tests/test_apache_fuselage"
    "_field_decl_contract.py"
)
...
LEFTOVER_APACHE_NOSE = (
    "Scripts/tests/test_apache_nose"
    "_field_decl_contract.py"
)
...
LEFTOVER_APACHE_HOVER_BOB = (
    "Scripts/tests/test_apache_hover_bob_centimeters"
    "_field_decl_contract.py"
)
...
def leftover_apache_ufunction_scripts() -> tuple[str, ...]:
    ...
    return (
        ...
        f"{prefix}test_apache_set_rotor_power_decl_contract.py",
        ...
        f"{prefix}test_apache_aim_chin_turret_decl_contract.py",
        f"{prefix}test_apache_set_orbit_focus_decl_contract.py",
    )
...
def leftover_analog_extra_scripts() -> tuple[str, ...]:
    ...
    ) + leftover_apache_ufunction_scripts()
...
HELLFIRE_RIGHT_DECL_RE = re.compile(
    r"TObjectPtr<UStaticMeshComponent>\s+HellfireRight\s*;"
)
HELLFIRE_RIGHT_INIT_RE = re.compile(
    r"TObjectPtr<UStaticMeshComponent>\s+HellfireRight\s*="
)
...
def sibling_uncontracted_decls() -> tuple[str, ...]:
    return (
        ...
        SIBLING_CANOPY,
        SIBLING_TAIL_BOOM,
        SIBLING_HORIZONTAL_TAIL,
        SIBLING_TAIL_ROTOR,
        SIBLING_STUB_WING_LEFT,
        SIBLING_STUB_WING_RIGHT,
        SIBLING_MAIN_ROTOR,
        SIBLING_MAIN_ROTOR_CROSS,
        SIBLING_VERTICAL_TAIL,
        SIBLING_PILOT_CANOPY,
        SIBLING_ROTOR_POWER,
        SIBLING_HOVER_BOB,
        ...
        SIBLING_NIGHT_VISION,
        SIBLING_CHIN_TURRET,
        SIBLING_CHIN_HOUSING,
        SIBLING_CHIN_BARREL,
        SIBLING_ROTOR_MAST,
        SIBLING_RADAR_DOME,
        SIBLING_ENGINE_LEFT,
        SIBLING_ENGINE_RIGHT,
        SIBLING_GEAR_LEFT,
        SIBLING_GEAR_RIGHT,
        SIBLING_SENSOR_BALL,
        SIBLING_GEAR_NOSE,
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # leftover HellfireLeft / HydraLeft / HydraRight / PylonRight,
    # leftover Fuselage / TailBoom / AircraftRoot, leftover
    # TObjectPtr<USceneComponent>, or an initializer on
    # HellfireRight as the slot.
    if not has_one_declaration(region, declaration):
        return False
    compact = collapsed(region)
    if HELLFIRE_RIGHT_DECL_RE.search(compact) is None:
        return False
    if HELLFIRE_RIGHT_INIT_RE.search(compact):
        return False
...
def protected_uproperty_fields(header: str) -> str:
    ...
    while True:
        ...
        if has_identifier(field_text, SIBLING_GUNNER_MOUNT):
            break
    ...
    if has_identifier(window, SIBLING_GUNNER_MOUNT):
        raise AssertionError(
            f"{CLASS_NAME} parse window claims sibling "
            f"{SIBLING_GUNNER_MOUNT}"
        )
    for later in (
        SIBLING_PILOT_MOUNT,
        SIBLING_EYE_MOUNT,
        ...
        if has_identifier(window, later):
            raise AssertionError(
                f"{CLASS_NAME} parse window claims sibling {later}"
            )
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    while True:
        ...
        if depth == 0 and re.match(
            r"\s*TObjectPtr<UStaticMeshComponent>\s+HellfireRight\b",
            compact[index:],
        ):
            return compact[start : index - 1]
        cursor = cursor + match.start() + 1
    raise AssertionError(
        "UPROPERTY for TObjectPtr<UStaticMeshComponent> HellfireRight "
...
class ApacheHellfireRightFieldDeclContractTests(unittest.TestCase):
    def test_apache_class_exists(self) -> None:
        ...
        self.assertTrue(has_identifier(section, "HellfireRight"), section)
        ...
        self.assertTrue(has_identifier(body, SIBLING_GEAR_LEFT), body)
        self.assertTrue(
            has_identifier(section, SIBLING_GEAR_LEFT),
            section,
        )
        self.assertTrue(has_identifier(body, SIBLING_GEAR_RIGHT), body)
        self.assertTrue(
            has_identifier(section, SIBLING_GEAR_RIGHT),
            section,
        )
        self.assertTrue(has_identifier(section, SIBLING_GEAR_NOSE), section)
        self.assertTrue(has_identifier(section, SIBLING_PYLON_LEFT), section)
        self.assertTrue(has_identifier(section, SIBLING_PYLON_RIGHT), section)
        self.assertTrue(has_identifier(section, SIBLING_HYDRA_LEFT), section)
        self.assertTrue(has_identifier(section, SIBLING_HYDRA_RIGHT), section)
        self.assertTrue(has_identifier(section, SIBLING_HELLFIRE_LEFT), section)
        self.assertTrue(has_identifier(body, SIBLING_GUNNER_MOUNT), body)
        self.assertFalse(
            has_identifier(section, SIBLING_GUNNER_MOUNT),
            section,
        )
        self.assertTrue(has_identifier(section, SIBLING_RADAR_DOME), section)
        self.assertTrue(has_identifier(section, SIBLING_NIGHT_VISION), section)
        self.assertTrue(has_identifier(section, SIBLING_PILOT_CANOPY), section)
        self.assertTrue(has_identifier(section, SIBLING_ENGINE_LEFT), section)
        self.assertTrue(has_identifier(section, SIBLING_SENSOR_BALL), section)
        self.assertTrue(has_identifier(section, SIBLING_STUB_WING_LEFT), section)
        self.assertTrue(has_identifier(section, SIBLING_STUB_WING_RIGHT), section)
        self.assertTrue(has_identifier(section, SIBLING_VERTICAL_TAIL), section)
        self.assertTrue(has_identifier(section, SIBLING_AIRCRAFT_ROOT), section)
        self.assertTrue(has_identifier(section, SIBLING_MAIN_ROTOR), section)
        self.assertTrue(has_identifier(section, SIBLING_TAIL_ROTOR), section)
        self.assertTrue(has_identifier(section, SIBLING_ROTOR_MAST), section)
        self.assertTrue(has_identifier(section, SIBLING_SENSOR_TURRET), section)
        self.assertTrue(has_identifier(section, SIBLING_CHIN_TURRET), section)
        self.assertTrue(has_identifier(section, SIBLING_CHIN_HOUSING), section)
        self.assertTrue(has_identifier(section, SIBLING_CHIN_BARREL), section)
        self.assertTrue(has_identifier(section, SIBLING_MAIN_ROTOR_CROSS), section)
        self.assertTrue(has_identifier(section, SIBLING_PILOT_CANOPY), section)
        self.assertTrue(has_identifier(section, SIBLING_RADAR_DOME), section)
        self.assertTrue(has_identifier(body, SIBLING_FUSELAGE), body)
        self.assertTrue(has_identifier(body, SIBLING_TAIL_BOOM), body)
        self.assertTrue(has_identifier(body, SIBLING_HORIZONTAL_TAIL), body)
        self.assertTrue(has_identifier(body, SIBLING_TAIL_ROTOR), body)
        self.assertTrue(has_identifier(body, SIBLING_CANOPY), body)
        self.assertTrue(has_identifier(body, SIBLING_NOSE), body)
        self.assertTrue(has_identifier(section, SIBLING_HORIZONTAL_TAIL), section)
        self.assertFalse(has_identifier(section, SIBLING_GUNNER_MOUNT), section)
    ...
    def test_leftover_class_same_identifier_does_not_satisfy(self) -> None:
        ...
        self.assertFalse(has_identifier(section, "HellfireRight"), section)
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, LOCKED_DECL)
        self.assertIn("HellfireRight", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_missing_hellfire_right_declaration_fails_closed(self) -> None:
        empty = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "protected:\n"
    ...
    def test_wrong_initializer_fails_closed(self) -> None:
        ...
        self.assertIn("TObjectPtr<UStaticMeshComponent> HellfireRight;", compact_origin)
        self.assertNotIn("GearNose = 160.f", compact_origin)
        self.assertNotIn("FName WeatherIdentity", compact_origin)
        self.assertNotIn("FName WeatherIdentity", compact_origin)

    def test_hellfire_right_declaration_matches_origin_main(self) -> None:
        section = spec_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("TObjectPtr<UStaticMeshComponent> HellfireRight"),
            LOCKED_DECL,
        )
        ...
        self.assertFalse(has_identifier(LOCKED_DECL, SIBLING_NOSE))
        self.assertNotIn(SIBLING_CANOPY, LOCKED_DECL)
        self.assertNotIn(SIBLING_TAIL_BOOM, LOCKED_DECL)
        self.assertNotIn(SIBLING_HORIZONTAL_TAIL, LOCKED_DECL)
        self.assertNotIn(SIBLING_TAIL_ROTOR, LOCKED_DECL)
        self.assertNotIn(SIBLING_STUB_WING_LEFT, LOCKED_DECL)
        self.assertNotIn(SIBLING_STUB_WING_RIGHT, LOCKED_DECL)
        self.assertNotIn(SIBLING_MAIN_ROTOR, LOCKED_DECL)
        self.assertNotIn(SIBLING_MAIN_ROTOR_CROSS, LOCKED_DECL)
        self.assertNotIn(SIBLING_VERTICAL_TAIL, LOCKED_DECL)
        self.assertNotIn(SIBLING_PILOT_CANOPY, LOCKED_DECL)
        self.assertNotIn(SIBLING_SILHOUETTE_MESH, LOCKED_DECL)
        ...
        self.assertNotIn(SIBLING_SENSOR_TURRET, LOCKED_DECL)
        self.assertNotIn(SIBLING_NIGHT_VISION, LOCKED_DECL)
        self.assertNotIn(SIBLING_CHIN_TURRET, LOCKED_DECL)
        self.assertNotIn(SIBLING_CHIN_HOUSING, LOCKED_DECL)
        self.assertNotIn(SIBLING_CHIN_BARREL, LOCKED_DECL)
        self.assertNotIn(SIBLING_ROTOR_MAST, LOCKED_DECL)
        self.assertNotIn(SIBLING_RADAR_DOME, LOCKED_DECL)
        self.assertNotIn(SIBLING_GUNNER_MOUNT, LOCKED_DECL)
        self.assertNotIn(SIBLING_PILOT_MOUNT, LOCKED_DECL)
        self.assertNotIn(SIBLING_GEAR_NOSE, LOCKED_DECL)
        self.assertNotIn(SIBLING_PYLON_LEFT, LOCKED_DECL)
        self.assertNotIn(SIBLING_PYLON_RIGHT, LOCKED_DECL)
        self.assertNotIn(SIBLING_HYDRA_LEFT, LOCKED_DECL)
        self.assertNotIn(SIBLING_HYDRA_RIGHT, LOCKED_DECL)
        self.assertNotIn(SIBLING_HELLFIRE_LEFT, LOCKED_DECL)
        self.assertNotIn("GuidedReserve", LOCKED_DECL)
        self.assertNotIn("GuidedMagazineSize", LOCKED_DECL)
        self.assertNotIn("RocketReserve", LOCKED_DECL)
        self.assertNotIn("RocketMagazineSize", LOCKED_DECL)
        self.assertNotIn("bHydraForClusters", LOCKED_DECL)
        self.assertNotIn(SIBLING_EYE_MOUNT, LOCKED_DECL)
        self.assertNotIn(SIBLING_WEAPON_MOUNT, LOCKED_DECL)
        ...
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_FUSELAGE}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_TAIL_BOOM}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_HORIZONTAL_TAIL}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_TAIL_ROTOR}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_CANOPY}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_NOSE}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_STUB_WING_LEFT}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_STUB_WING_RIGHT}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_MAIN_ROTOR}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_MAIN_ROTOR_CROSS}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_VERTICAL_TAIL}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_PILOT_CANOPY}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_SILHOUETTE}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_AIRCRAFT_ROOT}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_SENSOR_TURRET}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_NIGHT_VISION}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_CHIN_TURRET}\n", LOCKED_DECL)
        )
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_ROTOR_MAST}\n", LOCKED_DECL)
        )
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_locked_decl_is_not_leftover_clone_weather_identity(self) -> None:
        self.assertEqual(LOCKED_DECL, "TObjectPtr<UStaticMeshComponent> HellfireRight;")
        ...
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_ENGINE_LEFT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_ENGINE_RIGHT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_RADAR_DOME)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_SENSOR_BALL)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_NOSE)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_GEAR_LEFT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_GEAR_RIGHT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_HORIZONTAL_TAIL)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_GEAR_NOSE)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_PYLON_LEFT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_PYLON_RIGHT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_HYDRA_LEFT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_HYDRA_RIGHT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_HELLFIRE_LEFT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_GUNNER_MOUNT)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_GUIDED_RESERVE)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_GUIDED_MAGAZINE)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_ROCKET_RESERVE)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_ROCKET_MAGAZINE)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_HYDRA_FOR_CLUSTERS)
        ...
        self.assertNotIn("RocketMagazineSize", LOCKED_DECL)
        self.assertNotIn("bHydraForClusters", LOCKED_DECL)
        self.assertNotIn("HellfireLeft", LOCKED_DECL)
        self.assertNotIn("HydraLeft", LOCKED_DECL)
        self.assertNotIn("HydraRight", LOCKED_DECL)
        self.assertNotIn("PylonRight", LOCKED_DECL)
        self.assertNotIn("PylonLeft", LOCKED_DECL)
        self.assertNotIn("GunnerMount", LOCKED_DECL)
        self.assertNotEqual(
            LOCKED_DECL,
            "TObjectPtr<USceneComponent> HellfireRight;",
        )
        self.assertFalse(
            LOCKED_DECL.startswith("TObjectPtr<USceneComponent>"),
            LOCKED_DECL,
        )
        self.assertNotIn("WeatherIdentity", LOCKED_DECL)
        self.assertNotIn("FName ", LOCKED_DECL)
    ...
    def test_wrong_default_and_renames_do_not_satisfy(self) -> None:
        ...
        wrongs = (
            ...
            f"\t{TARGET_WRONG_TAIL_BOOM}\n",
            f"\t{TARGET_WRONG_HORIZONTAL_TAIL}\n",
            f"\t{TARGET_WRONG_TAIL_ROTOR}\n",
            f"\t{TARGET_WRONG_STUB_WING_LEFT}\n",
            f"\t{TARGET_WRONG_STUB_WING_RIGHT}\n",
            f"\t{TARGET_WRONG_MAIN_ROTOR}\n",
            f"\t{TARGET_WRONG_MAIN_ROTOR_CROSS}\n",
            f"\t{TARGET_WRONG_VERTICAL_TAIL}\n",
            f"\t{TARGET_WRONG_PILOT_CANOPY}\n",
            f"\t{TARGET_WRONG_SILHOUETTE}\n",
            f"\t{TARGET_WRONG_AIRCRAFT_ROOT}\n",
            f"\t{TARGET_WRONG_SENSOR_TURRET}\n",
            f"\t{TARGET_WRONG_NIGHT_VISION}\n",
            f"\t{TARGET_WRONG_CHIN_TURRET}\n",
            f"\t{TARGET_WRONG_CHIN_HOUSING}\n",
            f"\t{TARGET_WRONG_CHIN_BARREL}\n",
            f"\t{TARGET_WRONG_ROTOR_MAST}\n",
            f"\t{TARGET_WRONG_RADAR_DOME}\n",
            f"\t{TARGET_WRONG_ENGINE_LEFT}\n",
            f"\t{TARGET_WRONG_GEAR_LEFT}\n",
            f"\t{TARGET_WRONG_GEAR_RIGHT}\n",
            f"\t{TARGET_WRONG_ENGINE_RIGHT}\n",
            f"\t{TARGET_WRONG_NOSE}\n",
            f"\t{TARGET_WRONG_GEAR_LEFT}\n",
            f"\t{TARGET_WRONG_GEAR_RIGHT}\n",
            f"\t{TARGET_WRONG_ENGINE_RIGHT}\n",
            ...
            f"\t{TARGET_WRONG_GEAR_NOSE}\n",
            f"\t{TARGET_WRONG_PYLON_LEFT}\n",
            f"\t{TARGET_WRONG_PYLON_RIGHT}\n",
            f"\t{TARGET_WRONG_HYDRA_LEFT}\n",
            f"\t{TARGET_WRONG_HYDRA_RIGHT}\n",
            f"\t{TARGET_WRONG_HELLFIRE_LEFT}\n",
            f"\t{TARGET_WRONG_GUNNER_MOUNT}\n",
            f"\t{TARGET_WRONG_GUIDED_RESERVE}\n",
            f"\t{TARGET_WRONG_GUIDED_MAGAZINE}\n",
            f"\t{TARGET_WRONG_ROCKET_RESERVE}\n",
            f"\t{TARGET_WRONG_ROCKET_MAGAZINE}\n",
            f"\t{TARGET_WRONG_HYDRA_FOR_CLUSTERS}\n",
            leftover_primary,
            leftover_guided,
            "\tTObjectPtr<UStaticMeshComponent> HellfireRights;\n",
            "\tint32 HellfireRight = 140;\n",
            "\tbool HellfireRight = true;\n",
            "\tfloat HellfireRight = " + forty + ";\n",
            "\tfloat HellfireRight = " + eighty + ";\n",
        )
    ...
    def test_does_not_claim_sibling_gunner_mount_or_neighbors(self) -> None:
        for sibling in sibling_uncontracted_decls():
            self.assertFalse(has_identifier(LOCKED_DECL, sibling), sibling)
        for field in leftover_neighbor_hit_fields():
            self.assertNotIn(field, LOCKED_DECL)
        ...
        self.assertTrue(has_identifier(section, SIBLING_STUB_WING_LEFT))
        self.assertTrue(has_identifier(section, SIBLING_STUB_WING_RIGHT))
        self.assertTrue(has_identifier(section, SIBLING_VERTICAL_TAIL))
        self.assertTrue(has_identifier(section, SIBLING_MAIN_ROTOR))
        self.assertTrue(has_identifier(section, SIBLING_TAIL_ROTOR))
        self.assertTrue(has_identifier(section, SIBLING_ROTOR_MAST))
        self.assertTrue(has_identifier(section, SIBLING_SENSOR_TURRET))
        self.assertTrue(has_identifier(section, SIBLING_CHIN_TURRET))
        self.assertTrue(has_identifier(section, SIBLING_NIGHT_VISION))
        self.assertTrue(has_identifier(section, SIBLING_PILOT_CANOPY))
        self.assertTrue(has_identifier(section, SIBLING_ENGINE_LEFT))
        self.assertTrue(has_identifier(section, SIBLING_SENSOR_BALL))
        self.assertTrue(has_identifier(section, SIBLING_MAIN_ROTOR_CROSS))
        self.assertTrue(has_identifier(section, SIBLING_HORIZONTAL_TAIL))
        self.assertTrue(has_identifier(section, SIBLING_RADAR_DOME))
        self.assertTrue(has_identifier(section, SIBLING_ENGINE_RIGHT))
        self.assertTrue(has_identifier(section, SIBLING_GEAR_NOSE))
        self.assertTrue(has_identifier(section, SIBLING_GEAR_LEFT))
        self.assertTrue(has_identifier(section, SIBLING_GEAR_RIGHT))
        self.assertTrue(has_identifier(section, SIBLING_PYLON_LEFT))
        self.assertTrue(has_identifier(section, SIBLING_PYLON_RIGHT))
        self.assertTrue(has_identifier(section, SIBLING_HYDRA_LEFT))
        self.assertTrue(has_identifier(section, SIBLING_HYDRA_RIGHT))
        self.assertTrue(has_identifier(section, SIBLING_HELLFIRE_LEFT))
        self.assertFalse(has_identifier(section, SIBLING_GUNNER_MOUNT))
        self.assertFalse(has_identifier(section, SIBLING_PILOT_MOUNT))
        self.assertFalse(has_identifier(section, SIBLING_EYE_MOUNT))
        self.assertFalse(has_identifier(section, SIBLING_WEAPON_MOUNT))
        ...
        self.assertIn(TARGET_WRONG_RADAR_DOME, section)
        self.assertNotIn(TARGET_WRONG_ENGINE_LEFT, LOCKED_DECL)
        self.assertNotIn(TARGET_WRONG_SENSOR_BALL, LOCKED_DECL)
        self.assertNotIn(TARGET_WRONG_CANOPY, LOCKED_DECL)
        self.assertIn(TARGET_WRONG_MAIN_ROTOR_CROSS, section)
        self.assertNotIn(SIBLING_NIGHT_VISION, LOCKED_DECL)
        self.assertNotIn(SIBLING_STUB_WING_RIGHT, LOCKED_DECL)
        self.assertNotIn(SIBLING_VERTICAL_TAIL, LOCKED_DECL)
        self.assertNotIn(SIBLING_PILOT_CANOPY, LOCKED_DECL)
    ...
    def test_does_not_parse_private_or_neighbors(self) -> None:
        ...
        self.assertIn(STOP_BEFORE_PRIVATE, leaked)
        self.assertNotIn(STOP_BEFORE_PRIVATE, section)
        self.assertTrue(has_identifier(leaked, SIBLING_GEAR_LEFT))
        self.assertTrue(has_identifier(section, SIBLING_GEAR_LEFT))
        self.assertTrue(has_identifier(leaked, SIBLING_GEAR_RIGHT))
        self.assertTrue(has_identifier(section, SIBLING_GEAR_RIGHT))
        self.assertTrue(has_identifier(leaked, SIBLING_HELLFIRE_LEFT))
        self.assertTrue(has_identifier(section, SIBLING_HELLFIRE_LEFT))
        self.assertTrue(has_identifier(leaked, SIBLING_GUNNER_MOUNT))
        self.assertFalse(has_identifier(section, SIBLING_GUNNER_MOUNT))
        self.assertTrue(has_identifier(leaked, SIBLING_RADAR_DOME))
        self.assertTrue(has_identifier(section, SIBLING_RADAR_DOME))
        self.assertTrue(has_identifier(leaked, SIBLING_NIGHT_VISION))
        self.assertTrue(has_identifier(section, SIBLING_NIGHT_VISION))
        self.assertTrue(has_identifier(leaked, SIBLING_MAIN_ROTOR_CROSS))
        self.assertTrue(has_identifier(section, SIBLING_MAIN_ROTOR_CROSS))
        self.assertTrue(has_identifier(leaked, SIBLING_PILOT_CANOPY))
        self.assertTrue(has_identifier(section, SIBLING_PILOT_CANOPY))
        self.assertTrue(has_identifier(leaked, SIBLING_ENGINE_LEFT))
        self.assertTrue(has_identifier(section, SIBLING_ENGINE_LEFT))
        self.assertTrue(has_identifier(leaked, SIBLING_HORIZONTAL_TAIL))
        self.assertTrue(has_identifier(section, SIBLING_HORIZONTAL_TAIL))
        self.assertTrue(has_identifier(leaked, SIBLING_TAIL_ROTOR))
        self.assertTrue(has_identifier(section, SIBLING_TAIL_ROTOR))
        self.assertTrue(has_identifier(leaked, SIBLING_MAIN_ROTOR))
        self.assertTrue(has_identifier(section, SIBLING_MAIN_ROTOR))
        self.assertTrue(has_identifier(leaked, SIBLING_SENSOR_TURRET))
        self.assertTrue(has_identifier(section, SIBLING_SENSOR_TURRET))
        self.assertTrue(has_identifier(leaked, SIBLING_ROTOR_POWER))
        self.assertFalse(has_identifier(section, SIBLING_ROTOR_POWER))
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertIn("SkyguardApacheAircraft.h", HEADER_PATH)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "apache HellfireRight field decl contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(Path(__file__).name.endswith(
            "hellfire_right_field_decl_contract.py"
        ))
        self.assertNotIn("SkyguardApacheAircraft.cpp", THIS_SCRIPT)
        ...
        self.assertIn(LEFTOVER_APACHE_GEAR_NOSE, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_HELLFIRE_LEFT, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_HYDRA_LEFT, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_HYDRA_RIGHT, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_PYLON_LEFT, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_PYLON_RIGHT, LOCKED_SCRIPTS)
        ...
        self.assertIn(LEFTOVER_STORM_RAIN_HYDRA_FOR_CLUSTERS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_GUNSHIP_WEAPON_STATIONS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_ROTOR_MAST, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_MAIN_ROTOR, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_TAIL_ROTOR, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_CHIN_TURRET, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_CHIN_HOUSING, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_CHIN_BARREL, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_SENSOR_TURRET, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_SENSOR_BALL, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_NIGHT_VISION, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_PILOT_CANOPY, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_ENGINE_LEFT, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_ENGINE_RIGHT, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_RADAR_DOME, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_MAIN_ROTOR_CROSS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_HORIZONTAL_TAIL, LOCKED_SCRIPTS)
        ...
        self.assertIn(LEFTOVER_APACHE_VERTICAL_TAIL, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_STUB_WING_LEFT, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_TAIL_BOOM, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_FUSELAGE, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_CANOPY, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_NOSE, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_AIRCRAFT_ROOT, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_HOVER_BOB, LOCKED_SCRIPTS)
    ...
    def test_contract_is_target_field_declaration_only(self) -> None:
        ...
        self.assertFalse(has_identifier(locked_only, SIBLING_NOSE))
        self.assertNotIn(SIBLING_CANOPY, locked_only)
        self.assertNotIn(SIBLING_TAIL_BOOM, locked_only)
        self.assertNotIn(SIBLING_HORIZONTAL_TAIL, locked_only)
        self.assertNotIn(SIBLING_TAIL_ROTOR, locked_only)
        self.assertNotIn(SIBLING_STUB_WING_LEFT, locked_only)
        self.assertNotIn(SIBLING_STUB_WING_RIGHT, locked_only)
        self.assertNotIn(SIBLING_MAIN_ROTOR, locked_only)
        self.assertNotIn(SIBLING_MAIN_ROTOR_CROSS, locked_only)
        self.assertNotIn(SIBLING_VERTICAL_TAIL, locked_only)
        self.assertNotIn(SIBLING_PILOT_CANOPY, locked_only)
        self.assertNotIn(SIBLING_SILHOUETTE_MESH, locked_only)
        ...
        self.assertNotIn(SIBLING_SENSOR_TURRET, locked_only)
        self.assertNotIn(SIBLING_NIGHT_VISION, locked_only)
        self.assertNotIn(SIBLING_CHIN_TURRET, locked_only)
        self.assertNotIn(SIBLING_CHIN_HOUSING, locked_only)
        self.assertNotIn(SIBLING_CHIN_BARREL, locked_only)
        self.assertNotIn(SIBLING_ROTOR_MAST, locked_only)
        self.assertNotIn(SIBLING_RADAR_DOME, locked_only)
        self.assertNotIn(SIBLING_ENGINE_LEFT, locked_only)
        self.assertNotIn(SIBLING_SENSOR_BALL, locked_only)
        self.assertNotIn(SIBLING_GUNNER_MOUNT, locked_only)
        self.assertNotIn(SIBLING_GEAR_NOSE, locked_only)
        self.assertNotIn(SIBLING_PYLON_LEFT, locked_only)
        self.assertNotIn(SIBLING_PYLON_RIGHT, locked_only)
        self.assertNotIn(SIBLING_HYDRA_LEFT, locked_only)
        self.assertNotIn(SIBLING_HYDRA_RIGHT, locked_only)
        self.assertNotIn(SIBLING_HELLFIRE_LEFT, locked_only)
        self.assertNotIn("GuidedReserve", locked_only)
        self.assertNotIn("GuidedMagazineSize", locked_only)
        self.assertNotIn("RocketReserve", locked_only)
        self.assertNotIn("RocketMagazineSize", locked_only)
        self.assertNotIn("bHydraForClusters", locked_only)
