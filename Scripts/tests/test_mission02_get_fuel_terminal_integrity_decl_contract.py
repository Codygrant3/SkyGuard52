...
# INDEX_NONE or lock GetFuelTerminalIntegrity
# construction in the .cpp. This is leftover-safe
# Mission02 Objectives GetFuelTerminalIntegrity METHOD on
# ASkyguardMission02IntegrationDirector. It is
# NOT leftover Mission10 GetReadiness #776 /
# branch cursor/mission10-get-readiness-decl-
# contract-c332, NOT leftover same-name GetReadiness.
# NOT leftover Mission09 GetReadiness #758 /
# branch cursor/mission09-get-readiness-decl-
# contract-c332, NOT leftover Mission08
# GetReadiness #739, NOT leftover Mission07
# GetReadiness #718, NOT leftover Mission06
# GetReadiness #697, NOT leftover Mission05
# GetReadiness #681, NOT leftover closed
# Mission04 GetReadiness #658, NOT leftover
...
# leftover Mission01 / Mission03 / Mission10 GetReadiness,
...
# sibling Integration / Waves / Hoist / Safety /
...
# NotifyThreatDestroyed / StartHoistWindow /
# AdvanceHoistWindow / ValidateWeaponRelease /
# NotifyProtectedTargetDamage /
# NotifyProtectedAssetFailed /
# HandleDroneCityImpact /
# SynchronizeRuntimeState / IsCorePlayableReady /
# GetObjectiveRuntime / GetReadiness /
# GetWaveState / GetRemainingThreatsInWave /
# GetCurrentWaveIndex / GetConvoyIntegrity /
# GetSubstationIntegrity / NotifyFuelTerminalDamage /
# GetPoolRuntime / GetHoistRuntime /
# GetRejectedWeaponReleases /
# GetProtectedTarget / GetSurvivingTargetCount /
...
# leftover Mission01 GetReadiness,
# leftover Mission03 GetReadiness,
# leftover Mission04 GetReadiness,
# leftover Mission05 GetReadiness,
# leftover Mission06 GetReadiness #697,
# leftover Mission07 GetReadiness #718,
# leftover Mission08 GetReadiness #739,
# leftover Mission10 GetReadiness #776,
# leftover Mission02 InitializePlayableMission #828 /
# leftover Mission02 Configure #829 /
# leftover Mission02 StartNextWave #830 /
# leftover Mission02 NotifyThreatDestroyed #831 /
# leftover Mission02 NotifyFuelTerminalDamage #832,
# leftover Mission02 GetReadiness #837,
# leftover Mission02 GetWaveState #838,
# leftover Mission03 GetConvoyIntegrity #645,
# leftover Mission04 GetSubstationIntegrity #661,
# leftover MaximumProtectedIntegrity #808,
...
# (`int32 GetFuelTerminalIntegrity()
# const { return FuelTerminalIntegrity; }`);
...
# Targets / Integration / Boss / Destruction / Briefing /
# Hoist / Rescue / Safety / Performance / Evacuation,
# not Environment,
...
# Mission06 Waves #689, not leftover Mission05
# Waves #669, not leftover Mission07 Integration #718,
# not leftover Mission08 Integration #739, not leftover
# Harbor Mission02, not leftover Mission09 Waves /
...
# drafts #674–#736, leftover Apache
...
# Mission10 GetReadiness #776. Do not reopen leftover
# Mission02 InitializePlayableMission #828 /
# leftover Mission02 Configure #829 /
# leftover Mission02 StartNextWave #830 /
# leftover Mission02 NotifyThreatDestroyed #831 /
# leftover Mission02 NotifyFuelTerminalDamage #832 /
# leftover merged Mission02 C++ bundle #102. Do not reopen leftover
...
# Mission06 #696 / Mission05 #684. Do not reopen
# leftover drafts #56–#64, leftover drafts
# #107–#673, leftover #664, closed-without-merge
# #658–#673. Do not reopen open drafts #674–#774+.
...
GET_FUEL_TERMINAL_INTEGRITY = (
    "int32 GetFuelTerminalIntegrity() const"
)
GET_READINESS = (
...
# leftover Mission05 GetReadiness #681,
# leftover Mission04 GetReadiness #658,
# leftover Mission06 GetReadiness #697,
# leftover Mission07 GetReadiness #718,
# leftover Mission08 GetReadiness #739,
# leftover Mission10 GetReadiness #776,
...
# leftover Mission04 GetSubstationIntegrity #661,
# leftover MaximumProtectedIntegrity #808,
# leftover Mission09 GetReadiness #758,
...
# an isolated Python GetFuelTerminalIntegrity
...
# #628, leftover Harbor #6/#8/#9 / leftover merged
# Mission02 C++ bundle #102, leftover
...
LEFTOVER_MISSION10_GET_READINESS_NOT_LOCKED = (
    ...
    "cursor/mission10-get-readiness-decl-contract-c332",
)
LEFTOVER_MISSION02_SIBLING_METHODS_NOT_LOCKED = (
    ...
    "test_mission03_get_convoy_integrity_decl_contract.py",
    "test_mission04_get_substation_integrity_decl_contract.py",
...
LEFTOVER_MISSION03_GET_READINESS_NOT_LOCKED = (
    ...
    "FSkyguardMission03IntegrationReadiness",
    'Category="Skyguard|Mission03|Integration"',
)
...
LEFTOVER_MISSION05_GET_READINESS_NOT_LOCKED = (
    "test_mission05_get_readiness_decl_contract.py",
    "ASkyguardMission05IntegrationDirector",
    "SkyguardMission05IntegrationDirector.h",
...
LEFTOVER_MISSION06_GET_READINESS_NOT_LOCKED = (
    "test_mission06_get_readiness_decl_contract.py",
    "ASkyguardMission06IntegrationDirector",
    "SkyguardMission06IntegrationDirector.h",
...
LEFTOVER_MISSION08_GET_READINESS_NOT_LOCKED = (
    ...
    'Category="Skyguard|Mission08|Integration"',
    "cursor/mission08-get-readiness-decl-contract-c332",
)
LEFTOVER_MISSION09_GET_READINESS_NOT_LOCKED = (
    "test_mission09_get_readiness_decl_contract.py",
    "ASkyguardMission09IntegrationDirector",
    "SkyguardMission09IntegrationDirector.h",
    "FSkyguardMission09IntegrationReadiness",
    'Category="Skyguard|Mission09|Integration"',
    "cursor/mission09-get-readiness-decl-contract-c332",
)
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission07IntegrationDirector::GetReadiness",
    "SkyguardMission07IntegrationDirector.cpp",
    "ASkyguardMission08IntegrationDirector::GetReadiness",
    "SkyguardMission08IntegrationDirector.cpp",
    "ASkyguardMission09IntegrationDirector::GetReadiness",
    "SkyguardMission09IntegrationDirector.cpp",
    "ASkyguardMission02IntegrationDirector::GetReadiness",
    "SkyguardMission02IntegrationDirector.cpp",
    "ASkyguardMission10IntegrationDirector::GetReadiness",
    "SkyguardMission10IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission02GetFuelTerminalIntegrityDeclContractTests(unittest.TestCase):
    def test_mission02_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, GET_FUEL_TERMINAL_INTEGRITY),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, GET_FUEL_TERMINAL_INTEGRITY)
        self.assertIn("GetFuelTerminalIntegrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, GET_FUEL_TERMINAL_INTEGRITY)
    ...
    def test_missing_get_fuel_terminal_integrity_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, GET_FUEL_TERMINAL_INTEGRITY)
        self.assertIn("GetFuelTerminalIntegrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, GET_FUEL_TERMINAL_INTEGRITY)
        self.assertIn("GetFuelTerminalIntegrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("BlueprintPure", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("Category", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("BlueprintCallable", UFUNCTION_OBJECTIVES)
        ...
        self.assertIn("Objectives", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Integration", UFUNCTION_OBJECTIVES)
        self.assertIn("BlueprintPure", UFUNCTION_OBJECTIVES)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, GET_FUEL_TERMINAL_INTEGRITY)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, GET_FUEL_TERMINAL_INTEGRITY)
        self.assertIn("GetFuelTerminalIntegrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tvoid GetFuelTerminalIntegrity() const;\n"
        )
        as_const = (
            "\tint32 GetFuelTerminalIntegrity();\n"
        )
        with_arg = (
            "\tint32 GetFuelTerminalIntegrity(int32 Amount) const;\n"
        )
        renamed = (
            "\tint32 GetReadyState() const;\n"
        )
        short_name = "\tbool GetFuelTerminalIntegrity() const;\n"
        leftover_m06_type = (
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, GET_FUEL_TERMINAL_INTEGRITY)
            self.assertIn("GetFuelTerminalIntegrity", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_get_fuel_terminal_integrity_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, GET_FUEL_TERMINAL_INTEGRITY),
            GET_FUEL_TERMINAL_INTEGRITY,
        )
        self.assertTrue(has_declaration(section, GET_FUEL_TERMINAL_INTEGRITY))
        self.assertEqual(
            declaration_count(section, GET_FUEL_TERMINAL_INTEGRITY),
            1,
        )
        self.assertTrue(
            GET_FUEL_TERMINAL_INTEGRITY.startswith("int32 "),
            GET_FUEL_TERMINAL_INTEGRITY,
        )
        self.assertTrue(
            GET_FUEL_TERMINAL_INTEGRITY.startswith("int32 "),
        ...
        self.assertNotIn("FSkyguardMission02IntegrationReadiness", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertIn("GetFuelTerminalIntegrity", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetReadiness", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn(";", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertIn("return FuelTerminalIntegrity;", section)
        self.assertIn(UFUNCTION_OBJECTIVES, section)
        self.assertIn(" const", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertIn("()", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("TArray<", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("TObjectPtr", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("TSoftObjectPtr", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("INDEX_NONE", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("UFUNCTION", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("{", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("}", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("return ", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertIn(" const", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("Root", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("Briefing", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("AudioDirector", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("RadioChatter", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("SortiePresentation", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("CampaignDefinition", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("MissionDefinition", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("Readiness;", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("bAutoInitialize", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("bAllowBoundedActorSpawning", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("bAutoLaunchAfterBriefing", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("PathfinderSpawnLocation", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetAircraft", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("BindRuntimeActors", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("HandleDroneCityImpact", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("InitializePlayableMission", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("StartNextWave", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("AdvanceConvoyByDistance", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("NotifyConvoyDamage", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetWaveState", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetConvoyRouteState", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetDayBeatKit", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetNightBeatKit", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("StartSearchlightWindow", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("AdvanceSearchlightTrack", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("NotifySubstationDamage", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetRemainingThreatsInWave", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetSearchlightRuntime", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetSubstationIntegrity", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("StartPayloadWindow", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("AdvancePayloadWindow", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("TryJamActivePayload", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("NotifyAirfieldTargetDamage", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetPayloadWindow", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetTargetRuntime", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetSurvivingTargetCount", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetDayBeatKind", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetDayBeatIndex", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("TickDayBeatKit", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("HandleBossPhaseChanged", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ASkyguardMission06IntegrationDirector", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ASkyguardMission07IntegrationDirector", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ESkyguardMission06WaveState", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ESkyguardMission07WaveState", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ESkyguardMission08WaveState", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ESkyguardMission09WaveState", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ESkyguardMission07ProtectedTarget", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ESkyguardMission08ProtectedTarget", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ESkyguardMission09ProtectedTarget", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("FSkyguardMission07ProtectedTargetRuntime", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("FSkyguardMission08ProtectedTargetRuntime", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("FSkyguardMission09ProtectedTargetRuntime", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("FSkyguardMission08IntegrationReadiness", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("FSkyguardMission09IntegrationReadiness", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("FSkyguardMission09PoolRuntime", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("FSkyguardMission09PoolBudget", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ASkyguardMission08IntegrationDirector", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("BindCampaignRuntime", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetPoolRuntime", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ESkyguardSearchSector", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("FSkyguardSearchTrackRuntime", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ClassifyFalseTrack", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ConfirmRadarGhostIdentification", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("NotifyProtectedTargetDamage", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("AdvanceReinforcementTimer", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetSearchSector", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetClassifiedFalseTrackCount", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("IsHostileContactConfirmed", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetProtectedTarget", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetReinforcementTimeRemaining", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetNightBeatKind", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetNightBeatIndex", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("TickNightBeatKit", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ESkyguardAirfieldTarget", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ConvoyRuntimeAnchor", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("RoadHunterSpawnLocation", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ASkyguardMission02IntegrationDirector", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ConfigureMissionDefinition", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("NotifyObjectiveProgress", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("NotifyProtectedAssetFailed", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("SynchronizeRuntimeState", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("NotifyThreatDestroyed", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("IsCorePlayableReady", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetObjectiveRuntime", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetGunner", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetPathfinder", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetMissionId", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ValidateMissionContract", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ConfigureFromMission", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("AdvanceBriefing", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("SetAssetsReady", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("AcknowledgeAndLaunch", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("CanLaunch", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetElapsedSeconds", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetBriefingState", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetMinimumWarmupSeconds", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetBriefingText", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetRadioChatter", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetPresentation", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetMissionTitle", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("AcknowledgeBriefing", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("LaunchSortie", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("HullCollider", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("OpticalTracker", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("WeaponServo", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("CountermeasurePod", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("MinHeightFromOriginCm", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("RadarNode", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ESkyguardMission02WaveState", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("HarborIndustrial", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("MaxIntegrity", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("CurrentIntegrity", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("FillAndFinalize", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("FillAndFail", GET_FUEL_TERMINAL_INTEGRITY)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, GET_FUEL_TERMINAL_INTEGRITY)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tint32\n"
            "\tGetFuelTerminalIntegrity() const;\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_OBJECTIVES} {GET_FUEL_TERMINAL_INTEGRITY}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{GET_FUEL_TERMINAL_INTEGRITY}\n}}\n"
        self.assertTrue(has_declaration(one_line, GET_FUEL_TERMINAL_INTEGRITY))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, GET_FUEL_TERMINAL_INTEGRITY),
            section,
    ...
    def test_environment_category_does_not_satisfy_objectives(self) -> None:
        ...
        self.assertNotEqual(leftover_m02, UFUNCTION_OBJECTIVES)
        ...
        self.assertNotEqual(leftover_m05_waves, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_integration, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m07_ready, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m08_waves, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m08_hoist, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m08_safety, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m08_protection, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m08_ready, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m09_ready, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m09_waves, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m10_safety, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m09_protection, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m09_performance, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m09_objectives, UFUNCTION_OBJECTIVES)
        ...
        self.assertNotIn(leftover_m02, UFUNCTION_OBJECTIVES)
        ...
        self.assertNotIn(leftover_m05_waves, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_integration, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m07_ready, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m08_waves, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m08_hoist, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m08_safety, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m08_protection, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m08_ready, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m09_ready, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m09_waves, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m10_safety, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m09_protection, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m09_performance, UFUNCTION_OBJECTIVES)
        self.assertNotIn(leftover_m09_objectives, UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission01", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission03", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission04", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Mission05", UFUNCTION_OBJECTIVES)
    ...
    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        locked_only = f"{GET_FUEL_TERMINAL_INTEGRITY}\n"
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, GET_FUEL_TERMINAL_INTEGRITY)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", GET_FUEL_TERMINAL_INTEGRITY)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_get_fuel_terminal_integrity_cpp_body(self) -> None:
        locked_only = f"{GET_FUEL_TERMINAL_INTEGRITY}\n"
        self.assertNotIn("{", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("}", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("return ", GET_FUEL_TERMINAL_INTEGRITY)
        ...
        self.assertNotIn("return false", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("return true", GET_FUEL_TERMINAL_INTEGRITY)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{GET_FUEL_TERMINAL_INTEGRITY}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_FUEL_TERMINAL_INTEGRITY)
        self.assertIn("GetFuelTerminalIntegrity", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetReadiness", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertTrue(GET_FUEL_TERMINAL_INTEGRITY.startswith("int32 "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, GET_FUEL_TERMINAL_INTEGRITY)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("CurrentIntegrity", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("SkyguardApacheAircraft.h", GET_FUEL_TERMINAL_INTEGRITY)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", GET_FUEL_TERMINAL_INTEGRITY)
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        self.assertNotIn("550.f", GET_FUEL_TERMINAL_INTEGRITY)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{GET_FUEL_TERMINAL_INTEGRITY}\n"
        self.assertEqual(
            require_declaration(locked_only, GET_FUEL_TERMINAL_INTEGRITY),
            GET_FUEL_TERMINAL_INTEGRITY,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_FUEL_TERMINAL_INTEGRITY)
        ...
        self.assertNotIn("GetConvoyIntegrity", locked_only)
        self.assertNotIn("GetSubstationIntegrity", locked_only)
        self.assertNotIn("GetCurrentWaveIndex", locked_only)
        self.assertNotIn("NotifyFuelTerminalDamage", locked_only)
        self.assertNotIn("MaximumProtectedIntegrity", locked_only)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ASkyguardIronRainBoss", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ASkyguardRadarGhostBoss", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ASkyguardTempestBoss", section)
        self.assertNotIn("ASkyguardLastFlightBoss", GET_FUEL_TERMINAL_INTEGRITY)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 GetFuelTerminalIntegrity method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{GET_FUEL_TERMINAL_INTEGRITY}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, GET_FUEL_TERMINAL_INTEGRITY.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                GET_FUEL_TERMINAL_INTEGRITY.lower(),
                "mission02 GetFuelTerminalIntegrity contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, GET_FUEL_TERMINAL_INTEGRITY)

    def test_contract_is_get_fuel_terminal_integrity_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_get_fuel_terminal_integrity(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, GET_FUEL_TERMINAL_INTEGRITY)
            )
            self.assertNotEqual(GET_FUEL_TERMINAL_INTEGRITY, leftover)
        self.assertIn(
    ...
    def test_leftover_mission10_get_readiness_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
        ...
        for token in LEFTOVER_MISSION10_GET_READINESS_NOT_LOCKED:
            self.assertNotIn(token, GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("Mission10", UFUNCTION_OBJECTIVES)
        leftover_m10_type = (
            "\tconst FSkyguardMission10IntegrationReadiness& "
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m10_type, GET_FUEL_TERMINAL_INTEGRITY)
        self.assertIn("GetFuelTerminalIntegrity", str(raised.exception))
        self.assertNotIn(
            "cursor/mission10-get-readiness-decl-contract-c332",
            GET_FUEL_TERMINAL_INTEGRITY,
        ...
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover_harbor)
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_leftover_handle_drone_city_impact_does_not_satisfy(self) -> None:
        ...
        self.assertIn("GetFuelTerminalIntegrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, GET_FUEL_TERMINAL_INTEGRITY))
        locked_only = f"{GET_FUEL_TERMINAL_INTEGRITY}\n"
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission02_get_fuel_terminal_integrity"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_get_fuel_terminal_integrity"
                "_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission02_notify_fuel_terminal_damage"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_get_convoy_integrity"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission04_get_substation_integrity"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_maximum_protected_integrity"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission02_get_current_wave_index"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_mission07_get_readiness_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m07_type, GET_FUEL_TERMINAL_INTEGRITY)
        self.assertIn("GetFuelTerminalIntegrity", str(raised.exception))
    ...
    def test_sibling_mission08_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("NotifyThreatDestroyed", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("StartNextWave", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("StartHoistWindow", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("AdvanceHoistWindow", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ValidateWeaponRelease", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("IsCorePlayableReady", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("SynchronizeRuntimeState", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetObjectiveRuntime", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetWaveState", GET_FUEL_TERMINAL_INTEGRITY)
    ...
    def test_leftover_mission08_get_readiness_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m08_type, GET_FUEL_TERMINAL_INTEGRITY)
        self.assertIn("GetFuelTerminalIntegrity", str(raised.exception))
        self.assertNotIn(
            "cursor/mission08-get-readiness-decl-contract-c332",
            GET_FUEL_TERMINAL_INTEGRITY,
    ...
    def test_leftover_mission09_get_readiness_does_not_satisfy(self) -> None:
        ...
        for token in LEFTOVER_MISSION09_GET_READINESS_NOT_LOCKED:
            self.assertNotIn(token, GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("Mission09", UFUNCTION_OBJECTIVES)
        leftover_m09_type = (
            "\tconst FSkyguardMission09IntegrationReadiness& "
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m09_type, GET_FUEL_TERMINAL_INTEGRITY)
        self.assertIn("GetFuelTerminalIntegrity", str(raised.exception))
        self.assertNotIn(
            "cursor/mission09-get-readiness-decl-contract-c332",
            GET_FUEL_TERMINAL_INTEGRITY,
    ...
    def test_contract_does_not_relock_leftover_mission10_route_phase_enum(
        ...
        self.assertNotIn("GetRoutePhase", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("Waves", UFUNCTION_OBJECTIVES)
        self.assertNotIn("Integration", UFUNCTION_OBJECTIVES)
    ...
    def test_contract_does_not_relock_leftover_mission10_protected_group(
        ...
        self.assertNotIn("Protection", UFUNCTION_OBJECTIVES)
        self.assertNotIn("GetProtectedGroup", GET_FUEL_TERMINAL_INTEGRITY)
    ...
    def test_leftover_mission10_sibling_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("HandleDroneCityImpact", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("UFUNCTION", GET_DAY_BEAT_KIT)
        self.assertNotIn("StartPhaseWave", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("InitializePlayableMission", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("ValidateWeaponRelease", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertNotIn("GetRoutePhase", GET_FUEL_TERMINAL_INTEGRITY)
        self.assertIn(
