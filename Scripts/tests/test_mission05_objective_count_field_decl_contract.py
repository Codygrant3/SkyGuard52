...
# INDEX_NONE or lock ObjectiveCount
# construction in the .cpp. This is leftover-safe
# Mission05 IntegrationReadiness ObjectiveCount
...
# an isolated Python ObjectiveCount
...
# bProtectedTargetsReady stay leftover-only.
# THIS IS NOT leftover Mission02 ObjectiveCount #873,
# Mission03 ObjectiveCount #905, Mission04 ObjectiveCount
# #939, or Mission10 ObjectiveCount #823.
LOCKED = {
...
class Mission05ObjectiveCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("ObjectiveCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_objective_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_objective_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 ObjectiveCount"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= 0;"), LOCKED_DECL)
        self.assertIn("ObjectiveCount", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        for header in (
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertTrue(
                has_declaration(section, OBJECTIVE_COUNT_ONE),
                section,
            )
        one_line = f"{{\npublic:\n\t{LOCKED_DECL}\n}}\n"
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("ObjectiveCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 ObjectiveCount"))
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        # This Mission04 field default false is not Harbor 40/80.
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("ObjectiveCount", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 ObjectiveCount field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 ObjectiveCount contains "
    ...
    def test_contract_is_objective_count_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_objective_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_objective_count"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_sibling_count_fields_do_not_satisfy_objective_count(self) -> None:
        leftover_wave = "\tint32 WaveCount = 0;\n"
        leftover_protected = "\tint32 ProtectedTargetCount = 0;\n"
        ...
        leftover_wrong_default = "\tint32 ObjectiveCount = 1;\n"
        leftover_untyped = "\tObjectiveCount = 0;\n"
        leftover_as_bool = "\tbool ObjectiveCount = false;\n"
        leftover_runtime = (
            "\tUSkyguardObjectiveRuntime* GetObjectiveRuntime() const;\n"
        )
        leftover_readiness = (
