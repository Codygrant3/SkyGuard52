...
# origin/main is a split-line UPROPERTY field
# (`int32 MaximumSubstationIntegrity = 100;` with
# ClampMin one-line or split-line);
...
# FSkyguardSearchlightTrackRuntime, private, or
# Mission01-03 / Mission05-10 directors.
# Category is Skyguard|Mission04, not Campaign, not
# leftover Mission03 Campaign, not leftover
# Mission02 Campaign #857, not leftover
# Mission04 CampaignSaveUserIndex #920 / branch
# cursor/mission04-campaign-save-user-index-
# field-decl-contract-c332, not leftover
# Mission04 RequiredTrackSeconds #923 / branch
# cursor/mission04-required-track-seconds-field-
# decl-contract-c332, not leftover Mission02
# MaximumFuelTerminalIntegrity #859 / branch
# cursor/mission02-maximum-fuel-terminal-
# integrity-field-decl-contract-c332, not leftover
# Mission03 MaximumConvoyIntegrity / branch
# cursor/mission03-maximum-convoy-integrity-
# field-decl-contract-c332, not leftover
# Mission10 MaximumProtectedIntegrity / branch
...
# drafts #674-#923 including leftover Mission04
# Root #907 through RequiredTrackSeconds #923,
# CampaignDefinition #914, bAutoInitialize #915,
# MissionDefinition #916.
...
LOCKED_DECL = MAXIMUM_SUBSTATION_INTEGRITY_FIELD
...
# an isolated Python MaximumSubstationIntegrity
# field declaration contract on
# ASkyguardMission04IntegrationDirector.
# Not leftover Mission02 MaximumFuelTerminalIntegrity
# #859. Not leftover Mission03 MaximumConvoyIntegrity.
# Not leftover Mission10 MaximumProtectedIntegrity.
...
LEFTOVER_MISSION04_REQUIRED_TRACK_SECONDS_NOT_LOCKED = (
    "RequiredTrackSeconds",
    REQUIRED_TRACK_SECONDS_FIELD,
    "test_mission04_required_track_seconds_field_decl_contract.py",
    "cursor/mission04-required-track-seconds-field-decl-contract-c332",
)
...
class Mission04MaximumSubstationIntegrityFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("MaximumSubstationIntegrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_maximum_substation_integrity_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_maximum_substation_integrity_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 MaximumSubstationIntegrity"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("MaximumSubstationIntegrity", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tint32\n"
            "\tMaximumSubstationIntegrity = 100;\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("MaximumSubstationIntegrity", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 MaximumSubstationIntegrity"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("MaximumSubstationIntegrity", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 MaximumSubstationIntegrity field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 MaximumSubstationIntegrity contains "
    ...
    def test_contract_is_maximum_substation_integrity_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_maximum_substation_integrity(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tint32 MaximumSubstationIntegrity = 1;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_maximum_substation_integrity_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
