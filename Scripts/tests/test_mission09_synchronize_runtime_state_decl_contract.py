...
# Mission09 Integration SynchronizeRuntimeState
# METHOD on ASkyguardMission09IntegrationDirector.
...
# #738, leftover Mission05 ConfigureMissionDefinition,
...
# Integration #738, not leftover Mission08
...
class Mission09SynchronizeRuntimeStateDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 SynchronizeRuntimeState method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                REQUIRED_DECL.lower(),
                "mission09 SynchronizeRuntimeState contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_synchronize_runtime_state"
                "_decl_contract.py"
            )
        )
        self.assertIn(
