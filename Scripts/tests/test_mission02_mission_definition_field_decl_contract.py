...
# Mission02 MissionDefinition FIELD
...
# NOT leftover Mission10 MissionDefinition field
# #799 / branch cursor/mission10-mission-definition-
...
# drafts #674-#796, leftover Apache
...
class Mission02MissionDefinitionFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_mission_definition_field"
                "_decl_contract.py"
            )
        )
