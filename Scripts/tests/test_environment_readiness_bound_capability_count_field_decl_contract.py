...
STRUCT_NAME = "FSkyguardEnvironmentReadiness"
CLASS_NAME = STRUCT_NAME
# THIS IS leftover-safe FSkyguardEnvironmentReadiness
# BoundCapabilityCount FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly int32
# BoundCapabilityCount = 0; one-line / split-line
# UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover environment-readiness-
# defaults #174/#b931. THIS IS NOT leftover
# coastal-env-director-empty-fail-closed #156/#321b.
# THIS IS NOT leftover environment-quality-enum
# #06c7. THIS IS NOT leftover Mission01
# environment-readiness-defaults #204/#6b9d.
# Do NOT parse the director class.
# THIS IS leftover-safe FSkyguardEnvironmentReadiness
# BoundCapabilityCount FIELD (declaration-only;
...
# FSkyguardEnvironmentReadiness STRUCT
# public section only (after struct
# FSkyguardEnvironmentReadiness, before
# class ASkyguardCoastalEnvironmentDirector).
# Do NOT parse ASkyguardCoastalEnvironmentDirector,
# leftover environment-quality enum type body,
...
# leftover FSkyguardMission01EnvironmentReadiness,
# leftover FSkyguardMissionMapReadiness,
# leftover GetReadiness / RebuildDeterministicVegetation
# / ApplyQuality / ApplyMissionWeather,
# leftover director-class UPROPERTY fields that HAVE
# Category=, leftover Mission01/02/03/04/05/06/07/08/09/10
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardEnvironmentReadiness
# BoundCapabilityCount. THIS IS NOT leftover mission-map-
...
# Do NOT parse ASkyguardCoastalEnvironmentDirector,
# leftover environment-quality enum type body,
# leftover coastal-env-director-empty-fail-closed #321b,
# leftover environment-readiness-defaults #b931,
# leftover Mission01 environment-readiness-defaults #6b9d,
# leftover FSkyguardMission01EnvironmentReadiness,
# leftover FSkyguardMissionMapReadiness / leftover
# mission-map-readiness-defaults #3a2a / leftover
# MissionMapReadiness RoutePointCount sibling
# (THIS IS NOT leftover MissionMapReadiness
# RoutePointCount). THIS IS NOT leftover
# environment-readiness-defaults #b931. THIS IS
# NOT leftover coastal-env-director-empty-fail-
# closed #321b. THIS IS NOT leftover
# environment-quality-enum #06c7. THIS IS NOT
# leftover Mission01 environment-readiness-
# defaults #6b9d. Do NOT parse the director
# class. Do NOT parse
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardEnvironmentReadiness
# BoundCapabilityCount. THIS IS NOT leftover Mission05
...
# FSkyguardEnvironmentReadiness BoundCapabilityCount
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 BoundCapabilityCount = 0;
# one-line / split-line UPROPERTY wraps;
# origin/main has NO Category) on
# FSkyguardEnvironmentReadiness. It is
# leftover-safe FSkyguardEnvironmentReadiness
# BoundCapabilityCount FIELD (declaration-only). It is
# NOT leftover MissionMapReadiness RoutePointCount.
# It is
...
TARGET = "int32 BoundCapabilityCount = 0;"
TARGET_WRONG = "int32 BoundCapabilityCount = 1;"
LOCKED_DECL = TARGET
...
LEFTOVER_ENVIRONMENT_READINESS_NOT_LOCKED = (
    ...
    "test_mission_map_readiness_route_point_count_field_decl_contract.py",
...
class EnvironmentReadinessBoundCapabilityCountFieldDeclContractTests(unittest.TestCase):
    def test_environment_readiness_struct_exists(self) -> None:
        ...
        self.assertIn("BoundCapabilityCount", section)
        self.assertIn("TreeInstanceCount", section)
        self.assertIn("ShrubInstanceCount", section)
        self.assertIn("VFXPoolSize", section)
        ...
        self.assertNotIn("enum class ESkyguardEnvironmentQuality", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("BoundCapabilityCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_bound_capability_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_bound_capability_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 BoundCapabilityCount"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("BoundCapabilityCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("BoundCapabilityCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 BoundCapabilityCount"))
    ...
    def test_contract_does_not_relock_leftover_environment_readiness(
        ...
        self.assertIn(
            ...
            "_point_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_environment_quality_enum"
            "_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("BoundCapabilityCount", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_bound_capability_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_environment_readiness_bound"
            "_capability_count_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_environment_readiness_bound"
                "_capability_count_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_wrong_leftover_structs_do_not_satisfy(self) -> None:
        leftovers = (
            ...
            "\tconst FSkyguardEnvironmentReadiness& GetReadiness() const;\n"
            "};\n",
        )
    ...
    def test_parser_does_not_land_on_anchors_or_director(self) -> None:
        ...
        match = CLASS_RE.search(header)
        self.assertIsNotNone(match, header)
        self.assertIn("FSkyguardEnvironmentReadiness", match.group(0))
