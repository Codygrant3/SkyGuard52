...
# INDEX_NONE or lock RadarGhostSpawnLocation
# construction in the .cpp. This is leftover-safe
# Mission07 RadarGhostSpawnLocation FIELD
...
# RadarGhostSpawnLocation). This contract is
# RadarGhostSpawnLocation only. It is NOT leftover
...
# BlueprintReadWrite / Category Skyguard|Mission07 /
# FVector(73000.f, 32000.f, 7200.f), not
...
# Lock RadarGhostSpawnLocation only. Do not lock
...
# FSkyguardMission07ProtectedTargetRuntime, private, or Mission01 /
...
LOCKED_DECL = RADAR_GHOST_SPAWN_LOCATION
...
# an isolated Python RadarGhostSpawnLocation
...
class Mission07RadarGhostSpawnLocationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_radar_ghost_spawn_location_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_radar_ghost_spawn_location_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FVector RadarGhostSpawnLocation"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("RadarGhostSpawnLocation", LOCKED_DECL)
        self.assertIn("= FVector(73000.f, 32000.f, 7200.f)", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("RadarGhostSpawnLocation", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FVector RadarGhostSpawnLocation"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("RadarGhostSpawnLocation", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 RadarGhostSpawnLocation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission07 RadarGhostSpawnLocation field contains "
    ...
    def test_contract_is_runway_breaker_spawn_location_field_declaration_only(
        ...
        # substring of RadarGhostSpawnLocation, so equality
    ...
    def test_sibling_director_fields_do_not_satisfy_radar_ghost_spawn_location(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tFVector RadarGhostSpawnLocation = FVector(0.f, 0.f, 0.f);\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_airfield_target_runtime_does_not_satisfy_radar_ghost_spawn_location(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
