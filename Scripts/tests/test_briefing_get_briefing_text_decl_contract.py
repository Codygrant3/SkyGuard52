...
# CanLaunch, GetBriefingState, GetElapsedSeconds
# (sibling just pushed), GetMinimumWarmupSeconds,
# and GetRadioChatter on this class.
...
# leftover GetElapsedSeconds, and leftover
# GetMinimumWarmupSeconds stay sibling-only.
LOCKED_SCRIPTS = (
...
# GetMinimumWarmupSeconds / GetRadioChatter stay
# sibling-only.
UNLOCKED_NEIGHBORS = (
...
# cpp body. origin/main inline `return BriefingText` is
...
class BriefingGetBriefingTextDeclContractTests(unittest.TestCase):
    ...
    def test_contract_does_not_relock_configure_from_mission(self) -> None:
        ...
        self.assertNotIn("ConfigureFromMission", GET_BRIEFING_TEXT)
    ...
    def test_contract_does_not_relock_set_assets_ready(self) -> None:
        ...
        for neighbor in SET_ASSETS_READY_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_BRIEFING_TEXT)
        self.assertNotIn("SetAssetsReady", GET_BRIEFING_TEXT)
    ...
    def test_contract_does_not_relock_advance_briefing(self) -> None:
        ...
        for neighbor in ADVANCE_BRIEFING_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_BRIEFING_TEXT)
        self.assertNotIn("AdvanceBriefing", GET_BRIEFING_TEXT)
    ...
    def test_contract_does_not_relock_acknowledge_and_launch(self) -> None:
        ...
        for neighbor in ACKNOWLEDGE_AND_LAUNCH_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_BRIEFING_TEXT)
        self.assertNotIn("AcknowledgeAndLaunch", GET_BRIEFING_TEXT)
    ...
    def test_contract_does_not_relock_can_launch(self) -> None:
        ...
        for neighbor in CAN_LAUNCH_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_BRIEFING_TEXT)
        self.assertNotIn("CanLaunch", GET_BRIEFING_TEXT)
    ...
    def test_contract_does_not_relock_get_briefing_state(self) -> None:
        ...
        for neighbor in GET_BRIEFING_STATE_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_BRIEFING_TEXT)
        self.assertNotIn("GetBriefingState", GET_BRIEFING_TEXT)
    ...
    def test_contract_does_not_relock_get_elapsed_seconds(self) -> None:
        ...
        for neighbor in GET_ELAPSED_SECONDS_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_BRIEFING_TEXT)
        self.assertNotIn("GetElapsedSeconds", GET_BRIEFING_TEXT)
    ...
    def test_contract_does_not_relock_get_minimum_warmup_seconds(self) -> None:
        ...
        for neighbor in GET_MINIMUM_WARMUP_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_BRIEFING_TEXT)
        self.assertNotIn("GetMinimumWarmupSeconds", GET_BRIEFING_TEXT)
    ...
    def test_contract_does_not_relock_get_radio_chatter(self) -> None:
        ...
        for neighbor in GET_RADIO_CHATTER_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_BRIEFING_TEXT)
        self.assertNotIn("GetRadioChatter", GET_BRIEFING_TEXT)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "briefing GetBriefingText contract contains "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                lowered,
                f"briefing GetBriefingText contains {banned}; "
