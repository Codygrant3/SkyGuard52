...
# Mission07 IntegrationReadiness WaveCount
...
# is WaveCount after ObjectiveCount and before SearchTrackCount. Skip leftover
...
# drafts #674-#1040 including leftover Mission02
...
# THIS IS NOT leftover Mission06 WaveCount #1010,
...
class Mission07WaveCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 WaveCount field contract "
