...
# BeachTileCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 BeachTileCount = 0; one-line /
...
# BeachTiles #586 (ASkyguardMission01EnvironmentDirector::
# BeachTiles). THIS IS NOT leftover OceanTileCount
# sibling #1170. THIS IS NOT leftover director
# OceanTiles #585 / BeachTiles #586 / LandTiles #587.
# THIS IS NOT leftover in-flight leftover-safe
# LandTileCount / bAuthoredLandscapeSurfaceExposed
# (LOCK those sibling scripts; do not edit them).
# THIS IS NOT leftover Mission01 environment-readiness-
# defaults #6b9d/#204. THIS IS NOT leftover director
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# BeachTileCount FIELD (declaration-only;
...
# FSkyguardMission01EnvironmentReadiness BeachTileCount
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 BeachTileCount = 0;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# BeachTileCount. THIS IS NOT leftover mission-map-
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# BeachTileCount. THIS IS NOT leftover Mission05
...
# merge #665 #666 #668-#673, or open drafts #674-#1170.
...
# Mission01 EnvironmentReadiness BeachTileCount
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 BeachTileCount = 0;
# one-line / split-line UPROPERTY wraps;
...
# BeachTileCount FIELD (declaration-only). It is
...
TARGET = "int32 BeachTileCount = 0;"
TARGET_WRONG = "int32 BeachTileCount = 1;"
LOCKED_DECL = TARGET
...
class Mission01EnvironmentReadinessBeachTileCountFieldDeclContractTests(unittest.TestCase):
    def test_environment_readiness_struct_exists(self) -> None:
        ...
        self.assertIn("OceanTileCount", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("BeachTileCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_beach_tile_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_beach_tile_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 BeachTileCount"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("BeachTileCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("BeachTileCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 BeachTileCount"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("BeachTileCount", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_beach_tile_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
