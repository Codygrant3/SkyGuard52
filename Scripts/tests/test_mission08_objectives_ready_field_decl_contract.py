...
# Mission08 IntegrationReadiness bObjectivesReady
...
# NOT leftover Mission07 bObjectivesReady
...
# objectives-ready-field-decl-contract-c332,
# NOT leftover Mission08 bWavesReady
# FIELD (sibling this wave) / branch cursor/
# mission08-waves-ready-field-decl-contract-c332,
# NOT leftover bLifelineHunterReady (in-flight) /
# branch cursor/mission08-lifeline-hunter-
# ready-field-decl-contract-c332,
# NOT leftover Mission08 bGunnerReady
# FIELD #1069 / branch cursor/mission08-
# gunner-ready-field-decl-contract-c332,
# NOT leftover Mission08 bMapAssemblyReady
# FIELD #1070 / branch cursor/mission08-
...
# BETWEEN bMapAssemblyReady and bGunnerReady, then
# bLifelineHunterReady, then this bObjectivesReady
# field). Skip leftover Mission08 bGunnerReady #1069. Skip leftover
...
LEFTOVER_MISSION02_OBJECTIVES_READY_NOT_LOCKED = (
    "test_mission02_objectives_ready_field_decl_contract.py",
    "cursor/mission02-objectives-ready-field-decl-contract-c332",
)
LEFTOVER_MISSION03_OBJECTIVES_READY_NOT_LOCKED = (
    "test_mission03_objectives_ready_field_decl_contract.py",
    "cursor/mission03-objectives-ready-field-decl-contract-c332",
)
LEFTOVER_MISSION04_OBJECTIVES_READY_NOT_LOCKED = (
    "test_mission04_objectives_ready_field_decl_contract.py",
    "cursor/mission04-objectives-ready-field-decl-contract-c332",
)
...
LEFTOVER_MISSION07_OBJECTIVES_READY_NOT_LOCKED = (
    "test_mission07_objectives_ready_field_decl_contract.py",
    "cursor/mission07-objectives-ready-field-decl-contract-c332",
)
LEFTOVER_MISSION10_OBJECTIVES_READY_NOT_LOCKED = (
    "test_mission10_objectives_ready_field_decl_contract.py",
    "cursor/mission10-objectives-ready-field-decl-contract-c332",
)
...
class Mission08ObjectivesReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 bObjectivesReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 bObjectivesReady contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_lifeline_hunter"
            "_ready_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission07_objectives_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_same_name_objectives_ready_contracts_stay_locked(
        self,
    ) -> None:
        for leftover in LEFTOVER_SAME_NAME_OBJECTIVES_READY_NOT_LOCKED:
        ...
        for leftover in LEFTOVER_MISSION08_WAVES_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION07_OBJECTIVES_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION06_OBJECTIVES_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
