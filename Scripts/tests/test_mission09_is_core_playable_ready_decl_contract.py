...
# Mission09 Integration IsCorePlayableReady
# METHOD on ASkyguardMission09IntegrationDirector. It is
# NOT leftover Mission08 IsCorePlayableReady
...
# Category is Skyguard|Mission09|Integration, not
# Mission01 / Mission02 / Mission03 / Mission04 /
# Mission05 / Mission06 / Mission07 / Mission08 / Search /
...
# IsCorePlayableReady #737. Do not reopen
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission09IntegrationDirector::IsCorePlayableReady",
    "SkyguardMission08IntegrationDirector.cpp",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission09IsCorePlayableReadyDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission09|Integration", UFUNCTION_INTEGRATION)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 IsCorePlayableReady method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission09 IsCorePlayableReady contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_is_core_playable_ready"
                "_decl_contract.py"
            )
        )
        self.assertIn(
