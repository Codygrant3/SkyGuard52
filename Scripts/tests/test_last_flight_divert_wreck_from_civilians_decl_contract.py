...
# or lock the DivertWreckFromCivilians body in the
...
# sibling BeginTerminalStrikeCycle /
# IssueClimbCommand / OpenGuidanceArrayExposure /
# SetCivilianSeparationMeters. Stay off leftover
...
# isolated-test drafts #107–#454 including leftover
...
# Python DivertWreckFromCivilians declaration
# contract on ASkyguardLastFlightBoss. Stay off
# leftover sibling BeginTerminalStrikeCycle /
# IssueClimbCommand / OpenGuidanceArrayExposure /
...
# leftover isolated-test drafts #107–#454,
...
# .cpp DivertWreckFromCivilians body / invented
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardLastFlightBoss::DivertWreckFromCivilians",
    "SkyguardLastFlightBoss.cpp",
    "SetExposed",
...
class LastFlightDivertWreckFromCiviliansDeclContractTests(unittest.TestCase):
    def test_last_flight_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, DIVERT_WRECK_FROM_CIVILIANS),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, DIVERT_WRECK_FROM_CIVILIANS)
        self.assertIn("DivertWreckFromCivilians", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_missing_divert_wreck_from_civilians_declaration_fails_closed(
        self,
    ) -> None:
        neighbors_only = (
            "\tASkyguardLastFlightBoss();\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, DIVERT_WRECK_FROM_CIVILIANS)
        self.assertIn("DivertWreckFromCivilians", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, DIVERT_WRECK_FROM_CIVILIANS)
        self.assertIn("DivertWreckFromCivilians", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("BlueprintPure", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("UFUNCTION", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("Category", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("BlueprintCallable", DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, DIVERT_WRECK_FROM_CIVILIANS)
        self.assertIn("DivertWreckFromCivilians", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        missing_parens = "\tbool DivertWreckFromCivilians;\n"
        wrong_return_void = "\tvoid DivertWreckFromCivilians();\n"
        wrong_return_int = "\tint32 DivertWreckFromCivilians();\n"
        added_const = "\tbool DivertWreckFromCivilians() const;\n"
        added_arg = "\tbool DivertWreckFromCivilians(int32 BayIndex);\n"
        leftover_arg = (
            "\tbool DivertWreckFromCivilians(int32 BayIndex, float Extra);\n"
        )
        leftover_begin = f"\t{BEGIN_TERMINAL_STRIKE_CYCLE}\n"
        leftover_climb = f"\t{ISSUE_CLIMB_COMMAND}\n"
        leftover_divert = f"\t{OPEN_GUIDANCE_ARRAY_EXPOSURE}\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, DIVERT_WRECK_FROM_CIVILIANS)
            self.assertIn("DivertWreckFromCivilians", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_divert_wreck_from_civilians_declaration_matches_origin_main(
        self,
    ) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
        ...
        self.assertEqual(
            declaration_count(section, DIVERT_WRECK_FROM_CIVILIANS),
            1,
        )
        self.assertTrue(
            DIVERT_WRECK_FROM_CIVILIANS.startswith("bool "),
            DIVERT_WRECK_FROM_CIVILIANS,
        )
        self.assertTrue(
            DIVERT_WRECK_FROM_CIVILIANS.endswith(";"),
            DIVERT_WRECK_FROM_CIVILIANS,
        )
        self.assertIn(
        ...
        self.assertNotIn("int32 BayIndex", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("INDEX_NONE", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("{", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("}", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("return ", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn(" const", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn(
            "BeginTerminalStrikeCycle",
            DIVERT_WRECK_FROM_CIVILIANS,
        )
        self.assertNotIn("IssueClimbCommand", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn(
            "OpenGuidanceArrayExposure",
            DIVERT_WRECK_FROM_CIVILIANS,
        )
        ...
        self.assertNotIn("GetChinMuzzleLocation", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("GetGunnerMount", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("FaceWorldLocation", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("PortGuidanceArray", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("SetSearchlightTracked", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("SetContactIdentified", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn(
            "SetFriendlySeparationMeters",
            DIVERT_WRECK_FROM_CIVILIANS,
        )
        self.assertNotIn("SetLightningExposed", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn(
            "OpenUpperEngineExposure",
            DIVERT_WRECK_FROM_CIVILIANS,
        )
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        self.assertTrue(
            has_declaration(one_line, DIVERT_WRECK_FROM_CIVILIANS)
        )
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, DIVERT_WRECK_FROM_CIVILIANS),
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        locked_only = f"{DIVERT_WRECK_FROM_CIVILIANS}\n"
        self.assertNotIn("INDEX_NONE", locked_only)
        self.assertNotIn("INDEX_NONE", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("return INDEX_NONE", locked_only)
        self.assertNotIn("NAME_None", DIVERT_WRECK_FROM_CIVILIANS)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_divert_wreck_from_civilians_cpp_body(
        self,
    ) -> None:
        locked_only = f"{DIVERT_WRECK_FROM_CIVILIANS}\n"
        self.assertNotIn("{", DIVERT_WRECK_FROM_CIVILIANS)
        ...
        self.assertNotIn("return false", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("return true", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("SetExposed", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            DIVERT_WRECK_FROM_CIVILIANS,
        )
        self.assertNotIn("SetBossPhase", DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_contract_does_not_relock_begin_terminal_strike_cycle_sibling(
        ...
        for token in BEGIN_TERMINAL_STRIKE_CYCLE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn(
            "BeginTerminalStrikeCycle",
            DIVERT_WRECK_FROM_CIVILIANS,
        )
    ...
    def test_contract_does_not_relock_leftover_getters(self) -> None:
        ...
        for token in GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("GetFinaleStage", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("IsWreckDiverted", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn(
            "GetCivilianSeparationMeters",
            DIVERT_WRECK_FROM_CIVILIANS,
        )
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_contract_does_not_relock_weak_point_fields(self) -> None:
        ...
        self.assertNotIn("PortGuidanceArray", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("StarboardGuidanceArray", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("CommandCore", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("PortEngine", DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("SetSearchlightTracked", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("IsSearchlightTracked", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("ASkyguardBlackKiteBoss", DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            ...
            self.assertNotIn(token, DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("SetContactIdentified", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("IsContactIdentified", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("OpenOrbitExposure", DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        self.assertNotIn("OpenSensorExposure", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn(
            "ASkyguardLifelineHunterBoss",
            DIVERT_WRECK_FROM_CIVILIANS,
        )
    ...
    def test_contract_does_not_relock_leftover_tempest(self) -> None:
        ...
        self.assertNotIn("ASkyguardTempestBoss", DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_contract_does_not_relock_leftover_iron_rain(self) -> None:
        ...
        self.assertNotIn("OpenDispenserBay", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("ASkyguardIronRainBoss", DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        self.assertNotIn("ASkyguardPatrolShip", DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_contract_does_not_relock_mount_getters(self) -> None:
        ...
        for token in MOUNT_GETTERS_NOT_LOCKED:
            ...
            self.assertNotIn(token, DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("GetGunnerMount", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("GetChinTurret", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("GetSensorTurret", DIVERT_WRECK_FROM_CIVILIANS)

    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        locked_only = f"{DIVERT_WRECK_FROM_CIVILIANS}\n"
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("GetChinMuzzleLocation", DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("ESkyguardApacheSystem", DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_contract_does_not_relock_leftover_input_capture(self) -> None:
        ...
        self.assertNotIn("RecordPlayerEvent", DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("ASkyguardGunner", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("FillAndFinalize", DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("SkyguardRadarNode", DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn(
            "USkyguardBriefingWidget",
            DIVERT_WRECK_FROM_CIVILIANS,
        )
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DIVERT_WRECK_FROM_CIVILIANS)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn(
            "ESkyguardMissionSkylineStyle",
            DIVERT_WRECK_FROM_CIVILIANS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("MinHeightFromOriginCm", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("MaxIntegrity", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn(
            "SkyguardApacheAircraft.h",
            DIVERT_WRECK_FROM_CIVILIANS,
        )
        self.assertNotIn("SkyguardPathfinder", DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, DIVERT_WRECK_FROM_CIVILIANS)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{DIVERT_WRECK_FROM_CIVILIANS}\n"
        self.assertEqual(
            require_declaration(locked_only, DIVERT_WRECK_FROM_CIVILIANS),
            DIVERT_WRECK_FROM_CIVILIANS,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "last flight DivertWreckFromCivilians contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, DIVERT_WRECK_FROM_CIVILIANS.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                DIVERT_WRECK_FROM_CIVILIANS.lower(),
                "last flight DivertWreckFromCivilians contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, DIVERT_WRECK_FROM_CIVILIANS)

    def test_contract_is_divert_wreck_from_civilians_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertNotIn("return ", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertNotIn("{", DIVERT_WRECK_FROM_CIVILIANS)
        self.assertTrue(DIVERT_WRECK_FROM_CIVILIANS.startswith("bool "))
        self.assertTrue(DIVERT_WRECK_FROM_CIVILIANS.endswith(";"))
        self.assertIn(UFUNCTION_BOSS, section)
