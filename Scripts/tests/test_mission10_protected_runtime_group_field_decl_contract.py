...
STRUCT_NAME = "FSkyguardMission10ProtectedRuntime"
CLASS_NAME = STRUCT_NAME
# THIS IS leftover-safe Mission10 ProtectedRuntime
# Group FIELD (declaration-only;
...
# FSkyguardMission10ProtectedRuntime STRUCT
# public section only (after struct
# FSkyguardMission10ProtectedRuntime, before
# struct FSkyguardMission10IntegrationReadiness).
# Do NOT parse ASkyguardMission10IntegrationDirector,
# FSkyguardMission10IntegrationReadiness,
# leftover enum ESkyguardMission10ProtectedGroup
# type body, leftover enum
# ESkyguardMission10RoutePhase type body, leftover
# FSkyguardMission05ProtectedTargetRuntime, leftover
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission10 ProtectedRuntime
# Group. THIS IS NOT leftover Mission10
# protected-group enum #6f9d. THIS IS NOT leftover
# Mission10 protected-runtime-defaults #7898.
# THIS IS NOT leftover Mission10 ProtectedRuntime
# Integrity #826 / bDestroyed #827. THIS IS NOT leftover
# Mission10 ProtectedGroupCount #825. THIS IS NOT leftover
# Mission10 methods/fields #768-#825. THIS IS NOT leftover
# GetProtectedGroup / NotifyProtectedGroupDamage.
# THIS IS NOT leftover Mission05
# protected-target enum #aaa2. THIS IS NOT leftover
# Mission05 protected-target-runtime-defaults #ec8b.
# THIS IS NOT leftover Mission05 PTR Target.
...
# merge #665 #666 #668-#673, leftover Mission10
# Integrity #826 / bDestroyed #827, leftover Mission10
# methods/fields #768-#825, leftover Mission10 route-
# phase enum #701a, or open drafts #674-#1153.
...
# INDEX_NONE or lock Group
# construction in the .cpp. This is leftover-safe
# Mission10 ProtectedRuntime Group
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly ESkyguardMission10ProtectedGroup
# default Convoy,
# one-line / split-line UPROPERTY wraps) on
# FSkyguardMission10ProtectedRuntime. It is
# leftover-safe Mission10 ProtectedRuntime
# Group FIELD (declaration-only). It is
...
# the origin/main Convoy default,
...
class Mission10ProtectedRuntimeGroupFieldDeclContractTests(unittest.TestCase):
    def test_mission10_struct_exists(self) -> None:
        ...
        self.assertIn("bDestroyed", section)
        self.assertNotIn("FSkyguardStormRuntime", section)
        self.assertNotIn("FSkyguardMission10IntegrationReadiness", section)
        self.assertNotIn("ASkyguardMission10IntegrationDirector", section)
        self.assertNotIn("enum class ESkyguardMission10ProtectedGroup", section)
        self.assertNotIn("enum class ESkyguardMission10RoutePhase", section)
        ...
        self.assertNotIn("FerryTerminal", section)
    ...
    def test_missing_group_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_group_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("ESkyguardMission10ProtectedGroup Group"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("Convoy;"), LOCKED_DECL)
        ...
        self.assertIn("Convoy", LOCKED_DECL)
        ...
        self.assertIn("ESkyguardMission10ProtectedGroup", LOCKED_DECL)
        self.assertTrue(
            LOCKED_DECL.startswith("ESkyguardMission10ProtectedGroup "),
            LOCKED_DECL,
        )
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_true_default = (
            "public:\n"
            f"\t{UPROPERTY_MISSION10}\n"
            "\tESkyguardMission10ProtectedGroup Group = ESkyguardMission10ProtectedGroup::Convoy;\n"
            "};\n"
        )
        header_wrap_type = (
            f"struct {CLASS_NAME}\n{{\n{wrap_type}"
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("Group", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("ESkyguardMission10ProtectedGroup Group"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("Group", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 ProtectedRuntime Group field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission10 ProtectedRuntime Group contains "
    ...
    def test_contract_is_group_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(LOCKED_DECL.startswith("ESkyguardMission10ProtectedGroup Group"))
        self.assertIn("Group", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("Convoy;"))
        self.assertTrue(LOCKED_DECL.endswith(";"))
        self.assertNotIn("GetProtectedGroup", LOCKED_DECL)
        self.assertNotIn("FSkyguardMission10ProtectedRuntime", LOCKED_DECL)
        self.assertIn(UPROPERTY_MISSION10, section)

    def test_sibling_director_fields_do_not_satisfy_group(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission10_protected_runtime"
            "_group_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_protected_runtime"
                "_group_field_decl_contract.py"
            )
        )
        self.assertIn(
