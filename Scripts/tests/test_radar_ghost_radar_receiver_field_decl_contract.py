...
# INDEX_NONE or lock RadarReceiver construction
...
# fields SignatureModulator, CoolingDoor,
# Engine, DebrisPortEWPanel,
# DebrisStarboardEWPanel, or
...
# isolated-test drafts #107–#532 including
...
# leftover isolated-test drafts #107–#532,
# leftover searchlight-track-runtime-defaults
...
# drafts #107–#532 stay sibling-only.
LOCKED_SCRIPTS = (
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardRadarGhostBoss::RadarReceiver",
    "SkyguardRadarGhostBoss.cpp",
    "SetExposed",
...
class RadarGhostRadarReceiverFieldDeclContractTests(unittest.TestCase):
    def test_radar_ghost_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, RADAR_RECEIVER_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, RADAR_RECEIVER_FIELD)
        self.assertIn("RadarReceiver", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, RADAR_RECEIVER_FIELD)
    ...
    def test_missing_radar_receiver_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardRadarGhostBoss();\n"
            f"\t{SIGNATURE_MODULATOR_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, RADAR_RECEIVER_FIELD)
        self.assertIn("RadarReceiver", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, RADAR_RECEIVER_FIELD)
        self.assertIn("RadarReceiver", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn('Category="Skyguard|Mission07|Boss"', section)
        self.assertTrue(
            has_declaration(section, RADAR_RECEIVER_FIELD),
            section,
        )
        self.assertNotIn("UPROPERTY", RADAR_RECEIVER_FIELD)
        self.assertNotIn("VisibleAnywhere", RADAR_RECEIVER_FIELD)
        self.assertNotIn("BlueprintReadOnly", RADAR_RECEIVER_FIELD)
        self.assertNotIn("Category", RADAR_RECEIVER_FIELD)
        self.assertNotIn("BlueprintPure", UPROPERTY_PORT)
        self.assertNotIn("BlueprintCallable", UPROPERTY_PORT)
        self.assertIn("Skyguard|Mission07|Boss", UPROPERTY_PORT)
        self.assertIn("Mission07", UPROPERTY_PORT)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, RADAR_RECEIVER_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, RADAR_RECEIVER_FIELD)
        self.assertIn("RadarReceiver", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUSkyguardBossWeakPointComponent* RadarReceiver;\n"
        )
        as_array = (
        ...
        scene = (
            "\tTObjectPtr<USceneComponent> RadarReceiver;\n"
        )
        mesh = (
            "\tTObjectPtr<UStaticMeshComponent> RadarReceiver;\n"
        )
        weak = (
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, RADAR_RECEIVER_FIELD)
            self.assertIn("RadarReceiver", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_radar_receiver_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, RADAR_RECEIVER_FIELD),
            RADAR_RECEIVER_FIELD,
        )
        self.assertTrue(has_declaration(section, RADAR_RECEIVER_FIELD))
        self.assertEqual(declaration_count(section, RADAR_RECEIVER_FIELD), 1)
        self.assertTrue(
            RADAR_RECEIVER_FIELD.startswith(
                "TObjectPtr<USkyguardBossWeakPointComponent> "
            ),
            RADAR_RECEIVER_FIELD,
        )
        self.assertTrue(RADAR_RECEIVER_FIELD.endswith(";"), RADAR_RECEIVER_FIELD)
        self.assertIn("RadarReceiver", RADAR_RECEIVER_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            RADAR_RECEIVER_FIELD,
        )
        self.assertIn("TObjectPtr<", RADAR_RECEIVER_FIELD)
        self.assertNotIn("TArray<", RADAR_RECEIVER_FIELD)
        self.assertNotIn("=", RADAR_RECEIVER_FIELD)
        self.assertNotIn("INDEX_NONE", RADAR_RECEIVER_FIELD)
        self.assertNotIn("UFUNCTION", RADAR_RECEIVER_FIELD)
        self.assertNotIn("{", RADAR_RECEIVER_FIELD)
        self.assertNotIn("}", RADAR_RECEIVER_FIELD)
        self.assertNotIn("return ", RADAR_RECEIVER_FIELD)
        self.assertNotIn("CommandAntenna", RADAR_RECEIVER_FIELD)
        self.assertNotIn("ControlLinkage", RADAR_RECEIVER_FIELD)
        self.assertNotIn("NoseCamera", RADAR_RECEIVER_FIELD)
        self.assertNotIn("DebrisCenter", RADAR_RECEIVER_FIELD)
        self.assertNotIn("DebrisTail", RADAR_RECEIVER_FIELD)
        self.assertNotIn("DebrisNose", RADAR_RECEIVER_FIELD)
        self.assertNotIn("DebrisSpine", RADAR_RECEIVER_FIELD)
        self.assertNotIn("AdvanceEncounter", RADAR_RECEIVER_FIELD)
        self.assertNotIn("ResetEncounterState", RADAR_RECEIVER_FIELD)
        self.assertNotIn("IsRouteStateSafe", RADAR_RECEIVER_FIELD)
        self.assertNotIn("GetRouteProgress", RADAR_RECEIVER_FIELD)
        self.assertNotIn("GetEffectiveSpeedMultiplier", RADAR_RECEIVER_FIELD)
        self.assertNotIn("IsAttackTelegraphActive", RADAR_RECEIVER_FIELD)
        self.assertNotIn("GetTelegraphsTriggered", RADAR_RECEIVER_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", RADAR_RECEIVER_FIELD)
        self.assertNotIn("RadarNode", RADAR_RECEIVER_FIELD)
        self.assertNotIn("BeginTerminalStrikeCycle", RADAR_RECEIVER_FIELD)
        self.assertNotIn("OpenGuidanceArrayExposure", RADAR_RECEIVER_FIELD)
        self.assertNotIn("IssueClimbCommand", RADAR_RECEIVER_FIELD)
        self.assertNotIn("DivertWreckFromCivilians", RADAR_RECEIVER_FIELD)
        self.assertNotIn("SetCivilianSeparationMeters", RADAR_RECEIVER_FIELD)
        self.assertNotIn("GetCivilianSeparationMeters", RADAR_RECEIVER_FIELD)
        self.assertNotIn("GetFinaleStage", RADAR_RECEIVER_FIELD)
        self.assertNotIn("IsClimbCommandIssued", RADAR_RECEIVER_FIELD)
        self.assertNotIn("IsWreckDiverted", RADAR_RECEIVER_FIELD)
        self.assertNotIn("GetObjectiveMilestonesReached", RADAR_RECEIVER_FIELD)
        self.assertNotIn("ESkyguardLastFlightStage", RADAR_RECEIVER_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", RADAR_RECEIVER_FIELD)
        self.assertNotIn("GetGunnerMount", RADAR_RECEIVER_FIELD)
        self.assertNotIn("FaceWorldLocation", RADAR_RECEIVER_FIELD)
        self.assertNotIn("PortGuidanceArray", RADAR_RECEIVER_FIELD)
        self.assertNotIn("DebrisArmorPort", RADAR_RECEIVER_FIELD)
        self.assertNotIn("SetSearchlightTracked", RADAR_RECEIVER_FIELD)
        self.assertNotIn("SetContactIdentified", RADAR_RECEIVER_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", RADAR_RECEIVER_FIELD)
        self.assertNotIn("SetLightningExposed", RADAR_RECEIVER_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", RADAR_RECEIVER_FIELD)
        self.assertNotIn("HullCollider", RADAR_RECEIVER_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, RADAR_RECEIVER_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_PORT} {RADAR_RECEIVER_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(
                declaration_count(section, RADAR_RECEIVER_FIELD),
                1,
            )
        one_line = f"{{\npublic:\n\t{RADAR_RECEIVER_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, RADAR_RECEIVER_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, RADAR_RECEIVER_FIELD),
            section,
    ...
    def test_assigned_radar_receiver_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<USkyguardBossWeakPointComponent> "
            "RadarReceiver = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, RADAR_RECEIVER_FIELD)
        self.assertIn("RadarReceiver", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, RADAR_RECEIVER_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("RadarReceiver", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, RADAR_RECEIVER_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{RADAR_RECEIVER_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, RADAR_RECEIVER_FIELD)
        ...
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_PORT, section)
        self.assertTrue(has_declaration(section, RADAR_RECEIVER_FIELD), section)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            RADAR_RECEIVER_FIELD.startswith("UFUNCTION"),
            RADAR_RECEIVER_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, RADAR_RECEIVER_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", RADAR_RECEIVER_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_radar_receiver_cpp_body(self) -> None:
        locked_only = f"{RADAR_RECEIVER_FIELD}\n"
        self.assertNotIn("{", RADAR_RECEIVER_FIELD)
        self.assertNotIn("}", RADAR_RECEIVER_FIELD)
        self.assertNotIn("return ", RADAR_RECEIVER_FIELD)
        ...
        self.assertNotIn("SkyguardRadarGhostBoss.cpp", RADAR_RECEIVER_FIELD)
        self.assertNotIn("SkyguardRadarGhostBoss.cpp", locked_only)
        self.assertNotIn("return false", RADAR_RECEIVER_FIELD)
        self.assertNotIn("return true", RADAR_RECEIVER_FIELD)
        self.assertNotIn("CreateDefaultSubobject", RADAR_RECEIVER_FIELD)
        self.assertNotIn("SetExposed", RADAR_RECEIVER_FIELD)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            RADAR_RECEIVER_FIELD,
        )
        self.assertNotIn("SetBossPhase", RADAR_RECEIVER_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", RADAR_RECEIVER_FIELD)

    def test_contract_does_not_relock_sibling_tempest_fields(self) -> None:
        locked_only = f"{RADAR_RECEIVER_FIELD}\n"
        for token in SIBLING_TEMPEST_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("PortDischargeBoom", RADAR_RECEIVER_FIELD)
        self.assertNotIn("StarboardDischargeBoom", RADAR_RECEIVER_FIELD)
        self.assertNotIn("EngineIntake", RADAR_RECEIVER_FIELD)
        self.assertNotIn("DebrisPortPanel", RADAR_RECEIVER_FIELD)
        self.assertNotIn("DebrisStarboardPanel", RADAR_RECEIVER_FIELD)
        self.assertNotIn("DebrisIntakePanel", RADAR_RECEIVER_FIELD)
        self.assertNotIn("RequiredLockStabilitySeconds", RADAR_RECEIVER_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            RADAR_RECEIVER_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_encounter_controller(
        ...
        for token in LEFTOVER_ENCOUNTER_CONTROLLER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("EncounterController", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_control_servo(self) -> None:
        ...
        for token in LEFTOVER_CONTROL_SERVO_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("ControlServo", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_sibling_iron_rain_fields(self) -> None:
        ...
        for token in SIBLING_IRON_RAIN_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("DispenserCenter", RADAR_RECEIVER_FIELD)
        self.assertNotIn("MaxReleasesPerBay", RADAR_RECEIVER_FIELD)
        self.assertIn("RadarReceiver", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_dispenser_starboard(
        ...
        for token in LEFTOVER_DISPENSER_STARBOARD_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("DispenserStarboard", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_get_maneuver(self) -> None:
        ...
        for token in LEFTOVER_GET_MANEUVER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("GetManeuver", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_open_first_window(), RADAR_RECEIVER_FIELD)
        self.assertNotIn(leftover_open_final_window(), locked_only)
        self.assertNotIn(leftover_open_final_window(), RADAR_RECEIVER_FIELD)
        self.assertNotIn(leftover_arm_command_core_path(), locked_only)
        self.assertNotIn(leftover_arm_command_core_path(), RADAR_RECEIVER_FIELD)
        self.assertNotIn(leftover_apply_strike(), locked_only)
        self.assertNotIn(leftover_apply_strike(), RADAR_RECEIVER_FIELD)
        self.assertNotIn(leftover_is_lock_eligible(), locked_only)
        self.assertNotIn(leftover_is_lock_eligible(), RADAR_RECEIVER_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, locked_only)
            self.assertNotIn(name, RADAR_RECEIVER_FIELD)
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_debris_getters(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("GetDefeatDebrisPieceCount", RADAR_RECEIVER_FIELD)
        self.assertNotIn("GetMaxDefeatDebrisPieces", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("SetSearchlightTracked", RADAR_RECEIVER_FIELD)
        self.assertNotIn("ASkyguardBlackKiteBoss", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            ...
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("SetContactIdentified", RADAR_RECEIVER_FIELD)
        self.assertNotIn("OpenOrbitExposure", RADAR_RECEIVER_FIELD)
        self.assertNotIn("IsContactIdentified", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_sibling_radar_ghost_fields(self) -> None:
        ...
        for token in SIBLING_RADAR_GHOST_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("SignatureModulator", RADAR_RECEIVER_FIELD)
        self.assertNotIn("CoolingDoor", RADAR_RECEIVER_FIELD)
        self.assertNotIn("DebrisPortEWPanel", RADAR_RECEIVER_FIELD)
        self.assertNotIn("DebrisStarboardEWPanel", RADAR_RECEIVER_FIELD)
        self.assertNotIn("DebrisCoolingDoor", RADAR_RECEIVER_FIELD)
        self.assertIn("RadarReceiver", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_dispenser_port(self) -> None:
        ...
        for token in LEFTOVER_DISPENSER_PORT_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("DispenserPort", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_NOT_LOCKED:
            ...
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", RADAR_RECEIVER_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest_methods(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("SetLightningExposed", RADAR_RECEIVER_FIELD)
        self.assertNotIn("ApplyCorrectiveBankGust", RADAR_RECEIVER_FIELD)
        self.assertNotIn("IsLightningExposed", RADAR_RECEIVER_FIELD)
        self.assertNotIn("GetLockStabilitySeconds", RADAR_RECEIVER_FIELD)
        self.assertNotIn(leftover_advance_stabilized_lock(), RADAR_RECEIVER_FIELD)
        self.assertNotIn(leftover_arm_break_finish(), RADAR_RECEIVER_FIELD)
        self.assertNotIn(leftover_is_break_finish_armed(), RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        for token in LEFTOVER_PATROL_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("ASkyguardPatrolShip", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        ...
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            ...
            self.assertNotIn(neighbor, RADAR_RECEIVER_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("ASkyguardGunner", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("SkyguardRadarNode", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            ...
            self.assertNotIn(token, RADAR_RECEIVER_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", RADAR_RECEIVER_FIELD)
        self.assertNotIn("MaxIntegrity", RADAR_RECEIVER_FIELD)
        self.assertNotIn("CurrentIntegrity", RADAR_RECEIVER_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", RADAR_RECEIVER_FIELD)
        self.assertNotIn(
            "SkyguardPathfinderEncounterController.h",
            RADAR_RECEIVER_FIELD,
        )
    ...
    def test_contract_does_not_open_leftover_weak_point_component_header(
        ...
        self.assertNotIn(leftover_header, RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, RADAR_RECEIVER_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", RADAR_RECEIVER_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{RADAR_RECEIVER_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, RADAR_RECEIVER_FIELD),
            RADAR_RECEIVER_FIELD,
        )
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardRadarGhostBoss::RadarReceiver", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "radar ghost RadarReceiver field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{RADAR_RECEIVER_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, RADAR_RECEIVER_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                RADAR_RECEIVER_FIELD.lower(),
                "radar ghost RadarReceiver contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, RADAR_RECEIVER_FIELD)

    def test_contract_is_radar_receiver_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertTrue(RADAR_RECEIVER_FIELD.endswith(";"))
        self.assertNotIn("=", RADAR_RECEIVER_FIELD)
        self.assertIn(UPROPERTY_PORT, section)
