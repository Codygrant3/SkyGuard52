...
# Mission04 Objectives NotifyProtectedAssetFailed on
...
# searchlight-track-runtime-defaults #7347 (do not
# lock GetSearchlightRuntime), and NOT leftover
# Mission04 wave-state enum #bb22. Distinct from
# leftover Mission03 NotifyProtectedAssetFailed #634.
# Distinct from leftover Mission01 NotifyProtectedAssetFailed
# #612.
...
# lock sibling Integration / Waves / Searchlight /
...
# #628, leftover Mission03 NotifyProtectedAssetFailed
# #634, leftover Mission01 NotifyProtectedAssetFailed
# #612, leftover Mission04 wave-state enum #bb22,
...
# Category is Skyguard|Mission04|Objectives, not
# Waves, not Integration, not Environment, not leftover
# briefing-widget, not leftover
# MissionBriefingComponent methods, not leftover
# Mission01 Integration, not leftover Mission03
# Objectives #634, not leftover Mission01
# NotifyProtectedAssetFailed #612, not leftover Harbor Mission02
# Integration.
# Stay off leftover drafts #56–#64, leftover Harbor
# #6/#8/#9, leftover theater-kit #59, leftover
# isolated-test drafts #107–#651, leftover Apache
...
# leftover theater-kit #59, leftover #107–#651, plus
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission04IntegrationDirector::NotifyProtectedAssetFailed",
    "SkyguardMission04IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission04NotifyProtectedAssetFailedDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission04|Objectives", UFUNCTION_OBJECTIVES)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 NotifyProtectedAssetFailed method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission04 NotifyProtectedAssetFailed contains "
