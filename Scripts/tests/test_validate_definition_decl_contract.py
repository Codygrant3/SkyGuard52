...
# validation error text, or campaign-id contents, or lock
# the ValidateDefinition body in the .cpp.
...
# USkyguardCampaignSubsystem methods, LoadCampaignProgress
...
# here. FindMission / GetPrimaryAssetId / CampaignId /
...
# is ValidateDefinition on USkyguardCampaignDefinition only.
...
# .cpp ValidateDefinition body / invented validation error
# text stay unlocked. Do not invent INDEX_NONE or lock the
# cpp body.
CPP_AND_INVENTED = (
    "INDEX_NONE",
    "NAME_None",
...
class ValidateDefinitionDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn(UFUNCTION_VALIDATE, section)
        self.assertTrue(has_declaration(section, VALIDATE_DEFINITION), section)
    ...
    def test_declaration_does_not_invent_validation_error_text(self) -> None:
        ...
        self.assertNotIn("at least one mission", VALIDATE_DEFINITION)
        self.assertNotIn("null mission", VALIDATE_DEFINITION)
    ...
    def test_declaration_does_not_invent_campaign_id_contents(self) -> None:
        ...
        self.assertNotIn("TEXT(", VALIDATE_DEFINITION)
        self.assertNotIn("CampaignId =", VALIDATE_DEFINITION)
    ...
    def test_contract_does_not_relock_campaign_fields(self) -> None:
        ...
        self.assertNotIn("Missions", VALIDATE_DEFINITION)
    ...
    def test_contract_does_not_relock_campaign_subsystem_methods(self) -> None:
        ...
        self.assertNotIn("ConfigureCampaign", VALIDATE_DEFINITION)
        self.assertNotIn("CanStartMission", VALIDATE_DEFINITION)
        self.assertNotIn("StartMission", VALIDATE_DEFINITION)
        self.assertNotIn("GetActiveMission", VALIDATE_DEFINITION)
        self.assertNotIn("USkyguardCampaignSubsystem", VALIDATE_DEFINITION)
    ...
    def test_contract_does_not_relock_save_game_helpers(self) -> None:
        ...
        for neighbor in SAVE_GAME_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, VALIDATE_DEFINITION)
        self.assertNotIn("ApplySaveGame", VALIDATE_DEFINITION)
        self.assertNotIn("BuildSaveGame", VALIDATE_DEFINITION)
        self.assertNotIn("RetrySaveLastDebrief", VALIDATE_DEFINITION)
        self.assertNotIn("SaveCampaignToSlot", VALIDATE_DEFINITION)
        self.assertNotIn("LoadCampaignFromSlot", VALIDATE_DEFINITION)
        self.assertNotIn("DeleteCampaignSlot", VALIDATE_DEFINITION)
        self.assertNotIn("GetMissionRecords", VALIDATE_DEFINITION)
    ...
    def test_contract_does_not_require_rifle_or_igla(self) -> None:
        ...
        self.assertNotEqual(VALIDATE_DEFINITION, "Rifle")
        self.assertNotEqual(VALIDATE_DEFINITION, "Igla")
    ...
    def test_declaration_bans_igla_yak_rifle(self) -> None:
        ...
        for banned in BANNED:
            self.assertNotIn(
                banned,
                lowered,
                f"campaign ValidateDefinition contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn("D:/Skyguard52", VALIDATE_DEFINITION)
