...
STRUCT_NAME = "FSkyguardMission09IntegrationReadiness"
CLASS_NAME = STRUCT_NAME
# THIS IS leftover-safe Mission09 readiness-struct
# bPresentationReady FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly bool = false;
# one-line / split-line UPROPERTY wraps; origin/main
# has NO Category). PARSE
# FSkyguardMission09IntegrationReadiness STRUCT
# public section only (after struct
# FSkyguardMission09IntegrationReadiness, before
# class SKYGUARD52_API ASkyguardMission09IntegrationDirector).
# Do NOT parse ASkyguardMission09IntegrationDirector,
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission09 readiness-struct
# bPresentationReady. THIS IS NOT leftover Mission09
# readiness-struct bSortiePresentationReady (sibling,
# do not take that field). THIS IS NOT leftover
# Mission08 FSkyguardMission08IntegrationReadiness
# bSortiePresentationReady #1078. THIS IS NOT leftover
# Mission09 director SortiePresentation #1089 /
# leftover Mission09 director Readiness #1100.
# THIS IS NOT leftover Mission08
# FSkyguardMission08IntegrationReadiness
# bObjectivesReady. THIS IS NOT leftover
# Mission07 same-name readiness-struct field.
# THIS IS NOT leftover Mission09 director Root /
# map-assembly sibling fields. THIS IS NOT leftover
# Mission09 readiness-struct bMissionDefinitionValid
# #1101 through bProtectedTargetsReady #1109. THIS IS
# NOT leftover Mission09 director MissionDefinition
# #1092. THIS IS NOT leftover Mission09 director
# Readiness field #1100 / leftover Mission09 director
# Root #1083. THIS IS NOT leftover Mission06/05/04/03/
# 02/01/10 same-name readiness-struct drafts. THIS IS
# NOT leftover Mission09 Root #1083 through director
# Readiness #1100. THIS IS NOT leftover Mission09
# Blueprint UFUNCTION methods. THIS IS NOT leftover
# director-class public UPROPERTY fields.
...
# merge #665 #666 #668-#673, or open drafts #674-#1109.
...
# INDEX_NONE or lock bPresentationReady
# construction in the .cpp. This is leftover-safe
# Mission09 IntegrationReadiness bPresentationReady
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool default false,
# one-line / split-line UPROPERTY wraps) on
# FSkyguardMission09IntegrationReadiness. It is
# NOT leftover Mission08 readiness-struct
# bObjectivesReady FIELD / branch
# cursor/mission08-objectives-ready-field-
# decl-contract-c332, NOT leftover Mission08
# readiness-struct bMapAssemblyReady FIELD /
# branch cursor/mission08-map-assembly-ready-
# field-decl-contract-c332, It is
# NOT leftover Mission08 director MissionDefinition
# FIELD #1054 / branch cursor/mission08-
# mission-definition-field-decl-contract-c332,
# NOT leftover Mission08 director Readiness field
# (sibling this wave cursor/mission08-readiness-
# field-decl-contract-c332), NOT leftover Mission08
# bCampaignDefinitionValid (sibling this wave
# cursor/mission08-campaign-definition-valid-field-
# decl-contract-c332), NOT leftover Mission07
# bMissionDefinitionValid FIELD #1028 / branch
# cursor/mission07-mission-definition-valid-field-
# decl-contract-c332, NOT leftover Mission06
# bMissionDefinitionValid
# FIELD #996 / branch cursor/mission06-
...
# mission-definition-valid-field-decl-contract-c332,
# NOT leftover Mission04 bMissionDefinitionValid
# FIELD #927 / branch cursor/mission04-
# mission-definition-valid-field-decl-contract-c332,
# NOT leftover Mission02 bMissionDefinitionValid
# FIELD #861 / branch cursor/mission02-
# mission-definition-valid-field-decl-contract-c332,
# NOT leftover Mission03 bMissionDefinitionValid
# FIELD #893 / branch cursor/mission03-
# mission-definition-valid-field-decl-contract-c332,
# NOT leftover Mission10 bMissionDefinitionValid
# FIELD #810 / branch cursor/mission10-
# mission-definition-valid-field-decl-contract-c332,
# NOT leftover Mission07 director MissionDefinition
# FIELD #1017 / branch cursor/mission07-
# mission-definition-field-decl-contract-c332,
# NOT leftover Mission07 director Readiness field
# (in-flight cursor/mission07-readiness-field-
# decl-contract-c332), NOT leftover Mission07
# MaximumProtectedTargetIntegrity (IDLE+pushed;
# cursor/mission07-maximum-protected-target-
# integrity-field-decl-contract-c332), NOT leftover
# Mission07 ReinforcementDeadlineSeconds (in-flight
# cursor/mission07-reinforcement-deadline-seconds-
# field-decl-contract-c332),
# NOT leftover Mission06 director MissionDefinition
# FIELD #985 / branch cursor/mission06-
# mission-definition-field-decl-contract-c332,
# NOT leftover Mission05 director MissionDefinition
# FIELD #953 / branch cursor/mission05-
# mission-definition-field-decl-contract-c332,
...
# struct section of
# FSkyguardMission09IntegrationReadiness only
# (between struct FSkyguardMission09IntegrationReadiness
# and the following UCLASS /
# ASkyguardMission09IntegrationDirector; not
# ASkyguardMission09IntegrationDirector public
# fields already drafted through Root #1083 /
# director Readiness #1100 / MissionDefinition #1092,
...
# not leftover Mission01/02/03/04/05/06/08-10 readiness structs).
# This field has no Category and no ClampMin.
# Skip leftover b + Ya + kRuntimeReady. Skip leftover
...
# drafts #674-#1104 including leftover Mission02
...
# the locked FSkyguardMission09IntegrationReadiness
# public section. Do not parse
# ASkyguardMission09IntegrationDirector director-class
# fields. Do not parse FSkyguardHoistWindowRuntime.
# Do not parse FSkyguardMission08ProtectedTargetRuntime.
# Do not parse leftover FSkyguardSearchTrackRuntime.
# Do not parse leftover FSkyguardMission07ProtectedTargetRuntime.
...
# drafts #674-#1104. Do not reopen leftover
# Mission06 director field drafts Root #981
# through CampaignSaveUserIndex #991 / MissionDefinition
# #985. Do not reopen leftover
...
PRESENTATION_READY_TRUE = (
    "bool bPresentationReady = true;"
)
LOCKED_DECL = PRESENTATION_READY
...
# an isolated Python bPresentationReady
# field declaration contract on
# FSkyguardMission09IntegrationReadiness.
# Harbor 40/80 fail-closed in Mission02/03/04/05/
# 06/07 test files; this contract is Mission08/09-only.
# Do not reopen leftover Mission07 readiness-struct
# bMissionDefinitionValid #1028 through SearchTrackCount
# #1043. Do not reopen leftover Mission08 director
# Root #1044 through MaximumProtectedTargetIntegrity
# #1065. Do not reopen leftover Mission08 Blueprint
# UFUNCTION methods #729-#749. Do not reopen leftover
...
# hoist-window-runtime-defaults #ec79.
LOCKED = {
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission01_presentation_ready_field_decl_contract.py",
    "Scripts/tests/test_mission02_presentation_ready_field_decl_contract.py",
    "Scripts/tests/test_mission03_presentation_ready_field_decl_contract.py",
    "Scripts/tests/test_mission04_presentation_ready_field_decl_contract.py",
    "Scripts/tests/test_mission05_presentation_ready_field_decl_contract.py",
    "Scripts/tests/test_mission06_presentation_ready_field_decl_contract.py",
    "Scripts/tests/test_mission07_presentation_ready_field_decl_contract.py",
    "Scripts/tests/test_mission08_presentation_ready_field_decl_contract.py",
    "Scripts/tests/test_mission10_presentation_ready_field_decl_contract.py",
    ...
    "Scripts/tests/test_mission01_map_assembly_ready_field_decl_contract.py",
...
LEFTOVER_MISSION09_OBJECTIVES_READY_NOT_LOCKED = (
    "test_mission09_objectives_ready_field_decl_contract.py",
    "cursor/mission09-objectives-ready-field-decl-contract-c332",
)
LEFTOVER_MISSION09_PROTECTED_TARGETS_READY_NOT_LOCKED = (
    "test_mission09_protected_targets_ready_field_decl_contract.py",
    "cursor/mission09-protected-targets-ready-field-decl-contract-c332",
)
LEFTOVER_MISSION09_ESCALATING_WAVES_READY_NOT_LOCKED = (
    "test_mission09_escalating_waves_ready_field_decl_contract.py",
    "cursor/mission09-escalating-waves-ready-field-decl-contract-c332",
)
LEFTOVER_MISSION09_IRON_RAIN_READY_NOT_LOCKED = (
    "test_mission09_iron_rain_ready_field_decl_contract.py",
    "cursor/mission09-iron-rain-ready-field-decl-contract-c332",
)
LEFTOVER_MISSION09_GUNNER_READY_NOT_LOCKED = (
    "test_mission09_gunner_ready_field_decl_contract.py",
    "cursor/mission09-gunner-ready-field-decl-contract-c332",
)
LEFTOVER_MISSION08_SORTIE_PRESENTATION_READY_NOT_LOCKED = (
    "test_mission08_sortie_presentation_ready_field_decl_contract.py",
    "cursor/mission08-sortie-presentation-ready-field-decl-contract-c332",
)
...
LEFTOVER_SAME_NAME_PRESENTATION_READY_NOT_LOCKED = (
    "test_mission01_presentation_ready_field_decl_contract.py",
    "test_mission02_presentation_ready_field_decl_contract.py",
    "test_mission03_presentation_ready_field_decl_contract.py",
    "test_mission04_presentation_ready_field_decl_contract.py",
    "test_mission05_presentation_ready_field_decl_contract.py",
    "test_mission06_presentation_ready_field_decl_contract.py",
    "test_mission07_presentation_ready_field_decl_contract.py",
    "test_mission08_presentation_ready_field_decl_contract.py",
    "test_mission10_presentation_ready_field_decl_contract.py",
)
...
LEFTOVER_MISSION09_MAP_ASSEMBLY_READY_NOT_LOCKED = (
    "test_mission09_map_assembly_ready_field_decl_contract.py",
    "cursor/mission09-map-assembly-ready-field-decl-contract-c332",
)
LEFTOVER_SAME_NAME_OBJECTIVES_READY_NOT_LOCKED = (
    "test_mission01_objectives_ready_field_decl_contract.py",
    "test_mission02_objectives_ready_field_decl_contract.py",
    "test_mission03_objectives_ready_field_decl_contract.py",
    "test_mission04_objectives_ready_field_decl_contract.py",
    "test_mission05_objectives_ready_field_decl_contract.py",
    "test_mission06_objectives_ready_field_decl_contract.py",
    "test_mission07_objectives_ready_field_decl_contract.py",
    "test_mission08_objectives_ready_field_decl_contract.py",
    "test_mission10_objectives_ready_field_decl_contract.py",
)
...
LEFTOVER_SAME_NAME_MAP_ASSEMBLY_READY_NOT_LOCKED = (
    "test_mission01_map_assembly_ready_field_decl_contract.py",
    "test_mission02_map_assembly_ready_field_decl_contract.py",
    "test_mission03_map_assembly_ready_field_decl_contract.py",
    "test_mission04_map_assembly_ready_field_decl_contract.py",
    "test_mission05_map_assembly_ready_field_decl_contract.py",
...
LEFTOVER_MISSION09_MISSION_DEFINITION_VALID_NOT_LOCKED = (
    "test_mission09_mission_definition_valid_field_decl_contract.py",
    "cursor/mission09-mission-definition-valid-field-decl-contract-c332",
)
...
LEFTOVER_MISSION09_DIRECTOR_FIELDS_NOT_LOCKED = (
    "test_mission09_root_field_decl_contract.py",
    "test_mission09_briefing_field_decl_contract.py",
    "test_mission09_audio_director_field_decl_contract.py",
    "test_mission09_radio_chatter_field_decl_contract.py",
    "test_mission09_sortie_presentation_field_decl_contract.py",
    "test_mission09_campaign_definition_field_decl_contract.py",
    "test_mission09_mission_definition_field_decl_contract.py",
    "test_mission09_auto_initialize_field_decl_contract.py",
    "test_mission09_allow_bounded_actor_spawning_field_decl_contract.py",
    "test_mission09_auto_launch_after_briefing_field_decl_contract.py",
    ...
    "test_mission09_skyline_anchor_field_decl_contract.py",
    "test_mission09_major_bridge_anchor_field_decl_contract.py",
    "test_mission09_power_station_anchor_field_decl_contract.py",
    "test_mission09_readiness_field_decl_contract.py",
    "cursor/mission09-mission-definition-field-decl-contract-c332",
    "cursor/mission09-readiness-field-decl-contract-c332",
    "cursor/mission09-campaign-save-user-index-field-decl-contract-c332",
    "FSkyguardMission09IntegrationReadiness Readiness;",
)
LEFTOVER_MISSION07_READINESS_STRUCT_FIELDS_NOT_LOCKED = (
    "test_mission07_campaign_definition_valid_field_decl_contract.py",
    "test_mission07_map_assembly_ready_field_decl_contract.py",
    "test_mission07_gunner_ready_field_decl_contract.py",
    "test_mission07_radar_ghost_ready_field_decl_contract.py",
    "test_mission07_objectives_ready_field_decl_contract.py",
    "test_mission07_waves_ready_field_decl_contract.py",
    "test_mission07_search_runtime_ready_field_decl_contract.py",
    "test_mission07_protected_targets_ready_field_decl_contract.py",
...
LEFTOVER_MISSION08_DIRECTOR_FIELDS_NOT_LOCKED = (
    "test_mission08_root_field_decl_contract.py",
    "test_mission08_briefing_field_decl_contract.py",
    "test_mission08_audio_director_field_decl_contract.py",
    "test_mission08_radio_chatter_field_decl_contract.py",
    "test_mission08_sortie_presentation_field_decl_contract.py",
    "test_mission08_campaign_definition_field_decl_contract.py",
    "test_mission08_mission_definition_field_decl_contract.py",
    ...
    "test_mission08_rescue_helicopter_anchor_field_decl_contract.py",
    "test_mission08_hoist_cable_anchor_field_decl_contract.py",
    "test_mission08_survivors_anchor_field_decl_contract.py",
    "test_mission08_rafts_anchor_field_decl_contract.py",
    "test_mission08_rescue_vessel_anchor_field_decl_contract.py",
    ...
    "cursor/mission08-mission-definition-field-decl-contract-c332",
    ...
    "cursor/mission08-required-covered-seconds-field-decl-contract-c332",
    "cursor/mission08-minimum-weapon-separation-meters-field-decl-contract-c332",
...
class Mission09PresentationReadyFieldDeclContractTests(unittest.TestCase):
    def test_mission09_struct_exists(self) -> None:
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bPresentationReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_presentation_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_presentation_ready_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bPresentationReady"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bPresentationReady", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bPresentationReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bPresentationReady"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bPresentationReady", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 bPresentationReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 bPresentationReady contains "
    ...
    def test_contract_is_presentation_ready_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_presentation_ready(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission09_objectives_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission09_protected_targets_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission09_sortie_presentation_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission09_map_assembly_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_map_assembly_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission07_maximum_protected_target_integrity"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission07_reinforcement_deadline_seconds"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_contract_does_not_parse_director_class_or_storm_runtime(
        ...
        for token in LEFTOVER_MISSION06_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION07_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        ...
        for token in LEFTOVER_MISSION06_MISSION_DEFINITION_VALID_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION07_MISSION_DEFINITION_VALID_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        search_only = (
        ...
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover_m07_only)
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        leftover_m08_only = (
        ...
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover_m08_only)
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        for token in LEFTOVER_MISSION08_MISSION_DEFINITION_VALID_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION09_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION07_MISSION_DEFINITION_VALID_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION08_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION08_CAMPAIGN_DEFINITION_VALID_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_SAME_NAME_MAP_ASSEMBLY_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION08_MAP_ASSEMBLY_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION08_OBJECTIVES_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION09_OBJECTIVES_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION09_PROTECTED_TARGETS_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION09_ESCALATING_WAVES_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION09_IRON_RAIN_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION09_GUNNER_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION08_SORTIE_PRESENTATION_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION09_SORTIE_PRESENTATION_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_SAME_NAME_PRESENTATION_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_SAME_NAME_SORTIE_PRESENTATION_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION09_MAP_ASSEMBLY_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_SAME_NAME_OBJECTIVES_READY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        for token in LEFTOVER_MISSION09_MISSION_DEFINITION_VALID_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        self.assertNotIn(
