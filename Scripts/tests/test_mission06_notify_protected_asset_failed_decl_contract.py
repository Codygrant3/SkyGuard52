...
# Mission06 Objectives NotifyProtectedAssetFailed
# METHOD on ASkyguardMission06IntegrationDirector. It is
# NOT leftover Mission05 NotifyProtectedAssetFailed
# #682, NOT leftover Mission01 / Mission03 /
# Mission04 NotifyProtectedAssetFailed, NOT leftover
# Mission05 NotifyThreatDestroyed #669, NOT leftover
...
# leftover Mission06 wave-state enum #fa65, NOT
# leftover airfield-target enum #14d2, NOT
# leftover airfield-target-runtime-defaults #6ad8, NOT
...
# leftover Mission03 / Mission04
# NotifyThreatDestroyed, leftover Mission05
# ConfigureMissionDefinition, leftover Mission05
# GetSurvivingTargetCount, leftover Mission04
# wave-state enum #bb22, leftover Mission06
# wave-state enum #fa65, leftover airfield-target
# enum #14d2, leftover
...
# wraps, and an inline body without locking the body.
# Nearby origin/main
...
# Category is Skyguard|Mission06|Objectives, not
# Mission01 / Mission02 / Mission03 / Mission04 /
# Mission05 / Integration / Payload / Targets /
# Waves / Boss / Destruction / Briefing, not
...
# #669, not leftover Harbor Mission02 Integration.
...
# #668/#669/#682. Closed leftover #658–#673.
...
LEFTOVER_MISSION05_NOTIFY_THREAT_NOT_LOCKED = (
    "ASkyguardMission05IntegrationDirector",
    "SkyguardMission05IntegrationDirector.h",
...
LEFTOVER_MISSION06_NOTIFY_THREAT_NOT_LOCKED = (
    "NotifyThreatDestroyed",
    NOTIFY_THREAT_DESTROYED,
    "test_mission06_notify_threat_destroyed_decl_contract.py",
    'Category="Skyguard|Mission06|Waves"',
)
LEFTOVER_MISSION03_NOTIFY_THREAT_NOT_LOCKED = (
    "ASkyguardMission03IntegrationDirector",
    "SkyguardMission03IntegrationDirector.h",
    "test_mission03_notify_threat_destroyed_decl_contract.py",
    'Category="Skyguard|Mission03|Waves"',
)
LEFTOVER_MISSION04_NOTIFY_THREAT_NOT_LOCKED = (
    "ASkyguardMission04IntegrationDirector",
    "SkyguardMission04IntegrationDirector.h",
    "test_mission04_notify_threat_destroyed_decl_contract.py",
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission06IntegrationDirector::NotifyProtectedAssetFailed",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission06NotifyProtectedAssetFailedDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission06|Objectives", UFUNCTION_OBJECTIVES)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        with_arg = "\tbool InitializePlayableMission(bool bForce);\n"
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 NotifyProtectedAssetFailed method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission06 NotifyProtectedAssetFailed contains "
    ...
    def test_leftover_mission05_notify_threat_destroyed_does_not_satisfy(
        ...
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        for token in LEFTOVER_MISSION05_NOTIFY_THREAT_NOT_LOCKED:
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn(
            "Scripts/tests/test_mission05_notify_threat_destroyed"
            "_decl_contract.py",
    ...
    def test_leftover_mission03_notify_threat_destroyed_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
        ...
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        for token in LEFTOVER_MISSION03_NOTIFY_THREAT_NOT_LOCKED:
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn(
            "Scripts/tests/test_mission03_notify_threat_destroyed"
            "_decl_contract.py",
    ...
    def test_leftover_mission04_notify_threat_destroyed_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission04IntegrationDirector "
        ...
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        for token in LEFTOVER_MISSION04_NOTIFY_THREAT_NOT_LOCKED:
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn(
            "Scripts/tests/test_mission04_notify_threat_destroyed"
            "_decl_contract.py",
    ...
    def test_contract_does_not_relock_leftover_mission06_wave_state_enum(
        ...
        self.assertNotIn("ESkyguardMission06WaveState", UFUNCTION_OBJECTIVES)
    ...
    def test_leftover_mission06_notify_threat_destroyed_does_not_satisfy(
        self,
    ) -> None:
        region = f"\t{NOTIFY_THREAT_DESTROYED}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(region, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn("NotifyProtectedAssetFailed", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        ...
        for token in LEFTOVER_MISSION06_NOTIFY_THREAT_NOT_LOCKED:
            self.assertNotIn(token, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn(
            "Scripts/tests/test_mission06_notify_threat_destroyed"
            "_decl_contract.py",
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_notify_protected_asset_failed"
                "_decl_contract.py"
            )
        )
        self.assertIn(
