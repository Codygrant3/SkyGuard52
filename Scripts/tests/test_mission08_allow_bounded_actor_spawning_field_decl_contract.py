...
# THIS IS leftover-safe Mission08 bAllowBoundedActorSpawning FIELD
# (declaration-only, one-line / split-line UPROPERTY wraps, bool
# default true) on ASkyguardMission08IntegrationDirector.
# THIS IS NOT leftover Mission07 bAllowBoundedActorSpawning /
# branch cursor/mission07-allow-bounded-actor-spawning-field-
# decl-contract-c332. THIS IS NOT leftover Mission06
# bAllowBoundedActorSpawning #987. THIS IS NOT leftover
# Mission05 bAllowBoundedActorSpawning #955. THIS IS NOT leftover
# Mission04 bAllowBoundedActorSpawning #917. THIS IS NOT leftover
# Mission02 bAllowBoundedActorSpawning #854.
...
# director Root #1044 through CampaignDefinition #1055.
...
# merge #665 #666 #668-#673, or open drafts #674-#1055.
...
# Mission08 bAllowBoundedActorSpawning FIELD
...
# Mission02 bAllowBoundedActorSpawning field
# #854 / branch cursor/mission02-allow-bounded-
# actor-spawning-field-decl-contract-c332, NOT leftover
# Mission04 bAllowBoundedActorSpawning #917 / branch
# cursor/mission04-allow-bounded-actor-spawning-
# field-decl-contract-c332, NOT leftover
# Mission05 bAllowBoundedActorSpawning #955 / branch
# cursor/mission05-allow-bounded-actor-spawning-
# field-decl-contract-c332, NOT leftover Mission06
# leftover bAllowBoundedActorSpawning #987 / branch
# cursor/mission06-allow-bounded-actor-spawning-
# field-decl-contract-c332, NOT leftover Mission07
# Root #1011 / Briefing #1012 / AudioDirector #1013 /
# RadioChatter / SortiePresentation #1014 /
# CampaignDefinition / MissionDefinition /
# bAutoInitialize sibling lanes, NOT leftover Mission06
# MissionDefinition in-flight branch cursor/
# mission06-mission-definition-field-decl-
# contract-c332, NOT leftover Mission06
# bAutoInitialize in-flight branch, NOT leftover
# Mission10 bAllowBoundedActorSpawning field
# / branch cursor/mission10-allow-bounded-
# actor-spawning-field-decl-contract-c332, NOT leftover
# Mission06 AudioDirector draft #979 / branch cursor/
# mission06-audio-director-field-decl-contract-
# c332, NOT leftover Mission06 Briefing draft
# #980 / branch cursor/mission06-briefing-field-
# decl-contract-c332, NOT leftover Mission06 Root
# draft #981 / branch cursor/mission06-root-field-
# decl-contract-c332, NOT leftover Mission06
# RadioChatter #982 / branch cursor/mission06-radio-
# chatter-field-decl-contract-c332, NOT leftover
# Mission06 SortiePresentation #984 in-flight branch
# cursor/mission06-sortie-presentation-field-
# decl-contract-c332, NOT leftover Mission06
# CampaignDefinition #983 in-flight branch cursor/
# mission06-campaign-definition-field-decl-
# contract-c332, NOT leftover Mission04 bAudioReady #937 /
...
# = false / = true / = 0 / = 100 / = 0.f /
# TEXT("Skyguard52Campaign") / FVector(...) /
# FRotator(...) defaults, and nearby split-line
...
# FSkyguardHoistWindowRuntime,
# FSkyguardMission08ProtectedTargetRuntime, or private
# UPROPERTY(Transient). Do not parse leftover
# FSkyguardSearchTrackRuntime, leftover
# FSkyguardMission07IntegrationReadiness, leftover
# FSkyguardMission07ProtectedTargetRuntime, or Mission01 /
...
# drafts #674-#1055 including leftover Mission03
...
# CampaignDefinition #983 / SortiePresentation
# #984 / leftover MissionDefinition /
# leftover bAutoInitialize in-flight branches.
...
class Mission08AllowBoundedActorSpawningFieldDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_mission = f"\t{RADIO_CHATTER_FIELD}\n"
        leftover_readiness_field = f"\t{READINESS_FIELD}\n"
        leftover_auto = f"\t{AUTO_INITIALIZE_FIELD}\n"
        leftover_allow = f"\t{MISSION_DEFINITION_FIELD}\n"
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 allow bounded actor spawning field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 allow bounded actor spawning field contains "
    ...
    def test_leftover_mission10_allow_bounded_actor_spawning_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission08_allow_bounded_actor"
            "_spawning_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_allow_bounded_actor_spawning"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
            "Scripts/tests/test_mission01_allow_bounded_actor"
            "_spawning_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission02_allow_bounded_actor"
            "_spawning_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission04_allow_bounded_actor"
            "_spawning_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission05_allow_bounded_actor"
            "_spawning_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission06_allow_bounded_actor"
            "_spawning_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission07_allow_bounded_actor"
            "_spawning_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_root_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_mission02_allow_bounded_actor_spawning_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission02IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission03_allow_bounded_actor_spawning_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission04_allow_bounded_actor_spawning_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_leftover_mission06_allow_bounded_actor_spawning_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_leftover_mission05_allow_bounded_actor_spawning_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_leftover_mission07_allow_bounded_actor_spawning_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_private_transient_does_not_satisfy_allow_bounded_actor_spawning(
        ...
        self.assertNotIn("ResolvedMission", LOCKED_DECL)
