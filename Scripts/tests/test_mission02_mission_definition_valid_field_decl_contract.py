...
# Mission02 IntegrationReadiness bMissionDefinitionValid
...
# drafts #674-#858+ including leftover Mission02
# methods #828-#844, Root #845 through
# CampaignSaveUserIndex #857, leftover Mission10
...
# Mission02 siblings #828-#857. Do not reopen leftover
...
class Mission02MissionDefinitionValidFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 bMissionDefinitionValid field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 bMissionDefinitionValid contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_mission_definition"
                "_valid_field_decl_contract.py"
            )
        )
        self.assertIn(
