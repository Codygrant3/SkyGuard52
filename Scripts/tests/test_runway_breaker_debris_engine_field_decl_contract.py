...
# INDEX_NONE or lock DebrisEngine construction
...
# DebrisPortWing / DebrisPayloadBay and not leftover
# emergency-finish named surfaces
# (split tokens only). Keep RunwayBreaker
# DebrisEngine distinct from leftover Breakwater
# DebrisEngine, leftover RoadHunter DebrisEngine,
# leftover LastFlight debris engines, and sibling
# RunwayBreaker PortEngine
# (USkyguardBossWeakPointComponent).
# Sibling fields RunwayRack, HangarRack,
# HeatManifold, PortEngine, DebrisPortWing,
# DebrisPayloadBay must not satisfy the primary lock.
...
# DebrisEngine;`); accept that form and other
...
# isolated-test drafts #107–#558 including
...
LAST_FLIGHT_DEBRIS_ENGINE_PORT_FIELD = (
    "TObjectPtr<UStaticMeshComponent> DebrisEnginePort;"
)
LAST_FLIGHT_DEBRIS_ENGINE_STARBOARD_FIELD = (
...
# leftover isolated-test drafts #107–#558,
# leftover searchlight-track-runtime-defaults
...
# unlocked for THIS test's primary DebrisEngine lock. Leftover
...
LEFTOVER_LAST_FLIGHT_DEBRIS_ENGINES_NOT_LOCKED = (
    "test_last_flight_debris_engine_port_field_decl_contract.py",
    "test_last_flight_debris_engine_starboard_field_decl_contract.py",
    "DebrisEnginePort",
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardRunwayBreakerBoss::DebrisEngine",
    "SkyguardRunwayBreakerBoss.cpp",
    "SetExposed",
...
class RunwayBreakerDebrisEngineFieldDeclContractTests(unittest.TestCase):
    def test_runway_breaker_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, DEBRIS_ENGINE_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, DEBRIS_ENGINE_FIELD)
        self.assertIn("DebrisEngine", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, DEBRIS_ENGINE_FIELD)
    ...
    def test_missing_debris_engine_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardRunwayBreakerBoss();\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, DEBRIS_ENGINE_FIELD)
        self.assertIn("DebrisEngine", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, DEBRIS_ENGINE_FIELD)
        self.assertIn("DebrisEngine", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UPROPERTY", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("VisibleAnywhere", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("BlueprintReadOnly", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("Category", DEBRIS_ENGINE_FIELD)
        ...
        self.assertNotIn("Mission06", UPROPERTY_DESTRUCTION)
        self.assertIn("Destruction", UPROPERTY_DESTRUCTION)
        self.assertNotIn("Encounter", UPROPERTY_DESTRUCTION)
        self.assertNotIn("Mission03", UPROPERTY_DESTRUCTION)
        self.assertNotIn("Mission02", UPROPERTY_DESTRUCTION)
        self.assertNotIn("Mission07", UPROPERTY_DESTRUCTION)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, DEBRIS_ENGINE_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, DEBRIS_ENGINE_FIELD)
        self.assertIn("DebrisEngine", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUStaticMeshComponent* DebrisEngine;\n"
        )
        as_array = (
        ...
        scene = (
            "\tTObjectPtr<USceneComponent> DebrisEngine;\n"
        )
        mesh = (
            "\tTObjectPtr<USkyguardBossWeakPointComponent> DebrisEngine;\n"
        )
        weak = (
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, DEBRIS_ENGINE_FIELD)
            self.assertIn("DebrisEngine", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_debris_engine_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, DEBRIS_ENGINE_FIELD),
            DEBRIS_ENGINE_FIELD,
        )
        self.assertTrue(has_declaration(section, DEBRIS_ENGINE_FIELD))
        self.assertEqual(declaration_count(section, DEBRIS_ENGINE_FIELD), 1)
        self.assertTrue(
            DEBRIS_ENGINE_FIELD.startswith(
                "TObjectPtr<UStaticMeshComponent> "
            ),
            DEBRIS_ENGINE_FIELD,
        )
        self.assertTrue(DEBRIS_ENGINE_FIELD.endswith(";"), DEBRIS_ENGINE_FIELD)
        self.assertIn("DebrisEngine", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("HangarRack", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("HeatManifold", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("RunwayRack", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DebrisPortWing", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DebrisPayloadBay", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("PortEngine", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("TargetingCamera", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("LeftActuator", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("RightActuator", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DebrisLeftWing", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DebrisRightWing", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DebrisCoolingDoor", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("SignatureModulator", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("RadarReceiver", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("CoolingDoor", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("PortLatch", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("NoseCamera", DEBRIS_ENGINE_FIELD)
        self.assertIn(
            "UStaticMeshComponent",
            DEBRIS_ENGINE_FIELD,
        )
        self.assertIn("TObjectPtr<", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("TArray<", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("=", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("INDEX_NONE", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("UFUNCTION", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("{", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("}", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("return ", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("CommandAntenna", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ControlLinkage", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("NoseCamera", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DebrisCenter", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DebrisTail", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DebrisNose", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DebrisSpine", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("AdvanceEncounter", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ResetEncounterState", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("IsRouteStateSafe", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("GetRouteProgress", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("GetEffectiveSpeedMultiplier", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("IsAttackTelegraphActive", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("GetTelegraphsTriggered", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("RadarNode", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("BeginTerminalStrikeCycle", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("OpenGuidanceArrayExposure", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("IssueClimbCommand", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DivertWreckFromCivilians", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("SetCivilianSeparationMeters", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("GetCivilianSeparationMeters", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("GetFinaleStage", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("IsClimbCommandIssued", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("IsWreckDiverted", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("GetObjectiveMilestonesReached", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ESkyguardLastFlightStage", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("GetGunnerMount", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("FaceWorldLocation", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("PortGuidanceArray", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DebrisArmorPort", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("SetSearchlightTracked", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("SetContactIdentified", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("SetLightningExposed", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("HullCollider", DEBRIS_ENGINE_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, DEBRIS_ENGINE_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_DESTRUCTION} {DEBRIS_ENGINE_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(
                declaration_count(section, DEBRIS_ENGINE_FIELD),
                1,
            )
        one_line = f"{{\npublic:\n\t{DEBRIS_ENGINE_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, DEBRIS_ENGINE_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, DEBRIS_ENGINE_FIELD),
            section,
    ...
    def test_assigned_debris_engine_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<UStaticMeshComponent> "
            "DebrisEngine = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, DEBRIS_ENGINE_FIELD)
        self.assertIn("DebrisEngine", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, DEBRIS_ENGINE_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("DebrisEngine", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, DEBRIS_ENGINE_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{DEBRIS_ENGINE_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, DEBRIS_ENGINE_FIELD)
        ...
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_DESTRUCTION, section)
        self.assertTrue(has_declaration(section, DEBRIS_ENGINE_FIELD), section)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            DEBRIS_ENGINE_FIELD.startswith("UFUNCTION"),
            DEBRIS_ENGINE_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, DEBRIS_ENGINE_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", DEBRIS_ENGINE_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_debris_engine_cpp_body(self) -> None:
        locked_only = f"{DEBRIS_ENGINE_FIELD}\n"
        self.assertNotIn("{", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("}", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("return ", DEBRIS_ENGINE_FIELD)
        ...
        self.assertNotIn("SkyguardRunwayBreakerBoss.cpp", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("SkyguardRunwayBreakerBoss.cpp", locked_only)
        self.assertNotIn("return false", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("return true", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("CreateDefaultSubobject", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("SetExposed", DEBRIS_ENGINE_FIELD)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            DEBRIS_ENGINE_FIELD,
        )
        self.assertNotIn("SetBossPhase", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", DEBRIS_ENGINE_FIELD)

    def test_contract_does_not_relock_sibling_tempest_fields(self) -> None:
        locked_only = f"{DEBRIS_ENGINE_FIELD}\n"
        for token in SIBLING_TEMPEST_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("PortDischargeBoom", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("StarboardDischargeBoom", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("EngineIntake", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DebrisPortPanel", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DebrisStarboardPanel", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DebrisIntakePanel", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("RequiredLockStabilitySeconds", DEBRIS_ENGINE_FIELD)
        self.assertIn(
            "UStaticMeshComponent",
            DEBRIS_ENGINE_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_encounter_controller(
        ...
        for token in LEFTOVER_ENCOUNTER_CONTROLLER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("EncounterController", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_control_servo(self) -> None:
        ...
        for token in LEFTOVER_CONTROL_SERVO_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ControlServo", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_sibling_iron_rain_fields(self) -> None:
        ...
        for token in SIBLING_IRON_RAIN_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DispenserCenter", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("MaxReleasesPerBay", DEBRIS_ENGINE_FIELD)
        self.assertIn("DebrisEngine", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost_methods(
        ...
        for token in LEFTOVER_RADAR_GHOST_METHODS_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("SetContactIdentified", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("OpenOrbitExposure", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("IsContactIdentified", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", DEBRIS_ENGINE_FIELD)
        self.assertNotIn(leftover_open_rear_aspect_window(), DEBRIS_ENGINE_FIELD)

    def test_debris_cooling_door_does_not_satisfy_debris_engine(self) -> None:
        leftover = f"\t{DEBRIS_COOLING_DOOR_FIELD}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover, DEBRIS_ENGINE_FIELD)
        self.assertIn("DebrisEngine", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover, DEBRIS_ENGINE_FIELD))
        self.assertNotEqual(DEBRIS_COOLING_DOOR_FIELD, DEBRIS_ENGINE_FIELD)
        self.assertIn("UStaticMeshComponent", DEBRIS_ENGINE_FIELD)
        self.assertNotIn(
            "USkyguardBossWeakPointComponent",
            DEBRIS_COOLING_DOOR_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_dispenser_starboard(
        ...
        for token in LEFTOVER_DISPENSER_STARBOARD_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DispenserStarboard", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_get_maneuver(self) -> None:
        ...
        for token in LEFTOVER_GET_MANEUVER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("GetManeuver", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_open_first_window(), DEBRIS_ENGINE_FIELD)
        self.assertNotIn(leftover_open_final_window(), locked_only)
        self.assertNotIn(leftover_open_final_window(), DEBRIS_ENGINE_FIELD)
        self.assertNotIn(leftover_arm_command_core_path(), locked_only)
        self.assertNotIn(leftover_arm_command_core_path(), DEBRIS_ENGINE_FIELD)
        self.assertNotIn(leftover_apply_strike(), locked_only)
        self.assertNotIn(leftover_apply_strike(), DEBRIS_ENGINE_FIELD)
        self.assertNotIn(leftover_is_lock_eligible(), locked_only)
        self.assertNotIn(leftover_is_lock_eligible(), DEBRIS_ENGINE_FIELD)
        self.assertNotIn(leftover_arm_emergency_finish(), locked_only)
        self.assertNotIn(leftover_arm_emergency_finish(), DEBRIS_ENGINE_FIELD)
        ...
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_debris_getters(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("GetDefeatDebrisPieceCount", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("GetMaxDefeatDebrisPieces", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("SetSearchlightTracked", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ASkyguardBlackKiteBoss", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        self.assertNotIn("CoolingDoor", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("SignatureModulator", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ASkyguardRadarGhostBoss", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest_methods(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("SetLightningExposed", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ApplyCorrectiveBankGust", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("IsLightningExposed", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("GetLockStabilitySeconds", DEBRIS_ENGINE_FIELD)
        self.assertNotIn(leftover_advance_stabilized_lock(), DEBRIS_ENGINE_FIELD)
        self.assertNotIn(leftover_arm_break_finish(), DEBRIS_ENGINE_FIELD)
        self.assertNotIn(leftover_is_break_finish_armed(), DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        for token in LEFTOVER_PATROL_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ASkyguardPatrolShip", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        ...
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            ...
            self.assertNotIn(neighbor, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ASkyguardGunner", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("SkyguardRadarNode", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            ...
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("MaxIntegrity", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("CurrentIntegrity", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", DEBRIS_ENGINE_FIELD)
        self.assertNotIn(
            "SkyguardPathfinderEncounterController.h",
            DEBRIS_ENGINE_FIELD,
        )
    ...
    def test_contract_does_not_open_leftover_weak_point_component_header(
        ...
        self.assertNotIn(leftover_header, DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{DEBRIS_ENGINE_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, DEBRIS_ENGINE_FIELD),
            DEBRIS_ENGINE_FIELD,
        )
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardRunwayBreakerBoss::DebrisEngine", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "runway breaker PortEngine field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{DEBRIS_ENGINE_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, DEBRIS_ENGINE_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                DEBRIS_ENGINE_FIELD.lower(),
                "runway breaker PortEngine contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, DEBRIS_ENGINE_FIELD)

    def test_contract_is_debris_engine_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertTrue(DEBRIS_ENGINE_FIELD.endswith(";"))
        self.assertNotIn("=", DEBRIS_ENGINE_FIELD)
        self.assertIn(UPROPERTY_DESTRUCTION, section)
    ...
    def test_contract_does_not_relock_sibling_road_hunter_fields(self) -> None:
        ...
        self.assertNotIn("PortEngine", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DebrisRightWing", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ASkyguardRoadHunterBoss", DEBRIS_ENGINE_FIELD)
        self.assertIn("DebrisEngine", DEBRIS_ENGINE_FIELD)
        self.assertNotEqual(DEBRIS_ENGINE_FIELD, ROAD_HUNTER_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_sibling_breakwater_fields(self) -> None:
        ...
        for token in SIBLING_BREAKWATER_FIELDS_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("PortLatch", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("StarboardLatch", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DecoyPods", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ElevatorLinkage", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ASkyguardBreakwaterBoss", DEBRIS_ENGINE_FIELD)
        self.assertIn(
            "Scripts/tests/test_breakwater_engine_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_runway_breaker_debris_engine_is_not_breakwater_engine(self) -> None:
        locked_only = f"{DEBRIS_ENGINE_FIELD}\n"
        self.assertNotEqual(DEBRIS_ENGINE_FIELD, BREAKWATER_ENGINE_FIELD)
        self.assertNotEqual(DEBRIS_ENGINE_FIELD, RADAR_GHOST_ENGINE_FIELD)
        self.assertNotEqual(collapsed(DEBRIS_ENGINE_FIELD), collapsed(ENGINE_FIELD))
        self.assertNotEqual(DEBRIS_ENGINE_FIELD, ROAD_HUNTER_ENGINE_FIELD)
        ...
        self.assertNotIn("ASkyguardRoadHunterBoss", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ASkyguardRadarGhostBoss", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ASkyguardPathfinderBoss", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ASkyguardLastFlightBoss", DEBRIS_ENGINE_FIELD)
        self.assertIn("DebrisEngine", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("PortEngine", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("TargetingCamera", DEBRIS_ENGINE_FIELD)
    ...
    def test_runway_breaker_debris_engine_is_not_leftover_debris_engine(
        ...
        self.assertIn("DebrisEngine", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("PortEngine", DEBRIS_ENGINE_FIELD)
        self.assertNotEqual(DEBRIS_ENGINE_FIELD, PORT_ENGINE_FIELD)
        self.assertNotEqual(DEBRIS_ENGINE_FIELD, ROAD_HUNTER_ENGINE_FIELD)
        self.assertNotEqual(DEBRIS_ENGINE_FIELD, BREAKWATER_ENGINE_FIELD)
    def test_contract_does_not_relock_leftover_mission02_wave_state(
        ...
        for token in LEFTOVER_MISSION02_WAVE_STATE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ESkyguardMission02WaveState", DEBRIS_ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter_fields(
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("OpticalTracker", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("WeaponServo", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("CountermeasurePod", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", DEBRIS_ENGINE_FIELD)


    def test_runway_breaker_debris_engine_is_not_radar_ghost_engine(self) -> None:
        locked_only = f"{DEBRIS_ENGINE_FIELD}\n"
        self.assertNotEqual(DEBRIS_ENGINE_FIELD, RADAR_GHOST_ENGINE_FIELD)
        self.assertEqual(CLASS_NAME, "ASkyguardRunwayBreakerBoss")
        self.assertNotEqual(CLASS_NAME, "ASkyguardRadarGhostBoss")
    ...
    def test_runway_breaker_debris_engine_is_not_pathfinder_engine(self) -> None:
        locked_only = f"{DEBRIS_ENGINE_FIELD}\n"
        self.assertNotEqual(
            collapsed(DEBRIS_ENGINE_FIELD),
    ...
    def test_runway_breaker_debris_engine_is_not_road_hunter_engine(self) -> None:
        locked_only = f"{DEBRIS_ENGINE_FIELD}\n"
        self.assertNotEqual(DEBRIS_ENGINE_FIELD, ROAD_HUNTER_ENGINE_FIELD)
        self.assertEqual(CLASS_NAME, "ASkyguardRunwayBreakerBoss")
        self.assertNotEqual(CLASS_NAME, "ASkyguardRoadHunterBoss")
    ...
    def test_hangar_rack_does_not_satisfy_debris_engine(self) -> None:
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover, DEBRIS_ENGINE_FIELD))
        self.assertNotEqual(HANGAR_RACK_FIELD, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("HangarRack", DEBRIS_ENGINE_FIELD)

    def test_heat_manifold_and_runway_rack_do_not_satisfy_debris_engine(
        self,
    ) -> None:
        for region, name in (
            (f"\t{HEAT_MANIFOLD_FIELD}\n", "HeatManifold"),
    ...
    def test_runway_breaker_sibling_fields_do_not_satisfy_debris_engine(
        self,
    ) -> None:
        for region, name in (
            (f"\t{RUNWAY_BREAKER_DEBRIS_PORT_WING_FIELD}\n", "DebrisPortWing"),
            ...
            self.assertFalse(has_declaration(region, DEBRIS_ENGINE_FIELD))
            self.assertNotIn(name, DEBRIS_ENGINE_FIELD)
    def test_port_engine_does_not_satisfy_debris_engine(self) -> None:
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover, DEBRIS_ENGINE_FIELD))
        self.assertNotEqual(PORT_ENGINE_FIELD, DEBRIS_ENGINE_FIELD)
        self.assertIn("UStaticMeshComponent", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("UStaticMeshComponent", PORT_ENGINE_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            PORT_ENGINE_FIELD,
        )
    ...
    def test_targeting_camera_does_not_satisfy_debris_engine(self) -> None:
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover, DEBRIS_ENGINE_FIELD))
        self.assertNotEqual(TARGETING_CAMERA_FIELD, DEBRIS_ENGINE_FIELD)
        self.assertNotIn("TargetingCamera", DEBRIS_ENGINE_FIELD)
        self.assertIn("DebrisEngine", DEBRIS_ENGINE_FIELD)

    def test_left_and_right_actuators_do_not_satisfy_debris_engine(self) -> None:
        for region, name in (
            (f"\t{LEFT_ACTUATOR_FIELD}\n", "LeftActuator"),
            (f"\t{RIGHT_ACTUATOR_FIELD}\n", "RightActuator"),
        ):
    ...
    def test_runway_breaker_debris_engine_is_not_last_flight_port_engine(
        self,
    ) -> None:
        locked_only = f"{DEBRIS_ENGINE_FIELD}\n"
        self.assertNotEqual(DEBRIS_ENGINE_FIELD, LAST_FLIGHT_PORT_ENGINE_FIELD)
        self.assertEqual(CLASS_NAME, "ASkyguardRunwayBreakerBoss")
        self.assertNotEqual(CLASS_NAME, "ASkyguardLastFlightBoss")
        self.assertNotEqual(
            HEADER_PATH,
        ...
        self.assertIn("DebrisEngine", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("PortEngine", DEBRIS_ENGINE_FIELD)
    def test_runway_breaker_debris_engine_is_not_last_flight_debris_engines(
        self,
    ) -> None:
        locked_only = f"{DEBRIS_ENGINE_FIELD}\n"
        self.assertNotEqual(
        ...
        self.assertEqual(CLASS_NAME, "ASkyguardRunwayBreakerBoss")
        self.assertNotEqual(CLASS_NAME, "ASkyguardLastFlightBoss")
        for token in LEFTOVER_LAST_FLIGHT_DEBRIS_ENGINES_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_ENGINE_FIELD)
        self.assertIn(
            "Scripts/tests/test_last_flight_debris_engine_port_field_decl_contract.py",
        ...
        self.assertNotIn("DebrisEnginePort", DEBRIS_ENGINE_FIELD)
        self.assertNotIn("DebrisEngineStarboard", DEBRIS_ENGINE_FIELD)
        self.assertIn("DebrisEngine", DEBRIS_ENGINE_FIELD)
