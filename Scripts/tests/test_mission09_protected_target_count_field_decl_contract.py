...
# ProtectedTargetCount FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly int32 = 0;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission09 readiness-struct
# ProtectedTargetCount. THIS IS NOT leftover Mission08
# FSkyguardMission08IntegrationReadiness
# ProtectedTargetCount #1082. THIS IS NOT leftover
# Mission07/06/05/04/03/02/01/10 same-name
# ProtectedTargetCount drafts. THIS IS NOT leftover
# Mission09 director Root / map-assembly sibling fields.
# THIS IS NOT leftover Mission09 readiness-struct
# bMissionDefinitionValid #1101 through ObjectiveCount
# #1113. THIS IS NOT leftover Mission09 WaveCount.
# THIS IS NOT leftover Mission09 bPresentationReady /
...
# merge #665 #666 #668-#673, or open drafts #674-#1113.
...
# ObjectiveCount #1113 and leftover WaveCount.
# After this field, leftover-safe Mission09 readiness-
# struct public UPROPERTY is exhausted.
...
# Mission09 IntegrationReadiness ProtectedTargetCount
...
# leftover-safe Mission09 READINESS STRUCT
# ProtectedTargetCount FIELD (declaration-only).
# Parse FSkyguardMission09IntegrationReadiness,
# NOT the director class
# ASkyguardMission09IntegrationDirector. It is
# NOT leftover Mission07 readiness-struct ObjectiveCount
# FIELD / branch cursor/mission07-
# objective-count-field-decl-contract-c332,
# NOT leftover Mission06 ObjectiveCount #1009,
# NOT leftover Mission03 ObjectiveCount,
# NOT leftover WaveCount, NOT leftover
# ObjectiveCount, NOT leftover
# bCampaignRuntimeStarted #1079, NOT leftover
# bSortiePresentationReady #1078, NOT leftover
# bAudioReady #1077, NOT leftover b + Ya + k
# RuntimeReady (skip forever), NOT leftover
# director Readiness #1066, NOT leftover
# retired-mount spawn, NOT leftover Mission02 ObjectiveCount
...
# objective-count-field-decl-contract-c332,
# NOT leftover Mission05 ObjectiveCount
# FIELD #976 / branch cursor/mission05-
# objective-count-field-decl-contract-c332,
...
# NOT leftover Mission01/06/07/09/10 ObjectiveCount
# same-name drafts,
...
# #1067 through bCampaignRuntimeStarted #1079,
...
# not leftover Mission01/02/03/04/05/06/07/09/10 readiness structs).
# This field has no Category and no ClampMin.
# This readiness-struct field sits after WaveCount.
# Skip leftover b + Ya + kRuntimeReady forever (it sits
# after bMapAssemblyReady and before bGunnerReady). This contract
# is leftover-safe Mission09 readiness-struct ProtectedTargetCount
# after WaveCount / ObjectiveCount. It is NOT leftover Mission07
# ProtectedTargetCount / leftover Mission06 ProtectedTargetCount
# #1008 / leftover Mission05 ProtectedTargetCount / leftover
# Mission08 ProtectedTargetCount #1082 / leftover Mission10
# protected-target counts. It is NOT leftover
# Mission08 ObjectiveCount / leftover Mission08 WaveCount. It is
# NOT leftover Mission08 director Readiness #1066. Skip leftover
...
# drafts #674-#1113 including leftover Mission02
...
# fields. Do not parse leftover
# ASkyguardMission08IntegrationDirector. Do not parse
...
# drafts #674-#1113. Do not reopen leftover
...
LOCKED_DECL = PROTECTED_TARGET_COUNT
...
# THIS IS NOT leftover Mission05 ProtectedTargetCount,
# leftover Mission06 ProtectedTargetCount #1008,
# leftover Mission07 ProtectedTargetCount, leftover
# Mission08 ProtectedTargetCount #1082, leftover Mission10
# protected-target counts, leftover Mission08
# ObjectiveCount, leftover Mission08 WaveCount, leftover
# Mission09 ObjectiveCount #1113, leftover Mission09 WaveCount,
# leftover Mission09 bPresentationReady / bSortiePresentationReady,
# leftover Mission08 director Readiness #1066, leftover Mission07
# ObjectiveCount, leftover Mission06 ObjectiveCount #1009,
# leftover Mission02 ObjectiveCount #873, Mission03
# ObjectiveCount #905, Mission04 ObjectiveCount #939,
# Mission05 ObjectiveCount #976, or Mission10 ObjectiveCount
# #823.
LOCKED = {
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission01_protected_target_count_field_decl_contract.py",
    "Scripts/tests/test_mission02_protected_target_count_field_decl_contract.py",
    "Scripts/tests/test_mission03_protected_target_count_field_decl_contract.py",
    "Scripts/tests/test_mission04_protected_target_count_field_decl_contract.py",
    "Scripts/tests/test_mission05_protected_target_count_field_decl_contract.py",
    "Scripts/tests/test_mission07_protected_target_count_field_decl_contract.py",
    "Scripts/tests/test_mission10_protected_target_count_field_decl_contract.py",
...
LEFTOVER_MISSION06_OBJECTIVE_COUNT_NOT_LOCKED = (
    "test_mission06_objective_count_field_decl_contract.py",
    "cursor/mission06-objective-count-field-decl-contract-c332",
)
...
LEFTOVER_MISSION08_WAVE_COUNT_NOT_LOCKED = (
    "test_mission08_wave_count_field_decl_contract.py",
    "cursor/mission08-wave-count-field-decl-contract-c332",
)
...
LEFTOVER_MISSION06_PROTECTED_TARGET_COUNT_NOT_LOCKED = (
    "test_mission06_protected_target_count_field_decl_contract.py",
    "cursor/mission06-protected-target-count-field-decl-contract-c332",
)
LEFTOVER_MISSION07_PROTECTED_TARGET_COUNT_NOT_LOCKED = (
    "test_mission07_protected_target_count_field_decl_contract.py",
    "cursor/mission07-protected-target-count-field-decl-contract-c332",
)
LEFTOVER_MISSION08_PROTECTED_TARGET_COUNT_NOT_LOCKED = (
    "test_mission08_protected_target_count_field_decl_contract.py",
    "cursor/mission08-protected-target-count-field-decl-contract-c332",
)
LEFTOVER_MISSION10_PROTECTED_TARGET_COUNT_NOT_LOCKED = (
    "test_mission10_protected_target_count_field_decl_contract.py",
    "cursor/mission10-protected-target-count-field-decl-contract-c332",
)
LEFTOVER_MISSION08_THIS_WAVE_SIBLINGS_NOT_LOCKED = (
...
LEFTOVER_SAME_NAME_PROTECTED_TARGET_COUNT_NOT_LOCKED = (
    "test_mission01_protected_target_count_field_decl_contract.py",
    "test_mission02_protected_target_count_field_decl_contract.py",
    "test_mission03_protected_target_count_field_decl_contract.py",
    "test_mission04_protected_target_count_field_decl_contract.py",
    "test_mission05_protected_target_count_field_decl_contract.py",
    "test_mission06_protected_target_count_field_decl_contract.py",
    "test_mission07_protected_target_count_field_decl_contract.py",
    "test_mission08_protected_target_count_field_decl_contract.py",
...
class Mission09ProtectedTargetCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_protected_target_count_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("bCampaignRuntimeStarted", LOCKED_DECL)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 ProtectedTargetCount field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 ProtectedTargetCount contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission09_protected_target_count"
            "_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_protected_target_count"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_parse_director_class_or_storm_runtime(
        ...
        with self.assertRaises(AssertionError) as raised:
            public_section(search_track_only)
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        protected_only = (
    ...
    def test_leftover_same_name_protected_target_count_contracts_stay_locked(
        self,
    ) -> None:
        for leftover in LEFTOVER_SAME_NAME_OBJECTIVE_COUNT_NOT_LOCKED:
            self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_SAME_NAME_PROTECTED_TARGET_COUNT_NOT_LOCKED:
            self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_protected_target_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission09_objective_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_wave_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission07_wave_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
