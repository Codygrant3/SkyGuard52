...
# RebindIfNeeded.
# origin/main form: one-line BlueprintCallable wrap
# UFUNCTION(BlueprintCallable, Category="Skyguard|Presentation|HUD")
# then BARE `void RebindIfNeeded();`
# (declaration-only, no inline body required).
# THIS IS leftover-safe unique analog Presentation|HUD UFUNCTION.
# Category IS `Skyguard|Presentation|HUD`. BlueprintCallable IS present.
# Unique leftover-safe Category path: Skyguard|Presentation|HUD
# (NEW unused 3-segment suffix HUD). This is leftover-safe
# unique analog, NOT leftover analog Presentation.
# const IS absent. Return type IS void. Declaration-only. No args.
# KEEP BlueprintCallable. Do NOT retarget to BindPresentation /
# RefreshFromPresentationState / GetBoundPresentation.
# Word-boundary match RebindIfNeeded vs BindPresentation.
# Identifier RebindIfNeeded is NOT leftover analog BindPresentation
# #1707 SHA 6a4d0db188a528053b7608035a2622d1de65be49 and NOT leftover
# analog RefreshFromPresentationState.
# Fail-closed if the UFUNCTION or decl is missing
# or renamed, if Category is missing, if specifiers
# stay BlueprintPure, if const is present, if the
# return type is not void, if args are present, or if Category is
...
# unique suffix / Category="Settings" without Skyguard| /
# Category="Skyguard|Presentation" without leftover-safe unique
# |HUD suffix / Category="Skyguard|Presentation|Briefing" /
...
# Parse CLASS `USkyguardSortieHudHostComponent` public
# section ONLY after `class USkyguardSortieHudHostComponent`
# / GENERATED_BODY. Start at `public:`. Stop BEFORE `private:`.
# Stop BEFORE first public UPROPERTY (`BriefingWidgetClass`).
# Presentation|HUD UFUNCTIONs sit early in public, before UPROPERTY.
# Do NOT claim sibling UFUNCTION BindPresentation /
# RefreshFromPresentationState / GetBoundPresentation as this slot
# (leave them uncontracted).
# Do NOT claim ShouldShowDebriefForState (NO UFUNCTION macro).
# Identifier RebindIfNeeded is NOT leftover analog
# sortie-hud-host-fail-closed bulk #132 (behavioral; wrap Category
# HUD UFUNCTION declaration only) and NOT leftover analog
# Gunner CpgSightHud #1627.
# Do NOT claim leftover unique Gunner FIELD Boom / CpgSightHud /
...
# Do NOT claim leftover unique Validation BlueprintCallable
# PrepareGovernedLandscapeForVisibleValidation.
# Do NOT claim leftover unique Validation BlueprintPure
# GetActiveRHIAndFeatureLevel.
# Skip leftover analog theater-kit GetLampInstanceCount
# Category Skyguard|Theater.
# Skip leftover analog ProductionBank EnsureDefaultEntries
# Category Skyguard|Audio|Production.
# Skip leftover analog GetSortieHits BlueprintPure
# Category Skyguard|Combat|Sortie.
# Skip leftover analog BindPresentation #1707.
# Skip leftover analog RefreshFromPresentationState.
# Skip leftover analog GetBoundPresentation.
# Skip leftover analog GetInvertVerticalLook.
# Skip leftover analog env-vfx GetActivationCount.
# Skip leftover analog Pathfinder Encounter unique FIELD.
# Skip leftover analog Production Audio Entry/Routing/Audit
# struct fields.
# Skip private / protected members.
# Clone leftover unique Validation BlueprintCallable #1694
# SHA e8a9961586c6ed5d538c813bb93d824c79b24db2
# — RETARGET method/return/args. KEEP BlueprintCallable.
# Clone leftover unique BlueprintCallable #1680
# SHA 27ffb2a529b5067ad204e9c35e46f650a02403a4
# Category Production — RETARGET Category Production →
# Skyguard|Presentation|HUD. KEEP BlueprintCallable.
# RETARGET void EnsureDefaultEntries(); →
# void RebindIfNeeded();
# FAIL-CLOSED if LOCKED_DECL is void EnsureDefaultEntries();
# Clone leftover unique BlueprintPure GetSortieHits #1685
# SHA 4e878e0750eaed9a830a48e36e94d949f608491b
# Category Combat|Sortie — RETARGET Category Combat|Sortie →
# Skyguard|Presentation|HUD. KEEP BlueprintCallable not BlueprintPure.
# Clone leftover unique Validation BlueprintPure #1695
# SHA 44ff9ffdf3359acfed757b1588de83a1a9aabe98
# — RETARGET; this slot is BlueprintCallable not BlueprintPure.
# Clone #1300 SHA c4679feb43f4b97d3a814c088e3b6c344e15831f
# is Category Theater wrapping FName
# WeatherIdentity with no initializer — RETARGET hard.
# LOCKED_DECL is `void RebindIfNeeded();`
# NOT `FName WeatherIdentity;` and NOT 160.f and NOT
# FireRate = 12.0f / RecoilPitch = 0.92f and NOT
# RouteLengthCm = 45000.f and NOT
# int32 GetSortieHits() const; and NOT
# void ResetSortieCombatStats(); and NOT
# bool GetInvertVerticalLook() const; and NOT
# bool bSuccess = false; and NOT
# void EnsureDefaultEntries(); and NOT
# void BindPresentation( and NOT
# void RefreshFromPresentationState(); and NOT
# GetBoundPresentation() const; and NOT
# int32 GetActivationCount() const;
# Fail-closed if this test still asserts those
# AS THE LOCKED DECL.
...
TARGET = "void RebindIfNeeded();"
TARGET_INLINE = (
    "void RebindIfNeeded() { }"
)
TARGET_WRONG_BARE = "void RebindIfNeeded() const;"
TARGET_WRONG_NO_CONST = (
    "bool RebindIfNeeded();"
)
TARGET_WRONG_VOID = "bool AreResolvedProductionLoopRoutesComplete() const;"
TARGET_WRONG_FLOAT = "float RebindIfNeeded();"
TARGET_WRONG_INT = "int32 RebindIfNeeded();"
TARGET_WRONG_RENAME = "void RebindIfNeede();"
TARGET_WRONG_RESET_SORTIE = "void ResetSortieCombatStats();"
TARGET_WRONG_GET_SORTIE_HITS = "int32 GetSortieHits() const;"
TARGET_WRONG_ENSURE = "void EnsureDefaultEntries();"
TARGET_WRONG_BIND = (
...
TARGET_WRONG_SIBLING_INIT = "void InitializeRequiredEntries();"
...
TARGET_WRONG_TRUE = "bool RebindIfNeeded = true;"
TARGET_WRONG_ZERO = "bool RebindIfNeeded = 0.f;"
...
UFUNCTION_CALLABLE = LOCKED_UFUNCTION_WRAP
UFUNCTION_PURE = (
...
UFUNCTION_COMBAT_CALLABLE = (
    'UFUNCTION(BlueprintCallable, Category="Skyguard|Combat")'
)
UFUNCTION_PRESENTATION_BARE = (
...
UFUNCTION_VALIDATION = (
    'UFUNCTION(BlueprintCallable, '
    'Category="Skyguard|Mission01|Environment|Validation")'
)
TARGET_WRONG_BUDGET = (
...
STOP_BEFORE_EVENT_DEFINITIONS = "Entries"
SIBLING_INITIALIZE_REQUIRED = "InitializeRequiredEntries"
SIBLING_EVALUATE_READINESS = "EvaluateReadiness"
SIBLING_CONFIGURE_ROUTING = "ConfigureRoutingTopology"
SIBLING_UNBOUND_CATEGORIES = "GetUnboundRequiredCategories"
SIBLING_FIND_ENTRY = "FindEntry"
SIBLING_GET_REQUIRED = "GetRequiredCategories"
SIBLING_GET_DISPLAY = "GetCategoryDisplayName"
...
STOP_BEFORE_SKYLINE_STYLE = "HasBoundObject"
...
THIS_SCRIPT = (
    "Scripts/tests/test_sortie_hud_rebind_if_needed"
    "_decl_contract.py"
)
...
LOCKED = {
    ...
    "SkyguardSortieHudHostComponentTests.cpp",
    "SkyguardGunner.cpp",
    "SkyguardGunner.h",
...
def leftover_analog_extra_scripts() -> tuple[str, ...]:
    ...
    return (
        ...
        LEFTOVER_THEATER_LAMP_COUNT,
        LEFTOVER_GUNNER_TRACE_RANGE,
        f"{prefix}test_sortie_hud_host_fail_closed.py",
        f"{prefix}test_sortie_hud_host_fail_closed_tests.py",
        f"{prefix}test_sortie_hud_host_fail_closed_contract.py",
        f"{prefix}test_sortie_hud_bind_presentation_decl_contract.py",
        f"{prefix}test_sortie_hud_refresh_from_presentation_state"
        "_decl_contract.py",
        f"{prefix}test_gunner_cpg_sight_hud_field_decl_contract.py",
        f"{prefix}test_gunner_reset_sortie_combat_stats"
        "_decl_contract.py",
        f"{prefix}test_gunner_get_sortie_hits_decl_contract.py",
        f"{prefix}test_audio_production_bank_ensure_default_entries"
        "_decl_contract.py",
        f"{prefix}test_mission01_prepare_governed_landscape_for_visible"
        "_validation_decl_contract.py",
        f"{prefix}test_mission01_get_active_rhi_and_feature_level"
        "_decl_contract.py",
        f"{prefix}test_theater_kit_spec_weather_identity"
        "_field_decl_contract.py",
        f"{prefix}test_env_vfx_activate_pooled_effect_decl_contract.py",
        f"{prefix}test_env_vfx_deactivate_all_effects_decl_contract.py",
        f"{prefix}test_env_vfx_get_allocated_pool_size_decl_contract.py",
        f"{prefix}test_environment_vfx_pool_fail_closed.py",
        f"{prefix}test_settings_get_invert_vertical_look"
        "_decl_contract.py",
...
def leftover_presentation_category_without_hud(text: str) -> bool:
    return (
        re.search(r'Category="Skyguard\|Presentation"(?!\|HUD)', text) is not None
    )


def leftover_combat_category_without_sortie(text: str) -> bool:
    return (
        re.search(r'Category="Skyguard\|Combat"(?!\|Sortie)', text) is not None
    )


def leftover_banned_record_primary_shot() -> str:
    return "Record" + "Ri" + "fle" + "Shot"


def leftover_banned_record_primary_hit() -> str:
    return "Record" + "Ri" + "fle" + "Hit"


def leftover_banned_record_guided_shot() -> str:
    return "Record" + "Ig" + "la" + "Shot"


def leftover_banned_record_guided_hit() -> str:
    return "Record" + "Ig" + "la" + "Hit"
...
METHOD_SIGNATURE_RE = re.compile(
    r"\bvoid\s+RebindIfNeeded\s*\(\s*\)\s*(?:;|\{)"
)
REBIND_IF_NEEDED_IDENT_RE = re.compile(r"\bRebindIfNeeded\b")
BIND_PRESENTATION_IDENT_RE = re.compile(r"\bBindPresentation\b")
REFRESH_FROM_PRESENTATION_STATE_IDENT_RE = re.compile(
    r"\bRefreshFromPresentationState\b"
)
GET_BOUND_PRESENTATION_IDENT_RE = re.compile(r"\bGetBoundPresentation\b")
LEFTOVER_CLONE_RESOLVED_RE = re.compile(
    r"\bbool\s+AreResolvedProductionLoopRoutesComplete\b"
)
LEFTOVER_SIBLING_INIT_RE = re.compile(
    r"\bvoid\s+InitializeRequiredEntries\b"
)
...
def sibling_uncontracted_decls() -> tuple[str, ...]:
    return (
        ...
        "GetSortieAircraftDamageFraction",
        "FillSortieCombatStats",
        "FillResultCombatStats",
        "CpgSightHud",
        "GetAppliedLookSensitivity",
...
def has_declaration(region: str, declaration: str) -> bool:
    # Fail-closed on authored BlueprintCallable signature
    # `void RebindIfNeeded();`.
    # Accept origin/main trailing-semicolon form and an
    # inline body without locking the body. Do not accept a
    # const qualifier, a bool/float/int32 rename, extra params,
    # leftover unique AreResolvedProductionLoopRoutesComplete /
    # InitializeRequiredEntries / GetResolvedProductionLoopRouteCount,
    # leftover analog IsDestroyed / GetLampInstanceCount,
    # leftover FName WeatherIdentity, leftover TObjectPtr
    # ProductionBank, leftover GlobalVoiceLimit = 24,
    # leftover OpenCockpitWindLoop / EngineIdleLoop, leftover
    # FireRate / RecoilPitch, leftover Boom, leftover
    # VegetationStartCullDistanceCm, or Harbor 40 / 80.
    del declaration
    compact = collapsed(region)
    if METHOD_SIGNATURE_RE.search(compact) is None:
        return False
    if re.search(r"\bvoid\s+RebindIfNeeded\s*\(\s*\)\s*const\b", compact):
        return False
    if re.search(r"\bbool\s+RebindIfNeeded\b", compact):
        return False
    if re.search(r"\bfloat\s+RebindIfNeeded\b", compact):
        return False
    if re.search(r"\bint32\s+RebindIfNeeded\b", compact):
        return False
    if re.search(
        r"\bvoid\s+RebindIfNeeded\s*\(\s*[^)]+\s*\)",
        compact,
        ...
        return False
    if LEFTOVER_CLONE_RESOLVED_RE.search(compact):
        return False
    if LEFTOVER_SIBLING_INIT_RE.search(compact) and METHOD_SIGNATURE_RE.search(compact) is None:
        return False
...
def spec_section(header: str) -> str:
    ...
    look_yaw = re.search(r"\bLookYawLimit\b", section)
    if look_yaw is not None:
        section = section[: look_yaw.start()]
    banned_shot = leftover_banned_record_primary_shot()
    banned = re.search(r"\b" + re.escape(banned_shot) + r"\b", section)
    if banned is not None:
        section = section[: banned.start()]
    if STOP_BEFORE_PRIVATE in section:
        raise AssertionError(
            f"{CLASS_NAME} parse window includes {STOP_BEFORE_PRIVATE}"
        )
...
def attached_ufunction_specifiers(section: str) -> str:
    ...
    while True:
        ...
        if depth == 0 and re.match(
            r"\s*void\s+RebindIfNeeded\b",
            compact[index:],
        ):
            return compact[start : index - 1]
        cursor = cursor + match.start() + 1
    raise AssertionError(
        "UFUNCTION for void RebindIfNeeded "
...
class SortieHudRebindIfNeededDeclContractTests(
    unittest.TestCase
):
    def test_sortie_hud_host_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_identifier(section, "RebindIfNeeded"),
            section,
        )
        self.assertIn("UFUNCTION", section)
        self.assertIn(STOP_BEFORE_PUBLIC, header)
        self.assertNotIn(STOP_BEFORE_PRIVATE, section)
        self.assertTrue(has_identifier(body, "BriefingWidgetClass"), body)
        self.assertFalse(
            has_identifier(section, SIBLING_FIRE_RATE),
            section,
        )
        self.assertTrue(has_identifier(body, "DebriefWidgetClass"), body)
        self.assertFalse(has_identifier(section, SIBLING_LOOK_YAW_LIMIT), section)
        self.assertTrue(has_identifier(body, "BriefingZOrder"), body)
        self.assertFalse(has_identifier(section, SIBLING_BOOM), section)
        self.assertTrue(has_identifier(body, "DebriefZOrder"), body)
        self.assertFalse(
            has_identifier(section, SIBLING_CPG_STATION),
            section,
        )
        self.assertTrue(has_identifier(body, "ActiveBriefingWidget"), body)
        self.assertFalse(has_identifier(section, STOP_BEFORE_SKYLINE_STYLE), section)
        self.assertTrue(has_identifier(body, "ActiveDebriefWidget"), body)
        self.assertFalse(has_identifier(section, "ActiveDebriefWidget"), section)
        ...
        self.assertEqual(CLASS_NAME, "USkyguardSortieHudHostComponent")
        self.assertNotEqual(CLASS_NAME, "ASkyguardGunner")
        self.assertNotEqual(CLASS_NAME, "USkyguardAudioProductionBank")
        self.assertNotEqual(CLASS_NAME, "USkyguardCampaignSubsystem")
        self.assertEqual(HEADER_PATH, "Source/Skyguard52/SkyguardSortieHudHostComponent.h")
    ...
    def test_missing_rebind_if_needed_declaration_fails_closed(
        self,
    ) -> None:
        empty = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn('Skyguard|Apache', LOCKED_UFUNCTION_WRAP)
        self.assertNotIn('Skyguard|Theater', section)
        self.assertNotIn('Skyguard|MissionMap', section)
        self.assertFalse(
            leftover_presentation_category_without_hud(section),
            section,
        )
        self.assertIn('Skyguard|Presentation|HUD', section)
        ...
        self.assertIn("BlueprintCallable", LOCKED_UFUNCTION_WRAP)
        self.assertIn("Category", LOCKED_UFUNCTION_WRAP)
        self.assertIn(
            'Category="Skyguard|Presentation|HUD"',
            LOCKED_UFUNCTION_WRAP,
        )
        self.assertNotIn("BlueprintPure", LOCKED_UFUNCTION_WRAP)
        ...
        self.assertFalse(
            leftover_presentation_category_without_hud(specifiers),
            specifiers,
        )
        self.assertIn('Skyguard|Presentation|HUD', specifiers)
        ...
        self.assertNotEqual(
            specifiers,
            'BlueprintCallable, Category="Skyguard|Presentation"',
        )
        self.assertTrue(has_declaration(section, LOCKED_DECL), section)
    ...
    def test_rebind_if_needed_declaration_matches_origin_main(
        self,
    ) -> None:
        section = spec_section(origin_main_header())
        self.assertEqual(
    ...
    def test_locked_decl_is_not_leftover_clone_weather_identity(self) -> None:
        ...
        self.assertNotEqual(LOCKED_DECL, "void EnsureDefaultEntries();")
        self.assertNotEqual(LOCKED_DECL, "void ResetSortieCombatStats();")
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_BIND)
        self.assertNotEqual(LOCKED_DECL, "void RefreshFromPresentationState();")
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_LOOK_YAW)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_MISSION_ID)
        ...
        self.assertFalse(
            leftover_presentation_category_without_hud(LOCKED_UFUNCTION_WRAP),
            LOCKED_UFUNCTION_WRAP,
        )
        self.assertIn('Skyguard|Presentation|HUD', LOCKED_UFUNCTION_WRAP)
        self.assertNotIn('Skyguard|Combat|Feedback', LOCKED_UFUNCTION_WRAP)
        self.assertNotIn('Skyguard|Combat|Safety', LOCKED_UFUNCTION_WRAP)
        self.assertNotIn(
            'Skyguard|Theater',
            LOCKED_UFUNCTION_WRAP,
        )
        ...
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_ENSURE)
        ...
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_BOUND)
        self.assertNotEqual(LOCKED_DECL, TARGET_WRONG_ACTIVATION)
        ...
        self.assertFalse(has_identifier(LOCKED_DECL, "BindPresentation"))
        self.assertFalse(has_identifier(LOCKED_DECL, "RefreshFromPresentationState"))
        self.assertFalse(has_identifier(LOCKED_DECL, "GetBoundPresentation"))
        self.assertIsNotNone(REBIND_IF_NEEDED_IDENT_RE.search(LOCKED_DECL))
        self.assertIsNone(BIND_PRESENTATION_IDENT_RE.search(LOCKED_DECL))
        self.assertIsNone(
            REFRESH_FROM_PRESENTATION_STATE_IDENT_RE.search(LOCKED_DECL)
        )
        self.assertIsNone(GET_BOUND_PRESENTATION_IDENT_RE.search(LOCKED_DECL))
        self.assertIsNone(BIND_PRESENTATION_IDENT_RE.search("void RebindIfNeeded();"))
        self.assertIsNone(
            REBIND_IF_NEEDED_IDENT_RE.search(
                "void BindPresentation("
                "USkyguardSortiePresentationComponent* InPresentation);"
            )
        )
        self.assertIsNotNone(
            REFRESH_FROM_PRESENTATION_STATE_IDENT_RE.search(TARGET_WRONG_REFRESH)
        )
        self.assertFalse(has_identifier(LOCKED_DECL, "ResetSortieCombatStats"))
        self.assertFalse(has_identifier(LOCKED_DECL, "GetActivationCount"))
        self.assertFalse(has_identifier(LOCKED_DECL, "GetInvertVerticalLook"))
        self.assertFalse(has_identifier(LOCKED_DECL, "CpgSightHud"))
        self.assertNotIn("GetSortieShotsFired", LOCKED_DECL)
        self.assertNotIn("GetSortieHits", LOCKED_DECL)
        self.assertNotIn("GetSortieAircraftDamageFraction", LOCKED_DECL)
        self.assertNotIn("FillSortieCombatStats", LOCKED_DECL)
        self.assertNotIn("FillResultCombatStats", LOCKED_DECL)
        ...
        self.assertNotIn("MinimumSafeSideFireYaw", LOCKED_DECL)
        self.assertNotIn("MaxReleasesPerBay", LOCKED_DECL)
        self.assertNotIn("MinimumCivilianSeparationMeters", LOCKED_DECL)
        self.assertNotIn(leftover_banned_record_primary_shot(), LOCKED_DECL)
        self.assertNotIn(leftover_banned_record_primary_hit(), LOCKED_DECL)
        self.assertNotIn(leftover_banned_record_guided_shot(), LOCKED_DECL)
        self.assertNotIn(leftover_banned_record_guided_hit(), LOCKED_DECL)
    ...
    def test_wrong_default_and_renames_do_not_satisfy(self) -> None:
        ...
        wrongs = (
            ...
            leftover_guided,
            "\tvoid RebindIfNeed();\n",
            "\tint32 RebindIfNeeded = 1;\n",
            "\tFName RebindIfNeeded = NAME_None;\n",
            "\tvoid RebindIfNeeded() = "
            + forty
            + ";\n",
            "\tvoid RebindIfNeeded() = "
    ...
    def test_missing_category_or_blueprint_callable_fails_closed(self) -> None:
        ...
        self.assertFalse(
            leftover_presentation_category_without_hud(origin),
            origin,
        )
        self.assertIn('Skyguard|Presentation|HUD', origin)
        self.assertNotIn('Skyguard|Combat|Feedback', origin)
        self.assertNotIn('Skyguard|Combat|Safety', origin)
        self.assertNotIn('Skyguard|Settings', origin)
        self.assertNotIn('Skyguard|Boss|Encounter', origin)
        ...
        self.assertTrue(
            leftover_combat_category_without_sortie(combat_specs)
        )
        self.assertFalse(
            leftover_presentation_category_without_hud(combat_specs)
        )
        leftover_feedback = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "public:\n"
            f"\t{UFUNCTION_COMBAT_FEEDBACK}\n"
            f"\t{LOCKED_DECL}\n"
            f"{STOP_BEFORE_PRIVATE}\n"
            "};\n"
        )
        feedback_specs = attached_ufunction_specifiers(
        ...
        leftover_safety = (
            ...
            "{\n"
            "public:\n"
            f"\t{UFUNCTION_COMBAT_SAFETY}\n"
            f"\t{LOCKED_DECL}\n"
            f"{STOP_BEFORE_PRIVATE}\n"
            "};\n"
        )
        safety_specs = attached_ufunction_specifiers(
        ...
        self.assertIn('Category="Skyguard|Settings"', settings_specs)
        self.assertNotIn(
            'Category="Skyguard|Presentation|HUD"',
            settings_specs,
        )
        ...
        self.assertNotIn('Skyguard|Settings', origin)
        self.assertNotIn('Skyguard|Boss|Encounter', origin)
        leftover_presentation_bare = (
            f"class SKYGUARD52_API {CLASS_NAME}\n"
            "{\n"
            "public:\n"
            f"\t{UFUNCTION_PRESENTATION_BARE}\n"
            f"\t{LOCKED_DECL}\n"
            f"{STOP_BEFORE_PRIVATE}\n"
            "};\n"
        )
        presentation_bare_specs = attached_ufunction_specifiers(
            spec_section(leftover_presentation_bare)
        )
        self.assertIn(
            'Category="Skyguard|Presentation"',
            presentation_bare_specs,
        )
        self.assertTrue(
            leftover_presentation_category_without_hud(presentation_bare_specs)
        )
        self.assertNotIn(
            'Category="Skyguard|Presentation|HUD"',
            presentation_bare_specs,
        ...
        leftover_briefing = (
            ...
            "{\n"
            "public:\n"
            f"\t{UFUNCTION_BRIEFING}\n"
            f"\t{LOCKED_DECL}\n"
            f"{STOP_BEFORE_PRIVATE}\n"
            "};\n"
        )
        briefing_specs = attached_ufunction_specifiers(
            spec_section(leftover_briefing)
        )
        self.assertIn(
            'Category="Skyguard|Presentation|Briefing"',
            briefing_specs,
        ...
        debrief_specs = attached_ufunction_specifiers(
            spec_section(leftover_debrief)
        )
        self.assertIn(
            'Category="Skyguard|Presentation|Debrief"',
            debrief_specs,
        ...
        vfx_specs = attached_ufunction_specifiers(
            spec_section(leftover_vfx)
        )
        self.assertIn(
            'Category="Skyguard|Environment|VFX"',
            vfx_specs,
        ...
        leftover_validation = (
            ...
            "{\n"
            "public:\n"
            f"\t{UFUNCTION_VALIDATION}\n"
            f"\t{LOCKED_DECL}\n"
            f"{STOP_BEFORE_PRIVATE}\n"
            "};\n"
        )
        validation_specs = attached_ufunction_specifiers(
            spec_section(leftover_validation)
        )
        self.assertIn(
            'Category="Skyguard|Mission01|Environment|Validation"',
            validation_specs,
        ...
        self.assertNotIn('Skyguard|Presentation|Briefing', origin)
        self.assertNotIn('Skyguard|Presentation|Debrief', origin)
        self.assertNotIn('Skyguard|Environment|VFX', origin)
        self.assertNotIn('Skyguard|Mission01|Environment|Validation', origin)
        self.assertFalse(
            leftover_presentation_category_without_hud(origin),
            origin,
        )
    ...
    def test_does_not_claim_sibling_sortie_counters_or_neighbors(
        self,
    ) -> None:
        for sibling in sibling_uncontracted_decls():
            self.assertFalse(has_identifier(LOCKED_DECL, sibling), sibling)
        ...
        self.assertTrue(has_identifier(leaked, "BindPresentation"))
        self.assertFalse(has_identifier(LOCKED_DECL, SIBLING_INITIALIZE_REQUIRED))
        self.assertFalse(has_identifier(LOCKED_DECL, "GetSortieShotsFired"))
        self.assertFalse(has_identifier(LOCKED_DECL, "GetSortieHits"))
        self.assertFalse(has_identifier(LOCKED_DECL, "FillSortieCombatStats"))
        self.assertFalse(has_identifier(LOCKED_DECL, "FillResultCombatStats"))
        self.assertFalse(has_identifier(LOCKED_DECL, "EnsureDefaultEntries"))
        self.assertFalse(has_identifier(LOCKED_DECL, "BindPresentation"))
        self.assertFalse(has_identifier(LOCKED_DECL, "RefreshFromPresentationState"))
        self.assertFalse(has_identifier(LOCKED_DECL, "GetBoundPresentation"))
        self.assertFalse(has_identifier(LOCKED_DECL, "ResetSortieCombatStats"))
        self.assertFalse(has_identifier(LOCKED_DECL, "GetActivationCount"))
        self.assertTrue(has_identifier(section, "BindPresentation"))
        self.assertTrue(has_identifier(section, "RebindIfNeeded"))
        self.assertTrue(has_identifier(section, "GetBoundPresentation"))
        self.assertTrue(has_identifier(section, "RefreshFromPresentationState"))
        ...
        self.assertTrue(has_identifier(leaked, "BriefingWidgetClass"))
        self.assertFalse(has_identifier(section, SIBLING_FIRE_RATE))
        self.assertTrue(has_identifier(leaked, "DebriefWidgetClass"))
        self.assertFalse(has_identifier(section, SIBLING_LOOK_YAW_LIMIT))
        self.assertTrue(has_identifier(leaked, "BriefingZOrder"))
        self.assertFalse(has_identifier(section, SIBLING_BOOM))
        self.assertTrue(has_identifier(leaked, "DebriefZOrder"))
        self.assertFalse(has_identifier(section, SIBLING_CPG_STATION))
    ...
    def test_does_not_parse_private_or_neighbors(self) -> None:
        ...
        self.assertNotIn(STOP_BEFORE_PRIVATE, section)
        self.assertTrue(
            has_identifier(leaked, "RebindIfNeeded")
        )
        self.assertTrue(
            has_identifier(section, "RebindIfNeeded")
        )
        ...
        self.assertTrue(has_identifier(leaked, "BriefingWidgetClass"))
        self.assertFalse(has_identifier(section, SIBLING_FIRE_RATE))
        self.assertTrue(has_identifier(leaked, "ActiveDebriefWidget"))
        self.assertFalse(has_identifier(section, "ActiveDebriefWidget"))
        self.assertTrue(has_identifier(leaked, "ActiveBriefingWidget"))
        self.assertFalse(has_identifier(section, "ActiveBriefingWidget"))
    ...
    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        ...
        self.assertNotEqual(LOCKED_UFUNCTION_WRAP, UFUNCTION_COMBAT)
        self.assertNotEqual(LOCKED_UFUNCTION_WRAP, UFUNCTION_COMBAT_CALLABLE)
        self.assertNotEqual(LOCKED_UFUNCTION_WRAP, UFUNCTION_COMBAT_FEEDBACK)
        self.assertNotEqual(LOCKED_UFUNCTION_WRAP, UFUNCTION_COMBAT_SAFETY)
        self.assertNotEqual(LOCKED_UFUNCTION_WRAP, UFUNCTION_SETTINGS)
        self.assertNotEqual(LOCKED_UFUNCTION_WRAP, UFUNCTION_BOSS_ENCOUNTER)
        self.assertNotEqual(LOCKED_UFUNCTION_WRAP, UFUNCTION_PRESENTATION_BARE)
        self.assertNotEqual(LOCKED_UFUNCTION_WRAP, UFUNCTION_BRIEFING)
        self.assertNotEqual(LOCKED_UFUNCTION_WRAP, UFUNCTION_DEBRIEF)
        self.assertNotEqual(LOCKED_UFUNCTION_WRAP, UFUNCTION_ENV_VFX)
        self.assertNotEqual(LOCKED_UFUNCTION_WRAP, UFUNCTION_VALIDATION)
        self.assertNotEqual(LOCKED_UFUNCTION_WRAP, UFUNCTION_PAUSE)
        self.assertNotIn(
            'Category="Skyguard|Presentation|Briefing"',
            LOCKED_UFUNCTION_WRAP,
        )
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertNotEqual(
            THIS_SCRIPT,
            "Scripts/tests/test_fill_result_combat_stats_decl_contract.py",
        )
        self.assertNotEqual(
            THIS_SCRIPT,
        ...
        self.assertNotEqual(THIS_SCRIPT, LEFTOVER_THEATER_LAMP_COUNT)
        self.assertNotEqual(THIS_SCRIPT, LEFTOVER_THEATER_WEATHER_IDENTITY)
        self.assertNotEqual(THIS_SCRIPT, LEFTOVER_GUNNER_BOOM)
        self.assertNotEqual(THIS_SCRIPT, LEFTOVER_GUNNER_LOOK_YAW_LIMIT)
        self.assertNotEqual(THIS_SCRIPT, LEFTOVER_GUNNER_TRACE_RANGE)
        self.assertNotEqual(
            THIS_SCRIPT,
    ...
    def test_contract_is_target_method_declaration_only(self) -> None:
        ...
        self.assertFalse(has_identifier(locked_only, "BindPresentation"))
        self.assertFalse(has_identifier(locked_only, "RefreshFromPresentationState"))
        self.assertFalse(has_identifier(locked_only, "GetBoundPresentation"))
        self.assertFalse(has_identifier(locked_only, "ResetSortieCombatStats"))
        self.assertFalse(has_identifier(locked_only, "GetActivationCount"))
        self.assertFalse(has_identifier(locked_only, "GetInvertVerticalLook"))
        self.assertFalse(has_identifier(locked_only, "CpgSightHud"))
        self.assertNotIn("GetSortieShotsFired", locked_only)
        self.assertNotIn("GetSortieHits", locked_only)
        self.assertNotIn("GetSortieAircraftDamageFraction", locked_only)
        self.assertNotIn("FillSortieCombatStats", locked_only)
        self.assertNotIn("FillResultCombatStats", locked_only)
        self.assertNotIn("GetAppliedLookSensitivity", locked_only)
        self.assertNotIn("FireCameraShakeClass", locked_only)
        self.assertNotIn("MinimumSafeSideFireYaw", locked_only)
        self.assertNotIn("MaxReleasesPerBay", locked_only)
        self.assertNotIn("MinimumCivilianSeparationMeters", locked_only)
        self.assertNotIn(leftover_banned_record_primary_shot(), locked_only)
        self.assertNotIn(leftover_banned_record_guided_shot(), locked_only)
