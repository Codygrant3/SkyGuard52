...
# Mission04 IntegrationReadiness bWavesReady
...
# This is NOT leftover Mission02 bWavesReady #865.
# This is NOT leftover Mission03 bWavesReady #899.
# This is NOT leftover Mission10 bPhaseWavesReady #817.
# This is NOT leftover Mission04 Readiness #926.
# This is NOT leftover Mission02/03/04 wave-state
# enum contracts or leftover Mission04 GetWaveState.
LOCKED = {
...
class Mission04WavesReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 bWavesReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 bWavesReady contains "
