...
# FSkyguardPayloadWindowRuntime, leftover enum
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission06 AirfieldTargetRuntime
# Target. THIS IS NOT leftover airfield-target
# enum #222/#14d2. THIS IS NOT leftover
# airfield-target-runtime-defaults #217/#6ad8.
...
# Mission06 director Root / readiness drafts. THIS IS
...
# Mission06 AirfieldTargetRuntime Target
...
# Parse FSkyguardAirfieldTargetRuntime only.
...
class Mission06AirfieldTargetRuntimeTargetFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 ProtectedTargetRuntime Target field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission07 ProtectedTargetRuntime Target contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_airfield_target_runtime"
                "_target_field_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_parse_director_class_or_storm_runtime(
        ...
        self.assertTrue(
            has_declaration(public_section(airfield_only), LOCKED_DECL),
            airfield_only,
        )
        payload_only = (
            "struct FSkyguardPayloadWindowRuntime\n"
