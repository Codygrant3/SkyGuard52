...
# INDEX_NONE or lock ProductionLandscape construction
# in the .cpp. This is a FIELD contract on
# ASkyguardMission01EnvironmentDirector. Keep
# ProductionLandscape distinct from leftover
...
# bAutoLaunchAfterBriefing. Keep ProductionLandscape
...
# (#585), BeachTiles (#586), LandTiles,
# RouteExclusion, LandScatterBounds (in-flight
# sibling), InlandVegetationPCG (in-flight sibling
# this wave), AuthoredPCGGraph, leftover
# bLicensedVegetationLibraryApproved, leftover
# bProductionLandscapeBound. Do not lock leftover
...
# defaults, leftover GetReadiness. Do not lock leftover
# spawn-location fields. Do not lock leftover
...
# invent one. Do not lock the preceding comment
# block as the declaration. Nearby origin/main
...
# Category is Skyguard|Mission01|Environment|Landscape,
...
# leftover theater-kit #59, leftover #107–#586, plus
# SkyguardMission01EnvironmentDirector production
# files. This lane only adds an isolated Python
# ProductionLandscape field declaration contract on
...
# (#568/#572/#574–#586), leftover briefing-widget
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission01EnvironmentDirector::ProductionLandscape",
    "SkyguardMission01EnvironmentDirector.cpp",
...
class Mission01ProductionLandscapeFieldDeclContractTests(unittest.TestCase):
    def test_mission01_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, PRODUCTION_LANDSCAPE_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, PRODUCTION_LANDSCAPE_FIELD)
        self.assertIn("ProductionLandscape", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(has_declaration(section, PRODUCTION_LANDSCAPE_FIELD))

    def test_missing_production_landscape_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission01EnvironmentDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{OCEAN_TILES_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, PRODUCTION_LANDSCAPE_FIELD)
        self.assertIn("ProductionLandscape", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))

    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        macro_only = f"\t{UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, PRODUCTION_LANDSCAPE_FIELD)
        self.assertIn("ProductionLandscape", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE, section)
        ...
        self.assertNotIn("UPROPERTY", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("EditInstanceOnly", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("BlueprintReadWrite", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("VisibleAnywhere", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("BlueprintReadOnly", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("Category", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("BlueprintPure", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertNotIn("BlueprintCallable", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertIn(
            "Skyguard|Mission01|Environment|Landscape",
            UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE,
        )
        self.assertIn("Landscape", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertIn("EditInstanceOnly", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertIn("BlueprintReadWrite", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertNotEqual(
            UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE,
            UPROPERTY_MISSION01_ENVIRONMENT,
        )
        ...
        self.assertNotIn("PCG", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertNotIn("EditAnywhere", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertNotIn("VisibleAnywhere", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertNotIn("BlueprintReadOnly", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertNotIn("Mission02", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertNotIn("Boss", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertNotIn("Destruction", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertNotIn("Apache", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertNotIn("Mission07", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertNotIn("Mission10", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertNotIn("Encounter", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertNotIn("Safety", UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertNotEqual(
            UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE,
            UPROPERTY_INTEGRATION,
        )
        self.assertNotIn(UPROPERTY_INTEGRATION, UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
        self.assertNotIn(
            'Category="Skyguard|Mission01")',
            UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE,
        )
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE)
            self.assertNotIn(invented, PRODUCTION_LANDSCAPE_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, PRODUCTION_LANDSCAPE_FIELD)
        self.assertIn("ProductionLandscape", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tALandscapeProxy* ProductionLandscape;\n"
        )
        as_array = (
            "\tTArray<TObjectPtr<"
            "ALandscapeProxy>> "
        ...
        scene = "\tTObjectPtr<USceneComponent> ProductionLandscape;\n"
        static_mesh = "\tTObjectPtr<UStaticMeshComponent> ProductionLandscape;\n"
        instanced = (
            "\tTObjectPtr<UInstancedStaticMeshComponent> ProductionLandscape;\n"
        )
        weak = (
        ...
        assigned = (
            "\tTObjectPtr<ALandscapeProxy> "
            "ProductionLandscape = nullptr;\n"
        )
        soft = (
            "\tTSoftObjectPtr<ALandscapeProxy> "
            "ProductionLandscape;\n"
        )
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, PRODUCTION_LANDSCAPE_FIELD)
            self.assertIn("ProductionLandscape", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_production_landscape_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, PRODUCTION_LANDSCAPE_FIELD),
            PRODUCTION_LANDSCAPE_FIELD,
        )
        self.assertTrue(has_declaration(section, PRODUCTION_LANDSCAPE_FIELD))
        self.assertEqual(
            declaration_count(section, PRODUCTION_LANDSCAPE_FIELD),
            1,
        )
        self.assertTrue(
            PRODUCTION_LANDSCAPE_FIELD.startswith(
                "TObjectPtr<ALandscapeProxy> "
            ),
            PRODUCTION_LANDSCAPE_FIELD,
        )
        self.assertTrue(PRODUCTION_LANDSCAPE_FIELD.endswith(";"), PRODUCTION_LANDSCAPE_FIELD)
        self.assertIn("ProductionLandscape", PRODUCTION_LANDSCAPE_FIELD)
        self.assertIn(
            "ALandscapeProxy",
            PRODUCTION_LANDSCAPE_FIELD,
        )
        self.assertIn("TObjectPtr<", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("TArray<", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("TSoftObjectPtr", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("=", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("nullptr", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("INDEX_NONE", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("UFUNCTION", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("{", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("}", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("return ", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("OceanTiles", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("LandTiles", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("RouteExclusion", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("IsRouteExclusionSafe", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("bRouteExclusionValid", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("BeachTiles", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("InlandVegetationPCG", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("LandScatterBounds", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("AuthoredPCGGraph", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn(
            "bLicensedVegetationLibraryApproved",
            PRODUCTION_LANDSCAPE_FIELD,
        )
        ...
        self.assertNotIn("Root", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("GetReadiness", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("Briefing", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("AudioDirector", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("RadioChatter", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("SortiePresentation", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("CampaignDefinition", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("MissionDefinition", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("bAllowBoundedActorSpawning", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("bAutoInitialize", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("bAutoLaunchAfterBriefing", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("PathfinderSpawnLocation", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("GetAircraft", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("ConfigureFromMission", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("AdvanceBriefing", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("SetAssetsReady", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("AcknowledgeAndLaunch", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("CanLaunch", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("GetElapsedSeconds", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("GetBriefingState", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("GetMinimumWarmupSeconds", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("GetBriefingText", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("GetRadioChatter", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("GetPresentation", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("GetMissionTitle", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("AcknowledgeBriefing", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("LaunchSortie", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("HullCollider", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("OpticalTracker", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("WeaponServo", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("CountermeasurePod", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("RadarNode", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("ESkyguardMission02WaveState", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("HarborIndustrial", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("MaxIntegrity", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("CurrentIntegrity", PRODUCTION_LANDSCAPE_FIELD)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, PRODUCTION_LANDSCAPE_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty = (
            "public:\n"
            f"\t{UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE}\n"
            f"\t{PRODUCTION_LANDSCAPE_FIELD}\n"
            "};\n"
        )
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE} {PRODUCTION_LANDSCAPE_FIELD}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{PRODUCTION_LANDSCAPE_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, PRODUCTION_LANDSCAPE_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, PRODUCTION_LANDSCAPE_FIELD),
            section,
    ...
    def test_assigned_production_landscape_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<ALandscapeProxy> "
            "ProductionLandscape = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, PRODUCTION_LANDSCAPE_FIELD)
        self.assertIn("ProductionLandscape", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, PRODUCTION_LANDSCAPE_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("ProductionLandscape", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, PRODUCTION_LANDSCAPE_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{PRODUCTION_LANDSCAPE_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, PRODUCTION_LANDSCAPE_FIELD)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            PRODUCTION_LANDSCAPE_FIELD.startswith("UFUNCTION"),
            PRODUCTION_LANDSCAPE_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", PRODUCTION_LANDSCAPE_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_production_landscape_cpp_body(self) -> None:
        locked_only = f"{PRODUCTION_LANDSCAPE_FIELD}\n"
        self.assertNotIn("{", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("}", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("return ", PRODUCTION_LANDSCAPE_FIELD)
        ...
        self.assertNotIn("return false", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("return true", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("CreateDefaultSubobject", PRODUCTION_LANDSCAPE_FIELD)
    ...
    def test_contract_does_not_relock_sibling_environment_fields(self) -> None:
        ...
        for token in SIBLING_ENVIRONMENT_FIELDS_NOT_LOCKED:
            ...
            self.assertNotIn(token, PRODUCTION_LANDSCAPE_FIELD)
        self.assertIn("ProductionLandscape", PRODUCTION_LANDSCAPE_FIELD)
        self.assertTrue(
            PRODUCTION_LANDSCAPE_FIELD.startswith(
                "TObjectPtr<ALandscapeProxy> "
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, PRODUCTION_LANDSCAPE_FIELD)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_relock_leftover_get_readiness(self) -> None:
        ...
        self.assertNotIn(GET_READINESS, PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn(GET_READINESS_DECL, locked_only)
        self.assertNotIn(GET_READINESS_DECL, PRODUCTION_LANDSCAPE_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("CurrentIntegrity", PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", PRODUCTION_LANDSCAPE_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, PRODUCTION_LANDSCAPE_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", PRODUCTION_LANDSCAPE_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{PRODUCTION_LANDSCAPE_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, PRODUCTION_LANDSCAPE_FIELD),
            PRODUCTION_LANDSCAPE_FIELD,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, PRODUCTION_LANDSCAPE_FIELD)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertEqual(declaration_count(section, PRODUCTION_LANDSCAPE_FIELD), 1)
        self.assertNotIn(
            "SkyguardMission01EnvironmentDirector.cpp",
            section,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 ProductionLandscape field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{PRODUCTION_LANDSCAPE_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, PRODUCTION_LANDSCAPE_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                PRODUCTION_LANDSCAPE_FIELD.lower(),
                "mission01 ProductionLandscape contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live cop" + "y",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, PRODUCTION_LANDSCAPE_FIELD)

    def test_contract_is_production_landscape_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertIn("ProductionLandscape", PRODUCTION_LANDSCAPE_FIELD)
        self.assertTrue(PRODUCTION_LANDSCAPE_FIELD.endswith(";"))
        self.assertNotIn("=", PRODUCTION_LANDSCAPE_FIELD)
        self.assertIn(UPROPERTY_MISSION01_ENVIRONMENT_LANDSCAPE, section)

    def test_sibling_environment_fields_do_not_satisfy_production_landscape(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, PRODUCTION_LANDSCAPE_FIELD))
            self.assertNotEqual(PRODUCTION_LANDSCAPE_FIELD, leftover)
        self.assertIn(
            "Scripts/tests/test_mission01_ocean_tiles"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
    ...
    def test_sibling_director_fields_do_not_satisfy_production_landscape(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_preceding_comment_block_is_not_the_declaration(self) -> None:
        comment_only = (
            "\t/**\n"
            "\t * The imported production Landscape for Mission 1. "
            "It must carry\n"
            "\t * Skyguard.Environment.Mission01.Landscape and contain "
            "registered Landscape\n"
            "\t * components before the PCG component can activate.\n"
            "\t */\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(comment_only, PRODUCTION_LANDSCAPE_FIELD)
        self.assertIn("ProductionLandscape", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(
            has_declaration(comment_only, PRODUCTION_LANDSCAPE_FIELD)
        )
        self.assertNotIn("TObjectPtr<ALandscapeProxy>", comment_only)
