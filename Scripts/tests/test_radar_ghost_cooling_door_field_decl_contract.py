...
# INDEX_NONE or lock CoolingDoor construction
...
# RadarGhost sibling fields. Keep CoolingDoor
# distinct from DebrisCoolingDoor. This is not a
...
# CoolingDoor;`); accept that form and other
...
# isolated-test drafts #107–#533 including
...
# leftover isolated-test drafts #107–#533,
# leftover searchlight-track-runtime-defaults
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardRadarGhostBoss::CoolingDoor",
    "SkyguardRadarGhostBoss.cpp",
    "SetExposed",
...
class RadarGhostCoolingDoorFieldDeclContractTests(unittest.TestCase):
    def test_radar_ghost_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, COOLING_DOOR_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, COOLING_DOOR_FIELD)
        self.assertIn("CoolingDoor", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, COOLING_DOOR_FIELD)
    ...
    def test_missing_cooling_door_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardRadarGhostBoss();\n"
            f"\t{SIGNATURE_MODULATOR_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, COOLING_DOOR_FIELD)
        self.assertIn("CoolingDoor", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, COOLING_DOOR_FIELD)
        self.assertIn("CoolingDoor", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UPROPERTY", COOLING_DOOR_FIELD)
        self.assertNotIn("VisibleAnywhere", COOLING_DOOR_FIELD)
        self.assertNotIn("BlueprintReadOnly", COOLING_DOOR_FIELD)
        self.assertNotIn("Category", COOLING_DOOR_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, COOLING_DOOR_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, COOLING_DOOR_FIELD)
        self.assertIn("CoolingDoor", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUSkyguardBossWeakPointComponent* CoolingDoor;\n"
        )
        as_array = (
        ...
        scene = (
            "\tTObjectPtr<USceneComponent> CoolingDoor;\n"
        )
        mesh = (
            "\tTObjectPtr<UStaticMeshComponent> CoolingDoor;\n"
        )
        weak = (
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, COOLING_DOOR_FIELD)
            self.assertIn("CoolingDoor", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_cooling_door_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, COOLING_DOOR_FIELD),
            COOLING_DOOR_FIELD,
        )
        self.assertTrue(has_declaration(section, COOLING_DOOR_FIELD))
        self.assertEqual(declaration_count(section, COOLING_DOOR_FIELD), 1)
        self.assertTrue(
            COOLING_DOOR_FIELD.startswith(
                "TObjectPtr<USkyguardBossWeakPointComponent> "
            ),
            COOLING_DOOR_FIELD,
        )
        self.assertTrue(COOLING_DOOR_FIELD.endswith(";"), COOLING_DOOR_FIELD)
        self.assertIn("CoolingDoor", COOLING_DOOR_FIELD)
        self.assertNotIn("DebrisCoolingDoor", COOLING_DOOR_FIELD)
        self.assertNotIn("SignatureModulator", COOLING_DOOR_FIELD)
        self.assertNotIn("RadarReceiver", COOLING_DOOR_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            COOLING_DOOR_FIELD,
        )
        self.assertIn("TObjectPtr<", COOLING_DOOR_FIELD)
        self.assertNotIn("TArray<", COOLING_DOOR_FIELD)
        self.assertNotIn("=", COOLING_DOOR_FIELD)
        self.assertNotIn("INDEX_NONE", COOLING_DOOR_FIELD)
        self.assertNotIn("UFUNCTION", COOLING_DOOR_FIELD)
        self.assertNotIn("{", COOLING_DOOR_FIELD)
        self.assertNotIn("}", COOLING_DOOR_FIELD)
        self.assertNotIn("return ", COOLING_DOOR_FIELD)
        self.assertNotIn("CommandAntenna", COOLING_DOOR_FIELD)
        self.assertNotIn("ControlLinkage", COOLING_DOOR_FIELD)
        self.assertNotIn("NoseCamera", COOLING_DOOR_FIELD)
        self.assertNotIn("DebrisCenter", COOLING_DOOR_FIELD)
        self.assertNotIn("DebrisTail", COOLING_DOOR_FIELD)
        self.assertNotIn("DebrisNose", COOLING_DOOR_FIELD)
        self.assertNotIn("DebrisSpine", COOLING_DOOR_FIELD)
        self.assertNotIn("AdvanceEncounter", COOLING_DOOR_FIELD)
        self.assertNotIn("ResetEncounterState", COOLING_DOOR_FIELD)
        self.assertNotIn("IsRouteStateSafe", COOLING_DOOR_FIELD)
        self.assertNotIn("GetRouteProgress", COOLING_DOOR_FIELD)
        self.assertNotIn("GetEffectiveSpeedMultiplier", COOLING_DOOR_FIELD)
        self.assertNotIn("IsAttackTelegraphActive", COOLING_DOOR_FIELD)
        self.assertNotIn("GetTelegraphsTriggered", COOLING_DOOR_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", COOLING_DOOR_FIELD)
        self.assertNotIn("RadarNode", COOLING_DOOR_FIELD)
        self.assertNotIn("BeginTerminalStrikeCycle", COOLING_DOOR_FIELD)
        self.assertNotIn("OpenGuidanceArrayExposure", COOLING_DOOR_FIELD)
        self.assertNotIn("IssueClimbCommand", COOLING_DOOR_FIELD)
        self.assertNotIn("DivertWreckFromCivilians", COOLING_DOOR_FIELD)
        self.assertNotIn("SetCivilianSeparationMeters", COOLING_DOOR_FIELD)
        self.assertNotIn("GetCivilianSeparationMeters", COOLING_DOOR_FIELD)
        self.assertNotIn("GetFinaleStage", COOLING_DOOR_FIELD)
        self.assertNotIn("IsClimbCommandIssued", COOLING_DOOR_FIELD)
        self.assertNotIn("IsWreckDiverted", COOLING_DOOR_FIELD)
        self.assertNotIn("GetObjectiveMilestonesReached", COOLING_DOOR_FIELD)
        self.assertNotIn("ESkyguardLastFlightStage", COOLING_DOOR_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", COOLING_DOOR_FIELD)
        self.assertNotIn("GetGunnerMount", COOLING_DOOR_FIELD)
        self.assertNotIn("FaceWorldLocation", COOLING_DOOR_FIELD)
        self.assertNotIn("PortGuidanceArray", COOLING_DOOR_FIELD)
        self.assertNotIn("DebrisArmorPort", COOLING_DOOR_FIELD)
        self.assertNotIn("SetSearchlightTracked", COOLING_DOOR_FIELD)
        self.assertNotIn("SetContactIdentified", COOLING_DOOR_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", COOLING_DOOR_FIELD)
        self.assertNotIn("SetLightningExposed", COOLING_DOOR_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", COOLING_DOOR_FIELD)
        self.assertNotIn("HullCollider", COOLING_DOOR_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, COOLING_DOOR_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_PORT} {COOLING_DOOR_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(
                declaration_count(section, COOLING_DOOR_FIELD),
                1,
            )
        one_line = f"{{\npublic:\n\t{COOLING_DOOR_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, COOLING_DOOR_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, COOLING_DOOR_FIELD),
            section,
    ...
    def test_assigned_cooling_door_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<USkyguardBossWeakPointComponent> "
            "CoolingDoor = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, COOLING_DOOR_FIELD)
        self.assertIn("CoolingDoor", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, COOLING_DOOR_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("CoolingDoor", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, COOLING_DOOR_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{COOLING_DOOR_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, COOLING_DOOR_FIELD)
        ...
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_PORT, section)
        self.assertTrue(has_declaration(section, COOLING_DOOR_FIELD), section)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            COOLING_DOOR_FIELD.startswith("UFUNCTION"),
            COOLING_DOOR_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, COOLING_DOOR_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", COOLING_DOOR_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_cooling_door_cpp_body(self) -> None:
        locked_only = f"{COOLING_DOOR_FIELD}\n"
        self.assertNotIn("{", COOLING_DOOR_FIELD)
        self.assertNotIn("}", COOLING_DOOR_FIELD)
        self.assertNotIn("return ", COOLING_DOOR_FIELD)
        ...
        self.assertNotIn("SkyguardRadarGhostBoss.cpp", COOLING_DOOR_FIELD)
        self.assertNotIn("SkyguardRadarGhostBoss.cpp", locked_only)
        self.assertNotIn("return false", COOLING_DOOR_FIELD)
        self.assertNotIn("return true", COOLING_DOOR_FIELD)
        self.assertNotIn("CreateDefaultSubobject", COOLING_DOOR_FIELD)
        self.assertNotIn("SetExposed", COOLING_DOOR_FIELD)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            COOLING_DOOR_FIELD,
        )
        self.assertNotIn("SetBossPhase", COOLING_DOOR_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", COOLING_DOOR_FIELD)

    def test_contract_does_not_relock_sibling_tempest_fields(self) -> None:
        locked_only = f"{COOLING_DOOR_FIELD}\n"
        for token in SIBLING_TEMPEST_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COOLING_DOOR_FIELD)
        self.assertNotIn("PortDischargeBoom", COOLING_DOOR_FIELD)
        self.assertNotIn("StarboardDischargeBoom", COOLING_DOOR_FIELD)
        self.assertNotIn("EngineIntake", COOLING_DOOR_FIELD)
        self.assertNotIn("DebrisPortPanel", COOLING_DOOR_FIELD)
        self.assertNotIn("DebrisStarboardPanel", COOLING_DOOR_FIELD)
        self.assertNotIn("DebrisIntakePanel", COOLING_DOOR_FIELD)
        self.assertNotIn("RequiredLockStabilitySeconds", COOLING_DOOR_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            COOLING_DOOR_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_encounter_controller(
        ...
        for token in LEFTOVER_ENCOUNTER_CONTROLLER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COOLING_DOOR_FIELD)
        self.assertNotIn("EncounterController", COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_control_servo(self) -> None:
        ...
        for token in LEFTOVER_CONTROL_SERVO_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COOLING_DOOR_FIELD)
        self.assertNotIn("ControlServo", COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_sibling_iron_rain_fields(self) -> None:
        ...
        for token in SIBLING_IRON_RAIN_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COOLING_DOOR_FIELD)
        self.assertNotIn("DispenserCenter", COOLING_DOOR_FIELD)
        self.assertNotIn("MaxReleasesPerBay", COOLING_DOOR_FIELD)
        self.assertIn("CoolingDoor", COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost_methods(
        ...
        for token in LEFTOVER_RADAR_GHOST_METHODS_NOT_LOCKED:
            ...
            self.assertNotIn(token, COOLING_DOOR_FIELD)
        self.assertNotIn("SetContactIdentified", COOLING_DOOR_FIELD)
        self.assertNotIn("OpenOrbitExposure", COOLING_DOOR_FIELD)
        self.assertNotIn("IsContactIdentified", COOLING_DOOR_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", COOLING_DOOR_FIELD)
        self.assertNotIn(leftover_open_rear_aspect_window(), COOLING_DOOR_FIELD)

    def test_debris_cooling_door_does_not_satisfy_cooling_door(self) -> None:
        leftover = f"\t{DEBRIS_COOLING_DOOR_FIELD}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover, COOLING_DOOR_FIELD)
        self.assertIn("CoolingDoor", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover, COOLING_DOOR_FIELD))
    ...
    def test_contract_does_not_relock_leftover_dispenser_starboard(
        ...
        for token in LEFTOVER_DISPENSER_STARBOARD_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COOLING_DOOR_FIELD)
        self.assertNotIn("DispenserStarboard", COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_get_maneuver(self) -> None:
        ...
        for token in LEFTOVER_GET_MANEUVER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COOLING_DOOR_FIELD)
        self.assertNotIn("GetManeuver", COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_open_first_window(), COOLING_DOOR_FIELD)
        self.assertNotIn(leftover_open_final_window(), locked_only)
        self.assertNotIn(leftover_open_final_window(), COOLING_DOOR_FIELD)
        self.assertNotIn(leftover_arm_command_core_path(), locked_only)
        self.assertNotIn(leftover_arm_command_core_path(), COOLING_DOOR_FIELD)
        self.assertNotIn(leftover_apply_strike(), locked_only)
        self.assertNotIn(leftover_apply_strike(), COOLING_DOOR_FIELD)
        self.assertNotIn(leftover_is_lock_eligible(), locked_only)
        self.assertNotIn(leftover_is_lock_eligible(), COOLING_DOOR_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, locked_only)
            self.assertNotIn(name, COOLING_DOOR_FIELD)
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_debris_getters(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COOLING_DOOR_FIELD)
        self.assertNotIn("GetDefeatDebrisPieceCount", COOLING_DOOR_FIELD)
        self.assertNotIn("GetMaxDefeatDebrisPieces", COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, COOLING_DOOR_FIELD)
        self.assertNotIn("SetSearchlightTracked", COOLING_DOOR_FIELD)
        self.assertNotIn("ASkyguardBlackKiteBoss", COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_lifeline_hunter(self) -> None:
        ...
        for token in LEFTOVER_LIFELINE_HUNTER_NOT_LOCKED:
            ...
            self.assertNotIn(token, COOLING_DOOR_FIELD)
        self.assertNotIn("SetFriendlySeparationMeters", COOLING_DOOR_FIELD)
        self.assertNotIn("ASkyguardLifelineHunterBoss", COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest_methods(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, COOLING_DOOR_FIELD)
        self.assertNotIn("SetLightningExposed", COOLING_DOOR_FIELD)
        self.assertNotIn("ApplyCorrectiveBankGust", COOLING_DOOR_FIELD)
        self.assertNotIn("IsLightningExposed", COOLING_DOOR_FIELD)
        self.assertNotIn("GetLockStabilitySeconds", COOLING_DOOR_FIELD)
        self.assertNotIn(leftover_advance_stabilized_lock(), COOLING_DOOR_FIELD)
        self.assertNotIn(leftover_arm_break_finish(), COOLING_DOOR_FIELD)
        self.assertNotIn(leftover_is_break_finish_armed(), COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        for token in LEFTOVER_PATROL_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COOLING_DOOR_FIELD)
        self.assertNotIn("ASkyguardPatrolShip", COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        ...
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            ...
            self.assertNotIn(neighbor, COOLING_DOOR_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COOLING_DOOR_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COOLING_DOOR_FIELD)
        self.assertNotIn("ASkyguardGunner", COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, COOLING_DOOR_FIELD)
        self.assertNotIn("SkyguardRadarNode", COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, COOLING_DOOR_FIELD)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            ...
            self.assertNotIn(token, COOLING_DOOR_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", COOLING_DOOR_FIELD)
        self.assertNotIn("MaxIntegrity", COOLING_DOOR_FIELD)
        self.assertNotIn("CurrentIntegrity", COOLING_DOOR_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", COOLING_DOOR_FIELD)
        self.assertNotIn(
            "SkyguardPathfinderEncounterController.h",
            COOLING_DOOR_FIELD,
        )
    ...
    def test_contract_does_not_open_leftover_weak_point_component_header(
        ...
        self.assertNotIn(leftover_header, COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, COOLING_DOOR_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", COOLING_DOOR_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{COOLING_DOOR_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, COOLING_DOOR_FIELD),
            COOLING_DOOR_FIELD,
        )
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardRadarGhostBoss::CoolingDoor", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "radar ghost CoolingDoor field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{COOLING_DOOR_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, COOLING_DOOR_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                COOLING_DOOR_FIELD.lower(),
                "radar ghost CoolingDoor contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, COOLING_DOOR_FIELD)

    def test_contract_is_cooling_door_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertTrue(COOLING_DOOR_FIELD.endswith(";"))
        self.assertNotIn("=", COOLING_DOOR_FIELD)
        self.assertIn(UPROPERTY_PORT, section)
