...
# int32 default 0) on
# ASkyguardMission07IntegrationDirector. Note
...
# leftover Mission06 / leftover Mission08-10 directors.
# Category is Skyguard|Mission07|Campaign, not
...
UPROPERTY_MISSION07_CLAMP = 'meta=(ClampMin="0")'
...
class Mission07CampaignSaveUserIndexFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn("Campaign", UPROPERTY_MISSION07)
        self.assertIn("Skyguard|Mission07|Campaign", UPROPERTY_MISSION07)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_campaign_save_user_index_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
