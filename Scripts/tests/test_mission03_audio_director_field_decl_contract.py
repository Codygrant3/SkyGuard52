...
# Mission03 Integration AudioDirector
# FIELD (declaration-only, split-line) on
# ASkyguardMission03IntegrationDirector. It is
# NOT leftover Mission02 AudioDirector field #847 /
# branch cursor/mission02-audio-director-field-
# decl-contract-c332, NOT leftover Mission10
# AudioDirector field #794 / branch
# cursor/mission10-audio-director-field-
# decl-contract-c332, NOT leftover Mission01
# AudioDirector field #572, NOT leftover Mission04-
# Mission09 same-name AudioDirector field contracts,
# NOT leftover Mission03 Root #875 / leftover
# Mission03 ConvoyRuntimeAnchor #876 / leftover
# Mission03 Briefing sibling, NOT leftover
# production-audio-* defaults, NOT leftover
# radio-line-defaults #1dec,
# NOT leftover Mission10 Briefing field #795 /
# branch cursor/mission10-briefing-field-decl-
# contract-c332, NOT leftover Mission02 Root field,
# NOT leftover Mission02 Briefing field, NOT leftover
# Mission10 bBriefingReady #819, NOT leftover Mission02
# UFUNCTION siblings #828-#843, NOT leftover
...
# methods.
# not leftover Root / Briefing / HighwayConvoyAnchor /
...
# private, or Mission01 / Mission02 / Mission04-10 directors.
# Category is Skyguard|Mission03, not leftover Mission10, not
# Evacuation, not Integration, not leftover Mission01, not leftover
# Mission03 convoy methods, not leftover Mission03 Root #875,
# not leftover Mission03 ConvoyRuntimeAnchor #876, not leftover
# Mission03 Briefing sibling, not leftover Mission03 wave-state
# enum #0242, not leftover convoy-route-state enum #d34e, not leftover
# Mission10 / Mission04 /
...
# drafts #674–#876, leftover Apache
...
class Mission03AudioDirectorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tUSkyguardAudioDirectorComponent* AudioDirector;\n"
        )
        as_const = (
            "\tconst TObjectPtr<USkyguardAudioDirectorComponent>& "
            "AudioDirector;\n"
        )
        with_arg = (
            "\tTArray<TObjectPtr<USkyguardAudioDirectorComponent>> "
            "AudioDirector;\n"
        )
        renamed = (
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 AudioDirector field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission03 AudioDirector field contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_audio_director(
        ...
        self.assertIn(
            "Scripts/tests/test_mission06_audio_director"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission07_audio_director"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission03_audio_director_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission02_audio_director_does_not_satisfy(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_production_audio_entry_defaults"
            "_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
