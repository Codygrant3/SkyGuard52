...
# Mission10 Integration ConfigureMissionDefinition
# METHOD on ASkyguardMission10IntegrationDirector.
# It is NOT leftover Mission09
...
# Mission09 InitializePlayableMission #751, NOT leftover
# Mission08 InitializePlayableMission #729, NOT leftover
...
class Mission10ConfigureMissionDefinitionDeclContractTests(unittest.TestCase):
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission10 ConfigureMissionDefinition contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_configure_mission_definition"
                "_decl_contract.py"
            )
        )
        self.assertIn(
