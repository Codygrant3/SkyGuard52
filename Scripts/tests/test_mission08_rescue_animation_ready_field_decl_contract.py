...
# INDEX_NONE or lock bRescueAnimationReady
# construction in the .cpp. This is leftover-safe
# Mission08 IntegrationReadiness bRescueAnimationReady
...
RESCUE_ANIMATION_READY = (
    "bool bRescueAnimationReady = false;"
)
RESCUE_ANIMATION_READY_TRUE = (
    "bool bRescueAnimationReady = true;"
)
LOCKED_DECL = RESCUE_ANIMATION_READY
...
# an isolated Python bRescueAnimationReady
...
class Mission08RescueAnimationReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bRescueAnimationReady", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_rescue_animation_ready_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bRescueAnimationReady"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bRescueAnimationReady", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bRescueAnimationReady", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bRescueAnimationReady"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bRescueAnimationReady", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 bRescueAnimationReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 bRescueAnimationReady contains "
    ...
    def test_contract_is_rescue_animation_ready_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission08_rescue"
            "_animation_ready_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_rescue"
                "_animation_ready_field_decl_contract.py"
            )
        )
        self.assertIn(
