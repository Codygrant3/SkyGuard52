...
# Mission10 Integration GetObjectiveRuntime
...
# drafts #674–#775+, leftover Apache
...
class Mission10GetObjectiveRuntimeDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 GetObjectiveRuntime method contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_get_objective_runtime"
                "_decl_contract.py"
            )
        )
        self.assertIn(
