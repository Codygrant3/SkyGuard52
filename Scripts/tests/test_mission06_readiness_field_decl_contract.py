...
# Mission06 DIRECTOR CLASS Readiness FIELD
...
class Mission06ReadinessFieldDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("Skyguard|Mission05|Protection", UPROPERTY_MISSION06)
    ...
    def test_readiness_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FSkyguardMission06IntegrationReadiness "),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("Readiness", LOCKED_DECL)
        self.assertIn("FSkyguardMission06IntegrationReadiness", LOCKED_DECL)
    ...
    def test_contract_is_readiness_field_declaration_only(
        ...
        self.assertNotIn("return ", LOCKED_DECL)
        self.assertNotIn("{", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FSkyguardMission06IntegrationReadiness"))
        self.assertIn("Readiness", LOCKED_DECL)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_readiness_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_same_name_readiness_contracts_stay_locked(self) -> None:
        ...
        self.assertNotIn("EditAnywhere", UPROPERTY_MISSION06)
        self.assertNotIn("BlueprintReadWrite", UPROPERTY_MISSION06)
        self.assertIn("VisibleAnywhere", UPROPERTY_MISSION06)
        self.assertIn("BlueprintReadOnly", UPROPERTY_MISSION06)
    ...
    def test_contract_does_not_parse_readiness_struct(self) -> None:
        ...
        self.assertIsNone(
            re.search(
                r"class\s+(?:SKYGUARD52_API\s+)?"
                r"FSkyguardMission06IntegrationReadiness\b",
                header,
            )
        )
        self.assertIn(
