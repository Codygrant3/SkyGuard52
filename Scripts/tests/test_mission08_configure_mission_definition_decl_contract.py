...
# Mission08 Integration ConfigureMissionDefinition
# METHOD on ASkyguardMission08IntegrationDirector.
# It is NOT leftover Mission07
# ConfigureMissionDefinition, NOT leftover
...
class Mission08ConfigureMissionDefinitionDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_configure_mission_definition"
                "_decl_contract.py"
            )
        )
        self.assertIn(
