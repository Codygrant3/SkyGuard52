...
CLASS_NAME = "FSkyguardMission10ProtectedRuntime"
# Declaration presence only. Do not invent
# INDEX_NONE or lock Integrity
# construction in the .cpp. This is leftover-safe
# Mission10 ProtectedRuntime Integrity FIELD
# (int32 = 100). It is NOT leftover
# bPhaseWavesReady #817, NOT leftover
# StartPhaseWave #771, NOT leftover
# GetRemainingThreatsInWave #779, NOT leftover
# Mission10 Readiness #809, NOT leftover
# Mission01 Readiness #579, NOT leftover
# GetReadiness #776, NOT leftover
# retired-mount runtime-ready sibling field,
# NOT leftover Mission10 route-phase
# enum #701a, NOT leftover ObjectiveCount
# or ProtectedGroupCount siblings, NOT leftover
# Mission10 MaximumProtectedIntegrity field #808,
# NOT leftover Mission10 protected-group enum
# #6f9d Group field, NOT leftover Mission10
# protected-runtime-defaults #7898, NOT leftover
# GetProtectedGroup #782, NOT leftover
# NotifyProtectedGroupDamage #774, NOT leftover
# WaveCount sibling field.
# (VisibleAnywhere / BlueprintReadOnly,
# declaration-only, one-line / split-line
# UPROPERTY wraps, = 100 default) on
# FSkyguardMission10ProtectedRuntime. It is
...
# AudioDirector field #572 / branch cursor/
# mission01-audio-director-field-decl-contract-
# c332, NOT leftover Mission10 Readiness field
# #809 / branch cursor/mission10-readiness-
# field-decl-contract-c332, NOT leftover
# Mission01 Readiness field #579 / branch
# cursor/mission01-readiness-field-decl-
# contract-c332, NOT leftover Mission10
# GetReadiness method #776 / branch
# cursor/mission10-get-readiness-decl-
# contract-c332, NOT leftover retired-mount
# runtime-ready sibling readiness field,
# NOT leftover Mission10 briefing-ready field /
# branch cursor/mission10-briefing-ready-field-
# decl-contract-c332. This is leftover-safe
# Mission10 Integrity FIELD
# (VisibleAnywhere / BlueprintReadOnly,
# declaration-only, one-line / split-line
# UPROPERTY wraps, = 100 default) on
# FSkyguardMission10ProtectedRuntime. It is
...
# field #568 / branch cursor/mission01-briefing-
# field-decl-contract-c332, NOT leftover
# Mission10 evacuation-presentation-ready field /
# branch cursor/mission10-evacuation-presentation-
# ready-field-decl-contract-c332, NOT leftover
# Mission10 phase-waves-ready field / branch
# cursor/mission10-phase-waves-ready-field-decl-
# contract-c332, NOT leftover Mission10
# SortiePresentation
# field #797 / branch cursor/mission10-sortie-
# presentation-field-decl-contract-c332, NOT leftover
# Mission01 SortiePresentation field #575 / branch
# cursor/mission01-sortie-presentation-field-
# decl-contract-c332, NOT leftover Mission10
# last-flight-ready field / branch cursor/
# mission10-last-flight-ready-field-decl-
# contract-c332, NOT leftover Mission10
# EvacuationShipAnchor field #793 / branch
# cursor/mission10-evacuation-ship-anchor-
# field-decl-contract-c332, NOT leftover retired-
# mount runtime-ready sibling readiness field,
# NOT leftover Mission10 LastFlightSpawnLocation
# field #805 / branch cursor/mission10-last-
# flight-spawn-location-field-decl-contract-c332,
# NOT leftover Mission10 LastFlightSpawnRotation
# field #806 / branch cursor/mission10-last-
# flight-spawn-rotation-field-decl-contract-c332,
# NOT leftover Mission10 Readiness field on the
# director #809 / branch cursor/mission10-
# readiness-field-decl-contract-c332, NOT leftover
# Mission10 bMapAssemblyReady field / branch
# cursor/mission10-map-assembly-ready-field-
...
# the origin/main `= 100` default, and nearby
# split-line UPROPERTY wraps without locking a
# different body or invented metadata.
# Nearby origin/main
# UPROPERTY(VisibleAnywhere, BlueprintReadOnly)
# is required as present (no Category on this
# struct field). Accept one-line and
# split-line UPROPERTY wraps. Parse the public
# struct section of
# FSkyguardMission10ProtectedRuntime only,
# not ASkyguardMission10IntegrationDirector,
# not FSkyguardMission10IntegrationReadiness.
# This UPROPERTY has no Category, not
...
# drafts #674-#819+, leftover Apache
...
# an isolated Python Integrity
# field declaration contract on
# FSkyguardMission10ProtectedRuntime.
# Lock leftover bPhaseWavesReady #817,
# leftover StartPhaseWave #771, leftover
# GetRemainingThreatsInWave #779. Do not reopen leftover
# Mission10 AudioDirector #794, leftover Mission01 AudioDirector #572,
# leftover Mission10 Briefing #795, leftover Mission01 Briefing #568,
# leftover Mission10 SortiePresentation #797, leftover
# Mission10 CampaignDefinition #798, leftover Mission10
# MissionDefinition #799, leftover Mission01 Root #574,
# leftover environment-root #592, leftover
# Mission10 Readiness #809, leftover Mission01
# Readiness #579, leftover GetReadiness #776, leftover
# Mission10 enum/defaults #701a / #6f9d / #7898, leftover
# Mission10 MaximumProtectedIntegrity #808, leftover
# Mission10 Group field (uses leftover enum #6f9d), leftover
# drafts #56-#64, leftover #536-#673, leftover #664, or
# leftover open drafts #674-#819+.
LOCKED = {
...
SIBLING_STRUCT_FIELDS_NOT_LOCKED = (
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission10IntegrationDirector::Readiness",
    "SkyguardMission10IntegrationDirector.cpp",
...
def public_section(header: str) -> str:
    ...
    if public is None:
        first_access = ACCESS_RE.search(body)
        if first_access is not None and first_access.group(1) != "public":
            raise AssertionError(
                f"{CLASS_NAME} public section is missing from "
                f"origin/main:{HEADER_PATH}"
            )
        generated = re.search(r"GENERATED_BODY\s*\(\s*\)", body)
        start = generated.end() if generated is not None else 1
        rest = body[start:]
...
class Mission10ProtectedRuntimeIntegrityFieldDeclContractTests(unittest.TestCase):
    def test_mission10_struct_exists(self) -> None:
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("ProtectedRuntime", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn('Category="Skyguard|Mission10"', UPROPERTY_MISSION10)
        self.assertTrue(
            has_declaration(section, LOCKED_DECL),
            section,
        )
    ...
    def test_integrity_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 Integrity"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("Integrity", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("Integrity", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 Integrity field contract "
    ...
    def test_contract_is_integrity_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertNotIn("return ", LOCKED_DECL)
        self.assertNotIn("{", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 Integrity"))
        self.assertIn("Integrity", LOCKED_DECL)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission10_protected_runtime_integrity_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_protected_runtime_integrity_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission10_map_assembly_ready_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_last_flight_ready_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_gunner_ready_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission10_phase_waves_ready_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_evacuation_presentation_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission10_wave_count_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_protected_group_count_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission10_campaign_definition_valid"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_mission_definition_valid"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_phase_waves_ready_field_does_not_satisfy(self) -> None:
        leftover = "\tbool bPhaseWavesReady = false;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_leftover_start_phase_wave_does_not_satisfy(self) -> None:
        leftover = f"\t{START_PHASE_WAVE}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover, LOCKED_DECL)
        self.assertIn("ProtectedRuntime", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_leftover_get_remaining_threats_in_wave_does_not_satisfy(
        self,
    ) -> None:
        leftover = f"\t{GET_REMAINING_THREATS_IN_WAVE}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover, LOCKED_DECL)
        self.assertIn("ProtectedRuntime", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_leftover_sibling_count_fields_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("ProtectedGroupCount", LOCKED_DECL)
        self.assertNotIn("MaximumProtectedIntegrity", LOCKED_DECL)
        self.assertNotIn("bDestroyed", LOCKED_DECL)
        self.assertNotIn("Group", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 Integrity"))
        self.assertIn("= 100", LOCKED_DECL)
        self.assertIn(
