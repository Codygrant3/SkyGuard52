...
# drafts #674-#1080 including leftover Mission03
...
# Mission08 ObjectiveCount #1080. Lock leftover
...
class Mission09RootFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_root_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_root_declaration_matches_origin_main(self) -> None:
        ...
        self.assertIn("Root", LOCKED_DECL)
