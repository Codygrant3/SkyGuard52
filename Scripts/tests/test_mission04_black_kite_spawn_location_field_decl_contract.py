...
LOCKED_DECL = BLACK_KITE_SPAWN_LOCATION
...
# an isolated Python BlackKiteSpawnLocation
...
class Mission04BlackKiteSpawnLocationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("BlackKiteSpawnLocation", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_black_kite_spawn_location_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_black_kite_spawn_location_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FVector BlackKiteSpawnLocation"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("BlackKiteSpawnLocation", LOCKED_DECL)
        self.assertIn("= FVector(69000.f, -11000.f, 5200.f)", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tFVector\n"
            "\tBlackKiteSpawnLocation = FVector(69000.f, -11000.f, 5200.f);\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("BlackKiteSpawnLocation", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FVector BlackKiteSpawnLocation"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("BlackKiteSpawnLocation", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 BlackKiteSpawnLocation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 BlackKiteSpawnLocation contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_black_kite_spawn_location(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        self.assertNotIn("return false", LOCKED_DECL)
        self.assertNotIn("return true", LOCKED_DECL)
        self.assertIn("69000.f", LOCKED_DECL)
        self.assertIn("-11000.f", LOCKED_DECL)
        self.assertIn("5200.f", LOCKED_DECL)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_black_kite_spawn_location_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
