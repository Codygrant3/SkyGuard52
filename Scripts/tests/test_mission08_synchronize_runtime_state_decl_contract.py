...
# Mission08 Integration SynchronizeRuntimeState
# METHOD on ASkyguardMission08IntegrationDirector.
# It is NOT leftover Mission07
# SynchronizeRuntimeState #714, NOT leftover
# Mission05 SynchronizeRuntimeState, NOT leftover
# Mission06 SynchronizeRuntimeState #695, NOT leftover
# Mission01 / Mission03 / Mission04
# SynchronizeRuntimeState, NOT leftover
...
# leftover Mission03 SynchronizeRuntimeState,
# leftover Mission04 SynchronizeRuntimeState,
# leftover Mission05 SynchronizeRuntimeState,
# leftover Mission06 SynchronizeRuntimeState
# #695, leftover Mission07 SynchronizeRuntimeState
# #714, leftover Mission07 ConfigureMissionDefinition,
...
# not leftover Mission07 Integration #714, not leftover
...
# #658–#673. Do not reopen open drafts #674–#735.
...
LOCKED_DECL = SYNCHRONIZE_RUNTIME_STATE
...
# leftover Mission06 SynchronizeRuntimeState #695,
# leftover Mission04 SynchronizeRuntimeState,
# leftover Mission06 InitializePlayableMission, leftover
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission08IntegrationDirector::SynchronizeRuntimeState",
    "SkyguardMission08IntegrationDirector.cpp",
    "ASkyguardMission07IntegrationDirector::SynchronizeRuntimeState",
...
class Mission08SynchronizeRuntimeStateDeclContractTests(unittest.TestCase):
    ...
    def test_synchronize_declaration_matches_origin_main(self) -> None:
        ...
        self.assertIn("SynchronizeRuntimeState", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("SynchronizeRuntimeState", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("void "))
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 ConfigureMissionDefinition method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 ConfigureMissionDefinition contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_synchronize_runtime_state"
                "_decl_contract.py"
            )
        )
        self.assertIn(
