...
# THIS file is leftover-safe Mission03
...
# AudioDirector field #877 / branch
# cursor/mission03-audio-director-field-
# decl-contract-c332, NOT leftover
# GetReadiness(), NOT leftover retired-
# mount runtime-ready struct field
...
# Mission03 IntegrationReadiness bAudioReady
...
class Mission03AudioReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 bAudioReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission03 bAudioReady contains "
