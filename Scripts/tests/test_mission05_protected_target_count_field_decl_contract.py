...
CLASS_NAME = "FSkyguardMission05IntegrationReadiness"
STRUCT_NAME = CLASS_NAME
# Declaration presence only. Do not invent
# INDEX_NONE or lock ProtectedTargetCount
# construction in the .cpp. This is leftover-safe
# Mission05 IntegrationReadiness ProtectedTargetCount
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 default 0,
# one-line / split-line UPROPERTY wraps) on
# FSkyguardMission05IntegrationReadiness. It is
# NOT leftover retired-mount spawn location /
# spawn rotation / runtime-ready struct field,
# NOT leftover Mission02
# bGunnerReady FIELD #864 / branch cursor/mission02-
...
# gunner-ready-field-decl-contract-c332,
# NOT leftover Mission02 ObjectiveCount
# FIELD #873 / branch cursor/mission02-
# objective-count-field-decl-contract-c332,
# NOT leftover Mission03 ObjectiveCount
# FIELD #905 / branch cursor/mission03-
# objective-count-field-decl-contract-c332,
# NOT leftover Mission04 ObjectiveCount
# FIELD #939 / branch cursor/mission04-
# objective-count-field-decl-contract-c332,
# NOT leftover Mission10 ObjectiveCount
# FIELD #823 / branch cursor/mission10-
# objective-count-field-decl-contract-c332,
# NOT leftover Mission05 bObjectivesReady
# FIELD #968 / branch cursor/mission05-
# objectives-ready-field-decl-contract-c332,
# NOT leftover Mission05 bGunnerReady
# sibling / branch cursor/mission05-
# gunner-ready-field-decl-contract-c332,
...
# sibling / branch cursor/mission05-
# map-assembly-ready-field-decl-contract-c332,
# NOT leftover Mission05 Readiness director field
# #960 / branch cursor/mission05-readiness-
# field-decl-contract-c332,
# NOT leftover Mission05 director field drafts
# Root #947 through Readiness #960 /
# MaximumProtectedTargetIntegrity #961 /
# TempestSpawnRotation #962,
# NOT leftover Mission05 closed-without-merge
# #665 #666 #668 #669 #670 #671 #672 #673,
# NOT leftover Mission05 wave-state enum #ad28 /
...
# mission-definition-valid-field-decl-contract-c332,
# NOT leftover Mission02 CampaignDefinition
# UPROPERTY #850 / branch cursor/mission02-
# campaign-definition-field-decl-contract-c332,
# NOT leftover Mission03 director CampaignDefinition
# TSoftObjectPtr #881 / branch cursor/mission03-
# campaign-definition-field-decl-contract-c332,
# NOT leftover Mission03 Readiness director field
# / branch cursor/mission03-readiness-field-
# decl-contract-c332, NOT leftover Mission03
# GetReadiness(), NOT leftover Mission03
# bMissionDefinitionValid sibling,
...
# struct section of
# FSkyguardMission05IntegrationReadiness only
# (not ASkyguardMission05IntegrationDirector,
# not FSkyguardStormRuntime, not leftover
# FSkyguardMission04IntegrationReadiness, not leftover
# FSkyguardSearchlightTrackRuntime, not leftover
# FSkyguardMission02IntegrationReadiness, not leftover
# FSkyguardMission03IntegrationReadiness, not leftover
# director CampaignDefinition TSoftObjectPtr, not leftover
# GetReadiness(), not leftover Mission02/03/04/10
# readiness structs, not leftover Mission05 Readiness
# director field #960, not leftover Mission04
# bMapAssemblyReady FIELD #928, not leftover
# Mission03 bMissionDefinitionValid sibling, not leftover
# retired-mount runtime-ready struct field).
...
# drafts #674-#926 including leftover Mission02
# methods #828-#844, Root #845 through
# MaximumFuelTerminalIntegrity #859 / Readiness /
# bMissionDefinitionValid if opened, leftover Mission10
...
# the Mission04IntegrationDirector public section,
# and the locked FSkyguardMission05IntegrationReadiness
# public section. Pathfinder MinHeightFromOriginCm
...
# Mission02 siblings #828-#859. Do not reopen leftover
...
MAP_ASSEMBLY_READY_FIELD = (
    "bool bMapAssemblyReady = false;"
)
GUNNER_READY_FIELD = (
    "bool bGunnerReady = false;"
)
GUNNER_READY_FIELD_TRUE = (
    "bool bGunnerReady = true;"
)
OBJECTIVE_COUNT = (
...
PROTECTED_TARGET_COUNT_FIELD = (
    "int32 ProtectedTargetCount = 0;"
)
PROTECTED_TARGET_COUNT_ONE = (
    "int32 ProtectedTargetCount = 1;"
)
LOCKED_DECL = PROTECTED_TARGET_COUNT_FIELD
...
# an isolated Python ProtectedTargetCount
# field declaration contract on
# FSkyguardMission05IntegrationReadiness.
# SKIP leftover retired-mount runtime-ready forever.
# Sibling Mission05 readiness-struct drafts
# bMissionDefinitionValid / bCampaignDefinitionValid /
# bMapAssemblyReady / bGunnerReady / bTempestReady /
# bObjectivesReady / bWavesReady / bStormRuntimeReady /
# bProtectedTargetsReady / ObjectiveCount / WaveCount
# stay leftover-only.
# THIS IS NOT leftover Mission10 ProtectedGroupCount
# #825 / branch cursor/mission10-protected-group-count-
# field-decl-contract-c332, NOT leftover Mission10
# bProtectedGroupsReady #818, NOT leftover Mission05
# bProtectedTargetsReady #970 / branch cursor/mission05-
# protected-targets-ready-field-decl-contract-c332,
# NOT leftover Mission05 protected-target enum #aaa2 /
# leftover protected-target-runtime-defaults #ec8b,
# NOT leftover Mission04 bSubstationReady #934,
# NOT leftover Mission05 ObjectiveCount sibling / branch
# cursor/mission05-objective-count-field-decl-
# contract-c332, NOT leftover Mission02 ObjectiveCount
# #873, Mission03 ObjectiveCount #905, Mission04
# ObjectiveCount #939, or Mission10 ObjectiveCount #823.
LOCKED = {
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission01_campaign_definition_valid_field_decl_contract.py",
...
MAP_ASSEMBLY_READY_FIELD_TRUE = (
    "bool bMapAssemblyReady = true;"
)
...
LEFTOVER_MISSION03_DIRECTOR_CAMPAIGN_DEFINITION_NOT_LOCKED = (
    "test_mission03_campaign_definition_field_decl_contract.py",
    "cursor/mission03-campaign-definition-field-decl-contract-c332",
    CAMPAIGN_DEFINITION_FIELD,
    "TSoftObjectPtr<USkyguardCampaignDefinition>",
)
...
LEFTOVER_MISSION05_SIBLING_FIELDS_NOT_LOCKED = (
    ...
    "test_mission05_tempest_ready_field_decl_contract.py",
    "test_mission05_objectives_ready_field_decl_contract.py",
    "test_mission05_waves_ready_field_decl_contract.py",
    "test_mission05_storm_runtime_ready_field_decl_contract.py",
    ...
    "test_mission05_objective_count_field_decl_contract.py",
    "bMissionDefinitionValid",
    "bCampaignDefinitionValid",
    "bMapAssemblyReady",
    "bGunnerReady",
...
LEFTOVER_MISSION05_PROTECTED_TARGET_NOT_LOCKED_STRUCT = (
...
LEFTOVER_MISSION02_OBJECTIVE_COUNT_NOT_LOCKED = (
    "test_mission02_objective_count_field_decl_contract.py",
    "cursor/mission02-objective-count-field-decl-contract-c332",
)
LEFTOVER_MISSION03_OBJECTIVE_COUNT_NOT_LOCKED = (
    "test_mission03_objective_count_field_decl_contract.py",
    "cursor/mission03-objective-count-field-decl-contract-c332",
)
LEFTOVER_MISSION04_OBJECTIVE_COUNT_NOT_LOCKED = (
    "test_mission04_objective_count_field_decl_contract.py",
    "cursor/mission04-objective-count-field-decl-contract-c332",
)
LEFTOVER_MISSION10_OBJECTIVE_COUNT_NOT_LOCKED = (
    "test_mission10_objective_count_field_decl_contract.py",
    "cursor/mission10-objective-count-field-decl-contract-c332",
)
LEFTOVER_SAME_NAME_OBJECTIVE_COUNT_NOT_LOCKED = (
    "test_mission01_objective_count_field_decl_contract.py",
    "test_mission02_objective_count_field_decl_contract.py",
    "test_mission03_objective_count_field_decl_contract.py",
    "test_mission04_objective_count_field_decl_contract.py",
    "test_mission06_objective_count_field_decl_contract.py",
    "test_mission07_objective_count_field_decl_contract.py",
    "test_mission08_objective_count_field_decl_contract.py",
    "test_mission09_objective_count_field_decl_contract.py",
    "test_mission10_objective_count_field_decl_contract.py",
)
...
LEFTOVER_MISSION05_OBJECTIVES_READY_NOT_LOCKED = (
    "test_mission05_objectives_ready_field_decl_contract.py",
    "cursor/mission05-objectives-ready-field-decl-contract-c332",
    "bObjectivesReady",
)

LEFTOVER_MISSION05_OBJECTIVE_COUNT_NOT_LOCKED = (
    "test_mission05_objective_count_field_decl_contract.py",
    "cursor/mission05-objective-count-field-decl-contract-c332",
    "ObjectiveCount",
)
LEFTOVER_MISSION10_PROTECTED_GROUP_COUNT_NOT_LOCKED = (
    "test_mission10_protected_group_count_field_decl_contract.py",
    "cursor/mission10-protected-group-count-field-decl-contract-c332",
    "ProtectedGroupCount",
)
...
SIBLING_TYPES = (
    ...
    "ASkyguardMission02IntegrationDirector",
    "ASkyguardMission03IntegrationDirector",
    "FSkyguardMission02IntegrationReadiness",
...
class Mission05ProtectedTargetCountFieldDeclContractTests(unittest.TestCase):
    def test_mission05_struct_exists(self) -> None:
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("ProtectedTargetCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_protected_target_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_protected_target_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 ProtectedTargetCount"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= 0;"), LOCKED_DECL)
        self.assertIn("ProtectedTargetCount", LOCKED_DECL)
        ...
        self.assertNotIn("WaveCount", LOCKED_DECL)
        self.assertNotIn("ObjectiveCount", LOCKED_DECL)
        self.assertNotIn("bObjectivesReady", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        for header in (
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertTrue(
                has_declaration(section, PROTECTED_TARGET_COUNT_ONE),
                section,
            )
        one_line = f"{{\npublic:\n\t{LOCKED_DECL}\n}}\n"
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("ProtectedTargetCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 ProtectedTargetCount"))
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        # This Mission05 ProtectedTargetCount default 0 is not Harbor 40/80.
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 ProtectedTargetCount field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 ProtectedTargetCount contains "
    ...
    def test_contract_is_protected_target_count_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_protected_target_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission05_protected_target_count"
            "_field_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_protected_target_count"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_campaign_definition"
            "_valid_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_campaign_definition"
            "_valid_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_contract_does_not_parse_director_class(self) -> None:
        header = origin_main_header()
        director_only = (
    ...
    def test_contract_does_not_parse_storm_runtime(self) -> None:
        ...
        self.assertIsNotNone(CLASS_RE.search(header))
    ...
    def test_leftover_mission05_sibling_field_drafts_stay_locked(self) -> None:
        ...
        for leftover in LEFTOVER_MISSION05_WAVE_STATE_ENUM_NOT_LOCKED:
            if leftover.endswith(".py"):
                ...
                self.assertNotIn(leftover, LOCKED_DECL)
        for leftover in LEFTOVER_MISSION05_PROTECTED_TARGET_NOT_LOCKED_STRUCT:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
            elif leftover.startswith("cursor/"):
                continue
                ...
                self.assertNotIn(leftover, LOCKED_DECL)
        for leftover in LEFTOVER_MISSION05_READINESS_FIELD_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
            elif leftover.startswith("cursor/"):
                continue
    ...
    def test_leftover_same_name_objective_count_contracts_stay_locked(
        self,
    ) -> None:
        for leftover in LEFTOVER_SAME_NAME_OBJECTIVE_COUNT_NOT_LOCKED:
            self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_SAME_NAME_GUNNER_READY_NOT_LOCKED:
            self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        self.assertIn(
            "Scripts/tests/test_mission05_objective_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertNotIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_objective_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission02_objective_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission03_objective_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_objective_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_objectives_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        for leftover in LEFTOVER_MISSION04_OBJECTIVE_COUNT_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION05_GUNNER_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_MISSION05_MAP_ASSEMBLY_READY_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
    ...
    def test_sibling_count_fields_do_not_satisfy_protected_target_count(self) -> None:
        leftover_wave = "\tint32 WaveCount = 0;\n"
        leftover_objective = "\tint32 ObjectiveCount = 0;\n"
        leftover_radio = "\tint32 RadioLineCount = 0;\n"
        leftover_bool = "\tbool bObjectivesReady = false;\n"
        leftover_briefing = "\tbool bBriefingReady = false;\n"
        leftover_gunner = "\tbool bGunnerReady = false;\n"
        leftover_m10 = (
        ...
        leftover_wrong_default = "\tint32 ProtectedTargetCount = 1;\n"
        leftover_untyped = "\tProtectedTargetCount = 0;\n"
        leftover_as_bool = "\tbool ProtectedTargetCount = false;\n"
        leftover_runtime = (
            "\tUSkyguardObjectiveRuntime* GetObjectiveRuntime() const;\n"
        )
        leftover_readiness = (
        ...
        leftover_wave_enum = "\tESkyguardMission05WaveState WaveState;\n"
        leftover_runtime_ready = (
            "\tbool b" + "Ya" + "kRuntimeReady = false;\n"
        )
        leftover_storm = "\tFSkyguardStormRuntime StormRuntime;\n"
        leftover_director = (
            "class SKYGUARD52_API ASkyguardMission05IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        for region in (
            ...
            self.assertFalse(has_declaration(region, LOCKED_DECL))
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover_m10)
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover_m02)
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover_m03)
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover_m04)
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        with self.assertRaises(AssertionError) as raised:
            class_body(leftover_director)
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertTrue(LOCKED_DECL.startswith("int32 ProtectedTargetCount"))
        self.assertTrue(LOCKED_DECL.endswith("= 0;"))
        self.assertNotIn("WaveCount", LOCKED_DECL)
        self.assertNotIn("ObjectiveCount", LOCKED_DECL)
        self.assertNotIn("ProtectedGroupCount", LOCKED_DECL)
        self.assertNotIn("RadioLineCount", LOCKED_DECL)
        self.assertNotIn("bObjectivesReady", LOCKED_DECL)
        self.assertNotIn("bBriefingReady", LOCKED_DECL)
        self.assertNotIn("bGunnerReady", LOCKED_DECL)
        self.assertNotIn("GetObjectiveRuntime", LOCKED_DECL)
        self.assertNotIn("GetReadiness", LOCKED_DECL)
        self.assertNotIn("ESkyguardMission05WaveState", LOCKED_DECL)
        self.assertNotIn("FSkyguardStormRuntime", LOCKED_DECL)
        self.assertNotIn("bool ", LOCKED_DECL)
        self.assertNotIn("= false", LOCKED_DECL)
