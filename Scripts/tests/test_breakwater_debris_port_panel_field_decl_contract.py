...
# INDEX_NONE or lock DebrisPortPanel construction
...
# DebrisPortPanel distinct from leftover Tempest
# DebrisPortPanel (PR leftover, different class
...
# Primary lock is Breakwater DebrisPortPanel.
# Leftover Tempest DebrisPortPanel uses the same
...
# Tempest DebrisPortPanel; class ASkyguardBreakwaterBoss
# keeps this isolated.
...
# DebrisPortPanel field declaration contract on
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardBreakwaterBoss::DebrisPortPanel",
    "SkyguardBreakwaterBoss.cpp",
    "SetExposed",
...
class BreakwaterDebrisPortPanelFieldDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUStaticMeshComponent* DebrisPortPanel;\n"
        )
        as_array = (
        ...
        scene = (
            "\tTObjectPtr<USceneComponent> DebrisPortPanel;\n"
        )
        mesh = (
            "\tTObjectPtr<USkyguardBossWeakPointComponent> "
            "DebrisPortPanel;\n"
    ...
    def test_debris_port_panel_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("DebrisCenter", DEBRIS_PORT_PANEL_FIELD)
        ...
        self.assertNotIn("RadarNode", DEBRIS_PORT_PANEL_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        for header in (
            ...
            self.assertEqual(
                declaration_count(section, DEBRIS_PORT_PANEL_FIELD),
                1,
            )
        one_line = f"{{\npublic:\n\t{DEBRIS_PORT_PANEL_FIELD}\n}}\n"
    ...
    def test_contract_does_not_lock_debris_port_panel_cpp_body(self) -> None:
        ...
        self.assertNotIn("SkyguardBreakwaterBoss.cpp", DEBRIS_PORT_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_debris_port_panel(self) -> None:
        ...
        self.assertNotIn("ASkyguardTempestBoss", DEBRIS_PORT_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_sibling_iron_rain_fields(self) -> None:
        ...
        for token in SIBLING_IRON_RAIN_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("DispenserCenter", DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("MaxReleasesPerBay", DEBRIS_PORT_PANEL_FIELD)
        self.assertIn("DebrisPortPanel", DEBRIS_PORT_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_dispenser_starboard(
        ...
        for token in LEFTOVER_DISPENSER_STARBOARD_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("DispenserStarboard", DEBRIS_PORT_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_get_maneuver(self) -> None:
        ...
        for token in LEFTOVER_GET_MANEUVER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("GetManeuver", DEBRIS_PORT_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_sibling_breakwater_fields(self) -> None:
        ...
        for token in SIBLING_BREAKWATER_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("PortLatch", DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("StarboardLatch", DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("DecoyPods", DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("ElevatorLinkage", DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("DebrisEngine", DEBRIS_PORT_PANEL_FIELD)
        self.assertIn("DebrisPortPanel", DEBRIS_PORT_PANEL_FIELD)
    ...
    def test_breakwater_engine_is_not_radar_ghost_or_pathfinder_engine(
        ...
        locked_only = f"{DEBRIS_PORT_PANEL_FIELD}\n"
        self.assertNotEqual(BREAKWATER_ENGINE_FIELD, DEBRIS_PORT_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_mission02_wave_state(
        ...
        for token in LEFTOVER_MISSION02_WAVE_STATE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("ESkyguardMission02WaveState", DEBRIS_PORT_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_arm_emergency_finish(), DEBRIS_PORT_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        self.assertNotIn("SignatureModulator", DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("ASkyguardRadarGhostBoss", DEBRIS_PORT_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_sibling_radar_ghost_fields(self) -> None:
        ...
        for token in SIBLING_RADAR_GHOST_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("RadarReceiver", DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("CoolingDoor", DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("DebrisPortEWPanel", DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("DebrisStarboardEWPanel", DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("DebrisCoolingDoor", DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("SignatureModulator", DEBRIS_PORT_PANEL_FIELD)
        self.assertIn("DebrisPortPanel", DEBRIS_PORT_PANEL_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest_methods(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("SetLightningExposed", DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("ApplyCorrectiveBankGust", DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("IsLightningExposed", DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn("GetLockStabilitySeconds", DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn(leftover_advance_stabilized_lock(), DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn(leftover_arm_break_finish(), DEBRIS_PORT_PANEL_FIELD)
        self.assertNotIn(leftover_is_break_finish_armed(), DEBRIS_PORT_PANEL_FIELD)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardBreakwaterBoss::DebrisPortPanel", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "breakwater DebrisPortPanel field contract contains "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "breakwater DebrisPortPanel contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
