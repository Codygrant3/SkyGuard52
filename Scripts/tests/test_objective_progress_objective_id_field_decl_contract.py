# THIS IS leftover-safe FSkyguardObjectiveProgress ObjectiveId.
# origin/main form: split-line UPROPERTY(VisibleAnywhere,
# BlueprintReadOnly) then BARE `FName ObjectiveId;` (no initializer,
# no Category=). If a clone asserts an initializer and origin/main
# has a bare decl, accept the bare decl. If a clone asserts Category
# and origin/main has none, drop that assertion.
# THIS IS NOT leftover objective-progress-defaults #182 / #ae90.
# THIS IS NOT leftover AddObjectiveProgress #316.
# THIS IS NOT leftover HowToFlyRow StepId.
# THIS IS NOT leftover objective-runtime-fail-closed.
# Do not parse mission director GetObjectiveRuntime methods.
# LOCK leftover drafts #56-#64, leftover objective-progress-defaults
# #182/#ae90, leftover AddObjectiveProgress #316, leftover
# how-to-fly-row-defaults #191, leftover briefing-card/radio-row
# defaults, leftover AuthoringResult through #1250, leftover
# BriefingCard #1251-#1254, leftover RadioRow #1255-#1257.
# Parse STRUCT public section ONLY after struct
# FSkyguardObjectiveProgress and BEFORE struct FSkyguardMissionResult.
# Do NOT parse FSkyguardMissionResult / FSkyguardMissionDebrief.
# Do NOT parse campaign/mission director methods.
# Harbor 40/80 fail-closed.
# Ban retired live-copy tokens via split tokens
# (b + Ya + kRuntimeReady). Stay Apache CPG 30 mm / Hydra /
# Hellfire.

# THIS IS leftover-safe FSkyguardHowToFlyRow StepId.
# origin/main form: split-line UPROPERTY(VisibleAnywhere,
# BlueprintReadOnly) then BARE `FName ObjectiveId;` (no initializer,
# no Category=). If a clone asserts an initializer and origin/main
# has a bare decl, accept the bare decl. If a clone asserts Category
# and origin/main has none, drop that assertion.
# THIS IS NOT leftover how-to-fly-row-defaults #191 / #9ab2.
# THIS IS NOT leftover briefing-radio-row LineId.
# THIS IS NOT leftover BriefingCard CardId #1252.
# THIS IS NOT leftover briefing-card-defaults #178 / #8c3f.
# THIS IS NOT leftover briefing-radio-row-defaults #190 / #bf8e.
# THIS IS NOT leftover briefing-widget methods #388-#391.
# THIS IS NOT leftover AuthoringResult through #1250.
# THIS IS NOT leftover BriefingCard #1251-#1254.
# Do not contract leftover pictogram values from the enum body.
# Do not contract Pictogram.
# LOCK leftover drafts #56-#64, leftover briefing-card-defaults
# #178/#8c3f, leftover briefing-radio-row-defaults #190/#bf8e,
# leftover how-to-fly-row-defaults #191/#9ab2, leftover
# briefing-widget #388-#391, leftover AuthoringResult through
# #1250, leftover BriefingCard #1251-#1254.
# Declaration-only. Accept origin/main split-line UPROPERTY and
# bare FName ObjectiveId;. Fail closed if type/decl missing, renamed,
# Category= is added, or an initializer appears when origin/main
# is bare.
# Parse STRUCT public section ONLY after struct FSkyguardHowToFlyRow
# and BEFORE DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam.
# Do NOT parse USkyguardSortiePresentationComponent methods.
# Do NOT parse FSkyguardBriefingCard / FSkyguardBriefingRadioRow.
# Do NOT parse leftover pictogram enum body.
# Harbor 40/80 fail-closed.
# Ban retired live-copy tokens via split tokens
# (b + Ya + kRuntimeReady). Stay Apache CPG 30 mm / Hydra /
# Hellfire.

# THIS IS leftover-safe FSkyguardHowToFlyRow LineId.
# origin/main form: split-line UPROPERTY(VisibleAnywhere,
# BlueprintReadOnly) then BARE `FName ObjectiveId;` (no initializer,
# no Category=). If a clone asserts an initializer and origin/main
# has a bare decl, accept the bare decl. If a clone asserts Category
...
# THIS IS NOT leftover how-to-fly-row-defaults #191 / #9ab2.
# THIS IS NOT leftover briefing-widget methods #388-#391.
# THIS IS NOT leftover BriefingCard Priority #1251.
# THIS IS NOT leftover AuthoringResult through #1250.
# Do not contract leftover pictogram values from the enum body.
# Do not contract Pictogram.
# LOCK leftover drafts #56-#64, leftover briefing-card-defaults
...
# leftover how-to-fly-row-defaults #191/#9ab2, leftover
# briefing-widget #388-#391, leftover AuthoringResult through
# #1250, leftover BriefingCard Priority #1251.
# Declaration-only. Accept origin/main split-line UPROPERTY and
# bare FName ObjectiveId;. Fail closed if type/decl missing, renamed,
# Category= is added, or an initializer appears when origin/main
# is bare.
...
# and origin/main has none, drop that assertion.
# THIS IS NOT leftover briefing-card-defaults #178 / #8c3f.
# THIS IS NOT leftover briefing-fail-closed #9fe9.
# THIS IS NOT leftover sortie-presentation-fail-closed #7600.
# THIS IS NOT leftover briefing-widget methods #388-#391.
# THIS IS NOT leftover briefing-radio-row-defaults #190 / #bf8e.
# THIS IS NOT leftover how-to-fly-row-defaults #191 / #9ab2.
# Do not contract ESkyguardBriefingPictogram leftover pictogram values from the enum body.
# LOCK leftover drafts #56-#64, leftover briefing-card-defaults
# #178/#8c3f, leftover briefing-radio-row-defaults #190/#bf8e,
# leftover how-to-fly-row-defaults #191/#9ab2, leftover
# briefing-widget #388-#391, leftover AuthoringResult through
# #1250, leftover MaterialCompilation through Error #1232.
# Declaration-only. Accept origin/main split-line UPROPERTY and
# bare FName ObjectiveId;. Fail closed if type/decl missing, renamed,
# Category= is added, or an initializer appears when origin/main
# is bare.
...
# THIS IS leftover-safe FSkyguardHowToFlyRow
# Error. origin/main form: split-line UPROPERTY(VisibleAnywhere,
# BlueprintReadOnly) then BARE `FName ObjectiveId;` (no initializer).
# NO Category=. If a clone asserts an initializer and origin/main
# has a bare decl, accept the bare decl.
# THIS IS NOT leftover MaterialCompilation Error #1232.
# THIS IS NOT leftover CaptureConfig Error #1222.
# THIS IS NOT leftover VisibleAudit Error #1213.
# THIS IS NOT leftover Footprint Error #1198.
# THIS IS NOT leftover HeightSample Error #1188.
# THIS IS NOT leftover mission01-environment-authoring-result-defaults #df1a.
# THIS IS NOT leftover AuthoringResult Landscape #1233 / Graph #1234 /
# bSuccess #1235 / VisibleAudit #1236 / GraphNodeCount #1237 /
# LandscapeComponentCount #1238 / GraphNodeSettingClasses #1239 /
# GraphEdgeCount #1240 / bLandscapeGuidValid #1241 /
# bLandscapeTransformExact #1242 / bGraphContractValid #1243 /
# bAuthoredStructureReady #1244 / bLicensedMeshSlotsEmpty #1246 /
# bGenerationLocked #1245 / GeneratedPCGComponentCount #1247.
# LOCK leftover drafts #56-#64 plus leftover enum/defaults PRs
# including leftover mission01-environment-authoring-result-defaults
# #df1a. LOCK leftover AuthoringResult through GeneratedPCGComponentCount
# #1247. LOCK leftover MaterialCompilation Error #1232 /
# CaptureConfig Error #1222 / VisibleAudit Error #1213 /
# Footprint Error #1198 / HeightSample Error #1188.
# Declaration-only. Accept origin/main split-line UPROPERTY and
# bare FName ObjectiveId;. Fail closed if type/decl missing, renamed,
# Category= is added, or an initializer appears when origin/main
# is bare.
# Parse STRUCT public section only AFTER
# struct FSkyguardHowToFlyRow and BEFORE
# DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam.
# Do NOT parse USkyguardSortiePresentationComponent methods.
# Do NOT parse FSkyguardBriefingCard / FSkyguardBriefingRadioRow.
# Do NOT parse ESkyguardBriefingPictogram enum body.
# Do NOT parse ASkyguardMission01EnvironmentDirector.
# Do NOT parse FSkyguardMission01EnvironmentReadiness.
# Do NOT parse FSkyguardLandscapeVisibleAudit /
# CaptureConfigurationResult / MaterialCompilationResult /
# FootprintSampleResult / HeightSample.
# Harbor 40/80 fail-closed in this Mission01-related test file.
# Ban retired live-copy tokens via split tokens
# (b + Ya + kRuntimeReady). Stay Apache CPG 30 mm / Hydra /
# Hellfire.

# THIS IS leftover-safe FSkyguardHowToFlyRow
# Error. BARE decl, NO initializer.
# If a clone asserts an initializer and origin/main has a bare decl, accept the bare decl.
# THIS IS NOT leftover bSuccess #1235. THIS IS NOT leftover
# mission01-environment-authoring-result-defaults #df1a.
# THIS IS NOT leftover authored-structure-ready. THIS IS NOT leftover
# AuthoringResult through #1241. LOCK leftover AuthoringResult through
# #1241 plus leftover MaterialCompilation through Error #1232.
# THIS IS leftover-safe FSkyguardHowToFlyRow
# Error. THIS IS NOT leftover Mission01
# EnvironmentReadiness bAuthoredPCGStructureReady. THIS IS NOT leftover
# bSuccess #1235. THIS IS NOT leftover
# mission01-environment-authoring-result-defaults #df1a.
# THIS IS NOT leftover AuthoringResult Landscape #1233 / Graph #1234 /
# VisibleAudit #1236 / GraphNodeCount #1237 /
# LandscapeComponentCount #1238 / leftover landscape-guid-valid #c332.
# LOCK leftover drafts #56-#64 plus leftover enum/defaults PRs
# including leftover mission01-environment-authoring-result-defaults
# #df1a, leftover AuthoringResult Landscape #1233 / Graph #1234 /
# bSuccess #1235 / VisibleAudit #1236 / GraphNodeCount #1237 /
# LandscapeComponentCount #1238, leftover MaterialCompilation through
# Error #1232.
# Declaration-only. Accept origin/main split-line UPROPERTY and
# FName ObjectiveId;. Fail closed if type/decl
# missing, renamed, Category= is added, or an initializer appears when origin/main is bare.
# Parse STRUCT public section only AFTER
# struct FSkyguardHowToFlyRow and BEFORE
# DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam.
# Do NOT parse USkyguardSortiePresentationComponent methods.
...
# Do NOT parse FSkyguardMission01EnvironmentReadiness.
# Do NOT parse FSkyguardLandscapeVisibleAudit.
# Do NOT parse FSkyguardLandscapeMaterialCompilationResult.
# Do NOT parse FSkyguardLandscapeCaptureConfigurationResult.
# Harbor 40/80 fail-closed in this Mission01-related test file.
# Ban retired live-copy tokens via split tokens
# (b + Ya + kRuntimeReady). Stay Apache CPG 30 mm / Hydra /
# Hellfire.
...
# THIS IS leftover-safe FSkyguardHowToFlyRow
# Error. THIS IS NOT leftover
# mission01-environment-authoring-result-defaults #df1a.
# THIS IS NOT leftover AuthoringResult bSuccess #1235.
# Distinct from sibling bLandscapeTransformExact
# (next leftover-safe bool).
# LOCK leftover AuthoringResult Landscape #1233 / Graph #1234 /
# bSuccess #1235 / VisibleAudit #1236 / GraphNodeCount #1237 /
# LandscapeComponentCount #1238.
# LOCK leftover MaterialCompilation through Error #1232.
# LOCK leftover drafts #56-#64 plus leftover enum/defaults PRs
# including leftover mission01-environment-authoring-result-defaults
# #df1a, leftover AuthoringResult Landscape #1233 / Graph #1234 /
# bSuccess #1235 / VisibleAudit #1236.
# Declaration-only. Accept origin/main split-line UPROPERTY and
# FName ObjectiveId;. Fail closed if type/decl
# missing, renamed, Category= is added, or an initializer appears when origin/main is bare.
# Parse STRUCT public section only AFTER
...
# THIS IS leftover-safe FSkyguardHowToFlyRow
# Error. THIS IS NOT leftover MaterialCompilation bSuccess #1223.
# THIS IS NOT leftover CaptureConfig bSuccess #1214. THIS IS NOT
# leftover VisibleAudit bSuccess #1199. THIS IS NOT leftover
# Footprint bSuccess #1189. THIS IS NOT leftover
# mission01-environment-authoring-result-defaults #df1a.
# THIS IS leftover-safe FSkyguardHowToFlyRow
# Error FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# FName ObjectiveId; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# BARE decl, NO initializer. Fail closed if the type
# or decl is missing, renamed, Category= is added, or default
# is not false. Parse STRUCT public section only AFTER
# struct FSkyguardHowToFlyRow and BEFORE
# DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam.
# Do NOT parse USkyguardSortiePresentationComponent methods.
# Do NOT parse FSkyguardBriefingCard / FSkyguardBriefingRadioRow.
...
# Do NOT parse ASkyguardMission01EnvironmentDirector.
# Do NOT parse FSkyguardMission01EnvironmentReadiness.
# Do NOT parse FSkyguardLandscapeVisibleAudit (leftover bSuccess #1199).
# Do NOT parse FSkyguardLandscapeCaptureConfigurationResult (leftover bSuccess #1214).
# Do NOT parse FSkyguardLandscapeMaterialCompilationResult (leftover bSuccess #1223).
# Do NOT parse FSkyguardLandscapeFootprintSampleResult (leftover bSuccess #1189).
# THIS IS leftover-safe FSkyguardHowToFlyRow
# Error. THIS IS NOT leftover MaterialCompilation bSuccess #1223.
# THIS IS NOT leftover CaptureConfig bSuccess #1214.
# THIS IS NOT leftover VisibleAudit bSuccess #1199.
# THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
# THIS IS NOT leftover landscape-capture-config-defaults #d6fd.
# THIS IS NOT leftover landscape-visible-audit-defaults #0bce.
# THIS IS NOT leftover landscape-material-compilation-defaults #01d4.
# THIS IS NOT leftover mission01-environment-authoring-result-defaults #df1a.
# LOCK leftover MaterialCompilation through Error #1232.
# LOCK leftover MaterialCompilation bSuccess #1223.
# LOCK leftover CaptureConfig bSuccess #1214.
# LOCK leftover drafts #56-#64 plus leftover enum/defaults PRs
# including leftover landscape-capture-config-defaults #d6fd,
# leftover landscape-material-compilation-defaults #01d4, and
# leftover mission01-environment-authoring-result-defaults #df1a.
# LOCK leftover VisibleAudit bSuccess #1199.
# LOCK leftover Footprint bSuccess #1189.
# LOCK leftover CaptureConfig bSuccess #1214.
# LOCK leftover CaptureConfigurationResult #1214-#1224.
...
# Do NOT parse FSkyguardLandscapeCaptureConfigurationResult (leftover bSuccess #1214).
# THIS IS leftover-safe FSkyguardHowToFlyRow
# Error. THIS IS NOT leftover VisibleAudit bSuccess #1199.
# THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
# THIS IS NOT leftover landscape-capture-config-defaults #d6fd.
# THIS IS NOT leftover landscape-visible-audit-defaults #0bce.
# THIS IS NOT leftover landscape-material-compilation-defaults #01d4.
# THIS IS NOT leftover CaptureConfig bSuccess #1214.
# THIS IS NOT leftover VisibleAudit bSuccess #1199.
# THIS IS NOT leftover Footprint bSuccess #1189.
# LOCK leftover landscape-material-compilation-defaults #01d4.
# LOCK leftover CaptureConfig bSuccess #1214.
# LOCK leftover drafts #56-#64 plus leftover enum/defaults PRs
# including leftover landscape-capture-config-defaults #d6fd and
# leftover landscape-visible-audit-defaults #0bce.
# LOCK leftover VisibleAudit bSuccess #1199.
# LOCK leftover Footprint bSuccess #1189.
# LOCK leftover CaptureConfig bSuccess #1214.
# LOCK leftover landscape-material-compilation-defaults #01d4.
...
# FName ObjectiveId; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# DEFAULT IS `= true` NOT `= false` (NOT leftover
# bActorHiddenInGame = true). Fail closed if the type
# or decl is missing, renamed, Category= is added, or default
# is not false. Parse STRUCT public section only AFTER
# struct FSkyguardHowToFlyRow and BEFORE
# DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam.
...
# THIS IS leftover-safe FSkyguardHowToFlyRow
# Error. THIS IS NOT leftover
# landscape-visible-audit-defaults #0bce. THIS IS NOT leftover
# HiddenInGameComponentCount #1204. THIS IS NOT leftover
# Footprint bSuccess #1189 / Error #1198.
# LOCK leftover VisibleAudit bSuccess #1199 through
# GovernedMaterialParentMatchComponentCount #1206.
# LOCK leftover ContractCameraFrustumIntersectionCount #1207 /
# bActorHiddenInGame #1208.
# LOCK leftover drafts #56-#64 plus leftover enum/defaults PRs
# including leftover landscape-visible-audit-defaults #0bce.
# LOCK leftover Mission01 EnvironmentReadiness
# LandscapeComponentCount #1176.
# Harbor 40/80 fail-closed in this Mission01-related
# test file. Ban retired live-copy tokens via split tokens
# (b + Ya + kRuntimeReady). Stay Apache CPG 30 mm / Hydra /
# Hellfire.
...
# THIS IS leftover-safe FSkyguardHowToFlyRow
# Error. THIS IS NOT leftover
# VisibleAudit bActorHiddenInGame (in-flight sibling; LOCK
# that script). THIS IS NOT leftover VisibleAudit
# HiddenInGameComponentCount #1204. THIS IS NOT leftover
# landscape-visible-audit-defaults #0bce. THIS IS NOT leftover
# VisibleAudit bSuccess #1199. THIS IS NOT leftover Mission01
# EnvironmentReadiness LandscapeComponentCount #1176.
# LOCK leftover landscape-visible-audit-defaults #0bce.
# LOCK leftover HiddenInGameComponentCount #1204.
# LOCK leftover VisibleAudit bSuccess #1199.
# LOCK leftover drafts #56-#64 plus leftover enum/defaults
# PRs including leftover landscape-visible-audit-defaults
# #0bce, leftover landscape-footprint-sample-defaults
# #af83/#202, leftover landscape-height-sample-defaults
# #46a3/#200, leftover SampleLandscapeFootprint #627,
# leftover SampleLandscapeHeight #626, leftover Mission01
# environment-readiness-defaults #6b9d, leftover director
# OceanTiles #585 / BeachTiles #586 / LandTiles #587.
...
# THIS IS leftover-safe FSkyguardHowToFlyRow
# Error FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly FName ObjectiveId; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# Fail closed if the type or decl is missing, renamed, or
# Category= is added. Parse STRUCT public section only
# (after struct FSkyguardHowToFlyRow, before
...
# #46a3/#200. THIS IS NOT leftover
# landscape-footprint-sample-defaults #af83/#202.
# THIS IS NOT leftover LandscapeHeightSample bValid #1184 /
# QueryLocation #1185 / HeightfieldSource #1186 /
# HeightCentimeters #1187.
# THIS IS NOT leftover Mission01
# environment-readiness-defaults #6b9d/#204.
# THIS IS NOT leftover FSkyguardMission01EnvironmentReadiness
# LandscapeComponentCount #1176. THIS IS NOT leftover
# FSkyguardLandscapeVisibleAudit LandscapeComponentCount.
# THIS IS NOT leftover EnvironmentReadiness
# PCG-generation-authorized sibling #1180.
# LOCK leftover drafts #56-#64 plus leftover enum/defaults
# PRs including leftover landscape-height-sample-defaults
# #46a3/#200, leftover landscape-footprint-sample-defaults
# #af83/#202, leftover SampleLandscapeHeight #626, leftover
# SampleLandscapeFootprint #627, leftover Mission01
# environment-readiness-defaults #6b9d/#204.
# LOCK leftover-safe LandscapeComponentCount sibling #1176
# and leftover-safe PCG-generation-authorized sibling #1180.
# Harbor 40/80 fail-closed in this Mission01 test file
# (Mission08/09-only). Ban retired live-copy tokens via split
# tokens (b + Ya + kRuntimeReady). Stay Apache CPG 30 mm /
# Hydra / Hellfire.
# Fail closed if the type or decl is missing, renamed, or
# Category= is added. Do NOT parse
# USkyguardMission01LandscapeGroundingLibrary.
# LOCK leftover drafts #56-#64 plus leftover enum/defaults PRs
# including leftover Mission01 environment-readiness-defaults
# #6b9d/#204. LOCK leftover Mission01 director OceanTiles #585 /
# BeachTiles #586 / LandTiles #587 / RouteExclusion #588 /
# ProductionLandscape #591 / AuthoredPCGGraph #594. LOCK leftover
# HasContinuousCoastline #623 / leftover IsPointAllowedForPCG
# #622. THIS IS NOT leftover director class. THIS IS NOT leftover
# Mission01 environment-readiness-defaults #6b9d/#204. THIS IS NOT
# leftover director OceanTiles #585 / BeachTiles #586 / LandTiles
# #587 / RouteExclusion #588 / ProductionLandscape #591 /
# AuthoredPCGGraph #594. THIS IS NOT leftover
# HasContinuousCoastline #623 / IsPointAllowedForPCG #622.
# LOCK leftover-safe LandscapeComponentCount sibling #1176.
# LOCK leftover-safe bProductionLandscapeBound / bAuthoredPCGGraphBound /
# bPCGBoundsTagged siblings (PR #1177/#1179 and in-flight production-
# landscape-bound / authored-pcg-graph-bound drafts). Do not edit them.
# THIS IS NOT leftover bPCGBoundsTagged. THIS IS NOT leftover
# bProductionLandscapeBound / bAuthoredPCGGraphBound.
# Harbor 40/80 fail-closed in this Mission01 test file
# (Mission08/09-only). Ban retired live-copy tokens via split
...
STRUCT_NAME = "FSkyguardObjectiveProgress"
CLASS_NAME = STRUCT_NAME
# THIS IS leftover-safe FSkyguardHowToFlyRow
# Error FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly FName ObjectiveId; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover Mission01 environment-readiness-defaults
# #6b9d/#204. THIS IS NOT leftover ProductionLandscape #591.
# THIS IS NOT leftover FSkyguardLandscapeVisibleAudit::
# bValid. THIS IS NOT leftover
# SampleLandscapeHeight #626 / SampleLandscapeFootprint #627.
# THIS IS NOT leftover OceanTileCount #1170 / BeachTileCount
# #1171 / LandTileCount #1172 / bAuthoredLandscapeSurfaceExposed
# #1173. LOCK in-flight leftover-safe bContinuousCoastline /
# bRouteExclusionValid sibling scripts; do not edit them.
# THIS IS leftover-safe FSkyguardHowToFlyRow
# Error FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# FName ObjectiveId; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover Mission01 environment-readiness-defaults
# #6b9d/#204. THIS IS NOT leftover IsAuthoredEnvironmentReady
# #625. THIS IS NOT leftover ProductionLandscape director
# field #591. THIS IS NOT leftover OceanTileCount sibling
# #1170. THIS IS NOT leftover IsAuthoredLandscapeSurfaceExposed
# director method. THIS IS NOT leftover BeachTileCount /
# LandTileCount in-flight siblings (LOCK those scripts;
# do not edit them). THIS IS NOT leftover landscape-height-
# sample-defaults #46a3 / leftover landscape-footprint-
# sample-defaults #af83 / leftover landscape-visible-audit-
# defaults #0bce. THIS IS NOT leftover FSkyguardEnvironmentReadiness
# BoundCapabilityCount #1167 / TreeInstanceCount #1165 /
# ShrubInstanceCount #1168 / VFXPoolSize #1169. THIS IS NOT
# leftover Mission01 environment director OceanTiles #585 /
# BeachTiles #586 / LandTiles #587 / ProductionLandscape #591 /
# Root #592. THIS IS NOT leftover Mission01 environment
# director methods #613-#627 including leftover
# IsAuthoredEnvironmentReady #625 / SampleLandscape* /
# RebuildProductionLayout. THIS IS NOT leftover
# environment-readiness-defaults #174/#b931. THIS IS NOT
# leftover MissionMapReadiness field drafts #1155-#1164/#1166.
# THIS IS NOT leftover Mission10 Integrity #826 / bDestroyed
# #827. THIS IS NOT leftover Mission05 closed-without-merge
# #665 #666 #668-#673. LOCK leftover Apache closed #411-#426.
# LOCK leftover drafts #56-#64 and leftover #107-#673.
# Do not reopen open drafts #674-#1173.
# THIS IS leftover-safe FSkyguardHowToFlyRow
# Error FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly FName ObjectiveId; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover Mission01 environment-readiness-
# defaults #6b9d/#204. THIS IS NOT leftover director
# OceanTiles #585 (ASkyguardMission01EnvironmentDirector::
# OceanTiles). THIS IS NOT leftover FSkyguardEnvironmentReadiness
# BoundCapabilityCount #1167 / TreeInstanceCount #1165.
# THIS IS NOT leftover environment-readiness-defaults #b931.
# THIS IS leftover-safe FSkyguardHowToFlyRow
# Error FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# FName ObjectiveId;
# one-line / split-line UPROPERTY wraps; origin/main
# has NO Category). THIS IS leftover-safe
# FSkyguardMission01EnvironmentReadiness bValid
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly FName ObjectiveId;
# one-line / split-line UPROPERTY wraps;
# origin/main has NO Category). THIS IS NOT leftover
# environment-readiness-defaults #b931. THIS IS NOT
# leftover coastal-env-director-empty-fail-closed
# #321b. THIS IS NOT leftover environment-quality-
# enum #06c7. THIS IS NOT leftover director
# TreeInstances HISM field. THIS IS NOT leftover
# BoundCapabilityCount sibling (in-flight; LOCK
# that script; do not edit it).
# THIS IS leftover-safe FSkyguardHowToFlyRow
# Error FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# FName ObjectiveId;
...
# FSkyguardMission01EnvironmentReadiness STRUCT
# public section only (after struct
# FSkyguardMission01EnvironmentReadiness, before
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardHowToFlyRow
# bValid. THIS IS NOT leftover mission-map-
# readiness-defaults #3a2a. THIS IS NOT leftover
# mission-map GetReadiness / ValidateAssembly /
# RebuildRouteSpline / IsPointInsideFlightClearance.
# THIS IS NOT leftover MissionMapReadiness
# bDefinitionValid #1155 / leftover
# bRequiredObjectivesAnchored #1157 / leftover
# bRouteMatchesDefinition #1158. LOCK those
# sibling scripts. LOCK in-flight leftover-safe
# MissionMapReadiness bLandmarksDistinct /
# bWeatherMatchesDefinition. Do not parse
# ObjectiveAnchor / LandmarkAnchor (EditAnywhere).
# THIS IS NOT leftover Mission01/02/03/04/05/06/07/08/09/10
# same-name director Readiness fields.
# LOCK leftover Apache closed #411-#426.
# Do not reopen leftover Mission10 Integrity
# #826 / bDestroyed #827 or leftover Mission10
# methods/fields #768-#825.
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardHowToFlyRow
# bValid. THIS IS NOT leftover Mission05
...
# merge #665 #666 #668-#673, or open drafts #674-#1158.
...
# Mission01 EnvironmentReadiness bValid
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly FName ObjectiveId;
# one-line / split-line UPROPERTY wraps;
# origin/main has NO Category) on
# FSkyguardMission01EnvironmentReadiness. It is
# leftover-safe FSkyguardMission01EnvironmentReadiness
# bSuccess FIELD (declaration-only). It is
...
# drafts #674-#1158 including leftover Mission02
...
# drafts #674-#1158. Do not reopen leftover
...
TARGET = "FName ObjectiveId;"
TARGET_WRONG = "FName ObjectiveId = NAME_None;"
LOCKED_DECL = TARGET
...
LEFTOVER_ENVIRONMENT_READINESS_NOT_LOCKED = (
    ...
    "test_environment_readiness_bound_capability_count_field_decl_contract.py",
    "test_environment_readiness_tree_instance_count_field_decl_contract.py",
    "test_environment_readiness_shrub_instance_count_field_decl_contract.py",
    "test_environment_readiness_vfx_pool_size_field_decl_contract.py",
    "test_environment_quality_enum_contract.py",
    "test_coastal_env_director_empty_fail_closed.py",
    "test_coastal_environment_director_empty_fail_closed.py",
    ...
    "test_mission01_environment_readiness_ocean_tile_count_field_decl_contract.py",
    "test_mission01_environment_readiness_beach_tile_count_field_decl_contract.py",
    "test_mission01_environment_readiness_land_tile_count_field_decl_contract.py",
    "test_mission01_environment_readiness_authored_landscape_surface_exposed_field_decl_contract.py",
    "test_mission01_environment_readiness_continuous_coastline_field_decl_contract.py",
    "test_mission01_environment_readiness_route_exclusion_valid_field_decl_contract.py",
    "test_mission01_environment_readiness_landscape_component_count_field_decl_contract.py",
...
def unlocked_neighbors() -> tuple[str, ...]:
    return (
        ...
        "bool SampleLandscapeHeight",
        "bool SampleLandscapeFootprint",
...
def has_declaration(region: str, declaration: str) -> bool:
    # Fail-closed on the authored bare FString. Do not accept an
    # initializer for FSkyguardHowToFlyRow::
    # Error (must be bare FName ObjectiveId;).
    # THIS IS NOT leftover Mission01 EnvironmentReadiness
    # bAuthoredPCGStructureReady. THIS IS NOT leftover bSuccess #1235.
    # THIS IS NOT leftover VisibleAudit bSuccess #1199.
    # THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*FName\s+ObjectiveId\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for FName ObjectiveId is missing from "
...
class ObjectiveProgressObjectiveIdFieldDeclContractTests(unittest.TestCase):
    def test_objective_progress_struct_exists(self) -> None:
        ...
        self.assertIn("ObjectiveId", section)
        self.assertIn("CurrentProgress", section)
        self.assertIn("State", section)
        self.assertNotIn("StepId", section)
        self.assertNotIn("InputHint", section)
        self.assertNotIn("Instruction", section)
        self.assertNotIn("struct FSkyguardMissionResult", section)
        self.assertNotIn("struct FSkyguardMissionDebrief", section)
        self.assertNotIn("GetObjectiveRuntime", section)
        self.assertNotIn("AddObjectiveProgress", section)
        self.assertNotIn("CompletedObjectiveIds", section)
        self.assertNotIn("bMissionSucceeded", section)
        self.assertNotIn("Speaker", section)
        self.assertNotIn("Subtitle", section)
        self.assertNotIn("bAuthoredPCGStructureReady", section)
        self.assertNotIn("bAuthoredPCGStructureReady", LOCKED_DECL)
        self.assertNotIn("CardId", section)
        self.assertNotIn("Title", section)
        self.assertNotIn("Body", section)
        self.assertNotIn("Priority", section)
        self.assertNotIn("LineId", section)
        self.assertNotIn("DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam", section)
        self.assertNotIn("GetBriefingCards", section)
        self.assertNotIn("GetRadioRows", section)
        self.assertNotIn("GetHowToFlyRows", section)
        self.assertNotIn("struct FSkyguardBriefingCard", section)
        self.assertNotIn("struct FSkyguardBriefingRadioRow", section)
        self.assertNotIn("enum class ESkyguardBriefingPictogram", section)
        self.assertNotIn("class USkyguardSortiePresentationComponent", section)
        self.assertNotIn("bSuccess", section)
        self.assertNotIn("bLandscapeGuidValid", section)
        self.assertNotIn("GraphNodeCount", section)
        self.assertNotIn("GeneratedPCGInstanceCount", section)
        self.assertNotIn("bUsesShowOnlyLandscape", section)
        self.assertNotIn("CaptureSource", section)
        self.assertNotIn("bRenderThreadSynchronized", section)
        self.assertIn("ObjectiveId", section)
        self.assertNotIn("VisibleComponentCount", section)
        self.assertNotIn("RegisteredComponentCount", section)
        self.assertNotIn("struct FSkyguardLandscapeVisibleAudit", section)
        self.assertNotIn("VisibleAudit", section)
        self.assertNotIn("QueryLocation", section)
        self.assertNotIn("bool bValid", section)
        self.assertNotIn("HeightfieldSource", section)
        self.assertNotIn("BeachTileCount", section)
        self.assertNotIn("LandTileCount", section)
        self.assertNotIn("OceanTileCount", section)
        self.assertNotIn("RequiredSampleCount", section)
        self.assertNotIn("ValidSampleCount", section)
        self.assertNotIn("SupportedFraction", section)
        self.assertNotIn("USkyguardMission01EnvironmentAuthoringLibrary", section)
        self.assertNotIn("USkyguardMission01LandscapeGroundingLibrary", section)
        self.assertNotIn("bLandscapeTransformExact", LOCKED_DECL)
        self.assertNotIn("bSuccess", LOCKED_DECL.replace("Error", ""))
        self.assertNotIn("BoundCapabilityCount", section)
        self.assertNotIn("ShrubInstanceCount", section)
        self.assertNotIn("VFXPoolSize", section)
        ...
        self.assertNotIn("ASkyguardCoastalEnvironmentDirector", section)
        self.assertNotIn("ASkyguardMission01EnvironmentDirector", section)
        self.assertNotIn("FSkyguardEnvironmentReadiness", section)
        self.assertNotIn("FSkyguardMissionMapReadiness", section)
        self.assertNotIn("FSkyguardMission01IntegrationReadiness", section)
        self.assertNotIn("ESkyguardEnvironmentQuality", section)
        self.assertNotIn("OceanTiles", section)
        self.assertNotIn("TreeInstances", section)
        self.assertNotIn("ShrubInstances", section)
        self.assertNotIn("RebuildDeterministicVegetation", section)
        self.assertNotIn("ApplyQuality", section)
        self.assertNotIn("ApplyMissionWeather", section)
        self.assertNotIn("RebuildProductionLayout", section)
        self.assertNotIn("IsAuthoredEnvironmentReady", section)
        self.assertNotIn("HasContinuousCoastline", section)
        self.assertNotIn("IsPointAllowedForPCG", section)
        ...
        self.assertNotIn("struct FSkyguardLandscapeHeightSample", section)
        self.assertNotIn("FSkyguardLandscapeFootprintSampleResult", section)
        self.assertNotIn("FSkyguardLandscapeCaptureConfigurationResult", section)
        self.assertNotIn("FSkyguardLandscapeMaterialCompilationResult", section)
        self.assertNotIn("struct FSkyguardLandscapeMaterialCompilationResult", section)
        self.assertNotIn("USkyguardMission01EnvironmentAuthoringLibrary", section)
        self.assertNotIn("OceanTiles", section)
        self.assertNotIn("BeachTiles", section)
        self.assertNotIn("LandTiles", section)
        self.assertNotIn("FSkyguardEnvironmentReadiness", section)
        self.assertNotIn("FSkyguardMission01IntegrationReadiness", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("ObjectiveId", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_objective_id_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_objective_id_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FName ObjectiveId"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("ObjectiveId", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("ObjectiveId", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FName ObjectiveId"))
    ...
    def test_contract_does_not_relock_leftover_environment_readiness(
        ...
        self.assertIn(
            "Scripts/tests/test_environment_readiness_bound_capability"
            "_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_environment_readiness_tree"
            "_instance_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_environment_readiness_shrub"
            "_instance_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_environment_readiness_vfx"
            "_pool_size_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_readiness"
            "_ocean_tile_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_readiness"
            "_beach_tile_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_readiness"
            "_land_tile_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_readiness"
            "_authored_landscape_surface_exposed"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_readiness"
            "_continuous_coastline_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_readiness"
            "_route_exclusion_valid_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_readiness"
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_environment_readiness"
            "_production_landscape_bound_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_readiness"
            "_authored_pcg_graph_bound_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_readiness"
        ...
        self.assertNotIn("bAuthoredLandscapeSurfaceExposed", LOCKED_DECL)
        self.assertNotIn("OceanTileCount", LOCKED_DECL)
        self.assertNotIn("BeachTileCount", LOCKED_DECL)
        self.assertNotIn("LandTileCount", LOCKED_DECL)
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
            "_actor_hidden_in_game_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
            "_hidden_in_game_component_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
        ...
        self.assertIn("ObjectiveId", LOCKED_DECL)
        self.assertNotIn("FSkyguardLandscapeVisibleAudit", LOCKED_DECL)
        self.assertNotIn("FSkyguardLandscapeFootprintSampleResult", LOCKED_DECL)
        self.assertNotIn("bActorHiddenInGame", LOCKED_DECL)
        self.assertNotIn("bActorTemporarilyHiddenInEditor", LOCKED_DECL)
        self.assertNotIn("ContractCameraFrustumIntersectionCount", LOCKED_DECL)
        ...
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
            "_actor_temporarily_hidden_in_editor_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
            "_governed_material_parent_match_component_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
            "_generated_material_instance_ready_component_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_environment_authoring"
            "_result_landscape_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_authoring"
            "_result_graph_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_authoring"
            "_result_visible_audit_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_authoring"
            "_result_landscape_component_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_authoring"
            "_result_graph_node_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_authoring"
            "_result_graph_edge_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_authoring"
            "_result_graph_node_setting_classes_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_authoring"
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_environment_readiness"
            "_authored_pcg_structure_ready_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_sample_landscape"
            "_height_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_sample_landscape"
            "_footprint_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_readiness"
            "_pcg_generation_authorized_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_height_sample"
        ...
        self.assertIn(
            "Scripts/tests/test_landscape_height_sample"
            "_query_location_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_height_sample"
            "_height_centimeters_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_height_sample"
            "_heightfield_source_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        ...
        self.assertIn(
            "Scripts/tests/test_coastal_env_director_empty"
            "_fail_closed.py",
            LOCKED_SCRIPTS,
        )
        self.assertNotIn("BoundCapabilityCount", LOCKED_DECL)
        self.assertNotIn("TreeInstances", LOCKED_DECL)
        self.assertNotIn("ESkyguardEnvironmentQuality", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("ObjectiveId", locked_only)
    ...
    def test_this_file_bans_live_retired_tokens_case_sensitive(self) -> None:
        ...
        for banned in live:
            self.assertNotIn(
                banned,
                file_text,
                "objective-progress ObjectiveId field contract contains live "
                f"{banned}; split leftover tokens only",
            )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 ProtectedTargetRuntime Target field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 ProtectedTargetRuntime Target contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_success(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_objective_progress_objective_id"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
            "Scripts/tests/test_briefing_card_card_id"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_briefing_card_priority"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_briefing_card_title"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_briefing_card_body"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_briefing_card_defaults"
            "_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_briefing_radio_row_defaults"
            "_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_how_to_fly_row_defaults"
            "_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_briefing_radio_row_line_id"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_briefing_radio_row_speaker"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_briefing_radio_row_subtitle"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_how_to_fly_row_step_id"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_how_to_fly_row_input_hint"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_objective_progress_defaults"
            "_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_add_objective_progress"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_environment_authoring"
            "_result_generation_locked_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_authoring"
            "_result_generated_pcg_component_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_authoring"
            "_result_authored_structure_ready_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_authoring"
            "_result_graph_contract_valid_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_authoring"
            "_result_landscape_transform_exact_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
        ...
        self.assertIn(
            "Scripts/tests/test_landscape_material_compilation"
            "_asset_compilation_queue_empty_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_material_compilation"
            "_shader_compilation_queue_empty_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_authoring"
        ...
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
            "_bounds_finite_and_nonzero_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
            "_bounds_minimum_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
            "_bounds_maximum_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_wrong_leftover_structs_do_not_satisfy(self) -> None:
        leftovers = (
            ...
            f"\t{LOCKED_DECL}\n"
            "};\n",
            "class SKYGUARD52_API USkyguardMission01LandscapeGroundingLibrary "
    ...
    def test_leftover_mission_map_get_readiness_sibling_stays_locked(
        ...
        self.assertIn(
            "Scripts/tests/test_mission_map_readiness_required"
            "_objectives_anchored_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission_map_readiness_landmarks"
            "_distinct_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission_map_readiness_weather"
            "_matches_definition_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_parser_does_not_land_on_anchors_or_director(self) -> None:
        ...
        match = CLASS_RE.search(header)
        self.assertIsNotNone(match, header)
        self.assertIn("FSkyguardObjectiveProgress", match.group(0))
        ...
        self.assertNotIn("struct FSkyguardMissionResult", section)
        self.assertNotIn("struct FSkyguardMissionDebrief", section)
        self.assertNotIn("struct FSkyguardHowToFlyRow", section)
        self.assertNotIn("GetObjectiveRuntime", section)
        self.assertNotIn("AddObjectiveProgress", section)
        self.assertNotIn("CompletedObjectiveIds", section)
        self.assertNotIn("bMissionSucceeded", section)
        self.assertNotIn("DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam", section)
        self.assertNotIn("ConfigureFromMission", section)
