...
# INDEX_NONE or lock BreakwaterSpawnLocation
# construction in the .cpp. This is leftover-safe
# Mission02 BreakwaterSpawnLocation FIELD
# (declaration-only; EditAnywhere /
# BlueprintReadWrite FVector default
# FVector(65000.f, -8000.f, 4300.f),
...
# sibling field, NOT leftover LastFlightSpawnLocation leftover Mission10
# field / leftover LastFlightSpawnRotation
# sibling field,
# NOT leftover BreakwaterSpawnRotation sibling field,
# NOT leftover Breakwater boss fields #540-#545, NOT leftover retired-mount spawn
...
LOCKED_DECL = BREAKWATER_SPAWN_LOCATION
...
# an isolated Python BreakwaterSpawnLocation
...
class Mission02BreakwaterSpawnLocationFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("BreakwaterSpawnLocation", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_breakwater_spawn_location_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_last_flight_spawn_location_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FVector BreakwaterSpawnLocation"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("= FVector(65000.f, -8000.f, 4300.f);"), LOCKED_DECL)
        self.assertIn("BreakwaterSpawnLocation", LOCKED_DECL)
        self.assertIn("FVector ", LOCKED_DECL)
        self.assertIn("= FVector(65000.f, -8000.f, 4300.f)", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("BreakwaterSpawnLocation", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FVector BreakwaterSpawnLocation"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("BreakwaterSpawnLocation", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 BreakwaterSpawnLocation field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 BreakwaterSpawnLocation contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_breakwater_spawn_location(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_breakwater_spawn_location_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
