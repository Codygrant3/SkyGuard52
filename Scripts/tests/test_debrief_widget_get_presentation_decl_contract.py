...
# with an inline body possibly on following lines);
...
# BriefingWidget GetPresentation. This is not leftover
...
# Configure, leftover mission-debrief defaults,
...
# wave), GetDebrief, GetDebriefNarrative, GetFinalScore,
...
# leftover GetFinalScore, leftover
...
# here. Configure / GetDebrief / GetDebriefNarrative /
...
# cpp body. origin/main inline body is accepted as
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "USkyguardDebriefWidget::GetPresentation",
    "SkyguardSortiePresentationWidgets.cpp",
)
SIBLING_TYPES = (
...
class DebriefWidgetGetPresentationDeclContractTests(unittest.TestCase):
    ...
    def test_contract_does_not_relock_constructor(self) -> None:
        ...
        self.assertNotIn("ObjectInitializer", GET_PRESENTATION)
    ...
    def test_contract_does_not_relock_get_debrief(self) -> None:
        ...
        for neighbor in GET_DEBRIEF_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_PRESENTATION)
        self.assertNotIn("GetDebrief()", GET_PRESENTATION)
    ...
    def test_contract_does_not_relock_get_debrief_narrative(self) -> None:
        ...
        for neighbor in GET_DEBRIEF_NARRATIVE_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_PRESENTATION)
        self.assertNotIn("GetDebriefNarrative", GET_PRESENTATION)
    ...
    def test_contract_does_not_relock_get_final_score(self) -> None:
        ...
        for neighbor in GET_FINAL_SCORE_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_PRESENTATION)
        self.assertNotIn("GetFinalScore", GET_PRESENTATION)
    ...
    def test_contract_does_not_relock_is_progress_saved(self) -> None:
        ...
        for neighbor in IS_PROGRESS_SAVED_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_PRESENTATION)
        self.assertNotIn("IsProgressSaved", GET_PRESENTATION)
    ...
    def test_contract_does_not_relock_acknowledge_debrief(self) -> None:
        ...
        for neighbor in ACKNOWLEDGE_DEBRIEF_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_PRESENTATION)
        self.assertNotIn("AcknowledgeDebrief", GET_PRESENTATION)
    ...
    def test_contract_does_not_relock_retry_save(self) -> None:
        ...
        for neighbor in RETRY_SAVE_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_PRESENTATION)
        self.assertNotIn("RetrySave", GET_PRESENTATION)
    ...
    def test_contract_does_not_relock_travel_next(self) -> None:
        ...
        for neighbor in TRAVEL_NEXT_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_PRESENTATION)
        self.assertNotIn("TravelNext", GET_PRESENTATION)
    ...
    def test_contract_does_not_relock_handle_debrief_key(self) -> None:
        ...
        for neighbor in HANDLE_DEBRIEF_KEY_NOT_LOCKED:
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_PRESENTATION)
        self.assertNotIn("HandleDebriefKey", GET_PRESENTATION)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "debrief widget GetPresentation contract contains "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                lowered,
                f"debrief widget GetPresentation contains {banned}; "
