...
# INDEX_NONE or lock GetGunner construction
...
# BindRuntimeActors, NOT leftover Gunner
# combat-fill helpers / FillAndFinalize /
# FillAndFail, and NOT leftover Gunner
# IsVerticalLookInverted. Distinct from leftover
...
GET_GUNNER = "ASkyguardGunner* GetGunner() const"
GET_PATHFINDER = (
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission01IntegrationDirector::GetGunner",
    "SkyguardMission01IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission01GetGunnerDeclContractTests(unittest.TestCase):
    def test_mission01_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, GET_GUNNER),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, GET_GUNNER)
        self.assertIn("GetGunner", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, GET_GUNNER)
    ...
    def test_missing_get_gunner_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission01IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, GET_GUNNER)
        self.assertIn("GetGunner", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, GET_GUNNER)
        self.assertIn("GetGunner", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", GET_GUNNER)
        self.assertNotIn("BlueprintPure", GET_GUNNER)
        self.assertNotIn("Category", GET_GUNNER)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, GET_GUNNER)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, GET_GUNNER)
        self.assertIn("GetGunner", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = "\tvoid GetGunner() const;\n"
        missing_const = "\tASkyguardGunner* GetGunner();\n"
        extra_arg = (
            "\tASkyguardGunner* "
            "GetGunner(int32 Amount) const;\n"
        )
        extra_args = (
            "\tASkyguardGunner* "
            "GetGunner("
        ...
        renamed = "\tASkyguardGunner* GetReady() const;\n"
        short_name = "\tTObjectPtr<ASkyguardGunner> Gunner;\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, GET_GUNNER)
            self.assertIn("GetGunner", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_get_gunner_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, GET_GUNNER),
            GET_GUNNER,
        )
        self.assertTrue(has_declaration(section, GET_GUNNER))
        self.assertEqual(
            declaration_count(section, GET_GUNNER),
            1,
        )
        self.assertTrue(
            GET_GUNNER.startswith("ASkyguardGunner*"),
            GET_GUNNER,
        )
        self.assertTrue(
            GET_GUNNER.endswith(" const"),
            GET_GUNNER,
        )
        self.assertFalse(
            GET_GUNNER.endswith(";"),
        ...
        self.assertIn("GetGunner", GET_GUNNER)
        self.assertIn("GetGunner()", GET_GUNNER)
        self.assertIn(
            "ASkyguardGunner*",
            GET_GUNNER,
        ...
        self.assertNotIn("EnvironmentReadiness", GET_GUNNER)
        self.assertNotIn("MissionMapReadiness", GET_GUNNER)
        self.assertNotIn("IntegrationReadiness", GET_GUNNER)
        self.assertNotIn("TArray<", GET_GUNNER)
        self.assertNotIn("TObjectPtr", GET_GUNNER)
        self.assertNotIn("TSoftObjectPtr", GET_GUNNER)
        self.assertNotIn("INDEX_NONE", GET_GUNNER)
        self.assertNotIn("UFUNCTION", GET_GUNNER)
        self.assertNotIn("{", GET_GUNNER)
        self.assertNotIn("}", GET_GUNNER)
        self.assertNotIn("return ", GET_GUNNER)
        self.assertIn(" const", GET_GUNNER)
        self.assertNotIn(" const;", GET_GUNNER)
        self.assertNotIn("Root", GET_GUNNER)
        self.assertNotIn("Briefing", GET_GUNNER)
        self.assertNotIn("AudioDirector", GET_GUNNER)
        self.assertNotIn("RadioChatter", GET_GUNNER)
        self.assertNotIn("SortiePresentation", GET_GUNNER)
        self.assertNotIn("CampaignDefinition", GET_GUNNER)
        self.assertNotIn("MissionDefinition", GET_GUNNER)
        self.assertNotIn("Readiness;", GET_GUNNER)
        self.assertNotIn("bAutoInitialize", GET_GUNNER)
        self.assertNotIn("bAllowBoundedActorSpawning", GET_GUNNER)
        self.assertNotIn("bAutoLaunchAfterBriefing", GET_GUNNER)
        self.assertNotIn("PathfinderSpawnLocation", GET_GUNNER)
        self.assertNotIn("GetAircraft", GET_GUNNER)
        self.assertNotIn("BindRuntimeActors", GET_GUNNER)
        self.assertNotIn("HandleDroneCityImpact", GET_GUNNER)
        self.assertNotIn("ConfigureMissionDefinition", GET_GUNNER)
        self.assertNotIn("InitializePlayableMission", GET_GUNNER)
        self.assertNotIn("NotifyProtectedAssetFailed", GET_GUNNER)
        self.assertNotIn("SynchronizeRuntimeState", GET_GUNNER)
        self.assertNotIn("NotifyObjectiveProgress", GET_GUNNER)
        self.assertNotIn("IsCorePlayableReady", GET_GUNNER)
        self.assertNotIn("GetObjectiveRuntime", GET_GUNNER)
        self.assertNotIn("GetReadiness", GET_GUNNER)
        self.assertNotIn("GetPathfinder", GET_GUNNER)
        self.assertNotIn("IsVerticalLookInverted", GET_GUNNER)
        self.assertNotIn("GetMissionId", GET_GUNNER)
        self.assertNotIn("ValidateMissionContract", GET_GUNNER)
        self.assertNotIn("ConfigureFromMission", GET_GUNNER)
        self.assertNotIn("AdvanceBriefing", GET_GUNNER)
        self.assertNotIn("SetAssetsReady", GET_GUNNER)
        self.assertNotIn("AcknowledgeAndLaunch", GET_GUNNER)
        self.assertNotIn("CanLaunch", GET_GUNNER)
        self.assertNotIn("GetElapsedSeconds", GET_GUNNER)
        self.assertNotIn("GetBriefingState", GET_GUNNER)
        self.assertNotIn("GetMinimumWarmupSeconds", GET_GUNNER)
        self.assertNotIn("GetBriefingText", GET_GUNNER)
        self.assertNotIn("GetRadioChatter", GET_GUNNER)
        self.assertNotIn("GetPresentation", GET_GUNNER)
        self.assertNotIn("GetMissionTitle", GET_GUNNER)
        self.assertNotIn("AcknowledgeBriefing", GET_GUNNER)
        self.assertNotIn("LaunchSortie", GET_GUNNER)
        self.assertNotIn("HullCollider", GET_GUNNER)
        self.assertNotIn("OpticalTracker", GET_GUNNER)
        self.assertNotIn("WeaponServo", GET_GUNNER)
        self.assertNotIn("CountermeasurePod", GET_GUNNER)
        self.assertNotIn("MinHeightFromOriginCm", GET_GUNNER)
        self.assertNotIn("RadarNode", GET_GUNNER)
        self.assertNotIn("ESkyguardMission02WaveState", GET_GUNNER)
        self.assertNotIn("HarborIndustrial", GET_GUNNER)
        self.assertNotIn("MaxIntegrity", GET_GUNNER)
        self.assertNotIn("CurrentIntegrity", GET_GUNNER)
        self.assertNotIn("FillAndFinalize", GET_GUNNER)
        self.assertNotIn("FillAndFail", GET_GUNNER)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, GET_GUNNER)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_INTEGRATION} {GET_GUNNER}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{GET_GUNNER}\n}}\n"
        self.assertTrue(has_declaration(one_line, GET_GUNNER))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, GET_GUNNER),
            section,
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", GET_GUNNER)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_get_gunner_cpp_body(self) -> None:
        locked_only = f"{GET_GUNNER}\n"
        self.assertNotIn("{", GET_GUNNER)
        self.assertNotIn("}", GET_GUNNER)
        self.assertNotIn("return ", GET_GUNNER)
        ...
        self.assertNotIn("return false", GET_GUNNER)
        self.assertNotIn("return true", GET_GUNNER)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{GET_GUNNER}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_GUNNER)
        self.assertIn("GetGunner", GET_GUNNER)
        self.assertTrue(GET_GUNNER.startswith("ASkyguardGunner*"))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, GET_GUNNER)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, GET_GUNNER)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", GET_GUNNER)
        self.assertNotIn("CurrentIntegrity", GET_GUNNER)
        self.assertNotIn("SkyguardApacheAircraft.h", GET_GUNNER)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, GET_GUNNER)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", GET_GUNNER)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{GET_GUNNER}\n"
        self.assertEqual(
            require_declaration(locked_only, GET_GUNNER),
            GET_GUNNER,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_GUNNER)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 GetGunner method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{GET_GUNNER}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, GET_GUNNER.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, GET_GUNNER)

    def test_contract_is_get_gunner_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(GET_GUNNER.startswith("ASkyguardGunner*"))
        self.assertIn("GetGunner", GET_GUNNER)
        self.assertIn("GetGunner() const", GET_GUNNER)
        self.assertTrue(
            GET_GUNNER.endswith(" const"),
            GET_GUNNER,
        )
        self.assertFalse(GET_GUNNER.endswith(";"))
        self.assertNotIn("EnvironmentReadiness", GET_GUNNER)
        self.assertNotIn("MissionMapReadiness", GET_GUNNER)
        self.assertNotIn("IntegrationReadiness", GET_GUNNER)
        self.assertIn(UFUNCTION_INTEGRATION, section)

    def test_sibling_director_fields_do_not_satisfy_get_gunner(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, GET_GUNNER)
            )
            self.assertNotEqual(GET_GUNNER, leftover)
        self.assertIn(
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        self.assertNotIn("}", GET_GUNNER)
        self.assertNotIn("return ", GET_GUNNER)
        self.assertNotIn("return Other", GET_GUNNER)
        self.assertNotIn("return Gunner", GET_GUNNER)
