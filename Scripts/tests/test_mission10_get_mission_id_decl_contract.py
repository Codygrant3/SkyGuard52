...
# in the .cpp. This is leftover-safe Mission10
# Integration GetMissionId METHOD (inline body,
# declaration-only) on
# ASkyguardMission10IntegrationDirector.
# THIS is GetMissionId, NOT leftover Mission09
...
# the inline { return TEXT("M10_EvacuationFinale"); } body
# without locking a different body. Lock the MissionId
# token M10_EvacuationFinale as present in the inline
...
# Category is Skyguard|Mission10|Integration, not
...
# BindRuntimeActors, NOT leftover Mission09
...
class Mission10GetMissionIdDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission10|Integration", UFUNCTION_INTEGRATION)
    ...
    def test_get_mission_id_declaration_matches_origin_main(self) -> None:
        ...
        self.assertIn("GetMissionId()", REQUIRED_DECL)
        self.assertIn('TEXT("M10_EvacuationFinale")', REQUIRED_DECL)
