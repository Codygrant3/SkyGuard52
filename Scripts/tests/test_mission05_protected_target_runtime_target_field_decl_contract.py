...
# merge #665 #666 #668-#673, or open drafts #674-#1144.
...
class Mission05ProtectedTargetRuntimeTargetFieldDeclContractTests(unittest.TestCase):
    ...
    def test_target_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("ESkyguardMission05ProtectedTarget Target"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("OffshorePlatform;"), LOCKED_DECL)
        ...
        self.assertIn("ESkyguardMission05ProtectedTarget ", LOCKED_DECL)
        self.assertIn("OffshorePlatform", LOCKED_DECL)
        ...
        self.assertIn("ESkyguardMission05ProtectedTarget", LOCKED_DECL)
        self.assertTrue(
            LOCKED_DECL.startswith("ESkyguardMission05ProtectedTarget "),
            LOCKED_DECL,
        )
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("Target", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("ESkyguardMission05ProtectedTarget Target"))
    ...
    def test_contract_is_target_field_declaration_only(
        ...
        self.assertTrue(LOCKED_DECL.startswith("ESkyguardMission05ProtectedTarget Target"))
        self.assertIn("Target", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("OffshorePlatform;"))
