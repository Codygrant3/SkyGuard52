...
# Mission04 Integration IsCorePlayableReady
# on ASkyguardMission05IntegrationDirector. It is
...
# #636, or leftover Mission04 IsCorePlayableReady
# #657. Distinct from leftover briefing-widget /
...
# SynchronizeRuntimeState / InitializePlayableMission /
...
# GetSurvivingTargetCount / GetStormRainBeatKit /
# NotifyProtectedTargetDamage. Do not lock leftover Mission01
...
# leftover Mission01 IsCorePlayableReady
# #613, leftover Mission03 IsCorePlayableReady
# #636, leftover Mission04 IsCorePlayableReady
# #657, leftover Mission04 wave-state enum #bb22,
# leftover Mission05 wave-state enum #ad28, leftover
...
# leftover Mission05 StartNextWave #668 / NotifyThreatDestroyed
# #669. Skip leftover #664. Stay off leftover drafts
# #536–#673. Do not reopen closed #668/#669.
...
# Mission04 Integration #657, not leftover
# Mission05 Protection / Storm / Waves, not leftover
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission05IntegrationDirector::IsCorePlayableReady",
    "SkyguardMission05IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission05IsCorePlayableReadyDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        missing_const = "\tbool IsCorePlayableReady();\n"
        with_arg = "\tbool IsCorePlayableReady(float DeltaSeconds) const;\n"
        renamed = "\tbool IsPlayableReady() const;\n"
        short_name = "\tbool IsCoreReady() const;\n"
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("ASkyguardTempestBoss", IS_CORE_PLAYABLE_READY)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 IsCorePlayableReady method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission05 IsCorePlayableReady contains "
    ...
    def test_leftover_harbor_mission02_is_core_playable_ready_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
