...
# INDEX_NONE or lock GetReadiness
# construction in the .cpp. This is leftover-safe
# Mission02 Integration GetReadiness METHOD on
...
# an isolated Python GetReadiness
...
class Mission02GetReadinessDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        short_name = "\tbool GetReadiness() const;\n"
        leftover_m06_type = (
    ...
    def test_get_readiness_declaration_matches_origin_main(self) -> None:
        ...
        self.assertIn("FSkyguardMission02IntegrationReadiness", GET_READINESS)
        self.assertIn("GetReadiness", GET_READINESS)
        self.assertNotIn(";", GET_READINESS)
        self.assertIn("return Readiness;", section)
        self.assertIn(UFUNCTION_INTEGRATION, section)
        self.assertIn(" const", GET_READINESS)
        self.assertIn("()", GET_READINESS)
        ...
        self.assertNotIn("StartNextWave", GET_READINESS)
        self.assertNotIn("AdvanceConvoyByDistance", GET_READINESS)
        self.assertNotIn("NotifyConvoyDamage", GET_READINESS)
        self.assertNotIn("GetWaveState", GET_READINESS)
        self.assertNotIn("GetConvoyRouteState", GET_READINESS)
        self.assertNotIn("GetDayBeatKit", GET_READINESS)
        self.assertNotIn("GetNightBeatKit", GET_READINESS)
        self.assertNotIn("StartSearchlightWindow", GET_READINESS)
        self.assertNotIn("AdvanceSearchlightTrack", GET_READINESS)
        self.assertNotIn("NotifySubstationDamage", GET_READINESS)
        self.assertNotIn("GetRemainingThreatsInWave", GET_READINESS)
        self.assertNotIn("GetSearchlightRuntime", GET_READINESS)
        self.assertNotIn("GetSubstationIntegrity", GET_READINESS)
        self.assertNotIn("StartPayloadWindow", GET_READINESS)
        self.assertNotIn("AdvancePayloadWindow", GET_READINESS)
        self.assertNotIn("TryJamActivePayload", GET_READINESS)
        self.assertNotIn("NotifyAirfieldTargetDamage", GET_READINESS)
        self.assertNotIn("GetPayloadWindow", GET_READINESS)
        self.assertNotIn("GetTargetRuntime", GET_READINESS)
        self.assertNotIn("GetSurvivingTargetCount", GET_READINESS)
        self.assertNotIn("GetDayBeatKind", GET_READINESS)
        self.assertNotIn("GetDayBeatIndex", GET_READINESS)
        self.assertNotIn("TickDayBeatKit", GET_READINESS)
        self.assertNotIn("HandleBossPhaseChanged", GET_READINESS)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", GET_READINESS)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", GET_READINESS)
        self.assertNotIn("ASkyguardMission06IntegrationDirector", GET_READINESS)
        self.assertNotIn("ASkyguardMission07IntegrationDirector", GET_READINESS)
        self.assertNotIn("ESkyguardMission06WaveState", GET_READINESS)
        self.assertNotIn("ESkyguardMission07WaveState", GET_READINESS)
        self.assertNotIn("ESkyguardMission08WaveState", GET_READINESS)
        self.assertNotIn("ESkyguardMission09WaveState", GET_READINESS)
        self.assertNotIn("ESkyguardMission07ProtectedTarget", GET_READINESS)
        self.assertNotIn("ESkyguardMission08ProtectedTarget", GET_READINESS)
        self.assertNotIn("ESkyguardMission09ProtectedTarget", GET_READINESS)
        self.assertNotIn("FSkyguardMission07ProtectedTargetRuntime", GET_READINESS)
        self.assertNotIn("FSkyguardMission08ProtectedTargetRuntime", GET_READINESS)
        self.assertNotIn("FSkyguardMission09ProtectedTargetRuntime", GET_READINESS)
        self.assertNotIn("FSkyguardMission08IntegrationReadiness", GET_READINESS)
        self.assertNotIn("FSkyguardMission09IntegrationReadiness", GET_READINESS)
        self.assertNotIn("FSkyguardMission09PoolRuntime", GET_READINESS)
        self.assertNotIn("FSkyguardMission09PoolBudget", GET_READINESS)
        self.assertNotIn("ASkyguardMission08IntegrationDirector", GET_READINESS)
        self.assertNotIn("BindCampaignRuntime", GET_READINESS)
        self.assertNotIn("GetPoolRuntime", GET_READINESS)
        self.assertNotIn("ESkyguardSearchSector", GET_READINESS)
        self.assertNotIn("FSkyguardSearchTrackRuntime", GET_READINESS)
        self.assertNotIn("ClassifyFalseTrack", GET_READINESS)
        self.assertNotIn("ConfirmRadarGhostIdentification", GET_READINESS)
        self.assertNotIn("NotifyProtectedTargetDamage", GET_READINESS)
        self.assertNotIn("AdvanceReinforcementTimer", GET_READINESS)
        self.assertNotIn("GetSearchSector", GET_READINESS)
        self.assertNotIn("GetClassifiedFalseTrackCount", GET_READINESS)
        self.assertNotIn("IsHostileContactConfirmed", GET_READINESS)
        self.assertNotIn("GetProtectedTarget", GET_READINESS)
        self.assertNotIn("GetReinforcementTimeRemaining", GET_READINESS)
        self.assertNotIn("GetNightBeatKind", GET_READINESS)
        self.assertNotIn("GetNightBeatIndex", GET_READINESS)
        self.assertNotIn("TickNightBeatKit", GET_READINESS)
        self.assertNotIn("ESkyguardAirfieldTarget", GET_READINESS)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", GET_READINESS)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", GET_READINESS)
        self.assertNotIn("ConvoyRuntimeAnchor", GET_READINESS)
        self.assertNotIn("RoadHunterSpawnLocation", GET_READINESS)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", GET_READINESS)
        self.assertNotIn("ASkyguardMission02IntegrationDirector", GET_READINESS)
        ...
        self.assertNotIn("NotifyThreatDestroyed", GET_READINESS)
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        self.assertNotIn("550.f", GET_READINESS)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", GET_READINESS)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", GET_READINESS)
        self.assertNotIn("ASkyguardIronRainBoss", GET_READINESS)
        self.assertNotIn("ASkyguardRadarGhostBoss", GET_READINESS)
        self.assertNotIn("ASkyguardTempestBoss", section)
        self.assertNotIn("ASkyguardLastFlightBoss", GET_READINESS)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 GetReadiness method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                GET_READINESS.lower(),
                "mission02 GetReadiness contains "
    ...
    def test_leftover_mission10_get_readiness_does_not_satisfy(
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m10_type, GET_READINESS)
        self.assertIn("GetReadiness", str(raised.exception))
        self.assertNotIn(
            "cursor/mission10-get-readiness-decl-contract-c332",
            GET_READINESS,
    ...
    def test_leftover_handle_drone_city_impact_does_not_satisfy(self) -> None:
        ...
        self.assertIn("GetReadiness", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, GET_READINESS))
        locked_only = f"{GET_READINESS}\n"
    ...
    def test_leftover_mission07_get_readiness_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m07_type, GET_READINESS)
        self.assertIn("GetReadiness", str(raised.exception))
    ...
    def test_sibling_mission08_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("NotifyThreatDestroyed", GET_READINESS)
        self.assertNotIn("StartNextWave", GET_READINESS)
        self.assertNotIn("StartHoistWindow", GET_READINESS)
        self.assertNotIn("AdvanceHoistWindow", GET_READINESS)
        self.assertNotIn("ValidateWeaponRelease", GET_READINESS)
        self.assertNotIn("IsCorePlayableReady", GET_READINESS)
        self.assertNotIn("SynchronizeRuntimeState", GET_READINESS)
        self.assertNotIn("GetObjectiveRuntime", GET_READINESS)
        self.assertNotIn("GetWaveState", GET_READINESS)
    ...
    def test_leftover_mission08_get_readiness_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m08_type, GET_READINESS)
        self.assertIn("GetReadiness", str(raised.exception))
        self.assertNotIn(
            "cursor/mission08-get-readiness-decl-contract-c332",
            GET_READINESS,
    ...
    def test_leftover_mission09_get_readiness_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m09_type, GET_READINESS)
        self.assertIn("GetReadiness", str(raised.exception))
        self.assertNotIn(
            "cursor/mission09-get-readiness-decl-contract-c332",
            GET_READINESS,
    ...
    def test_contract_does_not_relock_leftover_mission10_route_phase_enum(
        ...
        self.assertNotIn("GetRoutePhase", GET_READINESS)
        self.assertNotIn("Waves", UFUNCTION_INTEGRATION)
    ...
    def test_contract_does_not_relock_leftover_mission10_protected_group(
        ...
        self.assertNotIn("Protection", UFUNCTION_INTEGRATION)
        self.assertNotIn("GetProtectedGroup", GET_READINESS)
    ...
    def test_leftover_mission10_sibling_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("HandleDroneCityImpact", GET_READINESS)
        self.assertNotIn("UFUNCTION", GET_DAY_BEAT_KIT)
        self.assertNotIn("StartPhaseWave", GET_READINESS)
        self.assertNotIn("InitializePlayableMission", GET_READINESS)
        self.assertNotIn("ValidateWeaponRelease", GET_READINESS)
        self.assertNotIn("GetRoutePhase", GET_READINESS)
        self.assertIn(
