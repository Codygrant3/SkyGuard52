...
# INDEX_NONE or lock RescueVesselAnchor
# construction in the .cpp. This is leftover-safe
# Mission08 RescueVesselAnchor FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps) on
# ASkyguardMission08IntegrationDirector. It is
# NOT leftover Mission07 Root FIELD #1011 / branch
# cursor/mission07-root-field-decl-contract-c332,
# NOT leftover Mission08 Root #1044 / branch
# cursor/mission08-root-field-decl-
# contract-c332, NOT leftover Mission08
# RescueHelicopterAnchor #1045 / branch cursor/
# mission08-rescue-helicopter-anchor-field-decl-
# contract-c332, NOT leftover Mission08
# HoistCableAnchor #1046 / branch cursor/
# mission08-hoist-cable-anchor-field-decl-
# contract-c332, NOT leftover Mission08
# SurvivorsAnchor (this-wave sibling) / branch
# cursor/mission08-survivors-anchor-field-decl-
# contract-c332, NOT leftover Mission08
# RaftsAnchor (this-wave sibling) / branch
# cursor/mission08-rafts-anchor-field-decl-
# contract-c332, NOT leftover Mission10
# HighwayConvoyAnchor / branch cursor/
# mission10-highway-convoy-anchor-field-decl-
# contract-c332, NOT leftover Mission08
# GetProtectedTarget #746, NOT leftover Mission06 Root field
...
# methods.
# not leftover Mission08 Root #1044 /
# leftover Mission08 RescueHelicopterAnchor #1045 /
# leftover Mission08 HoistCableAnchor #1046 /
# SurvivorsAnchor (this-wave sibling) /
# RaftsAnchor (this-wave sibling) /
# Briefing / AudioDirector /
...
# not leftover Mission07 Root FIELD #1011.
# not leftover Mission10 HighwayConvoyAnchor.
...
# FSkyguardHoistWindowRuntime, FSkyguardMission08ProtectedTargetRuntime,
# private UPROPERTY(Transient), or Mission01 / Mission02 /
# Mission03 / Mission04 / Mission05 / Mission06 / Mission07 /
# Mission09-10 directors. Do not parse leftover
# FSkyguardSearchTrackRuntime / leftover
# FSkyguardMission07ProtectedTargetRuntime /
# leftover FSkyguardAirfieldTargetRuntime /
# leftover FSkyguardPayloadWindowRuntime.
# Category is Skyguard|Mission08|Rescue, not
...
# Mission09 / Mission10, not leftover Mission01
# Root #574, not leftover Mission02 Root #845,
# not leftover Mission10 Root #786,
# not leftover Mission08 Root #1044 / RescueHelicopterAnchor #1045 / HoistCableAnchor #1046,
# not leftover Mission07 Root #1011,
# not leftover Mission10 HighwayConvoyAnchor,
# not leftover Mission09
# Protection #763, Payload / Targets / Objectives /
# Search / Waves / Hoist / Safety / Boss / Destruction /
# Briefing / Performance / Evacuation / Integration,
# not Environment,
...
# drafts #674-#1046 including leftover Mission07
# director Root #1011 through Readiness #1027 and
# leftover Mission07 readiness-struct #1028-#1043,
# leftover Mission08 Blueprint UFUNCTION methods
# #729-#749, leftover Apache
...
# drafts #674-#1046 including leftover Mission03
# ObjectiveCount #905 / WaveCount #906 / RadioLineCount #904,
# leftover Mission07 director Root #1011 through
# Readiness #1027, leftover Mission07 readiness-struct
# #1028-#1043, leftover Mission08 Blueprint UFUNCTION
# methods #729-#749, leftover Mission08
# director Root #1044 / RescueHelicopterAnchor
# #1045 / HoistCableAnchor #1046. Lock leftover Mission05
# closed-without-merge #665 #666 #668-#673. Do not
# reopen leftover #664. Do not lock leftover Mission08
# Root #1044 / leftover Mission08 RescueHelicopterAnchor
# #1045 / leftover Mission08 HoistCableAnchor #1046.
# Do not lock leftover Mission08 SurvivorsAnchor
# (this-wave sibling). Do not lock leftover
# Mission08 RaftsAnchor (this-wave sibling).
...
LOCKED_DECL = RESCUE_VESSEL_ANCHOR
...
# an isolated Python RescueVesselAnchor
...
class Mission08RescueVesselAnchorFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("RescueVesselAnchor", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_rescue_vessel_anchor_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn('Category="Skyguard|Mission08|Rescue"', section)
        self.assertTrue(
            has_declaration(section, LOCKED_DECL),
            section,
        )
        ...
        self.assertIn("Skyguard|Mission08|Rescue", UPROPERTY_MISSION08)
    ...
    def test_rescue_vessel_anchor_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertIn("RescueVesselAnchor", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("RescueVesselAnchor;", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 RescueVesselAnchor field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 RescueVesselAnchor field contains "
    ...
    def test_contract_is_rescue_vessel_anchor_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_rescue_vessel_anchor(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission08_rescue_vessel_anchor_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_rescue_vessel_anchor_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_hoist_cable_anchor_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_rescue_helicopter_anchor_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_survivors_anchor_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_rafts_anchor_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_highway_convoy_anchor_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        leftover_56_64 = (
    ...
    def test_readiness_struct_does_not_satisfy_rescue_vessel_anchor(self) -> None:
        leftover = (
    ...
    def test_hoist_window_runtime_struct_does_not_satisfy_rescue_vessel_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_protected_target_runtime_struct_does_not_satisfy_rescue_vessel_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_storm_runtime_struct_does_not_satisfy_rescue_vessel_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_airfield_target_runtime_struct_does_not_satisfy_rescue_vessel_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_struct_does_not_satisfy_rescue_vessel_anchor(self) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_declaration_accepts_origin_main_default_forms(self) -> None:
        ...
        stem = "TObjectPtr<USceneComponent> RescueVesselAnchor"
