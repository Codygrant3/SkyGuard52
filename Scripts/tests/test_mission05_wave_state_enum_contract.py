...
# Protected-target enum (#227), runtime defaults (#224), and storm
# runtime (#212) are sibling Mission 05 contracts.
LOCKED_SCRIPTS = (
...
# Apache CPG storm-sortie wave progression. Not Yak-52 intercept states.
LIVE_WAVE_STATES = [
    "Briefing",
    "AwaitingWave",
    "WaveActive",
...
# Protected-target (#227/#224), storm runtime (#212), and readiness
...
class Mission05WaveStateEnumContractTests(unittest.TestCase):
    ...
    def test_missing_enum_fails_closed(self) -> None:
        ...
        self.assertIn("ESkyguardMission05WaveState", str(raised.exception))
    ...
    def test_enumerators_match_live_order(self) -> None:
        ...
        body = enum_body(header, "ESkyguardMission05WaveState")
