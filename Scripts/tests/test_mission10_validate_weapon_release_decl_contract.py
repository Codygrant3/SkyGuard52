...
# INDEX_NONE or lock ValidateWeaponRelease
# construction in the .cpp. This is leftover-safe
# Mission10 Safety ValidateWeaponRelease METHOD
# on ASkyguardMission10IntegrationDirector. It is
# NOT leftover Mission09 NotifyThreatDestroyed
# #754 / branch cursor/mission09-notify-
# threat-destroyed-decl-contract-c332, NOT leftover
# Mission08 NotifyThreatDestroyed
# #733 / branch cursor/mission08-notify-
# threat-destroyed-decl-contract-c332, NOT leftover
# Mission07 NotifyThreatDestroyed #713,
# NOT leftover Mission06 NotifyThreatDestroyed
# #689, NOT leftover Mission05 NotifyThreatDestroyed
# #669, NOT leftover Mission01 / Mission03 /
# Mission04 NotifyThreatDestroyed, NOT leftover
...
# leftover Mission08 NotifyThreatDestroyed #733,
# leftover Mission09 NotifyThreatDestroyed #754,
# leftover Mission07 NotifyThreatDestroyed #713,
...
# origin/main is a split-line method
# (bool ValidateWeaponRelease, float
# CivilianSeparationMeters, bool
...
# Hoist / Waves / Rescue / Boss / Destruction /
...
# not leftover Mission10 Integration / Waves /
...
# NotifyThreatDestroyed #733. Do not reopen
# leftover Mission08 ValidateWeaponRelease #735.
# Do not reopen leftover Mission09 NotifyThreatDestroyed
# #754. Do not reopen leftover Mission10 route-
...
LEFTOVER_MISSION08_VALIDATE_WEAPON_RELEASE = (
    "bool ValidateWeaponRelease("
...
# an isolated Python ValidateWeaponRelease
...
LEFTOVER_MISSION08_VALIDATE_WEAPON_RELEASE_NOT_LOCKED = (
    LEFTOVER_MISSION08_VALIDATE_WEAPON_RELEASE,
    "FriendlySeparationMeters",
    "bShotIntersectsFriendlyCorridor",
    "test_mission08_validate_weapon_release_decl_contract.py",
    "cursor/mission08-validate-weapon-release-decl-contract-c332",
    "ASkyguardMission08IntegrationDirector",
    "SkyguardMission08IntegrationDirector.h",
    'Category="Skyguard|Mission08|Safety"',
)
LEFTOVER_MISSION08_NOTIFY_THREAT_DESTROYED_NOT_LOCKED = (
    "test_mission08_notify_threat_destroyed_decl_contract.py",
    "ASkyguardMission08IntegrationDirector",
    "SkyguardMission08IntegrationDirector.h",
    'Category="Skyguard|Mission08|Waves"',
    "cursor/mission08-notify-threat-destroyed-decl-contract-c332",
)
LEFTOVER_MISSION09_NOTIFY_THREAT_DESTROYED_NOT_LOCKED = (
    "test_mission09_notify_threat_destroyed_decl_contract.py",
    "ASkyguardMission09IntegrationDirector",
    "SkyguardMission09IntegrationDirector.h",
    'Category="Skyguard|Mission09|Waves"',
    "cursor/mission09-notify-threat-destroyed-decl-contract-c332",
)
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission10IntegrationDirector::ValidateWeaponRelease",
    "SkyguardMission10IntegrationDirector.cpp",
    "SkyguardMission09IntegrationDirector.cpp",
    "SkyguardMission08IntegrationDirector.cpp",
    "SkyguardMission06IntegrationDirector.cpp",
...
class Mission10ValidateWeaponReleaseDeclContractTests(unittest.TestCase):
    def test_mission10_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, VALIDATE_WEAPON_RELEASE),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, VALIDATE_WEAPON_RELEASE)
        self.assertIn("ValidateWeaponRelease", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, VALIDATE_WEAPON_RELEASE)
    ...
    def test_missing_validate_weapon_release_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission10IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, VALIDATE_WEAPON_RELEASE)
        self.assertIn("ValidateWeaponRelease", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, VALIDATE_WEAPON_RELEASE)
        self.assertIn("ValidateWeaponRelease", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("BlueprintCallable", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("Category", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("BlueprintPure", UFUNCTION_SAFETY)
        ...
        self.assertIn("BlueprintCallable", UFUNCTION_SAFETY)
        ...
        self.assertNotIn("Evacuation", UFUNCTION_SAFETY)
        self.assertNotIn("Campaign", UFUNCTION_SAFETY)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, VALIDATE_WEAPON_RELEASE)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, VALIDATE_WEAPON_RELEASE)
        self.assertIn("ValidateWeaponRelease", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = "\tvoid ValidateWeaponRelease(\n\t\tfloat CivilianSeparationMeters,\n\t\tbool bShotIntersectsCivilianCorridor);\n"
        as_const = "\tbool ValidateWeaponRelease(\n\t\tfloat CivilianSeparationMeters,\n\t\tbool bShotIntersectsCivilianCorridor) const;\n"
        with_arg = "\tbool ValidateWeaponRelease();\n"
        renamed = "\tbool ValidateRelease();\n"
        short_name = "\tbool StartPhaseWave();\n"
        ...
        leftover_m08_release = f"\t{LEFTOVER_MISSION08_VALIDATE_WEAPON_RELEASE}\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, VALIDATE_WEAPON_RELEASE)
            self.assertIn("ValidateWeaponRelease", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_initialize_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, VALIDATE_WEAPON_RELEASE),
            VALIDATE_WEAPON_RELEASE,
        )
        self.assertTrue(has_declaration(section, VALIDATE_WEAPON_RELEASE))
        self.assertEqual(
            declaration_count(section, VALIDATE_WEAPON_RELEASE),
            1,
        )
        self.assertTrue(
            VALIDATE_WEAPON_RELEASE.startswith("bool "),
            VALIDATE_WEAPON_RELEASE,
        )
        self.assertTrue(
            VALIDATE_WEAPON_RELEASE.endswith(";"),
            VALIDATE_WEAPON_RELEASE,
        )
        self.assertIn("ValidateWeaponRelease", VALIDATE_WEAPON_RELEASE)
        self.assertIn("float CivilianSeparationMeters", VALIDATE_WEAPON_RELEASE)
        self.assertIn(
            "bool bShotIntersectsCivilianCorridor",
            VALIDATE_WEAPON_RELEASE,
        )
        self.assertNotIn("FriendlySeparationMeters", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn(
            "bShotIntersectsFriendlyCorridor",
            VALIDATE_WEAPON_RELEASE,
        )
        self.assertNotIn("TArray<", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("TObjectPtr", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("TSoftObjectPtr", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("INDEX_NONE", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("UFUNCTION", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("{", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("}", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("return ", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("const;", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("Root", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("Briefing", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("AudioDirector", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("RadioChatter", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("SortiePresentation", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("CampaignDefinition", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("MissionDefinition", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("Readiness", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("bAutoInitialize", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("bAllowBoundedActorSpawning", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("bAutoLaunchAfterBriefing", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("PathfinderSpawnLocation", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetAircraft", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("BindRuntimeActors", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("HandleDroneCityImpact", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("StartNextWave", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("InitializePlayableMission", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("AdvanceConvoyByDistance", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("NotifyConvoyDamage", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetWaveState", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetConvoyRouteState", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetDayBeatKit", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetNightBeatKit", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("StartSearchlightWindow", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("AdvanceSearchlightTrack", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("NotifySubstationDamage", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetRemainingThreatsInWave", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetSearchlightRuntime", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetSubstationIntegrity", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("StartPayloadWindow", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("AdvancePayloadWindow", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("TryJamActivePayload", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("NotifyAirfieldTargetDamage", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetPayloadWindow", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetTargetRuntime", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetSurvivingTargetCount", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetDayBeatKind", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetDayBeatIndex", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("TickDayBeatKit", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("HandleBossPhaseChanged", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ASkyguardMission06IntegrationDirector", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ESkyguardMission06WaveState", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ESkyguardMission07WaveState", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ASkyguardMission07IntegrationDirector", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ASkyguardMission08IntegrationDirector", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ESkyguardMission08WaveState", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ESkyguardMission09WaveState", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ESkyguardMission09ProtectedTarget", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("FSkyguardMission09ProtectedTargetRuntime", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("FSkyguardMission09PoolRuntime", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("FSkyguardMission09PoolBudget", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("BindCampaignRuntime", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetPoolRuntime", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("IronRainSpawnLocation", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ESkyguardMission08ProtectedTarget", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("FSkyguardMission08ProtectedTargetRuntime", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("FSkyguardHoistWindowRuntime", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("StartHoistWindow", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("AdvanceHoistWindow", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("NotifyThreatDestroyed", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetHoistRuntime", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetRejectedWeaponReleases", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetStormRainBeatKit", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ApplyStormRainPlayContract", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetStormRainBeatKind", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("TickStormRainBeatKit", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("RescueHelicopterAnchor", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("LifelineHunterSpawnLocation", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ESkyguardMission07ProtectedTarget", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("FSkyguardMission07ProtectedTargetRuntime", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ESkyguardSearchSector", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("FSkyguardSearchTrackRuntime", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ClassifyFalseTrack", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ConfirmRadarGhostIdentification", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("NotifyProtectedTargetDamage", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("AdvanceReinforcementTimer", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetSearchSector", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetClassifiedFalseTrackCount", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("IsHostileContactConfirmed", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetProtectedTarget", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetReinforcementTimeRemaining", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetNightBeatKind", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetNightBeatIndex", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("TickNightBeatKit", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ESkyguardAirfieldTarget", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ConvoyRuntimeAnchor", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("RoadHunterSpawnLocation", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ASkyguardMission02IntegrationDirector", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ConfigureMissionDefinition", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("NotifyObjectiveProgress", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("NotifyProtectedAssetFailed", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("SynchronizeRuntimeState", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("IsCorePlayableReady", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetReadiness", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetObjectiveRuntime", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetGunner", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetPathfinder", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetMissionId", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ValidateMissionContract", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ConfigureFromMission", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("AdvanceBriefing", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("SetAssetsReady", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("AcknowledgeAndLaunch", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("CanLaunch", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetElapsedSeconds", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetBriefingState", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetMinimumWarmupSeconds", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetBriefingText", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetRadioChatter", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetPresentation", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetMissionTitle", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("AcknowledgeBriefing", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("LaunchSortie", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("HullCollider", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("OpticalTracker", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("WeaponServo", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("CountermeasurePod", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("MinHeightFromOriginCm", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("RadarNode", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ESkyguardMission02WaveState", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("HarborIndustrial", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("MaxIntegrity", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("CurrentIntegrity", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("FillAndFinalize", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("FillAndFail", VALIDATE_WEAPON_RELEASE)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, VALIDATE_WEAPON_RELEASE)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_SAFETY} {VALIDATE_WEAPON_RELEASE}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{VALIDATE_WEAPON_RELEASE}\n}}\n"
        self.assertTrue(has_declaration(one_line, VALIDATE_WEAPON_RELEASE))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, VALIDATE_WEAPON_RELEASE),
            section,
    ...
    def test_environment_category_does_not_satisfy_safety(self) -> None:
        ...
        self.assertNotEqual(leftover_m09, UFUNCTION_SAFETY)
        self.assertNotEqual(leftover_m09_waves, UFUNCTION_SAFETY)
        self.assertNotEqual(leftover_m10_integration, UFUNCTION_SAFETY)
        self.assertNotEqual(leftover_m10_waves, UFUNCTION_SAFETY)
        self.assertNotEqual(leftover_m10_protection, UFUNCTION_SAFETY)
    ...
    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        locked_only = f"{VALIDATE_WEAPON_RELEASE}\n"
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, VALIDATE_WEAPON_RELEASE)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", VALIDATE_WEAPON_RELEASE)
        section = public_section(origin_main_header())
    ...
    def test_contract_does_not_lock_initialize_cpp_body(self) -> None:
        ...
        self.assertNotIn("return false", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("return true", VALIDATE_WEAPON_RELEASE)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{VALIDATE_WEAPON_RELEASE}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, VALIDATE_WEAPON_RELEASE)
        self.assertIn("ValidateWeaponRelease", VALIDATE_WEAPON_RELEASE)
        self.assertTrue(VALIDATE_WEAPON_RELEASE.startswith("bool "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, VALIDATE_WEAPON_RELEASE)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, VALIDATE_WEAPON_RELEASE)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("CurrentIntegrity", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("SkyguardApacheAircraft.h", VALIDATE_WEAPON_RELEASE)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", VALIDATE_WEAPON_RELEASE)
    ...
    def test_minimum_civilian_separation_is_not_harbor_40_80(self) -> None:
        ...
        self.assertNotIn("550.f", VALIDATE_WEAPON_RELEASE)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{VALIDATE_WEAPON_RELEASE}\n"
        self.assertEqual(
            require_declaration(locked_only, VALIDATE_WEAPON_RELEASE),
            VALIDATE_WEAPON_RELEASE,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, VALIDATE_WEAPON_RELEASE)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ASkyguardIronRainBoss", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ASkyguardRadarGhostBoss", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("ASkyguardTempestBoss", section)
        self.assertNotIn("ASkyguardLastFlightBoss", VALIDATE_WEAPON_RELEASE)
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{VALIDATE_WEAPON_RELEASE}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, VALIDATE_WEAPON_RELEASE.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, VALIDATE_WEAPON_RELEASE)

    def test_contract_is_validate_weapon_release_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(VALIDATE_WEAPON_RELEASE.startswith("bool "))
        self.assertIn("ValidateWeaponRelease", VALIDATE_WEAPON_RELEASE)
        self.assertTrue(VALIDATE_WEAPON_RELEASE.endswith(";"))
        self.assertIn(UFUNCTION_SAFETY, section)

    def test_sibling_director_fields_do_not_satisfy_validate_weapon_release(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, VALIDATE_WEAPON_RELEASE)
            )
            self.assertNotEqual(VALIDATE_WEAPON_RELEASE, leftover)
        self.assertIn(
    ...
    def test_leftover_handle_drone_city_impact_does_not_satisfy(self) -> None:
        ...
        self.assertIn("ValidateWeaponRelease", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, VALIDATE_WEAPON_RELEASE))
        locked_only = f"{VALIDATE_WEAPON_RELEASE}\n"
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tbool ValidateWeaponRelease(\n\t\tfloat CivilianSeparationMeters,\n\t\tbool bShotIntersectsCivilianCorridor) { return false; }\n"
            "};\n"
        )
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_validate_weapon_release"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission10_route_phase_enum(
        ...
        self.assertNotIn("GetRoutePhase", VALIDATE_WEAPON_RELEASE)
    ...
    def test_contract_does_not_relock_leftover_mission10_protected_group(
        ...
        self.assertNotIn("Protection", UFUNCTION_SAFETY)
        self.assertNotIn("GetProtectedGroup", VALIDATE_WEAPON_RELEASE)
    ...
    def test_leftover_mission10_sibling_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("HandleDroneCityImpact", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("UFUNCTION", GET_DAY_BEAT_KIT)
        self.assertNotIn("StartPhaseWave", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("InitializePlayableMission", VALIDATE_WEAPON_RELEASE)
        self.assertNotIn("GetRoutePhase", VALIDATE_WEAPON_RELEASE)


    def test_contract_does_not_relock_leftover_mission03_notify_threat_destroyed(
        self,
    ) -> None:
        locked_only = f"{VALIDATE_WEAPON_RELEASE}\n"
    ...
    def test_contract_does_not_relock_leftover_mission07_notify_threat_destroyed(
        self,
    ) -> None:
        locked_only = f"{VALIDATE_WEAPON_RELEASE}\n"
    ...
    def test_contract_does_not_relock_leftover_mission08_validate_weapon_release(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission08IntegrationDirector "
            ...
            "\tUFUNCTION(BlueprintCallable, "
            'Category="Skyguard|Mission08|Safety")\n'
            f"\t{LEFTOVER_MISSION08_VALIDATE_WEAPON_RELEASE}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover)
        ...
        self.assertIn("missing", str(raised.exception).lower())
        locked_only = f"{VALIDATE_WEAPON_RELEASE}\n"
        for token in LEFTOVER_MISSION08_VALIDATE_WEAPON_RELEASE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, VALIDATE_WEAPON_RELEASE)
        self.assertIn(
            "Scripts/tests/test_mission08_validate_weapon_release"
    ...
    def test_contract_does_not_relock_leftover_mission08_notify_threat_destroyed(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission08IntegrationDirector "
        ...
        self.assertIn("missing", str(raised.exception).lower())
        locked_only = f"{VALIDATE_WEAPON_RELEASE}\n"
        for token in LEFTOVER_MISSION08_NOTIFY_THREAT_DESTROYED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, VALIDATE_WEAPON_RELEASE)
        self.assertIn(
            "Scripts/tests/test_mission08_notify_threat_destroyed"
    ...
    def test_contract_does_not_relock_leftover_mission09_notify_threat_destroyed(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission09IntegrationDirector "
        ...
        self.assertIn("missing", str(raised.exception).lower())
        locked_only = f"{VALIDATE_WEAPON_RELEASE}\n"
        for token in LEFTOVER_MISSION09_NOTIFY_THREAT_DESTROYED_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, VALIDATE_WEAPON_RELEASE)
        self.assertIn(
    ...
    def test_sibling_mission10_initialize_does_not_satisfy(self) -> None:
        ...
        self.assertNotEqual(leftover_integration, UFUNCTION_SAFETY)
        self.assertNotIn("Integration", UFUNCTION_SAFETY)
