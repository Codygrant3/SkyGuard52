...
# INDEX_NONE or lock Integrity construction in the
...
# (`float Integrity = 100.f;`); accept that
...
# only. Keep Integrity distinct from sibling
# WeakPointId (already drafted) and unused sibling
# fields bExposed / bDestroyed / MaxIntegrity and
# leftover accept-weapon flags on this component.
# Do not lock leftover accept flags. Do not lock
# leftover ApplyWeaponDamage / SetExposed /
# AcceptsWeapon methods (sibling-only). This is
# not leftover Apache MaxIntegrity /
# CurrentIntegrity (those are Harbor-sensitive on
# ASkyguardApacheAircraft). WeakPoint
# Integrity = 100.f and MaxIntegrity = 100.f are
# not Harbor 40/80. Do not treat 100.f as Harbor.
...
# #107-#565. Harbor interval retune tokens fail
...
# leftover WeakPointId field contract, leftover
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "USkyguardBossWeakPointComponent::Integrity",
    "SkyguardBossWeakPointComponent.cpp",
...
class WeakPointIntegrityFieldDeclContractTests(unittest.TestCase):
    def test_weak_point_component_class_exists(self) -> None:
        ...
        self.assertTrue(has_declaration(section, INTEGRITY_FIELD), section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, INTEGRITY_FIELD)
        self.assertIn("Integrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(has_declaration(section, INTEGRITY_FIELD))
    ...
    def test_missing_integrity_declaration_fails_closed(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, INTEGRITY_FIELD)
        self.assertIn("Integrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, INTEGRITY_FIELD)
        self.assertIn("Integrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertTrue(has_declaration(section, INTEGRITY_FIELD), section)
        self.assertNotIn("UPROPERTY", INTEGRITY_FIELD)
        self.assertNotIn("VisibleAnywhere", INTEGRITY_FIELD)
        self.assertNotIn("BlueprintReadOnly", INTEGRITY_FIELD)
        self.assertNotIn("Category", INTEGRITY_FIELD)
        ...
        self.assertNotIn("ClampMin", UPROPERTY_BOSS)
        self.assertIn("Skyguard|Boss", UPROPERTY_BOSS)
        self.assertIn("VisibleAnywhere", UPROPERTY_BOSS)
        self.assertIn("BlueprintReadOnly", UPROPERTY_BOSS)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, INTEGRITY_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, INTEGRITY_FIELD)
        self.assertIn("Integrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        missing_default = "\tfloat Integrity;\n"
        zero_assigned = "\tfloat Integrity = 0.f;\n"
        index_none = "\tfloat Integrity = INDEX_NONE;\n"
        wrong_type = "\tint32 Integrity = 100.f;\n"
        name_type = "\tFName Integrity = 100.f;\n"
        text_type = "\tFText Integrity = 100.f;\n"
        bool_type = "\tbool Integrity = 100.f;\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, INTEGRITY_FIELD)
            self.assertIn("Integrity", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_integrity_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(has_declaration(section, INTEGRITY_FIELD))
        self.assertEqual(declaration_count(section, INTEGRITY_FIELD), 1)
        self.assertTrue(INTEGRITY_FIELD.startswith("float "), INTEGRITY_FIELD)
        self.assertTrue(INTEGRITY_FIELD.endswith(";"), INTEGRITY_FIELD)
        self.assertIn("Integrity", INTEGRITY_FIELD)
        self.assertIn("100.f", INTEGRITY_FIELD)
        self.assertIn(" = ", INTEGRITY_FIELD)
        self.assertNotIn("INDEX_NONE", INTEGRITY_FIELD)
        self.assertNotIn("NAME_None", INTEGRITY_FIELD)
        self.assertNotIn("TEXT(", INTEGRITY_FIELD)
        self.assertNotIn("UFUNCTION", INTEGRITY_FIELD)
        self.assertNotIn("{", INTEGRITY_FIELD)
        self.assertNotIn("}", INTEGRITY_FIELD)
        self.assertNotIn("return ", INTEGRITY_FIELD)
        self.assertNotIn("ApplyWeaponDamage", INTEGRITY_FIELD)
        self.assertNotIn("SetExposed", INTEGRITY_FIELD)
        self.assertNotIn("AcceptsWeapon", INTEGRITY_FIELD)
        self.assertNotIn("MaxIntegrity", INTEGRITY_FIELD)
        self.assertNotIn("WeakPointId", INTEGRITY_FIELD)
        self.assertNotIn("CurrentIntegrity", INTEGRITY_FIELD)
        self.assertNotIn("RemainingIntegrity", INTEGRITY_FIELD)
        self.assertNotIn("bExposed", INTEGRITY_FIELD)
        self.assertNotIn("bDestroyed", INTEGRITY_FIELD)
        self.assertNotIn("HullCollider", INTEGRITY_FIELD)
        self.assertNotIn("OpticalTracker", INTEGRITY_FIELD)
        self.assertNotIn("WeaponServo", INTEGRITY_FIELD)
        self.assertNotIn("CountermeasurePod", INTEGRITY_FIELD)
        for name in leftover_weak_point_accept_flags():
            self.assertNotIn(name, INTEGRITY_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_BOSS} {INTEGRITY_FIELD}\n"
            "};\n"
        )
        ...
        for header in headers:
            section = public_section(header)
            self.assertTrue(
                has_declaration(section, INTEGRITY_FIELD),
                section,
            )
            self.assertEqual(
                require_declaration(section, INTEGRITY_FIELD),
            ...
            self.assertEqual(declaration_count(section, INTEGRITY_FIELD), 1)
        one_line = f"{{\npublic:\n\t{INTEGRITY_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, INTEGRITY_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, INTEGRITY_FIELD), section)
        self.assertEqual(
            require_declaration(section, INTEGRITY_FIELD),
    ...
    def test_zero_integrity_does_not_satisfy(self) -> None:
        assigned = "\tfloat Integrity = 0.f;\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, INTEGRITY_FIELD)
        self.assertIn("Integrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, INTEGRITY_FIELD))

    def test_uninitialized_integrity_does_not_satisfy(self) -> None:
        bare = "\tfloat Integrity;\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(bare, INTEGRITY_FIELD)
        self.assertIn("Integrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(bare, INTEGRITY_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("Integrity", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, INTEGRITY_FIELD))
    ...
    def test_leftover_methods_do_not_satisfy(self) -> None:
        for leftover in LEFTOVER_METHODS:
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, INTEGRITY_FIELD))
            self.assertNotIn(leftover, INTEGRITY_FIELD)
    ...
    def test_delegate_param_form_does_not_satisfy_field_lock(self) -> None:
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, INTEGRITY_FIELD))
        self.assertNotIn(DELEGATE_PARAM_FORM, INTEGRITY_FIELD)

    def test_max_integrity_sibling_does_not_satisfy(self) -> None:
        region = f"\t{MAX_INTEGRITY_FIELD}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(region, INTEGRITY_FIELD)
        self.assertIn("Integrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, INTEGRITY_FIELD))
        self.assertNotIn(MAX_INTEGRITY_FIELD, INTEGRITY_FIELD)

    def test_apache_current_integrity_does_not_satisfy(self) -> None:
        leftover_apache = "\tfloat CurrentIntegrity = 100.f;\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_apache, INTEGRITY_FIELD)
        self.assertIn("Integrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover_apache, INTEGRITY_FIELD))
        self.assertNotIn("CurrentIntegrity", INTEGRITY_FIELD)

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{INTEGRITY_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, INTEGRITY_FIELD)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(INTEGRITY_FIELD.startswith("UFUNCTION"), INTEGRITY_FIELD)
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, INTEGRITY_FIELD), section)
    ...
    def test_contract_does_not_lock_integrity_cpp_body(self) -> None:
        locked_only = f"{INTEGRITY_FIELD}\n"
        self.assertNotIn("{", INTEGRITY_FIELD)
        self.assertNotIn("}", INTEGRITY_FIELD)
        self.assertNotIn("return ", INTEGRITY_FIELD)
        ...
        self.assertNotIn("return false", INTEGRITY_FIELD)
        self.assertNotIn("return true", INTEGRITY_FIELD)
        self.assertNotIn("CreateDefaultSubobject", INTEGRITY_FIELD)
        self.assertNotIn("RefreshAuthoredWeakPointRegistry", INTEGRITY_FIELD)
        self.assertNotIn("SetBossPhase", INTEGRITY_FIELD)
        self.assertNotIn("HandleWeakPointDestroyed", INTEGRITY_FIELD)
    ...
    def test_contract_does_not_relock_sibling_weak_point_id(self) -> None:
        ...
        for token in LEFTOVER_WEAK_POINT_ID_NOT_LOCKED:
            ...
            self.assertNotIn(token, INTEGRITY_FIELD)
        self.assertIn(
            "Scripts/tests/test_weak_point_id_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{INTEGRITY_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, INTEGRITY_FIELD),
            INTEGRITY_FIELD,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, INTEGRITY_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, INTEGRITY_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", INTEGRITY_FIELD)
        self.assertNotIn("CurrentIntegrity", INTEGRITY_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", INTEGRITY_FIELD)
        leftover_header = "SkyguardPathfinderEncounterController.h"
        self.assertNotIn(leftover_header, locked_only)
        self.assertNotIn(leftover_header, INTEGRITY_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, INTEGRITY_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", INTEGRITY_FIELD)
    ...
    def test_integrity_and_max_integrity_are_not_harbor_40_80(self) -> None:
        locked_only = f"{INTEGRITY_FIELD}\n"
        section = public_section(origin_main_header())
        sibling = MAX_INTEGRITY_FIELD
        for token in leftover_harbor_tokens():
            self.assertNotEqual(token, INTEGRITY_FIELD)
        ...
        self.assertNotIn(sibling, INTEGRITY_FIELD)
        self.assertIn("100.f", INTEGRITY_FIELD)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "weak point Integrity field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{INTEGRITY_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, INTEGRITY_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                INTEGRITY_FIELD.lower(),
                "weak point Integrity contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, INTEGRITY_FIELD)

    def test_contract_is_integrity_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertNotIn("return ", INTEGRITY_FIELD)
        self.assertNotIn("{", INTEGRITY_FIELD)
        self.assertTrue(INTEGRITY_FIELD.startswith("float "))
        self.assertTrue(INTEGRITY_FIELD.endswith(";"))
        self.assertIn("100.f", INTEGRITY_FIELD)
        self.assertEqual(INTEGRITY_FIELD, "float Integrity = 100.f;")
        self.assertIn(UPROPERTY_BOSS, section)
        self.assertEqual(
            HEADER_PATH,
