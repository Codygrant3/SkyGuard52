...
CLASS_NAME = "ASkyguardMission09IntegrationDirector"

# THIS IS leftover-safe Mission09 MaximumProtectedTargetIntegrity FIELD
# (declaration-only, one-line / split-line UPROPERTY wraps,
# int32 = 100 default) on
# ASkyguardMission09IntegrationDirector.
# THIS IS NOT leftover Mission08 director MaximumProtectedTargetIntegrity
# (same-name other mission; lock leftover Mission08 director
# Root #1044 through Readiness #1066). THIS IS NOT leftover
# FSkyguardMission08IntegrationReadiness / Mission09 readiness-struct
# fields. THIS IS NOT leftover Mission07/06/05/04/03/02/01/10
# same-name MaximumProtectedTargetIntegrity director-field drafts.
# THIS IS NOT leftover Mission09 Root #1083 through
# CampaignSaveSlotName #1095. THIS IS NOT leftover Mission09
# Blueprint UFUNCTION methods. THIS IS NOT leftover
# spawn-location / spawn-rotation fields and leftover
# runtime-ready flag (skip forever). THIS IS NOT leftover
# Mission08/09 wave-state enums, protected-target enums,
# protected-target-runtime-defaults, leftover hoist-window-
# runtime-defaults #ec79, leftover Mission09 pool-runtime-
# defaults #5426 / leftover Mission09 pool-budget-defaults
# #4537.
# LOCK leftover drafts #56-#64 and leftover #107-#673.
# Do not reopen leftover #664, leftover closed-without-merge
# #658-#673, leftover Mission05 closed-without-merge #665 #666
# #668-#673, or open drafts #674-#1095.
# LOCK leftover Mission01/02/03/04/05/06/07/08/10 same-name
# director and readiness-struct drafts.
# LOCK leftover Mission07 director Root #1011 through
# Readiness #1027. LOCK leftover Mission07 readiness-struct
# bMissionDefinitionValid #1028 through SearchTrackCount #1043.
# LOCK leftover Mission08 Blueprint UFUNCTION methods #729-#749.
# LOCK leftover Mission08 director Root #1044 through
# Readiness #1066. LOCK leftover
...
# Root #1083 through CampaignSaveSlotName #1095.
# PARSE DIRECTOR CLASS public section of
# ASkyguardMission09IntegrationDirector only. Do NOT parse
# FSkyguardMission09IntegrationReadiness,
# FSkyguardMission09ProtectedTargetRuntime,
# FSkyguardMission09PoolBudget,
# FSkyguardMission09PoolRuntime, leftover
# FSkyguardMission08IntegrationReadiness, leftover
# FSkyguardHoistWindowRuntime, leftover
# FSkyguardMission08ProtectedTargetRuntime, or private
# UPROPERTY(Transient).
# Skip leftover forever: BindRuntimeActors (takes
# ASkyguard retired live-mount pointer), leftover spawn
# location / rotation, leftover runtime-ready flag,
# HandleDroneCityImpact, GetStormRainBeatKit without
# UFUNCTION. Harbor 40/80 fail-closed in
# Mission02/03/04/05/06/07 test files (Mission08/09-only).
# Incoming clock names must be absent.
# Declaration presence only. Do not invent
# INDEX_NONE or lock MaximumProtectedTargetIntegrity
# construction in the .cpp. This is leftover-safe
# Mission09 MaximumProtectedTargetIntegrity FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps, int32 default 100) on
# ASkyguardMission09IntegrationDirector. Note
# EditAnywhere / BlueprintReadWrite /
# Category Skyguard|Mission09 /
# int32 = 100, not VisibleAnywhere /
# BlueprintReadOnly / TObjectPtr. It is
# NOT leftover Mission05 MaximumProtectedTargetIntegrity
# #961 / branch cursor/mission05-maximum-protected-
# target-integrity-field-decl-contract-c332, NOT leftover
# Mission07 MaximumProtectedTargetIntegrity / branch
# cursor/mission07-maximum-protected-target-
# integrity-field-decl-contract-c332, NOT leftover
# Mission06 MaximumTargetIntegrity #992 / branch
# cursor/mission06-maximum-target-integrity-
# field-decl-contract-c332, NOT leftover Readiness,
# NOT leftover RequiredCoveredSeconds (in-flight),
# NOT leftover MinimumWeaponSeparationMeters (in-flight),
# NOT leftover LifelineHunterSpawnLocation #1061,
# NOT leftover LifelineHunterSpawnRotation (opening
# this wake). Skip leftover retired-mount spawn
# forever. Skip leftover retired-mount runtime-ready
# flag forever. It is
# NOT leftover Mission01 CampaignSaveUserIndex field
# #584 / branch cursor/mission01-campaign-save-
# user-index-field-decl-contract-c332, NOT leftover
# Mission02 CampaignSaveUserIndex field
# #857 / branch cursor/mission02-campaign-save-
# user-index-field-decl-contract-c332, NOT leftover
# Mission03 campaign-save-user-index FIELD
# #886 / branch cursor/mission03-campaign-save-
# user-index-field-decl-contract-c332, NOT leftover
# Mission04 CampaignSaveUserIndex field
# #920 / branch cursor/mission04-campaign-save-
# user-index-field-decl-contract-c332, NOT leftover
# Mission05 CampaignSaveUserIndex field
# #958 / branch cursor/mission05-campaign-save-
# user-index-field-decl-contract-c332, NOT leftover
# Mission06 CampaignSaveUserIndex field
# #991 / branch cursor/mission06-campaign-save-
# user-index-field-decl-contract-c332, NOT leftover
# Mission07 CampaignSaveUserIndex field
# / branch cursor/mission07-campaign-save-
# user-index-field-decl-contract-c332, NOT leftover
# Mission08 CampaignDefinition #1055 / branch
# cursor/mission08-campaign-definition-field-
# decl-contract-c332, NOT leftover
# Mission10 CampaignSaveUserIndex field
# #804 / branch cursor/mission10-campaign-save-
# user-index-field-decl-contract-c332, NOT leftover
# Mission06 bAutoInitialize field #986 / branch
# cursor/mission06-auto-initialize-field-decl-
# contract-c332, leftover Mission06
# bAllowBoundedActorSpawning / leftover
# bAutoLaunchAfterBriefing / leftover
# CampaignSaveSlotName in-flight branches, NOT leftover
# Mission01 / Mission02 / Mission03 / Mission04 /
# Mission05 / Mission06 / Mission07 / Mission10
# same-name CampaignSaveUserIndex director-field
# drafts. LOCK leftover Mission07 director Root
# #1011 through Readiness #1027. LOCK leftover
# Mission07 readiness-struct #1028-#1043. LOCK
# leftover Mission08 Blueprint UFUNCTION methods
# #729-#749. LOCK leftover Mission08 director Root
# #1044 through LifelineHunterSpawnLocation #1061.
# LOCK leftover drafts #56-#64 and leftover
# #107-#673. Do not reopen leftover #664, leftover
# closed-without-merge #658-#673, leftover Mission05
# closed-without-merge #665 #666 #668-#673, or open
# drafts #674-#1095. NOT leftover
# Mission07 Root #1011 / Briefing #1012 /
# AudioDirector #1013 / RadioChatter #1016 /
# SortiePresentation #1014 / CampaignDefinition #
# 1015 / MissionDefinition #1017 / leftover
# bAutoInitialize #1018 / leftover
# bAllowBoundedActorSpawning #1019 / leftover
# bAutoLaunchAfterBriefing / leftover
# CampaignSaveSlotName sibling field lanes, NOT leftover
# Mission06 RadioChatter in-flight/draft #982 /
# branch cursor/mission06-radio-chatter-field-
# decl-contract-c332, NOT leftover Mission06
# AudioDirector in-flight/draft #979 / branch
# cursor/mission06-audio-director-field-decl-
# contract-c332, NOT leftover Mission06 Briefing
# draft #980 / branch cursor/mission06-briefing-
# field-decl-contract-c332, NOT leftover Mission06
# Root draft #981 / branch cursor/mission06-root-
# field-decl-contract-c332, NOT leftover Mission06
# SortiePresentation / CampaignDefinition /
# MissionDefinition in-flight branches, NOT leftover Mission04 bAudioReady #937 /
# leftover Mission03 bAudioReady #901 /
# leftover Mission02 bAudioReady #869, NOT leftover
# Mission04 Root #907 / SearchlightPort #908 /
# SearchlightStarboard / Briefing siblings, NOT leftover
# audio-director fail-closed contracts / leftover
# production-audio-* defaults, NOT leftover
# FSkyguardMission06IntegrationReadiness fields,
# leftover FSkyguardMission05IntegrationReadiness
# bAudioReady #973, leftover FSkyguardStormRuntime
# fields, leftover FSkyguardAirfieldTargetRuntime,
# leftover FSkyguardPayloadWindowRuntime,
...
# methods.
# not leftover Root / Briefing / SearchlightPort /
...
# CampaignSaveSlotName sibling director fields.
...
# origin/main is a one-line UPROPERTY field
...
# split-line UPROPERTY wraps plus = 100.
# Do not invent ClampMin / VisibleAnywhere. Parse the public
# class section of
# ASkyguardMission09IntegrationDirector only.
# Do not parse FSkyguardMission08IntegrationReadiness,
# FSkyguardHoistWindowRuntime,
# FSkyguardMission08ProtectedTargetRuntime,
# leftover FSkyguardSearchTrackRuntime,
# leftover FSkyguardMission07ProtectedTargetRuntime,
# leftover FSkyguardMission07IntegrationReadiness,
# FSkyguardAirfieldTargetRuntime,
# FSkyguardPayloadWindowRuntime, private, or Mission01 /
# Mission02 / Mission03 / Mission04 / leftover Mission05 /
# leftover Mission06 / leftover Mission07 / leftover Mission08 /
# Mission10 directors.
# Category is Skyguard|Mission09, not
# Skyguard|Mission09|Campaign, not
# Skyguard|Mission09|Performance, not
...
# Mission04 / Mission05 / Mission06 / Mission07 /
...
# drafts #674-#1057, leftover Apache
...
# Mission09IntegrationDirector public section. Pathfinder MinHeightFromOriginCm
...
# drafts #674-#1057 including leftover Mission03
# ObjectiveCount #905 / WaveCount #906 / RadioLineCount #904,
# leftover Mission04 Root #907 / SearchlightPort #908,
# leftover Mission06 AudioDirector #979 / Briefing
# #980 / Root #981 / RadioChatter #982 /
# leftover SortiePresentation #984 / CampaignDefinition #
# 983 / MissionDefinition #985 / leftover
# bAutoInitialize #986 / leftover
# bAllowBoundedActorSpawning / leftover
# bAutoLaunchAfterBriefing / leftover
# CampaignSaveSlotName in-flight. Do not reopen open
# drafts #674-#1095.
...
UPROPERTY_MISSION09_CLAMP = 'meta=(ClampMin="1")'
...
MAXIMUM_PROTECTED_TARGET_INTEGRITY_FIELD = (
    "int32 MaximumProtectedTargetIntegrity = 100;"
)
REQUIRED_COVERED_SECONDS_FIELD = (
    "float RequiredCoveredSeconds = 4.f;"
)
LIFELINE_HUNTER_SPAWN_LOCATION = (
    "FVector LifelineHunterSpawnLocation;"
)
LIFELINE_HUNTER_SPAWN_ROTATION = (
    "FRotator LifelineHunterSpawnRotation;"
)
...
LOCKED_DECL = MAXIMUM_PROTECTED_TARGET_INTEGRITY_FIELD
...
# an isolated Python MaximumProtectedTargetIntegrity
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission01_maximum_protected_target_integrity_field_decl_contract.py",
    "Scripts/tests/test_mission02_maximum_protected_target_integrity_field_decl_contract.py",
    "Scripts/tests/test_mission03_maximum_protected_target_integrity_field_decl_contract.py",
    "Scripts/tests/test_mission04_maximum_protected_target_integrity_field_decl_contract.py",
    ...
    "Scripts/tests/test_mission04_audio_ready_field_decl_contract.py",
    ...
    "Scripts/tests/test_mission05_audio_ready_field_decl_contract.py",
    "Scripts/tests/test_mission05_briefing_ready_field_decl_contract.py",
    "Scripts/tests/test_mission05_sortie_presentation_ready_field_decl_contract.py",
    ...
    "Scripts/tests/test_mission05_protected_target_count_field_decl_contract.py",
    "Scripts/tests/test_mission05_gunner_ready_field_decl_contract.py",
    "Scripts/tests/test_mission05_tempest_ready_field_decl_contract.py",
    "Scripts/tests/test_mission05_storm_runtime_ready_field_decl_contract.py",
    "Scripts/tests/test_mission05_objectives_ready_field_decl_contract.py",
    "Scripts/tests/test_mission05_waves_ready_field_decl_contract.py",
    "Scripts/tests/test_mission05_protected_targets_ready_field_decl_contract.py",
...
LEFTOVER_MISSION01_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED = (
    "ASkyguardMission01IntegrationDirector",
    "SkyguardMission01IntegrationDirector.h",
    "test_mission01_campaign_save_user_index_field_decl_contract.py",
    "cursor/mission01-campaign-save-user-index-field-decl-contract-c332",
    'Category="Skyguard|Mission01|Campaign"',
)
LEFTOVER_MISSION02_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED = (
    "ASkyguardMission02IntegrationDirector",
    "SkyguardMission02IntegrationDirector.h",
    "test_mission02_campaign_save_user_index_field_decl_contract.py",
    "cursor/mission02-campaign-save-user-index-field-decl-contract-c332",
    'Category="Skyguard|Mission02|Campaign"',
)
LEFTOVER_MISSION03_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED = (
    "ASkyguardMission03IntegrationDirector",
    "SkyguardMission03IntegrationDirector.h",
    "test_mission03_campaign_save_user_index_field_decl_contract.py",
    "cursor/mission03-campaign-save-user-index-field-decl-contract-c332",
    'Category="Skyguard|Mission03|Campaign"',
)
LEFTOVER_MISSION04_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED = (
    "ASkyguardMission04IntegrationDirector",
    "SkyguardMission04IntegrationDirector.h",
    "test_mission04_campaign_save_user_index_field_decl_contract.py",
    "cursor/mission04-campaign-save-user-index-field-decl-contract-c332",
    'Category="Skyguard|Mission04|Campaign"',
)
LEFTOVER_MISSION05_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED = (
    "ASkyguardMission05IntegrationDirector",
    "SkyguardMission05IntegrationDirector.h",
    "test_mission05_campaign_save_user_index_field_decl_contract.py",
    "cursor/mission05-campaign-save-user-index-field-decl-contract-c332",
    'Category="Skyguard|Mission05|Campaign"',
)
LEFTOVER_MISSION07_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED = (
    "ASkyguardMission07IntegrationDirector",
    "SkyguardMission07IntegrationDirector.h",
    "test_mission07_campaign_save_user_index_field_decl_contract.py",
    "cursor/mission07-campaign-save-user-index-field-decl-contract-c332",
    'Category="Skyguard|Mission07|Campaign"',
)
LEFTOVER_MISSION08_AUTO_INITIALIZE_NOT_LOCKED = (
    AUTO_INITIALIZE_FIELD,
    "test_mission08_auto_initialize_field_decl_contract.py",
    "cursor/mission08-auto-initialize-field-decl-contract-c332",
)
LEFTOVER_MISSION08_ALLOW_BOUNDED_NOT_LOCKED = (
    ALLOW_BOUNDED_SPAWNING_FIELD,
    "test_mission08_allow_bounded_actor_spawning_field_decl_contract.py",
)
LEFTOVER_MISSION08_AUTO_LAUNCH_NOT_LOCKED = (
    AUTO_LAUNCH_AFTER_BRIEFING_FIELD,
    "test_mission08_auto_launch_after_briefing_field_decl_contract.py",
)
LEFTOVER_MISSION08_CAMPAIGN_SAVE_SLOT_NAME_NOT_LOCKED = (
    CAMPAIGN_SAVE_SLOT_NAME_FIELD,
    "test_mission08_campaign_save_slot_name_field_decl_contract.py",
)
LEFTOVER_MISSION08_CAMPAIGN_DEFINITION_NOT_LOCKED = (
    CAMPAIGN_DEFINITION_FIELD,
    "test_mission08_campaign_definition_field_decl_contract.py",
    "cursor/mission08-campaign-definition-field-decl-contract-c332",
)
LEFTOVER_MISSION06_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED = (
    "ASkyguardMission06IntegrationDirector",
    "SkyguardMission06IntegrationDirector.h",
    "test_mission06_campaign_save_user_index_field_decl_contract.py",
    "cursor/mission06-campaign-save-user-index-field-decl-contract-c332",
    'Category="Skyguard|Mission06|Campaign"',
)
LEFTOVER_MISSION10_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED = (
    "ASkyguardMission10IntegrationDirector",
    "SkyguardMission10IntegrationDirector.h",
    "test_mission10_campaign_save_user_index_field_decl_contract.py",
    "cursor/mission10-campaign-save-user-index-field-decl-contract-c332",
    'Category="Skyguard|Mission10|Campaign"',
)
LEFTOVER_MISSION03_CAMPAIGN_SAVE_SLOT_NAME_NOT_LOCKED = (
    "CampaignSaveSlotName",
    CAMPAIGN_SAVE_SLOT_NAME_FIELD,
    "test_mission03_campaign_save_slot_name_field_decl_contract.py",
)
LEFTOVER_MISSION04_CAMPAIGN_SAVE_SLOT_NAME_NOT_LOCKED = (
    "CampaignSaveSlotName",
    CAMPAIGN_SAVE_SLOT_NAME_FIELD,
    "test_mission04_campaign_save_slot_name_field_decl_contract.py",
)
LEFTOVER_MISSION06_AUTO_INITIALIZE_NOT_LOCKED = (
    AUTO_INITIALIZE_FIELD,
    "test_mission06_auto_initialize_field_decl_contract.py",
    "cursor/mission06-auto-initialize-field-decl-contract-c332",
)
LEFTOVER_MISSION06_ALLOW_BOUNDED_NOT_LOCKED = (
    ALLOW_BOUNDED_SPAWNING_FIELD,
    "test_mission06_allow_bounded_actor_spawning_field_decl_contract.py",
)
LEFTOVER_MISSION06_AUTO_LAUNCH_NOT_LOCKED = (
    AUTO_LAUNCH_AFTER_BRIEFING_FIELD,
    "test_mission06_auto_launch_after_briefing_field_decl_contract.py",
)
LEFTOVER_MISSION06_CAMPAIGN_SAVE_SLOT_NAME_NOT_LOCKED = (
    CAMPAIGN_SAVE_SLOT_NAME_FIELD,
    "test_mission06_campaign_save_slot_name_field_decl_contract.py",
)
LEFTOVER_CONVOY_ROUTE_STATE_ENUM_NOT_LOCKED = (
    "ESkyguardConvoyRouteState",
    "test_convoy_route_state_enum_contract.py",
    "cursor/convoy-route-state-enum-contract-d34e",
)
LEFTOVER_MISSION03_WAVE_STATE_ENUM_NOT_LOCKED = (
    "ESkyguardMission03WaveState",
    "test_mission03_wave_state_enum_contract.py",
    "cursor/mission03-wave-state-enum-contract-0242",
)
LEFTOVER_SAME_NAME_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED = (
    "test_mission01_campaign_save_user_index_field_decl_contract.py",
    "test_mission02_campaign_save_user_index_field_decl_contract.py",
    "test_mission03_campaign_save_user_index_field_decl_contract.py",
    "test_mission04_campaign_save_user_index_field_decl_contract.py",
    ...
    "test_mission06_campaign_save_user_index_field_decl_contract.py",
    "test_mission07_campaign_save_user_index_field_decl_contract.py",
    "test_mission08_campaign_save_user_index_field_decl_contract.py",
    "test_mission09_campaign_save_user_index_field_decl_contract.py",
    "test_mission10_campaign_save_user_index_field_decl_contract.py",
)
LEFTOVER_MISSION08_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED = (
    CAMPAIGN_SAVE_USER_INDEX_FIELD,
    "test_mission08_campaign_save_user_index_field_decl_contract.py",
    "cursor/mission08-campaign-save-user-index-field-decl-contract-c332",
    'Category="Skyguard|Mission08|Campaign"',
)
LEFTOVER_SAME_NAME_INTEGRITY_NOT_LOCKED = (
    "test_mission01_maximum_protected_target_integrity_field_decl_contract.py",
    "test_mission02_maximum_protected_target_integrity_field_decl_contract.py",
    "test_mission03_maximum_protected_target_integrity_field_decl_contract.py",
    "test_mission04_maximum_protected_target_integrity_field_decl_contract.py",
    "test_mission05_maximum_protected_target_integrity_field_decl_contract.py",
    "cursor/mission05-maximum-protected-target-integrity-field-decl-contract-c332",
    "test_mission06_maximum_target_integrity_field_decl_contract.py",
    "cursor/mission06-maximum-target-integrity-field-decl-contract-c332",
    "test_mission07_maximum_protected_target_integrity_field_decl_contract.py",
    "cursor/mission07-maximum-protected-target-integrity-field-decl-contract-c332",
    "test_mission08_maximum_protected_target_integrity_field_decl_contract.py",
    "cursor/mission08-maximum-protected-target-integrity-field-decl-contract-c332",
    "test_mission10_maximum_protected_integrity_field_decl_contract.py",
    "MaximumTargetIntegrity",
)
LEFTOVER_MISSION08_REQUIRED_COVERED_SECONDS_NOT_LOCKED = (
    REQUIRED_COVERED_SECONDS_FIELD,
    "test_mission08_required_covered_seconds_field_decl_contract.py",
)
LEFTOVER_MISSION08_MINIMUM_WEAPON_SEPARATION_NOT_LOCKED = (
    MINIMUM_WEAPON_SEPARATION_FIELD,
    "test_mission08_minimum_weapon_separation_meters_field_decl_contract.py",
)
LEFTOVER_MISSION08_LIFELINE_HUNTER_SPAWN_LOCATION_NOT_LOCKED = (
    LIFELINE_HUNTER_SPAWN_LOCATION,
    "test_mission08_lifeline_hunter_spawn_location_field_decl_contract.py",
)
LEFTOVER_MISSION08_LIFELINE_HUNTER_SPAWN_ROTATION_NOT_LOCKED = (
    LIFELINE_HUNTER_SPAWN_ROTATION,
    "test_mission08_lifeline_hunter_spawn_rotation_field_decl_contract.py",
)
LEFTOVER_CAMPAIGN_SAVE_USER_INDEX_METHODS_NOT_LOCKED = (
    "GetCampaignSaveUserIndex",
    "SetCampaignSaveUserIndex",
    "test_get_campaign_save_user_index_decl_contract.py",
    "test_set_campaign_save_user_index_decl_contract.py",
    "test_campaign_save_user_index_decl_contract.py",
)
...
class Mission09MaximumProtectedTargetIntegrityFieldDeclContractTests(unittest.TestCase):
    def test_mission09_class_exists(self) -> None:
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("MaximumProtectedTargetIntegrity", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_maximum_protected_target_integrity_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        macro_only = f"\t{UPROPERTY_MISSION09}\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("BlueprintCallable", UPROPERTY_MISSION09)
        self.assertNotIn("BlueprintPure", UPROPERTY_MISSION09)
        self.assertIn("Skyguard|Mission09", UPROPERTY_MISSION09)
        self.assertNotIn("Skyguard|Mission02|Protection", UPROPERTY_MISSION09)
        self.assertNotIn("Integration", UPROPERTY_MISSION09)
        self.assertNotIn("Mission01", UPROPERTY_MISSION09)
        self.assertNotIn("Mission02", UPROPERTY_MISSION09)
        self.assertNotIn("Mission03", UPROPERTY_MISSION09)
        self.assertNotIn("Mission04", UPROPERTY_MISSION09)
        self.assertNotIn("Mission05", UPROPERTY_MISSION09)
        self.assertNotIn("Protection", UPROPERTY_MISSION09)
        self.assertNotIn("Search", UPROPERTY_MISSION09)
        self.assertNotIn("Waves", UPROPERTY_MISSION09)
        self.assertNotIn("Payload", UPROPERTY_MISSION09)
        self.assertNotIn("Targets", UPROPERTY_MISSION09)
        self.assertNotIn("Objectives", UPROPERTY_MISSION09)
        self.assertNotIn("Environment", UPROPERTY_MISSION09)
        self.assertNotIn("Briefing", UPROPERTY_MISSION09)
        self.assertNotIn("Mission10", UPROPERTY_MISSION09)
        self.assertNotIn("Boss", UPROPERTY_MISSION09)
        self.assertNotIn("Destruction", UPROPERTY_MISSION09)
        self.assertNotIn("Apache", UPROPERTY_MISSION09)
        self.assertNotIn("Mission06", UPROPERTY_MISSION09)
        self.assertNotIn("Mission07", UPROPERTY_MISSION09)
        self.assertNotIn("Mission08", UPROPERTY_MISSION09)
        self.assertNotIn("Encounter", UPROPERTY_MISSION09)
        self.assertNotIn("Safety", UPROPERTY_MISSION09)
        self.assertNotIn("Performance", UPROPERTY_MISSION09)
        self.assertNotIn("Hoist", UPROPERTY_MISSION09)
        self.assertNotIn("Rescue", UPROPERTY_MISSION09)
        self.assertNotIn("Evacuation", UPROPERTY_MISSION09)
        self.assertNotIn("Campaign", UPROPERTY_MISSION09)
        self.assertNotIn("Skyguard|Mission08|Campaign", UPROPERTY_MISSION09)
        self.assertNotIn("ClampMin", UPROPERTY_MISSION09)
        self.assertNotIn("ClampMin", LOCKED_DECL)
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, UPROPERTY_MISSION09)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_radio = f"\t{AUDIO_DIRECTOR_FIELD}\n"
        ...
        leftover_auto = f"\t{RADIO_CHATTER_FIELD}\n"
    ...
    def test_maximum_protected_target_integrity_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 MaximumProtectedTargetIntegrity"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("MaximumProtectedTargetIntegrity", LOCKED_DECL)
        self.assertIn("= 100", LOCKED_DECL)
        ...
        self.assertNotIn("CampaignSaveSlotName", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tint32\n"
            "\tMaximumProtectedTargetIntegrity = 100;\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION09} {LOCKED_DECL}\n"
            "};\n"
        )
        ...
        wrap_origin_clamp_split = (
            ...
            "\tUPROPERTY(EditAnywhere, BlueprintReadWrite, "
            'Category="Skyguard|Mission09")\n'
            f"\t\t{UPROPERTY_MISSION09_CLAMP})\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
        )
        wrap_origin_clamp_same_line = (
            "public:\n"
            "\tUPROPERTY(EditAnywhere, BlueprintReadWrite, "
            'Category="Skyguard|Mission09") '
            f"{UPROPERTY_MISSION09_CLAMP})\n"
        ...
        header_wrap_origin_clamp_same_line = (
            f"class SKYGUARD52_API {CLASS_NAME} "
            f": public AActor\n{{\n{wrap_origin_clamp_same_line}"
        )
        for header in (
        ...
        self.assertNotIn("ClampMin", UPROPERTY_MISSION09)
        self.assertNotIn("ClampMin", LOCKED_DECL)
        self.assertNotIn("VisibleAnywhere", UPROPERTY_MISSION09)
        self.assertNotIn("BlueprintReadOnly", UPROPERTY_MISSION09)
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(environment, UPROPERTY_MISSION09)
        self.assertNotEqual(briefing, UPROPERTY_MISSION09)
        self.assertNotIn(environment, UPROPERTY_MISSION09)
        self.assertNotIn(briefing, UPROPERTY_MISSION09)
        leftover_m01 = (
            'UFUNCTION(BlueprintCallable, '
        ...
        self.assertNotEqual(leftover_m01, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m02, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_harbor, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m03, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m04, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m05, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m06, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_waves, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m05_waves, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_integration, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m07_ready, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m08_waves, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m08_hoist, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m08_safety, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m08_protection, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m08_ready, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m09_ready, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m09_waves, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m10_safety, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m09_protection, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m09_performance, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_m09_objectives, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_payload, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_targets, UPROPERTY_MISSION09)
        self.assertNotEqual(leftover_objectives, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m01, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m02, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_harbor, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m03, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m04, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m05, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m06, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m05_waves, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_integration, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m07_ready, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m08_waves, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m08_hoist, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m08_safety, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m08_protection, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m08_ready, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m09_ready, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m09_waves, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m10_safety, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m09_protection, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m09_performance, UPROPERTY_MISSION09)
        self.assertNotIn(leftover_m09_objectives, UPROPERTY_MISSION09)
        self.assertNotIn("Mission01", UPROPERTY_MISSION09)
        self.assertNotIn("Mission02", UPROPERTY_MISSION09)
        self.assertNotIn("Mission03", UPROPERTY_MISSION09)
        self.assertNotIn("Mission04", UPROPERTY_MISSION09)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("MaximumProtectedTargetIntegrity", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 MaximumProtectedTargetIntegrity"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("MaximumProtectedTargetIntegrity", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 MaximumProtectedTargetIntegrity field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 MaximumProtectedTargetIntegrity field contains "
    ...
    def test_contract_is_maximum_protected_target_integrity_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_maximum_protected_target_integrity(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_leftover_mission02_initialize_does_not_satisfy(self) -> None:
        ...
        self.assertIn(
            "Scripts/tests/test_mission02_audio_director_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_mission10_radio_chatter_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tint32 CampaignSaveUserIndex = 1;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_contract_does_not_relock_leftover_handle_boss_phase_changed(
        ...
        for token in LEFTOVER_HANDLE_BOSS_PHASE_CHANGED_NOT_LOCKED:
            ...
            self.assertNotIn(token, LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", UPROPERTY_MISSION09)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission09_maximum_protected_target_integrity_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_maximum_protected_target_integrity_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission06_audio_director_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission06_radio_chatter_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission07_campaign_save_slot_name"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_allow_bounded_actor_spawning"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_auto_launch_after_briefing"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_required_covered_seconds"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_minimum_weapon_separation_meters"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_lifeline_hunter_spawn_rotation"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_lifeline_hunter_spawn_location"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission07_campaign_save_user_index"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_auto_initialize_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission02_auto_initialize_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission03_auto_initialize_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission04_auto_initialize_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission05_auto_initialize_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission10_auto_initialize_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        leftover_56_64 = (
    ...
    def test_readiness_struct_does_not_satisfy_audio_director(self) -> None:
        leftover = (
        ...
        self.assertFalse(has_declaration(section, LOCKED_DECL))
        self.assertNotIn("FSkyguardMission08IntegrationReadiness", LOCKED_DECL)
        self.assertNotIn("FSkyguardHoistWindowRuntime", LOCKED_DECL)
        self.assertNotIn("FSkyguardMission08ProtectedTargetRuntime", LOCKED_DECL)
        self.assertNotIn("FSkyguardMission07IntegrationReadiness", LOCKED_DECL)

    def test_leftover_mission02_radio_chatter_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission02IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission03_radio_chatter_does_not_satisfy(self) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_audio_director_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_audio_director_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )


    def test_leftover_mission04_radio_chatter_does_not_satisfy(self) -> None:
        leftover = (
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_audio_ready_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_mission05_auto_initialize_does_not_satisfy(self) -> None:
        leftover = (
        ...
        self.assertIn(
            "Scripts/tests/test_mission05_audio_ready_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission05_root_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_audio_director_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_airfield_target_runtime_does_not_satisfy_maximum_protected_target_integrity(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_does_not_satisfy_maximum_protected_target_integrity(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_leftover_mission01_campaign_save_user_index_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission01IntegrationDirector "
        ...
        for token in LEFTOVER_MISSION01_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED:
            self.assertNotIn(token, LOCKED_DECL)

    def test_leftover_mission02_campaign_save_user_index_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission02IntegrationDirector "
        ...
        for token in LEFTOVER_MISSION02_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED:
            self.assertNotIn(token, LOCKED_DECL)

    def test_leftover_mission04_campaign_save_user_index_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission04IntegrationDirector "
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission04_campaign_save_user_index"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        for token in LEFTOVER_MISSION04_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED:
            self.assertNotIn(token, LOCKED_DECL)

    def test_leftover_mission05_campaign_save_user_index_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission05IntegrationDirector "
        ...
        for token in LEFTOVER_MISSION05_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED:
            self.assertNotIn(token, LOCKED_DECL)

    def test_leftover_mission06_campaign_save_user_index_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
        ...
        for token in LEFTOVER_MISSION06_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED:
            self.assertNotIn(token, LOCKED_DECL)

    def test_search_track_runtime_does_not_satisfy_maximum_protected_target_integrity(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_protected_target_runtime_does_not_satisfy_maximum_protected_target_integrity(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_leftover_mission06_sibling_campaign_fields_stay_locked(
        self,
    ) -> None:
        for leftover in (
            "Scripts/tests/test_mission06_auto_initialize"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission06_allow_bounded_actor_spawning"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission06_auto_launch_after_briefing"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission06_campaign_save_slot_name"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission06_campaign_save_user_index"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission06_root_field"
            ...
            "Scripts/tests/test_mission06_sortie_presentation_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission06_campaign_definition_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission06_mission_definition_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission07_root_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission07_briefing_field"
            ...
            "_decl_contract.py",
            "Scripts/tests/test_mission07_campaign_definition_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission07_mission_definition_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission07_auto_initialize_field"
            "_decl_contract.py",
            "Scripts/tests/test_mission07_allow_bounded_actor_spawning"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission07_auto_launch_after_briefing"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission07_campaign_save_slot_name"
            "_field_decl_contract.py",
        ):
    ...
    def test_contract_does_not_parse_readiness_or_airfield_structs(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertTrue(has_declaration(section, LOCKED_DECL), section)
        self.assertNotIn("FSkyguardMission08IntegrationReadiness", LOCKED_DECL)
    ...
    def test_leftover_mission07_campaign_save_user_index_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
        ...
        for token in LEFTOVER_MISSION07_CAMPAIGN_SAVE_USER_INDEX_NOT_LOCKED:
            self.assertNotIn(token, LOCKED_DECL)

    def test_leftover_mission08_sibling_campaign_fields_stay_locked(
        self,
    ) -> None:
        for leftover in (
            "Scripts/tests/test_mission08_campaign_save_slot_name"
            ...
            "Scripts/tests/test_mission08_campaign_save_user_index"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission08_auto_initialize"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission08_allow_bounded_actor_spawning"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission08_auto_launch_after_briefing"
        ...
        locked_only = f"{LOCKED_DECL}\n"
        self.assertNotIn("CampaignSaveSlotName", locked_only)
        self.assertNotIn("CampaignSaveUserIndex", LOCKED_DECL)
        self.assertNotIn("CampaignDefinition", LOCKED_DECL)
        self.assertNotIn("bAutoInitialize", LOCKED_DECL)
        self.assertNotIn("bAllowBoundedActorSpawning", LOCKED_DECL)
        self.assertNotIn("bAutoLaunchAfterBriefing", LOCKED_DECL)
        self.assertNotIn("RequiredCoveredSeconds", LOCKED_DECL)
        self.assertNotIn("MinimumWeaponSeparationMeters", LOCKED_DECL)
        self.assertNotIn("LifelineHunterSpawnLocation", LOCKED_DECL)
        self.assertNotIn("LifelineHunterSpawnRotation", LOCKED_DECL)

    def test_leftover_same_name_mission05_integrity_stays_locked(self) -> None:
        self.assertIn(
            "Scripts/tests/test_mission05_maximum_protected_target"
            "_integrity_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        leftover_m07 = (
            ...
            "public:\n"
            "\tUPROPERTY(EditAnywhere, BlueprintReadWrite, "
            'Category="Skyguard|Mission07", meta=(ClampMin="1"))\n'
            f"\t{LOCKED_DECL}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover_m07)
        self.assertIn(CLASS_NAME, str(raised.exception))
        leftover_m06 = (
            "int32 MaximumTargetIntegrity = 100;"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m06, LOCKED_DECL)
        self.assertIn("MaximumProtectedTargetIntegrity", str(raised.exception))
        self.assertNotIn("MaximumTargetIntegrity", LOCKED_DECL)
        self.assertNotIn(
            "cursor/mission05-maximum-protected-target-integrity-"
            "field-decl-contract-c332",
            LOCKED_DECL,
        )
        self.assertNotIn(
            "cursor/mission07-maximum-protected-target-integrity-"
            "field-decl-contract-c332",
            LOCKED_DECL,
        )
        self.assertIn(
            "Scripts/tests/test_mission08_maximum_protected_target"
            "_integrity_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        leftover_m08 = (
            ...
            "public:\n"
            "\tUPROPERTY(EditAnywhere, BlueprintReadWrite, "
            'Category="Skyguard|Mission08", meta=(ClampMin="1"))\n'
            f"\t{LOCKED_DECL}\n"
            "};\n"
        )
        with self.assertRaises(AssertionError) as raised:
            public_section(leftover_m08)
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertNotIn(
            "cursor/mission08-maximum-protected-target-integrity-"
            "field-decl-contract-c332",
            LOCKED_DECL,
        )
        self.assertIn(
