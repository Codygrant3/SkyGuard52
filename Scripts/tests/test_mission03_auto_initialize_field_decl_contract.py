...
# Mission03 bAutoInitialize FIELD
...
# private, or Mission01-02 / Mission04-10 directors.
...
# Integration, not Mission01 / Mission02 / Mission04 /
...
class Mission03AutoInitializeFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission03_auto_initialize_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
