...
# isolated-test drafts #107–#496 including leftover
...
# leftover isolated-test drafts #107–#496,
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardBlackKiteBoss::PowerBus",
    "SkyguardBlackKiteBoss.cpp",
    "SetExposed",
...
class BlackKitePowerBusFieldDeclContractTests(unittest.TestCase):
    def test_black_kite_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, POWER_BUS_FIELD),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, POWER_BUS_FIELD)
        self.assertIn("PowerBus", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, POWER_BUS_FIELD)
    ...
    def test_missing_power_bus_declaration_fails_closed(
        self,
    ) -> None:
        neighbors_only = (
            "\tASkyguardBlackKiteBoss();\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, POWER_BUS_FIELD)
        self.assertIn("PowerBus", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, POWER_BUS_FIELD)
        self.assertIn("PowerBus", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UPROPERTY", POWER_BUS_FIELD)
        self.assertNotIn("VisibleAnywhere", POWER_BUS_FIELD)
        self.assertNotIn("BlueprintReadOnly", POWER_BUS_FIELD)
        self.assertNotIn("Category", POWER_BUS_FIELD)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, POWER_BUS_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, POWER_BUS_FIELD)
        self.assertIn("PowerBus", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = (
            "\tUSkyguardBossWeakPointComponent* PowerBus;\n"
        )
        as_array = (
        ...
        scene = (
            "\tTObjectPtr<USceneComponent> PowerBus;\n"
        )
        weak = (
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, POWER_BUS_FIELD)
            self.assertIn("PowerBus", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_power_bus_declaration_matches_origin_main(
        self,
    ) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
        ...
        self.assertEqual(
            declaration_count(section, POWER_BUS_FIELD),
            1,
        )
        self.assertTrue(
            POWER_BUS_FIELD.startswith(
                "TObjectPtr<USkyguardBossWeakPointComponent> "
            ),
            POWER_BUS_FIELD,
        )
        self.assertTrue(
            POWER_BUS_FIELD.endswith(";"),
            POWER_BUS_FIELD,
        )
        self.assertIn("PowerBus", POWER_BUS_FIELD)
        self.assertIn(
        ...
        self.assertIn("TObjectPtr<", POWER_BUS_FIELD)
        self.assertNotIn("TArray<", POWER_BUS_FIELD)
        self.assertNotIn("=", POWER_BUS_FIELD)
        self.assertNotIn("INDEX_NONE", POWER_BUS_FIELD)
        self.assertNotIn("UFUNCTION", POWER_BUS_FIELD)
        self.assertNotIn("{", POWER_BUS_FIELD)
        self.assertNotIn("}", POWER_BUS_FIELD)
        self.assertNotIn("return ", POWER_BUS_FIELD)
        self.assertNotIn(
            "BeginTerminalStrikeCycle",
            POWER_BUS_FIELD,
        )
        self.assertNotIn("OpenGuidanceArrayExposure", POWER_BUS_FIELD)
        self.assertNotIn("IssueClimbCommand", POWER_BUS_FIELD)
        self.assertNotIn(
            "DivertWreckFromCivilians",
            POWER_BUS_FIELD,
        )
        ...
        self.assertNotIn("GetCivilianSeparationMeters", POWER_BUS_FIELD)
        self.assertNotIn("GetFinaleStage", POWER_BUS_FIELD)
        self.assertNotIn("IsClimbCommandIssued", POWER_BUS_FIELD)
        self.assertNotIn("IsWreckDiverted", POWER_BUS_FIELD)
        self.assertNotIn(
            "GetObjectiveMilestonesReached",
            POWER_BUS_FIELD,
        )
        ...
        self.assertNotIn("GetChinMuzzleLocation", POWER_BUS_FIELD)
        self.assertNotIn("GetGunnerMount", POWER_BUS_FIELD)
        self.assertNotIn("FaceWorldLocation", POWER_BUS_FIELD)
        self.assertNotIn("StarboardGuidanceArray", POWER_BUS_FIELD)
        self.assertNotIn("CommandCore", POWER_BUS_FIELD)
        self.assertNotIn("SetSearchlightTracked", POWER_BUS_FIELD)
        self.assertNotIn("SetContactIdentified", POWER_BUS_FIELD)
        self.assertNotIn(
            "SetFriendlySeparationMeters",
            POWER_BUS_FIELD,
        )
        self.assertNotIn("SetLightningExposed", POWER_BUS_FIELD)
        self.assertNotIn(
            "OpenUpperEngineExposure",
            POWER_BUS_FIELD,
        )
        self.assertNotIn("HullCollider", POWER_BUS_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, POWER_BUS_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_PORT} {POWER_BUS_FIELD}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{POWER_BUS_FIELD}\n}}\n"
        self.assertTrue(
            has_declaration(one_line, POWER_BUS_FIELD)
        )
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, POWER_BUS_FIELD),
    ...
    def test_assigned_power_bus_does_not_satisfy(self) -> None:
        assigned = (
            "\tTObjectPtr<USkyguardBossWeakPointComponent> "
            "PowerBus = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, POWER_BUS_FIELD)
        self.assertIn("PowerBus", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, POWER_BUS_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        ...
        for region in (
            ...
            self.assertIn("PowerBus", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, POWER_BUS_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{POWER_BUS_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, POWER_BUS_FIELD)
        ...
        section = public_section(origin_main_header())
        self.assertIn(UPROPERTY_PORT, section)
        self.assertTrue(has_declaration(section, POWER_BUS_FIELD), section)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            POWER_BUS_FIELD.startswith("UFUNCTION"),
            POWER_BUS_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, POWER_BUS_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", POWER_BUS_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_power_bus_cpp_body(
        self,
    ) -> None:
        locked_only = f"{POWER_BUS_FIELD}\n"
        self.assertNotIn("{", POWER_BUS_FIELD)
        ...
        self.assertNotIn("return false", POWER_BUS_FIELD)
        self.assertNotIn("return true", POWER_BUS_FIELD)
        self.assertNotIn("CreateDefaultSubobject", POWER_BUS_FIELD)
        self.assertNotIn("SetExposed", POWER_BUS_FIELD)
        self.assertNotIn(
            "RefreshAuthoredWeakPointRegistry",
            POWER_BUS_FIELD,
        )
        self.assertNotIn("SetBossPhase", POWER_BUS_FIELD)
        self.assertNotIn(
    ...
    def test_contract_does_not_relock_begin_terminal_strike_cycle_sibling(
        ...
        for token in BEGIN_TERMINAL_STRIKE_CYCLE_NOT_LOCKED:
            ...
            self.assertNotIn(token, POWER_BUS_FIELD)
        self.assertNotIn("BeginTerminalStrikeCycle", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_divert_wreck_from_civilians_sibling(
        ...
        for token in DIVERT_WRECK_FROM_CIVILIANS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, POWER_BUS_FIELD)
        self.assertNotIn("DivertWreckFromCivilians", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_set_civilian_separation_meters_sibling(
        ...
        for token in SET_CIVILIAN_SEPARATION_METERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, POWER_BUS_FIELD)
        self.assertNotIn("SetCivilianSeparationMeters", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_leftover_emergency_finish(self) -> None:
        ...
        self.assertNotIn(leftover_apply_strike(), POWER_BUS_FIELD)
        self.assertNotIn(leftover_is_lock_eligible(), locked_only)
        self.assertNotIn(leftover_is_lock_eligible(), POWER_BUS_FIELD)
        for name in leftover_emergency_finish_names():
            self.assertNotIn(name, locked_only)
            self.assertNotIn(name, POWER_BUS_FIELD)
        for script in leftover_live_copy_boss_scripts():
            self.assertNotIn(script, POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_sibling_last_flight_fields(self) -> None:
        ...
        for token in WEAK_POINT_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, POWER_BUS_FIELD)
        self.assertNotIn("PortGuidanceArray", POWER_BUS_FIELD)
        self.assertNotIn("StarboardGuidanceArray", POWER_BUS_FIELD)
        self.assertNotIn("PortStrikeBayMechanism", POWER_BUS_FIELD)
        self.assertNotIn("StarboardStrikeBayMechanism", POWER_BUS_FIELD)
        self.assertNotIn("PortCoolingSystem", POWER_BUS_FIELD)
        self.assertNotIn("StarboardCoolingSystem", POWER_BUS_FIELD)
        self.assertNotIn("CommandCore", POWER_BUS_FIELD)
        self.assertNotIn("PortEngine", POWER_BUS_FIELD)
        self.assertNotIn("Jammer", POWER_BUS_FIELD)
        self.assertIn(
            "USkyguardBossWeakPointComponent",
            POWER_BUS_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_debris_getters(self) -> None:
        ...
        for token in LEFTOVER_DEBRIS_GETTERS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, POWER_BUS_FIELD)
        self.assertNotIn("GetDefeatDebrisPieceCount", POWER_BUS_FIELD)
        self.assertNotIn("GetMaxDefeatDebrisPieces", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_leftover_starboard_engine(self) -> None:
        ...
        for token in LEFTOVER_STARBOARD_ENGINE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, POWER_BUS_FIELD)
        self.assertNotIn("StarboardEngine", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_leftover_sibling_debris_fields(
        ...
        for token in LEFTOVER_SIBLING_DEBRIS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, POWER_BUS_FIELD)
        self.assertNotIn("DebrisArmorStarboard", POWER_BUS_FIELD)
        self.assertNotIn("DebrisStrikeBayPort", POWER_BUS_FIELD)
        self.assertNotIn("DebrisStrikeBayStarboard", POWER_BUS_FIELD)
        self.assertNotIn("DebrisEnginePort", POWER_BUS_FIELD)
        self.assertNotIn("DebrisEngineStarboard", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_leftover_black_kite(self) -> None:
        ...
        for token in LEFTOVER_BLACK_KITE_NOT_LOCKED:
            ...
            self.assertNotIn(token, POWER_BUS_FIELD)
        self.assertNotIn("SetSearchlightTracked", POWER_BUS_FIELD)
        self.assertNotIn("IsSearchlightTracked", POWER_BUS_FIELD)
        self.assertNotIn("StarboardNavigationVane", POWER_BUS_FIELD)
        self.assertNotIn("PortNavigationVane", POWER_BUS_FIELD)
        self.assertNotIn("DebrisPortVane", POWER_BUS_FIELD)
        self.assertNotIn("DebrisStarboardVane", POWER_BUS_FIELD)
        self.assertNotIn("DebrisJammer", POWER_BUS_FIELD)
        self.assertNotIn("ASkyguardLastFlightBoss", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_ghost(self) -> None:
        ...
        for token in LEFTOVER_RADAR_GHOST_NOT_LOCKED:
            ...
            self.assertNotIn(token, POWER_BUS_FIELD)
        self.assertNotIn("SetContactIdentified", POWER_BUS_FIELD)
        self.assertNotIn("OpenOrbitExposure", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, POWER_BUS_FIELD)
        self.assertNotIn("SetLightningExposed", POWER_BUS_FIELD)
        self.assertNotIn("ASkyguardTempestBoss", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_leftover_iron_rain(self) -> None:
        ...
        self.assertNotIn("ASkyguardIronRainBoss", POWER_BUS_FIELD)
        self.assertNotIn(
            "ASkyguardIronRainBoss::IssueClimbCommand",
            POWER_BUS_FIELD,
        )
    ...
    def test_contract_does_not_relock_leftover_patrol_ship(self) -> None:
        ...
        for token in LEFTOVER_PATROL_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, POWER_BUS_FIELD)
        self.assertNotIn("ASkyguardPatrolShip", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_chin_muzzle(self) -> None:
        ...
        for neighbor in GET_CHIN_MUZZLE_NOT_LOCKED:
            ...
            self.assertNotIn(neighbor, POWER_BUS_FIELD)
        self.assertNotIn("GetChinMuzzleLocation", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_leftover_own_ship_systems(self) -> None:
        ...
        for token in LEFTOVER_OWN_SHIP_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, POWER_BUS_FIELD)
        self.assertNotIn("ESkyguardApacheSystem", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_leftover_gunner(self) -> None:
        ...
        for token in LEFTOVER_GUNNER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, POWER_BUS_FIELD)
        self.assertNotIn("ASkyguardGunner", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_leftover_radar_node(self) -> None:
        ...
        for token in LEFTOVER_RADAR_NODE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, POWER_BUS_FIELD)
        self.assertNotIn("SkyguardRadarNode", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_leftover_widget_decl_siblings(
        ...
        self.assertNotIn("USkyguardDebriefWidget", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_leftover_skyline_harbor_industrial(
        ...
        for token in LEFTOVER_SKYLINE_NOT_LOCKED:
            ...
            self.assertNotIn(token, POWER_BUS_FIELD)
            self.assertNotIn(token, section)
        self.assertNotIn("HarborIndustrial", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        for token in WRONG_HARBOR_HEADERS_NOT_SCANNED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, POWER_BUS_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", POWER_BUS_FIELD)
        self.assertNotIn("MaxIntegrity", POWER_BUS_FIELD)
        self.assertNotIn("CurrentIntegrity", POWER_BUS_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", POWER_BUS_FIELD)
    ...
    def test_contract_does_not_open_leftover_weak_point_component_header(
        ...
        self.assertNotIn(leftover_header, POWER_BUS_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, POWER_BUS_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{POWER_BUS_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, POWER_BUS_FIELD),
            POWER_BUS_FIELD,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "black kite PowerBus field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        ...
        locked_only = f"{POWER_BUS_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, POWER_BUS_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                POWER_BUS_FIELD.lower(),
                "black kite PowerBus contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live copy",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, POWER_BUS_FIELD)

    def test_contract_is_power_bus_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertTrue(POWER_BUS_FIELD.endswith(";"))
        self.assertNotIn("=", POWER_BUS_FIELD)
        self.assertIn(UPROPERTY_PORT, section)
