...
# INDEX_NONE or lock Engine construction in the
...
# CommandAntenna, NoseCamera, ControlLinkage,
...
# drafts #107–#500, plus PathfinderBoss
# production files. This lane only adds an isolated
# Python Engine field declaration contract on
...
# NoseCamera, ControlLinkage, DebrisNose,
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardPathfinderBoss::Engine",
    "SkyguardPathfinderBoss.cpp",
    "SetExposed",
...
class PathfinderEngineFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(has_declaration(section, ENGINE_FIELD))
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = "\tUSkyguardBossWeakPointComponent* Engine;\n"
        as_array = (
            "\tTArray<TObjectPtr<USkyguardBossWeakPointComponent>> "
            "Engine;\n"
        )
        scene = "\tTObjectPtr<USceneComponent> Engine;\n"
        mesh = "\tTObjectPtr<UStaticMeshComponent> Engine;\n"
        weak = (
    ...
    def test_engine_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("CommandCore", ENGINE_FIELD)
        self.assertNotIn("PortEngine", ENGINE_FIELD)
        self.assertNotIn("StarboardEngine", ENGINE_FIELD)
    ...
    def test_contract_does_not_lock_engine_cpp_body(self) -> None:
        ...
        self.assertNotIn("}", ENGINE_FIELD)
        self.assertNotIn("return ", ENGINE_FIELD)
        self.assertNotIn("ASkyguardPathfinderBoss::Engine", ENGINE_FIELD)
        self.assertNotIn("SkyguardPathfinderBoss.cpp", ENGINE_FIELD)
        ...
        self.assertNotIn("RefreshAuthoredWeakPointRegistry", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_sibling_pathfinder_fields(self) -> None:
        ...
        self.assertNotIn("DebrisSpine", ENGINE_FIELD)
        self.assertNotIn("EncounterController", ENGINE_FIELD)
        self.assertIn("USkyguardBossWeakPointComponent", ENGINE_FIELD)
        self.assertIn("Engine", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_starboard_guidance_array(
        ...
        for token in LEFTOVER_STARBOARD_GUIDANCE_ARRAY_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("StarboardGuidanceArray", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_port_strike_bay_mechanism(
        ...
        for token in LEFTOVER_PORT_STRIKE_BAY_MECHANISM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("PortStrikeBayMechanism", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_starboard_strike_bay_mechanism(
        ...
        for token in LEFTOVER_STARBOARD_STRIKE_BAY_MECHANISM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("StarboardStrikeBayMechanism", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_port_cooling_system(self) -> None:
        ...
        for token in LEFTOVER_PORT_COOLING_SYSTEM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("PortCoolingSystem", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_starboard_cooling_system(
        ...
        for token in LEFTOVER_STARBOARD_COOLING_SYSTEM_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("StarboardCoolingSystem", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_jammer(self) -> None:
        ...
        for token in LEFTOVER_JAMMER_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("Jammer", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_last_flight_debris_fields(
        ...
        self.assertNotIn("DebrisArmorStarboard", ENGINE_FIELD)
        self.assertNotIn("DebrisStrikeBayPort", ENGINE_FIELD)
        self.assertNotIn("DebrisStrikeBayStarboard", ENGINE_FIELD)
        self.assertNotIn("DebrisEnginePort", ENGINE_FIELD)
        self.assertNotIn("DebrisEngineStarboard", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_tempest(self) -> None:
        ...
        for token in LEFTOVER_TEMPEST_NOT_LOCKED:
            ...
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("SetLightningExposed", ENGINE_FIELD)
        self.assertNotIn("ASkyguardTempestBoss", ENGINE_FIELD)
    ...
    def test_contract_does_not_relock_leftover_iron_rain(self) -> None:
        ...
        for token in LEFTOVER_IRON_RAIN_NOT_LOCKED:
            ...
            self.assertNotIn(token, ENGINE_FIELD)
        self.assertNotIn("OpenUpperEngineExposure", ENGINE_FIELD)
        self.assertNotIn("ASkyguardIronRainBoss", ENGINE_FIELD)
        self.assertNotIn(
            "ASkyguardIronRainBoss::IssueClimbCommand",
            ENGINE_FIELD,
        )
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(self) -> None:
        ...
        self.assertNotIn("ASkyguardPathfinderBoss::Engine", section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "pathfinder Engine field contract contains "
