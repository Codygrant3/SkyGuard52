...
# INDEX_NONE or lock MissedTrackDamage
# construction in the .cpp. This is leftover-safe
# Mission04 MissedTrackDamage FIELD
# (declaration-only, one-line / split-line
# UPROPERTY wraps plus = 35, ClampMin 1,
# int32 default 35) on
# ASkyguardMission04IntegrationDirector CLASS
# public section, not leftover
# FSkyguardMission04IntegrationReadiness, not
# leftover FSkyguardSearchlightTrackRuntime.
# NOT leftover Mission04 MaximumSubstationIntegrity
# (sibling, ClampMin 1 default 100).
# NOT leftover Mission04 RequiredTrackSeconds #923
# (float 3.f ClampMin 0.1).
# NOT leftover Mission04 CampaignSaveUserIndex #920
# (int32 ClampMin 0, Category Campaign).
# NOT leftover searchlight-track-runtime-defaults #7347 /
# branch cursor/searchlight-track-runtime-
# defaults-contract-7347.
# NOT leftover Mission04 StartSearchlightWindow /
# AdvanceSearchlightTrack method contracts.
# Note EditAnywhere / BlueprintReadWrite /
# Category Skyguard|Mission04 /
# int32 = 35, not VisibleAnywhere /
# BlueprintReadOnly / TObjectPtr. It is
# NOT leftover Mission04 CampaignSaveUserIndex
# FIELD / branch cursor/mission04-campaign-save-
# user-index-field-decl-contract-c332, NOT leftover
# searchlight-track-runtime-defaults #7347 /
# branch cursor/searchlight-track-runtime-
# defaults-contract-7347, NOT leftover Mission04
# StartSearchlightWindow / AdvanceSearchlightTrack,
# NOT leftover Mission04 RequiredTrackSeconds sibling,
# NOT leftover BlackKiteSpawnLocation /
# BlackKiteSpawnRotation, It is
...
# (`int32 MissedTrackDamage = 35;` with
# ClampMin on the same UPROPERTY line);
# accept that form, other one-line / split-line wraps,
# the `= 35` default, and nearby split-line
...
# Do not parse FSkyguardMission04IntegrationReadiness,
# leftover FSkyguardSearchlightTrackRuntime,
# private, or Mission01-03 / Mission05-10 directors.
# Category is Skyguard|Mission04, not leftover
# Mission04 Campaign, not
...
# drafts #674-#916 including leftover Mission04
# CampaignDefinition #914, bAutoInitialize #915,
# MissionDefinition #916, leftover radio-line-
...
# file and the locked Mission04 public decl slice.
# Do not scan
# Apache public section for those tokens. Incoming
# clock names must be absent from the
# Mission04IntegrationDirector public section. Pathfinder MinHeightFromOriginCm
...
# drafts #674-#918 including leftover Mission04
# CampaignDefinition #914, bAutoInitialize #915,
# MissionDefinition #916, leftover #107-#673,
# leftover searchlight-track-runtime-defaults
# #7347, leftover radio-line-defaults #1dec.
# CampaignSaveSlotName / CampaignSaveUserIndex
# may already have newer drafts; do not reopen.
...
UPROPERTY_MISSION04_CLAMP = 'meta=(ClampMin="1")'
...
REQUIRED_TRACK_SECONDS_FIELD = (
    "float RequiredTrackSeconds = 3.f;"
)
MISSED_TRACK_DAMAGE_FIELD = (
...
LOCKED_DECL = MISSED_TRACK_DAMAGE_FIELD
...
# an isolated Python MissedTrackDamage
...
class Mission04MissedTrackDamageFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("MissedTrackDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_missed_track_damage_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        macro_only = f"\t{UPROPERTY_MISSION04}\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn(UPROPERTY_MISSION04_CLAMP, section)
        self.assertIn("EditAnywhere", section)
        self.assertIn("BlueprintReadWrite", section)
        self.assertIn('Category="Skyguard|Mission04"', section)
        ...
        self.assertNotIn("Mission02", UPROPERTY_MISSION04)
        self.assertNotIn("Mission03", UPROPERTY_MISSION04)
        self.assertNotIn("Mission05", UPROPERTY_MISSION04)
        self.assertNotIn("Mission06", UPROPERTY_MISSION04)
        self.assertNotIn("Protection", UPROPERTY_MISSION04)
        self.assertNotIn("Search", UPROPERTY_MISSION04)
        self.assertNotIn("Waves", UPROPERTY_MISSION04)
        self.assertNotIn("Payload", UPROPERTY_MISSION04)
        self.assertNotIn("Targets", UPROPERTY_MISSION04)
        self.assertNotIn("Objectives", UPROPERTY_MISSION04)
        self.assertNotIn("Environment", UPROPERTY_MISSION04)
        self.assertNotIn("Briefing", UPROPERTY_MISSION04)
        self.assertNotIn("Mission10", UPROPERTY_MISSION04)
        self.assertNotIn("Boss", UPROPERTY_MISSION04)
        self.assertNotIn("Destruction", UPROPERTY_MISSION04)
        self.assertNotIn("Apache", UPROPERTY_MISSION04)
        self.assertNotIn("Mission07", UPROPERTY_MISSION04)
        self.assertNotIn("Mission08", UPROPERTY_MISSION04)
        self.assertNotIn("Mission09", UPROPERTY_MISSION04)
        self.assertNotIn("Encounter", UPROPERTY_MISSION04)
        self.assertNotIn("Safety", UPROPERTY_MISSION04)
        self.assertNotIn("Performance", UPROPERTY_MISSION04)
        self.assertNotIn("Hoist", UPROPERTY_MISSION04)
        self.assertNotIn("Rescue", UPROPERTY_MISSION04)
        self.assertNotIn("Evacuation", UPROPERTY_MISSION04)
        self.assertNotIn("Campaign", UPROPERTY_MISSION04)
        self.assertNotIn("Skyguard|Mission04|Campaign", UPROPERTY_MISSION04)
        self.assertNotIn("ClampMin", UPROPERTY_MISSION04)
        self.assertNotIn("ClampMin", LOCKED_DECL)
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, UPROPERTY_MISSION04)
    ...
    def test_missed_track_damage_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 MissedTrackDamage"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("MissedTrackDamage", LOCKED_DECL)
        self.assertIn("= 35", LOCKED_DECL)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION04} {LOCKED_DECL}\n"
            "};\n"
        )
        ...
        wrap_origin_clamp_split = (
            ...
            "\tUPROPERTY(EditAnywhere, BlueprintReadWrite, "
            'Category="Skyguard|Mission04",\n'
            f"\t\t{UPROPERTY_MISSION04_CLAMP})\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
        )
        wrap_origin_one_line_clamp = (
            "public:\n"
            "\tUPROPERTY(EditAnywhere, BlueprintReadWrite, "
            'Category="Skyguard|Mission04", '
            f"{UPROPERTY_MISSION04_CLAMP})\n"
        ...
        header_wrap_origin_one_line_clamp = (
            f"class SKYGUARD52_API {CLASS_NAME} "
            f": public AActor\n{{\n{wrap_origin_one_line_clamp}"
        )
        for header in (
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(environment, UPROPERTY_MISSION04)
        self.assertNotEqual(briefing, UPROPERTY_MISSION04)
        self.assertNotIn(environment, UPROPERTY_MISSION04)
        self.assertNotIn(briefing, UPROPERTY_MISSION04)
        leftover_m01 = (
            'UFUNCTION(BlueprintCallable, '
        ...
        self.assertNotEqual(leftover_m01, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m02, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_harbor, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m03, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m04, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m05, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m06, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_waves, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m05_waves, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_integration, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m07_ready, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m08_waves, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m08_hoist, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m08_safety, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m08_protection, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m08_ready, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m09_ready, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m09_waves, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m10_safety, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m09_protection, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m09_performance, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_m09_objectives, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_payload, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_targets, UPROPERTY_MISSION04)
        self.assertNotEqual(leftover_objectives, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m01, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m02, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_harbor, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m03, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m04, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m05, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m06, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m05_waves, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_integration, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m07_ready, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m08_waves, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m08_hoist, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m08_safety, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m08_protection, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m08_ready, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m09_ready, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m09_waves, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m10_safety, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m09_protection, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m09_performance, UPROPERTY_MISSION04)
        self.assertNotIn(leftover_m09_objectives, UPROPERTY_MISSION04)
        self.assertNotIn("Mission01", UPROPERTY_MISSION04)
        self.assertNotIn("Mission02", UPROPERTY_MISSION04)
        self.assertNotIn("Mission03", UPROPERTY_MISSION04)
        self.assertNotIn("Mission05", UPROPERTY_MISSION04)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("MissedTrackDamage", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 MissedTrackDamage"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("MissedTrackDamage", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 MissedTrackDamage field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission04 MissedTrackDamage contains "
    ...
    def test_contract_is_missed_track_damage_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_missed_track_damage(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_required_track_seconds"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        assigned = "\tint32 MissedTrackDamage = 1;\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_contract_does_not_relock_leftover_handle_boss_phase_changed(
        ...
        for token in LEFTOVER_HANDLE_BOSS_PHASE_CHANGED_NOT_LOCKED:
            ...
            self.assertNotIn(token, LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", LOCKED_DECL)
        self.assertNotIn("HandleBossPhaseChanged", UPROPERTY_MISSION04)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission04_missed_track_damage_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission04_missed_track_damage_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission10_campaign_save_user_index_does_not_satisfy(
        ...
        self.assertNotIn("RequiredTrackSeconds", LOCKED_DECL)
    ...
    def test_leftover_same_name_campaign_save_user_index_contracts_stay_locked(
        ...
        self.assertNotIn(
            "Scripts/tests/test_mission04_missed_track_damage"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_contract_does_not_parse_readiness_struct(self) -> None:
        ...
        self.assertIsNone(
            re.search(
                ...
                r"FSkyguardMission04IntegrationReadiness\b",
                header,
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_parse_searchlight_track_runtime_struct(
        self,
    ) -> None:
        header = origin_main_header()
        struct_only = (
        ...
        self.assertIsNone(
            re.search(
                r"class\s+(?:SKYGUARD52_API\s+)?"
                r"FSkyguardSearchlightTrackRuntime\b",
                header,
            )
        )
        self.assertIn("struct FSkyguardSearchlightTrackRuntime", header)
        section = public_section(header)
        self.assertTrue(has_declaration(section, LOCKED_DECL), section)
        self.assertNotIn("float RemainingSeconds = 0.f;", LOCKED_DECL)
        self.assertNotIn("float HeldSeconds = 0.f;", LOCKED_DECL)
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", LOCKED_DECL)
        self.assertNotIn("RequiredTrackSeconds", LOCKED_DECL)
        self.assertNotIn("BlackKiteSpawnLocation", LOCKED_DECL)
        self.assertNotIn("BlackKiteSpawnRotation", LOCKED_DECL)
        self.assertNotIn(REQUIRED_TRACK_SECONDS_FIELD, LOCKED_DECL)
        self.assertNotIn(MAXIMUM_SUBSTATION_INTEGRITY_FIELD, LOCKED_DECL)
        self.assertNotIn(CAMPAIGN_SAVE_USER_INDEX_FIELD, LOCKED_DECL)
        self.assertNotIn("VisibleAnywhere", UPROPERTY_MISSION04)
        self.assertNotIn("BlueprintReadOnly", UPROPERTY_MISSION04)
