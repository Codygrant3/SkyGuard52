...
# (this is the Integration getter only). Distinct
# from leftover campaign-subsystem
# GetObjectiveRuntime (#313). Distinct from
...
# campaign-subsystem GetObjectiveRuntime.
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission01IntegrationDirector::GetObjectiveRuntime",
    "SkyguardMission01IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission01GetObjectiveRuntimeDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        extra_arg = "\tUSkyguardObjectiveRuntime* GetObjectiveRuntime(int32 Amount) const;\n"
        extra_args = (
            "\tUSkyguardObjectiveRuntime* GetObjectiveRuntime("
            "FName ObjectiveId, int32 Amount = 1) const;\n"
        )
        as_int = "\tint32 GetObjectiveRuntime() const;\n"
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 GetObjectiveRuntime method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission01 GetObjectiveRuntime contains "
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        self.assertNotIn("}", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("return ", GET_OBJECTIVE_RUNTIME)
        self.assertNotIn("return Other", GET_OBJECTIVE_RUNTIME)
