...
# bDefinitionValid FIELD (declaration-only;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe MissionMapReadiness
# bDefinitionValid. THIS IS NOT leftover mission-map-
...
TARGET = "bool bDefinitionValid = false;"
TARGET_WRONG = "bool bDefinitionValid = true;"
LOCKED_DECL = TARGET
...
class MissionMapReadinessDefinitionValidFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bDefinitionValid", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_definition_valid_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_definition_valid_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bDefinitionValid"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bDefinitionValid", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bDefinitionValid", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bDefinitionValid"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bDefinitionValid", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_definition_valid(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
