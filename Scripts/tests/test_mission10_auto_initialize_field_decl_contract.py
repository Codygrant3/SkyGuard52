...
# bAutoInitialize #580, not leftover Mission01
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission10IntegrationDirector::bAutoInitialize",
    "SkyguardMission10IntegrationDirector.cpp",
...
class Mission10AutoInitializeFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_auto_initialize_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
