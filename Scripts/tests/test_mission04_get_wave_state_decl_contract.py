...
# Mission03 GetWaveState #640. Distinct from leftover
...
# #640, leftover Mission04 wave-state enum #bb22
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission04IntegrationDirector::GetWaveState",
    "SkyguardMission04IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission04GetWaveStateDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        with_arg = (
            "\tESkyguardMission04WaveState "
            "GetWaveState(float DeltaSeconds) const;\n"
        )
        renamed = (
            "\tESkyguardMission04WaveState "
            "GetReady() const;\n"
    ...
    def test_get_wave_state_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            GET_WAVE_STATE.startswith("ESkyguardMission04WaveState"),
            GET_WAVE_STATE,
        )
        self.assertTrue(
            GET_WAVE_STATE.endswith(" const"),
            GET_WAVE_STATE,
        )
        self.assertFalse(
        ...
        self.assertNotIn("ESkyguardMission03WaveState", GET_WAVE_STATE)
        ...
        self.assertNotIn("const;", GET_WAVE_STATE)
        ...
        self.assertNotIn("Mission04IntegrationReadiness", GET_WAVE_STATE)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("GetWaveState", GET_WAVE_STATE)
        self.assertTrue(GET_WAVE_STATE.startswith("ESkyguardMission04WaveState"))
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertNotIn("{", GET_WAVE_STATE)
        self.assertNotIn("}", GET_WAVE_STATE)
        self.assertNotIn("return Other", GET_WAVE_STATE)
        self.assertNotIn("return WaveState", GET_WAVE_STATE)
        self.assertNotIn("return Readiness", GET_WAVE_STATE)
        self.assertNotIn("return false", GET_WAVE_STATE)
        self.assertNotIn("return true", GET_WAVE_STATE)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 GetWaveState method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission04 GetWaveState contains "
    ...
    def test_contract_is_get_wave_state_declaration_only(
        ...
        self.assertTrue(GET_WAVE_STATE.startswith("ESkyguardMission04WaveState"))
        self.assertIn("GetWaveState", GET_WAVE_STATE)
        self.assertIn("GetWaveState() const", GET_WAVE_STATE)
        self.assertTrue(GET_WAVE_STATE.endswith(" const"))
        self.assertFalse(GET_WAVE_STATE.endswith(";"))
        self.assertNotIn("ESkyguardMission03WaveState", GET_WAVE_STATE)
        self.assertIn(UFUNCTION_WAVES, section)
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            "public:\n"
            "\tESkyguardMission04WaveState "
            "GetWaveState() const { return Readiness; }\n"
            "};\n"
        )
