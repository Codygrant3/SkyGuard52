...
# Mission06 bAutoLaunchAfterBriefing FIELD
...
class Mission06AutoLaunchAfterBriefingFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_auto_launch_after_briefing_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
