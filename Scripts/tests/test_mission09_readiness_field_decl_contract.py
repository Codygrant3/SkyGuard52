...
# THIS IS leftover-safe Mission09 DIRECTOR CLASS Readiness FIELD
# (declaration-only, one-line / split-line UPROPERTY wraps)
# on ASkyguardMission09IntegrationDirector.
# THIS IS the director-class field
# FSkyguardMission09IntegrationReadiness Readiness;
# THIS IS NOT leftover Mission08 director Readiness #1066 /
# branch cursor/mission08-readiness-field-decl-contract-c332.
# THIS IS NOT leftover FSkyguardMission08IntegrationReadiness
# fields #1067-#1082. THIS IS NOT leftover Mission07 director
# Readiness #1027 / branch
# cursor/mission07-readiness-field-decl-contract-c332.
# THIS IS NOT leftover Mission06 Readiness #995 / leftover
# Mission05 Readiness #960 / leftover Mission04 Readiness
# #926 / leftover Mission03 Readiness #890 / leftover
# Mission02 Readiness #860 / leftover Mission01 Readiness
# #579 / leftover Mission10 Readiness #809.
# THIS IS NOT leftover Mission09 PoolBudget sibling field.
# THIS IS NOT leftover Mission09 Root #1083 through
# CampaignSaveUserIndex #1098. THIS IS NOT leftover
# Mission09 Blueprint UFUNCTION methods. THIS IS NOT leftover
# FSkyguardMission09IntegrationReadiness public UPROPERTY
# fields (later lane). THIS IS NOT leftover spawn-location /
# spawn-rotation fields and leftover runtime-ready flag
# (skip forever). THIS IS NOT leftover Mission08/09
# wave-state enums, protected-target enums,
# protected-target-runtime-defaults, leftover
# hoist-window-runtime-defaults #ec79, leftover Mission09
# pool-runtime-defaults #5426 / leftover Mission09
# pool-budget-defaults #4537.
# LOCK leftover drafts #56-#64 and leftover #107-#673.
# Do not reopen leftover #664, leftover closed-without-merge
# #658-#673, leftover Mission05 closed-without-merge #665
# #666 #668-#673, or open drafts #674-#1098.
...
# methods #729-#749. LOCK leftover Mission08 director Root
# #1044 through Readiness #1066. LOCK leftover
...
# Root #1083 through CampaignSaveUserIndex #1098.
# PARSE DIRECTOR CLASS public section of
# ASkyguardMission09IntegrationDirector only. Do NOT parse
# the FSkyguardMission09IntegrationReadiness struct body
# (its fields are a later lane). Do NOT parse
...
# UPROPERTY(Transient).
# Skip leftover forever: BindRuntimeActors (takes retired
# live-mount pointer), leftover HandleDroneCityImpact,
# leftover GetStormRainBeatKit without UFUNCTION, leftover
# spawn location / leftover runtime-ready flag.
# Harbor 40/80 fail-closed in Mission02/03/04/05/06/07
# test files (Mission08/09-only). Incoming clock names must
# be absent. Apache CPG lock stays 30 mm / Hydra / Hellfire.
# Declaration presence only. Do not invent INDEX_NONE or
# lock Readiness construction in the .cpp. Note
# VisibleAnywhere / BlueprintReadOnly / Category
# Skyguard|Mission09, not EditAnywhere / BlueprintReadWrite
# / FSkyguardMission09PoolBudget / TObjectPtr.
# origin/main is a one-line field
# (`FSkyguardMission09IntegrationReadiness Readiness;`);
# accept that form, other one-line / split-line wraps,
# and nearby split-line UPROPERTY wraps without locking
# invented metadata.
# Nearby origin/main
# UPROPERTY(VisibleAnywhere, BlueprintReadOnly,
# Category="Skyguard|Mission09")
# is required as present. Accept one-line and split-line
# UPROPERTY wraps. Parse the DIRECTOR CLASS public section
# of ASkyguardMission09IntegrationDirector only.
...
# not Mission10|Campaign, not Integration, not
# Mission01 / Mission02 / Mission03 / Mission04 /
# Mission05 / Mission06 / Mission07 / Mission08, not
# leftover Mission01 Root #574, not leftover Mission01
# Readiness #579, not leftover Mission10 GetReadiness
# #776, not leftover Mission09 Protection #763, Payload /
# Targets / Objectives / Search / Waves / Hoist / Safety /
# Boss / Destruction / Briefing / Rescue / Performance /
# Evacuation, not Environment, not leftover
# briefing-widget, not leftover MissionBriefingComponent
# methods, not leftover Mission01 Integration, not leftover
# Mission03 Integration, not leftover Mission04
# Integration, not leftover Mission05 Integration #666,
# not leftover Mission06 Waves #699, not leftover
# Mission05 Waves #677, not leftover Mission07 Waves #721,
...
# Objectives, not leftover Mission02 Integration.
...
# drafts #674-#1098, leftover Apache MaxIntegrity /
# CurrentIntegrity, leftover Apache mount getters #851b /
# own-ship #96c5 / chin muzzle #4e39, leftover
# settings-apply-broadcast #1268, leftover patrol-ship
# empty fail-closed #5382, leftover RadarNode, leftover
# named boss methods, leftover LifelineHunter
# OpticalTracker / WeaponServo / CountermeasurePod /
# Engine fields, leftover briefing / debrief widget
# isolated contracts, leftover briefing-card /
# briefing-radio-row defaults, leftover briefing
# fail-closed tests, leftover environment-readiness
# defaults #6b9d / #b931, leftover
# mission-map-readiness-defaults #3a2a, leftover skyline
...
# Mission09IntegrationDirector public section. Pathfinder
# MinHeightFromOriginCm is the wrong header, not Harbor
# 40/80. LastFlight MinimumCivilianSeparationMeters =
# 550.f is Harbor-adjacent; do not treat as Harbor 40/80.
# LifelineHunter MinimumWeaponSeparationMeters = 450.f
# is Harbor-adjacent. Do not lock leftover
# ESkyguardMission02WaveState while leftover Harbor
# #6/#8/#9 remain open. Skip leftover #664 cloud-env
# install. Do not reopen leftover drafts #536-#673. Do
# not reopen leftover #668/#669. Do not reopen leftover
# Mission07 GetReadiness #718. Do not reopen leftover
...
# Mission01 Readiness field #579. Do not reopen leftover
# Mission10 route-phase enum #701a, leftover Mission10
# protected-group enum #6f9d, leftover Mission10
# protected-runtime-defaults #7898. Do not reopen leftover
# Mission08 wave-state enum #68fc / #237, leftover
# Mission08 protected-target enum #a66a / #229, leftover
# Mission08 protected-target-runtime-defaults #75e6 /
# #226, leftover hoist-window-runtime-defaults #ec79.
...
# drafts #56-#64, leftover drafts #107-#673, leftover
# #664, closed-without-merge #658-#673 including
# Mission04 GetRemainingThreatsInWave #662. Do not
# reopen open drafts #674-#1098.
...
# leftover Mission01 Readiness #579, leftover
# Mission10 GetReadiness #776, leftover
...
LOCKED_SCRIPTS = (
    ...
    "Scripts/tests/test_mission09_iron_rain_spawn_location_field_decl_contract.py",
    ...
    "Scripts/tests/test_get_campaign_save_user_index_decl_contract.py",
    "Scripts/tests/test_set_campaign_save_user_index_decl_contract.py",
    "Scripts/tests/test_campaign_save_user_index_decl_contract.py",
    ...
    "Scripts/tests/test_campaign_save_slot_name_decl_contract.py",
    "Scripts/tests/test_get_campaign_save_slot_name_decl_contract.py",
    "Scripts/tests/test_set_campaign_save_slot_name_decl_contract.py",
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission04IntegrationDirector::Readiness",
    "SkyguardMission10IntegrationDirector.cpp",
...
LEFTOVER_MISSION02_READINESS_FIELD_NOT_LOCKED = (
    ...
    "cursor/mission02-readiness-field-decl-contract-c332",
...
LEFTOVER_MISSION03_READINESS_FIELD_NOT_LOCKED = (
    ...
    "cursor/mission03-readiness-field-decl-contract-c332",
    'Category="Skyguard|Mission03"',
    "FSkyguardMission03IntegrationReadiness Readiness;",
)

LEFTOVER_MISSION05_READINESS_FIELD_NOT_LOCKED = (
    "ASkyguardMission05IntegrationDirector",
    "SkyguardMission05IntegrationDirector.h",
...
LEFTOVER_MISSION06_READINESS_FIELD_NOT_LOCKED = (
    "ASkyguardMission06IntegrationDirector",
    "SkyguardMission06IntegrationDirector.h",
    "test_mission06_readiness_field_decl_contract.py",
    "cursor/mission06-readiness-field-decl-contract-c332",
    'Category="Skyguard|Mission06"',
    "FSkyguardMission06IntegrationReadiness Readiness;",
)
LEFTOVER_MISSION07_READINESS_FIELD_NOT_LOCKED = (
    "ASkyguardMission07IntegrationDirector",
    "SkyguardMission07IntegrationDirector.h",
    "test_mission07_readiness_field_decl_contract.py",
    "cursor/mission07-readiness-field-decl-contract-c332",
    'Category="Skyguard|Mission07"',
    "FSkyguardMission07IntegrationReadiness Readiness;",
)
LEFTOVER_MISSION08_READINESS_FIELD_NOT_LOCKED = (
    "ASkyguardMission08IntegrationDirector",
    "SkyguardMission08IntegrationDirector.h",
    "test_mission08_readiness_field_decl_contract.py",
    "cursor/mission08-readiness-field-decl-contract-c332",
    'Category="Skyguard|Mission08"',
    "FSkyguardMission08IntegrationReadiness Readiness;",
)
LEFTOVER_MISSION08_SIBLING_FIELDS_NOT_LOCKED = (
...
LEFTOVER_MISSION07_SIBLING_FIELDS_NOT_LOCKED = (
    "test_mission07_root_field_decl_contract.py",
    "test_mission07_briefing_field_decl_contract.py",
    "test_mission07_audio_director_field_decl_contract.py",
    "test_mission07_radio_chatter_field_decl_contract.py",
    "test_mission07_sortie_presentation_field_decl_contract.py",
    "test_mission07_campaign_definition_field_decl_contract.py",
    "test_mission07_mission_definition_field_decl_contract.py",
    "test_mission07_auto_initialize_field_decl_contract.py",
    "test_mission07_allow_bounded_actor_spawning_field_decl_contract.py",
    "test_mission07_auto_launch_after_briefing_field_decl_contract.py",
    "test_mission07_campaign_save_slot_name_field_decl_contract.py",
...
LEFTOVER_MISSION05_SIBLING_FIELDS_NOT_LOCKED = (
...
LEFTOVER_MISSION05_WAVE_STATE_ENUM_NOT_LOCKED = (
    "ESkyguardMission05WaveState",
    "test_mission05_wave_state_enum_contract.py",
    "cursor/mission05-wave-state-enum-contract-ad28",
)
LEFTOVER_MISSION05_PROTECTED_TARGET_NOT_LOCKED = (
    "ESkyguardMission05ProtectedTarget",
    "test_mission05_protected_target_enum_contract.py",
    "cursor/mission05-protected-target-enum-contract-aaa2",
    "test_mission05_protected_target_runtime_defaults_contract.py",
    "cursor/mission05-protected-target-runtime-defaults-ec8b",
)
LEFTOVER_STORM_RUNTIME_DEFAULTS_NOT_LOCKED = (
    "FSkyguardStormRuntime",
    "test_storm_runtime_defaults_contract.py",
    "cursor/storm-runtime-defaults-contract-89c9",
)
LEFTOVER_MISSION10_READINESS_FIELD_NOT_LOCKED = (
    "ASkyguardMission10IntegrationDirector",
    "SkyguardMission10IntegrationDirector.h",
    "test_mission10_readiness_field_decl_contract.py",
    "cursor/mission10-readiness-field-decl-contract-c332",
    'Category="Skyguard|Mission10"',
    "FSkyguardMission10IntegrationReadiness Readiness;",
)
LEFTOVER_SAME_NAME_READINESS_FIELD_NOT_LOCKED = (
    "test_mission01_readiness_field_decl_contract.py",
    "test_mission02_readiness_field_decl_contract.py",
    "test_mission03_readiness_field_decl_contract.py",
    "test_mission04_readiness_field_decl_contract.py",
...
LEFTOVER_GET_READINESS_METHODS_NOT_LOCKED = (
    "GetReadiness",
    "test_mission01_get_readiness_decl_contract.py",
...
LEFTOVER_RADIO_LINE_DEFAULTS_NOT_LOCKED = (
    "test_radio_line_defaults_contract.py",
    "cursor/radio-line-defaults-contract-1dec",
)
...
class Mission09ReadinessFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_readiness_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("Skyguard|Mission05|Protection", UPROPERTY_MISSION09)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_m01_readiness_type = (
            "\tFSkyguardMission01IntegrationReadiness Readiness;\n"
        )
        leftover_get_readiness_method = f"\t{GET_READINESS}\n"
        leftover_map_readiness = (
        ...
        leftover_readiness_field = f"\t{ROOT_FIELD}\n"
    ...
    def test_readiness_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FSkyguardMission09IntegrationReadiness "),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("Readiness", LOCKED_DECL)
        self.assertIn("FSkyguardMission09IntegrationReadiness", LOCKED_DECL)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 GetProtectedGroup method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission10 GetProtectedGroup contains "
    ...
    def test_contract_is_readiness_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertNotIn("return ", LOCKED_DECL)
        self.assertNotIn("{", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("FSkyguardMission09IntegrationReadiness"))
        self.assertIn("Readiness", LOCKED_DECL)
    ...
    def test_sibling_director_fields_do_not_satisfy_readiness(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission09_readiness_field"
            "_decl_contract.py"
        )
        self.assertNotIn(this_script, LOCKED_SCRIPTS)
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_readiness_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission08_readiness_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission02_briefing_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission02_radio_chatter_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission02_sortie_presentation_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission02_mission_definition_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission02_allow_bounded_actor_spawning"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission02_campaign_save_slot_name"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_mission04_get_readiness_does_not_satisfy(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", LOCKED_DECL)
        self.assertNotIn("BlueprintPure", LOCKED_DECL)
        self.assertNotIn("return Readiness", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_leftover_mission10_protected_group(
        ...
        self.assertNotIn("FSkyguardPayloadWindowRuntime", LOCKED_DECL)
        self.assertNotIn("bool bMissionDefinitionValid = false;", LOCKED_DECL)
        self.assertNotIn("bool bCampaignDefinitionValid = false;", LOCKED_DECL)
    ...
    def test_leftover_mission01_readiness_field_does_not_satisfy(self) -> None:
        leftover_m01_field = (
            "\tFSkyguardMission01IntegrationReadiness Readiness;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m01_field, LOCKED_DECL)
        self.assertIn("Readiness", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover_m01_field, LOCKED_DECL))
        leftover = (
            "class SKYGUARD52_API ASkyguardMission01IntegrationDirector "
            ": public AActor\n"
            "{\n"
    ...
    def test_leftover_mission10_get_readiness_method_does_not_satisfy(
        self,
    ) -> None:
        leftover_method = f"\t{GET_READINESS}\n"
        with self.assertRaises(AssertionError) as raised:
    ...
    def test_leftover_mission02_readiness_field_does_not_satisfy(self) -> None:
        leftover_m02_field = (
            "\tFSkyguardMission02IntegrationReadiness Readiness;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m02_field, LOCKED_DECL)
        self.assertIn("Readiness", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover_m02_field, LOCKED_DECL))
        leftover = (
            "class SKYGUARD52_API ASkyguardMission02IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        self.assertNotIn("FSkyguardMission02IntegrationReadiness", LOCKED_DECL)
        self.assertNotIn("Mission02", UPROPERTY_MISSION09)

    def test_leftover_mission03_readiness_field_does_not_satisfy(self) -> None:
        leftover_m03_field = (
            "\tFSkyguardMission03IntegrationReadiness Readiness;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m03_field, LOCKED_DECL)
        self.assertIn("Readiness", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover_m03_field, LOCKED_DECL))
        leftover = (
            "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        self.assertNotIn("FSkyguardMission03IntegrationReadiness", LOCKED_DECL)
        self.assertNotIn("Mission03", UPROPERTY_MISSION09)

    def test_leftover_mission10_readiness_field_does_not_satisfy(self) -> None:
        leftover_m10_field = (
            "\tFSkyguardMission10IntegrationReadiness Readiness;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m10_field, LOCKED_DECL)
        self.assertIn("Readiness", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover_m10_field, LOCKED_DECL))
        leftover = (
            "class SKYGUARD52_API ASkyguardMission10IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        self.assertNotIn("FSkyguardMission10IntegrationReadiness", LOCKED_DECL)
        self.assertNotIn("Mission10", UPROPERTY_MISSION09)

    def test_leftover_mission04_readiness_field_does_not_satisfy(self) -> None:
        leftover_m04_field = (
            "\tFSkyguardMission04IntegrationReadiness Readiness;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m04_field, LOCKED_DECL)
        self.assertIn("Readiness", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover_m04_field, LOCKED_DECL))
        leftover = (
    ...
    def test_contract_does_not_parse_storm_runtime(self) -> None:
        header = origin_main_header()
        struct_only = (
        ...
        self.assertIsNone(
            re.search(
                r"class\s+(?:SKYGUARD52_API\s+)?"
                r"FSkyguardStormRuntime\b",
                header,
            )
        )
    ...
    def test_leftover_mission05_sibling_field_drafts_stay_locked(self) -> None:
        for leftover in LEFTOVER_MISSION05_SIBLING_FIELDS_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
            else:
                self.assertNotIn(leftover, LOCKED_DECL)
        for leftover in LEFTOVER_MISSION05_WAVE_STATE_ENUM_NOT_LOCKED:
            if leftover.endswith(".py") or leftover.startswith("cursor/"):
                if leftover.endswith(".py"):
                    self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
            else:
                self.assertNotIn(leftover, LOCKED_DECL)
        for leftover in LEFTOVER_MISSION05_PROTECTED_TARGET_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
            elif leftover.startswith("cursor/"):
                continue
            else:
                self.assertNotIn(leftover, LOCKED_DECL)
        for leftover in LEFTOVER_STORM_RUNTIME_DEFAULTS_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
            elif leftover.startswith("cursor/"):
                continue
    ...
    def test_leftover_same_name_readiness_contracts_stay_locked(self) -> None:
        for leftover in LEFTOVER_SAME_NAME_READINESS_FIELD_NOT_LOCKED:
            self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        for leftover in LEFTOVER_GET_READINESS_METHODS_NOT_LOCKED:
            if leftover.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover, LOCKED_SCRIPTS)
        self.assertIn(
            "Scripts/tests/test_mission07_readiness_field"
        ...
        self.assertIn(
            "Scripts/tests/test_mission03_campaign_save_slot_name"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission04_campaign_save_slot_name"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
        ...
        self.assertNotIn("EditAnywhere", UPROPERTY_MISSION09)
        self.assertNotIn("BlueprintReadWrite", UPROPERTY_MISSION09)
        self.assertIn("VisibleAnywhere", UPROPERTY_MISSION09)
        self.assertIn("BlueprintReadOnly", UPROPERTY_MISSION09)

    def test_contract_does_not_parse_readiness_struct(self) -> None:
        header = origin_main_header()
        struct_only = (
            "USTRUCT(BlueprintType)\n"
            "struct FSkyguardMission09IntegrationReadiness\n"
        ...
        self.assertIsNone(
            re.search(
                r"class\s+(?:SKYGUARD52_API\s+)?"
                r"FSkyguardMission09IntegrationReadiness\b",
                header,
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission07_readiness_field_does_not_satisfy(self) -> None:
        leftover_m07_field = (
            "\tFSkyguardMission07IntegrationReadiness Readiness;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m07_field, LOCKED_DECL)
        self.assertIn("Readiness", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover_m07_field, LOCKED_DECL))
        leftover = (
        ...
        self.assertNotIn("FSkyguardMission07IntegrationReadiness", LOCKED_DECL)
        self.assertNotIn("Mission07", UPROPERTY_MISSION09)
        for leftover_script in LEFTOVER_MISSION07_READINESS_FIELD_NOT_LOCKED:
            if leftover_script.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover_script, LOCKED_SCRIPTS)
            else:
                self.assertNotIn(leftover_script, LOCKED_DECL)

    def test_leftover_mission08_sibling_director_fields_stay_locked(
        self,
    ) -> None:
        for leftover in (
            "Scripts/tests/test_mission08_mission_definition_valid"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission08_campaign_definition_valid"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission08_maximum_protected_target_integrity"
            "_field_decl_contract.py",
        ...
        self.assertNotIn("bMissionDefinitionValid", LOCKED_DECL)
        self.assertNotIn("bCampaignDefinitionValid", LOCKED_DECL)
        self.assertNotIn("UpdateReadiness", LOCKED_DECL)

    def test_leftover_mission08_readiness_field_does_not_satisfy(self) -> None:
        leftover_m08_field = (
            "\tFSkyguardMission08IntegrationReadiness Readiness;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m08_field, LOCKED_DECL)
        self.assertIn("Readiness", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(leftover_m08_field, LOCKED_DECL))
        leftover = (
            "class SKYGUARD52_API ASkyguardMission08IntegrationDirector "
            ": public AActor\n"
            "{\n"
        ...
        self.assertNotIn("FSkyguardMission08IntegrationReadiness", LOCKED_DECL)
        self.assertNotIn("Mission08", UPROPERTY_MISSION09)
        for leftover_script in LEFTOVER_MISSION08_READINESS_FIELD_NOT_LOCKED:
            if leftover_script.endswith(".py"):
                self.assertIn("Scripts/tests/" + leftover_script, LOCKED_SCRIPTS)
            else:
                self.assertNotIn(leftover_script, LOCKED_DECL)

    def test_leftover_mission09_sibling_director_fields_stay_locked(
        self,
    ) -> None:
        for leftover in (
            "Scripts/tests/test_mission09_root_field_decl_contract.py",
            "Scripts/tests/test_mission09_skyline_anchor"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission09_power_station_anchor"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission09_major_bridge_anchor"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission09_briefing_field_decl_contract.py",
            "Scripts/tests/test_mission09_audio_director"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission09_radio_chatter"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission09_sortie_presentation"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission09_campaign_definition"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission09_mission_definition"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission09_auto_initialize"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission09_allow_bounded_actor_spawning"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission09_campaign_save_slot_name"
            "_field_decl_contract.py",
            "Scripts/tests/test_mission09_campaign_save_user_index"
            "_field_decl_contract.py",
        ):
            self.assertIn(leftover, LOCKED_SCRIPTS)
        locked_only = f"{LOCKED_DECL}\n"
        ...
        self.assertNotIn("IronRainSpawnLocation", LOCKED_DECL)
        self.assertNotIn("SkylineAnchor", LOCKED_DECL)
        self.assertNotIn("PowerStationAnchor", LOCKED_DECL)
        self.assertNotIn("MajorBridgeAnchor", LOCKED_DECL)
        self.assertNotIn("bMissionDefinitionValid", LOCKED_DECL)
        self.assertNotIn("ProtectedTargetCount", LOCKED_DECL)
        self.assertNotIn("UpdateReadiness", LOCKED_DECL)
