...
# Mission02 Integration ValidateMissionContract
# METHOD (declaration-only, split-line) on
# ASkyguardMission02IntegrationDirector. It is
# NOT leftover Mission10 ValidateMissionContract
# #785 / branch cursor/mission10-validate-mission-
# contract-decl-contract-c332, NOT leftover
# Mission09 ValidateMissionContract
# #767 / branch cursor/mission09-validate-mission-
# contract-decl-contract-c332, NOT leftover
# Mission08 ValidateMissionContract #748, NOT leftover
...
# Mission04 / Mission03 / Mission01
# ValidateMissionContract drafts, NOT leftover
# Mission10 ValidateWeaponRelease #772, NOT leftover
# Mission10 GetMissionId (sibling; do not lock it
# as the subject), NOT leftover Mission10
# GetProtectedGroup #782, NOT leftover Mission10
# protected-group enum
...
# GetMissionId / GetProtectedGroup. Do not
...
# and an inline body without locking a different body.
# Nearby origin/main
...
# Protection, not Mission01 / Mission10 / Mission03 /
# Mission04 / Mission05 / Mission06 / Mission07 /
# Mission08 / Mission09, not leftover Mission09
...
# Objectives, not leftover Mission10 Protection / Safety / Waves.
...
# drafts #674–#783, leftover Apache
...
# drafts #674–#783. Do not reopen leftover
# Mission09 / Mission08 / Mission07 / Mission06 /
# Mission05 ValidateMissionContract drafts
# #767 / #748 / #728 / #707 / #686.
...
GET_BREAKWATER = (
    "ASkyguardBreakwaterBoss* GetBreakwater() const "
    "{ return Breakwater; }"
)
GET_MISSION02_MISSION_ID = (
    "static FName GetMissionId() "
...
# an isolated Python ValidateMissionContract
...
LEFTOVER_MISSION09_VALIDATE_NOT_LOCKED = (
    "test_mission09_validate_mission_contract_decl_contract.py",
    "ASkyguardMission09IntegrationDirector",
    "SkyguardMission09IntegrationDirector.h",
    'Category="Skyguard|Mission09|Integration"',
    "cursor/mission09-validate-mission-contract-decl-contract-c332",
)
LEFTOVER_MISSION08_VALIDATE_NOT_LOCKED = (
    "test_mission08_validate_mission_contract_decl_contract.py",
    "ASkyguardMission08IntegrationDirector",
    "SkyguardMission08IntegrationDirector.h",
    'Category="Skyguard|Mission08|Integration"',
    "cursor/mission08-validate-mission-contract-decl-contract-c332",
)
...
LEFTOVER_MISSION10_VALIDATE_NOT_LOCKED = (
    "test_mission10_validate_mission_contract_decl_contract.py",
    "ASkyguardMission10IntegrationDirector",
    "SkyguardMission10IntegrationDirector.h",
    'Category="Skyguard|Mission10|Integration"',
    "cursor/mission10-validate-mission-contract-decl-contract-c332",
)
LEFTOVER_MISSION04_VALIDATE_NOT_LOCKED = (
    ...
    "SkyguardMission04IntegrationDirector.h",
    'Category="Skyguard|Mission04|Integration"',
    "cursor/mission04-validate-mission-contract-decl-contract-c332",
)
LEFTOVER_MISSION03_VALIDATE_NOT_LOCKED = (
    ...
    "SkyguardMission03IntegrationDirector.h",
    'Category="Skyguard|Mission03|Integration"',
    "cursor/mission03-validate-mission-contract-decl-contract-c332",
)
LEFTOVER_MISSION01_VALIDATE_NOT_LOCKED = (
    ...
    "SkyguardMission01IntegrationDirector.h",
    'Category="Skyguard|Mission01|Integration"',
    "cursor/mission01-validate-mission-contract-decl-contract-c332",
)
LEFTOVER_MISSION02_SIBLING_METHODS_NOT_LOCKED = (
    ...
    "test_mission02_get_breakwater_decl_contract.py",
...
class Mission02ValidateMissionContractDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tvoid ValidateMissionContract();\n"
        )
        as_const = (
            "\tstatic bool ValidateMissionContract() const;\n"
        )
        with_arg = (
            "\tstatic bool ValidateMissionContract(int32 Amount);\n"
        )
        renamed = (
            "\tstatic bool ValidateMissionDefinition();\n"
        )
        short_name = "\tstatic bool ValidateContract();\n"
        leftover_m06_type = (
            "\tFSkyguardMission09ProtectedTargetRuntime GetProtectedTarget("
            "ESkyguardMission09ProtectedTarget Target) const;\n"
        )
        ...
        leftover_validate = f"\t{GET_MISSION_ID}\n"
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("ValidateMissionContract", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("static bool "))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("ValidateMissionContract", locked_only)
        self.assertNotIn("GetProtectedGroup", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 ValidateMissionContract method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 ValidateMissionContract contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_validate_mission_contract"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission09_validate(self) -> None:
        locked_only = f"{LOCKED_DECL}\n"
        for token in LEFTOVER_MISSION09_VALIDATE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission08_validate(self) -> None:
        locked_only = f"{LOCKED_DECL}\n"
        for token in LEFTOVER_MISSION08_VALIDATE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        self.assertIn(
    ...
    def test_locked_scripts_list_sibling_mission10_contracts(self) -> None:
        required = (
            "Scripts/tests/test_mission10_initialize_playable_mission"
            "_decl_contract.py",
            "Scripts/tests/test_mission10_configure_mission_definition"
    ...
    def test_contract_does_not_relock_leftover_mission10_validate(self) -> None:
        locked_only = f"{LOCKED_DECL}\n"
        for token in LEFTOVER_MISSION10_VALIDATE_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, LOCKED_DECL)
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission03_validate(self) -> None:
        locked_only = f"{LOCKED_DECL}\n"
    ...
    def test_contract_does_not_relock_leftover_mission01_validate(self) -> None:
        locked_only = f"{LOCKED_DECL}\n"
    ...
    def test_leftover_mission02_sibling_methods_do_not_satisfy(self) -> None:
        for leftover in LEFTOVER_MISSION02_SIBLING_METHODS_NOT_LOCKED:
            if leftover.startswith("test_") or leftover.startswith("cursor/"):
                continue
            region = f"\t{leftover}\n"
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, LOCKED_DECL)
        ...
        self.assertNotIn(GET_BREAKWATER, LOCKED_DECL)
        self.assertNotIn(GET_CURRENT_WAVE_INDEX, LOCKED_DECL)
        self.assertNotIn("InitializePlayableMission", LOCKED_DECL)
        self.assertNotIn("ConfigureMissionDefinition", LOCKED_DECL)
        self.assertIn(
    ...
    def test_locked_scripts_list_sibling_mission02_and_mission10_contracts(
        self,
    ) -> None:
        required = (
            "Scripts/tests/test_mission02_initialize_playable_mission"
