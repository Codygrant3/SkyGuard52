...
# bClassifiedFalse FIELD (declaration-only;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe Mission07 SearchTrackRuntime
# bClassifiedFalse FIELD. THIS IS NOT leftover SearchTrackRuntime
# TrackId #1133. THIS IS NOT leftover SearchTrackRuntime
# Sector #1135. THIS IS NOT leftover search-track-
...
# bActive #1130 / CoveredSeconds #1131 / RemainingSeconds #1132 /
# CompletedWindows #1134. LOCK leftover
...
# = false on this bool field. This is leftover-safe
# Mission07 SearchTrackRuntime bClassifiedFalse
...
# bClassifiedFalse FIELD (declaration-only). It is
...
# an isolated Python bClassifiedFalse
...
class Mission07SearchTrackRuntimeClassifiedFalseFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bClassifiedFalse", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_active_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bClassifiedFalse"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bClassifiedFalse", LOCKED_DECL)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertIn("bClassifiedFalse", section)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bClassifiedFalse", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bClassifiedFalse"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bClassifiedFalse", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 bClassifiedFalse field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission07 bClassifiedFalse contains "
