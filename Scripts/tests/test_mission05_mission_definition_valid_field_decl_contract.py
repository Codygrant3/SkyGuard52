...
STRUCT_NAME = "FSkyguardMission05IntegrationReadiness"
...
# Mission05 IntegrationReadiness bMissionDefinitionValid
...
# (not ASkyguardMission05IntegrationDirector public
# fields already drafted through Readiness #960 /
# MaximumProtectedTargetIntegrity #961 /
# TempestSpawnRotation #962, not leftover
...
# not leftover Mission01/02/03/04/06-10 readiness structs).
...
# the locked FSkyguardMission05IntegrationReadiness
# public section. Do not parse
# ASkyguardMission05IntegrationDirector director-class
# fields. Do not parse FSkyguardStormRuntime. Pathfinder MinHeightFromOriginCm
...
# drafts #674-#962. Do not reopen leftover
...
# same-name Readiness drafts or leftover Mission02/03/04/10
# same-name director field drafts.
...
class Mission05MissionDefinitionValidFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 bMissionDefinitionValid field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 bMissionDefinitionValid contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_mission_definition"
                "_valid_field_decl_contract.py"
            )
        )
        self.assertIn(
