# THIS IS leftover-safe FSkyguardLoadoutSpec GuidedReserve.
# origin/main form: BARE
# `int32 GuidedReserve = SkyguardApacheCpgFeel::GuidedReserve;`
# THIS STRUCT IS A PLAIN C++ STRUCT. NOT UPROPERTY. NOT USTRUCT.
# NO Category. NO BlueprintReadOnly. NO EditAnywhere.
# NO VisibleAnywhere. NO GENERATED_BODY.
# Fail-closed if a clone still asserts UPROPERTY / Category /
# VisibleAnywhere / EditAnywhere / BlueprintReadOnly /
# GENERATED_BODY / USTRUCT as the locked decl.
# Locked decl must be the BARE field
# `int32 GuidedReserve = SkyguardApacheCpgFeel::GuidedReserve;`
# Parse STRUCT `FSkyguardLoadoutSpec` body ONLY after
# `struct FSkyguardLoadoutSpec`. Stop before
# `FSkyguardLoadoutSpec SkyguardResolveLoadout`.
# Do NOT parse leftover `SkyguardApacheCpgFeel` namespace as
# the parse window (the initializer references it; do not
# lock the feel namespace itself).
# Do NOT parse leftover `ESkyguardLoadout` enum body.
# Do NOT parse leftover `ESkyguardGunshipWeapon` enum body.
# Do NOT parse leftover `FSkyguardCpgDebriefSnapshot`.
# Do NOT parse leftover `FSkyguardCpgHudSnapshot`.
# Do NOT parse leftover analog bulk #253.
# Do NOT parse leftover apache-cpg-feel #118.
# Do NOT parse leftover resolve-loadout #275.
# Do NOT parse leftover loadout-display-name #263.
# Do NOT parse leftover loadout-slot-helpers #262.
# Do NOT parse leftover CpgDebriefSnapshot isolated
# #1451-#1465.
# Do NOT parse leftover LoadoutSpec Loadout #1468.
# Do NOT parse leftover LoadoutSpec StartingStation #1466.
# Do NOT parse leftover LoadoutSpec FlareCount #1467.
# Do NOT parse leftover LoadoutSpec CannonMagazineSize.
# Do NOT parse leftover LoadoutSpec CannonReserve.
# Do NOT parse leftover LoadoutSpec RocketMagazineSize.
# Do NOT parse leftover LoadoutSpec RocketReserve.
# Do NOT parse leftover LoadoutSpec GuidedMagazineSize.
# Do NOT parse leftover MeshBindSlot #1447-#1450.
# Do NOT parse leftover TheaterKit.
# Do NOT parse leftover MissionDefinition #350-#364.
# Do NOT parse leftover USkyguardRuntimeMeshCatalog.
...
# Do NOT parse leftover Harbor 40/80 directors.
# Do NOT parse leftover retired mount / player-weapon types
# (split tokens).
# Exact identifier vs siblings CannonMagazineSize /
# CannonReserve / RocketMagazineSize / RocketReserve /
# GuidedMagazineSize (same int32 type and same
# SkyguardApacheCpgFeel:: style initializer, different
# identifier) and vs FlareCount (`int32 FlareCount = 6`),
# Loadout, StartingStation, HullIntegrity, PlaystyleLine.
# Do not claim sibling fields. Fail-closed if type is not
# `int32`, initializer missing, is a literal (`= 0`,
# `= 6`, `= 100`, `= 0.f`), or points at a different
# CpgFeel constant (CannonMagazineSize / CannonReserve /
# RocketMagazineSize / GuidedMagazineSize / etc.).
# Analog leftover loadout-spec-defaults #253 / #ff30
# (`Scripts/tests/test_loadout_spec_defaults_contract.py`).
# Keep that bulk analog in LOCKED_SCRIPTS. Do not reopen
# leftover #253. Then this isolated FIELD decl.
# Leftover analog apache-cpg-feel #118 stays in
# LOCKED_SCRIPTS; do not reopen it.
# Harbor 40/80 fail-closed. CpgFeel constant initializer
# is not Harbor. Sibling HullIntegrity 14 + 0.f is not
# this slot and is not Harbor.
...
LEFTOVER_SORTIE = "ASkyguardGunshipSortieDirector"
LEFTOVER_CPG_FEEL = "SkyguardApacheCpgFeel"
LEFTOVER_LOADOUT_ENUM = "ESkyguardLoadout"
LEFTOVER_WEAPON_ENUM = "ESkyguardGunshipWeapon"
TARGET = (
    "int32 GuidedReserve = "
    "SkyguardApacheCpgFeel::GuidedReserve;"
)
TARGET_WRONG_BARE = "int32 GuidedReserve;"
TARGET_WRONG_ZERO = "int32 GuidedReserve = 0;"
TARGET_WRONG_ZERO_F = "int32 GuidedReserve = 0.f;"
TARGET_WRONG_FALSE = "int32 GuidedReserve = false;"
TARGET_WRONG_HUNDRED = "int32 GuidedReserve = 100;"
TARGET_WRONG_SIX = "int32 GuidedReserve = 6;"
TARGET_WRONG_CPG_FEEL = (
    "int32 GuidedReserve = SkyguardApacheCpgFeel::CannonMagazineSize;"
)
TARGET_WRONG_ROCKET_MAG = (
    "int32 GuidedReserve = "
    "SkyguardApacheCpgFeel::RocketMagazineSize;"
)
TARGET_WRONG_GUIDED_MAG = (
    "int32 GuidedReserve = "
...
LOCKED_DECL = TARGET
STOP_BEFORE_RESOLVE = "FSkyguardLoadoutSpec SkyguardResolveLoadout"
STOP_BEFORE_FROM_SLOT = "SkyguardLoadoutFromSlot"
STOP_BEFORE_SLOT = "SkyguardLoadoutSlot"
STOP_BEFORE_DISPLAY = "SkyguardLoadoutDisplayName"
STOP_BEFORE_CLIMAX = "enum class ESkyguardClimaxKind"
STOP_BEFORE_PATROL = "enum class ESkyguardPatrolShipSystem"
STOP_BEFORE_HUD_SNAPSHOT = "struct FSkyguardCpgHudSnapshot"
STOP_BEFORE_DEBRIEF_SNAPSHOT = "struct FSkyguardCpgDebriefSnapshot"
STOP_BEFORE_CPG_FEEL = "namespace SkyguardApacheCpgFeel"
STOP_BEFORE_LOADOUT_ENUM = "enum class ESkyguardLoadout"
...
STOP_BEFORE_MESH_CATALOG = "class USkyguardRuntimeMeshCatalog"
STOP_BEFORE_AUDIO_HARNESS = "class USkyguardAudioAcceptanceHarness"
STOP_BEFORE_AUDIO_BANK = "class USkyguardAudioProductionBank"
...
SIBLING_LOADOUT = "Loadout"
SIBLING_STARTING_STATION = "StartingStation"
SIBLING_CANNON_MAG = "CannonMagazineSize"
SIBLING_CANNON_RESERVE = "CannonReserve"
SIBLING_ROCKET_MAG = "RocketMagazineSize"
SIBLING_ROCKET_RESERVE = "RocketReserve"
SIBLING_GUIDED_MAG = "GuidedMagazineSize"
SIBLING_FLARE = "FlareCount"
SIBLING_HULL = "HullIntegrity"
SIBLING_PLAYSTYLE = "PlaystyleLine"
THIS_SCRIPT = (
    "Scripts/tests/test_loadout_spec_guided_reserve"
    "_field_decl_contract.py"
)
LEFTOVER_ANALOG_DEFAULTS = (
    "Scripts/tests/test_loadout_spec_defaults_contract.py"
)
LEFTOVER_RESOLVE_LOADOUT = (
    "Scripts/tests/test_resolve_loadout_decl_contract.py"
)
LEFTOVER_APACHE_CPG_FEEL = (
    "Scripts/tests/test_apache_cpg_feel_contract.py"
)
LEFTOVER_LOADOUT_DISPLAY_NAME = (
    "Scripts/tests/test_loadout_display_name_contract.py"
)
LEFTOVER_LOADOUT_SLOT_HELPERS = (
...
LOCKED_SCRIPTS = (
    ...
    LEFTOVER_RADAR_NODE_RESET_GAMEPLAY_CONTRACT,
    "Scripts/tests/test_loadout_spec_defaults_contract.py",
    "Scripts/tests/test_loadout_spec_defaults.py",
    "Scripts/tests/test_loadout_spec_defaults_tests.py",
    "Scripts/tests/test_resolve_loadout_decl_contract.py",
    "Scripts/tests/test_loadout_display_name_contract.py",
    "Scripts/tests/test_loadout_slot_helpers_contract.py",
    "Scripts/tests/test_apache_cpg_feel_contract.py",
    ...
    "Scripts/tests/test_mesh_bind_slot_fields_contract.py",
    "Scripts/tests/test_mesh_bind_slot_slot_id_field_decl_contract.py",
    "Scripts/tests/test_mesh_bind_slot_preferred_field_decl_contract.py",
    "Scripts/tests/test_mesh_bind_slot_proxy_fallback_field_decl_contract.py",
    "Scripts/tests/test_mesh_bind_slot_notes_field_decl_contract.py",
...
def sibling_uncontracted_decls() -> tuple[str, ...]:
    return (
        SIBLING_LOADOUT,
        SIBLING_STARTING_STATION,
        SIBLING_CANNON_MAG,
        SIBLING_CANNON_RESERVE,
        SIBLING_ROCKET_MAG,
        SIBLING_ROCKET_RESERVE,
        SIBLING_GUIDED_MAG,
        SIBLING_FLARE,
        SIBLING_HULL,
        SIBLING_PLAYSTYLE,
...
def leftover_cpg_feel_initializers() -> tuple[str, ...]:
    return (
...
def locked_cpg_feel_initializer() -> str:
    return "SkyguardApacheCpgFeel::GuidedReserve"
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # `int32 GuidedReserve = SkyguardApacheCpgFeel::GuidedReserve;`
    # Do not accept missing initializer, literal `= 0` /
    # `= 6` / `= 100` / `= 0.f`, leftover sibling CpgFeel
    # constants, or leftover FlareCount `= 6`. Do not accept
    # sibling CannonMagazineSize / CannonReserve /
    # RocketMagazineSize / GuidedMagazineSize / HullIntegrity /
    # PlaystyleLine.
    if not has_one_declaration(region, declaration):
        return False
    compact = collapsed(region)
    if re.search(
        r"int32\s+GuidedReserve\s*=\s*"
        r"SkyguardApacheCpgFeel::GuidedReserve\s*;",
        compact,
    ) is None:
        return False
    if re.search(r"int32\s+GuidedReserve\s*=\s*0\b", compact):
        return False
    if re.search(r"int32\s+GuidedReserve\s*=\s*0\.f", compact):
        return False
    if re.search(r"int32\s+GuidedReserve\s*=\s*false\b", compact):
        return False
    if re.search(r"int32\s+GuidedReserve\s*=\s*100\b", compact):
        return False
    if re.search(r"int32\s+GuidedReserve\s*=\s*6\b", compact):
        return False
    if re.search(
        r"int32\s+GuidedReserve\s*=\s*"
        r"SkyguardApacheCpgFeel::CannonMagazineSize\b",
        compact,
    ):
        return False
    if re.search(
        r"int32\s+GuidedReserve\s*=\s*"
        r"SkyguardApacheCpgFeel::CannonReserve\b",
        compact,
    ):
        return False
    if re.search(
        r"int32\s+GuidedReserve\s*=\s*"
        r"SkyguardApacheCpgFeel::RocketMagazineSize\b",
        compact,
    ):
        return False
    if re.search(
        r"int32\s+GuidedReserve\s*=\s*"
        r"SkyguardApacheCpgFeel::RocketReserve\b",
        compact,
    ):
        return False
    if re.search(
        r"int32\s+GuidedReserve\s*=\s*"
        r"SkyguardApacheCpgFeel::GuidedMagazineSize\b",
        compact,
    ):
        return False
    if re.search(r"float\s+GuidedReserve\b", compact):
        return False
    if re.search(r"bool\s+GuidedReserve\b", compact):
        return False
    if re.search(r"int32\s+GuidedReserve\s*;", compact) and not re.search(
        r"int32\s+GuidedReserve\s*=",
        compact,
    ):
        return False
    return True
...
def leaked_neighbor_tokens() -> tuple[str, ...]:
    return (
        ...
        STOP_BEFORE_CPG_FEEL,
        STOP_BEFORE_LOADOUT_ENUM,
        STOP_BEFORE_WEAPON_ENUM,
        STOP_BEFORE_THEATER,
        STOP_BEFORE_MISSION_DEF,
        STOP_BEFORE_MESH_CATALOG,
        STOP_BEFORE_AUDIO_HARNESS,
        STOP_BEFORE_AUDIO_BANK,
        ...
        f"struct {LEFTOVER_DEBRIEF_SNAPSHOT}",
        f"struct {LEFTOVER_THEATER_SPEC}",
        f"class {LEFTOVER_MISSION_DEFINITION}",
        f"class {LEFTOVER_MESH_CATALOG}",
        f"class {LEFTOVER_AUDIO_HARNESS}",
        f"class {LEFTOVER_AUDIO_BANK}",
        f"struct {LEFTOVER_AUDIO_EVENT_DEF}",
        f"class {LEFTOVER_SORTIE}",
    )


def spec_section(header: str) -> str:
    body = struct_body(header)
    resolve_at = header.find(STOP_BEFORE_RESOLVE)
    struct_at = STRUCT_RE.search(header)
    if struct_at is None:
        raise AssertionError(
            f"{STRUCT_NAME} is missing from origin/main:{HEADER_PATH}"
        )
    if resolve_at != -1 and resolve_at < struct_at.start():
        raise AssertionError(
            f"{STRUCT_NAME} parse window includes {STOP_BEFORE_RESOLVE}"
        )
    ...
    if STOP_BEFORE_RESOLVE in section:
        raise AssertionError(
            f"{STRUCT_NAME} parse window includes {STOP_BEFORE_RESOLVE}"
        )
    return section
...
def clone_locked_macros() -> tuple[str, ...]:
    return (
        "UPROPERTY",
        "Category",
        "VisibleAnywhere",
...
class LoadoutSpecGuidedReserveFieldDeclContractTests(unittest.TestCase):
    def test_loadout_spec_struct_exists(self) -> None:
        ...
        self.assertTrue(has_identifier(section, "GuidedReserve"), section)
        self.assertNotIn("UPROPERTY", section)
        self.assertNotIn("GENERATED_BODY", section)
        self.assertNotIn("USTRUCT", section)
        self.assertIn(STOP_BEFORE_RESOLVE, header)
        self.assertNotIn(STOP_BEFORE_RESOLVE, section)
        self.assertNotIn(STOP_BEFORE_RESOLVE, body)
        for sibling in sibling_uncontracted_decls():
            self.assertNotIn(sibling, LOCKED_DECL)
            self.assertNotEqual(LOCKED_DECL, f"int32 {sibling} = 6;")
            self.assertNotEqual(
                LOCKED_DECL,
                f"int32 {sibling} = SkyguardApacheCpgFeel::{sibling};",
            )
        ...
        self.assertNotIn(STOP_BEFORE_CPG_FEEL, section)
        self.assertNotIn(STOP_BEFORE_LOADOUT_ENUM, section)
        self.assertNotIn(STOP_BEFORE_WEAPON_ENUM, section)
        self.assertIn(locked_cpg_feel_initializer(), LOCKED_DECL)
        self.assertNotIn("namespace SkyguardApacheCpgFeel", section)

    def test_missing_struct_fails_closed(self) -> None:
        with self.assertRaises(AssertionError) as raised:
            struct_body(
                "struct FSkyguardUnrelatedLoadoutSpec\n{\n};\n"
            )
    ...
    def test_resolve_loadout_declaration_does_not_satisfy(self) -> None:
        mixed = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            "};\n"
            f"{STOP_BEFORE_RESOLVE}({LEFTOVER_LOADOUT_ENUM} Loadout);\n"
            f"\t{LOCKED_DECL}\n"
        )
        section = spec_section(mixed)
        self.assertFalse(has_identifier(section, "GuidedReserve"), section)
        self.assertNotIn(STOP_BEFORE_RESOLVE, section)
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, LOCKED_DECL)
        self.assertIn("GuidedReserve", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_missing_guided_reserve_declaration_fails_closed(self) -> None:
        empty = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            f"\tint32 {SIBLING_FLARE} = 6;\n"
            "};\n"
        )
    ...
    def test_locked_decl_is_bare_plain_field(self) -> None:
        self.assertEqual(
            LOCKED_DECL,
            "int32 GuidedReserve = "
            "SkyguardApacheCpgFeel::GuidedReserve;",
        ...
        self.assertTrue(LOCKED_DECL.startswith("int32 GuidedReserve"))
        ...
        self.assertNotEqual(LOCKED_DECL, CLONE_WRONG_UPROPERTY)
        self.assertNotEqual(LOCKED_DECL, CLONE_WRONG_USTRUCT)
        self.assertNotEqual(LOCKED_DECL, CLONE_WRONG_GENERATED)
        for macro in clone_locked_macros():
            self.assertNotIn(macro, LOCKED_DECL)

    def test_clone_uproperty_locked_decl_fails_closed(self) -> None:
        ...
        self.assertNotIn("Category", LOCKED_DECL)
        with self.assertRaises(AssertionError) as raised:
            require_declaration(CLONE_WRONG_UPROPERTY + "\n", LOCKED_DECL)
        self.assertIn("GuidedReserve", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        wrapped = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            f"\t{CLONE_WRONG_UPROPERTY}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
        )
        wrapped_section = spec_section(wrapped)
        self.assertIn("UPROPERTY", wrapped_section)
    ...
    def test_literal_initializer_fails_closed(self) -> None:
        leftover = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            f"\t{TARGET_WRONG_ZERO}\n"
        ...
        self.assertIn("GuidedReserve", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(f"\t{TARGET_WRONG_ZERO}\n", LOCKED_DECL))
        origin = spec_section(origin_main_header())
        ...
        self.assertNotIn("int32 GuidedReserve = 0;", compact_origin)
        self.assertNotIn("int32 GuidedReserve = 6;", compact_origin)
        self.assertNotIn("int32 GuidedReserve = 100;", compact_origin)

    def test_wrong_initializer_fails_closed(self) -> None:
        leftover_primary = (
            "\tint32 " + leftover_retired_primary_hits_field() + " = 6;\n"
        )
        leftover_guided = (
            "\tint32 " + leftover_retired_guided_hits_field() + " = 6;\n"
        )
        forty = "40" + ".f"
        eighty = "80" + ".f"
        wrongs = (
            ...
            leftover_primary,
            leftover_guided,
            f"\tint32 {SIBLING_CANNON_MAG} = "
            "SkyguardApacheCpgFeel::CannonMagazineSize;\n",
            f"\tint32 {SIBLING_CANNON_RESERVE} = "
            "SkyguardApacheCpgFeel::CannonReserve;\n",
            f"\tint32 {SIBLING_ROCKET_MAG} = "
            "SkyguardApacheCpgFeel::RocketMagazineSize;\n",
            f"\tint32 {SIBLING_ROCKET_RESERVE} = "
            "SkyguardApacheCpgFeel::RocketReserve;\n",
            f"\tint32 {SIBLING_GUIDED_MAG} = "
            "SkyguardApacheCpgFeel::GuidedMagazineSize;\n",
            f"\tint32 {SIBLING_FLARE} = 6;\n",
            "\tint32 GuidedReserves = "
            "SkyguardApacheCpgFeel::GuidedReserve;\n",
            "\tint32 GuidedReserve = " + forty + ";\n",
            "\tint32 GuidedReserve = " + eighty + ";\n",
        )
    ...
    def test_guided_reserve_declaration_matches_origin_main(self) -> None:
        section = spec_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 GuidedReserve"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("SkyguardApacheCpgFeel::GuidedReserve", LOCKED_DECL)
        self.assertNotIn("Category", LOCKED_DECL)
        for sibling in sibling_uncontracted_decls():
            self.assertNotIn(sibling, LOCKED_DECL)
        for field in leftover_neighbor_hit_fields():
            self.assertNotIn(field, LOCKED_DECL)
        for init in leftover_cpg_feel_initializers():
            self.assertNotIn(init, LOCKED_DECL)
        self.assertFalse(
        ...
        self.assertFalse(
            has_declaration(f"\t{TARGET_WRONG_CPG_FEEL}\n", LOCKED_DECL)
        )
        self.assertFalse(
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        uproperty_wraps = (
            f"\t{CLONE_WRONG_UPROPERTY}\n\t{LOCKED_DECL}\n",
            f"\t{CLONE_WRONG_UPROPERTY} {LOCKED_DECL}\n",
        )
        for region in uproperty_wraps:
            self.assertTrue(has_one_declaration(region, LOCKED_DECL), region)
        origin = spec_section(origin_main_header())
        self.assertNotIn("UPROPERTY", origin)

    def test_does_not_contract_sibling_loadout_fields(self) -> None:
        for sibling in sibling_uncontracted_decls():
            self.assertNotIn(sibling, LOCKED_DECL)
        for field in leftover_neighbor_hit_fields():
            self.assertNotIn(field, LOCKED_DECL)
        self.assertNotIn(STOP_BEFORE_RESOLVE, LOCKED_DECL)
        self.assertNotIn(LEFTOVER_HUD_SNAPSHOT, LOCKED_DECL)
    ...
    def test_does_not_parse_leftover_neighbors(self) -> None:
        ...
        self.assertIn(STOP_BEFORE_RESOLVE, header)
        self.assertNotIn(STOP_BEFORE_RESOLVE, section)
        self.assertNotIn(STOP_BEFORE_RESOLVE, leaked)
        self.assertIn(STOP_BEFORE_FROM_SLOT, header)
        self.assertNotIn(STOP_BEFORE_FROM_SLOT, section)
        self.assertIn(STOP_BEFORE_CPG_FEEL, header)
        self.assertNotIn(STOP_BEFORE_CPG_FEEL, section)
        self.assertNotIn(STOP_BEFORE_CPG_FEEL, leaked)
        self.assertIn(STOP_BEFORE_LOADOUT_ENUM, header)
        self.assertNotIn(STOP_BEFORE_LOADOUT_ENUM, section)
        self.assertNotIn(STOP_BEFORE_LOADOUT_ENUM, leaked)
        self.assertIn(STOP_BEFORE_WEAPON_ENUM, header)
        self.assertNotIn(STOP_BEFORE_WEAPON_ENUM, section)
        ...
        self.assertNotIn(STOP_BEFORE_DEBRIEF_SNAPSHOT, section)
        self.assertNotIn(STOP_BEFORE_THEATER, header)
        self.assertNotIn(STOP_BEFORE_MISSION_DEF, header)
        self.assertNotIn(STOP_BEFORE_MESH_CATALOG, header)
        self.assertNotIn(STOP_BEFORE_AUDIO_HARNESS, header)
        self.assertNotIn(STOP_BEFORE_AUDIO_BANK, header)
    ...
    def test_parse_window_excludes_leftover_enum_and_namespace(self) -> None:
        header = origin_main_header()
        section = spec_section(header)
        leaked = struct_body(header)
        for leftover in leftover_pictogram_values():
        ...
        for leftover in leftover_audio_event_enum_tokens():
            self.assertNotIn(leftover, section)
            self.assertNotIn(leftover, leaked)
        self.assertNotIn("AntiArmor", section)
        self.assertNotIn("RocketHeavy", section)
        self.assertNotIn("Intercept", section)
        self.assertNotIn("constexpr", section)
        self.assertNotIn(LEFTOVER_HUD_SNAPSHOT, section)
        self.assertNotIn(LEFTOVER_DEBRIEF_SNAPSHOT, section)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        other = (
            f"\t{STOP_BEFORE_RESOLVE}({LEFTOVER_LOADOUT_ENUM} Loadout);\n"
            f"\t{LEFTOVER_LOADOUT_ENUM} {STOP_BEFORE_FROM_SLOT}(int32 Slot);\n"
            f"\tint32 {STOP_BEFORE_SLOT}({LEFTOVER_LOADOUT_ENUM} Loadout);\n"
            f"\tconst TCHAR* {STOP_BEFORE_DISPLAY}"
            f"({LEFTOVER_LOADOUT_ENUM} Loadout);\n"
            f"\tint32 {SIBLING_FLARE} = 6;\n"
            f"\tint32 {SIBLING_CANNON_RESERVE} = "
            "SkyguardApacheCpgFeel::CannonReserve;\n"
            f"\t{TARGET_WRONG_HULL}\n"
    ...
    def test_contract_does_not_read_cpp_or_invented_bodies(self) -> None:
        ...
        self.assertNotIn("SkyguardGunshipTypes.cpp", THIS_SCRIPT)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "loadout-spec GuidedReserve field decl contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(Path(__file__).name.endswith(
            "guided_reserve_field_decl_contract.py"
        ))
        self.assertNotIn("SkyguardGunshipTypes.cpp", THIS_SCRIPT)
        self.assertIn(LEFTOVER_ANALOG_DEFAULTS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_RESOLVE_LOADOUT, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_APACHE_CPG_FEEL, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_LOADOUT_DISPLAY_NAME, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_LOADOUT_SLOT_HELPERS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_LOADOUT, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_STARTING_STATION, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_FLARE_COUNT, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_CANNON_MAGAZINE_SIZE, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_CANNON_RESERVE, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_ROCKET_MAGAZINE_SIZE, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_ROCKET_RESERVE, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_GUIDED_MAGAZINE_SIZE, LOCKED_SCRIPTS)
    ...
    def test_leftover_analog_defaults_stay_locked(self) -> None:
        leftovers = (
            LEFTOVER_ANALOG_DEFAULTS,
            LEFTOVER_RESOLVE_LOADOUT,
            LEFTOVER_APACHE_CPG_FEEL,
    ...
    def test_contract_is_target_field_declaration_only(self) -> None:
        ...
        self.assertNotIn(STOP_BEFORE_RESOLVE, locked_only)
        self.assertNotIn(LEFTOVER_APACHE_CLASS, locked_only)
        self.assertNotIn(LEFTOVER_THEATER_SPEC, locked_only)
        self.assertIn(locked_cpg_feel_initializer(), locked_only)
        self.assertNotIn("namespace SkyguardApacheCpgFeel", locked_only)
        self.assertNotIn(STOP_BEFORE_CPG_FEEL, locked_only)
        self.assertNotIn("UPROPERTY", locked_only)
        self.assertNotIn("Category", locked_only)
