...
# Mission08 Protection GetProtectedTarget
...
# defaults #75e6 / #226, NOT leftover Mission08
# GetWaveState, NOT leftover Mission08
...
class Mission08GetProtectedTargetDeclContractTests(unittest.TestCase):
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        origin_inline = (
            ...
            "\t\tESkyguardMission08ProtectedTarget Target) const\n"
            "\t{\n"
            "\t\treturn FSkyguardMission08ProtectedTargetRuntime();\n"
            "\t}\n"
            "};\n"
        )
        one_line_inline = (
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_get_protected_target"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_origin_main_accepts_split_line_without_locking_body(self) -> None:
        ...
        self.assertIn("ESkyguardMission08ProtectedTarget Target", section)
        self.assertIn("FSkyguardMission08ProtectedTargetRuntime", section)
        self.assertNotIn("{", LOCKED_DECL)
        self.assertNotIn("return ", LOCKED_DECL)
        self.assertNotIn("return false", LOCKED_DECL)
        self.assertNotIn("return true", LOCKED_DECL)
