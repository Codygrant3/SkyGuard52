...
# Mission06 bAllowBoundedActorSpawning FIELD
...
class Mission06AllowBoundedActorSpawningFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_allow_bounded_actor_spawning"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
