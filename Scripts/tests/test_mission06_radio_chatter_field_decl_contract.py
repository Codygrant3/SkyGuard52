...
# decl-contract-c332, NOT leftover Mission04 bAudioReady #937 /
...
class Mission06RadioChatterFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_radio_chatter_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
