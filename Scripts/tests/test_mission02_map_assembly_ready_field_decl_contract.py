...
# Mission02 IntegrationReadiness bMapAssemblyReady
...
# not leftover Mission01/03-10 readiness structs).
...
# leftover Mission10 bMapAssemblyReady #812,
# leftover Mission10 bCampaignDefinitionValid #811,
# leftover Mission10
...
# the Mission02IntegrationDirector public section,
# and the locked FSkyguardMission02IntegrationReadiness
...
class Mission02MapAssemblyReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission02 bMapAssemblyReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission02 bMapAssemblyReady contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission02_map_assembly_ready"
                "_field_decl_contract.py"
            )
        )
        self.assertIn(
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_map_assembly_ready"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
