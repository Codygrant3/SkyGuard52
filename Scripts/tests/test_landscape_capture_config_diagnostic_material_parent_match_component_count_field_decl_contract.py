...
# DiagnosticMaterialParentMatchComponentCount FIELD
# (declaration-only; VisibleAnywhere / BlueprintReadOnly
# int32 DiagnosticMaterialParentMatchComponentCount = 0;
# one-line / split-line UPROPERTY wraps; origin/main has
# NO Category).
...
# (leftover GovernedMaterialParentMatchComponentCount #1206).
# Do NOT parse FSkyguardLandscapeFootprintSampleResult.
# THIS IS leftover-safe FSkyguardLandscapeCaptureConfigurationResult
# DiagnosticMaterialParentMatchComponentCount.
# THIS IS NOT leftover VisibleAudit GovernedMaterialParentMatchComponentCount #1206.
...
# LOCK leftover VisibleAudit GovernedMaterialParentMatchComponentCount #1206.
...
# LandscapeComponentCount #1200 / VisibleComponentCount #1201 /
# RegisteredComponentCount #1202.
# LOCK in-flight RenderStateCreatedComponentCount and
# HiddenInGameComponentCount scripts; do not edit them.
...
# #665 #666 #668-#673, or open drafts #674-#1202.
...
# THIS IS leftover-safe FSkyguardLandscapeCaptureConfigurationResult
# DiagnosticMaterialParentMatchComponentCount FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# int32 DiagnosticMaterialParentMatchComponentCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover Mission01 EnvironmentReadiness
# LandscapeComponentCount #1176.
# THIS IS NOT leftover landscape-visible-audit-defaults #0bce.
# THIS IS NOT leftover VisibleAudit bSuccess #1199.
# THIS IS NOT leftover in-flight VisibleAudit
# LandscapeComponentCount or VisibleComponentCount
# (LOCK those scripts; do not edit them).
...
# THIS IS leftover-safe FSkyguardLandscapeCaptureConfigurationResult
# DiagnosticMaterialParentMatchComponentCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 DiagnosticMaterialParentMatchComponentCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# LandscapeComponentCount later; this ticket is DiagnosticMaterialParentMatchComponentCount only).
# LOCK leftover landscape-visible-audit-defaults #0bce.
# LOCK leftover Footprint bSuccess #1189.
...
# Do not reopen open drafts #674-#1202.
# THIS IS leftover-safe FSkyguardLandscapeCaptureConfigurationResult
# DiagnosticMaterialParentMatchComponentCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 DiagnosticMaterialParentMatchComponentCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# BlueprintReadOnly int32 DiagnosticMaterialParentMatchComponentCount = 0;
...
# DiagnosticMaterialParentMatchComponentCount FIELD (declaration-only). It is
...
TARGET = "int32 DiagnosticMaterialParentMatchComponentCount = 0;"
TARGET_WRONG = "float DiagnosticMaterialParentMatchComponentCount = 0;"
LOCKED_DECL = TARGET
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*int32\s+DiagnosticMaterialParentMatchComponentCount\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for int32 DiagnosticMaterialParentMatchComponentCount is missing from "
...
class LandscapeCaptureConfigDiagnosticMaterialParentMatchComponentCountFieldDeclContractTests(unittest.TestCase):
    def test_landscape_capture_config_struct_exists(self) -> None:
        ...
        self.assertIn("ShowOnlyLandscapeComponentCount", section)
        self.assertIn("DiagnosticMaterialParentMatchComponentCount", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("DiagnosticMaterialParentMatchComponentCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_diagnostic_material_parent_match_component_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_diagnostic_material_parent_match_component_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 DiagnosticMaterialParentMatchComponentCount"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("DiagnosticMaterialParentMatchComponentCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("DiagnosticMaterialParentMatchComponentCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 DiagnosticMaterialParentMatchComponentCount"))
    ...
    def test_contract_does_not_relock_leftover_environment_readiness(
        ...
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
            "_visible_component_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
            "_registered_component_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
            "_render_state_created_component_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
            "_hidden_in_game_component_count"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("DiagnosticMaterialParentMatchComponentCount", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_diagnostic_material_parent_match_component_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_landscape_capture_config"
            "_diagnostic_material_parent_match_component_count_field_decl_contract.py"
        )
        ...
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
            "_generated_material_instance_ready_component_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_landscape_capture_config"
        ...
        self.assertIn(
            "Scripts/tests/test_landscape_visible_audit"
            "_governed_material_parent_match_component_count_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
