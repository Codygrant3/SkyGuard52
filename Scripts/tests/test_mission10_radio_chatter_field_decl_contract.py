...
# Briefing / AudioDirector in-flight siblings,
...
CPP_AND_INVENTED = (
    ...
    "ASkyguardMission10IntegrationDirector::RadioChatter",
    "SkyguardMission10IntegrationDirector.cpp",
...
class Mission10RadioChatterFieldDeclContractTests(unittest.TestCase):
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_radio_chatter_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
