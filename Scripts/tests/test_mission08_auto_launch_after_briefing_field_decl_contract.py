...
# INDEX_NONE or lock bAutoLaunchAfterBriefing
# construction in the .cpp. This is leftover-safe
# Mission08 bAutoLaunchAfterBriefing FIELD
...
# NOT leftover Mission07 bAutoLaunchAfterBriefing
# / branch cursor/mission07-auto-launch-
# after-briefing-field-decl-contract-c332, NOT leftover
# Mission08 Briefing #1050 / branch cursor/
# mission08-briefing-field-decl-contract-c332, NOT leftover
# Mission01 bAutoLaunchAfterBriefing
# #582 (CLOSED, do not reopen #536-#673) / branch
# cursor/mission01-auto-launch-after-briefing-
# field-decl-contract-c332, NOT leftover
# Mission02 bAutoLaunchAfterBriefing
# #853 / branch cursor/mission02-auto-launch-
# after-briefing-field-decl-contract-c332, NOT leftover
# Mission03 auto-launch-after-briefing FIELD
# #883 / branch cursor/mission03-auto-launch-
# after-briefing-field-decl-contract-c332, NOT leftover
# Mission04 auto-launch-after-briefing FIELD
# #918 / branch cursor/mission04-auto-launch-
# after-briefing-field-decl-contract-c332, NOT leftover
# Mission05 auto-launch-after-briefing FIELD
# #956 / branch cursor/mission05-auto-launch-
# after-briefing-field-decl-contract-c332, NOT leftover
# Mission06 leftover bAutoLaunchAfterBriefing
# #988 / branch cursor/mission06-auto-launch-
# after-briefing-field-decl-contract-c332, NOT leftover
# Mission10 auto-launch-after-briefing FIELD
# #802 / branch cursor/mission10-auto-launch-
# after-briefing-field-decl-contract-c332. LOCK leftover
# Mission01 / Mission02 / Mission03 / Mission04 /
# Mission05 / Mission06 / Mission07 / Mission10
# same-name bAutoLaunchAfterBriefing director-field
...
# CampaignDefinition #1055. LOCK leftover drafts
# #56-#64 and leftover #107-#673. Do not reopen leftover
# #664, leftover closed-without-merge #658-#673,
# leftover Mission05 closed-without-merge #665 #666
# #668-#673, or open drafts #674-#1055. NOT leftover
...
# bAllowBoundedActorSpawning sibling lanes, NOT leftover
# Mission06 MissionDefinition field in-flight
# branch cursor/mission06-mission-definition-
...
# MissionDefinition sibling director fields.
...
LOCKED_DECL = AUTO_LAUNCH_AFTER_BRIEFING_FIELD
...
# an isolated Python bAutoLaunchAfterBriefing
...
class Mission08AutoLaunchAfterBriefingFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bAutoLaunchAfterBriefing", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_launch = f"\t{MISSION_DEFINITION_FIELD}\n"
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bAutoLaunchAfterBriefing", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 MissionDefinition field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission06 MissionDefinition field contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_auto_launch_after_briefing(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_auto_launch_after_briefing_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
            "Scripts/tests/test_mission06_auto_launch_after_briefing_field"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_airfield_target_runtime_does_not_satisfy_auto_launch_after_briefing(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_does_not_satisfy_auto_launch_after_briefing(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
