...
# GraphNodeCount. THIS IS NOT leftover mission01-environment-authoring-
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 GraphNodeCount = 0; one-line / split-line
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeCount. THIS IS NOT leftover mission01-environment-authoring-result-
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeCount FIELD (declaration-only; VisibleAnywhere / BlueprintReadOnly
# int32 GraphNodeCount = 0; one-line /
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeCount. THIS IS NOT leftover VisibleAudit
...
# DIFFERENT field).
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeCount FIELD (declaration-only;
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeCount. THIS IS NOT leftover VisibleAudit bSuccess #1199.
...
# Do NOT parse FSkyguardLandscapeVisibleAudit (leftover bSuccess #1199).
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeCount. THIS IS NOT leftover
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# GraphNodeCount FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly int32 GraphNodeCount = 0; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# BlueprintReadOnly int32 GraphNodeCount = 0;
...
TARGET = "int32 GraphNodeCount = 0;"
TARGET_WRONG = "int32 GraphNodeCount = 1;"
LOCKED_DECL = TARGET
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # FSkyguardMission01EnvironmentAuthoringResult::GraphNodeCount
    # (must be int32 GraphNodeCount = 0;).
    # THIS IS NOT leftover VisibleAudit bSuccess #1199.
    # THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*int32\s+GraphNodeCount\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for int32 GraphNodeCount is missing from "
...
class Mission01EnvironmentAuthoringResultGraphNodeCountFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("GraphNodeCount", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_graph_node_count_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_graph_node_count_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("int32 GraphNodeCount"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("GraphNodeCount", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("GraphNodeCount", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("int32 GraphNodeCount"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("GraphNodeCount", locked_only)
    ...
    def test_sibling_director_fields_do_not_satisfy_graph_node_count(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
