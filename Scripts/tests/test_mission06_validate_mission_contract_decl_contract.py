...
# Mission06 Integration ValidateMissionContract
# METHOD on ASkyguardMission06IntegrationDirector.
# It is NOT leftover Mission05
# ValidateMissionContract #686, NOT leftover
# Mission01 / Mission03 / Mission04
# ValidateMissionContract, NOT leftover
# mission-definition ValidateDefinition. It is
...
# Mission05 GetProtectedTarget #678. Do not
# reopen leftover Mission05
# ValidateMissionContract #686. Do not reopen
# leftover drafts #56–#64, leftover #107–#673,
# leftover #664, closed leftover #658–#673.
...
LEFTOVER_MISSION01_VALIDATE_NOT_LOCKED = (
    "ASkyguardMission01IntegrationDirector",
    "SkyguardMission01IntegrationDirector.h",
    "test_mission01_validate_mission_contract_decl_contract.py",
    'Category="Skyguard|Mission01|Integration"',
)
LEFTOVER_MISSION03_VALIDATE_NOT_LOCKED = (
    "ASkyguardMission03IntegrationDirector",
    "SkyguardMission03IntegrationDirector.h",
    "test_mission03_validate_mission_contract_decl_contract.py",
    'Category="Skyguard|Mission03|Integration"',
...
LEFTOVER_MISSION_DEFINITION_VALIDATE_NOT_LOCKED = (
    "test_validate_definition_decl_contract.py",
    "ValidateDefinition",
)
LEFTOVER_MISSION06_GET_TARGET_RUNTIME_NOT_LOCKED = (
    "test_mission06_get_target_runtime_decl_contract.py",
    GET_TARGET_RUNTIME,
    "GetTargetRuntime",
    'Category="Skyguard|Mission06|Targets"',
)
...
class Mission06ValidateMissionContractDeclContractTests(unittest.TestCase):
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        leftover_validate = f"\t{GET_TARGET_RUNTIME}\n"
    ...
    def test_validate_mission_contract_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("int32 Damage", VALIDATE_MISSION_CONTRACT)
        ...
        self.assertNotIn("NotifyThreatDestroyed", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("AdvanceConvoyByDistance", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("NotifyConvoyDamage", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetWaveState", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetConvoyRouteState", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetDayBeatKit", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetNightBeatKit", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("StartSearchlightWindow", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("AdvanceSearchlightTrack", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("NotifySubstationDamage", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("IsCorePlayableReady", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetSearchlightRuntime", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetSubstationIntegrity", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("StartNextWave", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("AdvancePayloadWindow", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("TryJamActivePayload", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("StartPayloadWindow", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetPayloadWindow", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetSurvivingTargetCount", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetDayBeatKind", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetDayBeatIndex", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("TickDayBeatKit", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("HandleBossPhaseChanged", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("ESkyguardMission06WaveState", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("ConvoyRuntimeAnchor", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("RoadHunterSpawnLocation", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("ASkyguardMission02IntegrationDirector", VALIDATE_MISSION_CONTRACT)
        ...
        self.assertNotIn("NotifyAirfieldTargetDamage", VALIDATE_MISSION_CONTRACT)
        ...
        self.assertNotIn("GetTargetRuntime", VALIDATE_MISSION_CONTRACT)
    ...
    def test_environment_category_does_not_satisfy_integration(self) -> None:
        ...
        self.assertNotEqual(leftover_m05_integration, UFUNCTION_INTEGRATION)
        ...
        self.assertNotIn(leftover_m05_integration, UFUNCTION_INTEGRATION)
        self.assertNotIn("Mission01", UFUNCTION_INTEGRATION)
        self.assertNotIn("Mission03", UFUNCTION_INTEGRATION)
        self.assertNotIn("Mission04", UFUNCTION_INTEGRATION)
        self.assertNotIn("Mission05", UFUNCTION_INTEGRATION)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertNotIn("GetTargetRuntime", locked_only)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", VALIDATE_MISSION_CONTRACT)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission06 ValidateMissionContract method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission06 ValidateMissionContract contains "
    ...
    def test_leftover_handle_drone_city_impact_does_not_satisfy(self) -> None:
        ...
        self.assertIn("ValidateMissionContract", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, VALIDATE_MISSION_CONTRACT))
        locked_only = f"{VALIDATE_MISSION_CONTRACT}\n"
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        one_line_inline = (
            ...
            "\tstatic bool ValidateMissionContract("
            "const USkyguardMissionDefinition* Mission, "
            "TArray<FText>& OutErrors) { return false; }\n"
            "};\n"
        )
    ...
    def test_contract_does_not_relock_leftover_mission05_protected_target_damage(
        ...
        self.assertNotIn("NotifyProtectedTargetDamage", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("Protection", UFUNCTION_INTEGRATION)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission06_validate_mission_contract"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission05_get_protected_target_does_not_satisfy(self) -> None:
        ...
        self.assertNotIn("Mission05", UFUNCTION_INTEGRATION)
        self.assertNotIn("Protection", UFUNCTION_INTEGRATION)
        self.assertNotIn("GetProtectedTarget", VALIDATE_MISSION_CONTRACT)
    ...
    def test_leftover_mission05_validate_mission_contract_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission05IntegrationDirector "
    ...
    def test_leftover_mission01_validate_mission_contract_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission01IntegrationDirector "
        ...
        for token in LEFTOVER_MISSION01_VALIDATE_NOT_LOCKED:
            self.assertNotIn(token, VALIDATE_MISSION_CONTRACT)

    def test_leftover_mission03_validate_mission_contract_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
        ...
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission03_validate_mission_contract"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        for token in LEFTOVER_MISSION03_VALIDATE_NOT_LOCKED:
            self.assertNotIn(token, VALIDATE_MISSION_CONTRACT)

    def test_leftover_mission04_validate_mission_contract_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission04IntegrationDirector "
    ...
    def test_leftover_mission_definition_validate_definition_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
        ...
        for token in LEFTOVER_MISSION_DEFINITION_VALIDATE_NOT_LOCKED:
            self.assertNotIn(token, VALIDATE_MISSION_CONTRACT)
            self.assertNotIn(token, UFUNCTION_INTEGRATION)

    def test_leftover_mission06_get_target_runtime_does_not_satisfy(self) -> None:
        leftover = f"\t{GET_TARGET_RUNTIME}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover, VALIDATE_MISSION_CONTRACT)
        self.assertIn("ValidateMissionContract", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission06_get_target_runtime"
        ...
        for token in LEFTOVER_MISSION06_GET_TARGET_RUNTIME_NOT_LOCKED:
            self.assertNotIn(token, VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("GetTargetRuntime", VALIDATE_MISSION_CONTRACT)
        self.assertNotIn("Targets", UFUNCTION_INTEGRATION)
