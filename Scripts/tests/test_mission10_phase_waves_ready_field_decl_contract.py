...
# INDEX_NONE or lock bPhaseWavesReady
# construction in the .cpp. This is leftover-safe
# Mission10 bPhaseWavesReady FIELD
...
# Mission10 bLastFlightReady field / branch
# cursor/mission10-last-flight-ready-field-
# decl-contract-c332, NOT leftover
# Mission10 bGunnerReady field / branch
# cursor/mission10-gunner-ready-field-
# decl-contract-c332, NOT leftover
# Mission10 bObjectivesReady field / branch
# cursor/mission10-objectives-ready-field-
# decl-contract-c332, NOT leftover
# Mission10 StartPhaseWave method #771 /
# branch cursor/mission10-start-phase-
# wave-decl-contract-c332, NOT leftover
# Mission10 GetRemainingThreatsInWave
# method #779 / branch cursor/mission10-
# get-remaining-threats-in-wave-decl-
# contract-c332, NOT leftover
# Mission10 GetObjectiveRuntime method /
# branch cursor/mission10-get-objective-
# runtime-decl-contract-c332, NOT leftover
# objective-runtime-fail-closed #6845 / branch
# cursor/objective-runtime-fail-closed-6845,
# NOT leftover objective-definition-defaults
# #b29f / branch cursor/objective-definition-
# defaults-contract-b29f, NOT leftover
# objective-progress-defaults #ae90 / branch
# cursor/objective-progress-defaults-contract-ae90,
# NOT leftover
...
# drafts #674-#813+, leftover Apache
...
PHASE_WAVES_READY_FIELD = (
    "bool bPhaseWavesReady = false;"
)
LOCKED_DECL = PHASE_WAVES_READY_FIELD
...
# an isolated Python bPhaseWavesReady
...
class Mission10PhaseWavesReadyFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_phase_waves_ready_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_phase_waves_ready_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bPhaseWavesReady"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("bPhaseWavesReady", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bPhaseWavesReady", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 bPhaseWavesReady field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission10 bPhaseWavesReady contains "
    ...
    def test_contract_is_phase_waves_ready_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertNotIn("return ", LOCKED_DECL)
        self.assertNotIn("{", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bPhaseWavesReady"))
        self.assertIn("bPhaseWavesReady", LOCKED_DECL)
    ...
    def test_sibling_director_fields_do_not_satisfy_phase_waves_ready(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_phase_waves_ready_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
