...
# INDEX_NONE or lock NotifyProtectedAssetFailed construction
# in the .cpp. This is leftover-safe Mission03
# Objectives NotifyProtectedAssetFailed on
...
# Mission03 wave-state enum #0242. It is also
# NOT leftover Mission01 NotifyProtectedAssetFailed
# #612, NOT leftover Harbor ProtectAsset, and
...
# Category is Skyguard|Mission03|Objectives, not
# Waves, not Convoy, not Integration, not Environment,
# not leftover
...
# convoy-route-state enum #d34e. Do not lock leftover
# Mission01 NotifyProtectedAssetFailed #612. Do not lock
# leftover Harbor ProtectAsset.
...
# leftover theater-kit #59, leftover #107–#630, plus
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission03IntegrationDirector::NotifyProtectedAssetFailed",
    "SkyguardMission03IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission03NotifyProtectedAssetFailedDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("BlueprintPure", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("Category", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("BlueprintPure", UFUNCTION_OBJECTIVES)
        self.assertIn("Skyguard|Mission03|Objectives", UFUNCTION_OBJECTIVES)
        ...
        self.assertNotIn("Convoy", UFUNCTION_OBJECTIVES)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        as_void_name = "\tvoid NotifyProtectedAssetFailed() const;\n"
    ...
    def test_notify_protected_asset_failed_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("EnvironmentReadiness", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("MissionMapReadiness", NOTIFY_PROTECTED_ASSET_FAILED)
        ...
        self.assertNotIn("TSoftObjectPtr<USkyguardMissionDefinition>", NOTIFY_PROTECTED_ASSET_FAILED)
        ...
        self.assertNotIn("ValidateDefinition", NOTIFY_PROTECTED_ASSET_FAILED)
        ...
        self.assertNotIn("ESkyguardMission03WaveState", NOTIFY_PROTECTED_ASSET_FAILED)
        ...
        self.assertNotIn("GetCurrentWaveIndex", NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_environment_category_does_not_satisfy_objectives(self) -> None:
        ...
        self.assertNotEqual(integration, UFUNCTION_OBJECTIVES)
        self.assertNotIn(environment, UFUNCTION_OBJECTIVES)
        self.assertNotIn(briefing, UFUNCTION_OBJECTIVES)
        self.assertNotIn(integration, UFUNCTION_OBJECTIVES)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission03 NotifyProtectedAssetFailed method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission03 NotifyProtectedAssetFailed contains "
    ...
    def test_contract_is_notify_protected_asset_failed_declaration_only(
        ...
        self.assertNotIn("TArray<FText>& OutErrors", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("static ", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertTrue(
            NOTIFY_PROTECTED_ASSET_FAILED.endswith(");"),
            NOTIFY_PROTECTED_ASSET_FAILED,
    ...
    def test_leftover_mission_definition_validate_does_not_satisfy(self) -> None:
        ...
        self.assertNotIn(MISSION_DEFINITION_VALIDATE, NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertIn(
            "Scripts/tests/test_mission_definition_validate_definition"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
