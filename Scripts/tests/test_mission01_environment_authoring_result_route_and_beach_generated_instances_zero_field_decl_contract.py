...
# bRouteAndBeachGeneratedInstancesZero. DEFAULT IS `= true` NOT `= false`.
# If a clone asserts `= false`, accept `= true` instead.
# THIS IS NOT leftover bSuccess #1235. THIS IS NOT leftover
# bGenerationLocked #1245 / bLicensedMeshSlotsEmpty #1246 /
# bAuthoredStructureReady #1244. THIS IS NOT leftover
# mission01-environment-authoring-result-defaults #df1a.
# THIS IS NOT leftover GeneratedPCGComponentCount #1247.
...
# #df1a. LOCK leftover AuthoringResult Landscape #1233 / Graph #1234 /
...
# bool bRouteAndBeachGeneratedInstancesZero = true. Fail closed if
# type/decl missing, renamed, Category= is added, or default is not
# true. Parse STRUCT public section only AFTER
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bRouteAndBeachGeneratedInstancesZero. THIS IS NOT leftover Mission01
...
# Error #1232.
# Declaration-only. Accept origin/main split-line UPROPERTY and
# bool bRouteAndBeachGeneratedInstancesZero = true. Fail closed if type/decl
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bRouteAndBeachGeneratedInstancesZero. THIS IS NOT leftover
# mission01-environment-authoring-result-defaults #df1a.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bRouteAndBeachGeneratedInstancesZero. THIS IS NOT leftover MaterialCompilation bSuccess #1223.
...
# mission01-environment-authoring-result-defaults #df1a.
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bRouteAndBeachGeneratedInstancesZero FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# bool bRouteAndBeachGeneratedInstancesZero = true; one-line /
...
# is not true. Parse STRUCT public section only AFTER
# struct FSkyguardMission01EnvironmentAuthoringResult and BEFORE
# class USkyguardMission01EnvironmentAuthoringLibrary.
# Do NOT parse USkyguardMission01EnvironmentAuthoringLibrary methods.
# Do NOT parse ASkyguardMission01EnvironmentDirector.
...
# Do NOT parse FSkyguardLandscapeCaptureConfigurationResult (leftover bSuccess #1214).
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bRouteAndBeachGeneratedInstancesZero. THIS IS NOT leftover VisibleAudit bSuccess #1199.
# THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
# THIS IS NOT leftover landscape-capture-config-defaults #d6fd.
# THIS IS NOT leftover landscape-visible-audit-defaults #0bce.
# THIS IS NOT leftover landscape-material-compilation-defaults #01d4.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bRouteAndBeachGeneratedInstancesZero FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bRouteAndBeachGeneratedInstancesZero = true; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
STRUCT_NAME = "FSkyguardMission01EnvironmentAuthoringResult"
...
# BlueprintReadOnly bool bRouteAndBeachGeneratedInstancesZero = true;
...
TARGET = "bool bRouteAndBeachGeneratedInstancesZero = true;"
TARGET_WRONG = "bool bRouteAndBeachGeneratedInstancesZero = false;"
LOCKED_DECL = TARGET
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # bRouteAndBeachGeneratedInstancesZero (must be = true, not = false).
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*bool\s+bRouteAndBeachGeneratedInstancesZero\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for bool bRouteAndBeachGeneratedInstancesZero is missing from "
...
class Mission01EnvironmentAuthoringResultRouteAndBeachGeneratedInstancesZeroFieldDeclContractTests(unittest.TestCase):
    def test_mission01_environment_authoring_result_struct_exists(self) -> None:
        ...
        self.assertIn("bSuccess", section)
        self.assertIn("bRouteAndBeachGeneratedInstancesZero", section)
        self.assertIn("bLandscapeGuidValid", section)
        self.assertNotIn("bAuthoredPCGStructureReady", section)
        self.assertNotIn("bAuthoredPCGStructureReady", LOCKED_DECL)
        self.assertIn("Landscape", section)
        self.assertIn("GraphNodeCount", section)
        self.assertIn("GeneratedPCGInstanceCount", section)
        ...
        self.assertIn("VisibleAudit", section)
        self.assertNotIn("QueryLocation", section)
        self.assertNotIn("bValid", section.replace("bRouteAndBeachGeneratedInstancesZero", ""))
        ...
        self.assertNotIn("bLicensedMeshSlotsEmpty", LOCKED_DECL)
        self.assertNotIn("bGenerationLocked", LOCKED_DECL)
        self.assertNotIn("bAuthoredStructureReady", LOCKED_DECL)
        self.assertNotIn("bGraphContractValid", LOCKED_DECL)
        self.assertNotIn("GeneratedPCGComponentCount", LOCKED_DECL)
        self.assertNotIn("bSuccess", LOCKED_DECL.replace("bRouteAndBeachGeneratedInstancesZero", ""))
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bRouteAndBeachGeneratedInstancesZero", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_route_and_beach_generated_instances_zero_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_route_and_beach_generated_instances_zero_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bRouteAndBeachGeneratedInstancesZero"),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith("true;"), LOCKED_DECL)
        self.assertNotIn("= false", LOCKED_DECL)
        self.assertIn("= true", LOCKED_DECL)
        self.assertFalse(
            has_declaration(
                "\tbool bRouteAndBeachGeneratedInstancesZero = false;\n",
                LOCKED_DECL,
            )
        )
        with self.assertRaises(AssertionError) as raised:
        ...
        self.assertIn("bRouteAndBeachGeneratedInstancesZero", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bRouteAndBeachGeneratedInstancesZero", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bRouteAndBeachGeneratedInstancesZero"))
    ...
    def test_contract_does_not_relock_leftover_environment_readiness(
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_environment_authoring"
            "_result_generated_pcg_component_count_field_decl"
            "_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bRouteAndBeachGeneratedInstancesZero", locked_only)
    ...
    def test_contract_is_target_field_declaration_only(
        ...
        self.assertTrue(LOCKED_DECL.startswith("bool bRouteAndBeachGeneratedInstancesZero"))
        self.assertIn("bRouteAndBeachGeneratedInstancesZero", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.endswith("true;"))
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        this_script = (
            "Scripts/tests/test_mission01_environment_authoring"
            "_result_route_and_beach_generated_instances_zero_field_decl_contract.py"
        )
