...
# Isolated leftover-safe Mission02 Waves GetWaveState
...
# NOT leftover Mission03 GetWaveState #640 / leftover
...
# NOT leftover merged Mission02 C++ bundle #102.
...
# INDEX_NONE or lock GetWaveState
# construction in the .cpp. This is leftover-safe
# Mission09 Waves GetWaveState METHOD on
...
# (`ESkyguardMission02WaveState GetWaveState()
# const { return WaveState; }`); accept that
...
class Mission02GetWaveStateDeclContractTests(unittest.TestCase):
    def test_mission02_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, GET_WAVE_STATE),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, GET_WAVE_STATE)
        self.assertIn("GetWaveState", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, GET_WAVE_STATE)
    ...
    def test_missing_get_wave_state_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission02IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, GET_WAVE_STATE)
        self.assertIn("GetWaveState", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, GET_WAVE_STATE)
        self.assertIn("GetWaveState", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", GET_WAVE_STATE)
        self.assertNotIn("BlueprintPure", GET_WAVE_STATE)
        self.assertNotIn("Category", GET_WAVE_STATE)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, GET_WAVE_STATE)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, GET_WAVE_STATE)
        self.assertIn("GetWaveState", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = (
            "\tvoid GetWaveState() const;\n"
        )
        as_bool = "\tbool GetWaveState() const;\n"
        missing_const = (
            "\tESkyguardMission08WaveState GetWaveState();\n"
        )
        with_arg = (
            "\tESkyguardMission08WaveState "
            "GetWaveState(int32 Wave) const;\n"
        )
        renamed = (
            "\tESkyguardMission02WaveState GetState() const;\n"
        )
        short_name = "\tESkyguardMission02WaveState GetWave() const;\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, GET_WAVE_STATE)
            self.assertIn("GetWaveState", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_get_wave_state_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, GET_WAVE_STATE),
            GET_WAVE_STATE,
        )
        self.assertTrue(has_declaration(section, GET_WAVE_STATE))
        self.assertEqual(
            declaration_count(section, GET_WAVE_STATE),
            1,
        )
        self.assertTrue(
            GET_WAVE_STATE.startswith("ESkyguardMission02WaveState "),
            GET_WAVE_STATE,
        )
        self.assertIn("ESkyguardMission02WaveState", GET_WAVE_STATE)
        self.assertIn("GetWaveState", GET_WAVE_STATE)
        self.assertNotIn(";", GET_WAVE_STATE)
        self.assertIn("return WaveState;", section)
        self.assertIn(UFUNCTION_WAVES, section)
        self.assertIn(" const", GET_WAVE_STATE)
        self.assertIn("()", GET_WAVE_STATE)
        self.assertNotIn("TArray<", GET_WAVE_STATE)
        self.assertNotIn("TObjectPtr", GET_WAVE_STATE)
        self.assertNotIn("TSoftObjectPtr", GET_WAVE_STATE)
        self.assertNotIn("INDEX_NONE", GET_WAVE_STATE)
        self.assertNotIn("UFUNCTION", GET_WAVE_STATE)
        self.assertNotIn("{", GET_WAVE_STATE)
        self.assertNotIn("}", GET_WAVE_STATE)
        self.assertNotIn("return ", GET_WAVE_STATE)
        self.assertIn(" const", GET_WAVE_STATE)
        self.assertNotIn("Root", GET_WAVE_STATE)
        self.assertNotIn("Briefing", GET_WAVE_STATE)
        self.assertNotIn("AudioDirector", GET_WAVE_STATE)
        self.assertNotIn("RadioChatter", GET_WAVE_STATE)
        self.assertNotIn("SortiePresentation", GET_WAVE_STATE)
        self.assertNotIn("CampaignDefinition", GET_WAVE_STATE)
        self.assertNotIn("MissionDefinition", GET_WAVE_STATE)
        self.assertNotIn("Readiness;", GET_WAVE_STATE)
        self.assertNotIn("bAutoInitialize", GET_WAVE_STATE)
        self.assertNotIn("bAllowBoundedActorSpawning", GET_WAVE_STATE)
        self.assertNotIn("bAutoLaunchAfterBriefing", GET_WAVE_STATE)
        self.assertNotIn("PathfinderSpawnLocation", GET_WAVE_STATE)
        self.assertNotIn("GetAircraft", GET_WAVE_STATE)
        self.assertNotIn("BindRuntimeActors", GET_WAVE_STATE)
        self.assertNotIn("HandleDroneCityImpact", GET_WAVE_STATE)
        self.assertNotIn("InitializePlayableMission", GET_WAVE_STATE)
        self.assertNotIn("StartNextWave", GET_WAVE_STATE)
        self.assertNotIn("AdvanceConvoyByDistance", GET_WAVE_STATE)
        self.assertNotIn("NotifyConvoyDamage", GET_WAVE_STATE)
        self.assertNotIn("GetReadiness", GET_WAVE_STATE)
        self.assertNotIn("GetConvoyRouteState", GET_WAVE_STATE)
        self.assertNotIn("GetDayBeatKit", GET_WAVE_STATE)
        self.assertNotIn("GetNightBeatKit", GET_WAVE_STATE)
        self.assertNotIn("StartSearchlightWindow", GET_WAVE_STATE)
        self.assertNotIn("AdvanceSearchlightTrack", GET_WAVE_STATE)
        self.assertNotIn("NotifySubstationDamage", GET_WAVE_STATE)
        self.assertNotIn("GetRemainingThreatsInWave", GET_WAVE_STATE)
        self.assertNotIn("GetSearchlightRuntime", GET_WAVE_STATE)
        self.assertNotIn("GetSubstationIntegrity", GET_WAVE_STATE)
        self.assertNotIn("StartPayloadWindow", GET_WAVE_STATE)
        self.assertNotIn("AdvancePayloadWindow", GET_WAVE_STATE)
        self.assertNotIn("TryJamActivePayload", GET_WAVE_STATE)
        self.assertNotIn("NotifyAirfieldTargetDamage", GET_WAVE_STATE)
        self.assertNotIn("GetPayloadWindow", GET_WAVE_STATE)
        self.assertNotIn("GetTargetRuntime", GET_WAVE_STATE)
        self.assertNotIn("GetSurvivingTargetCount", GET_WAVE_STATE)
        self.assertNotIn("GetDayBeatKind", GET_WAVE_STATE)
        self.assertNotIn("GetDayBeatIndex", GET_WAVE_STATE)
        self.assertNotIn("TickDayBeatKit", GET_WAVE_STATE)
        self.assertNotIn("HandleBossPhaseChanged", GET_WAVE_STATE)
        self.assertNotIn("ASkyguardMission04IntegrationDirector", GET_WAVE_STATE)
        self.assertNotIn("ASkyguardMission05IntegrationDirector", GET_WAVE_STATE)
        self.assertNotIn("ASkyguardMission06IntegrationDirector", GET_WAVE_STATE)
        self.assertNotIn("ASkyguardMission07IntegrationDirector", GET_WAVE_STATE)
        self.assertNotIn("ESkyguardMission06WaveState", GET_WAVE_STATE)
        self.assertNotIn("ESkyguardMission07WaveState", GET_WAVE_STATE)
        self.assertIn("ESkyguardMission02WaveState", GET_WAVE_STATE)
        self.assertNotIn("ESkyguardMission07ProtectedTarget", GET_WAVE_STATE)
        self.assertNotIn("ESkyguardMission08ProtectedTarget", GET_WAVE_STATE)
        self.assertNotIn("FSkyguardMission07ProtectedTargetRuntime", GET_WAVE_STATE)
        self.assertNotIn("FSkyguardMission08ProtectedTargetRuntime", GET_WAVE_STATE)
        self.assertNotIn("ESkyguardSearchSector", GET_WAVE_STATE)
        self.assertNotIn("FSkyguardSearchTrackRuntime", GET_WAVE_STATE)
        self.assertNotIn("ClassifyFalseTrack", GET_WAVE_STATE)
        self.assertNotIn("ConfirmRadarGhostIdentification", GET_WAVE_STATE)
        self.assertNotIn("NotifyProtectedTargetDamage", GET_WAVE_STATE)
        self.assertNotIn("AdvanceReinforcementTimer", GET_WAVE_STATE)
        self.assertNotIn("GetSearchSector", GET_WAVE_STATE)
        self.assertNotIn("GetClassifiedFalseTrackCount", GET_WAVE_STATE)
        self.assertNotIn("IsHostileContactConfirmed", GET_WAVE_STATE)
        self.assertNotIn("GetProtectedTarget", GET_WAVE_STATE)
        self.assertNotIn("GetReinforcementTimeRemaining", GET_WAVE_STATE)
        self.assertNotIn("GetNightBeatKind", GET_WAVE_STATE)
        self.assertNotIn("GetNightBeatIndex", GET_WAVE_STATE)
        self.assertNotIn("TickNightBeatKit", GET_WAVE_STATE)
        self.assertNotIn("ESkyguardAirfieldTarget", GET_WAVE_STATE)
        self.assertNotIn("FSkyguardPayloadWindowRuntime", GET_WAVE_STATE)
        self.assertNotIn("ASkyguardMission03IntegrationDirector", GET_WAVE_STATE)
        self.assertNotIn("ConvoyRuntimeAnchor", GET_WAVE_STATE)
        self.assertNotIn("RoadHunterSpawnLocation", GET_WAVE_STATE)
        self.assertNotIn("ASkyguardMission01IntegrationDirector", GET_WAVE_STATE)
        self.assertNotIn("ASkyguardMission09IntegrationDirector", GET_WAVE_STATE)
        self.assertNotIn("ConfigureMissionDefinition", GET_WAVE_STATE)
        self.assertNotIn("NotifyObjectiveProgress", GET_WAVE_STATE)
        self.assertNotIn("NotifyProtectedAssetFailed", GET_WAVE_STATE)
        self.assertNotIn("SynchronizeRuntimeState", GET_WAVE_STATE)
        self.assertNotIn("NotifyThreatDestroyed", GET_WAVE_STATE)
        self.assertNotIn("IsCorePlayableReady", GET_WAVE_STATE)
        self.assertNotIn("GetObjectiveRuntime", GET_WAVE_STATE)
        self.assertNotIn("GetGunner", GET_WAVE_STATE)
        self.assertNotIn("GetPathfinder", GET_WAVE_STATE)
        self.assertNotIn("GetMissionId", GET_WAVE_STATE)
        self.assertNotIn("ValidateMissionContract", GET_WAVE_STATE)
        self.assertNotIn("ConfigureFromMission", GET_WAVE_STATE)
        self.assertNotIn("AdvanceBriefing", GET_WAVE_STATE)
        self.assertNotIn("SetAssetsReady", GET_WAVE_STATE)
        self.assertNotIn("AcknowledgeAndLaunch", GET_WAVE_STATE)
        self.assertNotIn("CanLaunch", GET_WAVE_STATE)
        self.assertNotIn("GetElapsedSeconds", GET_WAVE_STATE)
        self.assertNotIn("GetBriefingState", GET_WAVE_STATE)
        self.assertNotIn("GetMinimumWarmupSeconds", GET_WAVE_STATE)
        self.assertNotIn("GetBriefingText", GET_WAVE_STATE)
        self.assertNotIn("GetRadioChatter", GET_WAVE_STATE)
        self.assertNotIn("GetPresentation", GET_WAVE_STATE)
        self.assertNotIn("GetMissionTitle", GET_WAVE_STATE)
        self.assertNotIn("AcknowledgeBriefing", GET_WAVE_STATE)
        self.assertNotIn("LaunchSortie", GET_WAVE_STATE)
        self.assertNotIn("HullCollider", GET_WAVE_STATE)
        self.assertNotIn("OpticalTracker", GET_WAVE_STATE)
        self.assertNotIn("WeaponServo", GET_WAVE_STATE)
        self.assertNotIn("CountermeasurePod", GET_WAVE_STATE)
        self.assertNotIn("MinHeightFromOriginCm", GET_WAVE_STATE)
        self.assertNotIn("RadarNode", GET_WAVE_STATE)
        self.assertNotIn("ESkyguardMission09WaveState", GET_WAVE_STATE)
        self.assertNotIn("HarborIndustrial", GET_WAVE_STATE)
        self.assertNotIn("MaxIntegrity", GET_WAVE_STATE)
        self.assertNotIn("CurrentIntegrity", GET_WAVE_STATE)
        self.assertNotIn("FillAndFinalize", GET_WAVE_STATE)
        self.assertNotIn("FillAndFail", GET_WAVE_STATE)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, GET_WAVE_STATE)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_WAVES} {GET_WAVE_STATE}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{GET_WAVE_STATE}\n}}\n"
        self.assertTrue(has_declaration(one_line, GET_WAVE_STATE))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, GET_WAVE_STATE),
            section,
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", GET_WAVE_STATE)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_get_wave_state_cpp_body(self) -> None:
        locked_only = f"{GET_WAVE_STATE}\n"
        self.assertNotIn("{", GET_WAVE_STATE)
        self.assertNotIn("}", GET_WAVE_STATE)
        self.assertNotIn("return ", GET_WAVE_STATE)
        self.assertNotIn(
            "ASkyguardMission02IntegrationDirector::GetWaveState",
            GET_WAVE_STATE,
        )
        self.assertNotIn(
            "SkyguardMission02IntegrationDirector.cpp",
        ...
        self.assertNotIn("return false", GET_WAVE_STATE)
        self.assertNotIn("return true", GET_WAVE_STATE)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{GET_WAVE_STATE}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_WAVE_STATE)
        self.assertIn("GetWaveState", GET_WAVE_STATE)
        self.assertTrue(GET_WAVE_STATE.startswith("ESkyguardMission02WaveState "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, GET_WAVE_STATE)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, GET_WAVE_STATE)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", GET_WAVE_STATE)
        self.assertNotIn("CurrentIntegrity", GET_WAVE_STATE)
        self.assertNotIn("SkyguardApacheAircraft.h", GET_WAVE_STATE)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, GET_WAVE_STATE)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", GET_WAVE_STATE)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{GET_WAVE_STATE}\n"
        self.assertEqual(
            require_declaration(locked_only, GET_WAVE_STATE),
            GET_WAVE_STATE,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, GET_WAVE_STATE)
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn("FSkyguardSearchlightTrackRuntime", GET_WAVE_STATE)
        self.assertNotIn("ASkyguardApacheAircraft", section)
        self.assertNotIn("ASkyguardRadarNode", section)
        self.assertNotIn("ASkyguardBlackKiteBoss", GET_WAVE_STATE)
        self.assertNotIn("ASkyguardIronRainBoss", GET_WAVE_STATE)
        self.assertNotIn("ASkyguardRadarGhostBoss", GET_WAVE_STATE)
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{GET_WAVE_STATE}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, GET_WAVE_STATE.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                GET_WAVE_STATE.lower(),
                "mission02 GetWaveState contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, GET_WAVE_STATE)

    def test_contract_is_get_wave_state_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_get_wave_state(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, GET_WAVE_STATE)
            )
            self.assertNotEqual(GET_WAVE_STATE, leftover)
        self.assertIn(
    ...
    def test_leftover_harbor_mission02_initialize_does_not_satisfy(
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_init_only, GET_WAVE_STATE)
        self.assertIn("GetWaveState", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(
            "Scripts/tests/test_mission02_initialize_playable_mission"
    ...
    def test_leftover_handle_drone_city_impact_does_not_satisfy(self) -> None:
        ...
        self.assertIn("GetWaveState", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(region, GET_WAVE_STATE))
        locked_only = f"{GET_WAVE_STATE}\n"
    ...
    def test_leftover_environment_get_wave_state_does_not_satisfy(self) -> None:
        leftover = (
    ...
    def test_leftover_mission07_get_wave_state_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m07_ready_type, GET_WAVE_STATE)
        self.assertIn("GetWaveState", str(raised.exception))
    ...
    def test_contract_does_not_relock_leftover_mission08_wave_state_enum(
        ...
        self.assertNotIn("ESkyguardMission08WaveState", GET_WAVE_STATE)
        self.assertIn("ESkyguardMission02WaveState", GET_WAVE_STATE)
        self.assertNotIn("Integration", UFUNCTION_WAVES)
    ...
    def test_sibling_mission08_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("NotifyThreatDestroyed", GET_WAVE_STATE)
        self.assertNotIn("StartNextWave", GET_WAVE_STATE)
        self.assertNotIn("StartHoistWindow", GET_WAVE_STATE)
        self.assertNotIn("AdvanceHoistWindow", GET_WAVE_STATE)
        self.assertNotIn("ValidateWeaponRelease", GET_WAVE_STATE)
        self.assertNotIn("IsCorePlayableReady", GET_WAVE_STATE)
        self.assertNotIn("SynchronizeRuntimeState", GET_WAVE_STATE)
        self.assertNotIn("GetObjectiveRuntime", GET_WAVE_STATE)
        self.assertNotIn("GetReadiness", GET_WAVE_STATE)
    ...
    def test_leftover_mission08_get_wave_state_does_not_satisfy(self) -> None:
        ...
        leftover_wave_index = f"\t{GET_CURRENT_WAVE_INDEX}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m08_type, GET_WAVE_STATE)
        self.assertIn("GetWaveState", str(raised.exception))
    ...
    def test_contract_does_not_relock_leftover_mission09_pool(self) -> None:
        ...
        self.assertNotIn("Performance", UFUNCTION_WAVES)
        self.assertNotIn("GetPoolRuntime", GET_WAVE_STATE)
    ...
    def test_sibling_mission09_methods_do_not_satisfy(self) -> None:
        ...
        for token in LEFTOVER_MISSION09_SIBLING_METHODS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, GET_WAVE_STATE)
        self.assertNotIn("BindCampaignRuntime", GET_WAVE_STATE)
        self.assertNotIn("GetPoolRuntime", GET_WAVE_STATE)
        self.assertNotIn(BIND_RUNTIME_ACTORS, GET_WAVE_STATE)
        self.assertNotIn("UFUNCTION", GET_DAY_BEAT_KIT)
        self.assertNotIn("UFUNCTION", GET_DAY_BEAT_KIND)
    ...
    def test_leftover_mission09_get_wave_state_does_not_satisfy(self) -> None:
        ...
        leftover_m09_type = f"\t{LEFTOVER_MISSION09_GET_WAVE_STATE}\n"
        with self.assertRaises(AssertionError) as raised:
            require_declaration(leftover_m09_type, GET_WAVE_STATE)
        self.assertIn("GetWaveState", str(raised.exception))
    ...
    def test_leftover_mission10_get_route_phase_does_not_satisfy(self) -> None:
        ...
        for token in LEFTOVER_MISSION10_GET_ROUTE_PHASE_NOT_LOCKED:
            self.assertNotIn(token, GET_WAVE_STATE)
        self.assertNotIn("Mission10", UFUNCTION_WAVES)
        self.assertNotIn("GetRoutePhase", GET_WAVE_STATE)
    ...
    def test_leftover_mission02_sibling_methods_do_not_satisfy(self) -> None:
        ...
        self.assertNotIn("InitializePlayableMission", GET_WAVE_STATE)
        self.assertNotIn("NotifyFuelTerminalDamage", GET_WAVE_STATE)
