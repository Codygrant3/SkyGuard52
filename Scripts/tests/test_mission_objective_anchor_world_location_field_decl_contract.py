# THIS IS leftover-safe FSkyguardMissionObjectiveAnchor WorldLocation.
...
# THIS IS leftover-safe isolated UPROPERTY without Category.
...
# drop to BlueprintReadWrite / VisibleAnywhere-only, if
# the type is not FVector, if Category= is added, or if the
# initializer is missing or not `= FVector::ZeroVector`.
# Harbor 40/80 fail-closed anywhere in the accepted decl
# and in the parse window.
# Accept one-line and split-line UPROPERTY wraps.
# Parse STRUCT `FSkyguardMissionObjectiveAnchor` body ONLY after
# `struct FSkyguardMissionObjectiveAnchor`. Stop at
# `struct FSkyguardMissionLandmarkAnchor`.
# Do NOT parse leftover `FSkyguardMissionMapReadiness`
# isolated fields.
# Do NOT parse leftover `ASkyguardMissionMapAssemblyDirector`
# UFUNCTIONs.
# Do NOT parse leftover `FSkyguardMissionLandmarkAnchor`
# defaults #203 / #4230 or LandmarkAnchor WorldLocation.
...
# (Harbor skyline label stays OUT of this window by
# starting at the claimed struct).
# Sibling ObjectiveId stays unclaimed (`FName ObjectiveId;`
# no initializer).
# THIS IS NOT leftover mission-objective-anchor-defaults
# #201 / #692c. Analog leftover
# mission-objective-anchor-defaults then this isolated
# WorldLocation field decl.
# THIS IS NOT leftover FSkyguardRoutePoint::WorldLocation
# #1340.
# THIS IS NOT leftover FSkyguardObjectiveDefinition::ObjectiveId
# #1364.
# THIS IS NOT leftover FSkyguardObjectiveProgress::ObjectiveId
# #1261.
...
# bare FName ObjectiveId / no `=`, retarget: type is
...
STRUCT_NAME = "FSkyguardMissionObjectiveAnchor"
...
LEFTOVER_ROUTE_POINT_WORLD_LOCATION = (
    "Scripts/tests/test_route_point_world_location"
    "_field_decl_contract.py"
)
LEFTOVER_MISSION_SAVE_RECORD_DEFAULTS = (
    "Scripts/tests/test_mission_save_record_defaults"
    "_contract.py"
)
...
LEFTOVER_MISSION_PRESENTATION_DEFAULTS = (
    "Scripts/tests/test_mission_presentation_defaults"
    "_contract.py"
)
LEFTOVER_MISSION_PRESENTATION_DEFAULTS_PY = (
    "Scripts/tests/test_mission_presentation_defaults.py"
)
LEFTOVER_MISSION_PRESENTATION_DEFAULTS_TESTS = (
    "Scripts/tests/test_mission_presentation_defaults"
    "_tests.py"
)
...
STOP_BEFORE_LANDMARK = "struct FSkyguardMissionLandmarkAnchor"
...
def leftover_isolated_decl_scripts() -> tuple[str, ...]:
    return (
        ...
        "_field_decl_contract.py",
        "Scripts/tests/test_weather_profile_wind_speed_meters"
        "_per_second_field_decl_contract.py",
        ...
        "_field_decl_contract.py",
        "Scripts/tests/test_mission_score_rules_perfect_accuracy"
        "_bonus_field_decl_contract.py",
        ...
        "_field_decl_contract.py",
        "Scripts/tests/test_objective_definition_required_for"
        "_mission_success_field_decl_contract.py",
        "Scripts/tests/test_objective_definition_score_reward"
        "_field_decl_contract.py",
        "Scripts/tests/test_objective_definition_failure_ends"
        "_mission_field_decl_contract.py",
        "Scripts/tests/test_boss_weak_point_definition_weak_point"
        "_id_field_decl_contract.py",
        "Scripts/tests/test_boss_weak_point_definition_required"
        "_weapon_field_decl_contract.py",
        "Scripts/tests/test_boss_weak_point_definition_exposes"
        "_weak_point_id_field_decl_contract.py",
        ...
        "_decl_contract.py",
        "Scripts/tests/test_mission_definition_display_name"
        "_decl_contract.py",
        "Scripts/tests/test_mission_definition_campaign_order"
        "_decl_contract.py",
        "Scripts/tests/test_mission_definition_mission_map"
        "_decl_contract.py",
        "Scripts/tests/test_mission_definition_route"
        "_decl_contract.py",
        "Scripts/tests/test_mission_definition_objectives"
        "_decl_contract.py",
        "Scripts/tests/test_mission_definition_waves"
        "_decl_contract.py",
        "Scripts/tests/test_mission_definition_weather"
        "_decl_contract.py",
        "Scripts/tests/test_mission_definition_boss"
        "_decl_contract.py",
        "Scripts/tests/test_mission_definition_score_rules"
        "_decl_contract.py",
        "Scripts/tests/test_mission_definition_prerequisite_ids"
        "_decl_contract.py",
        "Scripts/tests/test_mission_definition_required_medals"
        "_decl_contract.py",
        "Scripts/tests/test_mission_definition_get_primary_asset_id"
        "_decl_contract.py",
...
LOCKED_SCRIPTS = (
    ...
    LEFTOVER_MISSION_PRESENTATION_DEFAULTS_TESTS,
    LEFTOVER_MISSION_TYPES_DEFAULTS,
    *leftover_isolated_decl_scripts(),
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # Do not accept sibling ObjectiveId. Do not accept leftover
    # FSkyguardRoutePoint::WorldLocation or leftover
    # FSkyguardMissionLandmarkAnchor WorldLocation outside
    # this struct window.
...
class MissionObjectiveAnchorWorldLocationFieldDeclContractTests(unittest.TestCase):
    def test_objective_anchor_struct_exists(self) -> None:
        ...
        self.assertNotEqual(STRUCT_NAME, "FSkyguardMissionLandmarkAnchor")
        ...
        self.assertIn(STOP_BEFORE_LANDMARK, header)
        self.assertNotIn(STOP_BEFORE_LANDMARK, section)
        self.assertNotIn(STOP_BEFORE_LANDMARK, body)
    ...
    def test_missing_struct_fails_closed(self) -> None:
        with self.assertRaises(AssertionError) as raised:
            struct_body(
                "struct FSkyguardUnrelatedMissionObjectiveAnchor\n{\n};\n"
            )
    ...
    def test_landmark_or_readiness_declaration_does_not_satisfy(self) -> None:
        mixed = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            "\tGENERATED_BODY()\n"
            "};\n"
            f"{STOP_BEFORE_LANDMARK}\n"
            "{{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            f"\t{LOCKED_DECL}\n"
            "}}\n"
    ...
    def test_does_not_contract_sibling_objective_id(self) -> None:
        for sibling in sibling_uncontracted_decls():
            self.assertNotIn(sibling, LOCKED_DECL)
        for field in leftover_neighbor_hit_fields():
            self.assertNotIn(field, LOCKED_DECL)
    ...
    def test_does_not_parse_landmark_readiness_or_neighbors(self) -> None:
        header = origin_main_header()
        section = spec_section(header)
        leaked = struct_body(header)
        self.assertIn(STOP_BEFORE_LANDMARK, header)
        self.assertNotIn(STOP_BEFORE_LANDMARK, section)
        self.assertNotIn(STOP_BEFORE_LANDMARK, leaked)
        self.assertIn(STOP_BEFORE_MAP_READINESS, header)
        self.assertNotIn(STOP_BEFORE_MAP_READINESS, section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission-objective-anchor WorldLocation field decl "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(Path(__file__).name.endswith(
            "mission_objective_anchor_world_location_field_decl_contract.py"
        ))
        self.assertNotIn("SkyguardMissionMapAssemblyDirector.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardMissionTypes.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardMissionDefinition.cpp", THIS_SCRIPT)
        ...
        self.assertIn(LEFTOVER_ROUTE_POINT_WORLD_LOCATION, LOCKED_SCRIPTS)
    ...
    def test_contract_is_target_field_declaration_only(self) -> None:
        ...
        self.assertNotIn("FSkyguardMissionLandmarkAnchor", locked_only)
        ...
        self.assertNotIn(STOP_BEFORE_LANDMARK, locked_only)
