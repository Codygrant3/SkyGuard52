...
# THIS IS leftover-safe Mission09 CampaignDefinition FIELD
...
# SortiePresentation #1089 (Briefing #1086 / AudioDirector
# #1087 / RadioChatter #1088 / SortiePresentation #1089).
...
# CampaignDefinition director-field drafts.
...
# merge #665 #666 #668-#673, or open drafts #674-#1089.
...
# drafts #674-#1089 including leftover Mission06
...
LOCKED_DECL = CAMPAIGN_DEFINITION_FIELD
...
# an isolated Python CampaignDefinition
...
class Mission09CampaignDefinitionFieldDeclContractTests(unittest.TestCase):
    ...
    def test_missing_campaign_definition_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission08IntegrationDirector();\n"
    ...
    def test_campaign_definition_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("TSoftObjectPtr<USkyguardCampaignDefinition> "),
            LOCKED_DECL,
        )
        self.assertTrue(LOCKED_DECL.endswith(";"), LOCKED_DECL)
        self.assertIn("CampaignDefinition", LOCKED_DECL)
        self.assertIn("USkyguardCampaignDefinition", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("CampaignDefinition", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("TSoftObjectPtr<USkyguardCampaignDefinition>"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("CampaignDefinition", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 CampaignDefinition field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 CampaignDefinition field contains "
    ...
    def test_contract_is_campaign_definition_field_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
    ...
    def test_sibling_director_fields_do_not_satisfy_campaign_definition(
        self,
    ) -> None:
        for leftover in (
            BRIEFING_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_campaign_definition_field"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_readiness_struct_does_not_satisfy_campaign_definition(self) -> None:
        leftover = (
    ...
    def test_search_track_runtime_does_not_satisfy_campaign_definition(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_protected_target_runtime_does_not_satisfy_campaign_definition(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_airfield_target_runtime_does_not_satisfy_campaign_definition(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_payload_window_runtime_does_not_satisfy_campaign_definition(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_hoist_window_runtime_does_not_satisfy_campaign_definition(
        self,
    ) -> None:
        leftover = (
            "USTRUCT(BlueprintType)\n"
    ...
    def test_private_transient_does_not_satisfy_campaign_definition(
        self,
    ) -> None:
        leftover = (
            f"class SKYGUARD52_API {CLASS_NAME} "
