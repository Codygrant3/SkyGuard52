...
# bContinuousCoastline FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly bool
# bContinuousCoastline = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bContinuousCoastline FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bContinuousCoastline = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
# THIS IS NOT leftover Mission01 environment-readiness-defaults
# #6b9d/#204. THIS IS NOT leftover HasContinuousCoastline #623
# (DIFFERENT API on ASkyguardMission01EnvironmentDirector).
# THIS IS NOT leftover OceanTileCount #1170 / BeachTileCount
# #1171 / LandTileCount #1172 / bAuthoredLandscapeSurfaceExposed
# #1173. THIS IS NOT leftover IsAuthoredEnvironmentReady
# #625. THIS IS NOT leftover ProductionLandscape director
# field #591. THIS IS NOT leftover IsAuthoredLandscapeSurfaceExposed
# director method. LOCK in-flight leftover-safe
# bRouteExclusionValid / LandscapeComponentCount sibling
# scripts; do not edit them. THIS IS NOT leftover BeachTileCount /
# LandTileCount / OceanTileCount siblings (LOCK those scripts;
...
# FSkyguardMission01EnvironmentReadiness bContinuousCoastline
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bContinuousCoastline = false;
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bContinuousCoastline. THIS IS NOT leftover mission-map-
...
# UPROPERTY(Transient).
# THIS IS leftover-safe FSkyguardMission01EnvironmentReadiness
# bContinuousCoastline. THIS IS NOT leftover Mission05
...
# Mission01 EnvironmentReadiness bContinuousCoastline
# FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bContinuousCoastline = false;
# one-line / split-line UPROPERTY wraps;
...
# bContinuousCoastline FIELD (declaration-only). It is
...
TARGET = "bool bContinuousCoastline = false;"
TARGET_WRONG = "bool bContinuousCoastline = true;"
LOCKED_DECL = TARGET
...
class Mission01EnvironmentReadinessContinuousCoastlineFieldDeclContractTests(unittest.TestCase):
    def test_environment_readiness_struct_exists(self) -> None:
        ...
        self.assertIn("bContinuousCoastline", section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bContinuousCoastline", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_continuous_coastline_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_continuous_coastline_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bContinuousCoastline"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bContinuousCoastline", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bContinuousCoastline", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bContinuousCoastline"))
    ...
    def test_contract_does_not_relock_leftover_environment_readiness(
        ...
        self.assertIn(
            "Scripts/tests/test_mission01_environment_readiness"
            "_authored_landscape_surface_exposed_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_has_continuous"
            "_coastline_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
            "Scripts/tests/test_mission01_environment_readiness"
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bContinuousCoastline", locked_only)
    ...
    def test_contract_is_target_field_declaration_only(
        ...
        self.assertNotIn("HasContinuousCoastline", LOCKED_DECL)
    ...
    def test_sibling_director_fields_do_not_satisfy_continuous_coastline(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
