...
# Mission04 Integration GetReadiness
...
# GetReadiness #637, NOT leftover BindRuntimeActors
...
# #637, leftover environment-readiness defaults
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission04IntegrationDirector::GetReadiness",
    "SkyguardMission04IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission04GetReadinessDeclContractTests(unittest.TestCase):
    ...
    def test_get_readiness_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("Mission01IntegrationReadiness", GET_READINESS)
        self.assertNotIn("Mission03IntegrationReadiness", GET_READINESS)
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                GET_READINESS.lower(),
                "mission04 GetReadiness contains "
