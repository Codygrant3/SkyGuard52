...
# bLandscapeGuidValid. THIS IS NOT leftover
...
# bool bLandscapeGuidValid = false. Fail closed if type/decl
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bLandscapeGuidValid. THIS IS NOT leftover MaterialCompilation bSuccess #1223.
...
# mission01-environment-authoring-result-defaults #df1a.
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bLandscapeGuidValid FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# bool bLandscapeGuidValid = false; one-line /
...
# Do NOT parse FSkyguardLandscapeCaptureConfigurationResult (leftover bSuccess #1214).
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bLandscapeGuidValid. THIS IS NOT leftover VisibleAudit bSuccess #1199.
# THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
# THIS IS NOT leftover landscape-capture-config-defaults #d6fd.
# THIS IS NOT leftover landscape-visible-audit-defaults #0bce.
# THIS IS NOT leftover landscape-material-compilation-defaults #01d4.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bLandscapeGuidValid FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bLandscapeGuidValid = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# BlueprintReadOnly bool bLandscapeGuidValid = false;
...
TARGET = "bool bLandscapeGuidValid = false;"
TARGET_WRONG = "bool bLandscapeGuidValid = true;"
LOCKED_DECL = TARGET
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # bLandscapeGuidValid (must be = false, not = true).
    # THIS IS NOT leftover VisibleAudit bSuccess #1199.
    # THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*bool\s+bLandscapeGuidValid\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for bool bLandscapeGuidValid is missing from "
...
class Mission01EnvironmentAuthoringResultLandscapeGuidValidFieldDeclContractTests(unittest.TestCase):
    def test_mission01_environment_authoring_result_struct_exists(self) -> None:
        ...
        self.assertNotIn("bValid", section.replace("bLandscapeGuidValid", ""))
        ...
        self.assertNotIn("bSuccess", LOCKED_DECL.replace("bLandscapeGuidValid", ""))
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bLandscapeGuidValid", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_landscape_guid_valid_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_landscape_guid_valid_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bLandscapeGuidValid"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bLandscapeGuidValid", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bLandscapeGuidValid", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bLandscapeGuidValid"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bLandscapeGuidValid", locked_only)
