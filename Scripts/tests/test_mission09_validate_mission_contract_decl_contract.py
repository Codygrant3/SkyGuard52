...
# Mission09 Integration ValidateMissionContract
# METHOD (declaration-only, split-line) on
# ASkyguardMission09IntegrationDirector. It is
# NOT leftover Mission08 ValidateMissionContract
# #748 / branch cursor/mission08-validate-mission-
...
# Mission08 GetMissionId #749, not leftover
...
# leftover Mission08 ValidateMissionContract #748,
...
class Mission09ValidateMissionContractDeclContractTests(unittest.TestCase):
    ...
    def test_contract_does_not_lock_validate_mission_contract_cpp_body(self) -> None:
        ...
        self.assertNotIn("}", LOCKED_DECL)
        self.assertNotIn("return ", LOCKED_DECL)
        self.assertNotIn('TEXT("M09_SaturationAttack")', LOCKED_DECL)
        self.assertNotIn(
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission09 ValidateMissionContract method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission09 ValidateMissionContract contains "
    ...
    def test_contract_is_validate_mission_contract_declaration_only(
        ...
        self.assertIn("const USkyguardMissionDefinition* Mission", LOCKED_DECL)
        self.assertIn("TArray<FText>& OutErrors", LOCKED_DECL)
        self.assertIn(UFUNCTION_INTEGRATION, section)
    ...
    def test_declaration_accepts_inline_body_without_locking_it(self) -> None:
        ...
        self.assertNotIn("return false", LOCKED_DECL)
        self.assertNotIn("return true", LOCKED_DECL)
        self.assertNotIn("M07_SearchIntercept", LOCKED_DECL)
        self.assertNotIn("M06_AirfieldDefense", LOCKED_DECL)
        self.assertNotIn("M05_StormFront", LOCKED_DECL)
        self.assertNotIn("M04_NightBlackout", LOCKED_DECL)
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission09_validate_mission_contract"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_contract_does_not_relock_leftover_mission09_pool(self) -> None:
        ...
        self.assertNotIn("Performance", UFUNCTION_INTEGRATION)
        self.assertNotIn("GetReadiness", LOCKED_DECL)
        self.assertNotIn("Available = 48", LOCKED_DECL)
        self.assertNotIn("PeakActive", LOCKED_DECL)
        self.assertNotIn("Recycled", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_leftover_mission08_get_mission_id(
        ...
        self.assertNotIn("M08_RescueCover", LOCKED_DECL)
        self.assertNotIn("Mission08", UFUNCTION_INTEGRATION)
