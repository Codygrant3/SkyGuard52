...
# INDEX_NONE or lock MissionDefinition construction
# in the .cpp. This is a FIELD contract on
# ASkyguardMission01IntegrationDirector, not leftover
# USkyguardMissionDefinition public methods
# (already drafted) and not leftover briefing-widget
# getters. Keep MissionDefinition distinct from
# sibling director fields Briefing / AudioDirector /
# Root / RadioChatter / SortiePresentation /
# CampaignDefinition / Readiness. Do not lock leftover
# spawn-location fields on this class. Do not lock
# leftover GetAircraft. Do not lock leftover
# MissionBriefingComponent methods ConfigureFromMission
# / AdvanceBriefing / SetAssetsReady /
# AcknowledgeAndLaunch / CanLaunch / GetElapsedSeconds
# / GetBriefingState / GetMinimumWarmupSeconds /
# GetBriefingText / GetRadioChatter. Do not lock
# leftover briefing-widget GetPresentation / Configure
# / GetMissionTitle / GetBriefingText /
# AcknowledgeBriefing / LaunchSortie. Do not lock
# leftover USkyguardMissionDefinition MissionId /
# DisplayName / CampaignOrder / MissionMap / Route /
# Objectives / Waves / Weather / Boss / Presentation /
# ScoreRules / PrerequisiteMissionIds /
# RequiredCampaignMedals / GetPrimaryAssetId /
# FindObjective / ValidateDefinition. Do not open
# SkyguardMissionDefinition.h. Stay off leftover
# campaign-definition method contracts. Stay off
# leftover audio-director listener / telemetry /
# suppression / engine-state / bank-null / world-event
# fail-closed contracts. Stay off leftover
# radio-chatter empty-queue / empty-line fail-closed
# contracts. origin/main is a one-line field
# (`TSoftObjectPtr<USkyguardMissionDefinition>
# MissionDefinition;`); accept that form and other
# one-line / split-line wraps. Nearby origin/main
# UPROPERTY(EditAnywhere, BlueprintReadWrite,
# Category="Skyguard|Mission01") is required as
# present. Accept one-line and split-line
# UPROPERTY wraps. Parse the public class
# section of ASkyguardMission01IntegrationDirector
# only. Category is Skyguard|Mission01, not
# Mission01|Campaign / Mission02 / Boss / Destruction.
# Stay off leftover drafts #56–#64, leftover Harbor
# #6/#8/#9, leftover theater-kit #59, leftover
# isolated-test drafts #107–#574, leftover Apache
...
# leftover theater-kit #59, leftover #107–#574, plus
# SkyguardMission01IntegrationDirector production
# files. This lane only adds an isolated Python
# MissionDefinition field declaration contract on
...
# method decl contracts, leftover mission-definition
...
MISSION_ID_FIELD = "FName MissionId;"
FIND_OBJECTIVE = (
    "bool FindObjective(FName ObjectiveId, "
    "FSkyguardObjectiveDefinition& OutObjective) const;"
)
LEFTOVER_MISSION_DEFINITION_METHODS_NOT_LOCKED = (
    MISSION_ID_FIELD,
    FIND_OBJECTIVE,
    VALIDATE_DEFINITION,
    GET_PRIMARY_ASSET_ID,
    ...
    "test_mission_definition_mission_id_decl_contract.py",
    "test_mission_definition_display_name_decl_contract.py",
    "test_mission_definition_campaign_order_decl_contract.py",
    "test_mission_definition_mission_map_decl_contract.py",
    "test_mission_definition_route_decl_contract.py",
    "test_mission_definition_objectives_decl_contract.py",
    "test_mission_definition_waves_decl_contract.py",
    "test_mission_definition_weather_decl_contract.py",
    "test_mission_definition_boss_decl_contract.py",
    "test_mission_definition_presentation_decl_contract.py",
    "test_mission_definition_score_rules_decl_contract.py",
    "test_mission_definition_prerequisite_ids_decl_contract.py",
    "test_mission_definition_required_medals_decl_contract.py",
    "test_mission_definition_get_primary_asset_id_decl_contract.py",
    "test_mission_definition_find_objective_decl_contract.py",
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission01IntegrationDirector::MissionDefinition",
    "SkyguardMission01IntegrationDirector.cpp",
...
class Mission01MissionDefinitionFieldDeclContractTests(unittest.TestCase):
    def test_mission01_class_exists(self) -> None:
        ...
        self.assertTrue(has_declaration(section, MISSION_DEFINITION_FIELD), section)
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, MISSION_DEFINITION_FIELD)
        self.assertIn("MissionDefinition", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(has_declaration(section, MISSION_DEFINITION_FIELD))
    ...
    def test_missing_mission_definition_declaration_fails_closed(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, MISSION_DEFINITION_FIELD)
        self.assertIn("MissionDefinition", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_uproperty_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, MISSION_DEFINITION_FIELD)
        self.assertIn("MissionDefinition", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        self.assertIn('Category="Skyguard|Mission01"', section)
        self.assertTrue(has_declaration(section, MISSION_DEFINITION_FIELD), section)
        self.assertNotIn("UPROPERTY", MISSION_DEFINITION_FIELD)
        self.assertNotIn("EditAnywhere", MISSION_DEFINITION_FIELD)
        self.assertNotIn("BlueprintReadWrite", MISSION_DEFINITION_FIELD)
        self.assertNotIn("Category", MISSION_DEFINITION_FIELD)
        ...
        self.assertNotIn("|Campaign", UPROPERTY_MISSION01)
        ...
        for invented in INVENTED_UPROPERTY:
            ...
            self.assertNotIn(invented, MISSION_DEFINITION_FIELD)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, MISSION_DEFINITION_FIELD)
        self.assertIn("MissionDefinition", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        raw_pointer = "\tUSkyguardMissionDefinition* MissionDefinition;\n"
        as_array = (
            "\tTArray<TSoftObjectPtr<USkyguardMissionDefinition>> "
            "MissionDefinition;\n"
        )
        scene = "\tTSoftObjectPtr<USceneComponent> MissionDefinition;\n"
        briefing = (
            "\tTSoftObjectPtr<USkyguardCampaignDefinition> "
            "MissionDefinition;\n"
        )
        weak = (
            "\tTWeakObjectPtr<USkyguardMissionDefinition> "
            "MissionDefinition;\n"
        )
        assigned = (
            "\tTSoftObjectPtr<USkyguardMissionDefinition> "
        ...
        leftover_campaign = f"\t{AUDIO_DIRECTOR_FIELD}\n"
        leftover_mission = f"\t{CAMPAIGN_DEFINITION_FIELD}\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, MISSION_DEFINITION_FIELD)
            self.assertIn("MissionDefinition", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_mission_definition_declaration_matches_origin_main(self) -> None:
        ...
        self.assertTrue(has_declaration(section, MISSION_DEFINITION_FIELD))
        self.assertEqual(declaration_count(section, MISSION_DEFINITION_FIELD), 1)
        self.assertTrue(
            MISSION_DEFINITION_FIELD.startswith(
                "TSoftObjectPtr<USkyguardMissionDefinition> "
            ),
            MISSION_DEFINITION_FIELD,
        )
        self.assertTrue(MISSION_DEFINITION_FIELD.endswith(";"), MISSION_DEFINITION_FIELD)
        self.assertIn("MissionDefinition", MISSION_DEFINITION_FIELD)
        self.assertIn(
            "USkyguardMissionDefinition",
            MISSION_DEFINITION_FIELD,
        )
        self.assertIn("TSoftObjectPtr<", MISSION_DEFINITION_FIELD)
        self.assertNotIn("TArray<", MISSION_DEFINITION_FIELD)
        self.assertNotIn("TWeakObjectPtr", MISSION_DEFINITION_FIELD)
        self.assertNotIn("=", MISSION_DEFINITION_FIELD)
        self.assertNotIn("INDEX_NONE", MISSION_DEFINITION_FIELD)
        self.assertNotIn("UFUNCTION", MISSION_DEFINITION_FIELD)
        self.assertNotIn("{", MISSION_DEFINITION_FIELD)
        self.assertNotIn("}", MISSION_DEFINITION_FIELD)
        self.assertNotIn("return ", MISSION_DEFINITION_FIELD)
        self.assertNotIn("Briefing", MISSION_DEFINITION_FIELD)
        self.assertNotIn("RadioChatter", MISSION_DEFINITION_FIELD)
        self.assertNotIn("SortiePresentation", MISSION_DEFINITION_FIELD)
        self.assertNotIn("AudioDirector", MISSION_DEFINITION_FIELD)
        self.assertNotIn("CampaignDefinition", MISSION_DEFINITION_FIELD)
        self.assertNotIn("Readiness", MISSION_DEFINITION_FIELD)
        self.assertNotIn("PathfinderSpawnLocation", MISSION_DEFINITION_FIELD)
        self.assertNotIn("GetAircraft", MISSION_DEFINITION_FIELD)
        self.assertNotIn("ConfigureFromMission", MISSION_DEFINITION_FIELD)
        self.assertNotIn("AdvanceBriefing", MISSION_DEFINITION_FIELD)
        self.assertNotIn("SetAssetsReady", MISSION_DEFINITION_FIELD)
        self.assertNotIn("AcknowledgeAndLaunch", MISSION_DEFINITION_FIELD)
        self.assertNotIn("CanLaunch", MISSION_DEFINITION_FIELD)
        self.assertNotIn("GetElapsedSeconds", MISSION_DEFINITION_FIELD)
        self.assertNotIn("GetBriefingState", MISSION_DEFINITION_FIELD)
        self.assertNotIn("GetMinimumWarmupSeconds", MISSION_DEFINITION_FIELD)
        self.assertNotIn("GetBriefingText", MISSION_DEFINITION_FIELD)
        self.assertNotIn("GetRadioChatter", MISSION_DEFINITION_FIELD)
        self.assertNotIn("GetPresentation", MISSION_DEFINITION_FIELD)
        self.assertNotIn("GetMissionTitle", MISSION_DEFINITION_FIELD)
        self.assertNotIn("AcknowledgeBriefing", MISSION_DEFINITION_FIELD)
        self.assertNotIn("LaunchSortie", MISSION_DEFINITION_FIELD)
        self.assertNotIn("HullCollider", MISSION_DEFINITION_FIELD)
        self.assertNotIn("OpticalTracker", MISSION_DEFINITION_FIELD)
        self.assertNotIn("WeaponServo", MISSION_DEFINITION_FIELD)
        self.assertNotIn("CountermeasurePod", MISSION_DEFINITION_FIELD)
        self.assertNotIn("MinHeightFromOriginCm", MISSION_DEFINITION_FIELD)
        self.assertNotIn("RadarNode", MISSION_DEFINITION_FIELD)
        self.assertNotIn("ESkyguardMission02WaveState", MISSION_DEFINITION_FIELD)
        self.assertNotIn("HarborIndustrial", MISSION_DEFINITION_FIELD)
        self.assertNotIn("MaxIntegrity", MISSION_DEFINITION_FIELD)
        self.assertNotIn("CurrentIntegrity", MISSION_DEFINITION_FIELD)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, MISSION_DEFINITION_FIELD)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_uproperty_one_line = (
            "public:\n"
            f"\t{UPROPERTY_MISSION01} {MISSION_DEFINITION_FIELD}\n"
            "};\n"
        )
        ...
        for header in (
            ...
            self.assertEqual(declaration_count(section, MISSION_DEFINITION_FIELD), 1)
        one_line = f"{{\npublic:\n\t{MISSION_DEFINITION_FIELD}\n}}\n"
        self.assertTrue(has_declaration(one_line, MISSION_DEFINITION_FIELD))
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, MISSION_DEFINITION_FIELD), section)
        self.assertEqual(
            require_declaration(section, MISSION_DEFINITION_FIELD),
    ...
    def test_assigned_mission_definition_does_not_satisfy(self) -> None:
        assigned = (
            "\tTSoftObjectPtr<USkyguardMissionDefinition> "
            "MissionDefinition = nullptr;\n"
        )
        with self.assertRaises(AssertionError) as raised:
            require_declaration(assigned, MISSION_DEFINITION_FIELD)
        self.assertIn("MissionDefinition", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertFalse(has_declaration(assigned, MISSION_DEFINITION_FIELD))
    ...
    def test_sibling_public_fields_do_not_satisfy(self) -> None:
        for region in (
            ...
            self.assertIn("MissionDefinition", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, MISSION_DEFINITION_FIELD))

    def test_declaration_does_not_invent_uproperty_metadata(self) -> None:
        locked_only = f"{MISSION_DEFINITION_FIELD}\n"
        for invented in INVENTED_UPROPERTY:
            self.assertNotIn(invented, MISSION_DEFINITION_FIELD)
    ...
    def test_declaration_does_not_invent_ufunction(self) -> None:
        ...
        self.assertFalse(
            MISSION_DEFINITION_FIELD.startswith("UFUNCTION"),
            MISSION_DEFINITION_FIELD,
        )
        section = public_section(origin_main_header())
        self.assertTrue(has_declaration(section, MISSION_DEFINITION_FIELD), section)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", MISSION_DEFINITION_FIELD)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_mission_definition_cpp_body(self) -> None:
        locked_only = f"{MISSION_DEFINITION_FIELD}\n"
        self.assertNotIn("{", MISSION_DEFINITION_FIELD)
        self.assertNotIn("}", MISSION_DEFINITION_FIELD)
        self.assertNotIn("return ", MISSION_DEFINITION_FIELD)
        ...
        self.assertNotIn("return false", MISSION_DEFINITION_FIELD)
        self.assertNotIn("return true", MISSION_DEFINITION_FIELD)
        self.assertNotIn("CreateDefaultSubobject", MISSION_DEFINITION_FIELD)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{MISSION_DEFINITION_FIELD}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, MISSION_DEFINITION_FIELD)
        self.assertIn("MissionDefinition", MISSION_DEFINITION_FIELD)
        self.assertIn(
            "USkyguardMissionDefinition",
            MISSION_DEFINITION_FIELD,
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, MISSION_DEFINITION_FIELD)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", MISSION_DEFINITION_FIELD)
        self.assertNotIn("CurrentIntegrity", MISSION_DEFINITION_FIELD)
        self.assertNotIn("SkyguardApacheAircraft.h", MISSION_DEFINITION_FIELD)
    ...
    def test_contract_does_not_open_leftover_campaign_definition_header(
        ...
        self.assertNotIn(leftover_header, MISSION_DEFINITION_FIELD)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, MISSION_DEFINITION_FIELD)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", MISSION_DEFINITION_FIELD)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{MISSION_DEFINITION_FIELD}\n"
        self.assertEqual(
            require_declaration(locked_only, MISSION_DEFINITION_FIELD),
            MISSION_DEFINITION_FIELD,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, MISSION_DEFINITION_FIELD)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission01 MissionDefinition field contract contains "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{MISSION_DEFINITION_FIELD}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, MISSION_DEFINITION_FIELD.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                MISSION_DEFINITION_FIELD.lower(),
                "mission01 MissionDefinition contains "
                f"{banned}; declaration is Apache CPG 30 mm / Hydra / "
                "Hellfire, not leftover live cop" + "y",
            )
            self.assertNotIn(banned, locked_only.lower())
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, MISSION_DEFINITION_FIELD)

    def test_contract_is_mission_definition_field_declaration_only(self) -> None:
        header = origin_main_header()
        section = public_section(header)
        self.assertIsNotNone(CLASS_RE.search(header), header)
        self.assertEqual(
        ...
        self.assertTrue(MISSION_DEFINITION_FIELD.endswith(";"))
        self.assertNotIn("=", MISSION_DEFINITION_FIELD)
        self.assertIn(UPROPERTY_MISSION01, section)
    ...
    def test_sibling_director_fields_do_not_satisfy_mission_definition(
        ...
        for leftover in (
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(has_declaration(region, MISSION_DEFINITION_FIELD))
            self.assertNotEqual(MISSION_DEFINITION_FIELD, leftover)
        self.assertIn(
            "Scripts/tests/test_mission01_root_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_open_leftover_mission_definition_header(
        self,
    ) -> None:
        locked_only = f"{MISSION_DEFINITION_FIELD}\n"
        file_text = this_file_text()
        leftover_header = "SkyguardMissionDefinition.h"
        self.assertNotIn(leftover_header, locked_only)
        self.assertNotIn(leftover_header, MISSION_DEFINITION_FIELD)
        self.assertNotIn(f"origin/main:{leftover_header}", file_text)
        self.assertNotIn(
    ...
    def test_contract_does_not_relock_leftover_mission_definition_methods(
        self,
    ) -> None:
        locked_only = f"{MISSION_DEFINITION_FIELD}\n"
        for token in LEFTOVER_MISSION_DEFINITION_METHODS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, MISSION_DEFINITION_FIELD)
        self.assertIn(
        ...
        self.assertNotIn("SkyguardMissionDefinition.h", locked_only)
        self.assertNotIn("MissionId", locked_only)
        self.assertNotIn("FindObjective", locked_only)
        self.assertNotIn("ValidateDefinition", locked_only)
        self.assertNotIn("GetPrimaryAssetId", locked_only)

    def test_leftover_mission_definition_methods_do_not_satisfy(self) -> None:
        for leftover in (
            MISSION_ID_FIELD,
            FIND_OBJECTIVE,
            VALIDATE_DEFINITION,
