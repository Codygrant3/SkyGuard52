...
# INDEX_NONE or lock NotifySubstationDamage construction
# in the .cpp. This is leftover-safe Mission04
# Substation NotifySubstationDamage on
...
# (do not lock GetSearchlightRuntime), and NOT
# leftover Mission04 wave-state enum #bb22
# (do not lock enum values). Distinct from
# leftover Mission03 StartNextWave #630. Not
...
# Integration, not Searchlight, not Waves,
...
# Mission03 Waves StartNextWave #630.
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission04IntegrationDirector::NotifySubstationDamage",
    "SkyguardMission04IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission04NotifySubstationDamageDeclContractTests(unittest.TestCase):
    def test_mission04_class_exists(self) -> None:
        ...
        self.assertTrue(
            has_declaration(section, NOTIFY_SUBSTATION_DAMAGE),
            section,
        )
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, NOTIFY_SUBSTATION_DAMAGE)
        self.assertIn("NotifySubstationDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, NOTIFY_SUBSTATION_DAMAGE)
    ...
    def test_missing_notify_substation_damage_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission04IntegrationDirector();\n"
            f"\t{ROOT_FIELD}\n"
            f"\t{BRIEFING_FIELD}\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(neighbors_only, NOTIFY_SUBSTATION_DAMAGE)
        self.assertIn("NotifySubstationDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
    ...
    def test_ufunction_macro_alone_does_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(macro_only, NOTIFY_SUBSTATION_DAMAGE)
        self.assertIn("NotifySubstationDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertNotIn("UFUNCTION", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("BlueprintPure", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("Category", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("BlueprintPure", UFUNCTION_SUBSTATION)
        self.assertIn("Skyguard|Mission04|Substation", UFUNCTION_SUBSTATION)
        self.assertIn("BlueprintCallable", UFUNCTION_SUBSTATION)
        ...
        for invented in INVENTED_UFUNCTION:
            ...
            self.assertNotIn(invented, NOTIFY_SUBSTATION_DAMAGE)
    ...
    def test_neighbor_helpers_do_not_satisfy(self) -> None:
        ...
        with self.assertRaises(AssertionError) as raised:
            require_declaration(other_helpers, NOTIFY_SUBSTATION_DAMAGE)
        self.assertIn("NotifySubstationDamage", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_wrong_signature_does_not_satisfy(self) -> None:
        as_void = "\tvoid NotifySubstationDamage(int32 Damage);\n"
        as_const = "\tbool NotifySubstationDamage(int32 Damage) const;\n"
        as_int = "\tint32 NotifySubstationDamage(int32 Damage);\n"
        with_arg = "\tbool NotifySubstationDamage();\n"
        ...
        as_void_name = "\tvoid NotifySubstationDamage(int32 Damage) const;\n"
        renamed = "\tbool NotifySubstation();\n"
        short_name = "\tbool SubstationDamage();\n"
        ...
        for region in (
            ...
            with self.assertRaises(AssertionError) as raised:
                require_declaration(region, NOTIFY_SUBSTATION_DAMAGE)
            self.assertIn("NotifySubstationDamage", str(raised.exception))
            self.assertIn("missing", str(raised.exception).lower())

    def test_notify_substation_damage_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, NOTIFY_SUBSTATION_DAMAGE),
            NOTIFY_SUBSTATION_DAMAGE,
        )
        self.assertTrue(has_declaration(section, NOTIFY_SUBSTATION_DAMAGE))
        self.assertEqual(
            declaration_count(section, NOTIFY_SUBSTATION_DAMAGE),
            1,
        )
        self.assertTrue(
            NOTIFY_SUBSTATION_DAMAGE.startswith("bool "),
            NOTIFY_SUBSTATION_DAMAGE,
        )
        self.assertTrue(
            NOTIFY_SUBSTATION_DAMAGE.endswith("(int32 Damage);"),
            NOTIFY_SUBSTATION_DAMAGE,
        )
        self.assertIn("NotifySubstationDamage", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("static ", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn(
            "const USkyguardMissionDefinition* Mission",
            NOTIFY_SUBSTATION_DAMAGE,
        )
        ...
        self.assertNotIn("EnvironmentReadiness", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("MissionMapReadiness", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("TObjectPtr", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("TSoftObjectPtr", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("INDEX_NONE", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("UFUNCTION", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("{", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("}", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("return ", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn(" const;", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("Root", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("Briefing", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("AudioDirector", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("RadioChatter", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("SortiePresentation", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("CampaignDefinition", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("TSoftObjectPtr<USkyguardMissionDefinition>", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("Readiness;", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("bAutoInitialize", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("bAllowBoundedActorSpawning", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("bAutoLaunchAfterBriefing", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("PathfinderSpawnLocation", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetAircraft", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("BindRuntimeActors", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("HandleDroneCityImpact", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("ConfigureMissionDefinition", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("InitializePlayableMission", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("NotifyProtectedAssetFailed", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("SynchronizeRuntimeState", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("NotifyObjectiveProgress", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("IsCorePlayableReady", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetObjectiveRuntime", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetGunner", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetPathfinder", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetReadiness", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetMissionId", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("ValidateDefinition", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("ConfigureFromMission", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("AdvanceBriefing", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("SetAssetsReady", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("AcknowledgeAndLaunch", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("CanLaunch", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetElapsedSeconds", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetBriefingState", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetMinimumWarmupSeconds", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetBriefingText", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetRadioChatter", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetPresentation", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetMissionTitle", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("AcknowledgeBriefing", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("LaunchSortie", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("HullCollider", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("OpticalTracker", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("WeaponServo", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("CountermeasurePod", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("MinHeightFromOriginCm", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("RadarNode", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("ESkyguardMission02WaveState", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("ESkyguardMission03WaveState", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("NotifyThreatDestroyed", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetWaveState", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetCurrentWaveIndex", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetRemainingThreatsInWave", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("AdvanceConvoyByDistance", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("NotifyConvoyDamage", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("ValidateMissionContract", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("StartSearchlightWindow", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("AdvanceSearchlightTrack", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("StartNextWave", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetSearchlightRuntime", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetSubstationIntegrity", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("GetNightBeatKit", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("ESkyguardMission04WaveState", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("HarborIndustrial", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("MaxIntegrity", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("CurrentIntegrity", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("FillAndFinalize", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("FillAndFail", NOTIFY_SUBSTATION_DAMAGE)
        for name in leftover_live_copy_method_names():
            self.assertNotIn(name, NOTIFY_SUBSTATION_DAMAGE)
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        wrap_type = (
            "public:\n"
            "\tbool\n"
            "\tNotifySubstationDamage(int32 Damage);\n"
            "private:\n"
            "};\n"
        )
        wrap_spaces = (
        ...
        wrap_ufunction = (
            ...
            f"\t{NOTIFY_SUBSTATION_DAMAGE}\n"
            "};\n"
        )
        wrap_ufunction_one_line = (
            "public:\n"
            f"\t{UFUNCTION_SUBSTATION} {NOTIFY_SUBSTATION_DAMAGE}\n"
            "};\n"
        )
        ...
        one_line = f"{{\npublic:\n\t{NOTIFY_SUBSTATION_DAMAGE}\n}}\n"
        self.assertTrue(has_declaration(one_line, NOTIFY_SUBSTATION_DAMAGE))
        section = public_section(origin_main_header())
        self.assertTrue(
            has_declaration(section, NOTIFY_SUBSTATION_DAMAGE),
            section,
    ...
    def test_environment_category_does_not_satisfy_substation(self) -> None:
        ...
        self.assertNotEqual(integration, UFUNCTION_SUBSTATION)
        self.assertNotEqual(searchlight, UFUNCTION_SUBSTATION)
        self.assertNotEqual(leftover_waves, UFUNCTION_SUBSTATION)
        self.assertNotEqual(leftover_mission03, UFUNCTION_SUBSTATION)
        self.assertNotIn(environment, UFUNCTION_SUBSTATION)
        self.assertNotIn(briefing, UFUNCTION_SUBSTATION)
        self.assertNotIn(integration, UFUNCTION_SUBSTATION)
        self.assertNotIn(searchlight, UFUNCTION_SUBSTATION)
        self.assertNotIn(leftover_waves, UFUNCTION_SUBSTATION)
        self.assertNotIn(leftover_mission03, UFUNCTION_SUBSTATION)

    def test_declaration_does_not_invent_ufunction_metadata(self) -> None:
        locked_only = f"{NOTIFY_SUBSTATION_DAMAGE}\n"
        for invented in INVENTED_UFUNCTION:
            self.assertNotIn(invented, NOTIFY_SUBSTATION_DAMAGE)
    ...
    def test_declaration_does_not_invent_index_none(self) -> None:
        ...
        self.assertNotIn("NAME_None", NOTIFY_SUBSTATION_DAMAGE)
        section = public_section(origin_main_header())
        self.assertNotIn("INDEX_NONE", section)
        self.assertNotIn("return INDEX_NONE", section)
        self.assertNotIn("NAME_None", section)

    def test_contract_does_not_lock_notify_substation_damage_cpp_body(self) -> None:
        locked_only = f"{NOTIFY_SUBSTATION_DAMAGE}\n"
        self.assertNotIn("{", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("}", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("return ", NOTIFY_SUBSTATION_DAMAGE)
        ...
        self.assertNotIn("return false", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("return true", NOTIFY_SUBSTATION_DAMAGE)

    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        locked_only = f"{NOTIFY_SUBSTATION_DAMAGE}\n"
        for token in SIBLING_DIRECTOR_FIELDS_NOT_LOCKED:
            self.assertNotIn(token, locked_only)
            self.assertNotIn(token, NOTIFY_SUBSTATION_DAMAGE)
        self.assertIn("NotifySubstationDamage", NOTIFY_SUBSTATION_DAMAGE)
        self.assertTrue(NOTIFY_SUBSTATION_DAMAGE.startswith("bool "))
    ...
    def test_contract_does_not_relock_leftover_get_aircraft(self) -> None:
        ...
        self.assertNotIn(GET_AIRCRAFT, NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn(BIND_RUNTIME_ACTORS, locked_only)
        self.assertNotIn(BIND_RUNTIME_ACTORS, NOTIFY_SUBSTATION_DAMAGE)
        self.assertIn(
            "Scripts/tests/test_mission01_get_aircraft_decl_contract.py",
            LOCKED_SCRIPTS,
        )
    ...
    def test_contract_does_not_scan_wrong_harbor_headers(self) -> None:
        ...
        self.assertNotIn("MaxIntegrity", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("CurrentIntegrity", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("SkyguardApacheAircraft.h", NOTIFY_SUBSTATION_DAMAGE)
    ...
    def test_contract_does_not_scan_apache_public_section_for_harbor(
        ...
        self.assertNotIn(apache_header, NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("ASkyguardApacheAircraft", locked_only)
        self.assertNotIn("ASkyguardApacheAircraft", NOTIFY_SUBSTATION_DAMAGE)
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        locked_only = f"{NOTIFY_SUBSTATION_DAMAGE}\n"
        self.assertEqual(
            require_declaration(locked_only, NOTIFY_SUBSTATION_DAMAGE),
            NOTIFY_SUBSTATION_DAMAGE,
        )
        for neighbor in unlocked_neighbors():
            self.assertNotIn(neighbor, locked_only)
            self.assertNotIn(neighbor, NOTIFY_SUBSTATION_DAMAGE)
        ...
        self.assertNotIn("AdvanceSearchlightTrack", locked_only)
        self.assertNotIn("StartNextWave", locked_only)
        self.assertIn("NotifySubstationDamage", locked_only)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission04 NotifySubstationDamage method contract "
    ...
    def test_contract_does_not_require_retired_live_mount(self) -> None:
        locked_only = f"{NOTIFY_SUBSTATION_DAMAGE}\n"
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(banned, NOTIFY_SUBSTATION_DAMAGE.lower())
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                NOTIFY_SUBSTATION_DAMAGE.lower(),
                "mission04 NotifySubstationDamage contains "
    ...
    def test_contract_does_not_read_dirty_workspace_header(self) -> None:
        ...
        self.assertNotIn(dirty_fwd, NOTIFY_SUBSTATION_DAMAGE)

    def test_contract_is_notify_substation_damage_declaration_only(
        self,
    ) -> None:
        header = origin_main_header()
        section = public_section(header)
        ...
        self.assertNotIn("TArray<FText>& OutErrors", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("static ", NOTIFY_SUBSTATION_DAMAGE)
        self.assertTrue(
            NOTIFY_SUBSTATION_DAMAGE.endswith(");"),
            NOTIFY_SUBSTATION_DAMAGE,
        )
        self.assertTrue(NOTIFY_SUBSTATION_DAMAGE.endswith(";"))
        self.assertNotIn("EnvironmentReadiness", NOTIFY_SUBSTATION_DAMAGE)
        self.assertNotIn("MissionMapReadiness", NOTIFY_SUBSTATION_DAMAGE)
        self.assertIn(UFUNCTION_SUBSTATION, section)

    def test_sibling_director_fields_do_not_satisfy_notify_substation_damage(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
            ...
            self.assertIn("missing", str(raised.exception).lower())
            self.assertFalse(
                has_declaration(region, NOTIFY_SUBSTATION_DAMAGE)
            )
            self.assertNotEqual(NOTIFY_SUBSTATION_DAMAGE, leftover)
        self.assertIn(
    ...
    def test_leftover_mission_definition_validate_does_not_satisfy(self) -> None:
        ...
        self.assertNotIn(MISSION_DEFINITION_VALIDATE, NOTIFY_SUBSTATION_DAMAGE)
        self.assertIn(
            "Scripts/tests/test_mission_definition_validate_definition"
            "_decl_contract.py",
            LOCKED_SCRIPTS,
