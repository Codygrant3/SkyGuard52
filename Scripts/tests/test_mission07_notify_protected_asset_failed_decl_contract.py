...
# Mission07 Objectives NotifyProtectedAssetFailed
# METHOD on ASkyguardMission07IntegrationDirector. It is
...
# NotifyProtectedAssetFailed, NOT leftover Mission07
# StartNextWave, NOT leftover
...
# Waves / Search / Protection methods
...
# Category is Skyguard|Mission07|Objectives, not
# Mission01 / Mission02 / Mission03 / Mission04 /
# Mission05 / Mission06 / Integration / Search /
...
# Mission06 Objectives #694, not leftover
# Mission05 Objectives, not leftover Harbor Mission02.
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission07IntegrationDirector::NotifyProtectedAssetFailed",
    "SkyguardMission06IntegrationDirector.cpp",
)
SIBLING_TYPES = (
...
class Mission07NotifyProtectedAssetFailedDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission07|Objectives", UFUNCTION_OBJECTIVES)
    ...
    def test_environment_category_does_not_satisfy_objectives(self) -> None:
        ...
        leftover_m05_objectives = (
            'UFUNCTION(BlueprintCallable, '
            'Category="Skyguard|Mission05|Objectives")'
        )
        leftover_m06_objectives = leftover_objectives
        ...
        self.assertNotEqual(leftover_m05_objectives, UFUNCTION_OBJECTIVES)
        self.assertNotEqual(leftover_m06_objectives, UFUNCTION_OBJECTIVES)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission07 NotifyProtectedAssetFailed method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission07 NotifyProtectedAssetFailed contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission07_notify_protected_asset_failed"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_leftover_mission06_notify_protected_asset_failed_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission06IntegrationDirector "
    ...
    def test_leftover_mission05_notify_protected_asset_failed_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission05IntegrationDirector "
    ...
    def test_leftover_mission01_notify_protected_asset_failed_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission01IntegrationDirector "
    ...
    def test_leftover_mission03_notify_protected_asset_failed_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission03IntegrationDirector "
    ...
    def test_leftover_mission04_notify_protected_asset_failed_does_not_satisfy(
        self,
    ) -> None:
        leftover = (
            "class SKYGUARD52_API ASkyguardMission04IntegrationDirector "
