# THIS IS leftover-safe FSkyguardMissionObjectiveAnchor ObjectiveId.
...
# Do NOT contract sibling field WorldLocation.
...
# retarget: type is FName ObjectiveId, no `=`, specifiers
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # WorldLocation. Do not accept leftover
    # FSkyguardObjectiveDefinition / FSkyguardObjectiveProgress
    # ObjectiveId decls outside this struct window.
...
class MissionObjectiveAnchorObjectiveIdFieldDeclContractTests(unittest.TestCase):
    ...
    def test_does_not_contract_sibling_world_location(self) -> None:
        for sibling in sibling_uncontracted_decls():
            self.assertNotIn(sibling, LOCKED_DECL)
        for field in leftover_neighbor_hit_fields():
            self.assertNotIn(field, LOCKED_DECL)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission-objective-anchor ObjectiveId field decl "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(Path(__file__).name.endswith(
            "mission_objective_anchor_objective_id_field_decl_contract.py"
        ))
        self.assertNotIn("SkyguardMissionMapAssemblyDirector.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardMissionTypes.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardMissionDefinition.cpp", THIS_SCRIPT)
