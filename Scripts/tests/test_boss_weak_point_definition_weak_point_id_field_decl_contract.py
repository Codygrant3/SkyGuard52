...
# if Category= is added, if the type is not FName,
# if an initializer is added, or if Harbor tokens
# built as 40 + ".f" / 80 + ".f" appear in the parse window.
# Accept one-line and split-line UPROPERTY wraps.
# Parse STRUCT `FSkyguardBossWeakPointDefinition` body ONLY after
# `struct FSkyguardBossWeakPointDefinition`. Stop at
# `struct FSkyguardBossDefinition`.
# Do NOT parse leftover `USkyguardBossWeakPointComponent`
# (leftover WeakPointId #566 / bDestroyed #569 / bExposed
# #570 / Integrity #571 / MaxIntegrity #573).
# Do NOT parse leftover `FSkyguardObjectiveDefinition`.
# Do NOT parse leftover `FSkyguardObjectiveProgress`.
# Do NOT parse leftover `FSkyguardMissionScoreRules`.
# Do NOT parse leftover `FSkyguardWeatherProfile`.
# Do NOT parse leftover `FSkyguardRouteDefinition`.
# Do NOT parse leftover `USkyguardMissionDefinition`
# (leftover Boss field #358).
# Do NOT parse leftover boss-weak-point-defaults
# #188 / #2242.
# Do NOT parse leftover mission-types-defaults-tests
# #153 / #f47d (keep that bulk file in LOCKED_SCRIPTS).
# Do NOT parse leftover TheaterKit #1299-#1331.
# Do NOT contract sibling fields RequiredWeapon /
# ExposesWeakPointId / Integrity.
# Those sibling decls remain unclaimed.
# THIS IS NOT leftover boss-weak-point-defaults
# #188 / #2242.
# THIS IS NOT leftover USkyguardBossWeakPointComponent
# WeakPointId #566.
# THIS IS NOT leftover objective-definition-defaults
# #181 / #b29f.
# THIS IS NOT leftover objective-progress-defaults
# #182 / leftover ObjectiveProgress fields #1261-#1263.
# THIS IS NOT leftover mission-score-rules-defaults
# #185 / #deae.
# THIS IS NOT leftover weather-profile-defaults #184.
# THIS IS NOT leftover enemy-formation-defaults #183 / #2f1a.
# THIS IS NOT leftover enemy-wave-defaults #189 / #dc07.
# THIS IS NOT leftover route-point-defaults #180 / #0ac5.
# THIS IS NOT leftover route-definition-fields #192 / #dbff.
# THIS IS NOT leftover mission-types-defaults-tests
# #153 / #f47d.
# THIS IS NOT leftover mission-definition Boss #358.
# THIS IS NOT leftover RadioLine isolated fields
# #1332-#1337 or leftover #1332-#1359.
...
# the bulk).
# Analog: leftover boss-weak-point-defaults #188 / #2242
# then this isolated WeakPointId field decl, same as leftover
# objective-definition-defaults then isolated ObjectiveId,
...
# field decl, then isolated per-field decl here.
# If a clone asserts VisibleAnywhere /
# Category="Skyguard|Theater" / BlueprintReadWrite /
# `FName WeatherIdentity` / `FName ProfileId` /
# `FName LineId` / `FName PointId` / `FName ObjectiveId`,
# retarget: type is FName WeakPointId, no `=`, specifiers
# are EditAnywhere + BlueprintReadOnly, no Category.
...
STRUCT_NAME = "FSkyguardBossWeakPointDefinition"
OBJECTIVE_DEFINITION_NAME = "FSkyguardObjectiveDefinition"
BOSS_DEFINITION_NAME = "FSkyguardBossDefinition"
...
TARGET = "FName WeakPointId;"
TARGET_WRONG_EQ_NONE = "FName WeakPointId = NAME_None;"
TARGET_WRONG_FALSE = "FName WeakPointId = false;"
TARGET_WRONG_TRUE = "FName WeakPointId = true;"
TARGET_WRONG_ZERO = "FName WeakPointId = 0.f;"
TARGET_WRONG_FLOAT = "float WeakPointId;"
...
STOP_BEFORE_BOSS_DEFINITION = "struct FSkyguardBossDefinition"
STOP_BEFORE_OBJECTIVE_DEFINITION = "struct FSkyguardObjectiveDefinition"
...
SIBLING_REQUIRED_WEAPON = "RequiredWeapon"
SIBLING_EXPOSES_WEAK_POINT_ID = "ExposesWeakPointId"
SIBLING_INTEGRITY = "Integrity"
SIBLING_DISPLAY_NAME = "DisplayName"
SIBLING_TYPE = "Type"
SIBLING_REQUIRED_PROGRESS = "RequiredProgress"
SIBLING_REQUIRED_FOR_SUCCESS = "bRequiredForMissionSuccess"
SIBLING_FAILURE_ENDS_MISSION = "bFailureEndsMission"
SIBLING_SCORE_REWARD = "ScoreReward"
...
LEFTOVER_OBJECTIVE_DEFINITION_OBJECTIVE_ID = (
...
LEFTOVER_BOSS_WEAK_POINT_DEFAULTS_PY = (
    "Scripts/tests/test_boss_weak_point_defaults.py"
)
LEFTOVER_BOSS_WEAK_POINT_DEFAULTS_TESTS = (
    "Scripts/tests/test_boss_weak_point_defaults_tests.py"
)
LEFTOVER_COMPONENT_WEAK_POINT_ID = (
    "Scripts/tests/test_weak_point_id_field_decl_contract.py"
)
LEFTOVER_COMPONENT_DESTROYED = (
    "Scripts/tests/test_weak_point_destroyed_field_decl_contract.py"
)
LEFTOVER_COMPONENT_EXPOSED = (
    "Scripts/tests/test_weak_point_exposed_field_decl_contract.py"
)
LEFTOVER_COMPONENT_INTEGRITY = (
    "Scripts/tests/test_weak_point_integrity_field_decl_contract.py"
)
LEFTOVER_COMPONENT_MAX_INTEGRITY = (
    "Scripts/tests/test_weak_point_max_integrity"
    "_field_decl_contract.py"
)
...
LEFTOVER_OBJECTIVE_DEFINITION_DISPLAY_NAME = (
    "Scripts/tests/test_objective_definition_display_name"
    "_field_decl_contract.py"
)
LEFTOVER_OBJECTIVE_DEFINITION_TYPE = (
    "Scripts/tests/test_objective_definition_type"
    "_field_decl_contract.py"
)
LEFTOVER_OBJECTIVE_DEFINITION_REQUIRED_PROGRESS = (
    "Scripts/tests/test_objective_definition_required_progress"
    "_field_decl_contract.py"
)
LEFTOVER_OBJECTIVE_DEFINITION_REQUIRED_FOR_SUCCESS = (
    "Scripts/tests/test_objective_definition_required_for_mission_success"
    "_field_decl_contract.py"
)
LEFTOVER_OBJECTIVE_DEFINITION_FAILURE_ENDS_MISSION = (
    "Scripts/tests/test_objective_definition_failure_ends_mission"
    "_field_decl_contract.py"
)
LEFTOVER_OBJECTIVE_DEFINITION_SCORE_REWARD = (
    "Scripts/tests/test_objective_definition_score_reward"
    "_field_decl_contract.py"
)
REMAINING_REQUIRED_WEAPON_SCRIPT = (
    "Scripts/tests/test_boss_weak_point_definition_required_weapon"
    "_field_decl_contract.py"
)
REMAINING_EXPOSES_WEAK_POINT_ID_SCRIPT = (
    "Scripts/tests/test_boss_weak_point_definition_exposes_weak_point_id"
    "_field_decl_contract.py"
)
REMAINING_INTEGRITY_SCRIPT = (
...
def leftover_weather_profile_scripts() -> tuple[str, ...]:
    return (
        LEFTOVER_WEATHER_PROFILE_DEFAULTS,
        LEFTOVER_WEATHER_PROFILE_DEFAULTS_PY,
        LEFTOVER_WEATHER_PROFILE_DEFAULTS_TESTS,
...
def leftover_objective_definition_defaults_scripts() -> tuple[str, ...]:
    return (
        LEFTOVER_OBJECTIVE_DEFINITION_DEFAULTS,
        LEFTOVER_OBJECTIVE_DEFINITION_DEFAULTS_PY,
        LEFTOVER_OBJECTIVE_DEFINITION_DEFAULTS_TESTS,
...
def leftover_boss_weak_point_defaults_scripts() -> tuple[str, ...]:
    return (
        LEFTOVER_BOSS_WEAK_POINT_DEFAULTS,
        LEFTOVER_BOSS_WEAK_POINT_DEFAULTS_PY,
        LEFTOVER_BOSS_WEAK_POINT_DEFAULTS_TESTS,
...
def sibling_uncontracted_decls() -> tuple[str, ...]:
    return (
        SIBLING_REQUIRED_WEAPON,
        SIBLING_EXPOSES_WEAK_POINT_ID,
        SIBLING_INTEGRITY,
    )
...
def has_declaration(region: str, declaration: str) -> bool:
    # Fail-closed on the authored bare `FName WeakPointId;`.
    # Do not accept `= NAME_None` / `= false` / `= true` /
    # `= 0.f` / `= 160.f` / leftover float Health when
    # origin/main has a bare FName. Do not accept sibling
    # RequiredWeapon / ExposesWeakPointId / Integrity
    # fields. Do not accept leftover component WeakPointId
    # with `= NAME_None`.
    if not has_one_declaration(region, declaration):
        return False
    compact = collapsed(region)
    if re.search(
        r"FName\s+WeakPointId\s*=",
        compact,
    ):
        return False
    if re.search(
        r"float\s+WeakPointId\b",
        compact,
    ):
        return False
    if re.search(
...
def leaked_neighbor_tokens() -> tuple[str, ...]:
    return (
        STOP_BEFORE_BOSS_DEFINITION,
        STOP_BEFORE_OBJECTIVE_DEFINITION,
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    while True:
        ...
        if depth == 0 and re.match(
            r"\s*FName\s+WeakPointId\b", compact[index:]
        ):
            return compact[start : index - 1]
        cursor = cursor + match.start() + 1
    raise AssertionError(
        "UPROPERTY for FName WeakPointId is missing from "
...
def require_weak_point_id_specifiers(section: str) -> str:
    ...
    if "EditAnywhere" not in specifiers:
        raise AssertionError(
            ...
            f"{HEADER_PATH} struct {STRUCT_NAME} WeakPointId UPROPERTY"
        )
    if "BlueprintReadWrite" in specifiers:
        raise AssertionError(
            "BlueprintReadWrite instead of BlueprintReadOnly on "
            f"origin/main:{HEADER_PATH} struct {STRUCT_NAME} WeakPointId"
        )
...
class BossWeakPointDefinitionWeakPointIdFieldDeclContractTests(unittest.TestCase):
    def test_boss_weak_point_definition_struct_exists(self) -> None:
        ...
        self.assertNotEqual(STRUCT_NAME, BOSS_DEFINITION_NAME)
        ...
        self.assertTrue(has_identifier(section, "WeakPointId"), section)
        self.assertIn("UPROPERTY", section)
        self.assertIn(STOP_BEFORE_BOSS_DEFINITION, header)
        self.assertNotIn(STOP_BEFORE_BOSS_DEFINITION, section)
        self.assertNotIn(STOP_BEFORE_BOSS_DEFINITION, body)
        self.assertIn(STOP_BEFORE_OBJECTIVE_DEFINITION, header)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_DEFINITION, section)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_DEFINITION, body)
    ...
    def test_missing_struct_fails_closed(self) -> None:
        with self.assertRaises(AssertionError) as raised:
            struct_body(
                "struct FSkyguardUnrelatedBossWeakPointDefinition\n{\n};\n"
            )
    ...
    def test_later_struct_declaration_does_not_satisfy(self) -> None:
        mixed = (
            ...
            "\tGENERATED_BODY()\n"
            "};\n"
            f"{STOP_BEFORE_BOSS_DEFINITION}\n"
            "{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
            f"{STOP_BEFORE_OBJECTIVE_DEFINITION}\n"
            "{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
            f"{STOP_BEFORE_OBJECTIVE_PROGRESS}\n"
            "{\n"
            f"\t{UPROPERTY_EDIT_READONLY}\n"
            f"\t{LOCKED_DECL}\n"
            "};\n"
        ...
        self.assertFalse(has_identifier(section, "WeakPointId"), section)
        self.assertNotIn(STOP_BEFORE_BOSS_DEFINITION, section)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_DEFINITION, section)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_PROGRESS, section)
        self.assertNotIn(STOP_BEFORE_MISSION_DEFINITION, section)
        self.assertNotIn(ENEMY_FORMATION_NAME, section)
        self.assertNotIn(SCORE_RULES_NAME, section)
        with self.assertRaises(AssertionError) as raised:
            require_declaration(section, LOCKED_DECL)
        self.assertIn("WeakPointId", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())

    def test_missing_weak_point_id_declaration_fails_closed(self) -> None:
        empty = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
            f"\tFName {SIBLING_REQUIRED_WEAPON};\n"
            "};\n"
        )
    ...
    def test_origin_main_uproperty_metadata_is_present(self) -> None:
        ...
        specifiers = require_weak_point_id_specifiers(section)
    ...
    def test_initializer_fails_closed_when_origin_is_bare(self) -> None:
        ...
        self.assertIn("FName WeakPointId;", compact_origin)
        self.assertNotIn("WeakPointId = NAME_None", compact_origin)
        self.assertNotIn("WeakPointId = false", compact_origin)
        self.assertNotIn("WeakPointId = true", compact_origin)
        self.assertNotIn("WeakPointId = 0.f", compact_origin)
        self.assertNotIn("WeakPointId = 160.f", compact_origin)

    def test_weak_point_id_declaration_matches_origin_main(self) -> None:
        section = spec_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("FName WeakPointId"),
            LOCKED_DECL,
        )
    ...
    def test_wrong_default_and_renames_do_not_satisfy(self) -> None:
        ...
        wrongs = (
            ...
            leftover_guided,
            f"\tFName {SIBLING_REQUIRED_WEAPON};\n",
            f"\tFName {SIBLING_EXPOSES_WEAK_POINT_ID};\n",
            f"\tfloat {SIBLING_INTEGRITY} = 100.f;\n",
            "\tFName WeakPointIds;\n",
            "\tint32 WeakPointId;\n",
            "\tbool WeakPointId;\n",
            "\tfloat WeakPointId = " + forty + ";\n",
            "\tfloat WeakPointId = " + eighty + ";\n",
        )
    ...
    def test_dropped_edit_anywhere_or_read_write_fails_closed(self) -> None:
        origin = require_weak_point_id_specifiers(
        ...
        with self.assertRaises(AssertionError) as raised:
            require_weak_point_id_specifiers(spec_section(no_edit))
        ...
        with self.assertRaises(AssertionError) as raised:
            require_weak_point_id_specifiers(spec_section(read_write))
        ...
        with self.assertRaises(AssertionError) as raised:
            require_weak_point_id_specifiers(spec_section(visible))
        self.assertIn("EditAnywhere", str(raised.exception))
        with_category = (
            f"struct {STRUCT_NAME}\n"
            "{\n"
        ...
        with self.assertRaises(AssertionError) as raised:
            require_weak_point_id_specifiers(spec_section(with_category))
    ...
    def test_does_not_contract_sibling_boss_weak_point_fields(self) -> None:
        for sibling in sibling_uncontracted_decls():
            self.assertNotIn(sibling, LOCKED_DECL)
        for field in leftover_neighbor_hit_fields():
            self.assertNotIn(field, LOCKED_DECL)
    ...
    def test_does_not_parse_later_structs_or_neighbors(self) -> None:
        header = origin_main_header()
        section = spec_section(header)
        leaked = struct_body(header)
        self.assertIn(STOP_BEFORE_BOSS_DEFINITION, header)
        self.assertNotIn(STOP_BEFORE_BOSS_DEFINITION, section)
        self.assertNotIn(STOP_BEFORE_BOSS_DEFINITION, leaked)
        self.assertIn(STOP_BEFORE_OBJECTIVE_DEFINITION, header)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_DEFINITION, section)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_DEFINITION, leaked)
        self.assertIn(STOP_BEFORE_PRESENTATION, header)
        self.assertNotIn(STOP_BEFORE_PRESENTATION, section)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "boss-weak-point-definition WeakPointId field decl contract "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(Path(__file__).name.endswith(
            "boss_weak_point_definition_weak_point_id_field_decl_contract.py"
        ))
        self.assertNotIn("SkyguardMissionTypes.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardMissionDefinition.cpp", THIS_SCRIPT)
        self.assertNotIn("SkyguardMissionTypes.cpp", THIS_SCRIPT)
        ...
        self.assertIn(LEFTOVER_OBJECTIVE_DEFINITION_OBJECTIVE_ID, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_BOSS_WEAK_POINT_DEFAULTS, LOCKED_SCRIPTS)
        self.assertIn(LEFTOVER_COMPONENT_WEAK_POINT_ID, LOCKED_SCRIPTS)
    ...
    def test_leftover_mission_result_defaults_stay_locked(self) -> None:
        leftovers = (
            ...
            *leftover_radio_defaults_scripts(),
            ...
            LEFTOVER_WEATHER_PROFILE_DEFAULTS_PY,
            LEFTOVER_WEATHER_PROFILE_DEFAULTS_TESTS,
            *leftover_weather_profile_scripts(),
            *leftover_objective_definition_defaults_scripts(),
            *leftover_boss_weak_point_defaults_scripts(),
            LEFTOVER_MISSION_SCORE_RULES_DEFAULTS,
            LEFTOVER_ENEMY_FORMATION_DEFAULTS,
            LEFTOVER_ENEMY_WAVE_DEFAULTS,
        )
    ...
    def test_sibling_boss_weak_point_fields_stay_unclaimed(self) -> None:
        remaining = (
            REMAINING_REQUIRED_WEAPON_SCRIPT,
            REMAINING_EXPOSES_WEAK_POINT_ID_SCRIPT,
            REMAINING_INTEGRITY_SCRIPT,
    ...
    def test_contract_is_target_field_declaration_only(self) -> None:
        ...
        self.assertNotIn(STOP_BEFORE_BOSS_DEFINITION, locked_only)
        self.assertNotIn(STOP_BEFORE_OBJECTIVE_DEFINITION, locked_only)
        ...
        self.assertNotIn(SIBLING_REQUIRED_WEAPON, locked_only)
        self.assertNotIn(SIBLING_EXPOSES_WEAK_POINT_ID, locked_only)
        self.assertNotIn(SIBLING_INTEGRITY, locked_only)
        self.assertNotIn(SIBLING_DISPLAY_NAME, locked_only)
        self.assertNotIn(SIBLING_TYPE, locked_only)
        self.assertNotIn(SIBLING_REQUIRED_PROGRESS, locked_only)
        self.assertNotIn(SIBLING_REQUIRED_FOR_SUCCESS, locked_only)
        self.assertNotIn(SIBLING_FAILURE_ENDS_MISSION, locked_only)
        self.assertNotIn(SIBLING_SCORE_REWARD, locked_only)
