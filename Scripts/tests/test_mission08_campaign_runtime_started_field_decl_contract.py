...
# Mission08 IntegrationReadiness bCampaignRuntimeStarted
...
# NOT leftover Mission07 bCampaignRuntimeStarted
...
class Mission08CampaignRuntimeStartedFieldDeclContractTests(unittest.TestCase):
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission08 bCampaignRuntimeStarted field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission08 bCampaignRuntimeStarted contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission08_campaign_runtime"
                "_started_field_decl_contract.py"
            )
        )
    ...
    def test_leftover_same_name_gunner_ready_contracts_stay_locked(
        ...
        self.assertNotIn(
            "Scripts/tests/test_mission08_campaign_runtime_started"
            "_field_decl_contract.py",
            LOCKED_SCRIPTS,
        )
        self.assertIn(
    ...
    def test_leftover_same_name_campaign_runtime_started_contracts_stay_locked(
        ...
        self.assertIn("bAudioReady", section)
        self.assertIn("bBriefingReady", section)
