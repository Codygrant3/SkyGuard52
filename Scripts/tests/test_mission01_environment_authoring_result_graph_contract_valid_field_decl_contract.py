...
# bGraphContractValid. THIS IS NOT leftover Graph #1234.
# THIS IS NOT leftover bSuccess #1235. THIS IS NOT leftover
# mission01-environment-authoring-result-defaults #df1a.
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bGraphContractValid. THIS IS NOT leftover AuthoringResult
# Landscape #1233 / Graph #1234 / bSuccess #1235 / VisibleAudit #1236 /
# GraphNodeCount #1237 / LandscapeComponentCount #1238.
# THIS IS NOT leftover landscape-guid-valid sibling.
...
# leftover AuthoringResult Landscape #1233 / Graph #1234 / bSuccess #1235 /
# VisibleAudit #1236 / GraphNodeCount #1237 / LandscapeComponentCount #1238,
# leftover MaterialCompilation through Error #1232.
# Declaration-only. Accept origin/main split-line UPROPERTY and
# bool bGraphContractValid = false. Fail closed if type/decl
...
# Harbor 40/80 fail-closed. Ban retired live-copy tokens via split tokens
# (b + Ya + kRuntimeReady). Stay Apache CPG 30 mm / Hydra / Hellfire.

# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bGraphContractValid. THIS IS NOT leftover
# mission01-environment-authoring-result-defaults #df1a.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bGraphContractValid. THIS IS NOT leftover MaterialCompilation bSuccess #1223.
...
# mission01-environment-authoring-result-defaults #df1a.
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bGraphContractValid FIELD (declaration-only;
# VisibleAnywhere / BlueprintReadOnly
# bool bGraphContractValid = false; one-line /
...
# Do NOT parse FSkyguardLandscapeCaptureConfigurationResult (leftover bSuccess #1214).
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bGraphContractValid. THIS IS NOT leftover VisibleAudit bSuccess #1199.
# THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
# THIS IS NOT leftover landscape-capture-config-defaults #d6fd.
# THIS IS NOT leftover landscape-visible-audit-defaults #0bce.
# THIS IS NOT leftover landscape-material-compilation-defaults #01d4.
...
# THIS IS leftover-safe FSkyguardMission01EnvironmentAuthoringResult
# bGraphContractValid FIELD (declaration-only; VisibleAnywhere /
# BlueprintReadOnly bool bGraphContractValid = false; one-line /
# split-line UPROPERTY wraps; origin/main has NO Category).
...
# BlueprintReadOnly bool bGraphContractValid = false;
...
TARGET = "bool bGraphContractValid = false;"
TARGET_WRONG = "bool bGraphContractValid = true;"
LOCKED_DECL = TARGET
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # bGraphContractValid (must be = false, not = true).
    # THIS IS NOT leftover VisibleAudit bSuccess #1199.
    # THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    match = re.search(
        r"UPROPERTY\(([^)]*)\)\s*bool\s+bGraphContractValid\b",
        compact,
    )
    if match is None:
        raise AssertionError(
            "UPROPERTY for bool bGraphContractValid is missing from "
...
class Mission01EnvironmentAuthoringResultGraphContractValidFieldDeclContractTests(unittest.TestCase):
    def test_mission01_environment_authoring_result_struct_exists(self) -> None:
        ...
        self.assertIn("bGraphContractValid", section)
        ...
        self.assertNotIn("bValid", section.replace("bGraphContractValid", ""))
        ...
        self.assertNotIn("bLandscapeGuidValid", LOCKED_DECL)
        self.assertNotIn("bSuccess", LOCKED_DECL.replace("bGraphContractValid", ""))
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bGraphContractValid", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_graph_contract_valid_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_graph_contract_valid_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bGraphContractValid"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bGraphContractValid", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bGraphContractValid", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bGraphContractValid"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bGraphContractValid", locked_only)
