...
# Mission10 Objectives NotifyProtectedAssetFailed
# on ASkyguardMission10IntegrationDirector. It is
# NOT leftover Mission09 NotifyProtectedAssetFailed
# #756 / branch cursor/mission09-notify-
# protected-asset-failed-decl-contract-c332, NOT leftover
# Mission08 NotifyProtectedAssetFailed
# #737 / branch cursor/mission08-notify-
# protected-asset-failed-decl-contract-c332, NOT leftover
# Mission07 NotifyProtectedAssetFailed #712,
# NOT leftover Mission06 NotifyProtectedAssetFailed
# #694, NOT leftover Mission05 NotifyProtectedAssetFailed
# #682, NOT leftover closed Mission04 #655 /
# Mission03 #634 / Mission01 #612
# NotifyProtectedAssetFailed, NOT leftover
...
# StartPhaseWave / StartPayloadWindow /
...
# leftover Mission05 NotifyProtectedAssetFailed #682,
# leftover Mission08 NotifyProtectedAssetFailed #737,
# leftover Mission09 NotifyProtectedAssetFailed #756,
# leftover Mission07 NotifyProtectedAssetFailed #712,
# leftover Mission06 NotifyProtectedAssetFailed #694,
...
# Category is Skyguard|Mission10|Objectives, not
...
# not leftover Mission10 Integration / Safety /
# Protection / Waves / Evacuation / Campaign.
...
# drafts #674–#771+, leftover Apache
...
# NotifyProtectedAssetFailed #737. Do not reopen
# leftover Mission09 NotifyProtectedAssetFailed
# #756. Do not reopen leftover Mission10 route-
...
# leftover Mission08 StartNextWave #731 /
# Mission07 #708 / Mission06 #687 / closed #668.
# Do not reopen open drafts #674–#771+.
...
# an isolated Python NotifyProtectedAssetFailed
...
CPP_AND_INVENTED = (
    ...
    "return false",
    "return true",
    "ASkyguardMission10IntegrationDirector::NotifyProtectedAssetFailed",
    "SkyguardMission10IntegrationDirector.cpp",
    "SkyguardMission09IntegrationDirector.cpp",
    "SkyguardMission08IntegrationDirector.cpp",
    "SkyguardMission06IntegrationDirector.cpp",
...
class Mission10NotifyProtectedAssetFailedDeclContractTests(unittest.TestCase):
    ...
    def test_origin_main_ufunction_metadata_is_present(self) -> None:
        ...
        self.assertIn("Skyguard|Mission10|Objectives", UFUNCTION_OBJECTIVES)
        ...
        self.assertNotIn("Mission02", UFUNCTION_OBJECTIVES)
    ...
    def test_wrong_signature_does_not_satisfy(self) -> None:
        ...
        renamed = "\tbool NotifyProtectedAsset();\n"
        short_name = "\tbool ProtectedAssetFailed();\n"
        leftover_configure = f"\t{CONFIGURE_MISSION_DEFINITION}\n"
        leftover_notify = f"\t{NOTIFY_OBJECTIVE_PROGRESS}\n"
        leftover_failed = f"\t{NOTIFY_THREAT_DESTROYED}\n"
        ...
        leftover_threat = f"\t{INITIALIZE_PLAYABLE_MISSION}\n"
    ...
    def test_notify_protected_asset_failed_declaration_matches_origin_main(self) -> None:
        ...
        self.assertNotIn("int32", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("Amount", NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_environment_category_does_not_satisfy_waves(self) -> None:
        ...
        self.assertNotEqual(leftover_m10_integration, UFUNCTION_OBJECTIVES)
    ...
    def test_contract_does_not_lock_initialize_cpp_body(self) -> None:
        locked_only = f"{NOTIFY_PROTECTED_ASSET_FAILED}\n"
        self.assertNotIn("{", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("}", NOTIFY_PROTECTED_ASSET_FAILED)
        self.assertNotIn("return ", NOTIFY_PROTECTED_ASSET_FAILED)
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission10 InitializePlayableMission method contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                ...
                "mission10 InitializePlayableMission contains "
    ...
    def test_sibling_director_fields_do_not_satisfy_initialize(
        self,
    ) -> None:
        for leftover in (
            ROOT_FIELD,
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission10_notify_protected_asset_failed"
                "_decl_contract.py"
            )
        )
        self.assertIn(
    ...
    def test_sibling_mission10_initialize_does_not_satisfy(self) -> None:
