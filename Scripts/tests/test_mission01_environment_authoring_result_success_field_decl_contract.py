...
# bSuccess. THIS IS NOT leftover MaterialCompilation bSuccess #1223.
...
TARGET = "bool bSuccess = false;"
TARGET_WRONG = "bool bSuccess = true;"
LOCKED_DECL = TARGET
...
def has_declaration(region: str, declaration: str) -> bool:
    ...
    # bSuccess (must be = false, not = true).
    # THIS IS NOT leftover VisibleAudit bSuccess #1199.
    # THIS IS NOT leftover FootprintSampleResult bSuccess #1189.
...
def attached_uproperty_specifiers(section: str) -> str:
    ...
    if match is None:
        raise AssertionError(
            "UPROPERTY for bool bSuccess is missing from "
...
class Mission01EnvironmentAuthoringResultSuccessFieldDeclContractTests(unittest.TestCase):
    ...
    def test_private_declaration_does_not_satisfy_public_lock(self) -> None:
        ...
        self.assertIn("bSuccess", str(raised.exception))
        self.assertIn("missing", str(raised.exception).lower())
        self.assertIn(CLASS_NAME, str(raised.exception))
        self.assertFalse(
            has_declaration(section, LOCKED_DECL)
    ...
    def test_missing_success_declaration_fails_closed(self) -> None:
        neighbors_only = (
            "\tASkyguardMission09IntegrationDirector();\n"
    ...
    def test_success_declaration_matches_origin_main(self) -> None:
        section = public_section(origin_main_header())
        self.assertEqual(
            require_declaration(section, LOCKED_DECL),
            LOCKED_DECL,
        ...
        self.assertTrue(
            LOCKED_DECL.startswith("bool bSuccess"),
            LOCKED_DECL,
        )
        ...
        self.assertIn("bSuccess", LOCKED_DECL)
    ...
    def test_contract_does_not_relock_sibling_director_fields(self) -> None:
        ...
        self.assertIn("bSuccess", LOCKED_DECL)
        self.assertTrue(LOCKED_DECL.startswith("bool bSuccess"))
    ...
    def test_contract_does_not_relock_neighbor_helpers(self) -> None:
        ...
        self.assertIn("bSuccess", locked_only)
