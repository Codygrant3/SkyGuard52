...
# Mission05 IntegrationReadiness bCampaignDefinitionValid
...
# FIELD #862 / branch cursor/mission02-
# campaign-definition-valid-field-decl-contract-c332,
# NOT leftover Mission03 bCampaignDefinitionValid
# FIELD #892 / branch cursor/mission03-
# campaign-definition-valid-field-decl-contract-c332,
# NOT leftover Mission04 bCampaignDefinitionValid
# FIELD #929 / branch cursor/mission04-
# campaign-definition-valid-field-decl-contract-c332,
# NOT leftover Mission10 bCampaignDefinitionValid
# FIELD #811 / branch cursor/mission10-
# campaign-definition-valid-field-decl-contract-c332,
# NOT leftover Mission04 CampaignDefinition director
# field #914 / branch cursor/mission04-
# campaign-definition-field-decl-contract-c332,
# NOT leftover Mission04 Readiness director field
# #926 / branch cursor/mission04-readiness-field-
# decl-contract-c332,
# NOT leftover Mission05 director field drafts Root #947
# through Readiness #960 / MaximumProtectedTargetIntegrity
# #961 / TempestSpawnRotation #962, NOT leftover Mission05
# Readiness director field / branch cursor/mission05-
# readiness-field-decl-contract-c332 (that file locks the
# DIRECTOR Readiness FIELD; this contract locks the STRUCT
# MEMBER instead), NOT leftover Mission05 wave-state enum
# #ad28 / leftover Mission05 protected-target enum #aaa2 /
# leftover Mission05 protected-target-runtime-defaults
# #ec8b / leftover storm-runtime-defaults #89c9, NOT leftover
# Mission05 closed-without-merge #665 #666 #668 #669 #670
# #671 #672 #673, NOT leftover FSkyguardStormRuntime
# members, NOT leftover retired-mount spawn location /
# spawn rotation / runtime-ready struct fields, NOT leftover
# BindRuntimeActors / HandleDroneCityImpact / leftover
# GetStormRainBeatKit without UFUNCTION, NOT leftover
# Mission01 / Mission02 / Mission03 / Mission04 / Mission10
# same-name Readiness drafts and leftover Mission02 /
# Mission03 / Mission04 / Mission10 same-name director
# field drafts,
...
# not leftover ASkyguardMission04IntegrationDirector,
# not leftover director CampaignDefinition
# TSoftObjectPtr #881, not leftover GetReadiness(),
# not leftover Mission02/10 readiness structs,
# not leftover Mission03 bMissionDefinitionValid
# sibling, not leftover retired-mount runtime-ready
# struct field).
...
# drafts #674-#962 including leftover Mission02
...
# the Mission05IntegrationDirector public section,
...
CAMPAIGN_DEFINITION_VALID_FIELD_TRUE = (
...
LEFTOVER_MISSION05_CLOSED_WITHOUT_MERGE_NOT_LOCKED = (
    "#665",
    "#666",
    "#668",
    "#669",
...
GET_MISSION04_READINESS = (
    "const FSkyguardMission04IntegrationReadiness& "
    "GetReadiness() const"
)
READINESS_MISSION04_FIELD = (
    "FSkyguardMission04IntegrationReadiness Readiness;"
)
LEFTOVER_MISSION04_DIRECTOR_CAMPAIGN_DEFINITION_NOT_LOCKED = (
    "test_mission04_campaign_definition_field_decl_contract.py",
    "cursor/mission04-campaign-definition-field-decl-contract-c332",
    CAMPAIGN_DEFINITION_FIELD,
    "TSoftObjectPtr<USkyguardCampaignDefinition>",
)
...
class Mission05CampaignDefinitionValidFieldDeclContractTests(unittest.TestCase):
    ...
    def test_declaration_accepts_origin_main_split_line_forms(self) -> None:
        ...
        wrap_true = (
            "public:\n"
            f"\t{UPROPERTY_MISSION10}\n"
            f"\t{CAMPAIGN_DEFINITION_VALID_FIELD_TRUE}\n"
            "};\n"
        )
        wrap_true_one_line = (
            "public:\n"
        ...
        for header in (
            ...
            section = public_section(header)
            self.assertTrue(
                has_declaration(section, CAMPAIGN_DEFINITION_VALID_FIELD_TRUE),
                section,
            )
            self.assertEqual(
                require_declaration(
    ...
    def test_contract_parses_public_section_not_enum_private_or_cpp(
        ...
        self.assertNotIn(
            "ASkyguardMission05IntegrationDirector();", section
        )
        self.assertNotIn(
            "FSkyguardMission05IntegrationReadiness Readiness;",
            section,
        )
        self.assertNotIn("float Turbulence = 0.f;", section)
        self.assertNotIn("bool bLightningActive = false;", section)
        self.assertNotIn("FSkyguardStormRuntime", CLASS_RE.pattern)
        self.assertNotIn(
            "ASkyguardMission05IntegrationDirector",
            CLASS_RE.pattern,
        )
    ...
    def test_this_file_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                file_text,
                "mission05 bCampaignDefinitionValid field contract "
    ...
    def test_declaration_bans_retired_live_copy(self) -> None:
        ...
        for banned in leftover_live_copy_tokens():
            self.assertNotIn(
                banned,
                LOCKED_DECL.lower(),
                "mission05 bCampaignDefinitionValid contains "
    ...
    def test_locked_scripts_do_not_include_this_file(self) -> None:
        ...
        self.assertTrue(
            Path(__file__).name.endswith(
                "test_mission05_campaign_definition"
                "_valid_field_decl_contract.py"
            )
        )
        self.assertIn(
