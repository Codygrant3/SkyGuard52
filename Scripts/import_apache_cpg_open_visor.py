"""Import the open CPG visor GLB into Candidates (not accepted runtime)."""
import os

import unreal

SRC = r"D:\Skyguard52\Blender\APACHE_CPG_COCKPIT_BLOCKOUT01\exports\apache_cpg_open_visor.glb"
DEST = "/Game/Skyguard/Candidates/Apache/CPG_OpenVisor01"
NAME = "SM_ApacheCPG_OpenVisor"
REPORT = r"D:\Skyguard52\Saved\Reports\APACHE_CPG_OPEN_VISOR_IMPORT.txt"


def log(msg: str) -> None:
    unreal.log("[CPGOpenVisor] " + msg)
