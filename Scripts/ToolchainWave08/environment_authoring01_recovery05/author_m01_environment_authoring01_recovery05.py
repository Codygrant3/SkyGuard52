...
ATTEMPT_ROOT = r"D:\Skyguard52\Saved\BuildAttempts\TOOLCHAIN_WAVE08_M01_ENVIRONMENT_AUTHORING01_RECOVERY05\attempt_01"
...
OUTPUT_FILE = r"D:\SG52T08_ENV01\Content\ToolchainWave08\Environment\Lvl_M01_T08_EnvironmentAuthoring01_Recovery05.umap"
...
AUTHORING_PREFIX = "/Game/ToolchainWave08/Environment/Authoring01_Recovery05"
...
result = {
    "schema": "skyguard.toolchain-wave08.m01-environment-authoring01-recovery05.receipt.v1",
...
try:
    ...
    before_save_allowed = {OUTPUT_ASSET, OUTPUT_ASSET + ".Lvl_M01_T08_EnvironmentAuthoring01_Recovery05"}
    ...
    result["classification"] = "PASSED_M01_ENVIRONMENT_AUTHORING01_RECOVERY05_AUTOMATIC"
except Exception as exc:
...
if result["classification"] != "PASSED_M01_ENVIRONMENT_AUTHORING01_RECOVERY05_AUTOMATIC":
