...
SUPERVISOR = ROOT / "Scripts/ToolchainWave08/environment_visual_remediation01/stagea_recovery02/invoke_m01_visible_environment_kit_refinement01_stagea_recovery02_once.ps1"
...
FUTURE = (
    ROOT / "Saved/BuildAttempts/M01_VISIBLE_ENVIRONMENT_KIT_REFINEMENT01_STAGEA_RECOVERY02/attempt_01",
    ROOT / "Content/Skyguard/Meshes/Source/Mission01/VisibleEnvironmentKit_Refinement01_StageA_Recovery02",
    ROOT / "Saved/Reports/M01_VISIBLE_ENVIRONMENT_KIT_REFINEMENT01_STAGEA_RECOVERY02_TERMINAL_SUPERVISOR.json",
    ROOT / "Saved/Reports/M01_VISIBLE_ENVIRONMENT_KIT_REFINEMENT01_STAGEA_RECOVERY02_EMERGENCY_RECEIPT.jsonl",
)
...
def load_wrapper():
    spec = importlib.util.spec_from_file_location("stagea_recovery02_wrapper", WRAPPER)
...
def validate() -> dict[str, object]:
    ...
    require(contract["gate"] == "M01_VISIBLE_ENVIRONMENT_KIT_REFINEMENT01_STAGEA_RECOVERY02", "gate drift")
    ...
    ast.parse(corrected, filename="bounded_stagea_recovery02.py")
    ...
    return {
        "schema": "skyguard.m01-visible-environment-kit-refinement01-stagea-recovery02.offline-verification.v1",
        "classification": "PASS",
