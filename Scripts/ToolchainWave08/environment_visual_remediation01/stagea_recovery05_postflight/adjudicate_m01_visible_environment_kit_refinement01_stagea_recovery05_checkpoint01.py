...
OUTPUT = ROOT / r"Content\Skyguard\Meshes\Source\Mission01\VisibleEnvironmentKit_Refinement01_StageA_Recovery05_Checkpoint01"
SUPERVISOR_TERMINAL = ROOT / r"Saved\Reports\M01_VISIBLE_ENVIRONMENT_KIT_REFINEMENT01_STAGEA_RECOVERY05_CHECKPOINT01_TERMINAL_SUPERVISOR.json"
POSTFLIGHT = ROOT / r"Saved\Reports\M01_VISIBLE_ENVIRONMENT_KIT_REFINEMENT01_STAGEA_RECOVERY05_CHECKPOINT01_POSTFLIGHT.json"
...
def main() -> int:
    ...
    payload = {
        "schema": "skyguard.m01-visible-environment-kit-refinement01-stagea-recovery05-checkpoint01.postflight.v1",
        "gate": GATE,
