...
MODULE_PATH = Path(r"D:\Skyguard52\Scripts\ToolchainWave08\environment_visual_remediation01\stagea_recovery06_postflight\adjudicate_m01_visible_environment_kit_refinement01_stagea_recovery06_checkpoint01.py")


def load_module():
    spec = importlib.util.spec_from_file_location("r06_checkpoint_postflight", MODULE_PATH)
...
class Recovery06CheckpointPostflightTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.module = load_module()

    def fixture(self, width: int, height: int, prefix: bytes = b"\x89PNG\r\n\x1a\n") -> Path:
        root = Path(tempfile.mkdtemp(prefix="skyguard-r06-png-"))
    ...
    def test_truncated_header_rejected(self) -> None:
        root = Path(tempfile.mkdtemp(prefix="skyguard-r06-png-truncated-"))
        path = root / "fixture.png"
