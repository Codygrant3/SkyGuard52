...
MODULE_PATH = Path(r"D:\Skyguard52\Scripts\ToolchainWave08\environment_visual_remediation01\stagea_recovery07_postflight\adjudicate_m01_visible_environment_kit_refinement01_stagea_recovery07_checkpoint01.py")
...
class Recovery07CheckpointPostflightTests(unittest.TestCase):
    @classmethod
