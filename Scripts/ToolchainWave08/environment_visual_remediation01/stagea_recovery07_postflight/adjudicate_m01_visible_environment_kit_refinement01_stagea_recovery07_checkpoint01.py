...
OUTPUT = ROOT / r"Content\Skyguard\Meshes\Source\Mission01\VisibleEnvironmentKit_Refinement01_StageA_Recovery07_Checkpoint01"
SUPERVISOR_TERMINAL = ROOT / r"Saved\Reports\M01_VISIBLE_ENVIRONMENT_KIT_REFINEMENT01_STAGEA_RECOVERY07_CHECKPOINT01_TERMINAL_SUPERVISOR.json"
POSTFLIGHT = ROOT / r"Saved\Reports\M01_VISIBLE_ENVIRONMENT_KIT_REFINEMENT01_STAGEA_RECOVERY07_CHECKPOINT01_POSTFLIGHT.json"
...
WORKER_BYTES = 79498
WORKER_SHA256 = "11c87230cfd1464bc83fea7b4b7d14efe4341be5f1adeb0512116e5e0a3aaa95"
...
def main() -> int:
    ...
    require(receipts["checkpoint_receipt.json"].get("passed") is True and receipts["checkpoint_receipt.json"].get("count") == 9, "Checkpoint receipt failed")
    ...
    payload = {
        "schema": "skyguard.m01-visible-environment-kit-refinement01-stagea-recovery07-checkpoint01.postflight.v1",
        "gate": GATE,
