...
OUTPUT_ASSET = "/Game/M01/Lvl_M01_HeroStreetShoreCell03"
OUTPUT_FILE = ISOLATED / "Content/M01/Lvl_M01_HeroStreetShoreCell03.umap"
MATERIAL_ROOT = "/Game/M01/HeroStreetShoreCell03/Materials"
...
def run_offline_contract_test() -> int:
    ...
    print("PASS_M01_HERO_STREET_SHORE_CELL03_AUTHORING_CONTRACT")
    return 0
...
def run_unreal() -> None:
    ...
    result: dict[str, object] = {
        "schema": "skyguard.m01-hero-street-shore-cell03.authoring.v1",
    ...
    try:
        ...
        asphalt_file = ISOLATED / "Content/M01/HeroStreetShoreCell03/Materials/MI_M01_Cell03_Asphalt_Tiled.uasset"
        ...
        result["classification"] = "PASSED_M01_HERO_STREET_SHORE_CELL03_READY_FOR_D3D12_MAPPED_VISUAL_PROOF"
