...
ATTEMPT_ROOT = os.path.join(
    ROOT,
    r"Saved\BuildAttempts\M01_ENVIRONMENT_REALISM_STACK_AUTHORING01\attempt_01",
)
...
OUTPUT_ASSET = "/Game/ToolchainWave08/Environment/Lvl_M01_T08_EnvironmentRealismStack01"
INPUT_FILE = r"D:\SG52T08_ENV01\Content\ToolchainWave08\Environment\Lvl_M01_T08_EnvironmentAuthoring01_Recovery07.umap"
OUTPUT_FILE = r"D:\SG52T08_ENV01\Content\ToolchainWave08\Environment\Lvl_M01_T08_EnvironmentRealismStack01.umap"
EXPECTED_INPUT_SHA256 = "401fb7a86321c05f977347185e41fd0ea0436ef7ec3d06d635935ad5f4ce702f"
AUTHORING_PREFIX = "/Game/ToolchainWave08/Environment/RealismStack01"
RANDOM_SEED = 520811
...
result = {
    "schema": "skyguard.m01-environment-realism-stack-authoring01.receipt.v1",
...
try:
    ...
    require(not os.path.exists(OUTPUT_FILE), "RealismStack01 output file already exists")
    require(not unreal.EditorAssetLibrary.does_asset_exist(OUTPUT_ASSET), "RealismStack01 output asset already exists")
    ...
    require(levels.new_level_from_template(OUTPUT_ASSET, INPUT_ASSET), "Failed to create RealismStack01 from Recovery07")
    ...
    require(unreal.EditorAssetLibrary.save_asset(OUTPUT_ASSET, only_if_is_dirty=False), "Failed to save RealismStack01 map")
    result["saved_assets"] = [OUTPUT_ASSET]
    require(os.path.isfile(OUTPUT_FILE), "RealismStack01 output file is missing after save")
    ...
    result["classification"] = "PASSED_M01_ENVIRONMENT_REALISM_STACK_AUTHORING01_AUTOMATIC"
...
if result["classification"] != "PASSED_M01_ENVIRONMENT_REALISM_STACK_AUTHORING01_AUTOMATIC":
    raise RuntimeError(result["error"]["message"] if result["error"] else "RealismStack01 authoring failed")
