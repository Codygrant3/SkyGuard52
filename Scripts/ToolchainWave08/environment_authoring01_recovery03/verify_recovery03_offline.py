...
FUTURE = [
    ROOT / "Saved" / "BuildAttempts" / "TOOLCHAIN_WAVE08_M01_ENVIRONMENT_AUTHORING01_RECOVERY03_DEPENDENCY_PROBE" / "attempt_01",
    ROOT / "Saved" / "Reports" / "TOOLCHAIN_WAVE08_M01_ENVIRONMENT_AUTHORING01_RECOVERY03_DEPENDENCY_PROBE_TERMINAL_MANIFEST.json",
    ROOT / "Saved" / "Reports" / "TOOLCHAIN_WAVE08_M01_ENVIRONMENT_AUTHORING01_RECOVERY03_DEPENDENCY_PROBE_EMERGENCY_RECEIPT.jsonl",
    ROOT / "Saved" / "BuildAttempts" / "TOOLCHAIN_WAVE08_M01_ENVIRONMENT_AUTHORING01_RECOVERY03" / "attempt_01",
    pathlib.Path(r"D:\SG52T08_ENV01\Content\ToolchainWave08\Environment\Lvl_M01_T08_EnvironmentAuthoring01_Recovery03.umap"),
]
...
def main():
    ...
    if digest(PROBE) != digest(OLD_PROBE):
        failures.append("Recovery03 probe is not byte-identical to Recovery02")
    ...
    result = {
        "schema": "skyguard.toolchain-wave08.m01-authoring01-recovery03.offline-verifier.v1",
