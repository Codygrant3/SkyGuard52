...
REPLACEMENTS=(("M01_POLYHAVEN_VEGETATION_STAGING02_VISUAL_PROOF01","M01_POLYHAVEN_VEGETATION_STAGING02_VISUAL_PROOF01_RECOVERY07"),("M01-POLYHAVEN-VEGETATION-STAGING02-VISUAL-PROOF01","M01-POLYHAVEN-VEGETATION-STAGING02-VISUAL-PROOF01-RECOVERY07"),("M01PolyHavenVegetationStaging02VisualProof01.csv","M01PolyHavenVegetationStaging02VisualProof01Recovery06.csv"),("m01_polyhaven_vegetation_staging02_visual_proof01","m01_polyhaven_vegetation_staging02_visual_proof01_recovery07"),("polyhaven-vegetation-staging02-visual-proof01","polyhaven-vegetation-staging02-visual-proof01-recovery07"))
...
def transform_source():
    ...
    if "RECOVERY07_RECOVERY07" in source or "recovery07_recovery07" in source:raise RuntimeError("Duplicate Recovery06 adjudicator suffix")
    return source
if __name__=="__main__":exec(compile(transform_source(),str(SOURCE)+"::recovery07","exec"),globals(),globals())
