...
$Contract = 'D:\Skyguard52\Scripts\ToolchainWave08\m01_polyhaven_vegetation_staging01_recovery02\vegetation_staging01_recovery02_contract.json'
$Worker = 'D:\Skyguard52\Scripts\ToolchainWave08\m01_polyhaven_vegetation_staging01_recovery02\author_m01_polyhaven_vegetation_staging01_recovery02.py'
$AttemptRoot = 'D:\Skyguard52\Saved\BuildAttempts\M01_POLYHAVEN_VEGETATION_STAGING01_RECOVERY02\attempt_01'
$AttemptWorker = Join-Path $AttemptRoot 'author_m01_polyhaven_vegetation_staging01_recovery02.py'
...
$ExternalTerminal = 'D:\Skyguard52\Saved\Reports\M01_POLYHAVEN_VEGETATION_STAGING01_RECOVERY02_TERMINAL_MANIFEST.json'
$EmergencyReceipt = 'D:\Skyguard52\Saved\Reports\M01_POLYHAVEN_VEGETATION_STAGING01_RECOVERY02_EMERGENCY_RECEIPT.jsonl'
$AssetDiskRoot = 'D:\SG52T08_ENV01\Content\M01\SourceBacked\VegetationStaging01Recovery02'
$InputMap = 'D:\SG52T08_ENV01\Content\M01\Lvl_M01_HeroStreetShoreCell03Recovery01.umap'
$OutputMap = 'D:\SG52T08_ENV01\Content\M01\Lvl_M01_PolyHavenVegetationStaging01Recovery02.umap'
...
if ($OfflineContractTest) {
    ...
    Write-Output 'CLASSIFICATION=PASSED_M01_POLYHAVEN_VEGETATION_STAGING01_RECOVERY02_OFFLINE_CONTRACT'
    exit 0
}
...
try {
    ...
    Write-JsonAtomic $Preflight ([ordered]@{
        schema = 'skyguard.m01-polyhaven-vegetation-staging01-recovery02.preflight.v1'
    ...
    $terminal = [ordered]@{
        schema = 'skyguard.m01-polyhaven-vegetation-staging01-recovery02.terminal-supervisor.v1'
