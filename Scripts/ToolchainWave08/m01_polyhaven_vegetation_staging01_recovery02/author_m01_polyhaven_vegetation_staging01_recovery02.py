...
CONTRACT_PATH = ROOT / "Scripts/ToolchainWave08/m01_polyhaven_vegetation_staging01_recovery02/vegetation_staging01_recovery02_contract.json"
ATTEMPT = ROOT / "Saved/BuildAttempts/M01_POLYHAVEN_VEGETATION_STAGING01_RECOVERY02/attempt_01"
...
def offline_contract_test() -> int:
    ...
    print("PASS_M01_POLYHAVEN_VEGETATION_STAGING01_RECOVERY02_OFFLINE_CONTRACT")
    return 0
...
def run_unreal() -> None:
    ...
    result: dict[str, object] = {
        "schema": "skyguard.m01-polyhaven-vegetation-staging01-recovery02.authoring-receipt.v1",
    ...
    try:
        ...
        for spec in contract["assets"]:
            ...
            for index, (x_cm, y_cm, yaw, scale) in enumerate(placements, start=1):
                ...
                actor.set_folder_path(f"M01/SourceBacked/VegetationStaging01Recovery02/{asset_id}")
