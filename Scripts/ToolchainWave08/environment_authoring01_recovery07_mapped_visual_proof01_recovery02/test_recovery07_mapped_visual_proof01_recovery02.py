...
SPEC = importlib.util.spec_from_file_location(
    ...
    HERE / "adjudicate_recovery07_mapped_visual_proof01_recovery02_once.py",
)
...
class Recovery07MappedVisualProofTests(unittest.TestCase):
    ...
    def test_executor_uses_deferred_tick_without_save_api(self) -> None:
        source = (HERE / "capture_recovery07_mapped_visual_proof01_recovery02.py").read_text(
            encoding="utf-8"
        )
    ...
    def test_recovery01_supervisor_uses_editor_mode_and_stable_csv(self) -> None:
        supervisor = (HERE / "invoke_recovery07_mapped_visual_proof01_recovery02_once.ps1").read_text(encoding="utf-8")
