...
$contractId = 'T08-M01-ENV-AUTH01-RECOVERY07-MAPPED-VISUAL-PROOF01-RECOVERY02'
$scriptRoot = Join-Path $root 'Scripts\ToolchainWave08\environment_authoring01_recovery07_mapped_visual_proof01_recovery02'
$executor = Join-Path $scriptRoot 'capture_recovery07_mapped_visual_proof01_recovery02.py'
$adjudicator = Join-Path $scriptRoot 'adjudicate_recovery07_mapped_visual_proof01_recovery02_once.py'
$contract = Join-Path $root 'Docs\AAA_Review\TOOLCHAIN_WAVE08_M01_ENVIRONMENT_AUTHORING01_RECOVERY07_MAPPED_VISUAL_PROOF01_RECOVERY02_CONTRACT.json'
$offlineFreeze = Join-Path $root 'Docs\AAA_Review\TOOLCHAIN_WAVE08_M01_ENVIRONMENT_AUTHORING01_RECOVERY07_MAPPED_VISUAL_PROOF01_RECOVERY02_OFFLINE_DESIGN_FREEZE.json'
$bindingFreeze = Join-Path $root 'Docs\AAA_Review\TOOLCHAIN_WAVE08_M01_ENVIRONMENT_AUTHORING01_RECOVERY07_MAPPED_VISUAL_PROOF01_RECOVERY02_EXECUTION_PROMPT_BINDING_FREEZE.json'
$attemptRoot = Join-Path $root 'Saved\BuildAttempts\TOOLCHAIN_WAVE08_M01_ENVIRONMENT_AUTHORING01_RECOVERY07_MAPPED_VISUAL_PROOF01_RECOVERY02\attempt_01'
$launcherRoot = Join-Path $root 'Saved\BuildAttempts\TOOLCHAIN_WAVE08_M01_ENVIRONMENT_AUTHORING01_RECOVERY07_MAPPED_VISUAL_PROOF01_RECOVERY02\launcher_attempt_01'
$preflightReceipt = Join-Path $root 'Saved\Reports\TOOLCHAIN_WAVE08_M01_ENVIRONMENT_AUTHORING01_RECOVERY07_MAPPED_VISUAL_PROOF01_RECOVERY02_EXECUTION_PREFLIGHT.json'
$terminalSupervisor = Join-Path $root 'Saved\Reports\TOOLCHAIN_WAVE08_M01_ENVIRONMENT_AUTHORING01_RECOVERY07_MAPPED_VISUAL_PROOF01_RECOVERY02_TERMINAL_SUPERVISOR.json'
$emergencyReceipt = Join-Path $root 'Saved\Reports\TOOLCHAIN_WAVE08_M01_ENVIRONMENT_AUTHORING01_RECOVERY07_MAPPED_VISUAL_PROOF01_RECOVERY02_EMERGENCY_RECEIPT.jsonl'
$postflightReport = Join-Path $root 'Saved\Reports\TOOLCHAIN_WAVE08_M01_ENVIRONMENT_AUTHORING01_RECOVERY07_MAPPED_VISUAL_PROOF01_RECOVERY02_POSTFLIGHT.json'
$profileFile = Join-Path $isolatedRoot 'Saved\Profiling\CSV\Recovery07MappedVisualProof01Recovery02.csv'
$timeoutSeconds = 540
...
function Test-OfflineContract {
    ...
    if ($freeze.classification -ne 'PASSED_READY_FOR_EXPLICIT_SINGLE_RECOVERY07_MAPPED_VISUAL_PROOF01_RECOVERY02_AUTHORIZATION') { throw 'Offline freeze classification mismatch' }
    if ($binding.classification -ne 'PASSED_READY_FOR_EXPLICIT_SINGLE_RECOVERY07_MAPPED_VISUAL_PROOF01_RECOVERY02_AUTHORIZATION') { throw 'Binding freeze classification mismatch' }
