"""Bind the proven automatic D3D12 adjudicator to EnvironmentCompositionCorrection05 Recovery02."""
...
SOURCE = Path(
    r"D:\Skyguard52\Scripts\ToolchainWave08\m01_photoreal_foundation_ground_lighting_correction04_recovery01_visual_proof01\adjudicate_m01_photoreal_foundation_ground_lighting_correction04_recovery01_visual_proof01_once.py"
)
EXPECTED_BYTES = 2748
EXPECTED_SHA256 = "960bc3cd87f0aa4143dc76fed5a072cbe73288710af53151043fa9f0b5b8d2b6"
...
OLD_SLUG = "m01_photoreal_foundation_wave01_ground_lighting_correction04_recovery01_visual_proof01"
NEW_SLUG = "m01_photoreal_foundation_wave01_environment_composition_correction05_recovery02_visual_proof01"
OLD_KEBAB = "photoreal-foundation-wave01-ground-lighting-correction04-recovery01-visual-proof01"
NEW_KEBAB = "photoreal-foundation-wave01-environment-composition-correction05-recovery02-visual-proof01"
...
def transform_source() -> str:
    if not SOURCE.is_file() or SOURCE.stat().st_size != EXPECTED_BYTES or sha256(SOURCE) != EXPECTED_SHA256:
        raise RuntimeError("Frozen GroundLightingCorrection04 Recovery01 proof adjudicator changed")
    namespace = {"__name__": "ground_lighting_proof_adjudicator_authority"}
