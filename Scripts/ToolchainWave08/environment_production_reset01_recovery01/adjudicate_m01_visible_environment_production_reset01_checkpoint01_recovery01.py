"""Recovery01 output binding for the frozen Checkpoint01 adjudicator."""
...
def main() -> None:
    ...
    replacements = [
        ...
        (
            "M01_VISIBLE_ENVIRONMENT_PRODUCTION_RESET01_CHECKPOINT01_POSTFLIGHT.json",
            "M01_VISIBLE_ENVIRONMENT_PRODUCTION_RESET01_CHECKPOINT01_RECOVERY01_POSTFLIGHT.json",
        ),
    ]
