...
PROFILE = ISOLATED_ROOT / "Saved/Profiling/CSV/Recovery07MappedVisualProof01Recovery04.csv"
...
def verify_logs() -> dict[str, Any]:
    logs = [
        LAUNCHER / "logs/recovery07_mapped_visual_proof01_recovery04.engine.log",
        LAUNCHER / "logs/recovery07_mapped_visual_proof01_recovery04.stdout.log",
        LAUNCHER / "logs/recovery07_mapped_visual_proof01_recovery04.stderr.log",
    ]
    for path in logs:
