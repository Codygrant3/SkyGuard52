...
PROFILE = ISOLATED_ROOT / "Saved/Profiling/CSV/Recovery07MappedVisualProof01Recovery01.csv"
...
def verify_logs() -> dict[str, Any]:
    logs = [
        LAUNCHER / "logs/recovery07_mapped_visual_proof01_recovery01.engine.log",
        LAUNCHER / "logs/recovery07_mapped_visual_proof01_recovery01.stdout.log",
        LAUNCHER / "logs/recovery07_mapped_visual_proof01_recovery01.stderr.log",
    ]
    for path in logs:
