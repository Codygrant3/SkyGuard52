...
AUTHOR = ROOT / "Scripts/ToolchainWave08/m01_hero_street_shore_cell03_recovery01/author_m01_hero_street_shore_cell03_recovery01.py"
...
OUTPUT_MAP = ISOLATED / "Content/M01/Lvl_M01_HeroStreetShoreCell03Recovery01.umap"
...
TERMINAL = ROOT / "Saved/Reports/M01_HERO_STREET_SHORE_CELL03_RECOVERY01_TERMINAL_SUPERVISOR.json"
...
def offline_contract_test() -> int:
    ...
    if author_test.returncode != 0 or "PASS_M01_HERO_STREET_SHORE_CELL03_RECOVERY01_AUTHORING_CONTRACT" not in author_test.stdout:
...
def main() -> int:
    ...
    try:
        ...
        expected = "PASSED_M01_HERO_STREET_SHORE_CELL03_RECOVERY01_READY_FOR_D3D12_MAPPED_VISUAL_PROOF"
        ...
        terminal = {
            "schema": "skyguard.m01-hero-street-shore-cell03-recovery01.supervisor.v1",
