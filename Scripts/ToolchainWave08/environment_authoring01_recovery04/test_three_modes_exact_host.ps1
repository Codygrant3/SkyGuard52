...
$Target = 'D:\Skyguard52\Scripts\ToolchainWave08\environment_authoring01_recovery04\invoke_dependency_probe_once.ps1'
$ResultPath = 'D:\Skyguard52\Saved\Reports\ToolchainWave08\EnvironmentAuthoring01Recovery04OfflineDesign\exact_host_test_result_final.json'
$FuturePaths = @(
...
if ($conflict.stderr -notmatch 'Offline and authorized modes are mutually exclusive') { $failures += 'Conflicting-switch diagnostic missing from stderr' }
...
$result = [ordered]@{
    schema = 'skyguard.toolchain-wave08.m01-authoring01-recovery04.three-mode-exact-host-test.v1'
