...
BINDING_ID = "P4.6-M01-RECOVERY04-BINDING-01"
CONTRACT_ID = (
...
LAUNCHER = (
    ROOT
    / "Saved/BuildAttempts/"
    "PHASE4_M01_REPRESENTATIVE_VISUAL_ATTEMPT08_RECOVERY04_"
    "BINDING01/launcher_attempt_01"
)
PREFLIGHT = (
    ROOT
    / "Saved/Reports/"
    "PHASE4_M01_RECOVERY04_BINDING01_EXECUTION_PREFLIGHT.json"
)
SUPERVISOR = (
    ROOT
    / "Saved/Reports/"
    "PHASE4_M01_RECOVERY04_BINDING01_TERMINAL_SUPERVISOR.json"
)
LAUNCHER_SOURCE = (
    ROOT
    / "Scripts/"
    "invoke_skyguard_phase4_m01_representative_visual_"
    "attempt08_recovery04_once.ps1"
)
CONTRACT = (
    ROOT
    / "Docs/AAA_Review/"
    "PHASE4_M01_RECOVERY04_RUNTIME_BINDING_CONTRACT.json"
)
CAMERA_IDS = [
...
def offline_contract_test() -> dict[str, Any]:
    ...
    for marker in (
        ...
        "-DisablePlugins=SkyguardRecovery03NativeRecovery01,"
    ...
    return {
        "schema": "skyguard.phase4.m01-recovery04-binding01-offline-test.v1",
        "gate": "PASS",
...
def postflight() -> dict[str, Any]:
    ...
    result = {
        "schema": "skyguard.phase4.m01-recovery04-binding01-postflight.v1",
