...
Invoke-UEPy 'D:\Skyguard52\Scripts\build_skyguard_aaa_loop7_world.py' 'skyguard-aaa-loop7-world.log'
Invoke-UEPy 'D:\Skyguard52\Scripts\build_skyguard_aaa_import_textures_loop7.py' 'skyguard-aaa-loop7-tex.log'
Invoke-UEPy 'D:\Skyguard52\Scripts\build_skyguard_aaa_loop7_cinematic.py' 'skyguard-aaa-loop7-cine.log'
Write-Host 'loop7 editor passes finished'
