...
Updated: 2026-08-01T08:20:43-05:00

## Gate separation
- Structural capture gate: **PASS** — exact 11/11 cameras, 33/33 sources, and 33/33 SHA-256 entries verified
- Visual subject gate: **REJECT** — checker/proxy geometry occludes the intended subjects and the images do not present a recognizable AAA aircraft, cockpit, city, ocean, or combat scene
- Promotion rule: structural completeness is necessary but can never substitute for visual acceptance
...
| Harbor | BASE | 27.1% | 0.0% | ~90 | 16.2 | **Yes** (ok) |
| Ocean | BASE | 21.7% | 0.0% | ~82 | 14.4 | **Yes** (ok) |
...
| YakBeauty | FINAL | 48.8% | 0.0% | ~413 | 1.1 | **Yes** (strong) |

## Densify verified
- Map size: **30632546** (30.6 MB)
