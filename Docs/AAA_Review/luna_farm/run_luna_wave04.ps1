...
$combined = Join-Path $wave "wave04_all_proposals.json"
$payload = [ordered]@{
  wave = $WaveId
  model = $Model
...
$summaryPath = Join-Path $wave "wave04_job_summary.json"
$summary | ConvertTo-Json -Depth 6 | Set-Content -LiteralPath $summaryPath -Encoding utf8

$listPath = Join-Path $wave "wave04_proposals_list.json"
...
$rankedCsv = Join-Path $wave "wave04_ranked.csv"
...
[void]$lines.Add("Base freeze: **L56** densify+thin-art (11/11). L52 densify recipe; L53 rejected; L54/L55/L56 kept.")
