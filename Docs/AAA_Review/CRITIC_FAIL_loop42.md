# AAA Critic Report — Loop 42

## Verdict: FAIL vs AAA (authoritative)
Loop42 uses yaw=0 (+X) cameras aimed into high-frequency checker boards and radial prop proxies with alternating unlit/PBR mats, plus triple-source capture (BASE/FINAL/SCENE when available).
...
Updated: 2026-07-31T21:18:58-05:00

## Host Pillow RGB audit (best source per cam)
| Camera | Best src | black% | white% | uniq | edge | Usable |
|---|---|---|---|---|---|---|
| ADS | FINAL | 6.1% | 0.0% | ~178 | 0.4 | **Yes** (ok) |
| City | FINAL | 24.1% | 1.1% | ~308 | 0.7 | **Yes** (strong) |
| Cockpit | FINAL | 2.0% | 0.0% | ~84 | 0.3 | **Yes** (ok) |
| Combat | FINAL | 24.7% | 0.0% | ~184 | 0.6 | **Yes** (ok) |
| Harbor | FINAL | 23.3% | 0.0% | ~143 | 0.4 | **Yes** (ok) |
| Ocean | FINAL | 35.4% | 0.1% | ~105 | 0.5 | **Yes** (ok) |
| Prop | FINAL | 0.0% | 0.0% | ~54 | 0.2 | **Partial** (low structure) |
| PropHub | FINAL | 0.0% | 0.0% | ~68 | 0.0 | **Partial** (low structure) |
| PropNose | FINAL | 0.0% | 0.0% | ~155 | 0.1 | **Partial** (weak) |
| Wide | FINAL | 28.8% | 0.1% | ~82 | 0.5 | **Yes** (ok) |
| YakBeauty | FINAL | 16.4% | 0.0% | ~271 | 0.7 | **Yes** (strong) |

## Densify verified
- Map size: **11827454** (11.8 MB)
