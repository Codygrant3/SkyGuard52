# AAA Critic Report — Loop 44

## Verdict: FAIL vs AAA (authoritative)
Loop44 uses yaw=0 (+X) cameras aimed into high-frequency checker boards and radial prop proxies with alternating unlit/PBR mats, plus triple-source capture (BASE/FINAL/SCENE when available).
...
Updated: 2026-07-31T21:25:27-05:00

## Host Pillow RGB audit (best source per cam)
| Camera | Best src | black% | white% | uniq | edge | Usable |
|---|---|---|---|---|---|---|
| ADS | FINAL | 6.1% | 0.0% | ~178 | 0.4 | **Yes** (ok) |
| City | FINAL | 24.1% | 1.1% | ~311 | 0.7 | **Yes** (strong) |
| Cockpit | FINAL | 2.0% | 0.0% | ~84 | 0.3 | **Yes** (ok) |
| Combat | FINAL | 24.7% | 0.0% | ~185 | 0.6 | **Yes** (ok) |
| Harbor | FINAL | 23.0% | 0.0% | ~177 | 0.4 | **Yes** (ok) |
| Ocean | FINAL | 35.4% | 0.1% | ~105 | 0.5 | **Yes** (ok) |
| Prop | FINAL | 0.0% | 0.0% | ~54 | 0.6 | **Partial** (partial) |
| PropHub | FINAL | 5.1% | 0.0% | ~83 | 0.6 | **Yes** (ok) |
| PropNose | FINAL | 0.0% | 0.0% | ~68 | 0.4 | **Partial** (partial) |
| Wide | FINAL | 28.8% | 0.1% | ~82 | 0.5 | **Yes** (ok) |
| YakBeauty | FINAL | 17.1% | 0.0% | ~233 | 0.6 | **Yes** (strong) |

## Densify verified
- Map size: **11020215** (11.0 MB)
