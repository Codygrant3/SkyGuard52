# AAA Critic Report — Loop 30

## Verdict: FAIL vs AAA (authoritative)
Loop30 uses yaw=0 (+X) cameras aimed into high-frequency checker boards and radial prop proxies with alternating unlit/PBR mats, plus triple-source capture (BASE/FINAL/SCENE when available).
...
Updated: 2026-07-31T20:08:48-05:00

## Host Pillow RGB audit (best source per cam)
| Camera | Best src | black% | white% | uniq | edge | Usable |
|---|---|---|---|---|---|---|
| ADS | BASE | 29.5% | 0.0% | ~44 | 5.5 | **Partial** (partial) |
| City | BASE | 1.7% | 0.0% | ~52 | 1.0 | **Partial** (partial) |
| Cockpit | BASE | 0.0% | 0.0% | ~34 | 2.4 | **No** (low unique) |
| Combat | BASE | 25.3% | 0.0% | ~70 | 13.9 | **Partial** (partial) |
| Harbor | FINAL | 24.8% | 46.8% | ~499 | 0.1 | **Partial** (weak) |
| Ocean | FINAL | 25.1% | 47.1% | ~717 | 0.5 | **Yes** (strong) |
| Prop | FINAL | 0.0% | 0.0% | ~19 | 0.0 | **No** (low unique) |
| PropHub | FINAL | 0.0% | 0.0% | ~19 | 0.0 | **No** (low unique) |
| PropNose | FINAL | 0.0% | 0.0% | ~19 | 0.0 | **No** (low unique) |
| Wide | BASE | 24.8% | 0.0% | ~55 | 13.9 | **Partial** (partial) |
| YakBeauty | BASE | 19.1% | 0.0% | ~41 | 25.8 | **Partial** (partial) |

## Densify verified
- Map size: **11568454** (11.6 MB)
