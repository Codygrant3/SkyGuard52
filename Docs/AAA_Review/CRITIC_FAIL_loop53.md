# AAA Critic Report — Loop 53

## Verdict: FAIL vs AAA (authoritative)
Loop53 uses yaw=0 (+X) cameras aimed into high-frequency checker boards and radial prop proxies with alternating unlit/PBR mats, plus triple-source capture (BASE/FINAL/SCENE when available).
...
Updated: 2026-07-31T23:19:25-05:00

## Host Pillow RGB audit (best source per cam)
| Camera | Best src | black% | white% | uniq | edge | Usable |
|---|---|---|---|---|---|---|
| ADS | FINAL | 21.0% | 0.0% | ~161 | 0.6 | **Yes** (ok) |
| City | BASE | 22.1% | 0.0% | ~70 | 3.7 | **Partial** (partial) |
| Cockpit | FINAL | 4.9% | 0.0% | ~128 | 0.5 | **Yes** (ok) |
| Combat | BASE | 32.1% | 0.0% | ~120 | 13.0 | **Yes** (ok) |
| Harbor | BASE | 25.8% | 0.0% | ~96 | 15.9 | **Yes** (ok) |
| Ocean | BASE | 22.3% | 0.0% | ~75 | 12.5 | **Partial** (partial) |
| Prop | FINAL | 53.5% | 0.4% | ~52 | 0.5 | **Partial** (partial) |
| PropHub | FINAL | 51.4% | 0.0% | ~167 | 1.1 | **Yes** (ok) |
| PropNose | FINAL | 0.0% | 0.0% | ~57 | 0.3 | **Partial** (partial) |
| Wide | BASE | 20.3% | 0.0% | ~41 | 3.0 | **Partial** (partial) |
| YakBeauty | BASE | 33.1% | 0.0% | ~75 | 10.7 | **Partial** (partial) |

## Densify verified
- Map size: **19311380** (19.3 MB)
