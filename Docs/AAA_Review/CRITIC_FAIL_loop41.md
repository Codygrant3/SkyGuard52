# AAA Critic Report — Loop 41

## Verdict: FAIL vs AAA (authoritative)
Loop41 uses yaw=0 (+X) cameras aimed into high-frequency checker boards and radial prop proxies with alternating unlit/PBR mats, plus triple-source capture (BASE/FINAL/SCENE when available).
...
Updated: 2026-07-31T21:14:15-05:00
...
| Prop | FINAL | 0.0% | 0.0% | ~58 | 0.6 | **Partial** (partial) |
| PropHub | FINAL | 13.1% | 0.0% | ~95 | 0.7 | **Yes** (ok) |
| PropNose | FINAL | 0.0% | 0.0% | ~29 | 0.3 | **No** (low unique) |
| Wide | FINAL | 28.8% | 0.1% | ~82 | 0.5 | **Yes** (ok) |
| YakBeauty | FINAL | 17.1% | 0.0% | ~232 | 0.6 | **Yes** (strong) |

## Densify verified
- Map size: **7084992** (7.1 MB)
