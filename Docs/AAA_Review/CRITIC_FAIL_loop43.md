# AAA Critic Report — Loop 43

## Verdict: FAIL vs AAA (authoritative)
Loop43 uses yaw=0 (+X) cameras aimed into high-frequency checker boards and radial prop proxies with alternating unlit/PBR mats, plus triple-source capture (BASE/FINAL/SCENE when available).
...
Updated: 2026-07-31T21:22:23-05:00
...
| Harbor | FINAL | 23.2% | 0.0% | ~146 | 0.4 | **Yes** (ok) |
| Ocean | FINAL | 35.4% | 0.1% | ~105 | 0.5 | **Yes** (ok) |
| Prop | FINAL | 0.0% | 0.0% | ~53 | 0.6 | **Partial** (partial) |
| PropHub | FINAL | 4.8% | 0.0% | ~97 | 0.6 | **Yes** (ok) |
| PropNose | FINAL | 0.0% | 0.0% | ~73 | 0.5 | **Partial** (partial) |
| Wide | FINAL | 28.8% | 0.1% | ~82 | 0.5 | **Yes** (ok) |
| YakBeauty | FINAL | 17.1% | 0.0% | ~232 | 0.6 | **Yes** (strong) |

## Densify verified
- Map size: **9615379** (9.6 MB)
