...
void ASkyguardMission04IntegrationDirector::BeginPlay()
{
	...
	ASkyguardDrone::OnAnyCityImpacted.AddUObject(
		this,
		&ASkyguardMission04IntegrationDirector::HandleDroneCityImpact);
	if (bAutoInitialize)
	{
...
void ASkyguardMission04IntegrationDirector::EndPlay(
...
void ASkyguardMission04IntegrationDirector::HandleDroneCityImpact(
...
bool ASkyguardMission04IntegrationDirector::NotifyProtectedAssetFailed()
{
	return NotifySubstationDamage(FMath::Max(SubstationIntegrity, 1));
}
...
ASkyguardMission04IntegrationDirector::GetNightBeatKit() const
{
	return SkyguardNightSortieBeatKit::NightEyes();
}

ESkyguardNightSortieBeatKind
ASkyguardMission04IntegrationDirector::GetNightBeatKind() const
{
	return SkyguardNightSortieBeatKit::KindAt(GetNightBeatKit(), NightBeatIndex);
}

void ASkyguardMission04IntegrationDirector::TickNightBeatKit(
	const float DeltaSeconds)
{
...
void ASkyguardMission04IntegrationDirector::ApplyNightThermalContract()
{
	if (!Gunner)
	{
		return;
